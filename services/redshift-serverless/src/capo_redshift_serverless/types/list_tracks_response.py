...
class ListTracksResponse(TypedDict, closed=True):
    tracks: NotRequired["capo_redshift_serverless.types.track_list.TrackList"]
...
def serialize_aws_json_1_1(value: ListTracksResponse) -> dict:
    ...
    if "tracks" in value:
        ...
        out["tracks"] = (
            capo_redshift_serverless.types.track_list.serialize_aws_json_1_1(
                value["tracks"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListTracksResponse:
    ...
    if data.get("tracks") is not None:
        ...
        out["tracks"] = (
            capo_redshift_serverless.types.track_list.deserialize_aws_json_1_1(
                data["tracks"]
            )
        )
