...
class ListUsageLimitsResponse(TypedDict, closed=True):
    usage_limits: NotRequired["capo_redshift_serverless.types.usage_limits.UsageLimits"]
...
def serialize_aws_json_1_1(value: ListUsageLimitsResponse) -> dict:
    ...
    if "usage_limits" in value:
        ...
        out["usageLimits"] = (
            capo_redshift_serverless.types.usage_limits.serialize_aws_json_1_1(
                value["usage_limits"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListUsageLimitsResponse:
    ...
    if data.get("usageLimits") is not None:
        ...
        out["usage_limits"] = (
            capo_redshift_serverless.types.usage_limits.deserialize_aws_json_1_1(
                data["usageLimits"]
            )
        )
