...
if TYPE_CHECKING:
    import capo_redshift_serverless.types.performance_target_status


class PerformanceTarget(TypedDict, closed=True):
    status: NotRequired[
        "capo_redshift_serverless.types.performance_target_status.PerformanceTargetStatus"
    ]
