...
ManagedWorkgroups: TypeAlias = list[
    "capo_redshift_serverless.types.managed_workgroup_list_item.ManagedWorkgroupListItem"
]
...
def serialize_aws_json_1_1(value: ManagedWorkgroups) -> list:
    ...
    for item in value:
        out.append(
            capo_redshift_serverless.types.managed_workgroup_list_item.serialize_aws_json_1_1(
                item
            )
        )
    return out
