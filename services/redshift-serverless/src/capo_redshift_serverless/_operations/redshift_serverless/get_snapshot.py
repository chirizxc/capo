"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetSnapshot``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.get_snapshot_response.GetSnapshotResponse = (
        capo_redshift_serverless.types.get_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetSnapshot"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.get_snapshot_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
