"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#DeleteSnapshotCopyConfiguration``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.delete_snapshot_copy_configuration_response.DeleteSnapshotCopyConfigurationResponse = capo_redshift_serverless.types.delete_snapshot_copy_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.DeleteSnapshotCopyConfiguration"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.delete_snapshot_copy_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_snapshot_copy_configuration(
