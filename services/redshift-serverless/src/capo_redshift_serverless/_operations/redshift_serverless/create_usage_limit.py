"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#CreateUsageLimit``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.create_usage_limit_response.CreateUsageLimitResponse = capo_redshift_serverless.types.create_usage_limit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.CreateUsageLimit"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.create_usage_limit_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
