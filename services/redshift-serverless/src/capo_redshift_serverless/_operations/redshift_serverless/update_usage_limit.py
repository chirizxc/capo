"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateUsageLimit``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.update_usage_limit_response.UpdateUsageLimitResponse = capo_redshift_serverless.types.update_usage_limit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateUsageLimit"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.update_usage_limit_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_usage_limit(
