"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#DeleteEndpointAccess``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.delete_endpoint_access_response.DeleteEndpointAccessResponse = capo_redshift_serverless.types.delete_endpoint_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.DeleteEndpointAccess"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.delete_endpoint_access_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
