...
def handle_response(
    ...
    out: capo_redshift_serverless.types.delete_custom_domain_association_response.DeleteCustomDomainAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.delete_custom_domain_association_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
