"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetUsageLimit``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.get_usage_limit_response.GetUsageLimitResponse = capo_redshift_serverless.types.get_usage_limit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetUsageLimit"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.get_usage_limit_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_usage_limit(
