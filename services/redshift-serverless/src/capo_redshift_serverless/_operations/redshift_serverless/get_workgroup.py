"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetWorkgroup``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.get_workgroup_response.GetWorkgroupResponse = (
        capo_redshift_serverless.types.get_workgroup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetWorkgroup"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.get_workgroup_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
