...
def handle_response(
    ...
    out: capo_redshift_serverless.types.list_endpoint_access_response.ListEndpointAccessResponse = capo_redshift_serverless.types.list_endpoint_access_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.list_endpoint_access_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
