"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#ListScheduledActions``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.list_scheduled_actions_response.ListScheduledActionsResponse = capo_redshift_serverless.types.list_scheduled_actions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.ListScheduledActions"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.list_scheduled_actions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
