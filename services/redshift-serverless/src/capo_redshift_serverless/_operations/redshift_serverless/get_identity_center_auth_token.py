"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetIdentityCenterAuthToken``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.get_identity_center_auth_token_response.GetIdentityCenterAuthTokenResponse = capo_redshift_serverless.types.get_identity_center_auth_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.get_identity_center_auth_token_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
