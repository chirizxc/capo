"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#UpdateCustomDomainAssociation``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.update_custom_domain_association_response.UpdateCustomDomainAssociationResponse = capo_redshift_serverless.types.update_custom_domain_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.UpdateCustomDomainAssociation"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.update_custom_domain_association_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_custom_domain_association(
