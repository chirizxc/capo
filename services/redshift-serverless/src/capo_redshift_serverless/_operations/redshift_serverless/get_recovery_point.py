"""Generated from Smithy shape ``com.amazonaws.redshiftserverless#GetRecoveryPoint``."""
...
def handle_response(
    ...
    out: capo_redshift_serverless.types.get_recovery_point_response.GetRecoveryPointResponse = capo_redshift_serverless.types.get_recovery_point_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RedshiftServerless.GetRecoveryPoint"
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.get_recovery_point_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_recovery_point(
