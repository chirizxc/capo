...
def handle_response(
    ...
    out: capo_redshift_serverless.types.delete_usage_limit_response.DeleteUsageLimitResponse = capo_redshift_serverless.types.delete_usage_limit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_redshift_serverless.types.delete_usage_limit_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
