"""Generated from Smithy shape ``com.amazonaws.emrserverless#ResourceUtilization``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: ResourceUtilization) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ResourceUtilization:
