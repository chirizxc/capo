...
def handle_response(
    ...
    out: capo_cloud9.types.update_environment_result.UpdateEnvironmentResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloud9.types.update_environment_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_environment(
    ...
    capo_cloud9.types.update_environment_result.UpdateEnvironmentResult, zapros.Response
]:
