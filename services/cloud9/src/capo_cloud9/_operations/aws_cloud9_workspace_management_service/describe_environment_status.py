...
def handle_response(
    ...
    out: capo_cloud9.types.describe_environment_status_result.DescribeEnvironmentStatusResult = capo_cloud9.types.describe_environment_status_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloud9.types.describe_environment_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
