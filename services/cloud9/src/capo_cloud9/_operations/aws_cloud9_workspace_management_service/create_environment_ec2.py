"""Generated from Smithy shape ``com.amazonaws.cloud9#CreateEnvironmentEC2``."""
...
def handle_response(
    ...
    out: capo_cloud9.types.create_environment_ec2_result.CreateEnvironmentEC2Result = (
        capo_cloud9.types.create_environment_ec2_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloud9.types.create_environment_ec2_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_environment_ec2(
