"""Generated from Smithy shape ``com.amazonaws.marketplacedeployment#UntagResource``."""
...
def handle_response(
    ...
    out: capo_marketplace_deployment.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
