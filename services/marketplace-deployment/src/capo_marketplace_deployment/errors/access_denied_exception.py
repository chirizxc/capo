"""Generated from Smithy shape ``com.amazonaws.marketplacedeployment#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.marketplacedeployment#AccessDeniedException``."""
