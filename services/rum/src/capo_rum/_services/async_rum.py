...
from capo_rum._resources.rum.app_monitor_resource import AsyncAppMonitorResource
from capo_rum._services._aws_config import aaws_config
...
class AsyncRUMClient:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_rum.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_rum.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_rum._operations.rum.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def put_rum_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_rum.types.put_rum_events_request.PutRumEventsRequest]",
        ) -> AsyncOperationResponse[
            "capo_rum.types.put_rum_events_response.PutRumEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_rum._operations.rum.put_rum_events.async_put_rum_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_rum.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_rum.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_rum._operations.rum.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_rum.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_rum.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_rum._operations.rum.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
