"""Generated from Smithy shape ``com.amazonaws.rum#PutResourcePolicy``."""
...
import capo_rum.errors.malformed_policy_document_exception
import capo_rum.errors.policy_size_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MalformedPolicyDocumentException":
            raise capo_rum.errors.malformed_policy_document_exception.MalformedPolicyDocumentException.from_json(
                data, message
            )
        case "PolicySizeLimitExceededException":
            raise capo_rum.errors.policy_size_limit_exceeded_exception.PolicySizeLimitExceededException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_rum.types.put_resource_policy_response.PutResourcePolicyResponse = (
        capo_rum.types.put_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rum.types.put_resource_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
