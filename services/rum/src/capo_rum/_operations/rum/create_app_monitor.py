...
def handle_response(
    ...
    out: capo_rum.types.create_app_monitor_response.CreateAppMonitorResponse = (
        capo_rum.types.create_app_monitor_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rum.types.create_app_monitor_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_app_monitor(
    ...
    capo_rum.types.create_app_monitor_response.CreateAppMonitorResponse, zapros.Response
]:
