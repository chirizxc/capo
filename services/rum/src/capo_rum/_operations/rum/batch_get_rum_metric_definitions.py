...
def handle_response(
    ...
    out: capo_rum.types.batch_get_rum_metric_definitions_response.BatchGetRumMetricDefinitionsResponse = capo_rum.types.batch_get_rum_metric_definitions_response.deserialize_json(
