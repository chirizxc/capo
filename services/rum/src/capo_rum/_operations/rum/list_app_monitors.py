"""Generated from Smithy shape ``com.amazonaws.rum#ListAppMonitors``."""
...
def handle_response(
    ...
    out: capo_rum.types.list_app_monitors_response.ListAppMonitorsResponse = (
        capo_rum.types.list_app_monitors_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/appmonitors"
...
def list_app_monitors(
    ...
    capo_rum.types.list_app_monitors_response.ListAppMonitorsResponse, zapros.Response
]:
...
async def async_list_app_monitors(
