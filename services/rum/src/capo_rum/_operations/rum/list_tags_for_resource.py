"""Generated from Smithy shape ``com.amazonaws.rum#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_rum.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_rum.types.list_tags_for_resource_response.deserialize_json(
