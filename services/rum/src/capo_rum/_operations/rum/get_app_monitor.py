...
def handle_response(
    ...
    out: capo_rum.types.get_app_monitor_response.GetAppMonitorResponse = (
        capo_rum.types.get_app_monitor_response.deserialize_json(
...
def get_app_monitor(
    ...
    capo_rum.types.get_app_monitor_response.GetAppMonitorResponse, zapros.Response
]:
