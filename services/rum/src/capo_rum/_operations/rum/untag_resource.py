"""Generated from Smithy shape ``com.amazonaws.rum#UntagResource``."""
...
def handle_response(
    ...
    out: capo_rum.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_rum.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
