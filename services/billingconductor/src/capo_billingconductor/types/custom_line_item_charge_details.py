...
if TYPE_CHECKING:
    import capo_billingconductor.types.custom_line_item_flat_charge_details
    import capo_billingconductor.types.custom_line_item_percentage_charge_details
...
class CustomLineItemChargeDetails(TypedDict, closed=True):
    flat: NotRequired[
        "capo_billingconductor.types.custom_line_item_flat_charge_details.CustomLineItemFlatChargeDetails"
    ]
    ...
    percentage: NotRequired[
        "capo_billingconductor.types.custom_line_item_percentage_charge_details.CustomLineItemPercentageChargeDetails"
    ]
...
def serialize_json(value: CustomLineItemChargeDetails) -> dict:
    ...
    if "flat" in value:
        ...
        out["Flat"] = (
            capo_billingconductor.types.custom_line_item_flat_charge_details.serialize_json(
                value["flat"]
            )
        )
    if "percentage" in value:
        ...
        out["Percentage"] = (
            capo_billingconductor.types.custom_line_item_percentage_charge_details.serialize_json(
                value["percentage"]
            )
        )
    import capo_billingconductor.types.custom_line_item_type
...
def deserialize_json(data: dict) -> CustomLineItemChargeDetails:
    ...
    if data.get("Flat") is not None:
        ...
        out["flat"] = (
            capo_billingconductor.types.custom_line_item_flat_charge_details.deserialize_json(
                data["Flat"]
            )
        )
    if data.get("Percentage") is not None:
        ...
        out["percentage"] = (
            capo_billingconductor.types.custom_line_item_percentage_charge_details.deserialize_json(
                data["Percentage"]
            )
        )
