...
def serialize_json(value: ListAccountAssociationsInput) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            capo_billingconductor.types.list_account_associations_filter.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListAccountAssociationsInput:
    ...
    if data.get("Filters") is not None:
        ...
        out["filters"] = (
            capo_billingconductor.types.list_account_associations_filter.deserialize_json(
                data["Filters"]
            )
        )
