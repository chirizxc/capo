...
def handle_response(
    ...
    out: capo_billingconductor.types.list_pricing_rules_associated_to_pricing_plan_output.ListPricingRulesAssociatedToPricingPlanOutput = capo_billingconductor.types.list_pricing_rules_associated_to_pricing_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_pricing_rules_associated_to_pricing_plan_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
