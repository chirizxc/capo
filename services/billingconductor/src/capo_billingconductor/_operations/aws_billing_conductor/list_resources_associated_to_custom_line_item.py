...
def handle_response(
    ...
    out: capo_billingconductor.types.list_resources_associated_to_custom_line_item_output.ListResourcesAssociatedToCustomLineItemOutput = capo_billingconductor.types.list_resources_associated_to_custom_line_item_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_resources_associated_to_custom_line_item_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
