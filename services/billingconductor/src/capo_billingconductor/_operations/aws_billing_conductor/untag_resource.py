"""Generated from Smithy shape ``com.amazonaws.billingconductor#UntagResource``."""
...
def handle_response(
    ...
    out: capo_billingconductor.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
