...
def handle_response(
    ...
    out: capo_billingconductor.types.list_pricing_rules_output.ListPricingRulesOutput = capo_billingconductor.types.list_pricing_rules_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_pricing_rules_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
