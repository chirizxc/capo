...
def handle_response(
    ...
    out: capo_billingconductor.types.delete_pricing_plan_output.DeletePricingPlanOutput = capo_billingconductor.types.delete_pricing_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.delete_pricing_plan_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
