...
def handle_response(
    ...
    out: capo_billingconductor.types.list_pricing_plans_associated_with_pricing_rule_output.ListPricingPlansAssociatedWithPricingRuleOutput = capo_billingconductor.types.list_pricing_plans_associated_with_pricing_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_pricing_plans_associated_with_pricing_rule_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
