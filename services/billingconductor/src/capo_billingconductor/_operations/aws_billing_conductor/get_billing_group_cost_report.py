...
def handle_response(
    ...
    out: capo_billingconductor.types.get_billing_group_cost_report_output.GetBillingGroupCostReportOutput = capo_billingconductor.types.get_billing_group_cost_report_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.get_billing_group_cost_report_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
