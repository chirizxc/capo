...
def handle_response(
    ...
    out: capo_billingconductor.types.list_account_associations_output.ListAccountAssociationsOutput = capo_billingconductor.types.list_account_associations_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.list_account_associations_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
