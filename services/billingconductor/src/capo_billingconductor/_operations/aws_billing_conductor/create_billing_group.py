...
def handle_response(
    ...
    out: capo_billingconductor.types.create_billing_group_output.CreateBillingGroupOutput = capo_billingconductor.types.create_billing_group_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.create_billing_group_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
