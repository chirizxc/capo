...
def handle_response(
    ...
    out: capo_billingconductor.types.create_pricing_plan_output.CreatePricingPlanOutput = capo_billingconductor.types.create_pricing_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.create_pricing_plan_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
