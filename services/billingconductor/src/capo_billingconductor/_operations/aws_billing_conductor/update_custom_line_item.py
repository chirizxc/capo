...
def handle_response(
    ...
    out: capo_billingconductor.types.update_custom_line_item_output.UpdateCustomLineItemOutput = capo_billingconductor.types.update_custom_line_item_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billingconductor.types.update_custom_line_item_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
