...
class DescribeRuleGroupsNamespaceResponse(TypedDict, closed=True):
    rule_groups_namespace: "capo_amp.types.rule_groups_namespace_description.RuleGroupsNamespaceDescription"
...
def serialize_json(value: DescribeRuleGroupsNamespaceResponse) -> dict:
    ...
    out["ruleGroupsNamespace"] = (
        capo_amp.types.rule_groups_namespace_description.serialize_json(
...
def deserialize_json(data: dict) -> DescribeRuleGroupsNamespaceResponse:
    ...
    if data.get("ruleGroupsNamespace") is not None:
        ...
        out["rule_groups_namespace"] = (
            capo_amp.types.rule_groups_namespace_description.deserialize_json(
