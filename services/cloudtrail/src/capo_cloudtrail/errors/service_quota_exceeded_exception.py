"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudtrail#ServiceQuotaExceededException``."""
