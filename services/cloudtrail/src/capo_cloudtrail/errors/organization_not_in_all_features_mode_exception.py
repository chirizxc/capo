"""Generated from Smithy shape ``com.amazonaws.cloudtrail#OrganizationNotInAllFeaturesModeException``."""
...
class OrganizationNotInAllFeaturesModeException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudtrail#OrganizationNotInAllFeaturesModeException``."""
