...
class ListDashboardsResponse(TypedDict, closed=True):
    dashboards: NotRequired["capo_cloudtrail.types.dashboards.Dashboards"]
...
def serialize_aws_json_1_1(value: ListDashboardsResponse) -> dict:
    ...
    if "dashboards" in value:
        ...
        out["Dashboards"] = capo_cloudtrail.types.dashboards.serialize_aws_json_1_1(
            value["dashboards"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDashboardsResponse:
    ...
    if data.get("Dashboards") is not None:
        ...
        out["dashboards"] = capo_cloudtrail.types.dashboards.deserialize_aws_json_1_1(
            data["Dashboards"]
        )
