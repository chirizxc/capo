...
class Resource(TypedDict, closed=True):
    resource_type: NotRequired["capo_cloudtrail.types.string.String"]
    ...
    resource_name: NotRequired["capo_cloudtrail.types.string.String"]
    r"""<p>The name of the resource referenced by the event returned. These are user-created names whose values will depend on the environment. For example, the resource name might be \"auto-scaling-test-group\" for an Auto Scaling Group or \"i-1234567\" for an EC2 Instance.</p>"""
