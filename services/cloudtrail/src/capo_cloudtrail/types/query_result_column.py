...
if TYPE_CHECKING:
    import capo_cloudtrail.types.query_result_key
    import capo_cloudtrail.types.query_result_value

QueryResultColumn: TypeAlias = dict[
    "capo_cloudtrail.types.query_result_key.QueryResultKey",
    "capo_cloudtrail.types.query_result_value.QueryResultValue",
]
