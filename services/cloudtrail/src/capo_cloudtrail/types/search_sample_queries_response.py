...
class SearchSampleQueriesResponse(TypedDict, closed=True):
    search_results: NotRequired[
        "capo_cloudtrail.types.search_sample_queries_search_results.SearchSampleQueriesSearchResults"
    ]
...
def serialize_aws_json_1_1(value: SearchSampleQueriesResponse) -> dict:
    ...
    if "search_results" in value:
        ...
        out["SearchResults"] = (
            capo_cloudtrail.types.search_sample_queries_search_results.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SearchSampleQueriesResponse:
    ...
    if data.get("SearchResults") is not None:
        ...
        out["search_results"] = (
            capo_cloudtrail.types.search_sample_queries_search_results.deserialize_aws_json_1_1(
                data["SearchResults"]
            )
        )
