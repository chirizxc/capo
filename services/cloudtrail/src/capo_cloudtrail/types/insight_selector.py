...
class InsightSelector(TypedDict, closed=True):
    ...
    event_categories: NotRequired[
        "capo_cloudtrail.types.source_event_categories.SourceEventCategories"
    ]
...
def serialize_aws_json_1_1(value: InsightSelector) -> dict:
    ...
    if "event_categories" in value:
        ...
        out["EventCategories"] = (
            capo_cloudtrail.types.source_event_categories.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InsightSelector:
    ...
    if data.get("EventCategories") is not None:
        ...
        out["event_categories"] = (
            capo_cloudtrail.types.source_event_categories.deserialize_aws_json_1_1(
