...
class LookupEventsRequest(TypedDict, closed=True):
    ...
    event_category: NotRequired["capo_cloudtrail.types.event_category.EventCategory"]
    ...
    max_results: NotRequired["capo_cloudtrail.types.max_results.MaxResults"]
    """<p>The number of events to return. Possible values are 1 through 50. The default is 50.</p>"""
    next_token: NotRequired["capo_cloudtrail.types.next_token.NextToken"]
...
def serialize_aws_json_1_1(value: LookupEventsRequest) -> dict:
    ...
    if "lookup_attributes" in value:
        ...
        out["LookupAttributes"] = (
            capo_cloudtrail.types.lookup_attributes_list.serialize_aws_json_1_1(
    ...
    if "event_category" in value:
        ...
        out["EventCategory"] = (
            capo_cloudtrail.types.event_category.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LookupEventsRequest:
    ...
    if data.get("LookupAttributes") is not None:
        ...
        out["lookup_attributes"] = (
            capo_cloudtrail.types.lookup_attributes_list.deserialize_aws_json_1_1(
    ...
    if data.get("EventCategory") is not None:
        ...
        out["event_category"] = (
            capo_cloudtrail.types.event_category.deserialize_aws_json_1_1(
                data["EventCategory"]
            )
        )
