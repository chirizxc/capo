...
class ListImportFailuresResponse(TypedDict, closed=True):
    failures: NotRequired["capo_cloudtrail.types.import_failure_list.ImportFailureList"]
...
def serialize_aws_json_1_1(value: ListImportFailuresResponse) -> dict:
    ...
    if "failures" in value:
        ...
        out["Failures"] = (
            capo_cloudtrail.types.import_failure_list.serialize_aws_json_1_1(
                value["failures"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListImportFailuresResponse:
    ...
    if data.get("Failures") is not None:
        ...
        out["failures"] = (
            capo_cloudtrail.types.import_failure_list.deserialize_aws_json_1_1(
                data["Failures"]
            )
        )
