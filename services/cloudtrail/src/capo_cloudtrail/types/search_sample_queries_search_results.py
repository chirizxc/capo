...
if TYPE_CHECKING:
    import capo_cloudtrail.types.search_sample_queries_search_result

SearchSampleQueriesSearchResults: TypeAlias = list[
    "capo_cloudtrail.types.search_sample_queries_search_result.SearchSampleQueriesSearchResult"
]
...
def serialize_aws_json_1_1(value: SearchSampleQueriesSearchResults) -> list:
    ...
    for item in value:
        out.append(
            capo_cloudtrail.types.search_sample_queries_search_result.serialize_aws_json_1_1(
                item
            )
        )
    return out
