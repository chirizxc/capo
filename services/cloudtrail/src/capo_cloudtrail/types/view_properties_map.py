...
if TYPE_CHECKING:
    import capo_cloudtrail.types.view_properties_key
    import capo_cloudtrail.types.view_properties_value

ViewPropertiesMap: TypeAlias = dict[
    "capo_cloudtrail.types.view_properties_key.ViewPropertiesKey",
    "capo_cloudtrail.types.view_properties_value.ViewPropertiesValue",
]
