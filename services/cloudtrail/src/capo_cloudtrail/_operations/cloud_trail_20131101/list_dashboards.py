"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ListDashboards``."""
...
import capo_cloudtrail.types.dashboards
...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_dashboards_response.ListDashboardsResponse = (
        capo_cloudtrail.types.list_dashboards_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.ListDashboards"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_dashboards_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
