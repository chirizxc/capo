"""Generated from Smithy shape ``com.amazonaws.cloudtrail#StopEventDataStoreIngestion``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.stop_event_data_store_ingestion_response.StopEventDataStoreIngestionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.StopEventDataStoreIngestion"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.stop_event_data_store_ingestion_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_event_data_store_ingestion(
