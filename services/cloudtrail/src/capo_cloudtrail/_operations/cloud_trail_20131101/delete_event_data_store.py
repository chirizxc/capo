...
import capo_cloudtrail.errors.channel_exists_for_eds_exception
...
import capo_cloudtrail.errors.event_data_store_has_ongoing_import_exception
import capo_cloudtrail.errors.event_data_store_not_found_exception
import capo_cloudtrail.errors.event_data_store_termination_protected_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ChannelExistsForEDSException":
            raise capo_cloudtrail.errors.channel_exists_for_eds_exception.ChannelExistsForEDSException.from_aws_json_1_1(
                data, message
            )
        ...
        case "EventDataStoreTerminationProtectedException":
            raise capo_cloudtrail.errors.event_data_store_termination_protected_exception.EventDataStoreTerminationProtectedException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.delete_event_data_store_response.DeleteEventDataStoreResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.delete_event_data_store_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
