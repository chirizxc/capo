"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GetEventDataStore``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.get_event_data_store_response.GetEventDataStoreResponse = capo_cloudtrail.types.get_event_data_store_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.GetEventDataStore"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.get_event_data_store_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_event_data_store(
