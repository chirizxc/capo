...
def handle_response(
    ...
    out: capo_cloudtrail.types.get_trail_response.GetTrailResponse = (
        capo_cloudtrail.types.get_trail_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_cloudtrail.types.get_trail_request.GetTrailRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.get_trail_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_trail(
    ...
    input_: capo_cloudtrail.types.get_trail_request.GetTrailRequest,
) -> tuple[capo_cloudtrail.types.get_trail_response.GetTrailResponse, zapros.Response]:
