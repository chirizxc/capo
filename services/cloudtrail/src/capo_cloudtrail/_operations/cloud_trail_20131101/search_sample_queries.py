"""Generated from Smithy shape ``com.amazonaws.cloudtrail#SearchSampleQueries``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.search_sample_queries_response.SearchSampleQueriesResponse = capo_cloudtrail.types.search_sample_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.SearchSampleQueries"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.search_sample_queries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_search_sample_queries(
