...
import capo_cloudtrail.errors.invalid_event_category_exception
import capo_cloudtrail.errors.invalid_lookup_attributes_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidEventCategoryException":
            raise capo_cloudtrail.errors.invalid_event_category_exception.InvalidEventCategoryException.from_aws_json_1_1(
                data, message
            )
        case "InvalidLookupAttributesException":
            raise capo_cloudtrail.errors.invalid_lookup_attributes_exception.InvalidLookupAttributesException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.lookup_events_response.LookupEventsResponse = (
        capo_cloudtrail.types.lookup_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.lookup_events_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def lookup_events(
    ...
    capo_cloudtrail.types.lookup_events_response.LookupEventsResponse, zapros.Response
]:
