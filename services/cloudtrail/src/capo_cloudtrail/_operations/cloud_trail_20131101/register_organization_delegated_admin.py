...
import capo_cloudtrail.errors.account_registered_exception
import capo_cloudtrail.errors.cannot_delegate_management_account_exception
import capo_cloudtrail.errors.cloud_trail_access_not_enabled_exception
import capo_cloudtrail.errors.conflict_exception
import capo_cloudtrail.errors.delegated_admin_account_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountRegisteredException":
            raise capo_cloudtrail.errors.account_registered_exception.AccountRegisteredException.from_aws_json_1_1(
                data, message
            )
        case "CannotDelegateManagementAccountException":
            raise capo_cloudtrail.errors.cannot_delegate_management_account_exception.CannotDelegateManagementAccountException.from_aws_json_1_1(
                data, message
            )
        ...
        case "DelegatedAdminAccountLimitExceededException":
            raise capo_cloudtrail.errors.delegated_admin_account_limit_exceeded_exception.DelegatedAdminAccountLimitExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.register_organization_delegated_admin_response.RegisterOrganizationDelegatedAdminResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.register_organization_delegated_admin_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
