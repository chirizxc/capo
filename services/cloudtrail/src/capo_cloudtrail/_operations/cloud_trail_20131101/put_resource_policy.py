...
import capo_cloudtrail.errors.resource_policy_not_valid_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourcePolicyNotValidException":
            raise capo_cloudtrail.errors.resource_policy_not_valid_exception.ResourcePolicyNotValidException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.put_resource_policy_response.PutResourcePolicyResponse = capo_cloudtrail.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.put_resource_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
