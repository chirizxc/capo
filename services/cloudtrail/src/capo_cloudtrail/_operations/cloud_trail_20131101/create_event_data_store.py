...
def handle_response(
    ...
    out: capo_cloudtrail.types.create_event_data_store_response.CreateEventDataStoreResponse = capo_cloudtrail.types.create_event_data_store_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.create_event_data_store_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
