...
def handle_response(
    ...
    out: capo_cloudtrail.types.put_event_selectors_response.PutEventSelectorsResponse = capo_cloudtrail.types.put_event_selectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.put_event_selectors_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
