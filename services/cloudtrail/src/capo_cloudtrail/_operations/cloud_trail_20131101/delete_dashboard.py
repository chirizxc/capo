"""Generated from Smithy shape ``com.amazonaws.cloudtrail#DeleteDashboard``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.delete_dashboard_response.DeleteDashboardResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.DeleteDashboard"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.delete_dashboard_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
