...
def handle_response(
    ...
    out: capo_cloudtrail.types.get_channel_response.GetChannelResponse = (
        capo_cloudtrail.types.get_channel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.get_channel_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_channel(
    ...
    capo_cloudtrail.types.get_channel_response.GetChannelResponse, zapros.Response
]:
