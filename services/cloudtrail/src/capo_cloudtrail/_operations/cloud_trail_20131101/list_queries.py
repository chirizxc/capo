"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ListQueries``."""
...
import capo_cloudtrail.errors.invalid_date_range_exception
...
import capo_cloudtrail.errors.invalid_query_status_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDateRangeException":
            raise capo_cloudtrail.errors.invalid_date_range_exception.InvalidDateRangeException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidQueryStatusException":
            raise capo_cloudtrail.errors.invalid_query_status_exception.InvalidQueryStatusException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_queries_response.ListQueriesResponse = (
        capo_cloudtrail.types.list_queries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.ListQueries"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_queries_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_queries(
    ...
    capo_cloudtrail.types.list_queries_response.ListQueriesResponse, zapros.Response
]:
