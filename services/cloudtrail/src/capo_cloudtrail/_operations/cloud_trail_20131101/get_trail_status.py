"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GetTrailStatus``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.get_trail_status_response.GetTrailStatusResponse = (
        capo_cloudtrail.types.get_trail_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.get_trail_status_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_trail_status(
