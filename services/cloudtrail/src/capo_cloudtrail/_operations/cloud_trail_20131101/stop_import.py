"""Generated from Smithy shape ``com.amazonaws.cloudtrail#StopImport``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.stop_import_response.StopImportResponse = (
        capo_cloudtrail.types.stop_import_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.StopImport"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.stop_import_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def stop_import(
    ...
    capo_cloudtrail.types.stop_import_response.StopImportResponse, zapros.Response
]:
