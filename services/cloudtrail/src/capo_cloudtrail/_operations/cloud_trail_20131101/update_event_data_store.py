...
def handle_response(
    ...
    out: capo_cloudtrail.types.update_event_data_store_response.UpdateEventDataStoreResponse = capo_cloudtrail.types.update_event_data_store_response.deserialize_aws_json_1_1(
