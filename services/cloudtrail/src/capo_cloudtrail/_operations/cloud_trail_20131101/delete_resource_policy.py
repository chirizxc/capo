"""Generated from Smithy shape ``com.amazonaws.cloudtrail#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.DeleteResourcePolicy"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.delete_resource_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
