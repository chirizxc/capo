"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ListImportFailures``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_import_failures_response.ListImportFailuresResponse = capo_cloudtrail.types.list_import_failures_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.ListImportFailures"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_import_failures_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_import_failures(
