"""Generated from Smithy shape ``com.amazonaws.cloudtrail#StopLogging``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.stop_logging_response.StopLoggingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.stop_logging_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def stop_logging(
    ...
    capo_cloudtrail.types.stop_logging_response.StopLoggingResponse, zapros.Response
]:
