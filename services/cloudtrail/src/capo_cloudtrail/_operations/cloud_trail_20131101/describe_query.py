"""Generated from Smithy shape ``com.amazonaws.cloudtrail#DescribeQuery``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.describe_query_response.DescribeQueryResponse = (
        capo_cloudtrail.types.describe_query_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.DescribeQuery"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.describe_query_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_query(
    ...
    capo_cloudtrail.types.describe_query_response.DescribeQueryResponse, zapros.Response
]:
...
async def async_describe_query(
