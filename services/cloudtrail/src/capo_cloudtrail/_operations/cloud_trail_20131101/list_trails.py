"""Generated from Smithy shape ``com.amazonaws.cloudtrail#ListTrails``."""
...
def handle_response(
    ...
    out: capo_cloudtrail.types.list_trails_response.ListTrailsResponse = (
        capo_cloudtrail.types.list_trails_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.list_trails_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_trails(
    ...
    capo_cloudtrail.types.list_trails_response.ListTrailsResponse, zapros.Response
]:
