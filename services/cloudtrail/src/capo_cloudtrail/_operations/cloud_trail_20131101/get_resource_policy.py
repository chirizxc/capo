"""Generated from Smithy shape ``com.amazonaws.cloudtrail#GetResourcePolicy``."""
...
import capo_cloudtrail.errors.resource_arn_not_valid_exception
import capo_cloudtrail.errors.resource_not_found_exception
import capo_cloudtrail.errors.resource_policy_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceARNNotValidException":
            raise capo_cloudtrail.errors.resource_arn_not_valid_exception.ResourceARNNotValidException.from_aws_json_1_1(
                data, message
            )
        ...
        case "ResourcePolicyNotFoundException":
            raise capo_cloudtrail.errors.resource_policy_not_found_exception.ResourcePolicyNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cloudtrail.types.get_resource_policy_response.GetResourcePolicyResponse = capo_cloudtrail.types.get_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CloudTrail_20131101.GetResourcePolicy"
    body: bytes | None = json.dumps(
        capo_cloudtrail.types.get_resource_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
