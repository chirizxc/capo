...
from capo_mediaconnect._resources.media_connect.bridge_resource import (
    AsyncBridgeResource,
)
...
from capo_mediaconnect._resources.media_connect.flow_resource import AsyncFlowResource
...
from capo_mediaconnect._resources.media_connect.gateway_resource import (
...
from capo_mediaconnect._services._aws_config import aaws_config
...
class AsyncMediaConnectClientConfig(TypedDict, total=False, closed=True):
...
class AsyncMediaConnectClient:
    ...
    async def list_entitlements(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediaconnect.types.list_entitlements_request.ListEntitlementsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediaconnect.types.list_entitlements_response.ListEntitlementsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediaconnect._operations.media_connect.list_entitlements.async_list_entitlements(
    ...
    async def iter_list_entitlements(
        ...
        *,
        ...
        max_results: Optional["capo_mediaconnect.types.max_results.MaxResults"] = None,
        next_token: Optional[str] = None,
    ) -> "AsyncIterator[capo_mediaconnect.types.listed_entitlement.ListedEntitlement]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_global_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediaconnect.types.list_tags_for_global_resource_request.ListTagsForGlobalResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediaconnect.types.list_tags_for_global_resource_response.ListTagsForGlobalResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediaconnect._operations.media_connect.list_tags_for_global_resource.async_list_tags_for_global_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediaconnect.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediaconnect.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediaconnect._operations.media_connect.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_global_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediaconnect.types.tag_global_resource_request.TagGlobalResourceRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_mediaconnect._operations.media_connect.tag_global_resource.async_tag_global_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediaconnect.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediaconnect._operations.media_connect.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_global_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediaconnect.types.untag_global_resource_request.UntagGlobalResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediaconnect._operations.media_connect.untag_global_resource.async_untag_global_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediaconnect.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediaconnect._operations.media_connect.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
