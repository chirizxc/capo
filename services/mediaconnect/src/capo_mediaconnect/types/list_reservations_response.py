...
class ListReservationsResponse(TypedDict, closed=True):
    ...
    reservations: NotRequired[
        "capo_mediaconnect.types.__list_of_reservation.__listOfReservation"
    ]
...
def serialize_json(value: ListReservationsResponse) -> dict:
    ...
    if "reservations" in value:
        ...
        out["reservations"] = (
            capo_mediaconnect.types.__list_of_reservation.serialize_json(
                value["reservations"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ListReservationsResponse:
    ...
    if data.get("reservations") is not None:
        import capo_mediaconnect.types.__list_of_reservation

        out["reservations"] = (
            capo_mediaconnect.types.__list_of_reservation.deserialize_json(
                data["reservations"]
            )
        )
    return out
