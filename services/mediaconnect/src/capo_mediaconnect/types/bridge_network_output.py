"""Generated from Smithy shape ``com.amazonaws.mediaconnect#BridgeNetworkOutput``."""
...
class BridgeNetworkOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: BridgeNetworkOutput) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> BridgeNetworkOutput:
    out: BridgeNetworkOutput = {}  # type: ignore[typeddict-item]
