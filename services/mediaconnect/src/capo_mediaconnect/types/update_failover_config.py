...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateFailoverConfig) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateFailoverConfig:
    out: UpdateFailoverConfig = {}  # type: ignore[typeddict-item]
