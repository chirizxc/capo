...
class Reservation(TypedDict, closed=True):
    ...
    reservation_state: NotRequired[
        "capo_mediaconnect.types.reservation_state.ReservationState"
    ]
...
def serialize_json(value: Reservation) -> dict:
    ...
    if "reservation_state" in value:
        ...
        out["reservationState"] = (
            capo_mediaconnect.types.reservation_state.serialize_json(
...
def deserialize_json(data: dict) -> Reservation:
    ...
    if data.get("reservationState") is not None:
        ...
        out["reservation_state"] = (
            capo_mediaconnect.types.reservation_state.deserialize_json(
