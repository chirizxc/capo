...
if TYPE_CHECKING:
    import capo_mediaconnect.types.__list_of_media_stream_source_configuration
    import capo_mediaconnect.types.encryption
    import capo_mediaconnect.types.flow_transit_encryption
    import capo_mediaconnect.types.gateway_bridge_source
...
class Source(TypedDict, closed=True):
    ...
    media_stream_source_configurations: NotRequired[
        "capo_mediaconnect.types.__list_of_media_stream_source_configuration.__listOfMediaStreamSourceConfiguration"
    ]
    ...
    gateway_bridge_source: NotRequired[
        "capo_mediaconnect.types.gateway_bridge_source.GatewayBridgeSource"
    ]
...
def serialize_json(value: Source) -> dict:
    ...
    if "media_stream_source_configurations" in value:
        ...
        out["mediaStreamSourceConfigurations"] = (
            capo_mediaconnect.types.__list_of_media_stream_source_configuration.serialize_json(
    ...
    if "gateway_bridge_source" in value:
        ...
        out["gatewayBridgeSource"] = (
            capo_mediaconnect.types.gateway_bridge_source.serialize_json(
...
def deserialize_json(data: dict) -> Source:
    ...
    if data.get("ingestIp") is not None:
    ...
    if data.get("mediaStreamSourceConfigurations") is not None:
        ...
        out["media_stream_source_configurations"] = (
            capo_mediaconnect.types.__list_of_media_stream_source_configuration.deserialize_json(
    ...
    if data.get("gatewayBridgeSource") is not None:
        ...
        out["gateway_bridge_source"] = (
            capo_mediaconnect.types.gateway_bridge_source.deserialize_json(
    ...
    if data.get("connectedRouterOutputArn") is not None:
