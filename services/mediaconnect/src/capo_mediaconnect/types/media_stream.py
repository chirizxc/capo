...
class MediaStream(TypedDict, closed=True):
    attributes: NotRequired[
        "capo_mediaconnect.types.media_stream_attributes.MediaStreamAttributes"
    ]
...
def serialize_json(value: MediaStream) -> dict:
    ...
    if "attributes" in value:
        ...
        out["attributes"] = (
            capo_mediaconnect.types.media_stream_attributes.serialize_json(
                value["attributes"]
            )
        )
...
def deserialize_json(data: dict) -> MediaStream:
    ...
    if data.get("attributes") is not None:
        ...
        out["attributes"] = (
            capo_mediaconnect.types.media_stream_attributes.deserialize_json(
                data["attributes"]
            )
        )
