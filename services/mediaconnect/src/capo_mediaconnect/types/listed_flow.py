...
class ListedFlow(TypedDict, closed=True):
    ...
    source_type: NotRequired["capo_mediaconnect.types.source_type.SourceType"]
    ...
    maintenance: NotRequired["capo_mediaconnect.types.maintenance.Maintenance"]
...
def serialize_json(value: ListedFlow) -> dict:
    ...
    if "source_type" in value:
        ...
        out["sourceType"] = capo_mediaconnect.types.source_type.serialize_json(
            value["source_type"]
        )
    if "status" in value:
        import capo_mediaconnect.types.status
    ...
    if "maintenance" in value:
        ...
        out["maintenance"] = capo_mediaconnect.types.maintenance.serialize_json(
            value["maintenance"]
        )
    return out
