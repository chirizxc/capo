...
if TYPE_CHECKING:
    ...
    import capo_mediaconnect.types.router_output_protocol
    import capo_mediaconnect.types.router_output_protocol_configuration


class StandardRouterOutputConfiguration(TypedDict, closed=True):
    ...
    protocol_configuration: "capo_mediaconnect.types.router_output_protocol_configuration.RouterOutputProtocolConfiguration"
    """<p>The configuration settings for the protocol used by the standard router output.</p>"""
    protocol: NotRequired[
        "capo_mediaconnect.types.router_output_protocol.RouterOutputProtocol"
    ]
...
def serialize_json(value: StandardRouterOutputConfiguration) -> dict:
    ...
    out["protocolConfiguration"] = (
        capo_mediaconnect.types.router_output_protocol_configuration.serialize_json(
    ...
    if "protocol" in value:
        ...
        out["protocol"] = capo_mediaconnect.types.router_output_protocol.serialize_json(
            value["protocol"]
        )
    return out
...
def deserialize_json(data: dict) -> StandardRouterOutputConfiguration:
    ...
    if data.get("protocolConfiguration") is not None:
        ...
        out["protocol_configuration"] = (
            capo_mediaconnect.types.router_output_protocol_configuration.deserialize_json(
    ...
    if data.get("protocol") is not None:
        ...
        out["protocol"] = (
            capo_mediaconnect.types.router_output_protocol.deserialize_json(
                data["protocol"]
            )
        )
    return out
