...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_bridge_state_response.UpdateBridgeStateResponse = capo_mediaconnect.types.update_bridge_state_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_bridge_state_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
