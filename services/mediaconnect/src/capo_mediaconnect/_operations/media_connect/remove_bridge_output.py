...
def handle_response(
    ...
    out: capo_mediaconnect.types.remove_bridge_output_response.RemoveBridgeOutputResponse = capo_mediaconnect.types.remove_bridge_output_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{OutputName}", quote(input_["output_name"], safe=""))
