"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListOfferings``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_offerings_response.ListOfferingsResponse = (
        capo_mediaconnect.types.list_offerings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/offerings"
