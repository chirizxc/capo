"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DescribeFlowSourceThumbnail``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.describe_flow_source_thumbnail_response.DescribeFlowSourceThumbnailResponse = capo_mediaconnect.types.describe_flow_source_thumbnail_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/flows/{FlowArn}/source-thumbnail"
...
async def async_describe_flow_source_thumbnail(
