"""Generated from Smithy shape ``com.amazonaws.mediaconnect#RemoveFlowOutput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.remove_flow_output_response.RemoveFlowOutputResponse = capo_mediaconnect.types.remove_flow_output_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{OutputArn}", quote(input_["output_arn"], safe=""))
...
async def async_remove_flow_output(
