"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_mediaconnect.types.list_tags_for_resource_response.deserialize_json(
