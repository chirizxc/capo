...
def handle_response(
    ...
    out: capo_mediaconnect.types.get_router_input_source_metadata_response.GetRouterInputSourceMetadataResponse = capo_mediaconnect.types.get_router_input_source_metadata_response.deserialize_json(
