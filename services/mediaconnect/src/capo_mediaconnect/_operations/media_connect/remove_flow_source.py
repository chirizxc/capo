...
def handle_response(
    ...
    out: capo_mediaconnect.types.remove_flow_source_response.RemoveFlowSourceResponse = capo_mediaconnect.types.remove_flow_source_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{SourceArn}", quote(input_["source_arn"], safe=""))
