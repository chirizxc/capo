"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DeleteBridge``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.delete_bridge_response.DeleteBridgeResponse = (
        capo_mediaconnect.types.delete_bridge_response.deserialize_json(
...
def delete_bridge(
    ...
    capo_mediaconnect.types.delete_bridge_response.DeleteBridgeResponse, zapros.Response
]:
