...
import capo_mediaconnect.errors.add_flow_outputs420_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AddFlowOutputs420Exception":
            raise capo_mediaconnect.errors.add_flow_outputs420_exception.AddFlowOutputs420Exception.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_mediaconnect.types.add_flow_outputs_response.AddFlowOutputsResponse = (
        capo_mediaconnect.types.add_flow_outputs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.add_flow_outputs_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
