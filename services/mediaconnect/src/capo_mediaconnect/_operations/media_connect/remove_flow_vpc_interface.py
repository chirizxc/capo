...
def handle_response(
    ...
    out: capo_mediaconnect.types.remove_flow_vpc_interface_response.RemoveFlowVpcInterfaceResponse = capo_mediaconnect.types.remove_flow_vpc_interface_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{VpcInterfaceName}", quote(input_["vpc_interface_name"], safe="")
    )
