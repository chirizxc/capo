...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_router_output_response.UpdateRouterOutputResponse = capo_mediaconnect.types.update_router_output_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_router_output_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
