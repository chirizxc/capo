"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DeleteRouterOutput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.delete_router_output_response.DeleteRouterOutputResponse = capo_mediaconnect.types.delete_router_output_response.deserialize_json(
...
async def async_delete_router_output(
