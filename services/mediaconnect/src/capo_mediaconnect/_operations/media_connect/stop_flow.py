"""Generated from Smithy shape ``com.amazonaws.mediaconnect#StopFlow``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.stop_flow_response.StopFlowResponse = (
        capo_mediaconnect.types.stop_flow_response.deserialize_json(
...
def stop_flow(
    ...
    capo_mediaconnect.types.stop_flow_response.StopFlowResponse, zapros.Response
]:
