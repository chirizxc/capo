...
def handle_response(
    ...
    out: capo_mediaconnect.types.add_flow_vpc_interfaces_response.AddFlowVpcInterfacesResponse = capo_mediaconnect.types.add_flow_vpc_interfaces_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.add_flow_vpc_interfaces_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
