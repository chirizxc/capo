"""Generated from Smithy shape ``com.amazonaws.mediaconnect#StartFlow``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.start_flow_response.StartFlowResponse = (
        capo_mediaconnect.types.start_flow_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/flows/start/{FlowArn}"
...
def start_flow(
    ...
    capo_mediaconnect.types.start_flow_response.StartFlowResponse, zapros.Response
]:
