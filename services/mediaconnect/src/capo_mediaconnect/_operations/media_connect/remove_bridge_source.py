...
def handle_response(
    ...
    out: capo_mediaconnect.types.remove_bridge_source_response.RemoveBridgeSourceResponse = capo_mediaconnect.types.remove_bridge_source_response.deserialize_json(
