...
def handle_response(
    ...
    out: capo_mediaconnect.types.deregister_gateway_instance_response.DeregisterGatewayInstanceResponse = capo_mediaconnect.types.deregister_gateway_instance_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{GatewayInstanceArn}", quote(input_["gateway_instance_arn"], safe="")
    )
