...
def handle_response(
    ...
    out: capo_mediaconnect.types.revoke_flow_entitlement_response.RevokeFlowEntitlementResponse = capo_mediaconnect.types.revoke_flow_entitlement_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{EntitlementArn}", quote(input_["entitlement_arn"], safe=""))
