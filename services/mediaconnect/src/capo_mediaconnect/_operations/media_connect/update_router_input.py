"""Generated from Smithy shape ``com.amazonaws.mediaconnect#UpdateRouterInput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.update_router_input_response.UpdateRouterInputResponse = capo_mediaconnect.types.update_router_input_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.update_router_input_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_router_input(
