...
def handle_response(
    ...
    out: capo_mediaconnect.types.describe_gateway_response.DescribeGatewayResponse = (
        capo_mediaconnect.types.describe_gateway_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{GatewayArn}", quote(input_["gateway_arn"], safe=""))
