"""Generated from Smithy shape ``com.amazonaws.mediaconnect#BatchGetRouterInput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.batch_get_router_input_response.BatchGetRouterInputResponse = capo_mediaconnect.types.batch_get_router_input_response.deserialize_json(
...
def build_request(
    ...
    for item in input_["arns"]:
        params.append(("arns", item))
...
async def async_batch_get_router_input(
