...
def handle_response(
    ...
    out: capo_mediaconnect.types.add_bridge_outputs_response.AddBridgeOutputsResponse = capo_mediaconnect.types.add_bridge_outputs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.add_bridge_outputs_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
