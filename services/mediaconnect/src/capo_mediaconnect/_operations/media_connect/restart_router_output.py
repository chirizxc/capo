"""Generated from Smithy shape ``com.amazonaws.mediaconnect#RestartRouterOutput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.restart_router_output_response.RestartRouterOutputResponse = capo_mediaconnect.types.restart_router_output_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerOutput/restart/{Arn}"
...
async def async_restart_router_output(
