...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_tags_for_global_resource_response.ListTagsForGlobalResourceResponse = capo_mediaconnect.types.list_tags_for_global_resource_response.deserialize_json(
