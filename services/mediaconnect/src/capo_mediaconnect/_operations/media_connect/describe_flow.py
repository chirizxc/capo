"""Generated from Smithy shape ``com.amazonaws.mediaconnect#DescribeFlow``."""
...
import capo_mediaconnect.types.messages
...
def handle_response(
    ...
    out: capo_mediaconnect.types.describe_flow_response.DescribeFlowResponse = (
        capo_mediaconnect.types.describe_flow_response.deserialize_json(
...
def describe_flow(
    ...
    capo_mediaconnect.types.describe_flow_response.DescribeFlowResponse, zapros.Response
]:
