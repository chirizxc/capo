"""Generated from Smithy shape ``com.amazonaws.mediaconnect#GetRouterNetworkInterface``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.get_router_network_interface_response.GetRouterNetworkInterfaceResponse = capo_mediaconnect.types.get_router_network_interface_response.deserialize_json(
...
async def async_get_router_network_interface(
