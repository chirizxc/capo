"""Generated from Smithy shape ``com.amazonaws.mediaconnect#RestartRouterInput``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.restart_router_input_response.RestartRouterInputResponse = capo_mediaconnect.types.restart_router_input_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/routerInput/restart/{Arn}"
...
async def async_restart_router_input(
