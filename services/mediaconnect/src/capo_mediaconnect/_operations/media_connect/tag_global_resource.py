"""Generated from Smithy shape ``com.amazonaws.mediaconnect#TagGlobalResource``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.tag_global_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_tag_global_resource(
