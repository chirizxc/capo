...
import capo_mediaconnect.errors.create_flow420_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CreateFlow420Exception":
            raise capo_mediaconnect.errors.create_flow420_exception.CreateFlow420Exception.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_mediaconnect.types.create_flow_response.CreateFlowResponse = (
        capo_mediaconnect.types.create_flow_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.create_flow_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_flow(
    ...
    capo_mediaconnect.types.create_flow_response.CreateFlowResponse, zapros.Response
]:
