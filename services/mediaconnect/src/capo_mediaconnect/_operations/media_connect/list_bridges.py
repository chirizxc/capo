"""Generated from Smithy shape ``com.amazonaws.mediaconnect#ListBridges``."""
...
def handle_response(
    ...
    out: capo_mediaconnect.types.list_bridges_response.ListBridgesResponse = (
        capo_mediaconnect.types.list_bridges_response.deserialize_json(
...
def build_request(
    ...
    if "filter_arn" in input_:
        params.append(("filterArn", input_["filter_arn"]))
...
def list_bridges(
    ...
    capo_mediaconnect.types.list_bridges_response.ListBridgesResponse, zapros.Response
]:
