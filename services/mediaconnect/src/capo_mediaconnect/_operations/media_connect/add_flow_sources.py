...
def handle_response(
    ...
    out: capo_mediaconnect.types.add_flow_sources_response.AddFlowSourcesResponse = (
        capo_mediaconnect.types.add_flow_sources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediaconnect.types.add_flow_sources_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
