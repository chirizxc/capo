"""Generated from Smithy shape ``com.amazonaws.mediaconnect#BadRequestException``."""
...
class BadRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediaconnect#BadRequestException``."""
