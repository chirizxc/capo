...
class Dataset(TypedDict, closed=True):
    ...
    dataset_type: NotRequired["capo_personalize.types.dataset_type.DatasetType"]
    ...
    latest_dataset_update: NotRequired[
        "capo_personalize.types.dataset_update_summary.DatasetUpdateSummary"
    ]
...
def serialize_aws_json_1_1(value: Dataset) -> dict:
    ...
    if "latest_dataset_update" in value:
        ...
        out["latestDatasetUpdate"] = (
            capo_personalize.types.dataset_update_summary.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Dataset:
    ...
    if data.get("latestDatasetUpdate") is not None:
        ...
        out["latest_dataset_update"] = (
            capo_personalize.types.dataset_update_summary.deserialize_aws_json_1_1(
