...
if TYPE_CHECKING:
    ...
    import capo_personalize.types.description
    import capo_personalize.types.name
    import capo_personalize.types.recipe_type
...
class Recipe(TypedDict, closed=True):
    ...
    description: NotRequired["capo_personalize.types.description.Description"]
    ...
    recipe_type: NotRequired["capo_personalize.types.recipe_type.RecipeType"]
