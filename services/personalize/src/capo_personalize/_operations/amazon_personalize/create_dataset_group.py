"""Generated from Smithy shape ``com.amazonaws.personalize#CreateDatasetGroup``."""
...
def handle_response(
    ...
    out: capo_personalize.types.create_dataset_group_response.CreateDatasetGroupResponse = capo_personalize.types.create_dataset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.create_dataset_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_dataset_group(
