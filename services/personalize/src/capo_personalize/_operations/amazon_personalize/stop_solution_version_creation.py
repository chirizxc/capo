"""Generated from Smithy shape ``com.amazonaws.personalize#StopSolutionVersionCreation``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.StopSolutionVersionCreation"
    body: bytes | None = json.dumps(
        capo_personalize.types.stop_solution_version_creation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_solution_version_creation(
