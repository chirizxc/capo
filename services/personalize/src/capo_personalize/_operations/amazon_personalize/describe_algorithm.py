"""Generated from Smithy shape ``com.amazonaws.personalize#DescribeAlgorithm``."""
...
def handle_response(
    ...
    out: capo_personalize.types.describe_algorithm_response.DescribeAlgorithmResponse = capo_personalize.types.describe_algorithm_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_algorithm_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
