"""Generated from Smithy shape ``com.amazonaws.personalize#ListFilters``."""
...
def handle_response(
    ...
    out: capo_personalize.types.list_filters_response.ListFiltersResponse = (
        capo_personalize.types.list_filters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.ListFilters"
    body: bytes | None = json.dumps(
        capo_personalize.types.list_filters_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_filters(
    ...
    capo_personalize.types.list_filters_response.ListFiltersResponse, zapros.Response
]:
