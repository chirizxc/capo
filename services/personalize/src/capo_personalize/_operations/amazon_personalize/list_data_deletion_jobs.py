...
def handle_response(
    ...
    out: capo_personalize.types.list_data_deletion_jobs_response.ListDataDeletionJobsResponse = capo_personalize.types.list_data_deletion_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.list_data_deletion_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
