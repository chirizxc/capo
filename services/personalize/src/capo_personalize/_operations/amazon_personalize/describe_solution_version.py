"""Generated from Smithy shape ``com.amazonaws.personalize#DescribeSolutionVersion``."""
...
def handle_response(
    ...
    out: capo_personalize.types.describe_solution_version_response.DescribeSolutionVersionResponse = capo_personalize.types.describe_solution_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_solution_version_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_solution_version(
