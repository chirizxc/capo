"""Generated from Smithy shape ``com.amazonaws.personalize#ListBatchSegmentJobs``."""
...
def handle_response(
    ...
    out: capo_personalize.types.list_batch_segment_jobs_response.ListBatchSegmentJobsResponse = capo_personalize.types.list_batch_segment_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.ListBatchSegmentJobs"
    body: bytes | None = json.dumps(
        capo_personalize.types.list_batch_segment_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_batch_segment_jobs(
