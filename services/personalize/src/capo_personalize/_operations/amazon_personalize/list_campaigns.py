"""Generated from Smithy shape ``com.amazonaws.personalize#ListCampaigns``."""
...
def handle_response(
    ...
    out: capo_personalize.types.list_campaigns_response.ListCampaignsResponse = (
        capo_personalize.types.list_campaigns_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.list_campaigns_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
