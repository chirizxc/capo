"""Generated from Smithy shape ``com.amazonaws.personalize#UpdateMetricAttribution``."""
...
def handle_response(
    ...
    out: capo_personalize.types.update_metric_attribution_response.UpdateMetricAttributionResponse = capo_personalize.types.update_metric_attribution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.UpdateMetricAttribution"
    body: bytes | None = json.dumps(
        capo_personalize.types.update_metric_attribution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_metric_attribution(
