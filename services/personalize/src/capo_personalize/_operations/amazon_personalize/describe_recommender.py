...
def handle_response(
    ...
    out: capo_personalize.types.describe_recommender_response.DescribeRecommenderResponse = capo_personalize.types.describe_recommender_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_recommender_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
