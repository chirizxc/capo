...
def handle_response(
    ...
    out: capo_personalize.types.describe_dataset_import_job_response.DescribeDatasetImportJobResponse = capo_personalize.types.describe_dataset_import_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.describe_dataset_import_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
