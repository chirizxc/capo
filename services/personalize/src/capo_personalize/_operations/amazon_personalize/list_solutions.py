...
def handle_response(
    ...
    out: capo_personalize.types.list_solutions_response.ListSolutionsResponse = (
        capo_personalize.types.list_solutions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.list_solutions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
