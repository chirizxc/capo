...
def handle_response(
    ...
    out: capo_personalize.types.list_event_trackers_response.ListEventTrackersResponse = capo_personalize.types.list_event_trackers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_personalize.types.list_event_trackers_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
