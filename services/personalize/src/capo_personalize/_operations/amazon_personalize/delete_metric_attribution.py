"""Generated from Smithy shape ``com.amazonaws.personalize#DeleteMetricAttribution``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonPersonalize.DeleteMetricAttribution"
    body: bytes | None = json.dumps(
        capo_personalize.types.delete_metric_attribution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_metric_attribution(
