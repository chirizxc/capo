"""Generated from Smithy shape ``com.amazonaws.personalize#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.personalize#ResourceNotFoundException``."""
