...
from capo_notifications._resources.notifications.channel import AsyncChannel
from capo_notifications._resources.notifications.event_rule import AsyncEventRule
...
from capo_notifications._resources.notifications.notification_hub import (
...
from capo_notifications._services._aws_config import aaws_config
...
class AsyncNotificationsClient:
    ...
    async def list_managed_notification_channel_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_notifications.types.list_managed_notification_channel_associations_request.ListManagedNotificationChannelAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_notifications.types.list_managed_notification_channel_associations_response.ListManagedNotificationChannelAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_notifications._operations.notifications.list_managed_notification_channel_associations.async_list_managed_notification_channel_associations(
    ...
    async def iter_list_managed_notification_channel_associations(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_notifications.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_notifications.types.managed_notification_channel_association_summary.ManagedNotificationChannelAssociationSummary]":
        _token = next_token
        while True:
    ...
    async def list_member_accounts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_notifications.types.list_member_accounts_request.ListMemberAccountsRequest]",
        ) -> AsyncOperationResponse[
            "capo_notifications.types.list_member_accounts_response.ListMemberAccountsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_notifications._operations.notifications.list_member_accounts.async_list_member_accounts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_notifications.types.member_account.MemberAccount]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_notifications.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_notifications.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_notifications._operations.notifications.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_notifications.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_notifications.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_notifications._operations.notifications.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_notifications.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_notifications.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_notifications._operations.notifications.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
