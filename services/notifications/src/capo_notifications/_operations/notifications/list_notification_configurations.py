...
def handle_response(
    ...
    out: capo_notifications.types.list_notification_configurations_response.ListNotificationConfigurationsResponse = capo_notifications.types.list_notification_configurations_response.deserialize_json(
...
def build_request(
    ...
    if "event_rule_source" in input_:
        params.append(("eventRuleSource", input_["event_rule_source"]))
    if "channel_arn" in input_:
        params.append(("channelArn", input_["channel_arn"]))
    if "status" in input_:
        params.append(("status", input_["status"]))
    if "subtype" in input_:
        params.append(("subtype", input_["subtype"]))
