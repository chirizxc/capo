...
def handle_response(
    ...
    out: capo_notifications.types.get_managed_notification_event_response.GetManagedNotificationEventResponse = capo_notifications.types.get_managed_notification_event_response.deserialize_json(
