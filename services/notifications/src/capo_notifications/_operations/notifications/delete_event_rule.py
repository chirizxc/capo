"""Generated from Smithy shape ``com.amazonaws.notifications#DeleteEventRule``."""
...
def handle_response(
    ...
    out: capo_notifications.types.delete_event_rule_response.DeleteEventRuleResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_event_rule(
