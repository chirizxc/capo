...
def handle_response(
    ...
    out: capo_notifications.types.update_notification_configuration_response.UpdateNotificationConfigurationResponse = capo_notifications.types.update_notification_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.update_notification_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
