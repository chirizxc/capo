...
def handle_response(
    ...
    out: capo_notifications.types.list_managed_notification_events_response.ListManagedNotificationEventsResponse = capo_notifications.types.list_managed_notification_events_response.deserialize_json(
