...
def handle_response(
    ...
    out: capo_notifications.types.disassociate_managed_notification_additional_channel_response.DisassociateManagedNotificationAdditionalChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.disassociate_managed_notification_additional_channel_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
