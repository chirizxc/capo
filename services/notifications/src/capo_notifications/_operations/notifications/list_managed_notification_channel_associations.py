"""Generated from Smithy shape ``com.amazonaws.notifications#ListManagedNotificationChannelAssociations``."""
...
def handle_response(
    ...
    out: capo_notifications.types.list_managed_notification_channel_associations_response.ListManagedNotificationChannelAssociationsResponse = capo_notifications.types.list_managed_notification_channel_associations_response.deserialize_json(
