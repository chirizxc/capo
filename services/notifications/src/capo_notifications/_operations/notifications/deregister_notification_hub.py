...
def handle_response(
    ...
    out: capo_notifications.types.deregister_notification_hub_response.DeregisterNotificationHubResponse = capo_notifications.types.deregister_notification_hub_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{notificationHubRegion}", quote(input_["notification_hub_region"], safe="")
    )
