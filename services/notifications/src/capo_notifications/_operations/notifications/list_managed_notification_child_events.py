...
def handle_response(
    ...
    out: capo_notifications.types.list_managed_notification_child_events_response.ListManagedNotificationChildEventsResponse = capo_notifications.types.list_managed_notification_child_events_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["aggregate_managed_notification_event_arn"], safe=""),
    )
