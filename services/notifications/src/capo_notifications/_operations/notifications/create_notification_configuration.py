"""Generated from Smithy shape ``com.amazonaws.notifications#CreateNotificationConfiguration``."""
...
def handle_response(
    ...
    out: capo_notifications.types.create_notification_configuration_response.CreateNotificationConfigurationResponse = capo_notifications.types.create_notification_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.create_notification_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
