...
def handle_response(
    ...
    out: capo_notifications.types.associate_managed_notification_additional_channel_response.AssociateManagedNotificationAdditionalChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.associate_managed_notification_additional_channel_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
