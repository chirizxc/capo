...
def handle_response(
    ...
    out: capo_notifications.types.register_notification_hub_response.RegisterNotificationHubResponse = capo_notifications.types.register_notification_hub_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_notifications.types.register_notification_hub_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
