"""Generated from Smithy shape ``com.amazonaws.notifications#ListOrganizationalUnits``."""
...
import capo_notifications.types.organizational_units
...
def handle_response(
    ...
    out: capo_notifications.types.list_organizational_units_response.ListOrganizationalUnitsResponse = capo_notifications.types.list_organizational_units_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/organizational-units"
...
async def async_list_organizational_units(
