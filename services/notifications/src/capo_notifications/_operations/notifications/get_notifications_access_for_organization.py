...
def handle_response(
    ...
    out: capo_notifications.types.get_notifications_access_for_organization_response.GetNotificationsAccessForOrganizationResponse = capo_notifications.types.get_notifications_access_for_organization_response.deserialize_json(
