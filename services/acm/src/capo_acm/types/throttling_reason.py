...
if TYPE_CHECKING:
    import capo_acm.types.coral_availability_throttled_resource
    import capo_acm.types.coral_availability_throttling_reason


class ThrottlingReason(TypedDict, closed=True):
    reason: NotRequired[
        "capo_acm.types.coral_availability_throttling_reason.CoralAvailabilityThrottlingReason"
    ]
    """<p>A description of why a request was throttled.</p>"""
    resource: NotRequired[
        "capo_acm.types.coral_availability_throttled_resource.CoralAvailabilityThrottledResource"
    ]
