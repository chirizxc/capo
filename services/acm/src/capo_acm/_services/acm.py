...
from capo_acm._services._aws_config import aws_config
...
class ACMClientConfig(TypedDict, total=False, closed=True):
...
class ACMClient:
    ...
    def add_tags_to_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.add_tags_to_certificate_request.AddTagsToCertificateRequest]",
        ) -> OperationResponse[None]:
            import capo_acm._operations.certificate_manager.add_tags_to_certificate

            output, http_response = (
                capo_acm._operations.certificate_manager.add_tags_to_certificate.add_tags_to_certificate(
    ...
    def delete_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.delete_certificate_request.DeleteCertificateRequest]",
        ) -> OperationResponse[None]:
            import capo_acm._operations.certificate_manager.delete_certificate

            output, http_response = (
                capo_acm._operations.certificate_manager.delete_certificate.delete_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.describe_certificate_request.DescribeCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm.types.describe_certificate_response.DescribeCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.describe_certificate.describe_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def export_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.export_certificate_request.ExportCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm.types.export_certificate_response.ExportCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.export_certificate.export_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_configuration(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.get_account_configuration.get_account_configuration(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.get_certificate_request.GetCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm.types.get_certificate_response.GetCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.get_certificate.get_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.import_certificate_request.ImportCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm.types.import_certificate_response.ImportCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.import_certificate.import_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_certificates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.list_certificates_request.ListCertificatesRequest]",
        ) -> OperationResponse[
            "capo_acm.types.list_certificates_response.ListCertificatesResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.list_certificates.list_certificates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_certificates(
        ...
        *,
        ...
        sort_by: Optional["capo_acm.types.sort_by.SortBy"] = None,
        sort_order: Optional["capo_acm.types.sort_order.SortOrder"] = None,
    ) -> "Iterator[capo_acm.types.certificate_summary.CertificateSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.list_tags_for_certificate_request.ListTagsForCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm.types.list_tags_for_certificate_response.ListTagsForCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.list_tags_for_certificate.list_tags_for_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_account_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.put_account_configuration_request.PutAccountConfigurationRequest]",
        ) -> OperationResponse[None]:
            import capo_acm._operations.certificate_manager.put_account_configuration

            output, http_response = (
                capo_acm._operations.certificate_manager.put_account_configuration.put_account_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_tags_from_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.remove_tags_from_certificate_request.RemoveTagsFromCertificateRequest]",
        ) -> OperationResponse[None]:
            import capo_acm._operations.certificate_manager.remove_tags_from_certificate

            output, http_response = (
                capo_acm._operations.certificate_manager.remove_tags_from_certificate.remove_tags_from_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def renew_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.renew_certificate_request.RenewCertificateRequest]",
        ) -> OperationResponse[None]:
            import capo_acm._operations.certificate_manager.renew_certificate

            output, http_response = (
                capo_acm._operations.certificate_manager.renew_certificate.renew_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def request_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.request_certificate_request.RequestCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm.types.request_certificate_response.RequestCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.request_certificate.request_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def resend_validation_email(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.resend_validation_email_request.ResendValidationEmailRequest]",
        ) -> OperationResponse[None]:
            import capo_acm._operations.certificate_manager.resend_validation_email

            output, http_response = (
                capo_acm._operations.certificate_manager.resend_validation_email.resend_validation_email(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def revoke_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.revoke_certificate_request.RevokeCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm.types.revoke_certificate_response.RevokeCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.revoke_certificate.revoke_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def search_certificates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.search_certificates_request.SearchCertificatesRequest]",
        ) -> OperationResponse[
            "capo_acm.types.search_certificates_response.SearchCertificatesResponse"
        ]:
            ...
            output, http_response = (
                capo_acm._operations.certificate_manager.search_certificates.search_certificates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_acm.types.certificate_search_result.CertificateSearchResult]":
        _token = next_token
        while True:
    ...
    def update_certificate_options(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm.types.update_certificate_options_request.UpdateCertificateOptionsRequest]",
        ) -> OperationResponse[None]:
            import capo_acm._operations.certificate_manager.update_certificate_options

            output, http_response = (
                capo_acm._operations.certificate_manager.update_certificate_options.update_certificate_options(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
