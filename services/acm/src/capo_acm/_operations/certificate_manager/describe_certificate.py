"""Generated from Smithy shape ``com.amazonaws.acm#DescribeCertificate``."""
...
def handle_response(
    ...
    out: capo_acm.types.describe_certificate_response.DescribeCertificateResponse = (
        capo_acm.types.describe_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm.types.describe_certificate_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
