"""Generated from Smithy shape ``com.amazonaws.acm#RevokeCertificate``."""
...
def handle_response(
    ...
    out: capo_acm.types.revoke_certificate_response.RevokeCertificateResponse = (
        capo_acm.types.revoke_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CertificateManager.RevokeCertificate"
    body: bytes | None = json.dumps(
        capo_acm.types.revoke_certificate_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
