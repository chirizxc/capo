...
def handle_response(
    ...
    out: capo_acm.types.get_account_configuration_response.GetAccountConfigurationResponse = capo_acm.types.get_account_configuration_response.deserialize_aws_json_1_1(
