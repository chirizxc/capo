"""Generated from Smithy shape ``com.amazonaws.acm#SearchCertificates``."""
...
def handle_response(
    ...
    out: capo_acm.types.search_certificates_response.SearchCertificatesResponse = (
        capo_acm.types.search_certificates_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_acm._auth._sigv4.build_sigv4_auth_scheme(
                "acm", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CertificateManager.SearchCertificates"
    body: bytes | None = json.dumps(
        capo_acm.types.search_certificates_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_search_certificates(
