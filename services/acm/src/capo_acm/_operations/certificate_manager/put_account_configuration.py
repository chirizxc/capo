"""Generated from Smithy shape ``com.amazonaws.acm#PutAccountConfiguration``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CertificateManager.PutAccountConfiguration"
    body: bytes | None = json.dumps(
        capo_acm.types.put_account_configuration_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
