"""Generated from Smithy shape ``com.amazonaws.costexplorer#InvalidNextTokenException``."""
...
class InvalidNextTokenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.costexplorer#InvalidNextTokenException``."""
