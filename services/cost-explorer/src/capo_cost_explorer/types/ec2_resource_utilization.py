...
class EC2ResourceUtilization(TypedDict, closed=True):
    ...
    ebs_resource_utilization: NotRequired[
        "capo_cost_explorer.types.ebs_resource_utilization.EBSResourceUtilization"
    ]
    ...
    disk_resource_utilization: NotRequired[
        "capo_cost_explorer.types.disk_resource_utilization.DiskResourceUtilization"
    ]
    ...
    network_resource_utilization: NotRequired[
        "capo_cost_explorer.types.network_resource_utilization.NetworkResourceUtilization"
    ]
...
def serialize_aws_json_1_1(value: EC2ResourceUtilization) -> dict:
    ...
    if "ebs_resource_utilization" in value:
        ...
        out["EBSResourceUtilization"] = (
            capo_cost_explorer.types.ebs_resource_utilization.serialize_aws_json_1_1(
    ...
    if "disk_resource_utilization" in value:
        ...
        out["DiskResourceUtilization"] = (
            capo_cost_explorer.types.disk_resource_utilization.serialize_aws_json_1_1(
    ...
    if "network_resource_utilization" in value:
        ...
        out["NetworkResourceUtilization"] = (
            capo_cost_explorer.types.network_resource_utilization.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EC2ResourceUtilization:
    ...
    if data.get("EBSResourceUtilization") is not None:
        ...
        out["ebs_resource_utilization"] = (
            capo_cost_explorer.types.ebs_resource_utilization.deserialize_aws_json_1_1(
    ...
    if data.get("DiskResourceUtilization") is not None:
        ...
        out["disk_resource_utilization"] = (
            capo_cost_explorer.types.disk_resource_utilization.deserialize_aws_json_1_1(
    ...
    if data.get("NetworkResourceUtilization") is not None:
        ...
        out["network_resource_utilization"] = (
            capo_cost_explorer.types.network_resource_utilization.deserialize_aws_json_1_1(
