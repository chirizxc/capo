...
class ListCostCategoryResourceAssociationsResponse(TypedDict, closed=True):
    cost_category_resource_associations: NotRequired[
        "capo_cost_explorer.types.cost_category_resource_associations.CostCategoryResourceAssociations"
    ]
...
def serialize_aws_json_1_1(value: ListCostCategoryResourceAssociationsResponse) -> dict:
    ...
    if "cost_category_resource_associations" in value:
        ...
        out["CostCategoryResourceAssociations"] = (
            capo_cost_explorer.types.cost_category_resource_associations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if data.get("CostCategoryResourceAssociations") is not None:
        ...
        out["cost_category_resource_associations"] = (
            capo_cost_explorer.types.cost_category_resource_associations.deserialize_aws_json_1_1(
