...
class UpdateCostAllocationTagsStatusResponse(TypedDict, closed=True):
    errors: NotRequired[
        "capo_cost_explorer.types.update_cost_allocation_tags_status_errors.UpdateCostAllocationTagsStatusErrors"
    ]
...
def serialize_aws_json_1_1(value: UpdateCostAllocationTagsStatusResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["Errors"] = (
            capo_cost_explorer.types.update_cost_allocation_tags_status_errors.serialize_aws_json_1_1(
                value["errors"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpdateCostAllocationTagsStatusResponse:
    ...
    if data.get("Errors") is not None:
        ...
        out["errors"] = (
            capo_cost_explorer.types.update_cost_allocation_tags_status_errors.deserialize_aws_json_1_1(
                data["Errors"]
            )
        )
    return out
