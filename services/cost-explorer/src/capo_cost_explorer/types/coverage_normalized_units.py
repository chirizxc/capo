...
if TYPE_CHECKING:
    import capo_cost_explorer.types.coverage_normalized_units_percentage
    import capo_cost_explorer.types.on_demand_normalized_units
    import capo_cost_explorer.types.reserved_normalized_units
    import capo_cost_explorer.types.total_running_normalized_units


class CoverageNormalizedUnits(TypedDict, closed=True):
    on_demand_normalized_units: NotRequired[
        "capo_cost_explorer.types.on_demand_normalized_units.OnDemandNormalizedUnits"
    ]
    ...
    reserved_normalized_units: NotRequired[
        "capo_cost_explorer.types.reserved_normalized_units.ReservedNormalizedUnits"
    ]
    """<p>The number of normalized units that a reservation covers.</p>"""
    total_running_normalized_units: NotRequired[
        "capo_cost_explorer.types.total_running_normalized_units.TotalRunningNormalizedUnits"
    ]
    """<p>The total number of normalized units that you used.</p>"""
    coverage_normalized_units_percentage: NotRequired[
        "capo_cost_explorer.types.coverage_normalized_units_percentage.CoverageNormalizedUnitsPercentage"
    ]
