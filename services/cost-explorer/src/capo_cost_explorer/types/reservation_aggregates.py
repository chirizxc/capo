...
if TYPE_CHECKING:
    import capo_cost_explorer.types.amortized_recurring_fee
    import capo_cost_explorer.types.amortized_upfront_fee
    import capo_cost_explorer.types.net_ri_savings
    import capo_cost_explorer.types.on_demand_cost_of_ri_hours_used
    import capo_cost_explorer.types.purchased_hours
    import capo_cost_explorer.types.purchased_units
    import capo_cost_explorer.types.realized_savings
    import capo_cost_explorer.types.ri_cost_for_unused_hours
    import capo_cost_explorer.types.total_actual_hours
    import capo_cost_explorer.types.total_actual_units
    import capo_cost_explorer.types.total_amortized_fee
    import capo_cost_explorer.types.total_potential_ri_savings
    import capo_cost_explorer.types.unrealized_savings
    import capo_cost_explorer.types.unused_hours
    import capo_cost_explorer.types.unused_units
    import capo_cost_explorer.types.utilization_percentage
    import capo_cost_explorer.types.utilization_percentage_in_units


class ReservationAggregates(TypedDict, closed=True):
    utilization_percentage: NotRequired[
        "capo_cost_explorer.types.utilization_percentage.UtilizationPercentage"
    ]
    """<p>The percentage of reservation time that you used.</p>"""
    utilization_percentage_in_units: NotRequired[
        "capo_cost_explorer.types.utilization_percentage_in_units.UtilizationPercentageInUnits"
    ]
    ...
    purchased_hours: NotRequired[
        "capo_cost_explorer.types.purchased_hours.PurchasedHours"
    ]
    """<p>How many reservation hours that you purchased.</p>"""
    purchased_units: NotRequired[
        "capo_cost_explorer.types.purchased_units.PurchasedUnits"
    ]
    ...
    total_actual_hours: NotRequired[
        "capo_cost_explorer.types.total_actual_hours.TotalActualHours"
    ]
    """<p>The total number of reservation hours that you used.</p>"""
    total_actual_units: NotRequired[
        "capo_cost_explorer.types.total_actual_units.TotalActualUnits"
    ]
    ...
    unused_hours: NotRequired["capo_cost_explorer.types.unused_hours.UnusedHours"]
    """<p>The number of reservation hours that you didn't use.</p>"""
    unused_units: NotRequired["capo_cost_explorer.types.unused_units.UnusedUnits"]
    ...
    on_demand_cost_of_ri_hours_used: NotRequired[
        "capo_cost_explorer.types.on_demand_cost_of_ri_hours_used.OnDemandCostOfRIHoursUsed"
    ]
    """<p>How much your reservation costs if charged On-Demand rates.</p>"""
    net_ri_savings: NotRequired["capo_cost_explorer.types.net_ri_savings.NetRISavings"]
