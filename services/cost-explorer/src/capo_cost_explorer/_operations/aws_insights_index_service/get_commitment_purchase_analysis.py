...
import capo_cost_explorer.errors.analysis_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AnalysisNotFoundException":
            raise capo_cost_explorer.errors.analysis_not_found_exception.AnalysisNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_commitment_purchase_analysis_response.GetCommitmentPurchaseAnalysisResponse = capo_cost_explorer.types.get_commitment_purchase_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_commitment_purchase_analysis_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
