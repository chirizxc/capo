...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_savings_plans_utilization_details_response.GetSavingsPlansUtilizationDetailsResponse = capo_cost_explorer.types.get_savings_plans_utilization_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_savings_plans_utilization_details_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
