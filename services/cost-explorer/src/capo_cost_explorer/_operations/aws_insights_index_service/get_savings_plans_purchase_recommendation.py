"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetSavingsPlansPurchaseRecommendation``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_savings_plans_purchase_recommendation_response.GetSavingsPlansPurchaseRecommendationResponse = capo_cost_explorer.types.get_savings_plans_purchase_recommendation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_savings_plans_purchase_recommendation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_savings_plans_purchase_recommendation(
