"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetCostForecast``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_cost_forecast_response.GetCostForecastResponse = (
        capo_cost_explorer.types.get_cost_forecast_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_cost_forecast_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_cost_forecast(
