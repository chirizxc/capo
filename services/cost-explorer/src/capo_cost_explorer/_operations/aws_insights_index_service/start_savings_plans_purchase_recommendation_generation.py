"""Generated from Smithy shape ``com.amazonaws.costexplorer#StartSavingsPlansPurchaseRecommendationGeneration``."""
...
import capo_cost_explorer._protocol.eventstream
import capo_cost_explorer.errors.data_unavailable_exception
import capo_cost_explorer.errors.generation_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GenerationExistsException":
            raise capo_cost_explorer.errors.generation_exists_exception.GenerationExistsException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cost_explorer.types.start_savings_plans_purchase_recommendation_generation_response.StartSavingsPlansPurchaseRecommendationGenerationResponse = capo_cost_explorer.types.start_savings_plans_purchase_recommendation_generation_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_cost_explorer._auth._sigv4.build_sigv4_auth_scheme(
                "ce", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.start_savings_plans_purchase_recommendation_generation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_savings_plans_purchase_recommendation_generation(
