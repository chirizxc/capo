...
def handle_response(
    ...
    out: capo_cost_explorer.types.start_commitment_purchase_analysis_response.StartCommitmentPurchaseAnalysisResponse = capo_cost_explorer.types.start_commitment_purchase_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.start_commitment_purchase_analysis_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
