"""Generated from Smithy shape ``com.amazonaws.costexplorer#CreateAnomalySubscription``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.create_anomaly_subscription_response.CreateAnomalySubscriptionResponse = capo_cost_explorer.types.create_anomaly_subscription_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.CreateAnomalySubscription"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.create_anomaly_subscription_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_anomaly_subscription(
