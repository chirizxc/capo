"""Generated from Smithy shape ``com.amazonaws.costexplorer#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_cost_explorer.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
