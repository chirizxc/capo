"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetUsageForecast``."""
...
import capo_cost_explorer.errors.unresolvable_usage_unit_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnresolvableUsageUnitException":
            raise capo_cost_explorer.errors.unresolvable_usage_unit_exception.UnresolvableUsageUnitException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_usage_forecast_response.GetUsageForecastResponse = capo_cost_explorer.types.get_usage_forecast_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_usage_forecast_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_usage_forecast(
