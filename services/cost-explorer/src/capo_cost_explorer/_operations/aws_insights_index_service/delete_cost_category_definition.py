"""Generated from Smithy shape ``com.amazonaws.costexplorer#DeleteCostCategoryDefinition``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.delete_cost_category_definition_response.DeleteCostCategoryDefinitionResponse = capo_cost_explorer.types.delete_cost_category_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.DeleteCostCategoryDefinition"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.delete_cost_category_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_cost_category_definition(
