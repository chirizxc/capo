"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetAnomalies``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_anomalies_response.GetAnomaliesResponse = (
        capo_cost_explorer.types.get_anomalies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.GetAnomalies"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_anomalies_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
