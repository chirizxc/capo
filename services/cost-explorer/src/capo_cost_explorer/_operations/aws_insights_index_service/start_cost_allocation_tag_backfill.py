"""Generated from Smithy shape ``com.amazonaws.costexplorer#StartCostAllocationTagBackfill``."""
...
import capo_cost_explorer.errors.backfill_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BackfillLimitExceededException":
            raise capo_cost_explorer.errors.backfill_limit_exceeded_exception.BackfillLimitExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cost_explorer.types.start_cost_allocation_tag_backfill_response.StartCostAllocationTagBackfillResponse = capo_cost_explorer.types.start_cost_allocation_tag_backfill_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.StartCostAllocationTagBackfill"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.start_cost_allocation_tag_backfill_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_cost_allocation_tag_backfill(
