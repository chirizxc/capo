"""Generated from Smithy shape ``com.amazonaws.costexplorer#ListSavingsPlansPurchaseRecommendationGeneration``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_response.ListSavingsPlansPurchaseRecommendationGenerationResponse = capo_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.list_savings_plans_purchase_recommendation_generation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_savings_plans_purchase_recommendation_generation(
