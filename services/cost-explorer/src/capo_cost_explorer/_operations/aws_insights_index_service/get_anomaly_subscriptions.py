"""Generated from Smithy shape ``com.amazonaws.costexplorer#GetAnomalySubscriptions``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.get_anomaly_subscriptions_response.GetAnomalySubscriptionsResponse = capo_cost_explorer.types.get_anomaly_subscriptions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.GetAnomalySubscriptions"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.get_anomaly_subscriptions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_anomaly_subscriptions(
