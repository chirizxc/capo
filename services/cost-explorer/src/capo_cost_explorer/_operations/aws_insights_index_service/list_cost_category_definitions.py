"""Generated from Smithy shape ``com.amazonaws.costexplorer#ListCostCategoryDefinitions``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.list_cost_category_definitions_response.ListCostCategoryDefinitionsResponse = capo_cost_explorer.types.list_cost_category_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.ListCostCategoryDefinitions"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.list_cost_category_definitions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_cost_category_definitions(
