"""Generated from Smithy shape ``com.amazonaws.costexplorer#UpdateAnomalySubscription``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.update_anomaly_subscription_response.UpdateAnomalySubscriptionResponse = capo_cost_explorer.types.update_anomaly_subscription_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.UpdateAnomalySubscription"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.update_anomaly_subscription_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_anomaly_subscription(
