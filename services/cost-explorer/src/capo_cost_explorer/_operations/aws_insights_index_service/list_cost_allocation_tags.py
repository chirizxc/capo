...
def handle_response(
    ...
    out: capo_cost_explorer.types.list_cost_allocation_tags_response.ListCostAllocationTagsResponse = capo_cost_explorer.types.list_cost_allocation_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.list_cost_allocation_tags_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
