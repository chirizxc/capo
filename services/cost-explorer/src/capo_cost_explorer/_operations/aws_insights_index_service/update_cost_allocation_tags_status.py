...
import capo_cost_explorer.types.update_cost_allocation_tags_status_errors
...
def handle_response(
    ...
    out: capo_cost_explorer.types.update_cost_allocation_tags_status_response.UpdateCostAllocationTagsStatusResponse = capo_cost_explorer.types.update_cost_allocation_tags_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.update_cost_allocation_tags_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
