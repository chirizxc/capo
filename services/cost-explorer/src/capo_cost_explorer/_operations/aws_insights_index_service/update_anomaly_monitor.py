"""Generated from Smithy shape ``com.amazonaws.costexplorer#UpdateAnomalyMonitor``."""
...
def handle_response(
    ...
    out: capo_cost_explorer.types.update_anomaly_monitor_response.UpdateAnomalyMonitorResponse = capo_cost_explorer.types.update_anomaly_monitor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSInsightsIndexService.UpdateAnomalyMonitor"
    body: bytes | None = json.dumps(
        capo_cost_explorer.types.update_anomaly_monitor_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_anomaly_monitor(
