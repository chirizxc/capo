"""Generated from Smithy shape ``com.amazonaws.redshift#IntegrationAlreadyExistsFault``."""
...
class IntegrationAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#IntegrationAlreadyExistsFault``."""

    code: str | None = "IntegrationAlreadyExistsFault"

    def __init__(
        self, data: IntegrationAlreadyExistsFault_, message: str | None = None
    ):
        super().__init__(
            "client",
