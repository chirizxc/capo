"""Generated from Smithy shape ``com.amazonaws.redshift#AuthorizationNotFoundFault``."""
...
class AuthorizationNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#AuthorizationNotFoundFault``."""
