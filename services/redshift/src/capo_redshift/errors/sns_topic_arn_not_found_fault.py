"""Generated from Smithy shape ``com.amazonaws.redshift#SNSTopicArnNotFoundFault``."""
...
class SNSTopicArnNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#SNSTopicArnNotFoundFault``."""

    code: str | None = "SNSTopicArnNotFoundFault"

    def __init__(self, data: SNSTopicArnNotFoundFault_, message: str | None = None):
        super().__init__(
            "client",
