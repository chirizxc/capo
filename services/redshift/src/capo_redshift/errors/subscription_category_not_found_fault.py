"""Generated from Smithy shape ``com.amazonaws.redshift#SubscriptionCategoryNotFoundFault``."""
...
class SubscriptionCategoryNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#SubscriptionCategoryNotFoundFault``."""
