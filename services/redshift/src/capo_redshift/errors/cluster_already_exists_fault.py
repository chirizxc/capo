"""Generated from Smithy shape ``com.amazonaws.redshift#ClusterAlreadyExistsFault``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ClusterAlreadyExistsFault_, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ClusterAlreadyExistsFault_:
...
class ClusterAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#ClusterAlreadyExistsFault``."""
