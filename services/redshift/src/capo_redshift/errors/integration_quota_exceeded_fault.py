"""Generated from Smithy shape ``com.amazonaws.redshift#IntegrationQuotaExceededFault``."""
...
class IntegrationQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#IntegrationQuotaExceededFault``."""

    code: str | None = "IntegrationQuotaExceededFault"

    def __init__(
        self, data: IntegrationQuotaExceededFault_, message: str | None = None
    ):
        super().__init__(
            "client",
