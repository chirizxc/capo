"""Generated from Smithy shape ``com.amazonaws.redshift#EventSubscriptionQuotaExceededFault``."""
...
class EventSubscriptionQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.redshift#EventSubscriptionQuotaExceededFault``."""

    code: str | None = "EventSubscriptionQuotaExceededFault"

    def __init__(
        self, data: EventSubscriptionQuotaExceededFault_, message: str | None = None
    ):
        super().__init__(
            "client",
