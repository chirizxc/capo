...
class RestoreStatus(TypedDict, closed=True):
    ...
    snapshot_size_in_mega_bytes: NotRequired["capo_redshift.types.long.Long"]
    ...
    progress_in_mega_bytes: NotRequired["capo_redshift.types.long.Long"]
