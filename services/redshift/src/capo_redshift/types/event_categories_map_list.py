"""Generated from Smithy shape ``com.amazonaws.redshift#EventCategoriesMapList``."""
...
if TYPE_CHECKING:
    import capo_redshift.types.event_categories_map

EventCategoriesMapList: TypeAlias = list[
    "capo_redshift.types.event_categories_map.EventCategoriesMap"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        capo_redshift.types.event_categories_map.serialize_query(
...
def deserialize_query(el: Element) -> EventCategoriesMapList:
    ...
    for child in el.findall("EventCategoriesMap"):
        out.append(capo_redshift.types.event_categories_map.deserialize_query(child))
    return out
