...
ClusterDbRevisionsList: TypeAlias = list[
    "capo_redshift.types.cluster_db_revision.ClusterDbRevision"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        capo_redshift.types.cluster_db_revision.serialize_query(
...
def deserialize_query(el: Element) -> ClusterDbRevisionsList:
    ...
    for child in el.findall("ClusterDbRevision"):
        out.append(capo_redshift.types.cluster_db_revision.deserialize_query(child))
    return out
