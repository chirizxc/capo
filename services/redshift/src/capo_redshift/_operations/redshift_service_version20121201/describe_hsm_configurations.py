...
def handle_response(
    ...
    out: capo_redshift.types.hsm_configuration_message.HsmConfigurationMessage = (
        capo_redshift.types.hsm_configuration_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_hsm_configurations_message.serialize_query(
        input_, pairs, ""
    )
