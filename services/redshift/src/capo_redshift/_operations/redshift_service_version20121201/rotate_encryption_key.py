"""Generated from Smithy shape ``com.amazonaws.redshift#RotateEncryptionKey``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RotateEncryptionKeyResult")
    out: capo_redshift.types.rotate_encryption_key_result.RotateEncryptionKeyResult = (
        capo_redshift.types.rotate_encryption_key_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "RotateEncryptionKey"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.rotate_encryption_key_message.serialize_query(input_, pairs, "")
...
async def async_rotate_encryption_key(
