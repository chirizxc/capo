...
def handle_response(
    ...
    out: capo_redshift.types.register_namespace_output_message.RegisterNamespaceOutputMessage = capo_redshift.types.register_namespace_output_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.register_namespace_input_message.serialize_query(
        input_, pairs, ""
    )
