...
def handle_response(
    ...
    out: capo_redshift.types.event_categories_message.EventCategoriesMessage = (
        capo_redshift.types.event_categories_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_event_categories_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_event_categories(
    ...
    capo_redshift.types.event_categories_message.EventCategoriesMessage, zapros.Response
]:
