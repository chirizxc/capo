...
def handle_response(
    ...
    out: capo_redshift.types.describe_snapshot_schedules_output_message.DescribeSnapshotSchedulesOutputMessage = capo_redshift.types.describe_snapshot_schedules_output_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_snapshot_schedules_message.serialize_query(
        input_, pairs, ""
    )
