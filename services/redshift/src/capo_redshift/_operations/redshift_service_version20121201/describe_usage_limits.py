"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeUsageLimits``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeUsageLimitsResult")
    out: capo_redshift.types.usage_limit_list.UsageLimitList = (
        capo_redshift.types.usage_limit_list.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeUsageLimits"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_usage_limits_message.serialize_query(input_, pairs, "")
...
def describe_usage_limits(
    ...
    input_: capo_redshift.types.describe_usage_limits_message.DescribeUsageLimitsMessage,
) -> tuple[capo_redshift.types.usage_limit_list.UsageLimitList, zapros.Response]:
...
async def async_describe_usage_limits(
