"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyRedshiftIdcApplication``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyRedshiftIdcApplicationResult")
    out: capo_redshift.types.modify_redshift_idc_application_result.ModifyRedshiftIdcApplicationResult = capo_redshift.types.modify_redshift_idc_application_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyRedshiftIdcApplication"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.modify_redshift_idc_application_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_redshift_idc_application(
