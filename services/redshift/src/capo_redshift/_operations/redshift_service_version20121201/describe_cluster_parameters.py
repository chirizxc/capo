"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeClusterParameters``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeClusterParametersResult")
    out: capo_redshift.types.cluster_parameter_group_details.ClusterParameterGroupDetails = capo_redshift.types.cluster_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClusterParameters"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_cluster_parameters(
