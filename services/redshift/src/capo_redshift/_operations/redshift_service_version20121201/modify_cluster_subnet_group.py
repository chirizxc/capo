...
import capo_redshift.errors.subnet_already_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetAlreadyInUse":
            raise capo_redshift.errors.subnet_already_in_use.SubnetAlreadyInUse.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_redshift.types.modify_cluster_subnet_group_result.ModifyClusterSubnetGroupResult = capo_redshift.types.modify_cluster_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.modify_cluster_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
