...
import capo_redshift.errors.cluster_parameter_group_already_exists_fault
import capo_redshift.errors.cluster_parameter_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ClusterParameterGroupAlreadyExists":
            raise capo_redshift.errors.cluster_parameter_group_already_exists_fault.ClusterParameterGroupAlreadyExistsFault.from_query(
                error_el, message
            )
        case "ClusterParameterGroupQuotaExceeded":
            raise capo_redshift.errors.cluster_parameter_group_quota_exceeded_fault.ClusterParameterGroupQuotaExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_redshift.types.create_cluster_parameter_group_result.CreateClusterParameterGroupResult = capo_redshift.types.create_cluster_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.create_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
