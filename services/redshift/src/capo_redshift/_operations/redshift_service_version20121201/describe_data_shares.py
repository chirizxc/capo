"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeDataShares``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeDataSharesResult")
    out: capo_redshift.types.describe_data_shares_result.DescribeDataSharesResult = (
        capo_redshift.types.describe_data_shares_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeDataShares"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_data_shares_message.serialize_query(input_, pairs, "")
...
async def async_describe_data_shares(
