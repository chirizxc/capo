"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteSnapshotCopyGrant``."""
...
import capo_redshift.errors.invalid_snapshot_copy_grant_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidSnapshotCopyGrantStateFault":
            raise capo_redshift.errors.invalid_snapshot_copy_grant_state_fault.InvalidSnapshotCopyGrantStateFault.from_query(
                error_el, message
            )
...
def build_request(
    ...
    capo_redshift.types.delete_snapshot_copy_grant_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_snapshot_copy_grant(
