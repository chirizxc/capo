"""Generated from Smithy shape ``com.amazonaws.redshift#ListRecommendations``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListRecommendationsResult")
    out: capo_redshift.types.list_recommendations_result.ListRecommendationsResult = (
        capo_redshift.types.list_recommendations_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListRecommendations"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.list_recommendations_message.serialize_query(input_, pairs, "")
