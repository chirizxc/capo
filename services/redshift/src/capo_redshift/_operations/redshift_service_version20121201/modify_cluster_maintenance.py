...
def handle_response(
    ...
    out: capo_redshift.types.modify_cluster_maintenance_result.ModifyClusterMaintenanceResult = capo_redshift.types.modify_cluster_maintenance_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.modify_cluster_maintenance_message.serialize_query(
        input_, pairs, ""
    )
