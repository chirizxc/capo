...
import capo_redshift.errors.snapshot_copy_grant_already_exists_fault
import capo_redshift.errors.snapshot_copy_grant_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SnapshotCopyGrantAlreadyExistsFault":
            raise capo_redshift.errors.snapshot_copy_grant_already_exists_fault.SnapshotCopyGrantAlreadyExistsFault.from_query(
                error_el, message
            )
        case "SnapshotCopyGrantQuotaExceededFault":
            raise capo_redshift.errors.snapshot_copy_grant_quota_exceeded_fault.SnapshotCopyGrantQuotaExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_redshift.types.create_snapshot_copy_grant_result.CreateSnapshotCopyGrantResult = capo_redshift.types.create_snapshot_copy_grant_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.create_snapshot_copy_grant_message.serialize_query(
        input_, pairs, ""
    )
