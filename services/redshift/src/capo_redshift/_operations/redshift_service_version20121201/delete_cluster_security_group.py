"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteClusterSecurityGroup``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteClusterSecurityGroup"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.delete_cluster_security_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_cluster_security_group(
