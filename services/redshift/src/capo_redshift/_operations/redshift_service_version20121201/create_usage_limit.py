"""Generated from Smithy shape ``com.amazonaws.redshift#CreateUsageLimit``."""
...
import capo_redshift.errors.invalid_usage_limit_fault
...
import capo_redshift.errors.usage_limit_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidUsageLimit":
            raise capo_redshift.errors.invalid_usage_limit_fault.InvalidUsageLimitFault.from_query(
                error_el, message
            )
        ...
        case "UsageLimitAlreadyExists":
            raise capo_redshift.errors.usage_limit_already_exists_fault.UsageLimitAlreadyExistsFault.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateUsageLimitResult")
    out: capo_redshift.types.usage_limit.UsageLimit = (
        capo_redshift.types.usage_limit.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateUsageLimit"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.create_usage_limit_message.serialize_query(input_, pairs, "")
...
def create_usage_limit(
    ...
    input_: capo_redshift.types.create_usage_limit_message.CreateUsageLimitMessage,
) -> tuple[capo_redshift.types.usage_limit.UsageLimit, zapros.Response]:
...
async def async_create_usage_limit(
