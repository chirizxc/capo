...
def handle_response(
    ...
    out: capo_redshift.types.cluster_parameter_groups_message.ClusterParameterGroupsMessage = capo_redshift.types.cluster_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_cluster_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
