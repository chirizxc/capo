...
import capo_redshift.errors.cluster_security_group_already_exists_fault
import capo_redshift.errors.cluster_security_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ClusterSecurityGroupAlreadyExists":
            raise capo_redshift.errors.cluster_security_group_already_exists_fault.ClusterSecurityGroupAlreadyExistsFault.from_query(
                error_el, message
            )
        case "QuotaExceeded.ClusterSecurityGroup":
            raise capo_redshift.errors.cluster_security_group_quota_exceeded_fault.ClusterSecurityGroupQuotaExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_redshift.types.create_cluster_security_group_result.CreateClusterSecurityGroupResult = capo_redshift.types.create_cluster_security_group_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.create_cluster_security_group_message.serialize_query(
        input_, pairs, ""
    )
