...
def handle_response(
    ...
    out: capo_redshift.types.cluster_parameter_group_name_message.ClusterParameterGroupNameMessage = capo_redshift.types.cluster_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.modify_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
