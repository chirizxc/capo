...
def handle_response(
    ...
    out: capo_redshift.types.orderable_cluster_options_message.OrderableClusterOptionsMessage = capo_redshift.types.orderable_cluster_options_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_orderable_cluster_options_message.serialize_query(
        input_, pairs, ""
    )
