...
def handle_response(
    ...
    out: capo_redshift.types.create_cluster_result.CreateClusterResult = (
        capo_redshift.types.create_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.create_cluster_message.serialize_query(input_, pairs, "")
...
def create_cluster(
    ...
    capo_redshift.types.create_cluster_result.CreateClusterResult, zapros.Response
]:
