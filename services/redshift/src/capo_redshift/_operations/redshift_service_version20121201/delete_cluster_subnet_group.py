...
import capo_redshift.errors.invalid_cluster_subnet_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidClusterSubnetStateFault":
            raise capo_redshift.errors.invalid_cluster_subnet_state_fault.InvalidClusterSubnetStateFault.from_query(
                error_el, message
            )
        case _:
...
def build_request(
    ...
    capo_redshift.types.delete_cluster_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
