"""Generated from Smithy shape ``com.amazonaws.redshift#CreateScheduledAction``."""
...
import capo_redshift.errors.scheduled_action_already_exists_fault
import capo_redshift.errors.scheduled_action_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ScheduledActionAlreadyExists":
            raise capo_redshift.errors.scheduled_action_already_exists_fault.ScheduledActionAlreadyExistsFault.from_query(
                error_el, message
            )
        case "ScheduledActionQuotaExceeded":
            raise capo_redshift.errors.scheduled_action_quota_exceeded_fault.ScheduledActionQuotaExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateScheduledActionResult")
...
def build_request(
    ...
    pairs.append(("Action", "CreateScheduledAction"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.create_scheduled_action_message.serialize_query(
        input_, pairs, ""
    )
