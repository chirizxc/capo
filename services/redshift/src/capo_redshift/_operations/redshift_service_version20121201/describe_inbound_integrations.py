...
def handle_response(
    ...
    out: capo_redshift.types.inbound_integrations_message.InboundIntegrationsMessage = (
        capo_redshift.types.inbound_integrations_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_inbound_integrations_message.serialize_query(
        input_, pairs, ""
    )
