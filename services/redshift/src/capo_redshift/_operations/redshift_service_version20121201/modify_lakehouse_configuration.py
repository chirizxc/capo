...
def handle_response(
    ...
    out: capo_redshift.types.lakehouse_configuration.LakehouseConfiguration = (
        capo_redshift.types.lakehouse_configuration.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.modify_lakehouse_configuration_message.serialize_query(
        input_, pairs, ""
    )
...
def modify_lakehouse_configuration(
    ...
    capo_redshift.types.lakehouse_configuration.LakehouseConfiguration, zapros.Response
]:
