...
def handle_response(
    ...
    out: capo_redshift.types.events_message.EventsMessage = (
        capo_redshift.types.events_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_events_message.serialize_query(input_, pairs, "")
...
def describe_events(
    ...
    input_: capo_redshift.types.describe_events_message.DescribeEventsMessage,
) -> tuple[capo_redshift.types.events_message.EventsMessage, zapros.Response]:
