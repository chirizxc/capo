...
import capo_redshift.errors.conflict_policy_update_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictPolicyUpdateFault":
            raise capo_redshift.errors.conflict_policy_update_fault.ConflictPolicyUpdateFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_redshift.types.put_resource_policy_result.PutResourcePolicyResult = (
        capo_redshift.types.put_resource_policy_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.put_resource_policy_message.serialize_query(input_, pairs, "")
