"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeClusterTracks``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeClusterTracksResult")
    out: capo_redshift.types.track_list_message.TrackListMessage = (
        capo_redshift.types.track_list_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClusterTracks"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_cluster_tracks_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_cluster_tracks(
    ...
    input_: capo_redshift.types.describe_cluster_tracks_message.DescribeClusterTracksMessage,
) -> tuple[capo_redshift.types.track_list_message.TrackListMessage, zapros.Response]:
...
async def async_describe_cluster_tracks(
