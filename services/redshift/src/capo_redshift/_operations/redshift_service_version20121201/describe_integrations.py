"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeIntegrations``."""
...
def handle_response(
    ...
    out: capo_redshift.types.integrations_message.IntegrationsMessage = (
        capo_redshift.types.integrations_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_integrations_message.serialize_query(input_, pairs, "")
...
def describe_integrations(
    ...
    capo_redshift.types.integrations_message.IntegrationsMessage, zapros.Response
]:
