...
def handle_response(
    ...
    out: capo_redshift.types.resize_cluster_result.ResizeClusterResult = (
        capo_redshift.types.resize_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.resize_cluster_message.serialize_query(input_, pairs, "")
...
def resize_cluster(
    ...
    capo_redshift.types.resize_cluster_result.ResizeClusterResult, zapros.Response
]:
