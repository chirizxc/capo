...
def handle_response(
    ...
    out: capo_redshift.types.account_attribute_list.AccountAttributeList = (
        capo_redshift.types.account_attribute_list.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_account_attributes_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_account_attributes(
    ...
    capo_redshift.types.account_attribute_list.AccountAttributeList, zapros.Response
]:
