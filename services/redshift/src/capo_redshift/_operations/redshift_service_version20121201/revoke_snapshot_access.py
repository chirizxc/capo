...
def handle_response(
    ...
    out: capo_redshift.types.revoke_snapshot_access_result.RevokeSnapshotAccessResult = capo_redshift.types.revoke_snapshot_access_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.revoke_snapshot_access_message.serialize_query(
        input_, pairs, ""
    )
