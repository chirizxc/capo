"""Generated from Smithy shape ``com.amazonaws.redshift#RevokeEndpointAccess``."""
...
import capo_redshift.errors.endpoint_authorization_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EndpointAuthorizationNotFound":
            raise capo_redshift.errors.endpoint_authorization_not_found_fault.EndpointAuthorizationNotFoundFault.from_query(
                error_el, message
            )
...
def build_request(
    ...
    pairs.append(("Action", "RevokeEndpointAccess"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.revoke_endpoint_access_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_revoke_endpoint_access(
