...
import capo_redshift.errors.invalid_s3_bucket_name_fault
import capo_redshift.errors.invalid_s3_key_prefix_fault
...
def build_request(
    ...
    capo_redshift.types.enable_logging_message.serialize_query(input_, pairs, "")
