"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeClusterSecurityGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeClusterSecurityGroupsResult")
    out: capo_redshift.types.cluster_security_group_message.ClusterSecurityGroupMessage = capo_redshift.types.cluster_security_group_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeClusterSecurityGroups"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_cluster_security_groups_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_cluster_security_groups(
