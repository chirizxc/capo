"""Generated from Smithy shape ``com.amazonaws.redshift#DeleteResourcePolicy``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteResourcePolicy"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.delete_resource_policy_message.serialize_query(
        input_, pairs, ""
    )
