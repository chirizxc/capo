...
def handle_response(
    ...
    out: capo_redshift.types.tagged_resource_list_message.TaggedResourceListMessage = (
        capo_redshift.types.tagged_resource_list_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_tags_message.serialize_query(input_, pairs, "")
