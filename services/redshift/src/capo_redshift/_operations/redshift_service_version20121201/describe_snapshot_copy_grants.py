"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeSnapshotCopyGrants``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeSnapshotCopyGrantsResult")
    out: capo_redshift.types.snapshot_copy_grant_message.SnapshotCopyGrantMessage = (
        capo_redshift.types.snapshot_copy_grant_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSnapshotCopyGrants"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_snapshot_copy_grants_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_snapshot_copy_grants(
