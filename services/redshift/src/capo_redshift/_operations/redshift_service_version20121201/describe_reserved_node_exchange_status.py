"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeReservedNodeExchangeStatus``."""
...
import capo_redshift.errors.reserved_node_exchange_not_found_fault
...
import capo_redshift.types.reserved_node_exchange_status_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ReservedNodeExchangeNotFond":
            raise capo_redshift.errors.reserved_node_exchange_not_found_fault.ReservedNodeExchangeNotFoundFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeReservedNodeExchangeStatusResult")
    out: capo_redshift.types.describe_reserved_node_exchange_status_output_message.DescribeReservedNodeExchangeStatusOutputMessage = capo_redshift.types.describe_reserved_node_exchange_status_output_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeReservedNodeExchangeStatus"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_reserved_node_exchange_status_input_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_reserved_node_exchange_status(
