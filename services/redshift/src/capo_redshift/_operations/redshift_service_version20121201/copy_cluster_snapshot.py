...
def handle_response(
    ...
    out: capo_redshift.types.copy_cluster_snapshot_result.CopyClusterSnapshotResult = (
        capo_redshift.types.copy_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.copy_cluster_snapshot_message.serialize_query(input_, pairs, "")
