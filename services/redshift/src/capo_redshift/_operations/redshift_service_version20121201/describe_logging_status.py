"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeLoggingStatus``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeLoggingStatusResult")
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLoggingStatus"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_logging_status_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_logging_status(
