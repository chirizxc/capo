...
def handle_response(
    ...
    out: capo_redshift.types.modify_aqua_output_message.ModifyAquaOutputMessage = (
        capo_redshift.types.modify_aqua_output_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.modify_aqua_input_message.serialize_query(input_, pairs, "")
