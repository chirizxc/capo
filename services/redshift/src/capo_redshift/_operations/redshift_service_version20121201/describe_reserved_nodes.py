"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeReservedNodes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeReservedNodesResult")
    out: capo_redshift.types.reserved_nodes_message.ReservedNodesMessage = (
        capo_redshift.types.reserved_nodes_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeReservedNodes"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.describe_reserved_nodes_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_reserved_nodes(
    ...
    capo_redshift.types.reserved_nodes_message.ReservedNodesMessage, zapros.Response
]:
