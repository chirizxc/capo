...
import capo_redshift.errors.invalid_hsm_client_certificate_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidHsmClientCertificateStateFault":
            raise capo_redshift.errors.invalid_hsm_client_certificate_state_fault.InvalidHsmClientCertificateStateFault.from_query(
                error_el, message
            )
        case _:
...
def build_request(
    ...
    capo_redshift.types.delete_hsm_client_certificate_message.serialize_query(
        input_, pairs, ""
    )
