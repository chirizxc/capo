...
def handle_response(
    ...
    out: capo_redshift.types.node_configuration_options_message.NodeConfigurationOptionsMessage = capo_redshift.types.node_configuration_options_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_node_configuration_options_message.serialize_query(
        input_, pairs, ""
    )
