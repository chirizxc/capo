...
import capo_redshift.errors.batch_modify_cluster_snapshots_limit_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BatchModifyClusterSnapshotsLimitExceededFault":
            raise capo_redshift.errors.batch_modify_cluster_snapshots_limit_exceeded_fault.BatchModifyClusterSnapshotsLimitExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_redshift.types.batch_modify_cluster_snapshots_output_message.BatchModifyClusterSnapshotsOutputMessage = capo_redshift.types.batch_modify_cluster_snapshots_output_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.batch_modify_cluster_snapshots_message.serialize_query(
        input_, pairs, ""
    )
