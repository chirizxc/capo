"""Generated from Smithy shape ``com.amazonaws.redshift#ModifyUsageLimit``."""
...
import capo_redshift.errors.usage_limit_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UsageLimitNotFound":
            raise capo_redshift.errors.usage_limit_not_found_fault.UsageLimitNotFoundFault.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyUsageLimitResult")
...
def build_request(
    ...
    pairs.append(("Action", "ModifyUsageLimit"))
    pairs.append(("Version", "2012-12-01"))
    capo_redshift.types.modify_usage_limit_message.serialize_query(input_, pairs, "")
...
async def async_modify_usage_limit(
