"""Generated from Smithy shape ``com.amazonaws.redshift#DescribeClusterVersions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeClusterVersionsResult")
    out: capo_redshift.types.cluster_versions_message.ClusterVersionsMessage = (
        capo_redshift.types.cluster_versions_message.deserialize_query(
...
def build_request(
    ...
    capo_redshift.types.describe_cluster_versions_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_cluster_versions(
    ...
    capo_redshift.types.cluster_versions_message.ClusterVersionsMessage, zapros.Response
]:
