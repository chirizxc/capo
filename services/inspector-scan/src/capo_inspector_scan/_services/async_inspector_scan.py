...
from capo_inspector_scan._services._aws_config import aaws_config
...
class AsyncInspectorScanClientConfig(TypedDict, total=False, closed=True):
...
class AsyncInspectorScanClient:
    ...
    async def scan_sbom(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_inspector_scan.types.scan_sbom_request.ScanSbomRequest]",
        ) -> AsyncOperationResponse[
            "capo_inspector_scan.types.scan_sbom_response.ScanSbomResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_inspector_scan._operations.inspector_scan.scan_sbom.async_scan_sbom(
