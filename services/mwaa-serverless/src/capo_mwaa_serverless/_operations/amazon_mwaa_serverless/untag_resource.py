"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#UntagResource``."""
...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMWAAServerless.UntagResource"
    body: bytes | None = json.dumps(
        capo_mwaa_serverless.types.untag_resource_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
