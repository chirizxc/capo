...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.list_workflows_response.ListWorkflowsResponse = (
        capo_mwaa_serverless.types.list_workflows_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mwaa_serverless.types.list_workflows_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
