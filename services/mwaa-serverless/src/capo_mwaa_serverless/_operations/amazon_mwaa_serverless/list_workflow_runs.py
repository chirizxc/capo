"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#ListWorkflowRuns``."""
...
import capo_mwaa_serverless.types.workflow_run_summaries
...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.list_workflow_runs_response.ListWorkflowRunsResponse = capo_mwaa_serverless.types.list_workflow_runs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMWAAServerless.ListWorkflowRuns"
    body: bytes | None = json.dumps(
        capo_mwaa_serverless.types.list_workflow_runs_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
