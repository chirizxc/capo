"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#GetTaskInstance``."""
...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.get_task_instance_response.GetTaskInstanceResponse = capo_mwaa_serverless.types.get_task_instance_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mwaa_serverless.types.get_task_instance_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
