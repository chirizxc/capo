"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#TagResource``."""
...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMWAAServerless.TagResource"
    body: bytes | None = json.dumps(
        capo_mwaa_serverless.types.tag_resource_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
