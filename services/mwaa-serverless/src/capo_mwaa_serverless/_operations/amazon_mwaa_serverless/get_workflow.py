"""Generated from Smithy shape ``com.amazonaws.mwaaserverless#GetWorkflow``."""
...
def handle_response(
    ...
    out: capo_mwaa_serverless.types.get_workflow_response.GetWorkflowResponse = (
        capo_mwaa_serverless.types.get_workflow_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMWAAServerless.GetWorkflow"
    body: bytes | None = json.dumps(
        capo_mwaa_serverless.types.get_workflow_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
