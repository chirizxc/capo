...
class ListWorkflowRunsResponse(TypedDict, closed=True):
    workflow_runs: NotRequired[
        "capo_mwaa_serverless.types.workflow_run_summaries.WorkflowRunSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListWorkflowRunsResponse) -> dict:
    ...
    if "workflow_runs" in value:
        ...
        out["WorkflowRuns"] = (
            capo_mwaa_serverless.types.workflow_run_summaries.serialize_aws_json_1_0(
                value["workflow_runs"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListWorkflowRunsResponse:
    ...
    if data.get("WorkflowRuns") is not None:
        import capo_mwaa_serverless.types.workflow_run_summaries

        out["workflow_runs"] = (
            capo_mwaa_serverless.types.workflow_run_summaries.deserialize_aws_json_1_0(
                data["WorkflowRuns"]
            )
        )
