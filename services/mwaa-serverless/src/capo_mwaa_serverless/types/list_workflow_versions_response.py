...
class ListWorkflowVersionsResponse(TypedDict, closed=True):
    workflow_versions: NotRequired[
        "capo_mwaa_serverless.types.workflow_version_summaries.WorkflowVersionSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListWorkflowVersionsResponse) -> dict:
    ...
    if "workflow_versions" in value:
        ...
        out["WorkflowVersions"] = (
            capo_mwaa_serverless.types.workflow_version_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListWorkflowVersionsResponse:
    ...
    if data.get("WorkflowVersions") is not None:
        ...
        out["workflow_versions"] = (
            capo_mwaa_serverless.types.workflow_version_summaries.deserialize_aws_json_1_0(
