...
class ListTaskInstancesResponse(TypedDict, closed=True):
    task_instances: NotRequired[
        "capo_mwaa_serverless.types.task_instance_summaries.TaskInstanceSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListTaskInstancesResponse) -> dict:
    ...
    if "task_instances" in value:
        ...
        out["TaskInstances"] = (
            capo_mwaa_serverless.types.task_instance_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListTaskInstancesResponse:
    ...
    if data.get("TaskInstances") is not None:
        ...
        out["task_instances"] = (
            capo_mwaa_serverless.types.task_instance_summaries.deserialize_aws_json_1_0(
                data["TaskInstances"]
            )
        )
