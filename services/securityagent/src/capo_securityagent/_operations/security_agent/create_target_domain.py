...
def handle_response(
    ...
    out: capo_securityagent.types.create_target_domain_output.CreateTargetDomainOutput = capo_securityagent.types.create_target_domain_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.create_target_domain_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
