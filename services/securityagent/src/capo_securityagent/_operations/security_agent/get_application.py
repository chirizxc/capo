...
def handle_response(
    ...
    out: capo_securityagent.types.get_application_response.GetApplicationResponse = (
        capo_securityagent.types.get_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.get_application_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
