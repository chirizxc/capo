...
def handle_response(
    ...
    out: capo_securityagent.types.list_discovered_endpoints_output.ListDiscoveredEndpointsOutput = capo_securityagent.types.list_discovered_endpoints_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.list_discovered_endpoints_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
