"""Generated from Smithy shape ``com.amazonaws.securityagent#BatchGetArtifactMetadata``."""
...
def handle_response(
    ...
    out: capo_securityagent.types.batch_get_artifact_metadata_output.BatchGetArtifactMetadataOutput = capo_securityagent.types.batch_get_artifact_metadata_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.batch_get_artifact_metadata_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_get_artifact_metadata(
