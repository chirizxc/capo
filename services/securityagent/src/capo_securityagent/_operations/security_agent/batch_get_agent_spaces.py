...
def handle_response(
    ...
    out: capo_securityagent.types.batch_get_agent_spaces_output.BatchGetAgentSpacesOutput = capo_securityagent.types.batch_get_agent_spaces_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.batch_get_agent_spaces_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
