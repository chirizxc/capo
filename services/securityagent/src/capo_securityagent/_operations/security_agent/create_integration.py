...
def handle_response(
    ...
    out: capo_securityagent.types.create_integration_output.CreateIntegrationOutput = (
        capo_securityagent.types.create_integration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.create_integration_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
