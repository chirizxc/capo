"""Generated from Smithy shape ``com.amazonaws.securityagent#CreateApplication``."""
...
def handle_response(
    ...
    out: capo_securityagent.types.create_application_response.CreateApplicationResponse = capo_securityagent.types.create_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.create_application_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
