...
def handle_response(
    ...
    out: capo_securityagent.types.start_code_review_job_output.StartCodeReviewJobOutput = capo_securityagent.types.start_code_review_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.start_code_review_job_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
