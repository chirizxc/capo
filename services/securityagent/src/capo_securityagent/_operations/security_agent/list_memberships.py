...
def handle_response(
    ...
    out: capo_securityagent.types.list_memberships_response.ListMembershipsResponse = (
        capo_securityagent.types.list_memberships_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.list_memberships_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
