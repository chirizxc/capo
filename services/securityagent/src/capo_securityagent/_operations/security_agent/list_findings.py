...
def handle_response(
    ...
    out: capo_securityagent.types.list_findings_output.ListFindingsOutput = (
        capo_securityagent.types.list_findings_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.list_findings_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_findings(
    ...
    capo_securityagent.types.list_findings_output.ListFindingsOutput, zapros.Response
]:
