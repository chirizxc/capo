...
def handle_response(
    ...
    out: capo_securityagent.types.list_applications_response.ListApplicationsResponse = capo_securityagent.types.list_applications_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.list_applications_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
