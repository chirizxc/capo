...
def handle_response(
    ...
    out: capo_securityagent.types.delete_membership_response.DeleteMembershipResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityagent.types.delete_membership_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
