...
if TYPE_CHECKING:
    ...
    import capo_service_catalog_appregistry.types.association_count
...
class GetApplicationResponse(TypedDict, closed=True):
    ...
    associated_resource_count: (
        "capo_service_catalog_appregistry.types.association_count.AssociationCount"
    )
    ...
    integrations: NotRequired[
        "capo_service_catalog_appregistry.types.integrations.Integrations"
    ]
...
def serialize_json(value: GetApplicationResponse) -> dict:
    ...
    if "integrations" in value:
        ...
        out["integrations"] = (
            capo_service_catalog_appregistry.types.integrations.serialize_json(
                value["integrations"]
            )
        )
...
def deserialize_json(data: dict) -> GetApplicationResponse:
    ...
    if data.get("integrations") is not None:
        ...
        out["integrations"] = (
            capo_service_catalog_appregistry.types.integrations.deserialize_json(
                data["integrations"]
            )
        )
