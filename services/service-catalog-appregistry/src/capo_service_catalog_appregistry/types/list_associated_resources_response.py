...
class ListAssociatedResourcesResponse(TypedDict, closed=True):
    resources: NotRequired["capo_service_catalog_appregistry.types.resources.Resources"]
...
def serialize_json(value: ListAssociatedResourcesResponse) -> dict:
    ...
    if "resources" in value:
        ...
        out["resources"] = (
            capo_service_catalog_appregistry.types.resources.serialize_json(
                value["resources"]
            )
        )
...
def deserialize_json(data: dict) -> ListAssociatedResourcesResponse:
    ...
    if data.get("resources") is not None:
        ...
        out["resources"] = (
            capo_service_catalog_appregistry.types.resources.deserialize_json(
                data["resources"]
            )
        )
