...
if TYPE_CHECKING:
    ...
    import capo_service_catalog_appregistry.types.resource_item_type
    import capo_service_catalog_appregistry.types.resources_list_item_error_message
...
class ResourcesListItem(TypedDict, closed=True):
    ...
    error_message: NotRequired[
        "capo_service_catalog_appregistry.types.resources_list_item_error_message.ResourcesListItemErrorMessage"
    ]
    """<p> The message returned if the call fails. </p>"""
    status: NotRequired["capo_service_catalog_appregistry.types.string.String"]
    """<p> The status of the list item. </p>"""
    resource_type: NotRequired[
        "capo_service_catalog_appregistry.types.resource_item_type.ResourceItemType"
    ]
