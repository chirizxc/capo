...
def handle_response(
    ...
    out: capo_service_catalog_appregistry.types.get_associated_resource_response.GetAssociatedResourceResponse = capo_service_catalog_appregistry.types.get_associated_resource_response.deserialize_json(
...
def build_request(
    ...
    if "resource_tag_status" in input_:
        for item in input_["resource_tag_status"]:
            params.append(
                (
                    "resourceTagStatus",
