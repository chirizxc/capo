...
from capo_service_catalog_appregistry._services._aws_config import aaws_config
...
class AsyncServiceCatalogAppRegistryClient:
    ...
    async def associate_attribute_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.associate_attribute_group_request.AssociateAttributeGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.associate_attribute_group_response.AssociateAttributeGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.associate_attribute_group.async_associate_attribute_group(
    ...
    async def associate_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.associate_resource_request.AssociateResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.associate_resource_response.AssociateResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.associate_resource.async_associate_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.create_application_request.CreateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.create_application_response.CreateApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.create_application.async_create_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_attribute_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.create_attribute_group_request.CreateAttributeGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.create_attribute_group_response.CreateAttributeGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.create_attribute_group.async_create_attribute_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.delete_application_request.DeleteApplicationRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.delete_application_response.DeleteApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.delete_application.async_delete_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_attribute_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.delete_attribute_group_request.DeleteAttributeGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.delete_attribute_group_response.DeleteAttributeGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.delete_attribute_group.async_delete_attribute_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_attribute_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.disassociate_attribute_group_request.DisassociateAttributeGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.disassociate_attribute_group_response.DisassociateAttributeGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.disassociate_attribute_group.async_disassociate_attribute_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.disassociate_resource_request.DisassociateResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.disassociate_resource_response.DisassociateResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.disassociate_resource.async_disassociate_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.get_application_request.GetApplicationRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.get_application_response.GetApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.get_application.async_get_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_associated_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.get_associated_resource_request.GetAssociatedResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.get_associated_resource_response.GetAssociatedResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.get_associated_resource.async_get_associated_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_attribute_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.get_attribute_group_request.GetAttributeGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.get_attribute_group_response.GetAttributeGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.get_attribute_group.async_get_attribute_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.get_configuration.async_get_configuration(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_applications(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.list_applications_request.ListApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.list_applications_response.ListApplicationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.list_applications.async_list_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_service_catalog_appregistry.types.application_summary.ApplicationSummary]":
        _token = next_token
        while True:
    ...
    async def list_associated_attribute_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.list_associated_attribute_groups_request.ListAssociatedAttributeGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.list_associated_attribute_groups_response.ListAssociatedAttributeGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.list_associated_attribute_groups.async_list_associated_attribute_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_service_catalog_appregistry.types.attribute_group_id.AttributeGroupId]":
        _token = next_token
        while True:
    ...
    async def list_associated_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.list_associated_resources_request.ListAssociatedResourcesRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.list_associated_resources_response.ListAssociatedResourcesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.list_associated_resources.async_list_associated_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_service_catalog_appregistry.types.resource_info.ResourceInfo]":
        _token = next_token
        while True:
    ...
    async def list_attribute_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.list_attribute_groups_request.ListAttributeGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.list_attribute_groups_response.ListAttributeGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.list_attribute_groups.async_list_attribute_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_service_catalog_appregistry.types.attribute_group_summary.AttributeGroupSummary]":
        _token = next_token
        while True:
    ...
    async def list_attribute_groups_for_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.list_attribute_groups_for_application_request.ListAttributeGroupsForApplicationRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.list_attribute_groups_for_application_response.ListAttributeGroupsForApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.list_attribute_groups_for_application.async_list_attribute_groups_for_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_service_catalog_appregistry.types.attribute_group_details.AttributeGroupDetails]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.put_configuration_request.PutConfigurationRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.put_configuration.async_put_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def sync_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.sync_resource_request.SyncResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.sync_resource_response.SyncResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.sync_resource.async_sync_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.update_application_request.UpdateApplicationRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.update_application_response.UpdateApplicationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.update_application.async_update_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_attribute_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_service_catalog_appregistry.types.update_attribute_group_request.UpdateAttributeGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_service_catalog_appregistry.types.update_attribute_group_response.UpdateAttributeGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_service_catalog_appregistry._operations.aws242_app_registry.update_attribute_group.async_update_attribute_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
