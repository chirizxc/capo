...
if TYPE_CHECKING:
    import capo_marketplace_discovery.types.use_case_entry

UseCaseList: TypeAlias = list[
    "capo_marketplace_discovery.types.use_case_entry.UseCaseEntry"
]
...
def serialize_json(value: UseCaseList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_marketplace_discovery.types.use_case_entry.serialize_json(item))
    return out
