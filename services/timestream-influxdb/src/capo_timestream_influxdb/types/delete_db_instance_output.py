"""Generated from Smithy shape ``com.amazonaws.timestreaminfluxdb#DeleteDbInstanceOutput``."""
...
class DeleteDbInstanceOutput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DeleteDbInstanceOutput) -> dict:
    out: dict = {}
    out["id"] = value["id"]
    out["name"] = value["name"]
    out["arn"] = value["arn"]
