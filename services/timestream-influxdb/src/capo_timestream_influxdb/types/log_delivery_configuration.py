...
class LogDeliveryConfiguration(TypedDict, closed=True):
    s3_configuration: "capo_timestream_influxdb.types.s3_configuration.S3Configuration"
...
def serialize_aws_json_1_0(value: LogDeliveryConfiguration) -> dict:
    ...
    out["s3Configuration"] = (
        capo_timestream_influxdb.types.s3_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> LogDeliveryConfiguration:
    ...
    if data.get("s3Configuration") is not None:
        ...
        out["s3_configuration"] = (
            capo_timestream_influxdb.types.s3_configuration.deserialize_aws_json_1_0(
