...
if TYPE_CHECKING:
    import capo_entityresolution.types.rule_condition

RuleConditionList: TypeAlias = list[
    "capo_entityresolution.types.rule_condition.RuleCondition"
]
...
def serialize_json(value: RuleConditionList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_entityresolution.types.rule_condition.serialize_json(item))
    return out
