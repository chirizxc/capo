...
def handle_response(
    ...
    out: capo_entityresolution.types.get_matching_workflow_output.GetMatchingWorkflowOutput = capo_entityresolution.types.get_matching_workflow_output.deserialize_json(
