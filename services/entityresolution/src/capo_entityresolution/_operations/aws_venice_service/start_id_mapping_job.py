...
def handle_response(
    ...
    out: capo_entityresolution.types.start_id_mapping_job_output.StartIdMappingJobOutput = capo_entityresolution.types.start_id_mapping_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.start_id_mapping_job_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
