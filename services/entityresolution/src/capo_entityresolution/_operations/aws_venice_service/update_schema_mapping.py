...
def handle_response(
    ...
    out: capo_entityresolution.types.update_schema_mapping_output.UpdateSchemaMappingOutput = capo_entityresolution.types.update_schema_mapping_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.update_schema_mapping_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
