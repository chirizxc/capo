...
def handle_response(
    ...
    out: capo_entityresolution.types.delete_schema_mapping_output.DeleteSchemaMappingOutput = capo_entityresolution.types.delete_schema_mapping_output.deserialize_json(
