...
def handle_response(
    ...
    out: capo_entityresolution.types.delete_policy_statement_output.DeletePolicyStatementOutput = capo_entityresolution.types.delete_policy_statement_output.deserialize_json(
