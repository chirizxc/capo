...
def handle_response(
    ...
    out: capo_entityresolution.types.update_id_mapping_workflow_output.UpdateIdMappingWorkflowOutput = capo_entityresolution.types.update_id_mapping_workflow_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.update_id_mapping_workflow_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
