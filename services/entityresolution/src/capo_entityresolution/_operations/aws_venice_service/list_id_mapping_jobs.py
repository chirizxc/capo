...
def handle_response(
    ...
    out: capo_entityresolution.types.list_id_mapping_jobs_output.ListIdMappingJobsOutput = capo_entityresolution.types.list_id_mapping_jobs_output.deserialize_json(
