...
def handle_response(
    ...
    out: capo_entityresolution.types.get_id_mapping_workflow_output.GetIdMappingWorkflowOutput = capo_entityresolution.types.get_id_mapping_workflow_output.deserialize_json(
