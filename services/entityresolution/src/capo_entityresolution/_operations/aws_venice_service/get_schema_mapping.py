"""Generated from Smithy shape ``com.amazonaws.entityresolution#GetSchemaMapping``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.get_schema_mapping_output.GetSchemaMappingOutput = capo_entityresolution.types.get_schema_mapping_output.deserialize_json(
...
async def async_get_schema_mapping(
