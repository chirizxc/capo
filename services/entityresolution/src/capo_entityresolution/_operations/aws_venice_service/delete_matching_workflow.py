...
def handle_response(
    ...
    out: capo_entityresolution.types.delete_matching_workflow_output.DeleteMatchingWorkflowOutput = capo_entityresolution.types.delete_matching_workflow_output.deserialize_json(
