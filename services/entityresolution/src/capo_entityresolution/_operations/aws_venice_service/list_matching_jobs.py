"""Generated from Smithy shape ``com.amazonaws.entityresolution#ListMatchingJobs``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.list_matching_jobs_output.ListMatchingJobsOutput = capo_entityresolution.types.list_matching_jobs_output.deserialize_json(
...
async def async_list_matching_jobs(
