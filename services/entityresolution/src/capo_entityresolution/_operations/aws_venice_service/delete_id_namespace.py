...
def handle_response(
    ...
    out: capo_entityresolution.types.delete_id_namespace_output.DeleteIdNamespaceOutput = capo_entityresolution.types.delete_id_namespace_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{idNamespaceName}", quote(input_["id_namespace_name"], safe=""))
