"""Generated from Smithy shape ``com.amazonaws.entityresolution#ListIdMappingWorkflows``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.list_id_mapping_workflows_output.ListIdMappingWorkflowsOutput = capo_entityresolution.types.list_id_mapping_workflows_output.deserialize_json(
...
async def async_list_id_mapping_workflows(
