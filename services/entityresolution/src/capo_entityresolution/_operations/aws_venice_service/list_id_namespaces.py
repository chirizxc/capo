"""Generated from Smithy shape ``com.amazonaws.entityresolution#ListIdNamespaces``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.list_id_namespaces_output.ListIdNamespacesOutput = capo_entityresolution.types.list_id_namespaces_output.deserialize_json(
...
async def async_list_id_namespaces(
