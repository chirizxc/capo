"""Generated from Smithy shape ``com.amazonaws.entityresolution#UntagResource``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
