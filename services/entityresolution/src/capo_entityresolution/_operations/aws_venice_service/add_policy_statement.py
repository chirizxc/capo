"""Generated from Smithy shape ``com.amazonaws.entityresolution#AddPolicyStatement``."""
...
def handle_response(
    ...
    out: capo_entityresolution.types.add_policy_statement_output.AddPolicyStatementOutput = capo_entityresolution.types.add_policy_statement_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_entityresolution.types.add_policy_statement_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_add_policy_statement(
