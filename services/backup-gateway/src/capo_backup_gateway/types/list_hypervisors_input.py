"""Generated from Smithy shape ``com.amazonaws.backupgateway#ListHypervisorsInput``."""
...
class ListHypervisorsInput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListHypervisorsInput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListHypervisorsInput:
    out: ListHypervisorsInput = {}  # type: ignore[typeddict-item]
