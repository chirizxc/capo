...
def handle_response(
    ...
    out: capo_backup_gateway.types.put_maintenance_start_time_output.PutMaintenanceStartTimeOutput = capo_backup_gateway.types.put_maintenance_start_time_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.put_maintenance_start_time_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
