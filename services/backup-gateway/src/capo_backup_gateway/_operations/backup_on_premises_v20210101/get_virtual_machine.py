...
import capo_backup_gateway.types.virtual_machine_details
...
def handle_response(
    ...
    out: capo_backup_gateway.types.get_virtual_machine_output.GetVirtualMachineOutput = capo_backup_gateway.types.get_virtual_machine_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.get_virtual_machine_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
