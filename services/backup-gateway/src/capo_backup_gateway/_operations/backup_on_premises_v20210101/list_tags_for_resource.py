"""Generated from Smithy shape ``com.amazonaws.backupgateway#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_backup_gateway.types.list_tags_for_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BackupOnPremises_v20210101.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.list_tags_for_resource_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
