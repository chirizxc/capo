"""Generated from Smithy shape ``com.amazonaws.backupgateway#DeleteGateway``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.delete_gateway_output.DeleteGatewayOutput = (
        capo_backup_gateway.types.delete_gateway_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BackupOnPremises_v20210101.DeleteGateway"
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.delete_gateway_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def delete_gateway(
    ...
    capo_backup_gateway.types.delete_gateway_output.DeleteGatewayOutput, zapros.Response
]:
