...
def handle_response(
    ...
    out: capo_backup_gateway.types.create_gateway_output.CreateGatewayOutput = (
        capo_backup_gateway.types.create_gateway_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.create_gateway_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def create_gateway(
    ...
    capo_backup_gateway.types.create_gateway_output.CreateGatewayOutput, zapros.Response
]:
