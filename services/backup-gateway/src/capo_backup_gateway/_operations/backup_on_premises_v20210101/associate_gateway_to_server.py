...
def handle_response(
    ...
    out: capo_backup_gateway.types.associate_gateway_to_server_output.AssociateGatewayToServerOutput = capo_backup_gateway.types.associate_gateway_to_server_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.associate_gateway_to_server_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
