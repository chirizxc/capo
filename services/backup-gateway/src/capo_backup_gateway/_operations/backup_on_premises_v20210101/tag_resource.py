"""Generated from Smithy shape ``com.amazonaws.backupgateway#TagResource``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.tag_resource_output.TagResourceOutput = (
        capo_backup_gateway.types.tag_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BackupOnPremises_v20210101.TagResource"
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.tag_resource_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_backup_gateway.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
