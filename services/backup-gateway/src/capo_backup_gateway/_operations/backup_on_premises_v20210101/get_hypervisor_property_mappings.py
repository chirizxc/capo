...
def handle_response(
    ...
    out: capo_backup_gateway.types.get_hypervisor_property_mappings_output.GetHypervisorPropertyMappingsOutput = capo_backup_gateway.types.get_hypervisor_property_mappings_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.get_hypervisor_property_mappings_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
