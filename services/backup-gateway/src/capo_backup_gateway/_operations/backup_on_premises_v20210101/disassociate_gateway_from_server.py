"""Generated from Smithy shape ``com.amazonaws.backupgateway#DisassociateGatewayFromServer``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.disassociate_gateway_from_server_output.DisassociateGatewayFromServerOutput = capo_backup_gateway.types.disassociate_gateway_from_server_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BackupOnPremises_v20210101.DisassociateGatewayFromServer"
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.disassociate_gateway_from_server_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_gateway_from_server(
