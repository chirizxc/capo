"""Generated from Smithy shape ``com.amazonaws.backupgateway#StartVirtualMachinesMetadataSync``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.start_virtual_machines_metadata_sync_output.StartVirtualMachinesMetadataSyncOutput = capo_backup_gateway.types.start_virtual_machines_metadata_sync_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.start_virtual_machines_metadata_sync_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
