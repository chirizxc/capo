...
def handle_response(
    ...
    out: capo_backup_gateway.types.list_hypervisors_output.ListHypervisorsOutput = (
        capo_backup_gateway.types.list_hypervisors_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.list_hypervisors_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
