"""Generated from Smithy shape ``com.amazonaws.backupgateway#UpdateGatewayInformation``."""
...
def handle_response(
    ...
    out: capo_backup_gateway.types.update_gateway_information_output.UpdateGatewayInformationOutput = capo_backup_gateway.types.update_gateway_information_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "BackupOnPremises_v20210101.UpdateGatewayInformation"
    body: bytes | None = json.dumps(
        capo_backup_gateway.types.update_gateway_information_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
