...
if TYPE_CHECKING:
    ...
    import capo_voice_id.types.fraud_detection_action
...
class EnrollmentJobFraudDetectionConfig(TypedDict, closed=True):
    fraud_detection_action: NotRequired[
        "capo_voice_id.types.fraud_detection_action.FraudDetectionAction"
    ]
    ...
    watchlist_ids: NotRequired[
        "capo_voice_id.types.enrollment_job_fraud_detection_config_watchlist_ids.EnrollmentJobFraudDetectionConfigWatchlistIds"
    ]
...
def serialize_aws_json_1_0(value: EnrollmentJobFraudDetectionConfig) -> dict:
    ...
    if "watchlist_ids" in value:
        ...
        out["WatchlistIds"] = (
            capo_voice_id.types.enrollment_job_fraud_detection_config_watchlist_ids.serialize_aws_json_1_0(
                value["watchlist_ids"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> EnrollmentJobFraudDetectionConfig:
    ...
    if data.get("WatchlistIds") is not None:
        ...
        out["watchlist_ids"] = (
            capo_voice_id.types.enrollment_job_fraud_detection_config_watchlist_ids.deserialize_aws_json_1_0(
                data["WatchlistIds"]
            )
        )
    return out
