...
from capo_voice_id._resources.voice_id.domain_resource import AsyncDomainResource
from capo_voice_id._services._aws_config import aaws_config
...
class AsyncVoiceIDClient:
    ...
    async def associate_fraudster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.associate_fraudster_request.AssociateFraudsterRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.associate_fraudster_response.AssociateFraudsterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.associate_fraudster.async_associate_fraudster(
    ...
    async def create_watchlist(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.create_watchlist_request.CreateWatchlistRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.create_watchlist_response.CreateWatchlistResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.create_watchlist.async_create_watchlist(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_fraudster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.delete_fraudster_request.DeleteFraudsterRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.delete_fraudster.async_delete_fraudster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_speaker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.delete_speaker_request.DeleteSpeakerRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.delete_speaker.async_delete_speaker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_watchlist(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.delete_watchlist_request.DeleteWatchlistRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.delete_watchlist.async_delete_watchlist(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_fraudster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.describe_fraudster_request.DescribeFraudsterRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.describe_fraudster_response.DescribeFraudsterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.describe_fraudster.async_describe_fraudster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_fraudster_registration_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.describe_fraudster_registration_job_request.DescribeFraudsterRegistrationJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.describe_fraudster_registration_job_response.DescribeFraudsterRegistrationJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.describe_fraudster_registration_job.async_describe_fraudster_registration_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_speaker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.describe_speaker_request.DescribeSpeakerRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.describe_speaker_response.DescribeSpeakerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.describe_speaker.async_describe_speaker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_speaker_enrollment_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.describe_speaker_enrollment_job_request.DescribeSpeakerEnrollmentJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.describe_speaker_enrollment_job_response.DescribeSpeakerEnrollmentJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.describe_speaker_enrollment_job.async_describe_speaker_enrollment_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_watchlist(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.describe_watchlist_request.DescribeWatchlistRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.describe_watchlist_response.DescribeWatchlistResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.describe_watchlist.async_describe_watchlist(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_fraudster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.disassociate_fraudster_request.DisassociateFraudsterRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.disassociate_fraudster_response.DisassociateFraudsterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.disassociate_fraudster.async_disassociate_fraudster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def evaluate_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.evaluate_session_request.EvaluateSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.evaluate_session_response.EvaluateSessionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.evaluate_session.async_evaluate_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_fraudster_registration_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.list_fraudster_registration_jobs_request.ListFraudsterRegistrationJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.list_fraudster_registration_jobs_response.ListFraudsterRegistrationJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.list_fraudster_registration_jobs.async_list_fraudster_registration_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_fraudster_registration_jobs(
        ...
        *,
        ...
        next_token: Optional["capo_voice_id.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_voice_id.types.fraudster_registration_job_summary.FraudsterRegistrationJobSummary]":
        _token = next_token
        while True:
    ...
    async def list_fraudsters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.list_fraudsters_request.ListFraudstersRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.list_fraudsters_response.ListFraudstersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.list_fraudsters.async_list_fraudsters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_fraudsters(
        ...
        *,
        ...
        next_token: Optional["capo_voice_id.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_voice_id.types.fraudster_summary.FraudsterSummary]":
        _token = next_token
        while True:
    ...
    async def list_speaker_enrollment_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.list_speaker_enrollment_jobs_request.ListSpeakerEnrollmentJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.list_speaker_enrollment_jobs_response.ListSpeakerEnrollmentJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.list_speaker_enrollment_jobs.async_list_speaker_enrollment_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_speaker_enrollment_jobs(
        ...
        *,
        ...
        next_token: Optional["capo_voice_id.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_voice_id.types.speaker_enrollment_job_summary.SpeakerEnrollmentJobSummary]":
        _token = next_token
        while True:
    ...
    async def list_speakers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.list_speakers_request.ListSpeakersRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.list_speakers_response.ListSpeakersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.list_speakers.async_list_speakers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_speakers(
        ...
        *,
        ...
        next_token: Optional["capo_voice_id.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_voice_id.types.speaker_summary.SpeakerSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_watchlists(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.list_watchlists_request.ListWatchlistsRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.list_watchlists_response.ListWatchlistsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.list_watchlists.async_list_watchlists(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_watchlists(
        ...
        *,
        ...
        next_token: Optional["capo_voice_id.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_voice_id.types.watchlist_summary.WatchlistSummary]":
        _token = next_token
        while True:
    ...
    async def opt_out_speaker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.opt_out_speaker_request.OptOutSpeakerRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.opt_out_speaker_response.OptOutSpeakerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.opt_out_speaker.async_opt_out_speaker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_fraudster_registration_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.start_fraudster_registration_job_request.StartFraudsterRegistrationJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.start_fraudster_registration_job_response.StartFraudsterRegistrationJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.start_fraudster_registration_job.async_start_fraudster_registration_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_speaker_enrollment_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.start_speaker_enrollment_job_request.StartSpeakerEnrollmentJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.start_speaker_enrollment_job_response.StartSpeakerEnrollmentJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.start_speaker_enrollment_job.async_start_speaker_enrollment_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_watchlist(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_voice_id.types.update_watchlist_request.UpdateWatchlistRequest]",
        ) -> AsyncOperationResponse[
            "capo_voice_id.types.update_watchlist_response.UpdateWatchlistResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_voice_id._operations.voice_id.update_watchlist.async_update_watchlist(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
