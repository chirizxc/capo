...
def handle_response(
    ...
    out: capo_voice_id.types.opt_out_speaker_response.OptOutSpeakerResponse = (
        capo_voice_id.types.opt_out_speaker_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.opt_out_speaker_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def opt_out_speaker(
    ...
    capo_voice_id.types.opt_out_speaker_response.OptOutSpeakerResponse, zapros.Response
]:
