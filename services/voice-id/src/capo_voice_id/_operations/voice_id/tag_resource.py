...
def handle_response(
    ...
    out: capo_voice_id.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.tag_resource_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_voice_id.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
