"""Generated from Smithy shape ``com.amazonaws.voiceid#DeleteSpeaker``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.DeleteSpeaker"
    body: bytes | None = json.dumps(
        capo_voice_id.types.delete_speaker_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_speaker(
