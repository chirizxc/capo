"""Generated from Smithy shape ``com.amazonaws.voiceid#CreateWatchlist``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.create_watchlist_response.CreateWatchlistResponse = (
        capo_voice_id.types.create_watchlist_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.CreateWatchlist"
    body: bytes | None = json.dumps(
        capo_voice_id.types.create_watchlist_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
