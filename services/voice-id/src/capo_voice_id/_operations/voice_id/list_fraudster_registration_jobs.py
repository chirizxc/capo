...
def handle_response(
    ...
    out: capo_voice_id.types.list_fraudster_registration_jobs_response.ListFraudsterRegistrationJobsResponse = capo_voice_id.types.list_fraudster_registration_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.list_fraudster_registration_jobs_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
