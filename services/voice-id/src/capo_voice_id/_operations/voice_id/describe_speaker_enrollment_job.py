"""Generated from Smithy shape ``com.amazonaws.voiceid#DescribeSpeakerEnrollmentJob``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.describe_speaker_enrollment_job_response.DescribeSpeakerEnrollmentJobResponse = capo_voice_id.types.describe_speaker_enrollment_job_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.DescribeSpeakerEnrollmentJob"
    body: bytes | None = json.dumps(
        capo_voice_id.types.describe_speaker_enrollment_job_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_speaker_enrollment_job(
