...
def handle_response(
    ...
    out: capo_voice_id.types.update_watchlist_response.UpdateWatchlistResponse = (
        capo_voice_id.types.update_watchlist_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.update_watchlist_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
