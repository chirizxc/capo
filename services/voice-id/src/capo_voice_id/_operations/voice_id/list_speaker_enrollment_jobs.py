"""Generated from Smithy shape ``com.amazonaws.voiceid#ListSpeakerEnrollmentJobs``."""
...
def handle_response(
    ...
    out: capo_voice_id.types.list_speaker_enrollment_jobs_response.ListSpeakerEnrollmentJobsResponse = capo_voice_id.types.list_speaker_enrollment_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VoiceID.ListSpeakerEnrollmentJobs"
    body: bytes | None = json.dumps(
        capo_voice_id.types.list_speaker_enrollment_jobs_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_speaker_enrollment_jobs(
