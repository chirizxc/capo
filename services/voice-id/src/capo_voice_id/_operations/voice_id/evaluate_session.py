...
def handle_response(
    ...
    out: capo_voice_id.types.evaluate_session_response.EvaluateSessionResponse = (
        capo_voice_id.types.evaluate_session_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_voice_id.types.evaluate_session_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
