...
def handle_response(
    ...
    out: capo_schemas.types.describe_code_binding_response.DescribeCodeBindingResponse = capo_schemas.types.describe_code_binding_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{Language}", quote(input_["language"], safe=""))
