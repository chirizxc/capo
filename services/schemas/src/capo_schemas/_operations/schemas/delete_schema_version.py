"""Generated from Smithy shape ``com.amazonaws.schemas#DeleteSchemaVersion``."""
...
def build_request(
    ...
    url = url.replace("{SchemaVersion}", quote(input_["schema_version"], safe=""))
...
async def async_delete_schema_version(
