"""Generated from Smithy shape ``com.amazonaws.schemas#ListDiscoverers``."""
...
import capo_schemas.types.__list_of_discoverer_summary
...
def handle_response(
    ...
    out: capo_schemas.types.list_discoverers_response.ListDiscoverersResponse = (
        capo_schemas.types.list_discoverers_response.deserialize_json(
...
def build_request(
    ...
    if "discoverer_id_prefix" in input_:
        params.append(("discovererIdPrefix", input_["discoverer_id_prefix"]))
    if "limit" in input_:
        params.append(("limit", str(input_["limit"])))
    if "next_token" in input_:
        params.append(("nextToken", input_["next_token"]))
    if "source_arn_prefix" in input_:
        params.append(("sourceArnPrefix", input_["source_arn_prefix"]))
...
async def async_list_discoverers(
