...
def handle_response(
    ...
    out: capo_schemas.types.create_registry_response.CreateRegistryResponse = (
        capo_schemas.types.create_registry_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_schemas.types.create_registry_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_registry(
    ...
    capo_schemas.types.create_registry_response.CreateRegistryResponse, zapros.Response
]:
