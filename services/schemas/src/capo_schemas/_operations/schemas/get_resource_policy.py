...
def handle_response(
    ...
    out: capo_schemas.types.get_resource_policy_response.GetResourcePolicyResponse = (
        capo_schemas.types.get_resource_policy_response.deserialize_json(
...
def build_request(
    ...
    if "registry_name" in input_:
        params.append(("registryName", input_["registry_name"]))
