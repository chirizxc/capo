...
def handle_response(
    ...
    out: capo_schemas.types.list_registries_response.ListRegistriesResponse = (
        capo_schemas.types.list_registries_response.deserialize_json(
...
def build_request(
    ...
    if "registry_name_prefix" in input_:
        params.append(("registryNamePrefix", input_["registry_name_prefix"]))
    if "scope" in input_:
        params.append(("scope", input_["scope"]))
...
def list_registries(
    ...
    capo_schemas.types.list_registries_response.ListRegistriesResponse, zapros.Response
]:
