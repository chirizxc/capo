"""Generated from Smithy shape ``com.amazonaws.schemas#DescribeSchema``."""
...
def handle_response(
    ...
    out: capo_schemas.types.describe_schema_response.DescribeSchemaResponse = (
        capo_schemas.types.describe_schema_response.deserialize_json(
...
def describe_schema(
    ...
    capo_schemas.types.describe_schema_response.DescribeSchemaResponse, zapros.Response
]:
