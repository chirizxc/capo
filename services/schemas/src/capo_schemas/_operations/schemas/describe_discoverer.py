"""Generated from Smithy shape ``com.amazonaws.schemas#DescribeDiscoverer``."""
...
def handle_response(
    ...
    out: capo_schemas.types.describe_discoverer_response.DescribeDiscovererResponse = (
        capo_schemas.types.describe_discoverer_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{DiscovererId}", quote(input_["discoverer_id"], safe=""))
...
async def async_describe_discoverer(
