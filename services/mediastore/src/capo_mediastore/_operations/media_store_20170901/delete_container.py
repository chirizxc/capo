...
def handle_response(
    ...
    out: capo_mediastore.types.delete_container_output.DeleteContainerOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.delete_container_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_container(
    ...
    capo_mediastore.types.delete_container_output.DeleteContainerOutput, zapros.Response
]:
