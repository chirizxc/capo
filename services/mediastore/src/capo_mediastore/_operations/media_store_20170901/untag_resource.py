"""Generated from Smithy shape ``com.amazonaws.mediastore#UntagResource``."""
...
def handle_response(
    ...
    out: capo_mediastore.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.untag_resource_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def untag_resource(
    ...
    capo_mediastore.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
