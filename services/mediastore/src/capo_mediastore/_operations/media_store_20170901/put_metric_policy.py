...
def handle_response(
    ...
    out: capo_mediastore.types.put_metric_policy_output.PutMetricPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.put_metric_policy_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
