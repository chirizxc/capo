...
def handle_response(
    ...
    out: capo_mediastore.types.get_cors_policy_output.GetCorsPolicyOutput = (
        capo_mediastore.types.get_cors_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.get_cors_policy_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_cors_policy(
    ...
    capo_mediastore.types.get_cors_policy_output.GetCorsPolicyOutput, zapros.Response
]:
