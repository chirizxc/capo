...
def handle_response(
    ...
    out: capo_mediastore.types.list_containers_output.ListContainersOutput = (
        capo_mediastore.types.list_containers_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.list_containers_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_containers(
    ...
    capo_mediastore.types.list_containers_output.ListContainersOutput, zapros.Response
]:
