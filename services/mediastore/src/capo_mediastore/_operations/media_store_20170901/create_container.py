"""Generated from Smithy shape ``com.amazonaws.mediastore#CreateContainer``."""
...
import capo_mediastore.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_mediastore.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_mediastore.types.create_container_output.CreateContainerOutput = (
        capo_mediastore.types.create_container_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.create_container_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_container(
    ...
    capo_mediastore.types.create_container_output.CreateContainerOutput, zapros.Response
]:
