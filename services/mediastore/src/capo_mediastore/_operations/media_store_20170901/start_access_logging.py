"""Generated from Smithy shape ``com.amazonaws.mediastore#StartAccessLogging``."""
...
def handle_response(
    ...
    out: capo_mediastore.types.start_access_logging_output.StartAccessLoggingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.start_access_logging_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_access_logging(
