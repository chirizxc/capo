"""Generated from Smithy shape ``com.amazonaws.mediastore#DeleteContainerPolicy``."""
...
def handle_response(
    ...
    out: capo_mediastore.types.delete_container_policy_output.DeleteContainerPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.delete_container_policy_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_container_policy(
