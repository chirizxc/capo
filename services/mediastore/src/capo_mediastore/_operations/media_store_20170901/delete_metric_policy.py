"""Generated from Smithy shape ``com.amazonaws.mediastore#DeleteMetricPolicy``."""
...
def handle_response(
    ...
    out: capo_mediastore.types.delete_metric_policy_output.DeleteMetricPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "MediaStore_20170901.DeleteMetricPolicy"
    body: bytes | None = json.dumps(
        capo_mediastore.types.delete_metric_policy_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_metric_policy(
