"""Generated from Smithy shape ``com.amazonaws.mediastore#PutContainerPolicy``."""
...
def handle_response(
    ...
    out: capo_mediastore.types.put_container_policy_output.PutContainerPolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.put_container_policy_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_put_container_policy(
