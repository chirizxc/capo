"""Generated from Smithy shape ``com.amazonaws.mediastore#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_mediastore.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_mediastore.types.list_tags_for_resource_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediastore.types.list_tags_for_resource_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
