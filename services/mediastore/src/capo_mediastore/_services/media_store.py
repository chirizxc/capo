...
class MediaStoreClientConfig(TypedDict, total=False, closed=True):
...
class MediaStoreClient:
    ...
    def create_container(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.create_container_input.CreateContainerInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.create_container_output.CreateContainerOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.create_container.create_container(
    ...
    def delete_container(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.delete_container_input.DeleteContainerInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.delete_container_output.DeleteContainerOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.delete_container.delete_container(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_container_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.delete_container_policy_input.DeleteContainerPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.delete_container_policy_output.DeleteContainerPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.delete_container_policy.delete_container_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cors_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.delete_cors_policy_input.DeleteCorsPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.delete_cors_policy_output.DeleteCorsPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.delete_cors_policy.delete_cors_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.delete_lifecycle_policy_input.DeleteLifecyclePolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.delete_lifecycle_policy_output.DeleteLifecyclePolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.delete_lifecycle_policy.delete_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_metric_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.delete_metric_policy_input.DeleteMetricPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.delete_metric_policy_output.DeleteMetricPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.delete_metric_policy.delete_metric_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_container(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.describe_container_input.DescribeContainerInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.describe_container_output.DescribeContainerOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.describe_container.describe_container(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_container_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.get_container_policy_input.GetContainerPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.get_container_policy_output.GetContainerPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.get_container_policy.get_container_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_cors_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.get_cors_policy_input.GetCorsPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.get_cors_policy_output.GetCorsPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.get_cors_policy.get_cors_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.get_lifecycle_policy_input.GetLifecyclePolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.get_lifecycle_policy_output.GetLifecyclePolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.get_lifecycle_policy.get_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_metric_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.get_metric_policy_input.GetMetricPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.get_metric_policy_output.GetMetricPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.get_metric_policy.get_metric_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_containers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.list_containers_input.ListContainersInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.list_containers_output.ListContainersOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.list_containers.list_containers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_container_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.put_container_policy_input.PutContainerPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.put_container_policy_output.PutContainerPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.put_container_policy.put_container_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_cors_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.put_cors_policy_input.PutCorsPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.put_cors_policy_output.PutCorsPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.put_cors_policy.put_cors_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_lifecycle_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.put_lifecycle_policy_input.PutLifecyclePolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.put_lifecycle_policy_output.PutLifecyclePolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.put_lifecycle_policy.put_lifecycle_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_metric_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.put_metric_policy_input.PutMetricPolicyInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.put_metric_policy_output.PutMetricPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.put_metric_policy.put_metric_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_access_logging(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.start_access_logging_input.StartAccessLoggingInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.start_access_logging_output.StartAccessLoggingOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.start_access_logging.start_access_logging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_access_logging(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.stop_access_logging_input.StopAccessLoggingInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.stop_access_logging_output.StopAccessLoggingOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.stop_access_logging.stop_access_logging(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_mediastore.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "capo_mediastore.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_mediastore._operations.media_store_20170901.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
