...
if TYPE_CHECKING:
    import capo_vpc_lattice.types.private_dns_preference
...
class DnsOptions(TypedDict, closed=True):
    private_dns_preference: NotRequired[
        "capo_vpc_lattice.types.private_dns_preference.PrivateDnsPreference"
    ]
    ...
    private_dns_specified_domains: NotRequired[
        "capo_vpc_lattice.types.private_dns_specified_domains_list.PrivateDnsSpecifiedDomainsList"
    ]
...
def serialize_json(value: DnsOptions) -> dict:
    ...
    if "private_dns_specified_domains" in value:
        ...
        out["privateDnsSpecifiedDomains"] = (
            capo_vpc_lattice.types.private_dns_specified_domains_list.serialize_json(
...
def deserialize_json(data: dict) -> DnsOptions:
    ...
    if data.get("privateDnsSpecifiedDomains") is not None:
        ...
        out["private_dns_specified_domains"] = (
            capo_vpc_lattice.types.private_dns_specified_domains_list.deserialize_json(
