"""Generated from Smithy shape ``com.amazonaws.vpclattice#GetResourceConfiguration``."""
...
def handle_response(
    ...
    out: capo_vpc_lattice.types.get_resource_configuration_response.GetResourceConfigurationResponse = capo_vpc_lattice.types.get_resource_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["resource_configuration_identifier"], safe=""),
    )
...
async def async_get_resource_configuration(
