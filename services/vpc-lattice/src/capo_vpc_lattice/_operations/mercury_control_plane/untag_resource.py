"""Generated from Smithy shape ``com.amazonaws.vpclattice#UntagResource``."""
...
def handle_response(
    ...
    out: capo_vpc_lattice.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
