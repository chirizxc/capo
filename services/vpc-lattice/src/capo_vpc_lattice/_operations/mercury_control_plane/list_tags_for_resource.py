...
def handle_response(
    ...
    out: capo_vpc_lattice.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_vpc_lattice.types.list_tags_for_resource_response.deserialize_json(
