"""Generated from Smithy shape ``com.amazonaws.vpclattice#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.vpclattice#InternalServerException``."""
