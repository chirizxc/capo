...
class RequestFilter(TypedDict, closed=True):
    actions: NotRequired[
        "capo_bcm_recommended_actions.types.action_filter_list.ActionFilterList"
    ]
...
def serialize_aws_json_1_0(value: RequestFilter) -> dict:
    ...
    if "actions" in value:
        ...
        out["actions"] = (
            capo_bcm_recommended_actions.types.action_filter_list.serialize_aws_json_1_0(
                value["actions"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> RequestFilter:
    ...
    if data.get("actions") is not None:
        ...
        out["actions"] = (
            capo_bcm_recommended_actions.types.action_filter_list.deserialize_aws_json_1_0(
                data["actions"]
            )
        )
    return out
