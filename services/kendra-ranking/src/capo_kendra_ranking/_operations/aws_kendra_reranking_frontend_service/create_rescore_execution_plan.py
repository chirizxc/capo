"""Generated from Smithy shape ``com.amazonaws.kendraranking#CreateRescoreExecutionPlan``."""
...
import capo_kendra_ranking._protocol.eventstream
...
def handle_response(
    ...
    out: capo_kendra_ranking.types.create_rescore_execution_plan_response.CreateRescoreExecutionPlanResponse = capo_kendra_ranking.types.create_rescore_execution_plan_response.deserialize_aws_json_1_0(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_kendra_ranking._auth._sigv4.build_sigv4_auth_scheme(
                "kendra-ranking", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra_ranking.types.create_rescore_execution_plan_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_rescore_execution_plan(
