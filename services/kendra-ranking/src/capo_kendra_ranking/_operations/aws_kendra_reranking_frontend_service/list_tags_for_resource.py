"""Generated from Smithy shape ``com.amazonaws.kendraranking#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_kendra_ranking.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_kendra_ranking.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraRerankingFrontendService.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_kendra_ranking.types.list_tags_for_resource_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
