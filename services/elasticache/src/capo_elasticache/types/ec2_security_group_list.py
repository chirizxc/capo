"""Generated from Smithy shape ``com.amazonaws.elasticache#EC2SecurityGroupList``."""
...
if TYPE_CHECKING:
    import capo_elasticache.types.ec2_security_group

EC2SecurityGroupList: TypeAlias = list[
    "capo_elasticache.types.ec2_security_group.EC2SecurityGroup"
]
...
def serialize_query(
    ...
    for n, item in enumerate(value, 1):
        capo_elasticache.types.ec2_security_group.serialize_query(
...
def deserialize_query(el: Element) -> EC2SecurityGroupList:
    ...
    for child in el.findall("EC2SecurityGroup"):
        out.append(capo_elasticache.types.ec2_security_group.deserialize_query(child))
    return out
