...
from capo_elasticache._services._aws_config import aws_config
...
class ElastiCacheClient:
    ...
    def add_tags_to_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.add_tags_to_resource_message.AddTagsToResourceMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.tag_list_message.TagListMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.add_tags_to_resource.add_tags_to_resource(
    ...
    def authorize_cache_security_group_ingress(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.authorize_cache_security_group_ingress_message.AuthorizeCacheSecurityGroupIngressMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.authorize_cache_security_group_ingress_result.AuthorizeCacheSecurityGroupIngressResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.authorize_cache_security_group_ingress.authorize_cache_security_group_ingress(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_apply_update_action(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.batch_apply_update_action_message.BatchApplyUpdateActionMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.update_action_results_message.UpdateActionResultsMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.batch_apply_update_action.batch_apply_update_action(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_stop_update_action(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.batch_stop_update_action_message.BatchStopUpdateActionMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.update_action_results_message.UpdateActionResultsMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.batch_stop_update_action.batch_stop_update_action(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def complete_migration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.complete_migration_message.CompleteMigrationMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.complete_migration_response.CompleteMigrationResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.complete_migration.complete_migration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_serverless_cache_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.copy_serverless_cache_snapshot_request.CopyServerlessCacheSnapshotRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.copy_serverless_cache_snapshot_response.CopyServerlessCacheSnapshotResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.copy_serverless_cache_snapshot.copy_serverless_cache_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.copy_snapshot_message.CopySnapshotMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.copy_snapshot_result.CopySnapshotResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.copy_snapshot.copy_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cache_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_cache_cluster_message.CreateCacheClusterMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_cache_cluster_result.CreateCacheClusterResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_cache_cluster.create_cache_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cache_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_cache_parameter_group_message.CreateCacheParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_cache_parameter_group_result.CreateCacheParameterGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_cache_parameter_group.create_cache_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cache_security_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_cache_security_group_message.CreateCacheSecurityGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_cache_security_group_result.CreateCacheSecurityGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_cache_security_group.create_cache_security_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cache_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_cache_subnet_group_message.CreateCacheSubnetGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_cache_subnet_group_result.CreateCacheSubnetGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_cache_subnet_group.create_cache_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_global_replication_group_message.CreateGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_global_replication_group_result.CreateGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_global_replication_group.create_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_replication_group_message.CreateReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_replication_group_result.CreateReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_replication_group.create_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_serverless_cache(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_serverless_cache_request.CreateServerlessCacheRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_serverless_cache_response.CreateServerlessCacheResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_serverless_cache.create_serverless_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_serverless_cache_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_serverless_cache_snapshot_request.CreateServerlessCacheSnapshotRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_serverless_cache_snapshot_response.CreateServerlessCacheSnapshotResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_serverless_cache_snapshot.create_serverless_cache_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_snapshot_message.CreateSnapshotMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.create_snapshot_result.CreateSnapshotResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_snapshot.create_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_user(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_user_message.CreateUserMessage]",
        ) -> OperationResponse["capo_elasticache.types.user.User"]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.create_user

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_user.create_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_user_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.create_user_group_message.CreateUserGroupMessage]",
        ) -> OperationResponse["capo_elasticache.types.user_group.UserGroup"]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.create_user_group

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.create_user_group.create_user_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def decrease_node_groups_in_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.decrease_node_groups_in_global_replication_group_message.DecreaseNodeGroupsInGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.decrease_node_groups_in_global_replication_group_result.DecreaseNodeGroupsInGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.decrease_node_groups_in_global_replication_group.decrease_node_groups_in_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def decrease_replica_count(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.decrease_replica_count_message.DecreaseReplicaCountMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.decrease_replica_count_result.DecreaseReplicaCountResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.decrease_replica_count.decrease_replica_count(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cache_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_cache_cluster_message.DeleteCacheClusterMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.delete_cache_cluster_result.DeleteCacheClusterResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_cache_cluster.delete_cache_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cache_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_cache_parameter_group_message.DeleteCacheParameterGroupMessage]",
        ) -> OperationResponse[None]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.delete_cache_parameter_group

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_cache_parameter_group.delete_cache_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cache_security_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_cache_security_group_message.DeleteCacheSecurityGroupMessage]",
        ) -> OperationResponse[None]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.delete_cache_security_group

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_cache_security_group.delete_cache_security_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cache_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_cache_subnet_group_message.DeleteCacheSubnetGroupMessage]",
        ) -> OperationResponse[None]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.delete_cache_subnet_group

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_cache_subnet_group.delete_cache_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_global_replication_group_message.DeleteGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.delete_global_replication_group_result.DeleteGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_global_replication_group.delete_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_replication_group_message.DeleteReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.delete_replication_group_result.DeleteReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_replication_group.delete_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_serverless_cache(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_serverless_cache_request.DeleteServerlessCacheRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.delete_serverless_cache_response.DeleteServerlessCacheResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_serverless_cache.delete_serverless_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_serverless_cache_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_serverless_cache_snapshot_request.DeleteServerlessCacheSnapshotRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.delete_serverless_cache_snapshot_response.DeleteServerlessCacheSnapshotResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_serverless_cache_snapshot.delete_serverless_cache_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_snapshot_message.DeleteSnapshotMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.delete_snapshot_result.DeleteSnapshotResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_snapshot.delete_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_user(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_user_message.DeleteUserMessage]",
        ) -> OperationResponse["capo_elasticache.types.user.User"]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.delete_user

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_user.delete_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_user_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.delete_user_group_message.DeleteUserGroupMessage]",
        ) -> OperationResponse["capo_elasticache.types.user_group.UserGroup"]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.delete_user_group

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.delete_user_group.delete_user_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_cache_clusters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_cache_clusters_message.DescribeCacheClustersMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.cache_cluster_message.CacheClusterMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_cache_clusters.describe_cache_clusters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elasticache.types.cache_cluster.CacheCluster]":
        _token = marker
        while True:
    ...
    def describe_cache_engine_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_cache_engine_versions_message.DescribeCacheEngineVersionsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.cache_engine_version_message.CacheEngineVersionMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_cache_engine_versions.describe_cache_engine_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_engine_versions(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
        default_only: Optional["capo_elasticache.types.boolean.Boolean"] = None,
    ) -> "Iterator[capo_elasticache.types.cache_engine_version.CacheEngineVersion]":
        _token = marker
        while True:
    ...
    def describe_cache_parameter_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_cache_parameter_groups_message.DescribeCacheParameterGroupsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.cache_parameter_groups_message.CacheParameterGroupsMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_cache_parameter_groups.describe_cache_parameter_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_parameter_groups(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.cache_parameter_group.CacheParameterGroup]":
        _token = marker
        while True:
    ...
    def describe_cache_parameters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_cache_parameters_message.DescribeCacheParametersMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.cache_parameter_group_details.CacheParameterGroupDetails"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_cache_parameters.describe_cache_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_parameters(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.parameter.Parameter]":
        _token = marker
        while True:
    ...
    def describe_cache_security_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_cache_security_groups_message.DescribeCacheSecurityGroupsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.cache_security_group_message.CacheSecurityGroupMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_cache_security_groups.describe_cache_security_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_security_groups(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.cache_security_group.CacheSecurityGroup]":
        _token = marker
        while True:
    ...
    def describe_cache_subnet_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_cache_subnet_groups_message.DescribeCacheSubnetGroupsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.cache_subnet_group_message.CacheSubnetGroupMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_cache_subnet_groups.describe_cache_subnet_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_cache_subnet_groups(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.cache_subnet_group.CacheSubnetGroup]":
        _token = marker
        while True:
    ...
    def describe_engine_default_parameters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_engine_default_parameters_message.DescribeEngineDefaultParametersMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.describe_engine_default_parameters_result.DescribeEngineDefaultParametersResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_engine_default_parameters.describe_engine_default_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_events_message.DescribeEventsMessage]",
        ) -> OperationResponse["capo_elasticache.types.events_message.EventsMessage"]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.describe_events

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_events.describe_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_events(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.event.Event]":
        _token = marker
        while True:
    ...
    def describe_global_replication_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_global_replication_groups_message.DescribeGlobalReplicationGroupsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.describe_global_replication_groups_result.DescribeGlobalReplicationGroupsResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_global_replication_groups.describe_global_replication_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elasticache.types.global_replication_group.GlobalReplicationGroup]":
        _token = marker
        while True:
    ...
    def describe_replication_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_replication_groups_message.DescribeReplicationGroupsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.replication_group_message.ReplicationGroupMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_replication_groups.describe_replication_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_replication_groups(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.replication_group.ReplicationGroup]":
        _token = marker
        while True:
    ...
    def describe_reserved_cache_nodes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_reserved_cache_nodes_message.DescribeReservedCacheNodesMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.reserved_cache_node_message.ReservedCacheNodeMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_reserved_cache_nodes.describe_reserved_cache_nodes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_reserved_cache_nodes(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.reserved_cache_node.ReservedCacheNode]":
        _token = marker
        while True:
    ...
    def describe_reserved_cache_nodes_offerings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_reserved_cache_nodes_offerings_message.DescribeReservedCacheNodesOfferingsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.reserved_cache_nodes_offering_message.ReservedCacheNodesOfferingMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_reserved_cache_nodes_offerings.describe_reserved_cache_nodes_offerings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_reserved_cache_nodes_offerings(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.reserved_cache_nodes_offering.ReservedCacheNodesOffering]":
        _token = marker
        while True:
    ...
    def describe_serverless_caches(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_serverless_caches_request.DescribeServerlessCachesRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.describe_serverless_caches_response.DescribeServerlessCachesResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_serverless_caches.describe_serverless_caches(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_serverless_caches(
        ...
        *,
        ...
        next_token: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.serverless_cache.ServerlessCache]":
        _token = next_token
        while True:
    ...
    def describe_serverless_cache_snapshots(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_serverless_cache_snapshots_request.DescribeServerlessCacheSnapshotsRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.describe_serverless_cache_snapshots_response.DescribeServerlessCacheSnapshotsResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_serverless_cache_snapshots.describe_serverless_cache_snapshots(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elasticache.types.serverless_cache_snapshot.ServerlessCacheSnapshot]":
        _token = next_token
        while True:
    ...
    def describe_service_updates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_service_updates_message.DescribeServiceUpdatesMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.service_updates_message.ServiceUpdatesMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_service_updates.describe_service_updates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_service_updates(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.service_update.ServiceUpdate]":
        _token = marker
        while True:
    ...
    def describe_snapshots(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_snapshots_message.DescribeSnapshotsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.describe_snapshots_list_message.DescribeSnapshotsListMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_snapshots.describe_snapshots(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elasticache.types.snapshot.Snapshot]":
        _token = marker
        while True:
    ...
    def describe_update_actions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_update_actions_message.DescribeUpdateActionsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.update_actions_message.UpdateActionsMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_update_actions.describe_update_actions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_update_actions(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.update_action.UpdateAction]":
        _token = marker
        while True:
    ...
    def describe_user_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_user_groups_message.DescribeUserGroupsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.describe_user_groups_result.DescribeUserGroupsResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_user_groups.describe_user_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_user_groups(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.user_group.UserGroup]":
        _token = marker
        while True:
    ...
    def describe_users(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.describe_users_message.DescribeUsersMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.describe_users_result.DescribeUsersResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.describe_users.describe_users(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_users(
        ...
        *,
        ...
        marker: Optional["capo_elasticache.types.string.String"] = None,
    ) -> "Iterator[capo_elasticache.types.user.User]":
        _token = marker
        while True:
    ...
    def disassociate_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.disassociate_global_replication_group_message.DisassociateGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.disassociate_global_replication_group_result.DisassociateGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.disassociate_global_replication_group.disassociate_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def export_serverless_cache_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.export_serverless_cache_snapshot_request.ExportServerlessCacheSnapshotRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.export_serverless_cache_snapshot_response.ExportServerlessCacheSnapshotResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.export_serverless_cache_snapshot.export_serverless_cache_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def failover_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.failover_global_replication_group_message.FailoverGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.failover_global_replication_group_result.FailoverGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.failover_global_replication_group.failover_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def increase_node_groups_in_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.increase_node_groups_in_global_replication_group_message.IncreaseNodeGroupsInGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.increase_node_groups_in_global_replication_group_result.IncreaseNodeGroupsInGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.increase_node_groups_in_global_replication_group.increase_node_groups_in_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def increase_replica_count(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.increase_replica_count_message.IncreaseReplicaCountMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.increase_replica_count_result.IncreaseReplicaCountResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.increase_replica_count.increase_replica_count(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_allowed_node_type_modifications(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.list_allowed_node_type_modifications_message.ListAllowedNodeTypeModificationsMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.allowed_node_type_modifications_message.AllowedNodeTypeModificationsMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.list_allowed_node_type_modifications.list_allowed_node_type_modifications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.list_tags_for_resource_message.ListTagsForResourceMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.tag_list_message.TagListMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_cache_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_cache_cluster_message.ModifyCacheClusterMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.modify_cache_cluster_result.ModifyCacheClusterResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_cache_cluster.modify_cache_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_cache_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_cache_parameter_group_message.ModifyCacheParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.cache_parameter_group_name_message.CacheParameterGroupNameMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_cache_parameter_group.modify_cache_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_cache_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_cache_subnet_group_message.ModifyCacheSubnetGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.modify_cache_subnet_group_result.ModifyCacheSubnetGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_cache_subnet_group.modify_cache_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_global_replication_group_message.ModifyGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.modify_global_replication_group_result.ModifyGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_global_replication_group.modify_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_replication_group_message.ModifyReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.modify_replication_group_result.ModifyReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_replication_group.modify_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_replication_group_shard_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_replication_group_shard_configuration_message.ModifyReplicationGroupShardConfigurationMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.modify_replication_group_shard_configuration_result.ModifyReplicationGroupShardConfigurationResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_replication_group_shard_configuration.modify_replication_group_shard_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_serverless_cache(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_serverless_cache_request.ModifyServerlessCacheRequest]",
        ) -> OperationResponse[
            "capo_elasticache.types.modify_serverless_cache_response.ModifyServerlessCacheResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_serverless_cache.modify_serverless_cache(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_user(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_user_message.ModifyUserMessage]",
        ) -> OperationResponse["capo_elasticache.types.user.User"]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.modify_user

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_user.modify_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_user_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.modify_user_group_message.ModifyUserGroupMessage]",
        ) -> OperationResponse["capo_elasticache.types.user_group.UserGroup"]:
            import capo_elasticache._operations.amazon_elasti_cache_v9.modify_user_group

            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.modify_user_group.modify_user_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def purchase_reserved_cache_nodes_offering(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.purchase_reserved_cache_nodes_offering_message.PurchaseReservedCacheNodesOfferingMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.purchase_reserved_cache_nodes_offering_result.PurchaseReservedCacheNodesOfferingResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.purchase_reserved_cache_nodes_offering.purchase_reserved_cache_nodes_offering(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def rebalance_slots_in_global_replication_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.rebalance_slots_in_global_replication_group_message.RebalanceSlotsInGlobalReplicationGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.rebalance_slots_in_global_replication_group_result.RebalanceSlotsInGlobalReplicationGroupResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.rebalance_slots_in_global_replication_group.rebalance_slots_in_global_replication_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reboot_cache_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.reboot_cache_cluster_message.RebootCacheClusterMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.reboot_cache_cluster_result.RebootCacheClusterResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.reboot_cache_cluster.reboot_cache_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_tags_from_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.remove_tags_from_resource_message.RemoveTagsFromResourceMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.tag_list_message.TagListMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.remove_tags_from_resource.remove_tags_from_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reset_cache_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.reset_cache_parameter_group_message.ResetCacheParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.cache_parameter_group_name_message.CacheParameterGroupNameMessage"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.reset_cache_parameter_group.reset_cache_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def revoke_cache_security_group_ingress(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.revoke_cache_security_group_ingress_message.RevokeCacheSecurityGroupIngressMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.revoke_cache_security_group_ingress_result.RevokeCacheSecurityGroupIngressResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.revoke_cache_security_group_ingress.revoke_cache_security_group_ingress(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_migration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.start_migration_message.StartMigrationMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.start_migration_response.StartMigrationResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.start_migration.start_migration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_failover(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.test_failover_message.TestFailoverMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.test_failover_result.TestFailoverResult"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.test_failover.test_failover(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def test_migration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elasticache.types.test_migration_message.TestMigrationMessage]",
        ) -> OperationResponse[
            "capo_elasticache.types.test_migration_response.TestMigrationResponse"
        ]:
            ...
            output, http_response = (
                capo_elasticache._operations.amazon_elasti_cache_v9.test_migration.test_migration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
