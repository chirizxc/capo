...
import capo_elasticache.errors.authorization_already_exists_fault
import capo_elasticache.errors.cache_security_group_not_found_fault
import capo_elasticache.errors.invalid_cache_security_group_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AuthorizationAlreadyExists":
            raise capo_elasticache.errors.authorization_already_exists_fault.AuthorizationAlreadyExistsFault.from_query(
                error_el, message
            )
        ...
        case "InvalidCacheSecurityGroupState":
            raise capo_elasticache.errors.invalid_cache_security_group_state_fault.InvalidCacheSecurityGroupStateFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_elasticache.types.authorize_cache_security_group_ingress_result.AuthorizeCacheSecurityGroupIngressResult = capo_elasticache.types.authorize_cache_security_group_ingress_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.authorize_cache_security_group_ingress_message.serialize_query(
        input_, pairs, ""
    )
