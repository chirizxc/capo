...
def handle_response(
    ...
    out: capo_elasticache.types.copy_serverless_cache_snapshot_response.CopyServerlessCacheSnapshotResponse = capo_elasticache.types.copy_serverless_cache_snapshot_response.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.copy_serverless_cache_snapshot_request.serialize_query(
        input_, pairs, ""
    )
