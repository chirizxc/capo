...
def handle_response(
    ...
    out: capo_elasticache.types.cache_security_group_message.CacheSecurityGroupMessage = capo_elasticache.types.cache_security_group_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_cache_security_groups_message.serialize_query(
        input_, pairs, ""
    )
