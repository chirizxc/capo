...
def handle_response(
    ...
    out: capo_elasticache.types.replication_group_message.ReplicationGroupMessage = (
        capo_elasticache.types.replication_group_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_replication_groups_message.serialize_query(
        input_, pairs, ""
    )
