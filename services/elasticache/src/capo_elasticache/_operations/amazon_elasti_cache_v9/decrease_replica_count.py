"""Generated from Smithy shape ``com.amazonaws.elasticache#DecreaseReplicaCount``."""
...
def handle_response(
    ...
    out: capo_elasticache.types.decrease_replica_count_result.DecreaseReplicaCountResult = capo_elasticache.types.decrease_replica_count_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DecreaseReplicaCount"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.decrease_replica_count_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_decrease_replica_count(
