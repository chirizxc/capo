...
def handle_response(
    ...
    out: capo_elasticache.types.modify_replication_group_shard_configuration_result.ModifyReplicationGroupShardConfigurationResult = capo_elasticache.types.modify_replication_group_shard_configuration_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.modify_replication_group_shard_configuration_message.serialize_query(
        input_, pairs, ""
    )
