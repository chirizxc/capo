...
def handle_response(
    ...
    out: capo_elasticache.types.allowed_node_type_modifications_message.AllowedNodeTypeModificationsMessage = capo_elasticache.types.allowed_node_type_modifications_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.list_allowed_node_type_modifications_message.serialize_query(
        input_, pairs, ""
    )
