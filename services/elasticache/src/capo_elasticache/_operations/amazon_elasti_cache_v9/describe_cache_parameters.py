"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeCacheParameters``."""
...
def handle_response(
    ...
    out: capo_elasticache.types.cache_parameter_group_details.CacheParameterGroupDetails = capo_elasticache.types.cache_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCacheParameters"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.describe_cache_parameters_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_cache_parameters(
