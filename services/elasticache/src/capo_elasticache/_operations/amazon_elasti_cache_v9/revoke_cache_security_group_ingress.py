...
import capo_elasticache.errors.authorization_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AuthorizationNotFound":
            raise capo_elasticache.errors.authorization_not_found_fault.AuthorizationNotFoundFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_elasticache.types.revoke_cache_security_group_ingress_result.RevokeCacheSecurityGroupIngressResult = capo_elasticache.types.revoke_cache_security_group_ingress_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.revoke_cache_security_group_ingress_message.serialize_query(
        input_, pairs, ""
    )
