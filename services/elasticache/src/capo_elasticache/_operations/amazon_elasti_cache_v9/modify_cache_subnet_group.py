...
import capo_elasticache.errors.subnet_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetInUse":
            raise capo_elasticache.errors.subnet_in_use.SubnetInUse.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_elasticache.types.modify_cache_subnet_group_result.ModifyCacheSubnetGroupResult = capo_elasticache.types.modify_cache_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.modify_cache_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
