"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeEvents``."""
...
def handle_response(
    ...
    out: capo_elasticache.types.events_message.EventsMessage = (
        capo_elasticache.types.events_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_events_message.serialize_query(input_, pairs, "")
...
def describe_events(
    ...
    input_: capo_elasticache.types.describe_events_message.DescribeEventsMessage,
) -> tuple[capo_elasticache.types.events_message.EventsMessage, zapros.Response]:
