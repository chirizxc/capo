...
def handle_response(
    ...
    out: capo_elasticache.types.describe_users_result.DescribeUsersResult = (
        capo_elasticache.types.describe_users_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_users_message.serialize_query(input_, pairs, "")
...
def describe_users(
    ...
    capo_elasticache.types.describe_users_result.DescribeUsersResult, zapros.Response
]:
