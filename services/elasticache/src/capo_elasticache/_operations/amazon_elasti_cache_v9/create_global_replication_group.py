"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateGlobalReplicationGroup``."""
...
import capo_elasticache.errors.global_replication_group_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GlobalReplicationGroupAlreadyExistsFault":
            raise capo_elasticache.errors.global_replication_group_already_exists_fault.GlobalReplicationGroupAlreadyExistsFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateGlobalReplicationGroupResult")
    out: capo_elasticache.types.create_global_replication_group_result.CreateGlobalReplicationGroupResult = capo_elasticache.types.create_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateGlobalReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.create_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_global_replication_group(
