"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateServerlessCacheSnapshot``."""
...
import capo_elasticache.errors.serverless_cache_snapshot_already_exists_fault
import capo_elasticache.errors.serverless_cache_snapshot_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServerlessCacheSnapshotAlreadyExistsFault":
            raise capo_elasticache.errors.serverless_cache_snapshot_already_exists_fault.ServerlessCacheSnapshotAlreadyExistsFault.from_query(
                error_el, message
            )
        case "ServerlessCacheSnapshotQuotaExceededFault":
            raise capo_elasticache.errors.serverless_cache_snapshot_quota_exceeded_fault.ServerlessCacheSnapshotQuotaExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateServerlessCacheSnapshotResult")
    out: capo_elasticache.types.create_serverless_cache_snapshot_response.CreateServerlessCacheSnapshotResponse = capo_elasticache.types.create_serverless_cache_snapshot_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateServerlessCacheSnapshot"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.create_serverless_cache_snapshot_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_serverless_cache_snapshot(
