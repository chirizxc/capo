"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateCacheSecurityGroup``."""
...
import capo_elasticache.errors.cache_security_group_already_exists_fault
import capo_elasticache.errors.cache_security_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CacheSecurityGroupAlreadyExists":
            raise capo_elasticache.errors.cache_security_group_already_exists_fault.CacheSecurityGroupAlreadyExistsFault.from_query(
                error_el, message
            )
        case "QuotaExceeded.CacheSecurityGroup":
            raise capo_elasticache.errors.cache_security_group_quota_exceeded_fault.CacheSecurityGroupQuotaExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateCacheSecurityGroupResult")
    out: capo_elasticache.types.create_cache_security_group_result.CreateCacheSecurityGroupResult = capo_elasticache.types.create_cache_security_group_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.create_cache_security_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_cache_security_group(
