...
def handle_response(
    ...
    out: capo_elasticache.types.describe_snapshots_list_message.DescribeSnapshotsListMessage = capo_elasticache.types.describe_snapshots_list_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_snapshots_message.serialize_query(input_, pairs, "")
