"""Generated from Smithy shape ``com.amazonaws.elasticache#DecreaseNodeGroupsInGlobalReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DecreaseNodeGroupsInGlobalReplicationGroupResult")
    out: capo_elasticache.types.decrease_node_groups_in_global_replication_group_result.DecreaseNodeGroupsInGlobalReplicationGroupResult = capo_elasticache.types.decrease_node_groups_in_global_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DecreaseNodeGroupsInGlobalReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.decrease_node_groups_in_global_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_decrease_node_groups_in_global_replication_group(
