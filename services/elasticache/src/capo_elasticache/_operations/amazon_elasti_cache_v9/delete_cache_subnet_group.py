"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteCacheSubnetGroup``."""
...
import capo_elasticache.errors.cache_subnet_group_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CacheSubnetGroupInUse":
            raise capo_elasticache.errors.cache_subnet_group_in_use.CacheSubnetGroupInUse.from_query(
                error_el, message
            )
...
def build_request(
    ...
    pairs.append(("Action", "DeleteCacheSubnetGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.delete_cache_subnet_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_cache_subnet_group(
