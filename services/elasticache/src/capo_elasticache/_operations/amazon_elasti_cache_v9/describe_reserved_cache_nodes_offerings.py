...
def handle_response(
    ...
    out: capo_elasticache.types.reserved_cache_nodes_offering_message.ReservedCacheNodesOfferingMessage = capo_elasticache.types.reserved_cache_nodes_offering_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_reserved_cache_nodes_offerings_message.serialize_query(
        input_, pairs, ""
    )
