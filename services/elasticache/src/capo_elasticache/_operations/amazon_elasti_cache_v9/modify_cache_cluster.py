"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyCacheCluster``."""
...
def handle_response(
    ...
    out: capo_elasticache.types.modify_cache_cluster_result.ModifyCacheClusterResult = (
        capo_elasticache.types.modify_cache_cluster_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyCacheCluster"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.modify_cache_cluster_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_cache_cluster(
