...
def handle_response(
    ...
    out: capo_elasticache.types.describe_serverless_cache_snapshots_response.DescribeServerlessCacheSnapshotsResponse = capo_elasticache.types.describe_serverless_cache_snapshots_response.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_serverless_cache_snapshots_request.serialize_query(
        input_, pairs, ""
    )
