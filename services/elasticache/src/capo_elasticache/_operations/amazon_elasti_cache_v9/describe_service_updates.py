...
def handle_response(
    ...
    out: capo_elasticache.types.service_updates_message.ServiceUpdatesMessage = (
        capo_elasticache.types.service_updates_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_service_updates_message.serialize_query(
        input_, pairs, ""
    )
