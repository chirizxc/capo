"""Generated from Smithy shape ``com.amazonaws.elasticache#ModifyReplicationGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyReplicationGroupResult")
    out: capo_elasticache.types.modify_replication_group_result.ModifyReplicationGroupResult = capo_elasticache.types.modify_replication_group_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyReplicationGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.modify_replication_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_replication_group(
