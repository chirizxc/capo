"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeCacheClusters``."""
...
import capo_elasticache.types.cache_cluster_list
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeCacheClustersResult")
    out: capo_elasticache.types.cache_cluster_message.CacheClusterMessage = (
        capo_elasticache.types.cache_cluster_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_cache_clusters_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_cache_clusters(
    ...
    capo_elasticache.types.cache_cluster_message.CacheClusterMessage, zapros.Response
]:
...
async def async_describe_cache_clusters(
