"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeGlobalReplicationGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeGlobalReplicationGroupsResult")
    out: capo_elasticache.types.describe_global_replication_groups_result.DescribeGlobalReplicationGroupsResult = capo_elasticache.types.describe_global_replication_groups_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeGlobalReplicationGroups"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.describe_global_replication_groups_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_global_replication_groups(
