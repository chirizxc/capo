"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteUserGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteUserGroupResult")
...
def build_request(
    ...
    pairs.append(("Action", "DeleteUserGroup"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.delete_user_group_message.serialize_query(input_, pairs, "")
...
async def async_delete_user_group(
