...
def handle_response(
    ...
    out: capo_elasticache.types.reserved_cache_node_message.ReservedCacheNodeMessage = (
        capo_elasticache.types.reserved_cache_node_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_reserved_cache_nodes_message.serialize_query(
        input_, pairs, ""
    )
