"""Generated from Smithy shape ``com.amazonaws.elasticache#IncreaseReplicaCount``."""
...
import capo_elasticache.errors.no_operation_fault
import capo_elasticache.errors.node_groups_per_replication_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NodeGroupsPerReplicationGroupQuotaExceeded":
            raise capo_elasticache.errors.node_groups_per_replication_group_quota_exceeded_fault.NodeGroupsPerReplicationGroupQuotaExceededFault.from_query(
                error_el, message
            )
        ...
        case "NoOperationFault":
            raise capo_elasticache.errors.no_operation_fault.NoOperationFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("IncreaseReplicaCountResult")
    out: capo_elasticache.types.increase_replica_count_result.IncreaseReplicaCountResult = capo_elasticache.types.increase_replica_count_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "IncreaseReplicaCount"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.increase_replica_count_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_increase_replica_count(
