...
def handle_response(
    ...
    out: capo_elasticache.types.delete_snapshot_result.DeleteSnapshotResult = (
        capo_elasticache.types.delete_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.delete_snapshot_message.serialize_query(input_, pairs, "")
...
def delete_snapshot(
    ...
    capo_elasticache.types.delete_snapshot_result.DeleteSnapshotResult, zapros.Response
]:
