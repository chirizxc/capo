"""Generated from Smithy shape ``com.amazonaws.elasticache#CreateUser``."""
...
import capo_elasticache.errors.user_already_exists_fault
import capo_elasticache.errors.user_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UserAlreadyExists":
            raise capo_elasticache.errors.user_already_exists_fault.UserAlreadyExistsFault.from_query(
                error_el, message
            )
        case "UserQuotaExceeded":
            raise capo_elasticache.errors.user_quota_exceeded_fault.UserQuotaExceededFault.from_query(
                error_el, message
            )
        case _:
...
def build_request(
    ...
    capo_elasticache.types.create_user_message.serialize_query(input_, pairs, "")
