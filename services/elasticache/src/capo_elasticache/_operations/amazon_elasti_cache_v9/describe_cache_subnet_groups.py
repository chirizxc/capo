"""Generated from Smithy shape ``com.amazonaws.elasticache#DescribeCacheSubnetGroups``."""
...
import capo_elasticache.types.cache_subnet_groups
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeCacheSubnetGroupsResult")
    out: capo_elasticache.types.cache_subnet_group_message.CacheSubnetGroupMessage = (
        capo_elasticache.types.cache_subnet_group_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeCacheSubnetGroups"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.describe_cache_subnet_groups_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_cache_subnet_groups(
