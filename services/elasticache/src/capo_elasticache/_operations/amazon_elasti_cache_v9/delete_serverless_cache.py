"""Generated from Smithy shape ``com.amazonaws.elasticache#DeleteServerlessCache``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteServerlessCacheResult")
    out: capo_elasticache.types.delete_serverless_cache_response.DeleteServerlessCacheResponse = capo_elasticache.types.delete_serverless_cache_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteServerlessCache"))
    pairs.append(("Version", "2015-02-02"))
    capo_elasticache.types.delete_serverless_cache_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_serverless_cache(
