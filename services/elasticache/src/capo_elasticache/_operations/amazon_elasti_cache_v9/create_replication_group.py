...
import capo_elasticache.errors.replication_group_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReplicationGroupAlreadyExists":
            raise capo_elasticache.errors.replication_group_already_exists_fault.ReplicationGroupAlreadyExistsFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_elasticache.types.create_replication_group_result.CreateReplicationGroupResult = capo_elasticache.types.create_replication_group_result.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.create_replication_group_message.serialize_query(
        input_, pairs, ""
    )
