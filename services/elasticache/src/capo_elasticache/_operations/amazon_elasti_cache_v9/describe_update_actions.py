...
def handle_response(
    ...
    out: capo_elasticache.types.update_actions_message.UpdateActionsMessage = (
        capo_elasticache.types.update_actions_message.deserialize_query(
...
def build_request(
    ...
    capo_elasticache.types.describe_update_actions_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_update_actions(
    ...
    capo_elasticache.types.update_actions_message.UpdateActionsMessage, zapros.Response
]:
