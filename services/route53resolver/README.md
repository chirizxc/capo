...
```
pip install capo-route53resolver
```

## Usage

```python
from capo_route53resolver import AsyncRoute53ResolverClient
...
```python
from capo_route53resolver import AsyncRoute53ResolverClient
from capo_route53resolver.error import AccessDeniedException
