"""Generated from Smithy shape ``com.amazonaws.route53resolver#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53resolver#ValidationException``."""
