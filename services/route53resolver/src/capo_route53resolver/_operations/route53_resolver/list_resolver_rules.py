"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListResolverRules``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_resolver_rules_response.ListResolverRulesResponse = capo_route53resolver.types.list_resolver_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_resolver_rules_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_resolver_rules(
