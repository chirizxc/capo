...
def handle_response(
    ...
    out: capo_route53resolver.types.disassociate_firewall_rule_group_response.DisassociateFirewallRuleGroupResponse = capo_route53resolver.types.disassociate_firewall_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.disassociate_firewall_rule_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
