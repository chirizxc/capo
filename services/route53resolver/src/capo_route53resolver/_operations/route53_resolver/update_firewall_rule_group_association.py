"""Generated from Smithy shape ``com.amazonaws.route53resolver#UpdateFirewallRuleGroupAssociation``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.update_firewall_rule_group_association_response.UpdateFirewallRuleGroupAssociationResponse = capo_route53resolver.types.update_firewall_rule_group_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.UpdateFirewallRuleGroupAssociation"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.update_firewall_rule_group_association_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_firewall_rule_group_association(
