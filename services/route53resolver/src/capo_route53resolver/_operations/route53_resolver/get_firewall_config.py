...
def handle_response(
    ...
    out: capo_route53resolver.types.get_firewall_config_response.GetFirewallConfigResponse = capo_route53resolver.types.get_firewall_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_firewall_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
