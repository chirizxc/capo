...
import capo_route53resolver.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_route53resolver.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_route53resolver.types.create_outpost_resolver_response.CreateOutpostResolverResponse = capo_route53resolver.types.create_outpost_resolver_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.create_outpost_resolver_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
