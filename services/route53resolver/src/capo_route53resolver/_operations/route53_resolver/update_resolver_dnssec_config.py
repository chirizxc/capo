"""Generated from Smithy shape ``com.amazonaws.route53resolver#UpdateResolverDnssecConfig``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.update_resolver_dnssec_config_response.UpdateResolverDnssecConfigResponse = capo_route53resolver.types.update_resolver_dnssec_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.UpdateResolverDnssecConfig"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.update_resolver_dnssec_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_resolver_dnssec_config(
