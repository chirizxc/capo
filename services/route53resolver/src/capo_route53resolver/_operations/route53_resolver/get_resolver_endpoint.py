...
def handle_response(
    ...
    out: capo_route53resolver.types.get_resolver_endpoint_response.GetResolverEndpointResponse = capo_route53resolver.types.get_resolver_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_resolver_endpoint_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
