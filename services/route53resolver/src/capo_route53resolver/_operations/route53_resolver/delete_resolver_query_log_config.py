"""Generated from Smithy shape ``com.amazonaws.route53resolver#DeleteResolverQueryLogConfig``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.delete_resolver_query_log_config_response.DeleteResolverQueryLogConfigResponse = capo_route53resolver.types.delete_resolver_query_log_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.DeleteResolverQueryLogConfig"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.delete_resolver_query_log_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_resolver_query_log_config(
