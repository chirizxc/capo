"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetResolverQueryLogConfigAssociation``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.get_resolver_query_log_config_association_response.GetResolverQueryLogConfigAssociationResponse = capo_route53resolver.types.get_resolver_query_log_config_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetResolverQueryLogConfigAssociation"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_resolver_query_log_config_association_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_resolver_query_log_config_association(
