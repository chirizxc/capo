...
import capo_route53resolver.types.resolver_rule_associations
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_resolver_rule_associations_response.ListResolverRuleAssociationsResponse = capo_route53resolver.types.list_resolver_rule_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_resolver_rule_associations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
