"""Generated from Smithy shape ``com.amazonaws.route53resolver#DisassociateResolverRule``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.disassociate_resolver_rule_response.DisassociateResolverRuleResponse = capo_route53resolver.types.disassociate_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.disassociate_resolver_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_resolver_rule(
