"""Generated from Smithy shape ``com.amazonaws.route53resolver#ListResolverQueryLogConfigs``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.list_resolver_query_log_configs_response.ListResolverQueryLogConfigsResponse = capo_route53resolver.types.list_resolver_query_log_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.ListResolverQueryLogConfigs"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.list_resolver_query_log_configs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_resolver_query_log_configs(
