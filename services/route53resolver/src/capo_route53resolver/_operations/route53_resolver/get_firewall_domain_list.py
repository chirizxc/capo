"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetFirewallDomainList``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.get_firewall_domain_list_response.GetFirewallDomainListResponse = capo_route53resolver.types.get_firewall_domain_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetFirewallDomainList"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_firewall_domain_list_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_firewall_domain_list(
