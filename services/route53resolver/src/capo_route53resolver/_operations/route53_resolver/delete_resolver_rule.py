"""Generated from Smithy shape ``com.amazonaws.route53resolver#DeleteResolverRule``."""
...
import capo_route53resolver.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_route53resolver.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_route53resolver.types.delete_resolver_rule_response.DeleteResolverRuleResponse = capo_route53resolver.types.delete_resolver_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.delete_resolver_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_resolver_rule(
