"""Generated from Smithy shape ``com.amazonaws.route53resolver#BatchUpdateFirewallRule``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.batch_update_firewall_rule_response.BatchUpdateFirewallRuleResponse = capo_route53resolver.types.batch_update_firewall_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.BatchUpdateFirewallRule"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.batch_update_firewall_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
