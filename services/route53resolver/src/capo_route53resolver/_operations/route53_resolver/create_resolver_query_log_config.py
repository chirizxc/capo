...
def handle_response(
    ...
    out: capo_route53resolver.types.create_resolver_query_log_config_response.CreateResolverQueryLogConfigResponse = capo_route53resolver.types.create_resolver_query_log_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53resolver.types.create_resolver_query_log_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
