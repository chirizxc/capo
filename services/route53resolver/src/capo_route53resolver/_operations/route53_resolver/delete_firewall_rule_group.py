"""Generated from Smithy shape ``com.amazonaws.route53resolver#DeleteFirewallRuleGroup``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.delete_firewall_rule_group_response.DeleteFirewallRuleGroupResponse = capo_route53resolver.types.delete_firewall_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.DeleteFirewallRuleGroup"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.delete_firewall_rule_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_firewall_rule_group(
