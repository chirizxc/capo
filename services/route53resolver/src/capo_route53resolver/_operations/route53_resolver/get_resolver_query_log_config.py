"""Generated from Smithy shape ``com.amazonaws.route53resolver#GetResolverQueryLogConfig``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.get_resolver_query_log_config_response.GetResolverQueryLogConfigResponse = capo_route53resolver.types.get_resolver_query_log_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.GetResolverQueryLogConfig"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.get_resolver_query_log_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_resolver_query_log_config(
