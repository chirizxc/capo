"""Generated from Smithy shape ``com.amazonaws.route53resolver#PutFirewallRuleGroupPolicy``."""
...
def handle_response(
    ...
    out: capo_route53resolver.types.put_firewall_rule_group_policy_response.PutFirewallRuleGroupPolicyResponse = capo_route53resolver.types.put_firewall_rule_group_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Resolver.PutFirewallRuleGroupPolicy"
    body: bytes | None = json.dumps(
        capo_route53resolver.types.put_firewall_rule_group_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_firewall_rule_group_policy(
