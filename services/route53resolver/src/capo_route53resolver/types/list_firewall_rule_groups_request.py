...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListFirewallRuleGroupsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListFirewallRuleGroupsRequest:
    out: ListFirewallRuleGroupsRequest = {}  # type: ignore[typeddict-item]
