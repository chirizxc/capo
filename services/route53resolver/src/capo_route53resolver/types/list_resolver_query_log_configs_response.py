...
class ListResolverQueryLogConfigsResponse(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: ListResolverQueryLogConfigsResponse) -> dict:
    ...
    if "resolver_query_log_configs" in value:
        ...
        out["ResolverQueryLogConfigs"] = (
            capo_route53resolver.types.resolver_query_log_config_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListResolverQueryLogConfigsResponse:
    ...
    if data.get("ResolverQueryLogConfigs") is not None:
        ...
        out["resolver_query_log_configs"] = (
            capo_route53resolver.types.resolver_query_log_config_list.deserialize_aws_json_1_1(
