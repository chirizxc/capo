...
class ListResolverConfigsResponse(TypedDict, closed=True):
    ...
    resolver_configs: NotRequired[
        "capo_route53resolver.types.resolver_config_list.ResolverConfigList"
    ]
...
def serialize_aws_json_1_1(value: ListResolverConfigsResponse) -> dict:
    ...
    if "resolver_configs" in value:
        ...
        out["ResolverConfigs"] = (
            capo_route53resolver.types.resolver_config_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListResolverConfigsResponse:
    ...
    if data.get("ResolverConfigs") is not None:
        import capo_route53resolver.types.resolver_config_list

        out["resolver_configs"] = (
            capo_route53resolver.types.resolver_config_list.deserialize_aws_json_1_1(
