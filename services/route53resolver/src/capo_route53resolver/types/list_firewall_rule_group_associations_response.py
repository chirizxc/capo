...
class ListFirewallRuleGroupAssociationsResponse(TypedDict, closed=True):
    ...
    firewall_rule_group_associations: NotRequired[
        "capo_route53resolver.types.firewall_rule_group_associations.FirewallRuleGroupAssociations"
    ]
...
def serialize_aws_json_1_1(value: ListFirewallRuleGroupAssociationsResponse) -> dict:
    ...
    if "firewall_rule_group_associations" in value:
        ...
        out["FirewallRuleGroupAssociations"] = (
            capo_route53resolver.types.firewall_rule_group_associations.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListFirewallRuleGroupAssociationsResponse:
    ...
    if data.get("FirewallRuleGroupAssociations") is not None:
        ...
        out["firewall_rule_group_associations"] = (
            capo_route53resolver.types.firewall_rule_group_associations.deserialize_aws_json_1_1(
