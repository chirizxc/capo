"""Generated from Smithy shape ``com.amazonaws.route53resolver#CreateFirewallRuleEntry``."""
...
class CreateFirewallRuleEntry(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateFirewallRuleEntry) -> dict:
    out: dict = {}
