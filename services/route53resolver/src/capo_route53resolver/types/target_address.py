...
if TYPE_CHECKING:
    ...
    import capo_route53resolver.types.port
    import capo_route53resolver.types.protocol
    import capo_route53resolver.types.server_name_indication
...
class TargetAddress(TypedDict, closed=True):
    ...
    port: NotRequired["capo_route53resolver.types.port.Port"]
    ...
    protocol: NotRequired["capo_route53resolver.types.protocol.Protocol"]
    ...
    server_name_indication: NotRequired[
        "capo_route53resolver.types.server_name_indication.ServerNameIndication"
    ]
...
def serialize_aws_json_1_1(value: TargetAddress) -> dict:
    ...
    if "protocol" in value:
        ...
        out["Protocol"] = capo_route53resolver.types.protocol.serialize_aws_json_1_1(
            value["protocol"]
        )
