...
class ResolverQueryLogConfig(TypedDict, closed=True):
    ...
    status: NotRequired[
        "capo_route53resolver.types.resolver_query_log_config_status.ResolverQueryLogConfigStatus"
    ]
    ...
    association_count: "capo_route53resolver.types.count.Count"
    ...
    name: NotRequired[
        "capo_route53resolver.types.resolver_query_log_config_name.ResolverQueryLogConfigName"
    ]
...
def serialize_aws_json_1_1(value: ResolverQueryLogConfig) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_route53resolver.types.resolver_query_log_config_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ResolverQueryLogConfig:
    ...
    if data.get("Status") is not None:
        ...
        out["status"] = (
            capo_route53resolver.types.resolver_query_log_config_status.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
