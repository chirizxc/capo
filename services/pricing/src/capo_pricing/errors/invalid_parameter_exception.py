"""Generated from Smithy shape ``com.amazonaws.pricing#InvalidParameterException``."""
...
class InvalidParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.pricing#InvalidParameterException``."""
