"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateGroup``."""
...
import capo_quicksight.types.update_group_request
import capo_quicksight.types.update_group_response
...
) -> capo_quicksight.types.update_group_response.UpdateGroupResponse:
    out: capo_quicksight.types.update_group_response.UpdateGroupResponse = (
        capo_quicksight.types.update_group_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{GroupName}", quote(input_["group_name"], safe=""))
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_group(
    ...
    capo_quicksight.types.update_group_response.UpdateGroupResponse, zapros.Response
]:
