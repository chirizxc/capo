"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteBrand``."""
...
import capo_quicksight.types.delete_brand_response
...
) -> capo_quicksight.types.delete_brand_response.DeleteBrandResponse:
    out: capo_quicksight.types.delete_brand_response.DeleteBrandResponse = (
        capo_quicksight.types.delete_brand_response.deserialize_json(
...
def delete_brand(
    ...
    capo_quicksight.types.delete_brand_response.DeleteBrandResponse, zapros.Response
]:
