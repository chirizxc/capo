"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTopicRefresh``."""
...
def handle_response(
    ...
    out: capo_quicksight.types.describe_topic_refresh_response.DescribeTopicRefreshResponse = capo_quicksight.types.describe_topic_refresh_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{RefreshId}", quote(input_["refresh_id"], safe=""))
...
async def async_describe_topic_refresh(
