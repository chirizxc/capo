...
import capo_quicksight.types.update_user_response
...
) -> capo_quicksight.types.update_user_response.UpdateUserResponse:
    out: capo_quicksight.types.update_user_response.UpdateUserResponse = (
        capo_quicksight.types.update_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_user_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_user(
    ...
    capo_quicksight.types.update_user_response.UpdateUserResponse, zapros.Response
]:
