"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeFolder``."""
...
import capo_quicksight.types.describe_folder_request
import capo_quicksight.types.describe_folder_response
...
) -> capo_quicksight.types.describe_folder_response.DescribeFolderResponse:
    out: capo_quicksight.types.describe_folder_response.DescribeFolderResponse = (
        capo_quicksight.types.describe_folder_response.deserialize_json(
...
async def async_describe_folder(
