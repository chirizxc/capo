"""Generated from Smithy shape ``com.amazonaws.quicksight#ListFolders``."""
...
import capo_quicksight.types.list_folders_request
import capo_quicksight.types.list_folders_response
...
) -> capo_quicksight.types.list_folders_response.ListFoldersResponse:
    out: capo_quicksight.types.list_folders_response.ListFoldersResponse = (
        capo_quicksight.types.list_folders_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/folders"
...
def list_folders(
    ...
    capo_quicksight.types.list_folders_response.ListFoldersResponse, zapros.Response
]:
