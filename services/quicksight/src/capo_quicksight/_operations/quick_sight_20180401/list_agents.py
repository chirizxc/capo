...
import capo_quicksight.types.list_agents_request
...
) -> capo_quicksight.types.list_agents_response.ListAgentsResponse:
    out: capo_quicksight.types.list_agents_response.ListAgentsResponse = (
        capo_quicksight.types.list_agents_response.deserialize_json(
...
def list_agents(
    ...
    capo_quicksight.types.list_agents_response.ListAgentsResponse, zapros.Response
]:
