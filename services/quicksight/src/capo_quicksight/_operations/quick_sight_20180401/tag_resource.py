"""Generated from Smithy shape ``com.amazonaws.quicksight#TagResource``."""
...
import capo_quicksight.types.tag_resource_request
import capo_quicksight.types.tag_resource_response
...
) -> capo_quicksight.types.tag_resource_response.TagResourceResponse:
    out: capo_quicksight.types.tag_resource_response.TagResourceResponse = (
        capo_quicksight.types.tag_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.tag_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_quicksight.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
