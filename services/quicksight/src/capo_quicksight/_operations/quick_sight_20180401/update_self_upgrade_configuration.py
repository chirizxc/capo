...
import capo_quicksight.errors.invalid_parameter_exception
...
import capo_quicksight.types.update_self_upgrade_configuration_request
import capo_quicksight.types.update_self_upgrade_configuration_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidParameterException":
            raise capo_quicksight.errors.invalid_parameter_exception.InvalidParameterException.from_json(
                data, message
            )
...
) -> capo_quicksight.types.update_self_upgrade_configuration_response.UpdateSelfUpgradeConfigurationResponse:
    out: capo_quicksight.types.update_self_upgrade_configuration_response.UpdateSelfUpgradeConfigurationResponse = capo_quicksight.types.update_self_upgrade_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{Namespace}", quote(input_["namespace"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_self_upgrade_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
