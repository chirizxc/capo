"""Generated from Smithy shape ``com.amazonaws.quicksight#ListFlows``."""
...
) -> capo_quicksight.types.list_flows_output.ListFlowsOutput:
    out: capo_quicksight.types.list_flows_output.ListFlowsOutput = (
        capo_quicksight.types.list_flows_output.deserialize_json(
...
def list_flows(
    ...
    input_: capo_quicksight.types.list_flows_input.ListFlowsInput,
) -> tuple[capo_quicksight.types.list_flows_output.ListFlowsOutput, zapros.Response]:
