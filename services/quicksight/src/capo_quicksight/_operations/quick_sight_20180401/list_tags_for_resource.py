"""Generated from Smithy shape ``com.amazonaws.quicksight#ListTagsForResource``."""
...
import capo_quicksight.types.list_tags_for_resource_request
import capo_quicksight.types.list_tags_for_resource_response
...
) -> capo_quicksight.types.list_tags_for_resource_response.ListTagsForResourceResponse:
    out: capo_quicksight.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_quicksight.types.list_tags_for_resource_response.deserialize_json(
