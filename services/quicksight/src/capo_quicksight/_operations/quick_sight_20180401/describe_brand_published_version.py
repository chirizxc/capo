"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeBrandPublishedVersion``."""
...
import capo_quicksight.types.describe_brand_published_version_request
import capo_quicksight.types.describe_brand_published_version_response
...
) -> capo_quicksight.types.describe_brand_published_version_response.DescribeBrandPublishedVersionResponse:
    out: capo_quicksight.types.describe_brand_published_version_response.DescribeBrandPublishedVersionResponse = capo_quicksight.types.describe_brand_published_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{BrandId}", quote(input_["brand_id"], safe=""))
...
async def async_describe_brand_published_version(
