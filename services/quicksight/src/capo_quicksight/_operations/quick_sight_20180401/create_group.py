"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateGroup``."""
...
import capo_quicksight.types.create_group_request
import capo_quicksight.types.create_group_response
...
) -> capo_quicksight.types.create_group_response.CreateGroupResponse:
    out: capo_quicksight.types.create_group_response.CreateGroupResponse = (
        capo_quicksight.types.create_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_group(
    ...
    capo_quicksight.types.create_group_response.CreateGroupResponse, zapros.Response
]:
