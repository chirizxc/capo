"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateSpaceResources``."""
...
import capo_quicksight.types.update_space_resources_request
import capo_quicksight.types.update_space_resources_response
...
) -> capo_quicksight.types.update_space_resources_response.UpdateSpaceResourcesResponse:
    out: capo_quicksight.types.update_space_resources_response.UpdateSpaceResourcesResponse = capo_quicksight.types.update_space_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_space_resources_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_space_resources(
