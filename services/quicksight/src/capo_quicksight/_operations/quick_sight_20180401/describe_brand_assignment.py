"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeBrandAssignment``."""
...
import capo_quicksight.types.describe_brand_assignment_request
import capo_quicksight.types.describe_brand_assignment_response
...
) -> capo_quicksight.types.describe_brand_assignment_response.DescribeBrandAssignmentResponse:
    out: capo_quicksight.types.describe_brand_assignment_response.DescribeBrandAssignmentResponse = capo_quicksight.types.describe_brand_assignment_response.deserialize_json(
...
async def async_describe_brand_assignment(
