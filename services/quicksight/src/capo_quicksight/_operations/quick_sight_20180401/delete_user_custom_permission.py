...
import capo_quicksight.types.delete_user_custom_permission_response
...
) -> capo_quicksight.types.delete_user_custom_permission_response.DeleteUserCustomPermissionResponse:
    out: capo_quicksight.types.delete_user_custom_permission_response.DeleteUserCustomPermissionResponse = capo_quicksight.types.delete_user_custom_permission_response.deserialize_json(
