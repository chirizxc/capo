...
import capo_quicksight.types.tag_key_list
...
) -> capo_quicksight.types.untag_resource_response.UntagResourceResponse:
    out: capo_quicksight.types.untag_resource_response.UntagResourceResponse = (
        capo_quicksight.types.untag_resource_response.deserialize_json(
...
def untag_resource(
    ...
    capo_quicksight.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
