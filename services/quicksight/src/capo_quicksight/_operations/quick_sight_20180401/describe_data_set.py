...
import capo_quicksight.types.describe_data_set_request
import capo_quicksight.types.describe_data_set_response
...
def handle_response(
    ...
    out: capo_quicksight.types.describe_data_set_response.DescribeDataSetResponse = (
        capo_quicksight.types.describe_data_set_response.deserialize_json(
