...
) -> capo_quicksight.types.create_analysis_response.CreateAnalysisResponse:
    out: capo_quicksight.types.create_analysis_response.CreateAnalysisResponse = (
        capo_quicksight.types.create_analysis_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_analysis_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
