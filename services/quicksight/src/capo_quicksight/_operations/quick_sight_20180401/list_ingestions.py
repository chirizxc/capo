...
import capo_quicksight.types.list_ingestions_request
...
) -> capo_quicksight.types.list_ingestions_response.ListIngestionsResponse:
    out: capo_quicksight.types.list_ingestions_response.ListIngestionsResponse = (
        capo_quicksight.types.list_ingestions_response.deserialize_json(
