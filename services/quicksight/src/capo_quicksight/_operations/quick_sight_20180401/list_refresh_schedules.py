"""Generated from Smithy shape ``com.amazonaws.quicksight#ListRefreshSchedules``."""
...
import capo_quicksight.types.list_refresh_schedules_request
import capo_quicksight.types.list_refresh_schedules_response
...
) -> capo_quicksight.types.list_refresh_schedules_response.ListRefreshSchedulesResponse:
    out: capo_quicksight.types.list_refresh_schedules_response.ListRefreshSchedulesResponse = capo_quicksight.types.list_refresh_schedules_response.deserialize_json(
...
async def async_list_refresh_schedules(
