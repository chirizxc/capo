...
import capo_quicksight.types.describe_template_definition_request
import capo_quicksight.types.describe_template_definition_response
...
) -> capo_quicksight.types.describe_template_definition_response.DescribeTemplateDefinitionResponse:
    out: capo_quicksight.types.describe_template_definition_response.DescribeTemplateDefinitionResponse = capo_quicksight.types.describe_template_definition_response.deserialize_json(
...
def build_request(
    ...
    if "version_number" in input_:
        params.append(("version-number", str(input_["version_number"])))
    if "alias_name" in input_:
        params.append(("alias-name", input_["alias_name"]))
