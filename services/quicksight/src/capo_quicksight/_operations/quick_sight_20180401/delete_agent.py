...
import capo_quicksight.types.delete_agent_request
...
) -> capo_quicksight.types.delete_agent_response.DeleteAgentResponse:
    out: capo_quicksight.types.delete_agent_response.DeleteAgentResponse = (
        capo_quicksight.types.delete_agent_response.deserialize_json(
...
def delete_agent(
    ...
    capo_quicksight.types.delete_agent_response.DeleteAgentResponse, zapros.Response
]:
