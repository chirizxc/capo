"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateDashboard``."""
...
import capo_quicksight.types.create_dashboard_request
import capo_quicksight.types.create_dashboard_response
...
) -> capo_quicksight.types.create_dashboard_response.CreateDashboardResponse:
    out: capo_quicksight.types.create_dashboard_response.CreateDashboardResponse = (
        capo_quicksight.types.create_dashboard_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_dashboard_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
