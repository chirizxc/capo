"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteDataSource``."""
...
import capo_quicksight.types.delete_data_source_request
...
) -> capo_quicksight.types.delete_data_source_response.DeleteDataSourceResponse:
    out: capo_quicksight.types.delete_data_source_response.DeleteDataSourceResponse = (
        capo_quicksight.types.delete_data_source_response.deserialize_json(
