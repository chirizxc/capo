"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateAnalysis``."""
...
) -> capo_quicksight.types.update_analysis_response.UpdateAnalysisResponse:
    out: capo_quicksight.types.update_analysis_response.UpdateAnalysisResponse = (
        capo_quicksight.types.update_analysis_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_analysis_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_analysis(
