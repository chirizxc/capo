"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateVPCConnection``."""
...
) -> capo_quicksight.types.create_vpc_connection_response.CreateVPCConnectionResponse:
    out: capo_quicksight.types.create_vpc_connection_response.CreateVPCConnectionResponse = capo_quicksight.types.create_vpc_connection_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_vpc_connection_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
