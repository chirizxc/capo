...
import capo_quicksight.types.create_action_connector_request
import capo_quicksight.types.create_action_connector_response
...
def handle_response(
    ...
    capo_quicksight.types.create_action_connector_response.CreateActionConnectorResponse
):
    out: capo_quicksight.types.create_action_connector_response.CreateActionConnectorResponse = capo_quicksight.types.create_action_connector_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_action_connector_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
