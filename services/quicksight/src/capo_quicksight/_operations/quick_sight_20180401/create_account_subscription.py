"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateAccountSubscription``."""
...
import capo_quicksight.types.create_account_subscription_request
import capo_quicksight.types.create_account_subscription_response
...
) -> capo_quicksight.types.create_account_subscription_response.CreateAccountSubscriptionResponse:
    out: capo_quicksight.types.create_account_subscription_response.CreateAccountSubscriptionResponse = capo_quicksight.types.create_account_subscription_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_account_subscription_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
