...
) -> capo_quicksight.types.update_user_custom_permission_response.UpdateUserCustomPermissionResponse:
    out: capo_quicksight.types.update_user_custom_permission_response.UpdateUserCustomPermissionResponse = capo_quicksight.types.update_user_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_user_custom_permission_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
