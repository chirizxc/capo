"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateFolderMembership``."""
...
import capo_quicksight.types.create_folder_membership_request
import capo_quicksight.types.create_folder_membership_response
...
) -> capo_quicksight.types.create_folder_membership_response.CreateFolderMembershipResponse:
    out: capo_quicksight.types.create_folder_membership_response.CreateFolderMembershipResponse = capo_quicksight.types.create_folder_membership_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{MemberId}", quote(input_["member_id"], safe=""))
    url = url.replace(
        "{MemberType}",
        quote(
            capo_quicksight.types.member_type.serialize_json(input_["member_type"]),
            safe="",
        ),
    )
...
async def async_create_folder_membership(
