...
import capo_quicksight.types.create_theme_request
import capo_quicksight.types.create_theme_response
...
) -> capo_quicksight.types.create_theme_response.CreateThemeResponse:
    out: capo_quicksight.types.create_theme_response.CreateThemeResponse = (
        capo_quicksight.types.create_theme_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_theme_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_theme(
    ...
    capo_quicksight.types.create_theme_response.CreateThemeResponse, zapros.Response
]:
