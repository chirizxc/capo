"""Generated from Smithy shape ``com.amazonaws.quicksight#ListIAMPolicyAssignmentsForUser``."""
...
import capo_quicksight.types.list_iam_policy_assignments_for_user_request
import capo_quicksight.types.list_iam_policy_assignments_for_user_response
...
) -> capo_quicksight.types.list_iam_policy_assignments_for_user_response.ListIAMPolicyAssignmentsForUserResponse:
    out: capo_quicksight.types.list_iam_policy_assignments_for_user_response.ListIAMPolicyAssignmentsForUserResponse = capo_quicksight.types.list_iam_policy_assignments_for_user_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{UserName}", quote(input_["user_name"], safe=""))
...
async def async_list_iam_policy_assignments_for_user(
