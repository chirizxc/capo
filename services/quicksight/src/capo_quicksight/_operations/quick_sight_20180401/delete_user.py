...
import capo_quicksight.types.delete_user_request
import capo_quicksight.types.delete_user_response
...
) -> capo_quicksight.types.delete_user_response.DeleteUserResponse:
    out: capo_quicksight.types.delete_user_response.DeleteUserResponse = (
        capo_quicksight.types.delete_user_response.deserialize_json(
...
def delete_user(
    ...
    capo_quicksight.types.delete_user_response.DeleteUserResponse, zapros.Response
]:
