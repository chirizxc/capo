"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAgentPermissions``."""
...
import capo_quicksight.types.describe_agent_permissions_request
import capo_quicksight.types.describe_agent_permissions_response
...
) -> capo_quicksight.types.describe_agent_permissions_response.DescribeAgentPermissionsResponse:
    out: capo_quicksight.types.describe_agent_permissions_response.DescribeAgentPermissionsResponse = capo_quicksight.types.describe_agent_permissions_response.deserialize_json(
...
async def async_describe_agent_permissions(
