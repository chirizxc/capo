...
import capo_quicksight.types.update_dashboard_links_request
import capo_quicksight.types.update_dashboard_links_response
...
) -> capo_quicksight.types.update_dashboard_links_response.UpdateDashboardLinksResponse:
    out: capo_quicksight.types.update_dashboard_links_response.UpdateDashboardLinksResponse = capo_quicksight.types.update_dashboard_links_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_dashboard_links_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
