"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateTopic``."""
...
) -> capo_quicksight.types.update_topic_response.UpdateTopicResponse:
    out: capo_quicksight.types.update_topic_response.UpdateTopicResponse = (
        capo_quicksight.types.update_topic_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_topic_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_topic(
    ...
    capo_quicksight.types.update_topic_response.UpdateTopicResponse, zapros.Response
]:
