...
import capo_quicksight.types.start_dashboard_snapshot_job_request
import capo_quicksight.types.start_dashboard_snapshot_job_response
...
) -> capo_quicksight.types.start_dashboard_snapshot_job_response.StartDashboardSnapshotJobResponse:
    out: capo_quicksight.types.start_dashboard_snapshot_job_response.StartDashboardSnapshotJobResponse = capo_quicksight.types.start_dashboard_snapshot_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.start_dashboard_snapshot_job_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
