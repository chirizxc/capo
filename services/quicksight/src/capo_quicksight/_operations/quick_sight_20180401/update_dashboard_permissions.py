...
import capo_quicksight.types.update_dashboard_permissions_request
import capo_quicksight.types.update_dashboard_permissions_response
...
) -> capo_quicksight.types.update_dashboard_permissions_response.UpdateDashboardPermissionsResponse:
    out: capo_quicksight.types.update_dashboard_permissions_response.UpdateDashboardPermissionsResponse = capo_quicksight.types.update_dashboard_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_dashboard_permissions_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
