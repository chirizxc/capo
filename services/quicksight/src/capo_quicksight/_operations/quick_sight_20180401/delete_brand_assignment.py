...
def handle_response(
    ...
    capo_quicksight.types.delete_brand_assignment_response.DeleteBrandAssignmentResponse
):
    out: capo_quicksight.types.delete_brand_assignment_response.DeleteBrandAssignmentResponse = capo_quicksight.types.delete_brand_assignment_response.deserialize_json(
