...
import capo_quicksight.types.describe_space_request
import capo_quicksight.types.describe_space_response
...
) -> capo_quicksight.types.describe_space_response.DescribeSpaceResponse:
    out: capo_quicksight.types.describe_space_response.DescribeSpaceResponse = (
        capo_quicksight.types.describe_space_response.deserialize_json(
...
def build_request(
    ...
    if "max_contributors" in input_:
        params.append(("maxContributors", str(input_["max_contributors"])))
...
def describe_space(
    ...
    capo_quicksight.types.describe_space_response.DescribeSpaceResponse, zapros.Response
]:
