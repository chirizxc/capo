"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTemplateAlias``."""
...
import capo_quicksight.types.describe_template_alias_request
import capo_quicksight.types.describe_template_alias_response
...
def handle_response(
    ...
    capo_quicksight.types.describe_template_alias_response.DescribeTemplateAliasResponse
):
    out: capo_quicksight.types.describe_template_alias_response.DescribeTemplateAliasResponse = capo_quicksight.types.describe_template_alias_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{TemplateId}", quote(input_["template_id"], safe=""))
    url = url.replace("{AliasName}", quote(input_["alias_name"], safe=""))
...
async def async_describe_template_alias(
