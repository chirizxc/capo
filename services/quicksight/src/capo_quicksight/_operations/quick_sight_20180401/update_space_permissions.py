...
import capo_quicksight.types.update_space_permissions_request
import capo_quicksight.types.update_space_permissions_response
...
) -> capo_quicksight.types.update_space_permissions_response.UpdateSpacePermissionsResponse:
    out: capo_quicksight.types.update_space_permissions_response.UpdateSpacePermissionsResponse = capo_quicksight.types.update_space_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_space_permissions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
