"""Generated from Smithy shape ``com.amazonaws.quicksight#ListTemplates``."""
...
import capo_quicksight.types.list_templates_request
import capo_quicksight.types.list_templates_response
...
) -> capo_quicksight.types.list_templates_response.ListTemplatesResponse:
    out: capo_quicksight.types.list_templates_response.ListTemplatesResponse = (
        capo_quicksight.types.list_templates_response.deserialize_json(
...
def list_templates(
    ...
    capo_quicksight.types.list_templates_response.ListTemplatesResponse, zapros.Response
]:
