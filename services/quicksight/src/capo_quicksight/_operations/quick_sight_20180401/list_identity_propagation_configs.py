"""Generated from Smithy shape ``com.amazonaws.quicksight#ListIdentityPropagationConfigs``."""
...
import capo_quicksight.types.list_identity_propagation_configs_request
import capo_quicksight.types.list_identity_propagation_configs_response
...
) -> capo_quicksight.types.list_identity_propagation_configs_response.ListIdentityPropagationConfigsResponse:
    out: capo_quicksight.types.list_identity_propagation_configs_response.ListIdentityPropagationConfigsResponse = capo_quicksight.types.list_identity_propagation_configs_response.deserialize_json(
...
async def async_list_identity_propagation_configs(
