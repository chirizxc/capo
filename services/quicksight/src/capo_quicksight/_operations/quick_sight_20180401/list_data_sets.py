"""Generated from Smithy shape ``com.amazonaws.quicksight#ListDataSets``."""
...
import capo_quicksight.types.list_data_sets_request
...
) -> capo_quicksight.types.list_data_sets_response.ListDataSetsResponse:
    out: capo_quicksight.types.list_data_sets_response.ListDataSetsResponse = (
        capo_quicksight.types.list_data_sets_response.deserialize_json(
...
def list_data_sets(
    ...
    capo_quicksight.types.list_data_sets_response.ListDataSetsResponse, zapros.Response
]:
