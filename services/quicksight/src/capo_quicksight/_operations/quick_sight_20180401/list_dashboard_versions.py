"""Generated from Smithy shape ``com.amazonaws.quicksight#ListDashboardVersions``."""
...
import capo_quicksight.types.list_dashboard_versions_request
import capo_quicksight.types.list_dashboard_versions_response
...
def handle_response(
    ...
    capo_quicksight.types.list_dashboard_versions_response.ListDashboardVersionsResponse
):
    out: capo_quicksight.types.list_dashboard_versions_response.ListDashboardVersionsResponse = capo_quicksight.types.list_dashboard_versions_response.deserialize_json(
...
async def async_list_dashboard_versions(
