"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeSpacePermissions``."""
...
import capo_quicksight.types.describe_space_permissions_request
import capo_quicksight.types.describe_space_permissions_response
...
) -> capo_quicksight.types.describe_space_permissions_response.DescribeSpacePermissionsResponse:
    out: capo_quicksight.types.describe_space_permissions_response.DescribeSpacePermissionsResponse = capo_quicksight.types.describe_space_permissions_response.deserialize_json(
...
async def async_describe_space_permissions(
