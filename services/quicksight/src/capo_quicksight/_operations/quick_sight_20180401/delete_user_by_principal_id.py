...
) -> capo_quicksight.types.delete_user_by_principal_id_response.DeleteUserByPrincipalIdResponse:
    out: capo_quicksight.types.delete_user_by_principal_id_response.DeleteUserByPrincipalIdResponse = capo_quicksight.types.delete_user_by_principal_id_response.deserialize_json(
