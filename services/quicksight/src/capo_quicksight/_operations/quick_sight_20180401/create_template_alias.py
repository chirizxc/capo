...
import capo_quicksight.types.create_template_alias_request
import capo_quicksight.types.create_template_alias_response
...
) -> capo_quicksight.types.create_template_alias_response.CreateTemplateAliasResponse:
    out: capo_quicksight.types.create_template_alias_response.CreateTemplateAliasResponse = capo_quicksight.types.create_template_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_template_alias_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
