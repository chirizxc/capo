"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateAgent``."""
...
import capo_quicksight.types.create_agent_request
...
) -> capo_quicksight.types.create_agent_response.CreateAgentResponse:
    out: capo_quicksight.types.create_agent_response.CreateAgentResponse = (
        capo_quicksight.types.create_agent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_agent_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_agent(
    ...
    capo_quicksight.types.create_agent_response.CreateAgentResponse, zapros.Response
]:
