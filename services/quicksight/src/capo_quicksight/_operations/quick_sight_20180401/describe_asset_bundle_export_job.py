...
) -> capo_quicksight.types.describe_asset_bundle_export_job_response.DescribeAssetBundleExportJobResponse:
    out: capo_quicksight.types.describe_asset_bundle_export_job_response.DescribeAssetBundleExportJobResponse = capo_quicksight.types.describe_asset_bundle_export_job_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{AssetBundleExportJobId}", quote(input_["asset_bundle_export_job_id"], safe="")
    )
