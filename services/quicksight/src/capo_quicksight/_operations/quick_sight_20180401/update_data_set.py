"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDataSet``."""
...
import capo_quicksight.types.update_data_set_request
import capo_quicksight.types.update_data_set_response
...
def handle_response(
    ...
    out: capo_quicksight.types.update_data_set_response.UpdateDataSetResponse = (
        capo_quicksight.types.update_data_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_data_set_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
