...
import capo_quicksight.types.search_data_sets_response
...
) -> capo_quicksight.types.search_data_sets_response.SearchDataSetsResponse:
    out: capo_quicksight.types.search_data_sets_response.SearchDataSetsResponse = (
        capo_quicksight.types.search_data_sets_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.search_data_sets_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
