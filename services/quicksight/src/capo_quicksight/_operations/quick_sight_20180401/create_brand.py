...
) -> capo_quicksight.types.create_brand_response.CreateBrandResponse:
    out: capo_quicksight.types.create_brand_response.CreateBrandResponse = (
        capo_quicksight.types.create_brand_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_brand_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_brand(
    ...
    capo_quicksight.types.create_brand_response.CreateBrandResponse, zapros.Response
]:
