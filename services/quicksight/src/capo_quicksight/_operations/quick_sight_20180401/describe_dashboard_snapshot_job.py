"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDashboardSnapshotJob``."""
...
import capo_quicksight.types.describe_dashboard_snapshot_job_request
import capo_quicksight.types.describe_dashboard_snapshot_job_response
...
) -> capo_quicksight.types.describe_dashboard_snapshot_job_response.DescribeDashboardSnapshotJobResponse:
    out: capo_quicksight.types.describe_dashboard_snapshot_job_response.DescribeDashboardSnapshotJobResponse = capo_quicksight.types.describe_dashboard_snapshot_job_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{SnapshotJobId}", quote(input_["snapshot_job_id"], safe=""))
...
async def async_describe_dashboard_snapshot_job(
