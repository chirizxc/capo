...
import capo_quicksight.types.delete_o_auth_client_application_response
...
) -> capo_quicksight.types.delete_o_auth_client_application_response.DeleteOAuthClientApplicationResponse:
    out: capo_quicksight.types.delete_o_auth_client_application_response.DeleteOAuthClientApplicationResponse = capo_quicksight.types.delete_o_auth_client_application_response.deserialize_json(
