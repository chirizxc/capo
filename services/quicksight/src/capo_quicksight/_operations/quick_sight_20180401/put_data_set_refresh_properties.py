"""Generated from Smithy shape ``com.amazonaws.quicksight#PutDataSetRefreshProperties``."""
...
import capo_quicksight.types.put_data_set_refresh_properties_response
...
) -> capo_quicksight.types.put_data_set_refresh_properties_response.PutDataSetRefreshPropertiesResponse:
    out: capo_quicksight.types.put_data_set_refresh_properties_response.PutDataSetRefreshPropertiesResponse = capo_quicksight.types.put_data_set_refresh_properties_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.put_data_set_refresh_properties_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_data_set_refresh_properties(
