...
def handle_response(
    ...
    out: capo_quicksight.types.update_custom_permissions_response.UpdateCustomPermissionsResponse = capo_quicksight.types.update_custom_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_custom_permissions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
