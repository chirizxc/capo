...
import capo_quicksight.types.update_brand_published_version_response
...
) -> capo_quicksight.types.update_brand_published_version_response.UpdateBrandPublishedVersionResponse:
    out: capo_quicksight.types.update_brand_published_version_response.UpdateBrandPublishedVersionResponse = capo_quicksight.types.update_brand_published_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_brand_published_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
