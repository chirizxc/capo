...
) -> capo_quicksight.types.describe_namespace_response.DescribeNamespaceResponse:
    out: capo_quicksight.types.describe_namespace_response.DescribeNamespaceResponse = (
        capo_quicksight.types.describe_namespace_response.deserialize_json(
