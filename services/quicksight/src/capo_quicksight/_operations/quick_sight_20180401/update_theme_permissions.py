...
import capo_quicksight.types.update_theme_permissions_request
import capo_quicksight.types.update_theme_permissions_response
...
) -> capo_quicksight.types.update_theme_permissions_response.UpdateThemePermissionsResponse:
    out: capo_quicksight.types.update_theme_permissions_response.UpdateThemePermissionsResponse = capo_quicksight.types.update_theme_permissions_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ThemeId}", quote(input_["theme_id"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_theme_permissions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
