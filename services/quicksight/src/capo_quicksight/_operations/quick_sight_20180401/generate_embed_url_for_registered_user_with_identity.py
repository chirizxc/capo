...
import capo_quicksight.types.generate_embed_url_for_registered_user_with_identity_request
import capo_quicksight.types.generate_embed_url_for_registered_user_with_identity_response
...
) -> capo_quicksight.types.generate_embed_url_for_registered_user_with_identity_response.GenerateEmbedUrlForRegisteredUserWithIdentityResponse:
    out: capo_quicksight.types.generate_embed_url_for_registered_user_with_identity_response.GenerateEmbedUrlForRegisteredUserWithIdentityResponse = capo_quicksight.types.generate_embed_url_for_registered_user_with_identity_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.generate_embed_url_for_registered_user_with_identity_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
