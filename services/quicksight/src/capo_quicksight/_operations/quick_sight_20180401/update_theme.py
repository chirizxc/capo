...
import capo_quicksight.types.update_theme_request
...
) -> capo_quicksight.types.update_theme_response.UpdateThemeResponse:
    out: capo_quicksight.types.update_theme_response.UpdateThemeResponse = (
        capo_quicksight.types.update_theme_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_theme_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_theme(
    ...
    capo_quicksight.types.update_theme_response.UpdateThemeResponse, zapros.Response
]:
