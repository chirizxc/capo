"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteCustomPermissions``."""
...
import capo_quicksight.types.delete_custom_permissions_request
import capo_quicksight.types.delete_custom_permissions_response
...
) -> capo_quicksight.types.delete_custom_permissions_response.DeleteCustomPermissionsResponse:
    out: capo_quicksight.types.delete_custom_permissions_response.DeleteCustomPermissionsResponse = capo_quicksight.types.delete_custom_permissions_response.deserialize_json(
...
async def async_delete_custom_permissions(
