"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDashboard``."""
...
import capo_quicksight.types.update_dashboard_request
import capo_quicksight.types.update_dashboard_response
...
) -> capo_quicksight.types.update_dashboard_response.UpdateDashboardResponse:
    out: capo_quicksight.types.update_dashboard_response.UpdateDashboardResponse = (
        capo_quicksight.types.update_dashboard_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_dashboard_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
