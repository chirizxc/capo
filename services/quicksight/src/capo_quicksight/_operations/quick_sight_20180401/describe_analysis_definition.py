"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAnalysisDefinition``."""
...
import capo_quicksight.types.describe_analysis_definition_request
import capo_quicksight.types.describe_analysis_definition_response
...
) -> capo_quicksight.types.describe_analysis_definition_response.DescribeAnalysisDefinitionResponse:
    out: capo_quicksight.types.describe_analysis_definition_response.DescribeAnalysisDefinitionResponse = capo_quicksight.types.describe_analysis_definition_response.deserialize_json(
...
async def async_describe_analysis_definition(
