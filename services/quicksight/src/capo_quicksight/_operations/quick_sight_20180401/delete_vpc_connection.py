"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteVPCConnection``."""
...
import capo_quicksight.types.delete_vpc_connection_request
import capo_quicksight.types.delete_vpc_connection_response
...
def handle_response(
    ...
    out: capo_quicksight.types.delete_vpc_connection_response.DeleteVPCConnectionResponse = capo_quicksight.types.delete_vpc_connection_response.deserialize_json(
...
async def async_delete_vpc_connection(
