"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeRefreshSchedule``."""
...
import capo_quicksight.types.describe_refresh_schedule_request
import capo_quicksight.types.describe_refresh_schedule_response
...
) -> capo_quicksight.types.describe_refresh_schedule_response.DescribeRefreshScheduleResponse:
    out: capo_quicksight.types.describe_refresh_schedule_response.DescribeRefreshScheduleResponse = capo_quicksight.types.describe_refresh_schedule_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ScheduleId}", quote(input_["schedule_id"], safe=""))
...
async def async_describe_refresh_schedule(
