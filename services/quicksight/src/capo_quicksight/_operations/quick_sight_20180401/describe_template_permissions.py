"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeTemplatePermissions``."""
...
import capo_quicksight.types.describe_template_permissions_request
import capo_quicksight.types.describe_template_permissions_response
...
) -> capo_quicksight.types.describe_template_permissions_response.DescribeTemplatePermissionsResponse:
    out: capo_quicksight.types.describe_template_permissions_response.DescribeTemplatePermissionsResponse = capo_quicksight.types.describe_template_permissions_response.deserialize_json(
...
async def async_describe_template_permissions(
