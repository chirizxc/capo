"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateTemplate``."""
...
import capo_quicksight.types.update_template_request
import capo_quicksight.types.update_template_response
...
) -> capo_quicksight.types.update_template_response.UpdateTemplateResponse:
    out: capo_quicksight.types.update_template_response.UpdateTemplateResponse = (
        capo_quicksight.types.update_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_template_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
