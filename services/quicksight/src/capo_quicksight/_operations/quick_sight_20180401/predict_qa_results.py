...
) -> capo_quicksight.types.predict_qa_results_response.PredictQAResultsResponse:
    out: capo_quicksight.types.predict_qa_results_response.PredictQAResultsResponse = (
        capo_quicksight.types.predict_qa_results_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.predict_qa_results_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
