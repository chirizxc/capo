...
import capo_quicksight.types.update_brand_request
import capo_quicksight.types.update_brand_response
...
) -> capo_quicksight.types.update_brand_response.UpdateBrandResponse:
    out: capo_quicksight.types.update_brand_response.UpdateBrandResponse = (
        capo_quicksight.types.update_brand_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_brand_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_brand(
    ...
    capo_quicksight.types.update_brand_response.UpdateBrandResponse, zapros.Response
]:
