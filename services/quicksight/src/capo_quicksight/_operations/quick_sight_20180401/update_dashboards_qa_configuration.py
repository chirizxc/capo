"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDashboardsQAConfiguration``."""
...
import capo_quicksight.types.update_dashboards_qa_configuration_request
import capo_quicksight.types.update_dashboards_qa_configuration_response
...
) -> capo_quicksight.types.update_dashboards_qa_configuration_response.UpdateDashboardsQAConfigurationResponse:
    out: capo_quicksight.types.update_dashboards_qa_configuration_response.UpdateDashboardsQAConfigurationResponse = capo_quicksight.types.update_dashboards_qa_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_dashboards_qa_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_dashboards_qa_configuration(
