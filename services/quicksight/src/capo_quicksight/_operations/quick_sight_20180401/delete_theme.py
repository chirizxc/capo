...
import capo_quicksight.types.delete_theme_request
import capo_quicksight.types.delete_theme_response
...
) -> capo_quicksight.types.delete_theme_response.DeleteThemeResponse:
    out: capo_quicksight.types.delete_theme_response.DeleteThemeResponse = (
        capo_quicksight.types.delete_theme_response.deserialize_json(
...
def delete_theme(
    ...
    capo_quicksight.types.delete_theme_response.DeleteThemeResponse, zapros.Response
]:
