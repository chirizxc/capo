...
import capo_quicksight.types.create_account_customization_request
import capo_quicksight.types.create_account_customization_response
...
) -> capo_quicksight.types.create_account_customization_response.CreateAccountCustomizationResponse:
    out: capo_quicksight.types.create_account_customization_response.CreateAccountCustomizationResponse = capo_quicksight.types.create_account_customization_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_account_customization_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
