...
import capo_quicksight.types.delete_role_membership_request
import capo_quicksight.types.delete_role_membership_response
...
) -> capo_quicksight.types.delete_role_membership_response.DeleteRoleMembershipResponse:
    out: capo_quicksight.types.delete_role_membership_response.DeleteRoleMembershipResponse = capo_quicksight.types.delete_role_membership_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{MemberName}", quote(input_["member_name"], safe=""))
    url = url.replace(
        "{Role}",
