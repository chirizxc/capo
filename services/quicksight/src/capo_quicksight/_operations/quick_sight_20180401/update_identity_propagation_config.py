...
import capo_quicksight.types.update_identity_propagation_config_request
import capo_quicksight.types.update_identity_propagation_config_response
...
) -> capo_quicksight.types.update_identity_propagation_config_response.UpdateIdentityPropagationConfigResponse:
    out: capo_quicksight.types.update_identity_propagation_config_response.UpdateIdentityPropagationConfigResponse = capo_quicksight.types.update_identity_propagation_config_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{Service}",
        quote(
            capo_quicksight.types.service_type.serialize_json(input_["service"]),
            safe="",
        ),
    )
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_identity_propagation_config_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
