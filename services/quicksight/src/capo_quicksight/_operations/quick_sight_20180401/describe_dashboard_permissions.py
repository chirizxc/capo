"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDashboardPermissions``."""
...
import capo_quicksight.types.describe_dashboard_permissions_request
import capo_quicksight.types.describe_dashboard_permissions_response
...
) -> capo_quicksight.types.describe_dashboard_permissions_response.DescribeDashboardPermissionsResponse:
    out: capo_quicksight.types.describe_dashboard_permissions_response.DescribeDashboardPermissionsResponse = capo_quicksight.types.describe_dashboard_permissions_response.deserialize_json(
...
async def async_describe_dashboard_permissions(
