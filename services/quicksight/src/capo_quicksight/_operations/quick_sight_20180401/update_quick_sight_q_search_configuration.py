"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateQuickSightQSearchConfiguration``."""
...
import capo_quicksight.types.update_quick_sight_q_search_configuration_request
import capo_quicksight.types.update_quick_sight_q_search_configuration_response
...
) -> capo_quicksight.types.update_quick_sight_q_search_configuration_response.UpdateQuickSightQSearchConfigurationResponse:
    out: capo_quicksight.types.update_quick_sight_q_search_configuration_response.UpdateQuickSightQSearchConfigurationResponse = capo_quicksight.types.update_quick_sight_q_search_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_quick_sight_q_search_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_quick_sight_q_search_configuration(
