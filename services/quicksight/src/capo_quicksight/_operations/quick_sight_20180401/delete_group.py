"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteGroup``."""
...
import capo_quicksight.types.delete_group_request
import capo_quicksight.types.delete_group_response
...
) -> capo_quicksight.types.delete_group_response.DeleteGroupResponse:
    out: capo_quicksight.types.delete_group_response.DeleteGroupResponse = (
        capo_quicksight.types.delete_group_response.deserialize_json(
...
def delete_group(
    ...
    capo_quicksight.types.delete_group_response.DeleteGroupResponse, zapros.Response
]:
