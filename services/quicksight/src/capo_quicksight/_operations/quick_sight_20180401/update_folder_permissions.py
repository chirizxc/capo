"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateFolderPermissions``."""
...
import capo_quicksight.types.update_folder_permissions_request
import capo_quicksight.types.update_folder_permissions_response
...
) -> capo_quicksight.types.update_folder_permissions_response.UpdateFolderPermissionsResponse:
    out: capo_quicksight.types.update_folder_permissions_response.UpdateFolderPermissionsResponse = capo_quicksight.types.update_folder_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_folder_permissions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_folder_permissions(
