"""Generated from Smithy shape ``com.amazonaws.quicksight#ListNamespaces``."""
...
) -> capo_quicksight.types.list_namespaces_response.ListNamespacesResponse:
    out: capo_quicksight.types.list_namespaces_response.ListNamespacesResponse = (
        capo_quicksight.types.list_namespaces_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/namespaces"
