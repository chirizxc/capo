"""Generated from Smithy shape ``com.amazonaws.quicksight#ListAssetBundleImportJobs``."""
...
import capo_quicksight.types.asset_bundle_import_job_summary_list
import capo_quicksight.types.list_asset_bundle_import_jobs_request
import capo_quicksight.types.list_asset_bundle_import_jobs_response
...
) -> capo_quicksight.types.list_asset_bundle_import_jobs_response.ListAssetBundleImportJobsResponse:
    out: capo_quicksight.types.list_asset_bundle_import_jobs_response.ListAssetBundleImportJobsResponse = capo_quicksight.types.list_asset_bundle_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/accounts/{AwsAccountId}/asset-bundle-import-jobs"
...
async def async_list_asset_bundle_import_jobs(
