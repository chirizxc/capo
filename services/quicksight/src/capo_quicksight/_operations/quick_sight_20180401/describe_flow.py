"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeFlow``."""
...
) -> capo_quicksight.types.describe_flow_response.DescribeFlowResponse:
    out: capo_quicksight.types.describe_flow_response.DescribeFlowResponse = (
        capo_quicksight.types.describe_flow_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{FlowId}", quote(input_["flow_id"], safe=""))
    params: list[tuple[str, str]] = []
    if "publish_state" in input_:
        params.append(
            (
                "publish-state",
                capo_quicksight.types.flow_publish_state.serialize_json(
                    input_["publish_state"]
                ),
            )
        )
...
def describe_flow(
    ...
    capo_quicksight.types.describe_flow_response.DescribeFlowResponse, zapros.Response
]:
