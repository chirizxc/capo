"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateDashboardPublishedVersion``."""
...
import capo_quicksight.types.update_dashboard_published_version_request
import capo_quicksight.types.update_dashboard_published_version_response
...
) -> capo_quicksight.types.update_dashboard_published_version_response.UpdateDashboardPublishedVersionResponse:
    out: capo_quicksight.types.update_dashboard_published_version_response.UpdateDashboardPublishedVersionResponse = capo_quicksight.types.update_dashboard_published_version_response.deserialize_json(
...
async def async_update_dashboard_published_version(
