"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteRefreshSchedule``."""
...
import capo_quicksight.types.delete_refresh_schedule_request
import capo_quicksight.types.delete_refresh_schedule_response
...
def handle_response(
    ...
    capo_quicksight.types.delete_refresh_schedule_response.DeleteRefreshScheduleResponse
):
    out: capo_quicksight.types.delete_refresh_schedule_response.DeleteRefreshScheduleResponse = capo_quicksight.types.delete_refresh_schedule_response.deserialize_json(
...
async def async_delete_refresh_schedule(
