...
import capo_quicksight.types.update_account_custom_permission_response
...
) -> capo_quicksight.types.update_account_custom_permission_response.UpdateAccountCustomPermissionResponse:
    out: capo_quicksight.types.update_account_custom_permission_response.UpdateAccountCustomPermissionResponse = capo_quicksight.types.update_account_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_account_custom_permission_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
