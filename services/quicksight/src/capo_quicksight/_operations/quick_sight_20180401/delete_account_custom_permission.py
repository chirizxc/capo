"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteAccountCustomPermission``."""
...
import capo_quicksight.types.delete_account_custom_permission_request
import capo_quicksight.types.delete_account_custom_permission_response
...
) -> capo_quicksight.types.delete_account_custom_permission_response.DeleteAccountCustomPermissionResponse:
    out: capo_quicksight.types.delete_account_custom_permission_response.DeleteAccountCustomPermissionResponse = capo_quicksight.types.delete_account_custom_permission_response.deserialize_json(
...
async def async_delete_account_custom_permission(
