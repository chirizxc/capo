...
import capo_quicksight.types.create_o_auth_client_application_response
...
) -> capo_quicksight.types.create_o_auth_client_application_response.CreateOAuthClientApplicationResponse:
    out: capo_quicksight.types.create_o_auth_client_application_response.CreateOAuthClientApplicationResponse = capo_quicksight.types.create_o_auth_client_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.create_o_auth_client_application_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
