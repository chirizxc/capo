"""Generated from Smithy shape ``com.amazonaws.quicksight#ListSpaces``."""
...
import capo_quicksight.types.list_spaces_request
import capo_quicksight.types.list_spaces_response
...
) -> capo_quicksight.types.list_spaces_response.ListSpacesResponse:
    out: capo_quicksight.types.list_spaces_response.ListSpacesResponse = (
        capo_quicksight.types.list_spaces_response.deserialize_json(
...
def list_spaces(
    ...
    capo_quicksight.types.list_spaces_response.ListSpacesResponse, zapros.Response
]:
