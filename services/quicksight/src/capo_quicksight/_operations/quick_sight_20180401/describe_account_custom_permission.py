"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAccountCustomPermission``."""
...
import capo_quicksight.types.describe_account_custom_permission_request
import capo_quicksight.types.describe_account_custom_permission_response
...
) -> capo_quicksight.types.describe_account_custom_permission_response.DescribeAccountCustomPermissionResponse:
    out: capo_quicksight.types.describe_account_custom_permission_response.DescribeAccountCustomPermissionResponse = capo_quicksight.types.describe_account_custom_permission_response.deserialize_json(
...
async def async_describe_account_custom_permission(
