...
import capo_quicksight.types.describe_asset_bundle_import_job_response
...
) -> capo_quicksight.types.describe_asset_bundle_import_job_response.DescribeAssetBundleImportJobResponse:
    out: capo_quicksight.types.describe_asset_bundle_import_job_response.DescribeAssetBundleImportJobResponse = capo_quicksight.types.describe_asset_bundle_import_job_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{AssetBundleImportJobId}", quote(input_["asset_bundle_import_job_id"], safe="")
    )
