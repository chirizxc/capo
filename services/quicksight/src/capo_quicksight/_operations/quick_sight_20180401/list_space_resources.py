...
import capo_quicksight.types.list_space_resources_request
import capo_quicksight.types.list_space_resources_response
import capo_quicksight.types.space_resource_summaries
...
) -> capo_quicksight.types.list_space_resources_response.ListSpaceResourcesResponse:
    out: capo_quicksight.types.list_space_resources_response.ListSpaceResourcesResponse = capo_quicksight.types.list_space_resources_response.deserialize_json(
