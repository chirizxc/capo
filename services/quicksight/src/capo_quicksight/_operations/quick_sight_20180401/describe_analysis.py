"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeAnalysis``."""
...
def handle_response(
    ...
    out: capo_quicksight.types.describe_analysis_response.DescribeAnalysisResponse = (
        capo_quicksight.types.describe_analysis_response.deserialize_json(
...
async def async_describe_analysis(
