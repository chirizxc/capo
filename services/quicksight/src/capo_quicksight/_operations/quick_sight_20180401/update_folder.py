"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateFolder``."""
...
import capo_quicksight.types.update_folder_request
import capo_quicksight.types.update_folder_response
...
) -> capo_quicksight.types.update_folder_response.UpdateFolderResponse:
    out: capo_quicksight.types.update_folder_response.UpdateFolderResponse = (
        capo_quicksight.types.update_folder_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_folder_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_folder(
    ...
    capo_quicksight.types.update_folder_response.UpdateFolderResponse, zapros.Response
]:
