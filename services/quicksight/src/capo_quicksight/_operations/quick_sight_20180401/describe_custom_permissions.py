"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeCustomPermissions``."""
...
import capo_quicksight.types.describe_custom_permissions_request
import capo_quicksight.types.describe_custom_permissions_response
...
) -> capo_quicksight.types.describe_custom_permissions_response.DescribeCustomPermissionsResponse:
    out: capo_quicksight.types.describe_custom_permissions_response.DescribeCustomPermissionsResponse = capo_quicksight.types.describe_custom_permissions_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{CustomPermissionsName}", quote(input_["custom_permissions_name"], safe="")
    )
...
async def async_describe_custom_permissions(
