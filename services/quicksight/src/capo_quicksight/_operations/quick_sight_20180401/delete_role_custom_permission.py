"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteRoleCustomPermission``."""
...
import capo_quicksight.types.delete_role_custom_permission_request
import capo_quicksight.types.delete_role_custom_permission_response
...
) -> capo_quicksight.types.delete_role_custom_permission_response.DeleteRoleCustomPermissionResponse:
    out: capo_quicksight.types.delete_role_custom_permission_response.DeleteRoleCustomPermissionResponse = capo_quicksight.types.delete_role_custom_permission_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{Role}",
        quote(capo_quicksight.types.role.serialize_json(input_["role"]), safe=""),
    )
...
async def async_delete_role_custom_permission(
