...
) -> capo_quicksight.types.update_knowledge_base_permissions_response.UpdateKnowledgeBasePermissionsResponse:
    out: capo_quicksight.types.update_knowledge_base_permissions_response.UpdateKnowledgeBasePermissionsResponse = capo_quicksight.types.update_knowledge_base_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_knowledge_base_permissions_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
