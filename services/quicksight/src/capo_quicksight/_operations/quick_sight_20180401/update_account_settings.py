"""Generated from Smithy shape ``com.amazonaws.quicksight#UpdateAccountSettings``."""
...
import capo_quicksight.types.update_account_settings_request
import capo_quicksight.types.update_account_settings_response
...
def handle_response(
    ...
    capo_quicksight.types.update_account_settings_response.UpdateAccountSettingsResponse
):
    out: capo_quicksight.types.update_account_settings_response.UpdateAccountSettingsResponse = capo_quicksight.types.update_account_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_account_settings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
