...
import capo_quicksight.types.describe_o_auth_client_application_response
...
) -> capo_quicksight.types.describe_o_auth_client_application_response.DescribeOAuthClientApplicationResponse:
    out: capo_quicksight.types.describe_o_auth_client_application_response.DescribeOAuthClientApplicationResponse = capo_quicksight.types.describe_o_auth_client_application_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["o_auth_client_application_id"], safe=""),
    )
