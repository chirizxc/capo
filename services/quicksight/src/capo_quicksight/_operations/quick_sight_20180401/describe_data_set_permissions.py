"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDataSetPermissions``."""
...
import capo_quicksight.types.describe_data_set_permissions_request
import capo_quicksight.types.describe_data_set_permissions_response
...
) -> capo_quicksight.types.describe_data_set_permissions_response.DescribeDataSetPermissionsResponse:
    out: capo_quicksight.types.describe_data_set_permissions_response.DescribeDataSetPermissionsResponse = capo_quicksight.types.describe_data_set_permissions_response.deserialize_json(
...
async def async_describe_data_set_permissions(
