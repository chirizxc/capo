...
import capo_quicksight.types.update_template_alias_request
import capo_quicksight.types.update_template_alias_response
...
) -> capo_quicksight.types.update_template_alias_response.UpdateTemplateAliasResponse:
    out: capo_quicksight.types.update_template_alias_response.UpdateTemplateAliasResponse = capo_quicksight.types.update_template_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_template_alias_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
