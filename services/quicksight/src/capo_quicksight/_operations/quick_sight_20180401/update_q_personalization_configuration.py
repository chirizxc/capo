...
import capo_quicksight.types.update_q_personalization_configuration_request
import capo_quicksight.types.update_q_personalization_configuration_response
...
) -> capo_quicksight.types.update_q_personalization_configuration_response.UpdateQPersonalizationConfigurationResponse:
    out: capo_quicksight.types.update_q_personalization_configuration_response.UpdateQPersonalizationConfigurationResponse = capo_quicksight.types.update_q_personalization_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_q_personalization_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
