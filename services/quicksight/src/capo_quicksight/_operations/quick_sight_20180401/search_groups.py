...
import capo_quicksight.types.search_groups_request
import capo_quicksight.types.search_groups_response
...
) -> capo_quicksight.types.search_groups_response.SearchGroupsResponse:
    out: capo_quicksight.types.search_groups_response.SearchGroupsResponse = (
        capo_quicksight.types.search_groups_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.search_groups_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def search_groups(
    ...
    capo_quicksight.types.search_groups_response.SearchGroupsResponse, zapros.Response
]:
