...
import capo_quicksight.types.update_agent_request
...
import capo_quicksight.types.update_agent_response
...
) -> capo_quicksight.types.update_agent_response.UpdateAgentResponse:
    out: capo_quicksight.types.update_agent_response.UpdateAgentResponse = (
        capo_quicksight.types.update_agent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_agent_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_agent(
    ...
    capo_quicksight.types.update_agent_response.UpdateAgentResponse, zapros.Response
]:
