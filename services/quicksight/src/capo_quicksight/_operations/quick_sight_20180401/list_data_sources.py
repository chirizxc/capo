"""Generated from Smithy shape ``com.amazonaws.quicksight#ListDataSources``."""
...
import capo_quicksight.types.data_source_list
...
) -> capo_quicksight.types.list_data_sources_response.ListDataSourcesResponse:
    out: capo_quicksight.types.list_data_sources_response.ListDataSourcesResponse = (
        capo_quicksight.types.list_data_sources_response.deserialize_json(
