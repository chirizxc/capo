...
import capo_quicksight.types.update_space_request
import capo_quicksight.types.update_space_response
...
) -> capo_quicksight.types.update_space_response.UpdateSpaceResponse:
    out: capo_quicksight.types.update_space_response.UpdateSpaceResponse = (
        capo_quicksight.types.update_space_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_quicksight.types.update_space_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_space(
    ...
    capo_quicksight.types.update_space_response.UpdateSpaceResponse, zapros.Response
]:
