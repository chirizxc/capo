"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeDashboard``."""
...
import capo_quicksight.types.describe_dashboard_request
import capo_quicksight.types.describe_dashboard_response
...
) -> capo_quicksight.types.describe_dashboard_response.DescribeDashboardResponse:
    out: capo_quicksight.types.describe_dashboard_response.DescribeDashboardResponse = (
        capo_quicksight.types.describe_dashboard_response.deserialize_json(
