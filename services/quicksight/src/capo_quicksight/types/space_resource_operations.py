...
if TYPE_CHECKING:
    import capo_quicksight.types.space_resource_operation

SpaceResourceOperations: TypeAlias = list[
    "capo_quicksight.types.space_resource_operation.SpaceResourceOperation"
]
...
def serialize_json(value: SpaceResourceOperations) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_quicksight.types.space_resource_operation.serialize_json(item))
    return out
