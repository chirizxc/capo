"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeBrandResponse``."""
...
class DescribeBrandResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeBrandResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeBrandResponse:
    out: DescribeBrandResponse = {}  # type: ignore[typeddict-item]
