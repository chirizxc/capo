...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.scatter_plot_configuration
...
class ScatterPlotVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.scatter_plot_configuration.ScatterPlotConfiguration"
    ]
...
def serialize_json(value: ScatterPlotVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.scatter_plot_configuration.serialize_json(
...
def deserialize_json(data: dict) -> ScatterPlotVisual:
    ...
    if data.get("ChartConfiguration") is not None:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.scatter_plot_configuration.deserialize_json(
