...
class RefreshConfiguration(TypedDict, closed=True):
    incremental_refresh: "capo_quicksight.types.incremental_refresh.IncrementalRefresh"
...
def serialize_json(value: RefreshConfiguration) -> dict:
    ...
    out["IncrementalRefresh"] = (
        capo_quicksight.types.incremental_refresh.serialize_json(
...
def deserialize_json(data: dict) -> RefreshConfiguration:
    ...
    if data.get("IncrementalRefresh") is not None:
        ...
        out["incremental_refresh"] = (
            capo_quicksight.types.incremental_refresh.deserialize_json(
