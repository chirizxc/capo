...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.physical_table_id


class LogicalTableSource(TypedDict, closed=True):
    join_instruction: NotRequired[
        "capo_quicksight.types.join_instruction.JoinInstruction"
    ]
    """<p>Specifies the result of a join of two logical tables.</p>"""
    physical_table_id: NotRequired[
        "capo_quicksight.types.physical_table_id.PhysicalTableId"
    ]
...
def serialize_json(value: LogicalTableSource) -> dict:
    ...
    if "join_instruction" in value:
        ...
        out["JoinInstruction"] = capo_quicksight.types.join_instruction.serialize_json(
...
def deserialize_json(data: dict) -> LogicalTableSource:
    ...
    if data.get("JoinInstruction") is not None:
        ...
        out["join_instruction"] = (
            capo_quicksight.types.join_instruction.deserialize_json(
