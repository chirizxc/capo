...
class FilterOperationSelectedFieldsConfiguration(TypedDict, closed=True):
    selected_fields: NotRequired[
        "capo_quicksight.types.selected_field_list.SelectedFieldList"
    ]
    """<p>Chooses the fields that are filtered in <code>CustomActionFilterOperation</code>.</p>"""
    selected_field_options: NotRequired[
        "capo_quicksight.types.selected_field_options.SelectedFieldOptions"
    ]
    ...
    selected_columns: NotRequired[
        "capo_quicksight.types.custom_action_column_list.CustomActionColumnList"
    ]
...
def serialize_json(value: FilterOperationSelectedFieldsConfiguration) -> dict:
    ...
    if "selected_fields" in value:
        ...
        out["SelectedFields"] = (
            capo_quicksight.types.selected_field_list.serialize_json(
    ...
    if "selected_field_options" in value:
        ...
        out["SelectedFieldOptions"] = (
            capo_quicksight.types.selected_field_options.serialize_json(
    ...
    if "selected_columns" in value:
        ...
        out["SelectedColumns"] = (
            capo_quicksight.types.custom_action_column_list.serialize_json(
...
def deserialize_json(data: dict) -> FilterOperationSelectedFieldsConfiguration:
    ...
    if data.get("SelectedFields") is not None:
        ...
        out["selected_fields"] = (
            capo_quicksight.types.selected_field_list.deserialize_json(
                data["SelectedFields"]
            )
        )
    if data.get("SelectedFieldOptions") is not None:
        ...
        out["selected_field_options"] = (
            capo_quicksight.types.selected_field_options.deserialize_json(
    ...
    if data.get("SelectedColumns") is not None:
        ...
        out["selected_columns"] = (
            capo_quicksight.types.custom_action_column_list.deserialize_json(
