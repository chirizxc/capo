...
class NamedEntityDefinitionMetric(TypedDict, closed=True):
    aggregation: NotRequired[
        "capo_quicksight.types.named_entity_agg_type.NamedEntityAggType"
    ]
    ...
    aggregation_function_parameters: NotRequired[
        "capo_quicksight.types.aggregation_function_parameters.AggregationFunctionParameters"
    ]
...
def serialize_json(value: NamedEntityDefinitionMetric) -> dict:
    ...
    if "aggregation" in value:
        ...
        out["Aggregation"] = capo_quicksight.types.named_entity_agg_type.serialize_json(
            value["aggregation"]
        )
    if "aggregation_function_parameters" in value:
        ...
        out["AggregationFunctionParameters"] = (
            capo_quicksight.types.aggregation_function_parameters.serialize_json(
...
def deserialize_json(data: dict) -> NamedEntityDefinitionMetric:
    ...
    if data.get("Aggregation") is not None:
        ...
        out["aggregation"] = (
            capo_quicksight.types.named_entity_agg_type.deserialize_json(
                data["Aggregation"]
            )
        )
    if data.get("AggregationFunctionParameters") is not None:
        ...
        out["aggregation_function_parameters"] = (
            capo_quicksight.types.aggregation_function_parameters.deserialize_json(
