"""Generated from Smithy shape ``com.amazonaws.quicksight#PivotTableVisual``."""
...
class PivotTableVisual(TypedDict, closed=True):
    visual_id: (
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.pivot_table_configuration.PivotTableConfiguration"
    ]
    """<p>The configuration settings of the visual.</p>"""
    conditional_formatting: NotRequired[
        "capo_quicksight.types.pivot_table_conditional_formatting.PivotTableConditionalFormatting"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: PivotTableVisual) -> dict:
    out: dict = {}
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.pivot_table_configuration.serialize_json(
    ...
    if "conditional_formatting" in value:
        ...
        out["ConditionalFormatting"] = (
            capo_quicksight.types.pivot_table_conditional_formatting.serialize_json(
...
def deserialize_json(data: dict) -> PivotTableVisual:
    ...
    if data.get("ChartConfiguration") is not None:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.pivot_table_configuration.deserialize_json(
    ...
    if data.get("ConditionalFormatting") is not None:
        ...
        out["conditional_formatting"] = (
            capo_quicksight.types.pivot_table_conditional_formatting.deserialize_json(
