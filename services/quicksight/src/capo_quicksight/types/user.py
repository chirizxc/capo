...
class User(TypedDict, closed=True):
    ...
    email: NotRequired["capo_quicksight.types.string.String"]
    """<p>The user's email address.</p>"""
    role: NotRequired["capo_quicksight.types.user_role.UserRole"]
    ...
    identity_type: NotRequired["capo_quicksight.types.identity_type.IdentityType"]
    """<p>The type of identity authentication used by the user.</p>"""
    active: "capo_quicksight.types.boolean.Boolean"
    ...
    principal_id: NotRequired["capo_quicksight.types.string.String"]
...
def serialize_json(value: User) -> dict:
    ...
    if "role" in value:
        ...
        out["Role"] = capo_quicksight.types.user_role.serialize_json(value["role"])
...
def deserialize_json(data: dict) -> User:
    ...
    if data.get("Role") is not None:
        ...
        out["role"] = capo_quicksight.types.user_role.deserialize_json(data["Role"])
    ...
    if data.get("ExternalLoginFederationProviderUrl") is not None:
