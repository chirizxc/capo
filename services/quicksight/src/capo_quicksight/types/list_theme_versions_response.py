...
class ListThemeVersionsResponse(TypedDict, closed=True):
    theme_version_summary_list: NotRequired[
        "capo_quicksight.types.theme_version_summary_list.ThemeVersionSummaryList"
    ]
...
def serialize_json(value: ListThemeVersionsResponse) -> dict:
    ...
    if "theme_version_summary_list" in value:
        ...
        out["ThemeVersionSummaryList"] = (
            capo_quicksight.types.theme_version_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListThemeVersionsResponse:
    ...
    if data.get("ThemeVersionSummaryList") is not None:
        import capo_quicksight.types.theme_version_summary_list

        out["theme_version_summary_list"] = (
            capo_quicksight.types.theme_version_summary_list.deserialize_json(
