...
class DataPathType(TypedDict, closed=True):
    pivot_table_data_path_type: NotRequired[
        "capo_quicksight.types.pivot_table_data_path_type.PivotTableDataPathType"
    ]
...
def serialize_json(value: DataPathType) -> dict:
    ...
    if "pivot_table_data_path_type" in value:
        ...
        out["PivotTableDataPathType"] = (
            capo_quicksight.types.pivot_table_data_path_type.serialize_json(
...
def deserialize_json(data: dict) -> DataPathType:
    ...
    if data.get("PivotTableDataPathType") is not None:
        ...
        out["pivot_table_data_path_type"] = (
            capo_quicksight.types.pivot_table_data_path_type.deserialize_json(
