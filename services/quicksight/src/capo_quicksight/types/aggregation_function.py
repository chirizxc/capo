...
class AggregationFunction(TypedDict, closed=True):
    ...
    attribute_aggregation_function: NotRequired[
        "capo_quicksight.types.attribute_aggregation_function.AttributeAggregationFunction"
    ]
...
def serialize_json(value: AggregationFunction) -> dict:
    ...
    if "attribute_aggregation_function" in value:
        ...
        out["AttributeAggregationFunction"] = (
            capo_quicksight.types.attribute_aggregation_function.serialize_json(
...
def deserialize_json(data: dict) -> AggregationFunction:
    ...
    if data.get("AttributeAggregationFunction") is not None:
        ...
        out["attribute_aggregation_function"] = (
            capo_quicksight.types.attribute_aggregation_function.deserialize_json(
