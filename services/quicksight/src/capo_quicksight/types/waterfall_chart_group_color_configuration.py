...
class WaterfallChartGroupColorConfiguration(TypedDict, closed=True):
    positive_bar_color: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>Defines the color for the positive bars of a waterfall chart.</p>"""
    negative_bar_color: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>Defines the color for the negative bars of a waterfall chart.</p>"""
    total_bar_color: NotRequired["capo_quicksight.types.hex_color.HexColor"]
