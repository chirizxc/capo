...
class BodySectionRepeatDimensionConfiguration(TypedDict, closed=True):
    dynamic_category_dimension_configuration: NotRequired[
        "capo_quicksight.types.body_section_dynamic_category_dimension_configuration.BodySectionDynamicCategoryDimensionConfiguration"
    ]
    ...
    dynamic_numeric_dimension_configuration: NotRequired[
        "capo_quicksight.types.body_section_dynamic_numeric_dimension_configuration.BodySectionDynamicNumericDimensionConfiguration"
    ]
...
def serialize_json(value: BodySectionRepeatDimensionConfiguration) -> dict:
    ...
    if "dynamic_category_dimension_configuration" in value:
        ...
        out["DynamicCategoryDimensionConfiguration"] = (
            capo_quicksight.types.body_section_dynamic_category_dimension_configuration.serialize_json(
    ...
    if "dynamic_numeric_dimension_configuration" in value:
        ...
        out["DynamicNumericDimensionConfiguration"] = (
            capo_quicksight.types.body_section_dynamic_numeric_dimension_configuration.serialize_json(
...
def deserialize_json(data: dict) -> BodySectionRepeatDimensionConfiguration:
    ...
    if data.get("DynamicCategoryDimensionConfiguration") is not None:
        ...
        out["dynamic_category_dimension_configuration"] = (
            capo_quicksight.types.body_section_dynamic_category_dimension_configuration.deserialize_json(
    ...
    if data.get("DynamicNumericDimensionConfiguration") is not None:
        ...
        out["dynamic_numeric_dimension_configuration"] = (
            capo_quicksight.types.body_section_dynamic_numeric_dimension_configuration.deserialize_json(
