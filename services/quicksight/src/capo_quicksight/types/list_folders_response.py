"""Generated from Smithy shape ``com.amazonaws.quicksight#ListFoldersResponse``."""
...
class ListFoldersResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListFoldersResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListFoldersResponse:
    out: ListFoldersResponse = {}  # type: ignore[typeddict-item]
