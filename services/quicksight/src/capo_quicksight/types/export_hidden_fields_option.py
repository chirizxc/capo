"""Generated from Smithy shape ``com.amazonaws.quicksight#ExportHiddenFieldsOption``."""
...
class ExportHiddenFieldsOption(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ExportHiddenFieldsOption) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ExportHiddenFieldsOption:
    out: ExportHiddenFieldsOption = {}  # type: ignore[typeddict-item]
