"""Generated from Smithy shape ``com.amazonaws.quicksight#DescribeBrandPublishedVersionResponse``."""
...
class DescribeBrandPublishedVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeBrandPublishedVersionResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeBrandPublishedVersionResponse:
    out: DescribeBrandPublishedVersionResponse = {}  # type: ignore[typeddict-item]
