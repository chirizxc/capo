...
if TYPE_CHECKING:
    import capo_quicksight.types.cidr
    import capo_quicksight.types.ip_restriction_rule_description

IpRestrictionRuleMap: TypeAlias = dict[
    "capo_quicksight.types.cidr.CIDR",
    "capo_quicksight.types.ip_restriction_rule_description.IpRestrictionRuleDescription",
]
