...
if TYPE_CHECKING:
    import capo_quicksight.types.visual_customization_fields_configuration


class DashboardCustomizationVisualOptions(TypedDict, closed=True):
    fields_configuration: NotRequired[
        "capo_quicksight.types.visual_customization_fields_configuration.VisualCustomizationFieldsConfiguration"
    ]
...
def serialize_json(value: DashboardCustomizationVisualOptions) -> dict:
    ...
    if "fields_configuration" in value:
        ...
        out["FieldsConfiguration"] = (
            capo_quicksight.types.visual_customization_fields_configuration.serialize_json(
...
def deserialize_json(data: dict) -> DashboardCustomizationVisualOptions:
    ...
    if data.get("FieldsConfiguration") is not None:
        import capo_quicksight.types.visual_customization_fields_configuration

        out["fields_configuration"] = (
            capo_quicksight.types.visual_customization_fields_configuration.deserialize_json(
