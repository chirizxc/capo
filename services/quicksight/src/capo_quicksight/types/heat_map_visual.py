...
if TYPE_CHECKING:
    ...
    import capo_quicksight.types.heat_map_configuration
...
class HeatMapVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.heat_map_configuration.HeatMapConfiguration"
    ]
...
def serialize_json(value: HeatMapVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.heat_map_configuration.serialize_json(
...
def deserialize_json(data: dict) -> HeatMapVisual:
    ...
    if data.get("ChartConfiguration") is not None:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.heat_map_configuration.deserialize_json(
