...
class DonutOptions(TypedDict, closed=True):
    arc_options: NotRequired["capo_quicksight.types.arc_options.ArcOptions"]
    ...
    donut_center_options: NotRequired[
        "capo_quicksight.types.donut_center_options.DonutCenterOptions"
    ]
...
def serialize_json(value: DonutOptions) -> dict:
    ...
    if "arc_options" in value:
        ...
        out["ArcOptions"] = capo_quicksight.types.arc_options.serialize_json(
            value["arc_options"]
        )
    if "donut_center_options" in value:
        ...
        out["DonutCenterOptions"] = (
            capo_quicksight.types.donut_center_options.serialize_json(
...
def deserialize_json(data: dict) -> DonutOptions:
    ...
    if data.get("DonutCenterOptions") is not None:
        ...
        out["donut_center_options"] = (
            capo_quicksight.types.donut_center_options.deserialize_json(
