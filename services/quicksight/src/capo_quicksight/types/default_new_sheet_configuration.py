...
class DefaultNewSheetConfiguration(TypedDict, closed=True):
    interactive_layout_configuration: NotRequired[
        "capo_quicksight.types.default_interactive_layout_configuration.DefaultInteractiveLayoutConfiguration"
    ]
    ...
    paginated_layout_configuration: NotRequired[
        "capo_quicksight.types.default_paginated_layout_configuration.DefaultPaginatedLayoutConfiguration"
    ]
...
def serialize_json(value: DefaultNewSheetConfiguration) -> dict:
    ...
    if "interactive_layout_configuration" in value:
        ...
        out["InteractiveLayoutConfiguration"] = (
            capo_quicksight.types.default_interactive_layout_configuration.serialize_json(
    ...
    if "paginated_layout_configuration" in value:
        ...
        out["PaginatedLayoutConfiguration"] = (
            capo_quicksight.types.default_paginated_layout_configuration.serialize_json(
    ...
    if "sheet_content_type" in value:
        ...
        out["SheetContentType"] = (
            capo_quicksight.types.sheet_content_type.serialize_json(
...
def deserialize_json(data: dict) -> DefaultNewSheetConfiguration:
    ...
    if data.get("InteractiveLayoutConfiguration") is not None:
        ...
        out["interactive_layout_configuration"] = (
            capo_quicksight.types.default_interactive_layout_configuration.deserialize_json(
    ...
    if data.get("PaginatedLayoutConfiguration") is not None:
        ...
        out["paginated_layout_configuration"] = (
            capo_quicksight.types.default_paginated_layout_configuration.deserialize_json(
    ...
    if data.get("SheetContentType") is not None:
        ...
        out["sheet_content_type"] = (
            capo_quicksight.types.sheet_content_type.deserialize_json(
