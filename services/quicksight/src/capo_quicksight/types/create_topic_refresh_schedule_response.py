"""Generated from Smithy shape ``com.amazonaws.quicksight#CreateTopicRefreshScheduleResponse``."""
...
class CreateTopicRefreshScheduleResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateTopicRefreshScheduleResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateTopicRefreshScheduleResponse:
    out: CreateTopicRefreshScheduleResponse = {}  # type: ignore[typeddict-item]
