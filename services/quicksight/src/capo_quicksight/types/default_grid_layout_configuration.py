...
class DefaultGridLayoutConfiguration(TypedDict, closed=True):
    canvas_size_options: "capo_quicksight.types.grid_layout_canvas_size_options.GridLayoutCanvasSizeOptions"
