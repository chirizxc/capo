"""Generated from Smithy shape ``com.amazonaws.quicksight#ComboChartDefaultSeriesSettings``."""
...
class ComboChartDefaultSeriesSettings(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ComboChartDefaultSeriesSettings) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ComboChartDefaultSeriesSettings:
    out: ComboChartDefaultSeriesSettings = {}  # type: ignore[typeddict-item]
