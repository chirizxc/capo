...
class UIColorPalette(TypedDict, closed=True):
    primary_foreground: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    ...
    primary_background: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The background color that applies to visuals and other high emphasis UI.</p>"""
    secondary_foreground: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    ...
    secondary_background: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The background color that applies to the sheet background and sheet controls.</p>"""
    accent: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>This color is that applies to selected states and buttons.</p>"""
    accent_foreground: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The foreground color that applies to any text or other elements that appear over the accent color.</p>"""
    danger: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The color that applies to error messages.</p>"""
    danger_foreground: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The foreground color that applies to any text or other elements that appear over the error color.</p>"""
    warning: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>This color that applies to warning and informational messages.</p>"""
    warning_foreground: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The foreground color that applies to any text or other elements that appear over the warning color.</p>"""
    success: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The color that applies to success messages, for example the check mark for a successful download.</p>"""
    success_foreground: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The foreground color that applies to any text or other elements that appear over the success color.</p>"""
    dimension: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The color that applies to the names of fields that are identified as dimensions.</p>"""
    dimension_foreground: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The foreground color that applies to any text or other elements that appear over the dimension color.</p>"""
    measure: NotRequired["capo_quicksight.types.hex_color.HexColor"]
    """<p>The color that applies to the names of fields that are identified as measures.</p>"""
    measure_foreground: NotRequired["capo_quicksight.types.hex_color.HexColor"]
