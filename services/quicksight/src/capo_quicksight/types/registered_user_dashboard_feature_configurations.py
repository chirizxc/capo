...
if TYPE_CHECKING:
    import capo_quicksight.types.amazon_q_in_quick_sight_dashboard_configurations
    import capo_quicksight.types.bookmarks_configurations
...
class RegisteredUserDashboardFeatureConfigurations(TypedDict, closed=True):
    ...
    bookmarks: NotRequired[
        "capo_quicksight.types.bookmarks_configurations.BookmarksConfigurations"
    ]
    ...
    amazon_q_in_quick_sight: NotRequired[
        "capo_quicksight.types.amazon_q_in_quick_sight_dashboard_configurations.AmazonQInQuickSightDashboardConfigurations"
    ]
...
def serialize_json(value: RegisteredUserDashboardFeatureConfigurations) -> dict:
    ...
    if "bookmarks" in value:
        ...
        out["Bookmarks"] = (
            capo_quicksight.types.bookmarks_configurations.serialize_json(
                value["bookmarks"]
            )
        )
    ...
    if "amazon_q_in_quick_sight" in value:
        ...
        out["AmazonQInQuickSight"] = (
            capo_quicksight.types.amazon_q_in_quick_sight_dashboard_configurations.serialize_json(
...
def deserialize_json(data: dict) -> RegisteredUserDashboardFeatureConfigurations:
    ...
    if data.get("Bookmarks") is not None:
        ...
        out["bookmarks"] = (
            capo_quicksight.types.bookmarks_configurations.deserialize_json(
                data["Bookmarks"]
            )
        )
    ...
    if data.get("AmazonQInQuickSight") is not None:
        ...
        out["amazon_q_in_quick_sight"] = (
            capo_quicksight.types.amazon_q_in_quick_sight_dashboard_configurations.deserialize_json(
