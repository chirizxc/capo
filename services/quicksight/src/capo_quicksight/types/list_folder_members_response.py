...
class ListFolderMembersResponse(TypedDict, closed=True):
    ...
    folder_member_list: NotRequired[
        "capo_quicksight.types.folder_member_list.FolderMemberList"
    ]
...
def serialize_json(value: ListFolderMembersResponse) -> dict:
    ...
    if "folder_member_list" in value:
        ...
        out["FolderMemberList"] = (
            capo_quicksight.types.folder_member_list.serialize_json(
...
def deserialize_json(data: dict) -> ListFolderMembersResponse:
    ...
    if data.get("FolderMemberList") is not None:
        import capo_quicksight.types.folder_member_list

        out["folder_member_list"] = (
            capo_quicksight.types.folder_member_list.deserialize_json(
