...
if TYPE_CHECKING:
    import capo_quicksight.types.box_plot_chart_configuration
...
class BoxPlotVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.box_plot_chart_configuration.BoxPlotChartConfiguration"
    ]
...
def serialize_json(value: BoxPlotVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.box_plot_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> BoxPlotVisual:
    ...
    if data.get("ChartConfiguration") is not None:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.box_plot_chart_configuration.deserialize_json(
