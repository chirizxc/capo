...
class FontConfiguration(TypedDict, closed=True):
    font_size: NotRequired["capo_quicksight.types.font_size.FontSize"]
    """<p>The option that determines the text display size.</p>"""
    font_decoration: NotRequired["capo_quicksight.types.font_decoration.FontDecoration"]
    ...
    font_weight: NotRequired["capo_quicksight.types.font_weight.FontWeight"]
    """<p>The option that determines the text display weight, or boldness.</p>"""
    font_style: NotRequired["capo_quicksight.types.font_style.FontStyle"]
...
def serialize_json(value: FontConfiguration) -> dict:
    ...
    if "font_size" in value:
        ...
        out["FontSize"] = capo_quicksight.types.font_size.serialize_json(
            value["font_size"]
        )
    if "font_decoration" in value:
        import capo_quicksight.types.font_decoration

        out["FontDecoration"] = capo_quicksight.types.font_decoration.serialize_json(
    ...
    if "font_weight" in value:
        ...
        out["FontWeight"] = capo_quicksight.types.font_weight.serialize_json(
            value["font_weight"]
        )
    if "font_style" in value:
        import capo_quicksight.types.font_style

        out["FontStyle"] = capo_quicksight.types.font_style.serialize_json(
            value["font_style"]
        )
