...
if TYPE_CHECKING:
    import capo_quicksight.types.control_title_plain_text
    import capo_quicksight.types.control_title_rich_text


class ControlTitleFormatText(TypedDict, closed=True):
    plain_text: NotRequired[
        "capo_quicksight.types.control_title_plain_text.ControlTitlePlainText"
    ]
    """<p>The plain text format of the title text.</p>"""
    rich_text: NotRequired[
        "capo_quicksight.types.control_title_rich_text.ControlTitleRichText"
    ]
