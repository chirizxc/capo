...
def serialize_json(value: UpdateSelfUpgradeResponse) -> dict:
    ...
    if "self_upgrade_request_detail" in value:
        ...
        out["SelfUpgradeRequestDetail"] = (
            capo_quicksight.types.self_upgrade_request_detail.serialize_json(
...
def deserialize_json(data: dict) -> UpdateSelfUpgradeResponse:
    ...
    if data.get("SelfUpgradeRequestDetail") is not None:
        import capo_quicksight.types.self_upgrade_request_detail

        out["self_upgrade_request_detail"] = (
            capo_quicksight.types.self_upgrade_request_detail.deserialize_json(
