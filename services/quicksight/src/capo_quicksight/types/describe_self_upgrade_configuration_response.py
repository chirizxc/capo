...
class DescribeSelfUpgradeConfigurationResponse(TypedDict, closed=True):
    self_upgrade_configuration: NotRequired[
        "capo_quicksight.types.self_upgrade_configuration.SelfUpgradeConfiguration"
    ]
...
def serialize_json(value: DescribeSelfUpgradeConfigurationResponse) -> dict:
    ...
    if "self_upgrade_configuration" in value:
        ...
        out["SelfUpgradeConfiguration"] = (
            capo_quicksight.types.self_upgrade_configuration.serialize_json(
...
def deserialize_json(data: dict) -> DescribeSelfUpgradeConfigurationResponse:
    ...
    if data.get("SelfUpgradeConfiguration") is not None:
        ...
        out["self_upgrade_configuration"] = (
            capo_quicksight.types.self_upgrade_configuration.deserialize_json(
