...
class ListOAuthClientApplicationsResponse(TypedDict, closed=True):
    o_auth_client_applications: NotRequired[
        "capo_quicksight.types.o_auth_client_application_summary_list.OAuthClientApplicationSummaryList"
    ]
...
def serialize_json(value: ListOAuthClientApplicationsResponse) -> dict:
    ...
    if "o_auth_client_applications" in value:
        ...
        out["OAuthClientApplications"] = (
            capo_quicksight.types.o_auth_client_application_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListOAuthClientApplicationsResponse:
    ...
    if data.get("OAuthClientApplications") is not None:
        import capo_quicksight.types.o_auth_client_application_summary_list

        out["o_auth_client_applications"] = (
            capo_quicksight.types.o_auth_client_application_summary_list.deserialize_json(
