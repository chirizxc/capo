...
class ChartAxisLabelOptions(TypedDict, closed=True):
    ...
    sort_icon_visibility: NotRequired["capo_quicksight.types.visibility.Visibility"]
    """<p>The visibility configuration of the sort icon on a chart's axis label.</p>"""
    axis_label_options: NotRequired[
        "capo_quicksight.types.axis_label_options_list.AxisLabelOptionsList"
    ]
...
def serialize_json(value: ChartAxisLabelOptions) -> dict:
    ...
    if "sort_icon_visibility" in value:
        ...
        out["SortIconVisibility"] = capo_quicksight.types.visibility.serialize_json(
    ...
    if "axis_label_options" in value:
        ...
        out["AxisLabelOptions"] = (
            capo_quicksight.types.axis_label_options_list.serialize_json(
...
def deserialize_json(data: dict) -> ChartAxisLabelOptions:
    ...
    if data.get("AxisLabelOptions") is not None:
        ...
        out["axis_label_options"] = (
            capo_quicksight.types.axis_label_options_list.deserialize_json(
