...
class AnalysisSourceEntity(TypedDict, closed=True):
    source_template: NotRequired[
        "capo_quicksight.types.analysis_source_template.AnalysisSourceTemplate"
    ]
...
def serialize_json(value: AnalysisSourceEntity) -> dict:
    ...
    if "source_template" in value:
        ...
        out["SourceTemplate"] = (
            capo_quicksight.types.analysis_source_template.serialize_json(
...
def deserialize_json(data: dict) -> AnalysisSourceEntity:
    ...
    if data.get("SourceTemplate") is not None:
        ...
        out["source_template"] = (
            capo_quicksight.types.analysis_source_template.deserialize_json(
                data["SourceTemplate"]
            )
        )
    return out
