...
class AxisDataOptions(TypedDict, closed=True):
    numeric_axis_options: NotRequired[
        "capo_quicksight.types.numeric_axis_options.NumericAxisOptions"
    ]
    """<p>The options for an axis with a numeric field.</p>"""
    date_axis_options: NotRequired[
        "capo_quicksight.types.date_axis_options.DateAxisOptions"
    ]
...
def serialize_json(value: AxisDataOptions) -> dict:
    ...
    if "numeric_axis_options" in value:
        ...
        out["NumericAxisOptions"] = (
            capo_quicksight.types.numeric_axis_options.serialize_json(
    ...
    if "date_axis_options" in value:
        ...
        out["DateAxisOptions"] = capo_quicksight.types.date_axis_options.serialize_json(
...
def deserialize_json(data: dict) -> AxisDataOptions:
    ...
    if data.get("NumericAxisOptions") is not None:
        ...
        out["numeric_axis_options"] = (
            capo_quicksight.types.numeric_axis_options.deserialize_json(
    ...
    if data.get("DateAxisOptions") is not None:
        ...
        out["date_axis_options"] = (
            capo_quicksight.types.date_axis_options.deserialize_json(
