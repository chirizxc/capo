...
if TYPE_CHECKING:
    import capo_quicksight.types.audio_extraction_configuration
    import capo_quicksight.types.image_extraction_configuration
    import capo_quicksight.types.video_extraction_configuration


class MediaExtractionConfiguration(TypedDict, closed=True):
    image_extraction_configuration: NotRequired[
        "capo_quicksight.types.image_extraction_configuration.ImageExtractionConfiguration"
    ]
    """<p>The configuration for image extraction.</p>"""
    audio_extraction_configuration: NotRequired[
        "capo_quicksight.types.audio_extraction_configuration.AudioExtractionConfiguration"
    ]
    """<p>The configuration for audio extraction.</p>"""
    video_extraction_configuration: NotRequired[
        "capo_quicksight.types.video_extraction_configuration.VideoExtractionConfiguration"
    ]
...
def serialize_json(value: MediaExtractionConfiguration) -> dict:
    ...
    if "image_extraction_configuration" in value:
        ...
        out["imageExtractionConfiguration"] = (
            capo_quicksight.types.image_extraction_configuration.serialize_json(
    ...
    if "audio_extraction_configuration" in value:
        ...
        out["audioExtractionConfiguration"] = (
            capo_quicksight.types.audio_extraction_configuration.serialize_json(
    ...
    if "video_extraction_configuration" in value:
        ...
        out["videoExtractionConfiguration"] = (
            capo_quicksight.types.video_extraction_configuration.serialize_json(
...
def deserialize_json(data: dict) -> MediaExtractionConfiguration:
    ...
    if data.get("imageExtractionConfiguration") is not None:
        ...
        out["image_extraction_configuration"] = (
            capo_quicksight.types.image_extraction_configuration.deserialize_json(
    ...
    if data.get("audioExtractionConfiguration") is not None:
        ...
        out["audio_extraction_configuration"] = (
            capo_quicksight.types.audio_extraction_configuration.deserialize_json(
    ...
    if data.get("videoExtractionConfiguration") is not None:
        ...
        out["video_extraction_configuration"] = (
            capo_quicksight.types.video_extraction_configuration.deserialize_json(
