...
class DrillDownFilter(TypedDict, closed=True):
    numeric_equality_filter: NotRequired[
        "capo_quicksight.types.numeric_equality_drill_down_filter.NumericEqualityDrillDownFilter"
    ]
    """<p>The numeric equality type drill down filter. This filter is used for number type columns.</p>"""
    category_filter: NotRequired[
        "capo_quicksight.types.category_drill_down_filter.CategoryDrillDownFilter"
    ]
    """<p>The category type drill down filter. This filter is used for string type columns.</p>"""
    time_range_filter: NotRequired[
        "capo_quicksight.types.time_range_drill_down_filter.TimeRangeDrillDownFilter"
    ]
...
def serialize_json(value: DrillDownFilter) -> dict:
    ...
    if "numeric_equality_filter" in value:
        ...
        out["NumericEqualityFilter"] = (
            capo_quicksight.types.numeric_equality_drill_down_filter.serialize_json(
    ...
    if "category_filter" in value:
        ...
        out["CategoryFilter"] = (
            capo_quicksight.types.category_drill_down_filter.serialize_json(
    ...
    if "time_range_filter" in value:
        ...
        out["TimeRangeFilter"] = (
            capo_quicksight.types.time_range_drill_down_filter.serialize_json(
...
def deserialize_json(data: dict) -> DrillDownFilter:
    ...
    if data.get("NumericEqualityFilter") is not None:
        ...
        out["numeric_equality_filter"] = (
            capo_quicksight.types.numeric_equality_drill_down_filter.deserialize_json(
    ...
    if data.get("CategoryFilter") is not None:
        ...
        out["category_filter"] = (
            capo_quicksight.types.category_drill_down_filter.deserialize_json(
                data["CategoryFilter"]
            )
        )
    if data.get("TimeRangeFilter") is not None:
        ...
        out["time_range_filter"] = (
            capo_quicksight.types.time_range_drill_down_filter.deserialize_json(
