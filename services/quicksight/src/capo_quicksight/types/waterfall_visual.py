...
class WaterfallVisual(TypedDict, closed=True):
    ...
    chart_configuration: NotRequired[
        "capo_quicksight.types.waterfall_chart_configuration.WaterfallChartConfiguration"
    ]
...
def serialize_json(value: WaterfallVisual) -> dict:
    ...
    if "chart_configuration" in value:
        ...
        out["ChartConfiguration"] = (
            capo_quicksight.types.waterfall_chart_configuration.serialize_json(
...
def deserialize_json(data: dict) -> WaterfallVisual:
    ...
    if data.get("ChartConfiguration") is not None:
        ...
        out["chart_configuration"] = (
            capo_quicksight.types.waterfall_chart_configuration.deserialize_json(
