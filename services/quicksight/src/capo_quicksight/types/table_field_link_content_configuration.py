...
class TableFieldLinkContentConfiguration(TypedDict, closed=True):
    custom_text_content: NotRequired[
        "capo_quicksight.types.table_field_custom_text_content.TableFieldCustomTextContent"
    ]
    ...
    custom_icon_content: NotRequired[
        "capo_quicksight.types.table_field_custom_icon_content.TableFieldCustomIconContent"
    ]
...
def serialize_json(value: TableFieldLinkContentConfiguration) -> dict:
    ...
    if "custom_text_content" in value:
        ...
        out["CustomTextContent"] = (
            capo_quicksight.types.table_field_custom_text_content.serialize_json(
    ...
    if "custom_icon_content" in value:
        ...
        out["CustomIconContent"] = (
            capo_quicksight.types.table_field_custom_icon_content.serialize_json(
...
def deserialize_json(data: dict) -> TableFieldLinkContentConfiguration:
    ...
    if data.get("CustomTextContent") is not None:
        ...
        out["custom_text_content"] = (
            capo_quicksight.types.table_field_custom_text_content.deserialize_json(
    ...
    if data.get("CustomIconContent") is not None:
        ...
        out["custom_icon_content"] = (
            capo_quicksight.types.table_field_custom_icon_content.deserialize_json(
