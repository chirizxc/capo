"""Generated from Smithy shape ``com.amazonaws.quicksight#DeleteFolderResponse``."""
...
class DeleteFolderResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteFolderResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> DeleteFolderResponse:
    out: DeleteFolderResponse = {}  # type: ignore[typeddict-item]
