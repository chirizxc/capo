"""Generated from Smithy shape ``com.amazonaws.quicksight#InvalidParameterValueException``."""
...
class InvalidParameterValueException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.quicksight#InvalidParameterValueException``."""
