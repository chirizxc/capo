"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#CreateApplicationSnapshot``."""
...
import capo_kinesis_analytics_v2.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_kinesis_analytics_v2.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.create_application_snapshot_response.CreateApplicationSnapshotResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.CreateApplicationSnapshot"
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.create_application_snapshot_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_application_snapshot(
