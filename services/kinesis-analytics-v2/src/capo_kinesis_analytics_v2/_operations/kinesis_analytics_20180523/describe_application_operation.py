"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DescribeApplicationOperation``."""
...
import capo_kinesis_analytics_v2.types.application_operation_info_details
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.describe_application_operation_response.DescribeApplicationOperationResponse = capo_kinesis_analytics_v2.types.describe_application_operation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KinesisAnalytics_20180523.DescribeApplicationOperation"
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.describe_application_operation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_application_operation(
