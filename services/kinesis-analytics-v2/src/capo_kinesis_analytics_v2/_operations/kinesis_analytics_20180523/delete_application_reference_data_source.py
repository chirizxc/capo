"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#DeleteApplicationReferenceDataSource``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.delete_application_reference_data_source_response.DeleteApplicationReferenceDataSourceResponse = capo_kinesis_analytics_v2.types.delete_application_reference_data_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.delete_application_reference_data_source_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
