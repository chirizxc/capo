...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.delete_application_cloud_watch_logging_option_response.DeleteApplicationCloudWatchLoggingOptionResponse = capo_kinesis_analytics_v2.types.delete_application_cloud_watch_logging_option_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.delete_application_cloud_watch_logging_option_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
