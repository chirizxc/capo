"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#CreateApplication``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.create_application_response.CreateApplicationResponse = capo_kinesis_analytics_v2.types.create_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.create_application_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
