"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#AddApplicationInputProcessingConfiguration``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.add_application_input_processing_configuration_response.AddApplicationInputProcessingConfigurationResponse = capo_kinesis_analytics_v2.types.add_application_input_processing_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.add_application_input_processing_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
