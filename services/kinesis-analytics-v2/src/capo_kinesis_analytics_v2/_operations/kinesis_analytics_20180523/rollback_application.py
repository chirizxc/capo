...
def handle_response(
    ...
    out: capo_kinesis_analytics_v2.types.rollback_application_response.RollbackApplicationResponse = capo_kinesis_analytics_v2.types.rollback_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics_v2.types.rollback_application_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
