"""Generated from Smithy shape ``com.amazonaws.kinesisanalyticsv2#InvalidRequestException``."""
...
class InvalidRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisanalyticsv2#InvalidRequestException``."""
