...
if TYPE_CHECKING:
    import capo_kinesis_analytics_v2.types.catalog_configuration
    import capo_kinesis_analytics_v2.types.custom_artifacts_configuration_list
    import capo_kinesis_analytics_v2.types.deploy_as_application_configuration
    import capo_kinesis_analytics_v2.types.zeppelin_monitoring_configuration


class ZeppelinApplicationConfiguration(TypedDict, closed=True):
    monitoring_configuration: NotRequired[
        "capo_kinesis_analytics_v2.types.zeppelin_monitoring_configuration.ZeppelinMonitoringConfiguration"
    ]
    """<p>The monitoring configuration of a Managed Service for Apache Flink Studio notebook.</p>"""
    catalog_configuration: NotRequired[
        "capo_kinesis_analytics_v2.types.catalog_configuration.CatalogConfiguration"
    ]
    ...
    deploy_as_application_configuration: NotRequired[
        "capo_kinesis_analytics_v2.types.deploy_as_application_configuration.DeployAsApplicationConfiguration"
    ]
...
def serialize_aws_json_1_1(value: ZeppelinApplicationConfiguration) -> dict:
    ...
    if "monitoring_configuration" in value:
        ...
        out["MonitoringConfiguration"] = (
            capo_kinesis_analytics_v2.types.zeppelin_monitoring_configuration.serialize_aws_json_1_1(
    ...
    if "catalog_configuration" in value:
        ...
        out["CatalogConfiguration"] = (
            capo_kinesis_analytics_v2.types.catalog_configuration.serialize_aws_json_1_1(
    ...
    if "deploy_as_application_configuration" in value:
        ...
        out["DeployAsApplicationConfiguration"] = (
            capo_kinesis_analytics_v2.types.deploy_as_application_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ZeppelinApplicationConfiguration:
    ...
    if data.get("MonitoringConfiguration") is not None:
        ...
        out["monitoring_configuration"] = (
            capo_kinesis_analytics_v2.types.zeppelin_monitoring_configuration.deserialize_aws_json_1_1(
    ...
    if data.get("CatalogConfiguration") is not None:
        ...
        out["catalog_configuration"] = (
            capo_kinesis_analytics_v2.types.catalog_configuration.deserialize_aws_json_1_1(
                data["CatalogConfiguration"]
            )
        )
    if data.get("DeployAsApplicationConfiguration") is not None:
        import capo_kinesis_analytics_v2.types.deploy_as_application_configuration

        out["deploy_as_application_configuration"] = (
            capo_kinesis_analytics_v2.types.deploy_as_application_configuration.deserialize_aws_json_1_1(
                data["DeployAsApplicationConfiguration"]
            )
        )
    if data.get("CustomArtifactsConfiguration") is not None:
        import capo_kinesis_analytics_v2.types.custom_artifacts_configuration_list
