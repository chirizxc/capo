...
class ApplicationConfigurationUpdate(TypedDict, closed=True):
    sql_application_configuration_update: NotRequired[
        "capo_kinesis_analytics_v2.types.sql_application_configuration_update.SqlApplicationConfigurationUpdate"
    ]
    ...
    application_code_configuration_update: NotRequired[
        "capo_kinesis_analytics_v2.types.application_code_configuration_update.ApplicationCodeConfigurationUpdate"
    ]
    """<p>Describes updates to an application's code configuration.</p>"""
    flink_application_configuration_update: NotRequired[
        "capo_kinesis_analytics_v2.types.flink_application_configuration_update.FlinkApplicationConfigurationUpdate"
    ]
    ...
    environment_property_updates: NotRequired[
        "capo_kinesis_analytics_v2.types.environment_property_updates.EnvironmentPropertyUpdates"
    ]
    ...
    application_snapshot_configuration_update: NotRequired[
        "capo_kinesis_analytics_v2.types.application_snapshot_configuration_update.ApplicationSnapshotConfigurationUpdate"
    ]
    ...
    application_system_rollback_configuration_update: NotRequired[
        "capo_kinesis_analytics_v2.types.application_system_rollback_configuration_update.ApplicationSystemRollbackConfigurationUpdate"
    ]
    ...
    vpc_configuration_updates: NotRequired[
        "capo_kinesis_analytics_v2.types.vpc_configuration_updates.VpcConfigurationUpdates"
    ]
    ...
    zeppelin_application_configuration_update: NotRequired[
        "capo_kinesis_analytics_v2.types.zeppelin_application_configuration_update.ZeppelinApplicationConfigurationUpdate"
    ]
    ...
    application_encryption_configuration_update: NotRequired[
        "capo_kinesis_analytics_v2.types.application_encryption_configuration_update.ApplicationEncryptionConfigurationUpdate"
    ]
...
def serialize_aws_json_1_1(value: ApplicationConfigurationUpdate) -> dict:
    ...
    if "sql_application_configuration_update" in value:
        ...
        out["SqlApplicationConfigurationUpdate"] = (
            capo_kinesis_analytics_v2.types.sql_application_configuration_update.serialize_aws_json_1_1(
    ...
    if "application_code_configuration_update" in value:
        ...
        out["ApplicationCodeConfigurationUpdate"] = (
            capo_kinesis_analytics_v2.types.application_code_configuration_update.serialize_aws_json_1_1(
    ...
    if "flink_application_configuration_update" in value:
        ...
        out["FlinkApplicationConfigurationUpdate"] = (
            capo_kinesis_analytics_v2.types.flink_application_configuration_update.serialize_aws_json_1_1(
    ...
    if "environment_property_updates" in value:
        ...
        out["EnvironmentPropertyUpdates"] = (
            capo_kinesis_analytics_v2.types.environment_property_updates.serialize_aws_json_1_1(
    ...
    if "application_snapshot_configuration_update" in value:
        ...
        out["ApplicationSnapshotConfigurationUpdate"] = (
            capo_kinesis_analytics_v2.types.application_snapshot_configuration_update.serialize_aws_json_1_1(
    ...
    if "application_system_rollback_configuration_update" in value:
        ...
        out["ApplicationSystemRollbackConfigurationUpdate"] = (
            capo_kinesis_analytics_v2.types.application_system_rollback_configuration_update.serialize_aws_json_1_1(
    ...
    if "vpc_configuration_updates" in value:
        ...
        out["VpcConfigurationUpdates"] = (
            capo_kinesis_analytics_v2.types.vpc_configuration_updates.serialize_aws_json_1_1(
    ...
    if "zeppelin_application_configuration_update" in value:
        ...
        out["ZeppelinApplicationConfigurationUpdate"] = (
            capo_kinesis_analytics_v2.types.zeppelin_application_configuration_update.serialize_aws_json_1_1(
    ...
    if "application_encryption_configuration_update" in value:
        ...
        out["ApplicationEncryptionConfigurationUpdate"] = (
            capo_kinesis_analytics_v2.types.application_encryption_configuration_update.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ApplicationConfigurationUpdate:
    ...
    if data.get("SqlApplicationConfigurationUpdate") is not None:
        ...
        out["sql_application_configuration_update"] = (
            capo_kinesis_analytics_v2.types.sql_application_configuration_update.deserialize_aws_json_1_1(
    ...
    if data.get("ApplicationCodeConfigurationUpdate") is not None:
        ...
        out["application_code_configuration_update"] = (
            capo_kinesis_analytics_v2.types.application_code_configuration_update.deserialize_aws_json_1_1(
    ...
    if data.get("FlinkApplicationConfigurationUpdate") is not None:
        ...
        out["flink_application_configuration_update"] = (
            capo_kinesis_analytics_v2.types.flink_application_configuration_update.deserialize_aws_json_1_1(
    ...
    if data.get("EnvironmentPropertyUpdates") is not None:
        ...
        out["environment_property_updates"] = (
            capo_kinesis_analytics_v2.types.environment_property_updates.deserialize_aws_json_1_1(
    ...
    if data.get("ApplicationSnapshotConfigurationUpdate") is not None:
        ...
        out["application_snapshot_configuration_update"] = (
            capo_kinesis_analytics_v2.types.application_snapshot_configuration_update.deserialize_aws_json_1_1(
    ...
    if data.get("ApplicationSystemRollbackConfigurationUpdate") is not None:
        ...
        out["application_system_rollback_configuration_update"] = (
            capo_kinesis_analytics_v2.types.application_system_rollback_configuration_update.deserialize_aws_json_1_1(
    ...
    if data.get("VpcConfigurationUpdates") is not None:
        ...
        out["vpc_configuration_updates"] = (
            capo_kinesis_analytics_v2.types.vpc_configuration_updates.deserialize_aws_json_1_1(
    ...
    if data.get("ZeppelinApplicationConfigurationUpdate") is not None:
        ...
        out["zeppelin_application_configuration_update"] = (
            capo_kinesis_analytics_v2.types.zeppelin_application_configuration_update.deserialize_aws_json_1_1(
    ...
    if data.get("ApplicationEncryptionConfigurationUpdate") is not None:
        ...
        out["application_encryption_configuration_update"] = (
            capo_kinesis_analytics_v2.types.application_encryption_configuration_update.deserialize_aws_json_1_1(
