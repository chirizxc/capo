...
if TYPE_CHECKING:
    import capo_kinesis_analytics_v2.types.record_column_delimiter
    import capo_kinesis_analytics_v2.types.record_row_delimiter


class CSVMappingParameters(TypedDict, closed=True):
    record_row_delimiter: (
        "capo_kinesis_analytics_v2.types.record_row_delimiter.RecordRowDelimiter"
    )
