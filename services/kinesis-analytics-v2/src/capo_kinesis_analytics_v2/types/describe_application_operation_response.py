...
class DescribeApplicationOperationResponse(TypedDict, closed=True):
    application_operation_info_details: NotRequired[
        "capo_kinesis_analytics_v2.types.application_operation_info_details.ApplicationOperationInfoDetails"
    ]
...
def serialize_aws_json_1_1(value: DescribeApplicationOperationResponse) -> dict:
    ...
    if "application_operation_info_details" in value:
        ...
        out["ApplicationOperationInfoDetails"] = (
            capo_kinesis_analytics_v2.types.application_operation_info_details.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeApplicationOperationResponse:
    ...
    if data.get("ApplicationOperationInfoDetails") is not None:
        import capo_kinesis_analytics_v2.types.application_operation_info_details

        out["application_operation_info_details"] = (
            capo_kinesis_analytics_v2.types.application_operation_info_details.deserialize_aws_json_1_1(
