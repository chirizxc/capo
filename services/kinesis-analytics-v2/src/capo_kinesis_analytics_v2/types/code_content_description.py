...
if TYPE_CHECKING:
    import capo_kinesis_analytics_v2.types.code_md5
    import capo_kinesis_analytics_v2.types.code_size
...
class CodeContentDescription(TypedDict, closed=True):
    ...
    code_md5: NotRequired["capo_kinesis_analytics_v2.types.code_md5.CodeMD5"]
    """<p>The checksum that can be used to validate zip-format code.</p>"""
    code_size: NotRequired["capo_kinesis_analytics_v2.types.code_size.CodeSize"]
    ...
    s3_application_code_location_description: NotRequired[
        "capo_kinesis_analytics_v2.types.s3_application_code_location_description.S3ApplicationCodeLocationDescription"
    ]
...
def serialize_aws_json_1_1(value: CodeContentDescription) -> dict:
    ...
    if "s3_application_code_location_description" in value:
        ...
        out["S3ApplicationCodeLocationDescription"] = (
            capo_kinesis_analytics_v2.types.s3_application_code_location_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CodeContentDescription:
    ...
    if data.get("S3ApplicationCodeLocationDescription") is not None:
        ...
        out["s3_application_code_location_description"] = (
            capo_kinesis_analytics_v2.types.s3_application_code_location_description.deserialize_aws_json_1_1(
