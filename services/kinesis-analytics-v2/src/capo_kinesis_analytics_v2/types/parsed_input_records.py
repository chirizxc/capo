...
if TYPE_CHECKING:
    import capo_kinesis_analytics_v2.types.parsed_input_record

ParsedInputRecords: TypeAlias = list[
    "capo_kinesis_analytics_v2.types.parsed_input_record.ParsedInputRecord"
]
...
def serialize_aws_json_1_1(value: ParsedInputRecords) -> list:
    ...
    for item in value:
        out.append(
            capo_kinesis_analytics_v2.types.parsed_input_record.serialize_aws_json_1_1(
                item
            )
        )
    return out
