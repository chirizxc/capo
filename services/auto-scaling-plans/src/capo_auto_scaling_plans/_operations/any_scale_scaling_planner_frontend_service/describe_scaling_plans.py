"""Generated from Smithy shape ``com.amazonaws.autoscalingplans#DescribeScalingPlans``."""
...
def handle_response(
    ...
    out: capo_auto_scaling_plans.types.describe_scaling_plans_response.DescribeScalingPlansResponse = capo_auto_scaling_plans.types.describe_scaling_plans_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_auto_scaling_plans.types.describe_scaling_plans_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_scaling_plans(
