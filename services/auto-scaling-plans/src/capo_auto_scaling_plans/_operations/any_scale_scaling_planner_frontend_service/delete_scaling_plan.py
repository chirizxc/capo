"""Generated from Smithy shape ``com.amazonaws.autoscalingplans#DeleteScalingPlan``."""
...
def handle_response(
    ...
    out: capo_auto_scaling_plans.types.delete_scaling_plan_response.DeleteScalingPlanResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AnyScaleScalingPlannerFrontendService.DeleteScalingPlan"
    body: bytes | None = json.dumps(
        capo_auto_scaling_plans.types.delete_scaling_plan_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_scaling_plan(
