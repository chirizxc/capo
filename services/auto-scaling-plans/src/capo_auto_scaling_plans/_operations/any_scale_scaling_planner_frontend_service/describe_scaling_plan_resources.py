"""Generated from Smithy shape ``com.amazonaws.autoscalingplans#DescribeScalingPlanResources``."""
...
import capo_auto_scaling_plans._protocol.eventstream
...
import capo_auto_scaling_plans.errors.invalid_next_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidNextTokenException":
            raise capo_auto_scaling_plans.errors.invalid_next_token_exception.InvalidNextTokenException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_auto_scaling_plans.types.describe_scaling_plan_resources_response.DescribeScalingPlanResourcesResponse = capo_auto_scaling_plans.types.describe_scaling_plan_resources_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_auto_scaling_plans._auth._sigv4.build_sigv4_auth_scheme(
                "autoscaling-plans", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_auto_scaling_plans.types.describe_scaling_plan_resources_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_scaling_plan_resources(
