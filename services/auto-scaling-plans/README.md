...
```
pip install capo-auto-scaling-plans
```

## Usage

```python
from capo_auto_scaling_plans import AsyncAutoScalingPlansClient
...
```python
from capo_auto_scaling_plans import AsyncAutoScalingPlansClient
from capo_auto_scaling_plans.error import ConcurrentUpdateException
