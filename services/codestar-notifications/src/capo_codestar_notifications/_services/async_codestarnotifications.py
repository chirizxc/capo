...
from capo_codestar_notifications._services._aws_config import aaws_config
...
class AsynccodestarnotificationsClient:
    ...
    async def create_notification_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.create_notification_rule_request.CreateNotificationRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.create_notification_rule_result.CreateNotificationRuleResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.create_notification_rule.async_create_notification_rule(
    ...
    async def delete_notification_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.delete_notification_rule_request.DeleteNotificationRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.delete_notification_rule_result.DeleteNotificationRuleResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.delete_notification_rule.async_delete_notification_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_target(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.delete_target_request.DeleteTargetRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.delete_target_result.DeleteTargetResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.delete_target.async_delete_target(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_notification_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.describe_notification_rule_request.DescribeNotificationRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.describe_notification_rule_result.DescribeNotificationRuleResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.describe_notification_rule.async_describe_notification_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_event_types(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.list_event_types_request.ListEventTypesRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.list_event_types_result.ListEventTypesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.list_event_types.async_list_event_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_codestar_notifications.types.event_type_summary.EventTypeSummary]":
        _token = next_token
        while True:
    ...
    async def list_notification_rules(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.list_notification_rules_request.ListNotificationRulesRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.list_notification_rules_result.ListNotificationRulesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.list_notification_rules.async_list_notification_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_codestar_notifications.types.notification_rule_summary.NotificationRuleSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.list_tags_for_resource_result.ListTagsForResourceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_targets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.list_targets_request.ListTargetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.list_targets_result.ListTargetsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.list_targets.async_list_targets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_targets(
        ...
        *,
        ...
        "AsyncIterator[capo_codestar_notifications.types.target_summary.TargetSummary]"
    ):
        _token = next_token
        while True:
    ...
    async def subscribe(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.subscribe_request.SubscribeRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.subscribe_result.SubscribeResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.subscribe.async_subscribe(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.tag_resource_result.TagResourceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def unsubscribe(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.unsubscribe_request.UnsubscribeRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.unsubscribe_result.UnsubscribeResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.unsubscribe.async_unsubscribe(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.untag_resource_result.UntagResourceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_notification_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_codestar_notifications.types.update_notification_rule_request.UpdateNotificationRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_codestar_notifications.types.update_notification_rule_result.UpdateNotificationRuleResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_codestar_notifications._operations.code_star_notifications_20191015.update_notification_rule.async_update_notification_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
