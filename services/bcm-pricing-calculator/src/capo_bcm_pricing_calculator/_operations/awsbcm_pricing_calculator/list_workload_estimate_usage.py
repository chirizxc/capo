"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListWorkloadEstimateUsage``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.list_workload_estimate_usage_response.ListWorkloadEstimateUsageResponse = capo_bcm_pricing_calculator.types.list_workload_estimate_usage_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMPricingCalculator.ListWorkloadEstimateUsage"
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.list_workload_estimate_usage_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_workload_estimate_usage(
