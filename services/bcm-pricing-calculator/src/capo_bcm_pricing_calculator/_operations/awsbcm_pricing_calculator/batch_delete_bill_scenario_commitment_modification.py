"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#BatchDeleteBillScenarioCommitmentModification``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_response.BatchDeleteBillScenarioCommitmentModificationResponse = capo_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.batch_delete_bill_scenario_commitment_modification_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_delete_bill_scenario_commitment_modification(
