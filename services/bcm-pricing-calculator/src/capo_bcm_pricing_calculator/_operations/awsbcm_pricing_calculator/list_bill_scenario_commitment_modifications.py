"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListBillScenarioCommitmentModifications``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_response.ListBillScenarioCommitmentModificationsResponse = capo_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.list_bill_scenario_commitment_modifications_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_bill_scenario_commitment_modifications(
