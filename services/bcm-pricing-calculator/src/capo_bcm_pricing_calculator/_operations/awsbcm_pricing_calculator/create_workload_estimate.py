"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#CreateWorkloadEstimate``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.create_workload_estimate_response.CreateWorkloadEstimateResponse = capo_bcm_pricing_calculator.types.create_workload_estimate_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMPricingCalculator.CreateWorkloadEstimate"
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.create_workload_estimate_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_workload_estimate(
