"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#BatchCreateBillScenarioCommitmentModification``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.batch_create_bill_scenario_commitment_modification_response.BatchCreateBillScenarioCommitmentModificationResponse = capo_bcm_pricing_calculator.types.batch_create_bill_scenario_commitment_modification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.batch_create_bill_scenario_commitment_modification_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
