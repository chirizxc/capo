"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListBillScenarioUsageModifications``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.list_bill_scenario_usage_modifications_response.ListBillScenarioUsageModificationsResponse = capo_bcm_pricing_calculator.types.list_bill_scenario_usage_modifications_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.list_bill_scenario_usage_modifications_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_bill_scenario_usage_modifications(
