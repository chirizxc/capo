...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_response.BatchUpdateBillScenarioCommitmentModificationResponse = capo_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.batch_update_bill_scenario_commitment_modification_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
