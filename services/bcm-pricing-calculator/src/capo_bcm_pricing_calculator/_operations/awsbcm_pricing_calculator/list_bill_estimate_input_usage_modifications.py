"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListBillEstimateInputUsageModifications``."""
...
import capo_bcm_pricing_calculator.types.bill_estimate_input_usage_modification_summaries
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.list_bill_estimate_input_usage_modifications_response.ListBillEstimateInputUsageModificationsResponse = capo_bcm_pricing_calculator.types.list_bill_estimate_input_usage_modifications_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.list_bill_estimate_input_usage_modifications_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_bill_estimate_input_usage_modifications(
