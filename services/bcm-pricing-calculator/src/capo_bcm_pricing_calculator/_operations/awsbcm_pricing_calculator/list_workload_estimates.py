"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListWorkloadEstimates``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.list_workload_estimates_response.ListWorkloadEstimatesResponse = capo_bcm_pricing_calculator.types.list_workload_estimates_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMPricingCalculator.ListWorkloadEstimates"
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.list_workload_estimates_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_workload_estimates(
