"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListBillEstimateCommitments``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.list_bill_estimate_commitments_response.ListBillEstimateCommitmentsResponse = capo_bcm_pricing_calculator.types.list_bill_estimate_commitments_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMPricingCalculator.ListBillEstimateCommitments"
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.list_bill_estimate_commitments_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_bill_estimate_commitments(
