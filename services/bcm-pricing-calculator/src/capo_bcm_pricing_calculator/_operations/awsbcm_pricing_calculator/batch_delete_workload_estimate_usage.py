"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#BatchDeleteWorkloadEstimateUsage``."""
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_response.BatchDeleteWorkloadEstimateUsageResponse = capo_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMPricingCalculator.BatchDeleteWorkloadEstimateUsage"
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.batch_delete_workload_estimate_usage_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_delete_workload_estimate_usage(
