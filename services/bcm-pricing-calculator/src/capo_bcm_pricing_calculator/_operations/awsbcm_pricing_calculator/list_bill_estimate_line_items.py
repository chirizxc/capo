"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#ListBillEstimateLineItems``."""
...
import capo_bcm_pricing_calculator.types.bill_estimate_line_item_summaries
...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.list_bill_estimate_line_items_response.ListBillEstimateLineItemsResponse = capo_bcm_pricing_calculator.types.list_bill_estimate_line_items_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBCMPricingCalculator.ListBillEstimateLineItems"
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.list_bill_estimate_line_items_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_bill_estimate_line_items(
