...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.get_bill_scenario_response.GetBillScenarioResponse = capo_bcm_pricing_calculator.types.get_bill_scenario_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.get_bill_scenario_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
