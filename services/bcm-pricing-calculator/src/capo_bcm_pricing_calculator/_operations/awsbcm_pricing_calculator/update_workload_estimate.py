...
def handle_response(
    ...
    out: capo_bcm_pricing_calculator.types.update_workload_estimate_response.UpdateWorkloadEstimateResponse = capo_bcm_pricing_calculator.types.update_workload_estimate_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_pricing_calculator.types.update_workload_estimate_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
