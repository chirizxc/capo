...
class ListBillEstimatesRequest(TypedDict, closed=True):
    filters: NotRequired[
...
def serialize_aws_json_1_0(value: ListBillEstimatesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            capo_bcm_pricing_calculator.types.list_bill_estimates_filters.serialize_aws_json_1_0(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListBillEstimatesRequest:
    ...
    if data.get("filters") is not None:
        ...
        out["filters"] = (
            capo_bcm_pricing_calculator.types.list_bill_estimates_filters.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
