...
class BatchCreateBillScenarioUsageModificationError(TypedDict, closed=True):
    ...
    error_code: NotRequired[
        "capo_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_error_code.BatchCreateBillScenarioUsageModificationErrorCode"
    ]
...
def serialize_aws_json_1_0(
    value: BatchCreateBillScenarioUsageModificationError,
) -> dict:
    out: dict = {}
    if "key" in value:
        out["key"] = value["key"]
    ...
    if "error_code" in value:
        ...
        out["errorCode"] = (
            capo_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_error_code.serialize_aws_json_1_0(
                value["error_code"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(
    ...
    if data.get("errorCode") is not None:
        ...
        out["error_code"] = (
            capo_bcm_pricing_calculator.types.batch_create_bill_scenario_usage_modification_error_code.deserialize_aws_json_1_0(
                data["errorCode"]
            )
        )
    return out
