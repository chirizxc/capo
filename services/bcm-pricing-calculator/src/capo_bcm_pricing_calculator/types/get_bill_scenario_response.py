"""Generated from Smithy shape ``com.amazonaws.bcmpricingcalculator#GetBillScenarioResponse``."""
...
class GetBillScenarioResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: GetBillScenarioResponse) -> dict:
    out: dict = {}
    out["id"] = value["id"]
    if "name" in value:
        out["name"] = value["name"]
...
def deserialize_aws_json_1_0(data: dict) -> GetBillScenarioResponse:
    out: GetBillScenarioResponse = {}  # type: ignore[typeddict-item]
    if data.get("id") is not None:
        out["id"] = data["id"]
    else:
        raise DeserializationError("GetBillScenarioResponse.id required")
