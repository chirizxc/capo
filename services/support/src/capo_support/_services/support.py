...
from capo_support._services._aws_config import aws_config
...
class SupportClientConfig(TypedDict, total=False, closed=True):
...
class SupportClient:
    ...
    def __init__(
        ...
        self._config = SupportClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[SupportClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: SupportClientConfig = config_overrides or {}
    ...
    def add_attachments_to_set(
        ...
        *,
        config_overrides: Optional[SupportClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.add_attachments_to_set_request.AddAttachmentsToSetRequest]",
        ) -> OperationResponse[
            "capo_support.types.add_attachments_to_set_response.AddAttachmentsToSetResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.add_attachments_to_set.add_attachments_to_set(
    ...
    def add_communication_to_case(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.add_communication_to_case_request.AddCommunicationToCaseRequest]",
        ) -> OperationResponse[
            "capo_support.types.add_communication_to_case_response.AddCommunicationToCaseResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.add_communication_to_case.add_communication_to_case(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_case(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.create_case_request.CreateCaseRequest]",
        ) -> OperationResponse[
            "capo_support.types.create_case_response.CreateCaseResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.create_case.create_case(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_attachment(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_attachment_request.DescribeAttachmentRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_attachment_response.DescribeAttachmentResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_attachment.describe_attachment(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_cases(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_cases_request.DescribeCasesRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_cases_response.DescribeCasesResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_cases.describe_cases(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_support.types.case_details.CaseDetails]":
        _token = next_token
        while True:
            _response = self.describe_cases(
    ...
    def describe_communications(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_communications_request.DescribeCommunicationsRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_communications_response.DescribeCommunicationsResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_communications.describe_communications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_communications(
        ...
        *,
        ...
        next_token: Optional["capo_support.types.next_token.NextToken"] = None,
        max_results: Optional["capo_support.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_support.types.communication.Communication]":
        _token = next_token
        while True:
            _response = self.describe_communications(
                case_id,
                config_overrides=config_overrides,
                before_time=before_time,
                after_time=after_time,
    ...
    def describe_create_case_options(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_create_case_options_request.DescribeCreateCaseOptionsRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_create_case_options_response.DescribeCreateCaseOptionsResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_create_case_options.describe_create_case_options(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_services(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_services_request.DescribeServicesRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_services_response.DescribeServicesResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_services.describe_services(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_severity_levels(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_severity_levels_request.DescribeSeverityLevelsRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_severity_levels_response.DescribeSeverityLevelsResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_severity_levels.describe_severity_levels(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_supported_languages(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_supported_languages_request.DescribeSupportedLanguagesRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_supported_languages_response.DescribeSupportedLanguagesResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_supported_languages.describe_supported_languages(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_trusted_advisor_check_refresh_statuses(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_trusted_advisor_check_refresh_statuses_request.DescribeTrustedAdvisorCheckRefreshStatusesRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_trusted_advisor_check_refresh_statuses_response.DescribeTrustedAdvisorCheckRefreshStatusesResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_trusted_advisor_check_refresh_statuses.describe_trusted_advisor_check_refresh_statuses(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_trusted_advisor_check_result(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_trusted_advisor_check_result_request.DescribeTrustedAdvisorCheckResultRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_trusted_advisor_check_result_response.DescribeTrustedAdvisorCheckResultResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_trusted_advisor_check_result.describe_trusted_advisor_check_result(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_trusted_advisor_checks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_trusted_advisor_checks_request.DescribeTrustedAdvisorChecksRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_trusted_advisor_checks_response.DescribeTrustedAdvisorChecksResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_trusted_advisor_checks.describe_trusted_advisor_checks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_trusted_advisor_check_summaries(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.describe_trusted_advisor_check_summaries_request.DescribeTrustedAdvisorCheckSummariesRequest]",
        ) -> OperationResponse[
            "capo_support.types.describe_trusted_advisor_check_summaries_response.DescribeTrustedAdvisorCheckSummariesResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.describe_trusted_advisor_check_summaries.describe_trusted_advisor_check_summaries(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def refresh_trusted_advisor_check(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.refresh_trusted_advisor_check_request.RefreshTrustedAdvisorCheckRequest]",
        ) -> OperationResponse[
            "capo_support.types.refresh_trusted_advisor_check_response.RefreshTrustedAdvisorCheckResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.refresh_trusted_advisor_check.refresh_trusted_advisor_check(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def resolve_case(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_support.types.resolve_case_request.ResolveCaseRequest]",
        ) -> OperationResponse[
            "capo_support.types.resolve_case_response.ResolveCaseResponse"
        ]:
            ...
            output, http_response = (
                capo_support._operations.aws_support_20130415.resolve_case.resolve_case(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
