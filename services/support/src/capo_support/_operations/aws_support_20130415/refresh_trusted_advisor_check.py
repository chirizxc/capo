"""Generated from Smithy shape ``com.amazonaws.support#RefreshTrustedAdvisorCheck``."""
...
def handle_response(
    ...
    out: capo_support.types.refresh_trusted_advisor_check_response.RefreshTrustedAdvisorCheckResponse = capo_support.types.refresh_trusted_advisor_check_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.refresh_trusted_advisor_check_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_refresh_trusted_advisor_check(
