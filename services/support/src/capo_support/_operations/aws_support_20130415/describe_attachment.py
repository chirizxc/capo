...
def handle_response(
    ...
    out: capo_support.types.describe_attachment_response.DescribeAttachmentResponse = (
        capo_support.types.describe_attachment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.describe_attachment_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
