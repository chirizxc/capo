...
def handle_response(
    ...
    out: capo_support.types.describe_create_case_options_response.DescribeCreateCaseOptionsResponse = capo_support.types.describe_create_case_options_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.describe_create_case_options_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
