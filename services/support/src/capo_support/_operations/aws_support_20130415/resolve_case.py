"""Generated from Smithy shape ``com.amazonaws.support#ResolveCase``."""
...
def handle_response(
    ...
    out: capo_support.types.resolve_case_response.ResolveCaseResponse = (
        capo_support.types.resolve_case_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.resolve_case_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def resolve_case(
    ...
    capo_support.types.resolve_case_response.ResolveCaseResponse, zapros.Response
]:
