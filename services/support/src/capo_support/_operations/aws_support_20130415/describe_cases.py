"""Generated from Smithy shape ``com.amazonaws.support#DescribeCases``."""
...
def handle_response(
    ...
    out: capo_support.types.describe_cases_response.DescribeCasesResponse = (
        capo_support.types.describe_cases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.describe_cases_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_cases(
    ...
    capo_support.types.describe_cases_response.DescribeCasesResponse, zapros.Response
]:
...
async def async_describe_cases(
