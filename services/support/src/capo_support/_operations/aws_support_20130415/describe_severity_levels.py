"""Generated from Smithy shape ``com.amazonaws.support#DescribeSeverityLevels``."""
...
def handle_response(
    ...
    out: capo_support.types.describe_severity_levels_response.DescribeSeverityLevelsResponse = capo_support.types.describe_severity_levels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.describe_severity_levels_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_severity_levels(
