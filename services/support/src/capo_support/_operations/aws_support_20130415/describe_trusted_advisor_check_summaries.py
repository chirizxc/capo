"""Generated from Smithy shape ``com.amazonaws.support#DescribeTrustedAdvisorCheckSummaries``."""
...
def handle_response(
    ...
    out: capo_support.types.describe_trusted_advisor_check_summaries_response.DescribeTrustedAdvisorCheckSummariesResponse = capo_support.types.describe_trusted_advisor_check_summaries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_support.types.describe_trusted_advisor_check_summaries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_trusted_advisor_check_summaries(
