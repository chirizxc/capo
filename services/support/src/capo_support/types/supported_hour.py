...
if TYPE_CHECKING:
    import capo_support.types.end_time
    import capo_support.types.start_time


class SupportedHour(TypedDict, closed=True):
    start_time: NotRequired["capo_support.types.start_time.StartTime"]
    """<p> Start Time. RFC 3339 format <code>'HH:mm:ss.SSS'</code>. </p>"""
    end_time: NotRequired["capo_support.types.end_time.EndTime"]
