...
class DescribeSeverityLevelsResponse(TypedDict, closed=True):
    severity_levels: NotRequired[
        "capo_support.types.severity_levels_list.SeverityLevelsList"
    ]
...
def serialize_aws_json_1_1(value: DescribeSeverityLevelsResponse) -> dict:
    ...
    if "severity_levels" in value:
        ...
        out["severityLevels"] = (
            capo_support.types.severity_levels_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeSeverityLevelsResponse:
    ...
    if data.get("severityLevels") is not None:
        ...
        out["severity_levels"] = (
            capo_support.types.severity_levels_list.deserialize_aws_json_1_1(
                data["severityLevels"]
            )
        )
    return out
