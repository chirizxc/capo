...
import capo_imagebuilder.types.workflow_executions_list
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_workflow_executions_response.ListWorkflowExecutionsResponse = capo_imagebuilder.types.list_workflow_executions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_workflow_executions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
