...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_image_recipe_policy_response.GetImageRecipePolicyResponse = capo_imagebuilder.types.get_image_recipe_policy_response.deserialize_json(
...
def build_request(
    ...
    if "image_recipe_arn" in input_:
        params.append(("imageRecipeArn", input_["image_recipe_arn"]))
