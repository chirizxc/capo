...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_infrastructure_configurations_response.ListInfrastructureConfigurationsResponse = capo_imagebuilder.types.list_infrastructure_configurations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_infrastructure_configurations_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
