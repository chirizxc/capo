"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetContainerRecipePolicy``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_container_recipe_policy_response.GetContainerRecipePolicyResponse = capo_imagebuilder.types.get_container_recipe_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetContainerRecipePolicy"
    params: list[tuple[str, str]] = []
    if "container_recipe_arn" in input_:
        params.append(("containerRecipeArn", input_["container_recipe_arn"]))
...
async def async_get_container_recipe_policy(
