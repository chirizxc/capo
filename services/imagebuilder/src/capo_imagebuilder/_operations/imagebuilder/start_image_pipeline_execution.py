...
def handle_response(
    ...
    out: capo_imagebuilder.types.start_image_pipeline_execution_response.StartImagePipelineExecutionResponse = capo_imagebuilder.types.start_image_pipeline_execution_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.start_image_pipeline_execution_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
