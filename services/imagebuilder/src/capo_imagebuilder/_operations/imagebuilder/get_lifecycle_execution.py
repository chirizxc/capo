...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_lifecycle_execution_response.GetLifecycleExecutionResponse = capo_imagebuilder.types.get_lifecycle_execution_response.deserialize_json(
...
def build_request(
    ...
    if "lifecycle_execution_id" in input_:
        params.append(("lifecycleExecutionId", input_["lifecycle_execution_id"]))
