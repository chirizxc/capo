...
import capo_imagebuilder.types.workflow_summary_list
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_workflow_build_versions_response.ListWorkflowBuildVersionsResponse = capo_imagebuilder.types.list_workflow_build_versions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_workflow_build_versions_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
