...
def handle_response(
    ...
    out: capo_imagebuilder.types.put_component_policy_response.PutComponentPolicyResponse = capo_imagebuilder.types.put_component_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.put_component_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
