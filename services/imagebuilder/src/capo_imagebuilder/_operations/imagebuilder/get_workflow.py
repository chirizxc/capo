"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetWorkflow``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_workflow_response.GetWorkflowResponse = (
        capo_imagebuilder.types.get_workflow_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetWorkflow"
    params: list[tuple[str, str]] = []
    if "workflow_build_version_arn" in input_:
        params.append(("workflowBuildVersionArn", input_["workflow_build_version_arn"]))
...
def get_workflow(
    ...
    capo_imagebuilder.types.get_workflow_response.GetWorkflowResponse, zapros.Response
]:
