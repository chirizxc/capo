...
def handle_response(
    ...
    out: capo_imagebuilder.types.import_disk_image_response.ImportDiskImageResponse = (
        capo_imagebuilder.types.import_disk_image_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.import_disk_image_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
