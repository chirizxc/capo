...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_image_response.GetImageResponse = (
        capo_imagebuilder.types.get_image_response.deserialize_json(
...
def build_request(
    ...
    if "image_build_version_arn" in input_:
        params.append(("imageBuildVersionArn", input_["image_build_version_arn"]))
...
def get_image(
    ...
    capo_imagebuilder.types.get_image_response.GetImageResponse, zapros.Response
]:
