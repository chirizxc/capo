...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_image_scan_findings_response.ListImageScanFindingsResponse = capo_imagebuilder.types.list_image_scan_findings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_image_scan_findings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
