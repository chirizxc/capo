"""Generated from Smithy shape ``com.amazonaws.imagebuilder#PutImageRecipePolicy``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.put_image_recipe_policy_response.PutImageRecipePolicyResponse = capo_imagebuilder.types.put_image_recipe_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/PutImageRecipePolicy"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.put_image_recipe_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_put_image_recipe_policy(
