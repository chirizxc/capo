"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetLifecyclePolicy``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_lifecycle_policy_response.GetLifecyclePolicyResponse = capo_imagebuilder.types.get_lifecycle_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetLifecyclePolicy"
