...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_lifecycle_policies_response.ListLifecyclePoliciesResponse = capo_imagebuilder.types.list_lifecycle_policies_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_lifecycle_policies_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
