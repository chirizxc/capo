...
def handle_response(
    ...
    out: capo_imagebuilder.types.delete_container_recipe_response.DeleteContainerRecipeResponse = capo_imagebuilder.types.delete_container_recipe_response.deserialize_json(
