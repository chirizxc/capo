...
def handle_response(
    ...
    out: capo_imagebuilder.types.delete_infrastructure_configuration_response.DeleteInfrastructureConfigurationResponse = capo_imagebuilder.types.delete_infrastructure_configuration_response.deserialize_json(
