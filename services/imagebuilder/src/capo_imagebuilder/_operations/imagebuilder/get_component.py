...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_component_response.GetComponentResponse = (
        capo_imagebuilder.types.get_component_response.deserialize_json(
...
def build_request(
    ...
    if "component_build_version_arn" in input_:
        params.append(
            ("componentBuildVersionArn", input_["component_build_version_arn"])
        )
...
def get_component(
    ...
    capo_imagebuilder.types.get_component_response.GetComponentResponse, zapros.Response
]:
