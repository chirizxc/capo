"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_imagebuilder.types.list_tags_for_resource_response.deserialize_json(
