...
def handle_response(
    ...
    out: capo_imagebuilder.types.update_lifecycle_policy_response.UpdateLifecyclePolicyResponse = capo_imagebuilder.types.update_lifecycle_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.update_lifecycle_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
