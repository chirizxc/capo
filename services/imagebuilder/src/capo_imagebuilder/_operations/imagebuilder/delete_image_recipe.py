...
def handle_response(
    ...
    out: capo_imagebuilder.types.delete_image_recipe_response.DeleteImageRecipeResponse = capo_imagebuilder.types.delete_image_recipe_response.deserialize_json(
