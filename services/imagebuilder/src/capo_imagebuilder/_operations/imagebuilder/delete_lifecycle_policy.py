"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteLifecyclePolicy``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse = capo_imagebuilder.types.delete_lifecycle_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DeleteLifecyclePolicy"
    params: list[tuple[str, str]] = []
    if "lifecycle_policy_arn" in input_:
        params.append(("lifecyclePolicyArn", input_["lifecycle_policy_arn"]))
