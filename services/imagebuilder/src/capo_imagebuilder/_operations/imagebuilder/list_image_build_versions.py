...
def handle_response(
    ...
    out: capo_imagebuilder.types.list_image_build_versions_response.ListImageBuildVersionsResponse = capo_imagebuilder.types.list_image_build_versions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.list_image_build_versions_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
