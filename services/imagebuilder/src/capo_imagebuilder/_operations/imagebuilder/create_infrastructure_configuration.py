...
def handle_response(
    ...
    out: capo_imagebuilder.types.create_infrastructure_configuration_response.CreateInfrastructureConfigurationResponse = capo_imagebuilder.types.create_infrastructure_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_imagebuilder.types.create_infrastructure_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
