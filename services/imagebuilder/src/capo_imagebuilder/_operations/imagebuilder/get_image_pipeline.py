"""Generated from Smithy shape ``com.amazonaws.imagebuilder#GetImagePipeline``."""
...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_image_pipeline_response.GetImagePipelineResponse = capo_imagebuilder.types.get_image_pipeline_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetImagePipeline"
    params: list[tuple[str, str]] = []
    if "image_pipeline_arn" in input_:
        params.append(("imagePipelineArn", input_["image_pipeline_arn"]))
...
async def async_get_image_pipeline(
