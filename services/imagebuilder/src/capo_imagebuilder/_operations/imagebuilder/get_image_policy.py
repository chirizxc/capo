...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_image_policy_response.GetImagePolicyResponse = (
        capo_imagebuilder.types.get_image_policy_response.deserialize_json(
...
def build_request(
    ...
    if "image_arn" in input_:
        params.append(("imageArn", input_["image_arn"]))
