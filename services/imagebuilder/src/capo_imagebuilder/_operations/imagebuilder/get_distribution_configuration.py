...
def handle_response(
    ...
    out: capo_imagebuilder.types.get_distribution_configuration_response.GetDistributionConfigurationResponse = capo_imagebuilder.types.get_distribution_configuration_response.deserialize_json(
...
def build_request(
    ...
    if "distribution_configuration_arn" in input_:
        params.append(
            ("distributionConfigurationArn", input_["distribution_configuration_arn"])
        )
