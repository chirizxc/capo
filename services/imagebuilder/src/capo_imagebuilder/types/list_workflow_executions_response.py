...
def serialize_json(value: ListWorkflowExecutionsResponse) -> dict:
    ...
    if "workflow_executions" in value:
        ...
        out["workflowExecutions"] = (
            capo_imagebuilder.types.workflow_executions_list.serialize_json(
...
def deserialize_json(data: dict) -> ListWorkflowExecutionsResponse:
    ...
    if data.get("workflowExecutions") is not None:
        import capo_imagebuilder.types.workflow_executions_list

        out["workflow_executions"] = (
            capo_imagebuilder.types.workflow_executions_list.deserialize_json(
