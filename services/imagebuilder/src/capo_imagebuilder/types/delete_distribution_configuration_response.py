"""Generated from Smithy shape ``com.amazonaws.imagebuilder#DeleteDistributionConfigurationResponse``."""
...
class DeleteDistributionConfigurationResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteDistributionConfigurationResponse) -> dict:
    out: dict = {}
