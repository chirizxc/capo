...
class ListDistributionConfigurationsResponse(TypedDict, closed=True):
    ...
    distribution_configuration_summary_list: NotRequired[
        "capo_imagebuilder.types.distribution_configuration_summary_list.DistributionConfigurationSummaryList"
    ]
...
def serialize_json(value: ListDistributionConfigurationsResponse) -> dict:
    ...
    if "distribution_configuration_summary_list" in value:
        ...
        out["distributionConfigurationSummaryList"] = (
            capo_imagebuilder.types.distribution_configuration_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDistributionConfigurationsResponse:
    ...
    if data.get("distributionConfigurationSummaryList") is not None:
        import capo_imagebuilder.types.distribution_configuration_summary_list

        out["distribution_configuration_summary_list"] = (
            capo_imagebuilder.types.distribution_configuration_summary_list.deserialize_json(
