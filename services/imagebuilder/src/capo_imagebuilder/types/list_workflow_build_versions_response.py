...
def serialize_json(value: ListWorkflowBuildVersionsResponse) -> dict:
    ...
    if "workflow_summary_list" in value:
        ...
        out["workflowSummaryList"] = (
            capo_imagebuilder.types.workflow_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListWorkflowBuildVersionsResponse:
    ...
    if data.get("workflowSummaryList") is not None:
        import capo_imagebuilder.types.workflow_summary_list

        out["workflow_summary_list"] = (
            capo_imagebuilder.types.workflow_summary_list.deserialize_json(
