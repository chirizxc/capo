...
class ListLifecyclePoliciesResponse(TypedDict, closed=True):
    lifecycle_policy_summary_list: NotRequired[
        "capo_imagebuilder.types.lifecycle_policy_summary_list.LifecyclePolicySummaryList"
    ]
...
def serialize_json(value: ListLifecyclePoliciesResponse) -> dict:
    ...
    if "lifecycle_policy_summary_list" in value:
        ...
        out["lifecyclePolicySummaryList"] = (
            capo_imagebuilder.types.lifecycle_policy_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListLifecyclePoliciesResponse:
    ...
    if data.get("lifecyclePolicySummaryList") is not None:
        ...
        out["lifecycle_policy_summary_list"] = (
            capo_imagebuilder.types.lifecycle_policy_summary_list.deserialize_json(
