...
if TYPE_CHECKING:
    ...
    import capo_imagebuilder.types.max_parallel_launches
...
class FastLaunchConfiguration(TypedDict, closed=True):
    ...
    launch_template: NotRequired[
        "capo_imagebuilder.types.fast_launch_launch_template_specification.FastLaunchLaunchTemplateSpecification"
    ]
...
def serialize_json(value: FastLaunchConfiguration) -> dict:
    ...
    if "snapshot_configuration" in value:
        ...
        out["snapshotConfiguration"] = (
            capo_imagebuilder.types.fast_launch_snapshot_configuration.serialize_json(
    ...
    if "launch_template" in value:
        ...
        out["launchTemplate"] = (
            capo_imagebuilder.types.fast_launch_launch_template_specification.serialize_json(
...
def deserialize_json(data: dict) -> FastLaunchConfiguration:
    ...
    if data.get("snapshotConfiguration") is not None:
        ...
        out["snapshot_configuration"] = (
            capo_imagebuilder.types.fast_launch_snapshot_configuration.deserialize_json(
    ...
    if data.get("launchTemplate") is not None:
        ...
        out["launch_template"] = (
            capo_imagebuilder.types.fast_launch_launch_template_specification.deserialize_json(
                data["launchTemplate"]
            )
        )
