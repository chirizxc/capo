"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.imagebuilder#ServiceQuotaExceededException``."""
