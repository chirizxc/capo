"""Generated from Smithy shape ``com.amazonaws.imagebuilder#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.imagebuilder#ResourceInUseException``."""
