...
def handle_response(
    ...
    out: capo_medialive.types.update_cloud_watch_alarm_template_group_response.UpdateCloudWatchAlarmTemplateGroupResponse = capo_medialive.types.update_cloud_watch_alarm_template_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_cloud_watch_alarm_template_group_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
