...
def handle_response(
    ...
    out: capo_medialive.types.describe_reservation_response.DescribeReservationResponse = capo_medialive.types.describe_reservation_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ReservationId}", quote(input_["reservation_id"], safe=""))
