...
def handle_response(
    ...
    out: capo_medialive.types.stop_multiplex_response.StopMultiplexResponse = (
        capo_medialive.types.stop_multiplex_response.deserialize_json(
...
def stop_multiplex(
    ...
    capo_medialive.types.stop_multiplex_response.StopMultiplexResponse, zapros.Response
]:
