"""Generated from Smithy shape ``com.amazonaws.medialive#ListReservations``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_reservations_response.ListReservationsResponse = (
        capo_medialive.types.list_reservations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/reservations"
