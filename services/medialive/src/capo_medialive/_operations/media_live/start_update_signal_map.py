"""Generated from Smithy shape ``com.amazonaws.medialive#StartUpdateSignalMap``."""
...
def handle_response(
    ...
    out: capo_medialive.types.start_update_signal_map_response.StartUpdateSignalMapResponse = capo_medialive.types.start_update_signal_map_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.start_update_signal_map_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_update_signal_map(
