"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteSchedule``."""
...
def handle_response(
    ...
    out: capo_medialive.types.delete_schedule_response.DeleteScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
