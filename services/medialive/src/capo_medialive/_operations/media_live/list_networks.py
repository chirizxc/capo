"""Generated from Smithy shape ``com.amazonaws.medialive#ListNetworks``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_networks_response.ListNetworksResponse = (
        capo_medialive.types.list_networks_response.deserialize_json(
...
def list_networks(
    ...
    capo_medialive.types.list_networks_response.ListNetworksResponse, zapros.Response
]:
