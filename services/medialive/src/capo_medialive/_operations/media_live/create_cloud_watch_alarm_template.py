...
def handle_response(
    ...
    out: capo_medialive.types.create_cloud_watch_alarm_template_response.CreateCloudWatchAlarmTemplateResponse = capo_medialive.types.create_cloud_watch_alarm_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_cloud_watch_alarm_template_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
