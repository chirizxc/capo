...
def handle_response(
    ...
    out: capo_medialive.types.create_node_response.CreateNodeResponse = (
        capo_medialive.types.create_node_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_node_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_node(
    ...
    capo_medialive.types.create_node_response.CreateNodeResponse, zapros.Response
]:
