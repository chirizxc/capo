"""Generated from Smithy shape ``com.amazonaws.medialive#StopChannel``."""
...
def handle_response(
    ...
    out: capo_medialive.types.stop_channel_response.StopChannelResponse = (
        capo_medialive.types.stop_channel_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/channels/{ChannelId}/stop"
...
def stop_channel(
    ...
    capo_medialive.types.stop_channel_response.StopChannelResponse, zapros.Response
]:
