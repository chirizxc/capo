"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeMultiplex``."""
...
def handle_response(
    ...
    out: capo_medialive.types.describe_multiplex_response.DescribeMultiplexResponse = (
        capo_medialive.types.describe_multiplex_response.deserialize_json(
...
async def async_describe_multiplex(
