"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeMultiplexProgram``."""
...
def handle_response(
    ...
    out: capo_medialive.types.describe_multiplex_program_response.DescribeMultiplexProgramResponse = capo_medialive.types.describe_multiplex_program_response.deserialize_json(
...
async def async_describe_multiplex_program(
