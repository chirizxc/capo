...
def handle_response(
    ...
    out: capo_medialive.types.delete_channel_response.DeleteChannelResponse = (
        capo_medialive.types.delete_channel_response.deserialize_json(
...
def delete_channel(
    ...
    capo_medialive.types.delete_channel_response.DeleteChannelResponse, zapros.Response
]:
