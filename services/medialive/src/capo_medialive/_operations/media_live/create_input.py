...
def handle_response(
    ...
    out: capo_medialive.types.create_input_response.CreateInputResponse = (
        capo_medialive.types.create_input_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_input_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_input(
    ...
    capo_medialive.types.create_input_response.CreateInputResponse, zapros.Response
]:
