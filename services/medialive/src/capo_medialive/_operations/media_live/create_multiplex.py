"""Generated from Smithy shape ``com.amazonaws.medialive#CreateMultiplex``."""
...
def handle_response(
    ...
    out: capo_medialive.types.create_multiplex_response.CreateMultiplexResponse = (
        capo_medialive.types.create_multiplex_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_multiplex_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_multiplex(
