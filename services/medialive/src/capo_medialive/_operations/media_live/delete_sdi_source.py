"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteSdiSource``."""
...
def handle_response(
    ...
    out: capo_medialive.types.delete_sdi_source_response.DeleteSdiSourceResponse = (
        capo_medialive.types.delete_sdi_source_response.deserialize_json(
...
async def async_delete_sdi_source(
