"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeInputSecurityGroup``."""
...
def handle_response(
    ...
    out: capo_medialive.types.describe_input_security_group_response.DescribeInputSecurityGroupResponse = capo_medialive.types.describe_input_security_group_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{InputSecurityGroupId}", quote(input_["input_security_group_id"], safe="")
    )
...
async def async_describe_input_security_group(
