"""Generated from Smithy shape ``com.amazonaws.medialive#ListMultiplexPrograms``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_multiplex_programs_response.ListMultiplexProgramsResponse = capo_medialive.types.list_multiplex_programs_response.deserialize_json(
...
async def async_list_multiplex_programs(
