"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteMultiplexProgram``."""
...
def handle_response(
    ...
    out: capo_medialive.types.delete_multiplex_program_response.DeleteMultiplexProgramResponse = capo_medialive.types.delete_multiplex_program_response.deserialize_json(
...
async def async_delete_multiplex_program(
