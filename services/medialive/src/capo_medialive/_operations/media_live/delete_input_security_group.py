"""Generated from Smithy shape ``com.amazonaws.medialive#DeleteInputSecurityGroup``."""
...
def handle_response(
    ...
    out: capo_medialive.types.delete_input_security_group_response.DeleteInputSecurityGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_input_security_group(
