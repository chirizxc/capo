...
def handle_response(
    ...
    out: capo_medialive.types.create_multiplex_program_response.CreateMultiplexProgramResponse = capo_medialive.types.create_multiplex_program_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_multiplex_program_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
