"""Generated from Smithy shape ``com.amazonaws.medialive#BatchStop``."""
...
def handle_response(
    ...
    out: capo_medialive.types.batch_stop_response.BatchStopResponse = (
        capo_medialive.types.batch_stop_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.batch_stop_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def batch_stop(
    ...
    input_: capo_medialive.types.batch_stop_request.BatchStopRequest,
) -> tuple[capo_medialive.types.batch_stop_response.BatchStopResponse, zapros.Response]:
