...
def handle_response(
    ...
    out: capo_medialive.types.update_event_bridge_rule_template_group_response.UpdateEventBridgeRuleTemplateGroupResponse = capo_medialive.types.update_event_bridge_rule_template_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_event_bridge_rule_template_group_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
