"""Generated from Smithy shape ``com.amazonaws.medialive#CreateEventBridgeRuleTemplate``."""
...
def handle_response(
    ...
    out: capo_medialive.types.create_event_bridge_rule_template_response.CreateEventBridgeRuleTemplateResponse = capo_medialive.types.create_event_bridge_rule_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_event_bridge_rule_template_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_event_bridge_rule_template(
