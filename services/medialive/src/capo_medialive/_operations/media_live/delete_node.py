...
def handle_response(
    ...
    out: capo_medialive.types.delete_node_response.DeleteNodeResponse = (
        capo_medialive.types.delete_node_response.deserialize_json(
...
def delete_node(
    ...
    capo_medialive.types.delete_node_response.DeleteNodeResponse, zapros.Response
]:
