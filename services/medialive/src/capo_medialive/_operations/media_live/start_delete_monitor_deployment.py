"""Generated from Smithy shape ``com.amazonaws.medialive#StartDeleteMonitorDeployment``."""
...
def handle_response(
    ...
    out: capo_medialive.types.start_delete_monitor_deployment_response.StartDeleteMonitorDeploymentResponse = capo_medialive.types.start_delete_monitor_deployment_response.deserialize_json(
...
async def async_start_delete_monitor_deployment(
