...
def handle_response(
    ...
    out: capo_medialive.types.update_input_response.UpdateInputResponse = (
        capo_medialive.types.update_input_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_input_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_input(
    ...
    capo_medialive.types.update_input_response.UpdateInputResponse, zapros.Response
]:
