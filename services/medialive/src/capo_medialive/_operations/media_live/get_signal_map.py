...
def handle_response(
    ...
    out: capo_medialive.types.get_signal_map_response.GetSignalMapResponse = (
        capo_medialive.types.get_signal_map_response.deserialize_json(
...
def get_signal_map(
    ...
    capo_medialive.types.get_signal_map_response.GetSignalMapResponse, zapros.Response
]:
