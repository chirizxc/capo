...
def handle_response(
    ...
    out: capo_medialive.types.create_signal_map_response.CreateSignalMapResponse = (
        capo_medialive.types.create_signal_map_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.create_signal_map_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
