"""Generated from Smithy shape ``com.amazonaws.medialive#CancelInputDeviceTransfer``."""
...
def handle_response(
    ...
    out: capo_medialive.types.cancel_input_device_transfer_response.CancelInputDeviceTransferResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDevices/{InputDeviceId}/cancel"
...
async def async_cancel_input_device_transfer(
