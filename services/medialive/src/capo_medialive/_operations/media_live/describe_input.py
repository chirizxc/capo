"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeInput``."""
...
def handle_response(
    ...
    out: capo_medialive.types.describe_input_response.DescribeInputResponse = (
        capo_medialive.types.describe_input_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{InputId}", quote(input_["input_id"], safe=""))
...
def describe_input(
    ...
    capo_medialive.types.describe_input_response.DescribeInputResponse, zapros.Response
]:
