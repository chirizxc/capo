"""Generated from Smithy shape ``com.amazonaws.medialive#DescribeNode``."""
...
def handle_response(
    ...
    out: capo_medialive.types.describe_node_response.DescribeNodeResponse = (
        capo_medialive.types.describe_node_response.deserialize_json(
...
def describe_node(
    ...
    capo_medialive.types.describe_node_response.DescribeNodeResponse, zapros.Response
]:
