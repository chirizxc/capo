...
def handle_response(
    ...
    out: capo_medialive.types.update_node_response.UpdateNodeResponse = (
        capo_medialive.types.update_node_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_node_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_node(
    ...
    capo_medialive.types.update_node_response.UpdateNodeResponse, zapros.Response
]:
