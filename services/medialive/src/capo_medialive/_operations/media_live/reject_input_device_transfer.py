"""Generated from Smithy shape ``com.amazonaws.medialive#RejectInputDeviceTransfer``."""
...
def handle_response(
    ...
    out: capo_medialive.types.reject_input_device_transfer_response.RejectInputDeviceTransferResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDevices/{InputDeviceId}/reject"
...
async def async_reject_input_device_transfer(
