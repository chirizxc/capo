"""Generated from Smithy shape ``com.amazonaws.medialive#ListNodes``."""
...
def handle_response(
    ...
    out: capo_medialive.types.list_nodes_response.ListNodesResponse = (
        capo_medialive.types.list_nodes_response.deserialize_json(
...
def list_nodes(
    ...
    input_: capo_medialive.types.list_nodes_request.ListNodesRequest,
) -> tuple[capo_medialive.types.list_nodes_response.ListNodesResponse, zapros.Response]:
