...
def handle_response(
    ...
    out: capo_medialive.types.update_cloud_watch_alarm_template_response.UpdateCloudWatchAlarmTemplateResponse = capo_medialive.types.update_cloud_watch_alarm_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_medialive.types.update_cloud_watch_alarm_template_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
