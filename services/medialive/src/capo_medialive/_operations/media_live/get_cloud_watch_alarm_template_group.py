...
def handle_response(
    ...
    out: capo_medialive.types.get_cloud_watch_alarm_template_group_response.GetCloudWatchAlarmTemplateGroupResponse = capo_medialive.types.get_cloud_watch_alarm_template_group_response.deserialize_json(
