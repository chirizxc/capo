"""Generated from Smithy shape ``com.amazonaws.medialive#StartInputDevice``."""
...
def handle_response(
    ...
    out: capo_medialive.types.start_input_device_response.StartInputDeviceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prod/inputDevices/{InputDeviceId}/start"
...
async def async_start_input_device(
