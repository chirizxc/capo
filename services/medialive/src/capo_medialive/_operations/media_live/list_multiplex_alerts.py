...
def handle_response(
    ...
    out: capo_medialive.types.list_multiplex_alerts_response.ListMultiplexAlertsResponse = capo_medialive.types.list_multiplex_alerts_response.deserialize_json(
...
def build_request(
    ...
    if "state_filter" in input_:
        params.append(("stateFilter", input_["state_filter"]))
