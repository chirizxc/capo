...
if TYPE_CHECKING:
    import capo_medialive.types.__integer_min1_max65535
...
class SrtOutputDestinationSettings(TypedDict, closed=True):
    ...
    connection_mode: NotRequired["capo_medialive.types.connection_mode.ConnectionMode"]
    ...
    listener_port: NotRequired[
        "capo_medialive.types.__integer_min1_max65535.__integerMin1Max65535"
    ]
...
def serialize_json(value: SrtOutputDestinationSettings) -> dict:
    ...
    if "connection_mode" in value:
        ...
        out["connectionMode"] = capo_medialive.types.connection_mode.serialize_json(
