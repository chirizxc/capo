...
class InputDeviceConfigurableAudioChannelPairConfig(TypedDict, closed=True):
    ...
    profile: NotRequired[
        "capo_medialive.types.input_device_configurable_audio_channel_pair_profile.InputDeviceConfigurableAudioChannelPairProfile"
    ]
...
def serialize_json(value: InputDeviceConfigurableAudioChannelPairConfig) -> dict:
    ...
    if "profile" in value:
        ...
        out["profile"] = (
            capo_medialive.types.input_device_configurable_audio_channel_pair_profile.serialize_json(
                value["profile"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> InputDeviceConfigurableAudioChannelPairConfig:
    ...
    if data.get("profile") is not None:
        ...
        out["profile"] = (
            capo_medialive.types.input_device_configurable_audio_channel_pair_profile.deserialize_json(
                data["profile"]
            )
        )
    return out
