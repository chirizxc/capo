...
class ClusterNetworkSettingsCreateRequest(TypedDict, closed=True):
    ...
    interface_mappings: NotRequired[
        "capo_medialive.types.__list_of_interface_mapping_create_request.__listOfInterfaceMappingCreateRequest"
    ]
...
def serialize_json(value: ClusterNetworkSettingsCreateRequest) -> dict:
    ...
    if "interface_mappings" in value:
        ...
        out["interfaceMappings"] = (
            capo_medialive.types.__list_of_interface_mapping_create_request.serialize_json(
...
def deserialize_json(data: dict) -> ClusterNetworkSettingsCreateRequest:
    ...
    if data.get("interfaceMappings") is not None:
        ...
        out["interface_mappings"] = (
            capo_medialive.types.__list_of_interface_mapping_create_request.deserialize_json(
