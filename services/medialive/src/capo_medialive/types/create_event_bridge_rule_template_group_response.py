"""Generated from Smithy shape ``com.amazonaws.medialive#CreateEventBridgeRuleTemplateGroupResponse``."""
...
class CreateEventBridgeRuleTemplateGroupResponse(TypedDict, closed=True):
    arn: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateEventBridgeRuleTemplateGroupResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateEventBridgeRuleTemplateGroupResponse:
    out: CreateEventBridgeRuleTemplateGroupResponse = {}  # type: ignore[typeddict-item]
