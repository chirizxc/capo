...
if TYPE_CHECKING:
    ...
    import capo_medialive.types.__string_min1_max255
...
class Output(TypedDict, closed=True):
    ...
    output_name: NotRequired[
        "capo_medialive.types.__string_min1_max255.__stringMin1Max255"
    ]
    """The name used to identify an output."""
    output_settings: NotRequired["capo_medialive.types.output_settings.OutputSettings"]
    """Output type-specific settings."""
    video_description_name: NotRequired["capo_medialive.types.__string.__string"]
...
def serialize_json(value: Output) -> dict:
    ...
    if "output_settings" in value:
        ...
        out["outputSettings"] = capo_medialive.types.output_settings.serialize_json(
