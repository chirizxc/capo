...
class NielsenWatermarksSettings(TypedDict, closed=True):
    nielsen_cbet_settings: NotRequired["capo_medialive.types.nielsen_cbet.NielsenCBET"]
    """Complete these fields only if you want to insert watermarks of type Nielsen CBET"""
    nielsen_distribution_type: NotRequired[
        "capo_medialive.types.nielsen_watermarks_distribution_types.NielsenWatermarksDistributionTypes"
    ]
...
def serialize_json(value: NielsenWatermarksSettings) -> dict:
    ...
    if "nielsen_cbet_settings" in value:
        ...
        out["nielsenCbetSettings"] = capo_medialive.types.nielsen_cbet.serialize_json(
    ...
    if "nielsen_distribution_type" in value:
        ...
        out["nielsenDistributionType"] = (
            capo_medialive.types.nielsen_watermarks_distribution_types.serialize_json(
...
def deserialize_json(data: dict) -> NielsenWatermarksSettings:
    ...
    if data.get("nielsenCbetSettings") is not None:
        ...
        out["nielsen_cbet_settings"] = (
            capo_medialive.types.nielsen_cbet.deserialize_json(
    ...
    if data.get("nielsenDistributionType") is not None:
        ...
        out["nielsen_distribution_type"] = (
            capo_medialive.types.nielsen_watermarks_distribution_types.deserialize_json(
