...
if TYPE_CHECKING:
    import capo_medialive.types.__double_min_negative8_max0
    import capo_medialive.types.__double_min_negative59_max0
...
class AudioNormalizationSettings(TypedDict, closed=True):
    algorithm: NotRequired[
        "capo_medialive.types.audio_normalization_algorithm.AudioNormalizationAlgorithm"
    ]
    ...
    algorithm_control: NotRequired[
        "capo_medialive.types.audio_normalization_algorithm_control.AudioNormalizationAlgorithmControl"
    ]
    """When set to correctAudio the output audio is corrected using the chosen algorithm. If set to measureOnly, the audio will be measured but not adjusted."""
    target_lkfs: NotRequired[
        "capo_medialive.types.__double_min_negative59_max0.__doubleMinNegative59Max0"
    ]
    ...
    peak_calculation: NotRequired[
        "capo_medialive.types.audio_normalization_peak_calculation.AudioNormalizationPeakCalculation"
    ]
    """If set to TRUE_PEAK, calculate the TruePeak for each output's audio track loudness."""
    peak_limiter_threshold: NotRequired[
        "capo_medialive.types.__double_min_negative8_max0.__doubleMinNegative8Max0"
    ]
...
def serialize_json(value: AudioNormalizationSettings) -> dict:
    ...
    if "algorithm" in value:
        ...
        out["algorithm"] = (
            capo_medialive.types.audio_normalization_algorithm.serialize_json(
                value["algorithm"]
            )
        )
    if "algorithm_control" in value:
        ...
        out["algorithmControl"] = (
            capo_medialive.types.audio_normalization_algorithm_control.serialize_json(
    ...
    if "peak_calculation" in value:
        ...
        out["peakCalculation"] = (
            capo_medialive.types.audio_normalization_peak_calculation.serialize_json(
...
def deserialize_json(data: dict) -> AudioNormalizationSettings:
    ...
    if data.get("algorithm") is not None:
        ...
        out["algorithm"] = (
            capo_medialive.types.audio_normalization_algorithm.deserialize_json(
                data["algorithm"]
            )
        )
    if data.get("algorithmControl") is not None:
        ...
        out["algorithm_control"] = (
            capo_medialive.types.audio_normalization_algorithm_control.deserialize_json(
    ...
    if data.get("peakCalculation") is not None:
        ...
        out["peak_calculation"] = (
            capo_medialive.types.audio_normalization_peak_calculation.deserialize_json(
