"""Generated from Smithy shape ``com.amazonaws.medialive#InputDeviceSummary``."""
...
class InputDeviceSummary(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: InputDeviceSummary) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
