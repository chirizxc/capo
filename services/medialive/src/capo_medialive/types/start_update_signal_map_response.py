"""Generated from Smithy shape ``com.amazonaws.medialive#StartUpdateSignalMapResponse``."""
...
class StartUpdateSignalMapResponse(TypedDict, closed=True):
    arn: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: StartUpdateSignalMapResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> StartUpdateSignalMapResponse:
    out: StartUpdateSignalMapResponse = {}  # type: ignore[typeddict-item]
