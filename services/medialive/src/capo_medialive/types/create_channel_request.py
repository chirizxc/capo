...
class CreateChannelRequest(TypedDict, closed=True):
    ...
    reserved: NotRequired["capo_medialive.types.__string.__string"]
    ...
    vpc: NotRequired["capo_medialive.types.vpc_output_settings.VpcOutputSettings"]
...
def serialize_json(value: CreateChannelRequest) -> dict:
    ...
    if "maintenance" in value:
        ...
        out["maintenance"] = (
            capo_medialive.types.maintenance_create_settings.serialize_json(
                value["maintenance"]
            )
        )
    if "name" in value:
    ...
    if "vpc" in value:
        ...
        out["vpc"] = capo_medialive.types.vpc_output_settings.serialize_json(
            value["vpc"]
        )
...
def deserialize_json(data: dict) -> CreateChannelRequest:
    ...
    if data.get("maintenance") is not None:
        ...
        out["maintenance"] = (
            capo_medialive.types.maintenance_create_settings.deserialize_json(
                data["maintenance"]
            )
        )
