...
if TYPE_CHECKING:
    ...
    import capo_medialive.types.multiplex_settings_summary
...
class MultiplexSummary(TypedDict, closed=True):
    ...
    multiplex_settings: NotRequired[
        "capo_medialive.types.multiplex_settings_summary.MultiplexSettingsSummary"
    ]
...
def serialize_json(value: MultiplexSummary) -> dict:
    ...
    if "multiplex_settings" in value:
        ...
        out["multiplexSettings"] = (
            capo_medialive.types.multiplex_settings_summary.serialize_json(
...
def deserialize_json(data: dict) -> MultiplexSummary:
    ...
    if data.get("multiplexSettings") is not None:
        ...
        out["multiplex_settings"] = (
            capo_medialive.types.multiplex_settings_summary.deserialize_json(
