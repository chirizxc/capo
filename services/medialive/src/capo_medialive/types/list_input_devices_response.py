...
class ListInputDevicesResponse(TypedDict, closed=True):
    input_devices: NotRequired[
        "capo_medialive.types.__list_of_input_device_summary.__listOfInputDeviceSummary"
    ]
...
def serialize_json(value: ListInputDevicesResponse) -> dict:
    ...
    if "input_devices" in value:
        ...
        out["inputDevices"] = (
            capo_medialive.types.__list_of_input_device_summary.serialize_json(
                value["input_devices"]
            )
        )
...
def deserialize_json(data: dict) -> ListInputDevicesResponse:
    ...
    if data.get("inputDevices") is not None:
        ...
        out["input_devices"] = (
            capo_medialive.types.__list_of_input_device_summary.deserialize_json(
                data["inputDevices"]
            )
        )
