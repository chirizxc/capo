"""Generated from Smithy shape ``com.amazonaws.medialive#GetEventBridgeRuleTemplateResponse``."""
...
class GetEventBridgeRuleTemplateResponse(TypedDict, closed=True):
    arn: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: GetEventBridgeRuleTemplateResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetEventBridgeRuleTemplateResponse:
    out: GetEventBridgeRuleTemplateResponse = {}  # type: ignore[typeddict-item]
