...
class VideoDescription(TypedDict, closed=True):
    codec_settings: NotRequired[
        "capo_medialive.types.video_codec_settings.VideoCodecSettings"
    ]
    ...
    respond_to_afd: NotRequired[
        "capo_medialive.types.video_description_respond_to_afd.VideoDescriptionRespondToAfd"
    ]
    ...
    scaling_behavior: NotRequired[
        "capo_medialive.types.video_description_scaling_behavior.VideoDescriptionScalingBehavior"
    ]
...
def serialize_json(value: VideoDescription) -> dict:
    ...
    if "codec_settings" in value:
        ...
        out["codecSettings"] = capo_medialive.types.video_codec_settings.serialize_json(
    ...
    if "respond_to_afd" in value:
        ...
        out["respondToAfd"] = (
            capo_medialive.types.video_description_respond_to_afd.serialize_json(
    ...
    if "scaling_behavior" in value:
        ...
        out["scalingBehavior"] = (
            capo_medialive.types.video_description_scaling_behavior.serialize_json(
...
def deserialize_json(data: dict) -> VideoDescription:
    ...
    if data.get("codecSettings") is not None:
        ...
        out["codec_settings"] = (
            capo_medialive.types.video_codec_settings.deserialize_json(
                data["codecSettings"]
            )
        )
    ...
    if data.get("respondToAfd") is not None:
        ...
        out["respond_to_afd"] = (
            capo_medialive.types.video_description_respond_to_afd.deserialize_json(
                data["respondToAfd"]
            )
        )
    if data.get("scalingBehavior") is not None:
        ...
        out["scaling_behavior"] = (
            capo_medialive.types.video_description_scaling_behavior.deserialize_json(
