...
if TYPE_CHECKING:
    import capo_medialive.types.__integer_min1_max8
...
class RemixSettings(TypedDict, closed=True):
    channel_mappings: NotRequired[
        "capo_medialive.types.__list_of_audio_channel_mapping.__listOfAudioChannelMapping"
    ]
    ...
    channels_out: NotRequired[
        "capo_medialive.types.__integer_min1_max8.__integerMin1Max8"
    ]
...
def serialize_json(value: RemixSettings) -> dict:
    ...
    if "channel_mappings" in value:
        ...
        out["channelMappings"] = (
            capo_medialive.types.__list_of_audio_channel_mapping.serialize_json(
...
def deserialize_json(data: dict) -> RemixSettings:
    ...
    if data.get("channelMappings") is not None:
        ...
        out["channel_mappings"] = (
            capo_medialive.types.__list_of_audio_channel_mapping.deserialize_json(
