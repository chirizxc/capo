...
class AudioChannelMapping(TypedDict, closed=True):
    input_channel_levels: NotRequired[
        "capo_medialive.types.__list_of_input_channel_level.__listOfInputChannelLevel"
    ]
...
def serialize_json(value: AudioChannelMapping) -> dict:
    ...
    if "input_channel_levels" in value:
        ...
        out["inputChannelLevels"] = (
            capo_medialive.types.__list_of_input_channel_level.serialize_json(
...
def deserialize_json(data: dict) -> AudioChannelMapping:
    ...
    if data.get("inputChannelLevels") is not None:
        ...
        out["input_channel_levels"] = (
            capo_medialive.types.__list_of_input_channel_level.deserialize_json(
