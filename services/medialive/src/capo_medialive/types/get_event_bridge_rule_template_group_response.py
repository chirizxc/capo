"""Generated from Smithy shape ``com.amazonaws.medialive#GetEventBridgeRuleTemplateGroupResponse``."""
...
class GetEventBridgeRuleTemplateGroupResponse(TypedDict, closed=True):
    arn: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: GetEventBridgeRuleTemplateGroupResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetEventBridgeRuleTemplateGroupResponse:
    out: GetEventBridgeRuleTemplateGroupResponse = {}  # type: ignore[typeddict-item]
