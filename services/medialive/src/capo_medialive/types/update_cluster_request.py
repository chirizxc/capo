...
def serialize_json(value: UpdateClusterRequest) -> dict:
    ...
    if "network_settings" in value:
        ...
        out["networkSettings"] = (
            capo_medialive.types.cluster_network_settings_update_request.serialize_json(
...
def deserialize_json(data: dict) -> UpdateClusterRequest:
    ...
    if data.get("networkSettings") is not None:
        ...
        out["network_settings"] = (
            capo_medialive.types.cluster_network_settings_update_request.deserialize_json(
