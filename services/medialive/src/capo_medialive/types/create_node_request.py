...
def serialize_json(value: CreateNodeRequest) -> dict:
    ...
    if "node_interface_mappings" in value:
        ...
        out["nodeInterfaceMappings"] = (
            capo_medialive.types.__list_of_node_interface_mapping_create_request.serialize_json(
...
def deserialize_json(data: dict) -> CreateNodeRequest:
    ...
    if data.get("nodeInterfaceMappings") is not None:
        ...
        out["node_interface_mappings"] = (
            capo_medialive.types.__list_of_node_interface_mapping_create_request.deserialize_json(
