...
class CaptionDescription(TypedDict, closed=True):
    accessibility: NotRequired[
        "capo_medialive.types.accessibility_type.AccessibilityType"
    ]
    ...
    caption_selector_name: NotRequired["capo_medialive.types.__string.__string"]
    """Specifies which input caption selector to use as a caption source when generating output captions. This field should match a captionSelector name."""
    destination_settings: NotRequired[
        "capo_medialive.types.caption_destination_settings.CaptionDestinationSettings"
    ]
    """Additional settings for captions destination that depend on the destination type."""
    language_code: NotRequired["capo_medialive.types.__string.__string"]
    """ISO 639-2 three-digit code: http://www.loc.gov/standards/iso639-2/"""
    language_description: NotRequired["capo_medialive.types.__string.__string"]
    ...
    caption_dash_roles: NotRequired[
        "capo_medialive.types.__list_of_dash_role_caption.__listOfDashRoleCaption"
    ]
...
def serialize_json(value: CaptionDescription) -> dict:
    ...
    if "accessibility" in value:
        ...
        out["accessibility"] = capo_medialive.types.accessibility_type.serialize_json(
            value["accessibility"]
        )
    ...
    if "destination_settings" in value:
        ...
        out["destinationSettings"] = (
            capo_medialive.types.caption_destination_settings.serialize_json(
    ...
    if "caption_dash_roles" in value:
        ...
        out["captionDashRoles"] = (
            capo_medialive.types.__list_of_dash_role_caption.serialize_json(
...
def deserialize_json(data: dict) -> CaptionDescription:
    ...
    if data.get("destinationSettings") is not None:
        ...
        out["destination_settings"] = (
            capo_medialive.types.caption_destination_settings.deserialize_json(
    ...
    if data.get("captionDashRoles") is not None:
        ...
        out["caption_dash_roles"] = (
            capo_medialive.types.__list_of_dash_role_caption.deserialize_json(
