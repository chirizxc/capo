...
class AvailConfiguration(TypedDict, closed=True):
    avail_settings: NotRequired["capo_medialive.types.avail_settings.AvailSettings"]
    ...
    scte35_segmentation_scope: NotRequired[
        "capo_medialive.types.scte35_segmentation_scope.Scte35SegmentationScope"
    ]
...
def serialize_json(value: AvailConfiguration) -> dict:
    ...
    if "avail_settings" in value:
        ...
        out["availSettings"] = capo_medialive.types.avail_settings.serialize_json(
    ...
    if "scte35_segmentation_scope" in value:
        ...
        out["scte35SegmentationScope"] = (
            capo_medialive.types.scte35_segmentation_scope.serialize_json(
...
def deserialize_json(data: dict) -> AvailConfiguration:
    ...
    if data.get("scte35SegmentationScope") is not None:
        ...
        out["scte35_segmentation_scope"] = (
            capo_medialive.types.scte35_segmentation_scope.deserialize_json(
