...
if TYPE_CHECKING:
    import capo_medialive.types.__integer_max5
...
class EventBridgeRuleTemplateSummary(TypedDict, closed=True):
    ...
    event_target_count: NotRequired["capo_medialive.types.__integer_max5.__integerMax5"]
...
def deserialize_json(data: dict) -> EventBridgeRuleTemplateSummary:
    ...
    if data.get("eventTargetCount") is not None:
