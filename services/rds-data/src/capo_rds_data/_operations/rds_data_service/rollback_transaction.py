...
def handle_response(
    ...
    out: capo_rds_data.types.rollback_transaction_response.RollbackTransactionResponse = capo_rds_data.types.rollback_transaction_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rds_data.types.rollback_transaction_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
