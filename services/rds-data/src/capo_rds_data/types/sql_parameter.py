...
if TYPE_CHECKING:
    ...
    import capo_rds_data.types.parameter_name
    import capo_rds_data.types.type_hint


class SqlParameter(TypedDict, closed=True):
    name: NotRequired["capo_rds_data.types.parameter_name.ParameterName"]
    """<p>The name of the parameter.</p>"""
    value: NotRequired["capo_rds_data.types.field.Field"]
    """<p>The value of the parameter.</p>"""
    type_hint: NotRequired["capo_rds_data.types.type_hint.TypeHint"]
...
def serialize_json(value: SqlParameter) -> dict:
    ...
    if "value" in value:
        ...
        out["value"] = capo_rds_data.types.field.serialize_json(value["value"])
    if "type_hint" in value:
        import capo_rds_data.types.type_hint

        out["typeHint"] = capo_rds_data.types.type_hint.serialize_json(
            value["type_hint"]
        )
    return out
