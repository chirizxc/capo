...
class ResultSetOptions(TypedDict, closed=True):
    decimal_return_type: NotRequired[
        "capo_rds_data.types.decimal_return_type.DecimalReturnType"
    ]
    ...
    long_return_type: NotRequired["capo_rds_data.types.long_return_type.LongReturnType"]
...
def serialize_json(value: ResultSetOptions) -> dict:
    ...
    if "decimal_return_type" in value:
        ...
        out["decimalReturnType"] = (
            capo_rds_data.types.decimal_return_type.serialize_json(
    ...
    if "long_return_type" in value:
        ...
        out["longReturnType"] = capo_rds_data.types.long_return_type.serialize_json(
...
def deserialize_json(data: dict) -> ResultSetOptions:
    ...
    if data.get("decimalReturnType") is not None:
        ...
        out["decimal_return_type"] = (
            capo_rds_data.types.decimal_return_type.deserialize_json(
