"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationTableStatistics``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_replication_table_statistics_response.DescribeReplicationTableStatisticsResponse = capo_database_migration_service.types.describe_replication_table_statistics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeReplicationTableStatistics"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_replication_table_statistics_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_replication_table_statistics(
