"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartReplication``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.start_replication_response.StartReplicationResponse = capo_database_migration_service.types.start_replication_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartReplication"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_replication_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
