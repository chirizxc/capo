"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ModifyReplicationSubnetGroup``."""
...
import capo_database_migration_service.errors.subnet_already_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetAlreadyInUse":
            raise capo_database_migration_service.errors.subnet_already_in_use.SubnetAlreadyInUse.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_database_migration_service.types.modify_replication_subnet_group_response.ModifyReplicationSubnetGroupResponse = capo_database_migration_service.types.modify_replication_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.modify_replication_subnet_group_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_modify_replication_subnet_group(
