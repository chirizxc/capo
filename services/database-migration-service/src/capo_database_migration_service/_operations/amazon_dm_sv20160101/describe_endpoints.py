"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeEndpoints``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_endpoints_response.DescribeEndpointsResponse = capo_database_migration_service.types.describe_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_endpoints_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
