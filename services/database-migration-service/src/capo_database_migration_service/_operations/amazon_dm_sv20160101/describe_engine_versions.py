...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_engine_versions_response.DescribeEngineVersionsResponse = capo_database_migration_service.types.describe_engine_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_engine_versions_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
