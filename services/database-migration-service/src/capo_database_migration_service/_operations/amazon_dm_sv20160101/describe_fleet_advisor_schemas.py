"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeFleetAdvisorSchemas``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_fleet_advisor_schemas_response.DescribeFleetAdvisorSchemasResponse = capo_database_migration_service.types.describe_fleet_advisor_schemas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeFleetAdvisorSchemas"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_fleet_advisor_schemas_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_fleet_advisor_schemas(
