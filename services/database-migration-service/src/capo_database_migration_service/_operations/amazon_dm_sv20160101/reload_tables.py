"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ReloadTables``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.reload_tables_response.ReloadTablesResponse = capo_database_migration_service.types.reload_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.reload_tables_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
