"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeDataMigrations``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_data_migrations_response.DescribeDataMigrationsResponse = capo_database_migration_service.types.describe_data_migrations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeDataMigrations"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_data_migrations_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_data_migrations(
