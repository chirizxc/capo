"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationTasks``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_replication_tasks_response.DescribeReplicationTasksResponse = capo_database_migration_service.types.describe_replication_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_replication_tasks_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_replication_tasks(
