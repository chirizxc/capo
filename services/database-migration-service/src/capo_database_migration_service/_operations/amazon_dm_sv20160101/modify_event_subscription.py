...
def handle_response(
    ...
    out: capo_database_migration_service.types.modify_event_subscription_response.ModifyEventSubscriptionResponse = capo_database_migration_service.types.modify_event_subscription_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.modify_event_subscription_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
