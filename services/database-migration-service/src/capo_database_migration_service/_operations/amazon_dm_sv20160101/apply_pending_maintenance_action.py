"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#ApplyPendingMaintenanceAction``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.apply_pending_maintenance_action_response.ApplyPendingMaintenanceActionResponse = capo_database_migration_service.types.apply_pending_maintenance_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.apply_pending_maintenance_action_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
