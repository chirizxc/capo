"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#GetTargetSelectionRules``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.get_target_selection_rules_response.GetTargetSelectionRulesResponse = capo_database_migration_service.types.get_target_selection_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.GetTargetSelectionRules"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.get_target_selection_rules_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_target_selection_rules(
