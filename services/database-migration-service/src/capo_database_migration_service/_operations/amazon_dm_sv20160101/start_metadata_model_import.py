"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartMetadataModelImport``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.start_metadata_model_import_response.StartMetadataModelImportResponse = capo_database_migration_service.types.start_metadata_model_import_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartMetadataModelImport"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_metadata_model_import_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_metadata_model_import(
