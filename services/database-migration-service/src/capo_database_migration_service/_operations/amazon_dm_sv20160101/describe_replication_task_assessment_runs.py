...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_replication_task_assessment_runs_response.DescribeReplicationTaskAssessmentRunsResponse = capo_database_migration_service.types.describe_replication_task_assessment_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_replication_task_assessment_runs_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
