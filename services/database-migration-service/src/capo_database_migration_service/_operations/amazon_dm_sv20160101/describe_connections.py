"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeConnections``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_connections_response.DescribeConnectionsResponse = capo_database_migration_service.types.describe_connections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_connections_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
