"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelAssessments``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_metadata_model_assessments_response.DescribeMetadataModelAssessmentsResponse = capo_database_migration_service.types.describe_metadata_model_assessments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeMetadataModelAssessments"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_metadata_model_assessments_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_metadata_model_assessments(
