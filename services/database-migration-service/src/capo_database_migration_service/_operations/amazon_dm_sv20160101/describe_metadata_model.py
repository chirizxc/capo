"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModel``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_metadata_model_response.DescribeMetadataModelResponse = capo_database_migration_service.types.describe_metadata_model_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeMetadataModel"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_metadata_model_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_metadata_model(
