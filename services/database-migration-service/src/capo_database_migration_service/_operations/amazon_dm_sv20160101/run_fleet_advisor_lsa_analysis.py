...
def handle_response(
    ...
    out: capo_database_migration_service.types.run_fleet_advisor_lsa_analysis_response.RunFleetAdvisorLsaAnalysisResponse = capo_database_migration_service.types.run_fleet_advisor_lsa_analysis_response.deserialize_aws_json_1_1(
