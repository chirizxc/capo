...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_replication_instance_response.CreateReplicationInstanceResponse = capo_database_migration_service.types.create_replication_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_replication_instance_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
