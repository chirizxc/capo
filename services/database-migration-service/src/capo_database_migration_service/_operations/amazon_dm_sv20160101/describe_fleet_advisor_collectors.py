...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_fleet_advisor_collectors_response.DescribeFleetAdvisorCollectorsResponse = capo_database_migration_service.types.describe_fleet_advisor_collectors_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_fleet_advisor_collectors_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
