"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeEndpointSettings``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_endpoint_settings_response.DescribeEndpointSettingsResponse = capo_database_migration_service.types.describe_endpoint_settings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeEndpointSettings"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_endpoint_settings_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_endpoint_settings(
