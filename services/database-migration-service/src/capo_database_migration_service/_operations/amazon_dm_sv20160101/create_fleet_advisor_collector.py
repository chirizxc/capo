"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#CreateFleetAdvisorCollector``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.create_fleet_advisor_collector_response.CreateFleetAdvisorCollectorResponse = capo_database_migration_service.types.create_fleet_advisor_collector_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.CreateFleetAdvisorCollector"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.create_fleet_advisor_collector_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_fleet_advisor_collector(
