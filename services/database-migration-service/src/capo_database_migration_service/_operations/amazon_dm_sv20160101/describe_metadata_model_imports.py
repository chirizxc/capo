"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelImports``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_metadata_model_imports_response.DescribeMetadataModelImportsResponse = capo_database_migration_service.types.describe_metadata_model_imports_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.DescribeMetadataModelImports"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_metadata_model_imports_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_metadata_model_imports(
