"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartRecommendations``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartRecommendations"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_recommendations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_recommendations(
