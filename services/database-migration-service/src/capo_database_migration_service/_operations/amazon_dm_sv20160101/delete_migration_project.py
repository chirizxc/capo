...
def handle_response(
    ...
    out: capo_database_migration_service.types.delete_migration_project_response.DeleteMigrationProjectResponse = capo_database_migration_service.types.delete_migration_project_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.delete_migration_project_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
