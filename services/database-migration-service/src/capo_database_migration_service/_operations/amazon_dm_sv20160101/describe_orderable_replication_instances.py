"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeOrderableReplicationInstances``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_orderable_replication_instances_response.DescribeOrderableReplicationInstancesResponse = capo_database_migration_service.types.describe_orderable_replication_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_orderable_replication_instances_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_orderable_replication_instances(
