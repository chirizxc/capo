"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeEvents``."""
...
import capo_database_migration_service.types.event_list
...
def handle_response(
    ...
    out: capo_database_migration_service.types.describe_events_response.DescribeEventsResponse = capo_database_migration_service.types.describe_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.describe_events_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
