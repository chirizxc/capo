...
def handle_response(
    ...
    out: capo_database_migration_service.types.delete_fleet_advisor_databases_response.DeleteFleetAdvisorDatabasesResponse = capo_database_migration_service.types.delete_fleet_advisor_databases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.delete_fleet_advisor_databases_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
