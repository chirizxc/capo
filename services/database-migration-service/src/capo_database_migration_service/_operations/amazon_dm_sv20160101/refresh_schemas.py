"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#RefreshSchemas``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.refresh_schemas_response.RefreshSchemasResponse = capo_database_migration_service.types.refresh_schemas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.refresh_schemas_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_refresh_schemas(
