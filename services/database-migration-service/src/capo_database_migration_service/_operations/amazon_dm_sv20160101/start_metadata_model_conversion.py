"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#StartMetadataModelConversion``."""
...
def handle_response(
    ...
    out: capo_database_migration_service.types.start_metadata_model_conversion_response.StartMetadataModelConversionResponse = capo_database_migration_service.types.start_metadata_model_conversion_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonDMSv20160101.StartMetadataModelConversion"
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.start_metadata_model_conversion_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_metadata_model_conversion(
