...
def handle_response(
    ...
    out: capo_database_migration_service.types.delete_replication_subnet_group_response.DeleteReplicationSubnetGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_database_migration_service.types.delete_replication_subnet_group_message.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
