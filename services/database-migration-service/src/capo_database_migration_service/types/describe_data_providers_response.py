...
class DescribeDataProvidersResponse(TypedDict, closed=True):
    ...
    data_providers: NotRequired[
        "capo_database_migration_service.types.data_provider_list.DataProviderList"
    ]
...
def serialize_aws_json_1_1(value: DescribeDataProvidersResponse) -> dict:
    ...
    if "data_providers" in value:
        ...
        out["DataProviders"] = (
            capo_database_migration_service.types.data_provider_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeDataProvidersResponse:
    ...
    if data.get("DataProviders") is not None:
        import capo_database_migration_service.types.data_provider_list

        out["data_providers"] = (
            capo_database_migration_service.types.data_provider_list.deserialize_aws_json_1_1(
                data["DataProviders"]
            )
        )
    return out
