"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeCertificatesMessage``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeCertificatesMessage) -> dict:
    out: dict = {}
    if "filters" in value:
        import capo_database_migration_service.types.filter_list
...
def deserialize_aws_json_1_1(data: dict) -> DescribeCertificatesMessage:
