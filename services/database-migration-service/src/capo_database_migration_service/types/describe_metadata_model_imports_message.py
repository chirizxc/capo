"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeMetadataModelImportsMessage``."""
...
class DescribeMetadataModelImportsMessage(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeMetadataModelImportsMessage) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeMetadataModelImportsMessage:
    out: DescribeMetadataModelImportsMessage = {}  # type: ignore[typeddict-item]
    if data.get("MigrationProjectIdentifier") is not None:
        out["migration_project_identifier"] = data["MigrationProjectIdentifier"]
    else:
        raise DeserializationError(
            "DescribeMetadataModelImportsMessage.migration_project_identifier required"
        )
