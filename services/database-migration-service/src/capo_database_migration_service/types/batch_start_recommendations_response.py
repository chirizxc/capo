...
class BatchStartRecommendationsResponse(TypedDict, closed=True):
    error_entries: NotRequired[
        "capo_database_migration_service.types.batch_start_recommendations_error_entry_list.BatchStartRecommendationsErrorEntryList"
    ]
...
def serialize_aws_json_1_1(value: BatchStartRecommendationsResponse) -> dict:
    ...
    if "error_entries" in value:
        ...
        out["ErrorEntries"] = (
            capo_database_migration_service.types.batch_start_recommendations_error_entry_list.serialize_aws_json_1_1(
                value["error_entries"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> BatchStartRecommendationsResponse:
    ...
    if data.get("ErrorEntries") is not None:
        ...
        out["error_entries"] = (
            capo_database_migration_service.types.batch_start_recommendations_error_entry_list.deserialize_aws_json_1_1(
                data["ErrorEntries"]
            )
        )
    return out
