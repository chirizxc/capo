"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeExtensionPackAssociationsMessage``."""
...
class DescribeExtensionPackAssociationsMessage(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeExtensionPackAssociationsMessage) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeExtensionPackAssociationsMessage:
    out: DescribeExtensionPackAssociationsMessage = {}  # type: ignore[typeddict-item]
    if data.get("MigrationProjectIdentifier") is not None:
        out["migration_project_identifier"] = data["MigrationProjectIdentifier"]
    else:
        raise DeserializationError(
            "DescribeExtensionPackAssociationsMessage.migration_project_identifier required"
        )
