...
class DescribeEventCategoriesResponse(TypedDict, closed=True):
    event_category_group_list: NotRequired[
        "capo_database_migration_service.types.event_category_group_list.EventCategoryGroupList"
    ]
...
def serialize_aws_json_1_1(value: DescribeEventCategoriesResponse) -> dict:
    ...
    if "event_category_group_list" in value:
        ...
        out["EventCategoryGroupList"] = (
            capo_database_migration_service.types.event_category_group_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEventCategoriesResponse:
    ...
    if data.get("EventCategoryGroupList") is not None:
        import capo_database_migration_service.types.event_category_group_list

        out["event_category_group_list"] = (
            capo_database_migration_service.types.event_category_group_list.deserialize_aws_json_1_1(
