...
class DescribeEventsResponse(TypedDict, closed=True):
    ...
    events: NotRequired["capo_database_migration_service.types.event_list.EventList"]
...
def serialize_aws_json_1_1(value: DescribeEventsResponse) -> dict:
    ...
    if "events" in value:
        ...
        out["Events"] = (
            capo_database_migration_service.types.event_list.serialize_aws_json_1_1(
                value["events"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEventsResponse:
    ...
    if data.get("Events") is not None:
        ...
        out["events"] = (
            capo_database_migration_service.types.event_list.deserialize_aws_json_1_1(
                data["Events"]
            )
        )
    return out
