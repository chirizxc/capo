...
class DescribeRecommendationLimitationsResponse(TypedDict, closed=True):
    ...
    limitations: NotRequired[
        "capo_database_migration_service.types.limitation_list.LimitationList"
    ]
...
def serialize_aws_json_1_1(value: DescribeRecommendationLimitationsResponse) -> dict:
    ...
    if "limitations" in value:
        ...
        out["Limitations"] = (
            capo_database_migration_service.types.limitation_list.serialize_aws_json_1_1(
                value["limitations"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeRecommendationLimitationsResponse:
    ...
    if data.get("Limitations") is not None:
        ...
        out["limitations"] = (
            capo_database_migration_service.types.limitation_list.deserialize_aws_json_1_1(
                data["Limitations"]
            )
        )
    return out
