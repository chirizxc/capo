...
class ReplicationTaskAssessmentRunProgress(TypedDict, closed=True):
    individual_assessment_count: "capo_database_migration_service.types.integer.Integer"
    """<p>The number of individual assessments that are specified to run.</p>"""
    individual_assessment_completed_count: (
        "capo_database_migration_service.types.integer.Integer"
    )
