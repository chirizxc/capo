"""Generated from Smithy shape ``com.amazonaws.databasemigrationservice#DescribeReplicationTaskIndividualAssessmentsMessage``."""
...
class DescribeReplicationTaskIndividualAssessmentsMessage(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: DescribeReplicationTaskIndividualAssessmentsMessage,
) -> dict:
    out: dict = {}
    if "filters" in value:
        import capo_database_migration_service.types.filter_list
...
def deserialize_aws_json_1_1(
    ...
    out: DescribeReplicationTaskIndividualAssessmentsMessage = {}  # type: ignore[typeddict-item]
