...
class SchemaResponse(TypedDict, closed=True):
    ...
    complexity: NotRequired["capo_database_migration_service.types.string.String"]
    ...
    database_instance: NotRequired[
        "capo_database_migration_service.types.database_short_info_response.DatabaseShortInfoResponse"
    ]
    ...
    original_schema: NotRequired[
        "capo_database_migration_service.types.schema_short_info_response.SchemaShortInfoResponse"
    ]
...
def serialize_aws_json_1_1(value: SchemaResponse) -> dict:
    ...
    if "database_instance" in value:
        ...
        out["DatabaseInstance"] = (
            capo_database_migration_service.types.database_short_info_response.serialize_aws_json_1_1(
    ...
    if "original_schema" in value:
        ...
        out["OriginalSchema"] = (
            capo_database_migration_service.types.schema_short_info_response.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SchemaResponse:
    ...
    if data.get("DatabaseInstance") is not None:
        ...
        out["database_instance"] = (
            capo_database_migration_service.types.database_short_info_response.deserialize_aws_json_1_1(
    ...
    if data.get("OriginalSchema") is not None:
        ...
        out["original_schema"] = (
            capo_database_migration_service.types.schema_short_info_response.deserialize_aws_json_1_1(
                data["OriginalSchema"]
            )
        )
