...
class DescribeEngineVersionsResponse(TypedDict, closed=True):
    engine_versions: NotRequired[
        "capo_database_migration_service.types.engine_version_list.EngineVersionList"
    ]
...
def serialize_aws_json_1_1(value: DescribeEngineVersionsResponse) -> dict:
    ...
    if "engine_versions" in value:
        ...
        out["EngineVersions"] = (
            capo_database_migration_service.types.engine_version_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEngineVersionsResponse:
    ...
    if data.get("EngineVersions") is not None:
        ...
        out["engine_versions"] = (
            capo_database_migration_service.types.engine_version_list.deserialize_aws_json_1_1(
                data["EngineVersions"]
            )
        )
