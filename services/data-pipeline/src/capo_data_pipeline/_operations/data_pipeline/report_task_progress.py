"""Generated from Smithy shape ``com.amazonaws.datapipeline#ReportTaskProgress``."""
...
def handle_response(
    ...
    out: capo_data_pipeline.types.report_task_progress_output.ReportTaskProgressOutput = capo_data_pipeline.types.report_task_progress_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.report_task_progress_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_report_task_progress(
