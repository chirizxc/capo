...
def handle_response(
    ...
    out: capo_data_pipeline.types.remove_tags_output.RemoveTagsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.remove_tags_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def remove_tags(
    ...
    capo_data_pipeline.types.remove_tags_output.RemoveTagsOutput, zapros.Response
]:
