...
def handle_response(
    ...
    out: capo_data_pipeline.types.deactivate_pipeline_output.DeactivatePipelineOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.deactivate_pipeline_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
