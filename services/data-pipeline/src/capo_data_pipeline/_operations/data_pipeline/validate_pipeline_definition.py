...
def handle_response(
    ...
    out: capo_data_pipeline.types.validate_pipeline_definition_output.ValidatePipelineDefinitionOutput = capo_data_pipeline.types.validate_pipeline_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_data_pipeline.types.validate_pipeline_definition_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
