...
from capo_data_pipeline._services._aws_config import aws_config
...
class DataPipelineClient:
    ...
    def activate_pipeline(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.activate_pipeline_input.ActivatePipelineInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.activate_pipeline_output.ActivatePipelineOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.activate_pipeline.activate_pipeline(
    ...
    def add_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.add_tags_input.AddTagsInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.add_tags_output.AddTagsOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.add_tags.add_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_pipeline(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.create_pipeline_input.CreatePipelineInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.create_pipeline_output.CreatePipelineOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.create_pipeline.create_pipeline(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deactivate_pipeline(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.deactivate_pipeline_input.DeactivatePipelineInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.deactivate_pipeline_output.DeactivatePipelineOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.deactivate_pipeline.deactivate_pipeline(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_pipeline(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.delete_pipeline_input.DeletePipelineInput]",
        ) -> OperationResponse[None]:
            import capo_data_pipeline._operations.data_pipeline.delete_pipeline

            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.delete_pipeline.delete_pipeline(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_objects(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.describe_objects_input.DescribeObjectsInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.describe_objects_output.DescribeObjectsOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.describe_objects.describe_objects(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_objects(
        ...
        *,
        ...
        marker: Optional["capo_data_pipeline.types.string.string"] = None,
    ) -> "Iterator[capo_data_pipeline.types.pipeline_object.PipelineObject]":
        _token = marker
        while True:
    ...
    def describe_pipelines(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.describe_pipelines_input.DescribePipelinesInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.describe_pipelines_output.DescribePipelinesOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.describe_pipelines.describe_pipelines(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def evaluate_expression(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.evaluate_expression_input.EvaluateExpressionInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.evaluate_expression_output.EvaluateExpressionOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.evaluate_expression.evaluate_expression(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_pipeline_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.get_pipeline_definition_input.GetPipelineDefinitionInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.get_pipeline_definition_output.GetPipelineDefinitionOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.get_pipeline_definition.get_pipeline_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_pipelines(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.list_pipelines_input.ListPipelinesInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.list_pipelines_output.ListPipelinesOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.list_pipelines.list_pipelines(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_pipelines(
        ...
        *,
        config_overrides: Optional[DataPipelineClientConfig] = None,
        marker: Optional["capo_data_pipeline.types.string.string"] = None,
    ) -> "Iterator[capo_data_pipeline.types.pipeline_id_name.PipelineIdName]":
        _token = marker
        while True:
    ...
    def poll_for_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.poll_for_task_input.PollForTaskInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.poll_for_task_output.PollForTaskOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.poll_for_task.poll_for_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_pipeline_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.put_pipeline_definition_input.PutPipelineDefinitionInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.put_pipeline_definition_output.PutPipelineDefinitionOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.put_pipeline_definition.put_pipeline_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def query_objects(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.query_objects_input.QueryObjectsInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.query_objects_output.QueryObjectsOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.query_objects.query_objects(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_query_objects(
        ...
        *,
        ...
        marker: Optional["capo_data_pipeline.types.string.string"] = None,
        limit: Optional["capo_data_pipeline.types.int.int"] = None,
    ) -> "Iterator[capo_data_pipeline.types.id.id]":
        _token = marker
        while True:
    ...
    def remove_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.remove_tags_input.RemoveTagsInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.remove_tags_output.RemoveTagsOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.remove_tags.remove_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def report_task_progress(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.report_task_progress_input.ReportTaskProgressInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.report_task_progress_output.ReportTaskProgressOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.report_task_progress.report_task_progress(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def report_task_runner_heartbeat(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.report_task_runner_heartbeat_input.ReportTaskRunnerHeartbeatInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.report_task_runner_heartbeat_output.ReportTaskRunnerHeartbeatOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.report_task_runner_heartbeat.report_task_runner_heartbeat(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.set_status_input.SetStatusInput]",
        ) -> OperationResponse[None]:
            import capo_data_pipeline._operations.data_pipeline.set_status

            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.set_status.set_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_task_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.set_task_status_input.SetTaskStatusInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.set_task_status_output.SetTaskStatusOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.set_task_status.set_task_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def validate_pipeline_definition(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_data_pipeline.types.validate_pipeline_definition_input.ValidatePipelineDefinitionInput]",
        ) -> OperationResponse[
            "capo_data_pipeline.types.validate_pipeline_definition_output.ValidatePipelineDefinitionOutput"
        ]:
            ...
            output, http_response = (
                capo_data_pipeline._operations.data_pipeline.validate_pipeline_definition.validate_pipeline_definition(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
