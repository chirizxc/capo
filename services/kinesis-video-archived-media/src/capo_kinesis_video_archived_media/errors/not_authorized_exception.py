"""Generated from Smithy shape ``com.amazonaws.kinesisvideoarchivedmedia#NotAuthorizedException``."""
...
class NotAuthorizedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisvideoarchivedmedia#NotAuthorizedException``."""
