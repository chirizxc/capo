...
def serialize_json(value: GetClipInput) -> dict:
    ...
    out["ClipFragmentSelector"] = (
        capo_kinesis_video_archived_media.types.clip_fragment_selector.serialize_json(
...
def deserialize_json(data: dict) -> GetClipInput:
    ...
    if data.get("ClipFragmentSelector") is not None:
        ...
        out["clip_fragment_selector"] = (
            capo_kinesis_video_archived_media.types.clip_fragment_selector.deserialize_json(
