...
from capo_kinesis_video_archived_media._services._aws_config import aaws_config
...
class AsyncKinesisVideoArchivedMediaClient:
    ...
    async def get_clip(
        ...
        *,
    ...
    ) -> "AsyncGenerator[capo_kinesis_video_archived_media.types.get_clip_output.GetClipOutput]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kinesis_video_archived_media.types.get_clip_input.GetClipInput]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_kinesis_video_archived_media._operations.aws_acuity_reader.get_clip.async_get_clip(
    ...
    async def get_dash_streaming_session_url(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kinesis_video_archived_media.types.get_dash_streaming_session_url_input.GetDASHStreamingSessionURLInput]",
        ) -> AsyncOperationResponse[
            "capo_kinesis_video_archived_media.types.get_dash_streaming_session_url_output.GetDASHStreamingSessionURLOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_kinesis_video_archived_media._operations.aws_acuity_reader.get_dash_streaming_session_url.async_get_dash_streaming_session_url(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_hls_streaming_session_url(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kinesis_video_archived_media.types.get_hls_streaming_session_url_input.GetHLSStreamingSessionURLInput]",
        ) -> AsyncOperationResponse[
            "capo_kinesis_video_archived_media.types.get_hls_streaming_session_url_output.GetHLSStreamingSessionURLOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_kinesis_video_archived_media._operations.aws_acuity_reader.get_hls_streaming_session_url.async_get_hls_streaming_session_url(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_images(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kinesis_video_archived_media.types.get_images_input.GetImagesInput]",
        ) -> AsyncOperationResponse[
            "capo_kinesis_video_archived_media.types.get_images_output.GetImagesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_kinesis_video_archived_media._operations.aws_acuity_reader.get_images.async_get_images(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_kinesis_video_archived_media.types.image.Image]":
        _token = next_token
        while True:
    ...
    async def get_media_for_fragment_list(
        ...
        *,
    ...
    ) -> "AsyncGenerator[capo_kinesis_video_archived_media.types.get_media_for_fragment_list_output.GetMediaForFragmentListOutput]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kinesis_video_archived_media.types.get_media_for_fragment_list_input.GetMediaForFragmentListInput]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_kinesis_video_archived_media._operations.aws_acuity_reader.get_media_for_fragment_list.async_get_media_for_fragment_list(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_fragments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kinesis_video_archived_media.types.list_fragments_input.ListFragmentsInput]",
        ) -> AsyncOperationResponse[
            "capo_kinesis_video_archived_media.types.list_fragments_output.ListFragmentsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_kinesis_video_archived_media._operations.aws_acuity_reader.list_fragments.async_list_fragments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_kinesis_video_archived_media.types.fragment.Fragment]":
        _token = next_token
        while True:
