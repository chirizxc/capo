"""Generated from Smithy shape ``com.amazonaws.servicediscovery#ListServices``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.list_services_response.ListServicesResponse = (
        capo_servicediscovery.types.list_services_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.list_services_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
