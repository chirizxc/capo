"""Generated from Smithy shape ``com.amazonaws.servicediscovery#TagResource``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.TagResource"
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.tag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
