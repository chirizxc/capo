"""Generated from Smithy shape ``com.amazonaws.servicediscovery#GetOperation``."""
...
import capo_servicediscovery.errors.operation_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OperationNotFound":
            raise capo_servicediscovery.errors.operation_not_found.OperationNotFound.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_servicediscovery.types.get_operation_response.GetOperationResponse = (
        capo_servicediscovery.types.get_operation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.get_operation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
