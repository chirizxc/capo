...
def handle_response(
    ...
    out: capo_servicediscovery.types.list_instances_response.ListInstancesResponse = (
        capo_servicediscovery.types.list_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.list_instances_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
