...
def handle_response(
    ...
    out: capo_servicediscovery.types.update_service_response.UpdateServiceResponse = (
        capo_servicediscovery.types.update_service_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.update_service_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
