"""Generated from Smithy shape ``com.amazonaws.servicediscovery#DeleteService``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.delete_service_response.DeleteServiceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.delete_service_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
