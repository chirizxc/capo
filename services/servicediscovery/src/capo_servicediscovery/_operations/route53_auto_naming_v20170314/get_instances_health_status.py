"""Generated from Smithy shape ``com.amazonaws.servicediscovery#GetInstancesHealthStatus``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.get_instances_health_status_response.GetInstancesHealthStatusResponse = capo_servicediscovery.types.get_instances_health_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.get_instances_health_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_instances_health_status(
