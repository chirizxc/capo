"""Generated from Smithy shape ``com.amazonaws.servicediscovery#DeregisterInstance``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.deregister_instance_response.DeregisterInstanceResponse = capo_servicediscovery.types.deregister_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.deregister_instance_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_deregister_instance(
