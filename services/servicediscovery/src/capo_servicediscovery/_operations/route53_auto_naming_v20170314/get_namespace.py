...
def handle_response(
    ...
    out: capo_servicediscovery.types.get_namespace_response.GetNamespaceResponse = (
        capo_servicediscovery.types.get_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.get_namespace_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
