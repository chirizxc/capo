"""Generated from Smithy shape ``com.amazonaws.servicediscovery#UpdatePrivateDnsNamespace``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.update_private_dns_namespace_response.UpdatePrivateDnsNamespaceResponse = capo_servicediscovery.types.update_private_dns_namespace_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.UpdatePrivateDnsNamespace"
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.update_private_dns_namespace_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_private_dns_namespace(
