"""Generated from Smithy shape ``com.amazonaws.servicediscovery#UntagResource``."""
...
def handle_response(
    ...
    out: capo_servicediscovery.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53AutoNaming_v20170314.UntagResource"
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.untag_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
