...
def handle_response(
    ...
    out: capo_servicediscovery.types.delete_service_attributes_response.DeleteServiceAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_servicediscovery.types.delete_service_attributes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
