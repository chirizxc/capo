...
class CreateServiceRequest(TypedDict, closed=True):
    ...
    namespace_id: NotRequired["capo_servicediscovery.types.arn.Arn"]
    r"""<p>The ID or Amazon Resource Name (ARN) of the namespace that you want to use to create the service. For namespaces shared with your Amazon Web Services account, specify the namespace ARN. For more information about shared namespaces, see <a href=\"https://docs.aws.amazon.com/cloud-map/latest/dg/sharing-namespaces.html\">Cross-account Cloud Map namespace sharing</a> in the <i>Cloud Map Developer Guide</i>.</p>"""
    ...
    r"""<p> <i>Public DNS and HTTP namespaces only.</i> A complex type that contains settings for an optional Route 53 health check. If you specify settings for a health check, Cloud Map associates the health check with all the Route 53 DNS records that you specify in <code>DnsConfig</code>.</p> <important> <p>If you specify a health check configuration, you can specify either <code>HealthCheckCustomConfig</code> or <code>HealthCheckConfig</code> but not both.</p> </important> <p>For information about the charges for health checks, see <a href=\"http://aws.amazon.com/cloud-map/pricing/\">Cloud Map Pricing</a>.</p>"""
...
def serialize_aws_json_1_1(value: CreateServiceRequest) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = (
            capo_servicediscovery.types.service_type_option.serialize_aws_json_1_1(
                value["type"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CreateServiceRequest:
    ...
    if data.get("Type") is not None:
        ...
        out["type"] = (
            capo_servicediscovery.types.service_type_option.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    return out
