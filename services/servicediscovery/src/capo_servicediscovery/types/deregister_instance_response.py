"""Generated from Smithy shape ``com.amazonaws.servicediscovery#DeregisterInstanceResponse``."""
...
class DeregisterInstanceResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeregisterInstanceResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeregisterInstanceResponse:
    out: DeregisterInstanceResponse = {}  # type: ignore[typeddict-item]
