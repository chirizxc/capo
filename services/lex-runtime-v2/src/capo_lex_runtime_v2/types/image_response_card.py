...
if TYPE_CHECKING:
    import capo_lex_runtime_v2.types.attachment_title
    import capo_lex_runtime_v2.types.attachment_url
    import capo_lex_runtime_v2.types.buttons_list


class ImageResponseCard(TypedDict, closed=True):
    title: "capo_lex_runtime_v2.types.attachment_title.AttachmentTitle"
    ...
    subtitle: NotRequired["capo_lex_runtime_v2.types.attachment_title.AttachmentTitle"]
    ...
    image_url: NotRequired["capo_lex_runtime_v2.types.attachment_url.AttachmentUrl"]
    ...
    buttons: NotRequired["capo_lex_runtime_v2.types.buttons_list.ButtonsList"]
...
def serialize_json(value: ImageResponseCard) -> dict:
    ...
    if "buttons" in value:
        ...
        out["buttons"] = capo_lex_runtime_v2.types.buttons_list.serialize_json(
            value["buttons"]
        )
    return out
...
def deserialize_json(data: dict) -> ImageResponseCard:
    ...
    if data.get("buttons") is not None:
        ...
        out["buttons"] = capo_lex_runtime_v2.types.buttons_list.deserialize_json(
            data["buttons"]
        )
    return out
