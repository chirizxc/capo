...
if TYPE_CHECKING:
    import capo_lex_runtime_v2.types.runtime_hint_values_list
...
class RuntimeHintDetails(TypedDict, closed=True):
    runtime_hint_values: NotRequired[
        "capo_lex_runtime_v2.types.runtime_hint_values_list.RuntimeHintValuesList"
    ]
...
def serialize_json(value: RuntimeHintDetails) -> dict:
    ...
    if "runtime_hint_values" in value:
        ...
        out["runtimeHintValues"] = (
            capo_lex_runtime_v2.types.runtime_hint_values_list.serialize_json(
    ...
    if "sub_slot_hints" in value:
        ...
        out["subSlotHints"] = (
            capo_lex_runtime_v2.types.slot_hints_slot_map.serialize_json(
...
def deserialize_json(data: dict) -> RuntimeHintDetails:
    ...
    if data.get("runtimeHintValues") is not None:
        ...
        out["runtime_hint_values"] = (
            capo_lex_runtime_v2.types.runtime_hint_values_list.deserialize_json(
    ...
    if data.get("subSlotHints") is not None:
        ...
        out["sub_slot_hints"] = (
            capo_lex_runtime_v2.types.slot_hints_slot_map.deserialize_json(
                data["subSlotHints"]
            )
        )
    return out
