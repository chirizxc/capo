"""Generated from Smithy shape ``com.amazonaws.lexruntimev2#GetSession``."""
...
def handle_response(
    ...
    out: capo_lex_runtime_v2.types.get_session_response.GetSessionResponse = (
        capo_lex_runtime_v2.types.get_session_response.deserialize_json(
...
def get_session(
    ...
    capo_lex_runtime_v2.types.get_session_response.GetSessionResponse, zapros.Response
]:
