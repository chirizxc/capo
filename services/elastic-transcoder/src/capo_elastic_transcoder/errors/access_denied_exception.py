"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elastictranscoder#AccessDeniedException``."""
