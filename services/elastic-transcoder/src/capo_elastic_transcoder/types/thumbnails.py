...
if TYPE_CHECKING:
    ...
    import capo_elastic_transcoder.types.digits
    ...
    import capo_elastic_transcoder.types.thumbnail_resolution


class Thumbnails(TypedDict, closed=True):
    format: NotRequired["capo_elastic_transcoder.types.jpg_or_png.JpgOrPng"]
    ...
    interval: NotRequired["capo_elastic_transcoder.types.digits.Digits"]
    """<p>The approximate number of seconds between thumbnails. Specify an integer value.</p>"""
    resolution: NotRequired[
        "capo_elastic_transcoder.types.thumbnail_resolution.ThumbnailResolution"
    ]
