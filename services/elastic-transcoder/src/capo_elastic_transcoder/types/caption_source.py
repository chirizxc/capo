...
if TYPE_CHECKING:
    ...
    import capo_elastic_transcoder.types.time_offset
...
class CaptionSource(TypedDict, closed=True):
    ...
    language: NotRequired["capo_elastic_transcoder.types.key.Key"]
    ...
    time_offset: NotRequired["capo_elastic_transcoder.types.time_offset.TimeOffset"]
    ...
    label: NotRequired["capo_elastic_transcoder.types.name.Name"]
