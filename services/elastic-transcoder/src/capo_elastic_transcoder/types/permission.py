...
if TYPE_CHECKING:
    ...
    import capo_elastic_transcoder.types.grantee
    import capo_elastic_transcoder.types.grantee_type


class Permission(TypedDict, closed=True):
    grantee_type: NotRequired["capo_elastic_transcoder.types.grantee_type.GranteeType"]
    ...
    grantee: NotRequired["capo_elastic_transcoder.types.grantee.Grantee"]
    ...
    access: NotRequired["capo_elastic_transcoder.types.access_controls.AccessControls"]
...
def serialize_json(value: Permission) -> dict:
    ...
    if "access" in value:
        ...
        out["Access"] = capo_elastic_transcoder.types.access_controls.serialize_json(
            value["access"]
        )
    return out
