...
if TYPE_CHECKING:
    import capo_elastic_transcoder.types.key_id_guid
    import capo_elastic_transcoder.types.non_empty_base64_encoded_string
    import capo_elastic_transcoder.types.one_to512_string
    import capo_elastic_transcoder.types.play_ready_drm_format_string
    import capo_elastic_transcoder.types.zero_to255_string


class PlayReadyDrm(TypedDict, closed=True):
    format: NotRequired[
        "capo_elastic_transcoder.types.play_ready_drm_format_string.PlayReadyDrmFormatString"
    ]
    """<p>The type of DRM, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.</p>"""
    key: NotRequired[
        "capo_elastic_transcoder.types.non_empty_base64_encoded_string.NonEmptyBase64EncodedString"
    ]
    ...
    key_id: NotRequired["capo_elastic_transcoder.types.key_id_guid.KeyIdGuid"]
    ...
    initialization_vector: NotRequired[
        "capo_elastic_transcoder.types.zero_to255_string.ZeroTo255String"
    ]
    ...
    license_acquisition_url: NotRequired[
        "capo_elastic_transcoder.types.one_to512_string.OneTo512String"
    ]
