"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#ReadPipelineResponse``."""
...
class ReadPipelineResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ReadPipelineResponse) -> dict:
    out: dict = {}
