...
if TYPE_CHECKING:
    import capo_elastic_transcoder.types.base64_encoded_string
    import capo_elastic_transcoder.types.hls_content_protection_method
    import capo_elastic_transcoder.types.key_storage_policy
    import capo_elastic_transcoder.types.zero_to255_string
    import capo_elastic_transcoder.types.zero_to512_string


class HlsContentProtection(TypedDict, closed=True):
    method: NotRequired[
        "capo_elastic_transcoder.types.hls_content_protection_method.HlsContentProtectionMethod"
    ]
    ...
    key: NotRequired[
        "capo_elastic_transcoder.types.base64_encoded_string.Base64EncodedString"
    ]
    ...
    license_acquisition_url: NotRequired[
        "capo_elastic_transcoder.types.zero_to512_string.ZeroTo512String"
    ]
    ...
    key_storage_policy: NotRequired[
        "capo_elastic_transcoder.types.key_storage_policy.KeyStoragePolicy"
    ]
