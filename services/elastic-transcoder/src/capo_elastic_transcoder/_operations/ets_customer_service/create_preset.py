"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#CreatePreset``."""
...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.create_preset_response.CreatePresetResponse = (
        capo_elastic_transcoder.types.create_preset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elastic_transcoder.types.create_preset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
