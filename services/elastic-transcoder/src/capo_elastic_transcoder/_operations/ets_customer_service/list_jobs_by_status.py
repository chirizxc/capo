...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.list_jobs_by_status_response.ListJobsByStatusResponse = capo_elastic_transcoder.types.list_jobs_by_status_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{Status}", quote(input_["status"], safe=""))
