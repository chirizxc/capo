"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#DeletePipeline``."""
...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.delete_pipeline_response.DeletePipelineResponse = {}  # type: ignore[typeddict-item]
    return out
