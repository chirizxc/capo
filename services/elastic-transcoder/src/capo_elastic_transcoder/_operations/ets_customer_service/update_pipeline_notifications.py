...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.update_pipeline_notifications_response.UpdatePipelineNotificationsResponse = capo_elastic_transcoder.types.update_pipeline_notifications_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elastic_transcoder.types.update_pipeline_notifications_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
