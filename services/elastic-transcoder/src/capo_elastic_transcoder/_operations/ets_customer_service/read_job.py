...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.read_job_response.ReadJobResponse = (
        capo_elastic_transcoder.types.read_job_response.deserialize_json(
...
def read_job(
    ...
    capo_elastic_transcoder.types.read_job_response.ReadJobResponse, zapros.Response
]:
