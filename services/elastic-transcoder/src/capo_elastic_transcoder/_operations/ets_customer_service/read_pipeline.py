"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#ReadPipeline``."""
...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.read_pipeline_response.ReadPipelineResponse = (
        capo_elastic_transcoder.types.read_pipeline_response.deserialize_json(
