"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#CreatePipeline``."""
...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.create_pipeline_response.CreatePipelineResponse = capo_elastic_transcoder.types.create_pipeline_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elastic_transcoder.types.create_pipeline_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
