"""Generated from Smithy shape ``com.amazonaws.elastictranscoder#ListPipelines``."""
...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.list_pipelines_response.ListPipelinesResponse = (
        capo_elastic_transcoder.types.list_pipelines_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2012-09-25/pipelines"
    params: list[tuple[str, str]] = []
    if "ascending" in input_:
        params.append(("Ascending", input_["ascending"]))
    if "page_token" in input_:
        params.append(("PageToken", input_["page_token"]))
