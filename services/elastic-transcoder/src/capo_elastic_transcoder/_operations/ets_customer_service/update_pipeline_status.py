...
def handle_response(
    ...
    out: capo_elastic_transcoder.types.update_pipeline_status_response.UpdatePipelineStatusResponse = capo_elastic_transcoder.types.update_pipeline_status_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elastic_transcoder.types.update_pipeline_status_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
