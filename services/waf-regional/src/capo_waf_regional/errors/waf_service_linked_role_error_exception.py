"""Generated from Smithy shape ``com.amazonaws.wafregional#WAFServiceLinkedRoleErrorException``."""
...
class WAFServiceLinkedRoleErrorException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.wafregional#WAFServiceLinkedRoleErrorException``."""

    code: str | None = "WAFServiceLinkedRoleErrorException"

    def __init__(
        self, data: WAFServiceLinkedRoleErrorException_, message: str | None = None
    ):
        super().__init__(
            "client",
