"""Generated from Smithy shape ``com.amazonaws.wafregional#WAFStaleDataException``."""
...
class WAFStaleDataException_(TypedDict, closed=True):
...
class WAFStaleDataException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.wafregional#WAFStaleDataException``."""

    code: str | None = "WAFStaleDataException"

    def __init__(self, data: WAFStaleDataException_, message: str | None = None):
        super().__init__(
            "client",
