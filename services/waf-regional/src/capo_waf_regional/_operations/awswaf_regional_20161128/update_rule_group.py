"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateRuleGroup``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_rule_group_response.UpdateRuleGroupResponse = (
        capo_waf_regional.types.update_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_rule_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
