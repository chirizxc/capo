...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_permission_policy_response.DeletePermissionPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_permission_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
