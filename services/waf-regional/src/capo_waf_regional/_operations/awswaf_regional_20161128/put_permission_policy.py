"""Generated from Smithy shape ``com.amazonaws.wafregional#PutPermissionPolicy``."""
...
import capo_waf_regional.errors.waf_invalid_permission_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WAFInvalidPermissionPolicyException":
            raise capo_waf_regional.errors.waf_invalid_permission_policy_exception.WAFInvalidPermissionPolicyException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_waf_regional.types.put_permission_policy_response.PutPermissionPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.put_permission_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
