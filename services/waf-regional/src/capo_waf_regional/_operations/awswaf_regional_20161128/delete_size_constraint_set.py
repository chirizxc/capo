"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteSizeConstraintSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_size_constraint_set_response.DeleteSizeConstraintSetResponse = capo_waf_regional.types.delete_size_constraint_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_size_constraint_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_size_constraint_set(
