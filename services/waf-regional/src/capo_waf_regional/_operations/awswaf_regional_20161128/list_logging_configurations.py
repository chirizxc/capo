...
def handle_response(
    ...
    out: capo_waf_regional.types.list_logging_configurations_response.ListLoggingConfigurationsResponse = capo_waf_regional.types.list_logging_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_logging_configurations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
