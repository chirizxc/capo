...
def handle_response(
    ...
    out: capo_waf_regional.types.get_web_acl_response.GetWebACLResponse = (
        capo_waf_regional.types.get_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_web_acl_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_web_acl(
    ...
    capo_waf_regional.types.get_web_acl_response.GetWebACLResponse, zapros.Response
]:
