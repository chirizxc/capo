"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteIPSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_ip_set_response.DeleteIPSetResponse = (
        capo_waf_regional.types.delete_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_ip_set_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_ip_set(
    ...
    capo_waf_regional.types.delete_ip_set_response.DeleteIPSetResponse, zapros.Response
]:
