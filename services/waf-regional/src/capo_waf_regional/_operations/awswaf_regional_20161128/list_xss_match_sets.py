"""Generated from Smithy shape ``com.amazonaws.wafregional#ListXssMatchSets``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_xss_match_sets_response.ListXssMatchSetsResponse = capo_waf_regional.types.list_xss_match_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_xss_match_sets_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
