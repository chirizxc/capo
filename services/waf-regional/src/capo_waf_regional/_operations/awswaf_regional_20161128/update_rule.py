"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateRule``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_rule_response.UpdateRuleResponse = (
        capo_waf_regional.types.update_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_rule_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_rule(
    ...
    capo_waf_regional.types.update_rule_response.UpdateRuleResponse, zapros.Response
]:
