"""Generated from Smithy shape ``com.amazonaws.wafregional#CreateIPSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.create_ip_set_response.CreateIPSetResponse = (
        capo_waf_regional.types.create_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.create_ip_set_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_ip_set(
    ...
    capo_waf_regional.types.create_ip_set_response.CreateIPSetResponse, zapros.Response
]:
