...
def handle_response(
    ...
    out: capo_waf_regional.types.get_rate_based_rule_managed_keys_response.GetRateBasedRuleManagedKeysResponse = capo_waf_regional.types.get_rate_based_rule_managed_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_rate_based_rule_managed_keys_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
