"""Generated from Smithy shape ``com.amazonaws.wafregional#ListWebACLs``."""
...
import capo_waf_regional.types.web_acl_summaries
...
def handle_response(
    ...
    out: capo_waf_regional.types.list_web_ac_ls_response.ListWebACLsResponse = (
        capo_waf_regional.types.list_web_ac_ls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.list_web_ac_ls_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_web_ac_ls(
    ...
    capo_waf_regional.types.list_web_ac_ls_response.ListWebACLsResponse, zapros.Response
]:
