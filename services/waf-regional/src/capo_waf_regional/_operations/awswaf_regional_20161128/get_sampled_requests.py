...
def handle_response(
    ...
    out: capo_waf_regional.types.get_sampled_requests_response.GetSampledRequestsResponse = capo_waf_regional.types.get_sampled_requests_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.get_sampled_requests_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
