"""Generated from Smithy shape ``com.amazonaws.wafregional#UpdateRateBasedRule``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.update_rate_based_rule_response.UpdateRateBasedRuleResponse = capo_waf_regional.types.update_rate_based_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.update_rate_based_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
