"""Generated from Smithy shape ``com.amazonaws.wafregional#CreateWebACL``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.create_web_acl_response.CreateWebACLResponse = (
        capo_waf_regional.types.create_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_waf_regional.types.create_web_acl_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
