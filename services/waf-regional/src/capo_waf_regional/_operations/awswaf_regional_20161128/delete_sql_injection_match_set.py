"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteSqlInjectionMatchSet``."""
...
def handle_response(
    ...
    out: capo_waf_regional.types.delete_sql_injection_match_set_response.DeleteSqlInjectionMatchSetResponse = capo_waf_regional.types.delete_sql_injection_match_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSWAF_Regional_20161128.DeleteSqlInjectionMatchSet"
    body: bytes | None = json.dumps(
        capo_waf_regional.types.delete_sql_injection_match_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
