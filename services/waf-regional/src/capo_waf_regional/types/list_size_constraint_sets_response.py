"""Generated from Smithy shape ``com.amazonaws.wafregional#ListSizeConstraintSetsResponse``."""
...
class ListSizeConstraintSetsResponse(TypedDict, closed=True):
    ...
    size_constraint_sets: NotRequired[
        "capo_waf_regional.types.size_constraint_set_summaries.SizeConstraintSetSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListSizeConstraintSetsResponse) -> dict:
    ...
    if "size_constraint_sets" in value:
        ...
        out["SizeConstraintSets"] = (
            capo_waf_regional.types.size_constraint_set_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListSizeConstraintSetsResponse:
    ...
    if data.get("SizeConstraintSets") is not None:
        import capo_waf_regional.types.size_constraint_set_summaries

        out["size_constraint_sets"] = (
            capo_waf_regional.types.size_constraint_set_summaries.deserialize_aws_json_1_1(
