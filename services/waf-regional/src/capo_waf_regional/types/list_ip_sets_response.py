...
class ListIPSetsResponse(TypedDict, closed=True):
    ...
    ip_sets: NotRequired["capo_waf_regional.types.ip_set_summaries.IPSetSummaries"]
...
def serialize_aws_json_1_1(value: ListIPSetsResponse) -> dict:
    ...
    if "ip_sets" in value:
        ...
        out["IPSets"] = capo_waf_regional.types.ip_set_summaries.serialize_aws_json_1_1(
            value["ip_sets"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListIPSetsResponse:
    ...
    if data.get("IPSets") is not None:
        ...
        out["ip_sets"] = (
            capo_waf_regional.types.ip_set_summaries.deserialize_aws_json_1_1(
                data["IPSets"]
            )
        )
    return out
