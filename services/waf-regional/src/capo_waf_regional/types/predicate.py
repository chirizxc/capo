...
if TYPE_CHECKING:
    import capo_waf_regional.types.negated
...
class Predicate(TypedDict, closed=True):
    negated: "capo_waf_regional.types.negated.Negated"
    ...
    type: "capo_waf_regional.types.predicate_type.PredicateType"
    """<p>The type of predicate in a <code>Rule</code>, such as <code>ByteMatch</code> or <code>IPSet</code>.</p>"""
    data_id: "capo_waf_regional.types.resource_id.ResourceId"
...
def serialize_aws_json_1_1(value: Predicate) -> dict:
    ...
    out["Type"] = capo_waf_regional.types.predicate_type.serialize_aws_json_1_1(
        value["type"]
    )
