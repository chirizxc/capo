...
class ByteMatchSet(TypedDict, closed=True):
    ...
    byte_match_tuples: "capo_waf_regional.types.byte_match_tuples.ByteMatchTuples"
...
def serialize_aws_json_1_1(value: ByteMatchSet) -> dict:
    ...
    out["ByteMatchTuples"] = (
        capo_waf_regional.types.byte_match_tuples.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ByteMatchSet:
    ...
    if data.get("ByteMatchTuples") is not None:
        ...
        out["byte_match_tuples"] = (
            capo_waf_regional.types.byte_match_tuples.deserialize_aws_json_1_1(
