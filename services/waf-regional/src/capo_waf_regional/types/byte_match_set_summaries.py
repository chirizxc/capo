...
if TYPE_CHECKING:
    import capo_waf_regional.types.byte_match_set_summary

ByteMatchSetSummaries: TypeAlias = list[
    "capo_waf_regional.types.byte_match_set_summary.ByteMatchSetSummary"
]
...
def serialize_aws_json_1_1(value: ByteMatchSetSummaries) -> list:
    ...
    for item in value:
        out.append(
            capo_waf_regional.types.byte_match_set_summary.serialize_aws_json_1_1(item)
        )
    return out
