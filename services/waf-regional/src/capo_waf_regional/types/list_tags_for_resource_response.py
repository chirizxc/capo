...
class ListTagsForResourceResponse(TypedDict, closed=True):
    ...
    tag_info_for_resource: NotRequired[
        "capo_waf_regional.types.tag_info_for_resource.TagInfoForResource"
    ]
    """<p></p>"""
...
def serialize_aws_json_1_1(value: ListTagsForResourceResponse) -> dict:
    ...
    if "tag_info_for_resource" in value:
        ...
        out["TagInfoForResource"] = (
            capo_waf_regional.types.tag_info_for_resource.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListTagsForResourceResponse:
    ...
    if data.get("TagInfoForResource") is not None:
        import capo_waf_regional.types.tag_info_for_resource

        out["tag_info_for_resource"] = (
            capo_waf_regional.types.tag_info_for_resource.deserialize_aws_json_1_1(
