"""Generated from Smithy shape ``com.amazonaws.wafregional#ByteMatchTuple``."""
...
class ByteMatchTuple(TypedDict, closed=True):
    ...
    target_string: (
        "capo_waf_regional.types.byte_match_target_string.ByteMatchTargetString"
    )
    ...
    positional_constraint: (
        "capo_waf_regional.types.positional_constraint.PositionalConstraint"
    )
...
def serialize_aws_json_1_1(value: ByteMatchTuple) -> dict:
    ...
    out["TargetString"] = (
        capo_waf_regional.types.byte_match_target_string.serialize_aws_json_1_1(
            value["target_string"]
        )
    )
    import capo_waf_regional.types.text_transformation
    ...
    out["PositionalConstraint"] = (
        capo_waf_regional.types.positional_constraint.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ByteMatchTuple:
    ...
    if data.get("TargetString") is not None:
        ...
        out["target_string"] = (
            capo_waf_regional.types.byte_match_target_string.deserialize_aws_json_1_1(
                data["TargetString"]
            )
        )
    else:
    ...
    if data.get("PositionalConstraint") is not None:
        ...
        out["positional_constraint"] = (
            capo_waf_regional.types.positional_constraint.deserialize_aws_json_1_1(
