"""Generated from Smithy shape ``com.amazonaws.wafregional#DeleteXssMatchSetResponse``."""
...
class DeleteXssMatchSetResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteXssMatchSetResponse) -> dict:
    out: dict = {}
