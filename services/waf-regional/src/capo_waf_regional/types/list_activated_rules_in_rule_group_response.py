...
class ListActivatedRulesInRuleGroupResponse(TypedDict, closed=True):
    ...
    activated_rules: NotRequired[
        "capo_waf_regional.types.activated_rules.ActivatedRules"
    ]
...
def serialize_aws_json_1_1(value: ListActivatedRulesInRuleGroupResponse) -> dict:
    ...
    if "activated_rules" in value:
        ...
        out["ActivatedRules"] = (
            capo_waf_regional.types.activated_rules.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListActivatedRulesInRuleGroupResponse:
    ...
    if data.get("ActivatedRules") is not None:
        ...
        out["activated_rules"] = (
            capo_waf_regional.types.activated_rules.deserialize_aws_json_1_1(
                data["ActivatedRules"]
            )
        )
    return out
