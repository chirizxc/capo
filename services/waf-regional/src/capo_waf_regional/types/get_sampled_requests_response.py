"""Generated from Smithy shape ``com.amazonaws.wafregional#GetSampledRequestsResponse``."""
...
if TYPE_CHECKING:
    import capo_waf_regional.types.population_size
    import capo_waf_regional.types.sampled_http_requests
...
class GetSampledRequestsResponse(TypedDict, closed=True):
    sampled_requests: NotRequired[
        "capo_waf_regional.types.sampled_http_requests.SampledHTTPRequests"
    ]
    """<p>A complex type that contains detailed information about each of the requests in the sample.</p>"""
    population_size: "capo_waf_regional.types.population_size.PopulationSize"
    ...
    time_window: NotRequired["capo_waf_regional.types.time_window.TimeWindow"]
...
def serialize_aws_json_1_1(value: GetSampledRequestsResponse) -> dict:
    ...
    if "sampled_requests" in value:
        ...
        out["SampledRequests"] = (
            capo_waf_regional.types.sampled_http_requests.serialize_aws_json_1_1(
    ...
    if "time_window" in value:
        ...
        out["TimeWindow"] = capo_waf_regional.types.time_window.serialize_aws_json_1_1(
            value["time_window"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetSampledRequestsResponse:
    ...
    if data.get("SampledRequests") is not None:
        ...
        out["sampled_requests"] = (
            capo_waf_regional.types.sampled_http_requests.deserialize_aws_json_1_1(
    ...
    if data.get("TimeWindow") is not None:
        ...
        out["time_window"] = (
            capo_waf_regional.types.time_window.deserialize_aws_json_1_1(
                data["TimeWindow"]
            )
        )
    return out
