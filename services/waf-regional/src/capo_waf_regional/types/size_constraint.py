...
if TYPE_CHECKING:
    import capo_waf_regional.types.comparison_operator
    import capo_waf_regional.types.field_to_match
    import capo_waf_regional.types.size
...
class SizeConstraint(TypedDict, closed=True):
    ...
    comparison_operator: (
        "capo_waf_regional.types.comparison_operator.ComparisonOperator"
    )
    ...
    size: "capo_waf_regional.types.size.Size"
...
def serialize_aws_json_1_1(value: SizeConstraint) -> dict:
    ...
    out["ComparisonOperator"] = (
        capo_waf_regional.types.comparison_operator.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SizeConstraint:
    ...
    if data.get("ComparisonOperator") is not None:
        ...
        out["comparison_operator"] = (
            capo_waf_regional.types.comparison_operator.deserialize_aws_json_1_1(
