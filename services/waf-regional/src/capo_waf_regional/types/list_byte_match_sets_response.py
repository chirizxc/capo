...
class ListByteMatchSetsResponse(TypedDict, closed=True):
    ...
    byte_match_sets: NotRequired[
        "capo_waf_regional.types.byte_match_set_summaries.ByteMatchSetSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListByteMatchSetsResponse) -> dict:
    ...
    if "byte_match_sets" in value:
        ...
        out["ByteMatchSets"] = (
            capo_waf_regional.types.byte_match_set_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListByteMatchSetsResponse:
    ...
    if data.get("ByteMatchSets") is not None:
        ...
        out["byte_match_sets"] = (
            capo_waf_regional.types.byte_match_set_summaries.deserialize_aws_json_1_1(
                data["ByteMatchSets"]
            )
        )
    return out
