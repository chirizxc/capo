...
class ListWebACLsResponse(TypedDict, closed=True):
    ...
    web_ac_ls: NotRequired["capo_waf_regional.types.web_acl_summaries.WebACLSummaries"]
...
def serialize_aws_json_1_1(value: ListWebACLsResponse) -> dict:
    ...
    if "web_ac_ls" in value:
        ...
        out["WebACLs"] = (
            capo_waf_regional.types.web_acl_summaries.serialize_aws_json_1_1(
                value["web_ac_ls"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListWebACLsResponse:
    ...
    if data.get("WebACLs") is not None:
        ...
        out["web_ac_ls"] = (
            capo_waf_regional.types.web_acl_summaries.deserialize_aws_json_1_1(
                data["WebACLs"]
            )
        )
    return out
