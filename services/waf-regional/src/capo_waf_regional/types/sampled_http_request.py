...
if TYPE_CHECKING:
    import capo_waf_regional.types.action
    import capo_waf_regional.types.http_request
    import capo_waf_regional.types.resource_id
    import capo_waf_regional.types.sample_weight
    import capo_waf_regional.types.timestamp


class SampledHTTPRequest(TypedDict, closed=True):
    request: "capo_waf_regional.types.http_request.HTTPRequest"
    """<p>A complex type that contains detailed information about the request.</p>"""
    weight: "capo_waf_regional.types.sample_weight.SampleWeight"
...
def serialize_aws_json_1_1(value: SampledHTTPRequest) -> dict:
    ...
    out["Request"] = capo_waf_regional.types.http_request.serialize_aws_json_1_1(
        value["request"]
    )
    ...
    if "timestamp" in value:
        ...
        out["Timestamp"] = capo_waf_regional.types.timestamp.serialize_aws_json_1_1(
            value["timestamp"]
        )
    if "action" in value:
