...
class AsyncEBSClient:
    ...
    async def complete_snapshot(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ebs.types.complete_snapshot_request.CompleteSnapshotRequest]",
        ) -> AsyncOperationResponse[
            "capo_ebs.types.complete_snapshot_response.CompleteSnapshotResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ebs._operations.ebs.complete_snapshot.async_complete_snapshot(
    ...
    async def get_snapshot_block(
        ...
        *,
        config_overrides: Optional[AsyncEBSClientConfig] = None,
    ) -> "AsyncGenerator[capo_ebs.types.get_snapshot_block_response.GetSnapshotBlockResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ebs.types.get_snapshot_block_request.GetSnapshotBlockRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_ebs._operations.ebs.get_snapshot_block.async_get_snapshot_block(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_changed_blocks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ebs.types.list_changed_blocks_request.ListChangedBlocksRequest]",
        ) -> AsyncOperationResponse[
            "capo_ebs.types.list_changed_blocks_response.ListChangedBlocksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ebs._operations.ebs.list_changed_blocks.async_list_changed_blocks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_snapshot_blocks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ebs.types.list_snapshot_blocks_request.ListSnapshotBlocksRequest]",
        ) -> AsyncOperationResponse[
            "capo_ebs.types.list_snapshot_blocks_response.ListSnapshotBlocksResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ebs._operations.ebs.list_snapshot_blocks.async_list_snapshot_blocks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_snapshot_block(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ebs.types.put_snapshot_block_request.PutSnapshotBlockRequest]",
        ) -> AsyncOperationResponse[
            "capo_ebs.types.put_snapshot_block_response.PutSnapshotBlockResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ebs._operations.ebs.put_snapshot_block.async_put_snapshot_block(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_snapshot(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ebs.types.start_snapshot_request.StartSnapshotRequest]",
        ) -> AsyncOperationResponse[
            "capo_ebs.types.start_snapshot_response.StartSnapshotResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ebs._operations.ebs.start_snapshot.async_start_snapshot(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
