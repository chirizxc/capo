"""Generated from Smithy shape ``com.amazonaws.ebs#GetSnapshotBlock``."""
...
def get_snapshot_block(
    ...
    capo_ebs.types.get_snapshot_block_response.GetSnapshotBlockResponse, zapros.Response
]:
...
async def async_get_snapshot_block(
