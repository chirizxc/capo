...
def handle_response(
    ...
    out: capo_ebs.types.complete_snapshot_response.CompleteSnapshotResponse = (
        capo_ebs.types.complete_snapshot_response.deserialize_json(
...
def build_request(
    ...
    if "checksum_aggregation_method" in input_:
        headers["x-amz-Checksum-Aggregation-Method"] = (
            capo_ebs.types.checksum_aggregation_method.serialize_json(
...
def complete_snapshot(
    ...
    capo_ebs.types.complete_snapshot_response.CompleteSnapshotResponse, zapros.Response
]:
