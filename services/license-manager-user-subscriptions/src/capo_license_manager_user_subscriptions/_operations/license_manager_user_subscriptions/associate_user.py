...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.associate_user_response.AssociateUserResponse = capo_license_manager_user_subscriptions.types.associate_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.associate_user_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
