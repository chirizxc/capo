"""Generated from Smithy shape ``com.amazonaws.licensemanagerusersubscriptions#StopProductSubscription``."""
...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.stop_product_subscription_response.StopProductSubscriptionResponse = capo_license_manager_user_subscriptions.types.stop_product_subscription_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.stop_product_subscription_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_product_subscription(
