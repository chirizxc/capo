...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.tag_resource_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
