...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.list_user_associations_response.ListUserAssociationsResponse = capo_license_manager_user_subscriptions.types.list_user_associations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.list_user_associations_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
