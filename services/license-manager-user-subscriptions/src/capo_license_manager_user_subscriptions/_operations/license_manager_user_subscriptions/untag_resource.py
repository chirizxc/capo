"""Generated from Smithy shape ``com.amazonaws.licensemanagerusersubscriptions#UntagResource``."""
...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
