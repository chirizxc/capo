"""Generated from Smithy shape ``com.amazonaws.licensemanagerusersubscriptions#DeleteLicenseServerEndpoint``."""
...
def handle_response(
    ...
    out: capo_license_manager_user_subscriptions.types.delete_license_server_endpoint_response.DeleteLicenseServerEndpointResponse = capo_license_manager_user_subscriptions.types.delete_license_server_endpoint_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/license-server/DeleteLicenseServerEndpoint"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_license_manager_user_subscriptions.types.delete_license_server_endpoint_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_license_server_endpoint(
