...
class ListLicenseServerEndpointsResponse(TypedDict, closed=True):
    license_server_endpoints: NotRequired[
        "capo_license_manager_user_subscriptions.types.license_server_endpoint_list.LicenseServerEndpointList"
    ]
...
def serialize_json(value: ListLicenseServerEndpointsResponse) -> dict:
    ...
    if "license_server_endpoints" in value:
        ...
        out["LicenseServerEndpoints"] = (
            capo_license_manager_user_subscriptions.types.license_server_endpoint_list.serialize_json(
...
def deserialize_json(data: dict) -> ListLicenseServerEndpointsResponse:
    ...
    if data.get("LicenseServerEndpoints") is not None:
        import capo_license_manager_user_subscriptions.types.license_server_endpoint_list

        out["license_server_endpoints"] = (
            capo_license_manager_user_subscriptions.types.license_server_endpoint_list.deserialize_json(
