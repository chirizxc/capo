...
from capo_license_manager_user_subscriptions._services._aws_config import aws_config
...
class LicenseManagerUserSubscriptionsClient:
    ...
    def associate_user(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.associate_user_request.AssociateUserRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.associate_user_response.AssociateUserResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.associate_user.associate_user(
    ...
    def create_license_server_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.create_license_server_endpoint_request.CreateLicenseServerEndpointRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.create_license_server_endpoint_response.CreateLicenseServerEndpointResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.create_license_server_endpoint.create_license_server_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_license_server_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.delete_license_server_endpoint_request.DeleteLicenseServerEndpointRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.delete_license_server_endpoint_response.DeleteLicenseServerEndpointResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.delete_license_server_endpoint.delete_license_server_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_identity_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.deregister_identity_provider_request.DeregisterIdentityProviderRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.deregister_identity_provider_response.DeregisterIdentityProviderResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.deregister_identity_provider.deregister_identity_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_user(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.disassociate_user_request.DisassociateUserRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.disassociate_user_response.DisassociateUserResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.disassociate_user.disassociate_user(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_identity_providers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.list_identity_providers_request.ListIdentityProvidersRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.list_identity_providers_response.ListIdentityProvidersResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_identity_providers.list_identity_providers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_identity_providers(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_license_manager_user_subscriptions.types.identity_provider_summary.IdentityProviderSummary]":
        _token = next_token
        while True:
    ...
    def list_instances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.list_instances_request.ListInstancesRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.list_instances_response.ListInstancesResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_instances.list_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_license_manager_user_subscriptions.types.instance_summary.InstanceSummary]":
        _token = next_token
        while True:
    ...
    def list_license_server_endpoints(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.list_license_server_endpoints_request.ListLicenseServerEndpointsRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.list_license_server_endpoints_response.ListLicenseServerEndpointsResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_license_server_endpoints.list_license_server_endpoints(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_license_server_endpoints(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_license_manager_user_subscriptions.types.license_server_endpoint.LicenseServerEndpoint]":
        _token = next_token
        while True:
    ...
    def list_product_subscriptions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.list_product_subscriptions_request.ListProductSubscriptionsRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.list_product_subscriptions_response.ListProductSubscriptionsResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_product_subscriptions.list_product_subscriptions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_product_subscriptions(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_license_manager_user_subscriptions.types.product_user_summary.ProductUserSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_user_associations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.list_user_associations_request.ListUserAssociationsRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.list_user_associations_response.ListUserAssociationsResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.list_user_associations.list_user_associations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_user_associations(
        ...
        *,
        ...
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_license_manager_user_subscriptions.types.instance_user_summary.InstanceUserSummary]":
        _token = next_token
        while True:
    ...
    def register_identity_provider(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.register_identity_provider_request.RegisterIdentityProviderRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.register_identity_provider_response.RegisterIdentityProviderResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.register_identity_provider.register_identity_provider(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_product_subscription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.start_product_subscription_request.StartProductSubscriptionRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.start_product_subscription_response.StartProductSubscriptionResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.start_product_subscription.start_product_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_product_subscription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.stop_product_subscription_request.StopProductSubscriptionRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.stop_product_subscription_response.StopProductSubscriptionResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.stop_product_subscription.stop_product_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_identity_provider_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_license_manager_user_subscriptions.types.update_identity_provider_settings_request.UpdateIdentityProviderSettingsRequest]",
        ) -> OperationResponse[
            "capo_license_manager_user_subscriptions.types.update_identity_provider_settings_response.UpdateIdentityProviderSettingsResponse"
        ]:
            ...
            output, http_response = (
                capo_license_manager_user_subscriptions._operations.license_manager_user_subscriptions.update_identity_provider_settings.update_identity_provider_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
