"""Generated from Smithy shape ``com.amazonaws.licensemanager#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.licensemanager#ResourceNotFoundException``."""
