...
class ListLicenseAssetRulesetsResponse(TypedDict, closed=True):
    license_asset_rulesets: NotRequired[
        "capo_license_manager.types.license_asset_ruleset_list.LicenseAssetRulesetList"
    ]
...
def serialize_aws_json_1_1(value: ListLicenseAssetRulesetsResponse) -> dict:
    ...
    if "license_asset_rulesets" in value:
        ...
        out["LicenseAssetRulesets"] = (
            capo_license_manager.types.license_asset_ruleset_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListLicenseAssetRulesetsResponse:
    ...
    if data.get("LicenseAssetRulesets") is not None:
        import capo_license_manager.types.license_asset_ruleset_list

        out["license_asset_rulesets"] = (
            capo_license_manager.types.license_asset_ruleset_list.deserialize_aws_json_1_1(
