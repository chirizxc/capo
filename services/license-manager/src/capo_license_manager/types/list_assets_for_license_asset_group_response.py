...
class ListAssetsForLicenseAssetGroupResponse(TypedDict, closed=True):
    assets: NotRequired["capo_license_manager.types.asset_list.AssetList"]
    """<p>Assets.</p>"""
...
def serialize_aws_json_1_1(value: ListAssetsForLicenseAssetGroupResponse) -> dict:
    ...
    if "assets" in value:
        ...
        out["Assets"] = capo_license_manager.types.asset_list.serialize_aws_json_1_1(
            value["assets"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListAssetsForLicenseAssetGroupResponse:
    ...
    if data.get("Assets") is not None:
        ...
        out["assets"] = capo_license_manager.types.asset_list.deserialize_aws_json_1_1(
            data["Assets"]
        )
