...
class LicenseUsage(TypedDict, closed=True):
    entitlement_usages: NotRequired[
        "capo_license_manager.types.entitlement_usage_list.EntitlementUsageList"
    ]
...
def serialize_aws_json_1_1(value: LicenseUsage) -> dict:
    ...
    if "entitlement_usages" in value:
        ...
        out["EntitlementUsages"] = (
            capo_license_manager.types.entitlement_usage_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LicenseUsage:
    ...
    if data.get("EntitlementUsages") is not None:
        ...
        out["entitlement_usages"] = (
            capo_license_manager.types.entitlement_usage_list.deserialize_aws_json_1_1(
