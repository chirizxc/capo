"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicensesRequest``."""
...
class ListLicensesRequest(TypedDict, closed=True):
    ...
    """<p>Filters to scope the results. The following filters are supported:</p> <ul> <li> <p> <code>Beneficiary</code> </p> </li> <li> <p> <code>ProductSKU</code> </p> </li> <li> <p> <code>Fingerprint</code> </p> </li> <li> <p> <code>Status</code> </p> </li> </ul>"""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListLicensesRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListLicensesRequest:
    out: ListLicensesRequest = {}  # type: ignore[typeddict-item]
