...
class ServiceStatus(TypedDict, closed=True):
    cross_account_discovery: NotRequired[
        "capo_license_manager.types.cross_account_discovery_service_status.CrossAccountDiscoveryServiceStatus"
    ]
    """<p>Status of cross-account discovery service.</p>"""
    cross_region_discovery: NotRequired[
        "capo_license_manager.types.cross_region_discovery_status.CrossRegionDiscoveryStatus"
    ]
...
def serialize_aws_json_1_1(value: ServiceStatus) -> dict:
    ...
    if "cross_account_discovery" in value:
        ...
        out["CrossAccountDiscovery"] = (
            capo_license_manager.types.cross_account_discovery_service_status.serialize_aws_json_1_1(
    ...
    if "cross_region_discovery" in value:
        ...
        out["CrossRegionDiscovery"] = (
            capo_license_manager.types.cross_region_discovery_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ServiceStatus:
    ...
    if data.get("CrossAccountDiscovery") is not None:
        ...
        out["cross_account_discovery"] = (
            capo_license_manager.types.cross_account_discovery_service_status.deserialize_aws_json_1_1(
    ...
    if data.get("CrossRegionDiscovery") is not None:
        ...
        out["cross_region_discovery"] = (
            capo_license_manager.types.cross_region_discovery_status.deserialize_aws_json_1_1(
