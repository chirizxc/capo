...
class ListLicenseManagerReportGeneratorsResponse(TypedDict, closed=True):
    report_generators: NotRequired[
        "capo_license_manager.types.report_generator_list.ReportGeneratorList"
    ]
...
def serialize_aws_json_1_1(value: ListLicenseManagerReportGeneratorsResponse) -> dict:
    ...
    if "report_generators" in value:
        ...
        out["ReportGenerators"] = (
            capo_license_manager.types.report_generator_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListLicenseManagerReportGeneratorsResponse:
    ...
    if data.get("ReportGenerators") is not None:
        import capo_license_manager.types.report_generator_list

        out["report_generators"] = (
            capo_license_manager.types.report_generator_list.deserialize_aws_json_1_1(
