...
class ResourceInventory(TypedDict, closed=True):
    resource_id: NotRequired["capo_license_manager.types.string.String"]
    ...
    platform: NotRequired["capo_license_manager.types.string.String"]
    """<p>Platform of the resource.</p>"""
    platform_version: NotRequired["capo_license_manager.types.string.String"]
    """<p>Platform version of the resource in the inventory.</p>"""
    resource_owning_account_id: NotRequired["capo_license_manager.types.string.String"]
    ...
    usage_operation: NotRequired["capo_license_manager.types.string.String"]
    """<p>Usage operation value that corresponds to the license type for billing purposes.</p>"""
    ami_id: NotRequired["capo_license_manager.types.string.String"]
    """<p>Amazon Machine Image (AMI) ID associated with the resource.</p>"""
    host_id: NotRequired["capo_license_manager.types.string.String"]
    """<p>Dedicated Host ID where the resource is running.</p>"""
    region: NotRequired["capo_license_manager.types.string.String"]
    """<p>Region where the resource is located.</p>"""
    instance_type: NotRequired["capo_license_manager.types.string.String"]
