"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListReceivedLicensesForOrganization``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.list_received_licenses_for_organization_response.ListReceivedLicensesForOrganizationResponse = capo_license_manager.types.list_received_licenses_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListReceivedLicensesForOrganization"
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_received_licenses_for_organization_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_received_licenses_for_organization(
