...
def handle_response(
    ...
    out: capo_license_manager.types.list_distributed_grants_response.ListDistributedGrantsResponse = capo_license_manager.types.list_distributed_grants_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_distributed_grants_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
