"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseManagerReportGenerators``."""
...
import capo_license_manager.types.report_generator_list
...
def handle_response(
    ...
    out: capo_license_manager.types.list_license_manager_report_generators_response.ListLicenseManagerReportGeneratorsResponse = capo_license_manager.types.list_license_manager_report_generators_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_license_manager_report_generators_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_license_manager_report_generators(
