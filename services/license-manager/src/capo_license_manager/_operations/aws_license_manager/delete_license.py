...
def handle_response(
    ...
    out: capo_license_manager.types.delete_license_response.DeleteLicenseResponse = (
        capo_license_manager.types.delete_license_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.delete_license_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
