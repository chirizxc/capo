"""Generated from Smithy shape ``com.amazonaws.licensemanager#CreateLicense``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.create_license_response.CreateLicenseResponse = (
        capo_license_manager.types.create_license_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.CreateLicense"
    body: bytes | None = json.dumps(
        capo_license_manager.types.create_license_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_license(
