"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListResourceInventory``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FailedDependencyException":
            raise capo_license_manager.errors.failed_dependency_exception.FailedDependencyException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_license_manager.types.list_resource_inventory_response.ListResourceInventoryResponse = capo_license_manager.types.list_resource_inventory_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_license_manager._auth._sigv4.build_sigv4_auth_scheme(
                "license-manager", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_resource_inventory_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_resource_inventory(
