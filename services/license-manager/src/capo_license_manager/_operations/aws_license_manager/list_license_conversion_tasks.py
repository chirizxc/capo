"""Generated from Smithy shape ``com.amazonaws.licensemanager#ListLicenseConversionTasks``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.list_license_conversion_tasks_response.ListLicenseConversionTasksResponse = capo_license_manager.types.list_license_conversion_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.ListLicenseConversionTasks"
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_license_conversion_tasks_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_license_conversion_tasks(
