"""Generated from Smithy shape ``com.amazonaws.licensemanager#RejectGrant``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.reject_grant_response.RejectGrantResponse = (
        capo_license_manager.types.reject_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.RejectGrant"
    body: bytes | None = json.dumps(
        capo_license_manager.types.reject_grant_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
