...
def handle_response(
    ...
    out: capo_license_manager.types.list_license_configurations_for_organization_response.ListLicenseConfigurationsForOrganizationResponse = capo_license_manager.types.list_license_configurations_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_license_configurations_for_organization_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
