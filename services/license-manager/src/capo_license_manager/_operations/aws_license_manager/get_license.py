...
def handle_response(
    ...
    out: capo_license_manager.types.get_license_response.GetLicenseResponse = (
        capo_license_manager.types.get_license_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.get_license_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_license(
    ...
    capo_license_manager.types.get_license_response.GetLicenseResponse, zapros.Response
]:
