...
import capo_license_manager.types.license_asset_ruleset_list
...
def handle_response(
    ...
    out: capo_license_manager.types.list_license_asset_rulesets_response.ListLicenseAssetRulesetsResponse = capo_license_manager.types.list_license_asset_rulesets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_license_asset_rulesets_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
