"""Generated from Smithy shape ``com.amazonaws.licensemanager#DeleteLicenseConfiguration``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.delete_license_configuration_response.DeleteLicenseConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.delete_license_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_license_configuration(
