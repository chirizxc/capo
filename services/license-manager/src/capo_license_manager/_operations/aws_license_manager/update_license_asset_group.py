...
def handle_response(
    ...
    out: capo_license_manager.types.update_license_asset_group_response.UpdateLicenseAssetGroupResponse = capo_license_manager.types.update_license_asset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.update_license_asset_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
