"""Generated from Smithy shape ``com.amazonaws.licensemanager#GetLicenseConfiguration``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.get_license_configuration_response.GetLicenseConfigurationResponse = capo_license_manager.types.get_license_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.get_license_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_license_configuration(
