"""Generated from Smithy shape ``com.amazonaws.licensemanager#DeleteGrant``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.delete_grant_response.DeleteGrantResponse = (
        capo_license_manager.types.delete_grant_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.DeleteGrant"
    body: bytes | None = json.dumps(
        capo_license_manager.types.delete_grant_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
