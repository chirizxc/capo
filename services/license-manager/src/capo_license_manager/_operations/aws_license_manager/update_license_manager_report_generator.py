"""Generated from Smithy shape ``com.amazonaws.licensemanager#UpdateLicenseManagerReportGenerator``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.update_license_manager_report_generator_response.UpdateLicenseManagerReportGeneratorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.UpdateLicenseManagerReportGenerator"
    body: bytes | None = json.dumps(
        capo_license_manager.types.update_license_manager_report_generator_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_license_manager_report_generator(
