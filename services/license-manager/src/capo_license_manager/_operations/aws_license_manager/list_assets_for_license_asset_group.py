...
import capo_license_manager.types.asset_list
...
def handle_response(
    ...
    out: capo_license_manager.types.list_assets_for_license_asset_group_response.ListAssetsForLicenseAssetGroupResponse = capo_license_manager.types.list_assets_for_license_asset_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_license_manager.types.list_assets_for_license_asset_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
