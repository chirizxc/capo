"""Generated from Smithy shape ``com.amazonaws.licensemanager#GetLicenseManagerReportGenerator``."""
...
def handle_response(
    ...
    out: capo_license_manager.types.get_license_manager_report_generator_response.GetLicenseManagerReportGeneratorResponse = capo_license_manager.types.get_license_manager_report_generator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSLicenseManager.GetLicenseManagerReportGenerator"
    body: bytes | None = json.dumps(
        capo_license_manager.types.get_license_manager_report_generator_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_license_manager_report_generator(
