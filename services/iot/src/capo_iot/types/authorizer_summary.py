"""Generated from Smithy shape ``com.amazonaws.iot#AuthorizerSummary``."""
...
class AuthorizerSummary(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AuthorizerSummary) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> AuthorizerSummary:
    out: AuthorizerSummary = {}  # type: ignore[typeddict-item]
