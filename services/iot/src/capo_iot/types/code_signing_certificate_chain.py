...
if TYPE_CHECKING:
    import capo_iot.types.certificate_name
    import capo_iot.types.inline_document


class CodeSigningCertificateChain(TypedDict, closed=True):
    certificate_name: NotRequired["capo_iot.types.certificate_name.CertificateName"]
    """<p>The name of the certificate.</p>"""
    inline_document: NotRequired["capo_iot.types.inline_document.InlineDocument"]
