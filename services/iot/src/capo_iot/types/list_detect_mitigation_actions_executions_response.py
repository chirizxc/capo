...
class ListDetectMitigationActionsExecutionsResponse(TypedDict, closed=True):
    actions_executions: NotRequired[
        "capo_iot.types.detect_mitigation_action_execution_list.DetectMitigationActionExecutionList"
    ]
...
def serialize_json(value: ListDetectMitigationActionsExecutionsResponse) -> dict:
    ...
    if "actions_executions" in value:
        ...
        out["actionsExecutions"] = (
            capo_iot.types.detect_mitigation_action_execution_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDetectMitigationActionsExecutionsResponse:
    ...
    if data.get("actionsExecutions") is not None:
        import capo_iot.types.detect_mitigation_action_execution_list

        out["actions_executions"] = (
            capo_iot.types.detect_mitigation_action_execution_list.deserialize_json(
