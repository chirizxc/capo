...
class MitigationActionParams(TypedDict, closed=True):
    update_device_certificate_params: NotRequired[
        "capo_iot.types.update_device_certificate_params.UpdateDeviceCertificateParams"
    ]
    """<p>Parameters to define a mitigation action that changes the state of the device certificate to inactive.</p>"""
    update_ca_certificate_params: NotRequired[
        "capo_iot.types.update_ca_certificate_params.UpdateCACertificateParams"
    ]
    """<p>Parameters to define a mitigation action that changes the state of the CA certificate to inactive.</p>"""
    add_things_to_thing_group_params: NotRequired[
        "capo_iot.types.add_things_to_thing_group_params.AddThingsToThingGroupParams"
    ]
    ...
    replace_default_policy_version_params: NotRequired[
        "capo_iot.types.replace_default_policy_version_params.ReplaceDefaultPolicyVersionParams"
    ]
    """<p>Parameters to define a mitigation action that adds a blank policy to restrict permissions.</p>"""
    enable_io_t_logging_params: NotRequired[
        "capo_iot.types.enable_io_t_logging_params.EnableIoTLoggingParams"
    ]
    ...
    publish_finding_to_sns_params: NotRequired[
        "capo_iot.types.publish_finding_to_sns_params.PublishFindingToSnsParams"
    ]
...
def serialize_json(value: MitigationActionParams) -> dict:
    ...
    if "update_device_certificate_params" in value:
        ...
        out["updateDeviceCertificateParams"] = (
            capo_iot.types.update_device_certificate_params.serialize_json(
    ...
    if "update_ca_certificate_params" in value:
        ...
        out["updateCACertificateParams"] = (
            capo_iot.types.update_ca_certificate_params.serialize_json(
    ...
    if "add_things_to_thing_group_params" in value:
        ...
        out["addThingsToThingGroupParams"] = (
            capo_iot.types.add_things_to_thing_group_params.serialize_json(
    ...
    if "replace_default_policy_version_params" in value:
        ...
        out["replaceDefaultPolicyVersionParams"] = (
            capo_iot.types.replace_default_policy_version_params.serialize_json(
    ...
    if "enable_io_t_logging_params" in value:
        ...
        out["enableIoTLoggingParams"] = (
            capo_iot.types.enable_io_t_logging_params.serialize_json(
    ...
    if "publish_finding_to_sns_params" in value:
        ...
        out["publishFindingToSnsParams"] = (
            capo_iot.types.publish_finding_to_sns_params.serialize_json(
...
def deserialize_json(data: dict) -> MitigationActionParams:
    ...
    if data.get("updateDeviceCertificateParams") is not None:
        ...
        out["update_device_certificate_params"] = (
            capo_iot.types.update_device_certificate_params.deserialize_json(
    ...
    if data.get("updateCACertificateParams") is not None:
        ...
        out["update_ca_certificate_params"] = (
            capo_iot.types.update_ca_certificate_params.deserialize_json(
    ...
    if data.get("addThingsToThingGroupParams") is not None:
        ...
        out["add_things_to_thing_group_params"] = (
            capo_iot.types.add_things_to_thing_group_params.deserialize_json(
    ...
    if data.get("replaceDefaultPolicyVersionParams") is not None:
        ...
        out["replace_default_policy_version_params"] = (
            capo_iot.types.replace_default_policy_version_params.deserialize_json(
    ...
    if data.get("enableIoTLoggingParams") is not None:
        ...
        out["enable_io_t_logging_params"] = (
            capo_iot.types.enable_io_t_logging_params.deserialize_json(
    ...
    if data.get("publishFindingToSnsParams") is not None:
        ...
        out["publish_finding_to_sns_params"] = (
            capo_iot.types.publish_finding_to_sns_params.deserialize_json(
