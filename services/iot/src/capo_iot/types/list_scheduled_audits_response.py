...
class ListScheduledAuditsResponse(TypedDict, closed=True):
    scheduled_audits: NotRequired[
        "capo_iot.types.scheduled_audit_metadata_list.ScheduledAuditMetadataList"
    ]
...
def serialize_json(value: ListScheduledAuditsResponse) -> dict:
    ...
    if "scheduled_audits" in value:
        ...
        out["scheduledAudits"] = (
            capo_iot.types.scheduled_audit_metadata_list.serialize_json(
...
def deserialize_json(data: dict) -> ListScheduledAuditsResponse:
    ...
    if data.get("scheduledAudits") is not None:
        import capo_iot.types.scheduled_audit_metadata_list

        out["scheduled_audits"] = (
            capo_iot.types.scheduled_audit_metadata_list.deserialize_json(
