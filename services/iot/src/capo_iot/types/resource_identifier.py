...
if TYPE_CHECKING:
    ...
    import capo_iot.types.role_alias_arn
    import capo_iot.types.role_arn


class ResourceIdentifier(TypedDict, closed=True):
    device_certificate_id: NotRequired["capo_iot.types.certificate_id.CertificateId"]
    ...
    account: NotRequired["capo_iot.types.aws_account_id.AwsAccountId"]
    """<p>The account with which the resource is associated.</p>"""
    iam_role_arn: NotRequired["capo_iot.types.role_arn.RoleArn"]
    """<p>The ARN of the IAM role that has overly permissive actions.</p>"""
    role_alias_arn: NotRequired["capo_iot.types.role_alias_arn.RoleAliasArn"]
    """<p>The ARN of the role alias that has overly permissive actions.</p>"""
    issuer_certificate_identifier: NotRequired[
        "capo_iot.types.issuer_certificate_identifier.IssuerCertificateIdentifier"
    ]
    """<p>The issuer certificate identifier.</p>"""
    device_certificate_arn: NotRequired["capo_iot.types.certificate_arn.CertificateArn"]
...
def serialize_json(value: ResourceIdentifier) -> dict:
    ...
    if "policy_version_identifier" in value:
        ...
        out["policyVersionIdentifier"] = (
            capo_iot.types.policy_version_identifier.serialize_json(
    ...
    if "issuer_certificate_identifier" in value:
        ...
        out["issuerCertificateIdentifier"] = (
            capo_iot.types.issuer_certificate_identifier.serialize_json(
...
def deserialize_json(data: dict) -> ResourceIdentifier:
    ...
    if data.get("policyVersionIdentifier") is not None:
        ...
        out["policy_version_identifier"] = (
            capo_iot.types.policy_version_identifier.deserialize_json(
    ...
    if data.get("issuerCertificateIdentifier") is not None:
        ...
        out["issuer_certificate_identifier"] = (
            capo_iot.types.issuer_certificate_identifier.deserialize_json(
