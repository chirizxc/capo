...
class DescribeManagedJobTemplateResponse(TypedDict, closed=True):
    ...
    document_parameters: NotRequired[
        "capo_iot.types.document_parameters.DocumentParameters"
    ]
...
def serialize_json(value: DescribeManagedJobTemplateResponse) -> dict:
    ...
    if "document_parameters" in value:
        ...
        out["documentParameters"] = capo_iot.types.document_parameters.serialize_json(
...
def deserialize_json(data: dict) -> DescribeManagedJobTemplateResponse:
    ...
    if data.get("documentParameters") is not None:
        ...
        out["document_parameters"] = (
            capo_iot.types.document_parameters.deserialize_json(
