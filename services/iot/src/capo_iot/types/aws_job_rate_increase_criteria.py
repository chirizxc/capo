...
if TYPE_CHECKING:
    import capo_iot.types.aws_job_rate_increase_criteria_number_of_things


class AwsJobRateIncreaseCriteria(TypedDict, closed=True):
    number_of_notified_things: NotRequired[
        "capo_iot.types.aws_job_rate_increase_criteria_number_of_things.AwsJobRateIncreaseCriteriaNumberOfThings"
    ]
