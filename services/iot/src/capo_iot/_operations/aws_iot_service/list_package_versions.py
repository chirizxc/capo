"""Generated from Smithy shape ``com.amazonaws.iot#ListPackageVersions``."""
...
import capo_iot.types.list_package_versions_request
import capo_iot.types.list_package_versions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_package_versions_response.ListPackageVersionsResponse = (
        capo_iot.types.list_package_versions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/packages/{packageName}/versions"
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_iot.types.package_version_status.serialize_json(input_["status"]),
            )
        )
