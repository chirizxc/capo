...
import capo_iot.types.update_ca_certificate_request
...
def build_request(
    ...
    if "new_status" in input_:
        params.append(
            (
                "newStatus",
                capo_iot.types.ca_certificate_status.serialize_json(
                    input_["new_status"]
                ),
            )
        )
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_ca_certificate_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
