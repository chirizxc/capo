...
import capo_iot.types.list_principal_things_request
import capo_iot.types.list_principal_things_response
...
def handle_response(
    ...
    out: capo_iot.types.list_principal_things_response.ListPrincipalThingsResponse = (
        capo_iot.types.list_principal_things_response.deserialize_json(
