"""Generated from Smithy shape ``com.amazonaws.iot#DescribeCertificate``."""
...
import capo_iot.types.describe_certificate_request
import capo_iot.types.describe_certificate_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_certificate_response.DescribeCertificateResponse = (
        capo_iot.types.describe_certificate_response.deserialize_json(
