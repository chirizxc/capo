"""Generated from Smithy shape ``com.amazonaws.iot#UpdateDynamicThingGroup``."""
...
import capo_iot.types.update_dynamic_thing_group_request
import capo_iot.types.update_dynamic_thing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.update_dynamic_thing_group_response.UpdateDynamicThingGroupResponse = capo_iot.types.update_dynamic_thing_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_dynamic_thing_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_dynamic_thing_group(
