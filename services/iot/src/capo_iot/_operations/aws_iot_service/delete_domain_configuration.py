...
import capo_iot.types.delete_domain_configuration_request
import capo_iot.types.delete_domain_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_domain_configuration_response.DeleteDomainConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
