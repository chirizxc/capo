...
import capo_iot.types.attach_security_profile_request
import capo_iot.types.attach_security_profile_response
...
def handle_response(
    ...
    out: capo_iot.types.attach_security_profile_response.AttachSecurityProfileResponse = {}  # type: ignore[typeddict-item]
    return out
