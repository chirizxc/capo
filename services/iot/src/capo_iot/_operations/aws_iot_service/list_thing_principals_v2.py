"""Generated from Smithy shape ``com.amazonaws.iot#ListThingPrincipalsV2``."""
...
import capo_iot.types.list_thing_principals_v2_request
import capo_iot.types.list_thing_principals_v2_response
...
def handle_response(
    ...
    out: capo_iot.types.list_thing_principals_v2_response.ListThingPrincipalsV2Response = capo_iot.types.list_thing_principals_v2_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/things/{thingName}/principals-v2"
...
async def async_list_thing_principals_v2(
