...
import capo_iot.types.list_attached_policies_request
import capo_iot.types.list_attached_policies_response
...
def handle_response(
    ...
    out: capo_iot.types.list_attached_policies_response.ListAttachedPoliciesResponse = (
        capo_iot.types.list_attached_policies_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{target}", quote(input_["target"], safe=""))
