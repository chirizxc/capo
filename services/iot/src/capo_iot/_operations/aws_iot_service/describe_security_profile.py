"""Generated from Smithy shape ``com.amazonaws.iot#DescribeSecurityProfile``."""
...
import capo_iot.types.describe_security_profile_request
import capo_iot.types.describe_security_profile_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_security_profile_response.DescribeSecurityProfileResponse = capo_iot.types.describe_security_profile_response.deserialize_json(
