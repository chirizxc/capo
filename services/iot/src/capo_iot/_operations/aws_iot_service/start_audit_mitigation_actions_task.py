...
import capo_iot.types.start_audit_mitigation_actions_task_request
import capo_iot.types.start_audit_mitigation_actions_task_response
...
def handle_response(
    ...
    out: capo_iot.types.start_audit_mitigation_actions_task_response.StartAuditMitigationActionsTaskResponse = capo_iot.types.start_audit_mitigation_actions_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.start_audit_mitigation_actions_task_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
