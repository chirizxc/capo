...
import capo_iot.types.list_thing_registration_task_reports_request
import capo_iot.types.list_thing_registration_task_reports_response
...
) -> capo_iot.types.list_thing_registration_task_reports_response.ListThingRegistrationTaskReportsResponse:
    out: capo_iot.types.list_thing_registration_task_reports_response.ListThingRegistrationTaskReportsResponse = capo_iot.types.list_thing_registration_task_reports_response.deserialize_json(
...
def build_request(
    ...
    if "report_type" in input_:
        params.append(
            (
                "reportType",
                capo_iot.types.report_type.serialize_json(input_["report_type"]),
            )
        )
