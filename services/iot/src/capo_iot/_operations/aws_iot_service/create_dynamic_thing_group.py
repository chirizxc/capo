...
import capo_iot.types.create_dynamic_thing_group_request
import capo_iot.types.create_dynamic_thing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.create_dynamic_thing_group_response.CreateDynamicThingGroupResponse = capo_iot.types.create_dynamic_thing_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_dynamic_thing_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
