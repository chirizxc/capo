...
import capo_iot.types.describe_certificate_provider_request
import capo_iot.types.describe_certificate_provider_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_certificate_provider_response.DescribeCertificateProviderResponse = capo_iot.types.describe_certificate_provider_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{certificateProviderName}", quote(input_["certificate_provider_name"], safe="")
    )
