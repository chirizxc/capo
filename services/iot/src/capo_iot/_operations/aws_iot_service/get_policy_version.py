"""Generated from Smithy shape ``com.amazonaws.iot#GetPolicyVersion``."""
...
import capo_iot.types.get_policy_version_request
import capo_iot.types.get_policy_version_response
...
def handle_response(
    ...
    out: capo_iot.types.get_policy_version_response.GetPolicyVersionResponse = (
        capo_iot.types.get_policy_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{policyVersionId}", quote(input_["policy_version_id"], safe=""))
...
def get_policy_version(
    ...
    capo_iot.types.get_policy_version_response.GetPolicyVersionResponse, zapros.Response
]:
