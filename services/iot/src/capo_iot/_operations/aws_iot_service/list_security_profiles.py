"""Generated from Smithy shape ``com.amazonaws.iot#ListSecurityProfiles``."""
...
import capo_iot.types.list_security_profiles_request
import capo_iot.types.list_security_profiles_response
...
def handle_response(
    ...
    out: capo_iot.types.list_security_profiles_response.ListSecurityProfilesResponse = (
        capo_iot.types.list_security_profiles_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/security-profiles"
