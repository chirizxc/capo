...
import capo_iot.types.list_commands_request
import capo_iot.types.list_commands_response
...
) -> capo_iot.types.list_commands_response.ListCommandsResponse:
    out: capo_iot.types.list_commands_response.ListCommandsResponse = (
        capo_iot.types.list_commands_response.deserialize_json(
...
def build_request(
    ...
    if "namespace" in input_:
        params.append(
            (
                "namespace",
                capo_iot.types.command_namespace.serialize_json(input_["namespace"]),
            )
        )
    if "command_parameter_name" in input_:
        params.append(("commandParameterName", input_["command_parameter_name"]))
    if "sort_order" in input_:
        params.append(
            (
                "sortOrder",
                capo_iot.types.sort_order.serialize_json(input_["sort_order"]),
            )
        )
...
def list_commands(
    ...
    input_: capo_iot.types.list_commands_request.ListCommandsRequest,
) -> tuple[capo_iot.types.list_commands_response.ListCommandsResponse, zapros.Response]:
