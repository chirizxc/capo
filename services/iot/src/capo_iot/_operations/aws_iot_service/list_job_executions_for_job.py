"""Generated from Smithy shape ``com.amazonaws.iot#ListJobExecutionsForJob``."""
...
import capo_iot.types.list_job_executions_for_job_request
import capo_iot.types.list_job_executions_for_job_response
...
def handle_response(
    ...
    out: capo_iot.types.list_job_executions_for_job_response.ListJobExecutionsForJobResponse = capo_iot.types.list_job_executions_for_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/jobs/{jobId}/things"
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_iot.types.job_execution_status.serialize_json(input_["status"]),
            )
        )
...
async def async_list_job_executions_for_job(
