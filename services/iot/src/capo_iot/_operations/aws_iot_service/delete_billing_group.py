"""Generated from Smithy shape ``com.amazonaws.iot#DeleteBillingGroup``."""
...
import capo_iot.types.delete_billing_group_request
import capo_iot.types.delete_billing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_billing_group_response.DeleteBillingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        "{billingGroupName}", quote(input_["billing_group_name"], safe="")
    )
