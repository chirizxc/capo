...
import capo_iot.types.list_domain_configurations_request
import capo_iot.types.list_domain_configurations_response
...
def handle_response(
    ...
    out: capo_iot.types.list_domain_configurations_response.ListDomainConfigurationsResponse = capo_iot.types.list_domain_configurations_response.deserialize_json(
...
def build_request(
    ...
    if "service_type" in input_:
        params.append(
            (
                "serviceType",
                capo_iot.types.service_type.serialize_json(input_["service_type"]),
            )
        )
