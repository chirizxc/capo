"""Generated from Smithy shape ``com.amazonaws.iot#DeleteRoleAlias``."""
...
import capo_iot.types.delete_role_alias_request
import capo_iot.types.delete_role_alias_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_role_alias_response.DeleteRoleAliasResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_role_alias(
    ...
    capo_iot.types.delete_role_alias_response.DeleteRoleAliasResponse, zapros.Response
]:
...
async def async_delete_role_alias(
