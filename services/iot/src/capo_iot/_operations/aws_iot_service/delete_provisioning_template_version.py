...
import capo_iot.types.delete_provisioning_template_version_request
import capo_iot.types.delete_provisioning_template_version_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_provisioning_template_version_response.DeleteProvisioningTemplateVersionResponse = {}  # type: ignore[typeddict-item]
    return out
