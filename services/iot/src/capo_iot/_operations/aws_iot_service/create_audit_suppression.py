...
import capo_iot.types.create_audit_suppression_request
import capo_iot.types.create_audit_suppression_response
...
def handle_response(
    ...
    out: capo_iot.types.create_audit_suppression_response.CreateAuditSuppressionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_audit_suppression_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
