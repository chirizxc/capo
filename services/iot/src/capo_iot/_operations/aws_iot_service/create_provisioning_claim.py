"""Generated from Smithy shape ``com.amazonaws.iot#CreateProvisioningClaim``."""
...
import capo_iot.types.create_provisioning_claim_request
import capo_iot.types.create_provisioning_claim_response
...
def handle_response(
    ...
    out: capo_iot.types.create_provisioning_claim_response.CreateProvisioningClaimResponse = capo_iot.types.create_provisioning_claim_response.deserialize_json(
...
async def async_create_provisioning_claim(
