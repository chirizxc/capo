"""Generated from Smithy shape ``com.amazonaws.iot#GetLoggingOptions``."""
...
import capo_iot.types.get_logging_options_request
import capo_iot.types.get_logging_options_response
...
def handle_response(
    ...
    out: capo_iot.types.get_logging_options_response.GetLoggingOptionsResponse = (
        capo_iot.types.get_logging_options_response.deserialize_json(
