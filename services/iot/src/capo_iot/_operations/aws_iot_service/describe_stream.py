"""Generated from Smithy shape ``com.amazonaws.iot#DescribeStream``."""
...
import capo_iot.types.describe_stream_request
import capo_iot.types.describe_stream_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_stream_response.DescribeStreamResponse = (
        capo_iot.types.describe_stream_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{streamId}", quote(input_["stream_id"], safe=""))
...
def describe_stream(
    ...
    capo_iot.types.describe_stream_response.DescribeStreamResponse, zapros.Response
]:
