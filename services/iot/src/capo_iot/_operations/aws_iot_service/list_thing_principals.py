"""Generated from Smithy shape ``com.amazonaws.iot#ListThingPrincipals``."""
...
import capo_iot.types.list_thing_principals_request
import capo_iot.types.list_thing_principals_response
...
def handle_response(
    ...
    out: capo_iot.types.list_thing_principals_response.ListThingPrincipalsResponse = (
        capo_iot.types.list_thing_principals_response.deserialize_json(
...
async def async_list_thing_principals(
