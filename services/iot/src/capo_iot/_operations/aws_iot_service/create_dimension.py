"""Generated from Smithy shape ``com.amazonaws.iot#CreateDimension``."""
...
import capo_iot.types.create_dimension_request
import capo_iot.types.create_dimension_response
...
def handle_response(
    ...
    out: capo_iot.types.create_dimension_response.CreateDimensionResponse = (
        capo_iot.types.create_dimension_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_dimension_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_dimension(
    ...
    capo_iot.types.create_dimension_response.CreateDimensionResponse, zapros.Response
]:
...
async def async_create_dimension(
