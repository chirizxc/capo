...
import capo_iot.types.delete_package_version_request
import capo_iot.types.delete_package_version_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_package_version_response.DeletePackageVersionResponse = {}  # type: ignore[typeddict-item]
    return out
