"""Generated from Smithy shape ``com.amazonaws.iot#ListThingGroupsForThing``."""
...
import capo_iot.types.list_thing_groups_for_thing_request
import capo_iot.types.list_thing_groups_for_thing_response
...
def handle_response(
    ...
    out: capo_iot.types.list_thing_groups_for_thing_response.ListThingGroupsForThingResponse = capo_iot.types.list_thing_groups_for_thing_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/things/{thingName}/thing-groups"
...
async def async_list_thing_groups_for_thing(
