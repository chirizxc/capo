"""Generated from Smithy shape ``com.amazonaws.iot#ListManagedJobTemplates``."""
...
import capo_iot.types.list_managed_job_templates_request
import capo_iot.types.list_managed_job_templates_response
...
) -> capo_iot.types.list_managed_job_templates_response.ListManagedJobTemplatesResponse:
    out: capo_iot.types.list_managed_job_templates_response.ListManagedJobTemplatesResponse = capo_iot.types.list_managed_job_templates_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-job-templates"
    params: list[tuple[str, str]] = []
    if "template_name" in input_:
        params.append(("templateName", input_["template_name"]))
...
async def async_list_managed_job_templates(
