"""Generated from Smithy shape ``com.amazonaws.iot#ListProvisioningTemplateVersions``."""
...
import capo_iot.types.list_provisioning_template_versions_request
import capo_iot.types.list_provisioning_template_versions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_provisioning_template_versions_response.ListProvisioningTemplateVersionsResponse = capo_iot.types.list_provisioning_template_versions_response.deserialize_json(
...
async def async_list_provisioning_template_versions(
