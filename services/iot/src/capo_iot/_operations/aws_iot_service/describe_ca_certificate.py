"""Generated from Smithy shape ``com.amazonaws.iot#DescribeCACertificate``."""
...
import capo_iot.types.describe_ca_certificate_request
import capo_iot.types.describe_ca_certificate_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_ca_certificate_response.DescribeCACertificateResponse = capo_iot.types.describe_ca_certificate_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{certificateId}", quote(input_["certificate_id"], safe=""))
...
async def async_describe_ca_certificate(
