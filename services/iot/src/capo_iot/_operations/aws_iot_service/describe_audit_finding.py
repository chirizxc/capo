"""Generated from Smithy shape ``com.amazonaws.iot#DescribeAuditFinding``."""
...
import capo_iot.types.describe_audit_finding_request
import capo_iot.types.describe_audit_finding_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_audit_finding_response.DescribeAuditFindingResponse = (
        capo_iot.types.describe_audit_finding_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/audit/findings/{findingId}"
...
async def async_describe_audit_finding(
