"""Generated from Smithy shape ``com.amazonaws.iot#DeleteCACertificate``."""
...
import capo_iot.types.delete_ca_certificate_request
import capo_iot.types.delete_ca_certificate_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_ca_certificate_response.DeleteCACertificateResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_ca_certificate(
