...
import capo_iot.types.describe_provisioning_template_version_request
import capo_iot.types.describe_provisioning_template_version_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_provisioning_template_version_response.DescribeProvisioningTemplateVersionResponse = capo_iot.types.describe_provisioning_template_version_response.deserialize_json(
