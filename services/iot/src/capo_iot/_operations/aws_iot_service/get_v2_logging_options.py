"""Generated from Smithy shape ``com.amazonaws.iot#GetV2LoggingOptions``."""
...
import capo_iot.types.get_v2_logging_options_request
import capo_iot.types.get_v2_logging_options_response
...
def handle_response(
    ...
    out: capo_iot.types.get_v2_logging_options_response.GetV2LoggingOptionsResponse = (
        capo_iot.types.get_v2_logging_options_response.deserialize_json(
...
def build_request(
    ...
    params.append(("verbose", "true" if input_.get("verbose", False) else "false"))
...
async def async_get_v2_logging_options(
