...
import capo_iot.types.get_topic_rule_destination_request
import capo_iot.types.get_topic_rule_destination_response
...
def handle_response(
    ...
    out: capo_iot.types.get_topic_rule_destination_response.GetTopicRuleDestinationResponse = capo_iot.types.get_topic_rule_destination_response.deserialize_json(
