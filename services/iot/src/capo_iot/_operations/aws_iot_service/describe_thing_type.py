...
import capo_iot.types.describe_thing_type_request
import capo_iot.types.describe_thing_type_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_thing_type_response.DescribeThingTypeResponse = (
        capo_iot.types.describe_thing_type_response.deserialize_json(
