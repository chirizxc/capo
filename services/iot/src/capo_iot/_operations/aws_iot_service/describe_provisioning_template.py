...
import capo_iot.types.describe_provisioning_template_request
import capo_iot.types.describe_provisioning_template_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_provisioning_template_response.DescribeProvisioningTemplateResponse = capo_iot.types.describe_provisioning_template_response.deserialize_json(
