"""Generated from Smithy shape ``com.amazonaws.iot#DeleteCommand``."""
...
import capo_iot.types.delete_command_request
import capo_iot.types.delete_command_response
...
) -> capo_iot.types.delete_command_response.DeleteCommandResponse:
    out: capo_iot.types.delete_command_response.DeleteCommandResponse = {}  # type: ignore[typeddict-item]
...
def delete_command(
    ...
    capo_iot.types.delete_command_response.DeleteCommandResponse, zapros.Response
]:
