"""Generated from Smithy shape ``com.amazonaws.iot#UpdateAuthorizer``."""
...
import capo_iot.types.update_authorizer_request
import capo_iot.types.update_authorizer_response
...
def handle_response(
    ...
    out: capo_iot.types.update_authorizer_response.UpdateAuthorizerResponse = (
        capo_iot.types.update_authorizer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_authorizer_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_authorizer(
    ...
    capo_iot.types.update_authorizer_response.UpdateAuthorizerResponse, zapros.Response
]:
