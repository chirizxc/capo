"""Generated from Smithy shape ``com.amazonaws.iot#DeletePolicyVersion``."""
...
import capo_iot.types.delete_policy_version_request
...
async def async_delete_policy_version(
