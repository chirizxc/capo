"""Generated from Smithy shape ``com.amazonaws.iot#GetCommand``."""
...
import capo_iot.types.get_command_request
import capo_iot.types.get_command_response
...
) -> capo_iot.types.get_command_response.GetCommandResponse:
    out: capo_iot.types.get_command_response.GetCommandResponse = (
        capo_iot.types.get_command_response.deserialize_json(
...
def get_command(
    ...
    input_: capo_iot.types.get_command_request.GetCommandRequest,
) -> tuple[capo_iot.types.get_command_response.GetCommandResponse, zapros.Response]:
