...
import capo_iot.types.delete_account_audit_configuration_request
import capo_iot.types.delete_account_audit_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_account_audit_configuration_response.DeleteAccountAuditConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    params.append(
        (
            ...
            "true" if input_.get("delete_scheduled_audits", False) else "false",
        )
    )
