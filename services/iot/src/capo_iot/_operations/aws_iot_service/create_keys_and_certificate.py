...
import capo_iot.types.create_keys_and_certificate_request
import capo_iot.types.create_keys_and_certificate_response
...
def handle_response(
    ...
    out: capo_iot.types.create_keys_and_certificate_response.CreateKeysAndCertificateResponse = capo_iot.types.create_keys_and_certificate_response.deserialize_json(
