"""Generated from Smithy shape ``com.amazonaws.iot#CreateProvisioningTemplate``."""
...
import capo_iot.types.create_provisioning_template_request
import capo_iot.types.create_provisioning_template_response
...
def handle_response(
    ...
    out: capo_iot.types.create_provisioning_template_response.CreateProvisioningTemplateResponse = capo_iot.types.create_provisioning_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_provisioning_template_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_provisioning_template(
