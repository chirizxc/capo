"""Generated from Smithy shape ``com.amazonaws.iot#DescribeEventConfigurations``."""
...
import capo_iot.types.describe_event_configurations_request
import capo_iot.types.describe_event_configurations_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_event_configurations_response.DescribeEventConfigurationsResponse = capo_iot.types.describe_event_configurations_response.deserialize_json(
...
async def async_describe_event_configurations(
