...
import capo_iot.types.describe_job_template_request
import capo_iot.types.describe_job_template_response
...
) -> capo_iot.types.describe_job_template_response.DescribeJobTemplateResponse:
    out: capo_iot.types.describe_job_template_response.DescribeJobTemplateResponse = (
        capo_iot.types.describe_job_template_response.deserialize_json(
