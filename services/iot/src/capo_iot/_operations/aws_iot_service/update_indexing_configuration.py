...
import capo_iot.types.update_indexing_configuration_request
import capo_iot.types.update_indexing_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.update_indexing_configuration_response.UpdateIndexingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_indexing_configuration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
