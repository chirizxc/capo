...
import capo_iot.types.delete_thing_type_request
import capo_iot.types.delete_thing_type_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_thing_type_response.DeleteThingTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_thing_type(
    ...
    capo_iot.types.delete_thing_type_response.DeleteThingTypeResponse, zapros.Response
]:
