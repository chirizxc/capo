"""Generated from Smithy shape ``com.amazonaws.iot#UpdateEncryptionConfiguration``."""
...
import capo_iot.types.update_encryption_configuration_request
import capo_iot.types.update_encryption_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.update_encryption_configuration_response.UpdateEncryptionConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_encryption_configuration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_encryption_configuration(
