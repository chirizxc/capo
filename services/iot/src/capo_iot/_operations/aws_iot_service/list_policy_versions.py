"""Generated from Smithy shape ``com.amazonaws.iot#ListPolicyVersions``."""
...
import capo_iot.types.list_policy_versions_request
import capo_iot.types.list_policy_versions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_policy_versions_response.ListPolicyVersionsResponse = (
        capo_iot.types.list_policy_versions_response.deserialize_json(
