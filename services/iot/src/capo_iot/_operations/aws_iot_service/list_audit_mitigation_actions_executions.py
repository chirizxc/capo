...
import capo_iot.types.list_audit_mitigation_actions_executions_request
import capo_iot.types.list_audit_mitigation_actions_executions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_audit_mitigation_actions_executions_response.ListAuditMitigationActionsExecutionsResponse = capo_iot.types.list_audit_mitigation_actions_executions_response.deserialize_json(
