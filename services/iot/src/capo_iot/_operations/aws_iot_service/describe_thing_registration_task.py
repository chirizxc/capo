...
import capo_iot.types.describe_thing_registration_task_request
import capo_iot.types.describe_thing_registration_task_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_thing_registration_task_response.DescribeThingRegistrationTaskResponse = capo_iot.types.describe_thing_registration_task_response.deserialize_json(
