"""Generated from Smithy shape ``com.amazonaws.iot#ListThingsInThingGroup``."""
...
import capo_iot.types.list_things_in_thing_group_request
import capo_iot.types.list_things_in_thing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.list_things_in_thing_group_response.ListThingsInThingGroupResponse = capo_iot.types.list_things_in_thing_group_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/thing-groups/{thingGroupName}/things"
    url = url.replace("{thingGroupName}", quote(input_["thing_group_name"], safe=""))
    params: list[tuple[str, str]] = []
    params.append(("recursive", "true" if input_.get("recursive", False) else "false"))
...
async def async_list_things_in_thing_group(
