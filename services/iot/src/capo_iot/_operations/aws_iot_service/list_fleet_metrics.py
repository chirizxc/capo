...
import capo_iot.types.list_fleet_metrics_request
import capo_iot.types.list_fleet_metrics_response
...
def handle_response(
    ...
    out: capo_iot.types.list_fleet_metrics_response.ListFleetMetricsResponse = (
        capo_iot.types.list_fleet_metrics_response.deserialize_json(
...
def list_fleet_metrics(
    ...
    capo_iot.types.list_fleet_metrics_response.ListFleetMetricsResponse, zapros.Response
]:
