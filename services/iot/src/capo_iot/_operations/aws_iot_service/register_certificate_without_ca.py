...
import capo_iot.types.register_certificate_without_ca_request
import capo_iot.types.register_certificate_without_ca_response
...
def handle_response(
    ...
    out: capo_iot.types.register_certificate_without_ca_response.RegisterCertificateWithoutCAResponse = capo_iot.types.register_certificate_without_ca_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.register_certificate_without_ca_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
