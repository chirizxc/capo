...
import capo_iot.types.remove_thing_from_thing_group_request
import capo_iot.types.remove_thing_from_thing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.remove_thing_from_thing_group_response.RemoveThingFromThingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.remove_thing_from_thing_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
