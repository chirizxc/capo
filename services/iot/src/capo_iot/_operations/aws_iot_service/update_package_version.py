"""Generated from Smithy shape ``com.amazonaws.iot#UpdatePackageVersion``."""
...
import capo_iot.types.update_package_version_request
import capo_iot.types.update_package_version_response
...
def handle_response(
    ...
    out: capo_iot.types.update_package_version_response.UpdatePackageVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_package_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_package_version(
