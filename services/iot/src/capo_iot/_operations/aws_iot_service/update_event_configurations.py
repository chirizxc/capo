...
import capo_iot.types.update_event_configurations_request
import capo_iot.types.update_event_configurations_response
...
def handle_response(
    ...
    out: capo_iot.types.update_event_configurations_response.UpdateEventConfigurationsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_event_configurations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
