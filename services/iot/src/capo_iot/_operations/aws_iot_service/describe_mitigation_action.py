...
import capo_iot.types.describe_mitigation_action_request
import capo_iot.types.describe_mitigation_action_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_mitigation_action_response.DescribeMitigationActionResponse = capo_iot.types.describe_mitigation_action_response.deserialize_json(
