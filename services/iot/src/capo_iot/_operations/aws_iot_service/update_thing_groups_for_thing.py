...
import capo_iot.types.update_thing_groups_for_thing_request
import capo_iot.types.update_thing_groups_for_thing_response
...
def handle_response(
    ...
    out: capo_iot.types.update_thing_groups_for_thing_response.UpdateThingGroupsForThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_thing_groups_for_thing_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
