...
import capo_iot.types.list_related_resources_for_audit_finding_request
import capo_iot.types.list_related_resources_for_audit_finding_response
...
def handle_response(
    ...
    out: capo_iot.types.list_related_resources_for_audit_finding_response.ListRelatedResourcesForAuditFindingResponse = capo_iot.types.list_related_resources_for_audit_finding_response.deserialize_json(
