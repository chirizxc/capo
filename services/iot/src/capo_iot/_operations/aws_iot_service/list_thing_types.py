...
import capo_iot.types.list_thing_types_request
import capo_iot.types.list_thing_types_response
...
def handle_response(
    ...
    out: capo_iot.types.list_thing_types_response.ListThingTypesResponse = (
        capo_iot.types.list_thing_types_response.deserialize_json(
...
def list_thing_types(
    ...
    capo_iot.types.list_thing_types_response.ListThingTypesResponse, zapros.Response
]:
