...
import capo_iot.types.create_scheduled_audit_request
import capo_iot.types.create_scheduled_audit_response
...
def handle_response(
    ...
    out: capo_iot.types.create_scheduled_audit_response.CreateScheduledAuditResponse = (
        capo_iot.types.create_scheduled_audit_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_scheduled_audit_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
