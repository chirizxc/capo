...
import capo_iot.types.cancel_audit_mitigation_actions_task_request
...
def handle_response(
    ...
    out: capo_iot.types.cancel_audit_mitigation_actions_task_response.CancelAuditMitigationActionsTaskResponse = {}  # type: ignore[typeddict-item]
    return out
