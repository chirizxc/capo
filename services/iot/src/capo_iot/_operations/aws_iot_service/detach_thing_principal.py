...
import capo_iot.types.detach_thing_principal_request
import capo_iot.types.detach_thing_principal_response
...
def handle_response(
    ...
    out: capo_iot.types.detach_thing_principal_response.DetachThingPrincipalResponse = {}  # type: ignore[typeddict-item]
    return out
