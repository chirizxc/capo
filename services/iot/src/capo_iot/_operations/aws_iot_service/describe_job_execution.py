...
import capo_iot.types.describe_job_execution_request
import capo_iot.types.describe_job_execution_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_job_execution_response.DescribeJobExecutionResponse = (
        capo_iot.types.describe_job_execution_response.deserialize_json(
...
def build_request(
    ...
    if "execution_number" in input_:
        params.append(("executionNumber", str(input_["execution_number"])))
