"""Generated from Smithy shape ``com.amazonaws.iot#UpdateRoleAlias``."""
...
import capo_iot.types.update_role_alias_request
import capo_iot.types.update_role_alias_response
...
def handle_response(
    ...
    out: capo_iot.types.update_role_alias_response.UpdateRoleAliasResponse = (
        capo_iot.types.update_role_alias_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{roleAlias}", quote(input_["role_alias"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iot.types.update_role_alias_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_role_alias(
    ...
    capo_iot.types.update_role_alias_response.UpdateRoleAliasResponse, zapros.Response
]:
...
async def async_update_role_alias(
