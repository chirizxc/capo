...
import capo_iot.types.list_targets_for_security_profile_request
import capo_iot.types.list_targets_for_security_profile_response
...
def handle_response(
    ...
    out: capo_iot.types.list_targets_for_security_profile_response.ListTargetsForSecurityProfileResponse = capo_iot.types.list_targets_for_security_profile_response.deserialize_json(
