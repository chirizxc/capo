...
import capo_iot.types.list_outgoing_certificates_request
import capo_iot.types.list_outgoing_certificates_response
...
def handle_response(
    ...
    out: capo_iot.types.list_outgoing_certificates_response.ListOutgoingCertificatesResponse = capo_iot.types.list_outgoing_certificates_response.deserialize_json(
...
def build_request(
    ...
    params.append(
        (
            "isAscendingOrder",
            "true" if input_.get("ascending_order", False) else "false",
        )
    )
