...
import capo_iot.types.deprecate_thing_type_request
import capo_iot.types.deprecate_thing_type_response
...
def handle_response(
    ...
    out: capo_iot.types.deprecate_thing_type_response.DeprecateThingTypeResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.deprecate_thing_type_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
