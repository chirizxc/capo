"""Generated from Smithy shape ``com.amazonaws.iot#DescribeScheduledAudit``."""
...
import capo_iot.types.describe_scheduled_audit_request
import capo_iot.types.describe_scheduled_audit_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_scheduled_audit_response.DescribeScheduledAuditResponse = capo_iot.types.describe_scheduled_audit_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{scheduledAuditName}", quote(input_["scheduled_audit_name"], safe="")
    )
...
async def async_describe_scheduled_audit(
