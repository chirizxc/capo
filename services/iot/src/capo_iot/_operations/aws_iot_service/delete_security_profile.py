...
import capo_iot.types.delete_security_profile_request
import capo_iot.types.delete_security_profile_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_security_profile_response.DeleteSecurityProfileResponse = {}  # type: ignore[typeddict-item]
    return out
