"""Generated from Smithy shape ``com.amazonaws.iot#DescribeManagedJobTemplate``."""
...
import capo_iot.types.describe_managed_job_template_request
import capo_iot.types.describe_managed_job_template_response
...
) -> capo_iot.types.describe_managed_job_template_response.DescribeManagedJobTemplateResponse:
    out: capo_iot.types.describe_managed_job_template_response.DescribeManagedJobTemplateResponse = capo_iot.types.describe_managed_job_template_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-job-templates/{templateName}"
    url = url.replace("{templateName}", quote(input_["template_name"], safe=""))
    params: list[tuple[str, str]] = []
    if "template_version" in input_:
        params.append(("templateVersion", input_["template_version"]))
...
async def async_describe_managed_job_template(
