"""Generated from Smithy shape ``com.amazonaws.iot#ListBillingGroups``."""
...
import capo_iot.types.list_billing_groups_request
import capo_iot.types.list_billing_groups_response
...
def handle_response(
    ...
    out: capo_iot.types.list_billing_groups_response.ListBillingGroupsResponse = (
        capo_iot.types.list_billing_groups_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/billing-groups"
    ...
    if "name_prefix_filter" in input_:
        params.append(("namePrefixFilter", input_["name_prefix_filter"]))
