...
import capo_iot.types.delete_certificate_provider_request
import capo_iot.types.delete_certificate_provider_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_certificate_provider_response.DeleteCertificateProviderResponse = {}  # type: ignore[typeddict-item]
    return out
