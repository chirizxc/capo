...
import capo_iot.types.create_thing_group_request
import capo_iot.types.create_thing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.create_thing_group_response.CreateThingGroupResponse = (
        capo_iot.types.create_thing_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_thing_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_thing_group(
    ...
    capo_iot.types.create_thing_group_response.CreateThingGroupResponse, zapros.Response
]:
