...
import capo_iot.types.command_execution_summary_list
import capo_iot.types.command_namespace
import capo_iot.types.list_command_executions_request
import capo_iot.types.list_command_executions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_command_executions_response.ListCommandExecutionsResponse = capo_iot.types.list_command_executions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.list_command_executions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
