"""Generated from Smithy shape ``com.amazonaws.iot#ListTopicRules``."""
...
import capo_iot.types.list_topic_rules_request
import capo_iot.types.list_topic_rules_response
...
def handle_response(
    ...
    out: capo_iot.types.list_topic_rules_response.ListTopicRulesResponse = (
        capo_iot.types.list_topic_rules_response.deserialize_json(
...
def build_request(
    ...
    if "rule_disabled" in input_:
        params.append(("ruleDisabled", "true" if input_["rule_disabled"] else "false"))
...
def list_topic_rules(
    ...
    capo_iot.types.list_topic_rules_response.ListTopicRulesResponse, zapros.Response
]:
...
async def async_list_topic_rules(
