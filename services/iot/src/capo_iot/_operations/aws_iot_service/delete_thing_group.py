"""Generated from Smithy shape ``com.amazonaws.iot#DeleteThingGroup``."""
...
import capo_iot.types.delete_thing_group_request
import capo_iot.types.delete_thing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_thing_group_response.DeleteThingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    if "expected_version" in input_:
        params.append(("expectedVersion", str(input_["expected_version"])))
...
def delete_thing_group(
    ...
    capo_iot.types.delete_thing_group_response.DeleteThingGroupResponse, zapros.Response
]:
...
async def async_delete_thing_group(
