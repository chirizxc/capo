"""Generated from Smithy shape ``com.amazonaws.iot#GetPackage``."""
...
import capo_iot.types.get_package_request
import capo_iot.types.get_package_response
...
def handle_response(
    ...
    out: capo_iot.types.get_package_response.GetPackageResponse = (
        capo_iot.types.get_package_response.deserialize_json(
...
def get_package(
    ...
    input_: capo_iot.types.get_package_request.GetPackageRequest,
) -> tuple[capo_iot.types.get_package_response.GetPackageResponse, zapros.Response]:
