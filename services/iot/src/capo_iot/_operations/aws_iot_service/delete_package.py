...
import capo_iot.types.delete_package_request
import capo_iot.types.delete_package_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_package_response.DeletePackageResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_package(
    ...
    capo_iot.types.delete_package_response.DeletePackageResponse, zapros.Response
]:
