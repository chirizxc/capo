...
import capo_iot.types.delete_mitigation_action_request
import capo_iot.types.delete_mitigation_action_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_mitigation_action_response.DeleteMitigationActionResponse = {}  # type: ignore[typeddict-item]
    return out
