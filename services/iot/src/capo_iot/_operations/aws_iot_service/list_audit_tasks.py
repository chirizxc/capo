"""Generated from Smithy shape ``com.amazonaws.iot#ListAuditTasks``."""
...
import capo_iot.types.list_audit_tasks_request
import capo_iot.types.list_audit_tasks_response
...
def handle_response(
    ...
    out: capo_iot.types.list_audit_tasks_response.ListAuditTasksResponse = (
        capo_iot.types.list_audit_tasks_response.deserialize_json(
...
def build_request(
    ...
    if "task_type" in input_:
        params.append(
            (
                "taskType",
                capo_iot.types.audit_task_type.serialize_json(input_["task_type"]),
            )
        )
    if "task_status" in input_:
        params.append(
            (
                "taskStatus",
                capo_iot.types.audit_task_status.serialize_json(input_["task_status"]),
            )
        )
...
def list_audit_tasks(
    ...
    capo_iot.types.list_audit_tasks_response.ListAuditTasksResponse, zapros.Response
]:
...
async def async_list_audit_tasks(
