...
import capo_iot.types.create_package_version_request
import capo_iot.types.create_package_version_response
...
def handle_response(
    ...
    out: capo_iot.types.create_package_version_response.CreatePackageVersionResponse = (
        capo_iot.types.create_package_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_package_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
