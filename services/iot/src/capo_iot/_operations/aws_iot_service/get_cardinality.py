...
import capo_iot.types.get_cardinality_request
import capo_iot.types.get_cardinality_response
...
def handle_response(
    ...
    out: capo_iot.types.get_cardinality_response.GetCardinalityResponse = (
        capo_iot.types.get_cardinality_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.get_cardinality_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def get_cardinality(
    ...
    capo_iot.types.get_cardinality_response.GetCardinalityResponse, zapros.Response
]:
