...
import capo_iot.types.list_audit_suppressions_request
import capo_iot.types.list_audit_suppressions_response
...
def handle_response(
    ...
    out: capo_iot.types.list_audit_suppressions_response.ListAuditSuppressionsResponse = capo_iot.types.list_audit_suppressions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.list_audit_suppressions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
