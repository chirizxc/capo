"""Generated from Smithy shape ``com.amazonaws.iot#ListThings``."""
...
import capo_iot.types.list_things_request
import capo_iot.types.list_things_response
...
def handle_response(
    ...
    out: capo_iot.types.list_things_response.ListThingsResponse = (
        capo_iot.types.list_things_response.deserialize_json(
...
def build_request(
    ...
    if "attribute_name" in input_:
        params.append(("attributeName", input_["attribute_name"]))
    if "attribute_value" in input_:
        params.append(("attributeValue", input_["attribute_value"]))
    if "thing_type_name" in input_:
        params.append(("thingTypeName", input_["thing_type_name"]))
    params.append(
        (
            "usePrefixAttributeValue",
            "true" if input_.get("use_prefix_attribute_value", False) else "false",
        )
    )
...
def list_things(
    ...
    input_: capo_iot.types.list_things_request.ListThingsRequest,
) -> tuple[capo_iot.types.list_things_response.ListThingsResponse, zapros.Response]:
