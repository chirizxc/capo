...
import capo_iot.types.update_audit_suppression_request
import capo_iot.types.update_audit_suppression_response
...
) -> capo_iot.types.update_audit_suppression_response.UpdateAuditSuppressionResponse:
    out: capo_iot.types.update_audit_suppression_response.UpdateAuditSuppressionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_audit_suppression_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
