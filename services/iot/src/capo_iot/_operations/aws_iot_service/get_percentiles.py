...
import capo_iot.types.get_percentiles_request
import capo_iot.types.get_percentiles_response
...
def handle_response(
    ...
    out: capo_iot.types.get_percentiles_response.GetPercentilesResponse = (
        capo_iot.types.get_percentiles_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.get_percentiles_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def get_percentiles(
    ...
    capo_iot.types.get_percentiles_response.GetPercentilesResponse, zapros.Response
]:
