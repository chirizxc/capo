...
def build_request(
    ...
    if "security_profile_name" in input_:
        params.append(("securityProfileName", input_["security_profile_name"]))
    if "behavior_criteria_type" in input_:
        params.append(
            (
                "behaviorCriteriaType",
                capo_iot.types.behavior_criteria_type.serialize_json(
                    input_["behavior_criteria_type"]
                ),
            )
        )
    if "list_suppressed_alerts" in input_:
        params.append(
            (
                ...
                "true" if input_["list_suppressed_alerts"] else "false",
            )
        )
    if "verification_state" in input_:
        params.append(
            (
                "verificationState",
                capo_iot.types.verification_state.serialize_json(
                    input_["verification_state"]
                ),
            )
        )
