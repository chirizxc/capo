"""Generated from Smithy shape ``com.amazonaws.iot#DeleteDimension``."""
...
import capo_iot.types.delete_dimension_request
import capo_iot.types.delete_dimension_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_dimension_response.DeleteDimensionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_dimension(
    ...
    capo_iot.types.delete_dimension_response.DeleteDimensionResponse, zapros.Response
]:
...
async def async_delete_dimension(
