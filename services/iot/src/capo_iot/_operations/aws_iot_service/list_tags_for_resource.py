...
import capo_iot.types.list_tags_for_resource_request
import capo_iot.types.list_tags_for_resource_response
...
def handle_response(
    ...
    out: capo_iot.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_iot.types.list_tags_for_resource_response.deserialize_json(
