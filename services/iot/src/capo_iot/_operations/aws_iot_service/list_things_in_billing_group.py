...
import capo_iot.types.list_things_in_billing_group_request
import capo_iot.types.list_things_in_billing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.list_things_in_billing_group_response.ListThingsInBillingGroupResponse = capo_iot.types.list_things_in_billing_group_response.deserialize_json(
