"""Generated from Smithy shape ``com.amazonaws.iot#DeleteStream``."""
...
import capo_iot.types.delete_stream_request
import capo_iot.types.delete_stream_response
...
def handle_response(
    ...
    out: capo_iot.types.delete_stream_response.DeleteStreamResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_stream(
    ...
    input_: capo_iot.types.delete_stream_request.DeleteStreamRequest,
) -> tuple[capo_iot.types.delete_stream_response.DeleteStreamResponse, zapros.Response]:
