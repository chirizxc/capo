...
import capo_iot.types.describe_encryption_configuration_request
import capo_iot.types.describe_encryption_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_encryption_configuration_response.DescribeEncryptionConfigurationResponse = capo_iot.types.describe_encryption_configuration_response.deserialize_json(
