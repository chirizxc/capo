...
import capo_iot.types.add_thing_to_billing_group_request
import capo_iot.types.add_thing_to_billing_group_response
...
def handle_response(
    ...
    out: capo_iot.types.add_thing_to_billing_group_response.AddThingToBillingGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.add_thing_to_billing_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
