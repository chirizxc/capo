...
import capo_iot.types.describe_job_request
import capo_iot.types.describe_job_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_job_response.DescribeJobResponse = (
        capo_iot.types.describe_job_response.deserialize_json(
...
def build_request(
    ...
    params.append(
        (
            "beforeSubstitution",
            "true" if input_.get("before_substitution", False) else "false",
        )
    )
...
def describe_job(
    ...
    input_: capo_iot.types.describe_job_request.DescribeJobRequest,
) -> tuple[capo_iot.types.describe_job_response.DescribeJobResponse, zapros.Response]:
