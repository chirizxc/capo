...
import capo_iot.types.get_buckets_aggregation_request
import capo_iot.types.get_buckets_aggregation_response
...
def handle_response(
    ...
    out: capo_iot.types.get_buckets_aggregation_response.GetBucketsAggregationResponse = capo_iot.types.get_buckets_aggregation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.get_buckets_aggregation_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
