"""Generated from Smithy shape ``com.amazonaws.iot#DescribeDefaultAuthorizer``."""
...
import capo_iot.types.describe_default_authorizer_request
import capo_iot.types.describe_default_authorizer_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_default_authorizer_response.DescribeDefaultAuthorizerResponse = capo_iot.types.describe_default_authorizer_response.deserialize_json(
...
async def async_describe_default_authorizer(
