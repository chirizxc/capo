...
import capo_iot.types.update_dimension_request
import capo_iot.types.update_dimension_response
...
def handle_response(
    ...
    out: capo_iot.types.update_dimension_response.UpdateDimensionResponse = (
        capo_iot.types.update_dimension_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_dimension_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_dimension(
    ...
    capo_iot.types.update_dimension_response.UpdateDimensionResponse, zapros.Response
]:
