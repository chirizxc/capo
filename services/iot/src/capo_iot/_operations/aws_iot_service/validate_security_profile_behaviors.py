...
import capo_iot.types.validate_security_profile_behaviors_request
import capo_iot.types.validate_security_profile_behaviors_response
...
def handle_response(
    ...
    out: capo_iot.types.validate_security_profile_behaviors_response.ValidateSecurityProfileBehaviorsResponse = capo_iot.types.validate_security_profile_behaviors_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.validate_security_profile_behaviors_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
