...
import capo_iot.types.disassociate_sbom_from_package_version_request
import capo_iot.types.disassociate_sbom_from_package_version_response
...
def handle_response(
    ...
    out: capo_iot.types.disassociate_sbom_from_package_version_response.DisassociateSbomFromPackageVersionResponse = {}  # type: ignore[typeddict-item]
    return out
