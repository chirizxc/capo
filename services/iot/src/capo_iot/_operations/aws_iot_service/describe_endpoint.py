...
import capo_iot.types.describe_endpoint_request
import capo_iot.types.describe_endpoint_response
...
def handle_response(
    ...
    out: capo_iot.types.describe_endpoint_response.DescribeEndpointResponse = (
        capo_iot.types.describe_endpoint_response.deserialize_json(
...
def build_request(
    ...
    if "endpoint_type" in input_:
        params.append(("endpointType", input_["endpoint_type"]))
...
def describe_endpoint(
    ...
    capo_iot.types.describe_endpoint_response.DescribeEndpointResponse, zapros.Response
]:
