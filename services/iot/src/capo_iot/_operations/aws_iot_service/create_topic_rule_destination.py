"""Generated from Smithy shape ``com.amazonaws.iot#CreateTopicRuleDestination``."""
...
import capo_iot.types.create_topic_rule_destination_request
import capo_iot.types.create_topic_rule_destination_response
...
def handle_response(
    ...
    out: capo_iot.types.create_topic_rule_destination_response.CreateTopicRuleDestinationResponse = capo_iot.types.create_topic_rule_destination_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.create_topic_rule_destination_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_topic_rule_destination(
