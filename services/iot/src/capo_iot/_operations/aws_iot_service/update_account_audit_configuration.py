...
import capo_iot.types.update_account_audit_configuration_request
import capo_iot.types.update_account_audit_configuration_response
...
def handle_response(
    ...
    out: capo_iot.types.update_account_audit_configuration_response.UpdateAccountAuditConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot.types.update_account_audit_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
