"""Generated from Smithy shape ``com.amazonaws.iot#InvalidStateTransitionException``."""
...
class InvalidStateTransitionException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iot#InvalidStateTransitionException``."""
