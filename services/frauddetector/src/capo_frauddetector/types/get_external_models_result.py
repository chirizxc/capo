...
class GetExternalModelsResult(TypedDict, closed=True):
    external_models: NotRequired[
        "capo_frauddetector.types.external_model_list.ExternalModelList"
    ]
...
def serialize_aws_json_1_1(value: GetExternalModelsResult) -> dict:
    ...
    if "external_models" in value:
        ...
        out["externalModels"] = (
            capo_frauddetector.types.external_model_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetExternalModelsResult:
    ...
    if data.get("externalModels") is not None:
        import capo_frauddetector.types.external_model_list

        out["external_models"] = (
            capo_frauddetector.types.external_model_list.deserialize_aws_json_1_1(
                data["externalModels"]
            )
        )
