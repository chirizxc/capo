...
if TYPE_CHECKING:
    import capo_frauddetector.types.aggregated_variables_importance_metrics
    import capo_frauddetector.types.data_validation_metrics
    import capo_frauddetector.types.training_metrics_v2
...
class TrainingResultV2(TypedDict, closed=True):
    ...
    training_metrics_v2: NotRequired[
        "capo_frauddetector.types.training_metrics_v2.TrainingMetricsV2"
    ]
    ...
    aggregated_variables_importance_metrics: NotRequired[
        "capo_frauddetector.types.aggregated_variables_importance_metrics.AggregatedVariablesImportanceMetrics"
    ]
...
def serialize_aws_json_1_1(value: TrainingResultV2) -> dict:
    ...
    if "training_metrics_v2" in value:
        ...
        out["trainingMetricsV2"] = (
            capo_frauddetector.types.training_metrics_v2.serialize_aws_json_1_1(
    ...
    if "aggregated_variables_importance_metrics" in value:
        ...
        out["aggregatedVariablesImportanceMetrics"] = (
            capo_frauddetector.types.aggregated_variables_importance_metrics.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TrainingResultV2:
    ...
    if data.get("trainingMetricsV2") is not None:
        import capo_frauddetector.types.training_metrics_v2

        out["training_metrics_v2"] = (
            capo_frauddetector.types.training_metrics_v2.deserialize_aws_json_1_1(
    ...
    if data.get("aggregatedVariablesImportanceMetrics") is not None:
        import capo_frauddetector.types.aggregated_variables_importance_metrics

        out["aggregated_variables_importance_metrics"] = (
            capo_frauddetector.types.aggregated_variables_importance_metrics.deserialize_aws_json_1_1(
