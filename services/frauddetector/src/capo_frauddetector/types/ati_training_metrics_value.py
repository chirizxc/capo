...
class ATITrainingMetricsValue(TypedDict, closed=True):
    metric_data_points: NotRequired[
        "capo_frauddetector.types.ati_metric_data_points_list.ATIMetricDataPointsList"
    ]
    """<p> The model's performance metrics data points. </p>"""
    model_performance: NotRequired[
        "capo_frauddetector.types.ati_model_performance.ATIModelPerformance"
    ]
...
def serialize_aws_json_1_1(value: ATITrainingMetricsValue) -> dict:
    ...
    if "metric_data_points" in value:
        ...
        out["metricDataPoints"] = (
            capo_frauddetector.types.ati_metric_data_points_list.serialize_aws_json_1_1(
    ...
    if "model_performance" in value:
        ...
        out["modelPerformance"] = (
            capo_frauddetector.types.ati_model_performance.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ATITrainingMetricsValue:
    ...
    if data.get("metricDataPoints") is not None:
        ...
        out["metric_data_points"] = (
            capo_frauddetector.types.ati_metric_data_points_list.deserialize_aws_json_1_1(
    ...
    if data.get("modelPerformance") is not None:
        ...
        out["model_performance"] = (
            capo_frauddetector.types.ati_model_performance.deserialize_aws_json_1_1(
