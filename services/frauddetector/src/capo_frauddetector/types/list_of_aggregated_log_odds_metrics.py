...
if TYPE_CHECKING:
    import capo_frauddetector.types.aggregated_log_odds_metric

ListOfAggregatedLogOddsMetrics: TypeAlias = list[
    "capo_frauddetector.types.aggregated_log_odds_metric.AggregatedLogOddsMetric"
]
...
def serialize_aws_json_1_1(value: ListOfAggregatedLogOddsMetrics) -> list:
    ...
    for item in value:
        out.append(
            capo_frauddetector.types.aggregated_log_odds_metric.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ListOfAggregatedLogOddsMetrics:
    ...
    for item in data:
        if item is None:
            continue
        out.append(
            capo_frauddetector.types.aggregated_log_odds_metric.deserialize_aws_json_1_1(
                item
            )
        )
    return out
