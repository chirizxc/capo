"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53recoverycontrolconfig#ServiceQuotaExceededException``."""
