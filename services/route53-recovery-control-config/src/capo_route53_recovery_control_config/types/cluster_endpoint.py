...
if TYPE_CHECKING:
    import capo_route53_recovery_control_config.types.__string_min1_max32_pattern_s
    import capo_route53_recovery_control_config.types.__string_min1_max128_pattern_a_za_z09


class ClusterEndpoint(TypedDict, closed=True):
    endpoint: NotRequired[
        "capo_route53_recovery_control_config.types.__string_min1_max128_pattern_a_za_z09.__stringMin1Max128PatternAZaZ09"
    ]
    ...
    region: NotRequired[
        "capo_route53_recovery_control_config.types.__string_min1_max32_pattern_s.__stringMin1Max32PatternS"
    ]
