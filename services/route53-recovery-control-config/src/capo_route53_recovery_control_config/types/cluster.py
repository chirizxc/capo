...
class Cluster(TypedDict, closed=True):
    ...
    cluster_endpoints: NotRequired[
        "capo_route53_recovery_control_config.types.__list_of_cluster_endpoint.__listOfClusterEndpoint"
    ]
...
def serialize_json(value: Cluster) -> dict:
    ...
    if "cluster_endpoints" in value:
        ...
        out["ClusterEndpoints"] = (
            capo_route53_recovery_control_config.types.__list_of_cluster_endpoint.serialize_json(
...
def deserialize_json(data: dict) -> Cluster:
    ...
    if data.get("ClusterEndpoints") is not None:
        ...
        out["cluster_endpoints"] = (
            capo_route53_recovery_control_config.types.__list_of_cluster_endpoint.deserialize_json(
