"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#UntagResource``."""
...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
