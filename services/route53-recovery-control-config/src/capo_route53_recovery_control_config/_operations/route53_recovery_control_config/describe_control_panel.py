...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.describe_control_panel_response.DescribeControlPanelResponse = capo_route53_recovery_control_config.types.describe_control_panel_response.deserialize_json(
