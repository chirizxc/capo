...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.list_safety_rules_response.ListSafetyRulesResponse = capo_route53_recovery_control_config.types.list_safety_rules_response.deserialize_json(
