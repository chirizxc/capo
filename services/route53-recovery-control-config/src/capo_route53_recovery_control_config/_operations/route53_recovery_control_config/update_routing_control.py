...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.update_routing_control_response.UpdateRoutingControlResponse = capo_route53_recovery_control_config.types.update_routing_control_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53_recovery_control_config.types.update_routing_control_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
