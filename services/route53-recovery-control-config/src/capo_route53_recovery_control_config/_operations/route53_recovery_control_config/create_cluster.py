"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#CreateCluster``."""
...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.create_cluster_response.CreateClusterResponse = capo_route53_recovery_control_config.types.create_cluster_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53_recovery_control_config.types.create_cluster_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
