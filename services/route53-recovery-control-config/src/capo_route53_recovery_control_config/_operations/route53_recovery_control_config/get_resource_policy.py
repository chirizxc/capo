...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.get_resource_policy_response.GetResourcePolicyResponse = capo_route53_recovery_control_config.types.get_resource_policy_response.deserialize_json(
