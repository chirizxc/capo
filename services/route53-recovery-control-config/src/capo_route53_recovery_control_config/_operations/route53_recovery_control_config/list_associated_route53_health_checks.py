...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.list_associated_route53_health_checks_response.ListAssociatedRoute53HealthChecksResponse = capo_route53_recovery_control_config.types.list_associated_route53_health_checks_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{RoutingControlArn}", quote(input_["routing_control_arn"], safe="")
    )
