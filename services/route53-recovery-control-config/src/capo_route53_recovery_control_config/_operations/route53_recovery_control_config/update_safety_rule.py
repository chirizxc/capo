"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#UpdateSafetyRule``."""
...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.update_safety_rule_response.UpdateSafetyRuleResponse = capo_route53_recovery_control_config.types.update_safety_rule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53_recovery_control_config.types.update_safety_rule_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_safety_rule(
