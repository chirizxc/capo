"""Generated from Smithy shape ``com.amazonaws.route53recoverycontrolconfig#ListRoutingControls``."""
...
def handle_response(
    ...
    out: capo_route53_recovery_control_config.types.list_routing_controls_response.ListRoutingControlsResponse = capo_route53_recovery_control_config.types.list_routing_controls_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/controlpanel/{ControlPanelArn}/routingcontrols"
    url = url.replace("{ControlPanelArn}", quote(input_["control_panel_arn"], safe=""))
