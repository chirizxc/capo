...
def handle_response(response: zapros.Response) -> capo_swf.types.history.History:
    out: capo_swf.types.history.History = (
        capo_swf.types.history.deserialize_aws_json_1_0(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_swf.types.history.History = (
        capo_swf.types.history.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.get_workflow_execution_history_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def get_workflow_execution_history(
    ...
    input_: capo_swf.types.get_workflow_execution_history_input.GetWorkflowExecutionHistoryInput,
) -> tuple[capo_swf.types.history.History, zapros.Response]:
