"""Generated from Smithy shape ``com.amazonaws.swf#ListOpenWorkflowExecutions``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.list_open_workflow_executions_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_open_workflow_executions(
