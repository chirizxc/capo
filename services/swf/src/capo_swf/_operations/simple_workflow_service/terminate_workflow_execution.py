"""Generated from Smithy shape ``com.amazonaws.swf#TerminateWorkflowExecution``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.terminate_workflow_execution_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_terminate_workflow_execution(
