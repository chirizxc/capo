...
def handle_response(
    ...
    out: capo_swf.types.activity_task.ActivityTask = (
        capo_swf.types.activity_task.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.poll_for_activity_task_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def poll_for_activity_task(
    ...
    input_: capo_swf.types.poll_for_activity_task_input.PollForActivityTaskInput,
) -> tuple[capo_swf.types.activity_task.ActivityTask, zapros.Response]:
