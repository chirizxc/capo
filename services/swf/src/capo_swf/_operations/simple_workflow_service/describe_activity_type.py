"""Generated from Smithy shape ``com.amazonaws.swf#DescribeActivityType``."""
...
import capo_swf.types.activity_type_configuration
...
def handle_response(
    ...
    out: capo_swf.types.activity_type_detail.ActivityTypeDetail = (
        capo_swf.types.activity_type_detail.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.describe_activity_type_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_activity_type(
    ...
    input_: capo_swf.types.describe_activity_type_input.DescribeActivityTypeInput,
) -> tuple[capo_swf.types.activity_type_detail.ActivityTypeDetail, zapros.Response]:
...
async def async_describe_activity_type(
