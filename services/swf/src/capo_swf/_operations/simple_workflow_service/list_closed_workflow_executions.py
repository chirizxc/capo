"""Generated from Smithy shape ``com.amazonaws.swf#ListClosedWorkflowExecutions``."""
...
def handle_response(
    ...
    out: capo_swf.types.workflow_execution_infos.WorkflowExecutionInfos = (
        capo_swf.types.workflow_execution_infos.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.list_closed_workflow_executions_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def list_closed_workflow_executions(
    ...
    capo_swf.types.workflow_execution_infos.WorkflowExecutionInfos, zapros.Response
]:
...
async def async_list_closed_workflow_executions(
