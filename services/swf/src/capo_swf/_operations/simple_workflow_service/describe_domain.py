"""Generated from Smithy shape ``com.amazonaws.swf#DescribeDomain``."""
...
def handle_response(
    ...
    out: capo_swf.types.domain_detail.DomainDetail = (
        capo_swf.types.domain_detail.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.describe_domain_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_domain(
    ...
    input_: capo_swf.types.describe_domain_input.DescribeDomainInput,
) -> tuple[capo_swf.types.domain_detail.DomainDetail, zapros.Response]:
