"""Generated from Smithy shape ``com.amazonaws.swf#DeleteWorkflowType``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SimpleWorkflowService.DeleteWorkflowType"
    body: bytes | None = json.dumps(
        capo_swf.types.delete_workflow_type_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_workflow_type(
