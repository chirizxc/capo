...
def handle_response(
    ...
    out: capo_swf.types.domain_infos.DomainInfos = (
        capo_swf.types.domain_infos.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.list_domains_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_domains(
    ...
    input_: capo_swf.types.list_domains_input.ListDomainsInput,
) -> tuple[capo_swf.types.domain_infos.DomainInfos, zapros.Response]:
