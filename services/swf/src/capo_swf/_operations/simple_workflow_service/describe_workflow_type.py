...
def handle_response(
    ...
    out: capo_swf.types.workflow_type_detail.WorkflowTypeDetail = (
        capo_swf.types.workflow_type_detail.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.describe_workflow_type_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_workflow_type(
    ...
    input_: capo_swf.types.describe_workflow_type_input.DescribeWorkflowTypeInput,
) -> tuple[capo_swf.types.workflow_type_detail.WorkflowTypeDetail, zapros.Response]:
