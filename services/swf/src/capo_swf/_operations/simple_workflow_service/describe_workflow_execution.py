"""Generated from Smithy shape ``com.amazonaws.swf#DescribeWorkflowExecution``."""
...
def handle_response(
    ...
    out: capo_swf.types.workflow_execution_detail.WorkflowExecutionDetail = (
        capo_swf.types.workflow_execution_detail.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.describe_workflow_execution_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def describe_workflow_execution(
    ...
    capo_swf.types.workflow_execution_detail.WorkflowExecutionDetail, zapros.Response
]:
...
async def async_describe_workflow_execution(
