"""Generated from Smithy shape ``com.amazonaws.swf#UndeprecateWorkflowType``."""
...
import capo_swf.errors.type_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TypeAlreadyExistsFault":
            raise capo_swf.errors.type_already_exists_fault.TypeAlreadyExistsFault.from_aws_json_1_0(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_swf.types.undeprecate_workflow_type_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_undeprecate_workflow_type(
