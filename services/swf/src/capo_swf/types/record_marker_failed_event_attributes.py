...
class RecordMarkerFailedEventAttributes(TypedDict, closed=True):
    ...
    cause: "capo_swf.types.record_marker_failed_cause.RecordMarkerFailedCause"
...
def serialize_aws_json_1_0(value: RecordMarkerFailedEventAttributes) -> dict:
    ...
    out["cause"] = capo_swf.types.record_marker_failed_cause.serialize_aws_json_1_0(
        value["cause"]
    )
...
def deserialize_aws_json_1_0(data: dict) -> RecordMarkerFailedEventAttributes:
    ...
    if data.get("cause") is not None:
        ...
        out["cause"] = (
            capo_swf.types.record_marker_failed_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    else:
