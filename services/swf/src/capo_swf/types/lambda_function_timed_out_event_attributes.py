...
class LambdaFunctionTimedOutEventAttributes(TypedDict, closed=True):
    ...
    timeout_type: NotRequired[
        "capo_swf.types.lambda_function_timeout_type.LambdaFunctionTimeoutType"
    ]
...
def serialize_aws_json_1_0(value: LambdaFunctionTimedOutEventAttributes) -> dict:
    ...
    if "timeout_type" in value:
        ...
        out["timeoutType"] = (
            capo_swf.types.lambda_function_timeout_type.serialize_aws_json_1_0(
                value["timeout_type"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> LambdaFunctionTimedOutEventAttributes:
    ...
    if data.get("timeoutType") is not None:
        ...
        out["timeout_type"] = (
            capo_swf.types.lambda_function_timeout_type.deserialize_aws_json_1_0(
                data["timeoutType"]
            )
        )
    return out
