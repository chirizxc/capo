...
if TYPE_CHECKING:
    ...
    import capo_swf.types.function_input
    import capo_swf.types.function_name


class LambdaFunctionScheduledEventAttributes(TypedDict, closed=True):
    ...
    input: NotRequired["capo_swf.types.function_input.FunctionInput"]
