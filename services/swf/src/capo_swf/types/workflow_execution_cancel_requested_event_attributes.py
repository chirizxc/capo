...
class WorkflowExecutionCancelRequestedEventAttributes(TypedDict, closed=True):
    ...
    external_initiated_event_id: "capo_swf.types.event_id.EventId"
    ...
    cause: NotRequired[
        "capo_swf.types.workflow_execution_cancel_requested_cause.WorkflowExecutionCancelRequestedCause"
    ]
...
def serialize_aws_json_1_0(
    ...
    if "cause" in value:
        ...
        out["cause"] = (
            capo_swf.types.workflow_execution_cancel_requested_cause.serialize_aws_json_1_0(
                value["cause"]
            )
        )
    return out
...
def deserialize_aws_json_1_0(
    ...
    if data.get("cause") is not None:
        ...
        out["cause"] = (
            capo_swf.types.workflow_execution_cancel_requested_cause.deserialize_aws_json_1_0(
                data["cause"]
            )
        )
    return out
