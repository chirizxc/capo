...
if TYPE_CHECKING:
    import capo_codeguru_security.types.header_key
    import capo_codeguru_security.types.header_value

RequestHeaderMap: TypeAlias = dict[
    "capo_codeguru_security.types.header_key.HeaderKey",
    "capo_codeguru_security.types.header_value.HeaderValue",
]
