...
class ListFindingsMetricsResponse(TypedDict, closed=True):
    findings_metrics: NotRequired[
        "capo_codeguru_security.types.findings_metric_list.FindingsMetricList"
    ]
...
def serialize_json(value: ListFindingsMetricsResponse) -> dict:
    ...
    if "findings_metrics" in value:
        ...
        out["findingsMetrics"] = (
            capo_codeguru_security.types.findings_metric_list.serialize_json(
...
def deserialize_json(data: dict) -> ListFindingsMetricsResponse:
    ...
    if data.get("findingsMetrics") is not None:
        ...
        out["findings_metrics"] = (
            capo_codeguru_security.types.findings_metric_list.deserialize_json(
