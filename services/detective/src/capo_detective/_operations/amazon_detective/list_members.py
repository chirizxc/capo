...
def handle_response(
    ...
    out: capo_detective.types.list_members_response.ListMembersResponse = (
        capo_detective.types.list_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_detective.types.list_members_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_members(
    ...
    capo_detective.types.list_members_response.ListMembersResponse, zapros.Response
]:
