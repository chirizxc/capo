"""Generated from Smithy shape ``com.amazonaws.detective#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_detective.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_detective.types.list_tags_for_resource_response.deserialize_json(
