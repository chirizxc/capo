...
def handle_response(
    ...
    out: capo_detective.types.list_graphs_response.ListGraphsResponse = (
        capo_detective.types.list_graphs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_detective.types.list_graphs_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def list_graphs(
    ...
    capo_detective.types.list_graphs_response.ListGraphsResponse, zapros.Response
]:
