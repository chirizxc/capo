...
def handle_response(
    ...
    out: capo_detective.types.batch_get_membership_datasources_response.BatchGetMembershipDatasourcesResponse = capo_detective.types.batch_get_membership_datasources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_detective.types.batch_get_membership_datasources_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
