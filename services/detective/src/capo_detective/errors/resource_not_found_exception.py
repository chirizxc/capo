"""Generated from Smithy shape ``com.amazonaws.detective#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.detective#ResourceNotFoundException``."""
