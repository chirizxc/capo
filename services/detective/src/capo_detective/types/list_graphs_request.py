"""Generated from Smithy shape ``com.amazonaws.detective#ListGraphsRequest``."""
...
class ListGraphsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListGraphsRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListGraphsRequest:
    out: ListGraphsRequest = {}  # type: ignore[typeddict-item]
