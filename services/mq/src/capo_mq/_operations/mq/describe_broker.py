"""Generated from Smithy shape ``com.amazonaws.mq#DescribeBroker``."""
...
def handle_response(
    ...
    out: capo_mq.types.describe_broker_response.DescribeBrokerResponse = (
        capo_mq.types.describe_broker_response.deserialize_json(
...
def describe_broker(
    ...
    capo_mq.types.describe_broker_response.DescribeBrokerResponse, zapros.Response
]:
...
async def async_describe_broker(
