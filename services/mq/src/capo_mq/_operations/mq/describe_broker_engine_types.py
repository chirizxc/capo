...
def handle_response(
    ...
    out: capo_mq.types.describe_broker_engine_types_response.DescribeBrokerEngineTypesResponse = capo_mq.types.describe_broker_engine_types_response.deserialize_json(
