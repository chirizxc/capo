...
def handle_response(
    ...
    out: capo_mq.types.reboot_broker_response.RebootBrokerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def reboot_broker(
    ...
    input_: capo_mq.types.reboot_broker_request.RebootBrokerRequest,
) -> tuple[capo_mq.types.reboot_broker_response.RebootBrokerResponse, zapros.Response]:
