"""Generated from Smithy shape ``com.amazonaws.mq#DeleteConfiguration``."""
...
def handle_response(
    ...
    out: capo_mq.types.delete_configuration_response.DeleteConfigurationResponse = (
        capo_mq.types.delete_configuration_response.deserialize_json(
