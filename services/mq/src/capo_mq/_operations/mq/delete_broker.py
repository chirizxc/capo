...
def handle_response(
    ...
    out: capo_mq.types.delete_broker_response.DeleteBrokerResponse = (
        capo_mq.types.delete_broker_response.deserialize_json(
...
def delete_broker(
    ...
    input_: capo_mq.types.delete_broker_request.DeleteBrokerRequest,
) -> tuple[capo_mq.types.delete_broker_response.DeleteBrokerResponse, zapros.Response]:
