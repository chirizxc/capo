"""Generated from Smithy shape ``com.amazonaws.mq#CreateBroker``."""
...
import capo_mq.errors.unauthorized_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnauthorizedException":
            raise capo_mq.errors.unauthorized_exception.UnauthorizedException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_mq.types.create_broker_response.CreateBrokerResponse = (
        capo_mq.types.create_broker_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mq.types.create_broker_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_broker(
    ...
    input_: capo_mq.types.create_broker_request.CreateBrokerRequest,
) -> tuple[capo_mq.types.create_broker_response.CreateBrokerResponse, zapros.Response]:
