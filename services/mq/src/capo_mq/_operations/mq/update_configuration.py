...
def handle_response(
    ...
    out: capo_mq.types.update_configuration_response.UpdateConfigurationResponse = (
        capo_mq.types.update_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mq.types.update_configuration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
