"""Generated from Smithy shape ``com.amazonaws.mq#ListTags``."""
...
def handle_response(
    ...
    out: capo_mq.types.list_tags_response.ListTagsResponse = (
        capo_mq.types.list_tags_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_mq.types.list_tags_response.ListTagsResponse = (
        capo_mq.types.list_tags_response.deserialize_json(
...
def list_tags(
    options: OperationOptions, input_: capo_mq.types.list_tags_request.ListTagsRequest
) -> tuple[capo_mq.types.list_tags_response.ListTagsResponse, zapros.Response]:
