...
def handle_response(
    ...
    out: capo_mq.types.create_user_response.CreateUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{Username}", quote(input_["username"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_mq.types.create_user_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_user(
    ...
    input_: capo_mq.types.create_user_request.CreateUserRequest,
) -> tuple[capo_mq.types.create_user_response.CreateUserResponse, zapros.Response]:
