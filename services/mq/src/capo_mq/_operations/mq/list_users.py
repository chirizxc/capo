...
def handle_response(
    ...
    out: capo_mq.types.list_users_response.ListUsersResponse = (
        capo_mq.types.list_users_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_mq.types.list_users_response.ListUsersResponse = (
        capo_mq.types.list_users_response.deserialize_json(
...
def list_users(
    options: OperationOptions, input_: capo_mq.types.list_users_request.ListUsersRequest
) -> tuple[capo_mq.types.list_users_response.ListUsersResponse, zapros.Response]:
