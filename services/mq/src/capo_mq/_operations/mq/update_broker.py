"""Generated from Smithy shape ``com.amazonaws.mq#UpdateBroker``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_mq.errors.conflict_exception.ConflictException.from_json(
                data, message
            )
        ...
        case "NotFoundException":
            raise capo_mq.errors.not_found_exception.NotFoundException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_mq.types.update_broker_response.UpdateBrokerResponse = (
        capo_mq.types.update_broker_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{BrokerId}", quote(input_["broker_id"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_mq.types.update_broker_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_broker(
    ...
    input_: capo_mq.types.update_broker_request.UpdateBrokerRequest,
) -> tuple[capo_mq.types.update_broker_response.UpdateBrokerResponse, zapros.Response]:
