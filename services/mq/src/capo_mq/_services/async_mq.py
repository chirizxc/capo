...
from capo_mq._services._aws_config import aaws_config
...
class AsyncmqClientConfig(TypedDict, total=False, closed=True):
...
class AsyncmqClient:
    ...
    def __init__(
        ...
        self._config = AsyncmqClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncmqClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncmqClientConfig = config_overrides or {}
    ...
    async def create_broker(
        self,
        *,
        config_overrides: Optional[AsyncmqClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.create_broker_request.CreateBrokerRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.create_broker_response.CreateBrokerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.create_broker.async_create_broker(
    ...
    async def create_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.create_configuration_request.CreateConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.create_configuration_response.CreateConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.create_configuration.async_create_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.create_tags_request.CreateTagsRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.create_tags.async_create_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.create_user_request.CreateUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.create_user_response.CreateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.create_user.async_create_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_broker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.delete_broker_request.DeleteBrokerRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.delete_broker_response.DeleteBrokerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.delete_broker.async_delete_broker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.delete_configuration_request.DeleteConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.delete_configuration_response.DeleteConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.delete_configuration.async_delete_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.delete_tags_request.DeleteTagsRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.delete_tags.async_delete_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.delete_user_request.DeleteUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.delete_user_response.DeleteUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.delete_user.async_delete_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_broker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.describe_broker_request.DescribeBrokerRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.describe_broker_response.DescribeBrokerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.describe_broker.async_describe_broker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_broker_engine_types(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.describe_broker_engine_types_request.DescribeBrokerEngineTypesRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.describe_broker_engine_types_response.DescribeBrokerEngineTypesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.describe_broker_engine_types.async_describe_broker_engine_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_broker_instance_options(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.describe_broker_instance_options_request.DescribeBrokerInstanceOptionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.describe_broker_instance_options_response.DescribeBrokerInstanceOptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.describe_broker_instance_options.async_describe_broker_instance_options(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.describe_configuration_request.DescribeConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.describe_configuration_response.DescribeConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.describe_configuration.async_describe_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_configuration_revision(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.describe_configuration_revision_request.DescribeConfigurationRevisionRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.describe_configuration_revision_response.DescribeConfigurationRevisionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.describe_configuration_revision.async_describe_configuration_revision(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.describe_user_request.DescribeUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.describe_user_response.DescribeUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.describe_user.async_describe_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_brokers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.list_brokers_request.ListBrokersRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.list_brokers_response.ListBrokersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.list_brokers.async_list_brokers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_brokers(
        ...
        *,
        ...
        max_results: Optional["capo_mq.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_mq.types.__string.__string"] = None,
    ) -> "AsyncIterator[capo_mq.types.broker_summary.BrokerSummary]":
        _token = next_token
        while True:
            _response = await self.list_brokers(
    ...
    async def list_configuration_revisions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.list_configuration_revisions_request.ListConfigurationRevisionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.list_configuration_revisions_response.ListConfigurationRevisionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.list_configuration_revisions.async_list_configuration_revisions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.list_configurations_request.ListConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.list_configurations_response.ListConfigurationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.list_configurations.async_list_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.list_tags_request.ListTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.list_tags_response.ListTagsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.list_tags.async_list_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_users(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.list_users_request.ListUsersRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.list_users_response.ListUsersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.list_users.async_list_users(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def promote(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.promote_request.PromoteRequest]",
        ) -> AsyncOperationResponse["capo_mq.types.promote_response.PromoteResponse"]:
            import capo_mq._operations.mq.promote

            output, http_response = await capo_mq._operations.mq.promote.async_promote(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reboot_broker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.reboot_broker_request.RebootBrokerRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.reboot_broker_response.RebootBrokerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.reboot_broker.async_reboot_broker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_broker(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.update_broker_request.UpdateBrokerRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.update_broker_response.UpdateBrokerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.update_broker.async_update_broker(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.update_configuration_request.UpdateConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.update_configuration_response.UpdateConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.update_configuration.async_update_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mq.types.update_user_request.UpdateUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_mq.types.update_user_response.UpdateUserResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mq._operations.mq.update_user.async_update_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
