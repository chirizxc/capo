"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationdiscoveryservice#ResourceNotFoundException``."""
