...
if TYPE_CHECKING:
    import capo_application_discovery_service.types.import_task_filter_value

ImportTaskFilterValueList: TypeAlias = list[
    "capo_application_discovery_service.types.import_task_filter_value.ImportTaskFilterValue"
]
