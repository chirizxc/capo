...
class AgentConfigurationStatus(TypedDict, closed=True):
    agent_id: NotRequired["capo_application_discovery_service.types.string.String"]
    """<p>The agent ID.</p>"""
    operation_succeeded: "capo_application_discovery_service.types.boolean.Boolean"
    ...
    description: NotRequired["capo_application_discovery_service.types.string.String"]
