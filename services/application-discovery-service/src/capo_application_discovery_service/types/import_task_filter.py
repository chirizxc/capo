...
class ImportTaskFilter(TypedDict, closed=True):
    name: NotRequired[
        "capo_application_discovery_service.types.import_task_filter_name.ImportTaskFilterName"
    ]
    """<p>The name, status, or import task ID for a specific import task.</p>"""
    values: NotRequired[
        "capo_application_discovery_service.types.import_task_filter_value_list.ImportTaskFilterValueList"
    ]
...
def serialize_aws_json_1_1(value: ImportTaskFilter) -> dict:
    ...
    if "name" in value:
        ...
        out["name"] = (
            capo_application_discovery_service.types.import_task_filter_name.serialize_aws_json_1_1(
                value["name"]
            )
        )
    if "values" in value:
        ...
        out["values"] = (
            capo_application_discovery_service.types.import_task_filter_value_list.serialize_aws_json_1_1(
                value["values"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ImportTaskFilter:
    ...
    if data.get("name") is not None:
        ...
        out["name"] = (
            capo_application_discovery_service.types.import_task_filter_name.deserialize_aws_json_1_1(
                data["name"]
            )
        )
    if data.get("values") is not None:
        ...
        out["values"] = (
            capo_application_discovery_service.types.import_task_filter_value_list.deserialize_aws_json_1_1(
                data["values"]
            )
        )
    return out
