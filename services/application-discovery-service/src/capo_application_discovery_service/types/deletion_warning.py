...
if TYPE_CHECKING:
    ...
    import capo_application_discovery_service.types.warning_code
    import capo_application_discovery_service.types.warning_text
...
class DeletionWarning(TypedDict, closed=True):
    ...
    warning_code: "capo_application_discovery_service.types.warning_code.WarningCode"
    """<p> The integer warning code associated with the warning message. </p>"""
    warning_text: NotRequired[
        "capo_application_discovery_service.types.warning_text.WarningText"
    ]
