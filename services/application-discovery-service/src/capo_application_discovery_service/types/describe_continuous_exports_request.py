...
def serialize_aws_json_1_1(value: DescribeContinuousExportsRequest) -> dict:
    ...
    if "export_ids" in value:
        ...
        out["exportIds"] = (
            capo_application_discovery_service.types.continuous_export_ids.serialize_aws_json_1_1(
                value["export_ids"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeContinuousExportsRequest:
    ...
    if data.get("exportIds") is not None:
        ...
        out["export_ids"] = (
            capo_application_discovery_service.types.continuous_export_ids.deserialize_aws_json_1_1(
                data["exportIds"]
            )
        )
