...
if TYPE_CHECKING:
    import capo_application_discovery_service.types.failed_configuration

FailedConfigurationList: TypeAlias = list[
    "capo_application_discovery_service.types.failed_configuration.FailedConfiguration"
]
...
def serialize_aws_json_1_1(value: FailedConfigurationList) -> list:
    ...
    for item in value:
        out.append(
            capo_application_discovery_service.types.failed_configuration.serialize_aws_json_1_1(
                item
            )
        )
    return out
