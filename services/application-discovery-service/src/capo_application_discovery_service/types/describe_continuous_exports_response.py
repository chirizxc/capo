...
class DescribeContinuousExportsResponse(TypedDict, closed=True):
    descriptions: NotRequired[
        "capo_application_discovery_service.types.continuous_export_descriptions.ContinuousExportDescriptions"
    ]
...
def serialize_aws_json_1_1(value: DescribeContinuousExportsResponse) -> dict:
    ...
    if "descriptions" in value:
        ...
        out["descriptions"] = (
            capo_application_discovery_service.types.continuous_export_descriptions.serialize_aws_json_1_1(
                value["descriptions"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeContinuousExportsResponse:
    ...
    if data.get("descriptions") is not None:
        ...
        out["descriptions"] = (
            capo_application_discovery_service.types.continuous_export_descriptions.deserialize_aws_json_1_1(
                data["descriptions"]
            )
        )
