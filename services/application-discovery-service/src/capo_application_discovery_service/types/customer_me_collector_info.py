...
class CustomerMeCollectorInfo(TypedDict, closed=True):
    active_me_collectors: "capo_application_discovery_service.types.integer.Integer"
    """<p> The number of active Migration Evaluator collectors. </p>"""
    healthy_me_collectors: "capo_application_discovery_service.types.integer.Integer"
    ...
    shutdown_me_collectors: "capo_application_discovery_service.types.integer.Integer"
    """<p> The number of Migration Evaluator collectors with <code>SHUTDOWN</code> status. </p>"""
    unhealthy_me_collectors: "capo_application_discovery_service.types.integer.Integer"
    """<p> The number of unhealthy Migration Evaluator collectors. </p>"""
    total_me_collectors: "capo_application_discovery_service.types.integer.Integer"
    """<p> The total number of Migration Evaluator collectors. </p>"""
    unknown_me_collectors: "capo_application_discovery_service.types.integer.Integer"
