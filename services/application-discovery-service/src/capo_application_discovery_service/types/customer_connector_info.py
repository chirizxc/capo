...
class CustomerConnectorInfo(TypedDict, closed=True):
    active_connectors: "capo_application_discovery_service.types.integer.Integer"
    """<p>Number of active discovery connectors.</p>"""
    healthy_connectors: "capo_application_discovery_service.types.integer.Integer"
    """<p>Number of healthy discovery connectors.</p>"""
    black_listed_connectors: "capo_application_discovery_service.types.integer.Integer"
    """<p>Number of blacklisted discovery connectors.</p>"""
    shutdown_connectors: "capo_application_discovery_service.types.integer.Integer"
    """<p>Number of discovery connectors with status SHUTDOWN,</p>"""
    unhealthy_connectors: "capo_application_discovery_service.types.integer.Integer"
    """<p>Number of unhealthy discovery connectors.</p>"""
    total_connectors: "capo_application_discovery_service.types.integer.Integer"
    """<p>Total number of discovery connectors.</p>"""
    unknown_connectors: "capo_application_discovery_service.types.integer.Integer"
