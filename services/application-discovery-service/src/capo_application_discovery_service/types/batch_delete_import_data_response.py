...
class BatchDeleteImportDataResponse(TypedDict, closed=True):
    errors: NotRequired[
        "capo_application_discovery_service.types.batch_delete_import_data_error_list.BatchDeleteImportDataErrorList"
    ]
...
def serialize_aws_json_1_1(value: BatchDeleteImportDataResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            capo_application_discovery_service.types.batch_delete_import_data_error_list.serialize_aws_json_1_1(
                value["errors"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> BatchDeleteImportDataResponse:
    ...
    if data.get("errors") is not None:
        ...
        out["errors"] = (
            capo_application_discovery_service.types.batch_delete_import_data_error_list.deserialize_aws_json_1_1(
                data["errors"]
            )
        )
    return out
