...
def handle_response(
    ...
    out: capo_application_discovery_service.types.describe_agents_response.DescribeAgentsResponse = capo_application_discovery_service.types.describe_agents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.describe_agents_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
