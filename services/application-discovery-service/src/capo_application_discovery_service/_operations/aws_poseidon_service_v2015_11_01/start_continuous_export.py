...
import capo_application_discovery_service.errors.conflict_error_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictErrorException":
            raise capo_application_discovery_service.errors.conflict_error_exception.ConflictErrorException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.start_continuous_export_response.StartContinuousExportResponse = capo_application_discovery_service.types.start_continuous_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.start_continuous_export_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
