...
def handle_response(
    ...
    out: capo_application_discovery_service.types.stop_continuous_export_response.StopContinuousExportResponse = capo_application_discovery_service.types.stop_continuous_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.stop_continuous_export_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
