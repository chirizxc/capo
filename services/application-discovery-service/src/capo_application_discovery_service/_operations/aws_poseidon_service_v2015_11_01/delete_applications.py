...
def handle_response(
    ...
    out: capo_application_discovery_service.types.delete_applications_response.DeleteApplicationsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.delete_applications_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
