"""Generated from Smithy shape ``com.amazonaws.applicationdiscoveryservice#DescribeImportTasks``."""
...
def handle_response(
    ...
    out: capo_application_discovery_service.types.describe_import_tasks_response.DescribeImportTasksResponse = capo_application_discovery_service.types.describe_import_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.describe_import_tasks_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_import_tasks(
