...
def handle_response(
    ...
    out: capo_application_discovery_service.types.describe_export_configurations_response.DescribeExportConfigurationsResponse = capo_application_discovery_service.types.describe_export_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_discovery_service.types.describe_export_configurations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
