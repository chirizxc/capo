"""Generated from Smithy shape ``com.amazonaws.lookoutequipment#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lookoutequipment#ThrottlingException``."""
