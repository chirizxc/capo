...
if TYPE_CHECKING:
    ...
    import capo_lookoutequipment.types.time_zone_offset


class InferenceInputConfiguration(TypedDict, closed=True):
    s3_input_configuration: NotRequired[
        "capo_lookoutequipment.types.inference_s3_input_configuration.InferenceS3InputConfiguration"
    ]
    ...
    input_time_zone_offset: NotRequired[
        "capo_lookoutequipment.types.time_zone_offset.TimeZoneOffset"
    ]
    ...
    inference_input_name_configuration: NotRequired[
        "capo_lookoutequipment.types.inference_input_name_configuration.InferenceInputNameConfiguration"
    ]
...
def serialize_aws_json_1_0(value: InferenceInputConfiguration) -> dict:
    ...
    if "s3_input_configuration" in value:
        ...
        out["S3InputConfiguration"] = (
            capo_lookoutequipment.types.inference_s3_input_configuration.serialize_aws_json_1_0(
    ...
    if "inference_input_name_configuration" in value:
        ...
        out["InferenceInputNameConfiguration"] = (
            capo_lookoutequipment.types.inference_input_name_configuration.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> InferenceInputConfiguration:
    ...
    if data.get("S3InputConfiguration") is not None:
        ...
        out["s3_input_configuration"] = (
            capo_lookoutequipment.types.inference_s3_input_configuration.deserialize_aws_json_1_0(
    ...
    if data.get("InferenceInputNameConfiguration") is not None:
        ...
        out["inference_input_name_configuration"] = (
            capo_lookoutequipment.types.inference_input_name_configuration.deserialize_aws_json_1_0(
