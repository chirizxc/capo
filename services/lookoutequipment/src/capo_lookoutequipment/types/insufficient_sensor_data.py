...
class InsufficientSensorData(TypedDict, closed=True):
    missing_complete_sensor_data: "capo_lookoutequipment.types.missing_complete_sensor_data.MissingCompleteSensorData"
    """<p> Parameter that describes the total number of sensors that have data completely missing for it. </p>"""
    sensors_with_short_date_range: "capo_lookoutequipment.types.sensors_with_short_date_range.SensorsWithShortDateRange"
...
def serialize_aws_json_1_0(value: InsufficientSensorData) -> dict:
    ...
    out["MissingCompleteSensorData"] = (
        capo_lookoutequipment.types.missing_complete_sensor_data.serialize_aws_json_1_0(
    ...
    out["SensorsWithShortDateRange"] = (
        capo_lookoutequipment.types.sensors_with_short_date_range.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> InsufficientSensorData:
    ...
    if data.get("MissingCompleteSensorData") is not None:
        ...
        out["missing_complete_sensor_data"] = (
            capo_lookoutequipment.types.missing_complete_sensor_data.deserialize_aws_json_1_0(
    ...
    if data.get("SensorsWithShortDateRange") is not None:
        ...
        out["sensors_with_short_date_range"] = (
            capo_lookoutequipment.types.sensors_with_short_date_range.deserialize_aws_json_1_0(
