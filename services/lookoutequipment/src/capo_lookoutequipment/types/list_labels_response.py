...
class ListLabelsResponse(TypedDict, closed=True):
    ...
    label_summaries: NotRequired[
        "capo_lookoutequipment.types.label_summaries.LabelSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListLabelsResponse) -> dict:
    ...
    if "label_summaries" in value:
        ...
        out["LabelSummaries"] = (
            capo_lookoutequipment.types.label_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListLabelsResponse:
    ...
    if data.get("LabelSummaries") is not None:
        import capo_lookoutequipment.types.label_summaries

        out["label_summaries"] = (
            capo_lookoutequipment.types.label_summaries.deserialize_aws_json_1_0(
                data["LabelSummaries"]
            )
        )
    return out
