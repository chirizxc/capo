...
class ListModelsResponse(TypedDict, closed=True):
    ...
    model_summaries: NotRequired[
        "capo_lookoutequipment.types.model_summaries.ModelSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListModelsResponse) -> dict:
    ...
    if "model_summaries" in value:
        ...
        out["ModelSummaries"] = (
            capo_lookoutequipment.types.model_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListModelsResponse:
    ...
    if data.get("ModelSummaries") is not None:
        ...
        out["model_summaries"] = (
            capo_lookoutequipment.types.model_summaries.deserialize_aws_json_1_0(
                data["ModelSummaries"]
            )
        )
    return out
