...
class ListInferenceExecutionsResponse(TypedDict, closed=True):
    ...
    inference_execution_summaries: NotRequired[
        "capo_lookoutequipment.types.inference_execution_summaries.InferenceExecutionSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListInferenceExecutionsResponse) -> dict:
    ...
    if "inference_execution_summaries" in value:
        ...
        out["InferenceExecutionSummaries"] = (
            capo_lookoutequipment.types.inference_execution_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListInferenceExecutionsResponse:
    ...
    if data.get("InferenceExecutionSummaries") is not None:
        ...
        out["inference_execution_summaries"] = (
            capo_lookoutequipment.types.inference_execution_summaries.deserialize_aws_json_1_0(
