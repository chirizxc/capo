"""Generated from Smithy shape ``com.amazonaws.ioteventsdata#AcknowledgeAlarmActionRequest``."""
...
class AcknowledgeAlarmActionRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: AcknowledgeAlarmActionRequest) -> dict:
    out: dict = {}
