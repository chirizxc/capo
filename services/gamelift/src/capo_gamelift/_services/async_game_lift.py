...
class AsyncGameLiftClient:
    ...
    async def iter_describe_fleet_location_attributes(
        self,
        *,
        config_overrides: Optional[AsyncGameLiftClientConfig] = None,
        fleet_id: Optional["capo_gamelift.types.fleet_id_or_arn.FleetIdOrArn"] = None,
    ...
    ) -> "AsyncIterator[capo_gamelift.types.describe_fleet_location_attributes_output.DescribeFleetLocationAttributesOutput]":
        _token = next_token
        while True:
            _response = await self.describe_fleet_location_attributes(
                config_overrides=config_overrides,
                fleet_id=fleet_id,
                locations=locations,
                limit=limit,
