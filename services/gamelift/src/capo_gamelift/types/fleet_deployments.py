...
def serialize_aws_json_1_1(value: FleetDeployments) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_gamelift.types.fleet_deployment.serialize_aws_json_1_1(item))
    return out
...
def deserialize_aws_json_1_1(data: list) -> FleetDeployments:
    ...
    for item in data:
        if item is None:
            continue
        out.append(capo_gamelift.types.fleet_deployment.deserialize_aws_json_1_1(item))
    return out
