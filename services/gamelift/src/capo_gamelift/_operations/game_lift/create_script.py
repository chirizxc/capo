...
def handle_response(
    ...
    out: capo_gamelift.types.create_script_output.CreateScriptOutput = (
        capo_gamelift.types.create_script_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_script_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_script(
    ...
    capo_gamelift.types.create_script_output.CreateScriptOutput, zapros.Response
]:
