"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateContainerFleet``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.create_container_fleet_output.CreateContainerFleetOutput = capo_gamelift.types.create_container_fleet_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.CreateContainerFleet"
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_container_fleet_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_container_fleet(
