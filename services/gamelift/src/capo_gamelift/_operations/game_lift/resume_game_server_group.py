"""Generated from Smithy shape ``com.amazonaws.gamelift#ResumeGameServerGroup``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.resume_game_server_group_output.ResumeGameServerGroupOutput = capo_gamelift.types.resume_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.ResumeGameServerGroup"
    body: bytes | None = json.dumps(
        capo_gamelift.types.resume_game_server_group_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_resume_game_server_group(
