"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeVpcPeeringAuthorizations``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_vpc_peering_authorizations_output.DescribeVpcPeeringAuthorizationsOutput = capo_gamelift.types.describe_vpc_peering_authorizations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_vpc_peering_authorizations_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_vpc_peering_authorizations(
