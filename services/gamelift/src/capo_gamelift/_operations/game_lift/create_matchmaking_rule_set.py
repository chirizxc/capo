"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateMatchmakingRuleSet``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.create_matchmaking_rule_set_output.CreateMatchmakingRuleSetOutput = capo_gamelift.types.create_matchmaking_rule_set_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_matchmaking_rule_set_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_matchmaking_rule_set(
