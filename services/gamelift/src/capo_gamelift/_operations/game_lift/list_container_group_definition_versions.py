"""Generated from Smithy shape ``com.amazonaws.gamelift#ListContainerGroupDefinitionVersions``."""
...
import capo_gamelift._protocol.eventstream
...
def handle_response(
    ...
    out: capo_gamelift.types.list_container_group_definition_versions_output.ListContainerGroupDefinitionVersionsOutput = capo_gamelift.types.list_container_group_definition_versions_output.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_gamelift._auth._sigv4.build_sigv4_auth_scheme(
                "gamelift", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.ListContainerGroupDefinitionVersions"
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_container_group_definition_versions_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_container_group_definition_versions(
