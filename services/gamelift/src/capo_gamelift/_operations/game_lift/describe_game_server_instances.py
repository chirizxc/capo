...
def handle_response(
    ...
    out: capo_gamelift.types.describe_game_server_instances_output.DescribeGameServerInstancesOutput = capo_gamelift.types.describe_game_server_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_game_server_instances_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
