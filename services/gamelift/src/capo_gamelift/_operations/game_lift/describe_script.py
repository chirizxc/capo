...
def handle_response(
    ...
    out: capo_gamelift.types.describe_script_output.DescribeScriptOutput = (
        capo_gamelift.types.describe_script_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_script_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_script(
    ...
    capo_gamelift.types.describe_script_output.DescribeScriptOutput, zapros.Response
]:
