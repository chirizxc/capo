"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeContainerGroupPortMappings``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_container_group_port_mappings_output.DescribeContainerGroupPortMappingsOutput = capo_gamelift.types.describe_container_group_port_mappings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.DescribeContainerGroupPortMappings"
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_container_group_port_mappings_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_container_group_port_mappings(
