"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeFleetPortSettings``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_fleet_port_settings_output.DescribeFleetPortSettingsOutput = capo_gamelift.types.describe_fleet_port_settings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_fleet_port_settings_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_fleet_port_settings(
