...
def handle_response(
    ...
    out: capo_gamelift.types.accept_match_output.AcceptMatchOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.accept_match_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def accept_match(
    ...
    input_: capo_gamelift.types.accept_match_input.AcceptMatchInput,
) -> tuple[capo_gamelift.types.accept_match_output.AcceptMatchOutput, zapros.Response]:
