...
def handle_response(
    ...
    out: capo_gamelift.types.create_alias_output.CreateAliasOutput = (
        capo_gamelift.types.create_alias_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_alias_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_alias(
    ...
    input_: capo_gamelift.types.create_alias_input.CreateAliasInput,
) -> tuple[capo_gamelift.types.create_alias_output.CreateAliasOutput, zapros.Response]:
