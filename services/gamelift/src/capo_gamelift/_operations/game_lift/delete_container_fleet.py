"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteContainerFleet``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.delete_container_fleet_output.DeleteContainerFleetOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.DeleteContainerFleet"
    body: bytes | None = json.dumps(
        capo_gamelift.types.delete_container_fleet_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_container_fleet(
