"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateMatchmakingConfiguration``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.create_matchmaking_configuration_output.CreateMatchmakingConfigurationOutput = capo_gamelift.types.create_matchmaking_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_matchmaking_configuration_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_matchmaking_configuration(
