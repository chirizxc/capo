...
def handle_response(
    ...
    out: capo_gamelift.types.create_build_output.CreateBuildOutput = (
        capo_gamelift.types.create_build_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_build_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_build(
    ...
    input_: capo_gamelift.types.create_build_input.CreateBuildInput,
) -> tuple[capo_gamelift.types.create_build_output.CreateBuildOutput, zapros.Response]:
