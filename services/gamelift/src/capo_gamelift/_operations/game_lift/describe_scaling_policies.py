"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeScalingPolicies``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_scaling_policies_output.DescribeScalingPoliciesOutput = capo_gamelift.types.describe_scaling_policies_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_scaling_policies_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
