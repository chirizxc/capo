...
def handle_response(
    ...
    out: capo_gamelift.types.describe_alias_output.DescribeAliasOutput = (
        capo_gamelift.types.describe_alias_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_alias_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_alias(
    ...
    capo_gamelift.types.describe_alias_output.DescribeAliasOutput, zapros.Response
]:
