"""Generated from Smithy shape ``com.amazonaws.gamelift#ListContainerGroupDefinitions``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.list_container_group_definitions_output.ListContainerGroupDefinitionsOutput = capo_gamelift.types.list_container_group_definitions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.ListContainerGroupDefinitions"
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_container_group_definitions_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_container_group_definitions(
