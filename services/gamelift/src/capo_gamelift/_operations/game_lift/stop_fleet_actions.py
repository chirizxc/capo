...
def handle_response(
    ...
    out: capo_gamelift.types.stop_fleet_actions_output.StopFleetActionsOutput = (
        capo_gamelift.types.stop_fleet_actions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.stop_fleet_actions_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
