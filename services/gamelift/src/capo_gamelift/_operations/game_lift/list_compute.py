...
import capo_gamelift.types.compute_list
...
def handle_response(
    ...
    out: capo_gamelift.types.list_compute_output.ListComputeOutput = (
        capo_gamelift.types.list_compute_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_compute_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_compute(
    ...
    input_: capo_gamelift.types.list_compute_input.ListComputeInput,
) -> tuple[capo_gamelift.types.list_compute_output.ListComputeOutput, zapros.Response]:
