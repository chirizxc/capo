"""Generated from Smithy shape ``com.amazonaws.gamelift#GetComputeAuthToken``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.get_compute_auth_token_output.GetComputeAuthTokenOutput = (
        capo_gamelift.types.get_compute_auth_token_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.GetComputeAuthToken"
    body: bytes | None = json.dumps(
        capo_gamelift.types.get_compute_auth_token_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_compute_auth_token(
