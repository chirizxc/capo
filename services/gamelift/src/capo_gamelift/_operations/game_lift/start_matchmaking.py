"""Generated from Smithy shape ``com.amazonaws.gamelift#StartMatchmaking``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.start_matchmaking_output.StartMatchmakingOutput = (
        capo_gamelift.types.start_matchmaking_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.start_matchmaking_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def start_matchmaking(
    ...
    capo_gamelift.types.start_matchmaking_output.StartMatchmakingOutput, zapros.Response
]:
...
async def async_start_matchmaking(
