...
def handle_response(
    ...
    out: capo_gamelift.types.delete_location_output.DeleteLocationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.delete_location_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_location(
    ...
    capo_gamelift.types.delete_location_output.DeleteLocationOutput, zapros.Response
]:
