"""Generated from Smithy shape ``com.amazonaws.gamelift#CreateGameServerGroup``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.create_game_server_group_output.CreateGameServerGroupOutput = capo_gamelift.types.create_game_server_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.CreateGameServerGroup"
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_game_server_group_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_game_server_group(
