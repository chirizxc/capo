"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteFleetLocations``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.delete_fleet_locations_output.DeleteFleetLocationsOutput = capo_gamelift.types.delete_fleet_locations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.DeleteFleetLocations"
    body: bytes | None = json.dumps(
        capo_gamelift.types.delete_fleet_locations_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_fleet_locations(
