"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateBuild``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_build_output.UpdateBuildOutput = (
        capo_gamelift.types.update_build_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_build_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_build(
    ...
    input_: capo_gamelift.types.update_build_input.UpdateBuildInput,
) -> tuple[capo_gamelift.types.update_build_output.UpdateBuildOutput, zapros.Response]:
