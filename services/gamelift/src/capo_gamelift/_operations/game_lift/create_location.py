...
def handle_response(
    ...
    out: capo_gamelift.types.create_location_output.CreateLocationOutput = (
        capo_gamelift.types.create_location_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_location_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_location(
    ...
    capo_gamelift.types.create_location_output.CreateLocationOutput, zapros.Response
]:
