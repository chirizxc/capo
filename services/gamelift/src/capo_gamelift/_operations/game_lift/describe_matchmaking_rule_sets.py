...
def handle_response(
    ...
    out: capo_gamelift.types.describe_matchmaking_rule_sets_output.DescribeMatchmakingRuleSetsOutput = capo_gamelift.types.describe_matchmaking_rule_sets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_matchmaking_rule_sets_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
