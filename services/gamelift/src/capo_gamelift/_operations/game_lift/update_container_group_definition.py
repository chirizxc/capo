"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateContainerGroupDefinition``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_container_group_definition_output.UpdateContainerGroupDefinitionOutput = capo_gamelift.types.update_container_group_definition_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.UpdateContainerGroupDefinition"
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_container_group_definition_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_container_group_definition(
