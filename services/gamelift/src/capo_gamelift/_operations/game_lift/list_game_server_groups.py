"""Generated from Smithy shape ``com.amazonaws.gamelift#ListGameServerGroups``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.list_game_server_groups_output.ListGameServerGroupsOutput = capo_gamelift.types.list_game_server_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.ListGameServerGroups"
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_game_server_groups_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_game_server_groups(
