...
def handle_response(
    ...
    out: capo_gamelift.types.update_alias_output.UpdateAliasOutput = (
        capo_gamelift.types.update_alias_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_alias_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_alias(
    ...
    input_: capo_gamelift.types.update_alias_input.UpdateAliasInput,
) -> tuple[capo_gamelift.types.update_alias_output.UpdateAliasOutput, zapros.Response]:
