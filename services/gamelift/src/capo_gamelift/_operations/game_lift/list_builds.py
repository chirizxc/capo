"""Generated from Smithy shape ``com.amazonaws.gamelift#ListBuilds``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.list_builds_output.ListBuildsOutput = (
        capo_gamelift.types.list_builds_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_builds_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_builds(
    ...
    input_: capo_gamelift.types.list_builds_input.ListBuildsInput,
) -> tuple[capo_gamelift.types.list_builds_output.ListBuildsOutput, zapros.Response]:
