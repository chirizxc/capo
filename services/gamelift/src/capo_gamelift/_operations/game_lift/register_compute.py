...
def handle_response(
    ...
    out: capo_gamelift.types.register_compute_output.RegisterComputeOutput = (
        capo_gamelift.types.register_compute_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.register_compute_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def register_compute(
    ...
    capo_gamelift.types.register_compute_output.RegisterComputeOutput, zapros.Response
]:
