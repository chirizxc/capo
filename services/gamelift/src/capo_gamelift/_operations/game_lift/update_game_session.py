"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateGameSession``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_game_session_output.UpdateGameSessionOutput = (
        capo_gamelift.types.update_game_session_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_game_session_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_game_session(
