...
def handle_response(
    ...
    out: capo_gamelift.types.update_fleet_port_settings_output.UpdateFleetPortSettingsOutput = capo_gamelift.types.update_fleet_port_settings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_fleet_port_settings_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
