"""Generated from Smithy shape ``com.amazonaws.gamelift#GetGameSessionLogUrl``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.get_game_session_log_url_output.GetGameSessionLogUrlOutput = capo_gamelift.types.get_game_session_log_url_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.get_game_session_log_url_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_game_session_log_url(
