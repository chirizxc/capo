"""Generated from Smithy shape ``com.amazonaws.gamelift#ResolveAlias``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.resolve_alias_output.ResolveAliasOutput = (
        capo_gamelift.types.resolve_alias_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.resolve_alias_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def resolve_alias(
    ...
    capo_gamelift.types.resolve_alias_output.ResolveAliasOutput, zapros.Response
]:
