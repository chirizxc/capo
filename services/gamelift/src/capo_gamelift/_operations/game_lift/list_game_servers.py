...
def handle_response(
    ...
    out: capo_gamelift.types.list_game_servers_output.ListGameServersOutput = (
        capo_gamelift.types.list_game_servers_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_game_servers_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_game_servers(
    ...
    capo_gamelift.types.list_game_servers_output.ListGameServersOutput, zapros.Response
]:
