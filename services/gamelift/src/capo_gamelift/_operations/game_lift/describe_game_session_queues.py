"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeGameSessionQueues``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_game_session_queues_output.DescribeGameSessionQueuesOutput = capo_gamelift.types.describe_game_session_queues_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_game_session_queues_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_game_session_queues(
