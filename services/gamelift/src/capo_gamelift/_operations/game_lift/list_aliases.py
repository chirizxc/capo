...
def handle_response(
    ...
    out: capo_gamelift.types.list_aliases_output.ListAliasesOutput = (
        capo_gamelift.types.list_aliases_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_aliases_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_aliases(
    ...
    input_: capo_gamelift.types.list_aliases_input.ListAliasesInput,
) -> tuple[capo_gamelift.types.list_aliases_output.ListAliasesOutput, zapros.Response]:
