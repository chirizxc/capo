"""Generated from Smithy shape ``com.amazonaws.gamelift#DeleteMatchmakingConfiguration``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.delete_matchmaking_configuration_output.DeleteMatchmakingConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.delete_matchmaking_configuration_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_matchmaking_configuration(
