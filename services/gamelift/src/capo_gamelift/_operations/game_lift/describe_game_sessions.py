...
def handle_response(
    ...
    out: capo_gamelift.types.describe_game_sessions_output.DescribeGameSessionsOutput = capo_gamelift.types.describe_game_sessions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_game_sessions_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
