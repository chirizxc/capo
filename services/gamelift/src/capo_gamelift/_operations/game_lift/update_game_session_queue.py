"""Generated from Smithy shape ``com.amazonaws.gamelift#UpdateGameSessionQueue``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.update_game_session_queue_output.UpdateGameSessionQueueOutput = capo_gamelift.types.update_game_session_queue_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.update_game_session_queue_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_game_session_queue(
