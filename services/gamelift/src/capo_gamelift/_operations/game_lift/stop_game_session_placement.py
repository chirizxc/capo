...
def handle_response(
    ...
    out: capo_gamelift.types.stop_game_session_placement_output.StopGameSessionPlacementOutput = capo_gamelift.types.stop_game_session_placement_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.stop_game_session_placement_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
