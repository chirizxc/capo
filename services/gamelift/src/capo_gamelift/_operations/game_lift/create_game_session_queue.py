...
def handle_response(
    ...
    out: capo_gamelift.types.create_game_session_queue_output.CreateGameSessionQueueOutput = capo_gamelift.types.create_game_session_queue_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.create_game_session_queue_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
