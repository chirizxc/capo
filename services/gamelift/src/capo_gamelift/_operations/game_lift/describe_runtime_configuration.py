"""Generated from Smithy shape ``com.amazonaws.gamelift#DescribeRuntimeConfiguration``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.describe_runtime_configuration_output.DescribeRuntimeConfigurationOutput = capo_gamelift.types.describe_runtime_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.describe_runtime_configuration_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_runtime_configuration(
