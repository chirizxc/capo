"""Generated from Smithy shape ``com.amazonaws.gamelift#ListLocations``."""
...
def handle_response(
    ...
    out: capo_gamelift.types.list_locations_output.ListLocationsOutput = (
        capo_gamelift.types.list_locations_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GameLift.ListLocations"
    body: bytes | None = json.dumps(
        capo_gamelift.types.list_locations_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_locations(
    ...
    capo_gamelift.types.list_locations_output.ListLocationsOutput, zapros.Response
]:
