...
def handle_response(
    ...
    out: capo_gamelift.types.stop_matchmaking_output.StopMatchmakingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gamelift.types.stop_matchmaking_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def stop_matchmaking(
    ...
    capo_gamelift.types.stop_matchmaking_output.StopMatchmakingOutput, zapros.Response
]:
