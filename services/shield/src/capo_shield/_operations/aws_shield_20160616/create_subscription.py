"""Generated from Smithy shape ``com.amazonaws.shield#CreateSubscription``."""
...
def handle_response(
    ...
    out: capo_shield.types.create_subscription_response.CreateSubscriptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.create_subscription_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
