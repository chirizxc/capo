...
def handle_response(
    ...
    out: capo_shield.types.associate_drt_role_response.AssociateDRTRoleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.associate_drt_role_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
