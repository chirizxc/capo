"""Generated from Smithy shape ``com.amazonaws.shield#TagResource``."""
...
def handle_response(
    ...
    out: capo_shield.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.TagResource"
    body: bytes | None = json.dumps(
        capo_shield.types.tag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_shield.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
