"""Generated from Smithy shape ``com.amazonaws.shield#DeleteProtection``."""
...
def handle_response(
    ...
    out: capo_shield.types.delete_protection_response.DeleteProtectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.delete_protection_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_protection(
