"""Generated from Smithy shape ``com.amazonaws.shield#EnableProactiveEngagement``."""
...
def handle_response(
    ...
    out: capo_shield.types.enable_proactive_engagement_response.EnableProactiveEngagementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.EnableProactiveEngagement"
    body: bytes | None = json.dumps(
        capo_shield.types.enable_proactive_engagement_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_enable_proactive_engagement(
