"""Generated from Smithy shape ``com.amazonaws.shield#DisableProactiveEngagement``."""
...
def handle_response(
    ...
    out: capo_shield.types.disable_proactive_engagement_response.DisableProactiveEngagementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.DisableProactiveEngagement"
    body: bytes | None = json.dumps(
        capo_shield.types.disable_proactive_engagement_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disable_proactive_engagement(
