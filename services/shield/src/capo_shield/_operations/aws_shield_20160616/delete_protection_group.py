"""Generated from Smithy shape ``com.amazonaws.shield#DeleteProtectionGroup``."""
...
def handle_response(
    ...
    out: capo_shield.types.delete_protection_group_response.DeleteProtectionGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShield_20160616.DeleteProtectionGroup"
    body: bytes | None = json.dumps(
        capo_shield.types.delete_protection_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_protection_group(
