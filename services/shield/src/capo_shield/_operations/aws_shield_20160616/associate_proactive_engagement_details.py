...
def handle_response(
    ...
    out: capo_shield.types.associate_proactive_engagement_details_response.AssociateProactiveEngagementDetailsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.associate_proactive_engagement_details_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
