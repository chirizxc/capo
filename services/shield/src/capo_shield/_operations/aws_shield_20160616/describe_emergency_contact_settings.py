"""Generated from Smithy shape ``com.amazonaws.shield#DescribeEmergencyContactSettings``."""
...
def handle_response(
    ...
    out: capo_shield.types.describe_emergency_contact_settings_response.DescribeEmergencyContactSettingsResponse = capo_shield.types.describe_emergency_contact_settings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.describe_emergency_contact_settings_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_emergency_contact_settings(
