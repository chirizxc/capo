"""Generated from Smithy shape ``com.amazonaws.shield#CreateProtection``."""
...
def handle_response(
    ...
    out: capo_shield.types.create_protection_response.CreateProtectionResponse = (
        capo_shield.types.create_protection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.create_protection_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_protection(
