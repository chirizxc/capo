...
def handle_response(
    ...
    out: capo_shield.types.describe_protection_group_response.DescribeProtectionGroupResponse = capo_shield.types.describe_protection_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.describe_protection_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
