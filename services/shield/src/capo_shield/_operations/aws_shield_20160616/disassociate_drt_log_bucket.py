...
def handle_response(
    ...
    out: capo_shield.types.disassociate_drt_log_bucket_response.DisassociateDRTLogBucketResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_shield.types.disassociate_drt_log_bucket_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
