...
def handle_response(
    ...
    out: capo_batch.types.update_quota_share_response.UpdateQuotaShareResponse = (
        capo_batch.types.update_quota_share_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_batch.types.update_quota_share_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
