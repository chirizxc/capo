"""Generated from Smithy shape ``com.amazonaws.batch#DescribeServiceJob``."""
...
def handle_response(
    ...
    out: capo_batch.types.describe_service_job_response.DescribeServiceJobResponse = (
        capo_batch.types.describe_service_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_batch.types.describe_service_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_describe_service_job(
