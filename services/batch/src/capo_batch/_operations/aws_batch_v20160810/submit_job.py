...
def handle_response(
    ...
    out: capo_batch.types.submit_job_response.SubmitJobResponse = (
        capo_batch.types.submit_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_batch.types.submit_job_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def submit_job(
    ...
    input_: capo_batch.types.submit_job_request.SubmitJobRequest,
) -> tuple[capo_batch.types.submit_job_response.SubmitJobResponse, zapros.Response]:
