...
def handle_response(
    ...
    out: capo_batch.types.submit_service_job_response.SubmitServiceJobResponse = (
        capo_batch.types.submit_service_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_batch.types.submit_service_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
