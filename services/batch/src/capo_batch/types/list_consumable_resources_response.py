...
class ListConsumableResourcesResponse(TypedDict, closed=True):
    consumable_resources: NotRequired[
        "capo_batch.types.consumable_resource_summary_list.ConsumableResourceSummaryList"
    ]
...
def serialize_json(value: ListConsumableResourcesResponse) -> dict:
    ...
    if "consumable_resources" in value:
        ...
        out["consumableResources"] = (
            capo_batch.types.consumable_resource_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListConsumableResourcesResponse:
    ...
    if data.get("consumableResources") is not None:
        import capo_batch.types.consumable_resource_summary_list

        out["consumable_resources"] = (
            capo_batch.types.consumable_resource_summary_list.deserialize_json(
