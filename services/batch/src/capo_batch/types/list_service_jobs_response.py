...
class ListServiceJobsResponse(TypedDict, closed=True):
    job_summary_list: NotRequired[
        "capo_batch.types.service_job_summary_list.ServiceJobSummaryList"
    ]
...
def serialize_json(value: ListServiceJobsResponse) -> dict:
    ...
    if "job_summary_list" in value:
        ...
        out["jobSummaryList"] = (
            capo_batch.types.service_job_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListServiceJobsResponse:
    ...
    if data.get("jobSummaryList") is not None:
        ...
        out["job_summary_list"] = (
            capo_batch.types.service_job_summary_list.deserialize_json(
                data["jobSummaryList"]
            )
        )
