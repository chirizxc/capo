...
def serialize_json(value: ListJobsByConsumableResourceRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            capo_batch.types.list_jobs_by_consumable_resource_filter_list.serialize_json(
                value["filters"]
            )
        )
...
def deserialize_json(data: dict) -> ListJobsByConsumableResourceRequest:
    ...
    if data.get("filters") is not None:
        ...
        out["filters"] = (
            capo_batch.types.list_jobs_by_consumable_resource_filter_list.deserialize_json(
                data["filters"]
            )
        )
