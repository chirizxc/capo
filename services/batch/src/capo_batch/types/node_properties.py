...
class NodeProperties(TypedDict, closed=True):
    ...
    main_node: NotRequired["capo_batch.types.integer.Integer"]
    ...
    node_range_properties: NotRequired[
        "capo_batch.types.node_range_properties.NodeRangeProperties"
    ]
...
def serialize_json(value: NodeProperties) -> dict:
    ...
    if "node_range_properties" in value:
        ...
        out["nodeRangeProperties"] = (
            capo_batch.types.node_range_properties.serialize_json(
...
def deserialize_json(data: dict) -> NodeProperties:
    ...
    if data.get("nodeRangeProperties") is not None:
        ...
        out["node_range_properties"] = (
            capo_batch.types.node_range_properties.deserialize_json(
