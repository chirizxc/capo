...
class Volume(TypedDict, closed=True):
    host: NotRequired["capo_batch.types.host.Host"]
    ...
    efs_volume_configuration: NotRequired[
        "capo_batch.types.efs_volume_configuration.EFSVolumeConfiguration"
    ]
...
def serialize_json(value: Volume) -> dict:
    ...
    if "host" in value:
        ...
        out["host"] = capo_batch.types.host.serialize_json(value["host"])
    if "name" in value:
        out["name"] = value["name"]
    if "efs_volume_configuration" in value:
        ...
        out["efsVolumeConfiguration"] = (
            capo_batch.types.efs_volume_configuration.serialize_json(
    ...
    if "s3files_volume_configuration" in value:
        ...
        out["s3filesVolumeConfiguration"] = (
            capo_batch.types.s3_files_volume_configuration.serialize_json(
...
def deserialize_json(data: dict) -> Volume:
    ...
    if data.get("efsVolumeConfiguration") is not None:
        ...
        out["efs_volume_configuration"] = (
            capo_batch.types.efs_volume_configuration.deserialize_json(
    ...
    if data.get("s3filesVolumeConfiguration") is not None:
        ...
        out["s3files_volume_configuration"] = (
            capo_batch.types.s3_files_volume_configuration.deserialize_json(
