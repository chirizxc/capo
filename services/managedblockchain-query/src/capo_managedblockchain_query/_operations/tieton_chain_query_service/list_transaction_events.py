...
def handle_response(
    ...
    out: capo_managedblockchain_query.types.list_transaction_events_output.ListTransactionEventsOutput = capo_managedblockchain_query.types.list_transaction_events_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain_query.types.list_transaction_events_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
