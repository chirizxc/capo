...
import capo_managedblockchain_query.types.transaction_output_list
...
def handle_response(
    ...
    out: capo_managedblockchain_query.types.list_transactions_output.ListTransactionsOutput = capo_managedblockchain_query.types.list_transactions_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain_query.types.list_transactions_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
