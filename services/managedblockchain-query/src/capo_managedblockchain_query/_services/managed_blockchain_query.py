...
from capo_managedblockchain_query._services._aws_config import aws_config
...
class ManagedBlockchainQueryClientConfig(TypedDict, total=False, closed=True):
...
class ManagedBlockchainQueryClient:
    ...
    def batch_get_token_balance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.batch_get_token_balance_input.BatchGetTokenBalanceInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.batch_get_token_balance_output.BatchGetTokenBalanceOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.batch_get_token_balance.batch_get_token_balance(
    ...
    def get_asset_contract(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.get_asset_contract_input.GetAssetContractInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.get_asset_contract_output.GetAssetContractOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.get_asset_contract.get_asset_contract(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_token_balance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.get_token_balance_input.GetTokenBalanceInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.get_token_balance_output.GetTokenBalanceOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.get_token_balance.get_token_balance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_transaction(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.get_transaction_input.GetTransactionInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.get_transaction_output.GetTransactionOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.get_transaction.get_transaction(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_asset_contracts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.list_asset_contracts_input.ListAssetContractsInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.list_asset_contracts_output.ListAssetContractsOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.list_asset_contracts.list_asset_contracts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_asset_contracts(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_managedblockchain_query.types.asset_contract.AssetContract]":
        _token = next_token
        while True:
    ...
    def list_filtered_transaction_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.list_filtered_transaction_events_input.ListFilteredTransactionEventsInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.list_filtered_transaction_events_output.ListFilteredTransactionEventsOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.list_filtered_transaction_events.list_filtered_transaction_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_filtered_transaction_events(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_managedblockchain_query.types.transaction_event.TransactionEvent]":
        _token = next_token
        while True:
    ...
    def list_token_balances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.list_token_balances_input.ListTokenBalancesInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.list_token_balances_output.ListTokenBalancesOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.list_token_balances.list_token_balances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_token_balances(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_managedblockchain_query.types.token_balance.TokenBalance]":
        _token = next_token
        while True:
    ...
    def list_transaction_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.list_transaction_events_input.ListTransactionEventsInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.list_transaction_events_output.ListTransactionEventsOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.list_transaction_events.list_transaction_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_transactions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_managedblockchain_query.types.list_transactions_input.ListTransactionsInput]",
        ) -> OperationResponse[
            "capo_managedblockchain_query.types.list_transactions_output.ListTransactionsOutput"
        ]:
            ...
            output, http_response = (
                capo_managedblockchain_query._operations.tieton_chain_query_service.list_transactions.list_transactions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_managedblockchain_query.types.transaction_output_item.TransactionOutputItem]":
        _token = next_token
        while True:
