"""Generated from Smithy shape ``com.amazonaws.codedeploy#TagResource``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.tag_resource_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_codedeploy.types.tag_resource_output.TagResourceOutput, zapros.Response
]:
