"""Generated from Smithy shape ``com.amazonaws.codedeploy#DeleteDeploymentConfig``."""
...
import capo_codedeploy.errors.deployment_config_in_use_exception
...
import capo_codedeploy.errors.invalid_operation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeploymentConfigInUseException":
            raise capo_codedeploy.errors.deployment_config_in_use_exception.DeploymentConfigInUseException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidOperationException":
            raise capo_codedeploy.errors.invalid_operation_exception.InvalidOperationException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.delete_deployment_config_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_deployment_config(
