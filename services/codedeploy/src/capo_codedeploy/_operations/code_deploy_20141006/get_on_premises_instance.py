...
def handle_response(
    ...
    out: capo_codedeploy.types.get_on_premises_instance_output.GetOnPremisesInstanceOutput = capo_codedeploy.types.get_on_premises_instance_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.get_on_premises_instance_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
