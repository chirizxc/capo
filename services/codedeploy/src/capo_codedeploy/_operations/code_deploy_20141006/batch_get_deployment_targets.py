"""Generated from Smithy shape ``com.amazonaws.codedeploy#BatchGetDeploymentTargets``."""
...
import capo_codedeploy.errors.deployment_target_list_size_exceeded_exception
import capo_codedeploy.errors.instance_does_not_exist_exception
...
import capo_codedeploy.types.deployment_target_list
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DeploymentTargetListSizeExceededException":
            raise capo_codedeploy.errors.deployment_target_list_size_exceeded_exception.DeploymentTargetListSizeExceededException.from_aws_json_1_1(
                data, message
            )
        case "InstanceDoesNotExistException":
            raise capo_codedeploy.errors.instance_does_not_exist_exception.InstanceDoesNotExistException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codedeploy.types.batch_get_deployment_targets_output.BatchGetDeploymentTargetsOutput = capo_codedeploy.types.batch_get_deployment_targets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.batch_get_deployment_targets_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_get_deployment_targets(
