...
import capo_codedeploy.errors.invalid_deployment_status_exception
import capo_codedeploy.errors.invalid_external_id_exception
import capo_codedeploy.errors.invalid_input_exception
import capo_codedeploy.errors.invalid_next_token_exception
import capo_codedeploy.errors.invalid_time_range_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDeploymentStatusException":
            raise capo_codedeploy.errors.invalid_deployment_status_exception.InvalidDeploymentStatusException.from_aws_json_1_1(
                data, message
            )
        case "InvalidExternalIdException":
            raise capo_codedeploy.errors.invalid_external_id_exception.InvalidExternalIdException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidTimeRangeException":
            raise capo_codedeploy.errors.invalid_time_range_exception.InvalidTimeRangeException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_codedeploy.types.list_deployments_output.ListDeploymentsOutput = (
        capo_codedeploy.types.list_deployments_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.list_deployments_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_deployments(
    ...
    capo_codedeploy.types.list_deployments_output.ListDeploymentsOutput, zapros.Response
]:
