...
import capo_codedeploy.errors.invalid_lifecycle_event_hook_execution_id_exception
import capo_codedeploy.errors.invalid_lifecycle_event_hook_execution_status_exception
import capo_codedeploy.errors.lifecycle_event_already_completed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidLifecycleEventHookExecutionIdException":
            raise capo_codedeploy.errors.invalid_lifecycle_event_hook_execution_id_exception.InvalidLifecycleEventHookExecutionIdException.from_aws_json_1_1(
                data, message
            )
        case "InvalidLifecycleEventHookExecutionStatusException":
            raise capo_codedeploy.errors.invalid_lifecycle_event_hook_execution_status_exception.InvalidLifecycleEventHookExecutionStatusException.from_aws_json_1_1(
                data, message
            )
        case "LifecycleEventAlreadyCompletedException":
            raise capo_codedeploy.errors.lifecycle_event_already_completed_exception.LifecycleEventAlreadyCompletedException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codedeploy.types.put_lifecycle_event_hook_execution_status_output.PutLifecycleEventHookExecutionStatusOutput = capo_codedeploy.types.put_lifecycle_event_hook_execution_status_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.put_lifecycle_event_hook_execution_status_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
