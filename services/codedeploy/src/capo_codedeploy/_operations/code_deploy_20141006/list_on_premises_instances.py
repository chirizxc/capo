...
import capo_codedeploy.errors.invalid_registration_status_exception
import capo_codedeploy.errors.invalid_tag_filter_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidRegistrationStatusException":
            raise capo_codedeploy.errors.invalid_registration_status_exception.InvalidRegistrationStatusException.from_aws_json_1_1(
                data, message
            )
        case "InvalidTagFilterException":
            raise capo_codedeploy.errors.invalid_tag_filter_exception.InvalidTagFilterException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_codedeploy.types.list_on_premises_instances_output.ListOnPremisesInstancesOutput = capo_codedeploy.types.list_on_premises_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.list_on_premises_instances_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
