...
import capo_codedeploy.errors.deployment_is_not_in_ready_state_exception
...
import capo_codedeploy.errors.invalid_deployment_wait_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DeploymentIsNotInReadyStateException":
            raise capo_codedeploy.errors.deployment_is_not_in_ready_state_exception.DeploymentIsNotInReadyStateException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidDeploymentWaitTypeException":
            raise capo_codedeploy.errors.invalid_deployment_wait_type_exception.InvalidDeploymentWaitTypeException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.continue_deployment_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
