"""Generated from Smithy shape ``com.amazonaws.codedeploy#GetApplication``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.get_application_output.GetApplicationOutput = (
        capo_codedeploy.types.get_application_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.get_application_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_application(
    ...
    capo_codedeploy.types.get_application_output.GetApplicationOutput, zapros.Response
]:
