"""Generated from Smithy shape ``com.amazonaws.codedeploy#BatchGetDeploymentGroups``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.batch_get_deployment_groups_output.BatchGetDeploymentGroupsOutput = capo_codedeploy.types.batch_get_deployment_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.batch_get_deployment_groups_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_get_deployment_groups(
