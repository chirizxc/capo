"""Generated from Smithy shape ``com.amazonaws.codedeploy#GetDeploymentInstance``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.get_deployment_instance_output.GetDeploymentInstanceOutput = capo_codedeploy.types.get_deployment_instance_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.get_deployment_instance_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_deployment_instance(
