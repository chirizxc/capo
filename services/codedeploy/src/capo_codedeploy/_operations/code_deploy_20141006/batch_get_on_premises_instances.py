...
def handle_response(
    ...
    out: capo_codedeploy.types.batch_get_on_premises_instances_output.BatchGetOnPremisesInstancesOutput = capo_codedeploy.types.batch_get_on_premises_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.batch_get_on_premises_instances_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
