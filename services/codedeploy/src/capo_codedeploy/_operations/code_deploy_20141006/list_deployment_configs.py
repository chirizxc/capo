"""Generated from Smithy shape ``com.amazonaws.codedeploy#ListDeploymentConfigs``."""
...
def handle_response(
    ...
    out: capo_codedeploy.types.list_deployment_configs_output.ListDeploymentConfigsOutput = capo_codedeploy.types.list_deployment_configs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.list_deployment_configs_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_deployment_configs(
