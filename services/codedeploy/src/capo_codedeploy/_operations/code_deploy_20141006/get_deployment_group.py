...
def handle_response(
    ...
    out: capo_codedeploy.types.get_deployment_group_output.GetDeploymentGroupOutput = (
        capo_codedeploy.types.get_deployment_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.get_deployment_group_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
