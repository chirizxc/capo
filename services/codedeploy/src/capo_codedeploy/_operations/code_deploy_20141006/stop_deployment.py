...
def handle_response(
    ...
    out: capo_codedeploy.types.stop_deployment_output.StopDeploymentOutput = (
        capo_codedeploy.types.stop_deployment_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.stop_deployment_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def stop_deployment(
    ...
    capo_codedeploy.types.stop_deployment_output.StopDeploymentOutput, zapros.Response
]:
