...
def handle_response(
    ...
    out: capo_codedeploy.types.list_git_hub_account_token_names_output.ListGitHubAccountTokenNamesOutput = capo_codedeploy.types.list_git_hub_account_token_names_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codedeploy.types.list_git_hub_account_token_names_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
