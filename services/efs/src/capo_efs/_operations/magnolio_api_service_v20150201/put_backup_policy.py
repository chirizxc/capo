"""Generated from Smithy shape ``com.amazonaws.efs#PutBackupPolicy``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_efs.types.put_backup_policy_request.serialize_json(input_), allow_nan=False
    ).encode()
...
async def async_put_backup_policy(
