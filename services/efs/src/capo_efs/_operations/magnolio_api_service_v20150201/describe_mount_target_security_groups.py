"""Generated from Smithy shape ``com.amazonaws.efs#DescribeMountTargetSecurityGroups``."""
...
def handle_response(
    ...
    out: capo_efs.types.describe_mount_target_security_groups_response.DescribeMountTargetSecurityGroupsResponse = capo_efs.types.describe_mount_target_security_groups_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{MountTargetId}", quote(input_["mount_target_id"], safe=""))
