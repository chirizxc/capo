...
def handle_response(
    ...
    out: capo_efs.types.put_account_preferences_response.PutAccountPreferencesResponse = capo_efs.types.put_account_preferences_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_efs.types.put_account_preferences_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
