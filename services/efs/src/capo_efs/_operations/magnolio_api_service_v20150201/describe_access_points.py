...
def handle_response(
    ...
    out: capo_efs.types.describe_access_points_response.DescribeAccessPointsResponse = (
        capo_efs.types.describe_access_points_response.deserialize_json(
...
def build_request(
    ...
    if "access_point_id" in input_:
        params.append(("AccessPointId", input_["access_point_id"]))
