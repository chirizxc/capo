...
class SubnetNotFound_(TypedDict, closed=True):
...
class SubnetNotFound(ServiceError):
    ...
    def __init__(self, data: SubnetNotFound_, message: str | None = None):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_json(cls, data: dict, message: str | None = None) -> "SubnetNotFound":
