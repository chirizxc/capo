...
if TYPE_CHECKING:
    import capo_pcs.types.slurm_custom_setting

SlurmCustomSettings: TypeAlias = list[
    "capo_pcs.types.slurm_custom_setting.SlurmCustomSetting"
]
...
def serialize_aws_json_1_0(value: SlurmCustomSettings) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_pcs.types.slurm_custom_setting.serialize_aws_json_1_0(item))
    return out
