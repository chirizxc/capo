...
class ClusterSlurmConfigurationRequest(TypedDict, closed=True):
    ...
    accounting: NotRequired["capo_pcs.types.accounting_request.AccountingRequest"]
    """<p>The accounting configuration includes configurable settings for Slurm accounting.</p>"""
    slurm_rest: NotRequired["capo_pcs.types.slurm_rest_request.SlurmRestRequest"]
    """<p>The Slurm REST API configuration for the cluster.</p>"""


# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ClusterSlurmConfigurationRequest) -> dict:
    out: dict = {}
    ...
    if "accounting" in value:
        ...
        out["accounting"] = capo_pcs.types.accounting_request.serialize_aws_json_1_0(
            value["accounting"]
        )
    if "slurm_rest" in value:
        import capo_pcs.types.slurm_rest_request

        out["slurmRest"] = capo_pcs.types.slurm_rest_request.serialize_aws_json_1_0(
            value["slurm_rest"]
        )
    return out
