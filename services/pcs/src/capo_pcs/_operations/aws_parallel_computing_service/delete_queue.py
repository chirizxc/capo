"""Generated from Smithy shape ``com.amazonaws.pcs#DeleteQueue``."""
...
def handle_response(
    ...
    out: capo_pcs.types.delete_queue_response.DeleteQueueResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSParallelComputingService.DeleteQueue"
    body: bytes | None = json.dumps(
        capo_pcs.types.delete_queue_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def delete_queue(
    ...
    input_: capo_pcs.types.delete_queue_request.DeleteQueueRequest,
) -> tuple[capo_pcs.types.delete_queue_response.DeleteQueueResponse, zapros.Response]:
