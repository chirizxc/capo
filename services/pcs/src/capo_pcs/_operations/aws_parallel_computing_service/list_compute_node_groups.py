...
def handle_response(
    ...
    out: capo_pcs.types.list_compute_node_groups_response.ListComputeNodeGroupsResponse = capo_pcs.types.list_compute_node_groups_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pcs.types.list_compute_node_groups_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
