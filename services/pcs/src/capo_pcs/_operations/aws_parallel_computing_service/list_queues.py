"""Generated from Smithy shape ``com.amazonaws.pcs#ListQueues``."""
...
def handle_response(
    ...
    out: capo_pcs.types.list_queues_response.ListQueuesResponse = (
        capo_pcs.types.list_queues_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSParallelComputingService.ListQueues"
    body: bytes | None = json.dumps(
        capo_pcs.types.list_queues_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_queues(
    ...
    input_: capo_pcs.types.list_queues_request.ListQueuesRequest,
) -> tuple[capo_pcs.types.list_queues_response.ListQueuesResponse, zapros.Response]:
