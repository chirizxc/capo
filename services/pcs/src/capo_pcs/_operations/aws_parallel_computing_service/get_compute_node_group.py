"""Generated from Smithy shape ``com.amazonaws.pcs#GetComputeNodeGroup``."""
...
def handle_response(
    ...
    out: capo_pcs.types.get_compute_node_group_response.GetComputeNodeGroupResponse = (
        capo_pcs.types.get_compute_node_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSParallelComputingService.GetComputeNodeGroup"
    body: bytes | None = json.dumps(
        capo_pcs.types.get_compute_node_group_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_compute_node_group(
