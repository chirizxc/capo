...
class DescribeInboundCrossClusterSearchConnectionsResponse(TypedDict, closed=True):
    cross_cluster_search_connections: NotRequired[
        "capo_elasticsearch_service.types.inbound_cross_cluster_search_connections.InboundCrossClusterSearchConnections"
    ]
...
def serialize_json(value: DescribeInboundCrossClusterSearchConnectionsResponse) -> dict:
    ...
    if "cross_cluster_search_connections" in value:
        ...
        out["CrossClusterSearchConnections"] = (
            capo_elasticsearch_service.types.inbound_cross_cluster_search_connections.serialize_json(
...
def deserialize_json(
    ...
    if data.get("CrossClusterSearchConnections") is not None:
        ...
        out["cross_cluster_search_connections"] = (
            capo_elasticsearch_service.types.inbound_cross_cluster_search_connections.deserialize_json(
