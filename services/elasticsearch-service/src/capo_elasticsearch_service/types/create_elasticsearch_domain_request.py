...
class CreateElasticsearchDomainRequest(TypedDict, closed=True):
    ...
    tag_list: NotRequired["capo_elasticsearch_service.types.tag_list.TagList"]
...
def serialize_json(value: CreateElasticsearchDomainRequest) -> dict:
    ...
    if "auto_tune_options" in value:
        ...
        out["AutoTuneOptions"] = (
            capo_elasticsearch_service.types.auto_tune_options_input.serialize_json(
...
def deserialize_json(data: dict) -> CreateElasticsearchDomainRequest:
    ...
    if data.get("AutoTuneOptions") is not None:
        ...
        out["auto_tune_options"] = (
            capo_elasticsearch_service.types.auto_tune_options_input.deserialize_json(
