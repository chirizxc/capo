...
if TYPE_CHECKING:
    import capo_elasticsearch_service.types.storage_sub_type_name
    import capo_elasticsearch_service.types.storage_type_limit_list
    import capo_elasticsearch_service.types.storage_type_name


class StorageType(TypedDict, closed=True):
    storage_type_name: NotRequired[
        "capo_elasticsearch_service.types.storage_type_name.StorageTypeName"
    ]
    storage_sub_type_name: NotRequired[
        "capo_elasticsearch_service.types.storage_sub_type_name.StorageSubTypeName"
    ]
    storage_type_limits: NotRequired[
        "capo_elasticsearch_service.types.storage_type_limit_list.StorageTypeLimitList"
    ]
...
def serialize_json(value: StorageType) -> dict:
    ...
    if "storage_type_limits" in value:
        ...
        out["StorageTypeLimits"] = (
            capo_elasticsearch_service.types.storage_type_limit_list.serialize_json(
...
def deserialize_json(data: dict) -> StorageType:
    ...
    if data.get("StorageTypeLimits") is not None:
        ...
        out["storage_type_limits"] = (
            capo_elasticsearch_service.types.storage_type_limit_list.deserialize_json(
