...
if TYPE_CHECKING:
    ...
    import capo_elasticsearch_service.types.identity_pool_id
    import capo_elasticsearch_service.types.role_arn
    import capo_elasticsearch_service.types.user_pool_id
...
class CognitoOptions(TypedDict, closed=True):
    ...
    user_pool_id: NotRequired[
        "capo_elasticsearch_service.types.user_pool_id.UserPoolId"
    ]
    """<p>Specifies the Cognito user pool ID for Kibana authentication.</p>"""
    identity_pool_id: NotRequired[
        "capo_elasticsearch_service.types.identity_pool_id.IdentityPoolId"
    ]
    """<p>Specifies the Cognito identity pool ID for Kibana authentication.</p>"""
    role_arn: NotRequired["capo_elasticsearch_service.types.role_arn.RoleArn"]
