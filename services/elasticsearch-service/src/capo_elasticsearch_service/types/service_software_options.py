...
class ServiceSoftwareOptions(TypedDict, closed=True):
    current_version: NotRequired["capo_elasticsearch_service.types.string.String"]
    """<p>The current service software version that is present on the domain.</p>"""
    new_version: NotRequired["capo_elasticsearch_service.types.string.String"]
    """<p>The new service software version if one is available.</p>"""
    update_available: NotRequired["capo_elasticsearch_service.types.boolean.Boolean"]
    ...
    cancellable: NotRequired["capo_elasticsearch_service.types.boolean.Boolean"]
    ...
    update_status: NotRequired[
        "capo_elasticsearch_service.types.deployment_status.DeploymentStatus"
    ]
    ...
    description: NotRequired["capo_elasticsearch_service.types.string.String"]
    """<p>The description of the <code>UpdateStatus</code>.</p>"""
    automated_update_date: NotRequired[
        "capo_elasticsearch_service.types.deployment_close_date_time_stamp.DeploymentCloseDateTimeStamp"
    ]
    ...
    optional_deployment: NotRequired["capo_elasticsearch_service.types.boolean.Boolean"]
...
def serialize_json(value: ServiceSoftwareOptions) -> dict:
    ...
    if "update_status" in value:
        ...
        out["UpdateStatus"] = (
            capo_elasticsearch_service.types.deployment_status.serialize_json(
                value["update_status"]
            )
        )
    ...
    if "automated_update_date" in value:
        ...
        out["AutomatedUpdateDate"] = (
            capo_elasticsearch_service.types.deployment_close_date_time_stamp.serialize_json(
...
def deserialize_json(data: dict) -> ServiceSoftwareOptions:
    ...
    if data.get("UpdateStatus") is not None:
        ...
        out["update_status"] = (
            capo_elasticsearch_service.types.deployment_status.deserialize_json(
                data["UpdateStatus"]
            )
        )
    ...
    if data.get("AutomatedUpdateDate") is not None:
        ...
        out["automated_update_date"] = (
            capo_elasticsearch_service.types.deployment_close_date_time_stamp.deserialize_json(
