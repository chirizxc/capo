...
class AutoTuneDetails(TypedDict, closed=True):
    scheduled_auto_tune_details: NotRequired[
        "capo_elasticsearch_service.types.scheduled_auto_tune_details.ScheduledAutoTuneDetails"
    ]
...
def serialize_json(value: AutoTuneDetails) -> dict:
    ...
    if "scheduled_auto_tune_details" in value:
        ...
        out["ScheduledAutoTuneDetails"] = (
            capo_elasticsearch_service.types.scheduled_auto_tune_details.serialize_json(
...
def deserialize_json(data: dict) -> AutoTuneDetails:
    ...
    if data.get("ScheduledAutoTuneDetails") is not None:
        ...
        out["scheduled_auto_tune_details"] = (
            capo_elasticsearch_service.types.scheduled_auto_tune_details.deserialize_json(
