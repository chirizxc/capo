...
if TYPE_CHECKING:
    import capo_elasticsearch_service.types.maximum_instance_count
    import capo_elasticsearch_service.types.minimum_instance_count


class InstanceCountLimits(TypedDict, closed=True):
    minimum_instance_count: (
        "capo_elasticsearch_service.types.minimum_instance_count.MinimumInstanceCount"
    )
    maximum_instance_count: (
        "capo_elasticsearch_service.types.maximum_instance_count.MaximumInstanceCount"
    )
