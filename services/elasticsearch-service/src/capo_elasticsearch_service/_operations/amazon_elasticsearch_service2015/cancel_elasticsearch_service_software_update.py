"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#CancelElasticsearchServiceSoftwareUpdate``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.cancel_elasticsearch_service_software_update_response.CancelElasticsearchServiceSoftwareUpdateResponse = capo_elasticsearch_service.types.cancel_elasticsearch_service_software_update_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/serviceSoftwareUpdate/cancel"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.cancel_elasticsearch_service_software_update_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_cancel_elasticsearch_service_software_update(
