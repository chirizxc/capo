...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.purchase_reserved_elasticsearch_instance_offering_response.PurchaseReservedElasticsearchInstanceOfferingResponse = capo_elasticsearch_service.types.purchase_reserved_elasticsearch_instance_offering_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.purchase_reserved_elasticsearch_instance_offering_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
