"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#ListElasticsearchInstanceTypes``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_elasticsearch_instance_types_response.ListElasticsearchInstanceTypesResponse = capo_elasticsearch_service.types.list_elasticsearch_instance_types_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/2015-01-01/es/instanceTypes/{ElasticsearchVersion}"
    )
    url = url.replace(
        "{ElasticsearchVersion}", quote(input_["elasticsearch_version"], safe="")
    )
...
async def async_list_elasticsearch_instance_types(
