...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.delete_elasticsearch_domain_response.DeleteElasticsearchDomainResponse = capo_elasticsearch_service.types.delete_elasticsearch_domain_response.deserialize_json(
