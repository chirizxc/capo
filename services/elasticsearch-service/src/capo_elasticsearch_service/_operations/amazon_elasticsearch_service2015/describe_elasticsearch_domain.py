...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.describe_elasticsearch_domain_response.DescribeElasticsearchDomainResponse = capo_elasticsearch_service.types.describe_elasticsearch_domain_response.deserialize_json(
