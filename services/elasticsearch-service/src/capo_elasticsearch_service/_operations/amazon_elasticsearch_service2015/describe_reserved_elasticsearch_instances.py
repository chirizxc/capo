...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.describe_reserved_elasticsearch_instances_response.DescribeReservedElasticsearchInstancesResponse = capo_elasticsearch_service.types.describe_reserved_elasticsearch_instances_response.deserialize_json(
...
def build_request(
    ...
    if "reserved_elasticsearch_instance_id" in input_:
        params.append(("reservationId", input_["reserved_elasticsearch_instance_id"]))
