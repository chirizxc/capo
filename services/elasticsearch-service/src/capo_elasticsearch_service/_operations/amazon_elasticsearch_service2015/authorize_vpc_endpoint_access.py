"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#AuthorizeVpcEndpointAccess``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.authorize_vpc_endpoint_access_response.AuthorizeVpcEndpointAccessResponse = capo_elasticsearch_service.types.authorize_vpc_endpoint_access_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.authorize_vpc_endpoint_access_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
