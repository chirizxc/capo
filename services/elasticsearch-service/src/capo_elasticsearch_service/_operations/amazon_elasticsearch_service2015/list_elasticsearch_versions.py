...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_elasticsearch_versions_response.ListElasticsearchVersionsResponse = capo_elasticsearch_service.types.list_elasticsearch_versions_response.deserialize_json(
