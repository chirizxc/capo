...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.get_package_version_history_response.GetPackageVersionHistoryResponse = capo_elasticsearch_service.types.get_package_version_history_response.deserialize_json(
