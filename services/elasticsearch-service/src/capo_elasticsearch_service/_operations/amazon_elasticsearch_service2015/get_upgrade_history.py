...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.get_upgrade_history_response.GetUpgradeHistoryResponse = capo_elasticsearch_service.types.get_upgrade_history_response.deserialize_json(
