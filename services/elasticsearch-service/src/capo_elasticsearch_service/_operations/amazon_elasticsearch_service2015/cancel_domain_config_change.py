...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.cancel_domain_config_change_response.CancelDomainConfigChangeResponse = capo_elasticsearch_service.types.cancel_domain_config_change_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.cancel_domain_config_change_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
