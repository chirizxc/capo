...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.update_package_response.UpdatePackageResponse = capo_elasticsearch_service.types.update_package_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.update_package_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
