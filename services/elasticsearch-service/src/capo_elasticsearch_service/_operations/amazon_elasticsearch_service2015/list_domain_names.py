...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_domain_names_response.ListDomainNamesResponse = capo_elasticsearch_service.types.list_domain_names_response.deserialize_json(
...
def build_request(
    ...
    if "engine_type" in input_:
        params.append(
            (
                "engineType",
                capo_elasticsearch_service.types.engine_type.serialize_json(
                    input_["engine_type"]
                ),
            )
        )
