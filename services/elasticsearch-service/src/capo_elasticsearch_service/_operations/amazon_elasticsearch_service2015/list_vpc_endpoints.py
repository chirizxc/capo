...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_vpc_endpoints_response.ListVpcEndpointsResponse = capo_elasticsearch_service.types.list_vpc_endpoints_response.deserialize_json(
