"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DescribeOutboundCrossClusterSearchConnections``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.describe_outbound_cross_cluster_search_connections_response.DescribeOutboundCrossClusterSearchConnectionsResponse = capo_elasticsearch_service.types.describe_outbound_cross_cluster_search_connections_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/ccs/outboundConnection/search"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.describe_outbound_cross_cluster_search_connections_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_outbound_cross_cluster_search_connections(
