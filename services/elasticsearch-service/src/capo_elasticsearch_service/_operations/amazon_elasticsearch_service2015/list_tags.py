"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#ListTags``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.list_tags_response.ListTagsResponse = (
        capo_elasticsearch_service.types.list_tags_response.deserialize_json(
