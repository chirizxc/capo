"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DeleteInboundCrossClusterSearchConnection``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.delete_inbound_cross_cluster_search_connection_response.DeleteInboundCrossClusterSearchConnectionResponse = capo_elasticsearch_service.types.delete_inbound_cross_cluster_search_connection_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["cross_cluster_search_connection_id"], safe=""),
    )
...
async def async_delete_inbound_cross_cluster_search_connection(
