"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#DeleteElasticsearchServiceRole``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/role"
...
async def async_delete_elasticsearch_service_role(
