...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.reject_inbound_cross_cluster_search_connection_response.RejectInboundCrossClusterSearchConnectionResponse = capo_elasticsearch_service.types.reject_inbound_cross_cluster_search_connection_response.deserialize_json(
