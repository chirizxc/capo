"""Generated from Smithy shape ``com.amazonaws.elasticsearchservice#StartElasticsearchServiceSoftwareUpdate``."""
...
def handle_response(
    ...
    out: capo_elasticsearch_service.types.start_elasticsearch_service_software_update_response.StartElasticsearchServiceSoftwareUpdateResponse = capo_elasticsearch_service.types.start_elasticsearch_service_software_update_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2015-01-01/es/serviceSoftwareUpdate/start"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_elasticsearch_service.types.start_elasticsearch_service_software_update_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_elasticsearch_service_software_update(
