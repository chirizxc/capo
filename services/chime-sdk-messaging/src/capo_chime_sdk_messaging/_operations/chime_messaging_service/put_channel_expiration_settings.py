"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#PutChannelExpirationSettings``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.put_channel_expiration_settings_response.PutChannelExpirationSettingsResponse = capo_chime_sdk_messaging.types.put_channel_expiration_settings_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/channels/{ChannelArn}/expiration-settings"
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.put_channel_expiration_settings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_channel_expiration_settings(
