...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.create_channel_response.CreateChannelResponse = capo_chime_sdk_messaging.types.create_channel_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.create_channel_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
