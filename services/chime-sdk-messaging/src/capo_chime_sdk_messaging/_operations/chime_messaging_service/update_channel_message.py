...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.update_channel_message_response.UpdateChannelMessageResponse = capo_chime_sdk_messaging.types.update_channel_message_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.update_channel_message_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
