"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#DescribeChannel``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.describe_channel_response.DescribeChannelResponse = capo_chime_sdk_messaging.types.describe_channel_response.deserialize_json(
