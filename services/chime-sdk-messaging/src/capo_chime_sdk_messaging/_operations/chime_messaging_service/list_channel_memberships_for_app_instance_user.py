...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.list_channel_memberships_for_app_instance_user_response.ListChannelMembershipsForAppInstanceUserResponse = capo_chime_sdk_messaging.types.list_channel_memberships_for_app_instance_user_response.deserialize_json(
