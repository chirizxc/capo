"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#GetChannelMessageStatus``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.get_channel_message_status_response.GetChannelMessageStatusResponse = capo_chime_sdk_messaging.types.get_channel_message_status_response.deserialize_json(
...
def build_request(
    ...
    if "sub_channel_id" in input_:
        params.append(("sub-channel-id", input_["sub_channel_id"]))
...
async def async_get_channel_message_status(
