...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.describe_channel_moderator_response.DescribeChannelModeratorResponse = capo_chime_sdk_messaging.types.describe_channel_moderator_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ChannelModeratorArn}", quote(input_["channel_moderator_arn"], safe="")
    )
