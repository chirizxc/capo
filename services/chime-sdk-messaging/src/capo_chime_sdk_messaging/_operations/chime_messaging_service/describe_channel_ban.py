"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#DescribeChannelBan``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.describe_channel_ban_response.DescribeChannelBanResponse = capo_chime_sdk_messaging.types.describe_channel_ban_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{MemberArn}", quote(input_["member_arn"], safe=""))
...
async def async_describe_channel_ban(
