...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.describe_channel_membership_for_app_instance_user_response.DescribeChannelMembershipForAppInstanceUserResponse = capo_chime_sdk_messaging.types.describe_channel_membership_for_app_instance_user_response.deserialize_json(
