"""Generated from Smithy shape ``com.amazonaws.chimesdkmessaging#ListChannelsAssociatedWithChannelFlow``."""
...
import capo_chime_sdk_messaging.types.channel_associated_with_flow_summary_list
...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.list_channels_associated_with_channel_flow_response.ListChannelsAssociatedWithChannelFlowResponse = capo_chime_sdk_messaging.types.list_channels_associated_with_channel_flow_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/channels?scope=channel-flow-associations"
    params: list[tuple[str, str]] = []
    if "channel_flow_arn" in input_:
        params.append(("channel-flow-arn", input_["channel_flow_arn"]))
...
async def async_list_channels_associated_with_channel_flow(
