...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.get_channel_membership_preferences_response.GetChannelMembershipPreferencesResponse = capo_chime_sdk_messaging.types.get_channel_membership_preferences_response.deserialize_json(
