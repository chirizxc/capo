...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.update_channel_read_marker_response.UpdateChannelReadMarkerResponse = capo_chime_sdk_messaging.types.update_channel_read_marker_response.deserialize_json(
