...
def build_request(
    ...
    import capo_chime_sdk_messaging._protocol.serialize
    import capo_chime_sdk_messaging.types.sort_order
    ...
    if "sort_order" in input_:
        params.append(
            (
                "sort-order",
                capo_chime_sdk_messaging.types.sort_order.serialize_json(
                    input_["sort_order"]
                ),
            )
        )
    if "not_before" in input_:
        params.append(
            (
                "not-before",
                capo_chime_sdk_messaging._protocol.serialize.fmt_date_time(
                    input_["not_before"]
                ),
            )
        )
