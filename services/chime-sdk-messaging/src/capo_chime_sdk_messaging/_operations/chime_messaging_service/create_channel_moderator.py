...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.create_channel_moderator_response.CreateChannelModeratorResponse = capo_chime_sdk_messaging.types.create_channel_moderator_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.create_channel_moderator_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
