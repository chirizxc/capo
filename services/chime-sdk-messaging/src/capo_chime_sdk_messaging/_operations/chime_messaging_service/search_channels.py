...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.search_channels_response.SearchChannelsResponse = capo_chime_sdk_messaging.types.search_channels_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_messaging.types.search_channels_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
