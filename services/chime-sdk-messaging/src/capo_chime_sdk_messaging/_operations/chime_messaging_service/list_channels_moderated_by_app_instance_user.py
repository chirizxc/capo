...
def handle_response(
    ...
    out: capo_chime_sdk_messaging.types.list_channels_moderated_by_app_instance_user_response.ListChannelsModeratedByAppInstanceUserResponse = capo_chime_sdk_messaging.types.list_channels_moderated_by_app_instance_user_response.deserialize_json(
