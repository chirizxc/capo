...
if TYPE_CHECKING:
    ...
    import capo_chime_sdk_meetings.types.join_token_string
...
class Attendee(TypedDict, closed=True):
    ...
    attendee_id: NotRequired["capo_chime_sdk_meetings.types.guid_string.GuidString"]
    """<p>The Amazon Chime SDK attendee ID.</p>"""
    join_token: NotRequired[
        "capo_chime_sdk_meetings.types.join_token_string.JoinTokenString"
    ]
