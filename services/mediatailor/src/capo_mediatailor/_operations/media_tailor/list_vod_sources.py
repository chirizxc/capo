"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListVodSources``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.list_vod_sources_response.ListVodSourcesResponse = (
        capo_mediatailor.types.list_vod_sources_response.deserialize_json(
...
async def async_list_vod_sources(
