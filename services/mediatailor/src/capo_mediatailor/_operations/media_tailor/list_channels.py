...
def handle_response(
    ...
    out: capo_mediatailor.types.list_channels_response.ListChannelsResponse = (
        capo_mediatailor.types.list_channels_response.deserialize_json(
...
def list_channels(
    ...
    capo_mediatailor.types.list_channels_response.ListChannelsResponse, zapros.Response
]:
