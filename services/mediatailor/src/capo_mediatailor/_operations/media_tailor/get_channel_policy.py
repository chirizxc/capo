"""Generated from Smithy shape ``com.amazonaws.mediatailor#GetChannelPolicy``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.get_channel_policy_response.GetChannelPolicyResponse = (
        capo_mediatailor.types.get_channel_policy_response.deserialize_json(
