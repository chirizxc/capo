"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeleteSourceLocation``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.delete_source_location_response.DeleteSourceLocationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_source_location(
