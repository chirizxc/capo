...
def handle_response(
    ...
    out: capo_mediatailor.types.stop_channel_response.StopChannelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def stop_channel(
    ...
    capo_mediatailor.types.stop_channel_response.StopChannelResponse, zapros.Response
]:
