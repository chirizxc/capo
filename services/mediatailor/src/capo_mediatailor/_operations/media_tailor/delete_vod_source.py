"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeleteVodSource``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.delete_vod_source_response.DeleteVodSourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_vod_source(
