...
def handle_response(
    ...
    out: capo_mediatailor.types.create_source_location_response.CreateSourceLocationResponse = capo_mediatailor.types.create_source_location_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.create_source_location_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
