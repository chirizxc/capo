"""Generated from Smithy shape ``com.amazonaws.mediatailor#UpdateProgram``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.update_program_response.UpdateProgramResponse = (
        capo_mediatailor.types.update_program_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.update_program_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
