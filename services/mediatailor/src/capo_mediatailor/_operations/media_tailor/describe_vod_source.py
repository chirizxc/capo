"""Generated from Smithy shape ``com.amazonaws.mediatailor#DescribeVodSource``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.describe_vod_source_response.DescribeVodSourceResponse = capo_mediatailor.types.describe_vod_source_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{VodSourceName}", quote(input_["vod_source_name"], safe=""))
