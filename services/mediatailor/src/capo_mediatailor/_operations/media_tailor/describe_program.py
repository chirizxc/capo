"""Generated from Smithy shape ``com.amazonaws.mediatailor#DescribeProgram``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.describe_program_response.DescribeProgramResponse = (
        capo_mediatailor.types.describe_program_response.deserialize_json(
...
async def async_describe_program(
