...
def handle_response(
    ...
    out: capo_mediatailor.types.delete_prefetch_schedule_response.DeletePrefetchScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["playback_configuration_name"], safe=""),
    )
