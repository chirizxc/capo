...
def handle_response(
    ...
    out: capo_mediatailor.types.configure_logs_for_playback_configuration_response.ConfigureLogsForPlaybackConfigurationResponse = capo_mediatailor.types.configure_logs_for_playback_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.configure_logs_for_playback_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
