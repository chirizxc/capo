"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeletePlaybackConfiguration``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.delete_playback_configuration_response.DeletePlaybackConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_playback_configuration(
