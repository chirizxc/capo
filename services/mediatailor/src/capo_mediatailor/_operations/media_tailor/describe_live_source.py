...
def handle_response(
    ...
    out: capo_mediatailor.types.describe_live_source_response.DescribeLiveSourceResponse = capo_mediatailor.types.describe_live_source_response.deserialize_json(
