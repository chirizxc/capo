"""Generated from Smithy shape ``com.amazonaws.mediatailor#DeleteChannelPolicy``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.delete_channel_policy_response.DeleteChannelPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
