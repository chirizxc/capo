"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListLiveSources``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.list_live_sources_response.ListLiveSourcesResponse = (
        capo_mediatailor.types.list_live_sources_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sourceLocation/{SourceLocationName}/liveSources"
    url = url.replace(
...
async def async_list_live_sources(
