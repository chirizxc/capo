"""Generated from Smithy shape ``com.amazonaws.mediatailor#ListSourceLocations``."""
...
def handle_response(
    ...
    out: capo_mediatailor.types.list_source_locations_response.ListSourceLocationsResponse = capo_mediatailor.types.list_source_locations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sourceLocations"
...
async def async_list_source_locations(
