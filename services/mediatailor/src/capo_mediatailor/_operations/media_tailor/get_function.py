...
def handle_response(
    ...
    out: capo_mediatailor.types.get_function_response.GetFunctionResponse = (
        capo_mediatailor.types.get_function_response.deserialize_json(
...
def get_function(
    ...
    capo_mediatailor.types.get_function_response.GetFunctionResponse, zapros.Response
]:
