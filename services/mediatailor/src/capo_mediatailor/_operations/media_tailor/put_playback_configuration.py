...
def handle_response(
    ...
    out: capo_mediatailor.types.put_playback_configuration_response.PutPlaybackConfigurationResponse = capo_mediatailor.types.put_playback_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.put_playback_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
