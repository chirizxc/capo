...
def handle_response(
    ...
    out: capo_mediatailor.types.create_live_source_response.CreateLiveSourceResponse = (
        capo_mediatailor.types.create_live_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediatailor.types.create_live_source_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
