...
def handle_response(
    ...
    out: capo_mediatailor.types.describe_source_location_response.DescribeSourceLocationResponse = capo_mediatailor.types.describe_source_location_response.deserialize_json(
