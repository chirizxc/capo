...
class ManifestProcessingRules(TypedDict, closed=True):
    ad_marker_passthrough: NotRequired[
        "capo_mediatailor.types.ad_marker_passthrough.AdMarkerPassthrough"
    ]
...
def serialize_json(value: ManifestProcessingRules) -> dict:
    ...
    if "ad_marker_passthrough" in value:
        ...
        out["AdMarkerPassthrough"] = (
            capo_mediatailor.types.ad_marker_passthrough.serialize_json(
...
def deserialize_json(data: dict) -> ManifestProcessingRules:
    ...
    if data.get("AdMarkerPassthrough") is not None:
        ...
        out["ad_marker_passthrough"] = (
            capo_mediatailor.types.ad_marker_passthrough.deserialize_json(
