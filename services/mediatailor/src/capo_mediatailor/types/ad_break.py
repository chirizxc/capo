...
class AdBreak(TypedDict, closed=True):
    message_type: NotRequired["capo_mediatailor.types.message_type.MessageType"]
    ...
    slate: NotRequired["capo_mediatailor.types.slate_source.SlateSource"]
    """<p>Ad break slate configuration.</p>"""
    splice_insert_message: NotRequired[
        "capo_mediatailor.types.splice_insert_message.SpliceInsertMessage"
    ]
    ...
    time_signal_message: NotRequired[
        "capo_mediatailor.types.time_signal_message.TimeSignalMessage"
    ]
    ...
    ad_break_metadata: NotRequired[
        "capo_mediatailor.types.ad_break_metadata_list.AdBreakMetadataList"
    ]
...
def serialize_json(value: AdBreak) -> dict:
    ...
    if "message_type" in value:
        ...
        out["MessageType"] = capo_mediatailor.types.message_type.serialize_json(
            value["message_type"]
        )
    ...
    if "slate" in value:
        ...
        out["Slate"] = capo_mediatailor.types.slate_source.serialize_json(
            value["slate"]
        )
    if "splice_insert_message" in value:
        ...
        out["SpliceInsertMessage"] = (
            capo_mediatailor.types.splice_insert_message.serialize_json(
    ...
    if "time_signal_message" in value:
        ...
        out["TimeSignalMessage"] = (
            capo_mediatailor.types.time_signal_message.serialize_json(
    ...
    if "ad_break_metadata" in value:
        ...
        out["AdBreakMetadata"] = (
            capo_mediatailor.types.ad_break_metadata_list.serialize_json(
...
def deserialize_json(data: dict) -> AdBreak:
    ...
    if data.get("SpliceInsertMessage") is not None:
        ...
        out["splice_insert_message"] = (
            capo_mediatailor.types.splice_insert_message.deserialize_json(
    ...
    if data.get("TimeSignalMessage") is not None:
        ...
        out["time_signal_message"] = (
            capo_mediatailor.types.time_signal_message.deserialize_json(
    ...
    if data.get("AdBreakMetadata") is not None:
        ...
        out["ad_break_metadata"] = (
            capo_mediatailor.types.ad_break_metadata_list.deserialize_json(
