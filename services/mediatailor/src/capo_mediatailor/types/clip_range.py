...
class ClipRange(TypedDict, closed=True):
    end_offset_millis: "capo_mediatailor.types.__long.__long"
    ...
    start_offset_millis: NotRequired["capo_mediatailor.types.__long.__long"]
