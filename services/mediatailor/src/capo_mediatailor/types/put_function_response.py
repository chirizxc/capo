"""Generated from Smithy shape ``com.amazonaws.mediatailor#PutFunctionResponse``."""
...
class PutFunctionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: PutFunctionResponse) -> dict:
    out: dict = {}
