...
class HttpGatewayRouteRewrite(TypedDict, closed=True):
    prefix: NotRequired[
        "capo_app_mesh.types.http_gateway_route_prefix_rewrite.HttpGatewayRoutePrefixRewrite"
    ]
    """<p>The specified beginning characters to rewrite.</p>"""
    path: NotRequired[
        "capo_app_mesh.types.http_gateway_route_path_rewrite.HttpGatewayRoutePathRewrite"
    ]
...
def serialize_json(value: HttpGatewayRouteRewrite) -> dict:
    ...
    if "prefix" in value:
        ...
        out["prefix"] = (
            capo_app_mesh.types.http_gateway_route_prefix_rewrite.serialize_json(
                value["prefix"]
            )
        )
    if "path" in value:
        ...
        out["path"] = (
            capo_app_mesh.types.http_gateway_route_path_rewrite.serialize_json(
                value["path"]
            )
        )
...
def deserialize_json(data: dict) -> HttpGatewayRouteRewrite:
    ...
    if data.get("prefix") is not None:
        ...
        out["prefix"] = (
            capo_app_mesh.types.http_gateway_route_prefix_rewrite.deserialize_json(
                data["prefix"]
            )
        )
    if data.get("path") is not None:
        ...
        out["path"] = (
            capo_app_mesh.types.http_gateway_route_path_rewrite.deserialize_json(
                data["path"]
            )
        )
