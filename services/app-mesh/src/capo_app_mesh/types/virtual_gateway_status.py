...
if TYPE_CHECKING:
    import capo_app_mesh.types.virtual_gateway_status_code


class VirtualGatewayStatus(TypedDict, closed=True):
    status: "capo_app_mesh.types.virtual_gateway_status_code.VirtualGatewayStatusCode"
