"""Generated from Smithy shape ``com.amazonaws.appmesh#VirtualRouterRef``."""
...
class VirtualRouterRef(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: VirtualRouterRef) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> VirtualRouterRef:
    ...
    if data.get("lastUpdatedAt") is not None:
        ...
        raise DeserializationError("VirtualRouterRef.last_updated_at required")
    return out
