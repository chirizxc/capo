...
def handle_response(
    ...
    out: capo_ssm_guiconnect.types.delete_connection_recording_preferences_response.DeleteConnectionRecordingPreferencesResponse = capo_ssm_guiconnect.types.delete_connection_recording_preferences_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_guiconnect.types.delete_connection_recording_preferences_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
