"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeSessions``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_sessions_result.DescribeSessionsResult = (
        capo_appstream.types.describe_sessions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_sessions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_describe_sessions(
