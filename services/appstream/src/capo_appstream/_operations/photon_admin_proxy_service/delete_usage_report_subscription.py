...
def handle_response(
    ...
    out: capo_appstream.types.delete_usage_report_subscription_result.DeleteUsageReportSubscriptionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.delete_usage_report_subscription_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
