...
def handle_response(
    ...
    out: capo_appstream.types.create_fleet_result.CreateFleetResult = (
        capo_appstream.types.create_fleet_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.create_fleet_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_fleet(
    ...
    input_: capo_appstream.types.create_fleet_request.CreateFleetRequest,
) -> tuple[capo_appstream.types.create_fleet_result.CreateFleetResult, zapros.Response]:
