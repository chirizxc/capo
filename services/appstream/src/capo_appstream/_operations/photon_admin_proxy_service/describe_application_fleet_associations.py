"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeApplicationFleetAssociations``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_application_fleet_associations_result.DescribeApplicationFleetAssociationsResult = capo_appstream.types.describe_application_fleet_associations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_application_fleet_associations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_application_fleet_associations(
