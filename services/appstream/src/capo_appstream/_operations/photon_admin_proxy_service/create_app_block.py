...
def handle_response(
    ...
    out: capo_appstream.types.create_app_block_result.CreateAppBlockResult = (
        capo_appstream.types.create_app_block_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.create_app_block_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_app_block(
    ...
    capo_appstream.types.create_app_block_result.CreateAppBlockResult, zapros.Response
]:
