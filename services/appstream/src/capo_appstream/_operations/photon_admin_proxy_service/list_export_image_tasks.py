"""Generated from Smithy shape ``com.amazonaws.appstream#ListExportImageTasks``."""
...
def handle_response(
    ...
    out: capo_appstream.types.list_export_image_tasks_result.ListExportImageTasksResult = capo_appstream.types.list_export_image_tasks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.ListExportImageTasks"
    body: bytes | None = json.dumps(
        capo_appstream.types.list_export_image_tasks_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_export_image_tasks(
