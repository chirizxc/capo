"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeImageBuilders``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_image_builders_result.DescribeImageBuildersResult = capo_appstream.types.describe_image_builders_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_image_builders_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_image_builders(
