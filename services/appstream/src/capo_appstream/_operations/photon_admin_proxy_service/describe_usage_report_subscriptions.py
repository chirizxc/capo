...
def handle_response(
    ...
    out: capo_appstream.types.describe_usage_report_subscriptions_result.DescribeUsageReportSubscriptionsResult = capo_appstream.types.describe_usage_report_subscriptions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_usage_report_subscriptions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
