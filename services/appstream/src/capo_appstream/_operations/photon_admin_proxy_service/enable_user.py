...
def handle_response(
    ...
    out: capo_appstream.types.enable_user_result.EnableUserResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.enable_user_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def enable_user(
    ...
    input_: capo_appstream.types.enable_user_request.EnableUserRequest,
) -> tuple[capo_appstream.types.enable_user_result.EnableUserResult, zapros.Response]:
