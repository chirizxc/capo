...
def handle_response(
    ...
    out: capo_appstream.types.create_app_block_builder_streaming_url_result.CreateAppBlockBuilderStreamingURLResult = capo_appstream.types.create_app_block_builder_streaming_url_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.create_app_block_builder_streaming_url_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
