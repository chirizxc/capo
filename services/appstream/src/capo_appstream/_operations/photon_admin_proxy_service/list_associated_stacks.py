"""Generated from Smithy shape ``com.amazonaws.appstream#ListAssociatedStacks``."""
...
def handle_response(
    ...
    out: capo_appstream.types.list_associated_stacks_result.ListAssociatedStacksResult = capo_appstream.types.list_associated_stacks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.list_associated_stacks_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_associated_stacks(
