"""Generated from Smithy shape ``com.amazonaws.appstream#CopyImage``."""
...
def handle_response(
    ...
    out: capo_appstream.types.copy_image_response.CopyImageResponse = (
        capo_appstream.types.copy_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.copy_image_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def copy_image(
    ...
    input_: capo_appstream.types.copy_image_request.CopyImageRequest,
) -> tuple[capo_appstream.types.copy_image_response.CopyImageResponse, zapros.Response]:
