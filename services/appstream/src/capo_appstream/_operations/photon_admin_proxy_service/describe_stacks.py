"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeStacks``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_stacks_result.DescribeStacksResult = (
        capo_appstream.types.describe_stacks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_stacks_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_stacks(
    ...
    capo_appstream.types.describe_stacks_result.DescribeStacksResult, zapros.Response
]:
