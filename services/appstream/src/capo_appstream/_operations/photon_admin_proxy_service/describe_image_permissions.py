...
def handle_response(
    ...
    out: capo_appstream.types.describe_image_permissions_result.DescribeImagePermissionsResult = capo_appstream.types.describe_image_permissions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_image_permissions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
