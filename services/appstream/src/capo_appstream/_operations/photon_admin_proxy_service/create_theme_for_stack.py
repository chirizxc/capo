"""Generated from Smithy shape ``com.amazonaws.appstream#CreateThemeForStack``."""
...
def handle_response(
    ...
    out: capo_appstream.types.create_theme_for_stack_result.CreateThemeForStackResult = capo_appstream.types.create_theme_for_stack_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PhotonAdminProxyService.CreateThemeForStack"
    body: bytes | None = json.dumps(
        capo_appstream.types.create_theme_for_stack_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_theme_for_stack(
