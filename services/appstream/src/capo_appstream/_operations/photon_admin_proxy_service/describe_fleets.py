"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeFleets``."""
...
def handle_response(
    ...
    out: capo_appstream.types.describe_fleets_result.DescribeFleetsResult = (
        capo_appstream.types.describe_fleets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appstream.types.describe_fleets_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_fleets(
    ...
    capo_appstream.types.describe_fleets_result.DescribeFleetsResult, zapros.Response
]:
