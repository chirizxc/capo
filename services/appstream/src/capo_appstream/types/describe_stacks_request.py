"""Generated from Smithy shape ``com.amazonaws.appstream#DescribeStacksRequest``."""
...
class DescribeStacksRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeStacksRequest) -> dict:
    out: dict = {}
    if "names" in value:
        import capo_appstream.types.string_list
...
def deserialize_aws_json_1_1(data: dict) -> DescribeStacksRequest:
    out: DescribeStacksRequest = {}  # type: ignore[typeddict-item]
