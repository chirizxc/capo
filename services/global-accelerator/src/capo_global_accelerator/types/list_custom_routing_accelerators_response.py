...
class ListCustomRoutingAcceleratorsResponse(TypedDict, closed=True):
    accelerators: NotRequired[
        "capo_global_accelerator.types.custom_routing_accelerators.CustomRoutingAccelerators"
    ]
...
def serialize_aws_json_1_1(value: ListCustomRoutingAcceleratorsResponse) -> dict:
    ...
    if "accelerators" in value:
        ...
        out["Accelerators"] = (
            capo_global_accelerator.types.custom_routing_accelerators.serialize_aws_json_1_1(
                value["accelerators"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListCustomRoutingAcceleratorsResponse:
    ...
    if data.get("Accelerators") is not None:
        ...
        out["accelerators"] = (
            capo_global_accelerator.types.custom_routing_accelerators.deserialize_aws_json_1_1(
                data["Accelerators"]
            )
        )
