...
class CustomRoutingDestinationDescription(TypedDict, closed=True):
    from_port: NotRequired["capo_global_accelerator.types.port_number.PortNumber"]
    ...
    to_port: NotRequired["capo_global_accelerator.types.port_number.PortNumber"]
    ...
    protocols: NotRequired["capo_global_accelerator.types.protocols.Protocols"]
...
def serialize_aws_json_1_1(value: CustomRoutingDestinationDescription) -> dict:
    ...
    if "protocols" in value:
        ...
        out["Protocols"] = (
            capo_global_accelerator.types.protocols.serialize_aws_json_1_1(
                value["protocols"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CustomRoutingDestinationDescription:
    ...
    if data.get("Protocols") is not None:
        ...
        out["protocols"] = (
            capo_global_accelerator.types.protocols.deserialize_aws_json_1_1(
                data["Protocols"]
            )
        )
    return out
