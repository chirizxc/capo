"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#Listener``."""
...
class Listener(TypedDict, closed=True):
    ...
    protocol: NotRequired["capo_global_accelerator.types.protocol.Protocol"]
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: Listener) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> Listener:
