...
import capo_global_accelerator.types.custom_routing_accelerators
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_custom_routing_accelerators_response.ListCustomRoutingAcceleratorsResponse = capo_global_accelerator.types.list_custom_routing_accelerators_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_custom_routing_accelerators_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
