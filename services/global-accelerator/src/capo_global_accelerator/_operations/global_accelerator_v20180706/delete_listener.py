"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DeleteListener``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.delete_listener_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
