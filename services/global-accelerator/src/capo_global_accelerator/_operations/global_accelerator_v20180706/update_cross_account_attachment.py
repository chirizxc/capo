"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#UpdateCrossAccountAttachment``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.update_cross_account_attachment_response.UpdateCrossAccountAttachmentResponse = capo_global_accelerator.types.update_cross_account_attachment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.UpdateCrossAccountAttachment"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.update_cross_account_attachment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_cross_account_attachment(
