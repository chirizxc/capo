...
def handle_response(
    ...
    out: capo_global_accelerator.types.advertise_byoip_cidr_response.AdvertiseByoipCidrResponse = capo_global_accelerator.types.advertise_byoip_cidr_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.advertise_byoip_cidr_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
