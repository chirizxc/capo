"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DeleteAccelerator``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.delete_accelerator_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_accelerator(
