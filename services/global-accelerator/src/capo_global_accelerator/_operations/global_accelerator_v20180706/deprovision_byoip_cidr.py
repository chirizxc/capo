"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DeprovisionByoipCidr``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.deprovision_byoip_cidr_response.DeprovisionByoipCidrResponse = capo_global_accelerator.types.deprovision_byoip_cidr_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.DeprovisionByoipCidr"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.deprovision_byoip_cidr_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
