"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#RemoveEndpoints``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.RemoveEndpoints"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.remove_endpoints_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_remove_endpoints(
