"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_global_accelerator.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
