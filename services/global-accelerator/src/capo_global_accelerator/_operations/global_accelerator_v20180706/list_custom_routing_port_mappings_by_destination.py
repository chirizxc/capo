"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#ListCustomRoutingPortMappingsByDestination``."""
...
import capo_global_accelerator._protocol.eventstream
...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_custom_routing_port_mappings_by_destination_response.ListCustomRoutingPortMappingsByDestinationResponse = capo_global_accelerator.types.list_custom_routing_port_mappings_by_destination_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_global_accelerator._auth._sigv4.build_sigv4_auth_scheme(
                "globalaccelerator", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_custom_routing_port_mappings_by_destination_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_custom_routing_port_mappings_by_destination(
