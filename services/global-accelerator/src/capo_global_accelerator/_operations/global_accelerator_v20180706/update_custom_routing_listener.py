...
def handle_response(
    ...
    out: capo_global_accelerator.types.update_custom_routing_listener_response.UpdateCustomRoutingListenerResponse = capo_global_accelerator.types.update_custom_routing_listener_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.update_custom_routing_listener_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
