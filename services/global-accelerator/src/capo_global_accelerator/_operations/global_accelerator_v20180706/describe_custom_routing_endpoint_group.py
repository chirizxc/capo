...
def handle_response(
    ...
    out: capo_global_accelerator.types.describe_custom_routing_endpoint_group_response.DescribeCustomRoutingEndpointGroupResponse = capo_global_accelerator.types.describe_custom_routing_endpoint_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.describe_custom_routing_endpoint_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
