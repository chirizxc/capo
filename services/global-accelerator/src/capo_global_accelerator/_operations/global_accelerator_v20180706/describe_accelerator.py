"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#DescribeAccelerator``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.describe_accelerator_response.DescribeAcceleratorResponse = capo_global_accelerator.types.describe_accelerator_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.describe_accelerator_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_accelerator(
