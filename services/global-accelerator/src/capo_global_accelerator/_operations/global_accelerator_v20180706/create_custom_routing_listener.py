"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#CreateCustomRoutingListener``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.create_custom_routing_listener_response.CreateCustomRoutingListenerResponse = capo_global_accelerator.types.create_custom_routing_listener_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.CreateCustomRoutingListener"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.create_custom_routing_listener_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_custom_routing_listener(
