...
def handle_response(
    ...
    out: capo_global_accelerator.types.list_cross_account_resources_response.ListCrossAccountResourcesResponse = capo_global_accelerator.types.list_cross_account_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.list_cross_account_resources_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
