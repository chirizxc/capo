"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#AllowCustomRoutingTraffic``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.AllowCustomRoutingTraffic"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.allow_custom_routing_traffic_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_allow_custom_routing_traffic(
