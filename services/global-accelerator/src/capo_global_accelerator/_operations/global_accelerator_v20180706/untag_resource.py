"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#UntagResource``."""
...
def handle_response(
    ...
    out: capo_global_accelerator.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "GlobalAccelerator_V20180706.UntagResource"
    body: bytes | None = json.dumps(
        capo_global_accelerator.types.untag_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
