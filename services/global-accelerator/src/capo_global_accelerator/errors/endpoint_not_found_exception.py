"""Generated from Smithy shape ``com.amazonaws.globalaccelerator#EndpointNotFoundException``."""
...
class EndpointNotFoundException_(TypedDict, closed=True):
    message: NotRequired["capo_global_accelerator.types.error_message.ErrorMessage"]


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: EndpointNotFoundException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class EndpointNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.globalaccelerator#EndpointNotFoundException``."""
