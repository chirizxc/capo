"""Generated from Smithy shape ``com.amazonaws.mediaconvert#TooManyRequestsException``."""
...
class TooManyRequestsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediaconvert#TooManyRequestsException``."""
