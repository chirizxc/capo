...
class VideoDescription(TypedDict, closed=True):
    afd_signaling: NotRequired["capo_mediaconvert.types.afd_signaling.AfdSignaling"]
    ...
    anti_alias: NotRequired["capo_mediaconvert.types.anti_alias.AntiAlias"]
    """The anti-alias filter is automatically applied to all outputs. The service no longer accepts the value DISABLED for AntiAlias. If you specify that in your job, the service will ignore the setting."""
    chroma_position_mode: NotRequired[
        "capo_mediaconvert.types.chroma_position_mode.ChromaPositionMode"
    ]
    ...
    codec_settings: NotRequired[
        "capo_mediaconvert.types.video_codec_settings.VideoCodecSettings"
    ]
    ...
    color_metadata: NotRequired["capo_mediaconvert.types.color_metadata.ColorMetadata"]
    ...
    drop_frame_timecode: NotRequired[
        "capo_mediaconvert.types.drop_frame_timecode.DropFrameTimecode"
    ]
    ...
    respond_to_afd: NotRequired["capo_mediaconvert.types.respond_to_afd.RespondToAfd"]
    ...
    scaling_behavior: NotRequired[
        "capo_mediaconvert.types.scaling_behavior.ScalingBehavior"
    ]
    ...
    timecode_insertion: NotRequired[
        "capo_mediaconvert.types.video_timecode_insertion.VideoTimecodeInsertion"
    ]
    ...
    timecode_track: NotRequired["capo_mediaconvert.types.timecode_track.TimecodeTrack"]
    ...
    video_preprocessors: NotRequired[
        "capo_mediaconvert.types.video_preprocessor.VideoPreprocessor"
    ]
...
def serialize_json(value: VideoDescription) -> dict:
    ...
    if "afd_signaling" in value:
        ...
        out["afdSignaling"] = capo_mediaconvert.types.afd_signaling.serialize_json(
            value["afd_signaling"]
        )
    if "anti_alias" in value:
        import capo_mediaconvert.types.anti_alias

        out["antiAlias"] = capo_mediaconvert.types.anti_alias.serialize_json(
            value["anti_alias"]
        )
    if "chroma_position_mode" in value:
        ...
        out["chromaPositionMode"] = (
            capo_mediaconvert.types.chroma_position_mode.serialize_json(
    ...
    if "codec_settings" in value:
        ...
        out["codecSettings"] = (
            capo_mediaconvert.types.video_codec_settings.serialize_json(
    ...
    if "color_metadata" in value:
        ...
        out["colorMetadata"] = capo_mediaconvert.types.color_metadata.serialize_json(
    ...
    if "drop_frame_timecode" in value:
        ...
        out["dropFrameTimecode"] = (
            capo_mediaconvert.types.drop_frame_timecode.serialize_json(
    ...
    if "respond_to_afd" in value:
        ...
        out["respondToAfd"] = capo_mediaconvert.types.respond_to_afd.serialize_json(
    ...
    if "scaling_behavior" in value:
        ...
        out["scalingBehavior"] = (
            capo_mediaconvert.types.scaling_behavior.serialize_json(
    ...
    if "timecode_insertion" in value:
        ...
        out["timecodeInsertion"] = (
            capo_mediaconvert.types.video_timecode_insertion.serialize_json(
    ...
    if "timecode_track" in value:
        ...
        out["timecodeTrack"] = capo_mediaconvert.types.timecode_track.serialize_json(
    ...
    if "video_preprocessors" in value:
        ...
        out["videoPreprocessors"] = (
            capo_mediaconvert.types.video_preprocessor.serialize_json(
...
def deserialize_json(data: dict) -> VideoDescription:
    ...
    if data.get("chromaPositionMode") is not None:
        ...
        out["chroma_position_mode"] = (
            capo_mediaconvert.types.chroma_position_mode.deserialize_json(
    ...
    if data.get("codecSettings") is not None:
        ...
        out["codec_settings"] = (
            capo_mediaconvert.types.video_codec_settings.deserialize_json(
                data["codecSettings"]
            )
        )
    ...
    if data.get("dropFrameTimecode") is not None:
        ...
        out["drop_frame_timecode"] = (
            capo_mediaconvert.types.drop_frame_timecode.deserialize_json(
    ...
    if data.get("scalingBehavior") is not None:
        ...
        out["scaling_behavior"] = (
            capo_mediaconvert.types.scaling_behavior.deserialize_json(
    ...
    if data.get("timecodeInsertion") is not None:
        ...
        out["timecode_insertion"] = (
            capo_mediaconvert.types.video_timecode_insertion.deserialize_json(
    ...
    if data.get("videoPreprocessors") is not None:
        ...
        out["video_preprocessors"] = (
            capo_mediaconvert.types.video_preprocessor.deserialize_json(
