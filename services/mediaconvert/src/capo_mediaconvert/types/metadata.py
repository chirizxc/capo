...
class Metadata(TypedDict, closed=True):
    e_tag: NotRequired["capo_mediaconvert.types.__string.__string"]
    """The entity tag (ETag) of the file."""
    file_size: NotRequired["capo_mediaconvert.types.__long.__long"]
    ...
    mime_type: NotRequired["capo_mediaconvert.types.__string.__string"]
...
def serialize_json(value: Metadata) -> dict:
    ...
    if "last_modified" in value:
        ...
        out["lastModified"] = capo_mediaconvert.types.__timestamp_unix.serialize_json(
            value["last_modified"]
        )
