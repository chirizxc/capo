...
class Queue(TypedDict, closed=True):
    ...
    progressing_jobs_count: NotRequired["capo_mediaconvert.types.__integer.__integer"]
    """The estimated number of jobs with a PROGRESSING status."""
    reservation_plan: NotRequired[
        "capo_mediaconvert.types.reservation_plan.ReservationPlan"
    ]
    """Details about the pricing plan for your reserved queue. Required for reserved queues and not applicable to on-demand queues."""
    service_overrides: NotRequired[
        "capo_mediaconvert.types.__list_of_service_override.__listOfServiceOverride"
    ]
    ...
    submitted_jobs_count: NotRequired["capo_mediaconvert.types.__integer.__integer"]
...
def serialize_json(value: Queue) -> dict:
    ...
    if "reservation_plan" in value:
        ...
        out["reservationPlan"] = (
            capo_mediaconvert.types.reservation_plan.serialize_json(
    ...
    if "service_overrides" in value:
        ...
        out["serviceOverrides"] = (
            capo_mediaconvert.types.__list_of_service_override.serialize_json(
...
def deserialize_json(data: dict) -> Queue:
    ...
    if data.get("reservationPlan") is not None:
        ...
        out["reservation_plan"] = (
            capo_mediaconvert.types.reservation_plan.deserialize_json(
    ...
    if data.get("serviceOverrides") is not None:
        ...
        out["service_overrides"] = (
            capo_mediaconvert.types.__list_of_service_override.deserialize_json(
