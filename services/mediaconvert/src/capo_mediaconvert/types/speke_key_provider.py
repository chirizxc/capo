...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__list_of__string_pattern09a_faf809a_faf409a_faf409a_faf409a_faf12
...
class SpekeKeyProvider(TypedDict, closed=True):
    ...
    resource_id: NotRequired["capo_mediaconvert.types.__string.__string"]
    """Specify the resource ID that your SPEKE-compliant key provider uses to identify this content."""
    system_ids: NotRequired[
        "capo_mediaconvert.types.__list_of__string_pattern09a_faf809a_faf409a_faf409a_faf409a_faf12.__listOf__stringPattern09aFAF809aFAF409aFAF409aFAF409aFAF12"
    ]
...
def serialize_json(value: SpekeKeyProvider) -> dict:
    ...
    if "system_ids" in value:
        ...
        out["systemIds"] = (
            capo_mediaconvert.types.__list_of__string_pattern09a_faf809a_faf409a_faf409a_faf409a_faf12.serialize_json(
                value["system_ids"]
            )
        )
    if "url" in value:
...
def deserialize_json(data: dict) -> SpekeKeyProvider:
    ...
    if data.get("systemIds") is not None:
        ...
        out["system_ids"] = (
            capo_mediaconvert.types.__list_of__string_pattern09a_faf809a_faf409a_faf409a_faf409a_faf12.deserialize_json(
                data["systemIds"]
            )
        )
