"""Generated from Smithy shape ``com.amazonaws.mediaconvert#HlsImageBasedTrickPlayVariant``."""
...
class HlsImageBasedTrickPlayVariant(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: HlsImageBasedTrickPlayVariant) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> HlsImageBasedTrickPlayVariant:
    out: HlsImageBasedTrickPlayVariant = {}  # type: ignore[typeddict-item]
