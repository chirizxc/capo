...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__integer_min_negative180_max180
...
class ColorCorrector(TypedDict, closed=True):
    ...
    """Brightness level."""
    clip_limits: NotRequired["capo_mediaconvert.types.clip_limits.ClipLimits"]
    """Specify YUV limits and RGB tolerances when you set Sample range conversion to Limited range clip."""
    color_space_conversion: NotRequired[
        "capo_mediaconvert.types.color_space_conversion.ColorSpaceConversion"
    ]
    ...
    hdr_to_sdr_tone_mapper: NotRequired[
        "capo_mediaconvert.types.hdr_to_sdr_tone_mapper.HDRToSDRToneMapper"
    ]
    ...
    hue: NotRequired[
        "capo_mediaconvert.types.__integer_min_negative180_max180.__integerMinNegative180Max180"
    ]
    """Hue in degrees."""
    ...
    sample_range_conversion: NotRequired[
        "capo_mediaconvert.types.sample_range_conversion.SampleRangeConversion"
    ]
...
def serialize_json(value: ColorCorrector) -> dict:
    ...
    if "clip_limits" in value:
        ...
        out["clipLimits"] = capo_mediaconvert.types.clip_limits.serialize_json(
            value["clip_limits"]
        )
    if "color_space_conversion" in value:
        ...
        out["colorSpaceConversion"] = (
            capo_mediaconvert.types.color_space_conversion.serialize_json(
    ...
    if "hdr_to_sdr_tone_mapper" in value:
        ...
        out["hdrToSdrToneMapper"] = (
            capo_mediaconvert.types.hdr_to_sdr_tone_mapper.serialize_json(
    ...
    if "sample_range_conversion" in value:
        ...
        out["sampleRangeConversion"] = (
            capo_mediaconvert.types.sample_range_conversion.serialize_json(
...
def deserialize_json(data: dict) -> ColorCorrector:
    ...
    if data.get("colorSpaceConversion") is not None:
        ...
        out["color_space_conversion"] = (
            capo_mediaconvert.types.color_space_conversion.deserialize_json(
    ...
    if data.get("hdrToSdrToneMapper") is not None:
        ...
        out["hdr_to_sdr_tone_mapper"] = (
            capo_mediaconvert.types.hdr_to_sdr_tone_mapper.deserialize_json(
    ...
    if data.get("sampleRangeConversion") is not None:
        ...
        out["sample_range_conversion"] = (
            capo_mediaconvert.types.sample_range_conversion.deserialize_json(
