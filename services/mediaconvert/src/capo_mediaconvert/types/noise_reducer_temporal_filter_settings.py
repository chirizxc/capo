...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__integer_min0_max4
    import capo_mediaconvert.types.__integer_min0_max16
    import capo_mediaconvert.types.__integer_min_negative1_max3
...
class NoiseReducerTemporalFilterSettings(TypedDict, closed=True):
    aggressive_mode: NotRequired[
        "capo_mediaconvert.types.__integer_min0_max4.__integerMin0Max4"
    ]
    """Use Aggressive mode for content that has complex motion. Higher values produce stronger temporal filtering. This filters highly complex scenes more aggressively and creates better VQ for low bitrate outputs."""
    post_temporal_sharpening: NotRequired[
        "capo_mediaconvert.types.noise_filter_post_temporal_sharpening.NoiseFilterPostTemporalSharpening"
    ]
    ...
    post_temporal_sharpening_strength: NotRequired[
        "capo_mediaconvert.types.noise_filter_post_temporal_sharpening_strength.NoiseFilterPostTemporalSharpeningStrength"
    ]
    ...
    speed: NotRequired[
        "capo_mediaconvert.types.__integer_min_negative1_max3.__integerMinNegative1Max3"
    ]
...
def serialize_json(value: NoiseReducerTemporalFilterSettings) -> dict:
    ...
    if "post_temporal_sharpening" in value:
        ...
        out["postTemporalSharpening"] = (
            capo_mediaconvert.types.noise_filter_post_temporal_sharpening.serialize_json(
    ...
    if "post_temporal_sharpening_strength" in value:
        ...
        out["postTemporalSharpeningStrength"] = (
            capo_mediaconvert.types.noise_filter_post_temporal_sharpening_strength.serialize_json(
...
def deserialize_json(data: dict) -> NoiseReducerTemporalFilterSettings:
    ...
    if data.get("postTemporalSharpening") is not None:
        ...
        out["post_temporal_sharpening"] = (
            capo_mediaconvert.types.noise_filter_post_temporal_sharpening.deserialize_json(
    ...
    if data.get("postTemporalSharpeningStrength") is not None:
        ...
        out["post_temporal_sharpening_strength"] = (
            capo_mediaconvert.types.noise_filter_post_temporal_sharpening_strength.deserialize_json(
