...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__integer_min1_max17895697
    import capo_mediaconvert.types.__integer_min1_max2147483640


class MotionImageInsertionFramerate(TypedDict, closed=True):
    framerate_denominator: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max17895697.__integerMin1Max17895697"
    ]
    """The bottom of the fraction that expresses your overlay frame rate. For example, if your frame rate is 24 fps, set this value to 1."""
    framerate_numerator: NotRequired[
        "capo_mediaconvert.types.__integer_min1_max2147483640.__integerMin1Max2147483640"
    ]
