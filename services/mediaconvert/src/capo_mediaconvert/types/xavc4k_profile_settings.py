...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__integer_min8_max12
...
class Xavc4kProfileSettings(TypedDict, closed=True):
    bitrate_class: NotRequired[
        "capo_mediaconvert.types.xavc4k_profile_bitrate_class.Xavc4kProfileBitrateClass"
    ]
    ...
    codec_profile: NotRequired[
        "capo_mediaconvert.types.xavc4k_profile_codec_profile.Xavc4kProfileCodecProfile"
    ]
    ...
    quality_tuning_level: NotRequired[
        "capo_mediaconvert.types.xavc4k_profile_quality_tuning_level.Xavc4kProfileQualityTuningLevel"
    ]
    """Optional. Use Quality tuning level to choose how you want to trade off encoding speed for output video quality. The default behavior is faster, lower quality, single-pass encoding."""
    slices: NotRequired[
        "capo_mediaconvert.types.__integer_min8_max12.__integerMin8Max12"
    ]
...
def serialize_json(value: Xavc4kProfileSettings) -> dict:
    ...
    if "bitrate_class" in value:
        ...
        out["bitrateClass"] = (
            capo_mediaconvert.types.xavc4k_profile_bitrate_class.serialize_json(
                value["bitrate_class"]
            )
        )
    if "codec_profile" in value:
        ...
        out["codecProfile"] = (
            capo_mediaconvert.types.xavc4k_profile_codec_profile.serialize_json(
                value["codec_profile"]
            )
        )
    ...
    if "quality_tuning_level" in value:
        ...
        out["qualityTuningLevel"] = (
            capo_mediaconvert.types.xavc4k_profile_quality_tuning_level.serialize_json(
...
def deserialize_json(data: dict) -> Xavc4kProfileSettings:
    ...
    if data.get("bitrateClass") is not None:
        ...
        out["bitrate_class"] = (
            capo_mediaconvert.types.xavc4k_profile_bitrate_class.deserialize_json(
                data["bitrateClass"]
            )
        )
    if data.get("codecProfile") is not None:
        ...
        out["codec_profile"] = (
            capo_mediaconvert.types.xavc4k_profile_codec_profile.deserialize_json(
                data["codecProfile"]
            )
        )
    ...
    if data.get("qualityTuningLevel") is not None:
        ...
        out["quality_tuning_level"] = (
            capo_mediaconvert.types.xavc4k_profile_quality_tuning_level.deserialize_json(
