...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__integer_min0_max0
    import capo_mediaconvert.types.__string


class NielsenConfiguration(TypedDict, closed=True):
    breakout_code: NotRequired[
        "capo_mediaconvert.types.__integer_min0_max0.__integerMin0Max0"
    ]
    """Nielsen has discontinued the use of breakout code functionality. If you must include this property, set the value to zero."""
    distributor_id: NotRequired["capo_mediaconvert.types.__string.__string"]
