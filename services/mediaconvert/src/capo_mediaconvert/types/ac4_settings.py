...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__double_min_negative1000_max3
    import capo_mediaconvert.types.__double_min_negative1000_max_negative1
    import capo_mediaconvert.types.__integer_min48000_max48000
    import capo_mediaconvert.types.__integer_min48000_max768000
...
class Ac4Settings(TypedDict, closed=True):
    bitrate: NotRequired[
        "capo_mediaconvert.types.__integer_min48000_max768000.__integerMin48000Max768000"
    ]
    ...
    bitstream_mode: NotRequired[
        "capo_mediaconvert.types.ac4_bitstream_mode.Ac4BitstreamMode"
    ]
    ...
    coding_mode: NotRequired["capo_mediaconvert.types.ac4_coding_mode.Ac4CodingMode"]
    ...
    dynamic_range_compression_flat_panel_tv: NotRequired[
        "capo_mediaconvert.types.ac4_dynamic_range_compression_drc_profile.Ac4DynamicRangeCompressionDrcProfile"
    ]
    ...
    lo_ro_center_mix_level: NotRequired[
        "capo_mediaconvert.types.__double_min_negative1000_max3.__doubleMinNegative1000Max3"
    ]
    ...
    lo_ro_surround_mix_level: NotRequired[
        "capo_mediaconvert.types.__double_min_negative1000_max_negative1.__doubleMinNegative1000MaxNegative1"
    ]
    ...
    stereo_downmix: NotRequired[
        "capo_mediaconvert.types.ac4_stereo_downmix.Ac4StereoDownmix"
    ]
...
def serialize_json(value: Ac4Settings) -> dict:
    ...
    if "bitstream_mode" in value:
        ...
        out["bitstreamMode"] = (
            capo_mediaconvert.types.ac4_bitstream_mode.serialize_json(
    ...
    if "coding_mode" in value:
        ...
        out["codingMode"] = capo_mediaconvert.types.ac4_coding_mode.serialize_json(
            value["coding_mode"]
        )
    if "dynamic_range_compression_flat_panel_tv" in value:
        ...
        out["dynamicRangeCompressionFlatPanelTv"] = (
            capo_mediaconvert.types.ac4_dynamic_range_compression_drc_profile.serialize_json(
    ...
    if "stereo_downmix" in value:
        ...
        out["stereoDownmix"] = (
            capo_mediaconvert.types.ac4_stereo_downmix.serialize_json(
...
def deserialize_json(data: dict) -> Ac4Settings:
    ...
    if data.get("bitstreamMode") is not None:
        ...
        out["bitstream_mode"] = (
            capo_mediaconvert.types.ac4_bitstream_mode.deserialize_json(
                data["bitstreamMode"]
            )
        )
    ...
    if data.get("dynamicRangeCompressionFlatPanelTv") is not None:
        ...
        out["dynamic_range_compression_flat_panel_tv"] = (
            capo_mediaconvert.types.ac4_dynamic_range_compression_drc_profile.deserialize_json(
    ...
    if data.get("stereoDownmix") is not None:
        ...
        out["stereo_downmix"] = (
            capo_mediaconvert.types.ac4_stereo_downmix.deserialize_json(
                data["stereoDownmix"]
            )
        )
    return out
