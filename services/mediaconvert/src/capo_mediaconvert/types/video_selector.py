...
class VideoSelector(TypedDict, closed=True):
    alpha_behavior: NotRequired["capo_mediaconvert.types.alpha_behavior.AlphaBehavior"]
    """Ignore this setting unless this input is a QuickTime animation with an alpha channel. Use this setting to create separate Key and Fill outputs. In each output, specify which part of the input MediaConvert uses. Leave this setting at the default value DISCARD to delete the alpha channel and preserve the video. Set it to REMAP_TO_LUMA to delete the video and map the alpha channel to the luma channel of your outputs."""
    color_space: NotRequired["capo_mediaconvert.types.color_space.ColorSpace"]
    ...
    color_space_usage: NotRequired[
        "capo_mediaconvert.types.color_space_usage.ColorSpaceUsage"
    ]
    ...
    embedded_timecode_override: NotRequired[
        "capo_mediaconvert.types.embedded_timecode_override.EmbeddedTimecodeOverride"
    ]
    ...
    hdr10_metadata: NotRequired["capo_mediaconvert.types.hdr10_metadata.Hdr10Metadata"]
    ...
    pad_video: NotRequired["capo_mediaconvert.types.pad_video.PadVideo"]
    ...
    rotate: NotRequired["capo_mediaconvert.types.input_rotate.InputRotate"]
    ...
    sample_range: NotRequired[
        "capo_mediaconvert.types.input_sample_range.InputSampleRange"
    ]
    ...
    selector_type: NotRequired[
        "capo_mediaconvert.types.video_selector_type.VideoSelectorType"
    ]
...
def serialize_json(value: VideoSelector) -> dict:
    ...
    if "alpha_behavior" in value:
        ...
        out["alphaBehavior"] = capo_mediaconvert.types.alpha_behavior.serialize_json(
            value["alpha_behavior"]
        )
    if "color_space" in value:
        import capo_mediaconvert.types.color_space

        out["colorSpace"] = capo_mediaconvert.types.color_space.serialize_json(
            value["color_space"]
        )
    if "color_space_usage" in value:
        ...
        out["colorSpaceUsage"] = (
            capo_mediaconvert.types.color_space_usage.serialize_json(
    ...
    if "embedded_timecode_override" in value:
        ...
        out["embeddedTimecodeOverride"] = (
            capo_mediaconvert.types.embedded_timecode_override.serialize_json(
    ...
    if "hdr10_metadata" in value:
        ...
        out["hdr10Metadata"] = capo_mediaconvert.types.hdr10_metadata.serialize_json(
    ...
    if "pad_video" in value:
        ...
        out["padVideo"] = capo_mediaconvert.types.pad_video.serialize_json(
            value["pad_video"]
        )
    if "pid" in value:
        out["pid"] = value["pid"]
    ...
    if "rotate" in value:
        ...
        out["rotate"] = capo_mediaconvert.types.input_rotate.serialize_json(
            value["rotate"]
        )
    if "sample_range" in value:
        import capo_mediaconvert.types.input_sample_range

        out["sampleRange"] = capo_mediaconvert.types.input_sample_range.serialize_json(
            value["sample_range"]
        )
    if "selector_type" in value:
        ...
        out["selectorType"] = (
            capo_mediaconvert.types.video_selector_type.serialize_json(
                value["selector_type"]
            )
        )
    if "streams" in value:
...
def deserialize_json(data: dict) -> VideoSelector:
    ...
    if data.get("colorSpaceUsage") is not None:
        ...
        out["color_space_usage"] = (
            capo_mediaconvert.types.color_space_usage.deserialize_json(
    ...
    if data.get("embeddedTimecodeOverride") is not None:
        ...
        out["embedded_timecode_override"] = (
            capo_mediaconvert.types.embedded_timecode_override.deserialize_json(
    ...
    if data.get("sampleRange") is not None:
        ...
        out["sample_range"] = (
            capo_mediaconvert.types.input_sample_range.deserialize_json(
                data["sampleRange"]
            )
        )
    if data.get("selectorType") is not None:
        ...
        out["selector_type"] = (
            capo_mediaconvert.types.video_selector_type.deserialize_json(
                data["selectorType"]
            )
        )
