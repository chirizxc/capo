...
class OutputGroupSettings(TypedDict, closed=True):
    cmaf_group_settings: NotRequired[
        "capo_mediaconvert.types.cmaf_group_settings.CmafGroupSettings"
    ]
    ...
    dash_iso_group_settings: NotRequired[
        "capo_mediaconvert.types.dash_iso_group_settings.DashIsoGroupSettings"
    ]
    ...
    file_group_settings: NotRequired[
        "capo_mediaconvert.types.file_group_settings.FileGroupSettings"
    ]
    ...
    hls_group_settings: NotRequired[
        "capo_mediaconvert.types.hls_group_settings.HlsGroupSettings"
    ]
    ...
    ms_smooth_group_settings: NotRequired[
        "capo_mediaconvert.types.ms_smooth_group_settings.MsSmoothGroupSettings"
    ]
    ...
    type: NotRequired["capo_mediaconvert.types.output_group_type.OutputGroupType"]
...
def serialize_json(value: OutputGroupSettings) -> dict:
    ...
    if "cmaf_group_settings" in value:
        ...
        out["cmafGroupSettings"] = (
            capo_mediaconvert.types.cmaf_group_settings.serialize_json(
    ...
    if "dash_iso_group_settings" in value:
        ...
        out["dashIsoGroupSettings"] = (
            capo_mediaconvert.types.dash_iso_group_settings.serialize_json(
    ...
    if "file_group_settings" in value:
        ...
        out["fileGroupSettings"] = (
            capo_mediaconvert.types.file_group_settings.serialize_json(
    ...
    if "hls_group_settings" in value:
        ...
        out["hlsGroupSettings"] = (
            capo_mediaconvert.types.hls_group_settings.serialize_json(
    ...
    if "ms_smooth_group_settings" in value:
        ...
        out["msSmoothGroupSettings"] = (
            capo_mediaconvert.types.ms_smooth_group_settings.serialize_json(
    ...
    if "type" in value:
        ...
        out["type"] = capo_mediaconvert.types.output_group_type.serialize_json(
            value["type"]
        )
    return out
...
def deserialize_json(data: dict) -> OutputGroupSettings:
    ...
    if data.get("cmafGroupSettings") is not None:
        ...
        out["cmaf_group_settings"] = (
            capo_mediaconvert.types.cmaf_group_settings.deserialize_json(
    ...
    if data.get("dashIsoGroupSettings") is not None:
        ...
        out["dash_iso_group_settings"] = (
            capo_mediaconvert.types.dash_iso_group_settings.deserialize_json(
    ...
    if data.get("fileGroupSettings") is not None:
        ...
        out["file_group_settings"] = (
            capo_mediaconvert.types.file_group_settings.deserialize_json(
    ...
    if data.get("hlsGroupSettings") is not None:
        ...
        out["hls_group_settings"] = (
            capo_mediaconvert.types.hls_group_settings.deserialize_json(
    ...
    if data.get("msSmoothGroupSettings") is not None:
        ...
        out["ms_smooth_group_settings"] = (
            capo_mediaconvert.types.ms_smooth_group_settings.deserialize_json(
