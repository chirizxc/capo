...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__string_pattern_sn_signal_processing_notification_ns


class EsamSignalProcessingNotification(TypedDict, closed=True):
    scc_xml: NotRequired[
        "capo_mediaconvert.types.__string_pattern_sn_signal_processing_notification_ns.__stringPatternSNSignalProcessingNotificationNS"
    ]
