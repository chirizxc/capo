...
class GifSettings(TypedDict, closed=True):
    framerate_control: NotRequired[
        "capo_mediaconvert.types.gif_framerate_control.GifFramerateControl"
    ]
    ...
    framerate_conversion_algorithm: NotRequired[
        "capo_mediaconvert.types.gif_framerate_conversion_algorithm.GifFramerateConversionAlgorithm"
    ]
...
def serialize_json(value: GifSettings) -> dict:
    ...
    if "framerate_control" in value:
        ...
        out["framerateControl"] = (
            capo_mediaconvert.types.gif_framerate_control.serialize_json(
    ...
    if "framerate_conversion_algorithm" in value:
        ...
        out["framerateConversionAlgorithm"] = (
            capo_mediaconvert.types.gif_framerate_conversion_algorithm.serialize_json(
...
def deserialize_json(data: dict) -> GifSettings:
    ...
    if data.get("framerateControl") is not None:
        ...
        out["framerate_control"] = (
            capo_mediaconvert.types.gif_framerate_control.deserialize_json(
    ...
    if data.get("framerateConversionAlgorithm") is not None:
        ...
        out["framerate_conversion_algorithm"] = (
            capo_mediaconvert.types.gif_framerate_conversion_algorithm.deserialize_json(
