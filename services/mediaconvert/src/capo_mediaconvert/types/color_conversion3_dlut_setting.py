...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__string_min14_pattern_s3_cube_cube_https_cube_cube
    import capo_mediaconvert.types.color_space


class ColorConversion3DLUTSetting(TypedDict, closed=True):
    file_input: NotRequired[
        "capo_mediaconvert.types.__string_min14_pattern_s3_cube_cube_https_cube_cube.__stringMin14PatternS3CubeCUBEHttpsCubeCUBE"
    ]
    ...
    input_color_space: NotRequired["capo_mediaconvert.types.color_space.ColorSpace"]
    ...
    output_color_space: NotRequired["capo_mediaconvert.types.color_space.ColorSpace"]
...
def serialize_json(value: ColorConversion3DLUTSetting) -> dict:
    ...
    if "input_color_space" in value:
        ...
        out["inputColorSpace"] = capo_mediaconvert.types.color_space.serialize_json(
    ...
    if "output_color_space" in value:
        ...
        out["outputColorSpace"] = capo_mediaconvert.types.color_space.serialize_json(
...
def deserialize_json(data: dict) -> ColorConversion3DLUTSetting:
    ...
    if data.get("outputColorSpace") is not None:
        ...
        out["output_color_space"] = (
            capo_mediaconvert.types.color_space.deserialize_json(
