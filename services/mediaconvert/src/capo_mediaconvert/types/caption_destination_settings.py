...
class CaptionDestinationSettings(TypedDict, closed=True):
    burnin_destination_settings: NotRequired[
        "capo_mediaconvert.types.burnin_destination_settings.BurninDestinationSettings"
    ]
    ...
    dvb_sub_destination_settings: NotRequired[
        "capo_mediaconvert.types.dvb_sub_destination_settings.DvbSubDestinationSettings"
    ]
    ...
    embedded_destination_settings: NotRequired[
        "capo_mediaconvert.types.embedded_destination_settings.EmbeddedDestinationSettings"
    ]
    ...
    imsc_destination_settings: NotRequired[
        "capo_mediaconvert.types.imsc_destination_settings.ImscDestinationSettings"
    ]
    """Settings related to IMSC captions. IMSC is a sidecar format that holds captions in a file that is separate from the video container. Set up sidecar captions in the same output group, but different output from your video. For more information, see https://docs.aws.amazon.com/mediaconvert/latest/ug/ttml-and-webvtt-output-captions.html."""
    scc_destination_settings: NotRequired[
        "capo_mediaconvert.types.scc_destination_settings.SccDestinationSettings"
    ]
    ...
    srt_destination_settings: NotRequired[
        "capo_mediaconvert.types.srt_destination_settings.SrtDestinationSettings"
    ]
    ...
    teletext_destination_settings: NotRequired[
        "capo_mediaconvert.types.teletext_destination_settings.TeletextDestinationSettings"
    ]
    ...
    ttml_destination_settings: NotRequired[
        "capo_mediaconvert.types.ttml_destination_settings.TtmlDestinationSettings"
    ]
    """Settings related to TTML captions. TTML is a sidecar format that holds captions in a file that is separate from the video container. Set up sidecar captions in the same output group, but different output from your video. For more information, see https://docs.aws.amazon.com/mediaconvert/latest/ug/ttml-and-webvtt-output-captions.html."""
    webvtt_destination_settings: NotRequired[
        "capo_mediaconvert.types.webvtt_destination_settings.WebvttDestinationSettings"
    ]
...
def serialize_json(value: CaptionDestinationSettings) -> dict:
    ...
    if "burnin_destination_settings" in value:
        ...
        out["burninDestinationSettings"] = (
            capo_mediaconvert.types.burnin_destination_settings.serialize_json(
    ...
    if "destination_type" in value:
        ...
        out["destinationType"] = (
            capo_mediaconvert.types.caption_destination_type.serialize_json(
    ...
    if "dvb_sub_destination_settings" in value:
        ...
        out["dvbSubDestinationSettings"] = (
            capo_mediaconvert.types.dvb_sub_destination_settings.serialize_json(
    ...
    if "embedded_destination_settings" in value:
        ...
        out["embeddedDestinationSettings"] = (
            capo_mediaconvert.types.embedded_destination_settings.serialize_json(
    ...
    if "imsc_destination_settings" in value:
        ...
        out["imscDestinationSettings"] = (
            capo_mediaconvert.types.imsc_destination_settings.serialize_json(
    ...
    if "scc_destination_settings" in value:
        ...
        out["sccDestinationSettings"] = (
            capo_mediaconvert.types.scc_destination_settings.serialize_json(
    ...
    if "srt_destination_settings" in value:
        ...
        out["srtDestinationSettings"] = (
            capo_mediaconvert.types.srt_destination_settings.serialize_json(
    ...
    if "teletext_destination_settings" in value:
        ...
        out["teletextDestinationSettings"] = (
            capo_mediaconvert.types.teletext_destination_settings.serialize_json(
    ...
    if "ttml_destination_settings" in value:
        ...
        out["ttmlDestinationSettings"] = (
            capo_mediaconvert.types.ttml_destination_settings.serialize_json(
    ...
    if "webvtt_destination_settings" in value:
        ...
        out["webvttDestinationSettings"] = (
            capo_mediaconvert.types.webvtt_destination_settings.serialize_json(
...
def deserialize_json(data: dict) -> CaptionDestinationSettings:
    ...
    if data.get("burninDestinationSettings") is not None:
        ...
        out["burnin_destination_settings"] = (
            capo_mediaconvert.types.burnin_destination_settings.deserialize_json(
    ...
    if data.get("destinationType") is not None:
        ...
        out["destination_type"] = (
            capo_mediaconvert.types.caption_destination_type.deserialize_json(
    ...
    if data.get("dvbSubDestinationSettings") is not None:
        ...
        out["dvb_sub_destination_settings"] = (
            capo_mediaconvert.types.dvb_sub_destination_settings.deserialize_json(
    ...
    if data.get("embeddedDestinationSettings") is not None:
        ...
        out["embedded_destination_settings"] = (
            capo_mediaconvert.types.embedded_destination_settings.deserialize_json(
    ...
    if data.get("imscDestinationSettings") is not None:
        ...
        out["imsc_destination_settings"] = (
            capo_mediaconvert.types.imsc_destination_settings.deserialize_json(
    ...
    if data.get("sccDestinationSettings") is not None:
        ...
        out["scc_destination_settings"] = (
            capo_mediaconvert.types.scc_destination_settings.deserialize_json(
    ...
    if data.get("srtDestinationSettings") is not None:
        ...
        out["srt_destination_settings"] = (
            capo_mediaconvert.types.srt_destination_settings.deserialize_json(
    ...
    if data.get("teletextDestinationSettings") is not None:
        ...
        out["teletext_destination_settings"] = (
            capo_mediaconvert.types.teletext_destination_settings.deserialize_json(
    ...
    if data.get("ttmlDestinationSettings") is not None:
        ...
        out["ttml_destination_settings"] = (
            capo_mediaconvert.types.ttml_destination_settings.deserialize_json(
    ...
    if data.get("webvttDestinationSettings") is not None:
        ...
        out["webvtt_destination_settings"] = (
            capo_mediaconvert.types.webvtt_destination_settings.deserialize_json(
