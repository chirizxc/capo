...
if TYPE_CHECKING:
    import capo_mediaconvert.types.__string_pattern_a_za_z0902
    import capo_mediaconvert.types.__string_pattern_arn_aws_us_gov_cn_kms_az26_east_west_central_north_south_east_west1912_d12_key_afaf098_afaf094_afaf094_afaf094_afaf0912_mrk_afaf0932
...
class S3EncryptionSettings(TypedDict, closed=True):
    encryption_type: NotRequired[
        "capo_mediaconvert.types.s3_server_side_encryption_type.S3ServerSideEncryptionType"
    ]
    ...
    kms_encryption_context: NotRequired[
        "capo_mediaconvert.types.__string_pattern_a_za_z0902.__stringPatternAZaZ0902"
    ]
    ...
    kms_key_arn: NotRequired[
        "capo_mediaconvert.types.__string_pattern_arn_aws_us_gov_cn_kms_az26_east_west_central_north_south_east_west1912_d12_key_afaf098_afaf094_afaf094_afaf094_afaf0912_mrk_afaf0932.__stringPatternArnAwsUsGovCnKmsAZ26EastWestCentralNorthSouthEastWest1912D12KeyAFAF098AFAF094AFAF094AFAF094AFAF0912MrkAFAF0932"
    ]
...
def serialize_json(value: S3EncryptionSettings) -> dict:
    ...
    if "encryption_type" in value:
        ...
        out["encryptionType"] = (
            capo_mediaconvert.types.s3_server_side_encryption_type.serialize_json(
...
def deserialize_json(data: dict) -> S3EncryptionSettings:
    ...
    if data.get("encryptionType") is not None:
        ...
        out["encryption_type"] = (
            capo_mediaconvert.types.s3_server_side_encryption_type.deserialize_json(
                data["encryptionType"]
            )
        )
