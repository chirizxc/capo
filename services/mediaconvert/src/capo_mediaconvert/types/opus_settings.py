...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__integer_min16000_max48000
    import capo_mediaconvert.types.__integer_min32000_max192000


class OpusSettings(TypedDict, closed=True):
    bitrate: NotRequired[
        "capo_mediaconvert.types.__integer_min32000_max192000.__integerMin32000Max192000"
    ]
    ...
    sample_rate: NotRequired[
        "capo_mediaconvert.types.__integer_min16000_max48000.__integerMin16000Max48000"
    ]
