...
if TYPE_CHECKING:
    ...
    import capo_mediaconvert.types.__list_of_caption_description
    import capo_mediaconvert.types.__string_max256
    import capo_mediaconvert.types.__string_min0
    import capo_mediaconvert.types.__string_min1_max256
    import capo_mediaconvert.types.container_settings
    import capo_mediaconvert.types.output_settings
...
class Output(TypedDict, closed=True):
    ...
    caption_descriptions: NotRequired[
        "capo_mediaconvert.types.__list_of_caption_description.__listOfCaptionDescription"
    ]
    ...
    extension: NotRequired["capo_mediaconvert.types.__string_max256.__stringMax256"]
    ...
    output_settings: NotRequired[
        "capo_mediaconvert.types.output_settings.OutputSettings"
    ]
    """Specific settings for this type of output."""
    preset: NotRequired["capo_mediaconvert.types.__string_min0.__stringMin0"]
...
def serialize_json(value: Output) -> dict:
    ...
    if "caption_descriptions" in value:
        ...
        out["captionDescriptions"] = (
            capo_mediaconvert.types.__list_of_caption_description.serialize_json(
    ...
    if "output_settings" in value:
        ...
        out["outputSettings"] = capo_mediaconvert.types.output_settings.serialize_json(
...
def deserialize_json(data: dict) -> Output:
    ...
    if data.get("captionDescriptions") is not None:
        ...
        out["caption_descriptions"] = (
            capo_mediaconvert.types.__list_of_caption_description.deserialize_json(
    ...
    if data.get("outputSettings") is not None:
        ...
        out["output_settings"] = (
            capo_mediaconvert.types.output_settings.deserialize_json(
                data["outputSettings"]
            )
        )
