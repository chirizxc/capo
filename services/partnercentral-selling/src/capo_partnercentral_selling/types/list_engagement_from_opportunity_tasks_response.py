...
class ListEngagementFromOpportunityTasksResponse(TypedDict, closed=True):
    task_summaries: NotRequired[
        "capo_partnercentral_selling.types.list_engagement_from_opportunity_task_summaries.ListEngagementFromOpportunityTaskSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListEngagementFromOpportunityTasksResponse) -> dict:
    ...
    if "task_summaries" in value:
        ...
        out["TaskSummaries"] = (
            capo_partnercentral_selling.types.list_engagement_from_opportunity_task_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListEngagementFromOpportunityTasksResponse:
    ...
    if data.get("TaskSummaries") is not None:
        ...
        out["task_summaries"] = (
            capo_partnercentral_selling.types.list_engagement_from_opportunity_task_summaries.deserialize_aws_json_1_0(
                data["TaskSummaries"]
            )
        )
