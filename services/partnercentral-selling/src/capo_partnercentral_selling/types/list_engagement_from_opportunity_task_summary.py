"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#ListEngagementFromOpportunityTaskSummary``."""
...
class ListEngagementFromOpportunityTaskSummary(TypedDict, closed=True):
    task_id: NotRequired[
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListEngagementFromOpportunityTaskSummary) -> dict:
    out: dict = {}
    if "task_id" in value:
...
def deserialize_aws_json_1_0(data: dict) -> ListEngagementFromOpportunityTaskSummary:
    out: ListEngagementFromOpportunityTaskSummary = {}  # type: ignore[typeddict-item]
