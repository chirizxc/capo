"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#StartEngagementByAcceptingInvitationTask``."""
...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.start_engagement_by_accepting_invitation_task_response.StartEngagementByAcceptingInvitationTaskResponse = capo_partnercentral_selling.types.start_engagement_by_accepting_invitation_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/StartEngagementByAcceptingInvitationTask"
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.start_engagement_by_accepting_invitation_task_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_engagement_by_accepting_invitation_task(
