"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#StartEngagementFromOpportunityTask``."""
...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.start_engagement_from_opportunity_task_response.StartEngagementFromOpportunityTaskResponse = capo_partnercentral_selling.types.start_engagement_from_opportunity_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/StartEngagementFromOpportunityTask"
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.start_engagement_from_opportunity_task_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_engagement_from_opportunity_task(
