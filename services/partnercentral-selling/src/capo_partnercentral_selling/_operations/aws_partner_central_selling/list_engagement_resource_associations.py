"""Generated from Smithy shape ``com.amazonaws.partnercentralselling#ListEngagementResourceAssociations``."""
...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.list_engagement_resource_associations_response.ListEngagementResourceAssociationsResponse = capo_partnercentral_selling.types.list_engagement_resource_associations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ListEngagementResourceAssociations"
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.list_engagement_resource_associations_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_engagement_resource_associations(
