...
def handle_response(
    ...
    out: capo_partnercentral_selling.types.start_opportunity_from_engagement_task_response.StartOpportunityFromEngagementTaskResponse = capo_partnercentral_selling.types.start_opportunity_from_engagement_task_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_selling.types.start_opportunity_from_engagement_task_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
