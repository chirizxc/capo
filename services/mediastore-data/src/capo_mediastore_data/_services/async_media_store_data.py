...
class AsyncMediaStoreDataClient:
    ...
    async def delete_object(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediastore_data.types.delete_object_request.DeleteObjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediastore_data.types.delete_object_response.DeleteObjectResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediastore_data._operations.media_store_object_20170901.delete_object.async_delete_object(
    ...
    async def describe_object(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediastore_data.types.describe_object_request.DescribeObjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediastore_data.types.describe_object_response.DescribeObjectResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediastore_data._operations.media_store_object_20170901.describe_object.async_describe_object(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_object(
        ...
        *,
    ...
    ) -> "AsyncGenerator[capo_mediastore_data.types.get_object_response.GetObjectResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediastore_data.types.get_object_request.GetObjectRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_mediastore_data._operations.media_store_object_20170901.get_object.async_get_object(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_items(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediastore_data.types.list_items_request.ListItemsRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediastore_data.types.list_items_response.ListItemsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediastore_data._operations.media_store_object_20170901.list_items.async_list_items(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_mediastore_data.types.list_items_response.ListItemsResponse]":
        _token = next_token
        while True:
            _response = await self.list_items(
    ...
    async def put_object(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediastore_data.types.put_object_request.PutObjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediastore_data.types.put_object_response.PutObjectResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediastore_data._operations.media_store_object_20170901.put_object.async_put_object(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
