"""Generated from Smithy shape ``com.amazonaws.mediastoredata#ListItems``."""
...
def handle_response(
    ...
    out: capo_mediastore_data.types.list_items_response.ListItemsResponse = (
        capo_mediastore_data.types.list_items_response.deserialize_json(
...
def list_items(
    ...
    capo_mediastore_data.types.list_items_response.ListItemsResponse, zapros.Response
]:
