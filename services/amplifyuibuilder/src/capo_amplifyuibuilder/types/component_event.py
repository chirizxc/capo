...
class ComponentEvent(TypedDict, closed=True):
    ...
    parameters: NotRequired[
        "capo_amplifyuibuilder.types.action_parameters.ActionParameters"
    ]
...
def serialize_json(value: ComponentEvent) -> dict:
    ...
    if "parameters" in value:
        ...
        out["parameters"] = (
            capo_amplifyuibuilder.types.action_parameters.serialize_json(
                value["parameters"]
            )
        )
...
def deserialize_json(data: dict) -> ComponentEvent:
    ...
    if data.get("parameters") is not None:
        ...
        out["parameters"] = (
            capo_amplifyuibuilder.types.action_parameters.deserialize_json(
                data["parameters"]
            )
        )
