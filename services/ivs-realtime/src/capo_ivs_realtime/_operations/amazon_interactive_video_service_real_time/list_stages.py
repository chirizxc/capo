...
import capo_ivs_realtime.types.stage_summary_list
...
def handle_response(
    ...
    out: capo_ivs_realtime.types.list_stages_response.ListStagesResponse = (
        capo_ivs_realtime.types.list_stages_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs_realtime.types.list_stages_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_stages(
    ...
    capo_ivs_realtime.types.list_stages_response.ListStagesResponse, zapros.Response
]:
