...
def handle_response(
    ...
    out: capo_ivs_realtime.types.delete_ingest_configuration_response.DeleteIngestConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs_realtime.types.delete_ingest_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
