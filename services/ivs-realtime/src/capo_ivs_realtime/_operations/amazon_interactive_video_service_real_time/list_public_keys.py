...
def handle_response(
    ...
    out: capo_ivs_realtime.types.list_public_keys_response.ListPublicKeysResponse = (
        capo_ivs_realtime.types.list_public_keys_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs_realtime.types.list_public_keys_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
