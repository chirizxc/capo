...
def handle_response(
    ...
    out: capo_ivs_realtime.types.get_ingest_configuration_response.GetIngestConfigurationResponse = capo_ivs_realtime.types.get_ingest_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs_realtime.types.get_ingest_configuration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
