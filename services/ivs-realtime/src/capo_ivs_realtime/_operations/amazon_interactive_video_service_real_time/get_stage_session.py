...
def handle_response(
    ...
    out: capo_ivs_realtime.types.get_stage_session_response.GetStageSessionResponse = (
        capo_ivs_realtime.types.get_stage_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs_realtime.types.get_stage_session_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
