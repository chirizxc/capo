...
if TYPE_CHECKING:
    import capo_ivs_realtime.types.bitrate
    import capo_ivs_realtime.types.framerate
    import capo_ivs_realtime.types.height
    import capo_ivs_realtime.types.width


class Video(TypedDict, closed=True):
    width: NotRequired["capo_ivs_realtime.types.width.Width"]
    ...
    height: NotRequired["capo_ivs_realtime.types.height.Height"]
    ...
    framerate: NotRequired["capo_ivs_realtime.types.framerate.Framerate"]
    """<p>Video frame rate, in fps. Default: 30.</p>"""
    bitrate: NotRequired["capo_ivs_realtime.types.bitrate.Bitrate"]
