...
if TYPE_CHECKING:
    ...
    import capo_ivs_realtime.types.recording_configuration_format


class RecordingConfiguration(TypedDict, closed=True):
    hls_configuration: NotRequired[
        "capo_ivs_realtime.types.composition_recording_hls_configuration.CompositionRecordingHlsConfiguration"
    ]
    """<p>An HLS configuration object to return information about how the recording will be configured.</p>"""
    format: NotRequired[
        "capo_ivs_realtime.types.recording_configuration_format.RecordingConfigurationFormat"
    ]
...
def serialize_json(value: RecordingConfiguration) -> dict:
    ...
    if "hls_configuration" in value:
        ...
        out["hlsConfiguration"] = (
            capo_ivs_realtime.types.composition_recording_hls_configuration.serialize_json(
...
def deserialize_json(data: dict) -> RecordingConfiguration:
    ...
    if data.get("hlsConfiguration") is not None:
        ...
        out["hls_configuration"] = (
            capo_ivs_realtime.types.composition_recording_hls_configuration.deserialize_json(
