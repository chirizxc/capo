...
from capo_resource_explorer_2._resources.resource_explorer.cfn_index import CfnIndex
from capo_resource_explorer_2._resources.resource_explorer.cfn_view import CfnView
from capo_resource_explorer_2._resources.resource_explorer.default_view_association import (
    DefaultViewAssociation,
)
from capo_resource_explorer_2._services._aws_config import aws_config
...
class ResourceExplorer2ClientConfig(TypedDict, total=False, closed=True):
...
class ResourceExplorer2Client:
    ...
    def operation_options(
        ...
        overrides: ResourceExplorer2ClientConfig = config_overrides or {}
    ...
    def batch_get_view(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.batch_get_view_input.BatchGetViewInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.batch_get_view_output.BatchGetViewOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.batch_get_view.batch_get_view(
    ...
    def create_resource_explorer_setup(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.create_resource_explorer_setup_input.CreateResourceExplorerSetupInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.create_resource_explorer_setup_output.CreateResourceExplorerSetupOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.create_resource_explorer_setup.create_resource_explorer_setup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_explorer_setup(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.delete_resource_explorer_setup_input.DeleteResourceExplorerSetupInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.delete_resource_explorer_setup_output.DeleteResourceExplorerSetupOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.delete_resource_explorer_setup.delete_resource_explorer_setup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_default_view(
        ...
        def _handler(req: "OperationRequest[None]") -> OperationResponse[None]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.disassociate_default_view.disassociate_default_view(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_account_level_service_configuration(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.get_account_level_service_configuration.get_account_level_service_configuration(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_default_view(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.get_default_view.get_default_view(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_index(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.get_index.get_index(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_managed_view(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.get_managed_view_input.GetManagedViewInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.get_managed_view_output.GetManagedViewOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.get_managed_view.get_managed_view(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_explorer_setup(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.get_resource_explorer_setup_input.GetResourceExplorerSetupInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.get_resource_explorer_setup_output.GetResourceExplorerSetupOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.get_resource_explorer_setup.get_resource_explorer_setup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_get_resource_explorer_setup(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_resource_explorer_2.types.region_status.RegionStatus]":
        _token = next_token
        while True:
            _response = self.get_resource_explorer_setup(
                task_id,
    ...
    def get_service_index(
        ...
        def _handler(
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.get_service_index.get_service_index(
                    req.options
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_service_view(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.get_service_view_input.GetServiceViewInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.get_service_view_output.GetServiceViewOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.get_service_view.get_service_view(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_indexes_for_members(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.list_indexes_for_members_input.ListIndexesForMembersInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.list_indexes_for_members_output.ListIndexesForMembersOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.list_indexes_for_members.list_indexes_for_members(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_indexes_for_members(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_resource_explorer_2.types.member_index.MemberIndex]":
        _token = next_token
        while True:
            _response = self.list_indexes_for_members(
                account_id_list,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def list_managed_views(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.list_managed_views_input.ListManagedViewsInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.list_managed_views_output.ListManagedViewsOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.list_managed_views.list_managed_views(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_managed_views(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = self.list_managed_views(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def list_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.list_resources_input.ListResourcesInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.list_resources_output.ListResourcesOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.list_resources.list_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_resources(
        ...
        *,
        ...
        view_arn: Optional[str] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_resource_explorer_2.types.resource.Resource]":
        _token = next_token
        while True:
    ...
    def list_service_indexes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.list_service_indexes_input.ListServiceIndexesInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.list_service_indexes_output.ListServiceIndexesOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.list_service_indexes.list_service_indexes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_service_indexes(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_resource_explorer_2.types.index.Index]":
        _token = next_token
        while True:
            _response = self.list_service_indexes(
                config_overrides=config_overrides,
                regions=regions,
                max_results=max_results,
                next_token=_token,
    ...
    def list_service_views(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.list_service_views_input.ListServiceViewsInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.list_service_views_output.ListServiceViewsOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.list_service_views.list_service_views(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_service_views(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = self.list_service_views(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    def list_streaming_access_for_services(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.list_streaming_access_for_services_input.ListStreamingAccessForServicesInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.list_streaming_access_for_services_output.ListStreamingAccessForServicesOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.list_streaming_access_for_services.list_streaming_access_for_services(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_streaming_access_for_services(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_resource_explorer_2.types.streaming_access_details.StreamingAccessDetails]":
        _token = next_token
        while True:
            _response = self.list_streaming_access_for_services(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    def list_supported_resource_types(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.list_supported_resource_types_input.ListSupportedResourceTypesInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.list_supported_resource_types_output.ListSupportedResourceTypesOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.list_supported_resource_types.list_supported_resource_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_supported_resource_types(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_resource_explorer_2.types.supported_resource_type.SupportedResourceType]":
        _token = next_token
        while True:
            _response = self.list_supported_resource_types(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def search(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.search_input.SearchInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.search_output.SearchOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.search.search(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_explorer_2.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "capo_resource_explorer_2.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_explorer_2._operations.resource_explorer.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
