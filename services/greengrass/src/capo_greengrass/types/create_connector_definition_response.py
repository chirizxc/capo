"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateConnectorDefinitionResponse``."""
...
class CreateConnectorDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateConnectorDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateConnectorDefinitionResponse:
    out: CreateConnectorDefinitionResponse = {}  # type: ignore[typeddict-item]
