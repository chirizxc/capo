"""Generated from Smithy shape ``com.amazonaws.greengrass#GetSubscriptionDefinitionVersionResponse``."""
...
class GetSubscriptionDefinitionVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetSubscriptionDefinitionVersionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
