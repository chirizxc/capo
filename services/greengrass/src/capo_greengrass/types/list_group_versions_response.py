"""Generated from Smithy shape ``com.amazonaws.greengrass#ListGroupVersionsResponse``."""
...
class ListGroupVersionsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListGroupVersionsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListGroupVersionsResponse:
    out: ListGroupVersionsResponse = {}  # type: ignore[typeddict-item]
