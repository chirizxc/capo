"""Generated from Smithy shape ``com.amazonaws.greengrass#GetConnectorDefinitionResponse``."""
...
class GetConnectorDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetConnectorDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetConnectorDefinitionResponse:
    out: GetConnectorDefinitionResponse = {}  # type: ignore[typeddict-item]
