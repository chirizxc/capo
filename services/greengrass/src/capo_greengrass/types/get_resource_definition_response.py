"""Generated from Smithy shape ``com.amazonaws.greengrass#GetResourceDefinitionResponse``."""
...
class GetResourceDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetResourceDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> GetResourceDefinitionResponse:
    out: GetResourceDefinitionResponse = {}  # type: ignore[typeddict-item]
