"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateResourceDefinitionResponse``."""
...
class CreateResourceDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateResourceDefinitionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateResourceDefinitionResponse:
    out: CreateResourceDefinitionResponse = {}  # type: ignore[typeddict-item]
