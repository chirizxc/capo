"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateSubscriptionDefinitionVersionResponse``."""
...
class CreateSubscriptionDefinitionVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateSubscriptionDefinitionVersionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateSubscriptionDefinitionVersionResponse:
    out: CreateSubscriptionDefinitionVersionResponse = {}  # type: ignore[typeddict-item]
