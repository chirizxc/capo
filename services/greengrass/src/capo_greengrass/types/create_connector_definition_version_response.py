"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateConnectorDefinitionVersionResponse``."""
...
class CreateConnectorDefinitionVersionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateConnectorDefinitionVersionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> CreateConnectorDefinitionVersionResponse:
    out: CreateConnectorDefinitionVersionResponse = {}  # type: ignore[typeddict-item]
