"""Generated from Smithy shape ``com.amazonaws.greengrass#ResetDeployments``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.reset_deployments_response.ResetDeploymentsResponse = (
        capo_greengrass.types.reset_deployments_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/greengrass/groups/{GroupId}/deployments/$reset"
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.reset_deployments_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_reset_deployments(
