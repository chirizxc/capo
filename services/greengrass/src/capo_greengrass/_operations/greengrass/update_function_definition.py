"""Generated from Smithy shape ``com.amazonaws.greengrass#UpdateFunctionDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.update_function_definition_response.UpdateFunctionDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_function_definition_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_function_definition(
