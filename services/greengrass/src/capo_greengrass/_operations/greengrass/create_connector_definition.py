...
def handle_response(
    ...
    out: capo_greengrass.types.create_connector_definition_response.CreateConnectorDefinitionResponse = capo_greengrass.types.create_connector_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_connector_definition_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
