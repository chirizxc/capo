...
def handle_response(
    ...
    out: capo_greengrass.types.disassociate_service_role_from_account_response.DisassociateServiceRoleFromAccountResponse = capo_greengrass.types.disassociate_service_role_from_account_response.deserialize_json(
