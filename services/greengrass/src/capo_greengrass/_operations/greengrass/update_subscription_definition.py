...
def handle_response(
    ...
    out: capo_greengrass.types.update_subscription_definition_response.UpdateSubscriptionDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_subscription_definition_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
