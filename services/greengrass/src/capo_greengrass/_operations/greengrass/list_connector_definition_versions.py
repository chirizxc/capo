...
def handle_response(
    ...
    out: capo_greengrass.types.list_connector_definition_versions_response.ListConnectorDefinitionVersionsResponse = capo_greengrass.types.list_connector_definition_versions_response.deserialize_json(
