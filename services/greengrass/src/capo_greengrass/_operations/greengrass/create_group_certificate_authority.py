"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateGroupCertificateAuthority``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_group_certificate_authority_response.CreateGroupCertificateAuthorityResponse = capo_greengrass.types.create_group_certificate_authority_response.deserialize_json(
...
async def async_create_group_certificate_authority(
