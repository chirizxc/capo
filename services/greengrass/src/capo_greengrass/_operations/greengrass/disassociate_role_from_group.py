"""Generated from Smithy shape ``com.amazonaws.greengrass#DisassociateRoleFromGroup``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.disassociate_role_from_group_response.DisassociateRoleFromGroupResponse = capo_greengrass.types.disassociate_role_from_group_response.deserialize_json(
...
async def async_disassociate_role_from_group(
