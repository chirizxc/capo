"""Generated from Smithy shape ``com.amazonaws.greengrass#ListConnectorDefinitions``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_connector_definitions_response.ListConnectorDefinitionsResponse = capo_greengrass.types.list_connector_definitions_response.deserialize_json(
...
async def async_list_connector_definitions(
