"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateCoreDefinitionVersion``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_core_definition_version_response.CreateCoreDefinitionVersionResponse = capo_greengrass.types.create_core_definition_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{CoreDefinitionId}", quote(input_["core_definition_id"], safe="")
    )
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_core_definition_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_core_definition_version(
