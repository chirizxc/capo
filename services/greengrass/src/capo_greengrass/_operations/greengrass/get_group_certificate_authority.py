"""Generated from Smithy shape ``com.amazonaws.greengrass#GetGroupCertificateAuthority``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_group_certificate_authority_response.GetGroupCertificateAuthorityResponse = capo_greengrass.types.get_group_certificate_authority_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{CertificateAuthorityId}", quote(input_["certificate_authority_id"], safe="")
    )
...
async def async_get_group_certificate_authority(
