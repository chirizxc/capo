...
def handle_response(
    ...
    out: capo_greengrass.types.create_subscription_definition_version_response.CreateSubscriptionDefinitionVersionResponse = capo_greengrass.types.create_subscription_definition_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_subscription_definition_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
