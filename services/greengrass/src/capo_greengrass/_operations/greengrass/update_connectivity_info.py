...
def handle_response(
    ...
    out: capo_greengrass.types.update_connectivity_info_response.UpdateConnectivityInfoResponse = capo_greengrass.types.update_connectivity_info_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_connectivity_info_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
