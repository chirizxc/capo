...
def handle_response(
    ...
    out: capo_greengrass.types.get_service_role_for_account_response.GetServiceRoleForAccountResponse = capo_greengrass.types.get_service_role_for_account_response.deserialize_json(
