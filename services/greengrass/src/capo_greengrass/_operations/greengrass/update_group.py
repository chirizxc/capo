...
def handle_response(
    ...
    out: capo_greengrass.types.update_group_response.UpdateGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_group(
    ...
    capo_greengrass.types.update_group_response.UpdateGroupResponse, zapros.Response
]:
