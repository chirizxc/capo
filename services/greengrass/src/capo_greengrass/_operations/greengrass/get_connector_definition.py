"""Generated from Smithy shape ``com.amazonaws.greengrass#GetConnectorDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_connector_definition_response.GetConnectorDefinitionResponse = capo_greengrass.types.get_connector_definition_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ConnectorDefinitionId}", quote(input_["connector_definition_id"], safe="")
    )
...
async def async_get_connector_definition(
