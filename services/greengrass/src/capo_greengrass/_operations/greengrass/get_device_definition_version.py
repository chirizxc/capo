...
def handle_response(
    ...
    out: capo_greengrass.types.get_device_definition_version_response.GetDeviceDefinitionVersionResponse = capo_greengrass.types.get_device_definition_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["device_definition_version_id"], safe=""),
    )
