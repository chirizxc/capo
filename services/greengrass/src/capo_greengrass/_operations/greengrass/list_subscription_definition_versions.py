"""Generated from Smithy shape ``com.amazonaws.greengrass#ListSubscriptionDefinitionVersions``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_subscription_definition_versions_response.ListSubscriptionDefinitionVersionsResponse = capo_greengrass.types.list_subscription_definition_versions_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["subscription_definition_id"], safe=""),
    )
...
async def async_list_subscription_definition_versions(
