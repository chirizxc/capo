"""Generated from Smithy shape ``com.amazonaws.greengrass#ListDeviceDefinitions``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_device_definitions_response.ListDeviceDefinitionsResponse = capo_greengrass.types.list_device_definitions_response.deserialize_json(
...
async def async_list_device_definitions(
