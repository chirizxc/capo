...
def handle_response(
    ...
    out: capo_greengrass.types.get_connector_definition_version_response.GetConnectorDefinitionVersionResponse = capo_greengrass.types.get_connector_definition_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["connector_definition_version_id"], safe=""),
    )
