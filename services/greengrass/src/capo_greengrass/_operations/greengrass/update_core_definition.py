...
def handle_response(
    ...
    out: capo_greengrass.types.update_core_definition_response.UpdateCoreDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_core_definition_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
