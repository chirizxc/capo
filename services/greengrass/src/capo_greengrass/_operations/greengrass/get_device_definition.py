"""Generated from Smithy shape ``com.amazonaws.greengrass#GetDeviceDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_device_definition_response.GetDeviceDefinitionResponse = capo_greengrass.types.get_device_definition_response.deserialize_json(
...
async def async_get_device_definition(
