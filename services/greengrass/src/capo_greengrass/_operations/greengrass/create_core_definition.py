"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateCoreDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_core_definition_response.CreateCoreDefinitionResponse = capo_greengrass.types.create_core_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_core_definition_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_core_definition(
