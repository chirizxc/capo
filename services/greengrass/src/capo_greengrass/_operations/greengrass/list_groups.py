...
def handle_response(
    ...
    out: capo_greengrass.types.list_groups_response.ListGroupsResponse = (
        capo_greengrass.types.list_groups_response.deserialize_json(
...
def list_groups(
    ...
    capo_greengrass.types.list_groups_response.ListGroupsResponse, zapros.Response
]:
