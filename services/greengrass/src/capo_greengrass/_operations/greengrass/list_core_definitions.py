...
def handle_response(
    ...
    out: capo_greengrass.types.list_core_definitions_response.ListCoreDefinitionsResponse = capo_greengrass.types.list_core_definitions_response.deserialize_json(
