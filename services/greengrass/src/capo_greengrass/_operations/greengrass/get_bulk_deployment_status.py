"""Generated from Smithy shape ``com.amazonaws.greengrass#GetBulkDeploymentStatus``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_bulk_deployment_status_response.GetBulkDeploymentStatusResponse = capo_greengrass.types.get_bulk_deployment_status_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{BulkDeploymentId}", quote(input_["bulk_deployment_id"], safe="")
    )
...
async def async_get_bulk_deployment_status(
