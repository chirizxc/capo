...
def handle_response(
    ...
    out: capo_greengrass.types.associate_role_to_group_response.AssociateRoleToGroupResponse = capo_greengrass.types.associate_role_to_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.associate_role_to_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
