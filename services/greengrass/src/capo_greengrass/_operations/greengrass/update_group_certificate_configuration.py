...
def handle_response(
    ...
    out: capo_greengrass.types.update_group_certificate_configuration_response.UpdateGroupCertificateConfigurationResponse = capo_greengrass.types.update_group_certificate_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.update_group_certificate_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
