...
def handle_response(
    ...
    out: capo_greengrass.types.get_group_version_response.GetGroupVersionResponse = (
        capo_greengrass.types.get_group_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{GroupVersionId}", quote(input_["group_version_id"], safe=""))
