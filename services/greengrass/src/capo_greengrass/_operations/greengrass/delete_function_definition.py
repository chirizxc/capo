"""Generated from Smithy shape ``com.amazonaws.greengrass#DeleteFunctionDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.delete_function_definition_response.DeleteFunctionDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_function_definition(
