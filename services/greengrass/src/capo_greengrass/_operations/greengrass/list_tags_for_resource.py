"""Generated from Smithy shape ``com.amazonaws.greengrass#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_greengrass.types.list_tags_for_resource_response.deserialize_json(
