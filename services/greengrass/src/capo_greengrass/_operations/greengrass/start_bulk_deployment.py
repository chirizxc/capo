"""Generated from Smithy shape ``com.amazonaws.greengrass#StartBulkDeployment``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.start_bulk_deployment_response.StartBulkDeploymentResponse = capo_greengrass.types.start_bulk_deployment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.start_bulk_deployment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_bulk_deployment(
