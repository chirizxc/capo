"""Generated from Smithy shape ``com.amazonaws.greengrass#GetGroupCertificateConfiguration``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_group_certificate_configuration_response.GetGroupCertificateConfigurationResponse = capo_greengrass.types.get_group_certificate_configuration_response.deserialize_json(
...
async def async_get_group_certificate_configuration(
