"""Generated from Smithy shape ``com.amazonaws.greengrass#ListResourceDefinitionVersions``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.list_resource_definition_versions_response.ListResourceDefinitionVersionsResponse = capo_greengrass.types.list_resource_definition_versions_response.deserialize_json(
...
async def async_list_resource_definition_versions(
