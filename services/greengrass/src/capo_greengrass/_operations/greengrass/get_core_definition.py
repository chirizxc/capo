"""Generated from Smithy shape ``com.amazonaws.greengrass#GetCoreDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_core_definition_response.GetCoreDefinitionResponse = capo_greengrass.types.get_core_definition_response.deserialize_json(
...
async def async_get_core_definition(
