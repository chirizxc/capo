"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateSubscriptionDefinition``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_subscription_definition_response.CreateSubscriptionDefinitionResponse = capo_greengrass.types.create_subscription_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_subscription_definition_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_subscription_definition(
