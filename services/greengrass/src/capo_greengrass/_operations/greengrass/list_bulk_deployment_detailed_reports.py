...
def handle_response(
    ...
    out: capo_greengrass.types.list_bulk_deployment_detailed_reports_response.ListBulkDeploymentDetailedReportsResponse = capo_greengrass.types.list_bulk_deployment_detailed_reports_response.deserialize_json(
