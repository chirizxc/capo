"""Generated from Smithy shape ``com.amazonaws.greengrass#GetConnectivityInfo``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.get_connectivity_info_response.GetConnectivityInfoResponse = capo_greengrass.types.get_connectivity_info_response.deserialize_json(
