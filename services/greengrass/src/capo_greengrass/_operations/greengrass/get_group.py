...
def handle_response(
    ...
    out: capo_greengrass.types.get_group_response.GetGroupResponse = (
        capo_greengrass.types.get_group_response.deserialize_json(
...
def get_group(
    ...
    input_: capo_greengrass.types.get_group_request.GetGroupRequest,
) -> tuple[capo_greengrass.types.get_group_response.GetGroupResponse, zapros.Response]:
