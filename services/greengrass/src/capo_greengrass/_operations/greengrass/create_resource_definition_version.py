"""Generated from Smithy shape ``com.amazonaws.greengrass#CreateResourceDefinitionVersion``."""
...
def handle_response(
    ...
    out: capo_greengrass.types.create_resource_definition_version_response.CreateResourceDefinitionVersionResponse = capo_greengrass.types.create_resource_definition_version_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ResourceDefinitionId}", quote(input_["resource_definition_id"], safe="")
    )
    ...
    body: bytes | None = json.dumps(
        capo_greengrass.types.create_resource_definition_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_resource_definition_version(
