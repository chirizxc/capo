...
def handle_response(
    ...
    out: capo_auto_scaling.types.describe_lifecycle_hooks_answer.DescribeLifecycleHooksAnswer = capo_auto_scaling.types.describe_lifecycle_hooks_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.describe_lifecycle_hooks_type.serialize_query(
        input_, pairs, ""
    )
