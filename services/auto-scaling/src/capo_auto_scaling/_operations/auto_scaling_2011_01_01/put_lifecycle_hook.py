...
def handle_response(
    ...
    out: capo_auto_scaling.types.put_lifecycle_hook_answer.PutLifecycleHookAnswer = (
        capo_auto_scaling.types.put_lifecycle_hook_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.put_lifecycle_hook_type.serialize_query(input_, pairs, "")
