"""Generated from Smithy shape ``com.amazonaws.autoscaling#AttachLoadBalancerTargetGroups``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("AttachLoadBalancerTargetGroupsResult")
    out: capo_auto_scaling.types.attach_load_balancer_target_groups_result_type.AttachLoadBalancerTargetGroupsResultType = capo_auto_scaling.types.attach_load_balancer_target_groups_result_type.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "AttachLoadBalancerTargetGroups"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.attach_load_balancer_target_groups_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_attach_load_balancer_target_groups(
