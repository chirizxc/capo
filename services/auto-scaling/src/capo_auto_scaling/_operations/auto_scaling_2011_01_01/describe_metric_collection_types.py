...
def handle_response(
    ...
    out: capo_auto_scaling.types.describe_metric_collection_types_answer.DescribeMetricCollectionTypesAnswer = capo_auto_scaling.types.describe_metric_collection_types_answer.deserialize_query(
