...
def handle_response(
    ...
    out: capo_auto_scaling.types.attach_load_balancers_result_type.AttachLoadBalancersResultType = capo_auto_scaling.types.attach_load_balancers_result_type.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.attach_load_balancers_type.serialize_query(
        input_, pairs, ""
    )
