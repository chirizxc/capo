"""Generated from Smithy shape ``com.amazonaws.autoscaling#RecordLifecycleActionHeartbeat``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("RecordLifecycleActionHeartbeatResult")
    out: capo_auto_scaling.types.record_lifecycle_action_heartbeat_answer.RecordLifecycleActionHeartbeatAnswer = capo_auto_scaling.types.record_lifecycle_action_heartbeat_answer.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "RecordLifecycleActionHeartbeat"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.record_lifecycle_action_heartbeat_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_record_lifecycle_action_heartbeat(
