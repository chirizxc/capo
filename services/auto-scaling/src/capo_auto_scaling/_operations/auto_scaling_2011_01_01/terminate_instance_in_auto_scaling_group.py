...
def handle_response(
    ...
    out: capo_auto_scaling.types.activity_type.ActivityType = (
        capo_auto_scaling.types.activity_type.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.terminate_instance_in_auto_scaling_group_type.serialize_query(
        input_, pairs, ""
    )
...
def terminate_instance_in_auto_scaling_group(
    ...
    input_: capo_auto_scaling.types.terminate_instance_in_auto_scaling_group_type.TerminateInstanceInAutoScalingGroupType,
) -> tuple[capo_auto_scaling.types.activity_type.ActivityType, zapros.Response]:
