...
def handle_response(
    ...
    out: capo_auto_scaling.types.batch_put_scheduled_update_group_action_answer.BatchPutScheduledUpdateGroupActionAnswer = capo_auto_scaling.types.batch_put_scheduled_update_group_action_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.batch_put_scheduled_update_group_action_type.serialize_query(
        input_, pairs, ""
    )
