"""Generated from Smithy shape ``com.amazonaws.autoscaling#DeleteWarmPool``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteWarmPoolResult")
    out: capo_auto_scaling.types.delete_warm_pool_answer.DeleteWarmPoolAnswer = (
        capo_auto_scaling.types.delete_warm_pool_answer.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteWarmPool"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.delete_warm_pool_type.serialize_query(input_, pairs, "")
...
async def async_delete_warm_pool(
