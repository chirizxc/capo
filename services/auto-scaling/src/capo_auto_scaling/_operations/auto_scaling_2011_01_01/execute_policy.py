"""Generated from Smithy shape ``com.amazonaws.autoscaling#ExecutePolicy``."""
...
def build_request(
    ...
    pairs.append(("Action", "ExecutePolicy"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.execute_policy_type.serialize_query(input_, pairs, "")
