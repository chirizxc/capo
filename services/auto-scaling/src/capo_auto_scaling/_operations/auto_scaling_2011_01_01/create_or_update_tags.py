"""Generated from Smithy shape ``com.amazonaws.autoscaling#CreateOrUpdateTags``."""
...
def build_request(
    ...
    pairs.append(("Action", "CreateOrUpdateTags"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.create_or_update_tags_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_create_or_update_tags(
