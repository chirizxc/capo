...
def handle_response(
    ...
    out: capo_auto_scaling.types.describe_load_balancer_target_groups_response.DescribeLoadBalancerTargetGroupsResponse = capo_auto_scaling.types.describe_load_balancer_target_groups_response.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.describe_load_balancer_target_groups_request.serialize_query(
        input_, pairs, ""
    )
