"""Generated from Smithy shape ``com.amazonaws.autoscaling#DeleteNotificationConfiguration``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteNotificationConfiguration"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.delete_notification_configuration_type.serialize_query(
        input_, pairs, ""
    )
