"""Generated from Smithy shape ``com.amazonaws.autoscaling#DeleteAutoScalingGroup``."""
...
def build_request(
    ...
    pairs.append(("Action", "DeleteAutoScalingGroup"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.delete_auto_scaling_group_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_delete_auto_scaling_group(
