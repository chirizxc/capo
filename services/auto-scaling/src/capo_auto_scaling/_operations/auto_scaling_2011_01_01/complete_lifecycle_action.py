"""Generated from Smithy shape ``com.amazonaws.autoscaling#CompleteLifecycleAction``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CompleteLifecycleActionResult")
    out: capo_auto_scaling.types.complete_lifecycle_action_answer.CompleteLifecycleActionAnswer = capo_auto_scaling.types.complete_lifecycle_action_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.complete_lifecycle_action_type.serialize_query(
        input_, pairs, ""
    )
...
async def async_complete_lifecycle_action(
