...
def handle_response(
    ...
    out: capo_auto_scaling.types.scheduled_actions_type.ScheduledActionsType = (
        capo_auto_scaling.types.scheduled_actions_type.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.describe_scheduled_actions_type.serialize_query(
        input_, pairs, ""
    )
...
def describe_scheduled_actions(
    ...
    capo_auto_scaling.types.scheduled_actions_type.ScheduledActionsType, zapros.Response
]:
