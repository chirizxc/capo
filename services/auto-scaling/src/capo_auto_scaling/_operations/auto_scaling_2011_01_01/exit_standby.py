"""Generated from Smithy shape ``com.amazonaws.autoscaling#ExitStandby``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ExitStandbyResult")
    out: capo_auto_scaling.types.exit_standby_answer.ExitStandbyAnswer = (
        capo_auto_scaling.types.exit_standby_answer.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ExitStandby"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.exit_standby_query.serialize_query(input_, pairs, "")
...
def exit_standby(
    ...
    capo_auto_scaling.types.exit_standby_answer.ExitStandbyAnswer, zapros.Response
]:
