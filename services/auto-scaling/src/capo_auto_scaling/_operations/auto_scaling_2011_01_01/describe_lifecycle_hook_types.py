...
def handle_response(
    ...
    out: capo_auto_scaling.types.describe_lifecycle_hook_types_answer.DescribeLifecycleHookTypesAnswer = capo_auto_scaling.types.describe_lifecycle_hook_types_answer.deserialize_query(
