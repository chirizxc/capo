"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeLaunchConfigurations``."""
...
def handle_response(
    ...
    out: capo_auto_scaling.types.launch_configurations_type.LaunchConfigurationsType = (
        capo_auto_scaling.types.launch_configurations_type.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeLaunchConfigurations"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.launch_configuration_names_type.serialize_query(
        input_, pairs, ""
    )
