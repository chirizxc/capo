...
def handle_response(
    ...
    out: capo_auto_scaling.types.detach_traffic_sources_result_type.DetachTrafficSourcesResultType = capo_auto_scaling.types.detach_traffic_sources_result_type.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.detach_traffic_sources_type.serialize_query(
        input_, pairs, ""
    )
