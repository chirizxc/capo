"""Generated from Smithy shape ``com.amazonaws.autoscaling#DetachInstances``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DetachInstancesResult")
    out: capo_auto_scaling.types.detach_instances_answer.DetachInstancesAnswer = (
        capo_auto_scaling.types.detach_instances_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.detach_instances_query.serialize_query(input_, pairs, "")
...
async def async_detach_instances(
