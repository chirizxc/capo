...
def handle_response(
    ...
    out: capo_auto_scaling.types.describe_termination_policy_types_answer.DescribeTerminationPolicyTypesAnswer = capo_auto_scaling.types.describe_termination_policy_types_answer.deserialize_query(
