...
def handle_response(
    ...
    out: capo_auto_scaling.types.describe_notification_configurations_answer.DescribeNotificationConfigurationsAnswer = capo_auto_scaling.types.describe_notification_configurations_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.describe_notification_configurations_type.serialize_query(
        input_, pairs, ""
    )
