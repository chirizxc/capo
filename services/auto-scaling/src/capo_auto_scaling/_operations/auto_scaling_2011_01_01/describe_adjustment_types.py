"""Generated from Smithy shape ``com.amazonaws.autoscaling#DescribeAdjustmentTypes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeAdjustmentTypesResult")
    out: capo_auto_scaling.types.describe_adjustment_types_answer.DescribeAdjustmentTypesAnswer = capo_auto_scaling.types.describe_adjustment_types_answer.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "DescribeAdjustmentTypes"))
...
async def async_describe_adjustment_types(
