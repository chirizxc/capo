"""Generated from Smithy shape ``com.amazonaws.autoscaling#EnableMetricsCollection``."""
...
def build_request(
    ...
    pairs.append(("Action", "EnableMetricsCollection"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.enable_metrics_collection_query.serialize_query(
        input_, pairs, ""
    )
...
async def async_enable_metrics_collection(
