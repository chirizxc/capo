"""Generated from Smithy shape ``com.amazonaws.autoscaling#ResumeProcesses``."""
...
def build_request(
    ...
    pairs.append(("Action", "ResumeProcesses"))
    pairs.append(("Version", "2011-01-01"))
    capo_auto_scaling.types.scaling_process_query.serialize_query(input_, pairs, "")
...
async def async_resume_processes(
