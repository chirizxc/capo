...
def handle_response(
    ...
    out: capo_auto_scaling.types.batch_delete_scheduled_action_answer.BatchDeleteScheduledActionAnswer = capo_auto_scaling.types.batch_delete_scheduled_action_answer.deserialize_query(
...
def build_request(
    ...
    capo_auto_scaling.types.batch_delete_scheduled_action_type.serialize_query(
        input_, pairs, ""
    )
