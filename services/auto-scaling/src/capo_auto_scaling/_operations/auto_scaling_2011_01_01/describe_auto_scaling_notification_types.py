...
def handle_response(
    ...
    out: capo_auto_scaling.types.describe_auto_scaling_notification_types_answer.DescribeAutoScalingNotificationTypesAnswer = capo_auto_scaling.types.describe_auto_scaling_notification_types_answer.deserialize_query(
