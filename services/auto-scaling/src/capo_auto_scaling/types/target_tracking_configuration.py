...
if TYPE_CHECKING:
    ...
    import capo_auto_scaling.types.disable_scale_in
...
class TargetTrackingConfiguration(TypedDict, closed=True):
    predefined_metric_specification: NotRequired[
        "capo_auto_scaling.types.predefined_metric_specification.PredefinedMetricSpecification"
    ]
    ...
    customized_metric_specification: NotRequired[
        "capo_auto_scaling.types.customized_metric_specification.CustomizedMetricSpecification"
    ]
    ...
    disable_scale_in: NotRequired[
        "capo_auto_scaling.types.disable_scale_in.DisableScaleIn"
    ]
...
def deserialize_query(el: Element) -> TargetTrackingConfiguration:
    ...
    if child_predefined_metric_specification is not None:
        ...
        out["predefined_metric_specification"] = (
            capo_auto_scaling.types.predefined_metric_specification.deserialize_query(
    ...
    if child_customized_metric_specification is not None:
        ...
        out["customized_metric_specification"] = (
            capo_auto_scaling.types.customized_metric_specification.deserialize_query(
