...
from capo_trustedadvisor._services._aws_config import aws_config
...
class TrustedAdvisorClient:
    ...
    def batch_update_recommendation_resource_exclusion(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.batch_update_recommendation_resource_exclusion_request.BatchUpdateRecommendationResourceExclusionRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.batch_update_recommendation_resource_exclusion_response.BatchUpdateRecommendationResourceExclusionResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.batch_update_recommendation_resource_exclusion.batch_update_recommendation_resource_exclusion(
    ...
    def get_organization_recommendation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.get_organization_recommendation_request.GetOrganizationRecommendationRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.get_organization_recommendation_response.GetOrganizationRecommendationResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.get_organization_recommendation.get_organization_recommendation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_recommendation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.get_recommendation_request.GetRecommendationRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.get_recommendation_response.GetRecommendationResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.get_recommendation.get_recommendation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_checks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.list_checks_request.ListChecksRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.list_checks_response.ListChecksResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.list_checks.list_checks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_trustedadvisor.types.check_summary.CheckSummary]":
        _token = next_token
        while True:
    ...
    def list_organization_recommendation_accounts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.list_organization_recommendation_accounts_request.ListOrganizationRecommendationAccountsRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.list_organization_recommendation_accounts_response.ListOrganizationRecommendationAccountsResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.list_organization_recommendation_accounts.list_organization_recommendation_accounts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_trustedadvisor.types.account_recommendation_lifecycle_summary.AccountRecommendationLifecycleSummary]":
        _token = next_token
        while True:
    ...
    def list_organization_recommendation_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.list_organization_recommendation_resources_request.ListOrganizationRecommendationResourcesRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.list_organization_recommendation_resources_response.ListOrganizationRecommendationResourcesResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.list_organization_recommendation_resources.list_organization_recommendation_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_trustedadvisor.types.organization_recommendation_resource_summary.OrganizationRecommendationResourceSummary]":
        _token = next_token
        while True:
    ...
    def list_organization_recommendations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.list_organization_recommendations_request.ListOrganizationRecommendationsRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.list_organization_recommendations_response.ListOrganizationRecommendationsResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.list_organization_recommendations.list_organization_recommendations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_organization_recommendations(
        ...
        *,
        ...
        after_last_updated_at: Optional[datetime.datetime] = None,
        before_last_updated_at: Optional[datetime.datetime] = None,
    ) -> "Iterator[capo_trustedadvisor.types.organization_recommendation_summary.OrganizationRecommendationSummary]":
        _token = next_token
        while True:
    ...
    def list_recommendation_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.list_recommendation_resources_request.ListRecommendationResourcesRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.list_recommendation_resources_response.ListRecommendationResourcesResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.list_recommendation_resources.list_recommendation_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_trustedadvisor.types.recommendation_resource_summary.RecommendationResourceSummary]":
        _token = next_token
        while True:
    ...
    def list_recommendations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.list_recommendations_request.ListRecommendationsRequest]",
        ) -> OperationResponse[
            "capo_trustedadvisor.types.list_recommendations_response.ListRecommendationsResponse"
        ]:
            ...
            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.list_recommendations.list_recommendations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_trustedadvisor.types.recommendation_summary.RecommendationSummary]":
        _token = next_token
        while True:
    ...
    def update_organization_recommendation_lifecycle(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.update_organization_recommendation_lifecycle_request.UpdateOrganizationRecommendationLifecycleRequest]",
        ) -> OperationResponse[None]:
            import capo_trustedadvisor._operations.trusted_advisor.update_organization_recommendation_lifecycle

            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.update_organization_recommendation_lifecycle.update_organization_recommendation_lifecycle(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_recommendation_lifecycle(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_trustedadvisor.types.update_recommendation_lifecycle_request.UpdateRecommendationLifecycleRequest]",
        ) -> OperationResponse[None]:
            import capo_trustedadvisor._operations.trusted_advisor.update_recommendation_lifecycle

            output, http_response = (
                capo_trustedadvisor._operations.trusted_advisor.update_recommendation_lifecycle.update_recommendation_lifecycle(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
