"""Generated from Smithy shape ``com.amazonaws.trustedadvisor#ListOrganizationRecommendationResources``."""
...
def handle_response(
    ...
    out: capo_trustedadvisor.types.list_organization_recommendation_resources_response.ListOrganizationRecommendationResourcesResponse = capo_trustedadvisor.types.list_organization_recommendation_resources_response.deserialize_json(
...
def build_request(
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_trustedadvisor.types.resource_status.serialize_json(
                    input_["status"]
                ),
            )
        )
    if "exclusion_status" in input_:
        params.append(
            (
                "exclusionStatus",
                capo_trustedadvisor.types.exclusion_status.serialize_json(
                    input_["exclusion_status"]
                ),
            )
        )
    if "region_code" in input_:
        params.append(("regionCode", input_["region_code"]))
    if "affected_account_id" in input_:
        params.append(("affectedAccountId", input_["affected_account_id"]))
...
async def async_list_organization_recommendation_resources(
