"""Generated from Smithy shape ``com.amazonaws.trustedadvisor#ListOrganizationRecommendationAccounts``."""
...
def handle_response(
    ...
    out: capo_trustedadvisor.types.list_organization_recommendation_accounts_response.ListOrganizationRecommendationAccountsResponse = capo_trustedadvisor.types.list_organization_recommendation_accounts_response.deserialize_json(
...
async def async_list_organization_recommendation_accounts(
