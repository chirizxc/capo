"""Generated from Smithy shape ``com.amazonaws.trustedadvisor#GetRecommendation``."""
...
def handle_response(
    ...
    out: capo_trustedadvisor.types.get_recommendation_response.GetRecommendationResponse = capo_trustedadvisor.types.get_recommendation_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/recommendations/{recommendationIdentifier}"
    url = url.replace(
        "{recommendationIdentifier}",
        quote(input_["recommendation_identifier"], safe=""),
    )
