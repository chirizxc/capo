...
import capo_signer.errors.throttling_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ThrottlingException":
            raise capo_signer.errors.throttling_exception.ThrottlingException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_signer.types.start_signing_job_response.StartSigningJobResponse = (
        capo_signer.types.start_signing_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_signer.types.start_signing_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
