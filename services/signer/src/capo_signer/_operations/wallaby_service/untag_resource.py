"""Generated from Smithy shape ``com.amazonaws.signer#UntagResource``."""
...
def handle_response(
    ...
    out: capo_signer.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_signer.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
