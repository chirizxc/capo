"""Generated from Smithy shape ``com.amazonaws.signer#GetSigningPlatform``."""
...
def handle_response(
    ...
    out: capo_signer.types.get_signing_platform_response.GetSigningPlatformResponse = (
        capo_signer.types.get_signing_platform_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/signing-platforms/{platformId}"
    url = url.replace("{platformId}", quote(input_["platform_id"], safe=""))
...
async def async_get_signing_platform(
