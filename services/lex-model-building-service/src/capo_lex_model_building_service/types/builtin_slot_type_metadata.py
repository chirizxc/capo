...
if TYPE_CHECKING:
    import capo_lex_model_building_service.types.builtin_slot_type_signature
...
class BuiltinSlotTypeMetadata(TypedDict, closed=True):
    signature: NotRequired[
        "capo_lex_model_building_service.types.builtin_slot_type_signature.BuiltinSlotTypeSignature"
    ]
