...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.put_slot_type_response.PutSlotTypeResponse = capo_lex_model_building_service.types.put_slot_type_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_model_building_service.types.put_slot_type_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
