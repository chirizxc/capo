"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetBuiltinSlotTypes``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_builtin_slot_types_response.GetBuiltinSlotTypesResponse = capo_lex_model_building_service.types.get_builtin_slot_types_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/builtins/slottypes"
    ...
    if "signature_contains" in input_:
        params.append(("signatureContains", input_["signature_contains"]))
...
async def async_get_builtin_slot_types(
