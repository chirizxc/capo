"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetImport``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_import_response.GetImportResponse = (
        capo_lex_model_building_service.types.get_import_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{importId}", quote(input_["import_id"], safe=""))
