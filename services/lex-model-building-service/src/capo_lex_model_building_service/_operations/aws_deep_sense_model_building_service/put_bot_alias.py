"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#PutBotAlias``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.put_bot_alias_response.PutBotAliasResponse = capo_lex_model_building_service.types.put_bot_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_model_building_service.types.put_bot_alias_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
