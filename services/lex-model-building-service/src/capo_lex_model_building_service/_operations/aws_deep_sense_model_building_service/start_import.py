...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.start_import_response.StartImportResponse = capo_lex_model_building_service.types.start_import_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_model_building_service.types.start_import_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
