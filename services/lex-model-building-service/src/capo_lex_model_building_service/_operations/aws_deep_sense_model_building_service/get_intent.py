"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetIntent``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_intent_response.GetIntentResponse = (
        capo_lex_model_building_service.types.get_intent_response.deserialize_json(
