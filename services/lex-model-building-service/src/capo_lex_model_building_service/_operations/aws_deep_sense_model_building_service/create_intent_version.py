...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.create_intent_version_response.CreateIntentVersionResponse = capo_lex_model_building_service.types.create_intent_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_model_building_service.types.create_intent_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
