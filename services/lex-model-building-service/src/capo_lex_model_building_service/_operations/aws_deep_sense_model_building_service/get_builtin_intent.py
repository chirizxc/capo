"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetBuiltinIntent``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_builtin_intent_response.GetBuiltinIntentResponse = capo_lex_model_building_service.types.get_builtin_intent_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/builtins/intents/{signature}"
    url = url.replace("{signature}", quote(input_["signature"], safe=""))
...
async def async_get_builtin_intent(
