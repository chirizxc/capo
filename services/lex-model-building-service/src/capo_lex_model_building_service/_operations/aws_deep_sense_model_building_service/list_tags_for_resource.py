...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_lex_model_building_service.types.list_tags_for_resource_response.deserialize_json(
