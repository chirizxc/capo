...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_builtin_intents_response.GetBuiltinIntentsResponse = capo_lex_model_building_service.types.get_builtin_intents_response.deserialize_json(
