"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetBotAlias``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_bot_alias_response.GetBotAliasResponse = capo_lex_model_building_service.types.get_bot_alias_response.deserialize_json(
