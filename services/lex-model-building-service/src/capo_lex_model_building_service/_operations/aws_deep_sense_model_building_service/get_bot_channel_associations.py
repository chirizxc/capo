"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetBotChannelAssociations``."""
...
import capo_lex_model_building_service.types.bot_channel_association_list
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_bot_channel_associations_response.GetBotChannelAssociationsResponse = capo_lex_model_building_service.types.get_bot_channel_associations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/bots/{botName}/aliases/{botAlias}/channels"
...
async def async_get_bot_channel_associations(
