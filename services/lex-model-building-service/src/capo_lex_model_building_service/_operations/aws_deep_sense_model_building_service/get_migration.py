"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetMigration``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_migration_response.GetMigrationResponse = capo_lex_model_building_service.types.get_migration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/migrations/{migrationId}"
    url = url.replace("{migrationId}", quote(input_["migration_id"], safe=""))
