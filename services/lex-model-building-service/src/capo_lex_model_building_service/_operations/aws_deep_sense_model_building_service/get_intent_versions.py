"""Generated from Smithy shape ``com.amazonaws.lexmodelbuildingservice#GetIntentVersions``."""
...
def handle_response(
    ...
    out: capo_lex_model_building_service.types.get_intent_versions_response.GetIntentVersionsResponse = capo_lex_model_building_service.types.get_intent_versions_response.deserialize_json(
...
async def async_get_intent_versions(
