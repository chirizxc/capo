...
class HealthLakeClientConfig(TypedDict, total=False, closed=True):
...
class HealthLakeClient:
    ...
    def __init__(
        ...
        self._config = HealthLakeClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[HealthLakeClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: HealthLakeClientConfig = config_overrides or {}
    ...
    def create_fhir_datastore(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.create_fhir_datastore_request.CreateFHIRDatastoreRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.create_fhir_datastore_response.CreateFHIRDatastoreResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.create_fhir_datastore.create_fhir_datastore(
    ...
    def delete_fhir_datastore(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.delete_fhir_datastore_request.DeleteFHIRDatastoreRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.delete_fhir_datastore_response.DeleteFHIRDatastoreResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.delete_fhir_datastore.delete_fhir_datastore(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fhir_datastore(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.describe_fhir_datastore_request.DescribeFHIRDatastoreRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.describe_fhir_datastore_response.DescribeFHIRDatastoreResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.describe_fhir_datastore.describe_fhir_datastore(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fhir_export_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.describe_fhir_export_job_request.DescribeFHIRExportJobRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.describe_fhir_export_job_response.DescribeFHIRExportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.describe_fhir_export_job.describe_fhir_export_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_fhir_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.describe_fhir_import_job_request.DescribeFHIRImportJobRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.describe_fhir_import_job_response.DescribeFHIRImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.describe_fhir_import_job.describe_fhir_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_fhir_datastores(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.list_fhir_datastores_request.ListFHIRDatastoresRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.list_fhir_datastores_response.ListFHIRDatastoresResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.list_fhir_datastores.list_fhir_datastores(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_fhir_export_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.list_fhir_export_jobs_request.ListFHIRExportJobsRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.list_fhir_export_jobs_response.ListFHIRExportJobsResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.list_fhir_export_jobs.list_fhir_export_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_fhir_import_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.list_fhir_import_jobs_request.ListFHIRImportJobsRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.list_fhir_import_jobs_response.ListFHIRImportJobsResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.list_fhir_import_jobs.list_fhir_import_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_fhir_export_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.start_fhir_export_job_request.StartFHIRExportJobRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.start_fhir_export_job_response.StartFHIRExportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.start_fhir_export_job.start_fhir_export_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_fhir_import_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.start_fhir_import_job_request.StartFHIRImportJobRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.start_fhir_import_job_response.StartFHIRImportJobResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.start_fhir_import_job.start_fhir_import_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_fhir_datastore(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_healthlake.types.update_fhir_datastore_request.UpdateFHIRDatastoreRequest]",
        ) -> OperationResponse[
            "capo_healthlake.types.update_fhir_datastore_response.UpdateFHIRDatastoreResponse"
        ]:
            ...
            output, http_response = (
                capo_healthlake._operations.health_lake.update_fhir_datastore.update_fhir_datastore(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
