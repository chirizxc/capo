"""Generated from Smithy shape ``com.amazonaws.healthlake#ListFHIRImportJobs``."""
...
def handle_response(
    ...
    out: capo_healthlake.types.list_fhir_import_jobs_response.ListFHIRImportJobsResponse = capo_healthlake.types.list_fhir_import_jobs_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "HealthLake.ListFHIRImportJobs"
    body: bytes | None = json.dumps(
        capo_healthlake.types.list_fhir_import_jobs_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_fhir_import_jobs(
