"""Generated from Smithy shape ``com.amazonaws.healthlake#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_healthlake.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_healthlake.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "HealthLake.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_healthlake.types.list_tags_for_resource_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
