"""Generated from Smithy shape ``com.amazonaws.healthlake#ListFHIRDatastores``."""
...
def handle_response(
    ...
    out: capo_healthlake.types.list_fhir_datastores_response.ListFHIRDatastoresResponse = capo_healthlake.types.list_fhir_datastores_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_healthlake.types.list_fhir_datastores_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_fhir_datastores(
