...
def handle_response(
    ...
    out: capo_healthlake.types.update_fhir_datastore_response.UpdateFHIRDatastoreResponse = capo_healthlake.types.update_fhir_datastore_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_healthlake.types.update_fhir_datastore_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
