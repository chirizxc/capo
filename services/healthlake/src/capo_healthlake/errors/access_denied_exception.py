"""Generated from Smithy shape ``com.amazonaws.healthlake#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.healthlake#AccessDeniedException``."""
