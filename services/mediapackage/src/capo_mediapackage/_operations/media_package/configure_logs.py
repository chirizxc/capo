...
def handle_response(
    ...
    out: capo_mediapackage.types.configure_logs_response.ConfigureLogsResponse = (
        capo_mediapackage.types.configure_logs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackage.types.configure_logs_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
