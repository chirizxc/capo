...
def handle_response(
    ...
    out: capo_mediapackage.types.list_harvest_jobs_response.ListHarvestJobsResponse = (
        capo_mediapackage.types.list_harvest_jobs_response.deserialize_json(
...
def build_request(
    ...
    if "include_channel_id" in input_:
        params.append(("includeChannelId", input_["include_channel_id"]))
    if "include_status" in input_:
        params.append(("includeStatus", input_["include_status"]))
