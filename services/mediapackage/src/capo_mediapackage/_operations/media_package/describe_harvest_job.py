...
def handle_response(
    ...
    out: capo_mediapackage.types.describe_harvest_job_response.DescribeHarvestJobResponse = capo_mediapackage.types.describe_harvest_job_response.deserialize_json(
