"""Generated from Smithy shape ``com.amazonaws.mediapackage#DescribeOriginEndpoint``."""
...
def handle_response(
    ...
    out: capo_mediapackage.types.describe_origin_endpoint_response.DescribeOriginEndpointResponse = capo_mediapackage.types.describe_origin_endpoint_response.deserialize_json(
...
async def async_describe_origin_endpoint(
