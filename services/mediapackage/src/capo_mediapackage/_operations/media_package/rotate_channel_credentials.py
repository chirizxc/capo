...
def handle_response(
    ...
    out: capo_mediapackage.types.rotate_channel_credentials_response.RotateChannelCredentialsResponse = capo_mediapackage.types.rotate_channel_credentials_response.deserialize_json(
