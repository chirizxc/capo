"""Generated from Smithy shape ``com.amazonaws.mediapackage#RotateIngestEndpointCredentialsResponse``."""
...
class RotateIngestEndpointCredentialsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: RotateIngestEndpointCredentialsResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
