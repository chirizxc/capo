"""Generated from Smithy shape ``com.amazonaws.mediapackage#RotateChannelCredentialsResponse``."""
...
class RotateChannelCredentialsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: RotateChannelCredentialsResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["arn"] = value["arn"]
...
def deserialize_json(data: dict) -> RotateChannelCredentialsResponse:
    out: RotateChannelCredentialsResponse = {}  # type: ignore[typeddict-item]
