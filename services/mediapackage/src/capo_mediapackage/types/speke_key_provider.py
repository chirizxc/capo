...
if TYPE_CHECKING:
    ...
    import capo_mediapackage.types.encryption_contract_configuration


class SpekeKeyProvider(TypedDict, closed=True):
    certificate_arn: NotRequired["capo_mediapackage.types.__string.__string"]
    """An Amazon Resource Name (ARN) of a Certificate Manager certificate that MediaPackage will use for enforcing secure end-to-end data transfer with the key provider service."""
    encryption_contract_configuration: NotRequired[
        "capo_mediapackage.types.encryption_contract_configuration.EncryptionContractConfiguration"
    ]
    resource_id: NotRequired["capo_mediapackage.types.__string.__string"]
...
def serialize_json(value: SpekeKeyProvider) -> dict:
    ...
    if "encryption_contract_configuration" in value:
        ...
        out["encryptionContractConfiguration"] = (
            capo_mediapackage.types.encryption_contract_configuration.serialize_json(
    ...
    if "system_ids" in value:
        ...
        out["systemIds"] = capo_mediapackage.types.__list_of__string.serialize_json(
            value["system_ids"]
        )
    if "url" in value:
        out["url"] = value["url"]
...
def deserialize_json(data: dict) -> SpekeKeyProvider:
    ...
    if data.get("encryptionContractConfiguration") is not None:
        ...
        out["encryption_contract_configuration"] = (
            capo_mediapackage.types.encryption_contract_configuration.deserialize_json(
    ...
    if data.get("systemIds") is not None:
        ...
        out["system_ids"] = capo_mediapackage.types.__list_of__string.deserialize_json(
            data["systemIds"]
        )
