...
if TYPE_CHECKING:
    import capo_mediapackage.types.__period_triggers_element

__listOf__PeriodTriggersElement: TypeAlias = list[
    "capo_mediapackage.types.__period_triggers_element.__PeriodTriggersElement"
]
...
def serialize_json(value: __listOf__PeriodTriggersElement) -> list:
    ...
    for item in value:
        out.append(
            capo_mediapackage.types.__period_triggers_element.serialize_json(item)
        )
    return out
