...
import capo_iot_events.types.detector_model_summaries
...
def handle_response(
    ...
    out: capo_iot_events.types.list_detector_models_response.ListDetectorModelsResponse = capo_iot_events.types.list_detector_models_response.deserialize_json(
