...
import capo_iot_events.types.alarm_model_version_summaries
...
def handle_response(
    ...
    out: capo_iot_events.types.list_alarm_model_versions_response.ListAlarmModelVersionsResponse = capo_iot_events.types.list_alarm_model_versions_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{alarmModelName}", quote(input_["alarm_model_name"], safe=""))
