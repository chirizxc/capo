"""Generated from Smithy shape ``com.amazonaws.iotevents#DeleteDetectorModel``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.delete_detector_model_response.DeleteDetectorModelResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_detector_model(
