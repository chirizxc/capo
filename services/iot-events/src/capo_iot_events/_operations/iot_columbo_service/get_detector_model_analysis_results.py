"""Generated from Smithy shape ``com.amazonaws.iotevents#GetDetectorModelAnalysisResults``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.get_detector_model_analysis_results_response.GetDetectorModelAnalysisResultsResponse = capo_iot_events.types.get_detector_model_analysis_results_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/analysis/detector-models/{analysisId}/results"
    url = url.replace("{analysisId}", quote(input_["analysis_id"], safe=""))
...
async def async_get_detector_model_analysis_results(
