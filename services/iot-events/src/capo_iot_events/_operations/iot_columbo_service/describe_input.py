"""Generated from Smithy shape ``com.amazonaws.iotevents#DescribeInput``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.describe_input_response.DescribeInputResponse = (
        capo_iot_events.types.describe_input_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{inputName}", quote(input_["input_name"], safe=""))
...
def describe_input(
    ...
    capo_iot_events.types.describe_input_response.DescribeInputResponse, zapros.Response
]:
...
async def async_describe_input(
