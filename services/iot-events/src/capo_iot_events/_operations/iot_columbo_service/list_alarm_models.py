"""Generated from Smithy shape ``com.amazonaws.iotevents#ListAlarmModels``."""
...
def handle_response(
    ...
    out: capo_iot_events.types.list_alarm_models_response.ListAlarmModelsResponse = (
        capo_iot_events.types.list_alarm_models_response.deserialize_json(
...
async def async_list_alarm_models(
