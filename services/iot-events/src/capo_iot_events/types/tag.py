...
if TYPE_CHECKING:
    import capo_iot_events.types.tag_key
    import capo_iot_events.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_iot_events.types.tag_key.TagKey"
    """<p>The tag's key.</p>"""
    value: "capo_iot_events.types.tag_value.TagValue"
    """<p>The tag's value.</p>"""
