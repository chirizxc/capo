...
class InputIdentifier(TypedDict, closed=True):
    iot_events_input_identifier: NotRequired[
        "capo_iot_events.types.iot_events_input_identifier.IotEventsInputIdentifier"
    ]
    """<p> The identifier of the input routed to AWS IoT Events. </p>"""
    iot_site_wise_input_identifier: NotRequired[
        "capo_iot_events.types.iot_site_wise_input_identifier.IotSiteWiseInputIdentifier"
    ]
...
def serialize_json(value: InputIdentifier) -> dict:
    ...
    if "iot_events_input_identifier" in value:
        ...
        out["iotEventsInputIdentifier"] = (
            capo_iot_events.types.iot_events_input_identifier.serialize_json(
    ...
    if "iot_site_wise_input_identifier" in value:
        ...
        out["iotSiteWiseInputIdentifier"] = (
            capo_iot_events.types.iot_site_wise_input_identifier.serialize_json(
...
def deserialize_json(data: dict) -> InputIdentifier:
    ...
    if data.get("iotEventsInputIdentifier") is not None:
        ...
        out["iot_events_input_identifier"] = (
            capo_iot_events.types.iot_events_input_identifier.deserialize_json(
    ...
    if data.get("iotSiteWiseInputIdentifier") is not None:
        ...
        out["iot_site_wise_input_identifier"] = (
            capo_iot_events.types.iot_site_wise_input_identifier.deserialize_json(
