...
def serialize_json(value: ListDetectorModelVersionsResponse) -> dict:
    ...
    if "detector_model_version_summaries" in value:
        ...
        out["detectorModelVersionSummaries"] = (
            capo_iot_events.types.detector_model_version_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListDetectorModelVersionsResponse:
    ...
    if data.get("detectorModelVersionSummaries") is not None:
        import capo_iot_events.types.detector_model_version_summaries

        out["detector_model_version_summaries"] = (
            capo_iot_events.types.detector_model_version_summaries.deserialize_json(
