...
if TYPE_CHECKING:
    import capo_iot_events.types.asset_property_boolean_value
    import capo_iot_events.types.asset_property_double_value
    import capo_iot_events.types.asset_property_integer_value
    import capo_iot_events.types.asset_property_string_value


class AssetPropertyVariant(TypedDict, closed=True):
    string_value: NotRequired[
        "capo_iot_events.types.asset_property_string_value.AssetPropertyStringValue"
    ]
    ...
    integer_value: NotRequired[
        "capo_iot_events.types.asset_property_integer_value.AssetPropertyIntegerValue"
    ]
    ...
    double_value: NotRequired[
        "capo_iot_events.types.asset_property_double_value.AssetPropertyDoubleValue"
    ]
    ...
    boolean_value: NotRequired[
        "capo_iot_events.types.asset_property_boolean_value.AssetPropertyBooleanValue"
    ]
