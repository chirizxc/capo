...
class ListDetectorModelsResponse(TypedDict, closed=True):
    detector_model_summaries: NotRequired[
        "capo_iot_events.types.detector_model_summaries.DetectorModelSummaries"
    ]
...
def serialize_json(value: ListDetectorModelsResponse) -> dict:
    ...
    if "detector_model_summaries" in value:
        ...
        out["detectorModelSummaries"] = (
            capo_iot_events.types.detector_model_summaries.serialize_json(
...
def deserialize_json(data: dict) -> ListDetectorModelsResponse:
    ...
    if data.get("detectorModelSummaries") is not None:
        import capo_iot_events.types.detector_model_summaries

        out["detector_model_summaries"] = (
            capo_iot_events.types.detector_model_summaries.deserialize_json(
