"""Generated from Smithy shape ``com.amazonaws.iotevents#CreateAlarmModelResponse``."""
...
class CreateAlarmModelResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateAlarmModelResponse) -> dict:
    out: dict = {}
