"""Generated from Smithy shape ``com.amazonaws.athena#ListWorkGroups``."""
...
def handle_response(
    ...
    out: capo_athena.types.list_work_groups_output.ListWorkGroupsOutput = (
        capo_athena.types.list_work_groups_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_work_groups_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_work_groups(
    ...
    capo_athena.types.list_work_groups_output.ListWorkGroupsOutput, zapros.Response
]:
...
async def async_list_work_groups(
