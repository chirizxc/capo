"""Generated from Smithy shape ``com.amazonaws.athena#GetCalculationExecution``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_calculation_execution_response.GetCalculationExecutionResponse = capo_athena.types.get_calculation_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetCalculationExecution"
    body: bytes | None = json.dumps(
        capo_athena.types.get_calculation_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_calculation_execution(
