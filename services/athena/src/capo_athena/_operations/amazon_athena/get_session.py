...
def handle_response(
    ...
    out: capo_athena.types.get_session_response.GetSessionResponse = (
        capo_athena.types.get_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_session_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_session(
    ...
    input_: capo_athena.types.get_session_request.GetSessionRequest,
) -> tuple[capo_athena.types.get_session_response.GetSessionResponse, zapros.Response]:
