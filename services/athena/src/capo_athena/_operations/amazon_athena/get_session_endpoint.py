...
def handle_response(
    ...
    out: capo_athena.types.get_session_endpoint_response.GetSessionEndpointResponse = (
        capo_athena.types.get_session_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_session_endpoint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
