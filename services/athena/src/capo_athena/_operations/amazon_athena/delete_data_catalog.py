"""Generated from Smithy shape ``com.amazonaws.athena#DeleteDataCatalog``."""
...
def handle_response(
    ...
    out: capo_athena.types.delete_data_catalog_output.DeleteDataCatalogOutput = (
        capo_athena.types.delete_data_catalog_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.DeleteDataCatalog"
    body: bytes | None = json.dumps(
        capo_athena.types.delete_data_catalog_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_data_catalog(
