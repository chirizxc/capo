...
def handle_response(
    ...
    out: capo_athena.types.list_named_queries_output.ListNamedQueriesOutput = (
        capo_athena.types.list_named_queries_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_named_queries_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_named_queries(
    ...
    capo_athena.types.list_named_queries_output.ListNamedQueriesOutput, zapros.Response
]:
