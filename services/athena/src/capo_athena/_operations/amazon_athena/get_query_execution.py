"""Generated from Smithy shape ``com.amazonaws.athena#GetQueryExecution``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_query_execution_output.GetQueryExecutionOutput = (
        capo_athena.types.get_query_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_query_execution_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_query_execution(
