"""Generated from Smithy shape ``com.amazonaws.athena#CreateWorkGroup``."""
...
def handle_response(
    ...
    out: capo_athena.types.create_work_group_output.CreateWorkGroupOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.create_work_group_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_work_group(
    ...
    capo_athena.types.create_work_group_output.CreateWorkGroupOutput, zapros.Response
]:
...
async def async_create_work_group(
