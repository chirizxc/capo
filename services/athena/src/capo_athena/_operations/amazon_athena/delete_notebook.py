...
def handle_response(
    ...
    out: capo_athena.types.delete_notebook_output.DeleteNotebookOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.delete_notebook_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_notebook(
    ...
    capo_athena.types.delete_notebook_output.DeleteNotebookOutput, zapros.Response
]:
