"""Generated from Smithy shape ``com.amazonaws.athena#ListTableMetadata``."""
...
def handle_response(
    ...
    out: capo_athena.types.list_table_metadata_output.ListTableMetadataOutput = (
        capo_athena.types.list_table_metadata_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.ListTableMetadata"
    body: bytes | None = json.dumps(
        capo_athena.types.list_table_metadata_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_table_metadata(
