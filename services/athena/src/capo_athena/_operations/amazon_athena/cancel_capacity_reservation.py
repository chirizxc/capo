"""Generated from Smithy shape ``com.amazonaws.athena#CancelCapacityReservation``."""
...
def handle_response(
    ...
    out: capo_athena.types.cancel_capacity_reservation_output.CancelCapacityReservationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.CancelCapacityReservation"
    body: bytes | None = json.dumps(
        capo_athena.types.cancel_capacity_reservation_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
