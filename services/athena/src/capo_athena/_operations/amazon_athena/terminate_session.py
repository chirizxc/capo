...
def handle_response(
    ...
    out: capo_athena.types.terminate_session_response.TerminateSessionResponse = (
        capo_athena.types.terminate_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.terminate_session_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
