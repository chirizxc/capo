"""Generated from Smithy shape ``com.amazonaws.athena#GetTableMetadata``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_table_metadata_output.GetTableMetadataOutput = (
        capo_athena.types.get_table_metadata_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetTableMetadata"
    body: bytes | None = json.dumps(
        capo_athena.types.get_table_metadata_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_table_metadata(
    ...
    capo_athena.types.get_table_metadata_output.GetTableMetadataOutput, zapros.Response
]:
