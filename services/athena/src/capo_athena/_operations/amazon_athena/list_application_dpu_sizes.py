...
def handle_response(
    ...
    out: capo_athena.types.list_application_dpu_sizes_output.ListApplicationDPUSizesOutput = capo_athena.types.list_application_dpu_sizes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_application_dpu_sizes_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
