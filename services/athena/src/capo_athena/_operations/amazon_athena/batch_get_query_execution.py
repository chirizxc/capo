"""Generated from Smithy shape ``com.amazonaws.athena#BatchGetQueryExecution``."""
...
def handle_response(
    ...
    out: capo_athena.types.batch_get_query_execution_output.BatchGetQueryExecutionOutput = capo_athena.types.batch_get_query_execution_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.batch_get_query_execution_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_get_query_execution(
