"""Generated from Smithy shape ``com.amazonaws.athena#GetSessionStatus``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_session_status_response.GetSessionStatusResponse = (
        capo_athena.types.get_session_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetSessionStatus"
    body: bytes | None = json.dumps(
        capo_athena.types.get_session_status_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_session_status(
