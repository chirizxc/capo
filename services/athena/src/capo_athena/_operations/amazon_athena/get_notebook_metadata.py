...
def handle_response(
    ...
    out: capo_athena.types.get_notebook_metadata_output.GetNotebookMetadataOutput = (
        capo_athena.types.get_notebook_metadata_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_notebook_metadata_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
