...
def handle_response(
    ...
    out: capo_athena.types.list_databases_output.ListDatabasesOutput = (
        capo_athena.types.list_databases_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_databases_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_databases(
    ...
    capo_athena.types.list_databases_output.ListDatabasesOutput, zapros.Response
]:
