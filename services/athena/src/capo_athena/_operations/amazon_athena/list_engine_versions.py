"""Generated from Smithy shape ``com.amazonaws.athena#ListEngineVersions``."""
...
def handle_response(
    ...
    out: capo_athena.types.list_engine_versions_output.ListEngineVersionsOutput = (
        capo_athena.types.list_engine_versions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_engine_versions_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
