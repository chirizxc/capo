"""Generated from Smithy shape ``com.amazonaws.athena#StopCalculationExecution``."""
...
def handle_response(
    ...
    out: capo_athena.types.stop_calculation_execution_response.StopCalculationExecutionResponse = capo_athena.types.stop_calculation_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.StopCalculationExecution"
    body: bytes | None = json.dumps(
        capo_athena.types.stop_calculation_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_calculation_execution(
