"""Generated from Smithy shape ``com.amazonaws.athena#ListQueryExecutions``."""
...
def handle_response(
    ...
    out: capo_athena.types.list_query_executions_output.ListQueryExecutionsOutput = (
        capo_athena.types.list_query_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_query_executions_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_query_executions(
