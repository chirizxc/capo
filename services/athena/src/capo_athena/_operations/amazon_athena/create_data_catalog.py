"""Generated from Smithy shape ``com.amazonaws.athena#CreateDataCatalog``."""
...
def handle_response(
    ...
    out: capo_athena.types.create_data_catalog_output.CreateDataCatalogOutput = (
        capo_athena.types.create_data_catalog_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.CreateDataCatalog"
    body: bytes | None = json.dumps(
        capo_athena.types.create_data_catalog_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_data_catalog(
