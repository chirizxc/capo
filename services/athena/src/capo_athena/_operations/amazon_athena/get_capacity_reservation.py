"""Generated from Smithy shape ``com.amazonaws.athena#GetCapacityReservation``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_capacity_reservation_output.GetCapacityReservationOutput = capo_athena.types.get_capacity_reservation_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetCapacityReservation"
    body: bytes | None = json.dumps(
        capo_athena.types.get_capacity_reservation_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_capacity_reservation(
