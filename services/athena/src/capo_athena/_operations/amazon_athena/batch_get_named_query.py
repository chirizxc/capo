...
def handle_response(
    ...
    out: capo_athena.types.batch_get_named_query_output.BatchGetNamedQueryOutput = (
        capo_athena.types.batch_get_named_query_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.batch_get_named_query_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
