"""Generated from Smithy shape ``com.amazonaws.athena#GetNamedQuery``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_named_query_output.GetNamedQueryOutput = (
        capo_athena.types.get_named_query_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.get_named_query_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_named_query(
    ...
    capo_athena.types.get_named_query_output.GetNamedQueryOutput, zapros.Response
]:
...
async def async_get_named_query(
