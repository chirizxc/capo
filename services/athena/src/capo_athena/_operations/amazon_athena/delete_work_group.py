...
def handle_response(
    ...
    out: capo_athena.types.delete_work_group_output.DeleteWorkGroupOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.delete_work_group_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_work_group(
    ...
    capo_athena.types.delete_work_group_output.DeleteWorkGroupOutput, zapros.Response
]:
