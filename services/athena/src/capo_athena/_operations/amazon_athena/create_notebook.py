"""Generated from Smithy shape ``com.amazonaws.athena#CreateNotebook``."""
...
def handle_response(
    ...
    out: capo_athena.types.create_notebook_output.CreateNotebookOutput = (
        capo_athena.types.create_notebook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.CreateNotebook"
    body: bytes | None = json.dumps(
        capo_athena.types.create_notebook_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_notebook(
    ...
    capo_athena.types.create_notebook_output.CreateNotebookOutput, zapros.Response
]:
