"""Generated from Smithy shape ``com.amazonaws.athena#GetDataCatalog``."""
...
def handle_response(
    ...
    out: capo_athena.types.get_data_catalog_output.GetDataCatalogOutput = (
        capo_athena.types.get_data_catalog_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonAthena.GetDataCatalog"
    body: bytes | None = json.dumps(
        capo_athena.types.get_data_catalog_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_data_catalog(
    ...
    capo_athena.types.get_data_catalog_output.GetDataCatalogOutput, zapros.Response
]:
...
async def async_get_data_catalog(
