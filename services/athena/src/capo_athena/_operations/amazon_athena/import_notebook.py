...
def handle_response(
    ...
    out: capo_athena.types.import_notebook_output.ImportNotebookOutput = (
        capo_athena.types.import_notebook_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.import_notebook_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def import_notebook(
    ...
    capo_athena.types.import_notebook_output.ImportNotebookOutput, zapros.Response
]:
