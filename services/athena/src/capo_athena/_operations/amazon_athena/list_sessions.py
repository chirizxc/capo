...
def handle_response(
    ...
    out: capo_athena.types.list_sessions_response.ListSessionsResponse = (
        capo_athena.types.list_sessions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_athena.types.list_sessions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_sessions(
    ...
    capo_athena.types.list_sessions_response.ListSessionsResponse, zapros.Response
]:
