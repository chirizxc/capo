...
class GetCapacityReservationOutput(TypedDict, closed=True):
    capacity_reservation: "capo_athena.types.capacity_reservation.CapacityReservation"
...
def serialize_aws_json_1_1(value: GetCapacityReservationOutput) -> dict:
    ...
    out["CapacityReservation"] = (
        capo_athena.types.capacity_reservation.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetCapacityReservationOutput:
    ...
    if data.get("CapacityReservation") is not None:
        ...
        out["capacity_reservation"] = (
            capo_athena.types.capacity_reservation.deserialize_aws_json_1_1(
