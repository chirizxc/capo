...
class ListNamedQueriesOutput(TypedDict, closed=True):
    named_query_ids: NotRequired[
        "capo_athena.types.named_query_id_list.NamedQueryIdList"
    ]
...
def serialize_aws_json_1_1(value: ListNamedQueriesOutput) -> dict:
    ...
    if "named_query_ids" in value:
        ...
        out["NamedQueryIds"] = (
            capo_athena.types.named_query_id_list.serialize_aws_json_1_1(
