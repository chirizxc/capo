...
class ListExecutorsResponse(TypedDict, closed=True):
    ...
    executors_summary: NotRequired[
        "capo_athena.types.executors_summary_list.ExecutorsSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListExecutorsResponse) -> dict:
    ...
    if "executors_summary" in value:
        ...
        out["ExecutorsSummary"] = (
            capo_athena.types.executors_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListExecutorsResponse:
    ...
    if data.get("ExecutorsSummary") is not None:
        ...
        out["executors_summary"] = (
            capo_athena.types.executors_summary_list.deserialize_aws_json_1_1(
