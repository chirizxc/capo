"""Generated from Smithy shape ``com.amazonaws.ram#DisassociateResourceSharePermissionResponse``."""
...
class DisassociateResourceSharePermissionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DisassociateResourceSharePermissionResponse) -> dict:
    out: dict = {}
