...
def handle_response(
    ...
    out: capo_ram.types.list_permission_associations_response.ListPermissionAssociationsResponse = capo_ram.types.list_permission_associations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.list_permission_associations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
