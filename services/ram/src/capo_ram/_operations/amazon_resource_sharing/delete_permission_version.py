...
def handle_response(
    ...
    out: capo_ram.types.delete_permission_version_response.DeletePermissionVersionResponse = capo_ram.types.delete_permission_version_response.deserialize_json(
