"""Generated from Smithy shape ``com.amazonaws.ram#UntagResource``."""
...
def handle_response(
    ...
    out: capo_ram.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.untag_resource_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def untag_resource(
    ...
    capo_ram.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
