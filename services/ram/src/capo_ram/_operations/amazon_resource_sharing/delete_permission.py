...
def handle_response(
    ...
    out: capo_ram.types.delete_permission_response.DeletePermissionResponse = (
        capo_ram.types.delete_permission_response.deserialize_json(
...
def delete_permission(
    ...
    capo_ram.types.delete_permission_response.DeletePermissionResponse, zapros.Response
]:
