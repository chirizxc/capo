...
def handle_response(
    ...
    out: capo_ram.types.get_resource_shares_response.GetResourceSharesResponse = (
        capo_ram.types.get_resource_shares_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.get_resource_shares_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
