...
import capo_ram.errors.invalid_max_results_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidMaxResultsException":
            raise capo_ram.errors.invalid_max_results_exception.InvalidMaxResultsException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ram.types.get_resource_share_invitations_response.GetResourceShareInvitationsResponse = capo_ram.types.get_resource_share_invitations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.get_resource_share_invitations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
