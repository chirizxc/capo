...
def handle_response(
    ...
    out: capo_ram.types.accept_resource_share_invitation_response.AcceptResourceShareInvitationResponse = capo_ram.types.accept_resource_share_invitation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.accept_resource_share_invitation_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
