...
def handle_response(
    ...
    out: capo_ram.types.get_permission_response.GetPermissionResponse = (
        capo_ram.types.get_permission_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ram.types.get_permission_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def get_permission(
    ...
    capo_ram.types.get_permission_response.GetPermissionResponse, zapros.Response
]:
