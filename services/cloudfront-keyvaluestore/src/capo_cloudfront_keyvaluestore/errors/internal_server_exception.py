"""Generated from Smithy shape ``com.amazonaws.cloudfrontkeyvaluestore#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudfrontkeyvaluestore#InternalServerException``."""
