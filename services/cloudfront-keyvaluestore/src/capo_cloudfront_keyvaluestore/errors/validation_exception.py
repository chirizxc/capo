"""Generated from Smithy shape ``com.amazonaws.cloudfrontkeyvaluestore#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudfrontkeyvaluestore#ValidationException``."""
