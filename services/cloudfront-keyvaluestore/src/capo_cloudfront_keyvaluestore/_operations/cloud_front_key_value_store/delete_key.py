"""Generated from Smithy shape ``com.amazonaws.cloudfrontkeyvaluestore#DeleteKey``."""
...
def handle_response(
    ...
    out: capo_cloudfront_keyvaluestore.types.delete_key_response.DeleteKeyResponse = (
        capo_cloudfront_keyvaluestore.types.delete_key_response.deserialize_json(
