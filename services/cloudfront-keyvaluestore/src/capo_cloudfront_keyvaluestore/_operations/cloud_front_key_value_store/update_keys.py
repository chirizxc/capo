...
def handle_response(
    ...
    out: capo_cloudfront_keyvaluestore.types.update_keys_response.UpdateKeysResponse = (
        capo_cloudfront_keyvaluestore.types.update_keys_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudfront_keyvaluestore.types.update_keys_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
