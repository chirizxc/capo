...
from capo_codeconnections._pagination import resolve_path as _resolve_path
from capo_codeconnections._services._aws_config import aws_config
...
class CodeConnectionsClient:
    ...
    def create_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.create_connection_input.CreateConnectionInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.create_connection_output.CreateConnectionOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.create_connection.create_connection(
        ...
        input_: capo_codeconnections.types.create_connection_input.CreateConnectionInput = {
    ...
    def create_host(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.create_host_input.CreateHostInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.create_host_output.CreateHostOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.create_host.create_host(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.create_host_input.CreateHostInput = {
            "name": name,
    ...
    def create_repository_link(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.create_repository_link_input.CreateRepositoryLinkInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.create_repository_link_output.CreateRepositoryLinkOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.create_repository_link.create_repository_link(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.create_repository_link_input.CreateRepositoryLinkInput = {
    ...
    def create_sync_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.create_sync_configuration_input.CreateSyncConfigurationInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.create_sync_configuration_output.CreateSyncConfigurationOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.create_sync_configuration.create_sync_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.delete_connection_input.DeleteConnectionInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.delete_connection_output.DeleteConnectionOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.delete_connection.delete_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.delete_connection_input.DeleteConnectionInput = {
            "connection_arn": connection_arn
        }
    ...
    def delete_host(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.delete_host_input.DeleteHostInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.delete_host_output.DeleteHostOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.delete_host.delete_host(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_repository_link(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.delete_repository_link_input.DeleteRepositoryLinkInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.delete_repository_link_output.DeleteRepositoryLinkOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.delete_repository_link.delete_repository_link(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.delete_repository_link_input.DeleteRepositoryLinkInput = {
            "repository_link_id": repository_link_id
        }
    ...
    def delete_sync_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.delete_sync_configuration_input.DeleteSyncConfigurationInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.delete_sync_configuration_output.DeleteSyncConfigurationOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.delete_sync_configuration.delete_sync_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.delete_sync_configuration_input.DeleteSyncConfigurationInput = {
            "sync_type": sync_type,
            "resource_name": resource_name,
        }
    ...
    def get_connection(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.get_connection_input.GetConnectionInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.get_connection_output.GetConnectionOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.get_connection.get_connection(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_host(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.get_host_input.GetHostInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.get_host_output.GetHostOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.get_host.get_host(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_repository_link(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.get_repository_link_input.GetRepositoryLinkInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.get_repository_link_output.GetRepositoryLinkOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.get_repository_link.get_repository_link(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.get_repository_link_input.GetRepositoryLinkInput = {
            "repository_link_id": repository_link_id
        }
    ...
    def get_repository_sync_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.get_repository_sync_status_input.GetRepositorySyncStatusInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.get_repository_sync_status.get_repository_sync_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_sync_status(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.get_resource_sync_status_input.GetResourceSyncStatusInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.get_resource_sync_status_output.GetResourceSyncStatusOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.get_resource_sync_status.get_resource_sync_status(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_sync_blocker_summary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.get_sync_blocker_summary_input.GetSyncBlockerSummaryInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.get_sync_blocker_summary_output.GetSyncBlockerSummaryOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.get_sync_blocker_summary.get_sync_blocker_summary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.get_sync_blocker_summary_input.GetSyncBlockerSummaryInput = {
            "sync_type": sync_type,
            "resource_name": resource_name,
        }
    ...
    def get_sync_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.get_sync_configuration_input.GetSyncConfigurationInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.get_sync_configuration_output.GetSyncConfigurationOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.get_sync_configuration.get_sync_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_connections(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.list_connections_input.ListConnectionsInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.list_connections_output.ListConnectionsOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.list_connections.list_connections(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_connections(
        ...
        *,
        ...
        next_token: Optional["capo_codeconnections.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_codeconnections.types.list_connections_output.ListConnectionsOutput]":
        _token = next_token
        while True:
    ...
    def list_hosts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.list_hosts_input.ListHostsInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.list_hosts_output.ListHostsOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.list_hosts.list_hosts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.list_hosts_input.ListHostsInput = {}
        if max_results is not None:
            input_["max_results"] = max_results
        if next_token is not None:
            input_["next_token"] = next_token
    ...
    def iter_list_hosts(
        ...
        *,
        ...
        next_token: Optional["capo_codeconnections.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_codeconnections.types.list_hosts_output.ListHostsOutput]":
        _token = next_token
        while True:
    ...
    def list_repository_links(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.list_repository_links_input.ListRepositoryLinksInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.list_repository_links_output.ListRepositoryLinksOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.list_repository_links.list_repository_links(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.list_repository_links_input.ListRepositoryLinksInput = {}
        if max_results is not None:
            input_["max_results"] = max_results
        if next_token is not None:
            input_["next_token"] = next_token
    ...
    ) -> "Iterator[capo_codeconnections.types.list_repository_links_output.ListRepositoryLinksOutput]":
        _token = next_token
        while True:
    ...
    def list_repository_sync_definitions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.list_repository_sync_definitions_input.ListRepositorySyncDefinitionsInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.list_repository_sync_definitions_output.ListRepositorySyncDefinitionsOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.list_repository_sync_definitions.list_repository_sync_definitions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.list_repository_sync_definitions_input.ListRepositorySyncDefinitionsInput = {
            "repository_link_id": repository_link_id,
            "sync_type": sync_type,
        }
    ...
    def list_sync_configurations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.list_sync_configurations_input.ListSyncConfigurationsInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.list_sync_configurations_output.ListSyncConfigurationsOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.list_sync_configurations.list_sync_configurations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.list_sync_configurations_input.ListSyncConfigurationsInput = {
            "repository_link_id": repository_link_id,
            "sync_type": sync_type,
        }
        if max_results is not None:
    ...
    ) -> "Iterator[capo_codeconnections.types.list_sync_configurations_output.ListSyncConfigurationsOutput]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_host(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.update_host_input.UpdateHostInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.update_host_output.UpdateHostOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.update_host.update_host(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.update_host_input.UpdateHostInput = {
            "host_arn": host_arn
        }
    ...
    def update_repository_link(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.update_repository_link_input.UpdateRepositoryLinkInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.update_repository_link_output.UpdateRepositoryLinkOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.update_repository_link.update_repository_link(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
        ...
        interceptors_, options_ = self.operation_options(config_overrides)
        input_: capo_codeconnections.types.update_repository_link_input.UpdateRepositoryLinkInput = {
            "repository_link_id": repository_link_id
        }
    ...
    def update_sync_blocker(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.update_sync_blocker_input.UpdateSyncBlockerInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.update_sync_blocker_output.UpdateSyncBlockerOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.update_sync_blocker.update_sync_blocker(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_sync_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_codeconnections.types.update_sync_configuration_input.UpdateSyncConfigurationInput]",
        ) -> OperationResponse[
            "capo_codeconnections.types.update_sync_configuration_output.UpdateSyncConfigurationOutput"
        ]:
            ...
            output, http_response = (
                capo_codeconnections._operations.code_connections_20231201.update_sync_configuration.update_sync_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
