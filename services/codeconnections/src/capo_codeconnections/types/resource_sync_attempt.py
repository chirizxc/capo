...
if TYPE_CHECKING:
    import capo_codeconnections.types.resource_sync_event_list
    import capo_codeconnections.types.resource_sync_status
...
class ResourceSyncAttempt(TypedDict, closed=True):
    events: "capo_codeconnections.types.resource_sync_event_list.ResourceSyncEventList"
    """<p>The events related to a resource sync attempt.</p>"""
    initial_revision: "capo_codeconnections.types.revision.Revision"
    ...
    status: "capo_codeconnections.types.resource_sync_status.ResourceSyncStatus"
    ...
    target_revision: "capo_codeconnections.types.revision.Revision"
...
def serialize_aws_json_1_0(value: ResourceSyncAttempt) -> dict:
    ...
    out["Events"] = (
        capo_codeconnections.types.resource_sync_event_list.serialize_aws_json_1_0(
            value["events"]
        )
    )
    import capo_codeconnections.types.revision

    out["InitialRevision"] = capo_codeconnections.types.revision.serialize_aws_json_1_0(
    ...
    out["Status"] = (
        capo_codeconnections.types.resource_sync_status.serialize_aws_json_1_0(
            value["status"]
        )
    )
    import capo_codeconnections.types.revision

    out["TargetRevision"] = capo_codeconnections.types.revision.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ResourceSyncAttempt:
    ...
    if data.get("Events") is not None:
        ...
        out["events"] = (
            capo_codeconnections.types.resource_sync_event_list.deserialize_aws_json_1_0(
                data["Events"]
            )
        )
    else:
    ...
    if data.get("Status") is not None:
        ...
        out["status"] = (
            capo_codeconnections.types.resource_sync_status.deserialize_aws_json_1_0(
                data["Status"]
            )
        )
    else:
