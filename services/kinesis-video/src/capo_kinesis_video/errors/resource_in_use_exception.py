"""Generated from Smithy shape ``com.amazonaws.kinesisvideo#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisvideo#ResourceInUseException``."""
