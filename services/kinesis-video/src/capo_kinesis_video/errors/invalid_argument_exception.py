"""Generated from Smithy shape ``com.amazonaws.kinesisvideo#InvalidArgumentException``."""
...
class InvalidArgumentException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kinesisvideo#InvalidArgumentException``."""
