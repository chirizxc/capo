"""Generated from Smithy shape ``com.amazonaws.cognitosync#DescribeDataset``."""
...
def handle_response(
    ...
    out: capo_cognito_sync.types.describe_dataset_response.DescribeDatasetResponse = (
        capo_cognito_sync.types.describe_dataset_response.deserialize_json(
