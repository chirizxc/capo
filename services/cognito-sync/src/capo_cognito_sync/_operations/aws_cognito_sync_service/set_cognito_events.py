"""Generated from Smithy shape ``com.amazonaws.cognitosync#SetCognitoEvents``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_sync.types.set_cognito_events_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_set_cognito_events(
