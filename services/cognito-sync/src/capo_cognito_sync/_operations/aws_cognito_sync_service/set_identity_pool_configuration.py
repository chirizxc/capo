...
import capo_cognito_sync.errors.concurrent_modification_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConcurrentModificationException":
            raise capo_cognito_sync.errors.concurrent_modification_exception.ConcurrentModificationException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cognito_sync.types.set_identity_pool_configuration_response.SetIdentityPoolConfigurationResponse = capo_cognito_sync.types.set_identity_pool_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_sync.types.set_identity_pool_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
