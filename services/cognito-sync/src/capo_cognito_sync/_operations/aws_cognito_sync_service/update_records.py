...
import capo_cognito_sync.errors.invalid_lambda_function_output_exception
import capo_cognito_sync.errors.invalid_parameter_exception
import capo_cognito_sync.errors.lambda_throttled_exception
import capo_cognito_sync.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidLambdaFunctionOutputException":
            raise capo_cognito_sync.errors.invalid_lambda_function_output_exception.InvalidLambdaFunctionOutputException.from_json(
                data, message
            )
        ...
        case "LambdaThrottledException":
            raise capo_cognito_sync.errors.lambda_throttled_exception.LambdaThrottledException.from_json(
                data, message
            )
        case "LimitExceededException":
            raise capo_cognito_sync.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cognito_sync.types.update_records_response.UpdateRecordsResponse = (
        capo_cognito_sync.types.update_records_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_cognito_sync.types.update_records_request.UpdateRecordsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_sync.types.update_records_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
