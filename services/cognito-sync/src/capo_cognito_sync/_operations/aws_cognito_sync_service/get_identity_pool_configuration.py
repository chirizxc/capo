"""Generated from Smithy shape ``com.amazonaws.cognitosync#GetIdentityPoolConfiguration``."""
...
def handle_response(
    ...
    out: capo_cognito_sync.types.get_identity_pool_configuration_response.GetIdentityPoolConfigurationResponse = capo_cognito_sync.types.get_identity_pool_configuration_response.deserialize_json(
...
async def async_get_identity_pool_configuration(
