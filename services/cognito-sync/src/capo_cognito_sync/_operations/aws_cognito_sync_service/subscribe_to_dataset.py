"""Generated from Smithy shape ``com.amazonaws.cognitosync#SubscribeToDataset``."""
...
def handle_response(
    ...
    out: capo_cognito_sync.types.subscribe_to_dataset_response.SubscribeToDatasetResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_subscribe_to_dataset(
