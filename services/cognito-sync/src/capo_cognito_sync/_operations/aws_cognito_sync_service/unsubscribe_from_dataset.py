"""Generated from Smithy shape ``com.amazonaws.cognitosync#UnsubscribeFromDataset``."""
...
def handle_response(
    ...
    out: capo_cognito_sync.types.unsubscribe_from_dataset_response.UnsubscribeFromDatasetResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_unsubscribe_from_dataset(
