"""Generated from Smithy shape ``com.amazonaws.servicecatalog#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.servicecatalog#ResourceInUseException``."""
