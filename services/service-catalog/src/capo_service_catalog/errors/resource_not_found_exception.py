"""Generated from Smithy shape ``com.amazonaws.servicecatalog#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.servicecatalog#ResourceNotFoundException``."""
