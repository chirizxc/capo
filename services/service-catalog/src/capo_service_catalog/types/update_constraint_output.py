"""Generated from Smithy shape ``com.amazonaws.servicecatalog#UpdateConstraintOutput``."""
...
class UpdateConstraintOutput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateConstraintOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateConstraintOutput:
    out: UpdateConstraintOutput = {}  # type: ignore[typeddict-item]
