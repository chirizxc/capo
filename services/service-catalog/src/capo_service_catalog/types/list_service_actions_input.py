"""Generated from Smithy shape ``com.amazonaws.servicecatalog#ListServiceActionsInput``."""
...
class ListServiceActionsInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListServiceActionsInput) -> dict:
    out: dict = {}
