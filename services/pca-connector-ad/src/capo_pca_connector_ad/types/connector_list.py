"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#ConnectorList``."""
...
ConnectorList: TypeAlias = list[
    "capo_pca_connector_ad.types.connector_summary.ConnectorSummary"
]
...
def serialize_json(value: ConnectorList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_pca_connector_ad.types.connector_summary.serialize_json(item))
    return out
