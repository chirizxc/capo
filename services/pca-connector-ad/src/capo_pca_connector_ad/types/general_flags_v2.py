"""Generated from Smithy shape ``com.amazonaws.pcaconnectorad#GeneralFlagsV2``."""

from typing_extensions import NotRequired, TypedDict


class GeneralFlagsV2(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GeneralFlagsV2) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GeneralFlagsV2:
    out: GeneralFlagsV2 = {}  # type: ignore[typeddict-item]
