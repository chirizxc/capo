...
class EncryptionConfigurationDetails(TypedDict, closed=True):
    key_type: NotRequired["capo_sso_admin.types.kms_key_type.KmsKeyType"]
    ...
    encryption_status: NotRequired["capo_sso_admin.types.kms_key_status.KmsKeyStatus"]
    """<p>The current status of encryption configuration.</p>"""
    encryption_status_reason: NotRequired["capo_sso_admin.types.reason.Reason"]
...
def serialize_aws_json_1_1(value: EncryptionConfigurationDetails) -> dict:
    ...
    if "encryption_status" in value:
        ...
        out["EncryptionStatus"] = (
            capo_sso_admin.types.kms_key_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EncryptionConfigurationDetails:
    ...
    if data.get("EncryptionStatus") is not None:
        ...
        out["encryption_status"] = (
            capo_sso_admin.types.kms_key_status.deserialize_aws_json_1_1(
