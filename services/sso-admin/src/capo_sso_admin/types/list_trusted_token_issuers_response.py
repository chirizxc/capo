...
class ListTrustedTokenIssuersResponse(TypedDict, closed=True):
    trusted_token_issuers: NotRequired[
        "capo_sso_admin.types.trusted_token_issuer_list.TrustedTokenIssuerList"
    ]
...
def serialize_aws_json_1_1(value: ListTrustedTokenIssuersResponse) -> dict:
    ...
    if "trusted_token_issuers" in value:
        ...
        out["TrustedTokenIssuers"] = (
            capo_sso_admin.types.trusted_token_issuer_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListTrustedTokenIssuersResponse:
    ...
    if data.get("TrustedTokenIssuers") is not None:
        import capo_sso_admin.types.trusted_token_issuer_list

        out["trusted_token_issuers"] = (
            capo_sso_admin.types.trusted_token_issuer_list.deserialize_aws_json_1_1(
