"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribePermissionSetProvisioningStatusResponse``."""
...
class DescribePermissionSetProvisioningStatusResponse(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: DescribePermissionSetProvisioningStatusResponse,
) -> dict:
    out: dict = {}
