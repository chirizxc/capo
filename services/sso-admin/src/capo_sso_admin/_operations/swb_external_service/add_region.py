...
def handle_response(
    ...
    out: capo_sso_admin.types.add_region_response.AddRegionResponse = (
        capo_sso_admin.types.add_region_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.add_region_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def add_region(
    ...
    input_: capo_sso_admin.types.add_region_request.AddRegionRequest,
) -> tuple[capo_sso_admin.types.add_region_response.AddRegionResponse, zapros.Response]:
