"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListApplicationGrants``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_application_grants_response.ListApplicationGrantsResponse = capo_sso_admin.types.list_application_grants_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListApplicationGrants"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_application_grants_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_application_grants(
