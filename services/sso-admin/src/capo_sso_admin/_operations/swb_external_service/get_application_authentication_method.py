...
def handle_response(
    ...
    out: capo_sso_admin.types.get_application_authentication_method_response.GetApplicationAuthenticationMethodResponse = capo_sso_admin.types.get_application_authentication_method_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.get_application_authentication_method_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
