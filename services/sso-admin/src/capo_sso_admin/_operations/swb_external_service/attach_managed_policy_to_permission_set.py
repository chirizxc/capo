...
def handle_response(
    ...
    out: capo_sso_admin.types.attach_managed_policy_to_permission_set_response.AttachManagedPolicyToPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.attach_managed_policy_to_permission_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
