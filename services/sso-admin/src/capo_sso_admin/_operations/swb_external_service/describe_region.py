"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribeRegion``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.describe_region_response.DescribeRegionResponse = (
        capo_sso_admin.types.describe_region_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DescribeRegion"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.describe_region_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_describe_region(
