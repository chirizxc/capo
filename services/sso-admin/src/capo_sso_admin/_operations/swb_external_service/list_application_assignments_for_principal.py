"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListApplicationAssignmentsForPrincipal``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_application_assignments_for_principal_response.ListApplicationAssignmentsForPrincipalResponse = capo_sso_admin.types.list_application_assignments_for_principal_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_application_assignments_for_principal_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_application_assignments_for_principal(
