"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListApplicationAssignments``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_application_assignments_response.ListApplicationAssignmentsResponse = capo_sso_admin.types.list_application_assignments_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListApplicationAssignments"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_application_assignments_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_application_assignments(
