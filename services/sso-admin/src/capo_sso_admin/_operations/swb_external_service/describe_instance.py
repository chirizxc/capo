"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribeInstance``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.describe_instance_response.DescribeInstanceResponse = (
        capo_sso_admin.types.describe_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DescribeInstance"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.describe_instance_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
