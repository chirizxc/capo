"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListPermissionSetsProvisionedToAccount``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_permission_sets_provisioned_to_account_response.ListPermissionSetsProvisionedToAccountResponse = capo_sso_admin.types.list_permission_sets_provisioned_to_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_permission_sets_provisioned_to_account_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_permission_sets_provisioned_to_account(
