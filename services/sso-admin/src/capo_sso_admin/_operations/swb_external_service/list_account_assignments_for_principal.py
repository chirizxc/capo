"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListAccountAssignmentsForPrincipal``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_account_assignments_for_principal_response.ListAccountAssignmentsForPrincipalResponse = capo_sso_admin.types.list_account_assignments_for_principal_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListAccountAssignmentsForPrincipal"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_account_assignments_for_principal_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_account_assignments_for_principal(
