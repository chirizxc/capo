"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribeInstanceAccessControlAttributeConfiguration``."""
...
import capo_sso_admin._protocol.eventstream
...
def handle_response(
    ...
    out: capo_sso_admin.types.describe_instance_access_control_attribute_configuration_response.DescribeInstanceAccessControlAttributeConfigurationResponse = capo_sso_admin.types.describe_instance_access_control_attribute_configuration_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_sso_admin._auth._sigv4.build_sigv4_auth_scheme(
                "sso", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.describe_instance_access_control_attribute_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_instance_access_control_attribute_configuration(
