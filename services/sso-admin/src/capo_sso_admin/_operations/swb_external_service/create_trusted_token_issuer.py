...
def handle_response(
    ...
    out: capo_sso_admin.types.create_trusted_token_issuer_response.CreateTrustedTokenIssuerResponse = capo_sso_admin.types.create_trusted_token_issuer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.create_trusted_token_issuer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
