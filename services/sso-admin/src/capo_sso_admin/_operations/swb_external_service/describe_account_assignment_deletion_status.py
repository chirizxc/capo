...
def handle_response(
    ...
    out: capo_sso_admin.types.describe_account_assignment_deletion_status_response.DescribeAccountAssignmentDeletionStatusResponse = capo_sso_admin.types.describe_account_assignment_deletion_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.describe_account_assignment_deletion_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
