"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DetachCustomerManagedPolicyReferenceFromPermissionSet``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.detach_customer_managed_policy_reference_from_permission_set_response.DetachCustomerManagedPolicyReferenceFromPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.detach_customer_managed_policy_reference_from_permission_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_detach_customer_managed_policy_reference_from_permission_set(
