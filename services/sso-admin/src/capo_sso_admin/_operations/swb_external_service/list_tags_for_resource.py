...
def handle_response(
    ...
    out: capo_sso_admin.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_sso_admin.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
