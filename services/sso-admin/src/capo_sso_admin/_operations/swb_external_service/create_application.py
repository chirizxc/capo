...
def handle_response(
    ...
    out: capo_sso_admin.types.create_application_response.CreateApplicationResponse = (
        capo_sso_admin.types.create_application_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.create_application_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
