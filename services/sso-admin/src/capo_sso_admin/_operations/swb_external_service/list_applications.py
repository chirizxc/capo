"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListApplications``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_applications_response.ListApplicationsResponse = (
        capo_sso_admin.types.list_applications_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListApplications"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_applications_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
