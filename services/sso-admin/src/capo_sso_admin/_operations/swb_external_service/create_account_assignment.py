...
def handle_response(
    ...
    out: capo_sso_admin.types.create_account_assignment_response.CreateAccountAssignmentResponse = capo_sso_admin.types.create_account_assignment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.create_account_assignment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
