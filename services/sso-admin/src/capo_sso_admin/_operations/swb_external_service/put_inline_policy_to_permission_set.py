"""Generated from Smithy shape ``com.amazonaws.ssoadmin#PutInlinePolicyToPermissionSet``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.put_inline_policy_to_permission_set_response.PutInlinePolicyToPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.PutInlinePolicyToPermissionSet"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.put_inline_policy_to_permission_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_inline_policy_to_permission_set(
