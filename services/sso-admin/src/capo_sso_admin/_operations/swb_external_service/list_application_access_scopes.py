"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListApplicationAccessScopes``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_application_access_scopes_response.ListApplicationAccessScopesResponse = capo_sso_admin.types.list_application_access_scopes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListApplicationAccessScopes"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_application_access_scopes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_application_access_scopes(
