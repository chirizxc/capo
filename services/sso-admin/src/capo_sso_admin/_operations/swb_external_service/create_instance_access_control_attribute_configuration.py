"""Generated from Smithy shape ``com.amazonaws.ssoadmin#CreateInstanceAccessControlAttributeConfiguration``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.create_instance_access_control_attribute_configuration_response.CreateInstanceAccessControlAttributeConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.create_instance_access_control_attribute_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_instance_access_control_attribute_configuration(
