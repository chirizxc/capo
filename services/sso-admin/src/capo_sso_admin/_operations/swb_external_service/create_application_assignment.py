"""Generated from Smithy shape ``com.amazonaws.ssoadmin#CreateApplicationAssignment``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.create_application_assignment_response.CreateApplicationAssignmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.CreateApplicationAssignment"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.create_application_assignment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_application_assignment(
