"""Generated from Smithy shape ``com.amazonaws.ssoadmin#DescribeTrustedTokenIssuer``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.describe_trusted_token_issuer_response.DescribeTrustedTokenIssuerResponse = capo_sso_admin.types.describe_trusted_token_issuer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.DescribeTrustedTokenIssuer"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.describe_trusted_token_issuer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_trusted_token_issuer(
