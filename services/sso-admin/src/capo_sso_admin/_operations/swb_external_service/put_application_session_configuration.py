"""Generated from Smithy shape ``com.amazonaws.ssoadmin#PutApplicationSessionConfiguration``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.put_application_session_configuration_response.PutApplicationSessionConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.PutApplicationSessionConfiguration"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.put_application_session_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_application_session_configuration(
