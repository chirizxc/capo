"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListTrustedTokenIssuers``."""
...
import capo_sso_admin.types.trusted_token_issuer_list
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_trusted_token_issuers_response.ListTrustedTokenIssuersResponse = capo_sso_admin.types.list_trusted_token_issuers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListTrustedTokenIssuers"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_trusted_token_issuers_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_trusted_token_issuers(
