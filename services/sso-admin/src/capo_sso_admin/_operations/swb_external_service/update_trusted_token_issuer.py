"""Generated from Smithy shape ``com.amazonaws.ssoadmin#UpdateTrustedTokenIssuer``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.update_trusted_token_issuer_response.UpdateTrustedTokenIssuerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.UpdateTrustedTokenIssuer"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.update_trusted_token_issuer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_trusted_token_issuer(
