...
def handle_response(
    ...
    out: capo_sso_admin.types.update_instance_response.UpdateInstanceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.update_instance_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
