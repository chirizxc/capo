"""Generated from Smithy shape ``com.amazonaws.ssoadmin#AttachCustomerManagedPolicyReferenceToPermissionSet``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.attach_customer_managed_policy_reference_to_permission_set_response.AttachCustomerManagedPolicyReferenceToPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.attach_customer_managed_policy_reference_to_permission_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_attach_customer_managed_policy_reference_to_permission_set(
