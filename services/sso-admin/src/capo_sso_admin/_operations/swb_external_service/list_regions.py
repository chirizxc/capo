"""Generated from Smithy shape ``com.amazonaws.ssoadmin#ListRegions``."""
...
def handle_response(
    ...
    out: capo_sso_admin.types.list_regions_response.ListRegionsResponse = (
        capo_sso_admin.types.list_regions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SWBExternalService.ListRegions"
    body: bytes | None = json.dumps(
        capo_sso_admin.types.list_regions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_regions(
    ...
    capo_sso_admin.types.list_regions_response.ListRegionsResponse, zapros.Response
]:
