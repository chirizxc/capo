...
def handle_response(
    ...
    out: capo_sso_admin.types.put_permissions_boundary_to_permission_set_response.PutPermissionsBoundaryToPermissionSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sso_admin.types.put_permissions_boundary_to_permission_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
