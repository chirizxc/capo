...
def handle_response(
    ...
    out: capo_s3files.types.get_synchronization_configuration_response.GetSynchronizationConfigurationResponse = capo_s3files.types.get_synchronization_configuration_response.deserialize_json(
