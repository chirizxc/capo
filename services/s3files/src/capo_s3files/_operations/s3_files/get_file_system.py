...
def handle_response(
    ...
    out: capo_s3files.types.get_file_system_response.GetFileSystemResponse = (
        capo_s3files.types.get_file_system_response.deserialize_json(
...
def get_file_system(
    ...
    capo_s3files.types.get_file_system_response.GetFileSystemResponse, zapros.Response
]:
