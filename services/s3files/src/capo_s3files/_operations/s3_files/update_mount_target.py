"""Generated from Smithy shape ``com.amazonaws.s3files#UpdateMountTarget``."""
...
def handle_response(
    ...
    out: capo_s3files.types.update_mount_target_response.UpdateMountTargetResponse = (
        capo_s3files.types.update_mount_target_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3files.types.update_mount_target_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_mount_target(
