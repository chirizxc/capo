...
def handle_response(
    ...
    out: capo_s3files.types.get_mount_target_response.GetMountTargetResponse = (
        capo_s3files.types.get_mount_target_response.deserialize_json(
...
def get_mount_target(
    ...
    capo_s3files.types.get_mount_target_response.GetMountTargetResponse, zapros.Response
]:
