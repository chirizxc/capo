...
def handle_response(
    ...
    out: capo_s3files.types.get_access_point_response.GetAccessPointResponse = (
        capo_s3files.types.get_access_point_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{accessPointId}", quote(input_["access_point_id"], safe=""))
...
def get_access_point(
    ...
    capo_s3files.types.get_access_point_response.GetAccessPointResponse, zapros.Response
]:
