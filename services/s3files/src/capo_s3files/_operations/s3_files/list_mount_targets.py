"""Generated from Smithy shape ``com.amazonaws.s3files#ListMountTargets``."""
...
def handle_response(
    ...
    out: capo_s3files.types.list_mount_targets_response.ListMountTargetsResponse = (
        capo_s3files.types.list_mount_targets_response.deserialize_json(
...
async def async_list_mount_targets(
