...
def handle_response(
    ...
    out: capo_directory_service_data.types.describe_group_result.DescribeGroupResult = (
        capo_directory_service_data.types.describe_group_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service_data.types.describe_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
