...
def handle_response(
    ...
    out: capo_directory_service_data.types.list_group_members_result.ListGroupMembersResult = capo_directory_service_data.types.list_group_members_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service_data.types.list_group_members_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
