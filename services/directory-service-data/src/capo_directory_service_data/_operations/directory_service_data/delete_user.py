...
def handle_response(
    ...
    out: capo_directory_service_data.types.delete_user_result.DeleteUserResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service_data.types.delete_user_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
