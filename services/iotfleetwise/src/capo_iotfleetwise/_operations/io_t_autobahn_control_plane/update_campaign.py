...
def handle_response(
    ...
    out: capo_iotfleetwise.types.update_campaign_response.UpdateCampaignResponse = (
        capo_iotfleetwise.types.update_campaign_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.update_campaign_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
