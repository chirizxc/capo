...
def handle_response(
    ...
    out: capo_iotfleetwise.types.delete_vehicle_response.DeleteVehicleResponse = (
        capo_iotfleetwise.types.delete_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.delete_vehicle_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
