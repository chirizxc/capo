...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_decoder_manifest_network_interfaces_response.ListDecoderManifestNetworkInterfacesResponse = capo_iotfleetwise.types.list_decoder_manifest_network_interfaces_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.list_decoder_manifest_network_interfaces_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
