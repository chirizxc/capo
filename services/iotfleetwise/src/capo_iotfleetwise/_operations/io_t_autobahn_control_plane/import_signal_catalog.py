"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#ImportSignalCatalog``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.import_signal_catalog_response.ImportSignalCatalogResponse = capo_iotfleetwise.types.import_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.ImportSignalCatalog"
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.import_signal_catalog_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_import_signal_catalog(
