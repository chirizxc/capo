...
def handle_response(
    ...
    out: capo_iotfleetwise.types.update_decoder_manifest_response.UpdateDecoderManifestResponse = capo_iotfleetwise.types.update_decoder_manifest_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.update_decoder_manifest_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
