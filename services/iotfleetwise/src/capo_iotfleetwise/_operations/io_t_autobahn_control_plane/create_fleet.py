...
def handle_response(
    ...
    out: capo_iotfleetwise.types.create_fleet_response.CreateFleetResponse = (
        capo_iotfleetwise.types.create_fleet_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.create_fleet_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def create_fleet(
    ...
    capo_iotfleetwise.types.create_fleet_response.CreateFleetResponse, zapros.Response
]:
