"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#PutEncryptionConfiguration``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.put_encryption_configuration_response.PutEncryptionConfigurationResponse = capo_iotfleetwise.types.put_encryption_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.PutEncryptionConfiguration"
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.put_encryption_configuration_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_encryption_configuration(
