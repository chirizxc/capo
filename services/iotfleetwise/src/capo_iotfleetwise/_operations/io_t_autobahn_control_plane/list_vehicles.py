...
def handle_response(
    ...
    out: capo_iotfleetwise.types.list_vehicles_response.ListVehiclesResponse = (
        capo_iotfleetwise.types.list_vehicles_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.list_vehicles_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_vehicles(
    ...
    capo_iotfleetwise.types.list_vehicles_response.ListVehiclesResponse, zapros.Response
]:
