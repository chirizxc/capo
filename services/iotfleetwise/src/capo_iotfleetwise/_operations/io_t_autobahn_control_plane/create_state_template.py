...
def handle_response(
    ...
    out: capo_iotfleetwise.types.create_state_template_response.CreateStateTemplateResponse = capo_iotfleetwise.types.create_state_template_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.create_state_template_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
