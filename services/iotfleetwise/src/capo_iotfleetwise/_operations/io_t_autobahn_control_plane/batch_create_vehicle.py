...
def handle_response(
    ...
    out: capo_iotfleetwise.types.batch_create_vehicle_response.BatchCreateVehicleResponse = capo_iotfleetwise.types.batch_create_vehicle_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.batch_create_vehicle_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
