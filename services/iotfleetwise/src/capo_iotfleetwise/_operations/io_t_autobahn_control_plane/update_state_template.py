"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#UpdateStateTemplate``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.update_state_template_response.UpdateStateTemplateResponse = capo_iotfleetwise.types.update_state_template_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.UpdateStateTemplate"
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.update_state_template_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_state_template(
