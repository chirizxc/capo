...
def handle_response(
    ...
    out: capo_iotfleetwise.types.create_signal_catalog_response.CreateSignalCatalogResponse = capo_iotfleetwise.types.create_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.create_signal_catalog_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
