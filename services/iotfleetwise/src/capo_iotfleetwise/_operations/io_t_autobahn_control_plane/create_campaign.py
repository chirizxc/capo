"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#CreateCampaign``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.create_campaign_response.CreateCampaignResponse = (
        capo_iotfleetwise.types.create_campaign_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.CreateCampaign"
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.create_campaign_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
