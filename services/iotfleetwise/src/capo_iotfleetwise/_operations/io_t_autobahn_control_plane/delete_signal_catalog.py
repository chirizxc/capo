"""Generated from Smithy shape ``com.amazonaws.iotfleetwise#DeleteSignalCatalog``."""
...
def handle_response(
    ...
    out: capo_iotfleetwise.types.delete_signal_catalog_response.DeleteSignalCatalogResponse = capo_iotfleetwise.types.delete_signal_catalog_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IoTAutobahnControlPlane.DeleteSignalCatalog"
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.delete_signal_catalog_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_signal_catalog(
