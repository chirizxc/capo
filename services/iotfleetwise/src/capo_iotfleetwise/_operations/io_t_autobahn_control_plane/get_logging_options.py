...
def handle_response(
    ...
    out: capo_iotfleetwise.types.get_logging_options_response.GetLoggingOptionsResponse = capo_iotfleetwise.types.get_logging_options_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotfleetwise.types.get_logging_options_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
