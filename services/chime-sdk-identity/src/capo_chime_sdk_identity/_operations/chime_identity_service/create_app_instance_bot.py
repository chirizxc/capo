...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.create_app_instance_bot_response.CreateAppInstanceBotResponse = capo_chime_sdk_identity.types.create_app_instance_bot_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_identity.types.create_app_instance_bot_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
