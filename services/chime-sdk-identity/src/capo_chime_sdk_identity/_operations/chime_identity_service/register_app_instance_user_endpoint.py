"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#RegisterAppInstanceUserEndpoint``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.register_app_instance_user_endpoint_response.RegisterAppInstanceUserEndpointResponse = capo_chime_sdk_identity.types.register_app_instance_user_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_identity.types.register_app_instance_user_endpoint_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_register_app_instance_user_endpoint(
