"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#DescribeAppInstanceUser``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.describe_app_instance_user_response.DescribeAppInstanceUserResponse = capo_chime_sdk_identity.types.describe_app_instance_user_response.deserialize_json(
...
async def async_describe_app_instance_user(
