...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.list_app_instance_bots_response.ListAppInstanceBotsResponse = capo_chime_sdk_identity.types.list_app_instance_bots_response.deserialize_json(
