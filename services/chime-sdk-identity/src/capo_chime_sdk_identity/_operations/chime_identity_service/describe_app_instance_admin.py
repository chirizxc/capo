"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#DescribeAppInstanceAdmin``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.describe_app_instance_admin_response.DescribeAppInstanceAdminResponse = capo_chime_sdk_identity.types.describe_app_instance_admin_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{AppInstanceAdminArn}", quote(input_["app_instance_admin_arn"], safe="")
    )
    url = url.replace("{AppInstanceArn}", quote(input_["app_instance_arn"], safe=""))
...
async def async_describe_app_instance_admin(
