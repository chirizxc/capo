...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.create_app_instance_user_response.CreateAppInstanceUserResponse = capo_chime_sdk_identity.types.create_app_instance_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_identity.types.create_app_instance_user_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
