"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#ListAppInstanceUsers``."""
...
import capo_chime_sdk_identity.types.app_instance_user_list
...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.list_app_instance_users_response.ListAppInstanceUsersResponse = capo_chime_sdk_identity.types.list_app_instance_users_response.deserialize_json(
...
async def async_list_app_instance_users(
