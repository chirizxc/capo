...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.list_app_instance_admins_response.ListAppInstanceAdminsResponse = capo_chime_sdk_identity.types.list_app_instance_admins_response.deserialize_json(
