...
def handle_response(
    ...
    out: capo_chime_sdk_identity.types.put_app_instance_user_expiration_settings_response.PutAppInstanceUserExpirationSettingsResponse = capo_chime_sdk_identity.types.put_app_instance_user_expiration_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_identity.types.put_app_instance_user_expiration_settings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
