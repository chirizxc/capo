"""Generated from Smithy shape ``com.amazonaws.chimesdkidentity#ForbiddenException``."""
...
class ForbiddenException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.chimesdkidentity#ForbiddenException``."""
