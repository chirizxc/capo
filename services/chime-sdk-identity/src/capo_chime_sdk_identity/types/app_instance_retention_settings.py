...
class AppInstanceRetentionSettings(TypedDict, closed=True):
    channel_retention_settings: NotRequired[
        "capo_chime_sdk_identity.types.channel_retention_settings.ChannelRetentionSettings"
    ]
...
def serialize_json(value: AppInstanceRetentionSettings) -> dict:
    ...
    if "channel_retention_settings" in value:
        ...
        out["ChannelRetentionSettings"] = (
            capo_chime_sdk_identity.types.channel_retention_settings.serialize_json(
...
def deserialize_json(data: dict) -> AppInstanceRetentionSettings:
    ...
    if data.get("ChannelRetentionSettings") is not None:
        ...
        out["channel_retention_settings"] = (
            capo_chime_sdk_identity.types.channel_retention_settings.deserialize_json(
