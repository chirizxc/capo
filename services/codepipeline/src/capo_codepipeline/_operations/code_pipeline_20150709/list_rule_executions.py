...
def handle_response(
    ...
    out: capo_codepipeline.types.list_rule_executions_output.ListRuleExecutionsOutput = capo_codepipeline.types.list_rule_executions_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.list_rule_executions_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
