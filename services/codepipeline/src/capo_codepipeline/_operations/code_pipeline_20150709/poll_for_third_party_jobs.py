"""Generated from Smithy shape ``com.amazonaws.codepipeline#PollForThirdPartyJobs``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.poll_for_third_party_jobs_output.PollForThirdPartyJobsOutput = capo_codepipeline.types.poll_for_third_party_jobs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.poll_for_third_party_jobs_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_poll_for_third_party_jobs(
