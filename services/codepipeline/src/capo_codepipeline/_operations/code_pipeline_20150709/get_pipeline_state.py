...
def handle_response(
    ...
    out: capo_codepipeline.types.get_pipeline_state_output.GetPipelineStateOutput = (
        capo_codepipeline.types.get_pipeline_state_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.get_pipeline_state_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
