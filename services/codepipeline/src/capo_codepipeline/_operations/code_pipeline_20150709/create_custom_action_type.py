"""Generated from Smithy shape ``com.amazonaws.codepipeline#CreateCustomActionType``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.create_custom_action_type_output.CreateCustomActionTypeOutput = capo_codepipeline.types.create_custom_action_type_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.create_custom_action_type_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_custom_action_type(
