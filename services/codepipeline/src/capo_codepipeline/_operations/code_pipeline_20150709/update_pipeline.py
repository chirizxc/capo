"""Generated from Smithy shape ``com.amazonaws.codepipeline#UpdatePipeline``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.update_pipeline_output.UpdatePipelineOutput = (
        capo_codepipeline.types.update_pipeline_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.update_pipeline_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_pipeline(
    ...
    capo_codepipeline.types.update_pipeline_output.UpdatePipelineOutput, zapros.Response
]:
