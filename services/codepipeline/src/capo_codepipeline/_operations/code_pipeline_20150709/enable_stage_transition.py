"""Generated from Smithy shape ``com.amazonaws.codepipeline#EnableStageTransition``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.enable_stage_transition_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_enable_stage_transition(
