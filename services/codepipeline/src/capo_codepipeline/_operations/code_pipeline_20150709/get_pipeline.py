...
import capo_codepipeline.errors.pipeline_version_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PipelineVersionNotFoundException":
            raise capo_codepipeline.errors.pipeline_version_not_found_exception.PipelineVersionNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.get_pipeline_output.GetPipelineOutput = (
        capo_codepipeline.types.get_pipeline_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.get_pipeline_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_pipeline(
    ...
    capo_codepipeline.types.get_pipeline_output.GetPipelineOutput, zapros.Response
]:
