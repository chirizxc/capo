"""Generated from Smithy shape ``com.amazonaws.codepipeline#AcknowledgeThirdPartyJob``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.acknowledge_third_party_job_output.AcknowledgeThirdPartyJobOutput = capo_codepipeline.types.acknowledge_third_party_job_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.acknowledge_third_party_job_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_acknowledge_third_party_job(
