"""Generated from Smithy shape ``com.amazonaws.codepipeline#ListDeployActionExecutionTargets``."""
...
import capo_codepipeline.errors.action_execution_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ActionExecutionNotFoundException":
            raise capo_codepipeline.errors.action_execution_not_found_exception.ActionExecutionNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codepipeline.types.list_deploy_action_execution_targets_output.ListDeployActionExecutionTargetsOutput = capo_codepipeline.types.list_deploy_action_execution_targets_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "CodePipeline_20150709.ListDeployActionExecutionTargets"
    body: bytes | None = json.dumps(
        capo_codepipeline.types.list_deploy_action_execution_targets_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_deploy_action_execution_targets(
