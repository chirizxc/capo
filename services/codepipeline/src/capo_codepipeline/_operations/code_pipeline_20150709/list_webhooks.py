"""Generated from Smithy shape ``com.amazonaws.codepipeline#ListWebhooks``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.list_webhooks_output.ListWebhooksOutput = (
        capo_codepipeline.types.list_webhooks_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.list_webhooks_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_webhooks(
    ...
    capo_codepipeline.types.list_webhooks_output.ListWebhooksOutput, zapros.Response
]:
