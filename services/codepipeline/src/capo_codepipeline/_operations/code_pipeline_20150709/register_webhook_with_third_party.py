...
def handle_response(
    ...
    out: capo_codepipeline.types.register_webhook_with_third_party_output.RegisterWebhookWithThirdPartyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.register_webhook_with_third_party_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
