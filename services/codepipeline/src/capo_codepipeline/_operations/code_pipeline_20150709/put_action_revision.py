"""Generated from Smithy shape ``com.amazonaws.codepipeline#PutActionRevision``."""
...
def handle_response(
    ...
    out: capo_codepipeline.types.put_action_revision_output.PutActionRevisionOutput = (
        capo_codepipeline.types.put_action_revision_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codepipeline.types.put_action_revision_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_action_revision(
