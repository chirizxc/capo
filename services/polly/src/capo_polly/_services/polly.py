...
class PollyClientConfig(TypedDict, total=False, closed=True):
...
class PollyClient:
    ...
    def __init__(
        ...
        self._config = PollyClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[PollyClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: PollyClientConfig = config_overrides or {}
    ...
    def delete_lexicon(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.delete_lexicon(name='example')
        """

        def _handler(
            req: "OperationRequest[capo_polly.types.delete_lexicon_input.DeleteLexiconInput]",
        ) -> OperationResponse[
            "capo_polly.types.delete_lexicon_output.DeleteLexiconOutput"
        ]:
            ...
            output, http_response = (
                capo_polly._operations.parrot_v1.delete_lexicon.delete_lexicon(
    ...
    def describe_voices(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.describe_voices(language_code='en-GB')
        """

        def _handler(
            req: "OperationRequest[capo_polly.types.describe_voices_input.DescribeVoicesInput]",
        ) -> OperationResponse[
            "capo_polly.types.describe_voices_output.DescribeVoicesOutput"
        ]:
            ...
            output, http_response = (
                capo_polly._operations.parrot_v1.describe_voices.describe_voices(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_lexicon(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_polly.types.get_lexicon_input.GetLexiconInput]",
        ) -> OperationResponse["capo_polly.types.get_lexicon_output.GetLexiconOutput"]:
            import capo_polly._operations.parrot_v1.get_lexicon

            output, http_response = (
                capo_polly._operations.parrot_v1.get_lexicon.get_lexicon(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_speech_synthesis_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_polly.types.get_speech_synthesis_task_input.GetSpeechSynthesisTaskInput]",
        ) -> OperationResponse[
            "capo_polly.types.get_speech_synthesis_task_output.GetSpeechSynthesisTaskOutput"
        ]:
            ...
            output, http_response = (
                capo_polly._operations.parrot_v1.get_speech_synthesis_task.get_speech_synthesis_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_lexicons(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_polly.types.list_lexicons_input.ListLexiconsInput]",
        ) -> OperationResponse[
            "capo_polly.types.list_lexicons_output.ListLexiconsOutput"
        ]:
            ...
            output, http_response = (
                capo_polly._operations.parrot_v1.list_lexicons.list_lexicons(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_speech_synthesis_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_polly.types.list_speech_synthesis_tasks_input.ListSpeechSynthesisTasksInput]",
        ) -> OperationResponse[
            "capo_polly.types.list_speech_synthesis_tasks_output.ListSpeechSynthesisTasksOutput"
        ]:
            ...
            output, http_response = (
                capo_polly._operations.parrot_v1.list_speech_synthesis_tasks.list_speech_synthesis_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_lexicon(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.put_lexicon(name='W3C', content='<Lexicon Content>')
        """

        def _handler(
            req: "OperationRequest[capo_polly.types.put_lexicon_input.PutLexiconInput]",
        ) -> OperationResponse["capo_polly.types.put_lexicon_output.PutLexiconOutput"]:
            import capo_polly._operations.parrot_v1.put_lexicon

            output, http_response = (
                capo_polly._operations.parrot_v1.put_lexicon.put_lexicon(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_speech_synthesis_stream(
        ...
        *,
        ...
        action_stream: Optional[
            "Iterator[capo_polly.types.start_speech_synthesis_stream_action_stream._StartSpeechSynthesisStreamActionStream] | capo_polly.types.start_speech_synthesis_stream_action_stream._StartSpeechSynthesisStreamActionStream"
        ] = None,
    ) -> "Generator[capo_polly.types.start_speech_synthesis_stream_output.StartSpeechSynthesisStreamOutput]":
        ...
        def _handler(
            req: "OperationRequest[capo_polly.types.start_speech_synthesis_stream_input.StartSpeechSynthesisStreamInput]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                capo_polly._operations.parrot_v1.start_speech_synthesis_stream.start_speech_synthesis_stream(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_speech_synthesis_task(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_polly.types.start_speech_synthesis_task_input.StartSpeechSynthesisTaskInput]",
        ) -> OperationResponse[
            "capo_polly.types.start_speech_synthesis_task_output.StartSpeechSynthesisTaskOutput"
        ]:
            ...
            output, http_response = (
                capo_polly._operations.parrot_v1.start_speech_synthesis_task.start_speech_synthesis_task(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def synthesize_speech(
        ...
        *,
        ...
        text_type: Optional["capo_polly.types.text_type.TextType"] = None,
    ) -> "Generator[capo_polly.types.synthesize_speech_output.SynthesizeSpeechOutput]":
        ...
        Examples:
            ...
            >>> client.synthesize_speech(lexicon_names=['example'], output_format='mp3', sample_rate='8000', text='All Gaul is divided into three parts', text_type='text', voice_id='Joanna')
        """

        def _handler(
            req: "OperationRequest[capo_polly.types.synthesize_speech_input.SynthesizeSpeechInput]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                capo_polly._operations.parrot_v1.synthesize_speech.synthesize_speech(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
