...
import capo_polly.errors.invalid_sns_topic_arn_exception
...
def handle_response(
    ...
    out: capo_polly.types.start_speech_synthesis_task_output.StartSpeechSynthesisTaskOutput = capo_polly.types.start_speech_synthesis_task_output.deserialize_json(
