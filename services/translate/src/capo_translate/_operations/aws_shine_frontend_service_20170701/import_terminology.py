"""Generated from Smithy shape ``com.amazonaws.translate#ImportTerminology``."""
...
import capo_translate.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_translate.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_translate.types.import_terminology_response.ImportTerminologyResponse = (
        capo_translate.types.import_terminology_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.import_terminology_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_import_terminology(
