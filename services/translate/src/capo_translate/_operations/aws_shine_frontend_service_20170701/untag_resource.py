"""Generated from Smithy shape ``com.amazonaws.translate#UntagResource``."""
...
def handle_response(
    ...
    out: capo_translate.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShineFrontendService_20170701.UntagResource"
    body: bytes | None = json.dumps(
        capo_translate.types.untag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def untag_resource(
    ...
    capo_translate.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
