"""Generated from Smithy shape ``com.amazonaws.translate#GetParallelData``."""
...
def handle_response(
    ...
    out: capo_translate.types.get_parallel_data_response.GetParallelDataResponse = (
        capo_translate.types.get_parallel_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSShineFrontendService_20170701.GetParallelData"
    body: bytes | None = json.dumps(
        capo_translate.types.get_parallel_data_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_parallel_data(
