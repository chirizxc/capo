...
def handle_response(
    ...
    out: capo_translate.types.create_parallel_data_response.CreateParallelDataResponse = capo_translate.types.create_parallel_data_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.create_parallel_data_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
