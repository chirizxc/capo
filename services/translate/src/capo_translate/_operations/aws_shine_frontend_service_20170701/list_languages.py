...
import capo_translate.errors.unsupported_display_language_code_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedDisplayLanguageCodeException":
            raise capo_translate.errors.unsupported_display_language_code_exception.UnsupportedDisplayLanguageCodeException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_translate.types.list_languages_response.ListLanguagesResponse = (
        capo_translate.types.list_languages_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.list_languages_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_languages(
    ...
    capo_translate.types.list_languages_response.ListLanguagesResponse, zapros.Response
]:
