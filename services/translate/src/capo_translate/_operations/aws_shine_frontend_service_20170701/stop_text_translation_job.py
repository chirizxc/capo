...
def handle_response(
    ...
    out: capo_translate.types.stop_text_translation_job_response.StopTextTranslationJobResponse = capo_translate.types.stop_text_translation_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_translate.types.stop_text_translation_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
