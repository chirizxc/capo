"""Generated from Smithy shape ``com.amazonaws.translate#InvalidParameterValueException``."""
...
class InvalidParameterValueException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.translate#InvalidParameterValueException``."""
