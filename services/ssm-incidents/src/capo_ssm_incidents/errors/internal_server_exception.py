"""Generated from Smithy shape ``com.amazonaws.ssmincidents#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ssmincidents#InternalServerException``."""
