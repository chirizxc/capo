...
from capo_ssm_incidents._services._aws_config import aaws_config
...
class AsyncSSMIncidentsClientConfig(TypedDict, total=False, closed=True):
...
class AsyncSSMIncidentsClient:
    ...
    async def batch_get_incident_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.batch_get_incident_findings_input.BatchGetIncidentFindingsInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.batch_get_incident_findings_output.BatchGetIncidentFindingsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.batch_get_incident_findings.async_batch_get_incident_findings(
    ...
    async def create_replication_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.create_replication_set_input.CreateReplicationSetInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.create_replication_set_output.CreateReplicationSetOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.create_replication_set.async_create_replication_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_response_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.create_response_plan_input.CreateResponsePlanInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.create_response_plan_output.CreateResponsePlanOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.create_response_plan.async_create_response_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_timeline_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.create_timeline_event_input.CreateTimelineEventInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.create_timeline_event_output.CreateTimelineEventOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.create_timeline_event.async_create_timeline_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_incident_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.delete_incident_record_input.DeleteIncidentRecordInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.delete_incident_record_output.DeleteIncidentRecordOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.delete_incident_record.async_delete_incident_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_replication_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.delete_replication_set_input.DeleteReplicationSetInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.delete_replication_set_output.DeleteReplicationSetOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.delete_replication_set.async_delete_replication_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.delete_resource_policy_input.DeleteResourcePolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.delete_resource_policy_output.DeleteResourcePolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.delete_resource_policy.async_delete_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_response_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.delete_response_plan_input.DeleteResponsePlanInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.delete_response_plan_output.DeleteResponsePlanOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.delete_response_plan.async_delete_response_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_timeline_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.delete_timeline_event_input.DeleteTimelineEventInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.delete_timeline_event_output.DeleteTimelineEventOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.delete_timeline_event.async_delete_timeline_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_incident_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.get_incident_record_input.GetIncidentRecordInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.get_incident_record_output.GetIncidentRecordOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.get_incident_record.async_get_incident_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_replication_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.get_replication_set_input.GetReplicationSetInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.get_replication_set_output.GetReplicationSetOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.get_replication_set.async_get_replication_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.get_resource_policies_input.GetResourcePoliciesInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.get_resource_policies_output.GetResourcePoliciesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.get_resource_policies.async_get_resource_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_resource_policies(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_incidents.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_ssm_incidents.types.resource_policy.ResourcePolicy]":
        _token = next_token
        while True:
    ...
    async def get_response_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.get_response_plan_input.GetResponsePlanInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.get_response_plan_output.GetResponsePlanOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.get_response_plan.async_get_response_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_timeline_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.get_timeline_event_input.GetTimelineEventInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.get_timeline_event_output.GetTimelineEventOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.get_timeline_event.async_get_timeline_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_incident_findings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.list_incident_findings_input.ListIncidentFindingsInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.list_incident_findings_output.ListIncidentFindingsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.list_incident_findings.async_list_incident_findings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_incident_findings(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_ssm_incidents.types.finding_summary.FindingSummary]":
        _token = next_token
        while True:
    ...
    async def list_incident_records(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.list_incident_records_input.ListIncidentRecordsInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.list_incident_records_output.ListIncidentRecordsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.list_incident_records.async_list_incident_records(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_incident_records(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_incidents.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_ssm_incidents.types.incident_record_summary.IncidentRecordSummary]":
        _token = next_token
        while True:
    ...
    async def list_related_items(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.list_related_items_input.ListRelatedItemsInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.list_related_items_output.ListRelatedItemsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.list_related_items.async_list_related_items(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_related_items(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_incidents.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_ssm_incidents.types.related_item.RelatedItem]":
        _token = next_token
        while True:
    ...
    async def list_replication_sets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.list_replication_sets_input.ListReplicationSetsInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.list_replication_sets_output.ListReplicationSetsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.list_replication_sets.async_list_replication_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_replication_sets(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_incidents.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_ssm_incidents.types.arn.Arn]":
        _token = next_token
        while True:
    ...
    async def list_response_plans(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.list_response_plans_input.ListResponsePlansInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.list_response_plans_output.ListResponsePlansOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.list_response_plans.async_list_response_plans(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_response_plans(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_incidents.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_ssm_incidents.types.response_plan_summary.ResponsePlanSummary]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_timeline_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.list_timeline_events_input.ListTimelineEventsInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.list_timeline_events_output.ListTimelineEventsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.list_timeline_events.async_list_timeline_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_timeline_events(
        ...
        *,
        ...
        max_results: Optional["capo_ssm_incidents.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_ssm_incidents.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_ssm_incidents.types.event_summary.EventSummary]":
        _token = next_token
        while True:
    ...
    async def put_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.put_resource_policy_input.PutResourcePolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.put_resource_policy_output.PutResourcePolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.put_resource_policy.async_put_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_incident(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.start_incident_input.StartIncidentInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.start_incident_output.StartIncidentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.start_incident.async_start_incident(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_deletion_protection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.update_deletion_protection_input.UpdateDeletionProtectionInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.update_deletion_protection_output.UpdateDeletionProtectionOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.update_deletion_protection.async_update_deletion_protection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_incident_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.update_incident_record_input.UpdateIncidentRecordInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.update_incident_record_output.UpdateIncidentRecordOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.update_incident_record.async_update_incident_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_related_items(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.update_related_items_input.UpdateRelatedItemsInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.update_related_items_output.UpdateRelatedItemsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.update_related_items.async_update_related_items(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_replication_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.update_replication_set_input.UpdateReplicationSetInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.update_replication_set_output.UpdateReplicationSetOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.update_replication_set.async_update_replication_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_response_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.update_response_plan_input.UpdateResponsePlanInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.update_response_plan_output.UpdateResponsePlanOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.update_response_plan.async_update_response_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_timeline_event(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_ssm_incidents.types.update_timeline_event_input.UpdateTimelineEventInput]",
        ) -> AsyncOperationResponse[
            "capo_ssm_incidents.types.update_timeline_event_output.UpdateTimelineEventOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_ssm_incidents._operations.ssm_incidents.update_timeline_event.async_update_timeline_event(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
