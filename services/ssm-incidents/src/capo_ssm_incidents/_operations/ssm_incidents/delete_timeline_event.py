...
def handle_response(
    ...
    out: capo_ssm_incidents.types.delete_timeline_event_output.DeleteTimelineEventOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.delete_timeline_event_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
