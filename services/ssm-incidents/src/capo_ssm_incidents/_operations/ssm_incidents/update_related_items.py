...
def handle_response(
    ...
    out: capo_ssm_incidents.types.update_related_items_output.UpdateRelatedItemsOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.update_related_items_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
