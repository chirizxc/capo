...
def handle_response(
    ...
    out: capo_ssm_incidents.types.start_incident_output.StartIncidentOutput = (
        capo_ssm_incidents.types.start_incident_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.start_incident_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def start_incident(
    ...
    capo_ssm_incidents.types.start_incident_output.StartIncidentOutput, zapros.Response
]:
