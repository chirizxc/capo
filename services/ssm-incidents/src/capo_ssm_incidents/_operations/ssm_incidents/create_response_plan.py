...
def handle_response(
    ...
    out: capo_ssm_incidents.types.create_response_plan_output.CreateResponsePlanOutput = capo_ssm_incidents.types.create_response_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.create_response_plan_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
