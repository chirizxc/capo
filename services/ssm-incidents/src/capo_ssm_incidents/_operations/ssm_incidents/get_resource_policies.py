...
def handle_response(
    ...
    out: capo_ssm_incidents.types.get_resource_policies_output.GetResourcePoliciesOutput = capo_ssm_incidents.types.get_resource_policies_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_incidents.types.get_resource_policies_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
