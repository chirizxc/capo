...
def handle_response(
    ...
    out: capo_ssm_incidents.types.get_timeline_event_output.GetTimelineEventOutput = (
        capo_ssm_incidents.types.get_timeline_event_output.deserialize_json(
...
def build_request(
    ...
    if "incident_record_arn" in input_:
        params.append(("incidentRecordArn", input_["incident_record_arn"]))
    if "event_id" in input_:
        params.append(("eventId", input_["event_id"]))
