"""Generated from Smithy shape ``com.amazonaws.rds#InvalidGlobalClusterStateFault``."""
...
class InvalidGlobalClusterStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#InvalidGlobalClusterStateFault``."""

    code: str | None = "InvalidGlobalClusterStateFault"

    def __init__(
        self, data: InvalidGlobalClusterStateFault_, message: str | None = None
    ):
        super().__init__(
            "client",
