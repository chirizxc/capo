"""Generated from Smithy shape ``com.amazonaws.rds#DBInstanceNotFoundFault``."""
...
class DBInstanceNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DBInstanceNotFoundFault``."""

    code: str | None = "DBInstanceNotFoundFault"

    def __init__(self, data: DBInstanceNotFoundFault_, message: str | None = None):
        super().__init__(
            "client",
