"""Generated from Smithy shape ``com.amazonaws.rds#DBClusterSnapshotAlreadyExistsFault``."""
...
class DBClusterSnapshotAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rds#DBClusterSnapshotAlreadyExistsFault``."""

    code: str | None = "DBClusterSnapshotAlreadyExistsFault"

    def __init__(
        self, data: DBClusterSnapshotAlreadyExistsFault_, message: str | None = None
    ):
        super().__init__(
            "client",
