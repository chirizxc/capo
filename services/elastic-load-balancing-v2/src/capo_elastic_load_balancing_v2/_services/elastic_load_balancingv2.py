...
from capo_elastic_load_balancing_v2._services._aws_config import aws_config
...
class ElasticLoadBalancingv2Client:
    ...
    def add_listener_certificates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.add_listener_certificates_input.AddListenerCertificatesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.add_listener_certificates_output.AddListenerCertificatesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.add_listener_certificates.add_listener_certificates(
    ...
    def add_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.add_tags_input.AddTagsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.add_tags_output.AddTagsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.add_tags.add_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def add_trust_store_revocations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.add_trust_store_revocations_input.AddTrustStoreRevocationsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.add_trust_store_revocations_output.AddTrustStoreRevocationsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.add_trust_store_revocations.add_trust_store_revocations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_listener(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.create_listener_input.CreateListenerInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.create_listener_output.CreateListenerOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_listener.create_listener(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.create_load_balancer_input.CreateLoadBalancerInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.create_load_balancer_output.CreateLoadBalancerOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_load_balancer.create_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.create_rule_input.CreateRuleInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.create_rule_output.CreateRuleOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_rule.create_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_target_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.create_target_group_input.CreateTargetGroupInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.create_target_group_output.CreateTargetGroupOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_target_group.create_target_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_trust_store(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.create_trust_store_input.CreateTrustStoreInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.create_trust_store_output.CreateTrustStoreOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.create_trust_store.create_trust_store(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_listener(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.delete_listener_input.DeleteListenerInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.delete_listener_output.DeleteListenerOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_listener.delete_listener(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_load_balancer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.delete_load_balancer_input.DeleteLoadBalancerInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.delete_load_balancer_output.DeleteLoadBalancerOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_load_balancer.delete_load_balancer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.delete_rule_input.DeleteRuleInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.delete_rule_output.DeleteRuleOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_rule.delete_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_shared_trust_store_association(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.delete_shared_trust_store_association_input.DeleteSharedTrustStoreAssociationInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.delete_shared_trust_store_association_output.DeleteSharedTrustStoreAssociationOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_shared_trust_store_association.delete_shared_trust_store_association(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_target_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.delete_target_group_input.DeleteTargetGroupInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.delete_target_group_output.DeleteTargetGroupOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_target_group.delete_target_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_trust_store(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.delete_trust_store_input.DeleteTrustStoreInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.delete_trust_store_output.DeleteTrustStoreOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.delete_trust_store.delete_trust_store(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def deregister_targets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.deregister_targets_input.DeregisterTargetsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.deregister_targets_output.DeregisterTargetsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.deregister_targets.deregister_targets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_account_limits(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_account_limits_input.DescribeAccountLimitsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_account_limits_output.DescribeAccountLimitsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_account_limits.describe_account_limits(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.limit.Limit]":
        _token = marker
        while True:
    ...
    def describe_capacity_reservation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_capacity_reservation_input.DescribeCapacityReservationInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_capacity_reservation_output.DescribeCapacityReservationOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_capacity_reservation.describe_capacity_reservation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_listener_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_listener_attributes_input.DescribeListenerAttributesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_listener_attributes_output.DescribeListenerAttributesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_listener_attributes.describe_listener_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_listener_certificates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_listener_certificates_input.DescribeListenerCertificatesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_listener_certificates_output.DescribeListenerCertificatesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_listener_certificates.describe_listener_certificates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.certificate.Certificate]":
        _token = marker
        while True:
    ...
    def describe_listeners(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_listeners_input.DescribeListenersInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_listeners_output.DescribeListenersOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_listeners.describe_listeners(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.listener.Listener]":
        _token = marker
        while True:
    ...
    def describe_load_balancer_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_load_balancer_attributes_input.DescribeLoadBalancerAttributesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_load_balancer_attributes_output.DescribeLoadBalancerAttributesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_load_balancer_attributes.describe_load_balancer_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_load_balancers(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_load_balancers_input.DescribeLoadBalancersInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_load_balancers_output.DescribeLoadBalancersOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_load_balancers.describe_load_balancers(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.load_balancer.LoadBalancer]":
        _token = marker
        while True:
    ...
    def wait_until_load_balancer_exists(
        self,
        *,
        max_wait_time: float,
        min_delay: float = 15,
    ...
    def describe_rules(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_rules_input.DescribeRulesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_rules_output.DescribeRulesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_rules.describe_rules(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.rule.Rule]":
        _token = marker
        while True:
    ...
    def describe_ssl_policies(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_ssl_policies_input.DescribeSSLPoliciesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_ssl_policies_output.DescribeSSLPoliciesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_ssl_policies.describe_ssl_policies(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_tags_input.DescribeTagsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_tags_output.DescribeTagsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_tags.describe_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_target_group_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_target_group_attributes_input.DescribeTargetGroupAttributesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_target_group_attributes_output.DescribeTargetGroupAttributesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_target_group_attributes.describe_target_group_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_target_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_target_groups_input.DescribeTargetGroupsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_target_groups_output.DescribeTargetGroupsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_target_groups.describe_target_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.target_group.TargetGroup]":
        _token = marker
        while True:
    ...
    def describe_target_health(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_target_health_input.DescribeTargetHealthInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_target_health_output.DescribeTargetHealthOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_target_health.describe_target_health(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_trust_store_associations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_trust_store_associations_input.DescribeTrustStoreAssociationsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_trust_store_associations_output.DescribeTrustStoreAssociationsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_trust_store_associations.describe_trust_store_associations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.trust_store_association.TrustStoreAssociation]":
        _token = marker
        while True:
    ...
    def describe_trust_store_revocations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_trust_store_revocations_input.DescribeTrustStoreRevocationsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_trust_store_revocations_output.DescribeTrustStoreRevocationsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_trust_store_revocations.describe_trust_store_revocations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.describe_trust_store_revocation.DescribeTrustStoreRevocation]":
        _token = marker
        while True:
    ...
    def describe_trust_stores(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.describe_trust_stores_input.DescribeTrustStoresInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.describe_trust_stores_output.DescribeTrustStoresOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.describe_trust_stores.describe_trust_stores(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_elastic_load_balancing_v2.types.trust_store.TrustStore]":
        _token = marker
        while True:
    ...
    def get_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.get_resource_policy_input.GetResourcePolicyInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.get_resource_policy_output.GetResourcePolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_trust_store_ca_certificates_bundle(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_input.GetTrustStoreCaCertificatesBundleInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.get_trust_store_ca_certificates_bundle_output.GetTrustStoreCaCertificatesBundleOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.get_trust_store_ca_certificates_bundle.get_trust_store_ca_certificates_bundle(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_trust_store_revocation_content(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.get_trust_store_revocation_content_input.GetTrustStoreRevocationContentInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.get_trust_store_revocation_content_output.GetTrustStoreRevocationContentOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.get_trust_store_revocation_content.get_trust_store_revocation_content(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_capacity_reservation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_capacity_reservation_input.ModifyCapacityReservationInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_capacity_reservation_output.ModifyCapacityReservationOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_capacity_reservation.modify_capacity_reservation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_ip_pools(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_ip_pools_input.ModifyIpPoolsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_ip_pools_output.ModifyIpPoolsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_ip_pools.modify_ip_pools(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_listener(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_listener_input.ModifyListenerInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_listener_output.ModifyListenerOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_listener.modify_listener(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_listener_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_listener_attributes_input.ModifyListenerAttributesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_listener_attributes_output.ModifyListenerAttributesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_listener_attributes.modify_listener_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_load_balancer_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_load_balancer_attributes_input.ModifyLoadBalancerAttributesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_load_balancer_attributes_output.ModifyLoadBalancerAttributesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_load_balancer_attributes.modify_load_balancer_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_rule(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_rule_input.ModifyRuleInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_rule_output.ModifyRuleOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_rule.modify_rule(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_target_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_target_group_input.ModifyTargetGroupInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_target_group_output.ModifyTargetGroupOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_target_group.modify_target_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_target_group_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_target_group_attributes_input.ModifyTargetGroupAttributesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_target_group_attributes_output.ModifyTargetGroupAttributesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_target_group_attributes.modify_target_group_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_trust_store(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.modify_trust_store_input.ModifyTrustStoreInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.modify_trust_store_output.ModifyTrustStoreOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.modify_trust_store.modify_trust_store(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def register_targets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.register_targets_input.RegisterTargetsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.register_targets_output.RegisterTargetsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.register_targets.register_targets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_listener_certificates(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.remove_listener_certificates_input.RemoveListenerCertificatesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.remove_listener_certificates_output.RemoveListenerCertificatesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.remove_listener_certificates.remove_listener_certificates(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.remove_tags_input.RemoveTagsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.remove_tags_output.RemoveTagsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.remove_tags.remove_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_trust_store_revocations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.remove_trust_store_revocations_input.RemoveTrustStoreRevocationsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.remove_trust_store_revocations_output.RemoveTrustStoreRevocationsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.remove_trust_store_revocations.remove_trust_store_revocations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_ip_address_type(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.set_ip_address_type_input.SetIpAddressTypeInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.set_ip_address_type_output.SetIpAddressTypeOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.set_ip_address_type.set_ip_address_type(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_rule_priorities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.set_rule_priorities_input.SetRulePrioritiesInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.set_rule_priorities_output.SetRulePrioritiesOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.set_rule_priorities.set_rule_priorities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_security_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.set_security_groups_input.SetSecurityGroupsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.set_security_groups_output.SetSecurityGroupsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.set_security_groups.set_security_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_subnets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_elastic_load_balancing_v2.types.set_subnets_input.SetSubnetsInput]",
        ) -> OperationResponse[
            "capo_elastic_load_balancing_v2.types.set_subnets_output.SetSubnetsOutput"
        ]:
            ...
            output, http_response = (
                capo_elastic_load_balancing_v2._operations.elastic_load_balancing_v10.set_subnets.set_subnets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
