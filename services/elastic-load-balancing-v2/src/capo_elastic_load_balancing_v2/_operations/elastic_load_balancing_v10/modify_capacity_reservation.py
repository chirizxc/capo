...
import capo_elastic_load_balancing_v2.errors.capacity_decrease_requests_limit_exceeded_exception
import capo_elastic_load_balancing_v2.errors.capacity_reservation_pending_exception
import capo_elastic_load_balancing_v2.errors.capacity_units_limit_exceeded_exception
import capo_elastic_load_balancing_v2.errors.insufficient_capacity_exception
...
import capo_elastic_load_balancing_v2.errors.prior_request_not_complete_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CapacityDecreaseRequestLimitExceeded":
            raise capo_elastic_load_balancing_v2.errors.capacity_decrease_requests_limit_exceeded_exception.CapacityDecreaseRequestsLimitExceededException.from_query(
                error_el, message
            )
        case "CapacityReservationPending":
            raise capo_elastic_load_balancing_v2.errors.capacity_reservation_pending_exception.CapacityReservationPendingException.from_query(
                error_el, message
            )
        case "CapacityUnitsLimitExceeded":
            raise capo_elastic_load_balancing_v2.errors.capacity_units_limit_exceeded_exception.CapacityUnitsLimitExceededException.from_query(
                error_el, message
            )
        case "InsufficientCapacity":
            raise capo_elastic_load_balancing_v2.errors.insufficient_capacity_exception.InsufficientCapacityException.from_query(
                error_el, message
            )
        ...
        case "PriorRequestNotComplete":
            raise capo_elastic_load_balancing_v2.errors.prior_request_not_complete_exception.PriorRequestNotCompleteException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.modify_capacity_reservation_output.ModifyCapacityReservationOutput = capo_elastic_load_balancing_v2.types.modify_capacity_reservation_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.modify_capacity_reservation_input.serialize_query(
        input_, pairs, ""
    )
