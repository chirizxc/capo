"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ModifyTargetGroupAttributes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyTargetGroupAttributesResult")
    out: capo_elastic_load_balancing_v2.types.modify_target_group_attributes_output.ModifyTargetGroupAttributesOutput = capo_elastic_load_balancing_v2.types.modify_target_group_attributes_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ModifyTargetGroupAttributes"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.modify_target_group_attributes_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_target_group_attributes(
