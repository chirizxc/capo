...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.modify_rule_output.ModifyRuleOutput = (
        capo_elastic_load_balancing_v2.types.modify_rule_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.modify_rule_input.serialize_query(
        input_, pairs, ""
    )
