...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.set_rule_priorities_output.SetRulePrioritiesOutput = capo_elastic_load_balancing_v2.types.set_rule_priorities_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.set_rule_priorities_input.serialize_query(
        input_, pairs, ""
    )
