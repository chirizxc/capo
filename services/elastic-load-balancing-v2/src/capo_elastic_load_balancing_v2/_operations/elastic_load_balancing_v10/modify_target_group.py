...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.modify_target_group_output.ModifyTargetGroupOutput = capo_elastic_load_balancing_v2.types.modify_target_group_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.modify_target_group_input.serialize_query(
        input_, pairs, ""
    )
