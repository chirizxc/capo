...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.describe_rules_output.DescribeRulesOutput = capo_elastic_load_balancing_v2.types.describe_rules_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.describe_rules_input.serialize_query(
        input_, pairs, ""
    )
