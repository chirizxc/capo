"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DescribeSSLPolicies``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeSSLPoliciesResult")
    out: capo_elastic_load_balancing_v2.types.describe_ssl_policies_output.DescribeSSLPoliciesOutput = capo_elastic_load_balancing_v2.types.describe_ssl_policies_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeSSLPolicies"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.describe_ssl_policies_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_ssl_policies(
