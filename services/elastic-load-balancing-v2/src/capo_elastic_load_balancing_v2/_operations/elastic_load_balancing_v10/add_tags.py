...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.add_tags_output.AddTagsOutput = (
        capo_elastic_load_balancing_v2.types.add_tags_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.add_tags_input.serialize_query(
        input_, pairs, ""
    )
...
def add_tags(
    ...
    capo_elastic_load_balancing_v2.types.add_tags_output.AddTagsOutput, zapros.Response
]:
