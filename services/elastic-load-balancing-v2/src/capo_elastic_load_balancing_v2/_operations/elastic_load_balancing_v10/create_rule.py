"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#CreateRule``."""
...
import capo_elastic_load_balancing_v2.errors.priority_in_use_exception
...
import capo_elastic_load_balancing_v2.errors.too_many_rules_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PriorityInUse":
            raise capo_elastic_load_balancing_v2.errors.priority_in_use_exception.PriorityInUseException.from_query(
                error_el, message
            )
        ...
        case "TooManyRules":
            raise capo_elastic_load_balancing_v2.errors.too_many_rules_exception.TooManyRulesException.from_query(
                error_el, message
            )
        case "TooManyTags":
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("CreateRuleResult")
    out: capo_elastic_load_balancing_v2.types.create_rule_output.CreateRuleOutput = (
        capo_elastic_load_balancing_v2.types.create_rule_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "CreateRule"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.create_rule_input.serialize_query(
        input_, pairs, ""
    )
