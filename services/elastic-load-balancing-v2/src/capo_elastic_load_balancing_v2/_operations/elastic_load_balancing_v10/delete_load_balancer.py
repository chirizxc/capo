"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DeleteLoadBalancer``."""
...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.delete_load_balancer_output.DeleteLoadBalancerOutput = capo_elastic_load_balancing_v2.types.delete_load_balancer_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.delete_load_balancer_input.serialize_query(
        input_, pairs, ""
    )
