"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#SetIpAddressType``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SetIpAddressTypeResult")
    out: capo_elastic_load_balancing_v2.types.set_ip_address_type_output.SetIpAddressTypeOutput = capo_elastic_load_balancing_v2.types.set_ip_address_type_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "SetIpAddressType"))
    pairs.append(("Version", "2015-12-01"))
    capo_elastic_load_balancing_v2.types.set_ip_address_type_input.serialize_query(
        input_, pairs, ""
    )
