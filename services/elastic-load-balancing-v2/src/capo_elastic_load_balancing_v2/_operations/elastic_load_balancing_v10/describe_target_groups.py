...
def handle_response(
    ...
    out: capo_elastic_load_balancing_v2.types.describe_target_groups_output.DescribeTargetGroupsOutput = capo_elastic_load_balancing_v2.types.describe_target_groups_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.describe_target_groups_input.serialize_query(
        input_, pairs, ""
    )
