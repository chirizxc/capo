"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#DeregisterTargets``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeregisterTargetsResult")
    out: capo_elastic_load_balancing_v2.types.deregister_targets_output.DeregisterTargetsOutput = capo_elastic_load_balancing_v2.types.deregister_targets_output.deserialize_query(
...
def build_request(
    ...
    capo_elastic_load_balancing_v2.types.deregister_targets_input.serialize_query(
        input_, pairs, ""
    )
