"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#TooManyTagsException``."""
...
class TooManyTagsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticloadbalancingv2#TooManyTagsException``."""
