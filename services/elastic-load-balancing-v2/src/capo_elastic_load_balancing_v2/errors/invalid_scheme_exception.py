"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#InvalidSchemeException``."""
...
class InvalidSchemeException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticloadbalancingv2#InvalidSchemeException``."""
