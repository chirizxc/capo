"""Generated from Smithy shape ``com.amazonaws.elasticloadbalancingv2#ResourceInUseException``."""
...
# --- awsQuery ser/de ---
def serialize_query(
    value: ResourceInUseException_, pairs: list[tuple[str, str]], prefix: str
) -> None:
...
def deserialize_query(el: Element) -> ResourceInUseException_:
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elasticloadbalancingv2#ResourceInUseException``."""
