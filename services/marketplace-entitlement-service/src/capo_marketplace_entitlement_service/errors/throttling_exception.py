"""Generated from Smithy shape ``com.amazonaws.marketplaceentitlementservice#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.marketplaceentitlementservice#ThrottlingException``."""
