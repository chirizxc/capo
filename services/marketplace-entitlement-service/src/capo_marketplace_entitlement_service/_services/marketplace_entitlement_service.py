...
class MarketplaceEntitlementServiceClient:
    ...
    ) -> "Iterator[capo_marketplace_entitlement_service.types.get_entitlements_result.GetEntitlementsResult]":
        _token = next_token
        while True:
            _response = self.get_entitlements(
                product_code,
