...
def handle_response(
    ...
    out: capo_route_53_domains.types.resend_contact_reachability_email_response.ResendContactReachabilityEmailResponse = capo_route_53_domains.types.resend_contact_reachability_email_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.resend_contact_reachability_email_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
