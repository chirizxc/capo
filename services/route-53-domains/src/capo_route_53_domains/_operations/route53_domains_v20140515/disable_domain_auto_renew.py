"""Generated from Smithy shape ``com.amazonaws.route53domains#DisableDomainAutoRenew``."""
...
def handle_response(
    ...
    out: capo_route_53_domains.types.disable_domain_auto_renew_response.DisableDomainAutoRenewResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.disable_domain_auto_renew_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disable_domain_auto_renew(
