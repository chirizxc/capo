"""Generated from Smithy shape ``com.amazonaws.route53domains#DeleteDomain``."""
...
def handle_response(
    ...
    out: capo_route_53_domains.types.delete_domain_response.DeleteDomainResponse = (
        capo_route_53_domains.types.delete_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Domains_v20140515.DeleteDomain"
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.delete_domain_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
