...
def handle_response(
    ...
    out: capo_route_53_domains.types.disable_domain_transfer_lock_response.DisableDomainTransferLockResponse = capo_route_53_domains.types.disable_domain_transfer_lock_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.disable_domain_transfer_lock_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
