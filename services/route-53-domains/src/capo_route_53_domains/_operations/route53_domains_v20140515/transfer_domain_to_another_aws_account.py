...
def handle_response(
    ...
    out: capo_route_53_domains.types.transfer_domain_to_another_aws_account_response.TransferDomainToAnotherAwsAccountResponse = capo_route_53_domains.types.transfer_domain_to_another_aws_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.transfer_domain_to_another_aws_account_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
