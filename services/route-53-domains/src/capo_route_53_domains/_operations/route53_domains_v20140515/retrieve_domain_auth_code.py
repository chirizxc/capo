"""Generated from Smithy shape ``com.amazonaws.route53domains#RetrieveDomainAuthCode``."""
...
def handle_response(
    ...
    out: capo_route_53_domains.types.retrieve_domain_auth_code_response.RetrieveDomainAuthCodeResponse = capo_route_53_domains.types.retrieve_domain_auth_code_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.retrieve_domain_auth_code_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_retrieve_domain_auth_code(
