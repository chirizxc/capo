"""Generated from Smithy shape ``com.amazonaws.route53domains#PushDomain``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Route53Domains_v20140515.PushDomain"
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.push_domain_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
