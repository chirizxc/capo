"""Generated from Smithy shape ``com.amazonaws.route53domains#UpdateDomainContact``."""
...
def handle_response(
    ...
    out: capo_route_53_domains.types.update_domain_contact_response.UpdateDomainContactResponse = capo_route_53_domains.types.update_domain_contact_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.update_domain_contact_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_domain_contact(
