"""Generated from Smithy shape ``com.amazonaws.route53domains#RenewDomain``."""
...
def handle_response(
    ...
    out: capo_route_53_domains.types.renew_domain_response.RenewDomainResponse = (
        capo_route_53_domains.types.renew_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route_53_domains.types.renew_domain_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
