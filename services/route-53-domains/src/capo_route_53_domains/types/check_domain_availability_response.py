...
class CheckDomainAvailabilityResponse(TypedDict, closed=True):
    availability: NotRequired[
        "capo_route_53_domains.types.domain_availability.DomainAvailability"
    ]
...
def serialize_aws_json_1_1(value: CheckDomainAvailabilityResponse) -> dict:
    ...
    if "availability" in value:
        ...
        out["Availability"] = (
            capo_route_53_domains.types.domain_availability.serialize_aws_json_1_1(
                value["availability"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CheckDomainAvailabilityResponse:
    ...
    if data.get("Availability") is not None:
        ...
        out["availability"] = (
            capo_route_53_domains.types.domain_availability.deserialize_aws_json_1_1(
                data["Availability"]
            )
        )
    return out
