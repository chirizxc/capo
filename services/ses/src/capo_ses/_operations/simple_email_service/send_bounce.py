"""Generated from Smithy shape ``com.amazonaws.ses#SendBounce``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SendBounceResult")
    out: capo_ses.types.send_bounce_response.SendBounceResponse = (
        capo_ses.types.send_bounce_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "SendBounce"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.send_bounce_request.serialize_query(input_, pairs, "")
...
def send_bounce(
    ...
    input_: capo_ses.types.send_bounce_request.SendBounceRequest,
) -> tuple[capo_ses.types.send_bounce_response.SendBounceResponse, zapros.Response]:
