"""Generated from Smithy shape ``com.amazonaws.ses#GetIdentityPolicies``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetIdentityPoliciesResult")
    out: capo_ses.types.get_identity_policies_response.GetIdentityPoliciesResponse = (
        capo_ses.types.get_identity_policies_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetIdentityPolicies"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.get_identity_policies_request.serialize_query(input_, pairs, "")
...
async def async_get_identity_policies(
