...
import capo_ses.errors.invalid_template_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTemplate":
            raise capo_ses.errors.invalid_template_exception.InvalidTemplateException.from_query(
                error_el, message
            )
        case "LimitExceeded":
...
def handle_response(
    ...
    out: capo_ses.types.create_template_response.CreateTemplateResponse = (
        capo_ses.types.create_template_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.create_template_request.serialize_query(input_, pairs, "")
...
def create_template(
    ...
    capo_ses.types.create_template_response.CreateTemplateResponse, zapros.Response
]:
