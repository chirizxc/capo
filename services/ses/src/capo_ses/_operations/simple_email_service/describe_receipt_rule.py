...
def handle_response(
    ...
    out: capo_ses.types.describe_receipt_rule_response.DescribeReceiptRuleResponse = (
        capo_ses.types.describe_receipt_rule_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.describe_receipt_rule_request.serialize_query(input_, pairs, "")
