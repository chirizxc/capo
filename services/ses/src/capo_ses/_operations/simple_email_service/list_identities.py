"""Generated from Smithy shape ``com.amazonaws.ses#ListIdentities``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListIdentitiesResult")
    out: capo_ses.types.list_identities_response.ListIdentitiesResponse = (
        capo_ses.types.list_identities_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListIdentities"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.list_identities_request.serialize_query(input_, pairs, "")
...
def list_identities(
    ...
    capo_ses.types.list_identities_response.ListIdentitiesResponse, zapros.Response
]:
