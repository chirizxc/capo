...
def handle_response(
    ...
    out: capo_ses.types.verify_domain_dkim_response.VerifyDomainDkimResponse = (
        capo_ses.types.verify_domain_dkim_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.verify_domain_dkim_request.serialize_query(input_, pairs, "")
...
def verify_domain_dkim(
    ...
    capo_ses.types.verify_domain_dkim_response.VerifyDomainDkimResponse, zapros.Response
]:
