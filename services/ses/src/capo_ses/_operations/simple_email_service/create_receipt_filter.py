...
def handle_response(
    ...
    out: capo_ses.types.create_receipt_filter_response.CreateReceiptFilterResponse = (
        capo_ses.types.create_receipt_filter_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.create_receipt_filter_request.serialize_query(input_, pairs, "")
