"""Generated from Smithy shape ``com.amazonaws.ses#SetReceiptRulePosition``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SetReceiptRulePositionResult")
    out: capo_ses.types.set_receipt_rule_position_response.SetReceiptRulePositionResponse = capo_ses.types.set_receipt_rule_position_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "SetReceiptRulePosition"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.set_receipt_rule_position_request.serialize_query(input_, pairs, "")
...
async def async_set_receipt_rule_position(
