...
def handle_response(
    ...
    out: capo_ses.types.clone_receipt_rule_set_response.CloneReceiptRuleSetResponse = (
        capo_ses.types.clone_receipt_rule_set_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.clone_receipt_rule_set_request.serialize_query(input_, pairs, "")
