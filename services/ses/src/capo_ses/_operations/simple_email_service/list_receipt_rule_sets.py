"""Generated from Smithy shape ``com.amazonaws.ses#ListReceiptRuleSets``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListReceiptRuleSetsResult")
    out: capo_ses.types.list_receipt_rule_sets_response.ListReceiptRuleSetsResponse = (
        capo_ses.types.list_receipt_rule_sets_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.list_receipt_rule_sets_request.serialize_query(input_, pairs, "")
...
async def async_list_receipt_rule_sets(
