...
def handle_response(
    ...
    out: capo_ses.types.describe_configuration_set_response.DescribeConfigurationSetResponse = capo_ses.types.describe_configuration_set_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.describe_configuration_set_request.serialize_query(input_, pairs, "")
