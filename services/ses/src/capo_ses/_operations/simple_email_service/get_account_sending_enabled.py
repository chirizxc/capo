...
def handle_response(
    ...
    out: capo_ses.types.get_account_sending_enabled_response.GetAccountSendingEnabledResponse = capo_ses.types.get_account_sending_enabled_response.deserialize_query(
