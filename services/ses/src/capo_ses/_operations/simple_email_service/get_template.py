...
def handle_response(
    ...
    out: capo_ses.types.get_template_response.GetTemplateResponse = (
        capo_ses.types.get_template_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.get_template_request.serialize_query(input_, pairs, "")
...
def get_template(
    ...
    input_: capo_ses.types.get_template_request.GetTemplateRequest,
) -> tuple[capo_ses.types.get_template_response.GetTemplateResponse, zapros.Response]:
