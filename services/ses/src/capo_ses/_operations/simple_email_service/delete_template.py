...
def handle_response(
    ...
    out: capo_ses.types.delete_template_response.DeleteTemplateResponse = (
        capo_ses.types.delete_template_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.delete_template_request.serialize_query(input_, pairs, "")
...
def delete_template(
    ...
    capo_ses.types.delete_template_response.DeleteTemplateResponse, zapros.Response
]:
