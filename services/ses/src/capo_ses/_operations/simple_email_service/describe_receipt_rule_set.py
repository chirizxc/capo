"""Generated from Smithy shape ``com.amazonaws.ses#DescribeReceiptRuleSet``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeReceiptRuleSetResult")
    out: capo_ses.types.describe_receipt_rule_set_response.DescribeReceiptRuleSetResponse = capo_ses.types.describe_receipt_rule_set_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeReceiptRuleSet"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.describe_receipt_rule_set_request.serialize_query(input_, pairs, "")
...
async def async_describe_receipt_rule_set(
