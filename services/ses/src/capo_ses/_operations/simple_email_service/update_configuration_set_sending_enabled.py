"""Generated from Smithy shape ``com.amazonaws.ses#UpdateConfigurationSetSendingEnabled``."""
...
def build_request(
    ...
    pairs.append(("Action", "UpdateConfigurationSetSendingEnabled"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.update_configuration_set_sending_enabled_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_configuration_set_sending_enabled(
