"""Generated from Smithy shape ``com.amazonaws.ses#ListReceiptFilters``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListReceiptFiltersResult")
    out: capo_ses.types.list_receipt_filters_response.ListReceiptFiltersResponse = (
        capo_ses.types.list_receipt_filters_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListReceiptFilters"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.list_receipt_filters_request.serialize_query(input_, pairs, "")
...
async def async_list_receipt_filters(
