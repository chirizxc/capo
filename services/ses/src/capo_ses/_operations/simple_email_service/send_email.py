...
def handle_response(
    ...
    out: capo_ses.types.send_email_response.SendEmailResponse = (
        capo_ses.types.send_email_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.send_email_request.serialize_query(input_, pairs, "")
...
def send_email(
    ...
    input_: capo_ses.types.send_email_request.SendEmailRequest,
) -> tuple[capo_ses.types.send_email_response.SendEmailResponse, zapros.Response]:
