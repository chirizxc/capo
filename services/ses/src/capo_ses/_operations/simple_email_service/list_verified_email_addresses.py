"""Generated from Smithy shape ``com.amazonaws.ses#ListVerifiedEmailAddresses``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListVerifiedEmailAddressesResult")
    out: capo_ses.types.list_verified_email_addresses_response.ListVerifiedEmailAddressesResponse = capo_ses.types.list_verified_email_addresses_response.deserialize_query(
...
async def async_list_verified_email_addresses(
