"""Generated from Smithy shape ``com.amazonaws.ses#SetActiveReceiptRuleSet``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("SetActiveReceiptRuleSetResult")
    out: capo_ses.types.set_active_receipt_rule_set_response.SetActiveReceiptRuleSetResponse = capo_ses.types.set_active_receipt_rule_set_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "SetActiveReceiptRuleSet"))
    pairs.append(("Version", "2010-12-01"))
    capo_ses.types.set_active_receipt_rule_set_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_set_active_receipt_rule_set(
