"""Generated from Smithy shape ``com.amazonaws.ses#DeleteConfigurationSet``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteConfigurationSetResult")
    out: capo_ses.types.delete_configuration_set_response.DeleteConfigurationSetResponse = capo_ses.types.delete_configuration_set_response.deserialize_query(
...
def build_request(
    ...
    capo_ses.types.delete_configuration_set_request.serialize_query(input_, pairs, "")
