"""Generated from Smithy shape ``com.amazonaws.ses#UpdateConfigurationSetReputationMetricsEnabled``."""
...
def build_request(
    ...
    capo_ses.types.update_configuration_set_reputation_metrics_enabled_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_configuration_set_reputation_metrics_enabled(
