...
class AsyncAIOpsClient:
    ...
    async def iter_list_investigation_groups(
        self,
        *,
        config_overrides: Optional[AsyncAIOpsClientConfig] = None,
        next_token: Optional[
        ...
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[capo_aiops.types.list_investigation_groups_model.ListInvestigationGroupsModel]":
        _token = next_token
        while True:
            _response = await self.list_investigation_groups(
