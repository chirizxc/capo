...
from capo_api_gateway._services._aws_config import aaws_config
...
class AsyncAPIGatewayClient:
    ...
    async def create_api_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_api_key_request.CreateApiKeyRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.api_key.ApiKey"]:
            import capo_api_gateway._operations.backplane_control_service.create_api_key

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_api_key.async_create_api_key(
    ...
    async def create_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_authorizer_request.CreateAuthorizerRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.authorizer.Authorizer"]:
            import capo_api_gateway._operations.backplane_control_service.create_authorizer

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_authorizer.async_create_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_base_path_mapping(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_base_path_mapping_request.CreateBasePathMappingRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.base_path_mapping.BasePathMapping"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_base_path_mapping.async_create_base_path_mapping(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_deployment_request.CreateDeploymentRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.deployment.Deployment"]:
            import capo_api_gateway._operations.backplane_control_service.create_deployment

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_deployment.async_create_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_documentation_part(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_documentation_part_request.CreateDocumentationPartRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_part.DocumentationPart"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_documentation_part.async_create_documentation_part(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_documentation_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_documentation_version_request.CreateDocumentationVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_version.DocumentationVersion"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_documentation_version.async_create_documentation_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_domain_name(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_domain_name_request.CreateDomainNameRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.domain_name.DomainName"]:
            import capo_api_gateway._operations.backplane_control_service.create_domain_name

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_domain_name.async_create_domain_name(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_domain_name_access_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_domain_name_access_association_request.CreateDomainNameAccessAssociationRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.domain_name_access_association.DomainNameAccessAssociation"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_domain_name_access_association.async_create_domain_name_access_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_model(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_model_request.CreateModelRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.model.Model"]:
            import capo_api_gateway._operations.backplane_control_service.create_model

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_model.async_create_model(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_request_validator(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_request_validator_request.CreateRequestValidatorRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.request_validator.RequestValidator"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_request_validator.async_create_request_validator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_resource_request.CreateResourceRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.resource.Resource"]:
            import capo_api_gateway._operations.backplane_control_service.create_resource

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_resource.async_create_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_rest_api(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_rest_api_request.CreateRestApiRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.rest_api.RestApi"]:
            import capo_api_gateway._operations.backplane_control_service.create_rest_api

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_rest_api.async_create_rest_api(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_stage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_stage_request.CreateStageRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.stage.Stage"]:
            import capo_api_gateway._operations.backplane_control_service.create_stage

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_stage.async_create_stage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_usage_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_usage_plan_request.CreateUsagePlanRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.usage_plan.UsagePlan"]:
            import capo_api_gateway._operations.backplane_control_service.create_usage_plan

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_usage_plan.async_create_usage_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_usage_plan_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_usage_plan_key_request.CreateUsagePlanKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.usage_plan_key.UsagePlanKey"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_usage_plan_key.async_create_usage_plan_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_vpc_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.create_vpc_link_request.CreateVpcLinkRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.vpc_link.VpcLink"]:
            import capo_api_gateway._operations.backplane_control_service.create_vpc_link

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.create_vpc_link.async_create_vpc_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_api_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_api_key_request.DeleteApiKeyRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_api_key.async_delete_api_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_authorizer_request.DeleteAuthorizerRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_authorizer.async_delete_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_base_path_mapping(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_base_path_mapping_request.DeleteBasePathMappingRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_base_path_mapping.async_delete_base_path_mapping(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_client_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_client_certificate_request.DeleteClientCertificateRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_client_certificate.async_delete_client_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_deployment_request.DeleteDeploymentRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_deployment.async_delete_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_documentation_part(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_documentation_part_request.DeleteDocumentationPartRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_documentation_part.async_delete_documentation_part(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_documentation_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_documentation_version_request.DeleteDocumentationVersionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_documentation_version.async_delete_documentation_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_domain_name(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_domain_name_request.DeleteDomainNameRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_domain_name.async_delete_domain_name(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_domain_name_access_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_domain_name_access_association_request.DeleteDomainNameAccessAssociationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_domain_name_access_association.async_delete_domain_name_access_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_gateway_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_gateway_response_request.DeleteGatewayResponseRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_gateway_response.async_delete_gateway_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_integration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_integration_request.DeleteIntegrationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_integration.async_delete_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_integration_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_integration_response_request.DeleteIntegrationResponseRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_integration_response.async_delete_integration_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_method(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_method_request.DeleteMethodRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_method.async_delete_method(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_method_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_method_response_request.DeleteMethodResponseRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_method_response.async_delete_method_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_model(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_model_request.DeleteModelRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_model.async_delete_model(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_request_validator(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_request_validator_request.DeleteRequestValidatorRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_request_validator.async_delete_request_validator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_resource_request.DeleteResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_resource.async_delete_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_rest_api(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_rest_api_request.DeleteRestApiRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_rest_api.async_delete_rest_api(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_stage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_stage_request.DeleteStageRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_stage.async_delete_stage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_usage_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_usage_plan_request.DeleteUsagePlanRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_usage_plan.async_delete_usage_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_usage_plan_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_usage_plan_key_request.DeleteUsagePlanKeyRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_usage_plan_key.async_delete_usage_plan_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_vpc_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.delete_vpc_link_request.DeleteVpcLinkRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.delete_vpc_link.async_delete_vpc_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def flush_stage_authorizers_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.flush_stage_authorizers_cache_request.FlushStageAuthorizersCacheRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.flush_stage_authorizers_cache.async_flush_stage_authorizers_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def flush_stage_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.flush_stage_cache_request.FlushStageCacheRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.flush_stage_cache.async_flush_stage_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def generate_client_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.generate_client_certificate_request.GenerateClientCertificateRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.client_certificate.ClientCertificate"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.generate_client_certificate.async_generate_client_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_account_request.GetAccountRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.account.Account"]:
            import capo_api_gateway._operations.backplane_control_service.get_account

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_account.async_get_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_api_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_api_key_request.GetApiKeyRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.api_key.ApiKey"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_api_key.async_get_api_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_api_keys(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_api_keys_request.GetApiKeysRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.api_keys.ApiKeys"]:
            import capo_api_gateway._operations.backplane_control_service.get_api_keys

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_api_keys.async_get_api_keys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.api_key.ApiKey]":
        _token = position
        while True:
    ...
    async def get_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_authorizer_request.GetAuthorizerRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.authorizer.Authorizer"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_authorizer.async_get_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_authorizers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_authorizers_request.GetAuthorizersRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.authorizers.Authorizers"]:
            import capo_api_gateway._operations.backplane_control_service.get_authorizers

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_authorizers.async_get_authorizers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_base_path_mapping(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_base_path_mapping_request.GetBasePathMappingRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.base_path_mapping.BasePathMapping"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_base_path_mapping.async_get_base_path_mapping(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_base_path_mappings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_base_path_mappings_request.GetBasePathMappingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.base_path_mappings.BasePathMappings"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_base_path_mappings.async_get_base_path_mappings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.base_path_mapping.BasePathMapping]":
        _token = position
        while True:
    ...
    async def get_client_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_client_certificate_request.GetClientCertificateRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.client_certificate.ClientCertificate"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_client_certificate.async_get_client_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_client_certificates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_client_certificates_request.GetClientCertificatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.client_certificates.ClientCertificates"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_client_certificates.async_get_client_certificates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.client_certificate.ClientCertificate]":
        _token = position
        while True:
    ...
    async def get_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_deployment_request.GetDeploymentRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.deployment.Deployment"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_deployment.async_get_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_deployments(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_deployments_request.GetDeploymentsRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.deployments.Deployments"]:
            import capo_api_gateway._operations.backplane_control_service.get_deployments

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_deployments.async_get_deployments(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.deployment.Deployment]":
        _token = position
        while True:
    ...
    async def get_documentation_part(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_documentation_part_request.GetDocumentationPartRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_part.DocumentationPart"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_documentation_part.async_get_documentation_part(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_documentation_parts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_documentation_parts_request.GetDocumentationPartsRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_parts.DocumentationParts"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_documentation_parts.async_get_documentation_parts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_documentation_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_documentation_version_request.GetDocumentationVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_version.DocumentationVersion"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_documentation_version.async_get_documentation_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_documentation_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_documentation_versions_request.GetDocumentationVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_versions.DocumentationVersions"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_documentation_versions.async_get_documentation_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_domain_name(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_domain_name_request.GetDomainNameRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.domain_name.DomainName"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_domain_name.async_get_domain_name(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_domain_name_access_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_domain_name_access_associations_request.GetDomainNameAccessAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.domain_name_access_associations.DomainNameAccessAssociations"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_domain_name_access_associations.async_get_domain_name_access_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_domain_names(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_domain_names_request.GetDomainNamesRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.domain_names.DomainNames"]:
            import capo_api_gateway._operations.backplane_control_service.get_domain_names

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_domain_names.async_get_domain_names(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.domain_name.DomainName]":
        _token = position
        while True:
    ...
    async def get_export(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_export_request.GetExportRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.export_response.ExportResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_export.async_get_export(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_gateway_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_gateway_response_request.GetGatewayResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.gateway_response.GatewayResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_gateway_response.async_get_gateway_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_gateway_responses(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_gateway_responses_request.GetGatewayResponsesRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.gateway_responses.GatewayResponses"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_gateway_responses.async_get_gateway_responses(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_integration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_integration_request.GetIntegrationRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.integration.Integration"]:
            import capo_api_gateway._operations.backplane_control_service.get_integration

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_integration.async_get_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_integration_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_integration_response_request.GetIntegrationResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.integration_response.IntegrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_integration_response.async_get_integration_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_method(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_method_request.GetMethodRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.method.Method"]:
            import capo_api_gateway._operations.backplane_control_service.get_method

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_method.async_get_method(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_method_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_method_response_request.GetMethodResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.method_response.MethodResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_method_response.async_get_method_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_model(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_model_request.GetModelRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.model.Model"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_model.async_get_model(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_models(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_models_request.GetModelsRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.models.Models"]:
            import capo_api_gateway._operations.backplane_control_service.get_models

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_models.async_get_models(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.model.Model]":
        _token = position
        while True:
    ...
    async def get_model_template(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_model_template_request.GetModelTemplateRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.template.Template"]:
            import capo_api_gateway._operations.backplane_control_service.get_model_template

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_model_template.async_get_model_template(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_request_validator(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_request_validator_request.GetRequestValidatorRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.request_validator.RequestValidator"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_request_validator.async_get_request_validator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_request_validators(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_request_validators_request.GetRequestValidatorsRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.request_validators.RequestValidators"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_request_validators.async_get_request_validators(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_resource_request.GetResourceRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.resource.Resource"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_resource.async_get_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resources(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_resources_request.GetResourcesRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.resources.Resources"]:
            import capo_api_gateway._operations.backplane_control_service.get_resources

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_resources.async_get_resources(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_resources(
        ...
        *,
        ...
        embed: Optional["capo_api_gateway.types.list_of_string.ListOfString"] = None,
    ) -> "AsyncIterator[capo_api_gateway.types.resource.Resource]":
        _token = position
        while True:
    ...
    async def get_rest_api(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_rest_api_request.GetRestApiRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.rest_api.RestApi"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_rest_api.async_get_rest_api(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_rest_apis(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_rest_apis_request.GetRestApisRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.rest_apis.RestApis"]:
            import capo_api_gateway._operations.backplane_control_service.get_rest_apis

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_rest_apis.async_get_rest_apis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.rest_api.RestApi]":
        _token = position
        while True:
    ...
    async def get_sdk(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_sdk_request.GetSdkRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.sdk_response.SdkResponse"]:
            import capo_api_gateway._operations.backplane_control_service.get_sdk

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_sdk.async_get_sdk(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sdk_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_sdk_type_request.GetSdkTypeRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.sdk_type.SdkType"]:
            import capo_api_gateway._operations.backplane_control_service.get_sdk_type

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_sdk_type.async_get_sdk_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sdk_types(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_sdk_types_request.GetSdkTypesRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.sdk_types.SdkTypes"]:
            import capo_api_gateway._operations.backplane_control_service.get_sdk_types

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_sdk_types.async_get_sdk_types(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_stage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_stage_request.GetStageRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.stage.Stage"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_stage.async_get_stage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_stages(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_stages_request.GetStagesRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.stages.Stages"]:
            import capo_api_gateway._operations.backplane_control_service.get_stages

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_stages.async_get_stages(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_tags_request.GetTagsRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.tags.Tags"]:
            import capo_api_gateway._operations.backplane_control_service.get_tags

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_tags.async_get_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_usage_request.GetUsageRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.usage.Usage"]:
            import capo_api_gateway._operations.backplane_control_service.get_usage

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_usage.async_get_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[tuple[capo_api_gateway.types.string.String, capo_api_gateway.types.list_of_usage.ListOfUsage]]":
        _token = position
        while True:
    ...
    async def get_usage_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_usage_plan_request.GetUsagePlanRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.usage_plan.UsagePlan"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_usage_plan.async_get_usage_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_usage_plan_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_usage_plan_key_request.GetUsagePlanKeyRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.usage_plan_key.UsagePlanKey"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_usage_plan_key.async_get_usage_plan_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_usage_plan_keys(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_usage_plan_keys_request.GetUsagePlanKeysRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.usage_plan_keys.UsagePlanKeys"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_usage_plan_keys.async_get_usage_plan_keys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_get_usage_plan_keys(
        ...
        *,
        ...
        name_query: Optional["capo_api_gateway.types.string.String"] = None,
    ) -> "AsyncIterator[capo_api_gateway.types.usage_plan_key.UsagePlanKey]":
        _token = position
        while True:
    ...
    async def get_usage_plans(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_usage_plans_request.GetUsagePlansRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.usage_plans.UsagePlans"]:
            import capo_api_gateway._operations.backplane_control_service.get_usage_plans

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_usage_plans.async_get_usage_plans(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.usage_plan.UsagePlan]":
        _token = position
        while True:
    ...
    async def get_vpc_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_vpc_link_request.GetVpcLinkRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.vpc_link.VpcLink"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_vpc_link.async_get_vpc_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_vpc_links(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.get_vpc_links_request.GetVpcLinksRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.vpc_links.VpcLinks"]:
            import capo_api_gateway._operations.backplane_control_service.get_vpc_links

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.get_vpc_links.async_get_vpc_links(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_api_gateway.types.vpc_link.VpcLink]":
        _token = position
        while True:
    ...
    async def import_api_keys(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.import_api_keys_request.ImportApiKeysRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.api_key_ids.ApiKeyIds"]:
            import capo_api_gateway._operations.backplane_control_service.import_api_keys

            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.import_api_keys.async_import_api_keys(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_documentation_parts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.import_documentation_parts_request.ImportDocumentationPartsRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_part_ids.DocumentationPartIds"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.import_documentation_parts.async_import_documentation_parts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_rest_api(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.import_rest_api_request.ImportRestApiRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.rest_api.RestApi"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.import_rest_api.async_import_rest_api(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_gateway_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.put_gateway_response_request.PutGatewayResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.gateway_response.GatewayResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.put_gateway_response.async_put_gateway_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_integration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.put_integration_request.PutIntegrationRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.integration.Integration"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.put_integration.async_put_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_integration_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.put_integration_response_request.PutIntegrationResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.integration_response.IntegrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.put_integration_response.async_put_integration_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_method(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.put_method_request.PutMethodRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.method.Method"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.put_method.async_put_method(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_method_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.put_method_response_request.PutMethodResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.method_response.MethodResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.put_method_response.async_put_method_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_rest_api(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.put_rest_api_request.PutRestApiRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.rest_api.RestApi"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.put_rest_api.async_put_rest_api(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reject_domain_name_access_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.reject_domain_name_access_association_request.RejectDomainNameAccessAssociationRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.reject_domain_name_access_association.async_reject_domain_name_access_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_invoke_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.test_invoke_authorizer_request.TestInvokeAuthorizerRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.test_invoke_authorizer_response.TestInvokeAuthorizerResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.test_invoke_authorizer.async_test_invoke_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def test_invoke_method(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.test_invoke_method_request.TestInvokeMethodRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.test_invoke_method_response.TestInvokeMethodResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.test_invoke_method.async_test_invoke_method(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_account(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_account_request.UpdateAccountRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.account.Account"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_account.async_update_account(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_api_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_api_key_request.UpdateApiKeyRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.api_key.ApiKey"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_api_key.async_update_api_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_authorizer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_authorizer_request.UpdateAuthorizerRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.authorizer.Authorizer"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_authorizer.async_update_authorizer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_base_path_mapping(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_base_path_mapping_request.UpdateBasePathMappingRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.base_path_mapping.BasePathMapping"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_base_path_mapping.async_update_base_path_mapping(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_client_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_client_certificate_request.UpdateClientCertificateRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.client_certificate.ClientCertificate"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_client_certificate.async_update_client_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_deployment(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_deployment_request.UpdateDeploymentRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.deployment.Deployment"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_deployment.async_update_deployment(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_documentation_part(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_documentation_part_request.UpdateDocumentationPartRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_part.DocumentationPart"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_documentation_part.async_update_documentation_part(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_documentation_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_documentation_version_request.UpdateDocumentationVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.documentation_version.DocumentationVersion"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_documentation_version.async_update_documentation_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_domain_name(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_domain_name_request.UpdateDomainNameRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.domain_name.DomainName"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_domain_name.async_update_domain_name(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_gateway_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_gateway_response_request.UpdateGatewayResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.gateway_response.GatewayResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_gateway_response.async_update_gateway_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_integration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_integration_request.UpdateIntegrationRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.integration.Integration"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_integration.async_update_integration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_integration_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_integration_response_request.UpdateIntegrationResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.integration_response.IntegrationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_integration_response.async_update_integration_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_method(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_method_request.UpdateMethodRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.method.Method"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_method.async_update_method(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_method_response(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_method_response_request.UpdateMethodResponseRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.method_response.MethodResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_method_response.async_update_method_response(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_model(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_model_request.UpdateModelRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.model.Model"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_model.async_update_model(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_request_validator(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_request_validator_request.UpdateRequestValidatorRequest]",
        ) -> AsyncOperationResponse[
            "capo_api_gateway.types.request_validator.RequestValidator"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_request_validator.async_update_request_validator(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_resource_request.UpdateResourceRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.resource.Resource"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_resource.async_update_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_rest_api(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_rest_api_request.UpdateRestApiRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.rest_api.RestApi"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_rest_api.async_update_rest_api(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_stage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_stage_request.UpdateStageRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.stage.Stage"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_stage.async_update_stage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_usage_request.UpdateUsageRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.usage.Usage"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_usage.async_update_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_usage_plan(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_usage_plan_request.UpdateUsagePlanRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.usage_plan.UsagePlan"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_usage_plan.async_update_usage_plan(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_vpc_link(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_api_gateway.types.update_vpc_link_request.UpdateVpcLinkRequest]",
        ) -> AsyncOperationResponse["capo_api_gateway.types.vpc_link.VpcLink"]:
            ...
            (
                output,
                http_response,
            ) = await capo_api_gateway._operations.backplane_control_service.update_vpc_link.async_update_vpc_link(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
