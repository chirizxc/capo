...
def handle_response(
    ...
    out: capo_api_gateway.types.rest_apis.RestApis = (
        capo_api_gateway.types.rest_apis.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.rest_apis.RestApis = (
        capo_api_gateway.types.rest_apis.deserialize_json(
...
def get_rest_apis(
    ...
    input_: capo_api_gateway.types.get_rest_apis_request.GetRestApisRequest,
) -> tuple[capo_api_gateway.types.rest_apis.RestApis, zapros.Response]:
