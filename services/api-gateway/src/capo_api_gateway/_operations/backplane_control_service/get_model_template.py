"""Generated from Smithy shape ``com.amazonaws.apigateway#GetModelTemplate``."""
...
def handle_response(
    ...
    out: capo_api_gateway.types.template.Template = (
        capo_api_gateway.types.template.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.template.Template = (
        capo_api_gateway.types.template.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{modelName}", quote(input_["model_name"], safe=""))
...
def get_model_template(
    ...
    input_: capo_api_gateway.types.get_model_template_request.GetModelTemplateRequest,
) -> tuple[capo_api_gateway.types.template.Template, zapros.Response]:
