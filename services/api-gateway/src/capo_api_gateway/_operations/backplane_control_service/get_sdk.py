...
def handle_response(
    ...
    out: capo_api_gateway.types.sdk_response.SdkResponse = {
...
def build_request(
    ...
    url = url.replace("{sdkType}", quote(input_["sdk_type"], safe=""))
...
def get_sdk(
    ...
    input_: capo_api_gateway.types.get_sdk_request.GetSdkRequest,
) -> tuple[capo_api_gateway.types.sdk_response.SdkResponse, zapros.Response]:
