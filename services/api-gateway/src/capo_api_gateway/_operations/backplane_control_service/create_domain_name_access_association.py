...
def handle_response(
    ...
    out: capo_api_gateway.types.domain_name_access_association.DomainNameAccessAssociation = capo_api_gateway.types.domain_name_access_association.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.create_domain_name_access_association_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
