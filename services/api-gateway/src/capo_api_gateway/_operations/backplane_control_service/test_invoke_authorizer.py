...
def handle_response(
    ...
    out: capo_api_gateway.types.test_invoke_authorizer_response.TestInvokeAuthorizerResponse = capo_api_gateway.types.test_invoke_authorizer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.test_invoke_authorizer_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
