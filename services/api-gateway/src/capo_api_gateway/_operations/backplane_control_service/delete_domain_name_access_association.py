"""Generated from Smithy shape ``com.amazonaws.apigateway#DeleteDomainNameAccessAssociation``."""
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["domain_name_access_association_arn"], safe=""),
    )
...
async def async_delete_domain_name_access_association(
