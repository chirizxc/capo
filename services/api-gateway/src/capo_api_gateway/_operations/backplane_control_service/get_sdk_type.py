...
def handle_response(
    ...
    out: capo_api_gateway.types.sdk_type.SdkType = (
        capo_api_gateway.types.sdk_type.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_api_gateway.types.sdk_type.SdkType = (
        capo_api_gateway.types.sdk_type.deserialize_json(
...
def get_sdk_type(
    ...
    input_: capo_api_gateway.types.get_sdk_type_request.GetSdkTypeRequest,
) -> tuple[capo_api_gateway.types.sdk_type.SdkType, zapros.Response]:
