"""Generated from Smithy shape ``com.amazonaws.apigateway#PutGatewayResponse``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.put_gateway_response_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_put_gateway_response(
