...
import capo_api_gateway.types.list_of_domain_name_access_association
...
def handle_response(
    ...
    out: capo_api_gateway.types.domain_name_access_associations.DomainNameAccessAssociations = capo_api_gateway.types.domain_name_access_associations.deserialize_json(
...
def build_request(
    ...
    if "resource_owner" in input_:
        params.append(
            (
                "resourceOwner",
                capo_api_gateway.types.resource_owner.serialize_json(
                    input_["resource_owner"]
                ),
            )
        )
