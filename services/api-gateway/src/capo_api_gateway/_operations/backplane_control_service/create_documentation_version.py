"""Generated from Smithy shape ``com.amazonaws.apigateway#CreateDocumentationVersion``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_api_gateway.types.create_documentation_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_documentation_version(
