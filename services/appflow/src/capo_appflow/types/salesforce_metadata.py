...
class SalesforceMetadata(TypedDict, closed=True):
    ...
    data_transfer_apis: NotRequired[
        "capo_appflow.types.salesforce_data_transfer_api_list.SalesforceDataTransferApiList"
    ]
...
def serialize_json(value: SalesforceMetadata) -> dict:
    ...
    if "data_transfer_apis" in value:
        ...
        out["dataTransferApis"] = (
            capo_appflow.types.salesforce_data_transfer_api_list.serialize_json(
...
def deserialize_json(data: dict) -> SalesforceMetadata:
    ...
    if data.get("dataTransferApis") is not None:
        ...
        out["data_transfer_apis"] = (
            capo_appflow.types.salesforce_data_transfer_api_list.deserialize_json(
