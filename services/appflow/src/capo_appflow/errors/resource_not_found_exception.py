"""Generated from Smithy shape ``com.amazonaws.appflow#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appflow#ResourceNotFoundException``."""
