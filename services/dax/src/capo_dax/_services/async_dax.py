...
from capo_dax._services._aws_config import aaws_config
...
class AsyncDAXClient:
    ...
    async def create_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.create_cluster_request.CreateClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.create_cluster_response.CreateClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.create_cluster.async_create_cluster(
    ...
    async def create_parameter_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.create_parameter_group_request.CreateParameterGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.create_parameter_group_response.CreateParameterGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.create_parameter_group.async_create_parameter_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_subnet_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.create_subnet_group_request.CreateSubnetGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.create_subnet_group_response.CreateSubnetGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.create_subnet_group.async_create_subnet_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def decrease_replication_factor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.decrease_replication_factor_request.DecreaseReplicationFactorRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.decrease_replication_factor_response.DecreaseReplicationFactorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.decrease_replication_factor.async_decrease_replication_factor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.delete_cluster_request.DeleteClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.delete_cluster_response.DeleteClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.delete_cluster.async_delete_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_parameter_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.delete_parameter_group_request.DeleteParameterGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.delete_parameter_group_response.DeleteParameterGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.delete_parameter_group.async_delete_parameter_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_subnet_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.delete_subnet_group_request.DeleteSubnetGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.delete_subnet_group_response.DeleteSubnetGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.delete_subnet_group.async_delete_subnet_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_clusters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.describe_clusters_request.DescribeClustersRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.describe_clusters_response.DescribeClustersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.describe_clusters.async_describe_clusters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_default_parameters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.describe_default_parameters_request.DescribeDefaultParametersRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.describe_default_parameters_response.DescribeDefaultParametersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.describe_default_parameters.async_describe_default_parameters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_events(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.describe_events_request.DescribeEventsRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.describe_events_response.DescribeEventsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.describe_events.async_describe_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_parameter_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.describe_parameter_groups_request.DescribeParameterGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.describe_parameter_groups_response.DescribeParameterGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.describe_parameter_groups.async_describe_parameter_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_parameters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.describe_parameters_request.DescribeParametersRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.describe_parameters_response.DescribeParametersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.describe_parameters.async_describe_parameters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_subnet_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.describe_subnet_groups_request.DescribeSubnetGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.describe_subnet_groups_response.DescribeSubnetGroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.describe_subnet_groups.async_describe_subnet_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def increase_replication_factor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.increase_replication_factor_request.IncreaseReplicationFactorRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.increase_replication_factor_response.IncreaseReplicationFactorResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.increase_replication_factor.async_increase_replication_factor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.list_tags_request.ListTagsRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.list_tags_response.ListTagsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.list_tags.async_list_tags(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reboot_node(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.reboot_node_request.RebootNodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.reboot_node_response.RebootNodeResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.reboot_node.async_reboot_node(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.update_cluster_request.UpdateClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.update_cluster_response.UpdateClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.update_cluster.async_update_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_parameter_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.update_parameter_group_request.UpdateParameterGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.update_parameter_group_response.UpdateParameterGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.update_parameter_group.async_update_parameter_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_subnet_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dax.types.update_subnet_group_request.UpdateSubnetGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_dax.types.update_subnet_group_response.UpdateSubnetGroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dax._operations.amazon_daxv3.update_subnet_group.async_update_subnet_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
