"""Generated from Smithy shape ``com.amazonaws.dax#NodeQuotaForClusterExceededFault``."""
...
class NodeQuotaForClusterExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.dax#NodeQuotaForClusterExceededFault``."""

    code: str | None = "NodeQuotaForClusterExceededFault"

    def __init__(
        self, data: NodeQuotaForClusterExceededFault_, message: str | None = None
    ):
        super().__init__(
            "client",
