"""Generated from Smithy shape ``com.amazonaws.connectcampaigns#GetInstanceOnboardingJobStatusResponse``."""
...
class GetInstanceOnboardingJobStatusResponse(TypedDict, closed=True):
    connect_instance_onboarding_job_status: NotRequired[
        "capo_connectcampaigns.types.instance_onboarding_job_status.InstanceOnboardingJobStatus"
    ]
...
def serialize_json(value: GetInstanceOnboardingJobStatusResponse) -> dict:
    ...
    if "connect_instance_onboarding_job_status" in value:
        ...
        out["connectInstanceOnboardingJobStatus"] = (
            capo_connectcampaigns.types.instance_onboarding_job_status.serialize_json(
...
def deserialize_json(data: dict) -> GetInstanceOnboardingJobStatusResponse:
    ...
    if data.get("connectInstanceOnboardingJobStatus") is not None:
        ...
        out["connect_instance_onboarding_job_status"] = (
            capo_connectcampaigns.types.instance_onboarding_job_status.deserialize_json(
