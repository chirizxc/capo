...
class UntagResourceRequest(TypedDict, closed=True):
    ...
    resource_tag_keys: (
        "capo_bcm_data_exports.types.resource_tag_key_list.ResourceTagKeyList"
    )
...
def serialize_aws_json_1_1(value: UntagResourceRequest) -> dict:
    ...
    out["ResourceTagKeys"] = (
        capo_bcm_data_exports.types.resource_tag_key_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UntagResourceRequest:
    ...
    if data.get("ResourceTagKeys") is not None:
        import capo_bcm_data_exports.types.resource_tag_key_list

        out["resource_tag_keys"] = (
            capo_bcm_data_exports.types.resource_tag_key_list.deserialize_aws_json_1_1(
