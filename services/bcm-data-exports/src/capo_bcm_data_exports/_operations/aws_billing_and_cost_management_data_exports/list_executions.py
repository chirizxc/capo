"""Generated from Smithy shape ``com.amazonaws.bcmdataexports#ListExecutions``."""
...
def handle_response(
    ...
    out: capo_bcm_data_exports.types.list_executions_response.ListExecutionsResponse = (
        capo_bcm_data_exports.types.list_executions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBillingAndCostManagementDataExports.ListExecutions"
    body: bytes | None = json.dumps(
        capo_bcm_data_exports.types.list_executions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
