...
def handle_response(
    ...
    out: capo_bcm_data_exports.types.delete_export_response.DeleteExportResponse = (
        capo_bcm_data_exports.types.delete_export_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_data_exports.types.delete_export_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
