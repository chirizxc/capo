...
from capo_kinesis_video_webrtc_storage._services._aws_config import aws_config
...
if TYPE_CHECKING:
    ...
    import capo_kinesis_video_webrtc_storage.types.join_storage_session_input


class KinesisVideoWebRTCStorageClientConfig(TypedDict, total=False, closed=True):
...
class KinesisVideoWebRTCStorageClient:
    ...
    def __init__(
        ...
        self._config = KinesisVideoWebRTCStorageClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[KinesisVideoWebRTCStorageClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: KinesisVideoWebRTCStorageClientConfig = config_overrides or {}
    ...
    def join_storage_session_as_viewer(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_kinesis_video_webrtc_storage.types.join_storage_session_as_viewer_input.JoinStorageSessionAsViewerInput]",
        ) -> OperationResponse[None]:
            import capo_kinesis_video_webrtc_storage._operations.aws_acuity_routing_service_lambda.join_storage_session_as_viewer

            output, http_response = (
                capo_kinesis_video_webrtc_storage._operations.aws_acuity_routing_service_lambda.join_storage_session_as_viewer.join_storage_session_as_viewer(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
