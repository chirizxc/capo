...
class Experiment(TypedDict, closed=True):
    experiment_arn: NotRequired["capo_resiliencehub.types.string255.String255"]
    """<p>Amazon Resource Name (ARN) of the FIS experiment.</p>"""
    experiment_template_id: NotRequired["capo_resiliencehub.types.string255.String255"]
