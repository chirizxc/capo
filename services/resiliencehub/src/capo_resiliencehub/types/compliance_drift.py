...
class ComplianceDrift(TypedDict, closed=True):
    entity_id: NotRequired["capo_resiliencehub.types.string255.String255"]
    ...
    entity_type: NotRequired["capo_resiliencehub.types.string255.String255"]
    ...
    drift_type: NotRequired["capo_resiliencehub.types.drift_type.DriftType"]
    """<p>The type of drift detected. Currently, Resilience Hub supports only <b>ApplicationCompliance</b> drift type.</p>"""
    app_id: NotRequired["capo_resiliencehub.types.string255.String255"]
    """<p>Identifier of your application.</p>"""
    app_version: NotRequired["capo_resiliencehub.types.string255.String255"]
    """<p>Published version of your application on which drift was detected.</p>"""
    expected_reference_id: NotRequired["capo_resiliencehub.types.string255.String255"]
    ...
    actual_reference_id: NotRequired["capo_resiliencehub.types.string255.String255"]
...
def serialize_json(value: ComplianceDrift) -> dict:
    ...
    if "drift_type" in value:
        ...
        out["driftType"] = capo_resiliencehub.types.drift_type.serialize_json(
            value["drift_type"]
        )
    if "app_id" in value:
