...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_app_component_compliances_response.ListAppComponentCompliancesResponse = capo_resiliencehub.types.list_app_component_compliances_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.list_app_component_compliances_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
