...
def handle_response(
    ...
    out: capo_resiliencehub.types.delete_recommendation_template_response.DeleteRecommendationTemplateResponse = capo_resiliencehub.types.delete_recommendation_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.delete_recommendation_template_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
