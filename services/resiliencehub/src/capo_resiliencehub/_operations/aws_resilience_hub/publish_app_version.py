...
def handle_response(
    ...
    out: capo_resiliencehub.types.publish_app_version_response.PublishAppVersionResponse = capo_resiliencehub.types.publish_app_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.publish_app_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
