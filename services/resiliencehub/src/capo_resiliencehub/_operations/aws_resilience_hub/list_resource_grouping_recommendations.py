...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_resource_grouping_recommendations_response.ListResourceGroupingRecommendationsResponse = capo_resiliencehub.types.list_resource_grouping_recommendations_response.deserialize_json(
