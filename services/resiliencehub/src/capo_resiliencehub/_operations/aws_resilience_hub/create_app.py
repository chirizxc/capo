...
def handle_response(
    ...
    out: capo_resiliencehub.types.create_app_response.CreateAppResponse = (
        capo_resiliencehub.types.create_app_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.create_app_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_app(
    ...
    capo_resiliencehub.types.create_app_response.CreateAppResponse, zapros.Response
]:
