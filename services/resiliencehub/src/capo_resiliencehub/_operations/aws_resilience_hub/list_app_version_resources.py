...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_app_version_resources_response.ListAppVersionResourcesResponse = capo_resiliencehub.types.list_app_version_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.list_app_version_resources_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
