...
import capo_resiliencehub.types.resource_drift_list
...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_app_assessment_resource_drifts_response.ListAppAssessmentResourceDriftsResponse = capo_resiliencehub.types.list_app_assessment_resource_drifts_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.list_app_assessment_resource_drifts_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
