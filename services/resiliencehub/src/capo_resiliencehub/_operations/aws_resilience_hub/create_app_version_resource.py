...
def handle_response(
    ...
    out: capo_resiliencehub.types.create_app_version_resource_response.CreateAppVersionResourceResponse = capo_resiliencehub.types.create_app_version_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.create_app_version_resource_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
