"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListResiliencyPolicies``."""
...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_resiliency_policies_response.ListResiliencyPoliciesResponse = capo_resiliencehub.types.list_resiliency_policies_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-resiliency-policies"
    params: list[tuple[str, str]] = []
    if "policy_name" in input_:
        params.append(("policyName", input_["policy_name"]))
...
async def async_list_resiliency_policies(
