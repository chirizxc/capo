...
def handle_response(
    ...
    out: capo_resiliencehub.types.add_draft_app_version_resource_mappings_response.AddDraftAppVersionResourceMappingsResponse = capo_resiliencehub.types.add_draft_app_version_resource_mappings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.add_draft_app_version_resource_mappings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
