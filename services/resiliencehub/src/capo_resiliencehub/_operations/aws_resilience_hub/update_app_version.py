...
def handle_response(
    ...
    out: capo_resiliencehub.types.update_app_version_response.UpdateAppVersionResponse = capo_resiliencehub.types.update_app_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.update_app_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
