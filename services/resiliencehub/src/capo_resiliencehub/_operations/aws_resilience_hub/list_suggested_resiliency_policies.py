...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_suggested_resiliency_policies_response.ListSuggestedResiliencyPoliciesResponse = capo_resiliencehub.types.list_suggested_resiliency_policies_response.deserialize_json(
