...
def handle_response(
    ...
    out: capo_resiliencehub.types.update_app_response.UpdateAppResponse = (
        capo_resiliencehub.types.update_app_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.update_app_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_app(
    ...
    capo_resiliencehub.types.update_app_response.UpdateAppResponse, zapros.Response
]:
