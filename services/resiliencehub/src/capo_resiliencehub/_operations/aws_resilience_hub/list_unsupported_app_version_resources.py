"""Generated from Smithy shape ``com.amazonaws.resiliencehub#ListUnsupportedAppVersionResources``."""
...
def handle_response(
    ...
    out: capo_resiliencehub.types.list_unsupported_app_version_resources_response.ListUnsupportedAppVersionResourcesResponse = capo_resiliencehub.types.list_unsupported_app_version_resources_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-unsupported-app-version-resources"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.list_unsupported_app_version_resources_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_unsupported_app_version_resources(
