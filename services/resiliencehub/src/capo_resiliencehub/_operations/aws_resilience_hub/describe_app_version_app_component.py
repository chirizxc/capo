...
def handle_response(
    ...
    out: capo_resiliencehub.types.describe_app_version_app_component_response.DescribeAppVersionAppComponentResponse = capo_resiliencehub.types.describe_app_version_app_component_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.describe_app_version_app_component_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
