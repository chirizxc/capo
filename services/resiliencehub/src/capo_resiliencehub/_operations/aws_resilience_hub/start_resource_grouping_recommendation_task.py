...
def handle_response(
    ...
    out: capo_resiliencehub.types.start_resource_grouping_recommendation_task_response.StartResourceGroupingRecommendationTaskResponse = capo_resiliencehub.types.start_resource_grouping_recommendation_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.start_resource_grouping_recommendation_task_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
