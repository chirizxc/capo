...
def build_request(
    ...
    import capo_resiliencehub._protocol.serialize
    ...
    if "from_last_assessment_time" in input_:
        params.append(
            (
                ...
                capo_resiliencehub._protocol.serialize.fmt_date_time(
                    input_["from_last_assessment_time"]
                ),
            )
        )
    if "to_last_assessment_time" in input_:
        params.append(
            (
                ...
                capo_resiliencehub._protocol.serialize.fmt_date_time(
                    input_["to_last_assessment_time"]
                ),
            )
        )
    ...
    if "aws_application_arn" in input_:
        params.append(("awsApplicationArn", input_["aws_application_arn"]))
