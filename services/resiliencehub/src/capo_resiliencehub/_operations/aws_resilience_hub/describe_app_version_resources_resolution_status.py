"""Generated from Smithy shape ``com.amazonaws.resiliencehub#DescribeAppVersionResourcesResolutionStatus``."""
...
def handle_response(
    ...
    out: capo_resiliencehub.types.describe_app_version_resources_resolution_status_response.DescribeAppVersionResourcesResolutionStatusResponse = capo_resiliencehub.types.describe_app_version_resources_resolution_status_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/describe-app-version-resources-resolution-status"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_resiliencehub.types.describe_app_version_resources_resolution_status_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_app_version_resources_resolution_status(
