...
class AsyncresiliencehubClient:
    ...
    async def iter_list_alarm_recommendations(
        self,
        assessment_arn: "capo_resiliencehub.types.arn.Arn",
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_alarm_recommendations_response.ListAlarmRecommendationsResponse]":
        _token = next_token
        while True:
            _response = await self.list_alarm_recommendations(
                assessment_arn,
    ...
    async def iter_list_app_assessment_compliance_drifts(
        self,
        assessment_arn: "capo_resiliencehub.types.arn.Arn",
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_assessment_compliance_drifts_response.ListAppAssessmentComplianceDriftsResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_assessment_compliance_drifts(
                assessment_arn,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def iter_list_app_assessments(
        self,
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        app_arn: Optional["capo_resiliencehub.types.arn.Arn"] = None,
        ...
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_assessments_response.ListAppAssessmentsResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_assessments(
                config_overrides=config_overrides,
                app_arn=app_arn,
    ...
    async def iter_list_app_component_compliances(
        self,
        assessment_arn: "capo_resiliencehub.types.arn.Arn",
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_component_compliances_response.ListAppComponentCompliancesResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_component_compliances(
                assessment_arn,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def iter_list_app_component_recommendations(
        self,
        assessment_arn: "capo_resiliencehub.types.arn.Arn",
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_component_recommendations_response.ListAppComponentRecommendationsResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_component_recommendations(
                assessment_arn,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def iter_list_app_input_sources(
        self,
        app_arn: "capo_resiliencehub.types.arn.Arn",
        app_version: "capo_resiliencehub.types.entity_version.EntityVersion",
        *,
        ...
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_input_sources_response.ListAppInputSourcesResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_input_sources(
                app_arn,
                app_version,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def iter_list_apps(
        ...
        *,
        ...
        aws_application_arn: Optional["capo_resiliencehub.types.arn.Arn"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_apps_response.ListAppsResponse]":
        _token = next_token
        while True:
    ...
    async def iter_list_app_version_app_components(
        self,
        app_arn: "capo_resiliencehub.types.arn.Arn",
        app_version: "capo_resiliencehub.types.entity_version.EntityVersion",
        *,
        ...
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_version_app_components_response.ListAppVersionAppComponentsResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_version_app_components(
                app_arn,
                app_version,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def iter_list_app_version_resource_mappings(
        self,
        app_arn: "capo_resiliencehub.types.arn.Arn",
        app_version: "capo_resiliencehub.types.entity_version.EntityVersion",
        *,
        ...
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_version_resource_mappings_response.ListAppVersionResourceMappingsResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_version_resource_mappings(
                app_arn,
                app_version,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    async def iter_list_app_version_resources(
        self,
        app_arn: "capo_resiliencehub.types.arn.Arn",
        app_version: "capo_resiliencehub.types.entity_version.EntityVersion",
        *,
        ...
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_version_resources_response.ListAppVersionResourcesResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_version_resources(
                app_arn,
                app_version,
                config_overrides=config_overrides,
    ...
    async def iter_list_app_versions(
        self,
        app_arn: "capo_resiliencehub.types.arn.Arn",
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        ...
        start_time: Optional["capo_resiliencehub.types.time_stamp.TimeStamp"] = None,
        end_time: Optional["capo_resiliencehub.types.time_stamp.TimeStamp"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_app_versions_response.ListAppVersionsResponse]":
        _token = next_token
        while True:
            _response = await self.list_app_versions(
                app_arn,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def iter_list_recommendation_templates(
        self,
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        assessment_arn: Optional["capo_resiliencehub.types.arn.Arn"] = None,
        ...
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_recommendation_templates_response.ListRecommendationTemplatesResponse]":
        _token = next_token
        while True:
            _response = await self.list_recommendation_templates(
                config_overrides=config_overrides,
                assessment_arn=assessment_arn,
                reverse_order=reverse_order,
                status=status,
    ...
    async def iter_list_resiliency_policies(
        self,
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        policy_name: Optional["capo_resiliencehub.types.entity_name.EntityName"] = None,
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_resiliency_policies_response.ListResiliencyPoliciesResponse]":
        _token = next_token
        while True:
            _response = await self.list_resiliency_policies(
                config_overrides=config_overrides,
                policy_name=policy_name,
                next_token=_token,
                max_results=max_results,
    ...
    async def iter_list_sop_recommendations(
        self,
        assessment_arn: "capo_resiliencehub.types.arn.Arn",
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_sop_recommendations_response.ListSopRecommendationsResponse]":
        _token = next_token
        while True:
            _response = await self.list_sop_recommendations(
                assessment_arn,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def iter_list_suggested_resiliency_policies(
        self,
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_suggested_resiliency_policies_response.ListSuggestedResiliencyPoliciesResponse]":
        _token = next_token
        while True:
            _response = await self.list_suggested_resiliency_policies(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    async def iter_list_test_recommendations(
        self,
        assessment_arn: "capo_resiliencehub.types.arn.Arn",
        *,
        config_overrides: Optional[AsyncresiliencehubClientConfig] = None,
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_test_recommendations_response.ListTestRecommendationsResponse]":
        _token = next_token
        while True:
            _response = await self.list_test_recommendations(
                assessment_arn,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    async def iter_list_unsupported_app_version_resources(
        self,
        app_arn: "capo_resiliencehub.types.arn.Arn",
        app_version: "capo_resiliencehub.types.entity_version.EntityVersion",
        *,
        ...
        next_token: Optional["capo_resiliencehub.types.next_token.NextToken"] = None,
        max_results: Optional["capo_resiliencehub.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_resiliencehub.types.list_unsupported_app_version_resources_response.ListUnsupportedAppVersionResourcesResponse]":
        _token = next_token
        while True:
            _response = await self.list_unsupported_app_version_resources(
                app_arn,
                app_version,
                config_overrides=config_overrides,
                resolution_id=resolution_id,
