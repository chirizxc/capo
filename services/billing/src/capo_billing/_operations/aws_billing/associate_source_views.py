...
def handle_response(
    ...
    out: capo_billing.types.associate_source_views_response.AssociateSourceViewsResponse = capo_billing.types.associate_source_views_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billing.types.associate_source_views_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
