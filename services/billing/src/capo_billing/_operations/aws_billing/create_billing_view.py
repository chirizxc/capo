...
def handle_response(
    ...
    out: capo_billing.types.create_billing_view_response.CreateBillingViewResponse = (
        capo_billing.types.create_billing_view_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billing.types.create_billing_view_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
