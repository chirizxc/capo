"""Generated from Smithy shape ``com.amazonaws.billing#DeleteBillingView``."""
...
def handle_response(
    ...
    out: capo_billing.types.delete_billing_view_response.DeleteBillingViewResponse = (
        capo_billing.types.delete_billing_view_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBilling.DeleteBillingView"
    body: bytes | None = json.dumps(
        capo_billing.types.delete_billing_view_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_billing_view(
