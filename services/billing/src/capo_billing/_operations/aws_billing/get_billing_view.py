...
def handle_response(
    ...
    out: capo_billing.types.get_billing_view_response.GetBillingViewResponse = (
        capo_billing.types.get_billing_view_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_billing.types.get_billing_view_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_billing_view(
    ...
    capo_billing.types.get_billing_view_response.GetBillingViewResponse, zapros.Response
]:
