"""Generated from Smithy shape ``com.amazonaws.freetier#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.freetier#ResourceNotFoundException``."""
