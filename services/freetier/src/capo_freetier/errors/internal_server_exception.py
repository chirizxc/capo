"""Generated from Smithy shape ``com.amazonaws.freetier#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.freetier#InternalServerException``."""
