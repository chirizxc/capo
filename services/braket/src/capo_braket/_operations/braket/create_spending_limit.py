...
def handle_response(
    ...
    out: capo_braket.types.create_spending_limit_response.CreateSpendingLimitResponse = capo_braket.types.create_spending_limit_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_braket.types.create_spending_limit_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
