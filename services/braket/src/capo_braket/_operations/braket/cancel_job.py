...
def handle_response(
    ...
    out: capo_braket.types.cancel_job_response.CancelJobResponse = (
        capo_braket.types.cancel_job_response.deserialize_json(
...
def cancel_job(
    ...
    input_: capo_braket.types.cancel_job_request.CancelJobRequest,
) -> tuple[capo_braket.types.cancel_job_response.CancelJobResponse, zapros.Response]:
