...
def handle_response(
    ...
    out: capo_braket.types.create_quantum_task_response.CreateQuantumTaskResponse = (
        capo_braket.types.create_quantum_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_braket.types.create_quantum_task_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
