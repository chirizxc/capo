...
def handle_response(
    ...
    out: capo_braket.types.delete_spending_limit_response.DeleteSpendingLimitResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        "{spendingLimitArn}", quote(input_["spending_limit_arn"], safe="")
    )
