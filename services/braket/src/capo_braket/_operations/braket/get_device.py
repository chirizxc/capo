...
def handle_response(
    ...
    out: capo_braket.types.get_device_response.GetDeviceResponse = (
        capo_braket.types.get_device_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{deviceArn}", quote(input_["device_arn"], safe=""))
...
def get_device(
    ...
    input_: capo_braket.types.get_device_request.GetDeviceRequest,
) -> tuple[capo_braket.types.get_device_response.GetDeviceResponse, zapros.Response]:
