"""Generated from Smithy shape ``com.amazonaws.braket#GetQuantumTask``."""
...
def handle_response(
    ...
    out: capo_braket.types.get_quantum_task_response.GetQuantumTaskResponse = (
        capo_braket.types.get_quantum_task_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/quantum-task/{quantumTaskArn}"
    url = url.replace("{quantumTaskArn}", quote(input_["quantum_task_arn"], safe=""))
    params: list[tuple[str, str]] = []
    if "additional_attribute_names" in input_:
        for item in input_["additional_attribute_names"]:
            params.append(("additionalAttributeNames", item))
...
def get_quantum_task(
    ...
    capo_braket.types.get_quantum_task_response.GetQuantumTaskResponse, zapros.Response
]:
...
async def async_get_quantum_task(
