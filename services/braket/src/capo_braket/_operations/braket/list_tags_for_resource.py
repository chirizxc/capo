"""Generated from Smithy shape ``com.amazonaws.braket#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_braket.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_braket.types.list_tags_for_resource_response.deserialize_json(
