...
def handle_response(
    ...
    out: capo_braket.types.get_job_response.GetJobResponse = (
        capo_braket.types.get_job_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_braket.types.get_job_response.GetJobResponse = (
        capo_braket.types.get_job_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_braket.types.get_job_request.GetJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_job(
    options: OperationOptions, input_: capo_braket.types.get_job_request.GetJobRequest
) -> tuple[capo_braket.types.get_job_response.GetJobResponse, zapros.Response]:
