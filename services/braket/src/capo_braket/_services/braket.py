...
from capo_braket._resources.braket.device_resource import DeviceResource
from capo_braket._resources.braket.job_resource import JobResource
from capo_braket._resources.braket.quantum_task_resource import QuantumTaskResource
from capo_braket._resources.braket.spending_limit_resource import SpendingLimitResource
from capo_braket._services._aws_config import aws_config
...
class BraketClientConfig(TypedDict, total=False, closed=True):
...
class BraketClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_braket.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_braket.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_braket._operations.braket.list_tags_for_resource.list_tags_for_resource(
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_braket.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_braket.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_braket._operations.braket.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_braket.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_braket.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_braket._operations.braket.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_search_devices(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_braket.types.device_summary.DeviceSummary]":
        _token = next_token
        while True:
            _response = self.search_devices(
                filters,
    ...
    def iter_search_jobs(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_braket.types.job_summary.JobSummary]":
        _token = next_token
        while True:
    ...
    def iter_search_quantum_tasks(
        ...
        *,
        ...
        next_token: Optional[str] = None,
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_braket.types.quantum_task_summary.QuantumTaskSummary]":
        _token = next_token
        while True:
            _response = self.search_quantum_tasks(
                filters,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def create_spending_limit(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_braket.types.create_spending_limit_request.CreateSpendingLimitRequest]",
        ) -> OperationResponse[
            "capo_braket.types.create_spending_limit_response.CreateSpendingLimitResponse"
        ]:
            ...
            output, http_response = (
                capo_braket._operations.braket.create_spending_limit.create_spending_limit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_spending_limit(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_braket.types.update_spending_limit_request.UpdateSpendingLimitRequest]",
        ) -> OperationResponse[
            "capo_braket.types.update_spending_limit_response.UpdateSpendingLimitResponse"
        ]:
            ...
            output, http_response = (
                capo_braket._operations.braket.update_spending_limit.update_spending_limit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_spending_limit(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_braket.types.delete_spending_limit_request.DeleteSpendingLimitRequest]",
        ) -> OperationResponse[
            "capo_braket.types.delete_spending_limit_response.DeleteSpendingLimitResponse"
        ]:
            ...
            output, http_response = (
                capo_braket._operations.braket.delete_spending_limit.delete_spending_limit(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def search_spending_limits(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_braket.types.search_spending_limits_request.SearchSpendingLimitsRequest]",
        ) -> OperationResponse[
            "capo_braket.types.search_spending_limits_response.SearchSpendingLimitsResponse"
        ]:
            ...
            output, http_response = (
                capo_braket._operations.braket.search_spending_limits.search_spending_limits(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_search_spending_limits(
        self,
        *,
        config_overrides: Optional[BraketClientConfig] = None,
        next_token: Optional[str] = None,
    ...
    ) -> "Iterator[capo_braket.types.spending_limit_summary.SpendingLimitSummary]":
        _token = next_token
        while True:
            _response = self.search_spending_limits(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
                filters=filters,
