...
from capo_marketplace_metering._services._aws_config import aaws_config
...
class AsyncMarketplaceMeteringClientConfig(TypedDict, total=False, closed=True):
...
class AsyncMarketplaceMeteringClient:
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncMarketplaceMeteringClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncMarketplaceMeteringClientConfig = config_overrides or {}
    ...
    async def batch_meter_usage(
        ...
        *,
        config_overrides: Optional[AsyncMarketplaceMeteringClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_marketplace_metering.types.batch_meter_usage_request.BatchMeterUsageRequest]",
        ) -> AsyncOperationResponse[
            "capo_marketplace_metering.types.batch_meter_usage_result.BatchMeterUsageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_marketplace_metering._operations.awsmp_metering_service.batch_meter_usage.async_batch_meter_usage(
    ...
    async def meter_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_marketplace_metering.types.meter_usage_request.MeterUsageRequest]",
        ) -> AsyncOperationResponse[
            "capo_marketplace_metering.types.meter_usage_result.MeterUsageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_marketplace_metering._operations.awsmp_metering_service.meter_usage.async_meter_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def register_usage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_marketplace_metering.types.register_usage_request.RegisterUsageRequest]",
        ) -> AsyncOperationResponse[
            "capo_marketplace_metering.types.register_usage_result.RegisterUsageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_marketplace_metering._operations.awsmp_metering_service.register_usage.async_register_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def resolve_customer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_marketplace_metering.types.resolve_customer_request.ResolveCustomerRequest]",
        ) -> AsyncOperationResponse[
            "capo_marketplace_metering.types.resolve_customer_result.ResolveCustomerResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_marketplace_metering._operations.awsmp_metering_service.resolve_customer.async_resolve_customer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
