...
import capo_marketplace_metering.errors.expired_token_exception
import capo_marketplace_metering.errors.internal_service_error_exception
import capo_marketplace_metering.errors.invalid_token_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ExpiredTokenException":
            raise capo_marketplace_metering.errors.expired_token_exception.ExpiredTokenException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidTokenException":
            raise capo_marketplace_metering.errors.invalid_token_exception.InvalidTokenException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_marketplace_metering.types.resolve_customer_result.ResolveCustomerResult = capo_marketplace_metering.types.resolve_customer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_metering.types.resolve_customer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
