...
class GroupSummary(TypedDict, closed=True):
    group_name: NotRequired["capo_xray.types.string.String"]
    """<p>The unique case-sensitive name of the group.</p>"""
    group_arn: NotRequired["capo_xray.types.string.String"]
    """<p>The ARN of the group generated based on the GroupName.</p>"""
    filter_expression: NotRequired["capo_xray.types.string.String"]
