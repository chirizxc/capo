...
class BackendConnectionErrors(TypedDict, closed=True):
    timeout_count: NotRequired["capo_xray.types.nullable_integer.NullableInteger"]
    """<p></p>"""
    connection_refused_count: NotRequired[
        "capo_xray.types.nullable_integer.NullableInteger"
    ]
    """<p></p>"""
    http_code4_xx_count: NotRequired["capo_xray.types.nullable_integer.NullableInteger"]
    """<p></p>"""
    http_code5_xx_count: NotRequired["capo_xray.types.nullable_integer.NullableInteger"]
    """<p></p>"""
    unknown_host_count: NotRequired["capo_xray.types.nullable_integer.NullableInteger"]
    """<p></p>"""
    other_count: NotRequired["capo_xray.types.nullable_integer.NullableInteger"]
    """<p></p>"""
