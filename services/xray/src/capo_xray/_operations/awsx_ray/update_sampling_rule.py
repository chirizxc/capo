...
def handle_response(
    ...
    out: capo_xray.types.update_sampling_rule_result.UpdateSamplingRuleResult = (
        capo_xray.types.update_sampling_rule_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.update_sampling_rule_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
