...
def handle_response(
    ...
    out: capo_xray.types.delete_resource_policy_result.DeleteResourcePolicyResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.delete_resource_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
