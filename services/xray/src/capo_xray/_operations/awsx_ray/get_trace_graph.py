...
def handle_response(
    ...
    out: capo_xray.types.get_trace_graph_result.GetTraceGraphResult = (
        capo_xray.types.get_trace_graph_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.get_trace_graph_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def get_trace_graph(
    ...
    input_: capo_xray.types.get_trace_graph_request.GetTraceGraphRequest,
) -> tuple[capo_xray.types.get_trace_graph_result.GetTraceGraphResult, zapros.Response]:
