...
def handle_response(
    ...
    out: capo_xray.types.get_service_graph_result.GetServiceGraphResult = (
        capo_xray.types.get_service_graph_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.get_service_graph_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_service_graph(
    ...
    capo_xray.types.get_service_graph_result.GetServiceGraphResult, zapros.Response
]:
