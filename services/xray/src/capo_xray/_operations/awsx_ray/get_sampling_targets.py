...
def handle_response(
    ...
    out: capo_xray.types.get_sampling_targets_result.GetSamplingTargetsResult = (
        capo_xray.types.get_sampling_targets_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.get_sampling_targets_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
