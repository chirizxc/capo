...
def handle_response(
    ...
    out: capo_xray.types.get_indexing_rules_result.GetIndexingRulesResult = (
        capo_xray.types.get_indexing_rules_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.get_indexing_rules_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_indexing_rules(
    ...
    capo_xray.types.get_indexing_rules_result.GetIndexingRulesResult, zapros.Response
]:
