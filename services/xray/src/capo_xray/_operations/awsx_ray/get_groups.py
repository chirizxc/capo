"""Generated from Smithy shape ``com.amazonaws.xray#GetGroups``."""
...
def handle_response(
    ...
    out: capo_xray.types.get_groups_result.GetGroupsResult = (
        capo_xray.types.get_groups_result.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_xray.types.get_groups_result.GetGroupsResult = (
        capo_xray.types.get_groups_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.get_groups_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def get_groups(
    ...
    input_: capo_xray.types.get_groups_request.GetGroupsRequest,
) -> tuple[capo_xray.types.get_groups_result.GetGroupsResult, zapros.Response]:
