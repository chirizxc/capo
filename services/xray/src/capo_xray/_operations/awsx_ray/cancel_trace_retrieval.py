...
def handle_response(
    ...
    out: capo_xray.types.cancel_trace_retrieval_result.CancelTraceRetrievalResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.cancel_trace_retrieval_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
