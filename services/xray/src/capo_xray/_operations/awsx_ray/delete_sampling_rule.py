...
def handle_response(
    ...
    out: capo_xray.types.delete_sampling_rule_result.DeleteSamplingRuleResult = (
        capo_xray.types.delete_sampling_rule_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.delete_sampling_rule_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
