...
def handle_response(
    ...
    out: capo_xray.types.update_group_result.UpdateGroupResult = (
        capo_xray.types.update_group_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_xray.types.update_group_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_group(
    ...
    input_: capo_xray.types.update_group_request.UpdateGroupRequest,
) -> tuple[capo_xray.types.update_group_result.UpdateGroupResult, zapros.Response]:
