...
from capo_kinesis_video_media._services._aws_config import aaws_config
...
class AsyncKinesisVideoMediaClientConfig(TypedDict, total=False, closed=True):
...
class AsyncKinesisVideoMediaClient:
    ...
    async def get_media(
        ...
        *,
        ...
        "AsyncGenerator[capo_kinesis_video_media.types.get_media_output.GetMediaOutput]"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_kinesis_video_media.types.get_media_input.GetMediaInput]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_kinesis_video_media._operations.aws_acuity_inlet_service.get_media.async_get_media(
