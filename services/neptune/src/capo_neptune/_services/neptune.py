...
from capo_neptune._services._aws_config import aws_config
...
class NeptuneClient:
    ...
    def add_role_to_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.add_role_to_db_cluster_message.AddRoleToDBClusterMessage]",
        ) -> OperationResponse[None]:
            import capo_neptune._operations.amazon_rd_sv19.add_role_to_db_cluster

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.add_role_to_db_cluster.add_role_to_db_cluster(
    ...
    def add_source_identifier_to_subscription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.add_source_identifier_to_subscription_message.AddSourceIdentifierToSubscriptionMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.add_source_identifier_to_subscription_result.AddSourceIdentifierToSubscriptionResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.add_source_identifier_to_subscription.add_source_identifier_to_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def add_tags_to_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.add_tags_to_resource_message.AddTagsToResourceMessage]",
        ) -> OperationResponse[None]:
            import capo_neptune._operations.amazon_rd_sv19.add_tags_to_resource

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.add_tags_to_resource.add_tags_to_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def apply_pending_maintenance_action(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.apply_pending_maintenance_action_message.ApplyPendingMaintenanceActionMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.apply_pending_maintenance_action_result.ApplyPendingMaintenanceActionResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.apply_pending_maintenance_action.apply_pending_maintenance_action(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_db_cluster_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.copy_db_cluster_parameter_group_message.CopyDBClusterParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.copy_db_cluster_parameter_group_result.CopyDBClusterParameterGroupResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.copy_db_cluster_parameter_group.copy_db_cluster_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_db_cluster_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.copy_db_cluster_snapshot_message.CopyDBClusterSnapshotMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.copy_db_cluster_snapshot.copy_db_cluster_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def copy_db_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.copy_db_parameter_group_message.CopyDBParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.copy_db_parameter_group_result.CopyDBParameterGroupResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.copy_db_parameter_group.copy_db_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_db_cluster_message.CreateDBClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_db_cluster_result.CreateDBClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_db_cluster.create_db_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_db_cluster_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_db_cluster_endpoint_message.CreateDBClusterEndpointMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_db_cluster_endpoint_output.CreateDBClusterEndpointOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_db_cluster_endpoint.create_db_cluster_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_db_cluster_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_db_cluster_parameter_group_message.CreateDBClusterParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_db_cluster_parameter_group_result.CreateDBClusterParameterGroupResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_db_cluster_parameter_group.create_db_cluster_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_db_cluster_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_db_cluster_snapshot_message.CreateDBClusterSnapshotMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_db_cluster_snapshot_result.CreateDBClusterSnapshotResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_db_cluster_snapshot.create_db_cluster_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_db_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_db_instance_message.CreateDBInstanceMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_db_instance_result.CreateDBInstanceResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_db_instance.create_db_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_db_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_db_parameter_group_message.CreateDBParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_db_parameter_group_result.CreateDBParameterGroupResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_db_parameter_group.create_db_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_db_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_db_subnet_group_message.CreateDBSubnetGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_db_subnet_group_result.CreateDBSubnetGroupResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_db_subnet_group.create_db_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_event_subscription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_event_subscription_message.CreateEventSubscriptionMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_event_subscription_result.CreateEventSubscriptionResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_event_subscription.create_event_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_global_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.create_global_cluster_message.CreateGlobalClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.create_global_cluster_result.CreateGlobalClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.create_global_cluster.create_global_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_db_cluster_message.DeleteDBClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.delete_db_cluster_result.DeleteDBClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_db_cluster.delete_db_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_db_cluster_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_db_cluster_endpoint_message.DeleteDBClusterEndpointMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.delete_db_cluster_endpoint_output.DeleteDBClusterEndpointOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_db_cluster_endpoint.delete_db_cluster_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_db_cluster_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_db_cluster_parameter_group_message.DeleteDBClusterParameterGroupMessage]",
        ) -> OperationResponse[None]:
            import capo_neptune._operations.amazon_rd_sv19.delete_db_cluster_parameter_group

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_db_cluster_parameter_group.delete_db_cluster_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_db_cluster_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_db_cluster_snapshot_message.DeleteDBClusterSnapshotMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.delete_db_cluster_snapshot_result.DeleteDBClusterSnapshotResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_db_cluster_snapshot.delete_db_cluster_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_db_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_db_instance_message.DeleteDBInstanceMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.delete_db_instance_result.DeleteDBInstanceResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_db_instance.delete_db_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_db_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_db_parameter_group_message.DeleteDBParameterGroupMessage]",
        ) -> OperationResponse[None]:
            import capo_neptune._operations.amazon_rd_sv19.delete_db_parameter_group

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_db_parameter_group.delete_db_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_db_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_db_subnet_group_message.DeleteDBSubnetGroupMessage]",
        ) -> OperationResponse[None]:
            import capo_neptune._operations.amazon_rd_sv19.delete_db_subnet_group

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_db_subnet_group.delete_db_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_event_subscription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_event_subscription_message.DeleteEventSubscriptionMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.delete_event_subscription_result.DeleteEventSubscriptionResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_event_subscription.delete_event_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_global_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.delete_global_cluster_message.DeleteGlobalClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.delete_global_cluster_result.DeleteGlobalClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.delete_global_cluster.delete_global_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_db_cluster_endpoints(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_cluster_endpoints_message.DescribeDBClusterEndpointsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_cluster_endpoint_message.DBClusterEndpointMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_cluster_endpoints.describe_db_cluster_endpoints(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_db_cluster_endpoints(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.db_cluster_endpoint.DBClusterEndpoint]":
        _token = marker
        while True:
    ...
    def describe_db_cluster_parameter_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_cluster_parameter_groups_message.DescribeDBClusterParameterGroupsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_cluster_parameter_groups_message.DBClusterParameterGroupsMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_cluster_parameter_groups.describe_db_cluster_parameter_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_db_cluster_parameter_groups(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.db_cluster_parameter_group.DBClusterParameterGroup]":
        _token = marker
        while True:
    ...
    def describe_db_cluster_parameters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_cluster_parameters_message.DescribeDBClusterParametersMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_cluster_parameter_group_details.DBClusterParameterGroupDetails"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_cluster_parameters.describe_db_cluster_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_db_cluster_parameters(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.parameter.Parameter]":
        _token = marker
        while True:
    ...
    def describe_db_clusters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_clusters_message.DescribeDBClustersMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_cluster_message.DBClusterMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_clusters.describe_db_clusters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_db_clusters(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.db_cluster.DBCluster]":
        _token = marker
        while True:
    ...
    def describe_db_cluster_snapshot_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_cluster_snapshot_attributes_message.DescribeDBClusterSnapshotAttributesMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.describe_db_cluster_snapshot_attributes_result.DescribeDBClusterSnapshotAttributesResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_cluster_snapshot_attributes.describe_db_cluster_snapshot_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_db_cluster_snapshots(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_cluster_snapshots_message.DescribeDBClusterSnapshotsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_cluster_snapshot_message.DBClusterSnapshotMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_cluster_snapshots.describe_db_cluster_snapshots(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_db_cluster_snapshots(
        ...
        *,
        ...
        include_shared: Optional["capo_neptune.types.boolean.Boolean"] = None,
        include_public: Optional["capo_neptune.types.boolean.Boolean"] = None,
    ) -> "Iterator[capo_neptune.types.db_cluster_snapshot.DBClusterSnapshot]":
        _token = marker
        while True:
    ...
    def describe_db_engine_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_engine_versions_message.DescribeDBEngineVersionsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_engine_version_message.DBEngineVersionMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_engine_versions.describe_db_engine_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_neptune.types.db_engine_version.DBEngineVersion]":
        _token = marker
        while True:
    ...
    def describe_db_instances(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_instances_message.DescribeDBInstancesMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_instance_message.DBInstanceMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_instances.describe_db_instances(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_db_instances(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.db_instance.DBInstance]":
        _token = marker
        while True:
    ...
    def describe_db_parameter_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_parameter_groups_message.DescribeDBParameterGroupsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_parameter_groups_message.DBParameterGroupsMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_parameter_groups.describe_db_parameter_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_db_parameter_groups(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.db_parameter_group.DBParameterGroup]":
        _token = marker
        while True:
    ...
    def describe_db_parameters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_parameters_message.DescribeDBParametersMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_parameter_group_details.DBParameterGroupDetails"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_parameters.describe_db_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_db_subnet_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_db_subnet_groups_message.DescribeDBSubnetGroupsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_subnet_group_message.DBSubnetGroupMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_db_subnet_groups.describe_db_subnet_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_db_subnet_groups(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.db_subnet_group.DBSubnetGroup]":
        _token = marker
        while True:
    ...
    def describe_engine_default_cluster_parameters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_engine_default_cluster_parameters_message.DescribeEngineDefaultClusterParametersMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.describe_engine_default_cluster_parameters_result.DescribeEngineDefaultClusterParametersResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_engine_default_cluster_parameters.describe_engine_default_cluster_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_engine_default_parameters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_engine_default_parameters_message.DescribeEngineDefaultParametersMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.describe_engine_default_parameters_result.DescribeEngineDefaultParametersResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_engine_default_parameters.describe_engine_default_parameters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_event_categories(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_event_categories_message.DescribeEventCategoriesMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.event_categories_message.EventCategoriesMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_event_categories.describe_event_categories(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_events(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_events_message.DescribeEventsMessage]",
        ) -> OperationResponse["capo_neptune.types.events_message.EventsMessage"]:
            import capo_neptune._operations.amazon_rd_sv19.describe_events

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_events.describe_events(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_events(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.event.Event]":
        _token = marker
        while True:
    ...
    def describe_event_subscriptions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_event_subscriptions_message.DescribeEventSubscriptionsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.event_subscriptions_message.EventSubscriptionsMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_event_subscriptions.describe_event_subscriptions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_event_subscriptions(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.event_subscription.EventSubscription]":
        _token = marker
        while True:
    ...
    def describe_global_clusters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_global_clusters_message.DescribeGlobalClustersMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.global_clusters_message.GlobalClustersMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_global_clusters.describe_global_clusters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_global_clusters(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.global_cluster.GlobalCluster]":
        _token = marker
        while True:
    ...
    def describe_orderable_db_instance_options(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_orderable_db_instance_options_message.DescribeOrderableDBInstanceOptionsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.orderable_db_instance_options_message.OrderableDBInstanceOptionsMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_orderable_db_instance_options.describe_orderable_db_instance_options(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_describe_orderable_db_instance_options(
        ...
        *,
        ...
        marker: Optional["capo_neptune.types.string.String"] = None,
    ) -> "Iterator[capo_neptune.types.orderable_db_instance_option.OrderableDBInstanceOption]":
        _token = marker
        while True:
    ...
    def describe_pending_maintenance_actions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_pending_maintenance_actions_message.DescribePendingMaintenanceActionsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_pending_maintenance_actions.describe_pending_maintenance_actions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_neptune.types.resource_pending_maintenance_actions.ResourcePendingMaintenanceActions]":
        _token = marker
        while True:
    ...
    def describe_valid_db_instance_modifications(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.describe_valid_db_instance_modifications_message.DescribeValidDBInstanceModificationsMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.describe_valid_db_instance_modifications_result.DescribeValidDBInstanceModificationsResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.describe_valid_db_instance_modifications.describe_valid_db_instance_modifications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def failover_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.failover_db_cluster_message.FailoverDBClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.failover_db_cluster_result.FailoverDBClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.failover_db_cluster.failover_db_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def failover_global_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.failover_global_cluster_message.FailoverGlobalClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.failover_global_cluster_result.FailoverGlobalClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.failover_global_cluster.failover_global_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.list_tags_for_resource_message.ListTagsForResourceMessage]",
        ) -> OperationResponse["capo_neptune.types.tag_list_message.TagListMessage"]:
            import capo_neptune._operations.amazon_rd_sv19.list_tags_for_resource

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_db_cluster_message.ModifyDBClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.modify_db_cluster_result.ModifyDBClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_db_cluster.modify_db_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_db_cluster_endpoint(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_db_cluster_endpoint_message.ModifyDBClusterEndpointMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.modify_db_cluster_endpoint_output.ModifyDBClusterEndpointOutput"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_db_cluster_endpoint.modify_db_cluster_endpoint(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_db_cluster_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_db_cluster_parameter_group_message.ModifyDBClusterParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_cluster_parameter_group_name_message.DBClusterParameterGroupNameMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_db_cluster_parameter_group.modify_db_cluster_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_db_cluster_snapshot_attribute(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_db_cluster_snapshot_attribute_message.ModifyDBClusterSnapshotAttributeMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.modify_db_cluster_snapshot_attribute_result.ModifyDBClusterSnapshotAttributeResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_db_cluster_snapshot_attribute.modify_db_cluster_snapshot_attribute(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_db_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_db_instance_message.ModifyDBInstanceMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.modify_db_instance_result.ModifyDBInstanceResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_db_instance.modify_db_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_db_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_db_parameter_group_message.ModifyDBParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_parameter_group_name_message.DBParameterGroupNameMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_db_parameter_group.modify_db_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_db_subnet_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_db_subnet_group_message.ModifyDBSubnetGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.modify_db_subnet_group_result.ModifyDBSubnetGroupResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_db_subnet_group.modify_db_subnet_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_event_subscription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_event_subscription_message.ModifyEventSubscriptionMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.modify_event_subscription_result.ModifyEventSubscriptionResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_event_subscription.modify_event_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_global_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.modify_global_cluster_message.ModifyGlobalClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.modify_global_cluster_result.ModifyGlobalClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.modify_global_cluster.modify_global_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def promote_read_replica_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.promote_read_replica_db_cluster_message.PromoteReadReplicaDBClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.promote_read_replica_db_cluster_result.PromoteReadReplicaDBClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.promote_read_replica_db_cluster.promote_read_replica_db_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reboot_db_instance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.reboot_db_instance_message.RebootDBInstanceMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.reboot_db_instance_result.RebootDBInstanceResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.reboot_db_instance.reboot_db_instance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_from_global_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.remove_from_global_cluster_message.RemoveFromGlobalClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.remove_from_global_cluster_result.RemoveFromGlobalClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.remove_from_global_cluster.remove_from_global_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_role_from_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.remove_role_from_db_cluster_message.RemoveRoleFromDBClusterMessage]",
        ) -> OperationResponse[None]:
            import capo_neptune._operations.amazon_rd_sv19.remove_role_from_db_cluster

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.remove_role_from_db_cluster.remove_role_from_db_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_source_identifier_from_subscription(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.remove_source_identifier_from_subscription_message.RemoveSourceIdentifierFromSubscriptionMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.remove_source_identifier_from_subscription_result.RemoveSourceIdentifierFromSubscriptionResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.remove_source_identifier_from_subscription.remove_source_identifier_from_subscription(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_tags_from_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.remove_tags_from_resource_message.RemoveTagsFromResourceMessage]",
        ) -> OperationResponse[None]:
            import capo_neptune._operations.amazon_rd_sv19.remove_tags_from_resource

            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.remove_tags_from_resource.remove_tags_from_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reset_db_cluster_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.reset_db_cluster_parameter_group_message.ResetDBClusterParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_cluster_parameter_group_name_message.DBClusterParameterGroupNameMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.reset_db_cluster_parameter_group.reset_db_cluster_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def reset_db_parameter_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.reset_db_parameter_group_message.ResetDBParameterGroupMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.db_parameter_group_name_message.DBParameterGroupNameMessage"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.reset_db_parameter_group.reset_db_parameter_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def restore_db_cluster_from_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.restore_db_cluster_from_snapshot_message.RestoreDBClusterFromSnapshotMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.restore_db_cluster_from_snapshot_result.RestoreDBClusterFromSnapshotResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.restore_db_cluster_from_snapshot.restore_db_cluster_from_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def restore_db_cluster_to_point_in_time(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.restore_db_cluster_to_point_in_time_message.RestoreDBClusterToPointInTimeMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.restore_db_cluster_to_point_in_time_result.RestoreDBClusterToPointInTimeResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.restore_db_cluster_to_point_in_time.restore_db_cluster_to_point_in_time(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.start_db_cluster_message.StartDBClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.start_db_cluster_result.StartDBClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.start_db_cluster.start_db_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_db_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.stop_db_cluster_message.StopDBClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.stop_db_cluster_result.StopDBClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.stop_db_cluster.stop_db_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def switchover_global_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_neptune.types.switchover_global_cluster_message.SwitchoverGlobalClusterMessage]",
        ) -> OperationResponse[
            "capo_neptune.types.switchover_global_cluster_result.SwitchoverGlobalClusterResult"
        ]:
            ...
            output, http_response = (
                capo_neptune._operations.amazon_rd_sv19.switchover_global_cluster.switchover_global_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
