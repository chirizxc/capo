"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeEventSubscriptions``."""
...
def handle_response(
    ...
    out: capo_neptune.types.event_subscriptions_message.EventSubscriptionsMessage = (
        capo_neptune.types.event_subscriptions_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_event_subscriptions_message.serialize_query(
        input_, pairs, ""
    )
