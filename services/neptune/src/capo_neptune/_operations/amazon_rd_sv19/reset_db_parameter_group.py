"""Generated from Smithy shape ``com.amazonaws.neptune#ResetDBParameterGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ResetDBParameterGroupResult")
    out: capo_neptune.types.db_parameter_group_name_message.DBParameterGroupNameMessage = capo_neptune.types.db_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ResetDBParameterGroup"))
    pairs.append(("Version", "2014-10-31"))
    capo_neptune.types.reset_db_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_reset_db_parameter_group(
