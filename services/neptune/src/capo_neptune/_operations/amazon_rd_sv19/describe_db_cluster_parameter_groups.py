"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBClusterParameterGroups``."""
...
def handle_response(
    ...
    out: capo_neptune.types.db_cluster_parameter_groups_message.DBClusterParameterGroupsMessage = capo_neptune.types.db_cluster_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_cluster_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
