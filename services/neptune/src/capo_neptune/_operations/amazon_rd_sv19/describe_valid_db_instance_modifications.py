"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeValidDBInstanceModifications``."""
...
import capo_neptune.types.valid_db_instance_modifications_message
...
def handle_response(
    ...
    out: capo_neptune.types.describe_valid_db_instance_modifications_result.DescribeValidDBInstanceModificationsResult = capo_neptune.types.describe_valid_db_instance_modifications_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_valid_db_instance_modifications_message.serialize_query(
        input_, pairs, ""
    )
