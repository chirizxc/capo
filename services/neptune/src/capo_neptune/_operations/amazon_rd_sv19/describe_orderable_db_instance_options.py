"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeOrderableDBInstanceOptions``."""
...
def handle_response(
    ...
    out: capo_neptune.types.orderable_db_instance_options_message.OrderableDBInstanceOptionsMessage = capo_neptune.types.orderable_db_instance_options_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_orderable_db_instance_options_message.serialize_query(
        input_, pairs, ""
    )
