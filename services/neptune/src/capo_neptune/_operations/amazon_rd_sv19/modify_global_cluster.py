"""Generated from Smithy shape ``com.amazonaws.neptune#ModifyGlobalCluster``."""
...
def handle_response(
    ...
    out: capo_neptune.types.modify_global_cluster_result.ModifyGlobalClusterResult = (
        capo_neptune.types.modify_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.modify_global_cluster_message.serialize_query(input_, pairs, "")
