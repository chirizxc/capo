...
import capo_neptune.errors.db_cluster_role_already_exists_fault
import capo_neptune.errors.db_cluster_role_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBClusterRoleAlreadyExists":
            raise capo_neptune.errors.db_cluster_role_already_exists_fault.DBClusterRoleAlreadyExistsFault.from_query(
                error_el, message
            )
        case "DBClusterRoleQuotaExceeded":
            raise capo_neptune.errors.db_cluster_role_quota_exceeded_fault.DBClusterRoleQuotaExceededFault.from_query(
                error_el, message
            )
...
def build_request(
    ...
    capo_neptune.types.add_role_to_db_cluster_message.serialize_query(input_, pairs, "")
