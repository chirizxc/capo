...
def handle_response(
    ...
    out: capo_neptune.types.describe_engine_default_parameters_result.DescribeEngineDefaultParametersResult = capo_neptune.types.describe_engine_default_parameters_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_engine_default_parameters_message.serialize_query(
        input_, pairs, ""
    )
