...
def handle_response(
    ...
    out: capo_neptune.types.global_clusters_message.GlobalClustersMessage = (
        capo_neptune.types.global_clusters_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_global_clusters_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_global_clusters(
    ...
    capo_neptune.types.global_clusters_message.GlobalClustersMessage, zapros.Response
]:
