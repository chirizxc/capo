"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBClusterParameters``."""
...
def handle_response(
    ...
    out: capo_neptune.types.db_cluster_parameter_group_details.DBClusterParameterGroupDetails = capo_neptune.types.db_cluster_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
