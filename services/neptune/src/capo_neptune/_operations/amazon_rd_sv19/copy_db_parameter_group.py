...
def handle_response(
    ...
    out: capo_neptune.types.copy_db_parameter_group_result.CopyDBParameterGroupResult = capo_neptune.types.copy_db_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.copy_db_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
