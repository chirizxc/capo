...
def handle_response(
    ...
    out: capo_neptune.types.promote_read_replica_db_cluster_result.PromoteReadReplicaDBClusterResult = capo_neptune.types.promote_read_replica_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.promote_read_replica_db_cluster_message.serialize_query(
        input_, pairs, ""
    )
