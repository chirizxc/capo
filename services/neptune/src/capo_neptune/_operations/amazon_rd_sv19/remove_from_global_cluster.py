...
def handle_response(
    ...
    out: capo_neptune.types.remove_from_global_cluster_result.RemoveFromGlobalClusterResult = capo_neptune.types.remove_from_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.remove_from_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
