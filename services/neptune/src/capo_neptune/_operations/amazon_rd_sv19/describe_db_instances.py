...
def handle_response(
    ...
    out: capo_neptune.types.db_instance_message.DBInstanceMessage = (
        capo_neptune.types.db_instance_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_instances_message.serialize_query(input_, pairs, "")
...
def describe_db_instances(
    ...
    input_: capo_neptune.types.describe_db_instances_message.DescribeDBInstancesMessage,
) -> tuple[capo_neptune.types.db_instance_message.DBInstanceMessage, zapros.Response]:
