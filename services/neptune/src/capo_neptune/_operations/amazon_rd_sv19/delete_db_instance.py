"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBInstance``."""
...
import capo_neptune.errors.db_snapshot_already_exists_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DBSnapshotAlreadyExists":
            raise capo_neptune.errors.db_snapshot_already_exists_fault.DBSnapshotAlreadyExistsFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_neptune.types.delete_db_instance_result.DeleteDBInstanceResult = (
        capo_neptune.types.delete_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.delete_db_instance_message.serialize_query(input_, pairs, "")
...
def delete_db_instance(
    ...
    capo_neptune.types.delete_db_instance_result.DeleteDBInstanceResult, zapros.Response
]:
