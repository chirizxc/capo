"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBSubnetGroup``."""
...
import capo_neptune.errors.invalid_db_subnet_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDBSubnetStateFault":
            raise capo_neptune.errors.invalid_db_subnet_state_fault.InvalidDBSubnetStateFault.from_query(
                error_el, message
            )
        case _:
...
def build_request(
    ...
    capo_neptune.types.delete_db_subnet_group_message.serialize_query(input_, pairs, "")
