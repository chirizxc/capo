"""Generated from Smithy shape ``com.amazonaws.neptune#ModifyDBClusterParameterGroup``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ModifyDBClusterParameterGroupResult")
    out: capo_neptune.types.db_cluster_parameter_group_name_message.DBClusterParameterGroupNameMessage = capo_neptune.types.db_cluster_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.modify_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_modify_db_cluster_parameter_group(
