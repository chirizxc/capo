...
import capo_neptune.errors.subscription_already_exist_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubscriptionAlreadyExist":
            raise capo_neptune.errors.subscription_already_exist_fault.SubscriptionAlreadyExistFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_neptune.types.create_event_subscription_result.CreateEventSubscriptionResult = capo_neptune.types.create_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.create_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
