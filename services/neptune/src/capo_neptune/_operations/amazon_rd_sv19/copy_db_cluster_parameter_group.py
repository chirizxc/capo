"""Generated from Smithy shape ``com.amazonaws.neptune#CopyDBClusterParameterGroup``."""
...
def handle_response(
    ...
    out: capo_neptune.types.copy_db_cluster_parameter_group_result.CopyDBClusterParameterGroupResult = capo_neptune.types.copy_db_cluster_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.copy_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
