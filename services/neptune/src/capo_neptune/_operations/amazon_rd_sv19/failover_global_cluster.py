"""Generated from Smithy shape ``com.amazonaws.neptune#FailoverGlobalCluster``."""
...
def handle_response(
    ...
    out: capo_neptune.types.failover_global_cluster_result.FailoverGlobalClusterResult = capo_neptune.types.failover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.failover_global_cluster_message.serialize_query(
        input_, pairs, ""
    )
