"""Generated from Smithy shape ``com.amazonaws.neptune#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_neptune.types.tag_list_message.TagListMessage = (
        capo_neptune.types.tag_list_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.list_tags_for_resource_message.serialize_query(input_, pairs, "")
...
def list_tags_for_resource(
    ...
    input_: capo_neptune.types.list_tags_for_resource_message.ListTagsForResourceMessage,
) -> tuple[capo_neptune.types.tag_list_message.TagListMessage, zapros.Response]:
