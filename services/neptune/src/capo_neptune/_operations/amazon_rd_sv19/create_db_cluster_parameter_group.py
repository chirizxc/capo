"""Generated from Smithy shape ``com.amazonaws.neptune#CreateDBClusterParameterGroup``."""
...
def handle_response(
    ...
    out: capo_neptune.types.create_db_cluster_parameter_group_result.CreateDBClusterParameterGroupResult = capo_neptune.types.create_db_cluster_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.create_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
