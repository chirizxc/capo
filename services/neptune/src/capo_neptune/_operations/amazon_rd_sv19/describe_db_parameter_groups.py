"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBParameterGroups``."""
...
def handle_response(
    ...
    out: capo_neptune.types.db_parameter_groups_message.DBParameterGroupsMessage = (
        capo_neptune.types.db_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
