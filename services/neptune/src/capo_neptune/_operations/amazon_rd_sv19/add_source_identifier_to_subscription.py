"""Generated from Smithy shape ``com.amazonaws.neptune#AddSourceIdentifierToSubscription``."""
...
def handle_response(
    ...
    out: capo_neptune.types.add_source_identifier_to_subscription_result.AddSourceIdentifierToSubscriptionResult = capo_neptune.types.add_source_identifier_to_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.add_source_identifier_to_subscription_message.serialize_query(
        input_, pairs, ""
    )
