...
import capo_neptune.errors.instance_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InstanceQuotaExceeded":
            raise capo_neptune.errors.instance_quota_exceeded_fault.InstanceQuotaExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_neptune.types.create_db_instance_result.CreateDBInstanceResult = (
        capo_neptune.types.create_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.create_db_instance_message.serialize_query(input_, pairs, "")
...
def create_db_instance(
    ...
    capo_neptune.types.create_db_instance_result.CreateDBInstanceResult, zapros.Response
]:
