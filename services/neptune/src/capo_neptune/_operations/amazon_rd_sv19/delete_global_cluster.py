...
def handle_response(
    ...
    out: capo_neptune.types.delete_global_cluster_result.DeleteGlobalClusterResult = (
        capo_neptune.types.delete_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.delete_global_cluster_message.serialize_query(input_, pairs, "")
