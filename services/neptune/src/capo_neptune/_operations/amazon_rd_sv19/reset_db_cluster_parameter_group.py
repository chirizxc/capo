"""Generated from Smithy shape ``com.amazonaws.neptune#ResetDBClusterParameterGroup``."""
...
def build_request(
    ...
    capo_neptune.types.reset_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
