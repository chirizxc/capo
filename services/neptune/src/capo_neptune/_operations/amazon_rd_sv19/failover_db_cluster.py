"""Generated from Smithy shape ``com.amazonaws.neptune#FailoverDBCluster``."""
...
def handle_response(
    ...
    out: capo_neptune.types.failover_db_cluster_result.FailoverDBClusterResult = (
        capo_neptune.types.failover_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.failover_db_cluster_message.serialize_query(input_, pairs, "")
