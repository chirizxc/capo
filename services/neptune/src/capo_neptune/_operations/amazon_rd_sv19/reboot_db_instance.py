...
def handle_response(
    ...
    out: capo_neptune.types.reboot_db_instance_result.RebootDBInstanceResult = (
        capo_neptune.types.reboot_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.reboot_db_instance_message.serialize_query(input_, pairs, "")
...
def reboot_db_instance(
    ...
    capo_neptune.types.reboot_db_instance_result.RebootDBInstanceResult, zapros.Response
]:
