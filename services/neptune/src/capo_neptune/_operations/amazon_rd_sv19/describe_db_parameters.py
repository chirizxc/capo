"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBParameters``."""
...
def handle_response(
    ...
    out: capo_neptune.types.db_parameter_group_details.DBParameterGroupDetails = (
        capo_neptune.types.db_parameter_group_details.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_parameters_message.serialize_query(input_, pairs, "")
