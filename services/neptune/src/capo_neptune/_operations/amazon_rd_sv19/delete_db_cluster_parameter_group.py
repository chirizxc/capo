"""Generated from Smithy shape ``com.amazonaws.neptune#DeleteDBClusterParameterGroup``."""
...
def build_request(
    ...
    capo_neptune.types.delete_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
