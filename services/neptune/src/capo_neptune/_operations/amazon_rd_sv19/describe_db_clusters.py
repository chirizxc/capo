"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBClusters``."""
...
def handle_response(
    ...
    out: capo_neptune.types.db_cluster_message.DBClusterMessage = (
        capo_neptune.types.db_cluster_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_clusters_message.serialize_query(input_, pairs, "")
...
def describe_db_clusters(
    ...
    input_: capo_neptune.types.describe_db_clusters_message.DescribeDBClustersMessage,
) -> tuple[capo_neptune.types.db_cluster_message.DBClusterMessage, zapros.Response]:
