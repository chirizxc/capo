...
def handle_response(
    ...
    out: capo_neptune.types.start_db_cluster_result.StartDBClusterResult = (
        capo_neptune.types.start_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.start_db_cluster_message.serialize_query(input_, pairs, "")
...
def start_db_cluster(
    ...
    capo_neptune.types.start_db_cluster_result.StartDBClusterResult, zapros.Response
]:
