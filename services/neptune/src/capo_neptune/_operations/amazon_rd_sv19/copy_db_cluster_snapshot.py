"""Generated from Smithy shape ``com.amazonaws.neptune#CopyDBClusterSnapshot``."""
...
def handle_response(
    ...
    out: capo_neptune.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult = capo_neptune.types.copy_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.copy_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
