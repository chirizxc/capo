"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeEngineDefaultClusterParameters``."""
...
def handle_response(
    ...
    out: capo_neptune.types.describe_engine_default_cluster_parameters_result.DescribeEngineDefaultClusterParametersResult = capo_neptune.types.describe_engine_default_cluster_parameters_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_engine_default_cluster_parameters_message.serialize_query(
        input_, pairs, ""
    )
