"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeDBClusterSnapshots``."""
...
def handle_response(
    ...
    out: capo_neptune.types.db_cluster_snapshot_message.DBClusterSnapshotMessage = (
        capo_neptune.types.db_cluster_snapshot_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_cluster_snapshots_message.serialize_query(
        input_, pairs, ""
    )
