"""Generated from Smithy shape ``com.amazonaws.neptune#ModifyDBSubnetGroup``."""
...
import capo_neptune.errors.subnet_already_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetAlreadyInUse":
            raise capo_neptune.errors.subnet_already_in_use.SubnetAlreadyInUse.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_neptune.types.modify_db_subnet_group_result.ModifyDBSubnetGroupResult = (
        capo_neptune.types.modify_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.modify_db_subnet_group_message.serialize_query(input_, pairs, "")
