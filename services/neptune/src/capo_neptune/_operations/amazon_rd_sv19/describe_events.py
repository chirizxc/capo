"""Generated from Smithy shape ``com.amazonaws.neptune#DescribeEvents``."""
...
def handle_response(
    ...
    out: capo_neptune.types.events_message.EventsMessage = (
        capo_neptune.types.events_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_events_message.serialize_query(input_, pairs, "")
...
def describe_events(
    ...
    input_: capo_neptune.types.describe_events_message.DescribeEventsMessage,
) -> tuple[capo_neptune.types.events_message.EventsMessage, zapros.Response]:
