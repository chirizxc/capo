...
def handle_response(
    ...
    out: capo_neptune.types.db_subnet_group_message.DBSubnetGroupMessage = (
        capo_neptune.types.db_subnet_group_message.deserialize_query(
...
def build_request(
    ...
    capo_neptune.types.describe_db_subnet_groups_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_db_subnet_groups(
    ...
    capo_neptune.types.db_subnet_group_message.DBSubnetGroupMessage, zapros.Response
]:
