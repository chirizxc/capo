"""Generated from Smithy shape ``com.amazonaws.neptune#DBClusterQuotaExceededFault``."""
...
class DBClusterQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#DBClusterQuotaExceededFault``."""
