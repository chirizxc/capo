"""Generated from Smithy shape ``com.amazonaws.neptune#OptionGroupNotFoundFault``."""
...
class OptionGroupNotFoundFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#OptionGroupNotFoundFault``."""

    code: str | None = "OptionGroupNotFoundFault"

    def __init__(self, data: OptionGroupNotFoundFault_, message: str | None = None):
        super().__init__(
            "client",
