"""Generated from Smithy shape ``com.amazonaws.neptune#DBInstanceAlreadyExistsFault``."""
...
class DBInstanceAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#DBInstanceAlreadyExistsFault``."""
