"""Generated from Smithy shape ``com.amazonaws.neptune#InvalidDBSnapshotStateFault``."""
...
class InvalidDBSnapshotStateFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.neptune#InvalidDBSnapshotStateFault``."""
