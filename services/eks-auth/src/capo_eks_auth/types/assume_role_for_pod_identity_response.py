...
class AssumeRoleForPodIdentityResponse(TypedDict, closed=True):
    subject: "capo_eks_auth.types.subject.Subject"
    ...
    pod_identity_association: (
        "capo_eks_auth.types.pod_identity_association.PodIdentityAssociation"
    )
    """<p>The Amazon Resource Name (ARN) and ID of the EKS Pod Identity association.</p>"""
    assumed_role_user: "capo_eks_auth.types.assumed_role_user.AssumedRoleUser"
    ...
    credentials: "capo_eks_auth.types.credentials.Credentials"
...
def serialize_json(value: AssumeRoleForPodIdentityResponse) -> dict:
    ...
    out["subject"] = capo_eks_auth.types.subject.serialize_json(value["subject"])
    out["audience"] = value["audience"]
    import capo_eks_auth.types.pod_identity_association

    out["podIdentityAssociation"] = (
        capo_eks_auth.types.pod_identity_association.serialize_json(
            value["pod_identity_association"]
        )
    )
    import capo_eks_auth.types.assumed_role_user

    out["assumedRoleUser"] = capo_eks_auth.types.assumed_role_user.serialize_json(
        value["assumed_role_user"]
    )
    import capo_eks_auth.types.credentials

    out["credentials"] = capo_eks_auth.types.credentials.serialize_json(
        value["credentials"]
    )
    return out
...
def deserialize_json(data: dict) -> AssumeRoleForPodIdentityResponse:
    ...
    if data.get("podIdentityAssociation") is not None:
        ...
        out["pod_identity_association"] = (
            capo_eks_auth.types.pod_identity_association.deserialize_json(
    ...
    if data.get("assumedRoleUser") is not None:
        ...
        out["assumed_role_user"] = (
            capo_eks_auth.types.assumed_role_user.deserialize_json(
