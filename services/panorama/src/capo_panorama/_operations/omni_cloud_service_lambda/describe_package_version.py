"""Generated from Smithy shape ``com.amazonaws.panorama#DescribePackageVersion``."""
...
def handle_response(
    ...
    out: capo_panorama.types.describe_package_version_response.DescribePackageVersionResponse = capo_panorama.types.describe_package_version_response.deserialize_json(
...
def build_request(
    ...
    if "owner_account" in input_:
        params.append(("OwnerAccount", input_["owner_account"]))
    if "patch_version" in input_:
        params.append(("PatchVersion", input_["patch_version"]))
