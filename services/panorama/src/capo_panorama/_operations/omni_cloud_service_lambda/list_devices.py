...
def build_request(
    ...
    if "sort_by" in input_:
        params.append(("SortBy", input_["sort_by"]))
    if "sort_order" in input_:
        params.append(("SortOrder", input_["sort_order"]))
    if "name_filter" in input_:
        params.append(("NameFilter", input_["name_filter"]))
    if "device_aggregated_status_filter" in input_:
        params.append(
            ("DeviceAggregatedStatusFilter", input_["device_aggregated_status_filter"])
        )
