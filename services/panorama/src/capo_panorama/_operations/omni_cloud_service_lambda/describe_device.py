"""Generated from Smithy shape ``com.amazonaws.panorama#DescribeDevice``."""
...
def handle_response(
    ...
    out: capo_panorama.types.describe_device_response.DescribeDeviceResponse = (
        capo_panorama.types.describe_device_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{DeviceId}", quote(input_["device_id"], safe=""))
...
def describe_device(
    ...
    capo_panorama.types.describe_device_response.DescribeDeviceResponse, zapros.Response
]:
