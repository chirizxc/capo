"""Generated from Smithy shape ``com.amazonaws.panorama#ListApplicationInstanceDependencies``."""
...
def handle_response(
    ...
    out: capo_panorama.types.list_application_instance_dependencies_response.ListApplicationInstanceDependenciesResponse = capo_panorama.types.list_application_instance_dependencies_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ApplicationInstanceId}", quote(input_["application_instance_id"], safe="")
    )
...
async def async_list_application_instance_dependencies(
