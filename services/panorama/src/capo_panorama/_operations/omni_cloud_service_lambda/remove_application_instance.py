"""Generated from Smithy shape ``com.amazonaws.panorama#RemoveApplicationInstance``."""
...
def handle_response(
    ...
    out: capo_panorama.types.remove_application_instance_response.RemoveApplicationInstanceResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_remove_application_instance(
