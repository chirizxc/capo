...
def handle_response(
    ...
    out: capo_panorama.types.list_application_instances_response.ListApplicationInstancesResponse = capo_panorama.types.list_application_instances_response.deserialize_json(
...
def build_request(
    ...
    if "status_filter" in input_:
        params.append(("statusFilter", input_["status_filter"]))
