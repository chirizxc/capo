...
def handle_response(
    ...
    out: capo_panorama.types.create_job_for_devices_response.CreateJobForDevicesResponse = capo_panorama.types.create_job_for_devices_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_panorama.types.create_job_for_devices_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
