...
def handle_response(
    ...
    out: capo_panorama.types.list_application_instance_node_instances_response.ListApplicationInstanceNodeInstancesResponse = capo_panorama.types.list_application_instance_node_instances_response.deserialize_json(
