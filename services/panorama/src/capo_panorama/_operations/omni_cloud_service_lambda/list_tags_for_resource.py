...
def handle_response(
    ...
    out: capo_panorama.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_panorama.types.list_tags_for_resource_response.deserialize_json(
