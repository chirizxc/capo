...
def handle_response(
    ...
    out: capo_panorama.types.create_package_import_job_response.CreatePackageImportJobResponse = capo_panorama.types.create_package_import_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_panorama.types.create_package_import_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
