"""Generated from Smithy shape ``com.amazonaws.panorama#ListNodeFromTemplateJobs``."""
...
def handle_response(
    ...
    out: capo_panorama.types.list_node_from_template_jobs_response.ListNodeFromTemplateJobsResponse = capo_panorama.types.list_node_from_template_jobs_response.deserialize_json(
...
async def async_list_node_from_template_jobs(
