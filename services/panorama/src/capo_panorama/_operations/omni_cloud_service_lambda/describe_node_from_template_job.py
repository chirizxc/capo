...
def handle_response(
    ...
    out: capo_panorama.types.describe_node_from_template_job_response.DescribeNodeFromTemplateJobResponse = capo_panorama.types.describe_node_from_template_job_response.deserialize_json(
