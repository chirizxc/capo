"""Generated from Smithy shape ``com.amazonaws.panorama#CreatePackage``."""
...
def handle_response(
    ...
    out: capo_panorama.types.create_package_response.CreatePackageResponse = (
        capo_panorama.types.create_package_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_panorama.types.create_package_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_package(
    ...
    capo_panorama.types.create_package_response.CreatePackageResponse, zapros.Response
]:
