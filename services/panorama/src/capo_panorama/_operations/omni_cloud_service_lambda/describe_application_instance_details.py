"""Generated from Smithy shape ``com.amazonaws.panorama#DescribeApplicationInstanceDetails``."""
...
def handle_response(
    ...
    out: capo_panorama.types.describe_application_instance_details_response.DescribeApplicationInstanceDetailsResponse = capo_panorama.types.describe_application_instance_details_response.deserialize_json(
...
async def async_describe_application_instance_details(
