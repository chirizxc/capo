"""Generated from Smithy shape ``com.amazonaws.panorama#ListPackages``."""
...
def handle_response(
    ...
    out: capo_panorama.types.list_packages_response.ListPackagesResponse = (
        capo_panorama.types.list_packages_response.deserialize_json(
...
def list_packages(
    ...
    capo_panorama.types.list_packages_response.ListPackagesResponse, zapros.Response
]:
