...
class CountsSummary(TypedDict, closed=True):
    components: NotRequired[
        "capo_proton.types.resource_counts_summary.ResourceCountsSummary"
    ]
...
def serialize_aws_json_1_0(value: CountsSummary) -> dict:
    ...
    if "components" in value:
        ...
        out["components"] = (
            capo_proton.types.resource_counts_summary.serialize_aws_json_1_0(
                value["components"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> CountsSummary:
    ...
    if data.get("components") is not None:
        ...
        out["components"] = (
            capo_proton.types.resource_counts_summary.deserialize_aws_json_1_0(
                data["components"]
            )
        )
