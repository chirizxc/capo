...
class GetServiceSyncBlockerSummaryOutput(TypedDict, closed=True):
    service_sync_blocker_summary: NotRequired[
        "capo_proton.types.service_sync_blocker_summary.ServiceSyncBlockerSummary"
    ]
...
def serialize_aws_json_1_0(value: GetServiceSyncBlockerSummaryOutput) -> dict:
    ...
    if "service_sync_blocker_summary" in value:
        ...
        out["serviceSyncBlockerSummary"] = (
            capo_proton.types.service_sync_blocker_summary.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetServiceSyncBlockerSummaryOutput:
    ...
    if data.get("serviceSyncBlockerSummary") is not None:
        import capo_proton.types.service_sync_blocker_summary

        out["service_sync_blocker_summary"] = (
            capo_proton.types.service_sync_blocker_summary.deserialize_aws_json_1_0(
