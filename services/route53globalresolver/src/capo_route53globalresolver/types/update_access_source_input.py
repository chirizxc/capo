...
class UpdateAccessSourceInput(TypedDict, closed=True):
    ...
    cidr: NotRequired["capo_route53globalresolver.types.cidr.Cidr"]
    ...
    protocol: NotRequired["capo_route53globalresolver.types.dns_protocol.DnsProtocol"]
