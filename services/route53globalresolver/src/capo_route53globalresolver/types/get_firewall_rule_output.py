"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#GetFirewallRuleOutput``."""
...
class GetFirewallRuleOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetFirewallRuleOutput) -> dict:
    out: dict = {}
    import capo_route53globalresolver.types.firewall_rule_action
...
def deserialize_json(data: dict) -> GetFirewallRuleOutput:
    out: GetFirewallRuleOutput = {}  # type: ignore[typeddict-item]
    if data.get("action") is not None:
        ...
        raise DeserializationError("GetFirewallRuleOutput.action required")
    ...
    if data.get("createdAt") is not None:
        ...
        raise DeserializationError("GetFirewallRuleOutput.created_at required")
    ...
    if data.get("id") is not None:
        ...
        raise DeserializationError("GetFirewallRuleOutput.id required")
    if data.get("name") is not None:
        out["name"] = data["name"]
    else:
        raise DeserializationError("GetFirewallRuleOutput.name required")
    if data.get("priority") is not None:
        out["priority"] = data["priority"]
    else:
        raise DeserializationError("GetFirewallRuleOutput.priority required")
    if data.get("dnsViewId") is not None:
        out["dns_view_id"] = data["dnsViewId"]
    else:
        raise DeserializationError("GetFirewallRuleOutput.dns_view_id required")
    ...
    if data.get("status") is not None:
        ...
        raise DeserializationError("GetFirewallRuleOutput.status required")
    if data.get("updatedAt") is not None:
        ...
        raise DeserializationError("GetFirewallRuleOutput.updated_at required")
    return out
