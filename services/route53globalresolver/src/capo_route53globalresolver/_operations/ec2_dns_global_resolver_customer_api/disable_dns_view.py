...
def handle_response(
    ...
    out: capo_route53globalresolver.types.disable_dns_view_output.DisableDNSViewOutput = capo_route53globalresolver.types.disable_dns_view_output.deserialize_json(
