...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_firewall_domain_lists_output.ListFirewallDomainListsOutput = capo_route53globalresolver.types.list_firewall_domain_lists_output.deserialize_json(
...
def build_request(
    ...
    if "global_resolver_id" in input_:
        params.append(("global_resolver_id", input_["global_resolver_id"]))
