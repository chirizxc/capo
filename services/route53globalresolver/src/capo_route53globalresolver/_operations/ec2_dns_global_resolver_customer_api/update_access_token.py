...
def handle_response(
    ...
    out: capo_route53globalresolver.types.update_access_token_output.UpdateAccessTokenOutput = capo_route53globalresolver.types.update_access_token_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.update_access_token_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
