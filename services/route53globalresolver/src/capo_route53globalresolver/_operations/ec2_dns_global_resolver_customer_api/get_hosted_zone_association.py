...
def handle_response(
    ...
    out: capo_route53globalresolver.types.get_hosted_zone_association_output.GetHostedZoneAssociationOutput = capo_route53globalresolver.types.get_hosted_zone_association_output.deserialize_json(
