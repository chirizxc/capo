"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListAccessSources``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_access_sources_output.ListAccessSourcesOutput = capo_route53globalresolver.types.list_access_sources_output.deserialize_json(
...
async def async_list_access_sources(
