...
def handle_response(
    ...
    out: capo_route53globalresolver.types.disassociate_hosted_zone_output.DisassociateHostedZoneOutput = capo_route53globalresolver.types.disassociate_hosted_zone_output.deserialize_json(
