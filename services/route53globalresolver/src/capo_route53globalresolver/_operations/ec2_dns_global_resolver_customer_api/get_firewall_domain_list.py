"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#GetFirewallDomainList``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.get_firewall_domain_list_output.GetFirewallDomainListOutput = capo_route53globalresolver.types.get_firewall_domain_list_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{firewallDomainListId}", quote(input_["firewall_domain_list_id"], safe="")
    )
