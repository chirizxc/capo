...
def handle_response(
    ...
    out: capo_route53globalresolver.types.delete_global_resolver_output.DeleteGlobalResolverOutput = capo_route53globalresolver.types.delete_global_resolver_output.deserialize_json(
