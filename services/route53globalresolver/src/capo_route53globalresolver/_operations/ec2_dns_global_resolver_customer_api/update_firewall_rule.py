...
def handle_response(
    ...
    out: capo_route53globalresolver.types.update_firewall_rule_output.UpdateFirewallRuleOutput = capo_route53globalresolver.types.update_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.update_firewall_rule_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
