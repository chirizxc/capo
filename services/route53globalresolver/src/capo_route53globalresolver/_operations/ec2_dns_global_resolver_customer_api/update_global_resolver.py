...
def handle_response(
    ...
    out: capo_route53globalresolver.types.update_global_resolver_output.UpdateGlobalResolverOutput = capo_route53globalresolver.types.update_global_resolver_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.update_global_resolver_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
