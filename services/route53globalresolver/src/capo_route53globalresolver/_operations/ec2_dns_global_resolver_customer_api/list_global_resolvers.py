"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#ListGlobalResolvers``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_global_resolvers_output.ListGlobalResolversOutput = capo_route53globalresolver.types.list_global_resolvers_output.deserialize_json(
...
async def async_list_global_resolvers(
