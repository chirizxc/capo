"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#GetFirewallRule``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.get_firewall_rule_output.GetFirewallRuleOutput = capo_route53globalresolver.types.get_firewall_rule_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{firewallRuleId}", quote(input_["firewall_rule_id"], safe=""))
...
async def async_get_firewall_rule(
