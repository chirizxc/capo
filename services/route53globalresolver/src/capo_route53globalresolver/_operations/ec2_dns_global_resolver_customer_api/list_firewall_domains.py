...
def handle_response(
    ...
    out: capo_route53globalresolver.types.list_firewall_domains_output.ListFirewallDomainsOutput = capo_route53globalresolver.types.list_firewall_domains_output.deserialize_json(
