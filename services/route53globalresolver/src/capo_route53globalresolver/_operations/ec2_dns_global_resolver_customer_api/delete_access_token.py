"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#DeleteAccessToken``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.delete_access_token_output.DeleteAccessTokenOutput = capo_route53globalresolver.types.delete_access_token_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{accessTokenId}", quote(input_["access_token_id"], safe=""))
