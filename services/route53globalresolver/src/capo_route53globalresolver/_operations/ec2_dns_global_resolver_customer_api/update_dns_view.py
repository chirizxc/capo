"""Generated from Smithy shape ``com.amazonaws.route53globalresolver#UpdateDNSView``."""
...
def handle_response(
    ...
    out: capo_route53globalresolver.types.update_dns_view_output.UpdateDNSViewOutput = (
        capo_route53globalresolver.types.update_dns_view_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_route53globalresolver.types.update_dns_view_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_dns_view(
