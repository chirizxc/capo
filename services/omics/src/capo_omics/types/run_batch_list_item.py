...
if TYPE_CHECKING:
    ...
    import capo_omics.types.submission_failure_message
    import capo_omics.types.submission_failure_reason
    import capo_omics.types.submission_status


class RunBatchListItem(TypedDict, closed=True):
    run_setting_id: NotRequired["capo_omics.types.run_setting_id.RunSettingId"]
    ...
    run_internal_uuid: NotRequired["capo_omics.types.run_uuid.RunUuid"]
    """<p>The universally unique identifier (UUID) for the run.</p>"""
    run_arn: NotRequired["capo_omics.types.run_arn.RunArn"]
    ...
    submission_failure_reason: NotRequired[
        "capo_omics.types.submission_failure_reason.SubmissionFailureReason"
    ]
    ...
    submission_failure_message: NotRequired[
        "capo_omics.types.submission_failure_message.SubmissionFailureMessage"
    ]
