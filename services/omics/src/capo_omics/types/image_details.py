...
if TYPE_CHECKING:
    import capo_omics.types.task_image_digest
    import capo_omics.types.uri


class ImageDetails(TypedDict, closed=True):
    image: NotRequired["capo_omics.types.uri.Uri"]
    """<p>The URI of the container image.</p>"""
    image_digest: NotRequired["capo_omics.types.task_image_digest.TaskImageDigest"]
