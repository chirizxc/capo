...
class ShareDetails(TypedDict, closed=True):
    ...
    status_message: NotRequired["capo_omics.types.status_message.StatusMessage"]
    ...
    creation_time: NotRequired["capo_omics.types.creation_time.CreationTime"]
    """<p>The timestamp of when the resource share was created.</p>"""
    update_time: NotRequired["capo_omics.types.update_time.UpdateTime"]
