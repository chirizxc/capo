...
def handle_response(
    ...
    out: capo_omics.types.list_run_groups_response.ListRunGroupsResponse = (
        capo_omics.types.list_run_groups_response.deserialize_json(
...
def list_run_groups(
    ...
    capo_omics.types.list_run_groups_response.ListRunGroupsResponse, zapros.Response
]:
