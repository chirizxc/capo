"""Generated from Smithy shape ``com.amazonaws.omics#ListAnnotationStores``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_annotation_stores_response.ListAnnotationStoresResponse = capo_omics.types.list_annotation_stores_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/annotationStores"
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_annotation_stores_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_annotation_stores(
