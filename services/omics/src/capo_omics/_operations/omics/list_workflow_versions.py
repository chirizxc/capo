...
def handle_response(
    ...
    out: capo_omics.types.list_workflow_versions_response.ListWorkflowVersionsResponse = capo_omics.types.list_workflow_versions_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{workflowId}", quote(input_["workflow_id"], safe=""))
