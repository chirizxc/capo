...
def handle_response(
    ...
    out: capo_omics.types.start_read_set_import_job_response.StartReadSetImportJobResponse = capo_omics.types.start_read_set_import_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.start_read_set_import_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
