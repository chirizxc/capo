"""Generated from Smithy shape ``com.amazonaws.omics#ListReadSetExportJobs``."""
...
import capo_omics.types.export_read_set_job_detail_list
...
def handle_response(
    ...
    out: capo_omics.types.list_read_set_export_jobs_response.ListReadSetExportJobsResponse = capo_omics.types.list_read_set_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/exportjobs"
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_read_set_export_jobs_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_read_set_export_jobs(
