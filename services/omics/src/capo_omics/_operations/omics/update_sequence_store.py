...
def handle_response(
    ...
    out: capo_omics.types.update_sequence_store_response.UpdateSequenceStoreResponse = (
        capo_omics.types.update_sequence_store_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.update_sequence_store_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
