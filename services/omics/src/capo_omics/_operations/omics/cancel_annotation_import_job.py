"""Generated from Smithy shape ``com.amazonaws.omics#CancelAnnotationImportJob``."""
...
def handle_response(
    ...
    out: capo_omics.types.cancel_annotation_import_response.CancelAnnotationImportResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_cancel_annotation_import_job(
