"""Generated from Smithy shape ``com.amazonaws.omics#GetReadSet``."""
...
def handle_response(
    ...
    out: capo_omics.types.get_read_set_response.GetReadSetResponse = {"payload": _iter}  # type: ignore[reportAssignmentType]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/readset/{id}"
...
def get_read_set(
    ...
    input_: capo_omics.types.get_read_set_request.GetReadSetRequest,
) -> tuple[capo_omics.types.get_read_set_response.GetReadSetResponse, zapros.Response]:
