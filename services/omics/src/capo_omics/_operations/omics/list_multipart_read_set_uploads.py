...
def handle_response(
    ...
    out: capo_omics.types.list_multipart_read_set_uploads_response.ListMultipartReadSetUploadsResponse = capo_omics.types.list_multipart_read_set_uploads_response.deserialize_json(
