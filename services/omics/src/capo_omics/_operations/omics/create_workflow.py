"""Generated from Smithy shape ``com.amazonaws.omics#CreateWorkflow``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_omics.errors.conflict_exception.ConflictException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_omics.types.create_workflow_response.CreateWorkflowResponse = (
        capo_omics.types.create_workflow_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/workflow"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_omics.types.create_workflow_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_workflow(
    ...
    capo_omics.types.create_workflow_response.CreateWorkflowResponse, zapros.Response
]:
