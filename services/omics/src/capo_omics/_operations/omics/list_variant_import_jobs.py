...
def handle_response(
    ...
    out: capo_omics.types.list_variant_import_jobs_response.ListVariantImportJobsResponse = capo_omics.types.list_variant_import_jobs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_variant_import_jobs_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
