...
def handle_response(
    ...
    out: capo_omics.types.create_share_response.CreateShareResponse = (
        capo_omics.types.create_share_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.create_share_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_share(
    ...
    input_: capo_omics.types.create_share_request.CreateShareRequest,
) -> tuple[capo_omics.types.create_share_response.CreateShareResponse, zapros.Response]:
