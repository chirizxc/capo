"""Generated from Smithy shape ``com.amazonaws.omics#DeleteReferenceStore``."""
...
def handle_response(
    ...
    out: capo_omics.types.delete_reference_store_response.DeleteReferenceStoreResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_reference_store(
