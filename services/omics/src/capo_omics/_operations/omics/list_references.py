...
def handle_response(
    ...
    out: capo_omics.types.list_references_response.ListReferencesResponse = (
        capo_omics.types.list_references_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_references_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def list_references(
    ...
    capo_omics.types.list_references_response.ListReferencesResponse, zapros.Response
]:
