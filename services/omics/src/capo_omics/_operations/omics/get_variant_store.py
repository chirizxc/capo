...
def handle_response(
    ...
    out: capo_omics.types.get_variant_store_response.GetVariantStoreResponse = (
        capo_omics.types.get_variant_store_response.deserialize_json(
...
def get_variant_store(
    ...
    capo_omics.types.get_variant_store_response.GetVariantStoreResponse, zapros.Response
]:
