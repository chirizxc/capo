"""Generated from Smithy shape ``com.amazonaws.omics#CreateConfiguration``."""
...
def handle_response(
    ...
    out: capo_omics.types.create_configuration_response.CreateConfigurationResponse = (
        capo_omics.types.create_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.create_configuration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
