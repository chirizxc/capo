...
def handle_response(
    ...
    out: capo_omics.types.create_workflow_version_response.CreateWorkflowVersionResponse = capo_omics.types.create_workflow_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.create_workflow_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
