...
def handle_response(
    ...
    out: capo_omics.types.delete_reference_response.DeleteReferenceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_reference(
    ...
    capo_omics.types.delete_reference_response.DeleteReferenceResponse, zapros.Response
]:
