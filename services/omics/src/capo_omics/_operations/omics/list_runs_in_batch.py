...
def build_request(
    ...
    url = url.replace("{batchId}", quote(input_["batch_id"], safe=""))
    ...
    if "submission_status" in input_:
        params.append(("submissionStatus", input_["submission_status"]))
    if "run_setting_id" in input_:
        params.append(("runSettingId", input_["run_setting_id"]))
    if "run_id" in input_:
