"""Generated from Smithy shape ``com.amazonaws.omics#GetBatch``."""
...
def handle_response(
    ...
    out: capo_omics.types.get_batch_response.GetBatchResponse = (
        capo_omics.types.get_batch_response.deserialize_json(
...
def get_batch(
    ...
    input_: capo_omics.types.get_batch_request.GetBatchRequest,
) -> tuple[capo_omics.types.get_batch_response.GetBatchResponse, zapros.Response]:
