...
def handle_response(
    ...
    out: capo_omics.types.get_read_set_activation_job_response.GetReadSetActivationJobResponse = capo_omics.types.get_read_set_activation_job_response.deserialize_json(
