"""Generated from Smithy shape ``com.amazonaws.omics#TagResource``."""
...
def handle_response(
    ...
    out: capo_omics.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.tag_resource_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def tag_resource(
    ...
    input_: capo_omics.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_omics.types.tag_resource_response.TagResourceResponse, zapros.Response]:
