"""Generated from Smithy shape ``com.amazonaws.omics#UpdateRunGroup``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.update_run_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_run_group(
