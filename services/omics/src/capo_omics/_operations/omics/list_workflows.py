"""Generated from Smithy shape ``com.amazonaws.omics#ListWorkflows``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_workflows_response.ListWorkflowsResponse = (
        capo_omics.types.list_workflows_response.deserialize_json(
...
def build_request(
    ...
    if "starting_token" in input_:
        params.append(("startingToken", input_["starting_token"]))
...
def list_workflows(
    ...
    capo_omics.types.list_workflows_response.ListWorkflowsResponse, zapros.Response
]:
