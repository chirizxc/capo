...
def handle_response(
    ...
    out: capo_omics.types.list_runs_response.ListRunsResponse = (
        capo_omics.types.list_runs_response.deserialize_json(
...
def build_request(
    ...
    if "run_group_id" in input_:
        params.append(("runGroupId", input_["run_group_id"]))
    if "batch_id" in input_:
        params.append(("batchId", input_["batch_id"]))
...
def list_runs(
    ...
    input_: capo_omics.types.list_runs_request.ListRunsRequest,
) -> tuple[capo_omics.types.list_runs_response.ListRunsResponse, zapros.Response]:
