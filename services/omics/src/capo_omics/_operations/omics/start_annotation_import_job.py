"""Generated from Smithy shape ``com.amazonaws.omics#StartAnnotationImportJob``."""
...
def handle_response(
    ...
    out: capo_omics.types.start_annotation_import_response.StartAnnotationImportResponse = capo_omics.types.start_annotation_import_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/import/annotation"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_omics.types.start_annotation_import_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_annotation_import_job(
