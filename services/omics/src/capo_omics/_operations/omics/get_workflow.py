...
def handle_response(
    ...
    out: capo_omics.types.get_workflow_response.GetWorkflowResponse = (
        capo_omics.types.get_workflow_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_omics.types.get_workflow_request.GetWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    if "export" in input_:
        for item in input_["export"]:
            params.append(("export", item))
    if "workflow_owner_id" in input_:
        params.append(("workflowOwnerId", input_["workflow_owner_id"]))
...
def get_workflow(
    ...
    input_: capo_omics.types.get_workflow_request.GetWorkflowRequest,
) -> tuple[capo_omics.types.get_workflow_response.GetWorkflowResponse, zapros.Response]:
