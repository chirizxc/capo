"""Generated from Smithy shape ``com.amazonaws.omics#GetReferenceMetadata``."""
...
def handle_response(
    ...
    out: capo_omics.types.get_reference_metadata_response.GetReferenceMetadataResponse = capo_omics.types.get_reference_metadata_response.deserialize_json(
...
async def async_get_reference_metadata(
