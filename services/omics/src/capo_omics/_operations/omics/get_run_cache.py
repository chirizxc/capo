...
def handle_response(
    ...
    out: capo_omics.types.get_run_cache_response.GetRunCacheResponse = (
        capo_omics.types.get_run_cache_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_omics.types.get_run_cache_request.GetRunCacheRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_run_cache(
    ...
    capo_omics.types.get_run_cache_response.GetRunCacheResponse, zapros.Response
]:
