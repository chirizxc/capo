"""Generated from Smithy shape ``com.amazonaws.omics#ListReadSetActivationJobs``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_read_set_activation_jobs_response.ListReadSetActivationJobsResponse = capo_omics.types.list_read_set_activation_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/activationjobs"
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_read_set_activation_jobs_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_read_set_activation_jobs(
