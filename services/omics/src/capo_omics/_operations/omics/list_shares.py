...
def handle_response(
    ...
    out: capo_omics.types.list_shares_response.ListSharesResponse = (
        capo_omics.types.list_shares_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_shares_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def list_shares(
    ...
    input_: capo_omics.types.list_shares_request.ListSharesRequest,
) -> tuple[capo_omics.types.list_shares_response.ListSharesResponse, zapros.Response]:
