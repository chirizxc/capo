"""Generated from Smithy shape ``com.amazonaws.omics#DeleteSequenceStore``."""
...
def handle_response(
    ...
    out: capo_omics.types.delete_sequence_store_response.DeleteSequenceStoreResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_sequence_store(
