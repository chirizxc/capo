"""Generated from Smithy shape ``com.amazonaws.omics#CancelRun``."""
...
def build_request(
    ...
    input_: capo_omics.types.cancel_run_request.CancelRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/run/{id}/cancel"
