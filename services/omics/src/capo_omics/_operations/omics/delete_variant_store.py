"""Generated from Smithy shape ``com.amazonaws.omics#DeleteVariantStore``."""
...
def handle_response(
    ...
    out: capo_omics.types.delete_variant_store_response.DeleteVariantStoreResponse = (
        capo_omics.types.delete_variant_store_response.deserialize_json(
...
async def async_delete_variant_store(
