"""Generated from Smithy shape ``com.amazonaws.omics#ListSequenceStores``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_sequence_stores_response.ListSequenceStoresResponse = (
        capo_omics.types.list_sequence_stores_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestores"
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_sequence_stores_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_sequence_stores(
