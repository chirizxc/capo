...
def handle_response(
    ...
    out: capo_omics.types.delete_run_batch_response.DeleteRunBatchResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.delete_run_batch_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def delete_run_batch(
    ...
    capo_omics.types.delete_run_batch_response.DeleteRunBatchResponse, zapros.Response
]:
