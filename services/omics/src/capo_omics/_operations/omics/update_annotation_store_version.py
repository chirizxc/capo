...
def handle_response(
    ...
    out: capo_omics.types.update_annotation_store_version_response.UpdateAnnotationStoreVersionResponse = capo_omics.types.update_annotation_store_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.update_annotation_store_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
