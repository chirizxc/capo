...
def handle_response(
    ...
    out: capo_omics.types.get_run_group_response.GetRunGroupResponse = (
        capo_omics.types.get_run_group_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_omics.types.get_run_group_request.GetRunGroupRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_run_group(
    ...
    capo_omics.types.get_run_group_response.GetRunGroupResponse, zapros.Response
]:
