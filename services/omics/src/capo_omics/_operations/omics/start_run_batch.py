...
def handle_response(
    ...
    out: capo_omics.types.start_run_batch_response.StartRunBatchResponse = (
        capo_omics.types.start_run_batch_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.start_run_batch_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def start_run_batch(
    ...
    capo_omics.types.start_run_batch_response.StartRunBatchResponse, zapros.Response
]:
