"""Generated from Smithy shape ``com.amazonaws.omics#GetConfiguration``."""
...
def handle_response(
    ...
    out: capo_omics.types.get_configuration_response.GetConfigurationResponse = (
        capo_omics.types.get_configuration_response.deserialize_json(
