"""Generated from Smithy shape ``com.amazonaws.omics#ListReadSets``."""
...
def handle_response(
    ...
    out: capo_omics.types.list_read_sets_response.ListReadSetsResponse = (
        capo_omics.types.list_read_sets_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sequencestore/{sequenceStoreId}/readsets"
    ...
    body: bytes | None = json.dumps(
        capo_omics.types.list_read_sets_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def list_read_sets(
    ...
    capo_omics.types.list_read_sets_response.ListReadSetsResponse, zapros.Response
]:
...
async def async_list_read_sets(
