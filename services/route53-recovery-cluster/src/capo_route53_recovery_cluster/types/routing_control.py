...
if TYPE_CHECKING:
    ...
    import capo_route53_recovery_cluster.types.control_panel_name
    import capo_route53_recovery_cluster.types.owner
...
class RoutingControl(TypedDict, closed=True):
    ...
    control_panel_name: NotRequired[
        "capo_route53_recovery_cluster.types.control_panel_name.ControlPanelName"
    ]
    ...
    routing_control_arn: NotRequired["capo_route53_recovery_cluster.types.arn.Arn"]
    ...
    owner: NotRequired["capo_route53_recovery_cluster.types.owner.Owner"]
