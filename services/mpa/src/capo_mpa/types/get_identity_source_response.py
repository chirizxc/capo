...
class GetIdentitySourceResponse(TypedDict, closed=True):
    ...
    identity_source_parameters: NotRequired[
        "capo_mpa.types.identity_source_parameters_for_get.IdentitySourceParametersForGet"
    ]
...
def serialize_json(value: GetIdentitySourceResponse) -> dict:
    ...
    if "identity_source_parameters" in value:
        ...
        out["IdentitySourceParameters"] = (
            capo_mpa.types.identity_source_parameters_for_get.serialize_json(
...
def deserialize_json(data: dict) -> GetIdentitySourceResponse:
    ...
    if data.get("IdentitySourceParameters") is not None:
        ...
        out["identity_source_parameters"] = (
            capo_mpa.types.identity_source_parameters_for_get.deserialize_json(
