"""Generated from Smithy shape ``com.amazonaws.mpa#GetSession``."""
...
def handle_response(
    ...
    out: capo_mpa.types.get_session_response.GetSessionResponse = (
        capo_mpa.types.get_session_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{SessionArn}", quote(input_["session_arn"], safe=""))
...
def get_session(
    ...
    input_: capo_mpa.types.get_session_request.GetSessionRequest,
) -> tuple[capo_mpa.types.get_session_response.GetSessionResponse, zapros.Response]:
