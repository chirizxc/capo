...
def handle_response(
    ...
    out: capo_mpa.types.update_approval_team_response.UpdateApprovalTeamResponse = (
        capo_mpa.types.update_approval_team_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mpa.types.update_approval_team_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
