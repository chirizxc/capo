...
import capo_kinesis_video_signaling._protocol.eventstream
...
def handle_response(
    ...
    out: capo_kinesis_video_signaling.types.send_alexa_offer_to_master_response.SendAlexaOfferToMasterResponse = capo_kinesis_video_signaling.types.send_alexa_offer_to_master_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = (
                capo_kinesis_video_signaling._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_video_signaling.types.send_alexa_offer_to_master_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
