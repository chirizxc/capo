...
class GetIceServerConfigResponse(TypedDict, closed=True):
    ice_server_list: NotRequired[
        "capo_kinesis_video_signaling.types.ice_server_list.IceServerList"
    ]
...
def serialize_json(value: GetIceServerConfigResponse) -> dict:
    ...
    if "ice_server_list" in value:
        ...
        out["IceServerList"] = (
            capo_kinesis_video_signaling.types.ice_server_list.serialize_json(
...
def deserialize_json(data: dict) -> GetIceServerConfigResponse:
    ...
    if data.get("IceServerList") is not None:
        ...
        out["ice_server_list"] = (
            capo_kinesis_video_signaling.types.ice_server_list.deserialize_json(
                data["IceServerList"]
            )
        )
    return out
