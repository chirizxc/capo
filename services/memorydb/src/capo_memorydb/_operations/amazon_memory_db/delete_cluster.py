"""Generated from Smithy shape ``com.amazonaws.memorydb#DeleteCluster``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.delete_cluster_response.DeleteClusterResponse = (
        capo_memorydb.types.delete_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.delete_cluster_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_cluster(
    ...
    capo_memorydb.types.delete_cluster_response.DeleteClusterResponse, zapros.Response
]:
