...
def handle_response(
    ...
    out: capo_memorydb.types.describe_ac_ls_response.DescribeACLsResponse = (
        capo_memorydb.types.describe_ac_ls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_ac_ls_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_ac_ls(
    ...
    capo_memorydb.types.describe_ac_ls_response.DescribeACLsResponse, zapros.Response
]:
