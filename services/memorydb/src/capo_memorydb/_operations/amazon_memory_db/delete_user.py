...
def handle_response(
    ...
    out: capo_memorydb.types.delete_user_response.DeleteUserResponse = (
        capo_memorydb.types.delete_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.delete_user_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_user(
    ...
    capo_memorydb.types.delete_user_response.DeleteUserResponse, zapros.Response
]:
