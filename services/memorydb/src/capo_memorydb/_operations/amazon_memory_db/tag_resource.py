...
def handle_response(
    ...
    out: capo_memorydb.types.tag_resource_response.TagResourceResponse = (
        capo_memorydb.types.tag_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.tag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_memorydb.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
