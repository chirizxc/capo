"""Generated from Smithy shape ``com.amazonaws.memorydb#UpdateMultiRegionCluster``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.update_multi_region_cluster_response.UpdateMultiRegionClusterResponse = capo_memorydb.types.update_multi_region_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.UpdateMultiRegionCluster"
    body: bytes | None = json.dumps(
        capo_memorydb.types.update_multi_region_cluster_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_multi_region_cluster(
