...
import capo_memorydb.errors.parameter_group_already_exists_fault
import capo_memorydb.errors.parameter_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ParameterGroupAlreadyExistsFault":
            raise capo_memorydb.errors.parameter_group_already_exists_fault.ParameterGroupAlreadyExistsFault.from_aws_json_1_1(
                data, message
            )
        case "ParameterGroupQuotaExceededFault":
            raise capo_memorydb.errors.parameter_group_quota_exceeded_fault.ParameterGroupQuotaExceededFault.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.create_parameter_group_response.CreateParameterGroupResponse = capo_memorydb.types.create_parameter_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.create_parameter_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
