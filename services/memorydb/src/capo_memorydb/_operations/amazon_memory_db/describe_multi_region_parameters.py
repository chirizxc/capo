"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeMultiRegionParameters``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.describe_multi_region_parameters_response.DescribeMultiRegionParametersResponse = capo_memorydb.types.describe_multi_region_parameters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeMultiRegionParameters"
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_multi_region_parameters_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_multi_region_parameters(
