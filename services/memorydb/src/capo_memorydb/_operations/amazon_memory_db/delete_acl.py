...
def handle_response(
    ...
    out: capo_memorydb.types.delete_acl_response.DeleteACLResponse = (
        capo_memorydb.types.delete_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.delete_acl_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_acl(
    ...
    input_: capo_memorydb.types.delete_acl_request.DeleteACLRequest,
) -> tuple[capo_memorydb.types.delete_acl_response.DeleteACLResponse, zapros.Response]:
