...
def handle_response(
    ...
    out: capo_memorydb.types.list_allowed_multi_region_cluster_updates_response.ListAllowedMultiRegionClusterUpdatesResponse = capo_memorydb.types.list_allowed_multi_region_cluster_updates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.list_allowed_multi_region_cluster_updates_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
