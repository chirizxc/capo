"""Generated from Smithy shape ``com.amazonaws.memorydb#DescribeMultiRegionClusters``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.describe_multi_region_clusters_response.DescribeMultiRegionClustersResponse = capo_memorydb.types.describe_multi_region_clusters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.DescribeMultiRegionClusters"
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_multi_region_clusters_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_multi_region_clusters(
