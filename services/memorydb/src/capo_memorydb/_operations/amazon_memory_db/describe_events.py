...
def handle_response(
    ...
    out: capo_memorydb.types.describe_events_response.DescribeEventsResponse = (
        capo_memorydb.types.describe_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_events_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_events(
    ...
    capo_memorydb.types.describe_events_response.DescribeEventsResponse, zapros.Response
]:
