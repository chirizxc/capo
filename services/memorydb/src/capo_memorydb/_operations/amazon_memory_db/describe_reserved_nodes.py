...
import capo_memorydb.errors.reserved_node_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReservedNodeNotFoundFault":
            raise capo_memorydb.errors.reserved_node_not_found_fault.ReservedNodeNotFoundFault.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.describe_reserved_nodes_response.DescribeReservedNodesResponse = capo_memorydb.types.describe_reserved_nodes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_reserved_nodes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
