"""Generated from Smithy shape ``com.amazonaws.memorydb#ListAllowedNodeTypeUpdates``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.list_allowed_node_type_updates_response.ListAllowedNodeTypeUpdatesResponse = capo_memorydb.types.list_allowed_node_type_updates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.ListAllowedNodeTypeUpdates"
    body: bytes | None = json.dumps(
        capo_memorydb.types.list_allowed_node_type_updates_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_allowed_node_type_updates(
