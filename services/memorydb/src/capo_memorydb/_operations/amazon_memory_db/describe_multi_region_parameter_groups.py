...
def handle_response(
    ...
    out: capo_memorydb.types.describe_multi_region_parameter_groups_response.DescribeMultiRegionParameterGroupsResponse = capo_memorydb.types.describe_multi_region_parameter_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.describe_multi_region_parameter_groups_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
