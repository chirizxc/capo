"""Generated from Smithy shape ``com.amazonaws.memorydb#UpdateACL``."""
...
def handle_response(
    ...
    out: capo_memorydb.types.update_acl_response.UpdateACLResponse = (
        capo_memorydb.types.update_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.UpdateACL"
    body: bytes | None = json.dumps(
        capo_memorydb.types.update_acl_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_acl(
    ...
    input_: capo_memorydb.types.update_acl_request.UpdateACLRequest,
) -> tuple[capo_memorydb.types.update_acl_response.UpdateACLResponse, zapros.Response]:
