...
import capo_memorydb.errors.service_update_not_found_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUpdateNotFoundFault":
            raise capo_memorydb.errors.service_update_not_found_fault.ServiceUpdateNotFoundFault.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_memorydb.types.batch_update_cluster_response.BatchUpdateClusterResponse = capo_memorydb.types.batch_update_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.batch_update_cluster_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
