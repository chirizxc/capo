...
def handle_response(
    ...
    out: capo_memorydb.types.list_tags_response.ListTagsResponse = (
        capo_memorydb.types.list_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.list_tags_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_tags(
    ...
    input_: capo_memorydb.types.list_tags_request.ListTagsRequest,
) -> tuple[capo_memorydb.types.list_tags_response.ListTagsResponse, zapros.Response]:
