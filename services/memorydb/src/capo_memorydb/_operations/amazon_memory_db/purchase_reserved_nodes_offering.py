"""Generated from Smithy shape ``com.amazonaws.memorydb#PurchaseReservedNodesOffering``."""
...
import capo_memorydb.errors.reserved_node_already_exists_fault
import capo_memorydb.errors.reserved_node_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ReservedNodeAlreadyExistsFault":
            raise capo_memorydb.errors.reserved_node_already_exists_fault.ReservedNodeAlreadyExistsFault.from_aws_json_1_1(
                data, message
            )
        case "ReservedNodeQuotaExceededFault":
            raise capo_memorydb.errors.reserved_node_quota_exceeded_fault.ReservedNodeQuotaExceededFault.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.purchase_reserved_nodes_offering_response.PurchaseReservedNodesOfferingResponse = capo_memorydb.types.purchase_reserved_nodes_offering_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AmazonMemoryDB.PurchaseReservedNodesOffering"
    body: bytes | None = json.dumps(
        capo_memorydb.types.purchase_reserved_nodes_offering_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_purchase_reserved_nodes_offering(
