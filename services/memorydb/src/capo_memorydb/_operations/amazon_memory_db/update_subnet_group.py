...
import capo_memorydb.errors.subnet_in_use
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SubnetInUse":
            raise capo_memorydb.errors.subnet_in_use.SubnetInUse.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.update_subnet_group_response.UpdateSubnetGroupResponse = (
        capo_memorydb.types.update_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.update_subnet_group_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
