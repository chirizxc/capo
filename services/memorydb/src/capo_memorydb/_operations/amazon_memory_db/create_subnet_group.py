...
import capo_memorydb.errors.invalid_subnet
import capo_memorydb.errors.service_linked_role_not_found_fault
import capo_memorydb.errors.subnet_group_already_exists_fault
import capo_memorydb.errors.subnet_group_quota_exceeded_fault
import capo_memorydb.errors.subnet_not_allowed_fault
import capo_memorydb.errors.subnet_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidSubnet":
            raise capo_memorydb.errors.invalid_subnet.InvalidSubnet.from_aws_json_1_1(
                data, message
            )
        ...
        case "SubnetGroupAlreadyExistsFault":
            raise capo_memorydb.errors.subnet_group_already_exists_fault.SubnetGroupAlreadyExistsFault.from_aws_json_1_1(
                data, message
            )
        case "SubnetGroupQuotaExceededFault":
            raise capo_memorydb.errors.subnet_group_quota_exceeded_fault.SubnetGroupQuotaExceededFault.from_aws_json_1_1(
                data, message
            )
        case "SubnetNotAllowedFault":
            raise capo_memorydb.errors.subnet_not_allowed_fault.SubnetNotAllowedFault.from_aws_json_1_1(
                data, message
            )
        case "SubnetQuotaExceededFault":
            raise capo_memorydb.errors.subnet_quota_exceeded_fault.SubnetQuotaExceededFault.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_memorydb.types.create_subnet_group_response.CreateSubnetGroupResponse = (
        capo_memorydb.types.create_subnet_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_memorydb.types.create_subnet_group_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
