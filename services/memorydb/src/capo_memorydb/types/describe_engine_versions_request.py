...
class DescribeEngineVersionsRequest(TypedDict, closed=True):
    ...
    parameter_group_family: NotRequired["capo_memorydb.types.string.String"]
    ...
    default_only: "capo_memorydb.types.boolean.Boolean"
