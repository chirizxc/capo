"""Generated from Smithy shape ``com.amazonaws.memorydb#ClusterAlreadyExistsFault``."""
...
class ClusterAlreadyExistsFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.memorydb#ClusterAlreadyExistsFault``."""
