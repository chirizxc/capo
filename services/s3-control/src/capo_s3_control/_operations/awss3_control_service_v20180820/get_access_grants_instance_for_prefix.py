...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_grants_instance_for_prefix_result.GetAccessGrantsInstanceForPrefixResult = capo_s3_control.types.get_access_grants_instance_for_prefix_result.deserialize_xml(
...
def build_request(
    ...
    if "s3_prefix" in input_:
        params.append(("s3prefix", input_["s3_prefix"]))
