...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_grants_instance_resource_policy_result.GetAccessGrantsInstanceResourcePolicyResult = capo_s3_control.types.get_access_grants_instance_resource_policy_result.deserialize_xml(
