"""Generated from Smithy shape ``com.amazonaws.s3control#PutBucketVersioning``."""
...
def build_request(
    ...
    capo_s3_control.types.versioning_configuration.serialize_xml(
        input_["versioning_configuration"], payload_root, "VersioningConfiguration"
    )
...
async def async_put_bucket_versioning(
