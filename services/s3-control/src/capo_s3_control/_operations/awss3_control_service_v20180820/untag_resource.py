...
def handle_response(
    ...
    out: capo_s3_control.types.untag_resource_result.UntagResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_s3_control.types.untag_resource_result.UntagResourceResult, zapros.Response
]:
