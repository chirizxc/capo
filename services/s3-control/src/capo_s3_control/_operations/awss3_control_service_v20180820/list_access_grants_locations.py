...
import capo_s3_control.types.access_grants_locations_list
...
def handle_response(
    ...
    out: capo_s3_control.types.list_access_grants_locations_result.ListAccessGrantsLocationsResult = capo_s3_control.types.list_access_grants_locations_result.deserialize_xml(
...
def build_request(
    ...
    if "location_scope" in input_:
        params.append(("locationscope", input_["location_scope"]))
