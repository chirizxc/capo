"""Generated from Smithy shape ``com.amazonaws.s3control#GetStorageLensConfigurationTagging``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_storage_lens_configuration_tagging_result.GetStorageLensConfigurationTaggingResult = capo_s3_control.types.get_storage_lens_configuration_tagging_result.deserialize_xml(
...
def build_request(
    ...
    url = url.replace("{ConfigId}", quote(input_["config_id"], safe=""))
...
async def async_get_storage_lens_configuration_tagging(
