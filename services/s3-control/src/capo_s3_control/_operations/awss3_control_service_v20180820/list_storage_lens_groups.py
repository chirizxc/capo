"""Generated from Smithy shape ``com.amazonaws.s3control#ListStorageLensGroups``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.list_storage_lens_groups_result.ListStorageLensGroupsResult = capo_s3_control.types.list_storage_lens_groups_result.deserialize_xml(
...
async def async_list_storage_lens_groups(
