...
def handle_response(
    ...
    out: capo_s3_control.types.get_multi_region_access_point_policy_status_result.GetMultiRegionAccessPointPolicyStatusResult = capo_s3_control.types.get_multi_region_access_point_policy_status_result.deserialize_xml(
