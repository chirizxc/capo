"""Generated from Smithy shape ``com.amazonaws.s3control#TagResource``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.tag_resource_result.TagResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def tag_resource(
    ...
    capo_s3_control.types.tag_resource_result.TagResourceResult, zapros.Response
]:
