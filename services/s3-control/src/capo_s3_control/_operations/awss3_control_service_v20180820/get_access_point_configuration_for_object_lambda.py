...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_point_configuration_for_object_lambda_result.GetAccessPointConfigurationForObjectLambdaResult = capo_s3_control.types.get_access_point_configuration_for_object_lambda_result.deserialize_xml(
