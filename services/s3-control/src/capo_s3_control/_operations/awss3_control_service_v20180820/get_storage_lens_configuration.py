"""Generated from Smithy shape ``com.amazonaws.s3control#GetStorageLensConfiguration``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_storage_lens_configuration_result.GetStorageLensConfigurationResult = {
        "storage_lens_configuration": capo_s3_control.types.storage_lens_configuration.deserialize_xml(
...
async def async_get_storage_lens_configuration(
