...
def handle_response(
    ...
    out: capo_s3_control.types.put_access_grants_instance_resource_policy_result.PutAccessGrantsInstanceResourcePolicyResult = capo_s3_control.types.put_access_grants_instance_resource_policy_result.deserialize_xml(
