"""Generated from Smithy shape ``com.amazonaws.s3control#CreateAccessPoint``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.create_access_point_result.CreateAccessPointResult = (
        capo_s3_control.types.create_access_point_result.deserialize_xml(
