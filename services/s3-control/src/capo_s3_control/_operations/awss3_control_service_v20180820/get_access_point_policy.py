...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_point_policy_result.GetAccessPointPolicyResult = capo_s3_control.types.get_access_point_policy_result.deserialize_xml(
