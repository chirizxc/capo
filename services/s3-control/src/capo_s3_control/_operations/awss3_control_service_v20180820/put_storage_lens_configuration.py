"""Generated from Smithy shape ``com.amazonaws.s3control#PutStorageLensConfiguration``."""
...
def build_request(
    ...
    root = Element("PutStorageLensConfigurationRequest")
    if "storage_lens_configuration" in input_:
        capo_s3_control.types.storage_lens_configuration.serialize_xml(
            input_["storage_lens_configuration"], root, "StorageLensConfiguration"
        )
    if "tags" in input_:
...
async def async_put_storage_lens_configuration(
