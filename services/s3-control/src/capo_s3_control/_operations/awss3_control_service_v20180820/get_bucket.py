...
def handle_response(
    ...
    out: capo_s3_control.types.get_bucket_result.GetBucketResult = (
        capo_s3_control.types.get_bucket_result.deserialize_xml(
...
def get_bucket(
    ...
    input_: capo_s3_control.types.get_bucket_request.GetBucketRequest,
) -> tuple[capo_s3_control.types.get_bucket_result.GetBucketResult, zapros.Response]:
