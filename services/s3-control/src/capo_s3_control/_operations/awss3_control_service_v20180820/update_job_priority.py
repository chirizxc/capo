...
def handle_response(
    ...
    out: capo_s3_control.types.update_job_priority_result.UpdateJobPriorityResult = (
        capo_s3_control.types.update_job_priority_result.deserialize_xml(
...
def build_request(
    ...
    params.append(("priority", str(input_.get("priority", 0))))
