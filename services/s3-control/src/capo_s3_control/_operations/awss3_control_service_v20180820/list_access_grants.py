...
def build_request(
    ...
    if "grantee_type" in input_:
        params.append(
            (
                "granteetype",
                capo_s3_control.types.grantee_type.to_xml_text(input_["grantee_type"]),
            )
        )
    if "grantee_identifier" in input_:
        params.append(("granteeidentifier", input_["grantee_identifier"]))
    ...
    if "grant_scope" in input_:
        params.append(("grantscope", input_["grant_scope"]))
    if "application_arn" in input_:
        params.append(("application_arn", input_["application_arn"]))
