"""Generated from Smithy shape ``com.amazonaws.s3control#GetAccessGrant``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_grant_result.GetAccessGrantResult = (
        capo_s3_control.types.get_access_grant_result.deserialize_xml(
...
def build_request(
    ...
    url = url.replace("{AccessGrantId}", quote(input_["access_grant_id"], safe=""))
...
def get_access_grant(
    ...
    capo_s3_control.types.get_access_grant_result.GetAccessGrantResult, zapros.Response
]:
...
async def async_get_access_grant(
