"""Generated from Smithy shape ``com.amazonaws.s3control#PutStorageLensConfigurationTagging``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.put_storage_lens_configuration_tagging_result.PutStorageLensConfigurationTaggingResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    if "tags" in input_:
        capo_s3_control.types.storage_lens_tags.serialize_xml(
...
async def async_put_storage_lens_configuration_tagging(
