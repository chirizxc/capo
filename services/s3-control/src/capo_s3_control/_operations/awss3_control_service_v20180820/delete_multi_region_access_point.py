...
def handle_response(
    ...
    out: capo_s3_control.types.delete_multi_region_access_point_result.DeleteMultiRegionAccessPointResult = capo_s3_control.types.delete_multi_region_access_point_result.deserialize_xml(
