...
def handle_response(
    ...
    out: capo_s3_control.types.list_storage_lens_configurations_result.ListStorageLensConfigurationsResult = capo_s3_control.types.list_storage_lens_configurations_result.deserialize_xml(
