"""Generated from Smithy shape ``com.amazonaws.s3control#GetBucketTagging``."""
...
def handle_response(
    ...
    out: capo_s3_control.types.get_bucket_tagging_result.GetBucketTaggingResult = (
        capo_s3_control.types.get_bucket_tagging_result.deserialize_xml(
