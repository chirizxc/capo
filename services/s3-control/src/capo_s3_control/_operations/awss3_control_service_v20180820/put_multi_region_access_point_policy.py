...
def handle_response(
    ...
    out: capo_s3_control.types.put_multi_region_access_point_policy_result.PutMultiRegionAccessPointPolicyResult = capo_s3_control.types.put_multi_region_access_point_policy_result.deserialize_xml(
