...
def handle_response(
    ...
    out: capo_s3_control.types.submit_multi_region_access_point_routes_result.SubmitMultiRegionAccessPointRoutesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{Mrap+}", quote(input_["mrap"], safe="/"))
