...
def handle_response(
    ...
    out: capo_s3_control.types.get_access_grants_instance_result.GetAccessGrantsInstanceResult = capo_s3_control.types.get_access_grants_instance_result.deserialize_xml(
