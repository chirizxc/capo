...
if TYPE_CHECKING:
    import capo_s3_control.types.min_storage_bytes_percentage
    import capo_s3_control.types.storage_lens_prefix_level_delimiter
    import capo_s3_control.types.storage_lens_prefix_level_max_depth


class SelectionCriteria(TypedDict, closed=True):
    ...
    max_depth: NotRequired[
        "capo_s3_control.types.storage_lens_prefix_level_max_depth.StorageLensPrefixLevelMaxDepth"
    ]
