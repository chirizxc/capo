...
import capo_chatbot.errors.delete_microsoft_teams_user_identity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeleteMicrosoftTeamsUserIdentityException":
            raise capo_chatbot.errors.delete_microsoft_teams_user_identity_exception.DeleteMicrosoftTeamsUserIdentityException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_chatbot.types.delete_microsoft_teams_user_identity_result.DeleteMicrosoftTeamsUserIdentityResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chatbot.types.delete_microsoft_teams_user_identity_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
