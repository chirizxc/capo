"""Generated from Smithy shape ``com.amazonaws.chatbot#GetAccountPreferences``."""
...
import capo_chatbot.errors.get_account_preferences_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "GetAccountPreferencesException":
            raise capo_chatbot.errors.get_account_preferences_exception.GetAccountPreferencesException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_chatbot.types.get_account_preferences_result.GetAccountPreferencesResult = capo_chatbot.types.get_account_preferences_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/get-account-preferences"
...
async def async_get_account_preferences(
