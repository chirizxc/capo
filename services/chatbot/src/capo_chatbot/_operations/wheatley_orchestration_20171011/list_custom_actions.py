...
def handle_response(
    ...
    out: capo_chatbot.types.list_custom_actions_result.ListCustomActionsResult = (
        capo_chatbot.types.list_custom_actions_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chatbot.types.list_custom_actions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
