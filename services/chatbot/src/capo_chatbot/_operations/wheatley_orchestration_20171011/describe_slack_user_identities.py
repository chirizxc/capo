...
import capo_chatbot.errors.describe_slack_user_identities_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DescribeSlackUserIdentitiesException":
            raise capo_chatbot.errors.describe_slack_user_identities_exception.DescribeSlackUserIdentitiesException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_chatbot.types.describe_slack_user_identities_result.DescribeSlackUserIdentitiesResult = capo_chatbot.types.describe_slack_user_identities_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chatbot.types.describe_slack_user_identities_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
