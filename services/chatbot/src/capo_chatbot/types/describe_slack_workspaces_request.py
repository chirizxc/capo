"""Generated from Smithy shape ``com.amazonaws.chatbot#DescribeSlackWorkspacesRequest``."""
...
class DescribeSlackWorkspacesRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DescribeSlackWorkspacesRequest) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DescribeSlackWorkspacesRequest:
    out: DescribeSlackWorkspacesRequest = {}  # type: ignore[typeddict-item]
