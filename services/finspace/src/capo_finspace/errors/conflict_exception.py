"""Generated from Smithy shape ``com.amazonaws.finspace#ConflictException``."""
...
class ConflictException_(TypedDict, closed=True):
    ...
    reason: NotRequired["capo_finspace.types.error_message2.ErrorMessage2"]
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.finspace#ConflictException``."""
