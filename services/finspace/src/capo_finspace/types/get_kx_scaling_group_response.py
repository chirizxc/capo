...
if TYPE_CHECKING:
    import capo_finspace.types.arn
...
class GetKxScalingGroupResponse(TypedDict, closed=True):
    ...
    scaling_group_arn: NotRequired["capo_finspace.types.arn.arn"]
...
def deserialize_json(data: dict) -> GetKxScalingGroupResponse:
    ...
    if data.get("scalingGroupArn") is not None:
