...
if TYPE_CHECKING:
    ...
    import capo_finspace.types.node_type


class CapacityConfiguration(TypedDict, closed=True):
    node_type: NotRequired["capo_finspace.types.node_type.NodeType"]
    ...
    node_count: NotRequired["capo_finspace.types.node_count.NodeCount"]
