...
class KxAttachedCluster(TypedDict, closed=True):
    ...
    cluster_status: NotRequired["capo_finspace.types.kx_cluster_status.KxClusterStatus"]
...
def serialize_json(value: KxAttachedCluster) -> dict:
    ...
    if "cluster_status" in value:
        ...
        out["clusterStatus"] = capo_finspace.types.kx_cluster_status.serialize_json(
