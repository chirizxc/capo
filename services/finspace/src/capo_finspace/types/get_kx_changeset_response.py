...
class GetKxChangesetResponse(TypedDict, closed=True):
    ...
    active_from_timestamp: NotRequired["capo_finspace.types.timestamp.Timestamp"]
...
def serialize_json(value: GetKxChangesetResponse) -> dict:
    ...
    if "active_from_timestamp" in value:
        ...
        out["activeFromTimestamp"] = capo_finspace.types.timestamp.serialize_json(
