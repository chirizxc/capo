"""Generated from Smithy shape ``com.amazonaws.ssmquicksetup#GetConfiguration``."""
...
def handle_response(
    ...
    out: capo_ssm_quicksetup.types.get_configuration_output.GetConfigurationOutput = (
        capo_ssm_quicksetup.types.get_configuration_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/getConfiguration/{ConfigurationId}"
    url = url.replace("{ConfigurationId}", quote(input_["configuration_id"], safe=""))
