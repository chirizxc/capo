"""Generated from Smithy shape ``com.amazonaws.ssmquicksetup#UpdateServiceSettings``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_quicksetup.types.update_service_settings_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
