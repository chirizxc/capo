...
def handle_response(
    ...
    out: capo_ssm_quicksetup.types.get_service_settings_output.GetServiceSettingsOutput = capo_ssm_quicksetup.types.get_service_settings_output.deserialize_json(
