"""Generated from Smithy shape ``com.amazonaws.ssmquicksetup#GetConfigurationManager``."""
...
def handle_response(
    ...
    out: capo_ssm_quicksetup.types.get_configuration_manager_output.GetConfigurationManagerOutput = capo_ssm_quicksetup.types.get_configuration_manager_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ManagerArn}", quote(input_["manager_arn"], safe=""))
...
async def async_get_configuration_manager(
