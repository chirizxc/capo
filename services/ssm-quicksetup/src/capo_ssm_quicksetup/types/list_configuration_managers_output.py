...
class ListConfigurationManagersOutput(TypedDict, closed=True):
    configuration_managers_list: NotRequired[
        "capo_ssm_quicksetup.types.configuration_manager_list.ConfigurationManagerList"
    ]
...
def serialize_json(value: ListConfigurationManagersOutput) -> dict:
    ...
    if "configuration_managers_list" in value:
        ...
        out["ConfigurationManagersList"] = (
            capo_ssm_quicksetup.types.configuration_manager_list.serialize_json(
...
def deserialize_json(data: dict) -> ListConfigurationManagersOutput:
    ...
    if data.get("ConfigurationManagersList") is not None:
        import capo_ssm_quicksetup.types.configuration_manager_list

        out["configuration_managers_list"] = (
            capo_ssm_quicksetup.types.configuration_manager_list.deserialize_json(
