...
class BatchTooLarge_(TypedDict, closed=True):
...
class BatchTooLarge(ServiceError):
    ...
    def __init__(self, data: BatchTooLarge_, message: str | None = None):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_xml(cls, el: Element, message: str | None = None) -> "BatchTooLarge":
