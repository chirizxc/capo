"""Generated from Smithy shape ``com.amazonaws.cloudfront#InvalidAssociation``."""
...
# --- restXml ser/de ---
def serialize_xml(value: InvalidAssociation_, parent: Element, tag: str) -> None:
    el = SubElement(parent, tag)
    if "message" in value:
        SubElement(el, "Message").text = str(value["message"])


def deserialize_xml(el: Element) -> InvalidAssociation_:
...
class InvalidAssociation(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudfront#InvalidAssociation``."""
