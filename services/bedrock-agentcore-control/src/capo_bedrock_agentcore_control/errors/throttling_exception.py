"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ThrottlingException``."""
