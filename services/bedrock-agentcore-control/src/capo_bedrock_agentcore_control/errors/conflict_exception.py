"""Generated from Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagentcorecontrol#ConflictException``."""
