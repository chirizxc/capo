...
if TYPE_CHECKING:
    ...
    import capo_iot_wireless.types.wireless_gateway_statistics_list
...
class ListWirelessGatewaysResponse(TypedDict, closed=True):
    ...
    wireless_gateway_list: NotRequired[
        "capo_iot_wireless.types.wireless_gateway_statistics_list.WirelessGatewayStatisticsList"
    ]
...
def serialize_json(value: ListWirelessGatewaysResponse) -> dict:
    ...
    if "wireless_gateway_list" in value:
        ...
        out["WirelessGatewayList"] = (
            capo_iot_wireless.types.wireless_gateway_statistics_list.serialize_json(
...
def deserialize_json(data: dict) -> ListWirelessGatewaysResponse:
    ...
    if data.get("WirelessGatewayList") is not None:
        import capo_iot_wireless.types.wireless_gateway_statistics_list

        out["wireless_gateway_list"] = (
            capo_iot_wireless.types.wireless_gateway_statistics_list.deserialize_json(
