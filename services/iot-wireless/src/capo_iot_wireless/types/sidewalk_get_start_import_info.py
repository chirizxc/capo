...
if TYPE_CHECKING:
    import capo_iot_wireless.types.device_creation_file_list
...
class SidewalkGetStartImportInfo(TypedDict, closed=True):
    device_creation_file_list: NotRequired[
        "capo_iot_wireless.types.device_creation_file_list.DeviceCreationFileList"
    ]
...
def serialize_json(value: SidewalkGetStartImportInfo) -> dict:
    ...
    if "device_creation_file_list" in value:
        ...
        out["DeviceCreationFileList"] = (
            capo_iot_wireless.types.device_creation_file_list.serialize_json(
...
def deserialize_json(data: dict) -> SidewalkGetStartImportInfo:
    ...
    if data.get("DeviceCreationFileList") is not None:
        import capo_iot_wireless.types.device_creation_file_list

        out["device_creation_file_list"] = (
            capo_iot_wireless.types.device_creation_file_list.deserialize_json(
