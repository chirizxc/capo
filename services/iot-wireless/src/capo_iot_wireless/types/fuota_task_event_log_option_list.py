...
if TYPE_CHECKING:
    import capo_iot_wireless.types.fuota_task_event_log_option

FuotaTaskEventLogOptionList: TypeAlias = list[
    "capo_iot_wireless.types.fuota_task_event_log_option.FuotaTaskEventLogOption"
]
...
def serialize_json(value: FuotaTaskEventLogOptionList) -> list:
    ...
    for item in value:
        out.append(
            capo_iot_wireless.types.fuota_task_event_log_option.serialize_json(item)
        )
    return out
