...
if TYPE_CHECKING:
    import capo_iot_wireless.types.cdma_nmr_obj

CdmaNmrList: TypeAlias = list["capo_iot_wireless.types.cdma_nmr_obj.CdmaNmrObj"]
...
def serialize_json(value: CdmaNmrList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_iot_wireless.types.cdma_nmr_obj.serialize_json(item))
    return out
