"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetResourceEventConfigurationResponse``."""
...
class GetResourceEventConfigurationResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetResourceEventConfigurationResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetResourceEventConfigurationResponse:
    out: GetResourceEventConfigurationResponse = {}  # type: ignore[typeddict-item]
