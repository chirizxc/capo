...
class GetMetricsResponse(TypedDict, closed=True):
    summary_metric_query_results: NotRequired[
        "capo_iot_wireless.types.summary_metric_query_results.SummaryMetricQueryResults"
    ]
...
def serialize_json(value: GetMetricsResponse) -> dict:
    ...
    if "summary_metric_query_results" in value:
        ...
        out["SummaryMetricQueryResults"] = (
            capo_iot_wireless.types.summary_metric_query_results.serialize_json(
...
def deserialize_json(data: dict) -> GetMetricsResponse:
    ...
    if data.get("SummaryMetricQueryResults") is not None:
        import capo_iot_wireless.types.summary_metric_query_results

        out["summary_metric_query_results"] = (
            capo_iot_wireless.types.summary_metric_query_results.deserialize_json(
