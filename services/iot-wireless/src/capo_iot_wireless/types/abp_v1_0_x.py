...
def serialize_json(value: AbpV1_0_x) -> dict:
    ...
    if "session_keys" in value:
        ...
        out["SessionKeys"] = (
            capo_iot_wireless.types.session_keys_abp_v1_0_x.serialize_json(
                value["session_keys"]
            )
        )
...
def deserialize_json(data: dict) -> AbpV1_0_x:
    ...
    if data.get("SessionKeys") is not None:
        ...
        out["session_keys"] = (
            capo_iot_wireless.types.session_keys_abp_v1_0_x.deserialize_json(
                data["SessionKeys"]
            )
        )
