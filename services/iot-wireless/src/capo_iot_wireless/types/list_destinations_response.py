...
def serialize_json(value: ListDestinationsResponse) -> dict:
    ...
    if "destination_list" in value:
        ...
        out["DestinationList"] = (
            capo_iot_wireless.types.destination_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDestinationsResponse:
    ...
    if data.get("DestinationList") is not None:
        import capo_iot_wireless.types.destination_list

        out["destination_list"] = (
            capo_iot_wireless.types.destination_list.deserialize_json(
