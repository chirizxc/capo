...
if TYPE_CHECKING:
    import capo_iot_wireless.types.app_eui
    import capo_iot_wireless.types.app_key
    import capo_iot_wireless.types.gen_app_key
...
class OtaaV1_0_x(TypedDict, closed=True):
    ...
    app_eui: NotRequired["capo_iot_wireless.types.app_eui.AppEui"]
    ...
    gen_app_key: NotRequired["capo_iot_wireless.types.gen_app_key.GenAppKey"]
