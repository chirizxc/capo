...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_gateway_task_definition_response.GetWirelessGatewayTaskDefinitionResponse = capo_iot_wireless.types.get_wireless_gateway_task_definition_response.deserialize_json(
