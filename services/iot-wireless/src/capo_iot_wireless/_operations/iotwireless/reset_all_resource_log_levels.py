"""Generated from Smithy shape ``com.amazonaws.iotwireless#ResetAllResourceLogLevels``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.reset_all_resource_log_levels_response.ResetAllResourceLogLevelsResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_reset_all_resource_log_levels(
