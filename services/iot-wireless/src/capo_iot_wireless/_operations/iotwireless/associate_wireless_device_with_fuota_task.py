...
def handle_response(
    ...
    out: capo_iot_wireless.types.associate_wireless_device_with_fuota_task_response.AssociateWirelessDeviceWithFuotaTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.associate_wireless_device_with_fuota_task_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
