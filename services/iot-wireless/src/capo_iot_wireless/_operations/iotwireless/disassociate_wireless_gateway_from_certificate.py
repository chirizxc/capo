"""Generated from Smithy shape ``com.amazonaws.iotwireless#DisassociateWirelessGatewayFromCertificate``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.disassociate_wireless_gateway_from_certificate_response.DisassociateWirelessGatewayFromCertificateResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_wireless_gateway_from_certificate(
