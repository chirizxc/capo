"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetServiceEndpoint``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_service_endpoint_response.GetServiceEndpointResponse = capo_iot_wireless.types.get_service_endpoint_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/service-endpoint"
...
async def async_get_service_endpoint(
