"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetWirelessDeviceStatistics``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_device_statistics_response.GetWirelessDeviceStatisticsResponse = capo_iot_wireless.types.get_wireless_device_statistics_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/wireless-devices/{WirelessDeviceId}/statistics"
    url = url.replace(
        "{WirelessDeviceId}", quote(input_["wireless_device_id"], safe="")
    )
...
async def async_get_wireless_device_statistics(
