"""Generated from Smithy shape ``com.amazonaws.iotwireless#CreateWirelessGatewayTask``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.create_wireless_gateway_task_response.CreateWirelessGatewayTaskResponse = capo_iot_wireless.types.create_wireless_gateway_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.create_wireless_gateway_task_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_wireless_gateway_task(
