...
def handle_response(
    ...
    out: capo_iot_wireless.types.start_wireless_device_import_task_response.StartWirelessDeviceImportTaskResponse = capo_iot_wireless.types.start_wireless_device_import_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.start_wireless_device_import_task_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
