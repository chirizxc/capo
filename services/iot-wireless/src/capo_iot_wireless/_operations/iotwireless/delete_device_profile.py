"""Generated from Smithy shape ``com.amazonaws.iotwireless#DeleteDeviceProfile``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.delete_device_profile_response.DeleteDeviceProfileResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_device_profile(
