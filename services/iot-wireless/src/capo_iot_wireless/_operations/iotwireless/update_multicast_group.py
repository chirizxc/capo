...
def handle_response(
    ...
    out: capo_iot_wireless.types.update_multicast_group_response.UpdateMulticastGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.update_multicast_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
