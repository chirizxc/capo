"""Generated from Smithy shape ``com.amazonaws.iotwireless#UpdatePosition``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.update_position_response.UpdatePositionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.update_position_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
