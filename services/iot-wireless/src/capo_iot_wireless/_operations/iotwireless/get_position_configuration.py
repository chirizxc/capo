...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_position_configuration_response.GetPositionConfigurationResponse = capo_iot_wireless.types.get_position_configuration_response.deserialize_json(
