"""Generated from Smithy shape ``com.amazonaws.iotwireless#DisassociateMulticastGroupFromFuotaTask``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.disassociate_multicast_group_from_fuota_task_response.DisassociateMulticastGroupFromFuotaTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        "{MulticastGroupId}", quote(input_["multicast_group_id"], safe="")
    )
...
async def async_disassociate_multicast_group_from_fuota_task(
