...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_gateway_statistics_response.GetWirelessGatewayStatisticsResponse = capo_iot_wireless.types.get_wireless_gateway_statistics_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{WirelessGatewayId}", quote(input_["wireless_gateway_id"], safe="")
    )
