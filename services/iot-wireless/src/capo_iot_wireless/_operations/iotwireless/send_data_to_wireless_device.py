"""Generated from Smithy shape ``com.amazonaws.iotwireless#SendDataToWirelessDevice``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.send_data_to_wireless_device_response.SendDataToWirelessDeviceResponse = capo_iot_wireless.types.send_data_to_wireless_device_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.send_data_to_wireless_device_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_send_data_to_wireless_device(
