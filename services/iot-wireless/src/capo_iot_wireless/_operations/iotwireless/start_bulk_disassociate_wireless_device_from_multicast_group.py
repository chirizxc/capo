"""Generated from Smithy shape ``com.amazonaws.iotwireless#StartBulkDisassociateWirelessDeviceFromMulticastGroup``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.start_bulk_disassociate_wireless_device_from_multicast_group_response.StartBulkDisassociateWirelessDeviceFromMulticastGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.start_bulk_disassociate_wireless_device_from_multicast_group_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_bulk_disassociate_wireless_device_from_multicast_group(
