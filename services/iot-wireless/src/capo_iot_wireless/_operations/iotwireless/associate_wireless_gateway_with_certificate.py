...
def handle_response(
    ...
    out: capo_iot_wireless.types.associate_wireless_gateway_with_certificate_response.AssociateWirelessGatewayWithCertificateResponse = capo_iot_wireless.types.associate_wireless_gateway_with_certificate_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.associate_wireless_gateway_with_certificate_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
