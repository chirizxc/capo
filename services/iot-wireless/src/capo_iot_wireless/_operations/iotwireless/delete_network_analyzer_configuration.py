...
def handle_response(
    ...
    out: capo_iot_wireless.types.delete_network_analyzer_configuration_response.DeleteNetworkAnalyzerConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        "{ConfigurationName}", quote(input_["configuration_name"], safe="")
    )
