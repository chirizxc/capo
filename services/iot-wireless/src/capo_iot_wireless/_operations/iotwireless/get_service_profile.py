"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetServiceProfile``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_service_profile_response.GetServiceProfileResponse = capo_iot_wireless.types.get_service_profile_response.deserialize_json(
...
async def async_get_service_profile(
