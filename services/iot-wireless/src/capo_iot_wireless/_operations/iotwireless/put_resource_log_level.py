...
def handle_response(
    ...
    out: capo_iot_wireless.types.put_resource_log_level_response.PutResourceLogLevelResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.put_resource_log_level_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
