...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_gateway_response.GetWirelessGatewayResponse = capo_iot_wireless.types.get_wireless_gateway_response.deserialize_json(
...
def build_request(
    ...
    if "identifier_type" in input_:
        params.append(
            (
                "identifierType",
                capo_iot_wireless.types.wireless_gateway_id_type.serialize_json(
