...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_log_levels_by_resource_types_response.GetLogLevelsByResourceTypesResponse = capo_iot_wireless.types.get_log_levels_by_resource_types_response.deserialize_json(
