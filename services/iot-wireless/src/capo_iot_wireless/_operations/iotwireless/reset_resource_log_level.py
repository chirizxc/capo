"""Generated from Smithy shape ``com.amazonaws.iotwireless#ResetResourceLogLevel``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.reset_resource_log_level_response.ResetResourceLogLevelResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_reset_resource_log_level(
