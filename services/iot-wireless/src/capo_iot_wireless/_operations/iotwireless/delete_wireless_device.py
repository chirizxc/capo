"""Generated from Smithy shape ``com.amazonaws.iotwireless#DeleteWirelessDevice``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.delete_wireless_device_response.DeleteWirelessDeviceResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_wireless_device(
