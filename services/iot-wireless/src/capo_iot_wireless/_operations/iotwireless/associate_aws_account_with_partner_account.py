...
def handle_response(
    ...
    out: capo_iot_wireless.types.associate_aws_account_with_partner_account_response.AssociateAwsAccountWithPartnerAccountResponse = capo_iot_wireless.types.associate_aws_account_with_partner_account_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.associate_aws_account_with_partner_account_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
