...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_wireless_device_import_task_response.GetWirelessDeviceImportTaskResponse = capo_iot_wireless.types.get_wireless_device_import_task_response.deserialize_json(
