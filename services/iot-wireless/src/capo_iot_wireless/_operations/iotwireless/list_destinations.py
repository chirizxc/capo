"""Generated from Smithy shape ``com.amazonaws.iotwireless#ListDestinations``."""
...
import capo_iot_wireless.types.destination_list
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_destinations_response.ListDestinationsResponse = (
        capo_iot_wireless.types.list_destinations_response.deserialize_json(
