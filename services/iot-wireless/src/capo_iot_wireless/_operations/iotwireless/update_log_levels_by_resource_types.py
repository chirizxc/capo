"""Generated from Smithy shape ``com.amazonaws.iotwireless#UpdateLogLevelsByResourceTypes``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.update_log_levels_by_resource_types_response.UpdateLogLevelsByResourceTypesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.update_log_levels_by_resource_types_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_log_levels_by_resource_types(
