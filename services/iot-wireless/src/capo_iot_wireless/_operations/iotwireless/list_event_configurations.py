...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_event_configurations_response.ListEventConfigurationsResponse = capo_iot_wireless.types.list_event_configurations_response.deserialize_json(
...
def build_request(
    ...
    if "resource_type" in input_:
        params.append(
            (
                "resourceType",
                capo_iot_wireless.types.event_notification_resource_type.serialize_json(
