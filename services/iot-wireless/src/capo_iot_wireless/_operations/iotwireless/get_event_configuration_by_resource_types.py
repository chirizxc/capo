"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetEventConfigurationByResourceTypes``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_event_configuration_by_resource_types_response.GetEventConfigurationByResourceTypesResponse = capo_iot_wireless.types.get_event_configuration_by_resource_types_response.deserialize_json(
...
async def async_get_event_configuration_by_resource_types(
