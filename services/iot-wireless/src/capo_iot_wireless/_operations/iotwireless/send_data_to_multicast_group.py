...
def handle_response(
    ...
    out: capo_iot_wireless.types.send_data_to_multicast_group_response.SendDataToMulticastGroupResponse = capo_iot_wireless.types.send_data_to_multicast_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.send_data_to_multicast_group_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
