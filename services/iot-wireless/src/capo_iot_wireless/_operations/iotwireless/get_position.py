"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetPosition``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_position_response.GetPositionResponse = (
        capo_iot_wireless.types.get_position_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/positions/{ResourceIdentifier}"
    url = url.replace(
...
def get_position(
    ...
    capo_iot_wireless.types.get_position_response.GetPositionResponse, zapros.Response
]:
