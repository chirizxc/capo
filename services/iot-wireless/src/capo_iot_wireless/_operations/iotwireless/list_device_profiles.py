"""Generated from Smithy shape ``com.amazonaws.iotwireless#ListDeviceProfiles``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_device_profiles_response.ListDeviceProfilesResponse = capo_iot_wireless.types.list_device_profiles_response.deserialize_json(
...
def build_request(
    ...
    if "device_profile_type" in input_:
        params.append(
            (
                "deviceProfileType",
                capo_iot_wireless.types.device_profile_type.serialize_json(
                    input_["device_profile_type"]
                ),
            )
        )
...
async def async_list_device_profiles(
