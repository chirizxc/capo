"""Generated from Smithy shape ``com.amazonaws.iotwireless#DisassociateWirelessGatewayFromThing``."""
...
def handle_response(
    ...
    out: capo_iot_wireless.types.disassociate_wireless_gateway_from_thing_response.DisassociateWirelessGatewayFromThingResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_wireless_gateway_from_thing(
