...
def handle_response(
    ...
    out: capo_iot_wireless.types.list_wireless_gateways_response.ListWirelessGatewaysResponse = capo_iot_wireless.types.list_wireless_gateways_response.deserialize_json(
