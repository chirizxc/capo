"""Generated from Smithy shape ``com.amazonaws.iotwireless#GetMetrics``."""
...
import capo_iot_wireless.types.summary_metric_query_results
...
def handle_response(
    ...
    out: capo_iot_wireless.types.get_metrics_response.GetMetricsResponse = (
        capo_iot_wireless.types.get_metrics_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_wireless.types.get_metrics_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_metrics(
    ...
    capo_iot_wireless.types.get_metrics_response.GetMetricsResponse, zapros.Response
]:
