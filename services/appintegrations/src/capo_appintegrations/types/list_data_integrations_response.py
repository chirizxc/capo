...
class ListDataIntegrationsResponse(TypedDict, closed=True):
    data_integrations: NotRequired[
        "capo_appintegrations.types.data_integrations_list.DataIntegrationsList"
    ]
...
def serialize_json(value: ListDataIntegrationsResponse) -> dict:
    ...
    if "data_integrations" in value:
        ...
        out["DataIntegrations"] = (
            capo_appintegrations.types.data_integrations_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDataIntegrationsResponse:
    ...
    if data.get("DataIntegrations") is not None:
        import capo_appintegrations.types.data_integrations_list

        out["data_integrations"] = (
            capo_appintegrations.types.data_integrations_list.deserialize_json(
