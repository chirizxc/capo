...
class ListDataIntegrationAssociationsResponse(TypedDict, closed=True):
    data_integration_associations: NotRequired[
        "capo_appintegrations.types.data_integration_associations_list.DataIntegrationAssociationsList"
    ]
...
def serialize_json(value: ListDataIntegrationAssociationsResponse) -> dict:
    ...
    if "data_integration_associations" in value:
        ...
        out["DataIntegrationAssociations"] = (
            capo_appintegrations.types.data_integration_associations_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDataIntegrationAssociationsResponse:
    ...
    if data.get("DataIntegrationAssociations") is not None:
        import capo_appintegrations.types.data_integration_associations_list

        out["data_integration_associations"] = (
            capo_appintegrations.types.data_integration_associations_list.deserialize_json(
