...
def handle_response(
    ...
    out: capo_appintegrations.types.update_application_response.UpdateApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appintegrations.types.update_application_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
