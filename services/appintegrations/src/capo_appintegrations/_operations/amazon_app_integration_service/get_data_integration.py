"""Generated from Smithy shape ``com.amazonaws.appintegrations#GetDataIntegration``."""
...
def handle_response(
    ...
    out: capo_appintegrations.types.get_data_integration_response.GetDataIntegrationResponse = capo_appintegrations.types.get_data_integration_response.deserialize_json(
...
async def async_get_data_integration(
