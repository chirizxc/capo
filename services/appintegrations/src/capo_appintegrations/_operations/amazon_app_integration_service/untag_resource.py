"""Generated from Smithy shape ``com.amazonaws.appintegrations#UntagResource``."""
...
def handle_response(
    ...
    out: capo_appintegrations.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
