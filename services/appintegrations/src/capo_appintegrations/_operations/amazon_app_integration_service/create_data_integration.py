"""Generated from Smithy shape ``com.amazonaws.appintegrations#CreateDataIntegration``."""
...
def handle_response(
    ...
    out: capo_appintegrations.types.create_data_integration_response.CreateDataIntegrationResponse = capo_appintegrations.types.create_data_integration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appintegrations.types.create_data_integration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_data_integration(
