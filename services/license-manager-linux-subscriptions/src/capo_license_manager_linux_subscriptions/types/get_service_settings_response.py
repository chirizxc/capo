"""Generated from Smithy shape ``com.amazonaws.licensemanagerlinuxsubscriptions#GetServiceSettingsResponse``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: GetServiceSettingsResponse) -> dict:
    out: dict = {}
