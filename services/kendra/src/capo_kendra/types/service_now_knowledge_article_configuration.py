...
if TYPE_CHECKING:
    ...
    import capo_kendra.types.service_now_knowledge_article_filter_query
...
class ServiceNowKnowledgeArticleConfiguration(TypedDict, closed=True):
    ...
    filter_query: NotRequired[
        "capo_kendra.types.service_now_knowledge_article_filter_query.ServiceNowKnowledgeArticleFilterQuery"
    ]
