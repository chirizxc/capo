...
if TYPE_CHECKING:
    import capo_kendra.types.inline_custom_document_enrichment_configuration

InlineCustomDocumentEnrichmentConfigurationList: TypeAlias = list[
    "capo_kendra.types.inline_custom_document_enrichment_configuration.InlineCustomDocumentEnrichmentConfiguration"
]
...
def serialize_aws_json_1_1(
    ...
    for item in value:
        out.append(
            capo_kendra.types.inline_custom_document_enrichment_configuration.serialize_aws_json_1_1(
                item
            )
        )
    return out
