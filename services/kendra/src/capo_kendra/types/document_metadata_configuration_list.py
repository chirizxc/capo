...
if TYPE_CHECKING:
    import capo_kendra.types.document_metadata_configuration

DocumentMetadataConfigurationList: TypeAlias = list[
    "capo_kendra.types.document_metadata_configuration.DocumentMetadataConfiguration"
]
...
def serialize_aws_json_1_1(value: DocumentMetadataConfigurationList) -> list:
    ...
    for item in value:
        out.append(
            capo_kendra.types.document_metadata_configuration.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> DocumentMetadataConfigurationList:
    ...
    for item in data:
        if item is None:
            continue
        out.append(
            capo_kendra.types.document_metadata_configuration.deserialize_aws_json_1_1(
                item
            )
        )
    return out
