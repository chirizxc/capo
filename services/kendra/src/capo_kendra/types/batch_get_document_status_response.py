...
class BatchGetDocumentStatusResponse(TypedDict, closed=True):
    errors: NotRequired[
        "capo_kendra.types.batch_get_document_status_response_errors.BatchGetDocumentStatusResponseErrors"
    ]
    ...
    document_status_list: NotRequired[
        "capo_kendra.types.document_status_list.DocumentStatusList"
    ]
...
def serialize_aws_json_1_1(value: BatchGetDocumentStatusResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["Errors"] = (
            capo_kendra.types.batch_get_document_status_response_errors.serialize_aws_json_1_1(
                value["errors"]
            )
        )
    if "document_status_list" in value:
        ...
        out["DocumentStatusList"] = (
            capo_kendra.types.document_status_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BatchGetDocumentStatusResponse:
    ...
    if data.get("Errors") is not None:
        ...
        out["errors"] = (
            capo_kendra.types.batch_get_document_status_response_errors.deserialize_aws_json_1_1(
                data["Errors"]
            )
        )
    if data.get("DocumentStatusList") is not None:
        ...
        out["document_status_list"] = (
            capo_kendra.types.document_status_list.deserialize_aws_json_1_1(
