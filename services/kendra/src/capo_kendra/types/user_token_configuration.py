...
class UserTokenConfiguration(TypedDict, closed=True):
    jwt_token_type_configuration: NotRequired[
        "capo_kendra.types.jwt_token_type_configuration.JwtTokenTypeConfiguration"
    ]
    """<p>Information about the JWT token type configuration.</p>"""
    json_token_type_configuration: NotRequired[
        "capo_kendra.types.json_token_type_configuration.JsonTokenTypeConfiguration"
    ]
...
def serialize_aws_json_1_1(value: UserTokenConfiguration) -> dict:
    ...
    if "jwt_token_type_configuration" in value:
        ...
        out["JwtTokenTypeConfiguration"] = (
            capo_kendra.types.jwt_token_type_configuration.serialize_aws_json_1_1(
    ...
    if "json_token_type_configuration" in value:
        ...
        out["JsonTokenTypeConfiguration"] = (
            capo_kendra.types.json_token_type_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UserTokenConfiguration:
    ...
    if data.get("JwtTokenTypeConfiguration") is not None:
        ...
        out["jwt_token_type_configuration"] = (
            capo_kendra.types.jwt_token_type_configuration.deserialize_aws_json_1_1(
    ...
    if data.get("JsonTokenTypeConfiguration") is not None:
        ...
        out["json_token_type_configuration"] = (
            capo_kendra.types.json_token_type_configuration.deserialize_aws_json_1_1(
