...
if TYPE_CHECKING:
    import capo_kendra.types.data_source_to_index_field_mapping

DataSourceToIndexFieldMappingList: TypeAlias = list[
    "capo_kendra.types.data_source_to_index_field_mapping.DataSourceToIndexFieldMapping"
]
...
def serialize_aws_json_1_1(value: DataSourceToIndexFieldMappingList) -> list:
    ...
    for item in value:
        out.append(
            capo_kendra.types.data_source_to_index_field_mapping.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> DataSourceToIndexFieldMappingList:
    ...
    for item in data:
        if item is None:
            continue
        out.append(
            capo_kendra.types.data_source_to_index_field_mapping.deserialize_aws_json_1_1(
                item
            )
        )
    return out
