...
if TYPE_CHECKING:
    import capo_kendra.types.identity_attribute_name


class UserIdentityConfiguration(TypedDict, closed=True):
    identity_attribute_name: NotRequired[
        "capo_kendra.types.identity_attribute_name.IdentityAttributeName"
    ]
