...
class Status(TypedDict, closed=True):
    ...
    document_status: NotRequired["capo_kendra.types.document_status.DocumentStatus"]
    ...
    failure_code: NotRequired["capo_kendra.types.string.String"]
    """<p>Indicates the source of the error.</p>"""
    failure_reason: NotRequired["capo_kendra.types.string.String"]
...
def serialize_aws_json_1_1(value: Status) -> dict:
    ...
    if "document_status" in value:
        ...
        out["DocumentStatus"] = (
            capo_kendra.types.document_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Status:
    ...
    if data.get("DocumentStatus") is not None:
        ...
        out["document_status"] = (
            capo_kendra.types.document_status.deserialize_aws_json_1_1(
                data["DocumentStatus"]
            )
        )
