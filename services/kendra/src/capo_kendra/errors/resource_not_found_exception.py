"""Generated from Smithy shape ``com.amazonaws.kendra#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kendra#ResourceNotFoundException``."""
