"""Generated from Smithy shape ``com.amazonaws.kendra#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.kendra#ServiceQuotaExceededException``."""
