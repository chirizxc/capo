"""Generated from Smithy shape ``com.amazonaws.kendra#BatchPutDocument``."""
...
def handle_response(
    ...
    out: capo_kendra.types.batch_put_document_response.BatchPutDocumentResponse = (
        capo_kendra.types.batch_put_document_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.batch_put_document_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
