"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeAccessControlConfiguration``."""
...
def handle_response(
    ...
    out: capo_kendra.types.describe_access_control_configuration_response.DescribeAccessControlConfigurationResponse = capo_kendra.types.describe_access_control_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.describe_access_control_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_access_control_configuration(
