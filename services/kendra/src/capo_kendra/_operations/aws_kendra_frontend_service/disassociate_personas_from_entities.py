"""Generated from Smithy shape ``com.amazonaws.kendra#DisassociatePersonasFromEntities``."""
...
def handle_response(
    ...
    out: capo_kendra.types.disassociate_personas_from_entities_response.DisassociatePersonasFromEntitiesResponse = capo_kendra.types.disassociate_personas_from_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.disassociate_personas_from_entities_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_personas_from_entities(
