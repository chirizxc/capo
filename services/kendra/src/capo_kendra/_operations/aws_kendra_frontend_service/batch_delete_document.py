...
def handle_response(
    ...
    out: capo_kendra.types.batch_delete_document_response.BatchDeleteDocumentResponse = capo_kendra.types.batch_delete_document_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.batch_delete_document_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
