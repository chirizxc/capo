"""Generated from Smithy shape ``com.amazonaws.kendra#DeletePrincipalMapping``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DeletePrincipalMapping"
    body: bytes | None = json.dumps(
        capo_kendra.types.delete_principal_mapping_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_principal_mapping(
