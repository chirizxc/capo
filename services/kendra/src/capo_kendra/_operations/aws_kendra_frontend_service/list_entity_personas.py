"""Generated from Smithy shape ``com.amazonaws.kendra#ListEntityPersonas``."""
...
import capo_kendra.types.personas_summary_list
...
def handle_response(
    ...
    out: capo_kendra.types.list_entity_personas_response.ListEntityPersonasResponse = (
        capo_kendra.types.list_entity_personas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ListEntityPersonas"
    body: bytes | None = json.dumps(
        capo_kendra.types.list_entity_personas_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_entity_personas(
