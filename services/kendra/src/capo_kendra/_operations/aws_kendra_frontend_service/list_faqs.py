...
def handle_response(
    ...
    out: capo_kendra.types.list_faqs_response.ListFaqsResponse = (
        capo_kendra.types.list_faqs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.list_faqs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_faqs(
    ...
    input_: capo_kendra.types.list_faqs_request.ListFaqsRequest,
) -> tuple[capo_kendra.types.list_faqs_response.ListFaqsResponse, zapros.Response]:
