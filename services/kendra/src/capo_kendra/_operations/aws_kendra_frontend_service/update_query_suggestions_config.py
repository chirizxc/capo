"""Generated from Smithy shape ``com.amazonaws.kendra#UpdateQuerySuggestionsConfig``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.UpdateQuerySuggestionsConfig"
    body: bytes | None = json.dumps(
        capo_kendra.types.update_query_suggestions_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_query_suggestions_config(
