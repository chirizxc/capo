...
def handle_response(
    ...
    out: capo_kendra.types.create_access_control_configuration_response.CreateAccessControlConfigurationResponse = capo_kendra.types.create_access_control_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.create_access_control_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
