"""Generated from Smithy shape ``com.amazonaws.kendra#Retrieve``."""
...
def handle_response(
    ...
    out: capo_kendra.types.retrieve_result.RetrieveResult = (
        capo_kendra.types.retrieve_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.Retrieve"
    body: bytes | None = json.dumps(
        capo_kendra.types.retrieve_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def retrieve(
    ...
    input_: capo_kendra.types.retrieve_request.RetrieveRequest,
) -> tuple[capo_kendra.types.retrieve_result.RetrieveResult, zapros.Response]:
