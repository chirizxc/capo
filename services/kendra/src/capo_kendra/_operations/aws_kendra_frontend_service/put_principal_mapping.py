"""Generated from Smithy shape ``com.amazonaws.kendra#PutPrincipalMapping``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.PutPrincipalMapping"
    body: bytes | None = json.dumps(
        capo_kendra.types.put_principal_mapping_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_put_principal_mapping(
