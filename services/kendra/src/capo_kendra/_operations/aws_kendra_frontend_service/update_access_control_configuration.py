...
def handle_response(
    ...
    out: capo_kendra.types.update_access_control_configuration_response.UpdateAccessControlConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.update_access_control_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
