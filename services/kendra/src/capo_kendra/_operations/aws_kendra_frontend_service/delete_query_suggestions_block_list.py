"""Generated from Smithy shape ``com.amazonaws.kendra#DeleteQuerySuggestionsBlockList``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DeleteQuerySuggestionsBlockList"
    body: bytes | None = json.dumps(
        capo_kendra.types.delete_query_suggestions_block_list_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_query_suggestions_block_list(
