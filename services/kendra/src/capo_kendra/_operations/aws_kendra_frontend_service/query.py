"""Generated from Smithy shape ``com.amazonaws.kendra#Query``."""
...
def handle_response(
    ...
    out: capo_kendra.types.query_result.QueryResult = (
        capo_kendra.types.query_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_kendra.types.query_request.QueryRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.query_request.serialize_aws_json_1_1(input_), allow_nan=False
    ).encode()
...
def query(
    options: OperationOptions, input_: capo_kendra.types.query_request.QueryRequest
) -> tuple[capo_kendra.types.query_result.QueryResult, zapros.Response]:
...
async def async_query(
    options: AsyncOperationOptions, input_: capo_kendra.types.query_request.QueryRequest
) -> tuple[capo_kendra.types.query_result.QueryResult, zapros.Response]:
