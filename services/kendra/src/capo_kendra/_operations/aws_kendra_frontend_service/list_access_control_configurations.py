...
def handle_response(
    ...
    out: capo_kendra.types.list_access_control_configurations_response.ListAccessControlConfigurationsResponse = capo_kendra.types.list_access_control_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.list_access_control_configurations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
