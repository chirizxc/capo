...
import capo_kendra.errors.resource_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_kendra.errors.resource_in_use_exception.ResourceInUseException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_kendra.types.start_data_source_sync_job_response.StartDataSourceSyncJobResponse = capo_kendra.types.start_data_source_sync_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.start_data_source_sync_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
