"""Generated from Smithy shape ``com.amazonaws.kendra#DescribeIndex``."""
...
def handle_response(
    ...
    out: capo_kendra.types.describe_index_response.DescribeIndexResponse = (
        capo_kendra.types.describe_index_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.describe_index_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_index(
    ...
    capo_kendra.types.describe_index_response.DescribeIndexResponse, zapros.Response
]:
