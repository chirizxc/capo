"""Generated from Smithy shape ``com.amazonaws.kendra#DeleteExperience``."""
...
def handle_response(
    ...
    out: capo_kendra.types.delete_experience_response.DeleteExperienceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.DeleteExperience"
    body: bytes | None = json.dumps(
        capo_kendra.types.delete_experience_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_experience(
