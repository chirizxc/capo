"""Generated from Smithy shape ``com.amazonaws.kendra#ClearQuerySuggestions``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ClearQuerySuggestions"
    body: bytes | None = json.dumps(
        capo_kendra.types.clear_query_suggestions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_clear_query_suggestions(
