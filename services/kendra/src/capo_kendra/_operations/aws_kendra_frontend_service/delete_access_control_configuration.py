"""Generated from Smithy shape ``com.amazonaws.kendra#DeleteAccessControlConfiguration``."""
...
def handle_response(
    ...
    out: capo_kendra.types.delete_access_control_configuration_response.DeleteAccessControlConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.delete_access_control_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_access_control_configuration(
