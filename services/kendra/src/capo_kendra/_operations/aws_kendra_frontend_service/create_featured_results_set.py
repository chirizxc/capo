"""Generated from Smithy shape ``com.amazonaws.kendra#CreateFeaturedResultsSet``."""
...
def handle_response(
    ...
    out: capo_kendra.types.create_featured_results_set_response.CreateFeaturedResultsSetResponse = capo_kendra.types.create_featured_results_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.CreateFeaturedResultsSet"
    body: bytes | None = json.dumps(
        capo_kendra.types.create_featured_results_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_featured_results_set(
