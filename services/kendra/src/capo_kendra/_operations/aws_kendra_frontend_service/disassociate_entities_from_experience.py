"""Generated from Smithy shape ``com.amazonaws.kendra#DisassociateEntitiesFromExperience``."""
...
def handle_response(
    ...
    out: capo_kendra.types.disassociate_entities_from_experience_response.DisassociateEntitiesFromExperienceResponse = capo_kendra.types.disassociate_entities_from_experience_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.disassociate_entities_from_experience_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_entities_from_experience(
