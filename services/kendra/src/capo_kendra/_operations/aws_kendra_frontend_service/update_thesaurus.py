"""Generated from Smithy shape ``com.amazonaws.kendra#UpdateThesaurus``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.UpdateThesaurus"
    body: bytes | None = json.dumps(
        capo_kendra.types.update_thesaurus_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_thesaurus(
