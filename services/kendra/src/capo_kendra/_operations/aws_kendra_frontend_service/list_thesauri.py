"""Generated from Smithy shape ``com.amazonaws.kendra#ListThesauri``."""
...
def handle_response(
    ...
    out: capo_kendra.types.list_thesauri_response.ListThesauriResponse = (
        capo_kendra.types.list_thesauri_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ListThesauri"
    body: bytes | None = json.dumps(
        capo_kendra.types.list_thesauri_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_thesauri(
    ...
    capo_kendra.types.list_thesauri_response.ListThesauriResponse, zapros.Response
]:
