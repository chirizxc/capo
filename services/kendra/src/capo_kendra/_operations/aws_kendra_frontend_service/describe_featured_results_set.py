...
def handle_response(
    ...
    out: capo_kendra.types.describe_featured_results_set_response.DescribeFeaturedResultsSetResponse = capo_kendra.types.describe_featured_results_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.describe_featured_results_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
