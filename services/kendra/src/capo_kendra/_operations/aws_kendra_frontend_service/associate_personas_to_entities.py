...
def handle_response(
    ...
    out: capo_kendra.types.associate_personas_to_entities_response.AssociatePersonasToEntitiesResponse = capo_kendra.types.associate_personas_to_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kendra.types.associate_personas_to_entities_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
