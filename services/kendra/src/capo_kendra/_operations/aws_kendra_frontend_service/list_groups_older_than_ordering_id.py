"""Generated from Smithy shape ``com.amazonaws.kendra#ListGroupsOlderThanOrderingId``."""
...
def handle_response(
    ...
    out: capo_kendra.types.list_groups_older_than_ordering_id_response.ListGroupsOlderThanOrderingIdResponse = capo_kendra.types.list_groups_older_than_ordering_id_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSKendraFrontendService.ListGroupsOlderThanOrderingId"
    body: bytes | None = json.dumps(
        capo_kendra.types.list_groups_older_than_ordering_id_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_groups_older_than_ordering_id(
