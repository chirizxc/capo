...
```
pip install capo-workspaces-thin-client
```

## Usage

```python
from capo_workspaces_thin_client import AsyncWorkSpacesThinClientClient
...
```python
from capo_workspaces_thin_client import AsyncWorkSpacesThinClientClient
from capo_workspaces_thin_client.error import AccessDeniedException
