...
class ListSoftwareSetsResponse(TypedDict, closed=True):
    software_sets: NotRequired[
        "capo_workspaces_thin_client.types.software_set_list.SoftwareSetList"
    ]
...
def serialize_json(value: ListSoftwareSetsResponse) -> dict:
    ...
    if "software_sets" in value:
        ...
        out["softwareSets"] = (
            capo_workspaces_thin_client.types.software_set_list.serialize_json(
                value["software_sets"]
            )
        )
...
def deserialize_json(data: dict) -> ListSoftwareSetsResponse:
    ...
    if data.get("softwareSets") is not None:
        import capo_workspaces_thin_client.types.software_set_list

        out["software_sets"] = (
            capo_workspaces_thin_client.types.software_set_list.deserialize_json(
                data["softwareSets"]
            )
        )
