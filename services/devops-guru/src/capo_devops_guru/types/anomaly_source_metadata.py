...
if TYPE_CHECKING:
    import capo_devops_guru.types.anomaly_source
...
class AnomalySourceMetadata(TypedDict, closed=True):
    source: NotRequired["capo_devops_guru.types.anomaly_source.AnomalySource"]
    """<p>The source of the anomaly.</p>"""
    source_resource_name: NotRequired[
        "capo_devops_guru.types.resource_name.ResourceName"
    ]
    """<p>The name of the anomaly's resource.</p>"""
    source_resource_type: NotRequired[
        "capo_devops_guru.types.resource_type.ResourceType"
    ]
