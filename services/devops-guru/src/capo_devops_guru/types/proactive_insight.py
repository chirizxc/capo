"""Generated from Smithy shape ``com.amazonaws.devopsguru#ProactiveInsight``."""
...
class ProactiveInsight(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ProactiveInsight) -> dict:
    out: dict = {}
    if "id" in value:
        out["Id"] = value["id"]
    if "name" in value:
