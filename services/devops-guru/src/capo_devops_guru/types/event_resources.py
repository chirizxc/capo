...
if TYPE_CHECKING:
    import capo_devops_guru.types.event_resource

EventResources: TypeAlias = list["capo_devops_guru.types.event_resource.EventResource"]
...
def serialize_json(value: EventResources) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_devops_guru.types.event_resource.serialize_json(item))
    return out
