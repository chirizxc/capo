...
class UpdateServiceIntegrationConfig(TypedDict, closed=True):
    ops_center: NotRequired[
        "capo_devops_guru.types.ops_center_integration_config.OpsCenterIntegrationConfig"
    ]
    logs_anomaly_detection: NotRequired[
        "capo_devops_guru.types.logs_anomaly_detection_integration_config.LogsAnomalyDetectionIntegrationConfig"
    ]
    ...
    kms_server_side_encryption: NotRequired[
        "capo_devops_guru.types.kms_server_side_encryption_integration_config.KMSServerSideEncryptionIntegrationConfig"
    ]
...
def serialize_json(value: UpdateServiceIntegrationConfig) -> dict:
    ...
    if "ops_center" in value:
        ...
        out["OpsCenter"] = (
            capo_devops_guru.types.ops_center_integration_config.serialize_json(
                value["ops_center"]
            )
        )
    if "logs_anomaly_detection" in value:
        ...
        out["LogsAnomalyDetection"] = (
            capo_devops_guru.types.logs_anomaly_detection_integration_config.serialize_json(
    ...
    if "kms_server_side_encryption" in value:
        ...
        out["KMSServerSideEncryption"] = (
            capo_devops_guru.types.kms_server_side_encryption_integration_config.serialize_json(
...
def deserialize_json(data: dict) -> UpdateServiceIntegrationConfig:
    ...
    if data.get("OpsCenter") is not None:
        ...
        out["ops_center"] = (
            capo_devops_guru.types.ops_center_integration_config.deserialize_json(
                data["OpsCenter"]
            )
        )
    if data.get("LogsAnomalyDetection") is not None:
        ...
        out["logs_anomaly_detection"] = (
            capo_devops_guru.types.logs_anomaly_detection_integration_config.deserialize_json(
    ...
    if data.get("KMSServerSideEncryption") is not None:
        ...
        out["kms_server_side_encryption"] = (
            capo_devops_guru.types.kms_server_side_encryption_integration_config.deserialize_json(
