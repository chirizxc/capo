...
if TYPE_CHECKING:
    ...
    import capo_devops_guru.types.performance_insights_metric_group
    import capo_devops_guru.types.performance_insights_metric_limit_integer


class PerformanceInsightsMetricDimensionGroup(TypedDict, closed=True):
    group: NotRequired[
        "capo_devops_guru.types.performance_insights_metric_group.PerformanceInsightsMetricGroup"
    ]
    ...
    dimensions: NotRequired[
        "capo_devops_guru.types.performance_insights_metric_dimensions.PerformanceInsightsMetricDimensions"
    ]
    ...
    limit: NotRequired[
        "capo_devops_guru.types.performance_insights_metric_limit_integer.PerformanceInsightsMetricLimitInteger"
    ]
...
def serialize_json(value: PerformanceInsightsMetricDimensionGroup) -> dict:
    ...
    if "dimensions" in value:
        ...
        out["Dimensions"] = (
            capo_devops_guru.types.performance_insights_metric_dimensions.serialize_json(
                value["dimensions"]
            )
        )
    if "limit" in value:
...
def deserialize_json(data: dict) -> PerformanceInsightsMetricDimensionGroup:
    ...
    if data.get("Dimensions") is not None:
        ...
        out["dimensions"] = (
            capo_devops_guru.types.performance_insights_metric_dimensions.deserialize_json(
                data["Dimensions"]
            )
        )
