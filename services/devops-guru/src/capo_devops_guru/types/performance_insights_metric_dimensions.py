...
if TYPE_CHECKING:
    import capo_devops_guru.types.performance_insights_metric_dimension

PerformanceInsightsMetricDimensions: TypeAlias = list[
    "capo_devops_guru.types.performance_insights_metric_dimension.PerformanceInsightsMetricDimension"
]
