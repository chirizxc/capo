...
class GetResourceCollectionResponse(TypedDict, closed=True):
    resource_collection: NotRequired[
        "capo_devops_guru.types.resource_collection_filter.ResourceCollectionFilter"
    ]
...
def serialize_json(value: GetResourceCollectionResponse) -> dict:
    ...
    if "resource_collection" in value:
        ...
        out["ResourceCollection"] = (
            capo_devops_guru.types.resource_collection_filter.serialize_json(
...
def deserialize_json(data: dict) -> GetResourceCollectionResponse:
    ...
    if data.get("ResourceCollection") is not None:
        ...
        out["resource_collection"] = (
            capo_devops_guru.types.resource_collection_filter.deserialize_json(
