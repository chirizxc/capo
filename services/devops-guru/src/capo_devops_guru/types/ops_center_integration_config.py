"""Generated from Smithy shape ``com.amazonaws.devopsguru#OpsCenterIntegrationConfig``."""
...
class OpsCenterIntegrationConfig(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: OpsCenterIntegrationConfig) -> dict:
    out: dict = {}
