...
if TYPE_CHECKING:
    import capo_devops_guru.types.explanation
    import capo_devops_guru.types.log_anomaly_token
    import capo_devops_guru.types.log_anomaly_type
    import capo_devops_guru.types.log_event_id
    import capo_devops_guru.types.log_stream_name
    import capo_devops_guru.types.number_of_log_lines_occurrences
    import capo_devops_guru.types.timestamp


class LogAnomalyClass(TypedDict, closed=True):
    log_stream_name: NotRequired["capo_devops_guru.types.log_stream_name.LogStreamName"]
    ...
    log_anomaly_type: NotRequired[
        "capo_devops_guru.types.log_anomaly_type.LogAnomalyType"
    ]
    """<p> The type of log anomaly that has been detected. </p>"""
    log_anomaly_token: NotRequired[
        "capo_devops_guru.types.log_anomaly_token.LogAnomalyToken"
    ]
    ...
    log_event_id: NotRequired["capo_devops_guru.types.log_event_id.LogEventId"]
    """<p> The ID of the log event. </p>"""
    explanation: NotRequired["capo_devops_guru.types.explanation.Explanation"]
    """<p> The explanation for why the log event is considered an anomaly. </p>"""
    number_of_log_lines_occurrences: "capo_devops_guru.types.number_of_log_lines_occurrences.NumberOfLogLinesOccurrences"
    """<p> The number of log lines where this anomalous log event occurs. </p>"""
    log_event_timestamp: NotRequired["capo_devops_guru.types.timestamp.Timestamp"]
...
def serialize_json(value: LogAnomalyClass) -> dict:
    ...
    if "log_anomaly_type" in value:
        ...
        out["LogAnomalyType"] = capo_devops_guru.types.log_anomaly_type.serialize_json(
    ...
    if "log_event_timestamp" in value:
        ...
        out["LogEventTimestamp"] = capo_devops_guru.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> LogAnomalyClass:
    ...
    if data.get("LogAnomalyType") is not None:
        ...
        out["log_anomaly_type"] = (
            capo_devops_guru.types.log_anomaly_type.deserialize_json(
                data["LogAnomalyType"]
            )
        )
