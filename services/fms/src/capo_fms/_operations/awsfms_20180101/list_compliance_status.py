...
def handle_response(
    ...
    out: capo_fms.types.list_compliance_status_response.ListComplianceStatusResponse = (
        capo_fms.types.list_compliance_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.list_compliance_status_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
