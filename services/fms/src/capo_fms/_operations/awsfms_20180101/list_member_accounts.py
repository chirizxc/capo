"""Generated from Smithy shape ``com.amazonaws.fms#ListMemberAccounts``."""
...
def handle_response(
    ...
    out: capo_fms.types.list_member_accounts_response.ListMemberAccountsResponse = (
        capo_fms.types.list_member_accounts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.list_member_accounts_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
