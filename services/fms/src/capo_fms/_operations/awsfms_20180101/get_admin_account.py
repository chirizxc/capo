"""Generated from Smithy shape ``com.amazonaws.fms#GetAdminAccount``."""
...
def handle_response(
    ...
    out: capo_fms.types.get_admin_account_response.GetAdminAccountResponse = (
        capo_fms.types.get_admin_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_admin_account_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_admin_account(
    ...
    capo_fms.types.get_admin_account_response.GetAdminAccountResponse, zapros.Response
]:
...
async def async_get_admin_account(
