"""Generated from Smithy shape ``com.amazonaws.fms#PutAppsList``."""
...
def handle_response(
    ...
    out: capo_fms.types.put_apps_list_response.PutAppsListResponse = (
        capo_fms.types.put_apps_list_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.PutAppsList"
    body: bytes | None = json.dumps(
        capo_fms.types.put_apps_list_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_apps_list(
    ...
    input_: capo_fms.types.put_apps_list_request.PutAppsListRequest,
) -> tuple[capo_fms.types.put_apps_list_response.PutAppsListResponse, zapros.Response]:
