...
def handle_response(
    ...
    out: capo_fms.types.list_admin_accounts_for_organization_response.ListAdminAccountsForOrganizationResponse = capo_fms.types.list_admin_accounts_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.list_admin_accounts_for_organization_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
