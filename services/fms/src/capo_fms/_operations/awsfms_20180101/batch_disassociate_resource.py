...
def handle_response(
    ...
    out: capo_fms.types.batch_disassociate_resource_response.BatchDisassociateResourceResponse = capo_fms.types.batch_disassociate_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.batch_disassociate_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
