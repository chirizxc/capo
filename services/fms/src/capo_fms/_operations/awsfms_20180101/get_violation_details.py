...
def handle_response(
    ...
    out: capo_fms.types.get_violation_details_response.GetViolationDetailsResponse = (
        capo_fms.types.get_violation_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_violation_details_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
