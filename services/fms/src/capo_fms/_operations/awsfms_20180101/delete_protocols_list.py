"""Generated from Smithy shape ``com.amazonaws.fms#DeleteProtocolsList``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.DeleteProtocolsList"
    body: bytes | None = json.dumps(
        capo_fms.types.delete_protocols_list_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_protocols_list(
