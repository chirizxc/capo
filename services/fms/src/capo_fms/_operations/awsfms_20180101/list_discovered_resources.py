"""Generated from Smithy shape ``com.amazonaws.fms#ListDiscoveredResources``."""
...
import capo_fms.types.discovered_resource_list
...
def handle_response(
    ...
    out: capo_fms.types.list_discovered_resources_response.ListDiscoveredResourcesResponse = capo_fms.types.list_discovered_resources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.ListDiscoveredResources"
    body: bytes | None = json.dumps(
        capo_fms.types.list_discovered_resources_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
