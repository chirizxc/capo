"""Generated from Smithy shape ``com.amazonaws.fms#ListAdminsManagingAccount``."""
...
def handle_response(
    ...
    out: capo_fms.types.list_admins_managing_account_response.ListAdminsManagingAccountResponse = capo_fms.types.list_admins_managing_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.ListAdminsManagingAccount"
    body: bytes | None = json.dumps(
        capo_fms.types.list_admins_managing_account_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_admins_managing_account(
