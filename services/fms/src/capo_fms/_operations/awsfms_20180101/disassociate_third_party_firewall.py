...
def handle_response(
    ...
    out: capo_fms.types.disassociate_third_party_firewall_response.DisassociateThirdPartyFirewallResponse = capo_fms.types.disassociate_third_party_firewall_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.disassociate_third_party_firewall_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
