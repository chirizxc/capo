"""Generated from Smithy shape ``com.amazonaws.fms#GetNotificationChannel``."""
...
def handle_response(
    ...
    out: capo_fms.types.get_notification_channel_response.GetNotificationChannelResponse = capo_fms.types.get_notification_channel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_notification_channel_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_notification_channel(
