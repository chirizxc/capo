...
def handle_response(
    ...
    out: capo_fms.types.get_admin_scope_response.GetAdminScopeResponse = (
        capo_fms.types.get_admin_scope_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.get_admin_scope_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_admin_scope(
    ...
    capo_fms.types.get_admin_scope_response.GetAdminScopeResponse, zapros.Response
]:
