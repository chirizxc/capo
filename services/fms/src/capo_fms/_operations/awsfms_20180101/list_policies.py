"""Generated from Smithy shape ``com.amazonaws.fms#ListPolicies``."""
...
def handle_response(
    ...
    out: capo_fms.types.list_policies_response.ListPoliciesResponse = (
        capo_fms.types.list_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.list_policies_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_policies(
    ...
    input_: capo_fms.types.list_policies_request.ListPoliciesRequest,
) -> tuple[capo_fms.types.list_policies_response.ListPoliciesResponse, zapros.Response]:
