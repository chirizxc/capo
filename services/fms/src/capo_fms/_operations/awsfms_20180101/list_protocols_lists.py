"""Generated from Smithy shape ``com.amazonaws.fms#ListProtocolsLists``."""
...
import capo_fms.types.protocols_lists_data
...
def handle_response(
    ...
    out: capo_fms.types.list_protocols_lists_response.ListProtocolsListsResponse = (
        capo_fms.types.list_protocols_lists_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSFMS_20180101.ListProtocolsLists"
    body: bytes | None = json.dumps(
        capo_fms.types.list_protocols_lists_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_protocols_lists(
