"""Generated from Smithy shape ``com.amazonaws.fms#PutPolicy``."""
...
def handle_response(
    ...
    out: capo_fms.types.put_policy_response.PutPolicyResponse = (
        capo_fms.types.put_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_fms.types.put_policy_request.PutPolicyRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.put_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_policy(
    ...
    input_: capo_fms.types.put_policy_request.PutPolicyRequest,
) -> tuple[capo_fms.types.put_policy_response.PutPolicyResponse, zapros.Response]:
