"""Generated from Smithy shape ``com.amazonaws.fms#DisassociateAdminAccount``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fms.types.disassociate_admin_account_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_admin_account(
