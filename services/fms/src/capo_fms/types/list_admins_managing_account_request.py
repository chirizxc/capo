"""Generated from Smithy shape ``com.amazonaws.fms#ListAdminsManagingAccountRequest``."""
...
class ListAdminsManagingAccountRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListAdminsManagingAccountRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListAdminsManagingAccountRequest:
    out: ListAdminsManagingAccountRequest = {}  # type: ignore[typeddict-item]
