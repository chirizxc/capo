...
from capo_docdb_elastic._services._aws_config import aws_config
...
class DocDBElasticClientConfig(TypedDict, total=False, closed=True):
...
class DocDBElasticClient:
    ...
    def __init__(
        ...
        self._config = DocDBElasticClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[DocDBElasticClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: DocDBElasticClientConfig = config_overrides or {}
    ...
    def apply_pending_maintenance_action(
        ...
        *,
        config_overrides: Optional[DocDBElasticClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.apply_pending_maintenance_action_input.ApplyPendingMaintenanceActionInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.apply_pending_maintenance_action_output.ApplyPendingMaintenanceActionOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.apply_pending_maintenance_action.apply_pending_maintenance_action(
    ...
    def copy_cluster_snapshot(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.copy_cluster_snapshot(snapshot_arn='arn:aws:docdb-elastic:us-east-1:$AWS_ACCOUNT_ID:cluster-snapshot/$SOURCE_SNAPSHOT_ID', target_snapshot_name='sampleSnapshotName')
        """

        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.copy_cluster_snapshot_input.CopyClusterSnapshotInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.copy_cluster_snapshot_output.CopyClusterSnapshotOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.copy_cluster_snapshot.copy_cluster_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.create_cluster_input.CreateClusterInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.create_cluster_output.CreateClusterOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.create_cluster.create_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_cluster_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.create_cluster_snapshot_input.CreateClusterSnapshotInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.create_cluster_snapshot_output.CreateClusterSnapshotOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.create_cluster_snapshot.create_cluster_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.delete_cluster_input.DeleteClusterInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.delete_cluster_output.DeleteClusterOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.delete_cluster.delete_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cluster_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.delete_cluster_snapshot_input.DeleteClusterSnapshotInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.delete_cluster_snapshot_output.DeleteClusterSnapshotOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.delete_cluster_snapshot.delete_cluster_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.get_cluster_input.GetClusterInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.get_cluster_output.GetClusterOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.get_cluster.get_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_cluster_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.get_cluster_snapshot_input.GetClusterSnapshotInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.get_cluster_snapshot_output.GetClusterSnapshotOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.get_cluster_snapshot.get_cluster_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_pending_maintenance_action(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.get_pending_maintenance_action_input.GetPendingMaintenanceActionInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.get_pending_maintenance_action_output.GetPendingMaintenanceActionOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.get_pending_maintenance_action.get_pending_maintenance_action(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_clusters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.list_clusters_input.ListClustersInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.list_clusters_output.ListClustersOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.list_clusters.list_clusters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_clusters(
        ...
        *,
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_docdb_elastic.types.cluster_in_list.ClusterInList]":
        _token = next_token
        while True:
    ...
    def list_cluster_snapshots(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.list_cluster_snapshots_input.ListClusterSnapshotsInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.list_cluster_snapshots_output.ListClusterSnapshotsOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.list_cluster_snapshots.list_cluster_snapshots(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_cluster_snapshots(
        self,
        *,
        config_overrides: Optional[DocDBElasticClientConfig] = None,
        cluster_arn: Optional[str] = None,
        ...
        max_results: Optional[int] = None,
        snapshot_type: Optional[str] = None,
    ) -> "Iterator[capo_docdb_elastic.types.cluster_snapshot_in_list.ClusterSnapshotInList]":
        _token = next_token
        while True:
            _response = self.list_cluster_snapshots(
                config_overrides=config_overrides,
                cluster_arn=cluster_arn,
                next_token=_token,
                max_results=max_results,
    ...
    def list_pending_maintenance_actions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.list_pending_maintenance_actions_input.ListPendingMaintenanceActionsInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.list_pending_maintenance_actions_output.ListPendingMaintenanceActionsOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.list_pending_maintenance_actions.list_pending_maintenance_actions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_pending_maintenance_actions(
        self,
        *,
        config_overrides: Optional[DocDBElasticClientConfig] = None,
        next_token: Optional[
        ...
        max_results: Optional[int] = None,
    ) -> "Iterator[capo_docdb_elastic.types.resource_pending_maintenance_action.ResourcePendingMaintenanceAction]":
        _token = next_token
        while True:
            _response = self.list_pending_maintenance_actions(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def restore_cluster_from_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.restore_cluster_from_snapshot_input.RestoreClusterFromSnapshotInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.restore_cluster_from_snapshot_output.RestoreClusterFromSnapshotOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.restore_cluster_from_snapshot.restore_cluster_from_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.start_cluster(cluster_arn='arn:aws:docdb-elastic:us-east-1:$AWS_ACCOUNT_ID:cluster/$CLUSTER_ID')
        """

        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.start_cluster_input.StartClusterInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.start_cluster_output.StartClusterOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.start_cluster.start_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> client.stop_cluster(cluster_arn='arn:aws:docdb-elastic:us-east-1:$AWS_ACCOUNT_ID:cluster/$CLUSTER_ID')
        """

        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.stop_cluster_input.StopClusterInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.stop_cluster_output.StopClusterOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.stop_cluster.stop_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_docdb_elastic.types.update_cluster_input.UpdateClusterInput]",
        ) -> OperationResponse[
            "capo_docdb_elastic.types.update_cluster_output.UpdateClusterOutput"
        ]:
            ...
            output, http_response = (
                capo_docdb_elastic._operations.chimera_db_lionfish_service_lambda.update_cluster.update_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
