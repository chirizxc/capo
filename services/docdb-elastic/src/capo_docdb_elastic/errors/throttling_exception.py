"""Generated from Smithy shape ``com.amazonaws.docdbelastic#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdbelastic#ThrottlingException``."""
