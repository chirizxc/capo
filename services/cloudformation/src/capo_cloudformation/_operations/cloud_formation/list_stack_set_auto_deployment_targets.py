"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListStackSetAutoDeploymentTargets``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListStackSetAutoDeploymentTargetsResult")
    out: capo_cloudformation.types.list_stack_set_auto_deployment_targets_output.ListStackSetAutoDeploymentTargetsOutput = capo_cloudformation.types.list_stack_set_auto_deployment_targets_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListStackSetAutoDeploymentTargets"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_stack_set_auto_deployment_targets_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_stack_set_auto_deployment_targets(
