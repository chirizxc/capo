...
def handle_response(
    ...
    out: capo_cloudformation.types.describe_change_set_hooks_output.DescribeChangeSetHooksOutput = capo_cloudformation.types.describe_change_set_hooks_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.describe_change_set_hooks_input.serialize_query(
        input_, pairs, ""
    )
