"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeStackDriftDetectionStatus``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeStackDriftDetectionStatusResult")
    out: capo_cloudformation.types.describe_stack_drift_detection_status_output.DescribeStackDriftDetectionStatusOutput = capo_cloudformation.types.describe_stack_drift_detection_status_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.describe_stack_drift_detection_status_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_stack_drift_detection_status(
