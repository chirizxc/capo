"""Generated from Smithy shape ``com.amazonaws.cloudformation#UpdateStack``."""
...
def handle_response(
    ...
    out: capo_cloudformation.types.update_stack_output.UpdateStackOutput = (
        capo_cloudformation.types.update_stack_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "UpdateStack"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.update_stack_input.serialize_query(input_, pairs, "")
...
def update_stack(
    ...
    capo_cloudformation.types.update_stack_output.UpdateStackOutput, zapros.Response
]:
