...
def handle_response(
    ...
    out: capo_cloudformation.types.update_termination_protection_output.UpdateTerminationProtectionOutput = capo_cloudformation.types.update_termination_protection_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.update_termination_protection_input.serialize_query(
        input_, pairs, ""
    )
