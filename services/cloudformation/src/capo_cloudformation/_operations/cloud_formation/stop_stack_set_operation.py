...
def handle_response(
    ...
    out: capo_cloudformation.types.stop_stack_set_operation_output.StopStackSetOperationOutput = capo_cloudformation.types.stop_stack_set_operation_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.stop_stack_set_operation_input.serialize_query(
        input_, pairs, ""
    )
