...
def handle_response(
    ...
    out: capo_cloudformation.types.describe_change_set_output.DescribeChangeSetOutput = capo_cloudformation.types.describe_change_set_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.describe_change_set_input.serialize_query(
        input_, pairs, ""
    )
