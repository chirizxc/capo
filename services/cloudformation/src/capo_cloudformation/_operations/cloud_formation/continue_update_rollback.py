...
def handle_response(
    ...
    out: capo_cloudformation.types.continue_update_rollback_output.ContinueUpdateRollbackOutput = capo_cloudformation.types.continue_update_rollback_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.continue_update_rollback_input.serialize_query(
        input_, pairs, ""
    )
