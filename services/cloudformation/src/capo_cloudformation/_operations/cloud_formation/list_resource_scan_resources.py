"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListResourceScanResources``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListResourceScanResourcesResult")
    out: capo_cloudformation.types.list_resource_scan_resources_output.ListResourceScanResourcesOutput = capo_cloudformation.types.list_resource_scan_resources_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListResourceScanResources"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_resource_scan_resources_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_resource_scan_resources(
