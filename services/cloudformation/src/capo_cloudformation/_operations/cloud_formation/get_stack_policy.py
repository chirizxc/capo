...
def handle_response(
    ...
    out: capo_cloudformation.types.get_stack_policy_output.GetStackPolicyOutput = (
        capo_cloudformation.types.get_stack_policy_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.get_stack_policy_input.serialize_query(input_, pairs, "")
