...
def handle_response(
    ...
    out: capo_cloudformation.types.publish_type_output.PublishTypeOutput = (
        capo_cloudformation.types.publish_type_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.publish_type_input.serialize_query(input_, pairs, "")
...
def publish_type(
    ...
    capo_cloudformation.types.publish_type_output.PublishTypeOutput, zapros.Response
]:
