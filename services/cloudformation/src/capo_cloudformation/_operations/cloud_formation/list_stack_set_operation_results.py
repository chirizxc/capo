"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListStackSetOperationResults``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListStackSetOperationResultsResult")
    out: capo_cloudformation.types.list_stack_set_operation_results_output.ListStackSetOperationResultsOutput = capo_cloudformation.types.list_stack_set_operation_results_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListStackSetOperationResults"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_stack_set_operation_results_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_stack_set_operation_results(
