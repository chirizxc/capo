"""Generated from Smithy shape ``com.amazonaws.cloudformation#BatchDescribeTypeConfigurations``."""
...
import capo_cloudformation.errors.type_configuration_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TypeConfigurationNotFoundException":
            raise capo_cloudformation.errors.type_configuration_not_found_exception.TypeConfigurationNotFoundException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("BatchDescribeTypeConfigurationsResult")
    out: capo_cloudformation.types.batch_describe_type_configurations_output.BatchDescribeTypeConfigurationsOutput = capo_cloudformation.types.batch_describe_type_configurations_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.batch_describe_type_configurations_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_batch_describe_type_configurations(
