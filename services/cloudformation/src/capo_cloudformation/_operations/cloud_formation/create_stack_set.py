...
import capo_cloudformation.errors.created_but_modified_exception
import capo_cloudformation.errors.limit_exceeded_exception
import capo_cloudformation.errors.name_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CreatedButModifiedException":
            raise capo_cloudformation.errors.created_but_modified_exception.CreatedButModifiedException.from_query(
                error_el, message
            )
        ...
        case "NameAlreadyExistsException":
            raise capo_cloudformation.errors.name_already_exists_exception.NameAlreadyExistsException.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cloudformation.types.create_stack_set_output.CreateStackSetOutput = (
        capo_cloudformation.types.create_stack_set_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.create_stack_set_input.serialize_query(input_, pairs, "")
