...
def handle_response(
    ...
    out: capo_cloudformation.types.describe_generated_template_output.DescribeGeneratedTemplateOutput = capo_cloudformation.types.describe_generated_template_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.describe_generated_template_input.serialize_query(
        input_, pairs, ""
    )
