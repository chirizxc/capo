...
def handle_response(
    ...
    out: capo_cloudformation.types.test_type_output.TestTypeOutput = (
        capo_cloudformation.types.test_type_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.test_type_input.serialize_query(input_, pairs, "")
...
def test_type(
    ...
    input_: capo_cloudformation.types.test_type_input.TestTypeInput,
) -> tuple[capo_cloudformation.types.test_type_output.TestTypeOutput, zapros.Response]:
