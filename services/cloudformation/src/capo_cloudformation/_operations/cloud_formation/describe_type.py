"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeType``."""
...
def handle_response(
    ...
    out: capo_cloudformation.types.describe_type_output.DescribeTypeOutput = (
        capo_cloudformation.types.describe_type_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeType"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.describe_type_input.serialize_query(input_, pairs, "")
...
def describe_type(
    ...
    capo_cloudformation.types.describe_type_output.DescribeTypeOutput, zapros.Response
]:
