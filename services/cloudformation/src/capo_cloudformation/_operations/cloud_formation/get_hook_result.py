"""Generated from Smithy shape ``com.amazonaws.cloudformation#GetHookResult``."""
...
def handle_response(
    ...
    out: capo_cloudformation.types.get_hook_result_output.GetHookResultOutput = (
        capo_cloudformation.types.get_hook_result_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetHookResult"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.get_hook_result_input.serialize_query(input_, pairs, "")
...
async def async_get_hook_result(
