...
def handle_response(
    ...
    out: capo_cloudformation.types.delete_stack_instances_output.DeleteStackInstancesOutput = capo_cloudformation.types.delete_stack_instances_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.delete_stack_instances_input.serialize_query(
        input_, pairs, ""
    )
