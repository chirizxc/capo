"""Generated from Smithy shape ``com.amazonaws.cloudformation#DescribeEvents``."""
...
import capo_cloudformation.types.operation_events
...
def handle_response(
    ...
    out: capo_cloudformation.types.describe_events_output.DescribeEventsOutput = (
        capo_cloudformation.types.describe_events_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.describe_events_input.serialize_query(input_, pairs, "")
