"""Generated from Smithy shape ``com.amazonaws.cloudformation#GetGeneratedTemplate``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("GetGeneratedTemplateResult")
    out: capo_cloudformation.types.get_generated_template_output.GetGeneratedTemplateOutput = capo_cloudformation.types.get_generated_template_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "GetGeneratedTemplate"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.get_generated_template_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_get_generated_template(
