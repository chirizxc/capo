"""Generated from Smithy shape ``com.amazonaws.cloudformation#ExecuteStackRefactor``."""
...
def build_request(
    ...
    pairs.append(("Action", "ExecuteStackRefactor"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.execute_stack_refactor_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_execute_stack_refactor(
