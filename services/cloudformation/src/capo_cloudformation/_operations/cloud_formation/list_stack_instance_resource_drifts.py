"""Generated from Smithy shape ``com.amazonaws.cloudformation#ListStackInstanceResourceDrifts``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListStackInstanceResourceDriftsResult")
    out: capo_cloudformation.types.list_stack_instance_resource_drifts_output.ListStackInstanceResourceDriftsOutput = capo_cloudformation.types.list_stack_instance_resource_drifts_output.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListStackInstanceResourceDrifts"))
    pairs.append(("Version", "2010-05-15"))
    capo_cloudformation.types.list_stack_instance_resource_drifts_input.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_stack_instance_resource_drifts(
