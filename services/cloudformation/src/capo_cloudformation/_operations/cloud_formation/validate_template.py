...
def handle_response(
    ...
    out: capo_cloudformation.types.validate_template_output.ValidateTemplateOutput = (
        capo_cloudformation.types.validate_template_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.validate_template_input.serialize_query(input_, pairs, "")
