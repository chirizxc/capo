...
def handle_response(
    ...
    out: capo_cloudformation.types.deregister_type_output.DeregisterTypeOutput = (
        capo_cloudformation.types.deregister_type_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.deregister_type_input.serialize_query(input_, pairs, "")
