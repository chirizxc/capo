...
def handle_response(
    ...
    out: capo_cloudformation.types.activate_organizations_access_output.ActivateOrganizationsAccessOutput = capo_cloudformation.types.activate_organizations_access_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.activate_organizations_access_input.serialize_query(
        input_, pairs, ""
    )
