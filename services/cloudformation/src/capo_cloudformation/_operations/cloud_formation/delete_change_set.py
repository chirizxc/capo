...
def handle_response(
    ...
    out: capo_cloudformation.types.delete_change_set_output.DeleteChangeSetOutput = (
        capo_cloudformation.types.delete_change_set_output.deserialize_query(
...
def build_request(
    ...
    capo_cloudformation.types.delete_change_set_input.serialize_query(input_, pairs, "")
