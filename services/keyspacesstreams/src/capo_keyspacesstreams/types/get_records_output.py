...
class GetRecordsOutput(TypedDict, closed=True):
    change_records: NotRequired["capo_keyspacesstreams.types.record_list.RecordList"]
    ...
    next_shard_iterator: NotRequired[
        "capo_keyspacesstreams.types.shard_iterator.ShardIterator"
    ]
    ...
    iterator_description: NotRequired[
        "capo_keyspacesstreams.types.iterator_description.IteratorDescription"
    ]
...
def serialize_aws_json_1_0(value: GetRecordsOutput) -> dict:
    ...
    if "change_records" in value:
        ...
        out["changeRecords"] = (
            capo_keyspacesstreams.types.record_list.serialize_aws_json_1_0(
    ...
    if "iterator_description" in value:
        ...
        out["iteratorDescription"] = (
            capo_keyspacesstreams.types.iterator_description.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetRecordsOutput:
    ...
    if data.get("changeRecords") is not None:
        ...
        out["change_records"] = (
            capo_keyspacesstreams.types.record_list.deserialize_aws_json_1_0(
                data["changeRecords"]
            )
        )
    ...
    if data.get("iteratorDescription") is not None:
        ...
        out["iterator_description"] = (
            capo_keyspacesstreams.types.iterator_description.deserialize_aws_json_1_0(
