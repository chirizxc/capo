...
class ListStreamsInput(TypedDict, closed=True):
    keyspace_name: NotRequired["capo_keyspacesstreams.types.keyspace_name.KeyspaceName"]
    ...
    table_name: NotRequired["capo_keyspacesstreams.types.table_name.TableName"]
