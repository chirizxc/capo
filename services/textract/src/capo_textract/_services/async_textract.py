...
from capo_textract._services._aws_config import aaws_config
...
class AsyncTextractClient:
    ...
    async def analyze_document(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.analyze_document_request.AnalyzeDocumentRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.analyze_document_response.AnalyzeDocumentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.analyze_document.async_analyze_document(
    ...
    async def analyze_expense(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.analyze_expense_request.AnalyzeExpenseRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.analyze_expense_response.AnalyzeExpenseResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.analyze_expense.async_analyze_expense(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def analyze_id(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.analyze_id_request.AnalyzeIDRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.analyze_id_response.AnalyzeIDResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.analyze_id.async_analyze_id(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_adapter(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.create_adapter_request.CreateAdapterRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.create_adapter_response.CreateAdapterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.create_adapter.async_create_adapter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_adapter_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.create_adapter_version_request.CreateAdapterVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.create_adapter_version_response.CreateAdapterVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.create_adapter_version.async_create_adapter_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_adapter(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.delete_adapter_request.DeleteAdapterRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.delete_adapter_response.DeleteAdapterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.delete_adapter.async_delete_adapter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_adapter_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.delete_adapter_version_request.DeleteAdapterVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.delete_adapter_version_response.DeleteAdapterVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.delete_adapter_version.async_delete_adapter_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detect_document_text(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.detect_document_text_request.DetectDocumentTextRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.detect_document_text_response.DetectDocumentTextResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.detect_document_text.async_detect_document_text(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_adapter(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.get_adapter_request.GetAdapterRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.get_adapter_response.GetAdapterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.get_adapter.async_get_adapter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_adapter_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.get_adapter_version_request.GetAdapterVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.get_adapter_version_response.GetAdapterVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.get_adapter_version.async_get_adapter_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_document_analysis(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.get_document_analysis_request.GetDocumentAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.get_document_analysis_response.GetDocumentAnalysisResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.get_document_analysis.async_get_document_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_document_text_detection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.get_document_text_detection_request.GetDocumentTextDetectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.get_document_text_detection_response.GetDocumentTextDetectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.get_document_text_detection.async_get_document_text_detection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_expense_analysis(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.get_expense_analysis_request.GetExpenseAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.get_expense_analysis_response.GetExpenseAnalysisResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.get_expense_analysis.async_get_expense_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_lending_analysis(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.get_lending_analysis_request.GetLendingAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.get_lending_analysis_response.GetLendingAnalysisResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.get_lending_analysis.async_get_lending_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_lending_analysis_summary(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.get_lending_analysis_summary_request.GetLendingAnalysisSummaryRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.get_lending_analysis_summary_response.GetLendingAnalysisSummaryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.get_lending_analysis_summary.async_get_lending_analysis_summary(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_adapters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.list_adapters_request.ListAdaptersRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.list_adapters_response.ListAdaptersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.list_adapters.async_list_adapters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_textract.types.adapter_overview.AdapterOverview]":
        _token = next_token
        while True:
    ...
    async def list_adapter_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.list_adapter_versions_request.ListAdapterVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.list_adapter_versions_response.ListAdapterVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.list_adapter_versions.async_list_adapter_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_textract.types.adapter_version_overview.AdapterVersionOverview]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_document_analysis(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.start_document_analysis_request.StartDocumentAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.start_document_analysis_response.StartDocumentAnalysisResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.start_document_analysis.async_start_document_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_document_text_detection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.start_document_text_detection_request.StartDocumentTextDetectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.start_document_text_detection_response.StartDocumentTextDetectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.start_document_text_detection.async_start_document_text_detection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_expense_analysis(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.start_expense_analysis_request.StartExpenseAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.start_expense_analysis_response.StartExpenseAnalysisResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.start_expense_analysis.async_start_expense_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_lending_analysis(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.start_lending_analysis_request.StartLendingAnalysisRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.start_lending_analysis_response.StartLendingAnalysisResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.start_lending_analysis.async_start_lending_analysis(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_adapter(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_textract.types.update_adapter_request.UpdateAdapterRequest]",
        ) -> AsyncOperationResponse[
            "capo_textract.types.update_adapter_response.UpdateAdapterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_textract._operations.textract.update_adapter.async_update_adapter(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
