...
def handle_response(
    ...
    out: capo_textract.types.analyze_id_response.AnalyzeIDResponse = (
        capo_textract.types.analyze_id_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.analyze_id_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def analyze_id(
    ...
    input_: capo_textract.types.analyze_id_request.AnalyzeIDRequest,
) -> tuple[capo_textract.types.analyze_id_response.AnalyzeIDResponse, zapros.Response]:
