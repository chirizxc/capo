"""Generated from Smithy shape ``com.amazonaws.textract#DeleteAdapterVersion``."""
...
def handle_response(
    ...
    out: capo_textract.types.delete_adapter_version_response.DeleteAdapterVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.DeleteAdapterVersion"
    body: bytes | None = json.dumps(
        capo_textract.types.delete_adapter_version_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_adapter_version(
