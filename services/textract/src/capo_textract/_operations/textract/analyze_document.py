"""Generated from Smithy shape ``com.amazonaws.textract#AnalyzeDocument``."""
...
import capo_textract._protocol.eventstream
...
import capo_textract.errors.human_loop_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "HumanLoopQuotaExceededException":
            raise capo_textract.errors.human_loop_quota_exceeded_exception.HumanLoopQuotaExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_textract.types.analyze_document_response.AnalyzeDocumentResponse = (
        capo_textract.types.analyze_document_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_textract._auth._sigv4.build_sigv4_auth_scheme(
                "textract", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.analyze_document_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
