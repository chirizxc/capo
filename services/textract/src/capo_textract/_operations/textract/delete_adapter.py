...
def handle_response(
    ...
    out: capo_textract.types.delete_adapter_response.DeleteAdapterResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.delete_adapter_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_adapter(
    ...
    capo_textract.types.delete_adapter_response.DeleteAdapterResponse, zapros.Response
]:
