...
def handle_response(
    ...
    out: capo_textract.types.get_adapter_response.GetAdapterResponse = (
        capo_textract.types.get_adapter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.get_adapter_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_adapter(
    ...
    capo_textract.types.get_adapter_response.GetAdapterResponse, zapros.Response
]:
