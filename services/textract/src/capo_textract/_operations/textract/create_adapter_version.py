"""Generated from Smithy shape ``com.amazonaws.textract#CreateAdapterVersion``."""
...
def handle_response(
    ...
    out: capo_textract.types.create_adapter_version_response.CreateAdapterVersionResponse = capo_textract.types.create_adapter_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.CreateAdapterVersion"
    body: bytes | None = json.dumps(
        capo_textract.types.create_adapter_version_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_adapter_version(
