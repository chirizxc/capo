...
def handle_response(
    ...
    out: capo_textract.types.get_lending_analysis_response.GetLendingAnalysisResponse = capo_textract.types.get_lending_analysis_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.get_lending_analysis_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
