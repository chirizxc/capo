...
import capo_textract.types.adapter_version_list
...
def handle_response(
    ...
    out: capo_textract.types.list_adapter_versions_response.ListAdapterVersionsResponse = capo_textract.types.list_adapter_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.list_adapter_versions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
