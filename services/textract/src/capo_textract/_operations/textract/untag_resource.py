"""Generated from Smithy shape ``com.amazonaws.textract#UntagResource``."""
...
def handle_response(
    ...
    out: capo_textract.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Textract.UntagResource"
    body: bytes | None = json.dumps(
        capo_textract.types.untag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def untag_resource(
    ...
    capo_textract.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
