...
def handle_response(
    ...
    out: capo_textract.types.analyze_expense_response.AnalyzeExpenseResponse = (
        capo_textract.types.analyze_expense_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.analyze_expense_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def analyze_expense(
    ...
    capo_textract.types.analyze_expense_response.AnalyzeExpenseResponse, zapros.Response
]:
