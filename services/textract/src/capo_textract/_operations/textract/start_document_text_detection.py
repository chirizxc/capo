"""Generated from Smithy shape ``com.amazonaws.textract#StartDocumentTextDetection``."""
...
def handle_response(
    ...
    out: capo_textract.types.start_document_text_detection_response.StartDocumentTextDetectionResponse = capo_textract.types.start_document_text_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_textract.types.start_document_text_detection_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_document_text_detection(
