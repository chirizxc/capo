...
class HumanLoopQuotaExceededException_(TypedDict, closed=True):
    resource_type: NotRequired["capo_textract.types.string.String"]
    """<p>The resource type.</p>"""
    quota_code: NotRequired["capo_textract.types.string.String"]
    """<p>The quota code.</p>"""
    service_code: NotRequired["capo_textract.types.string.String"]
