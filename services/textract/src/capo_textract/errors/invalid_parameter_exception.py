"""Generated from Smithy shape ``com.amazonaws.textract#InvalidParameterException``."""
...
class InvalidParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.textract#InvalidParameterException``."""
