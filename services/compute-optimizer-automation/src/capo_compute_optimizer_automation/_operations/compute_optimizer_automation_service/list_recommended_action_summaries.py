"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListRecommendedActionSummaries``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_recommended_action_summaries_response.ListRecommendedActionSummariesResponse = capo_compute_optimizer_automation.types.list_recommended_action_summaries_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_recommended_action_summaries_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_recommended_action_summaries(
