"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListAutomationRulePreviewSummaries``."""
...
import capo_compute_optimizer_automation._protocol.eventstream
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_automation_rule_preview_summaries_response.ListAutomationRulePreviewSummariesResponse = capo_compute_optimizer_automation.types.list_automation_rule_preview_summaries_response.deserialize_aws_json_1_0(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = (
                capo_compute_optimizer_automation._auth._sigv4.build_sigv4_auth_scheme(
                    "aco-automation", options.region, endpoint_scheme
                )
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_automation_rule_preview_summaries_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_automation_rule_preview_summaries(
