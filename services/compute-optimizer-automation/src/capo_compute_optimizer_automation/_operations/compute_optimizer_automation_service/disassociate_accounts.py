"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#DisassociateAccounts``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.disassociate_accounts_response.DisassociateAccountsResponse = capo_compute_optimizer_automation.types.disassociate_accounts_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.DisassociateAccounts"
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.disassociate_accounts_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_accounts(
