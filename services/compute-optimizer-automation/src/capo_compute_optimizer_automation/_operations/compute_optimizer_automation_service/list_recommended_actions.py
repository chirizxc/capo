"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListRecommendedActions``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_recommended_actions_response.ListRecommendedActionsResponse = capo_compute_optimizer_automation.types.list_recommended_actions_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerAutomationService.ListRecommendedActions"
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_recommended_actions_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
