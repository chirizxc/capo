...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.get_enrollment_configuration_response.GetEnrollmentConfigurationResponse = capo_compute_optimizer_automation.types.get_enrollment_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.get_enrollment_configuration_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
