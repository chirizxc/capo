"""Generated from Smithy shape ``com.amazonaws.computeoptimizerautomation#ListAutomationRulePreview``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer_automation.types.list_automation_rule_preview_response.ListAutomationRulePreviewResponse = capo_compute_optimizer_automation.types.list_automation_rule_preview_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer_automation.types.list_automation_rule_preview_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_automation_rule_preview(
