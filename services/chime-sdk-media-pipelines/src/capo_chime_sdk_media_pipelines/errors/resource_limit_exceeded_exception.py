"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#ResourceLimitExceededException``."""
...
class ResourceLimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.chimesdkmediapipelines#ResourceLimitExceededException``."""
