"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#ListMediaCapturePipelines``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.list_media_capture_pipelines_response.ListMediaCapturePipelinesResponse = capo_chime_sdk_media_pipelines.types.list_media_capture_pipelines_response.deserialize_json(
...
async def async_list_media_capture_pipelines(
