...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.create_media_concatenation_pipeline_response.CreateMediaConcatenationPipelineResponse = capo_chime_sdk_media_pipelines.types.create_media_concatenation_pipeline_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_media_pipelines.types.create_media_concatenation_pipeline_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
