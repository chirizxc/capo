...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_chime_sdk_media_pipelines.types.list_tags_for_resource_response.deserialize_json(
