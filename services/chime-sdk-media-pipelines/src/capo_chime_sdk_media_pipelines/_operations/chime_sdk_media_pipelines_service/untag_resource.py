...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_media_pipelines.types.untag_resource_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
