...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.list_media_insights_pipeline_configurations_response.ListMediaInsightsPipelineConfigurationsResponse = capo_chime_sdk_media_pipelines.types.list_media_insights_pipeline_configurations_response.deserialize_json(
