"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#UpdateMediaInsightsPipelineConfiguration``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.update_media_insights_pipeline_configuration_response.UpdateMediaInsightsPipelineConfigurationResponse = capo_chime_sdk_media_pipelines.types.update_media_insights_pipeline_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_media_pipelines.types.update_media_insights_pipeline_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_media_insights_pipeline_configuration(
