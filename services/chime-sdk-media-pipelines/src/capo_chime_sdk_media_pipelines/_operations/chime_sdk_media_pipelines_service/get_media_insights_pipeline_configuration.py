"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#GetMediaInsightsPipelineConfiguration``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.get_media_insights_pipeline_configuration_response.GetMediaInsightsPipelineConfigurationResponse = capo_chime_sdk_media_pipelines.types.get_media_insights_pipeline_configuration_response.deserialize_json(
...
async def async_get_media_insights_pipeline_configuration(
