...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.create_media_pipeline_kinesis_video_stream_pool_response.CreateMediaPipelineKinesisVideoStreamPoolResponse = capo_chime_sdk_media_pipelines.types.create_media_pipeline_kinesis_video_stream_pool_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_media_pipelines.types.create_media_pipeline_kinesis_video_stream_pool_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
