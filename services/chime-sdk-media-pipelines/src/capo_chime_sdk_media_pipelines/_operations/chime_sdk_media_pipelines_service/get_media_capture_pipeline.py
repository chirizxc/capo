...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.get_media_capture_pipeline_response.GetMediaCapturePipelineResponse = capo_chime_sdk_media_pipelines.types.get_media_capture_pipeline_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{MediaPipelineId}", quote(input_["media_pipeline_id"], safe=""))
