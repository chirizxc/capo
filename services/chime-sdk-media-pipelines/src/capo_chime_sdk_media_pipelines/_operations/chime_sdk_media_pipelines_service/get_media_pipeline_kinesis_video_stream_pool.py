"""Generated from Smithy shape ``com.amazonaws.chimesdkmediapipelines#GetMediaPipelineKinesisVideoStreamPool``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_media_pipelines.types.get_media_pipeline_kinesis_video_stream_pool_response.GetMediaPipelineKinesisVideoStreamPoolResponse = capo_chime_sdk_media_pipelines.types.get_media_pipeline_kinesis_video_stream_pool_response.deserialize_json(
...
async def async_get_media_pipeline_kinesis_video_stream_pool(
