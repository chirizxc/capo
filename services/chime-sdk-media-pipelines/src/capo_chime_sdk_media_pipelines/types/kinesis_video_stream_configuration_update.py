...
if TYPE_CHECKING:
    import capo_chime_sdk_media_pipelines.types.data_retention_change_in_hours


class KinesisVideoStreamConfigurationUpdate(TypedDict, closed=True):
    data_retention_in_hours: NotRequired[
        "capo_chime_sdk_media_pipelines.types.data_retention_change_in_hours.DataRetentionChangeInHours"
    ]
