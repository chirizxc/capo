...
class GetRestoreTestingPlanOutput(TypedDict, closed=True):
    restore_testing_plan: (
        "capo_backup.types.restore_testing_plan_for_get.RestoreTestingPlanForGet"
    )
...
def serialize_json(value: GetRestoreTestingPlanOutput) -> dict:
    ...
    out["RestoreTestingPlan"] = (
        capo_backup.types.restore_testing_plan_for_get.serialize_json(
...
def deserialize_json(data: dict) -> GetRestoreTestingPlanOutput:
    ...
    if data.get("RestoreTestingPlan") is not None:
        ...
        out["restore_testing_plan"] = (
            capo_backup.types.restore_testing_plan_for_get.deserialize_json(
