...
class ListBackupJobSummariesOutput(TypedDict, closed=True):
    backup_job_summaries: NotRequired[
        "capo_backup.types.backup_job_summary_list.BackupJobSummaryList"
    ]
...
def serialize_json(value: ListBackupJobSummariesOutput) -> dict:
    ...
    if "backup_job_summaries" in value:
        ...
        out["BackupJobSummaries"] = (
            capo_backup.types.backup_job_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListBackupJobSummariesOutput:
    ...
    if data.get("BackupJobSummaries") is not None:
        ...
        out["backup_job_summaries"] = (
            capo_backup.types.backup_job_summary_list.deserialize_json(
