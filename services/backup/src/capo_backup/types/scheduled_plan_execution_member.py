...
class ScheduledPlanExecutionMember(TypedDict, closed=True):
    execution_time: NotRequired["capo_backup.types.timestamp.timestamp"]
    ...
    rule_execution_type: NotRequired[
        "capo_backup.types.rule_execution_type.RuleExecutionType"
    ]
...
def serialize_json(value: ScheduledPlanExecutionMember) -> dict:
    ...
    if "execution_time" in value:
        ...
        out["ExecutionTime"] = capo_backup.types.timestamp.serialize_json(
    ...
    if "rule_execution_type" in value:
        ...
        out["RuleExecutionType"] = capo_backup.types.rule_execution_type.serialize_json(
...
def deserialize_json(data: dict) -> ScheduledPlanExecutionMember:
    ...
    if data.get("RuleExecutionType") is not None:
        ...
        out["rule_execution_type"] = (
            capo_backup.types.rule_execution_type.deserialize_json(
