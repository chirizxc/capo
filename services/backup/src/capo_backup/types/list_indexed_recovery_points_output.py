...
class ListIndexedRecoveryPointsOutput(TypedDict, closed=True):
    indexed_recovery_points: NotRequired[
        "capo_backup.types.indexed_recovery_point_list.IndexedRecoveryPointList"
    ]
...
def serialize_json(value: ListIndexedRecoveryPointsOutput) -> dict:
    ...
    if "indexed_recovery_points" in value:
        ...
        out["IndexedRecoveryPoints"] = (
            capo_backup.types.indexed_recovery_point_list.serialize_json(
...
def deserialize_json(data: dict) -> ListIndexedRecoveryPointsOutput:
    ...
    if data.get("IndexedRecoveryPoints") is not None:
        ...
        out["indexed_recovery_points"] = (
            capo_backup.types.indexed_recovery_point_list.deserialize_json(
