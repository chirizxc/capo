...
def handle_response(
    ...
    out: capo_backup.types.create_framework_output.CreateFrameworkOutput = (
        capo_backup.types.create_framework_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_framework_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_framework(
    ...
    capo_backup.types.create_framework_output.CreateFrameworkOutput, zapros.Response
]:
