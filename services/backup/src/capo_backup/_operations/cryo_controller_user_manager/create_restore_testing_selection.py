"""Generated from Smithy shape ``com.amazonaws.backup#CreateRestoreTestingSelection``."""
...
def handle_response(
    ...
    out: capo_backup.types.create_restore_testing_selection_output.CreateRestoreTestingSelectionOutput = capo_backup.types.create_restore_testing_selection_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_restore_testing_selection_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_restore_testing_selection(
