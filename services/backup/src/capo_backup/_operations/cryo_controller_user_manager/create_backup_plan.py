...
def handle_response(
    ...
    out: capo_backup.types.create_backup_plan_output.CreateBackupPlanOutput = (
        capo_backup.types.create_backup_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_backup_plan_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_backup_plan(
    ...
    capo_backup.types.create_backup_plan_output.CreateBackupPlanOutput, zapros.Response
]:
