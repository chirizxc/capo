"""Generated from Smithy shape ``com.amazonaws.backup#DescribeRecoveryPoint``."""
...
def handle_response(
    ...
    out: capo_backup.types.describe_recovery_point_output.DescribeRecoveryPointOutput = capo_backup.types.describe_recovery_point_output.deserialize_json(
...
async def async_describe_recovery_point(
