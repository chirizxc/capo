"""Generated from Smithy shape ``com.amazonaws.backup#GetRestoreTestingSelection``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_restore_testing_selection_output.GetRestoreTestingSelectionOutput = capo_backup.types.get_restore_testing_selection_output.deserialize_json(
...
async def async_get_restore_testing_selection(
