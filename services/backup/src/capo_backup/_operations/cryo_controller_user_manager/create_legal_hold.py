"""Generated from Smithy shape ``com.amazonaws.backup#CreateLegalHold``."""
...
def handle_response(
    ...
    out: capo_backup.types.create_legal_hold_output.CreateLegalHoldOutput = (
        capo_backup.types.create_legal_hold_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_legal_hold_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_legal_hold(
    ...
    capo_backup.types.create_legal_hold_output.CreateLegalHoldOutput, zapros.Response
]:
...
async def async_create_legal_hold(
