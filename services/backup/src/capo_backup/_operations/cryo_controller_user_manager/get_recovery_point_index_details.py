...
def handle_response(
    ...
    out: capo_backup.types.get_recovery_point_index_details_output.GetRecoveryPointIndexDetailsOutput = capo_backup.types.get_recovery_point_index_details_output.deserialize_json(
