...
def handle_response(
    ...
    out: capo_backup.types.describe_backup_job_output.DescribeBackupJobOutput = (
        capo_backup.types.describe_backup_job_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{BackupJobId}", quote(input_["backup_job_id"], safe=""))
