...
def build_request(
    ...
    if "source_resource_arn" in input_:
        params.append(("sourceResourceArn", input_["source_resource_arn"]))
    if "created_before" in input_:
        params.append(
            (
                "createdBefore",
                capo_backup._protocol.serialize.fmt_date_time(input_["created_before"]),
            )
        )
    if "created_after" in input_:
        params.append(
            (
                "createdAfter",
                capo_backup._protocol.serialize.fmt_date_time(input_["created_after"]),
            )
        )
    ...
    if "index_status" in input_:
        params.append(
            (
                "indexStatus",
                capo_backup.types.index_status.serialize_json(input_["index_status"]),
            )
        )
