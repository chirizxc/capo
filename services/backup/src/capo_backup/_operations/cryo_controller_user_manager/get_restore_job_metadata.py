"""Generated from Smithy shape ``com.amazonaws.backup#GetRestoreJobMetadata``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_restore_job_metadata_output.GetRestoreJobMetadataOutput = capo_backup.types.get_restore_job_metadata_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{RestoreJobId}", quote(input_["restore_job_id"], safe=""))
