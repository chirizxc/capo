...
def build_request(
    ...
    url = url.replace("{LegalHoldId}", quote(input_["legal_hold_id"], safe=""))
    params: list[tuple[str, str]] = []
    if "cancel_description" in input_:
        params.append(("cancelDescription", input_["cancel_description"]))
    if "retain_record_in_days" in input_:
        params.append(("retainRecordInDays", str(input_["retain_record_in_days"])))
