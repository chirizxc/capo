"""Generated from Smithy shape ``com.amazonaws.backup#ListRecoveryPointsByResource``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_recovery_points_by_resource_output.ListRecoveryPointsByResourceOutput = capo_backup.types.list_recovery_points_by_resource_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/resources/{ResourceArn}/recovery-points"
    ...
    params.append(
        (
            ...
            "true" if input_.get("managed_by_aws_backup_only", False) else "false",
        )
    )
...
async def async_list_recovery_points_by_resource(
