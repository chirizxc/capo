...
def build_request(
    ...
    if "by_state" in input_:
        params.append(
            (
                "state",
                capo_backup.types.copy_job_state.serialize_json(input_["by_state"]),
            )
        )
    ...
    if "by_destination_vault_arn" in input_:
        params.append(("destinationVaultArn", input_["by_destination_vault_arn"]))
    ...
    if "by_source_recovery_point_arn" in input_:
        params.append(
            ("sourceRecoveryPointArn", input_["by_source_recovery_point_arn"])
        )
