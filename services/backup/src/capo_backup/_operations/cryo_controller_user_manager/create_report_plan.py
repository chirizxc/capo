"""Generated from Smithy shape ``com.amazonaws.backup#CreateReportPlan``."""
...
def handle_response(
    ...
    out: capo_backup.types.create_report_plan_output.CreateReportPlanOutput = (
        capo_backup.types.create_report_plan_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_report_plan_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_report_plan(
    ...
    capo_backup.types.create_report_plan_output.CreateReportPlanOutput, zapros.Response
]:
...
async def async_create_report_plan(
