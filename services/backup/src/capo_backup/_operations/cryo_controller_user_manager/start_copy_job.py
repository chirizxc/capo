...
def handle_response(
    ...
    out: capo_backup.types.start_copy_job_output.StartCopyJobOutput = (
        capo_backup.types.start_copy_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.start_copy_job_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def start_copy_job(
    ...
    input_: capo_backup.types.start_copy_job_input.StartCopyJobInput,
) -> tuple[capo_backup.types.start_copy_job_output.StartCopyJobOutput, zapros.Response]:
