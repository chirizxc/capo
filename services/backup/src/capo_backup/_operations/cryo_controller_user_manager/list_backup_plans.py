...
def handle_response(
    ...
    out: capo_backup.types.list_backup_plans_output.ListBackupPlansOutput = (
        capo_backup.types.list_backup_plans_output.deserialize_json(
...
def build_request(
    ...
    if "include_deleted" in input_:
        params.append(
            ("includeDeleted", "true" if input_["include_deleted"] else "false")
        )
...
def list_backup_plans(
    ...
    capo_backup.types.list_backup_plans_output.ListBackupPlansOutput, zapros.Response
]:
