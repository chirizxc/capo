"""Generated from Smithy shape ``com.amazonaws.backup#GetRecoveryPointRestoreMetadata``."""
...
def handle_response(
    ...
    out: capo_backup.types.get_recovery_point_restore_metadata_output.GetRecoveryPointRestoreMetadataOutput = capo_backup.types.get_recovery_point_restore_metadata_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{RecoveryPointArn}", quote(input_["recovery_point_arn"], safe="")
    )
...
async def async_get_recovery_point_restore_metadata(
