"""Generated from Smithy shape ``com.amazonaws.backup#GetRestoreTestingPlan``."""
...
import capo_backup.types.restore_testing_plan_for_get
...
def handle_response(
    ...
    out: capo_backup.types.get_restore_testing_plan_output.GetRestoreTestingPlanOutput = capo_backup.types.get_restore_testing_plan_output.deserialize_json(
...
async def async_get_restore_testing_plan(
