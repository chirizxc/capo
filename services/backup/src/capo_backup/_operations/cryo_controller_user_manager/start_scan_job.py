...
def handle_response(
    ...
    out: capo_backup.types.start_scan_job_output.StartScanJobOutput = (
        capo_backup.types.start_scan_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.start_scan_job_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def start_scan_job(
    ...
    input_: capo_backup.types.start_scan_job_input.StartScanJobInput,
) -> tuple[capo_backup.types.start_scan_job_output.StartScanJobOutput, zapros.Response]:
