"""Generated from Smithy shape ``com.amazonaws.backup#DescribeReportJob``."""
...
def handle_response(
    ...
    out: capo_backup.types.describe_report_job_output.DescribeReportJobOutput = (
        capo_backup.types.describe_report_job_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ReportJobId}", quote(input_["report_job_id"], safe=""))
...
async def async_describe_report_job(
