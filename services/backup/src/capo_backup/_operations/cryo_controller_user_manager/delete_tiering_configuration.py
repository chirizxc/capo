...
def handle_response(
    ...
    out: capo_backup.types.delete_tiering_configuration_output.DeleteTieringConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["tiering_configuration_name"], safe=""),
    )
