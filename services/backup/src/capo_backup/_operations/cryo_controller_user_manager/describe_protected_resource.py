"""Generated from Smithy shape ``com.amazonaws.backup#DescribeProtectedResource``."""
...
def handle_response(
    ...
    out: capo_backup.types.describe_protected_resource_output.DescribeProtectedResourceOutput = capo_backup.types.describe_protected_resource_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/resources/{ResourceArn}"
...
async def async_describe_protected_resource(
