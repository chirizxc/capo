"""Generated from Smithy shape ``com.amazonaws.backup#DescribeCopyJob``."""
...
def handle_response(
    ...
    out: capo_backup.types.describe_copy_job_output.DescribeCopyJobOutput = (
        capo_backup.types.describe_copy_job_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/copy-jobs/{CopyJobId}"
    url = url.replace("{CopyJobId}", quote(input_["copy_job_id"], safe=""))
...
def describe_copy_job(
    ...
    capo_backup.types.describe_copy_job_output.DescribeCopyJobOutput, zapros.Response
]:
...
async def async_describe_copy_job(
