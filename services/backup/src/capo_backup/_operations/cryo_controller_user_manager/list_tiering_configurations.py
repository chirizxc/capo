...
def handle_response(
    ...
    out: capo_backup.types.list_tiering_configurations_output.ListTieringConfigurationsOutput = capo_backup.types.list_tiering_configurations_output.deserialize_json(
