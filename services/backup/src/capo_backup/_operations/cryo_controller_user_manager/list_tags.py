"""Generated from Smithy shape ``com.amazonaws.backup#ListTags``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_tags_output.ListTagsOutput = (
        capo_backup.types.list_tags_output.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_backup.types.list_tags_output.ListTagsOutput = (
        capo_backup.types.list_tags_output.deserialize_json(
...
def list_tags(
    options: OperationOptions, input_: capo_backup.types.list_tags_input.ListTagsInput
) -> tuple[capo_backup.types.list_tags_output.ListTagsOutput, zapros.Response]:
