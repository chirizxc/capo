...
def handle_response(
    ...
    out: capo_backup.types.list_backup_plan_templates_output.ListBackupPlanTemplatesOutput = capo_backup.types.list_backup_plan_templates_output.deserialize_json(
