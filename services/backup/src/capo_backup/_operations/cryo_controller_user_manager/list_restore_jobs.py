"""Generated from Smithy shape ``com.amazonaws.backup#ListRestoreJobs``."""
...
def handle_response(
    ...
    out: capo_backup.types.list_restore_jobs_output.ListRestoreJobsOutput = (
        capo_backup.types.list_restore_jobs_output.deserialize_json(
...
def build_request(
    ...
    if "by_status" in input_:
        params.append(
            (
                "status",
                capo_backup.types.restore_job_status.serialize_json(
                    input_["by_status"]
                ),
            )
        )
    ...
    if "by_restore_testing_plan_arn" in input_:
        params.append(("restoreTestingPlanArn", input_["by_restore_testing_plan_arn"]))
...
def list_restore_jobs(
    ...
    capo_backup.types.list_restore_jobs_output.ListRestoreJobsOutput, zapros.Response
]:
