...
def handle_response(
    ...
    out: capo_backup.types.create_logically_air_gapped_backup_vault_output.CreateLogicallyAirGappedBackupVaultOutput = capo_backup.types.create_logically_air_gapped_backup_vault_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backup.types.create_logically_air_gapped_backup_vault_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
