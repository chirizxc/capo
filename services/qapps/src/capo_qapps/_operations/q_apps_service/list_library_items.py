...
def handle_response(
    ...
    out: capo_qapps.types.list_library_items_output.ListLibraryItemsOutput = (
        capo_qapps.types.list_library_items_output.deserialize_json(
...
def build_request(
    ...
    if "category_id" in input_:
        params.append(("categoryId", input_["category_id"]))
...
def list_library_items(
    ...
    capo_qapps.types.list_library_items_output.ListLibraryItemsOutput, zapros.Response
]:
