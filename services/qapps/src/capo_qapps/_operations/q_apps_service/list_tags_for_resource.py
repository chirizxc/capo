"""Generated from Smithy shape ``com.amazonaws.qapps#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_qapps.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_qapps.types.list_tags_for_resource_response.deserialize_json(
