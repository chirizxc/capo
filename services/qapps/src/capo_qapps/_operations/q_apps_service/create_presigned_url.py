...
def handle_response(
    ...
    out: capo_qapps.types.create_presigned_url_output.CreatePresignedUrlOutput = (
        capo_qapps.types.create_presigned_url_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.create_presigned_url_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
