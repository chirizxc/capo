"""Generated from Smithy shape ``com.amazonaws.qapps#ListQApps``."""
...
def handle_response(
    ...
    out: capo_qapps.types.list_q_apps_output.ListQAppsOutput = (
        capo_qapps.types.list_q_apps_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/apps.list"
...
def list_q_apps(
    options: OperationOptions, input_: capo_qapps.types.list_q_apps_input.ListQAppsInput
) -> tuple[capo_qapps.types.list_q_apps_output.ListQAppsOutput, zapros.Response]:
