...
def handle_response(
    ...
    out: capo_qapps.types.get_q_app_session_output.GetQAppSessionOutput = (
        capo_qapps.types.get_q_app_session_output.deserialize_json(
...
def get_q_app_session(
    ...
    capo_qapps.types.get_q_app_session_output.GetQAppSessionOutput, zapros.Response
]:
