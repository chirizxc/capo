...
def handle_response(
    ...
    out: capo_qapps.types.import_document_output.ImportDocumentOutput = (
        capo_qapps.types.import_document_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.import_document_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def import_document(
    ...
    capo_qapps.types.import_document_output.ImportDocumentOutput, zapros.Response
]:
