"""Generated from Smithy shape ``com.amazonaws.qapps#ListQAppSessionData``."""
...
def handle_response(
    ...
    out: capo_qapps.types.list_q_app_session_data_output.ListQAppSessionDataOutput = (
        capo_qapps.types.list_q_app_session_data_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/runtime.listQAppSessionData"
...
async def async_list_q_app_session_data(
