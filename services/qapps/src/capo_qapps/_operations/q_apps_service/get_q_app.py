...
def handle_response(
    ...
    out: capo_qapps.types.get_q_app_output.GetQAppOutput = (
        capo_qapps.types.get_q_app_output.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_qapps.types.get_q_app_output.GetQAppOutput = (
        capo_qapps.types.get_q_app_output.deserialize_json(
...
def build_request(
    ...
    if "app_id" in input_:
        params.append(("appId", input_["app_id"]))
    if "app_version" in input_:
        params.append(("appVersion", str(input_["app_version"])))
...
def get_q_app(
    options: OperationOptions, input_: capo_qapps.types.get_q_app_input.GetQAppInput
) -> tuple[capo_qapps.types.get_q_app_output.GetQAppOutput, zapros.Response]:
