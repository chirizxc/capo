...
def handle_response(
    ...
    out: capo_qapps.types.list_categories_output.ListCategoriesOutput = (
        capo_qapps.types.list_categories_output.deserialize_json(
...
def list_categories(
    ...
    capo_qapps.types.list_categories_output.ListCategoriesOutput, zapros.Response
]:
