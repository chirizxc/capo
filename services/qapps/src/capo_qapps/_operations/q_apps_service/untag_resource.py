"""Generated from Smithy shape ``com.amazonaws.qapps#UntagResource``."""
...
def handle_response(
    ...
    out: capo_qapps.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_qapps.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
