...
def handle_response(
    ...
    out: capo_qapps.types.update_library_item_output.UpdateLibraryItemOutput = (
        capo_qapps.types.update_library_item_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.update_library_item_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_library_item(
    ...
    capo_qapps.types.update_library_item_output.UpdateLibraryItemOutput, zapros.Response
]:
