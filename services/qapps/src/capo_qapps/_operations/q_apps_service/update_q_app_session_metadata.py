...
def handle_response(
    ...
    out: capo_qapps.types.update_q_app_session_metadata_output.UpdateQAppSessionMetadataOutput = capo_qapps.types.update_q_app_session_metadata_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qapps.types.update_q_app_session_metadata_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
