"""Generated from Smithy shape ``com.amazonaws.qapps#UpdateQAppOutput``."""
...
class UpdateQAppOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateQAppOutput) -> dict:
    out: dict = {}
