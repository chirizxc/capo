...
if TYPE_CHECKING:
    ...
    import capo_connectcampaignsv2.types.local_time_zone_detection_scope
    import capo_connectcampaignsv2.types.time_zone


class LocalTimeZoneConfig(TypedDict, closed=True):
    default_time_zone: NotRequired["capo_connectcampaignsv2.types.time_zone.TimeZone"]
    local_time_zone_detection: NotRequired[
        "capo_connectcampaignsv2.types.local_time_zone_detection.LocalTimeZoneDetection"
    ]
    local_time_zone_detection_scope: NotRequired[
        "capo_connectcampaignsv2.types.local_time_zone_detection_scope.LocalTimeZoneDetectionScope"
    ]
...
def serialize_json(value: LocalTimeZoneConfig) -> dict:
    ...
    if "local_time_zone_detection" in value:
        ...
        out["localTimeZoneDetection"] = (
            capo_connectcampaignsv2.types.local_time_zone_detection.serialize_json(
...
def deserialize_json(data: dict) -> LocalTimeZoneConfig:
    ...
    if data.get("localTimeZoneDetection") is not None:
        ...
        out["local_time_zone_detection"] = (
            capo_connectcampaignsv2.types.local_time_zone_detection.deserialize_json(
