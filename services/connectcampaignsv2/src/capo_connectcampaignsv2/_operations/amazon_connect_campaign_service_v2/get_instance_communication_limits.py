...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.get_instance_communication_limits_response.GetInstanceCommunicationLimitsResponse = capo_connectcampaignsv2.types.get_instance_communication_limits_response.deserialize_json(
