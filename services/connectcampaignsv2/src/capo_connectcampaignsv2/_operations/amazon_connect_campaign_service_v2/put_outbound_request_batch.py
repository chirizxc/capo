...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.put_outbound_request_batch_response.PutOutboundRequestBatchResponse = capo_connectcampaignsv2.types.put_outbound_request_batch_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connectcampaignsv2.types.put_outbound_request_batch_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
