"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_connectcampaignsv2.types.list_tags_for_resource_response.deserialize_json(
