"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#GetInstanceOnboardingJobStatus``."""
...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.get_instance_onboarding_job_status_response.GetInstanceOnboardingJobStatusResponse = capo_connectcampaignsv2.types.get_instance_onboarding_job_status_response.deserialize_json(
...
async def async_get_instance_onboarding_job_status(
