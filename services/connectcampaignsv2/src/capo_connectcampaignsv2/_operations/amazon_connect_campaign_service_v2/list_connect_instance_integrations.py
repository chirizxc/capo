"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#ListConnectInstanceIntegrations``."""
...
def handle_response(
    ...
    out: capo_connectcampaignsv2.types.list_connect_instance_integrations_response.ListConnectInstanceIntegrationsResponse = capo_connectcampaignsv2.types.list_connect_instance_integrations_response.deserialize_json(
...
async def async_list_connect_instance_integrations(
