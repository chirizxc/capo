"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#InvalidStateException``."""
...
class InvalidStateException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.connectcampaignsv2#InvalidStateException``."""
