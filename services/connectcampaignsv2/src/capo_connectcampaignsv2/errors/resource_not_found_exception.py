"""Generated from Smithy shape ``com.amazonaws.connectcampaignsv2#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.connectcampaignsv2#ResourceNotFoundException``."""
