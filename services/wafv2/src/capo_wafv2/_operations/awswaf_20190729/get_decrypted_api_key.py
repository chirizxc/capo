...
def handle_response(
    ...
    out: capo_wafv2.types.get_decrypted_api_key_response.GetDecryptedAPIKeyResponse = (
        capo_wafv2.types.get_decrypted_api_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_decrypted_api_key_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
