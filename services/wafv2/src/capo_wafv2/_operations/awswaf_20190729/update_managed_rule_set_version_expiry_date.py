...
def handle_response(
    ...
    out: capo_wafv2.types.update_managed_rule_set_version_expiry_date_response.UpdateManagedRuleSetVersionExpiryDateResponse = capo_wafv2.types.update_managed_rule_set_version_expiry_date_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.update_managed_rule_set_version_expiry_date_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
