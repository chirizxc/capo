...
def handle_response(
    ...
    out: capo_wafv2.types.associate_web_acl_response.AssociateWebACLResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.associate_web_acl_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def associate_web_acl(
    ...
    capo_wafv2.types.associate_web_acl_response.AssociateWebACLResponse, zapros.Response
]:
