...
def handle_response(
    ...
    out: capo_wafv2.types.list_available_managed_rule_group_versions_response.ListAvailableManagedRuleGroupVersionsResponse = capo_wafv2.types.list_available_managed_rule_group_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_available_managed_rule_group_versions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
