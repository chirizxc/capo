...
def handle_response(
    ...
    out: capo_wafv2.types.get_permission_policy_response.GetPermissionPolicyResponse = (
        capo_wafv2.types.get_permission_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_permission_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
