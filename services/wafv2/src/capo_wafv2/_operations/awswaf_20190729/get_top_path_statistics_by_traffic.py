"""Generated from Smithy shape ``com.amazonaws.wafv2#GetTopPathStatisticsByTraffic``."""
...
import capo_wafv2._protocol.eventstream
...
def handle_response(
    ...
    out: capo_wafv2.types.get_top_path_statistics_by_traffic_response.GetTopPathStatisticsByTrafficResponse = capo_wafv2.types.get_top_path_statistics_by_traffic_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_wafv2._auth._sigv4.build_sigv4_auth_scheme(
                "wafv2", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.GetTopPathStatisticsByTraffic"
    body: bytes | None = json.dumps(
        capo_wafv2.types.get_top_path_statistics_by_traffic_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_top_path_statistics_by_traffic(
