...
def handle_response(
    ...
    out: capo_wafv2.types.put_managed_rule_set_versions_response.PutManagedRuleSetVersionsResponse = capo_wafv2.types.put_managed_rule_set_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.put_managed_rule_set_versions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
