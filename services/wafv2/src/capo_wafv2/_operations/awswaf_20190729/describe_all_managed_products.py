"""Generated from Smithy shape ``com.amazonaws.wafv2#DescribeAllManagedProducts``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.describe_all_managed_products_response.DescribeAllManagedProductsResponse = capo_wafv2.types.describe_all_managed_products_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.DescribeAllManagedProducts"
    body: bytes | None = json.dumps(
        capo_wafv2.types.describe_all_managed_products_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_all_managed_products(
