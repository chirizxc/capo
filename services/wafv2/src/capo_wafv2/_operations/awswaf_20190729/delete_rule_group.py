...
def handle_response(
    ...
    out: capo_wafv2.types.delete_rule_group_response.DeleteRuleGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.delete_rule_group_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_rule_group(
    ...
    capo_wafv2.types.delete_rule_group_response.DeleteRuleGroupResponse, zapros.Response
]:
