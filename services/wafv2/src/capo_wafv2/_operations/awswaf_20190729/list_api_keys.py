...
def handle_response(
    ...
    out: capo_wafv2.types.list_api_keys_response.ListAPIKeysResponse = (
        capo_wafv2.types.list_api_keys_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_api_keys_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_api_keys(
    ...
    capo_wafv2.types.list_api_keys_response.ListAPIKeysResponse, zapros.Response
]:
