"""Generated from Smithy shape ``com.amazonaws.wafv2#DeleteIPSet``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.delete_ip_set_response.DeleteIPSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.delete_ip_set_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_ip_set(
    ...
    capo_wafv2.types.delete_ip_set_response.DeleteIPSetResponse, zapros.Response
]:
