"""Generated from Smithy shape ``com.amazonaws.wafv2#UpdateIPSet``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.update_ip_set_response.UpdateIPSetResponse = (
        capo_wafv2.types.update_ip_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.update_ip_set_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_ip_set(
    ...
    capo_wafv2.types.update_ip_set_response.UpdateIPSetResponse, zapros.Response
]:
