"""Generated from Smithy shape ``com.amazonaws.wafv2#DeleteWebACL``."""
...
import capo_wafv2.errors.waf_associated_item_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "WAFAssociatedItemException":
            raise capo_wafv2.errors.waf_associated_item_exception.WAFAssociatedItemException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_wafv2.types.delete_web_acl_response.DeleteWebACLResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.delete_web_acl_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_web_acl(
    ...
    capo_wafv2.types.delete_web_acl_response.DeleteWebACLResponse, zapros.Response
]:
