"""Generated from Smithy shape ``com.amazonaws.wafv2#CreateRegexPatternSet``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.create_regex_pattern_set_response.CreateRegexPatternSetResponse = capo_wafv2.types.create_regex_pattern_set_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.create_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_regex_pattern_set(
