...
def handle_response(
    ...
    out: capo_wafv2.types.check_capacity_response.CheckCapacityResponse = (
        capo_wafv2.types.check_capacity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.check_capacity_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def check_capacity(
    ...
    capo_wafv2.types.check_capacity_response.CheckCapacityResponse, zapros.Response
]:
