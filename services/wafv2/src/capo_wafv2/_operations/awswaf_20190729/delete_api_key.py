"""Generated from Smithy shape ``com.amazonaws.wafv2#DeleteAPIKey``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.delete_api_key_response.DeleteAPIKeyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.DeleteAPIKey"
    body: bytes | None = json.dumps(
        capo_wafv2.types.delete_api_key_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_api_key(
    ...
    capo_wafv2.types.delete_api_key_response.DeleteAPIKeyResponse, zapros.Response
]:
