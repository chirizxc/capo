...
def handle_response(
    ...
    out: capo_wafv2.types.create_rule_group_response.CreateRuleGroupResponse = (
        capo_wafv2.types.create_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.create_rule_group_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_rule_group(
    ...
    capo_wafv2.types.create_rule_group_response.CreateRuleGroupResponse, zapros.Response
]:
