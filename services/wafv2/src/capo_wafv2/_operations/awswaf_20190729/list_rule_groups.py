"""Generated from Smithy shape ``com.amazonaws.wafv2#ListRuleGroups``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.list_rule_groups_response.ListRuleGroupsResponse = (
        capo_wafv2.types.list_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_rule_groups_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_rule_groups(
    ...
    capo_wafv2.types.list_rule_groups_response.ListRuleGroupsResponse, zapros.Response
]:
