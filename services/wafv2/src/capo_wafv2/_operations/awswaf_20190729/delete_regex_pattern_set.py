...
def handle_response(
    ...
    out: capo_wafv2.types.delete_regex_pattern_set_response.DeleteRegexPatternSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.delete_regex_pattern_set_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
