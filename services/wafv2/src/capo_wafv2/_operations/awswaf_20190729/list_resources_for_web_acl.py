...
def handle_response(
    ...
    out: capo_wafv2.types.list_resources_for_web_acl_response.ListResourcesForWebACLResponse = capo_wafv2.types.list_resources_for_web_acl_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_resources_for_web_acl_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
