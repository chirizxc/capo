"""Generated from Smithy shape ``com.amazonaws.wafv2#ListManagedRuleSets``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.list_managed_rule_sets_response.ListManagedRuleSetsResponse = capo_wafv2.types.list_managed_rule_sets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSWAF_20190729.ListManagedRuleSets"
    body: bytes | None = json.dumps(
        capo_wafv2.types.list_managed_rule_sets_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_managed_rule_sets(
