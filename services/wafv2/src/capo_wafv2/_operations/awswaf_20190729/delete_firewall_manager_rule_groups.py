...
def handle_response(
    ...
    out: capo_wafv2.types.delete_firewall_manager_rule_groups_response.DeleteFirewallManagerRuleGroupsResponse = capo_wafv2.types.delete_firewall_manager_rule_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.delete_firewall_manager_rule_groups_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
