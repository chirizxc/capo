"""Generated from Smithy shape ``com.amazonaws.wafv2#DescribeManagedRuleGroup``."""
...
def handle_response(
    ...
    out: capo_wafv2.types.describe_managed_rule_group_response.DescribeManagedRuleGroupResponse = capo_wafv2.types.describe_managed_rule_group_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wafv2.types.describe_managed_rule_group_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_managed_rule_group(
