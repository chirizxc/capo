...
def serialize_aws_json_1_1(value: LabelMatchStatement) -> dict:
    ...
    out["Scope"] = capo_wafv2.types.label_match_scope.serialize_aws_json_1_1(
        value["scope"]
    )
    out["Key"] = value["key"]
    return out
