...
class GetRuleGroupResponse(TypedDict, closed=True):
    rule_group: NotRequired["capo_wafv2.types.rule_group.RuleGroup"]
    """<p></p>"""
...
def serialize_aws_json_1_1(value: GetRuleGroupResponse) -> dict:
    ...
    if "rule_group" in value:
        ...
        out["RuleGroup"] = capo_wafv2.types.rule_group.serialize_aws_json_1_1(
            value["rule_group"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetRuleGroupResponse:
    ...
    if data.get("RuleGroup") is not None:
        ...
        out["rule_group"] = capo_wafv2.types.rule_group.deserialize_aws_json_1_1(
            data["RuleGroup"]
        )
