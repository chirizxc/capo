"""Generated from Smithy shape ``com.amazonaws.wafv2#UntagResourceRequest``."""
...
def serialize_aws_json_1_1(value: UntagResourceRequest) -> dict:
    ...
    out["TagKeys"] = capo_wafv2.types.tag_key_list.serialize_aws_json_1_1(
        value["tag_keys"]
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UntagResourceRequest:
    ...
    if data.get("TagKeys") is not None:
        ...
        out["tag_keys"] = capo_wafv2.types.tag_key_list.deserialize_aws_json_1_1(
            data["TagKeys"]
        )
    else:
