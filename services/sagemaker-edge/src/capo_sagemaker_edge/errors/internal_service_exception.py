...
from capo_sagemaker_edge.errors import ServiceError

if TYPE_CHECKING:
    import capo_sagemaker_edge.types.error_message


class InternalServiceException_(TypedDict, closed=True):
    message: NotRequired["capo_sagemaker_edge.types.error_message.ErrorMessage"]
