...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.get_recommendations_response.GetRecommendationsResponse = capo_codeguruprofiler.types.get_recommendations_response.deserialize_json(
