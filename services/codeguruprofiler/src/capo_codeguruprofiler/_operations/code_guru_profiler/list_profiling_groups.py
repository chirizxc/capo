"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#ListProfilingGroups``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.list_profiling_groups_response.ListProfilingGroupsResponse = capo_codeguruprofiler.types.list_profiling_groups_response.deserialize_json(
...
def build_request(
    ...
    if "include_description" in input_:
        params.append(
            ("includeDescription", "true" if input_["include_description"] else "false")
        )
...
async def async_list_profiling_groups(
