...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_codeguruprofiler.types.list_tags_for_resource_response.deserialize_json(
