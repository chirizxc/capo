...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.get_findings_report_account_summary_response.GetFindingsReportAccountSummaryResponse = capo_codeguruprofiler.types.get_findings_report_account_summary_response.deserialize_json(
