...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.remove_permission_response.RemovePermissionResponse = capo_codeguruprofiler.types.remove_permission_response.deserialize_json(
