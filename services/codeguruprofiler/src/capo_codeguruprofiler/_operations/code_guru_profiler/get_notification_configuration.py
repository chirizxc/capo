"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#GetNotificationConfiguration``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.get_notification_configuration_response.GetNotificationConfigurationResponse = capo_codeguruprofiler.types.get_notification_configuration_response.deserialize_json(
