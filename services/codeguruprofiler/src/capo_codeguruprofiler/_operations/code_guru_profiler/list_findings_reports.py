"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#ListFindingsReports``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.list_findings_reports_response.ListFindingsReportsResponse = capo_codeguruprofiler.types.list_findings_reports_response.deserialize_json(
...
def build_request(
    ...
    if "daily_reports_only" in input_:
        params.append(
            ("dailyReportsOnly", "true" if input_["daily_reports_only"] else "false")
        )
...
async def async_list_findings_reports(
