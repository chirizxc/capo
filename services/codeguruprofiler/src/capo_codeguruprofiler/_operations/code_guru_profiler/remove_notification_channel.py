"""Generated from Smithy shape ``com.amazonaws.codeguruprofiler#RemoveNotificationChannel``."""
...
def handle_response(
    ...
    out: capo_codeguruprofiler.types.remove_notification_channel_response.RemoveNotificationChannelResponse = capo_codeguruprofiler.types.remove_notification_channel_response.deserialize_json(
