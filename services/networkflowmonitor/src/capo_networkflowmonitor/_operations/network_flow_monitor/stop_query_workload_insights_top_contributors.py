"""Generated from Smithy shape ``com.amazonaws.networkflowmonitor#StopQueryWorkloadInsightsTopContributors``."""
...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.stop_query_workload_insights_top_contributors_output.StopQueryWorkloadInsightsTopContributorsOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_stop_query_workload_insights_top_contributors(
