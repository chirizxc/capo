"""Generated from Smithy shape ``com.amazonaws.networkflowmonitor#StopQueryWorkloadInsightsTopContributorsData``."""
...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.stop_query_workload_insights_top_contributors_data_output.StopQueryWorkloadInsightsTopContributorsDataOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_stop_query_workload_insights_top_contributors_data(
