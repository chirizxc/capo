...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.update_monitor_output.UpdateMonitorOutput = (
        capo_networkflowmonitor.types.update_monitor_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkflowmonitor.types.update_monitor_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
