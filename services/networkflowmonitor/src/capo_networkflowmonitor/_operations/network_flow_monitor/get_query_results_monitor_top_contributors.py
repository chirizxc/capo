...
def handle_response(
    ...
    out: capo_networkflowmonitor.types.get_query_results_monitor_top_contributors_output.GetQueryResultsMonitorTopContributorsOutput = capo_networkflowmonitor.types.get_query_results_monitor_top_contributors_output.deserialize_json(
