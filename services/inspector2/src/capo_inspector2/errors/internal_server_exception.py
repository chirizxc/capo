"""Generated from Smithy shape ``com.amazonaws.inspector2#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.inspector2#InternalServerException``."""
