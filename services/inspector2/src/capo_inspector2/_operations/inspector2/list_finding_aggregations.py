...
def handle_response(
    ...
    out: capo_inspector2.types.list_finding_aggregations_response.ListFindingAggregationsResponse = capo_inspector2.types.list_finding_aggregations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_finding_aggregations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
