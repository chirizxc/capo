...
def handle_response(
    ...
    out: capo_inspector2.types.associate_member_response.AssociateMemberResponse = (
        capo_inspector2.types.associate_member_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.associate_member_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
