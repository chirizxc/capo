...
import capo_inspector2.types.usage_total_list
...
def handle_response(
    ...
    out: capo_inspector2.types.list_usage_totals_response.ListUsageTotalsResponse = (
        capo_inspector2.types.list_usage_totals_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_usage_totals_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
