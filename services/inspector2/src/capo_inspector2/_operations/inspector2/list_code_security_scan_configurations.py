"""Generated from Smithy shape ``com.amazonaws.inspector2#ListCodeSecurityScanConfigurations``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.list_code_security_scan_configurations_response.ListCodeSecurityScanConfigurationsResponse = capo_inspector2.types.list_code_security_scan_configurations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/codesecurity/scan-configuration/list"
...
async def async_list_code_security_scan_configurations(
