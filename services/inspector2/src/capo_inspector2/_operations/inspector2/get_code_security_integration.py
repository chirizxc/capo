"""Generated from Smithy shape ``com.amazonaws.inspector2#GetCodeSecurityIntegration``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.get_code_security_integration_response.GetCodeSecurityIntegrationResponse = capo_inspector2.types.get_code_security_integration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.get_code_security_integration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_code_security_integration(
