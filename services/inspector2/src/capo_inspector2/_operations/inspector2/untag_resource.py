"""Generated from Smithy shape ``com.amazonaws.inspector2#UntagResource``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_inspector2.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
