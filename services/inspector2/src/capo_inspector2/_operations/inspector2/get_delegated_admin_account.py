...
def handle_response(
    ...
    out: capo_inspector2.types.get_delegated_admin_account_response.GetDelegatedAdminAccountResponse = capo_inspector2.types.get_delegated_admin_account_response.deserialize_json(
