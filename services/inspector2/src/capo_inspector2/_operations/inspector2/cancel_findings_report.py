...
def handle_response(
    ...
    out: capo_inspector2.types.cancel_findings_report_response.CancelFindingsReportResponse = capo_inspector2.types.cancel_findings_report_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.cancel_findings_report_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
