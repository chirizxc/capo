...
import capo_inspector2.types.cis_scan_list
...
def handle_response(
    ...
    out: capo_inspector2.types.list_cis_scans_response.ListCisScansResponse = (
        capo_inspector2.types.list_cis_scans_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_cis_scans_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_cis_scans(
    ...
    capo_inspector2.types.list_cis_scans_response.ListCisScansResponse, zapros.Response
]:
