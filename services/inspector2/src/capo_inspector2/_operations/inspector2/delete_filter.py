...
def handle_response(
    ...
    out: capo_inspector2.types.delete_filter_response.DeleteFilterResponse = (
        capo_inspector2.types.delete_filter_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.delete_filter_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def delete_filter(
    ...
    capo_inspector2.types.delete_filter_response.DeleteFilterResponse, zapros.Response
]:
