"""Generated from Smithy shape ``com.amazonaws.inspector2#ListCodeSecurityIntegrations``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.list_code_security_integrations_response.ListCodeSecurityIntegrationsResponse = capo_inspector2.types.list_code_security_integrations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/codesecurity/integration/list"
...
async def async_list_code_security_integrations(
