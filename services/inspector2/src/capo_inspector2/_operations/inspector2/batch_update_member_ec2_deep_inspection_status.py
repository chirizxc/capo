...
def handle_response(
    ...
    out: capo_inspector2.types.batch_update_member_ec2_deep_inspection_status_response.BatchUpdateMemberEc2DeepInspectionStatusResponse = capo_inspector2.types.batch_update_member_ec2_deep_inspection_status_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.batch_update_member_ec2_deep_inspection_status_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
