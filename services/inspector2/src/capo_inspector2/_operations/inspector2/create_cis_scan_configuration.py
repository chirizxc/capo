...
def handle_response(
    ...
    out: capo_inspector2.types.create_cis_scan_configuration_response.CreateCisScanConfigurationResponse = capo_inspector2.types.create_cis_scan_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.create_cis_scan_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
