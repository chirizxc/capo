...
def handle_response(
    ...
    out: capo_inspector2.types.list_findings_response.ListFindingsResponse = (
        capo_inspector2.types.list_findings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_findings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_findings(
    ...
    capo_inspector2.types.list_findings_response.ListFindingsResponse, zapros.Response
]:
