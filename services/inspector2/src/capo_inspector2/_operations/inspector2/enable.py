...
def handle_response(
    ...
    out: capo_inspector2.types.enable_response.EnableResponse = (
        capo_inspector2.types.enable_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.enable_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def enable(
    ...
    input_: capo_inspector2.types.enable_request.EnableRequest,
) -> tuple[capo_inspector2.types.enable_response.EnableResponse, zapros.Response]:
