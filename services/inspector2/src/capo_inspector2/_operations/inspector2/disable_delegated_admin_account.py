...
def handle_response(
    ...
    out: capo_inspector2.types.disable_delegated_admin_account_response.DisableDelegatedAdminAccountResponse = capo_inspector2.types.disable_delegated_admin_account_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.disable_delegated_admin_account_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
