...
def handle_response(
    ...
    out: capo_inspector2.types.batch_get_code_snippet_response.BatchGetCodeSnippetResponse = capo_inspector2.types.batch_get_code_snippet_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.batch_get_code_snippet_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
