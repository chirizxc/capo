"""Generated from Smithy shape ``com.amazonaws.inspector2#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_inspector2.types.list_tags_for_resource_response.deserialize_json(
