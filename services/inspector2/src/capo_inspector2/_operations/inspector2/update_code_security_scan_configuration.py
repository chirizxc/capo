...
def handle_response(
    ...
    out: capo_inspector2.types.update_code_security_scan_configuration_response.UpdateCodeSecurityScanConfigurationResponse = capo_inspector2.types.update_code_security_scan_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.update_code_security_scan_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
