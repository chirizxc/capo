...
def handle_response(
    ...
    out: capo_inspector2.types.batch_get_account_status_response.BatchGetAccountStatusResponse = capo_inspector2.types.batch_get_account_status_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.batch_get_account_status_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
