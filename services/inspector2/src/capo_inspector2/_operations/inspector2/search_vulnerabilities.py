...
def handle_response(
    ...
    out: capo_inspector2.types.search_vulnerabilities_response.SearchVulnerabilitiesResponse = capo_inspector2.types.search_vulnerabilities_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.search_vulnerabilities_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
