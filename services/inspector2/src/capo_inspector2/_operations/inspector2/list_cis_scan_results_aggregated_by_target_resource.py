"""Generated from Smithy shape ``com.amazonaws.inspector2#ListCisScanResultsAggregatedByTargetResource``."""
...
def handle_response(
    ...
    out: capo_inspector2.types.list_cis_scan_results_aggregated_by_target_resource_response.ListCisScanResultsAggregatedByTargetResourceResponse = capo_inspector2.types.list_cis_scan_results_aggregated_by_target_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector2.types.list_cis_scan_results_aggregated_by_target_resource_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_cis_scan_results_aggregated_by_target_resource(
