...
class ScopeSettings(TypedDict, closed=True):
    project_selection_scope: NotRequired[
        "capo_inspector2.types.project_selection_scope.ProjectSelectionScope"
    ]
...
def serialize_json(value: ScopeSettings) -> dict:
    ...
    if "project_selection_scope" in value:
        ...
        out["projectSelectionScope"] = (
            capo_inspector2.types.project_selection_scope.serialize_json(
...
def deserialize_json(data: dict) -> ScopeSettings:
    ...
    if data.get("projectSelectionScope") is not None:
        ...
        out["project_selection_scope"] = (
            capo_inspector2.types.project_selection_scope.deserialize_json(
