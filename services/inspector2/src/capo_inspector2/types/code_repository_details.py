...
if TYPE_CHECKING:
    ...
    import capo_inspector2.types.code_repository_project_name
    import capo_inspector2.types.code_repository_provider_type


class CodeRepositoryDetails(TypedDict, closed=True):
    project_name: NotRequired[
        "capo_inspector2.types.code_repository_project_name.CodeRepositoryProjectName"
    ]
    ...
    provider_type: NotRequired[
        "capo_inspector2.types.code_repository_provider_type.CodeRepositoryProviderType"
    ]
