...
if TYPE_CHECKING:
    import capo_inspector2.types.aws_eks_workload_info

AwsEksWorkloadInfoList: TypeAlias = list[
    "capo_inspector2.types.aws_eks_workload_info.AwsEksWorkloadInfo"
]
...
def serialize_json(value: AwsEksWorkloadInfoList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_inspector2.types.aws_eks_workload_info.serialize_json(item))
    return out
