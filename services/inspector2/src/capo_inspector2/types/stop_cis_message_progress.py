...
if TYPE_CHECKING:
    import capo_inspector2.types.check_count


class StopCisMessageProgress(TypedDict, closed=True):
    total_checks: "capo_inspector2.types.check_count.CheckCount"
    """<p>The progress' total checks.</p>"""
    successful_checks: "capo_inspector2.types.check_count.CheckCount"
    """<p>The progress' successful checks.</p>"""
    failed_checks: "capo_inspector2.types.check_count.CheckCount"
    """<p>The progress' failed checks.</p>"""
    not_evaluated_checks: "capo_inspector2.types.check_count.CheckCount"
    """<p>The progress' not evaluated checks.</p>"""
    unknown_checks: "capo_inspector2.types.check_count.CheckCount"
    """<p>The progress' unknown checks.</p>"""
    not_applicable_checks: "capo_inspector2.types.check_count.CheckCount"
    """<p>The progress' not applicable checks.</p>"""
    informational_checks: "capo_inspector2.types.check_count.CheckCount"
    """<p>The progress' informational checks.</p>"""
    error_checks: "capo_inspector2.types.check_count.CheckCount"
