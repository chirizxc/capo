...
if TYPE_CHECKING:
    import capo_inspector2.types.validation_exception_field

ValidationExceptionFields: TypeAlias = list[
    "capo_inspector2.types.validation_exception_field.ValidationExceptionField"
]
...
def serialize_json(value: ValidationExceptionFields) -> list:
    ...
    for item in value:
        out.append(
            capo_inspector2.types.validation_exception_field.serialize_json(item)
        )
    return out
