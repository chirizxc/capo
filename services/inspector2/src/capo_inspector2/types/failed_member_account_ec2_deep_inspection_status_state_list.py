...
if TYPE_CHECKING:
    import capo_inspector2.types.failed_member_account_ec2_deep_inspection_status_state

FailedMemberAccountEc2DeepInspectionStatusStateList: TypeAlias = list[
    "capo_inspector2.types.failed_member_account_ec2_deep_inspection_status_state.FailedMemberAccountEc2DeepInspectionStatusState"
]
...
def serialize_json(value: FailedMemberAccountEc2DeepInspectionStatusStateList) -> list:
    ...
    for item in value:
        out.append(
            capo_inspector2.types.failed_member_account_ec2_deep_inspection_status_state.serialize_json(
                item
            )
        )
    return out
