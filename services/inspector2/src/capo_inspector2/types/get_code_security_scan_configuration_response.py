...
class GetCodeSecurityScanConfigurationResponse(TypedDict, closed=True):
    ...
    name: NotRequired[
        "capo_inspector2.types.scan_configuration_name.ScanConfigurationName"
    ]
    """<p>The name of the scan configuration.</p>"""
    configuration: NotRequired[
        "capo_inspector2.types.code_security_scan_configuration.CodeSecurityScanConfiguration"
    ]
    """<p>The configuration settings for the code security scan.</p>"""
    level: NotRequired["capo_inspector2.types.configuration_level.ConfigurationLevel"]
...
def serialize_json(value: GetCodeSecurityScanConfigurationResponse) -> dict:
    ...
    if "last_updated_at" in value:
        ...
        out["lastUpdatedAt"] = capo_inspector2.types._prelude.timestamp.serialize_json(
