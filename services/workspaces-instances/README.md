...
```
pip install capo-workspaces-instances
```

## Usage

```python
from capo_workspaces_instances import AsyncWorkspacesInstancesClient
...
```python
from capo_workspaces_instances import AsyncWorkspacesInstancesClient
from capo_workspaces_instances.error import AccessDeniedException
