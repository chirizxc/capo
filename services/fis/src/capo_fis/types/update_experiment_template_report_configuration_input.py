"""Generated from Smithy shape ``com.amazonaws.fis#UpdateExperimentTemplateReportConfigurationInput``."""
...
class UpdateExperimentTemplateReportConfigurationInput(TypedDict, closed=True):
    outputs: NotRequired[
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateExperimentTemplateReportConfigurationInput) -> dict:
    out: dict = {}
    if "outputs" in value:
        import capo_fis.types.experiment_template_report_configuration_outputs_input
...
def deserialize_json(data: dict) -> UpdateExperimentTemplateReportConfigurationInput:
    out: UpdateExperimentTemplateReportConfigurationInput = {}  # type: ignore[typeddict-item]
