...
if TYPE_CHECKING:
    import capo_fis.types.experiment_template_action_parameter
    import capo_fis.types.experiment_template_action_parameter_name

ExperimentTemplateActionParameterMap: TypeAlias = dict[
    "capo_fis.types.experiment_template_action_parameter_name.ExperimentTemplateActionParameterName",
    "capo_fis.types.experiment_template_action_parameter.ExperimentTemplateActionParameter",
]
