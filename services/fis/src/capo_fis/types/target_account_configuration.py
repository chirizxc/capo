"""Generated from Smithy shape ``com.amazonaws.fis#TargetAccountConfiguration``."""
...
class TargetAccountConfiguration(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: TargetAccountConfiguration) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> TargetAccountConfiguration:
    out: TargetAccountConfiguration = {}  # type: ignore[typeddict-item]
