...
class ExperimentTemplateReportConfigurationDataSourcesInput(TypedDict, closed=True):
    cloud_watch_dashboards: NotRequired[
        "capo_fis.types.report_configuration_cloud_watch_dashboard_input_list.ReportConfigurationCloudWatchDashboardInputList"
    ]
...
def serialize_json(
    ...
    if "cloud_watch_dashboards" in value:
        ...
        out["cloudWatchDashboards"] = (
            capo_fis.types.report_configuration_cloud_watch_dashboard_input_list.serialize_json(
...
def deserialize_json(
    ...
    if data.get("cloudWatchDashboards") is not None:
        ...
        out["cloud_watch_dashboards"] = (
            capo_fis.types.report_configuration_cloud_watch_dashboard_input_list.deserialize_json(
