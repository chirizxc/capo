...
if TYPE_CHECKING:
    import capo_fis.types.experiment_error_account_id
    import capo_fis.types.experiment_error_code
    import capo_fis.types.experiment_error_location


class ExperimentError(TypedDict, closed=True):
    account_id: NotRequired[
        "capo_fis.types.experiment_error_account_id.ExperimentErrorAccountId"
    ]
    """<p>The Amazon Web Services Account ID where the experiment failure occurred.</p>"""
    code: NotRequired["capo_fis.types.experiment_error_code.ExperimentErrorCode"]
    """<p>The error code for the failed experiment.</p>"""
    location: NotRequired[
        "capo_fis.types.experiment_error_location.ExperimentErrorLocation"
    ]
