"""Generated from Smithy shape ``com.amazonaws.fis#GetExperimentResponse``."""
...
class GetExperimentResponse(TypedDict, closed=True):
    experiment: NotRequired["capo_fis.types.experiment.Experiment"]
    """<p>Information about the experiment.</p>"""


# --- restJson1 ser/de ---
def serialize_json(value: GetExperimentResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetExperimentResponse:
    out: GetExperimentResponse = {}  # type: ignore[typeddict-item]
