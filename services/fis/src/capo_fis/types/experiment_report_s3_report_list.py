...
if TYPE_CHECKING:
    import capo_fis.types.experiment_report_s3_report

ExperimentReportS3ReportList: TypeAlias = list[
    "capo_fis.types.experiment_report_s3_report.ExperimentReportS3Report"
]
...
def serialize_json(value: ExperimentReportS3ReportList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_fis.types.experiment_report_s3_report.serialize_json(item))
    return out
