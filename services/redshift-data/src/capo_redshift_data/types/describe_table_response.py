...
class DescribeTableResponse(TypedDict, closed=True):
    ...
    """<p>The table name. </p>"""
    column_list: NotRequired["capo_redshift_data.types.column_list.ColumnList"]
...
def serialize_aws_json_1_1(value: DescribeTableResponse) -> dict:
    ...
    if "column_list" in value:
        ...
        out["ColumnList"] = capo_redshift_data.types.column_list.serialize_aws_json_1_1(
            value["column_list"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTableResponse:
    ...
    if data.get("ColumnList") is not None:
        ...
        out["column_list"] = (
            capo_redshift_data.types.column_list.deserialize_aws_json_1_1(
                data["ColumnList"]
            )
        )
