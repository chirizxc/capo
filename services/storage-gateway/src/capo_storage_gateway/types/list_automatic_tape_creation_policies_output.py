...
class ListAutomaticTapeCreationPoliciesOutput(TypedDict, closed=True):
    automatic_tape_creation_policy_infos: NotRequired[
        "capo_storage_gateway.types.automatic_tape_creation_policy_infos.AutomaticTapeCreationPolicyInfos"
    ]
...
def serialize_aws_json_1_1(value: ListAutomaticTapeCreationPoliciesOutput) -> dict:
    ...
    if "automatic_tape_creation_policy_infos" in value:
        ...
        out["AutomaticTapeCreationPolicyInfos"] = (
            capo_storage_gateway.types.automatic_tape_creation_policy_infos.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListAutomaticTapeCreationPoliciesOutput:
    ...
    if data.get("AutomaticTapeCreationPolicyInfos") is not None:
        import capo_storage_gateway.types.automatic_tape_creation_policy_infos

        out["automatic_tape_creation_policy_infos"] = (
            capo_storage_gateway.types.automatic_tape_creation_policy_infos.deserialize_aws_json_1_1(
