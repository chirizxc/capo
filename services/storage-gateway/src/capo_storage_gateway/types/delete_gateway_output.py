"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteGatewayOutput``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DeleteGatewayOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DeleteGatewayOutput:
