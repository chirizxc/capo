...
if TYPE_CHECKING:
    ...
    import capo_storage_gateway.types.tape_recovery_point_status
    import capo_storage_gateway.types.tape_size
    import capo_storage_gateway.types.time


class TapeRecoveryPointInfo(TypedDict, closed=True):
    tape_arn: NotRequired["capo_storage_gateway.types.tape_arn.TapeARN"]
    """<p>The Amazon Resource Name (ARN) of the virtual tape.</p>"""
    tape_recovery_point_time: NotRequired["capo_storage_gateway.types.time.Time"]
    ...
    tape_status: NotRequired[
        "capo_storage_gateway.types.tape_recovery_point_status.TapeRecoveryPointStatus"
    ]
