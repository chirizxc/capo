...
class ListFileSharesOutput(TypedDict, closed=True):
    ...
    next_marker: NotRequired["capo_storage_gateway.types.marker.Marker"]
    ...
    file_share_info_list: NotRequired[
        "capo_storage_gateway.types.file_share_info_list.FileShareInfoList"
    ]
...
def serialize_aws_json_1_1(value: ListFileSharesOutput) -> dict:
    ...
    if "file_share_info_list" in value:
        ...
        out["FileShareInfoList"] = (
            capo_storage_gateway.types.file_share_info_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListFileSharesOutput:
    ...
    if data.get("FileShareInfoList") is not None:
        ...
        out["file_share_info_list"] = (
            capo_storage_gateway.types.file_share_info_list.deserialize_aws_json_1_1(
