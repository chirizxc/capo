...
if TYPE_CHECKING:
    ...
    import capo_storage_gateway.types.tape_archive_status
...
class TapeArchive(TypedDict, closed=True):
    ...
    completion_time: NotRequired["capo_storage_gateway.types.time.Time"]
    ...
    retrieved_to: NotRequired["capo_storage_gateway.types.gateway_arn.GatewayARN"]
    ...
    tape_status: NotRequired[
        "capo_storage_gateway.types.tape_archive_status.TapeArchiveStatus"
    ]
...
def serialize_aws_json_1_1(value: TapeArchive) -> dict:
    ...
    if "completion_time" in value:
        ...
        out["CompletionTime"] = capo_storage_gateway.types.time.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> TapeArchive:
    ...
    if data.get("TapeCreatedDate") is not None:
        import capo_storage_gateway.types.time
