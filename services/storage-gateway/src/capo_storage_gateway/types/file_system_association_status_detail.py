...
if TYPE_CHECKING:
    import capo_storage_gateway.types.file_system_association_sync_error_code


class FileSystemAssociationStatusDetail(TypedDict, closed=True):
    error_code: NotRequired[
        "capo_storage_gateway.types.file_system_association_sync_error_code.FileSystemAssociationSyncErrorCode"
    ]
