...
class NetworkInterface(TypedDict, closed=True):
    ipv4_address: NotRequired["capo_storage_gateway.types.string.string"]
    """<p>The Internet Protocol version 4 (IPv4) address of the interface.</p>"""
    mac_address: NotRequired["capo_storage_gateway.types.string.string"]
    ...
    ipv6_address: NotRequired["capo_storage_gateway.types.string.string"]
