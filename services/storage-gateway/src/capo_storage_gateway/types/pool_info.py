...
class PoolInfo(TypedDict, closed=True):
    ...
    pool_name: NotRequired["capo_storage_gateway.types.pool_name.PoolName"]
    ...
    storage_class: NotRequired[
        "capo_storage_gateway.types.tape_storage_class.TapeStorageClass"
    ]
    ...
    pool_status: NotRequired["capo_storage_gateway.types.pool_status.PoolStatus"]
...
def serialize_aws_json_1_1(value: PoolInfo) -> dict:
    ...
    if "storage_class" in value:
        ...
        out["StorageClass"] = (
            capo_storage_gateway.types.tape_storage_class.serialize_aws_json_1_1(
                value["storage_class"]
            )
        )
    if "retention_lock_type" in value:
        ...
        out["RetentionLockType"] = (
            capo_storage_gateway.types.retention_lock_type.serialize_aws_json_1_1(
    ...
    if "pool_status" in value:
        ...
        out["PoolStatus"] = (
            capo_storage_gateway.types.pool_status.serialize_aws_json_1_1(
                value["pool_status"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> PoolInfo:
    ...
    if data.get("StorageClass") is not None:
        ...
        out["storage_class"] = (
            capo_storage_gateway.types.tape_storage_class.deserialize_aws_json_1_1(
                data["StorageClass"]
            )
        )
    if data.get("RetentionLockType") is not None:
        ...
        out["retention_lock_type"] = (
            capo_storage_gateway.types.retention_lock_type.deserialize_aws_json_1_1(
    ...
    if data.get("PoolStatus") is not None:
        ...
        out["pool_status"] = (
            capo_storage_gateway.types.pool_status.deserialize_aws_json_1_1(
                data["PoolStatus"]
            )
        )
    return out
