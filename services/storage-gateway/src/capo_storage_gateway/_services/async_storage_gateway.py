...
from capo_storage_gateway._services._aws_config import aaws_config
...
class AsyncStorageGatewayClient:
    ...
    async def activate_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.activate_gateway_input.ActivateGatewayInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.activate_gateway_output.ActivateGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.activate_gateway.async_activate_gateway(
    ...
    async def add_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.add_cache_input.AddCacheInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.add_cache_output.AddCacheOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.add_cache.async_add_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def add_tags_to_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.add_tags_to_resource_input.AddTagsToResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.add_tags_to_resource_output.AddTagsToResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.add_tags_to_resource.async_add_tags_to_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def add_upload_buffer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.add_upload_buffer_input.AddUploadBufferInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.add_upload_buffer_output.AddUploadBufferOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.add_upload_buffer.async_add_upload_buffer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def add_working_storage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.add_working_storage_input.AddWorkingStorageInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.add_working_storage_output.AddWorkingStorageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.add_working_storage.async_add_working_storage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def assign_tape_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.assign_tape_pool_input.AssignTapePoolInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.assign_tape_pool_output.AssignTapePoolOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.assign_tape_pool.async_assign_tape_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_file_system(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.associate_file_system_input.AssociateFileSystemInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.associate_file_system_output.AssociateFileSystemOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.associate_file_system.async_associate_file_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def attach_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.attach_volume_input.AttachVolumeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.attach_volume_output.AttachVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.attach_volume.async_attach_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_archival(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.cancel_archival_input.CancelArchivalInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.cancel_archival_output.CancelArchivalOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.cancel_archival.async_cancel_archival(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_cache_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.cancel_cache_report_input.CancelCacheReportInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.cancel_cache_report_output.CancelCacheReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.cancel_cache_report.async_cancel_cache_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def cancel_retrieval(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.cancel_retrieval_input.CancelRetrievalInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.cancel_retrieval_output.CancelRetrievalOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.cancel_retrieval.async_cancel_retrieval(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cachedi_scsi_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_cachedi_scsi_volume_input.CreateCachediSCSIVolumeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_cachedi_scsi_volume_output.CreateCachediSCSIVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_cachedi_scsi_volume.async_create_cachedi_scsi_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_nfs_file_share(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_nfs_file_share_input.CreateNFSFileShareInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_nfs_file_share_output.CreateNFSFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_nfs_file_share.async_create_nfs_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_smb_file_share(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_smb_file_share_input.CreateSMBFileShareInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_smb_file_share_output.CreateSMBFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_smb_file_share.async_create_smb_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_snapshot(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_snapshot_input.CreateSnapshotInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_snapshot_output.CreateSnapshotOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_snapshot.async_create_snapshot(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_snapshot_from_volume_recovery_point(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_snapshot_from_volume_recovery_point_input.CreateSnapshotFromVolumeRecoveryPointInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_snapshot_from_volume_recovery_point_output.CreateSnapshotFromVolumeRecoveryPointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_snapshot_from_volume_recovery_point.async_create_snapshot_from_volume_recovery_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_storedi_scsi_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_storedi_scsi_volume_input.CreateStorediSCSIVolumeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_storedi_scsi_volume_output.CreateStorediSCSIVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_storedi_scsi_volume.async_create_storedi_scsi_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_tape_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_tape_pool_input.CreateTapePoolInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_tape_pool_output.CreateTapePoolOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_tape_pool.async_create_tape_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_tapes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_tapes_input.CreateTapesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_tapes_output.CreateTapesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_tapes.async_create_tapes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_tape_with_barcode(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.create_tape_with_barcode_input.CreateTapeWithBarcodeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.create_tape_with_barcode_output.CreateTapeWithBarcodeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.create_tape_with_barcode.async_create_tape_with_barcode(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_automatic_tape_creation_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_automatic_tape_creation_policy_input.DeleteAutomaticTapeCreationPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_automatic_tape_creation_policy_output.DeleteAutomaticTapeCreationPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_automatic_tape_creation_policy.async_delete_automatic_tape_creation_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_bandwidth_rate_limit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_bandwidth_rate_limit_input.DeleteBandwidthRateLimitInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_bandwidth_rate_limit_output.DeleteBandwidthRateLimitOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_bandwidth_rate_limit.async_delete_bandwidth_rate_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cache_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_cache_report_input.DeleteCacheReportInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_cache_report_output.DeleteCacheReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_cache_report.async_delete_cache_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_chap_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_chap_credentials_input.DeleteChapCredentialsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_chap_credentials_output.DeleteChapCredentialsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_chap_credentials.async_delete_chap_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_file_share(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_file_share_input.DeleteFileShareInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_file_share_output.DeleteFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_file_share.async_delete_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_gateway_input.DeleteGatewayInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_gateway_output.DeleteGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_gateway.async_delete_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_snapshot_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_snapshot_schedule_input.DeleteSnapshotScheduleInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_snapshot_schedule_output.DeleteSnapshotScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_snapshot_schedule.async_delete_snapshot_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tape(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_tape_input.DeleteTapeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_tape_output.DeleteTapeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_tape.async_delete_tape(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tape_archive(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_tape_archive_input.DeleteTapeArchiveInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_tape_archive_output.DeleteTapeArchiveOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_tape_archive.async_delete_tape_archive(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_tape_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_tape_pool_input.DeleteTapePoolInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_tape_pool_output.DeleteTapePoolOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_tape_pool.async_delete_tape_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.delete_volume_input.DeleteVolumeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.delete_volume_output.DeleteVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.delete_volume.async_delete_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_availability_monitor_test(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_availability_monitor_test_input.DescribeAvailabilityMonitorTestInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_availability_monitor_test_output.DescribeAvailabilityMonitorTestOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_availability_monitor_test.async_describe_availability_monitor_test(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_bandwidth_rate_limit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_bandwidth_rate_limit_input.DescribeBandwidthRateLimitInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_bandwidth_rate_limit_output.DescribeBandwidthRateLimitOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_bandwidth_rate_limit.async_describe_bandwidth_rate_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_bandwidth_rate_limit_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_bandwidth_rate_limit_schedule_input.DescribeBandwidthRateLimitScheduleInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_bandwidth_rate_limit_schedule_output.DescribeBandwidthRateLimitScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_bandwidth_rate_limit_schedule.async_describe_bandwidth_rate_limit_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_cache_input.DescribeCacheInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_cache_output.DescribeCacheOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_cache.async_describe_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cachedi_scsi_volumes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_cachedi_scsi_volumes_input.DescribeCachediSCSIVolumesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_cachedi_scsi_volumes_output.DescribeCachediSCSIVolumesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_cachedi_scsi_volumes.async_describe_cachedi_scsi_volumes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cache_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_cache_report_input.DescribeCacheReportInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_cache_report_output.DescribeCacheReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_cache_report.async_describe_cache_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_chap_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_chap_credentials_input.DescribeChapCredentialsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_chap_credentials_output.DescribeChapCredentialsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_chap_credentials.async_describe_chap_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_file_system_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_file_system_associations_input.DescribeFileSystemAssociationsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_file_system_associations_output.DescribeFileSystemAssociationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_file_system_associations.async_describe_file_system_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_gateway_information(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_gateway_information_input.DescribeGatewayInformationInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_gateway_information_output.DescribeGatewayInformationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_gateway_information.async_describe_gateway_information(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_maintenance_start_time(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_maintenance_start_time_input.DescribeMaintenanceStartTimeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_maintenance_start_time_output.DescribeMaintenanceStartTimeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_maintenance_start_time.async_describe_maintenance_start_time(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_nfs_file_shares(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_nfs_file_shares_input.DescribeNFSFileSharesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_nfs_file_shares_output.DescribeNFSFileSharesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_nfs_file_shares.async_describe_nfs_file_shares(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_smb_file_shares(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_smb_file_shares_input.DescribeSMBFileSharesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_smb_file_shares_output.DescribeSMBFileSharesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_smb_file_shares.async_describe_smb_file_shares(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_smb_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_smb_settings_input.DescribeSMBSettingsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_smb_settings_output.DescribeSMBSettingsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_smb_settings.async_describe_smb_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_snapshot_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_snapshot_schedule_input.DescribeSnapshotScheduleInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_snapshot_schedule_output.DescribeSnapshotScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_snapshot_schedule.async_describe_snapshot_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_storedi_scsi_volumes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_storedi_scsi_volumes_input.DescribeStorediSCSIVolumesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_storedi_scsi_volumes_output.DescribeStorediSCSIVolumesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_storedi_scsi_volumes.async_describe_storedi_scsi_volumes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_tape_archives(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_tape_archives_input.DescribeTapeArchivesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_tape_archives_output.DescribeTapeArchivesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_tape_archives.async_describe_tape_archives(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.tape_archive.TapeArchive]":
        _token = marker
        while True:
    ...
    async def describe_tape_recovery_points(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_tape_recovery_points_input.DescribeTapeRecoveryPointsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_tape_recovery_points_output.DescribeTapeRecoveryPointsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_tape_recovery_points.async_describe_tape_recovery_points(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.tape_recovery_point_info.TapeRecoveryPointInfo]":
        _token = marker
        while True:
    ...
    async def describe_tapes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_tapes_input.DescribeTapesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_tapes_output.DescribeTapesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_tapes.async_describe_tapes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.tape.Tape]":
        _token = marker
        while True:
    ...
    async def describe_upload_buffer(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_upload_buffer_input.DescribeUploadBufferInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_upload_buffer_output.DescribeUploadBufferOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_upload_buffer.async_describe_upload_buffer(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_vtl_devices(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_vtl_devices_input.DescribeVTLDevicesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_vtl_devices_output.DescribeVTLDevicesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_vtl_devices.async_describe_vtl_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.vtl_device.VTLDevice]":
        _token = marker
        while True:
    ...
    async def describe_working_storage(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.describe_working_storage_input.DescribeWorkingStorageInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.describe_working_storage_output.DescribeWorkingStorageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.describe_working_storage.async_describe_working_storage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detach_volume(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.detach_volume_input.DetachVolumeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.detach_volume_output.DetachVolumeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.detach_volume.async_detach_volume(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.disable_gateway_input.DisableGatewayInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.disable_gateway_output.DisableGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.disable_gateway.async_disable_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_file_system(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.disassociate_file_system_input.DisassociateFileSystemInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.disassociate_file_system_output.DisassociateFileSystemOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.disassociate_file_system.async_disassociate_file_system(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def evict_files_failing_upload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.evict_files_failing_upload_input.EvictFilesFailingUploadInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.evict_files_failing_upload_output.EvictFilesFailingUploadOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.evict_files_failing_upload.async_evict_files_failing_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def join_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.join_domain_input.JoinDomainInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.join_domain_output.JoinDomainOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.join_domain.async_join_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_automatic_tape_creation_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_automatic_tape_creation_policies_input.ListAutomaticTapeCreationPoliciesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_automatic_tape_creation_policies_output.ListAutomaticTapeCreationPoliciesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_automatic_tape_creation_policies.async_list_automatic_tape_creation_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_cache_reports(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_cache_reports_input.ListCacheReportsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_cache_reports_output.ListCacheReportsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_cache_reports.async_list_cache_reports(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_cache_reports(
        ...
        *,
        config_overrides: Optional[AsyncStorageGatewayClientConfig] = None,
        marker: Optional["capo_storage_gateway.types.marker.Marker"] = None,
    ) -> "AsyncIterator[capo_storage_gateway.types.cache_report_info.CacheReportInfo]":
        _token = marker
        while True:
    ...
    async def list_file_shares(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_file_shares_input.ListFileSharesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_file_shares_output.ListFileSharesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_file_shares.async_list_file_shares(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_file_shares(
        ...
        *,
        ...
        marker: Optional["capo_storage_gateway.types.marker.Marker"] = None,
    ) -> "AsyncIterator[capo_storage_gateway.types.file_share_info.FileShareInfo]":
        _token = marker
        while True:
    ...
    async def list_file_system_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_file_system_associations_input.ListFileSystemAssociationsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_file_system_associations_output.ListFileSystemAssociationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_file_system_associations.async_list_file_system_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_file_system_associations(
        ...
        *,
        ...
        marker: Optional["capo_storage_gateway.types.marker.Marker"] = None,
    ) -> "AsyncIterator[capo_storage_gateway.types.file_system_association_summary.FileSystemAssociationSummary]":
        _token = marker
        while True:
    ...
    async def list_gateways(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_gateways_input.ListGatewaysInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_gateways_output.ListGatewaysOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_gateways.async_list_gateways(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.gateway_info.GatewayInfo]":
        _token = marker
        while True:
    ...
    async def list_local_disks(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_local_disks_input.ListLocalDisksInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_local_disks_output.ListLocalDisksOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_local_disks.async_list_local_disks(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.tag.Tag]":
        _token = marker
        while True:
    ...
    async def list_tape_pools(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_tape_pools_input.ListTapePoolsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_tape_pools_output.ListTapePoolsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_tape_pools.async_list_tape_pools(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.pool_info.PoolInfo]":
        _token = marker
        while True:
    ...
    async def list_tapes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_tapes_input.ListTapesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_tapes_output.ListTapesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_tapes.async_list_tapes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.tape_info.TapeInfo]":
        _token = marker
        while True:
    ...
    async def list_volume_initiators(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_volume_initiators_input.ListVolumeInitiatorsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_volume_initiators_output.ListVolumeInitiatorsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_volume_initiators.async_list_volume_initiators(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_volume_recovery_points(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_volume_recovery_points_input.ListVolumeRecoveryPointsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_volume_recovery_points_output.ListVolumeRecoveryPointsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_volume_recovery_points.async_list_volume_recovery_points(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_volumes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.list_volumes_input.ListVolumesInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.list_volumes_output.ListVolumesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.list_volumes.async_list_volumes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_storage_gateway.types.volume_info.VolumeInfo]":
        _token = marker
        while True:
    ...
    async def notify_when_uploaded(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.notify_when_uploaded_input.NotifyWhenUploadedInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.notify_when_uploaded_output.NotifyWhenUploadedOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.notify_when_uploaded.async_notify_when_uploaded(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def refresh_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.refresh_cache_input.RefreshCacheInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.refresh_cache_output.RefreshCacheOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.refresh_cache.async_refresh_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_tags_from_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.remove_tags_from_resource_input.RemoveTagsFromResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.remove_tags_from_resource_output.RemoveTagsFromResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.remove_tags_from_resource.async_remove_tags_from_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reset_cache(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.reset_cache_input.ResetCacheInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.reset_cache_output.ResetCacheOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.reset_cache.async_reset_cache(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def retrieve_tape_archive(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.retrieve_tape_archive_input.RetrieveTapeArchiveInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.retrieve_tape_archive_output.RetrieveTapeArchiveOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.retrieve_tape_archive.async_retrieve_tape_archive(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def retrieve_tape_recovery_point(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.retrieve_tape_recovery_point_input.RetrieveTapeRecoveryPointInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.retrieve_tape_recovery_point_output.RetrieveTapeRecoveryPointOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.retrieve_tape_recovery_point.async_retrieve_tape_recovery_point(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_local_console_password(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.set_local_console_password_input.SetLocalConsolePasswordInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.set_local_console_password_output.SetLocalConsolePasswordOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.set_local_console_password.async_set_local_console_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_smb_guest_password(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.set_smb_guest_password_input.SetSMBGuestPasswordInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.set_smb_guest_password_output.SetSMBGuestPasswordOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.set_smb_guest_password.async_set_smb_guest_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def shutdown_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.shutdown_gateway_input.ShutdownGatewayInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.shutdown_gateway_output.ShutdownGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.shutdown_gateway.async_shutdown_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_availability_monitor_test(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.start_availability_monitor_test_input.StartAvailabilityMonitorTestInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.start_availability_monitor_test_output.StartAvailabilityMonitorTestOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.start_availability_monitor_test.async_start_availability_monitor_test(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_cache_report(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.start_cache_report_input.StartCacheReportInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.start_cache_report_output.StartCacheReportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.start_cache_report.async_start_cache_report(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_gateway(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.start_gateway_input.StartGatewayInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.start_gateway_output.StartGatewayOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.start_gateway.async_start_gateway(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_automatic_tape_creation_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_automatic_tape_creation_policy_input.UpdateAutomaticTapeCreationPolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_automatic_tape_creation_policy_output.UpdateAutomaticTapeCreationPolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_automatic_tape_creation_policy.async_update_automatic_tape_creation_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_bandwidth_rate_limit(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_bandwidth_rate_limit_input.UpdateBandwidthRateLimitInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_bandwidth_rate_limit_output.UpdateBandwidthRateLimitOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_bandwidth_rate_limit.async_update_bandwidth_rate_limit(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_bandwidth_rate_limit_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_bandwidth_rate_limit_schedule_input.UpdateBandwidthRateLimitScheduleInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_bandwidth_rate_limit_schedule_output.UpdateBandwidthRateLimitScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_bandwidth_rate_limit_schedule.async_update_bandwidth_rate_limit_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_chap_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_chap_credentials_input.UpdateChapCredentialsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_chap_credentials_output.UpdateChapCredentialsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_chap_credentials.async_update_chap_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_file_system_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_file_system_association_input.UpdateFileSystemAssociationInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_file_system_association_output.UpdateFileSystemAssociationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_file_system_association.async_update_file_system_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_gateway_information(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_gateway_information_input.UpdateGatewayInformationInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_gateway_information_output.UpdateGatewayInformationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_gateway_information.async_update_gateway_information(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_gateway_software_now(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_gateway_software_now_input.UpdateGatewaySoftwareNowInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_gateway_software_now_output.UpdateGatewaySoftwareNowOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_gateway_software_now.async_update_gateway_software_now(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_maintenance_start_time(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_maintenance_start_time_input.UpdateMaintenanceStartTimeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_maintenance_start_time_output.UpdateMaintenanceStartTimeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_maintenance_start_time.async_update_maintenance_start_time(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_nfs_file_share(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_nfs_file_share_input.UpdateNFSFileShareInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_nfs_file_share_output.UpdateNFSFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_nfs_file_share.async_update_nfs_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_smb_file_share(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_smb_file_share_input.UpdateSMBFileShareInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_smb_file_share_output.UpdateSMBFileShareOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_smb_file_share.async_update_smb_file_share(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_smb_file_share_visibility(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_smb_file_share_visibility_input.UpdateSMBFileShareVisibilityInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_smb_file_share_visibility_output.UpdateSMBFileShareVisibilityOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_smb_file_share_visibility.async_update_smb_file_share_visibility(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_smb_local_groups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_smb_local_groups_input.UpdateSMBLocalGroupsInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_smb_local_groups_output.UpdateSMBLocalGroupsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_smb_local_groups.async_update_smb_local_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_smb_security_strategy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_smb_security_strategy_input.UpdateSMBSecurityStrategyInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_smb_security_strategy_output.UpdateSMBSecurityStrategyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_smb_security_strategy.async_update_smb_security_strategy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_snapshot_schedule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_snapshot_schedule_input.UpdateSnapshotScheduleInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_snapshot_schedule_output.UpdateSnapshotScheduleOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_snapshot_schedule.async_update_snapshot_schedule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_vtl_device_type(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_storage_gateway.types.update_vtl_device_type_input.UpdateVTLDeviceTypeInput]",
        ) -> AsyncOperationResponse[
            "capo_storage_gateway.types.update_vtl_device_type_output.UpdateVTLDeviceTypeOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_storage_gateway._operations.storage_gateway_20130630.update_vtl_device_type.async_update_vtl_device_type(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
