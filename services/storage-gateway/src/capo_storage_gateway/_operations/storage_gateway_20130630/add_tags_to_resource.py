"""Generated from Smithy shape ``com.amazonaws.storagegateway#AddTagsToResource``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.add_tags_to_resource_output.AddTagsToResourceOutput = capo_storage_gateway.types.add_tags_to_resource_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.add_tags_to_resource_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
