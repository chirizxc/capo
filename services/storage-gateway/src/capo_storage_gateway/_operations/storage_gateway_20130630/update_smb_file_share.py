"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateSMBFileShare``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_smb_file_share_output.UpdateSMBFileShareOutput = capo_storage_gateway.types.update_smb_file_share_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_smb_file_share_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_smb_file_share(
