"""Generated from Smithy shape ``com.amazonaws.storagegateway#DisableGateway``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.disable_gateway_output.DisableGatewayOutput = (
        capo_storage_gateway.types.disable_gateway_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.disable_gateway_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_disable_gateway(
