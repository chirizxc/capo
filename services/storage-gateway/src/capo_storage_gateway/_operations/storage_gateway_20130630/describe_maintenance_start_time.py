"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeMaintenanceStartTime``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_maintenance_start_time_output.DescribeMaintenanceStartTimeOutput = capo_storage_gateway.types.describe_maintenance_start_time_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_maintenance_start_time_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_maintenance_start_time(
