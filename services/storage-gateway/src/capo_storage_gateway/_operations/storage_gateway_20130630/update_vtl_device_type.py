"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateVTLDeviceType``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_vtl_device_type_output.UpdateVTLDeviceTypeOutput = capo_storage_gateway.types.update_vtl_device_type_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_vtl_device_type_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_vtl_device_type(
