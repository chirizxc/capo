...
def handle_response(
    ...
    out: capo_storage_gateway.types.create_snapshot_from_volume_recovery_point_output.CreateSnapshotFromVolumeRecoveryPointOutput = capo_storage_gateway.types.create_snapshot_from_volume_recovery_point_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.create_snapshot_from_volume_recovery_point_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
