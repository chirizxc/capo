"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListVolumes``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_volumes_output.ListVolumesOutput = (
        capo_storage_gateway.types.list_volumes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_volumes_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_volumes(
    ...
    capo_storage_gateway.types.list_volumes_output.ListVolumesOutput, zapros.Response
]:
