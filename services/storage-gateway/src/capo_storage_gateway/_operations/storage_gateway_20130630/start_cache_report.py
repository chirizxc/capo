"""Generated from Smithy shape ``com.amazonaws.storagegateway#StartCacheReport``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.start_cache_report_output.StartCacheReportOutput = (
        capo_storage_gateway.types.start_cache_report_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.StartCacheReport"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.start_cache_report_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_cache_report(
