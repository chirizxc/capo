...
def handle_response(
    ...
    out: capo_storage_gateway.types.create_tapes_output.CreateTapesOutput = (
        capo_storage_gateway.types.create_tapes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.create_tapes_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_tapes(
    ...
    capo_storage_gateway.types.create_tapes_output.CreateTapesOutput, zapros.Response
]:
