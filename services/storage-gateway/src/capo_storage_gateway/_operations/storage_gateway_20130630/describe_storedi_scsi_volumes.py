"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeStorediSCSIVolumes``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_storedi_scsi_volumes_output.DescribeStorediSCSIVolumesOutput = capo_storage_gateway.types.describe_storedi_scsi_volumes_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_storedi_scsi_volumes_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_storedi_scsi_volumes(
