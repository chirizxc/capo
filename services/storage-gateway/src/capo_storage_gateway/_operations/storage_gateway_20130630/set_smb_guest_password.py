...
def handle_response(
    ...
    out: capo_storage_gateway.types.set_smb_guest_password_output.SetSMBGuestPasswordOutput = capo_storage_gateway.types.set_smb_guest_password_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.set_smb_guest_password_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
