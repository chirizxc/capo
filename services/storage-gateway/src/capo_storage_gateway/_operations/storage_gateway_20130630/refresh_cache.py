"""Generated from Smithy shape ``com.amazonaws.storagegateway#RefreshCache``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.refresh_cache_output.RefreshCacheOutput = (
        capo_storage_gateway.types.refresh_cache_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.refresh_cache_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def refresh_cache(
    ...
    capo_storage_gateway.types.refresh_cache_output.RefreshCacheOutput, zapros.Response
]:
