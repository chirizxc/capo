"""Generated from Smithy shape ``com.amazonaws.storagegateway#RetrieveTapeArchive``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.retrieve_tape_archive_output.RetrieveTapeArchiveOutput = capo_storage_gateway.types.retrieve_tape_archive_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.retrieve_tape_archive_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_retrieve_tape_archive(
