...
def handle_response(
    ...
    out: capo_storage_gateway.types.start_availability_monitor_test_output.StartAvailabilityMonitorTestOutput = capo_storage_gateway.types.start_availability_monitor_test_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.start_availability_monitor_test_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
