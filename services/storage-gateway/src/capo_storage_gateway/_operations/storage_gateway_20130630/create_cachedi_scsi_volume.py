...
def handle_response(
    ...
    out: capo_storage_gateway.types.create_cachedi_scsi_volume_output.CreateCachediSCSIVolumeOutput = capo_storage_gateway.types.create_cachedi_scsi_volume_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.create_cachedi_scsi_volume_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
