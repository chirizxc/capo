"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeCacheReport``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_cache_report_output.DescribeCacheReportOutput = capo_storage_gateway.types.describe_cache_report_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.DescribeCacheReport"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_cache_report_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_cache_report(
