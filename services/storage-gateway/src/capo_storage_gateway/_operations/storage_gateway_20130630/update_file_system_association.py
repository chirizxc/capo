"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateFileSystemAssociation``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_file_system_association_output.UpdateFileSystemAssociationOutput = capo_storage_gateway.types.update_file_system_association_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.UpdateFileSystemAssociation"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_file_system_association_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_file_system_association(
