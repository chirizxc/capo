"""Generated from Smithy shape ``com.amazonaws.storagegateway#DisassociateFileSystem``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.disassociate_file_system_output.DisassociateFileSystemOutput = capo_storage_gateway.types.disassociate_file_system_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.DisassociateFileSystem"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.disassociate_file_system_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_file_system(
