"""Generated from Smithy shape ``com.amazonaws.storagegateway#UpdateGatewaySoftwareNow``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.update_gateway_software_now_output.UpdateGatewaySoftwareNowOutput = capo_storage_gateway.types.update_gateway_software_now_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.update_gateway_software_now_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
