"""Generated from Smithy shape ``com.amazonaws.storagegateway#EvictFilesFailingUpload``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.evict_files_failing_upload_output.EvictFilesFailingUploadOutput = capo_storage_gateway.types.evict_files_failing_upload_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.EvictFilesFailingUpload"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.evict_files_failing_upload_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_evict_files_failing_upload(
