"""Generated from Smithy shape ``com.amazonaws.storagegateway#JoinDomain``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.join_domain_output.JoinDomainOutput = (
        capo_storage_gateway.types.join_domain_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.join_domain_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def join_domain(
    ...
    capo_storage_gateway.types.join_domain_output.JoinDomainOutput, zapros.Response
]:
