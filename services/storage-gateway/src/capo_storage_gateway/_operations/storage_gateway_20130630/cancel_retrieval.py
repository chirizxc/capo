"""Generated from Smithy shape ``com.amazonaws.storagegateway#CancelRetrieval``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.cancel_retrieval_output.CancelRetrievalOutput = (
        capo_storage_gateway.types.cancel_retrieval_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.cancel_retrieval_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_cancel_retrieval(
