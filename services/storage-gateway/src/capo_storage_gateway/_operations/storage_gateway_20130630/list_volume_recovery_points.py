...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_volume_recovery_points_output.ListVolumeRecoveryPointsOutput = capo_storage_gateway.types.list_volume_recovery_points_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_volume_recovery_points_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
