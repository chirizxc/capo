...
def handle_response(
    ...
    out: capo_storage_gateway.types.delete_tape_pool_output.DeleteTapePoolOutput = (
        capo_storage_gateway.types.delete_tape_pool_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.delete_tape_pool_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
