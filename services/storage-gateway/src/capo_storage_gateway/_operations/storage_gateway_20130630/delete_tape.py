"""Generated from Smithy shape ``com.amazonaws.storagegateway#DeleteTape``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.delete_tape_output.DeleteTapeOutput = (
        capo_storage_gateway.types.delete_tape_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.delete_tape_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_tape(
    ...
    capo_storage_gateway.types.delete_tape_output.DeleteTapeOutput, zapros.Response
]:
