...
def handle_response(
    ...
    out: capo_storage_gateway.types.delete_gateway_output.DeleteGatewayOutput = (
        capo_storage_gateway.types.delete_gateway_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.delete_gateway_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
