"""Generated from Smithy shape ``com.amazonaws.storagegateway#ListTapePools``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.list_tape_pools_output.ListTapePoolsOutput = (
        capo_storage_gateway.types.list_tape_pools_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StorageGateway_20130630.ListTapePools"
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.list_tape_pools_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_tape_pools(
