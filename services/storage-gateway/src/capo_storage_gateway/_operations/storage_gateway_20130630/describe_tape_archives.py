"""Generated from Smithy shape ``com.amazonaws.storagegateway#DescribeTapeArchives``."""
...
def handle_response(
    ...
    out: capo_storage_gateway.types.describe_tape_archives_output.DescribeTapeArchivesOutput = capo_storage_gateway.types.describe_tape_archives_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_storage_gateway.types.describe_tape_archives_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_tape_archives(
