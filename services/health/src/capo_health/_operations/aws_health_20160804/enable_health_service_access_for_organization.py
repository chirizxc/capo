"""Generated from Smithy shape ``com.amazonaws.health#EnableHealthServiceAccessForOrganization``."""
...
async def async_enable_health_service_access_for_organization(
