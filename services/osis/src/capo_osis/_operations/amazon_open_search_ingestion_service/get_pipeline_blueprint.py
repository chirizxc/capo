"""Generated from Smithy shape ``com.amazonaws.osis#GetPipelineBlueprint``."""
...
def handle_response(
    ...
    out: capo_osis.types.get_pipeline_blueprint_response.GetPipelineBlueprintResponse = capo_osis.types.get_pipeline_blueprint_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{BlueprintName}", quote(input_["blueprint_name"], safe=""))
    params: list[tuple[str, str]] = []
    if "format" in input_:
        params.append(("format", input_["format"]))
...
async def async_get_pipeline_blueprint(
