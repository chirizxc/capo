...
def handle_response(
    ...
    out: capo_osis.types.list_pipeline_endpoint_connections_response.ListPipelineEndpointConnectionsResponse = capo_osis.types.list_pipeline_endpoint_connections_response.deserialize_json(
