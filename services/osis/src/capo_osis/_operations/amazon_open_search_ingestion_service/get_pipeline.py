"""Generated from Smithy shape ``com.amazonaws.osis#GetPipeline``."""
...
def handle_response(
    ...
    out: capo_osis.types.get_pipeline_response.GetPipelineResponse = (
        capo_osis.types.get_pipeline_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/getPipeline/{PipelineName}"
...
def get_pipeline(
    ...
    input_: capo_osis.types.get_pipeline_request.GetPipelineRequest,
) -> tuple[capo_osis.types.get_pipeline_response.GetPipelineResponse, zapros.Response]:
