"""Generated from Smithy shape ``com.amazonaws.osis#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_osis.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
