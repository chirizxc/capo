...
def handle_response(
    ...
    out: capo_osis.types.validate_pipeline_response.ValidatePipelineResponse = (
        capo_osis.types.validate_pipeline_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_osis.types.validate_pipeline_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def validate_pipeline(
    ...
    capo_osis.types.validate_pipeline_response.ValidatePipelineResponse, zapros.Response
]:
