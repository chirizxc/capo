"""Generated from Smithy shape ``com.amazonaws.osis#ListPipelines``."""
...
def handle_response(
    ...
    out: capo_osis.types.list_pipelines_response.ListPipelinesResponse = (
        capo_osis.types.list_pipelines_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2022-01-01/osis/listPipelines"
...
def list_pipelines(
    ...
    capo_osis.types.list_pipelines_response.ListPipelinesResponse, zapros.Response
]:
