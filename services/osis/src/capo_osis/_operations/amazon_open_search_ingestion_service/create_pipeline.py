...
import capo_osis.errors.resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExistsException":
            raise capo_osis.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_osis.types.create_pipeline_response.CreatePipelineResponse = (
        capo_osis.types.create_pipeline_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_osis.types.create_pipeline_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_pipeline(
    ...
    capo_osis.types.create_pipeline_response.CreatePipelineResponse, zapros.Response
]:
