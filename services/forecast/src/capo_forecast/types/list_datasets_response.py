...
class ListDatasetsResponse(TypedDict, closed=True):
    datasets: NotRequired["capo_forecast.types.datasets.Datasets"]
...
def serialize_aws_json_1_1(value: ListDatasetsResponse) -> dict:
    ...
    if "datasets" in value:
        ...
        out["Datasets"] = capo_forecast.types.datasets.serialize_aws_json_1_1(
            value["datasets"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDatasetsResponse:
    ...
    if data.get("Datasets") is not None:
        ...
        out["datasets"] = capo_forecast.types.datasets.deserialize_aws_json_1_1(
            data["Datasets"]
        )
