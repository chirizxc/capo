...
class ListPredictorBacktestExportJobsResponse(TypedDict, closed=True):
    predictor_backtest_export_jobs: NotRequired[
        "capo_forecast.types.predictor_backtest_export_jobs.PredictorBacktestExportJobs"
    ]
...
def serialize_aws_json_1_1(value: ListPredictorBacktestExportJobsResponse) -> dict:
    ...
    if "predictor_backtest_export_jobs" in value:
        ...
        out["PredictorBacktestExportJobs"] = (
            capo_forecast.types.predictor_backtest_export_jobs.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListPredictorBacktestExportJobsResponse:
    ...
    if data.get("PredictorBacktestExportJobs") is not None:
        import capo_forecast.types.predictor_backtest_export_jobs

        out["predictor_backtest_export_jobs"] = (
            capo_forecast.types.predictor_backtest_export_jobs.deserialize_aws_json_1_1(
