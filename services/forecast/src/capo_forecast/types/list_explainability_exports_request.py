"""Generated from Smithy shape ``com.amazonaws.forecast#ListExplainabilityExportsRequest``."""
...
class ListExplainabilityExportsRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListExplainabilityExportsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> ListExplainabilityExportsRequest:
    out: ListExplainabilityExportsRequest = {}  # type: ignore[typeddict-item]
