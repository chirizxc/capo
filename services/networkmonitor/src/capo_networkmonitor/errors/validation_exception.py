"""Generated from Smithy shape ``com.amazonaws.networkmonitor#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.networkmonitor#ValidationException``."""
