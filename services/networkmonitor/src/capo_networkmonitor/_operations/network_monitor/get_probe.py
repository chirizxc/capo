"""Generated from Smithy shape ``com.amazonaws.networkmonitor#GetProbe``."""
...
def handle_response(
    ...
    out: capo_networkmonitor.types.get_probe_output.GetProbeOutput = (
        capo_networkmonitor.types.get_probe_output.deserialize_json(
...
def get_probe(
    ...
    input_: capo_networkmonitor.types.get_probe_input.GetProbeInput,
) -> tuple[capo_networkmonitor.types.get_probe_output.GetProbeOutput, zapros.Response]:
