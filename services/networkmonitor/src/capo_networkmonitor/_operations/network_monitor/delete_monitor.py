...
def handle_response(
    ...
    out: capo_networkmonitor.types.delete_monitor_output.DeleteMonitorOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_monitor(
    ...
    capo_networkmonitor.types.delete_monitor_output.DeleteMonitorOutput, zapros.Response
]:
