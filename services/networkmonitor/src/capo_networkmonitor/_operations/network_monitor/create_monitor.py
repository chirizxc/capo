"""Generated from Smithy shape ``com.amazonaws.networkmonitor#CreateMonitor``."""
...
def handle_response(
    ...
    out: capo_networkmonitor.types.create_monitor_output.CreateMonitorOutput = (
        capo_networkmonitor.types.create_monitor_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmonitor.types.create_monitor_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_monitor(
    ...
    capo_networkmonitor.types.create_monitor_output.CreateMonitorOutput, zapros.Response
]:
