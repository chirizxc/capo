"""Generated from Smithy shape ``com.amazonaws.networkmonitor#DeleteProbe``."""
...
def handle_response(
    ...
    out: capo_networkmonitor.types.delete_probe_output.DeleteProbeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{probeId}", quote(input_["probe_id"], safe=""))
...
def delete_probe(
    ...
    capo_networkmonitor.types.delete_probe_output.DeleteProbeOutput, zapros.Response
]:
