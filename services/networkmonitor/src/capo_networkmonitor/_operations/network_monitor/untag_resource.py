...
def handle_response(
    ...
    out: capo_networkmonitor.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_networkmonitor.types.untag_resource_output.UntagResourceOutput, zapros.Response
]:
