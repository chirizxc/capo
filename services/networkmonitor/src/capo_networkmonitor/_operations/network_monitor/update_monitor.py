...
def handle_response(
    ...
    out: capo_networkmonitor.types.update_monitor_output.UpdateMonitorOutput = (
        capo_networkmonitor.types.update_monitor_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmonitor.types.update_monitor_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_monitor(
    ...
    capo_networkmonitor.types.update_monitor_output.UpdateMonitorOutput, zapros.Response
]:
