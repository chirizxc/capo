...
if TYPE_CHECKING:
    ...
    import capo_codebuild.types.fleet_status
    import capo_codebuild.types.non_empty_string
    import capo_codebuild.types.proxy_configuration
    import capo_codebuild.types.scaling_configuration_output
...
class Fleet(TypedDict, closed=True):
    ...
    name: NotRequired["capo_codebuild.types.fleet_name.FleetName"]
    ...
    status: NotRequired["capo_codebuild.types.fleet_status.FleetStatus"]
    ...
    scaling_configuration: NotRequired[
        "capo_codebuild.types.scaling_configuration_output.ScalingConfigurationOutput"
    ]
...
def serialize_aws_json_1_1(value: Fleet) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = capo_codebuild.types.fleet_status.serialize_aws_json_1_1(
            value["status"]
        )
    ...
    if "scaling_configuration" in value:
        ...
        out["scalingConfiguration"] = (
            capo_codebuild.types.scaling_configuration_output.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Fleet:
    ...
    if data.get("status") is not None:
        ...
        out["status"] = capo_codebuild.types.fleet_status.deserialize_aws_json_1_1(
            data["status"]
        )
    ...
    if data.get("scalingConfiguration") is not None:
        ...
        out["scaling_configuration"] = (
            capo_codebuild.types.scaling_configuration_output.deserialize_aws_json_1_1(
