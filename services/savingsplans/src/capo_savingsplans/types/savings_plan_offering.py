...
class SavingsPlanOffering(TypedDict, closed=True):
    ...
    properties: NotRequired[
        "capo_savingsplans.types.savings_plan_offering_property_list.SavingsPlanOfferingPropertyList"
    ]
    """<p>The properties.</p>"""
...
def serialize_json(value: SavingsPlanOffering) -> dict:
    ...
    if "properties" in value:
        ...
        out["properties"] = (
            capo_savingsplans.types.savings_plan_offering_property_list.serialize_json(
                value["properties"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SavingsPlanOffering:
    ...
    if data.get("properties") is not None:
        ...
        out["properties"] = (
            capo_savingsplans.types.savings_plan_offering_property_list.deserialize_json(
                data["properties"]
            )
        )
    return out
