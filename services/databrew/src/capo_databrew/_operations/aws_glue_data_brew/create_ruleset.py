...
def handle_response(
    ...
    out: capo_databrew.types.create_ruleset_response.CreateRulesetResponse = (
        capo_databrew.types.create_ruleset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.create_ruleset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_ruleset(
    ...
    capo_databrew.types.create_ruleset_response.CreateRulesetResponse, zapros.Response
]:
