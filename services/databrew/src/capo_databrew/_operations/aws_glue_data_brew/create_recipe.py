...
def handle_response(
    ...
    out: capo_databrew.types.create_recipe_response.CreateRecipeResponse = (
        capo_databrew.types.create_recipe_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.create_recipe_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_recipe(
    ...
    capo_databrew.types.create_recipe_response.CreateRecipeResponse, zapros.Response
]:
