...
def handle_response(
    ...
    out: capo_databrew.types.list_job_runs_response.ListJobRunsResponse = (
        capo_databrew.types.list_job_runs_response.deserialize_json(
...
def list_job_runs(
    ...
    capo_databrew.types.list_job_runs_response.ListJobRunsResponse, zapros.Response
]:
