"""Generated from Smithy shape ``com.amazonaws.databrew#CreateSchedule``."""
...
def handle_response(
    ...
    out: capo_databrew.types.create_schedule_response.CreateScheduleResponse = (
        capo_databrew.types.create_schedule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.create_schedule_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_schedule(
    ...
    capo_databrew.types.create_schedule_response.CreateScheduleResponse, zapros.Response
]:
