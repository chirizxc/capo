"""Generated from Smithy shape ``com.amazonaws.databrew#DescribeRuleset``."""
...
def handle_response(
    ...
    out: capo_databrew.types.describe_ruleset_response.DescribeRulesetResponse = (
        capo_databrew.types.describe_ruleset_response.deserialize_json(
...
async def async_describe_ruleset(
