...
def handle_response(
    ...
    out: capo_databrew.types.delete_dataset_response.DeleteDatasetResponse = (
        capo_databrew.types.delete_dataset_response.deserialize_json(
...
def delete_dataset(
    ...
    capo_databrew.types.delete_dataset_response.DeleteDatasetResponse, zapros.Response
]:
