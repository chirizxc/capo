"""Generated from Smithy shape ``com.amazonaws.databrew#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_databrew.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_databrew.types.list_tags_for_resource_response.deserialize_json(
