"""Generated from Smithy shape ``com.amazonaws.databrew#UntagResource``."""
...
def handle_response(
    ...
    out: capo_databrew.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_databrew.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
