...
def handle_response(
    ...
    out: capo_databrew.types.publish_recipe_response.PublishRecipeResponse = (
        capo_databrew.types.publish_recipe_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.publish_recipe_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def publish_recipe(
    ...
    capo_databrew.types.publish_recipe_response.PublishRecipeResponse, zapros.Response
]:
