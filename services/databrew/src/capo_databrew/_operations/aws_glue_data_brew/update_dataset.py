...
def handle_response(
    ...
    out: capo_databrew.types.update_dataset_response.UpdateDatasetResponse = (
        capo_databrew.types.update_dataset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.update_dataset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_dataset(
    ...
    capo_databrew.types.update_dataset_response.UpdateDatasetResponse, zapros.Response
]:
