...
def handle_response(
    ...
    out: capo_databrew.types.delete_job_response.DeleteJobResponse = (
        capo_databrew.types.delete_job_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_databrew.types.delete_job_request.DeleteJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def delete_job(
    ...
    input_: capo_databrew.types.delete_job_request.DeleteJobRequest,
) -> tuple[capo_databrew.types.delete_job_response.DeleteJobResponse, zapros.Response]:
