"""Generated from Smithy shape ``com.amazonaws.databrew#ListRecipeVersions``."""
...
def handle_response(
    ...
    out: capo_databrew.types.list_recipe_versions_response.ListRecipeVersionsResponse = capo_databrew.types.list_recipe_versions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/recipeVersions"
...
async def async_list_recipe_versions(
