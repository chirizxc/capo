...
def handle_response(
    ...
    out: capo_databrew.types.list_jobs_response.ListJobsResponse = (
        capo_databrew.types.list_jobs_response.deserialize_json(
...
def build_request(
    ...
    if "dataset_name" in input_:
        params.append(("datasetName", input_["dataset_name"]))
    ...
    if "project_name" in input_:
        params.append(("projectName", input_["project_name"]))
...
def list_jobs(
    ...
    input_: capo_databrew.types.list_jobs_request.ListJobsRequest,
) -> tuple[capo_databrew.types.list_jobs_response.ListJobsResponse, zapros.Response]:
