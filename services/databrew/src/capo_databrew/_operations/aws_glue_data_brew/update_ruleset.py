"""Generated from Smithy shape ``com.amazonaws.databrew#UpdateRuleset``."""
...
def handle_response(
    ...
    out: capo_databrew.types.update_ruleset_response.UpdateRulesetResponse = (
        capo_databrew.types.update_ruleset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_databrew.types.update_ruleset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_ruleset(
    ...
    capo_databrew.types.update_ruleset_response.UpdateRulesetResponse, zapros.Response
]:
...
async def async_update_ruleset(
