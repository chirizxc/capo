"""Generated from Smithy shape ``com.amazonaws.databrew#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.databrew#ServiceQuotaExceededException``."""
