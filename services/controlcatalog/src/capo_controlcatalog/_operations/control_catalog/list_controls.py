...
def handle_response(
    ...
    out: capo_controlcatalog.types.list_controls_response.ListControlsResponse = (
        capo_controlcatalog.types.list_controls_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controlcatalog.types.list_controls_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
