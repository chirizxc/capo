...
def handle_response(
    ...
    out: capo_controlcatalog.types.list_domains_response.ListDomainsResponse = (
        capo_controlcatalog.types.list_domains_response.deserialize_json(
...
def list_domains(
    ...
    capo_controlcatalog.types.list_domains_response.ListDomainsResponse, zapros.Response
]:
