"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#AddApplicationInputProcessingConfiguration``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics.types.add_application_input_processing_configuration_response.AddApplicationInputProcessingConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.add_application_input_processing_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_add_application_input_processing_configuration(
