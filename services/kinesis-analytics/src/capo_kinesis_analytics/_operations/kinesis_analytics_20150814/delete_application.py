"""Generated from Smithy shape ``com.amazonaws.kinesisanalytics#DeleteApplication``."""
...
def handle_response(
    ...
    out: capo_kinesis_analytics.types.delete_application_response.DeleteApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis_analytics.types.delete_application_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
