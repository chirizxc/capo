...
if TYPE_CHECKING:
    import capo_kinesis_analytics.types.reference_data_source_update

ReferenceDataSourceUpdates: TypeAlias = list[
    "capo_kinesis_analytics.types.reference_data_source_update.ReferenceDataSourceUpdate"
]
...
def serialize_aws_json_1_1(value: ReferenceDataSourceUpdates) -> list:
    ...
    for item in value:
        out.append(
            capo_kinesis_analytics.types.reference_data_source_update.serialize_aws_json_1_1(
                item
            )
        )
    return out
