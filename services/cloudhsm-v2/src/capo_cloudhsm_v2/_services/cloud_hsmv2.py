...
class CloudHSMV2Client:
    ...
    def copy_backup_to_region(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.copy_backup_to_region_request.CopyBackupToRegionRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.copy_backup_to_region_response.CopyBackupToRegionResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.copy_backup_to_region.copy_backup_to_region(
    ...
    def create_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.create_cluster_request.CreateClusterRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.create_cluster_response.CreateClusterResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.create_cluster.create_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_hsm(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.create_hsm_request.CreateHsmRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.create_hsm_response.CreateHsmResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.create_hsm.create_hsm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_backup(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.delete_backup_request.DeleteBackupRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.delete_backup_response.DeleteBackupResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.delete_backup.delete_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.delete_cluster_request.DeleteClusterRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.delete_cluster_response.DeleteClusterResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.delete_cluster.delete_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_hsm(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.delete_hsm_request.DeleteHsmRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.delete_hsm_response.DeleteHsmResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.delete_hsm.delete_hsm(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.delete_resource_policy_response.DeleteResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.delete_resource_policy.delete_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_backups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.describe_backups_request.DescribeBackupsRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.describe_backups_response.DescribeBackupsResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.describe_backups.describe_backups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_clusters(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.describe_clusters_request.DescribeClustersRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.describe_clusters_response.DescribeClustersResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.describe_clusters.describe_clusters(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def initialize_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.initialize_cluster_request.InitializeClusterRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.initialize_cluster_response.InitializeClusterResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.initialize_cluster.initialize_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.list_tags_request.ListTagsRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.list_tags_response.ListTagsResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.list_tags.list_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_backup_attributes(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.modify_backup_attributes_request.ModifyBackupAttributesRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.modify_backup_attributes_response.ModifyBackupAttributesResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.modify_backup_attributes.modify_backup_attributes(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def modify_cluster(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.modify_cluster_request.ModifyClusterRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.modify_cluster_response.ModifyClusterResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.modify_cluster.modify_cluster(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def restore_backup(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.restore_backup_request.RestoreBackupRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.restore_backup_response.RestoreBackupResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.restore_backup.restore_backup(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudhsm_v2.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_cloudhsm_v2.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_cloudhsm_v2._operations.baldr_api_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
