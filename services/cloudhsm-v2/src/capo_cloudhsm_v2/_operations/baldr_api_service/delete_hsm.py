"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#DeleteHsm``."""
...
def handle_response(
    ...
    out: capo_cloudhsm_v2.types.delete_hsm_response.DeleteHsmResponse = (
        capo_cloudhsm_v2.types.delete_hsm_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.delete_hsm_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_hsm(
    ...
    capo_cloudhsm_v2.types.delete_hsm_response.DeleteHsmResponse, zapros.Response
]:
