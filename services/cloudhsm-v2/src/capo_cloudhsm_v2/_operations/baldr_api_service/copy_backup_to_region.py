...
def handle_response(
    ...
    out: capo_cloudhsm_v2.types.copy_backup_to_region_response.CopyBackupToRegionResponse = capo_cloudhsm_v2.types.copy_backup_to_region_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.copy_backup_to_region_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
