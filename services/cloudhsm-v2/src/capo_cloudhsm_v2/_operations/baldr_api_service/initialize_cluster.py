...
def handle_response(
    ...
    out: capo_cloudhsm_v2.types.initialize_cluster_response.InitializeClusterResponse = capo_cloudhsm_v2.types.initialize_cluster_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.initialize_cluster_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
