...
def handle_response(
    ...
    out: capo_cloudhsm_v2.types.describe_clusters_response.DescribeClustersResponse = (
        capo_cloudhsm_v2.types.describe_clusters_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.describe_clusters_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
