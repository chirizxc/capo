...
def handle_response(
    ...
    out: capo_cloudhsm_v2.types.modify_backup_attributes_response.ModifyBackupAttributesResponse = capo_cloudhsm_v2.types.modify_backup_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.modify_backup_attributes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
