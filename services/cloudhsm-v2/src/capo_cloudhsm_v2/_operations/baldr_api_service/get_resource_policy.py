"""Generated from Smithy shape ``com.amazonaws.cloudhsmv2#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_cloudhsm_v2.types.get_resource_policy_response.GetResourcePolicyResponse = capo_cloudhsm_v2.types.get_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudhsm_v2.types.get_resource_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
