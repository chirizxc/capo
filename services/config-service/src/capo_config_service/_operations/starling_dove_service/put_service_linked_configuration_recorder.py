"""Generated from Smithy shape ``com.amazonaws.configservice#PutServiceLinkedConfigurationRecorder``."""
...
def handle_response(
    ...
    out: capo_config_service.types.put_service_linked_configuration_recorder_response.PutServiceLinkedConfigurationRecorderResponse = capo_config_service.types.put_service_linked_configuration_recorder_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_service_linked_configuration_recorder_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_service_linked_configuration_recorder(
