...
def handle_response(
    ...
    out: capo_config_service.types.batch_get_aggregate_resource_config_response.BatchGetAggregateResourceConfigResponse = capo_config_service.types.batch_get_aggregate_resource_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.batch_get_aggregate_resource_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
