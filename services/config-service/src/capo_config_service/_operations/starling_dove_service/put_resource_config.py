...
import capo_config_service.errors.max_active_resources_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaxActiveResourcesExceededException":
            raise capo_config_service.errors.max_active_resources_exceeded_exception.MaxActiveResourcesExceededException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_resource_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
