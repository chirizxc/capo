...
def handle_response(
    ...
    out: capo_config_service.types.describe_organization_conformance_packs_response.DescribeOrganizationConformancePacksResponse = capo_config_service.types.describe_organization_conformance_packs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_organization_conformance_packs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
