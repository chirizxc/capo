...
import capo_config_service.errors.last_delivery_channel_delete_failed_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "LastDeliveryChannelDeleteFailedException":
            raise capo_config_service.errors.last_delivery_channel_delete_failed_exception.LastDeliveryChannelDeleteFailedException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.delete_delivery_channel_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
