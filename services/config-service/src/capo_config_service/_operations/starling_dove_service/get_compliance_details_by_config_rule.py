"""Generated from Smithy shape ``com.amazonaws.configservice#GetComplianceDetailsByConfigRule``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_compliance_details_by_config_rule_response.GetComplianceDetailsByConfigRuleResponse = capo_config_service.types.get_compliance_details_by_config_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetComplianceDetailsByConfigRule"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_compliance_details_by_config_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_compliance_details_by_config_rule(
