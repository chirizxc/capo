"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeRemediationConfigurations``."""
...
def handle_response(
    ...
    out: capo_config_service.types.describe_remediation_configurations_response.DescribeRemediationConfigurationsResponse = capo_config_service.types.describe_remediation_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeRemediationConfigurations"
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_remediation_configurations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_remediation_configurations(
