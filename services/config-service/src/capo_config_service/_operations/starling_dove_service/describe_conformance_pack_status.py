"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeConformancePackStatus``."""
...
def handle_response(
    ...
    out: capo_config_service.types.describe_conformance_pack_status_response.DescribeConformancePackStatusResponse = capo_config_service.types.describe_conformance_pack_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_conformance_pack_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_conformance_pack_status(
