"""Generated from Smithy shape ``com.amazonaws.configservice#ListConformancePackComplianceScores``."""
...
def handle_response(
    ...
    out: capo_config_service.types.list_conformance_pack_compliance_scores_response.ListConformancePackComplianceScoresResponse = capo_config_service.types.list_conformance_pack_compliance_scores_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.ListConformancePackComplianceScores"
    body: bytes | None = json.dumps(
        capo_config_service.types.list_conformance_pack_compliance_scores_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_conformance_pack_compliance_scores(
