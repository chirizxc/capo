"""Generated from Smithy shape ``com.amazonaws.configservice#GetConformancePackComplianceDetails``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_conformance_pack_compliance_details_response.GetConformancePackComplianceDetailsResponse = capo_config_service.types.get_conformance_pack_compliance_details_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.GetConformancePackComplianceDetails"
    body: bytes | None = json.dumps(
        capo_config_service.types.get_conformance_pack_compliance_details_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_conformance_pack_compliance_details(
