"""Generated from Smithy shape ``com.amazonaws.configservice#GetAggregateConformancePackComplianceSummary``."""
...
def handle_response(
    ...
    out: capo_config_service.types.get_aggregate_conformance_pack_compliance_summary_response.GetAggregateConformancePackComplianceSummaryResponse = capo_config_service.types.get_aggregate_conformance_pack_compliance_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.get_aggregate_conformance_pack_compliance_summary_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_aggregate_conformance_pack_compliance_summary(
