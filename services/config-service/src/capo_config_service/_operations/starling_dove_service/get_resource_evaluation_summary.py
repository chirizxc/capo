...
def handle_response(
    ...
    out: capo_config_service.types.get_resource_evaluation_summary_response.GetResourceEvaluationSummaryResponse = capo_config_service.types.get_resource_evaluation_summary_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.get_resource_evaluation_summary_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
