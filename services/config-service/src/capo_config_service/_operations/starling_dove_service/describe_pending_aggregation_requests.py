...
def handle_response(
    ...
    out: capo_config_service.types.describe_pending_aggregation_requests_response.DescribePendingAggregationRequestsResponse = capo_config_service.types.describe_pending_aggregation_requests_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_pending_aggregation_requests_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
