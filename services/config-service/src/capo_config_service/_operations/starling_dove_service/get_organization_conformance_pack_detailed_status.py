...
def handle_response(
    ...
    out: capo_config_service.types.get_organization_conformance_pack_detailed_status_response.GetOrganizationConformancePackDetailedStatusResponse = capo_config_service.types.get_organization_conformance_pack_detailed_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.get_organization_conformance_pack_detailed_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
