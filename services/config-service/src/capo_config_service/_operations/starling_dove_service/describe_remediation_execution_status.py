"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeRemediationExecutionStatus``."""
...
import capo_config_service.types.remediation_execution_statuses
...
def handle_response(
    ...
    out: capo_config_service.types.describe_remediation_execution_status_response.DescribeRemediationExecutionStatusResponse = capo_config_service.types.describe_remediation_execution_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeRemediationExecutionStatus"
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_remediation_execution_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_remediation_execution_status(
