...
def handle_response(
    ...
    out: capo_config_service.types.put_external_evaluation_response.PutExternalEvaluationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_external_evaluation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
