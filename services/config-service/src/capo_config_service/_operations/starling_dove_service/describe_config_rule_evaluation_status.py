"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeConfigRuleEvaluationStatus``."""
...
def handle_response(
    ...
    out: capo_config_service.types.describe_config_rule_evaluation_status_response.DescribeConfigRuleEvaluationStatusResponse = capo_config_service.types.describe_config_rule_evaluation_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeConfigRuleEvaluationStatus"
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_config_rule_evaluation_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_config_rule_evaluation_status(
