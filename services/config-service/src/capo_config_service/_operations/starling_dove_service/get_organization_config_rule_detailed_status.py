...
def handle_response(
    ...
    out: capo_config_service.types.get_organization_config_rule_detailed_status_response.GetOrganizationConfigRuleDetailedStatusResponse = capo_config_service.types.get_organization_config_rule_detailed_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.get_organization_config_rule_detailed_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
