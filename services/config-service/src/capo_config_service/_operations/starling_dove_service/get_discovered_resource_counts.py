"""Generated from Smithy shape ``com.amazonaws.configservice#GetDiscoveredResourceCounts``."""
...
import capo_config_service.types.resource_counts
...
def handle_response(
    ...
    out: capo_config_service.types.get_discovered_resource_counts_response.GetDiscoveredResourceCountsResponse = capo_config_service.types.get_discovered_resource_counts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.get_discovered_resource_counts_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_discovered_resource_counts(
