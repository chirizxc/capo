"""Generated from Smithy shape ``com.amazonaws.configservice#ListResourceEvaluations``."""
...
def handle_response(
    ...
    out: capo_config_service.types.list_resource_evaluations_response.ListResourceEvaluationsResponse = capo_config_service.types.list_resource_evaluations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.ListResourceEvaluations"
    body: bytes | None = json.dumps(
        capo_config_service.types.list_resource_evaluations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_resource_evaluations(
