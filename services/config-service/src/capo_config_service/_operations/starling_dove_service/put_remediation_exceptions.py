"""Generated from Smithy shape ``com.amazonaws.configservice#PutRemediationExceptions``."""
...
def handle_response(
    ...
    out: capo_config_service.types.put_remediation_exceptions_response.PutRemediationExceptionsResponse = capo_config_service.types.put_remediation_exceptions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_remediation_exceptions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_remediation_exceptions(
