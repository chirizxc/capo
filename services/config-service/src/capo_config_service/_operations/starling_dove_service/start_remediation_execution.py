...
def handle_response(
    ...
    out: capo_config_service.types.start_remediation_execution_response.StartRemediationExecutionResponse = capo_config_service.types.start_remediation_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.start_remediation_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
