"""Generated from Smithy shape ``com.amazonaws.configservice#DeletePendingAggregationRequest``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DeletePendingAggregationRequest"
    body: bytes | None = json.dumps(
        capo_config_service.types.delete_pending_aggregation_request_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_pending_aggregation_request(
