"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeConfigurationAggregators``."""
...
def handle_response(
    ...
    out: capo_config_service.types.describe_configuration_aggregators_response.DescribeConfigurationAggregatorsResponse = capo_config_service.types.describe_configuration_aggregators_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeConfigurationAggregators"
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_configuration_aggregators_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_configuration_aggregators(
