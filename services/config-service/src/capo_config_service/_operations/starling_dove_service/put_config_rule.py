"""Generated from Smithy shape ``com.amazonaws.configservice#PutConfigRule``."""
...
import capo_config_service.errors.max_number_of_config_rules_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MaxNumberOfConfigRulesExceededException":
            raise capo_config_service.errors.max_number_of_config_rules_exceeded_exception.MaxNumberOfConfigRulesExceededException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.put_config_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_config_rule(
