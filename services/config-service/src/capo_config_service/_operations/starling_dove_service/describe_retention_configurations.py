...
def handle_response(
    ...
    out: capo_config_service.types.describe_retention_configurations_response.DescribeRetentionConfigurationsResponse = capo_config_service.types.describe_retention_configurations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_retention_configurations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
