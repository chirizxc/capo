"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteRemediationExceptions``."""
...
import capo_config_service.errors.no_such_remediation_exception_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "NoSuchRemediationExceptionException":
            raise capo_config_service.errors.no_such_remediation_exception_exception.NoSuchRemediationExceptionException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_config_service.types.delete_remediation_exceptions_response.DeleteRemediationExceptionsResponse = capo_config_service.types.delete_remediation_exceptions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.delete_remediation_exceptions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_remediation_exceptions(
