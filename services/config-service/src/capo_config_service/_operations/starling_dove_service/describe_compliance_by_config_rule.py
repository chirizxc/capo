"""Generated from Smithy shape ``com.amazonaws.configservice#DescribeComplianceByConfigRule``."""
...
def handle_response(
    ...
    out: capo_config_service.types.describe_compliance_by_config_rule_response.DescribeComplianceByConfigRuleResponse = capo_config_service.types.describe_compliance_by_config_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DescribeComplianceByConfigRule"
    body: bytes | None = json.dumps(
        capo_config_service.types.describe_compliance_by_config_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_compliance_by_config_rule(
