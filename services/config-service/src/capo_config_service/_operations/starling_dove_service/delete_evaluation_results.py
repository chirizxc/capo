"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteEvaluationResults``."""
...
def handle_response(
    ...
    out: capo_config_service.types.delete_evaluation_results_response.DeleteEvaluationResultsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.delete_evaluation_results_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_evaluation_results(
