"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteOrganizationConfigRule``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.delete_organization_config_rule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_organization_config_rule(
