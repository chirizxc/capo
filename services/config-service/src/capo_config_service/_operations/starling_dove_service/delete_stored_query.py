"""Generated from Smithy shape ``com.amazonaws.configservice#DeleteStoredQuery``."""
...
def handle_response(
    ...
    out: capo_config_service.types.delete_stored_query_response.DeleteStoredQueryResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "StarlingDoveService.DeleteStoredQuery"
    body: bytes | None = json.dumps(
        capo_config_service.types.delete_stored_query_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_stored_query(
