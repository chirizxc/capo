"""Generated from Smithy shape ``com.amazonaws.configservice#StartConfigurationRecorder``."""
...
import capo_config_service.errors.no_available_delivery_channel_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "NoAvailableDeliveryChannelException":
            raise capo_config_service.errors.no_available_delivery_channel_exception.NoAvailableDeliveryChannelException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_config_service.types.start_configuration_recorder_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_configuration_recorder(
