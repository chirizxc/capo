...
class ListConfigurationRecordersRequest(TypedDict, closed=True):
    ...
    max_results: NotRequired["capo_config_service.types.max_results.MaxResults"]
...
def serialize_aws_json_1_1(value: ListConfigurationRecordersRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            capo_config_service.types.configuration_recorder_filter_list.serialize_aws_json_1_1(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListConfigurationRecordersRequest:
    ...
    if data.get("Filters") is not None:
        ...
        out["filters"] = (
            capo_config_service.types.configuration_recorder_filter_list.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
