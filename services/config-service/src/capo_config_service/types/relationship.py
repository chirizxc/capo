...
if TYPE_CHECKING:
    import capo_config_service.types.relationship_name
...
class Relationship(TypedDict, closed=True):
    ...
    relationship_name: NotRequired[
        "capo_config_service.types.relationship_name.RelationshipName"
    ]
...
def deserialize_aws_json_1_1(data: dict) -> Relationship:
    ...
    if data.get("relationshipName") is not None:
