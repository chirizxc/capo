...
if TYPE_CHECKING:
    import capo_config_service.types.organization_config_rule_trigger_type_no_sn
...
def serialize_aws_json_1_1(value: OrganizationConfigRuleTriggerTypeNoSNs) -> list:
    ...
    for item in value:
        out.append(
            capo_config_service.types.organization_config_rule_trigger_type_no_sn.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> OrganizationConfigRuleTriggerTypeNoSNs:
    ...
    for item in data:
        if item is None:
            continue
        out.append(
            capo_config_service.types.organization_config_rule_trigger_type_no_sn.deserialize_aws_json_1_1(
                item
            )
        )
    return out
