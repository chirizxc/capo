...
class GetResourceConfigHistoryResponse(TypedDict, closed=True):
    configuration_items: NotRequired[
        "capo_config_service.types.configuration_item_list.ConfigurationItemList"
    ]
...
def serialize_aws_json_1_1(value: GetResourceConfigHistoryResponse) -> dict:
    ...
    if "configuration_items" in value:
        ...
        out["configurationItems"] = (
            capo_config_service.types.configuration_item_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetResourceConfigHistoryResponse:
    ...
    if data.get("configurationItems") is not None:
        ...
        out["configuration_items"] = (
            capo_config_service.types.configuration_item_list.deserialize_aws_json_1_1(
