...
class DescribeDeliveryChannelStatusResponse(TypedDict, closed=True):
    delivery_channels_status: NotRequired[
        "capo_config_service.types.delivery_channel_status_list.DeliveryChannelStatusList"
    ]
...
def serialize_aws_json_1_1(value: DescribeDeliveryChannelStatusResponse) -> dict:
    ...
    if "delivery_channels_status" in value:
        ...
        out["DeliveryChannelsStatus"] = (
            capo_config_service.types.delivery_channel_status_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeDeliveryChannelStatusResponse:
    ...
    if data.get("DeliveryChannelsStatus") is not None:
        import capo_config_service.types.delivery_channel_status_list

        out["delivery_channels_status"] = (
            capo_config_service.types.delivery_channel_status_list.deserialize_aws_json_1_1(
