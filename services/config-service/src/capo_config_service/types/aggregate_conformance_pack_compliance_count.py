...
class AggregateConformancePackComplianceCount(TypedDict, closed=True):
    compliant_conformance_pack_count: "capo_config_service.types.integer.Integer"
    """<p>Number of compliant conformance packs.</p>"""
    non_compliant_conformance_pack_count: "capo_config_service.types.integer.Integer"
