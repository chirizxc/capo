...
class ResourceEvaluationFilters(TypedDict, closed=True):
    ...
    time_window: NotRequired["capo_config_service.types.time_window.TimeWindow"]
...
def serialize_aws_json_1_1(value: ResourceEvaluationFilters) -> dict:
    ...
    if "time_window" in value:
        ...
        out["TimeWindow"] = (
            capo_config_service.types.time_window.serialize_aws_json_1_1(
                value["time_window"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ResourceEvaluationFilters:
    ...
    if data.get("TimeWindow") is not None:
        ...
        out["time_window"] = (
            capo_config_service.types.time_window.deserialize_aws_json_1_1(
                data["TimeWindow"]
            )
        )
