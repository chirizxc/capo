...
class DescribeAggregateComplianceByConformancePacksResponse(TypedDict, closed=True):
    aggregate_compliance_by_conformance_packs: NotRequired[
        "capo_config_service.types.aggregate_compliance_by_conformance_pack_list.AggregateComplianceByConformancePackList"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "aggregate_compliance_by_conformance_packs" in value:
        ...
        out["AggregateComplianceByConformancePacks"] = (
            capo_config_service.types.aggregate_compliance_by_conformance_pack_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if data.get("AggregateComplianceByConformancePacks") is not None:
        ...
        out["aggregate_compliance_by_conformance_packs"] = (
            capo_config_service.types.aggregate_compliance_by_conformance_pack_list.deserialize_aws_json_1_1(
