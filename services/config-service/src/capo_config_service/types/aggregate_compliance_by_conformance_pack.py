...
class AggregateComplianceByConformancePack(TypedDict, closed=True):
    ...
    compliance: NotRequired[
        "capo_config_service.types.aggregate_conformance_pack_compliance.AggregateConformancePackCompliance"
    ]
...
def serialize_aws_json_1_1(value: AggregateComplianceByConformancePack) -> dict:
    ...
    if "compliance" in value:
        ...
        out["Compliance"] = (
            capo_config_service.types.aggregate_conformance_pack_compliance.serialize_aws_json_1_1(
                value["compliance"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> AggregateComplianceByConformancePack:
    ...
    if data.get("Compliance") is not None:
        ...
        out["compliance"] = (
            capo_config_service.types.aggregate_conformance_pack_compliance.deserialize_aws_json_1_1(
                data["Compliance"]
            )
        )
