...
class StoredQueryMetadata(TypedDict, closed=True):
    query_id: "capo_config_service.types.query_id.QueryId"
    """<p>The ID of the query. </p>"""
    query_arn: "capo_config_service.types.query_arn.QueryArn"
