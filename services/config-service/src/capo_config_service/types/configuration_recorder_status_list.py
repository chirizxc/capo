...
if TYPE_CHECKING:
    import capo_config_service.types.configuration_recorder_status

ConfigurationRecorderStatusList: TypeAlias = list[
    "capo_config_service.types.configuration_recorder_status.ConfigurationRecorderStatus"
]
...
def serialize_aws_json_1_1(value: ConfigurationRecorderStatusList) -> list:
    ...
    for item in value:
        out.append(
            capo_config_service.types.configuration_recorder_status.serialize_aws_json_1_1(
                item
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: list) -> ConfigurationRecorderStatusList:
    ...
    for item in data:
        if item is None:
            continue
        out.append(
            capo_config_service.types.configuration_recorder_status.deserialize_aws_json_1_1(
                item
            )
        )
    return out
