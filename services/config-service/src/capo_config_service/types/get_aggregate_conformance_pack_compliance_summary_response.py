...
class GetAggregateConformancePackComplianceSummaryResponse(TypedDict, closed=True):
    aggregate_conformance_pack_compliance_summaries: NotRequired[
        "capo_config_service.types.aggregate_conformance_pack_compliance_summary_list.AggregateConformancePackComplianceSummaryList"
    ]
...
def serialize_aws_json_1_1(
    ...
    if "aggregate_conformance_pack_compliance_summaries" in value:
        ...
        out["AggregateConformancePackComplianceSummaries"] = (
            capo_config_service.types.aggregate_conformance_pack_compliance_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(
    ...
    if data.get("AggregateConformancePackComplianceSummaries") is not None:
        ...
        out["aggregate_conformance_pack_compliance_summaries"] = (
            capo_config_service.types.aggregate_conformance_pack_compliance_summary_list.deserialize_aws_json_1_1(
