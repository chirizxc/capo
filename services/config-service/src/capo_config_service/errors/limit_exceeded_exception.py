"""Generated from Smithy shape ``com.amazonaws.configservice#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.configservice#LimitExceededException``."""
