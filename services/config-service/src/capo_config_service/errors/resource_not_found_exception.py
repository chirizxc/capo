"""Generated from Smithy shape ``com.amazonaws.configservice#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.configservice#ResourceNotFoundException``."""
