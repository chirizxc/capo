"""Generated from Smithy shape ``com.amazonaws.configservice#UnmodifiableEntityException``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UnmodifiableEntityException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class UnmodifiableEntityException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.configservice#UnmodifiableEntityException``."""
