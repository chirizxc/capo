"""Generated from Smithy shape ``com.amazonaws.applicationinsights#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationinsights#ResourceInUseException``."""
