...
from capo_application_insights._services._aws_config import aws_config
...
class ApplicationInsightsClient:
    ...
    def add_workload(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.add_workload_request.AddWorkloadRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.add_workload_response.AddWorkloadResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.add_workload.add_workload(
    ...
    def create_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.create_application_request.CreateApplicationRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.create_application_response.CreateApplicationResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.create_application.create_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_component(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.create_component_request.CreateComponentRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.create_component_response.CreateComponentResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.create_component.create_component(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_log_pattern(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.create_log_pattern_request.CreateLogPatternRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.create_log_pattern_response.CreateLogPatternResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.create_log_pattern.create_log_pattern(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.delete_application_request.DeleteApplicationRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.delete_application_response.DeleteApplicationResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.delete_application.delete_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_component(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.delete_component_request.DeleteComponentRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.delete_component_response.DeleteComponentResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.delete_component.delete_component(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_log_pattern(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.delete_log_pattern_request.DeleteLogPatternRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.delete_log_pattern_response.DeleteLogPatternResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.delete_log_pattern.delete_log_pattern(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_application_request.DescribeApplicationRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_application_response.DescribeApplicationResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_application.describe_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_component(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_component_request.DescribeComponentRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_component_response.DescribeComponentResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_component.describe_component(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_component_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_component_configuration_request.DescribeComponentConfigurationRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_component_configuration_response.DescribeComponentConfigurationResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_component_configuration.describe_component_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_component_configuration_recommendation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_component_configuration_recommendation_request.DescribeComponentConfigurationRecommendationRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_component_configuration_recommendation_response.DescribeComponentConfigurationRecommendationResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_component_configuration_recommendation.describe_component_configuration_recommendation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_log_pattern(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_log_pattern_request.DescribeLogPatternRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_log_pattern_response.DescribeLogPatternResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_log_pattern.describe_log_pattern(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_observation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_observation_request.DescribeObservationRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_observation_response.DescribeObservationResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_observation.describe_observation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_problem(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_problem_request.DescribeProblemRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_problem_response.DescribeProblemResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_problem.describe_problem(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_problem_observations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_problem_observations_request.DescribeProblemObservationsRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_problem_observations_response.DescribeProblemObservationsResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_problem_observations.describe_problem_observations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_workload(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.describe_workload_request.DescribeWorkloadRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.describe_workload_response.DescribeWorkloadResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.describe_workload.describe_workload(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_applications(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.list_applications_request.ListApplicationsRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.list_applications_response.ListApplicationsResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.list_applications.list_applications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_application_insights.types.list_applications_response.ListApplicationsResponse]":
        _token = next_token
        while True:
    ...
    def list_components(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.list_components_request.ListComponentsRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.list_components_response.ListComponentsResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.list_components.list_components(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_application_insights.types.list_components_response.ListComponentsResponse]":
        _token = next_token
        while True:
    ...
    def list_configuration_history(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.list_configuration_history_request.ListConfigurationHistoryRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.list_configuration_history_response.ListConfigurationHistoryResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.list_configuration_history.list_configuration_history(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_configuration_history(
        self,
        *,
        config_overrides: Optional[ApplicationInsightsClientConfig] = None,
        resource_group_name: Optional[
    ...
    ) -> "Iterator[capo_application_insights.types.list_configuration_history_response.ListConfigurationHistoryResponse]":
        _token = next_token
        while True:
            _response = self.list_configuration_history(
                config_overrides=config_overrides,
                resource_group_name=resource_group_name,
    ...
    def list_log_patterns(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.list_log_patterns_request.ListLogPatternsRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.list_log_patterns_response.ListLogPatternsResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.list_log_patterns.list_log_patterns(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_application_insights.types.list_log_patterns_response.ListLogPatternsResponse]":
        _token = next_token
        while True:
            _response = self.list_log_patterns(
                resource_group_name,
                config_overrides=config_overrides,
                pattern_set_name=pattern_set_name,
                max_results=max_results,
    ...
    def list_log_pattern_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.list_log_pattern_sets_request.ListLogPatternSetsRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.list_log_pattern_sets_response.ListLogPatternSetsResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.list_log_pattern_sets.list_log_pattern_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_log_pattern_sets(
        self,
        resource_group_name: "capo_application_insights.types.resource_group_name.ResourceGroupName",
        *,
        config_overrides: Optional[ApplicationInsightsClientConfig] = None,
    ...
    ) -> "Iterator[capo_application_insights.types.list_log_pattern_sets_response.ListLogPatternSetsResponse]":
        _token = next_token
        while True:
            _response = self.list_log_pattern_sets(
                resource_group_name,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def list_problems(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.list_problems_request.ListProblemsRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.list_problems_response.ListProblemsResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.list_problems.list_problems(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_application_insights.types.list_problems_response.ListProblemsResponse]":
        _token = next_token
        while True:
            _response = self.list_problems(
                config_overrides=config_overrides,
                account_id=account_id,
                resource_group_name=resource_group_name,
                start_time=start_time,
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_workloads(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.list_workloads_request.ListWorkloadsRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.list_workloads_response.ListWorkloadsResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.list_workloads.list_workloads(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_application_insights.types.list_workloads_response.ListWorkloadsResponse]":
        _token = next_token
        while True:
            _response = self.list_workloads(
                resource_group_name,
                component_name,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    def remove_workload(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.remove_workload_request.RemoveWorkloadRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.remove_workload_response.RemoveWorkloadResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.remove_workload.remove_workload(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_application(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.update_application_request.UpdateApplicationRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.update_application_response.UpdateApplicationResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.update_application.update_application(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_component(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.update_component_request.UpdateComponentRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.update_component_response.UpdateComponentResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.update_component.update_component(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_component_configuration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.update_component_configuration_request.UpdateComponentConfigurationRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.update_component_configuration_response.UpdateComponentConfigurationResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.update_component_configuration.update_component_configuration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_log_pattern(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.update_log_pattern_request.UpdateLogPatternRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.update_log_pattern_response.UpdateLogPatternResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.update_log_pattern.update_log_pattern(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_problem(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.update_problem_request.UpdateProblemRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.update_problem_response.UpdateProblemResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.update_problem.update_problem(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_workload(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_application_insights.types.update_workload_request.UpdateWorkloadRequest]",
        ) -> OperationResponse[
            "capo_application_insights.types.update_workload_response.UpdateWorkloadResponse"
        ]:
            ...
            output, http_response = (
                capo_application_insights._operations.ec2_windows_barley_service.update_workload.update_workload(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
