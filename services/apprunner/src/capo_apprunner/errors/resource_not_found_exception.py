"""Generated from Smithy shape ``com.amazonaws.apprunner#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.apprunner#ResourceNotFoundException``."""
