...
if TYPE_CHECKING:
    import capo_apprunner.types.certificate_validation_record

CertificateValidationRecordList: TypeAlias = list[
    "capo_apprunner.types.certificate_validation_record.CertificateValidationRecord"
]
...
def serialize_aws_json_1_0(value: CertificateValidationRecordList) -> list:
    ...
    for item in value:
        out.append(
            capo_apprunner.types.certificate_validation_record.serialize_aws_json_1_0(
                item
            )
        )
    return out
