"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#UpdateResourceSetResponse``."""
...
class UpdateResourceSetResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateResourceSetResponse) -> dict:
    out: dict = {}
