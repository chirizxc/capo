...
if TYPE_CHECKING:
    import capo_route53_recovery_readiness.types.resource

__listOfResource: TypeAlias = list[
    "capo_route53_recovery_readiness.types.resource.Resource"
]
...
def serialize_json(value: __listOfResource) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_route53_recovery_readiness.types.resource.serialize_json(item))
    return out
