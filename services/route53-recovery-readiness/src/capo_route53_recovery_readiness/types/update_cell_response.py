"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#UpdateCellResponse``."""
...
class UpdateCellResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateCellResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateCellResponse:
    out: UpdateCellResponse = {}  # type: ignore[typeddict-item]
