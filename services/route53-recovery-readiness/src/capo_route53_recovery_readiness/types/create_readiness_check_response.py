"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#CreateReadinessCheckResponse``."""
...
class CreateReadinessCheckResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateReadinessCheckResponse) -> dict:
    out: dict = {}
