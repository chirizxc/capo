"""Generated from Smithy shape ``com.amazonaws.route53recoveryreadiness#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.route53recoveryreadiness#ValidationException``."""
