"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#InvalidRequestException``."""
...
class InvalidRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.comprehendmedical#InvalidRequestException``."""
