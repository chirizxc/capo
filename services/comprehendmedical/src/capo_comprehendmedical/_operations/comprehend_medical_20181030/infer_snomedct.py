"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#InferSNOMEDCT``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.infer_snomedct_response.InferSNOMEDCTResponse = (
        capo_comprehendmedical.types.infer_snomedct_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.InferSNOMEDCT"
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.infer_snomedct_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_infer_snomedct(
