"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#ListEntitiesDetectionV2Jobs``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.list_entities_detection_v2_jobs_response.ListEntitiesDetectionV2JobsResponse = capo_comprehendmedical.types.list_entities_detection_v2_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.list_entities_detection_v2_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_entities_detection_v2_jobs(
