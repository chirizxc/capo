"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#InferRxNorm``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.infer_rx_norm_response.InferRxNormResponse = (
        capo_comprehendmedical.types.infer_rx_norm_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.infer_rx_norm_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
