"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#StopICD10CMInferenceJob``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.stop_icd10_cm_inference_job_response.StopICD10CMInferenceJobResponse = capo_comprehendmedical.types.stop_icd10_cm_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.StopICD10CMInferenceJob"
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.stop_icd10_cm_inference_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_icd10_cm_inference_job(
