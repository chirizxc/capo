...
def handle_response(
    ...
    out: capo_comprehendmedical.types.start_snomedct_inference_job_response.StartSNOMEDCTInferenceJobResponse = capo_comprehendmedical.types.start_snomedct_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.start_snomedct_inference_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
