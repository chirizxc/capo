"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#StopRxNormInferenceJob``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.stop_rx_norm_inference_job_response.StopRxNormInferenceJobResponse = capo_comprehendmedical.types.stop_rx_norm_inference_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.StopRxNormInferenceJob"
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.stop_rx_norm_inference_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_rx_norm_inference_job(
