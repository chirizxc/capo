"""Generated from Smithy shape ``com.amazonaws.comprehendmedical#ListSNOMEDCTInferenceJobs``."""
...
def handle_response(
    ...
    out: capo_comprehendmedical.types.list_snomedct_inference_jobs_response.ListSNOMEDCTInferenceJobsResponse = capo_comprehendmedical.types.list_snomedct_inference_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComprehendMedical_20181030.ListSNOMEDCTInferenceJobs"
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.list_snomedct_inference_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_snomedct_inference_jobs(
