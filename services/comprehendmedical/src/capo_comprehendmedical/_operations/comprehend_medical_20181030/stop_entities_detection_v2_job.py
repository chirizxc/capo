...
def handle_response(
    ...
    out: capo_comprehendmedical.types.stop_entities_detection_v2_job_response.StopEntitiesDetectionV2JobResponse = capo_comprehendmedical.types.stop_entities_detection_v2_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehendmedical.types.stop_entities_detection_v2_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
