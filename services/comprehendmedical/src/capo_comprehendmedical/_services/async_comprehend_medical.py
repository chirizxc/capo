...
from capo_comprehendmedical._services._aws_config import aaws_config
...
class AsyncComprehendMedicalClientConfig(TypedDict, total=False, closed=True):
...
class AsyncComprehendMedicalClient:
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncComprehendMedicalClientConfig] = None
    ...
    async def describe_entities_detection_v2_job(
        ...
        *,
        config_overrides: Optional[AsyncComprehendMedicalClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.describe_entities_detection_v2_job_request.DescribeEntitiesDetectionV2JobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.describe_entities_detection_v2_job_response.DescribeEntitiesDetectionV2JobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.describe_entities_detection_v2_job.async_describe_entities_detection_v2_job(
    ...
    async def describe_icd10_cm_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.describe_icd10_cm_inference_job_request.DescribeICD10CMInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.describe_icd10_cm_inference_job_response.DescribeICD10CMInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.describe_icd10_cm_inference_job.async_describe_icd10_cm_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_phi_detection_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.describe_phi_detection_job_request.DescribePHIDetectionJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.describe_phi_detection_job_response.DescribePHIDetectionJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.describe_phi_detection_job.async_describe_phi_detection_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_rx_norm_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.describe_rx_norm_inference_job_request.DescribeRxNormInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.describe_rx_norm_inference_job_response.DescribeRxNormInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.describe_rx_norm_inference_job.async_describe_rx_norm_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_snomedct_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.describe_snomedct_inference_job_request.DescribeSNOMEDCTInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.describe_snomedct_inference_job_response.DescribeSNOMEDCTInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.describe_snomedct_inference_job.async_describe_snomedct_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detect_entities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.detect_entities_request.DetectEntitiesRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.detect_entities_response.DetectEntitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.detect_entities.async_detect_entities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detect_entities_v2(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.detect_entities_v2_request.DetectEntitiesV2Request]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.detect_entities_v2_response.DetectEntitiesV2Response"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.detect_entities_v2.async_detect_entities_v2(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def detect_phi(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.detect_phi_request.DetectPHIRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.detect_phi_response.DetectPHIResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.detect_phi.async_detect_phi(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def infer_icd10_cm(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.infer_icd10_cm_request.InferICD10CMRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.infer_icd10_cm_response.InferICD10CMResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.infer_icd10_cm.async_infer_icd10_cm(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def infer_rx_norm(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.infer_rx_norm_request.InferRxNormRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.infer_rx_norm_response.InferRxNormResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.infer_rx_norm.async_infer_rx_norm(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def infer_snomedct(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.infer_snomedct_request.InferSNOMEDCTRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.infer_snomedct_response.InferSNOMEDCTResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.infer_snomedct.async_infer_snomedct(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_entities_detection_v2_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.list_entities_detection_v2_jobs_request.ListEntitiesDetectionV2JobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.list_entities_detection_v2_jobs_response.ListEntitiesDetectionV2JobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.list_entities_detection_v2_jobs.async_list_entities_detection_v2_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_icd10_cm_inference_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.list_icd10_cm_inference_jobs_request.ListICD10CMInferenceJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.list_icd10_cm_inference_jobs_response.ListICD10CMInferenceJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.list_icd10_cm_inference_jobs.async_list_icd10_cm_inference_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_phi_detection_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.list_phi_detection_jobs_request.ListPHIDetectionJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.list_phi_detection_jobs_response.ListPHIDetectionJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.list_phi_detection_jobs.async_list_phi_detection_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_rx_norm_inference_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.list_rx_norm_inference_jobs_request.ListRxNormInferenceJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.list_rx_norm_inference_jobs_response.ListRxNormInferenceJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.list_rx_norm_inference_jobs.async_list_rx_norm_inference_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_snomedct_inference_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.list_snomedct_inference_jobs_request.ListSNOMEDCTInferenceJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.list_snomedct_inference_jobs_response.ListSNOMEDCTInferenceJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.list_snomedct_inference_jobs.async_list_snomedct_inference_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_entities_detection_v2_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.start_entities_detection_v2_job_request.StartEntitiesDetectionV2JobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.start_entities_detection_v2_job_response.StartEntitiesDetectionV2JobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.start_entities_detection_v2_job.async_start_entities_detection_v2_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_icd10_cm_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.start_icd10_cm_inference_job_request.StartICD10CMInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.start_icd10_cm_inference_job_response.StartICD10CMInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.start_icd10_cm_inference_job.async_start_icd10_cm_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_phi_detection_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.start_phi_detection_job_request.StartPHIDetectionJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.start_phi_detection_job_response.StartPHIDetectionJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.start_phi_detection_job.async_start_phi_detection_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_rx_norm_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.start_rx_norm_inference_job_request.StartRxNormInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.start_rx_norm_inference_job_response.StartRxNormInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.start_rx_norm_inference_job.async_start_rx_norm_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_snomedct_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.start_snomedct_inference_job_request.StartSNOMEDCTInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.start_snomedct_inference_job_response.StartSNOMEDCTInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.start_snomedct_inference_job.async_start_snomedct_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_entities_detection_v2_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.stop_entities_detection_v2_job_request.StopEntitiesDetectionV2JobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.stop_entities_detection_v2_job_response.StopEntitiesDetectionV2JobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.stop_entities_detection_v2_job.async_stop_entities_detection_v2_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_icd10_cm_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.stop_icd10_cm_inference_job_request.StopICD10CMInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.stop_icd10_cm_inference_job_response.StopICD10CMInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.stop_icd10_cm_inference_job.async_stop_icd10_cm_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_phi_detection_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.stop_phi_detection_job_request.StopPHIDetectionJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.stop_phi_detection_job_response.StopPHIDetectionJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.stop_phi_detection_job.async_stop_phi_detection_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_rx_norm_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.stop_rx_norm_inference_job_request.StopRxNormInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.stop_rx_norm_inference_job_response.StopRxNormInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.stop_rx_norm_inference_job.async_stop_rx_norm_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_snomedct_inference_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_comprehendmedical.types.stop_snomedct_inference_job_request.StopSNOMEDCTInferenceJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_comprehendmedical.types.stop_snomedct_inference_job_response.StopSNOMEDCTInferenceJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_comprehendmedical._operations.comprehend_medical_20181030.stop_snomedct_inference_job.async_stop_snomedct_inference_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
