...
class syntheticsClientConfig(TypedDict, total=False, closed=True):
...
class syntheticsClient:
    ...
    def __init__(
        ...
        self._config = syntheticsClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[syntheticsClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: syntheticsClientConfig = config_overrides or {}
    ...
    def associate_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.associate_resource_request.AssociateResourceRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.associate_resource_response.AssociateResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.associate_resource.associate_resource(
    ...
    def create_canary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.create_canary_request.CreateCanaryRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.create_canary_response.CreateCanaryResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.create_canary.create_canary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.create_group_request.CreateGroupRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.create_group_response.CreateGroupResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.create_group.create_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_canary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.delete_canary_request.DeleteCanaryRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.delete_canary_response.DeleteCanaryResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.delete_canary.delete_canary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.delete_group_request.DeleteGroupRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.delete_group_response.DeleteGroupResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.delete_group.delete_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_canaries(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.describe_canaries_request.DescribeCanariesRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.describe_canaries_response.DescribeCanariesResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.describe_canaries.describe_canaries(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_canaries_last_run(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.describe_canaries_last_run_request.DescribeCanariesLastRunRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.describe_canaries_last_run_response.DescribeCanariesLastRunResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.describe_canaries_last_run.describe_canaries_last_run(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_runtime_versions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.describe_runtime_versions_request.DescribeRuntimeVersionsRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.describe_runtime_versions_response.DescribeRuntimeVersionsResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.describe_runtime_versions.describe_runtime_versions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def disassociate_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.disassociate_resource_request.DisassociateResourceRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.disassociate_resource_response.DisassociateResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.disassociate_resource.disassociate_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_canary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.get_canary_request.GetCanaryRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.get_canary_response.GetCanaryResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.get_canary.get_canary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_canary_runs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.get_canary_runs_request.GetCanaryRunsRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.get_canary_runs_response.GetCanaryRunsResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.get_canary_runs.get_canary_runs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_group(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.get_group_request.GetGroupRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.get_group_response.GetGroupResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.get_group.get_group(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_associated_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.list_associated_groups_request.ListAssociatedGroupsRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.list_associated_groups_response.ListAssociatedGroupsResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.list_associated_groups.list_associated_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_group_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.list_group_resources_request.ListGroupResourcesRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.list_group_resources_response.ListGroupResourcesResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.list_group_resources.list_group_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_groups(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.list_groups_request.ListGroupsRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.list_groups_response.ListGroupsResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.list_groups.list_groups(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_canary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.start_canary_request.StartCanaryRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.start_canary_response.StartCanaryResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.start_canary.start_canary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_canary_dry_run(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.start_canary_dry_run_request.StartCanaryDryRunRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.start_canary_dry_run_response.StartCanaryDryRunResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.start_canary_dry_run.start_canary_dry_run(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_canary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.stop_canary_request.StopCanaryRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.stop_canary_response.StopCanaryResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.stop_canary.stop_canary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_canary(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_synthetics.types.update_canary_request.UpdateCanaryRequest]",
        ) -> OperationResponse[
            "capo_synthetics.types.update_canary_response.UpdateCanaryResponse"
        ]:
            ...
            output, http_response = (
                capo_synthetics._operations.synthetics.update_canary.update_canary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
