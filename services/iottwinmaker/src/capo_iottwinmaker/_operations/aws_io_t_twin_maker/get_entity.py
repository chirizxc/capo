"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#GetEntity``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.get_entity_response.GetEntityResponse = (
        capo_iottwinmaker.types.get_entity_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{entityId}", quote(input_["entity_id"], safe=""))
...
def get_entity(
    ...
    capo_iottwinmaker.types.get_entity_response.GetEntityResponse, zapros.Response
]:
