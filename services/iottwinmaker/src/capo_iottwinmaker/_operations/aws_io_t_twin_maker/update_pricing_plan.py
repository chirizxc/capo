"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#UpdatePricingPlan``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.update_pricing_plan_response.UpdatePricingPlanResponse = capo_iottwinmaker.types.update_pricing_plan_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.update_pricing_plan_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
