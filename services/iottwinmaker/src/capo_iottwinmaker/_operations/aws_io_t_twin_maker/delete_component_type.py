...
def handle_response(
    ...
    out: capo_iottwinmaker.types.delete_component_type_response.DeleteComponentTypeResponse = capo_iottwinmaker.types.delete_component_type_response.deserialize_json(
