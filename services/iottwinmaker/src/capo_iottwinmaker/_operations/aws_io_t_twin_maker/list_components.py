...
def handle_response(
    ...
    out: capo_iottwinmaker.types.list_components_response.ListComponentsResponse = (
        capo_iottwinmaker.types.list_components_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.list_components_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
