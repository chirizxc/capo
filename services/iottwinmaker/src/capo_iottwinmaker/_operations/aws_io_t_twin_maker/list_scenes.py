...
def handle_response(
    ...
    out: capo_iottwinmaker.types.list_scenes_response.ListScenesResponse = (
        capo_iottwinmaker.types.list_scenes_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.list_scenes_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_scenes(
    ...
    capo_iottwinmaker.types.list_scenes_response.ListScenesResponse, zapros.Response
]:
