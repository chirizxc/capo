...
def handle_response(
    ...
    out: capo_iottwinmaker.types.list_properties_response.ListPropertiesResponse = (
        capo_iottwinmaker.types.list_properties_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.list_properties_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
