"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#GetScene``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.get_scene_response.GetSceneResponse = (
        capo_iottwinmaker.types.get_scene_response.deserialize_json(
...
def get_scene(
    ...
    capo_iottwinmaker.types.get_scene_response.GetSceneResponse, zapros.Response
]:
