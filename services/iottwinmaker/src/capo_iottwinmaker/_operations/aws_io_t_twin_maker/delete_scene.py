"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#DeleteScene``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.delete_scene_response.DeleteSceneResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_scene(
    ...
    capo_iottwinmaker.types.delete_scene_response.DeleteSceneResponse, zapros.Response
]:
