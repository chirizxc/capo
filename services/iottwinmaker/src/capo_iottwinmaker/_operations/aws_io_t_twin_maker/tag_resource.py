...
import capo_iottwinmaker.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_iottwinmaker.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.tag_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_iottwinmaker.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
