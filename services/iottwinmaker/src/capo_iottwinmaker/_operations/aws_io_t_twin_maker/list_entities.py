"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#ListEntities``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.list_entities_response.ListEntitiesResponse = (
        capo_iottwinmaker.types.list_entities_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/entities-list"
    url = url.replace("{workspaceId}", quote(input_["workspace_id"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.list_entities_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_entities(
    ...
    capo_iottwinmaker.types.list_entities_response.ListEntitiesResponse, zapros.Response
]:
