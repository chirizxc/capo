"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#GetWorkspace``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.get_workspace_response.GetWorkspaceResponse = (
        capo_iottwinmaker.types.get_workspace_response.deserialize_json(
...
def get_workspace(
    ...
    capo_iottwinmaker.types.get_workspace_response.GetWorkspaceResponse, zapros.Response
]:
