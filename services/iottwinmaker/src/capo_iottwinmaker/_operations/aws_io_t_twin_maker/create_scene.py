"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#CreateScene``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.create_scene_response.CreateSceneResponse = (
        capo_iottwinmaker.types.create_scene_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/workspaces/{workspaceId}/scenes"
    url = url.replace("{workspaceId}", quote(input_["workspace_id"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.create_scene_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_scene(
    ...
    capo_iottwinmaker.types.create_scene_response.CreateSceneResponse, zapros.Response
]:
