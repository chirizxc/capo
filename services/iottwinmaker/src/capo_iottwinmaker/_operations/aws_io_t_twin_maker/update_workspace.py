"""Generated from Smithy shape ``com.amazonaws.iottwinmaker#UpdateWorkspace``."""
...
def handle_response(
    ...
    out: capo_iottwinmaker.types.update_workspace_response.UpdateWorkspaceResponse = (
        capo_iottwinmaker.types.update_workspace_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iottwinmaker.types.update_workspace_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
