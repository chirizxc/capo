...
class GetPropertyValueResponse(TypedDict, closed=True):
    property_values: NotRequired[
        "capo_iottwinmaker.types.property_latest_value_map.PropertyLatestValueMap"
    ]
    ...
    tabular_property_values: NotRequired[
        "capo_iottwinmaker.types.tabular_property_values.TabularPropertyValues"
    ]
...
def serialize_json(value: GetPropertyValueResponse) -> dict:
    ...
    if "property_values" in value:
        ...
        out["propertyValues"] = (
            capo_iottwinmaker.types.property_latest_value_map.serialize_json(
    ...
    if "tabular_property_values" in value:
        ...
        out["tabularPropertyValues"] = (
            capo_iottwinmaker.types.tabular_property_values.serialize_json(
...
def deserialize_json(data: dict) -> GetPropertyValueResponse:
    ...
    if data.get("propertyValues") is not None:
        ...
        out["property_values"] = (
            capo_iottwinmaker.types.property_latest_value_map.deserialize_json(
                data["propertyValues"]
            )
        )
    ...
    if data.get("tabularPropertyValues") is not None:
        ...
        out["tabular_property_values"] = (
            capo_iottwinmaker.types.tabular_property_values.deserialize_json(
