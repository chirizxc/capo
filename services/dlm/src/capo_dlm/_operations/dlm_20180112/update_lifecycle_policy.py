"""Generated from Smithy shape ``com.amazonaws.dlm#UpdateLifecyclePolicy``."""
...
def handle_response(
    ...
    out: capo_dlm.types.update_lifecycle_policy_response.UpdateLifecyclePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dlm.types.update_lifecycle_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
