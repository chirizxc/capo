"""Generated from Smithy shape ``com.amazonaws.dlm#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_dlm.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_dlm.types.list_tags_for_resource_response.deserialize_json(
