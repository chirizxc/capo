"""Generated from Smithy shape ``com.amazonaws.dlm#DeleteLifecyclePolicy``."""
...
def handle_response(
    ...
    out: capo_dlm.types.delete_lifecycle_policy_response.DeleteLifecyclePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
