...
if TYPE_CHECKING:
    ...
    import capo_dlm.types.target_region


class CrossRegionCopyRule(TypedDict, closed=True):
    target_region: NotRequired["capo_dlm.types.target_region.TargetRegion"]
    ...
    deprecate_rule: NotRequired[
        "capo_dlm.types.cross_region_copy_deprecate_rule.CrossRegionCopyDeprecateRule"
    ]
...
def serialize_json(value: CrossRegionCopyRule) -> dict:
    ...
    if "deprecate_rule" in value:
        ...
        out["DeprecateRule"] = (
            capo_dlm.types.cross_region_copy_deprecate_rule.serialize_json(
...
def deserialize_json(data: dict) -> CrossRegionCopyRule:
    ...
    if data.get("DeprecateRule") is not None:
        ...
        out["deprecate_rule"] = (
            capo_dlm.types.cross_region_copy_deprecate_rule.deserialize_json(
                data["DeprecateRule"]
            )
        )
    return out
