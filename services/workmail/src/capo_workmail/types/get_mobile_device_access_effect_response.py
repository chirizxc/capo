...
class GetMobileDeviceAccessEffectResponse(TypedDict, closed=True):
    ...
    matched_rules: NotRequired[
        "capo_workmail.types.mobile_device_access_matched_rule_list.MobileDeviceAccessMatchedRuleList"
    ]
...
def serialize_aws_json_1_1(value: GetMobileDeviceAccessEffectResponse) -> dict:
    ...
    if "matched_rules" in value:
        ...
        out["MatchedRules"] = (
            capo_workmail.types.mobile_device_access_matched_rule_list.serialize_aws_json_1_1(
                value["matched_rules"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetMobileDeviceAccessEffectResponse:
    ...
    if data.get("MatchedRules") is not None:
        ...
        out["matched_rules"] = (
            capo_workmail.types.mobile_device_access_matched_rule_list.deserialize_aws_json_1_1(
                data["MatchedRules"]
            )
        )
    return out
