"""Generated from Smithy shape ``com.amazonaws.workmail#UnsupportedOperationException``."""
...
class UnsupportedOperationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.workmail#UnsupportedOperationException``."""
