...
class ConfigurationCheckDefinition(TypedDict, closed=True):
    ...
    applicable_application_types: NotRequired[
        "capo_ssm_sap.types.application_type_list.ApplicationTypeList"
    ]
...
def serialize_json(value: ConfigurationCheckDefinition) -> dict:
    ...
    if "id" in value:
        ...
        out["Id"] = capo_ssm_sap.types.configuration_check_type.serialize_json(
            value["id"]
        )
    if "name" in value:
        out["Name"] = value["name"]
    ...
    if "applicable_application_types" in value:
        ...
        out["ApplicableApplicationTypes"] = (
            capo_ssm_sap.types.application_type_list.serialize_json(
...
def deserialize_json(data: dict) -> ConfigurationCheckDefinition:
    ...
    if data.get("ApplicableApplicationTypes") is not None:
        ...
        out["applicable_application_types"] = (
            capo_ssm_sap.types.application_type_list.deserialize_json(
