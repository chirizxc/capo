...
from capo_bedrock_data_automation_runtime._services._aws_config import aws_config
...
class BedrockDataAutomationRuntimeClientConfig(TypedDict, total=False, closed=True):
...
class BedrockDataAutomationRuntimeClient:
    ...
    def invoke_data_automation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_data_automation_runtime.types.invoke_data_automation_request.InvokeDataAutomationRequest]",
        ) -> OperationResponse[
            "capo_bedrock_data_automation_runtime.types.invoke_data_automation_response.InvokeDataAutomationResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_data_automation_runtime._operations.amazon_bedrock_keystone_runtime_service.invoke_data_automation.invoke_data_automation(
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_data_automation_runtime.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_bedrock_data_automation_runtime.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_data_automation_runtime._operations.amazon_bedrock_keystone_runtime_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_data_automation_runtime.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_bedrock_data_automation_runtime.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_data_automation_runtime._operations.amazon_bedrock_keystone_runtime_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_data_automation_runtime.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_bedrock_data_automation_runtime.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_data_automation_runtime._operations.amazon_bedrock_keystone_runtime_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
