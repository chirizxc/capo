...
def handle_response(
    ...
    out: capo_macie2.types.update_resource_profile_response.UpdateResourceProfileResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.update_resource_profile_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
