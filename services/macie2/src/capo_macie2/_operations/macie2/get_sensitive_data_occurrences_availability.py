...
def handle_response(
    ...
    out: capo_macie2.types.get_sensitive_data_occurrences_availability_response.GetSensitiveDataOccurrencesAvailabilityResponse = capo_macie2.types.get_sensitive_data_occurrences_availability_response.deserialize_json(
