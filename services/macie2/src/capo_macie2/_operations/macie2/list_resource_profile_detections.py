"""Generated from Smithy shape ``com.amazonaws.macie2#ListResourceProfileDetections``."""
...
def handle_response(
    ...
    out: capo_macie2.types.list_resource_profile_detections_response.ListResourceProfileDetectionsResponse = capo_macie2.types.list_resource_profile_detections_response.deserialize_json(
...
async def async_list_resource_profile_detections(
