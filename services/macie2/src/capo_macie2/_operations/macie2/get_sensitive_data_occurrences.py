"""Generated from Smithy shape ``com.amazonaws.macie2#GetSensitiveDataOccurrences``."""
...
import capo_macie2.errors.unprocessable_entity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnprocessableEntityException":
            raise capo_macie2.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_macie2.types.get_sensitive_data_occurrences_response.GetSensitiveDataOccurrencesResponse = capo_macie2.types.get_sensitive_data_occurrences_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/findings/{findingId}/reveal"
    url = url.replace("{findingId}", quote(input_["finding_id"], safe=""))
...
async def async_get_sensitive_data_occurrences(
