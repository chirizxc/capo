"""Generated from Smithy shape ``com.amazonaws.macie2#DeleteInvitations``."""
...
def handle_response(
    ...
    out: capo_macie2.types.delete_invitations_response.DeleteInvitationsResponse = (
        capo_macie2.types.delete_invitations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.delete_invitations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
