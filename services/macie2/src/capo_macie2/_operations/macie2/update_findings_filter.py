...
def handle_response(
    ...
    out: capo_macie2.types.update_findings_filter_response.UpdateFindingsFilterResponse = capo_macie2.types.update_findings_filter_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.update_findings_filter_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
