"""Generated from Smithy shape ``com.amazonaws.macie2#DisassociateFromMasterAccount``."""
...
def handle_response(
    ...
    out: capo_macie2.types.disassociate_from_master_account_response.DisassociateFromMasterAccountResponse = {}  # type: ignore[typeddict-item]
    return out
