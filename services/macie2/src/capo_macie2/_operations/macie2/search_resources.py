...
def handle_response(
    ...
    out: capo_macie2.types.search_resources_response.SearchResourcesResponse = (
        capo_macie2.types.search_resources_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.search_resources_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def search_resources(
    ...
    capo_macie2.types.search_resources_response.SearchResourcesResponse, zapros.Response
]:
