"""Generated from Smithy shape ``com.amazonaws.macie2#GetRevealConfiguration``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_reveal_configuration_response.GetRevealConfigurationResponse = capo_macie2.types.get_reveal_configuration_response.deserialize_json(
...
async def async_get_reveal_configuration(
