...
def handle_response(
    ...
    out: capo_macie2.types.put_findings_publication_configuration_response.PutFindingsPublicationConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.put_findings_publication_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
