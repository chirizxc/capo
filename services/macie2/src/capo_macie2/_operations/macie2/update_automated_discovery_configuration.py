"""Generated from Smithy shape ``com.amazonaws.macie2#UpdateAutomatedDiscoveryConfiguration``."""
...
def handle_response(
    ...
    out: capo_macie2.types.update_automated_discovery_configuration_response.UpdateAutomatedDiscoveryConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.update_automated_discovery_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_automated_discovery_configuration(
