"""Generated from Smithy shape ``com.amazonaws.macie2#UpdateClassificationJob``."""
...
def handle_response(
    ...
    out: capo_macie2.types.update_classification_job_response.UpdateClassificationJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.update_classification_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_classification_job(
