...
def handle_response(
    ...
    out: capo_macie2.types.put_classification_export_configuration_response.PutClassificationExportConfigurationResponse = capo_macie2.types.put_classification_export_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.put_classification_export_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
