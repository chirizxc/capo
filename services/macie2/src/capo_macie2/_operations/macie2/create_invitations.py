"""Generated from Smithy shape ``com.amazonaws.macie2#CreateInvitations``."""
...
def handle_response(
    ...
    out: capo_macie2.types.create_invitations_response.CreateInvitationsResponse = (
        capo_macie2.types.create_invitations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.create_invitations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_invitations(
