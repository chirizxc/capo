...
def handle_response(
    ...
    out: capo_macie2.types.get_custom_data_identifier_response.GetCustomDataIdentifierResponse = capo_macie2.types.get_custom_data_identifier_response.deserialize_json(
