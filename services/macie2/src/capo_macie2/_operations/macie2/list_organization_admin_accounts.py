"""Generated from Smithy shape ``com.amazonaws.macie2#ListOrganizationAdminAccounts``."""
...
def handle_response(
    ...
    out: capo_macie2.types.list_organization_admin_accounts_response.ListOrganizationAdminAccountsResponse = capo_macie2.types.list_organization_admin_accounts_response.deserialize_json(
