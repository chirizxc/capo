...
def handle_response(
    ...
    out: capo_macie2.types.enable_organization_admin_account_response.EnableOrganizationAdminAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.enable_organization_admin_account_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
