"""Generated from Smithy shape ``com.amazonaws.macie2#GetMember``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_member_response.GetMemberResponse = (
        capo_macie2.types.get_member_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_macie2.types.get_member_request.GetMemberRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def get_member(
    ...
    input_: capo_macie2.types.get_member_request.GetMemberRequest,
) -> tuple[capo_macie2.types.get_member_response.GetMemberResponse, zapros.Response]:
