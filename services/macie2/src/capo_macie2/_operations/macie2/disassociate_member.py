"""Generated from Smithy shape ``com.amazonaws.macie2#DisassociateMember``."""
...
def handle_response(
    ...
    out: capo_macie2.types.disassociate_member_response.DisassociateMemberResponse = {}  # type: ignore[typeddict-item]
    return out
