...
def handle_response(
    ...
    out: capo_macie2.types.list_allow_lists_response.ListAllowListsResponse = (
        capo_macie2.types.list_allow_lists_response.deserialize_json(
...
def list_allow_lists(
    ...
    capo_macie2.types.list_allow_lists_response.ListAllowListsResponse, zapros.Response
]:
