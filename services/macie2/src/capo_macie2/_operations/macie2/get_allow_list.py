...
def handle_response(
    ...
    out: capo_macie2.types.get_allow_list_response.GetAllowListResponse = (
        capo_macie2.types.get_allow_list_response.deserialize_json(
...
def get_allow_list(
    ...
    capo_macie2.types.get_allow_list_response.GetAllowListResponse, zapros.Response
]:
