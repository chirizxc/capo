...
def handle_response(
    ...
    out: capo_macie2.types.get_automated_discovery_configuration_response.GetAutomatedDiscoveryConfigurationResponse = capo_macie2.types.get_automated_discovery_configuration_response.deserialize_json(
