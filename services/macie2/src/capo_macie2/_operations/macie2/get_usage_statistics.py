...
def handle_response(
    ...
    out: capo_macie2.types.get_usage_statistics_response.GetUsageStatisticsResponse = (
        capo_macie2.types.get_usage_statistics_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.get_usage_statistics_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
