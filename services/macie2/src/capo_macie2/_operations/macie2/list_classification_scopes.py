...
def handle_response(
    ...
    out: capo_macie2.types.list_classification_scopes_response.ListClassificationScopesResponse = capo_macie2.types.list_classification_scopes_response.deserialize_json(
