"""Generated from Smithy shape ``com.amazonaws.macie2#GetResourceProfile``."""
...
def handle_response(
    ...
    out: capo_macie2.types.get_resource_profile_response.GetResourceProfileResponse = (
        capo_macie2.types.get_resource_profile_response.deserialize_json(
...
async def async_get_resource_profile(
