...
def handle_response(
    ...
    out: capo_macie2.types.create_custom_data_identifier_response.CreateCustomDataIdentifierResponse = capo_macie2.types.create_custom_data_identifier_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.create_custom_data_identifier_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
