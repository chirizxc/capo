...
def handle_response(
    ...
    out: capo_macie2.types.create_member_response.CreateMemberResponse = (
        capo_macie2.types.create_member_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.create_member_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_member(
    ...
    capo_macie2.types.create_member_response.CreateMemberResponse, zapros.Response
]:
