"""Generated from Smithy shape ``com.amazonaws.macie2#ListMembers``."""
...
def handle_response(
    ...
    out: capo_macie2.types.list_members_response.ListMembersResponse = (
        capo_macie2.types.list_members_response.deserialize_json(
...
def build_request(
    ...
    if "only_associated" in input_:
        params.append(("onlyAssociated", input_["only_associated"]))
...
def list_members(
    ...
    capo_macie2.types.list_members_response.ListMembersResponse, zapros.Response
]:
