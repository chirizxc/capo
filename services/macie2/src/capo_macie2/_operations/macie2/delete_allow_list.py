"""Generated from Smithy shape ``com.amazonaws.macie2#DeleteAllowList``."""
...
def handle_response(
    ...
    out: capo_macie2.types.delete_allow_list_response.DeleteAllowListResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    if "ignore_job_checks" in input_:
        params.append(("ignoreJobChecks", input_["ignore_job_checks"]))
...
async def async_delete_allow_list(
