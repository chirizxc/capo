...
def handle_response(
    ...
    out: capo_macie2.types.create_allow_list_response.CreateAllowListResponse = (
        capo_macie2.types.create_allow_list_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.create_allow_list_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
