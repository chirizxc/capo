...
def handle_response(
    ...
    out: capo_macie2.types.list_custom_data_identifiers_response.ListCustomDataIdentifiersResponse = capo_macie2.types.list_custom_data_identifiers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_macie2.types.list_custom_data_identifiers_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
