...
def handle_response(
    ...
    out: capo_macie2.types.list_invitations_response.ListInvitationsResponse = (
        capo_macie2.types.list_invitations_response.deserialize_json(
...
def list_invitations(
    ...
    capo_macie2.types.list_invitations_response.ListInvitationsResponse, zapros.Response
]:
