...
class GetAutomatedDiscoveryConfigurationResponse(TypedDict, closed=True):
    ...
    classification_scope_id: NotRequired[
        "capo_macie2.types.classification_scope_id.ClassificationScopeId"
    ]
    ...
    disabled_at: NotRequired["capo_macie2.types.timestamp.Timestamp"]
    ...
    first_enabled_at: NotRequired["capo_macie2.types.timestamp.Timestamp"]
    ...
    last_updated_at: NotRequired["capo_macie2.types.timestamp.Timestamp"]
...
def serialize_json(value: GetAutomatedDiscoveryConfigurationResponse) -> dict:
    ...
    if "disabled_at" in value:
        ...
        out["disabledAt"] = capo_macie2.types.timestamp.serialize_json(
            value["disabled_at"]
        )
    if "first_enabled_at" in value:
        import capo_macie2.types.timestamp

        out["firstEnabledAt"] = capo_macie2.types.timestamp.serialize_json(
            value["first_enabled_at"]
        )
    if "last_updated_at" in value:
        import capo_macie2.types.timestamp

        out["lastUpdatedAt"] = capo_macie2.types.timestamp.serialize_json(
