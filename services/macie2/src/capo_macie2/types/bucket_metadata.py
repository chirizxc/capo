...
class BucketMetadata(TypedDict, closed=True):
    ...
    automated_discovery_monitoring_status: NotRequired[
        "capo_macie2.types.automated_discovery_monitoring_status.AutomatedDiscoveryMonitoringStatus"
    ]
    ...
    error_code: NotRequired[
        "capo_macie2.types.bucket_metadata_error_code.BucketMetadataErrorCode"
    ]
    ...
    error_message: NotRequired["capo_macie2.types.__string.__string"]
    ...
    job_details: NotRequired["capo_macie2.types.job_details.JobDetails"]
    ...
    object_count_by_encryption_type: NotRequired[
        "capo_macie2.types.object_count_by_encryption_type.ObjectCountByEncryptionType"
    ]
    ...
    region: NotRequired["capo_macie2.types.__string.__string"]
    """<p>The Amazon Web Services Region that hosts the bucket.</p>"""
    replication_details: NotRequired[
        "capo_macie2.types.replication_details.ReplicationDetails"
    ]
    ...
    sensitivity_score: NotRequired["capo_macie2.types.__integer.__integer"]
    ...
    server_side_encryption: NotRequired[
        "capo_macie2.types.bucket_server_side_encryption.BucketServerSideEncryption"
    ]
    """<p>The default server-side encryption settings for the bucket.</p>"""
    shared_access: NotRequired["capo_macie2.types.shared_access.SharedAccess"]
    ...
    tags: NotRequired["capo_macie2.types.__list_of_key_value_pair.__listOfKeyValuePair"]
    ...
    versioning: NotRequired["capo_macie2.types.__boolean.__boolean"]
...
def serialize_json(value: BucketMetadata) -> dict:
    ...
    if "automated_discovery_monitoring_status" in value:
        ...
        out["automatedDiscoveryMonitoringStatus"] = (
            capo_macie2.types.automated_discovery_monitoring_status.serialize_json(
    ...
    if "bucket_created_at" in value:
        ...
        out["bucketCreatedAt"] = capo_macie2.types.__timestamp_iso8601.serialize_json(
    ...
    if "error_code" in value:
        ...
        out["errorCode"] = capo_macie2.types.bucket_metadata_error_code.serialize_json(
            value["error_code"]
        )
    ...
    if "job_details" in value:
        ...
        out["jobDetails"] = capo_macie2.types.job_details.serialize_json(
            value["job_details"]
        )
    if "last_automated_discovery_time" in value:
        ...
        out["lastAutomatedDiscoveryTime"] = (
            capo_macie2.types.__timestamp_iso8601.serialize_json(
    ...
    if "object_count_by_encryption_type" in value:
        ...
        out["objectCountByEncryptionType"] = (
            capo_macie2.types.object_count_by_encryption_type.serialize_json(
    ...
    if "replication_details" in value:
        ...
        out["replicationDetails"] = (
            capo_macie2.types.replication_details.serialize_json(
    ...
    if "server_side_encryption" in value:
        ...
        out["serverSideEncryption"] = (
            capo_macie2.types.bucket_server_side_encryption.serialize_json(
    ...
    if "shared_access" in value:
        ...
        out["sharedAccess"] = capo_macie2.types.shared_access.serialize_json(
            value["shared_access"]
        )
    ...
    if "tags" in value:
        ...
        out["tags"] = capo_macie2.types.__list_of_key_value_pair.serialize_json(
            value["tags"]
        )
...
def deserialize_json(data: dict) -> BucketMetadata:
    ...
    if data.get("automatedDiscoveryMonitoringStatus") is not None:
        ...
        out["automated_discovery_monitoring_status"] = (
            capo_macie2.types.automated_discovery_monitoring_status.deserialize_json(
    ...
    if data.get("errorCode") is not None:
        ...
        out["error_code"] = (
            capo_macie2.types.bucket_metadata_error_code.deserialize_json(
                data["errorCode"]
            )
        )
    ...
    if data.get("objectCountByEncryptionType") is not None:
        ...
        out["object_count_by_encryption_type"] = (
            capo_macie2.types.object_count_by_encryption_type.deserialize_json(
    ...
    if data.get("replicationDetails") is not None:
        ...
        out["replication_details"] = (
            capo_macie2.types.replication_details.deserialize_json(
    ...
    if data.get("serverSideEncryption") is not None:
        ...
        out["server_side_encryption"] = (
            capo_macie2.types.bucket_server_side_encryption.deserialize_json(
