...
if TYPE_CHECKING:
    ...
    import capo_macie2.types.error_code
...
class UnprocessedAccount(TypedDict, closed=True):
    ...
    error_code: NotRequired["capo_macie2.types.error_code.ErrorCode"]
...
def serialize_json(value: UnprocessedAccount) -> dict:
    ...
    if "error_code" in value:
        ...
        out["errorCode"] = capo_macie2.types.error_code.serialize_json(
            value["error_code"]
        )
...
def deserialize_json(data: dict) -> UnprocessedAccount:
    ...
    if data.get("errorCode") is not None:
        ...
        out["error_code"] = capo_macie2.types.error_code.deserialize_json(
            data["errorCode"]
        )
