...
class SearchResourcesCriteria(TypedDict, closed=True):
    simple_criterion: NotRequired[
        "capo_macie2.types.search_resources_simple_criterion.SearchResourcesSimpleCriterion"
    ]
    ...
    tag_criterion: NotRequired[
        "capo_macie2.types.search_resources_tag_criterion.SearchResourcesTagCriterion"
    ]
...
def serialize_json(value: SearchResourcesCriteria) -> dict:
    ...
    if "simple_criterion" in value:
        ...
        out["simpleCriterion"] = (
            capo_macie2.types.search_resources_simple_criterion.serialize_json(
    ...
    if "tag_criterion" in value:
        ...
        out["tagCriterion"] = (
            capo_macie2.types.search_resources_tag_criterion.serialize_json(
                value["tag_criterion"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> SearchResourcesCriteria:
    ...
    if data.get("simpleCriterion") is not None:
        ...
        out["simple_criterion"] = (
            capo_macie2.types.search_resources_simple_criterion.deserialize_json(
    ...
    if data.get("tagCriterion") is not None:
        ...
        out["tag_criterion"] = (
            capo_macie2.types.search_resources_tag_criterion.deserialize_json(
                data["tagCriterion"]
            )
        )
    return out
