...
class GetResourceProfileResponse(TypedDict, closed=True):
    ...
    sensitivity_score_overridden: NotRequired["capo_macie2.types.__boolean.__boolean"]
    ...
    statistics: NotRequired["capo_macie2.types.resource_statistics.ResourceStatistics"]
...
def serialize_json(value: GetResourceProfileResponse) -> dict:
    ...
    if "profile_updated_at" in value:
        ...
        out["profileUpdatedAt"] = capo_macie2.types.__timestamp_iso8601.serialize_json(
    ...
    if "statistics" in value:
        ...
        out["statistics"] = capo_macie2.types.resource_statistics.serialize_json(
            value["statistics"]
        )
    return out
