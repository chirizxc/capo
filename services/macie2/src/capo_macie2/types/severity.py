...
def serialize_json(value: Severity) -> dict:
    ...
    if "description" in value:
        ...
        out["description"] = capo_macie2.types.severity_description.serialize_json(
            value["description"]
        )
    if "score" in value:
