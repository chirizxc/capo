...
class DescribeBucketsResponse(TypedDict, closed=True):
    buckets: NotRequired[
        "capo_macie2.types.__list_of_bucket_metadata.__listOfBucketMetadata"
    ]
...
def serialize_json(value: DescribeBucketsResponse) -> dict:
    ...
    if "buckets" in value:
        ...
        out["buckets"] = capo_macie2.types.__list_of_bucket_metadata.serialize_json(
            value["buckets"]
        )
