...
class Finding(TypedDict, closed=True):
    ...
    archived: NotRequired["capo_macie2.types.__boolean.__boolean"]
    """<p>Specifies whether the finding is archived (suppressed).</p>"""
    category: NotRequired["capo_macie2.types.finding_category.FindingCategory"]
    ...
    classification_details: NotRequired[
        "capo_macie2.types.classification_details.ClassificationDetails"
    ]
    ...
    partition: NotRequired["capo_macie2.types.__string.__string"]
    """<p>The Amazon Web Services partition that Amazon Macie created the finding in.</p>"""
    policy_details: NotRequired["capo_macie2.types.policy_details.PolicyDetails"]
    ...
    resources_affected: NotRequired[
        "capo_macie2.types.resources_affected.ResourcesAffected"
    ]
    """<p>The resources that the finding applies to.</p>"""
    sample: NotRequired["capo_macie2.types.__boolean.__boolean"]
    ...
    schema_version: NotRequired["capo_macie2.types.__string.__string"]
    """<p>The version of the schema that was used to define the data structures in the finding.</p>"""
    severity: NotRequired["capo_macie2.types.severity.Severity"]
    """<p>The severity level and score for the finding.</p>"""
    title: NotRequired["capo_macie2.types.__string.__string"]
    """<p>The brief description of the finding.</p>"""
    type: NotRequired["capo_macie2.types.finding_type.FindingType"]
...
def serialize_json(value: Finding) -> dict:
    ...
    if "category" in value:
        ...
        out["category"] = capo_macie2.types.finding_category.serialize_json(
            value["category"]
        )
    if "classification_details" in value:
        ...
        out["classificationDetails"] = (
            capo_macie2.types.classification_details.serialize_json(
    ...
    if "policy_details" in value:
        ...
        out["policyDetails"] = capo_macie2.types.policy_details.serialize_json(
    ...
    if "resources_affected" in value:
        ...
        out["resourcesAffected"] = capo_macie2.types.resources_affected.serialize_json(
    ...
    if "severity" in value:
        ...
        out["severity"] = capo_macie2.types.severity.serialize_json(value["severity"])
    if "title" in value:
        out["title"] = value["title"]
    if "type" in value:
        import capo_macie2.types.finding_type

        out["type"] = capo_macie2.types.finding_type.serialize_json(value["type"])
...
def deserialize_json(data: dict) -> Finding:
    ...
    if data.get("classificationDetails") is not None:
        ...
        out["classification_details"] = (
            capo_macie2.types.classification_details.deserialize_json(
    ...
    if data.get("resourcesAffected") is not None:
        ...
        out["resources_affected"] = (
            capo_macie2.types.resources_affected.deserialize_json(
