...
from capo_apigatewaymanagementapi._services._aws_config import aaws_config
...
class AsyncApiGatewayManagementApiClient:
    ...
    async def delete_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apigatewaymanagementapi.types.delete_connection_request.DeleteConnectionRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_apigatewaymanagementapi._operations.api_gateway_management_api.delete_connection.async_delete_connection(
    ...
    async def get_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apigatewaymanagementapi.types.get_connection_request.GetConnectionRequest]",
        ) -> AsyncOperationResponse[
            "capo_apigatewaymanagementapi.types.get_connection_response.GetConnectionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_apigatewaymanagementapi._operations.api_gateway_management_api.get_connection.async_get_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def post_to_connection(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_apigatewaymanagementapi.types.post_to_connection_request.PostToConnectionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_apigatewaymanagementapi._operations.api_gateway_management_api.post_to_connection.async_post_to_connection(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
