...
class NoSuchGeoLocation_(TypedDict, closed=True):
...
class NoSuchGeoLocation(ServiceError):
    ...
    def __init__(self, data: NoSuchGeoLocation_, message: str | None = None):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_xml(cls, el: Element, message: str | None = None) -> "NoSuchGeoLocation":
