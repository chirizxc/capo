...
class NoSuchChange_(TypedDict, closed=True):
...
class NoSuchChange(ServiceError):
    ...
    def __init__(self, data: NoSuchChange_, message: str | None = None):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_xml(cls, el: Element, message: str | None = None) -> "NoSuchChange":
