"""Generated from Smithy shape ``com.amazonaws.migrationhubstrategy#StartRecommendationReportGeneration``."""
...
def handle_response(
    ...
    out: capo_migrationhubstrategy.types.start_recommendation_report_generation_response.StartRecommendationReportGenerationResponse = capo_migrationhubstrategy.types.start_recommendation_report_generation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migrationhubstrategy.types.start_recommendation_report_generation_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_recommendation_report_generation(
