"""Generated from Smithy shape ``com.amazonaws.migrationhubstrategy#ListCollectors``."""
...
def handle_response(
    ...
    out: capo_migrationhubstrategy.types.list_collectors_response.ListCollectorsResponse = capo_migrationhubstrategy.types.list_collectors_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-collectors"
...
async def async_list_collectors(
