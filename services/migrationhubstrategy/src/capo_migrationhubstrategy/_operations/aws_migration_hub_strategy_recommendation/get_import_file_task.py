...
def handle_response(
    ...
    out: capo_migrationhubstrategy.types.get_import_file_task_response.GetImportFileTaskResponse = capo_migrationhubstrategy.types.get_import_file_task_response.deserialize_json(
