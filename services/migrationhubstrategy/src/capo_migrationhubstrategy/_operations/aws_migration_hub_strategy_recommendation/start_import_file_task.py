...
def handle_response(
    ...
    out: capo_migrationhubstrategy.types.start_import_file_task_response.StartImportFileTaskResponse = capo_migrationhubstrategy.types.start_import_file_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migrationhubstrategy.types.start_import_file_task_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
