...
import capo_migrationhubstrategy.types.list_import_file_task_information
...
def handle_response(
    ...
    out: capo_migrationhubstrategy.types.list_import_file_task_response.ListImportFileTaskResponse = capo_migrationhubstrategy.types.list_import_file_task_response.deserialize_json(
