"""Generated from Smithy shape ``com.amazonaws.migrationhubstrategy#GetServerDetails``."""
...
def handle_response(
    ...
    out: capo_migrationhubstrategy.types.get_server_details_response.GetServerDetailsResponse = capo_migrationhubstrategy.types.get_server_details_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/get-server-details/{serverId}"
...
async def async_get_server_details(
