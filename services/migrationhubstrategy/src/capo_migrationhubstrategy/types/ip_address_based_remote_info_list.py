...
if TYPE_CHECKING:
    import capo_migrationhubstrategy.types.ip_address_based_remote_info

IPAddressBasedRemoteInfoList: TypeAlias = list[
    "capo_migrationhubstrategy.types.ip_address_based_remote_info.IPAddressBasedRemoteInfo"
]
...
def serialize_json(value: IPAddressBasedRemoteInfoList) -> list:
    ...
    for item in value:
        out.append(
            capo_migrationhubstrategy.types.ip_address_based_remote_info.serialize_json(
                item
            )
        )
    return out
