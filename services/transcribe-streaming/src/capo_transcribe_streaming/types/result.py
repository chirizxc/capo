...
if TYPE_CHECKING:
    import capo_transcribe_streaming.types.alternative_list
    ...
    import capo_transcribe_streaming.types.language_identification
...
class Result(TypedDict, closed=True):
    ...
    alternatives: NotRequired[
        "capo_transcribe_streaming.types.alternative_list.AlternativeList"
    ]
    ...
    language_identification: NotRequired[
        "capo_transcribe_streaming.types.language_identification.LanguageIdentification"
    ]
...
def serialize_json(value: Result) -> dict:
    ...
    if "alternatives" in value:
        ...
        out["Alternatives"] = (
            capo_transcribe_streaming.types.alternative_list.serialize_json(
                value["alternatives"]
            )
        )
    ...
    if "language_identification" in value:
        ...
        out["LanguageIdentification"] = (
            capo_transcribe_streaming.types.language_identification.serialize_json(
...
def deserialize_json(data: dict) -> Result:
    ...
    if data.get("Alternatives") is not None:
        ...
        out["alternatives"] = (
            capo_transcribe_streaming.types.alternative_list.deserialize_json(
                data["Alternatives"]
            )
        )
    ...
    if data.get("LanguageIdentification") is not None:
        ...
        out["language_identification"] = (
            capo_transcribe_streaming.types.language_identification.deserialize_json(
