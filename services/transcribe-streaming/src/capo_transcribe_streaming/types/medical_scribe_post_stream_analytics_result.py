...
if TYPE_CHECKING:
    import capo_transcribe_streaming.types.clinical_note_generation_result


class MedicalScribePostStreamAnalyticsResult(TypedDict, closed=True):
    clinical_note_generation_result: NotRequired[
        "capo_transcribe_streaming.types.clinical_note_generation_result.ClinicalNoteGenerationResult"
    ]
...
def serialize_json(value: MedicalScribePostStreamAnalyticsResult) -> dict:
    ...
    if "clinical_note_generation_result" in value:
        ...
        out["ClinicalNoteGenerationResult"] = (
            capo_transcribe_streaming.types.clinical_note_generation_result.serialize_json(
...
def deserialize_json(data: dict) -> MedicalScribePostStreamAnalyticsResult:
    ...
    if data.get("ClinicalNoteGenerationResult") is not None:
        ...
        out["clinical_note_generation_result"] = (
            capo_transcribe_streaming.types.clinical_note_generation_result.deserialize_json(
