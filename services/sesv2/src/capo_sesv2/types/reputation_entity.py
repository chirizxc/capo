...
class ReputationEntity(TypedDict, closed=True):
    ...
    customer_managed_status: NotRequired["capo_sesv2.types.status_record.StatusRecord"]
    ...
    aws_ses_managed_status: NotRequired["capo_sesv2.types.status_record.StatusRecord"]
    ...
    sending_status_aggregate: NotRequired[
        "capo_sesv2.types.sending_status.SendingStatus"
    ]
    ...
    reputation_impact: NotRequired[
        "capo_sesv2.types.recommendation_impact.RecommendationImpact"
    ]
...
def serialize_json(value: ReputationEntity) -> dict:
    ...
    if "reputation_entity_type" in value:
        ...
        out["ReputationEntityType"] = (
            capo_sesv2.types.reputation_entity_type.serialize_json(
    ...
    if "customer_managed_status" in value:
        ...
        out["CustomerManagedStatus"] = capo_sesv2.types.status_record.serialize_json(
            value["customer_managed_status"]
        )
    if "aws_ses_managed_status" in value:
        import capo_sesv2.types.status_record

        out["AwsSesManagedStatus"] = capo_sesv2.types.status_record.serialize_json(
            value["aws_ses_managed_status"]
        )
    if "sending_status_aggregate" in value:
        import capo_sesv2.types.sending_status

        out["SendingStatusAggregate"] = capo_sesv2.types.sending_status.serialize_json(
            value["sending_status_aggregate"]
        )
    if "reputation_impact" in value:
        import capo_sesv2.types.recommendation_impact

        out["ReputationImpact"] = capo_sesv2.types.recommendation_impact.serialize_json(
...
def deserialize_json(data: dict) -> ReputationEntity:
    ...
    if data.get("ReputationEntityType") is not None:
        ...
        out["reputation_entity_type"] = (
            capo_sesv2.types.reputation_entity_type.deserialize_json(
    ...
    if data.get("CustomerManagedStatus") is not None:
        ...
        out["customer_managed_status"] = (
            capo_sesv2.types.status_record.deserialize_json(
    ...
    if data.get("SendingStatusAggregate") is not None:
        ...
        out["sending_status_aggregate"] = (
            capo_sesv2.types.sending_status.deserialize_json(
    ...
    if data.get("ReputationImpact") is not None:
        ...
        out["reputation_impact"] = (
            capo_sesv2.types.recommendation_impact.deserialize_json(
