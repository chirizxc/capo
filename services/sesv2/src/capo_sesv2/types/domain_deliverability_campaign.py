...
if TYPE_CHECKING:
    ...
    import capo_sesv2.types.esps
    import capo_sesv2.types.identity
    import capo_sesv2.types.image_url
    import capo_sesv2.types.ip_list
    import capo_sesv2.types.percentage
    import capo_sesv2.types.subject
    import capo_sesv2.types.timestamp
    import capo_sesv2.types.volume


class DomainDeliverabilityCampaign(TypedDict, closed=True):
    campaign_id: NotRequired["capo_sesv2.types.campaign_id.CampaignId"]
    ...
    image_url: NotRequired["capo_sesv2.types.image_url.ImageUrl"]
    """<p>The URL of an image that contains a snapshot of the email message that was sent.</p>"""
    subject: NotRequired["capo_sesv2.types.subject.Subject"]
    """<p>The subject line, or title, of the email message.</p>"""
    from_address: NotRequired["capo_sesv2.types.identity.Identity"]
    """<p>The verified email address that the email message was sent from.</p>"""
    sending_ips: NotRequired["capo_sesv2.types.ip_list.IpList"]
    """<p>The IP addresses that were used to send the email message.</p>"""
    first_seen_date_time: NotRequired["capo_sesv2.types.timestamp.Timestamp"]
    ...
    last_seen_date_time: NotRequired["capo_sesv2.types.timestamp.Timestamp"]
    ...
    inbox_count: NotRequired["capo_sesv2.types.volume.Volume"]
    """<p>The number of email messages that were delivered to recipients’ inboxes.</p>"""
    spam_count: NotRequired["capo_sesv2.types.volume.Volume"]
    """<p>The number of email messages that were delivered to recipients' spam or junk mail folders.</p>"""
    read_rate: NotRequired["capo_sesv2.types.percentage.Percentage"]
    ...
    delete_rate: NotRequired["capo_sesv2.types.percentage.Percentage"]
    ...
    read_delete_rate: NotRequired["capo_sesv2.types.percentage.Percentage"]
    ...
    projected_volume: NotRequired["capo_sesv2.types.volume.Volume"]
    """<p>The projected number of recipients that the email message was sent to.</p>"""
    esps: NotRequired["capo_sesv2.types.esps.Esps"]
...
def serialize_json(value: DomainDeliverabilityCampaign) -> dict:
    ...
    if "sending_ips" in value:
        ...
        out["SendingIps"] = capo_sesv2.types.ip_list.serialize_json(
            value["sending_ips"]
        )
    if "first_seen_date_time" in value:
        import capo_sesv2.types.timestamp

        out["FirstSeenDateTime"] = capo_sesv2.types.timestamp.serialize_json(
            value["first_seen_date_time"]
        )
    if "last_seen_date_time" in value:
        import capo_sesv2.types.timestamp

        out["LastSeenDateTime"] = capo_sesv2.types.timestamp.serialize_json(
    ...
    if "esps" in value:
        ...
        out["Esps"] = capo_sesv2.types.esps.serialize_json(value["esps"])
    return out
...
def deserialize_json(data: dict) -> DomainDeliverabilityCampaign:
    ...
    if data.get("SendingIps") is not None:
        ...
        out["sending_ips"] = capo_sesv2.types.ip_list.deserialize_json(
            data["SendingIps"]
        )
    if data.get("FirstSeenDateTime") is not None:
        import capo_sesv2.types.timestamp

        out["first_seen_date_time"] = capo_sesv2.types.timestamp.deserialize_json(
            data["FirstSeenDateTime"]
        )
    if data.get("LastSeenDateTime") is not None:
        import capo_sesv2.types.timestamp

        out["last_seen_date_time"] = capo_sesv2.types.timestamp.deserialize_json(
    ...
    if data.get("Esps") is not None:
        ...
        out["esps"] = capo_sesv2.types.esps.deserialize_json(data["Esps"])
    return out
