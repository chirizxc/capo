...
if TYPE_CHECKING:
    import capo_sesv2.types.email_template_html
    import capo_sesv2.types.email_template_subject
    import capo_sesv2.types.email_template_text


class EmailTemplateContent(TypedDict, closed=True):
    subject: NotRequired["capo_sesv2.types.email_template_subject.EmailTemplateSubject"]
    """<p>The subject line of the email.</p>"""
    text: NotRequired["capo_sesv2.types.email_template_text.EmailTemplateText"]
    """<p>The email body that will be visible to recipients whose email clients do not display HTML.</p>"""
    html: NotRequired["capo_sesv2.types.email_template_html.EmailTemplateHtml"]
