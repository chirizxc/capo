...
class GetDeliverabilityDashboardOptionsResponse(TypedDict, closed=True):
    ...
    subscription_expiry_date: NotRequired["capo_sesv2.types.timestamp.Timestamp"]
    ...
    account_status: NotRequired[
        "capo_sesv2.types.deliverability_dashboard_account_status.DeliverabilityDashboardAccountStatus"
    ]
...
def serialize_json(value: GetDeliverabilityDashboardOptionsResponse) -> dict:
    ...
    if "subscription_expiry_date" in value:
        ...
        out["SubscriptionExpiryDate"] = capo_sesv2.types.timestamp.serialize_json(
    ...
    if "account_status" in value:
        ...
        out["AccountStatus"] = (
            capo_sesv2.types.deliverability_dashboard_account_status.serialize_json(
...
def deserialize_json(data: dict) -> GetDeliverabilityDashboardOptionsResponse:
    ...
    if data.get("AccountStatus") is not None:
        ...
        out["account_status"] = (
            capo_sesv2.types.deliverability_dashboard_account_status.deserialize_json(
                data["AccountStatus"]
            )
        )
