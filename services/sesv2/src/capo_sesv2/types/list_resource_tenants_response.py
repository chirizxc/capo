...
class ListResourceTenantsResponse(TypedDict, closed=True):
    resource_tenants: NotRequired[
        "capo_sesv2.types.resource_tenant_metadata_list.ResourceTenantMetadataList"
    ]
...
def serialize_json(value: ListResourceTenantsResponse) -> dict:
    ...
    if "resource_tenants" in value:
        ...
        out["ResourceTenants"] = (
            capo_sesv2.types.resource_tenant_metadata_list.serialize_json(
...
def deserialize_json(data: dict) -> ListResourceTenantsResponse:
    ...
    if data.get("ResourceTenants") is not None:
        import capo_sesv2.types.resource_tenant_metadata_list

        out["resource_tenants"] = (
            capo_sesv2.types.resource_tenant_metadata_list.deserialize_json(
