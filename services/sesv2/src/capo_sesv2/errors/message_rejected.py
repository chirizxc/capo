"""Generated from Smithy shape ``com.amazonaws.sesv2#MessageRejected``."""
...
class MessageRejected(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.sesv2#MessageRejected``."""

    code: str | None = "MessageRejected"

    def __init__(self, data: MessageRejected_, message: str | None = None):
        super().__init__(
            "client",
    ...
    @classmethod
    def from_json(cls, data: dict, message: str | None = None) -> "MessageRejected":
