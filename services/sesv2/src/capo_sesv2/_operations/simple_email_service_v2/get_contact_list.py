...
def handle_response(
    ...
    out: capo_sesv2.types.get_contact_list_response.GetContactListResponse = (
        capo_sesv2.types.get_contact_list_response.deserialize_json(
...
def get_contact_list(
    ...
    capo_sesv2.types.get_contact_list_response.GetContactListResponse, zapros.Response
]:
