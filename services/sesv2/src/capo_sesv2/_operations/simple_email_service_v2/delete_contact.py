"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteContact``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.delete_contact_response.DeleteContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_contact(
    ...
    capo_sesv2.types.delete_contact_response.DeleteContactResponse, zapros.Response
]:
