...
def handle_response(
    ...
    out: capo_sesv2.types.get_tenant_response.GetTenantResponse = (
        capo_sesv2.types.get_tenant_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.get_tenant_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def get_tenant(
    ...
    input_: capo_sesv2.types.get_tenant_request.GetTenantRequest,
) -> tuple[capo_sesv2.types.get_tenant_response.GetTenantResponse, zapros.Response]:
