...
def handle_response(
    ...
    out: capo_sesv2.types.create_import_job_response.CreateImportJobResponse = (
        capo_sesv2.types.create_import_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_import_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_import_job(
    ...
    capo_sesv2.types.create_import_job_response.CreateImportJobResponse, zapros.Response
]:
