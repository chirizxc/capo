...
def handle_response(
    ...
    out: capo_sesv2.types.create_multi_region_endpoint_response.CreateMultiRegionEndpointResponse = capo_sesv2.types.create_multi_region_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_multi_region_endpoint_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
