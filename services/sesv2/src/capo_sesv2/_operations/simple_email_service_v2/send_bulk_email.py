...
def handle_response(
    ...
    out: capo_sesv2.types.send_bulk_email_response.SendBulkEmailResponse = (
        capo_sesv2.types.send_bulk_email_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.send_bulk_email_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def send_bulk_email(
    ...
    capo_sesv2.types.send_bulk_email_response.SendBulkEmailResponse, zapros.Response
]:
