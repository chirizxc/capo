...
def handle_response(
    ...
    out: capo_sesv2.types.put_configuration_set_vdm_options_response.PutConfigurationSetVdmOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_configuration_set_vdm_options_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
