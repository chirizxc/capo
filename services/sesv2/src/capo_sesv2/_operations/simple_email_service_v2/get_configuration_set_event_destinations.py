"""Generated from Smithy shape ``com.amazonaws.sesv2#GetConfigurationSetEventDestinations``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.get_configuration_set_event_destinations_response.GetConfigurationSetEventDestinationsResponse = capo_sesv2.types.get_configuration_set_event_destinations_response.deserialize_json(
