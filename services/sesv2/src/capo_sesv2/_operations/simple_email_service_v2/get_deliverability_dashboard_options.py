"""Generated from Smithy shape ``com.amazonaws.sesv2#GetDeliverabilityDashboardOptions``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.get_deliverability_dashboard_options_response.GetDeliverabilityDashboardOptionsResponse = capo_sesv2.types.get_deliverability_dashboard_options_response.deserialize_json(
