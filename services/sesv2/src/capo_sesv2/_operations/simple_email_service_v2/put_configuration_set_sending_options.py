"""Generated from Smithy shape ``com.amazonaws.sesv2#PutConfigurationSetSendingOptions``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.put_configuration_set_sending_options_response.PutConfigurationSetSendingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_configuration_set_sending_options_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_configuration_set_sending_options(
