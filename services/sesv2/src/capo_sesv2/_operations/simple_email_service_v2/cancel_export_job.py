"""Generated from Smithy shape ``com.amazonaws.sesv2#CancelExportJob``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.cancel_export_job_response.CancelExportJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/export-jobs/{JobId}/cancel"
...
def cancel_export_job(
    ...
    capo_sesv2.types.cancel_export_job_response.CancelExportJobResponse, zapros.Response
]:
...
async def async_cancel_export_job(
