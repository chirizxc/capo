...
def handle_response(
    ...
    out: capo_sesv2.types.put_deliverability_dashboard_option_response.PutDeliverabilityDashboardOptionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_deliverability_dashboard_option_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
