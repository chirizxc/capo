...
def handle_response(
    ...
    out: capo_sesv2.types.get_account_response.GetAccountResponse = (
        capo_sesv2.types.get_account_response.deserialize_json(
...
def get_account(
    ...
    input_: capo_sesv2.types.get_account_request.GetAccountRequest,
) -> tuple[capo_sesv2.types.get_account_response.GetAccountResponse, zapros.Response]:
