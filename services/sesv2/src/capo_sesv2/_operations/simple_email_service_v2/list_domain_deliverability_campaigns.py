...
def handle_response(
    ...
    out: capo_sesv2.types.list_domain_deliverability_campaigns_response.ListDomainDeliverabilityCampaignsResponse = capo_sesv2.types.list_domain_deliverability_campaigns_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{SubscribedDomain}", quote(input_["subscribed_domain"], safe=""))
