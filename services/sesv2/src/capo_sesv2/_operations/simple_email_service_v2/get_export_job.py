"""Generated from Smithy shape ``com.amazonaws.sesv2#GetExportJob``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.get_export_job_response.GetExportJobResponse = (
        capo_sesv2.types.get_export_job_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/email/export-jobs/{JobId}"
...
def get_export_job(
    ...
    capo_sesv2.types.get_export_job_response.GetExportJobResponse, zapros.Response
]:
