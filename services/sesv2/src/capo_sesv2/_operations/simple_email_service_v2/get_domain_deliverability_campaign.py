"""Generated from Smithy shape ``com.amazonaws.sesv2#GetDomainDeliverabilityCampaign``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.get_domain_deliverability_campaign_response.GetDomainDeliverabilityCampaignResponse = capo_sesv2.types.get_domain_deliverability_campaign_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{CampaignId}", quote(input_["campaign_id"], safe=""))
