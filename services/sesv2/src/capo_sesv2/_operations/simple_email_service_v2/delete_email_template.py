"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteEmailTemplate``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.delete_email_template_response.DeleteEmailTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
