...
def handle_response(
    ...
    out: capo_sesv2.types.put_configuration_set_tracking_options_response.PutConfigurationSetTrackingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_configuration_set_tracking_options_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
