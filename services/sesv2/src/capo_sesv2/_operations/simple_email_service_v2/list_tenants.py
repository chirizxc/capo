...
def handle_response(
    ...
    out: capo_sesv2.types.list_tenants_response.ListTenantsResponse = (
        capo_sesv2.types.list_tenants_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.list_tenants_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def list_tenants(
    ...
    input_: capo_sesv2.types.list_tenants_request.ListTenantsRequest,
) -> tuple[capo_sesv2.types.list_tenants_response.ListTenantsResponse, zapros.Response]:
