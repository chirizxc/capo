...
def handle_response(
    ...
    out: capo_sesv2.types.put_account_suppression_attributes_response.PutAccountSuppressionAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_account_suppression_attributes_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
