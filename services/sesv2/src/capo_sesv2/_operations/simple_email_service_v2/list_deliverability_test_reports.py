...
import capo_sesv2.types.deliverability_test_reports
...
def handle_response(
    ...
    out: capo_sesv2.types.list_deliverability_test_reports_response.ListDeliverabilityTestReportsResponse = capo_sesv2.types.list_deliverability_test_reports_response.deserialize_json(
