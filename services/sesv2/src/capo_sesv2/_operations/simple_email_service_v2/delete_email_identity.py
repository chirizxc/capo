"""Generated from Smithy shape ``com.amazonaws.sesv2#DeleteEmailIdentity``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.delete_email_identity_response.DeleteEmailIdentityResponse = {}  # type: ignore[typeddict-item]
    return out
