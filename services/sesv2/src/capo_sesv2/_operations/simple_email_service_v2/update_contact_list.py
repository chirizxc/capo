"""Generated from Smithy shape ``com.amazonaws.sesv2#UpdateContactList``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.update_contact_list_response.UpdateContactListResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.update_contact_list_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_contact_list(
