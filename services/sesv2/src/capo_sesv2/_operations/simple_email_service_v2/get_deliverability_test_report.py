"""Generated from Smithy shape ``com.amazonaws.sesv2#GetDeliverabilityTestReport``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.get_deliverability_test_report_response.GetDeliverabilityTestReportResponse = capo_sesv2.types.get_deliverability_test_report_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ReportId}", quote(input_["report_id"], safe=""))
