...
def handle_response(
    ...
    out: capo_sesv2.types.list_export_jobs_response.ListExportJobsResponse = (
        capo_sesv2.types.list_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.list_export_jobs_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_export_jobs(
    ...
    capo_sesv2.types.list_export_jobs_response.ListExportJobsResponse, zapros.Response
]:
