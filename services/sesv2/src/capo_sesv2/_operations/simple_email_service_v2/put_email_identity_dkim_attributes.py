...
def handle_response(
    ...
    out: capo_sesv2.types.put_email_identity_dkim_attributes_response.PutEmailIdentityDkimAttributesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.put_email_identity_dkim_attributes_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
