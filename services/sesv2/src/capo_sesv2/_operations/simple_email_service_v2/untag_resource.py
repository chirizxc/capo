...
def handle_response(
    ...
    out: capo_sesv2.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_sesv2.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
