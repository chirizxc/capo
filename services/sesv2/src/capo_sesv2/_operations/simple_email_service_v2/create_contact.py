...
def handle_response(
    ...
    out: capo_sesv2.types.create_contact_response.CreateContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sesv2.types.create_contact_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_contact(
    ...
    capo_sesv2.types.create_contact_response.CreateContactResponse, zapros.Response
]:
