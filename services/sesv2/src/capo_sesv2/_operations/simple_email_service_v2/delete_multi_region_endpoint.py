...
def handle_response(
    ...
    out: capo_sesv2.types.delete_multi_region_endpoint_response.DeleteMultiRegionEndpointResponse = capo_sesv2.types.delete_multi_region_endpoint_response.deserialize_json(
