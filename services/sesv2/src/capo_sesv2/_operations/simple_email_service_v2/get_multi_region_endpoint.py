"""Generated from Smithy shape ``com.amazonaws.sesv2#GetMultiRegionEndpoint``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.get_multi_region_endpoint_response.GetMultiRegionEndpointResponse = capo_sesv2.types.get_multi_region_endpoint_response.deserialize_json(
...
async def async_get_multi_region_endpoint(
