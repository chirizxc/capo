"""Generated from Smithy shape ``com.amazonaws.sesv2#GetContact``."""
...
def handle_response(
    ...
    out: capo_sesv2.types.get_contact_response.GetContactResponse = (
        capo_sesv2.types.get_contact_response.deserialize_json(
...
def get_contact(
    ...
    input_: capo_sesv2.types.get_contact_request.GetContactRequest,
) -> tuple[capo_sesv2.types.get_contact_response.GetContactResponse, zapros.Response]:
