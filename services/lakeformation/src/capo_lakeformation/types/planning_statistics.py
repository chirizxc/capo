...
class PlanningStatistics(TypedDict, closed=True):
    estimated_data_to_scan_bytes: (
        "capo_lakeformation.types.number_of_bytes.NumberOfBytes"
    )
    ...
    work_units_generated_count: "capo_lakeformation.types.number_of_items.NumberOfItems"
