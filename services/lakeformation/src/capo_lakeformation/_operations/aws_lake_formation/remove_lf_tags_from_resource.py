...
def handle_response(
    ...
    out: capo_lakeformation.types.remove_lf_tags_from_resource_response.RemoveLFTagsFromResourceResponse = capo_lakeformation.types.remove_lf_tags_from_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.remove_lf_tags_from_resource_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
