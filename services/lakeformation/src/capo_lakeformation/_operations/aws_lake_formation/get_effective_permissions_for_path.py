"""Generated from Smithy shape ``com.amazonaws.lakeformation#GetEffectivePermissionsForPath``."""
...
def handle_response(
    ...
    out: capo_lakeformation.types.get_effective_permissions_for_path_response.GetEffectivePermissionsForPathResponse = capo_lakeformation.types.get_effective_permissions_for_path_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.get_effective_permissions_for_path_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_effective_permissions_for_path(
