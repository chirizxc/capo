...
def handle_response(
    ...
    out: capo_lakeformation.types.delete_lake_formation_identity_center_configuration_response.DeleteLakeFormationIdentityCenterConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.delete_lake_formation_identity_center_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
