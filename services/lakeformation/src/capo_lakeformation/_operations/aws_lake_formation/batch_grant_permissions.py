...
def handle_response(
    ...
    out: capo_lakeformation.types.batch_grant_permissions_response.BatchGrantPermissionsResponse = capo_lakeformation.types.batch_grant_permissions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.batch_grant_permissions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
