...
def handle_response(
    ...
    out: capo_lakeformation.types.list_table_storage_optimizers_response.ListTableStorageOptimizersResponse = capo_lakeformation.types.list_table_storage_optimizers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.list_table_storage_optimizers_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
