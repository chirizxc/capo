...
def handle_response(
    ...
    out: capo_lakeformation.types.update_resource_response.UpdateResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.update_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
