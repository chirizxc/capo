...
def handle_response(
    ...
    out: capo_lakeformation.types.get_temporary_glue_partition_credentials_response.GetTemporaryGluePartitionCredentialsResponse = capo_lakeformation.types.get_temporary_glue_partition_credentials_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.get_temporary_glue_partition_credentials_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
