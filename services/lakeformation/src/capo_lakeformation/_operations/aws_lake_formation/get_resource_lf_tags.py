...
def handle_response(
    ...
    out: capo_lakeformation.types.get_resource_lf_tags_response.GetResourceLFTagsResponse = capo_lakeformation.types.get_resource_lf_tags_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lakeformation.types.get_resource_lf_tags_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
