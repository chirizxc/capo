"""Generated from Smithy shape ``com.amazonaws.simspaceweaver#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.simspaceweaver#ValidationException``."""
