...
def handle_response(
    ...
    out: capo_simspaceweaver.types.describe_simulation_output.DescribeSimulationOutput = capo_simspaceweaver.types.describe_simulation_output.deserialize_json(
...
def build_request(
    ...
    if "simulation" in input_:
        params.append(("simulation", input_["simulation"]))
