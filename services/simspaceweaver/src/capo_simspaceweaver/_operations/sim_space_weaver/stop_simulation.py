...
def handle_response(
    ...
    out: capo_simspaceweaver.types.stop_simulation_output.StopSimulationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_simspaceweaver.types.stop_simulation_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
