...
def handle_response(
    ...
    out: capo_simspaceweaver.types.start_clock_output.StartClockOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_simspaceweaver.types.start_clock_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def start_clock(
    ...
    capo_simspaceweaver.types.start_clock_output.StartClockOutput, zapros.Response
]:
