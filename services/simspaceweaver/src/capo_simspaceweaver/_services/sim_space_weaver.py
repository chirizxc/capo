...
from capo_simspaceweaver._resources.sim_space_weaver.simulation import Simulation
from capo_simspaceweaver._services._aws_config import aws_config
...
class SimSpaceWeaverClient:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.list_tags_for_resource.list_tags_for_resource(
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
