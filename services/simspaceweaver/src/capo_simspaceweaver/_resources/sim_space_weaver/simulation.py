...
if TYPE_CHECKING:
    ...
    from capo_simspaceweaver._services.async_sim_space_weaver import (
        AsyncSimSpaceWeaverClient,
        AsyncSimSpaceWeaverClientConfig,
    )
    from capo_simspaceweaver._services.sim_space_weaver import (
...
class Simulation:
    ...
    def create(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.start_simulation_input.StartSimulationInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.start_simulation_output.StartSimulationOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.start_simulation.start_simulation(
    ...
    def read(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.describe_simulation_input.DescribeSimulationInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.describe_simulation_output.DescribeSimulationOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.describe_simulation.describe_simulation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.stop_simulation_input.StopSimulationInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.stop_simulation_output.StopSimulationOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.stop_simulation.stop_simulation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.delete_simulation_input.DeleteSimulationInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.delete_simulation_output.DeleteSimulationOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.delete_simulation.delete_simulation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.list_simulations_input.ListSimulationsInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.list_simulations_output.ListSimulationsOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.list_simulations.list_simulations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_snapshot(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.create_snapshot_input.CreateSnapshotInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.create_snapshot_output.CreateSnapshotOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.create_snapshot.create_snapshot(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_app(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.delete_app_input.DeleteAppInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.delete_app_output.DeleteAppOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.delete_app.delete_app(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_app(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.describe_app_input.DescribeAppInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.describe_app_output.DescribeAppOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.describe_app.describe_app(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_apps(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.list_apps_input.ListAppsInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.list_apps_output.ListAppsOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.list_apps.list_apps(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_app(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.start_app_input.StartAppInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.start_app_output.StartAppOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.start_app.start_app(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_clock(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.start_clock_input.StartClockInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.start_clock_output.StartClockOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.start_clock.start_clock(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_app(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.stop_app_input.StopAppInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.stop_app_output.StopAppOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.stop_app.stop_app(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_clock(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_simspaceweaver.types.stop_clock_input.StopClockInput]",
        ) -> OperationResponse[
            "capo_simspaceweaver.types.stop_clock_output.StopClockOutput"
        ]:
            ...
            output, http_response = (
                capo_simspaceweaver._operations.sim_space_weaver.stop_clock.stop_clock(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
