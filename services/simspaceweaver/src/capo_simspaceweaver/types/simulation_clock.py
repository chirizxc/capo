...
if TYPE_CHECKING:
    import capo_simspaceweaver.types.clock_status
    import capo_simspaceweaver.types.clock_target_status


class SimulationClock(TypedDict, closed=True):
    status: NotRequired["capo_simspaceweaver.types.clock_status.ClockStatus"]
    """<p>The current status of the simulation clock.</p>"""
    target_status: NotRequired[
        "capo_simspaceweaver.types.clock_target_status.ClockTargetStatus"
    ]
