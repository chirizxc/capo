...
```
pip install capo-simspaceweaver
```

## Usage

```python
from capo_simspaceweaver import AsyncSimSpaceWeaverClient
...
```python
from capo_simspaceweaver import AsyncSimSpaceWeaverClient
from capo_simspaceweaver.error import ResourceNotFoundException
