"""Generated from Smithy shape ``com.amazonaws.neptunedata#ManagePropertygraphStatistics``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.manage_propertygraph_statistics_output.ManagePropertygraphStatisticsOutput = capo_neptunedata.types.manage_propertygraph_statistics_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptunedata.types.manage_propertygraph_statistics_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_manage_propertygraph_statistics(
