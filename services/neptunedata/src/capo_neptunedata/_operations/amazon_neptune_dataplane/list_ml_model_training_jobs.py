"""Generated from Smithy shape ``com.amazonaws.neptunedata#ListMLModelTrainingJobs``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.list_ml_model_training_jobs_output.ListMLModelTrainingJobsOutput = capo_neptunedata.types.list_ml_model_training_jobs_output.deserialize_json(
...
async def async_list_ml_model_training_jobs(
