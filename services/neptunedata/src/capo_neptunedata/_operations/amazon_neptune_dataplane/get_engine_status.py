"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetEngineStatus``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.get_engine_status_output.GetEngineStatusOutput = (
        capo_neptunedata.types.get_engine_status_output.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/status"
