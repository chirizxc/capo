...
def handle_response(
    ...
    out: capo_neptunedata.types.get_open_cypher_query_status_output.GetOpenCypherQueryStatusOutput = capo_neptunedata.types.get_open_cypher_query_status_output.deserialize_json(
