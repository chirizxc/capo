"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetGremlinQueryStatus``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.get_gremlin_query_status_output.GetGremlinQueryStatusOutput = capo_neptunedata.types.get_gremlin_query_status_output.deserialize_json(
...
async def async_get_gremlin_query_status(
