...
def handle_response(
    ...
    out: capo_neptunedata.types.execute_gremlin_profile_query_output.ExecuteGremlinProfileQueryOutput = {
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptunedata.types.execute_gremlin_profile_query_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
