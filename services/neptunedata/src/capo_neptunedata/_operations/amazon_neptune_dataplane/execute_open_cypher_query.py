...
def handle_response(
    ...
    out: capo_neptunedata.types.execute_open_cypher_query_output.ExecuteOpenCypherQueryOutput = capo_neptunedata.types.execute_open_cypher_query_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptunedata.types.execute_open_cypher_query_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
