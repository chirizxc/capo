"""Generated from Smithy shape ``com.amazonaws.neptunedata#DeleteMLEndpoint``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.delete_ml_endpoint_output.DeleteMLEndpointOutput = (
        capo_neptunedata.types.delete_ml_endpoint_output.deserialize_json(
...
def build_request(
    ...
    if "neptune_iam_role_arn" in input_:
        params.append(("neptuneIamRoleArn", input_["neptune_iam_role_arn"]))
    if "clean" in input_:
        params.append(("clean", "true" if input_["clean"] else "false"))
...
async def async_delete_ml_endpoint(
