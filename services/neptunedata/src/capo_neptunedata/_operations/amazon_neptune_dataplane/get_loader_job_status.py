...
def build_request(
    ...
    url = url.replace("{loadId}", quote(input_["load_id"], safe=""))
    params: list[tuple[str, str]] = []
    if "details" in input_:
        params.append(("details", "true" if input_["details"] else "false"))
    if "errors" in input_:
        params.append(("errors", "true" if input_["errors"] else "false"))
    if "page" in input_:
        params.append(("page", str(input_["page"])))
    if "errors_per_page" in input_:
        params.append(("errorsPerPage", str(input_["errors_per_page"])))
