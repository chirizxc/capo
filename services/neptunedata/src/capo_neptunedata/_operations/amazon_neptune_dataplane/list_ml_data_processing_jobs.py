"""Generated from Smithy shape ``com.amazonaws.neptunedata#ListMLDataProcessingJobs``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.list_ml_data_processing_jobs_output.ListMLDataProcessingJobsOutput = capo_neptunedata.types.list_ml_data_processing_jobs_output.deserialize_json(
...
async def async_list_ml_data_processing_jobs(
