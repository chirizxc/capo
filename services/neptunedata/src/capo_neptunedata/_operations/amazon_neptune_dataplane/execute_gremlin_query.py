...
def handle_response(
    ...
    out: capo_neptunedata.types.execute_gremlin_query_output.ExecuteGremlinQueryOutput = capo_neptunedata.types.execute_gremlin_query_output.deserialize_json(
...
def build_request(
    ...
    if "serializer" in input_:
        headers["accept"] = input_["serializer"]
    body: bytes | None = json.dumps(
        capo_neptunedata.types.execute_gremlin_query_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
