"""Generated from Smithy shape ``com.amazonaws.neptunedata#GetSparqlStatistics``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.get_sparql_statistics_output.GetSparqlStatisticsOutput = capo_neptunedata.types.get_sparql_statistics_output.deserialize_json(
...
async def async_get_sparql_statistics(
