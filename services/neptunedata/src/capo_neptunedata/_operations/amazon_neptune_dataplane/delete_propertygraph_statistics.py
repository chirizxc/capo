...
def handle_response(
    ...
    out: capo_neptunedata.types.delete_propertygraph_statistics_output.DeletePropertygraphStatisticsOutput = capo_neptunedata.types.delete_propertygraph_statistics_output.deserialize_json(
