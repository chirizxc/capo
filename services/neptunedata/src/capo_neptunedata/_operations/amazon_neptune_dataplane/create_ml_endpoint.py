"""Generated from Smithy shape ``com.amazonaws.neptunedata#CreateMLEndpoint``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.create_ml_endpoint_output.CreateMLEndpointOutput = (
        capo_neptunedata.types.create_ml_endpoint_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptunedata.types.create_ml_endpoint_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_ml_endpoint(
