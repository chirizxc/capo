"""Generated from Smithy shape ``com.amazonaws.neptunedata#DeleteSparqlStatistics``."""
...
def handle_response(
    ...
    out: capo_neptunedata.types.delete_sparql_statistics_output.DeleteSparqlStatisticsOutput = capo_neptunedata.types.delete_sparql_statistics_output.deserialize_json(
...
async def async_delete_sparql_statistics(
