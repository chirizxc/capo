...
if TYPE_CHECKING:
    import capo_neptunedata.types.edge_properties
...
class EdgeStructure(TypedDict, closed=True):
    ...
    edge_properties: NotRequired[
        "capo_neptunedata.types.edge_properties.EdgeProperties"
    ]
...
def serialize_json(value: EdgeStructure) -> dict:
    ...
    if "edge_properties" in value:
        ...
        out["edgeProperties"] = capo_neptunedata.types.edge_properties.serialize_json(
...
def deserialize_json(data: dict) -> EdgeStructure:
    ...
    if data.get("edgeProperties") is not None:
        ...
        out["edge_properties"] = (
            capo_neptunedata.types.edge_properties.deserialize_json(
                data["edgeProperties"]
            )
        )
    return out
