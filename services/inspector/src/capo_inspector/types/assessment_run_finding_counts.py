...
if TYPE_CHECKING:
    import capo_inspector.types.finding_count
    import capo_inspector.types.severity

AssessmentRunFindingCounts: TypeAlias = dict[
    "capo_inspector.types.severity.Severity",
    "capo_inspector.types.finding_count.FindingCount",
]
...
def serialize_aws_json_1_1(input_to_serialize: AssessmentRunFindingCounts) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[capo_inspector.types.severity.serialize_aws_json_1_1(key)] = value
    return out
