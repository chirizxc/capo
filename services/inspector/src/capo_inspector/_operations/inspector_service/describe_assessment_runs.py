"""Generated from Smithy shape ``com.amazonaws.inspector#DescribeAssessmentRuns``."""
...
def handle_response(
    ...
    out: capo_inspector.types.describe_assessment_runs_response.DescribeAssessmentRunsResponse = capo_inspector.types.describe_assessment_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_inspector.types.describe_assessment_runs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_assessment_runs(
