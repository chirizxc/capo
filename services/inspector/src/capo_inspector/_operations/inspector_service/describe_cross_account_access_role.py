...
def handle_response(
    ...
    out: capo_inspector.types.describe_cross_account_access_role_response.DescribeCrossAccountAccessRoleResponse = capo_inspector.types.describe_cross_account_access_role_response.deserialize_aws_json_1_1(
