...
if TYPE_CHECKING:
    ...
    import capo_codeguru_reviewer.types.kms_key_id


class KMSKeyDetails(TypedDict, closed=True):
    kms_key_id: NotRequired["capo_codeguru_reviewer.types.kms_key_id.KMSKeyId"]
    ...
    encryption_option: NotRequired[
        "capo_codeguru_reviewer.types.encryption_option.EncryptionOption"
    ]
...
def serialize_json(value: KMSKeyDetails) -> dict:
    ...
    if "encryption_option" in value:
        ...
        out["EncryptionOption"] = (
            capo_codeguru_reviewer.types.encryption_option.serialize_json(
...
def deserialize_json(data: dict) -> KMSKeyDetails:
    ...
    if data.get("EncryptionOption") is not None:
        ...
        out["encryption_option"] = (
            capo_codeguru_reviewer.types.encryption_option.deserialize_json(
