...
if TYPE_CHECKING:
    import capo_codeguru_reviewer.types.event_name
    import capo_codeguru_reviewer.types.event_state


class EventInfo(TypedDict, closed=True):
    name: NotRequired["capo_codeguru_reviewer.types.event_name.EventName"]
    ...
    state: NotRequired["capo_codeguru_reviewer.types.event_state.EventState"]
