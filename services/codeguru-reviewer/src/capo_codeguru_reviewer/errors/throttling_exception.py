"""Generated from Smithy shape ``com.amazonaws.codegurureviewer#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codegurureviewer#ThrottlingException``."""
