"""Generated from Smithy shape ``com.amazonaws.invoicing#ListProcurementPortalPreferences``."""
...
def handle_response(
    ...
    out: capo_invoicing.types.list_procurement_portal_preferences_response.ListProcurementPortalPreferencesResponse = capo_invoicing.types.list_procurement_portal_preferences_response.deserialize_aws_json_1_0(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_invoicing._auth._sigv4.build_sigv4_auth_scheme(
                "invoicing", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Invoicing.ListProcurementPortalPreferences"
    body: bytes | None = json.dumps(
        capo_invoicing.types.list_procurement_portal_preferences_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_procurement_portal_preferences(
