...
def handle_response(
    ...
    out: capo_invoicing.types.delete_procurement_portal_preference_response.DeleteProcurementPortalPreferenceResponse = capo_invoicing.types.delete_procurement_portal_preference_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_invoicing.types.delete_procurement_portal_preference_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
