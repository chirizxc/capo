"""Generated from Smithy shape ``com.amazonaws.invoicing#BatchGetInvoiceProfile``."""
...
def handle_response(
    ...
    out: capo_invoicing.types.batch_get_invoice_profile_response.BatchGetInvoiceProfileResponse = capo_invoicing.types.batch_get_invoice_profile_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Invoicing.BatchGetInvoiceProfile"
    body: bytes | None = json.dumps(
        capo_invoicing.types.batch_get_invoice_profile_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_get_invoice_profile(
