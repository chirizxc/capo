...
def handle_response(
    ...
    out: capo_invoicing.types.get_invoice_pdf_response.GetInvoicePDFResponse = (
        capo_invoicing.types.get_invoice_pdf_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_invoicing.types.get_invoice_pdf_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_invoice_pdf(
    ...
    capo_invoicing.types.get_invoice_pdf_response.GetInvoicePDFResponse, zapros.Response
]:
