...
def handle_response(
    ...
    out: capo_invoicing.types.delete_invoice_unit_response.DeleteInvoiceUnitResponse = (
        capo_invoicing.types.delete_invoice_unit_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_invoicing.types.delete_invoice_unit_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
