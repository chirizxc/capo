"""Generated from Smithy shape ``com.amazonaws.invoicing#ListInvoiceSummaries``."""
...
def handle_response(
    ...
    out: capo_invoicing.types.list_invoice_summaries_response.ListInvoiceSummariesResponse = capo_invoicing.types.list_invoice_summaries_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Invoicing.ListInvoiceSummaries"
    body: bytes | None = json.dumps(
        capo_invoicing.types.list_invoice_summaries_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_invoice_summaries(
