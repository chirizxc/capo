...
class ListInvoiceSummariesRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_0(value: ListInvoiceSummariesRequest) -> dict:
    ...
    out["Selector"] = (
        capo_invoicing.types.invoice_summaries_selector.serialize_aws_json_1_0(
            value["selector"]
        )
    )
    if "filter" in value:
        ...
        out["Filter"] = (
            capo_invoicing.types.invoice_summaries_filter.serialize_aws_json_1_0(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListInvoiceSummariesRequest:
    ...
    if data.get("Selector") is not None:
        ...
        out["selector"] = (
            capo_invoicing.types.invoice_summaries_selector.deserialize_aws_json_1_0(
                data["Selector"]
            )
        )
    else:
    ...
    if data.get("Filter") is not None:
        ...
        out["filter"] = (
            capo_invoicing.types.invoice_summaries_filter.deserialize_aws_json_1_0(
                data["Filter"]
            )
        )
