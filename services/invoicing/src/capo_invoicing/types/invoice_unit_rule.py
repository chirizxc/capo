...
class InvoiceUnitRule(TypedDict, closed=True):
    linked_accounts: NotRequired[
        "capo_invoicing.types.rule_account_id_list.RuleAccountIdList"
    ]
...
def serialize_aws_json_1_0(value: InvoiceUnitRule) -> dict:
    ...
    if "linked_accounts" in value:
        ...
        out["LinkedAccounts"] = (
            capo_invoicing.types.rule_account_id_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> InvoiceUnitRule:
    ...
    if data.get("LinkedAccounts") is not None:
        ...
        out["linked_accounts"] = (
            capo_invoicing.types.rule_account_id_list.deserialize_aws_json_1_0(
                data["LinkedAccounts"]
            )
        )
