...
class Entity(TypedDict, closed=True):
    ...
    billing_entity: NotRequired["capo_invoicing.types.billing_entity.BillingEntity"]
...
def serialize_aws_json_1_0(value: Entity) -> dict:
    ...
    if "billing_entity" in value:
        ...
        out["BillingEntity"] = (
            capo_invoicing.types.billing_entity.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Entity:
    ...
    if data.get("BillingEntity") is not None:
        ...
        out["billing_entity"] = (
            capo_invoicing.types.billing_entity.deserialize_aws_json_1_0(
                data["BillingEntity"]
            )
        )
    return out
