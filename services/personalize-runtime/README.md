...
```
pip install capo-personalize-runtime
```

## Usage

```python
from capo_personalize_runtime import AsyncPersonalizeRuntimeClient
...
```python
from capo_personalize_runtime import AsyncPersonalizeRuntimeClient
from capo_personalize_runtime.error import InvalidInputException
