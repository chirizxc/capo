...
class GetCoreNetworkChangeEventsResponse(TypedDict, closed=True):
    core_network_change_events: NotRequired[
        "capo_networkmanager.types.core_network_change_event_list.CoreNetworkChangeEventList"
    ]
...
def serialize_json(value: GetCoreNetworkChangeEventsResponse) -> dict:
    ...
    if "core_network_change_events" in value:
        ...
        out["CoreNetworkChangeEvents"] = (
            capo_networkmanager.types.core_network_change_event_list.serialize_json(
...
def deserialize_json(data: dict) -> GetCoreNetworkChangeEventsResponse:
    ...
    if data.get("CoreNetworkChangeEvents") is not None:
        import capo_networkmanager.types.core_network_change_event_list

        out["core_network_change_events"] = (
            capo_networkmanager.types.core_network_change_event_list.deserialize_json(
