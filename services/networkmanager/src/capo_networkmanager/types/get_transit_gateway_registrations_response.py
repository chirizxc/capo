...
class GetTransitGatewayRegistrationsResponse(TypedDict, closed=True):
    transit_gateway_registrations: NotRequired[
        "capo_networkmanager.types.transit_gateway_registration_list.TransitGatewayRegistrationList"
    ]
...
def serialize_json(value: GetTransitGatewayRegistrationsResponse) -> dict:
    ...
    if "transit_gateway_registrations" in value:
        ...
        out["TransitGatewayRegistrations"] = (
            capo_networkmanager.types.transit_gateway_registration_list.serialize_json(
...
def deserialize_json(data: dict) -> GetTransitGatewayRegistrationsResponse:
    ...
    if data.get("TransitGatewayRegistrations") is not None:
        import capo_networkmanager.types.transit_gateway_registration_list

        out["transit_gateway_registrations"] = (
            capo_networkmanager.types.transit_gateway_registration_list.deserialize_json(
