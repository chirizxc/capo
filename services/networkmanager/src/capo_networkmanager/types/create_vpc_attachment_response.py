"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateVpcAttachmentResponse``."""
...
class CreateVpcAttachmentResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateVpcAttachmentResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateVpcAttachmentResponse:
    out: CreateVpcAttachmentResponse = {}  # type: ignore[typeddict-item]
