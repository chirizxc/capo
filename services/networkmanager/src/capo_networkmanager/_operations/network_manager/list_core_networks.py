...
def handle_response(
    ...
    out: capo_networkmanager.types.list_core_networks_response.ListCoreNetworksResponse = capo_networkmanager.types.list_core_networks_response.deserialize_json(
