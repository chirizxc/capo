"""Generated from Smithy shape ``com.amazonaws.networkmanager#ExecuteCoreNetworkChangeSet``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.execute_core_network_change_set_response.ExecuteCoreNetworkChangeSetResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_execute_core_network_change_set(
