...
def handle_response(
    ...
    out: capo_networkmanager.types.put_resource_policy_response.PutResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.put_resource_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
