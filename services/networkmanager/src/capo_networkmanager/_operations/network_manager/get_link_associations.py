...
def handle_response(
    ...
    out: capo_networkmanager.types.get_link_associations_response.GetLinkAssociationsResponse = capo_networkmanager.types.get_link_associations_response.deserialize_json(
...
def build_request(
    ...
    if "link_id" in input_:
        params.append(("linkId", input_["link_id"]))
