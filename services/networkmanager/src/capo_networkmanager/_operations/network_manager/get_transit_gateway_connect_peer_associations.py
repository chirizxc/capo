...
def handle_response(
    ...
    out: capo_networkmanager.types.get_transit_gateway_connect_peer_associations_response.GetTransitGatewayConnectPeerAssociationsResponse = capo_networkmanager.types.get_transit_gateway_connect_peer_associations_response.deserialize_json(
...
def build_request(
    ...
    if "transit_gateway_connect_peer_arns" in input_:
        for item in input_["transit_gateway_connect_peer_arns"]:
            params.append(("transitGatewayConnectPeerArns", item))
