"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateConnection``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.create_connection_response.CreateConnectionResponse = capo_networkmanager.types.create_connection_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_connection_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
