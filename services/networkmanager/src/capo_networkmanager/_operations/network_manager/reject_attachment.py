"""Generated from Smithy shape ``com.amazonaws.networkmanager#RejectAttachment``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.reject_attachment_response.RejectAttachmentResponse = capo_networkmanager.types.reject_attachment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/attachments/{AttachmentId}/reject"
    url = url.replace("{AttachmentId}", quote(input_["attachment_id"], safe=""))
...
async def async_reject_attachment(
