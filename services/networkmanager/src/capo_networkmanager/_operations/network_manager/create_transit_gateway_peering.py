...
def handle_response(
    ...
    out: capo_networkmanager.types.create_transit_gateway_peering_response.CreateTransitGatewayPeeringResponse = capo_networkmanager.types.create_transit_gateway_peering_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_transit_gateway_peering_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
