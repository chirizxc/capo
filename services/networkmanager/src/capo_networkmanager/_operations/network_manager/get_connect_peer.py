"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetConnectPeer``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.get_connect_peer_response.GetConnectPeerResponse = (
        capo_networkmanager.types.get_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ConnectPeerId}", quote(input_["connect_peer_id"], safe=""))
...
async def async_get_connect_peer(
