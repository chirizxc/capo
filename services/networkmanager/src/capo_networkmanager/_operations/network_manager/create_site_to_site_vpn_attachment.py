...
def handle_response(
    ...
    out: capo_networkmanager.types.create_site_to_site_vpn_attachment_response.CreateSiteToSiteVpnAttachmentResponse = capo_networkmanager.types.create_site_to_site_vpn_attachment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_site_to_site_vpn_attachment_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
