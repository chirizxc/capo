...
def handle_response(
    ...
    out: capo_networkmanager.types.create_device_response.CreateDeviceResponse = (
        capo_networkmanager.types.create_device_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_device_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
