...
def handle_response(
    ...
    out: capo_networkmanager.types.list_connect_peers_response.ListConnectPeersResponse = capo_networkmanager.types.list_connect_peers_response.deserialize_json(
...
def build_request(
    ...
    if "connect_attachment_id" in input_:
        params.append(("connectAttachmentId", input_["connect_attachment_id"]))
