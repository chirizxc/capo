...
def handle_response(
    ...
    out: capo_networkmanager.types.delete_core_network_policy_version_response.DeleteCoreNetworkPolicyVersionResponse = capo_networkmanager.types.delete_core_network_policy_version_response.deserialize_json(
