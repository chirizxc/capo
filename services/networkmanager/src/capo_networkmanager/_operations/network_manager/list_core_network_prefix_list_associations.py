...
def handle_response(
    ...
    out: capo_networkmanager.types.list_core_network_prefix_list_associations_response.ListCoreNetworkPrefixListAssociationsResponse = capo_networkmanager.types.list_core_network_prefix_list_associations_response.deserialize_json(
...
def build_request(
    ...
    if "prefix_list_arn" in input_:
        params.append(("prefixListArn", input_["prefix_list_arn"]))
