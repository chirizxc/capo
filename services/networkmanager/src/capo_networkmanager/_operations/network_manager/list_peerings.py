...
def build_request(
    ...
    if "peering_type" in input_:
        params.append(
            (
                "peeringType",
                capo_networkmanager.types.peering_type.serialize_json(
                    input_["peering_type"]
                ),
            )
        )
    if "edge_location" in input_:
        params.append(("edgeLocation", input_["edge_location"]))
    if "state" in input_:
        params.append(
            (
                "state",
                capo_networkmanager.types.peering_state.serialize_json(input_["state"]),
            )
        )
