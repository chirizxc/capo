...
def handle_response(
    ...
    out: capo_networkmanager.types.delete_global_network_response.DeleteGlobalNetworkResponse = capo_networkmanager.types.delete_global_network_response.deserialize_json(
