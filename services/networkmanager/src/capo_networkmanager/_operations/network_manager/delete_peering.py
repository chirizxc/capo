"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeletePeering``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.delete_peering_response.DeletePeeringResponse = (
        capo_networkmanager.types.delete_peering_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/peerings/{PeeringId}"
    url = url.replace("{PeeringId}", quote(input_["peering_id"], safe=""))
...
async def async_delete_peering(
