...
def handle_response(
    ...
    out: capo_networkmanager.types.delete_link_response.DeleteLinkResponse = (
        capo_networkmanager.types.delete_link_response.deserialize_json(
...
def delete_link(
    ...
    capo_networkmanager.types.delete_link_response.DeleteLinkResponse, zapros.Response
]:
