"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_networkmanager.types.list_tags_for_resource_response.deserialize_json(
