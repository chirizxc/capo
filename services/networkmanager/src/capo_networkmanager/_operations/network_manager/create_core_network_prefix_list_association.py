"""Generated from Smithy shape ``com.amazonaws.networkmanager#CreateCoreNetworkPrefixListAssociation``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.create_core_network_prefix_list_association_response.CreateCoreNetworkPrefixListAssociationResponse = capo_networkmanager.types.create_core_network_prefix_list_association_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prefix-list"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_core_network_prefix_list_association_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_core_network_prefix_list_association(
