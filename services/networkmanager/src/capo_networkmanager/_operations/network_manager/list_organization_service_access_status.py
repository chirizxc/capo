"""Generated from Smithy shape ``com.amazonaws.networkmanager#ListOrganizationServiceAccessStatus``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.list_organization_service_access_status_response.ListOrganizationServiceAccessStatusResponse = capo_networkmanager.types.list_organization_service_access_status_response.deserialize_json(
...
async def async_list_organization_service_access_status(
