...
def handle_response(
    ...
    out: capo_networkmanager.types.get_vpc_attachment_response.GetVpcAttachmentResponse = capo_networkmanager.types.get_vpc_attachment_response.deserialize_json(
