...
def handle_response(
    ...
    out: capo_networkmanager.types.delete_core_network_response.DeleteCoreNetworkResponse = capo_networkmanager.types.delete_core_network_response.deserialize_json(
