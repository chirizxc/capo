...
def handle_response(
    ...
    out: capo_networkmanager.types.create_core_network_response.CreateCoreNetworkResponse = capo_networkmanager.types.create_core_network_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.create_core_network_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
