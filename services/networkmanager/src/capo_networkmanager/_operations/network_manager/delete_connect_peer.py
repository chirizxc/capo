...
def handle_response(
    ...
    out: capo_networkmanager.types.delete_connect_peer_response.DeleteConnectPeerResponse = capo_networkmanager.types.delete_connect_peer_response.deserialize_json(
