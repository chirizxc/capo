"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
