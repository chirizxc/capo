...
def handle_response(
    ...
    out: capo_networkmanager.types.disassociate_link_response.DisassociateLinkResponse = capo_networkmanager.types.disassociate_link_response.deserialize_json(
