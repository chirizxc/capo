...
def handle_response(
    ...
    out: capo_networkmanager.types.get_network_resource_relationships_response.GetNetworkResourceRelationshipsResponse = capo_networkmanager.types.get_network_resource_relationships_response.deserialize_json(
...
def build_request(
    ...
    if "core_network_id" in input_:
        params.append(("coreNetworkId", input_["core_network_id"]))
    if "registered_gateway_arn" in input_:
        params.append(("registeredGatewayArn", input_["registered_gateway_arn"]))
