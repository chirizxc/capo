"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetCoreNetwork``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.get_core_network_response.GetCoreNetworkResponse = (
        capo_networkmanager.types.get_core_network_response.deserialize_json(
...
async def async_get_core_network(
