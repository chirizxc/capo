"""Generated from Smithy shape ``com.amazonaws.networkmanager#GetCustomerGatewayAssociations``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.get_customer_gateway_associations_response.GetCustomerGatewayAssociationsResponse = capo_networkmanager.types.get_customer_gateway_associations_response.deserialize_json(
...
def build_request(
    ...
    if "customer_gateway_arns" in input_:
        for item in input_["customer_gateway_arns"]:
            params.append(("customerGatewayArns", item))
...
async def async_get_customer_gateway_associations(
