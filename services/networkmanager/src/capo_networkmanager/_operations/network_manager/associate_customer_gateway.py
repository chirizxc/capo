...
def handle_response(
    ...
    out: capo_networkmanager.types.associate_customer_gateway_response.AssociateCustomerGatewayResponse = capo_networkmanager.types.associate_customer_gateway_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.associate_customer_gateway_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
