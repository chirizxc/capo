...
def handle_response(
    ...
    out: capo_networkmanager.types.associate_connect_peer_response.AssociateConnectPeerResponse = capo_networkmanager.types.associate_connect_peer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.associate_connect_peer_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
