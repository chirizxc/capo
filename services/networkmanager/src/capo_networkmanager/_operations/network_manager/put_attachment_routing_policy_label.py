...
def handle_response(
    ...
    out: capo_networkmanager.types.put_attachment_routing_policy_label_response.PutAttachmentRoutingPolicyLabelResponse = capo_networkmanager.types.put_attachment_routing_policy_label_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_networkmanager.types.put_attachment_routing_policy_label_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
