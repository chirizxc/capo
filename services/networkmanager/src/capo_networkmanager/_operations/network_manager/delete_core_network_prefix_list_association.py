...
def handle_response(
    ...
    out: capo_networkmanager.types.delete_core_network_prefix_list_association_response.DeleteCoreNetworkPrefixListAssociationResponse = capo_networkmanager.types.delete_core_network_prefix_list_association_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{PrefixListArn}", quote(input_["prefix_list_arn"], safe=""))
