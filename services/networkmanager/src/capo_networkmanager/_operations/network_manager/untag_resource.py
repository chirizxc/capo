"""Generated from Smithy shape ``com.amazonaws.networkmanager#UntagResource``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
