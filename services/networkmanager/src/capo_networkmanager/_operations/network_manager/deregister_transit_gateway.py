"""Generated from Smithy shape ``com.amazonaws.networkmanager#DeregisterTransitGateway``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.deregister_transit_gateway_response.DeregisterTransitGatewayResponse = capo_networkmanager.types.deregister_transit_gateway_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{TransitGatewayArn}", quote(input_["transit_gateway_arn"], safe="")
    )
