"""Generated from Smithy shape ``com.amazonaws.networkmanager#StartOrganizationServiceAccessUpdate``."""
...
def handle_response(
    ...
    out: capo_networkmanager.types.start_organization_service_access_update_response.StartOrganizationServiceAccessUpdateResponse = capo_networkmanager.types.start_organization_service_access_update_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/organizations/service-access"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_networkmanager.types.start_organization_service_access_update_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_organization_service_access_update(
