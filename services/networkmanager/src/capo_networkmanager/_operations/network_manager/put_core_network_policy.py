"""Generated from Smithy shape ``com.amazonaws.networkmanager#PutCoreNetworkPolicy``."""
...
import capo_networkmanager.errors.core_network_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CoreNetworkPolicyException":
            raise capo_networkmanager.errors.core_network_policy_exception.CoreNetworkPolicyException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_networkmanager.types.put_core_network_policy_response.PutCoreNetworkPolicyResponse = capo_networkmanager.types.put_core_network_policy_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{CoreNetworkId}", quote(input_["core_network_id"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_networkmanager.types.put_core_network_policy_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_core_network_policy(
