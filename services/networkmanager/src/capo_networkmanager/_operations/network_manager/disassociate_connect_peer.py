...
def handle_response(
    ...
    out: capo_networkmanager.types.disassociate_connect_peer_response.DisassociateConnectPeerResponse = capo_networkmanager.types.disassociate_connect_peer_response.deserialize_json(
