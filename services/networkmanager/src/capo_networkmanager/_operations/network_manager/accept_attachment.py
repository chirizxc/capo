...
def handle_response(
    ...
    out: capo_networkmanager.types.accept_attachment_response.AcceptAttachmentResponse = capo_networkmanager.types.accept_attachment_response.deserialize_json(
