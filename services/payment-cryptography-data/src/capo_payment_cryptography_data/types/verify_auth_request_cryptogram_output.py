...
if TYPE_CHECKING:
    import capo_payment_cryptography_data.types.auth_response_value_type
...
class VerifyAuthRequestCryptogramOutput(TypedDict, closed=True):
    ...
    auth_response_value: NotRequired[
        "capo_payment_cryptography_data.types.auth_response_value_type.AuthResponseValueType"
    ]
