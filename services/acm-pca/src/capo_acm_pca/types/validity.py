...
def serialize_aws_json_1_1(value: Validity) -> dict:
    ...
    out["Type"] = capo_acm_pca.types.validity_period_type.serialize_aws_json_1_1(
        value["type"]
    )
    return out
