...
from capo_acm_pca._services._aws_config import aws_config
...
class ACMPCAClientConfig(TypedDict, total=False, closed=True):
...
class ACMPCAClient:
    ...
    def create_certificate_authority(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.create_certificate_authority_request.CreateCertificateAuthorityRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.create_certificate_authority_response.CreateCertificateAuthorityResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.create_certificate_authority.create_certificate_authority(
    ...
    def create_certificate_authority_audit_report(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.create_certificate_authority_audit_report_request.CreateCertificateAuthorityAuditReportRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.create_certificate_authority_audit_report_response.CreateCertificateAuthorityAuditReportResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.create_certificate_authority_audit_report.create_certificate_authority_audit_report(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_permission(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.create_permission_request.CreatePermissionRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.create_permission

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.create_permission.create_permission(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_certificate_authority(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.delete_certificate_authority_request.DeleteCertificateAuthorityRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.delete_certificate_authority

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.delete_certificate_authority.delete_certificate_authority(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_permission(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.delete_permission_request.DeletePermissionRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.delete_permission

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.delete_permission.delete_permission(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.delete_policy_request.DeletePolicyRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.delete_policy

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.delete_policy.delete_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_certificate_authority(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.describe_certificate_authority_request.DescribeCertificateAuthorityRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.describe_certificate_authority_response.DescribeCertificateAuthorityResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.describe_certificate_authority.describe_certificate_authority(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_certificate_authority_audit_report(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.describe_certificate_authority_audit_report_request.DescribeCertificateAuthorityAuditReportRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.describe_certificate_authority_audit_report_response.DescribeCertificateAuthorityAuditReportResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.describe_certificate_authority_audit_report.describe_certificate_authority_audit_report(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.get_certificate_request.GetCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.get_certificate_response.GetCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.get_certificate.get_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_certificate_authority_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.get_certificate_authority_certificate_request.GetCertificateAuthorityCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.get_certificate_authority_certificate_response.GetCertificateAuthorityCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.get_certificate_authority_certificate.get_certificate_authority_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_certificate_authority_csr(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.get_certificate_authority_csr_request.GetCertificateAuthorityCsrRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.get_certificate_authority_csr_response.GetCertificateAuthorityCsrResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.get_certificate_authority_csr.get_certificate_authority_csr(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.get_policy_request.GetPolicyRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.get_policy_response.GetPolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.get_policy.get_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def import_certificate_authority_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.import_certificate_authority_certificate_request.ImportCertificateAuthorityCertificateRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.import_certificate_authority_certificate

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.import_certificate_authority_certificate.import_certificate_authority_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def issue_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.issue_certificate_request.IssueCertificateRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.issue_certificate_response.IssueCertificateResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.issue_certificate.issue_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_certificate_authorities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.list_certificate_authorities_request.ListCertificateAuthoritiesRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.list_certificate_authorities_response.ListCertificateAuthoritiesResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.list_certificate_authorities.list_certificate_authorities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_acm_pca.types.certificate_authority.CertificateAuthority]":
        _token = next_token
        while True:
    ...
    def list_permissions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.list_permissions_request.ListPermissionsRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.list_permissions_response.ListPermissionsResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.list_permissions.list_permissions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_permissions(
        ...
        *,
        ...
        max_results: Optional["capo_acm_pca.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_acm_pca.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_acm_pca.types.permission.Permission]":
        _token = next_token
        while True:
    ...
    def list_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.list_tags_request.ListTagsRequest]",
        ) -> OperationResponse[
            "capo_acm_pca.types.list_tags_response.ListTagsResponse"
        ]:
            ...
            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.list_tags.list_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_tags(
        ...
        *,
        ...
        max_results: Optional["capo_acm_pca.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_acm_pca.types.next_token.NextToken"] = None,
    ) -> "Iterator[capo_acm_pca.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def put_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.put_policy_request.PutPolicyRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.put_policy

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.put_policy.put_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def restore_certificate_authority(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.restore_certificate_authority_request.RestoreCertificateAuthorityRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.restore_certificate_authority

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.restore_certificate_authority.restore_certificate_authority(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def revoke_certificate(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.revoke_certificate_request.RevokeCertificateRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.revoke_certificate

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.revoke_certificate.revoke_certificate(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_certificate_authority(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.tag_certificate_authority_request.TagCertificateAuthorityRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.tag_certificate_authority

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.tag_certificate_authority.tag_certificate_authority(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_certificate_authority(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.untag_certificate_authority_request.UntagCertificateAuthorityRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.untag_certificate_authority

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.untag_certificate_authority.untag_certificate_authority(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_certificate_authority(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_acm_pca.types.update_certificate_authority_request.UpdateCertificateAuthorityRequest]",
        ) -> OperationResponse[None]:
            import capo_acm_pca._operations.acm_private_ca.update_certificate_authority

            output, http_response = (
                capo_acm_pca._operations.acm_private_ca.update_certificate_authority.update_certificate_authority(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
