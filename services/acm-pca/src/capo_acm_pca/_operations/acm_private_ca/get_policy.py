"""Generated from Smithy shape ``com.amazonaws.acmpca#GetPolicy``."""
...
def handle_response(
    ...
    out: capo_acm_pca.types.get_policy_response.GetPolicyResponse = (
        capo_acm_pca.types.get_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ACMPrivateCA.GetPolicy"
    body: bytes | None = json.dumps(
        capo_acm_pca.types.get_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_policy(
    ...
    input_: capo_acm_pca.types.get_policy_request.GetPolicyRequest,
) -> tuple[capo_acm_pca.types.get_policy_response.GetPolicyResponse, zapros.Response]:
