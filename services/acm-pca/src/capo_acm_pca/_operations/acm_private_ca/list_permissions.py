...
def handle_response(
    ...
    out: capo_acm_pca.types.list_permissions_response.ListPermissionsResponse = (
        capo_acm_pca.types.list_permissions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.list_permissions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
