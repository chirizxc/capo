...
import capo_acm_pca.errors.malformed_csr_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MalformedCSRException":
            raise capo_acm_pca.errors.malformed_csr_exception.MalformedCSRException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_acm_pca.types.issue_certificate_response.IssueCertificateResponse = (
        capo_acm_pca.types.issue_certificate_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.issue_certificate_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
