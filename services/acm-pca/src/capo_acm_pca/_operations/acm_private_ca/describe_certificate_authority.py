"""Generated from Smithy shape ``com.amazonaws.acmpca#DescribeCertificateAuthority``."""
...
def handle_response(
    ...
    out: capo_acm_pca.types.describe_certificate_authority_response.DescribeCertificateAuthorityResponse = capo_acm_pca.types.describe_certificate_authority_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.describe_certificate_authority_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_certificate_authority(
