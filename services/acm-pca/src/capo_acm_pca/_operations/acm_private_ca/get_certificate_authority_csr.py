...
def handle_response(
    ...
    out: capo_acm_pca.types.get_certificate_authority_csr_response.GetCertificateAuthorityCsrResponse = capo_acm_pca.types.get_certificate_authority_csr_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.get_certificate_authority_csr_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
