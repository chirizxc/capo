"""Generated from Smithy shape ``com.amazonaws.acmpca#CreateCertificateAuthorityAuditReport``."""
...
def handle_response(
    ...
    out: capo_acm_pca.types.create_certificate_authority_audit_report_response.CreateCertificateAuthorityAuditReportResponse = capo_acm_pca.types.create_certificate_authority_audit_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ACMPrivateCA.CreateCertificateAuthorityAuditReport"
    body: bytes | None = json.dumps(
        capo_acm_pca.types.create_certificate_authority_audit_report_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_certificate_authority_audit_report(
