"""Generated from Smithy shape ``com.amazonaws.acmpca#ListTags``."""
...
def handle_response(
    ...
    out: capo_acm_pca.types.list_tags_response.ListTagsResponse = (
        capo_acm_pca.types.list_tags_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.list_tags_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_tags(
    ...
    input_: capo_acm_pca.types.list_tags_request.ListTagsRequest,
) -> tuple[capo_acm_pca.types.list_tags_response.ListTagsResponse, zapros.Response]:
