"""Generated from Smithy shape ``com.amazonaws.acmpca#RestoreCertificateAuthority``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.restore_certificate_authority_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_restore_certificate_authority(
