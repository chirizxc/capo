"""Generated from Smithy shape ``com.amazonaws.acmpca#TagCertificateAuthority``."""
...
import capo_acm_pca.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_acm_pca.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_acm_pca.types.tag_certificate_authority_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_tag_certificate_authority(
