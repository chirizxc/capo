"""Generated from Smithy shape ``com.amazonaws.lexruntimeservice#GetSession``."""
...
def handle_response(
    ...
    out: capo_lex_runtime_service.types.get_session_response.GetSessionResponse = (
        capo_lex_runtime_service.types.get_session_response.deserialize_json(
...
def build_request(
    ...
    if "checkpoint_label_filter" in input_:
        params.append(("checkpointLabelFilter", input_["checkpoint_label_filter"]))
