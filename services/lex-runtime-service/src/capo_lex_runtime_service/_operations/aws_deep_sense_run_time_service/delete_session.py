"""Generated from Smithy shape ``com.amazonaws.lexruntimeservice#DeleteSession``."""
...
def handle_response(
    ...
    out: capo_lex_runtime_service.types.delete_session_response.DeleteSessionResponse = capo_lex_runtime_service.types.delete_session_response.deserialize_json(
