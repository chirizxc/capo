...
class DeleteSessionResponse(TypedDict, closed=True):
    bot_name: NotRequired["capo_lex_runtime_service.types.bot_name.BotName"]
    """<p>The name of the bot associated with the session data.</p>"""
    bot_alias: NotRequired["capo_lex_runtime_service.types.bot_alias.BotAlias"]
    """<p>The alias in use for the bot associated with the session data.</p>"""
    user_id: NotRequired["capo_lex_runtime_service.types.user_id.UserId"]
