"""Generated from Smithy shape ``com.amazonaws.lexruntimeservice#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lexruntimeservice#ConflictException``."""
