"""Generated from Smithy shape ``com.amazonaws.lexruntimeservice#BadRequestException``."""
...
class BadRequestException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lexruntimeservice#BadRequestException``."""
