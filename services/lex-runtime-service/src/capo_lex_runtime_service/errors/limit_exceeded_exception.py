"""Generated from Smithy shape ``com.amazonaws.lexruntimeservice#LimitExceededException``."""
...
class LimitExceededException_(TypedDict, closed=True):
    retry_after_seconds: NotRequired["capo_lex_runtime_service.types.string.String"]
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.lexruntimeservice#LimitExceededException``."""
