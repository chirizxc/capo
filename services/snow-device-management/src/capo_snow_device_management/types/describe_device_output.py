...
if TYPE_CHECKING:
    ...
    import capo_snow_device_management.types.unlock_state
...
class DescribeDeviceOutput(TypedDict, closed=True):
    ...
    device_state: NotRequired[
        "capo_snow_device_management.types.unlock_state.UnlockState"
    ]
    """<p>The current state of the device.</p>"""
    physical_network_interfaces: NotRequired[
        "capo_snow_device_management.types.physical_network_interface_list.PhysicalNetworkInterfaceList"
    ]
    """<p>The network interfaces available on the device.</p>"""
    device_capacities: NotRequired[
        "capo_snow_device_management.types.capacity_list.CapacityList"
    ]
    """<p>The hardware specifications of the device. </p>"""
    software: NotRequired[
        "capo_snow_device_management.types.software_information.SoftwareInformation"
    ]
...
def serialize_json(value: DescribeDeviceOutput) -> dict:
    ...
    if "physical_network_interfaces" in value:
        ...
        out["physicalNetworkInterfaces"] = (
            capo_snow_device_management.types.physical_network_interface_list.serialize_json(
    ...
    if "device_capacities" in value:
        ...
        out["deviceCapacities"] = (
            capo_snow_device_management.types.capacity_list.serialize_json(
    ...
    if "software" in value:
        ...
        out["software"] = (
            capo_snow_device_management.types.software_information.serialize_json(
                value["software"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> DescribeDeviceOutput:
    ...
    if data.get("physicalNetworkInterfaces") is not None:
        ...
        out["physical_network_interfaces"] = (
            capo_snow_device_management.types.physical_network_interface_list.deserialize_json(
    ...
    if data.get("deviceCapacities") is not None:
        ...
        out["device_capacities"] = (
            capo_snow_device_management.types.capacity_list.deserialize_json(
    ...
    if data.get("software") is not None:
        ...
        out["software"] = (
            capo_snow_device_management.types.software_information.deserialize_json(
                data["software"]
            )
        )
    return out
