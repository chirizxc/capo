"""Generated from Smithy shape ``com.amazonaws.snowdevicemanagement#DescribeTask``."""
...
def handle_response(
    ...
    out: capo_snow_device_management.types.describe_task_output.DescribeTaskOutput = (
        capo_snow_device_management.types.describe_task_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/task/{taskId}"
