...
def handle_response(
    ...
    out: capo_snow_device_management.types.list_device_resources_output.ListDeviceResourcesOutput = capo_snow_device_management.types.list_device_resources_output.deserialize_json(
