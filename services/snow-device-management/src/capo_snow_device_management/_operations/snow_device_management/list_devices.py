...
def handle_response(
    ...
    out: capo_snow_device_management.types.list_devices_output.ListDevicesOutput = (
        capo_snow_device_management.types.list_devices_output.deserialize_json(
...
def build_request(
    ...
    if "job_id" in input_:
        params.append(("jobId", input_["job_id"]))
