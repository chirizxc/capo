"""Generated from Smithy shape ``com.amazonaws.snowdevicemanagement#CancelTask``."""
...
def handle_response(
    ...
    out: capo_snow_device_management.types.cancel_task_output.CancelTaskOutput = (
        capo_snow_device_management.types.cancel_task_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/task/{taskId}/cancel"
