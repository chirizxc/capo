...
def handle_response(
    ...
    out: capo_snow_device_management.types.list_tasks_output.ListTasksOutput = (
        capo_snow_device_management.types.list_tasks_output.deserialize_json(
...
def list_tasks(
    ...
    capo_snow_device_management.types.list_tasks_output.ListTasksOutput, zapros.Response
]:
