...
from capo_snow_device_management._resources.snow_device_management.task import AsyncTask
from capo_snow_device_management._services._aws_config import aaws_config
...
class AsyncSnowDeviceManagementClient:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snow_device_management.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_snow_device_management.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snow_device_management._operations.snow_device_management.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snow_device_management.types.tag_resource_input.TagResourceInput]",
            ...
            (
                output,
                http_response,
            ) = await capo_snow_device_management._operations.snow_device_management.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snow_device_management.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_snow_device_management._operations.snow_device_management.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
