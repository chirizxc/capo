...
def serialize_json(value: StreamEvent) -> dict:
    ...
    if "event_time" in value:
        ...
        out["eventTime"] = capo_ivs.types.time.serialize_json(value["event_time"])
    if "code" in value:
        out["code"] = value["code"]
    return out
