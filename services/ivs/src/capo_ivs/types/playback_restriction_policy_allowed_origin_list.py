...
if TYPE_CHECKING:
    import capo_ivs.types.playback_restriction_policy_allowed_origin

PlaybackRestrictionPolicyAllowedOriginList: TypeAlias = list[
    "capo_ivs.types.playback_restriction_policy_allowed_origin.PlaybackRestrictionPolicyAllowedOrigin"
]
