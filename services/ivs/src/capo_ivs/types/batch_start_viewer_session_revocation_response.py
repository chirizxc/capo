...
class BatchStartViewerSessionRevocationResponse(TypedDict, closed=True):
    ...
    errors: NotRequired[
        "capo_ivs.types.batch_start_viewer_session_revocation_errors.BatchStartViewerSessionRevocationErrors"
    ]
...
def serialize_json(value: BatchStartViewerSessionRevocationResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            capo_ivs.types.batch_start_viewer_session_revocation_errors.serialize_json(
                value["errors"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> BatchStartViewerSessionRevocationResponse:
    ...
    if data.get("errors") is not None:
        ...
        out["errors"] = (
            capo_ivs.types.batch_start_viewer_session_revocation_errors.deserialize_json(
                data["errors"]
            )
        )
    return out
