"""Generated from Smithy shape ``com.amazonaws.ivs#GetChannel``."""
...
def handle_response(
    ...
    out: capo_ivs.types.get_channel_response.GetChannelResponse = (
        capo_ivs.types.get_channel_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_ivs.types.get_channel_request.GetChannelRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    url = endpoint.url.rstrip("/") + "/GetChannel"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_ivs.types.get_channel_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def get_channel(
    ...
    input_: capo_ivs.types.get_channel_request.GetChannelRequest,
) -> tuple[capo_ivs.types.get_channel_response.GetChannelResponse, zapros.Response]:
