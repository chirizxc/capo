...
def handle_response(
    ...
    out: capo_ivs.types.get_ad_configuration_response.GetAdConfigurationResponse = (
        capo_ivs.types.get_ad_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.get_ad_configuration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
