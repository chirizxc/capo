"""Generated from Smithy shape ``com.amazonaws.ivs#ListStreams``."""
...
def handle_response(
    ...
    out: capo_ivs.types.list_streams_response.ListStreamsResponse = (
        capo_ivs.types.list_streams_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.list_streams_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def list_streams(
    ...
    input_: capo_ivs.types.list_streams_request.ListStreamsRequest,
) -> tuple[capo_ivs.types.list_streams_response.ListStreamsResponse, zapros.Response]:
