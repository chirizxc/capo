...
def handle_response(
    ...
    out: capo_ivs.types.create_channel_response.CreateChannelResponse = (
        capo_ivs.types.create_channel_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.create_channel_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_channel(
    ...
    capo_ivs.types.create_channel_response.CreateChannelResponse, zapros.Response
]:
