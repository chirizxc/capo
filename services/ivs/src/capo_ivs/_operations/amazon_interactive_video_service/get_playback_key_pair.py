...
def handle_response(
    ...
    out: capo_ivs.types.get_playback_key_pair_response.GetPlaybackKeyPairResponse = (
        capo_ivs.types.get_playback_key_pair_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.get_playback_key_pair_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
