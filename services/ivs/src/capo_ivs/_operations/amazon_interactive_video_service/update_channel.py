...
def handle_response(
    ...
    out: capo_ivs.types.update_channel_response.UpdateChannelResponse = (
        capo_ivs.types.update_channel_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.update_channel_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_channel(
    ...
    capo_ivs.types.update_channel_response.UpdateChannelResponse, zapros.Response
]:
