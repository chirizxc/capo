...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceUnavailable":
            raise capo_ivs.errors.service_unavailable.ServiceUnavailable.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ivs.types.batch_get_stream_key_response.BatchGetStreamKeyResponse = (
        capo_ivs.types.batch_get_stream_key_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.batch_get_stream_key_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
