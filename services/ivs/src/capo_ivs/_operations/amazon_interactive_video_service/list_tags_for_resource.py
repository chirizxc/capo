"""Generated from Smithy shape ``com.amazonaws.ivs#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_ivs.types.list_tags_for_resource_response.ListTagsForResourceResponse = (
        capo_ivs.types.list_tags_for_resource_response.deserialize_json(
