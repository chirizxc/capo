...
import capo_ivs.errors.stream_unavailable
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StreamUnavailable":
            raise capo_ivs.errors.stream_unavailable.StreamUnavailable.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_ivs.types.stop_stream_response.StopStreamResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.stop_stream_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def stop_stream(
    ...
    input_: capo_ivs.types.stop_stream_request.StopStreamRequest,
) -> tuple[capo_ivs.types.stop_stream_response.StopStreamResponse, zapros.Response]:
