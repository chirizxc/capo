...
def handle_response(
    ...
    out: capo_ivs.types.create_ad_configuration_response.CreateAdConfigurationResponse = capo_ivs.types.create_ad_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ivs.types.create_ad_configuration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
