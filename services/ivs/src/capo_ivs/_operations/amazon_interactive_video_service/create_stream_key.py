"""Generated from Smithy shape ``com.amazonaws.ivs#CreateStreamKey``."""
...
def handle_response(
    ...
    out: capo_ivs.types.create_stream_key_response.CreateStreamKeyResponse = (
        capo_ivs.types.create_stream_key_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/CreateStreamKey"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_ivs.types.create_stream_key_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_stream_key(
    ...
    capo_ivs.types.create_stream_key_response.CreateStreamKeyResponse, zapros.Response
]:
...
async def async_create_stream_key(
