"""Generated from Smithy shape ``com.amazonaws.ivs#UntagResource``."""
...
def handle_response(
    ...
    out: capo_ivs.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_ivs.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
