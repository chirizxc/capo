...
def handle_response(
    ...
    out: capo_keyspaces.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_keyspaces.types.untag_resource_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def untag_resource(
    ...
    capo_keyspaces.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
