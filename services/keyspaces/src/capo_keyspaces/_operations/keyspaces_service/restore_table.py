"""Generated from Smithy shape ``com.amazonaws.keyspaces#RestoreTable``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.restore_table_response.RestoreTableResponse = (
        capo_keyspaces.types.restore_table_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KeyspacesService.RestoreTable"
    body: bytes | None = json.dumps(
        capo_keyspaces.types.restore_table_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def restore_table(
    ...
    capo_keyspaces.types.restore_table_response.RestoreTableResponse, zapros.Response
]:
