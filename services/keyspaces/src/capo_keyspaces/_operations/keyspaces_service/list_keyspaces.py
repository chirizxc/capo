...
def handle_response(
    ...
    out: capo_keyspaces.types.list_keyspaces_response.ListKeyspacesResponse = (
        capo_keyspaces.types.list_keyspaces_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_keyspaces.types.list_keyspaces_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_keyspaces(
    ...
    capo_keyspaces.types.list_keyspaces_response.ListKeyspacesResponse, zapros.Response
]:
