"""Generated from Smithy shape ``com.amazonaws.keyspaces#GetType``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.get_type_response.GetTypeResponse = (
        capo_keyspaces.types.get_type_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KeyspacesService.GetType"
    body: bytes | None = json.dumps(
        capo_keyspaces.types.get_type_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_type(
    ...
    input_: capo_keyspaces.types.get_type_request.GetTypeRequest,
) -> tuple[capo_keyspaces.types.get_type_response.GetTypeResponse, zapros.Response]:
