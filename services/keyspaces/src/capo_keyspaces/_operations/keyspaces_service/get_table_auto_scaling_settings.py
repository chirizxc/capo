"""Generated from Smithy shape ``com.amazonaws.keyspaces#GetTableAutoScalingSettings``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.get_table_auto_scaling_settings_response.GetTableAutoScalingSettingsResponse = capo_keyspaces.types.get_table_auto_scaling_settings_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KeyspacesService.GetTableAutoScalingSettings"
    body: bytes | None = json.dumps(
        capo_keyspaces.types.get_table_auto_scaling_settings_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_table_auto_scaling_settings(
