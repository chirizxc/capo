"""Generated from Smithy shape ``com.amazonaws.keyspaces#DeleteKeyspace``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.delete_keyspace_response.DeleteKeyspaceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "KeyspacesService.DeleteKeyspace"
    body: bytes | None = json.dumps(
        capo_keyspaces.types.delete_keyspace_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
