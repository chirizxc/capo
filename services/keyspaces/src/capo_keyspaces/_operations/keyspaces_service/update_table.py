"""Generated from Smithy shape ``com.amazonaws.keyspaces#UpdateTable``."""
...
def handle_response(
    ...
    out: capo_keyspaces.types.update_table_response.UpdateTableResponse = (
        capo_keyspaces.types.update_table_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_keyspaces.types.update_table_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def update_table(
    ...
    capo_keyspaces.types.update_table_response.UpdateTableResponse, zapros.Response
]:
