...
if TYPE_CHECKING:
    import capo_keyspaces.types.tag_key
    import capo_keyspaces.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_keyspaces.types.tag_key.TagKey"
    ...
    value: "capo_keyspaces.types.tag_value.TagValue"
