...
def handle_response(
    ...
    out: capo_geo_places.types.suggest_response.SuggestResponse = (
        capo_geo_places.types.suggest_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_geo_places.types.suggest_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def suggest(
    ...
    input_: capo_geo_places.types.suggest_request.SuggestRequest,
) -> tuple[capo_geo_places.types.suggest_response.SuggestResponse, zapros.Response]:
