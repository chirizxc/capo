...
if TYPE_CHECKING:
    ...
    from capo_geo_places._services.geo_places import (
        GeoPlacesClient,
...
class AsyncProviderResource:
    ...
    async def autocomplete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_places.types.autocomplete_request.AutocompleteRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_places.types.autocomplete_response.AutocompleteResponse"
        ]:
            import capo_geo_places._operations.places_service.autocomplete
            ...
            (
                output,
                http_response,
            ) = await capo_geo_places._operations.places_service.autocomplete.async_autocomplete(
                req.options, req.input
            )
    ...
    async def geocode(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_places.types.geocode_request.GeocodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_places.types.geocode_response.GeocodeResponse"
        ]:
            import capo_geo_places._operations.places_service.geocode
            ...
            (
                output,
                http_response,
            ) = await capo_geo_places._operations.places_service.geocode.async_geocode(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_place(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_places.types.get_place_request.GetPlaceRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_places.types.get_place_response.GetPlaceResponse"
        ]:
            import capo_geo_places._operations.places_service.get_place
            ...
            (
                output,
                http_response,
            ) = await capo_geo_places._operations.places_service.get_place.async_get_place(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def reverse_geocode(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_places.types.reverse_geocode_request.ReverseGeocodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_places.types.reverse_geocode_response.ReverseGeocodeResponse"
        ]:
            import capo_geo_places._operations.places_service.reverse_geocode
            ...
            (
                output,
                http_response,
            ) = await capo_geo_places._operations.places_service.reverse_geocode.async_reverse_geocode(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_nearby(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_places.types.search_nearby_request.SearchNearbyRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_places.types.search_nearby_response.SearchNearbyResponse"
        ]:
            import capo_geo_places._operations.places_service.search_nearby
            ...
            (
                output,
                http_response,
            ) = await capo_geo_places._operations.places_service.search_nearby.async_search_nearby(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_text(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_places.types.search_text_request.SearchTextRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_places.types.search_text_response.SearchTextResponse"
        ]:
            import capo_geo_places._operations.places_service.search_text
            ...
            (
                output,
                http_response,
            ) = await capo_geo_places._operations.places_service.search_text.async_search_text(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def suggest(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_geo_places.types.suggest_request.SuggestRequest]",
        ) -> AsyncOperationResponse[
            "capo_geo_places.types.suggest_response.SuggestResponse"
        ]:
            import capo_geo_places._operations.places_service.suggest
            ...
            (
                output,
                http_response,
            ) = await capo_geo_places._operations.places_service.suggest.async_suggest(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
