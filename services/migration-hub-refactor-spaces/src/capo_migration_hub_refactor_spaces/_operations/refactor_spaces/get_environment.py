"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#GetEnvironment``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.get_environment_response.GetEnvironmentResponse = capo_migration_hub_refactor_spaces.types.get_environment_response.deserialize_json(
