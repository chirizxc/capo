...
import capo_migration_hub_refactor_spaces.errors.invalid_resource_policy_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResourcePolicyException":
            raise capo_migration_hub_refactor_spaces.errors.invalid_resource_policy_exception.InvalidResourcePolicyException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.put_resource_policy_response.PutResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub_refactor_spaces.types.put_resource_policy_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
