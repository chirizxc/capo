...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.delete_route_response.DeleteRouteResponse = capo_migration_hub_refactor_spaces.types.delete_route_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{RouteIdentifier}", quote(input_["route_identifier"], safe=""))
