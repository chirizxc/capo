"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#ListServices``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.list_services_response.ListServicesResponse = capo_migration_hub_refactor_spaces.types.list_services_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ApplicationIdentifier}", quote(input_["application_identifier"], safe="")
    )
