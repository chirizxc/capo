"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#DeleteEnvironment``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.delete_environment_response.DeleteEnvironmentResponse = capo_migration_hub_refactor_spaces.types.delete_environment_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/environments/{EnvironmentIdentifier}"
    url = url.replace(
