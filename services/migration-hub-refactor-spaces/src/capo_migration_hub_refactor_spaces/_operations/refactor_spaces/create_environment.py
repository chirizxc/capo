"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#CreateEnvironment``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.create_environment_response.CreateEnvironmentResponse = capo_migration_hub_refactor_spaces.types.create_environment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub_refactor_spaces.types.create_environment_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
