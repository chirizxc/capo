"""Generated from Smithy shape ``com.amazonaws.migrationhubrefactorspaces#UntagResource``."""
...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
