...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.delete_application_response.DeleteApplicationResponse = capo_migration_hub_refactor_spaces.types.delete_application_response.deserialize_json(
