...
def handle_response(
    ...
    out: capo_migration_hub_refactor_spaces.types.get_route_response.GetRouteResponse = capo_migration_hub_refactor_spaces.types.get_route_response.deserialize_json(
