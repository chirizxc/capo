...
if TYPE_CHECKING:
    ...
    import capo_drs.types.data_replication_state
...
class DataReplicationInfo(TypedDict, closed=True):
    ...
    replicated_disks: NotRequired[
        "capo_drs.types.data_replication_info_replicated_disks.DataReplicationInfoReplicatedDisks"
    ]
    """<p>The disks that should be replicated.</p>"""
    data_replication_state: NotRequired[
        "capo_drs.types.data_replication_state.DataReplicationState"
    ]
    """<p>The state of the data replication.</p>"""
    data_replication_initiation: NotRequired[
        "capo_drs.types.data_replication_initiation.DataReplicationInitiation"
    ]
    """<p>Information about whether the data replication has been initiated.</p>"""
    data_replication_error: NotRequired[
        "capo_drs.types.data_replication_error.DataReplicationError"
    ]
...
def serialize_json(value: DataReplicationInfo) -> dict:
    ...
    if "replicated_disks" in value:
        ...
        out["replicatedDisks"] = (
            capo_drs.types.data_replication_info_replicated_disks.serialize_json(
    ...
    if "data_replication_initiation" in value:
        ...
        out["dataReplicationInitiation"] = (
            capo_drs.types.data_replication_initiation.serialize_json(
    ...
    if "data_replication_error" in value:
        ...
        out["dataReplicationError"] = (
            capo_drs.types.data_replication_error.serialize_json(
...
def deserialize_json(data: dict) -> DataReplicationInfo:
    ...
    if data.get("replicatedDisks") is not None:
        ...
        out["replicated_disks"] = (
            capo_drs.types.data_replication_info_replicated_disks.deserialize_json(
    ...
    if data.get("dataReplicationInitiation") is not None:
        ...
        out["data_replication_initiation"] = (
            capo_drs.types.data_replication_initiation.deserialize_json(
    ...
    if data.get("dataReplicationError") is not None:
        ...
        out["data_replication_error"] = (
            capo_drs.types.data_replication_error.deserialize_json(
