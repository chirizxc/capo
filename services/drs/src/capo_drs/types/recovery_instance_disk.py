...
if TYPE_CHECKING:
    ...
    import capo_drs.types.ebs_volume_id
    import capo_drs.types.positive_integer


class RecoveryInstanceDisk(TypedDict, closed=True):
    internal_device_name: NotRequired["capo_drs.types.bounded_string.BoundedString"]
    ...
    ebs_volume_id: NotRequired["capo_drs.types.ebs_volume_id.EbsVolumeID"]
