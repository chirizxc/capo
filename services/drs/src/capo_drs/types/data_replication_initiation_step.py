...
if TYPE_CHECKING:
    import capo_drs.types.data_replication_initiation_step_name
    import capo_drs.types.data_replication_initiation_step_status


class DataReplicationInitiationStep(TypedDict, closed=True):
    name: NotRequired[
        "capo_drs.types.data_replication_initiation_step_name.DataReplicationInitiationStepName"
    ]
