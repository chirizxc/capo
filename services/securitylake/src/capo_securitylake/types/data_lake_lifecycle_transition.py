...
if TYPE_CHECKING:
    import capo_securitylake.types.data_lake_storage_class


class DataLakeLifecycleTransition(TypedDict, closed=True):
    storage_class: NotRequired[
        "capo_securitylake.types.data_lake_storage_class.DataLakeStorageClass"
    ]
