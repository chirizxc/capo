...
def handle_response(
    ...
    out: capo_securitylake.types.update_data_lake_response.UpdateDataLakeResponse = (
        capo_securitylake.types.update_data_lake_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.update_data_lake_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
