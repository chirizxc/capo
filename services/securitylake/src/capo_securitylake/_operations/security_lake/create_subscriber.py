"""Generated from Smithy shape ``com.amazonaws.securitylake#CreateSubscriber``."""
...
def handle_response(
    ...
    out: capo_securitylake.types.create_subscriber_response.CreateSubscriberResponse = (
        capo_securitylake.types.create_subscriber_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.create_subscriber_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
