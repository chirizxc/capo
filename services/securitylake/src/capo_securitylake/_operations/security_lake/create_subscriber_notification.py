...
def handle_response(
    ...
    out: capo_securitylake.types.create_subscriber_notification_response.CreateSubscriberNotificationResponse = capo_securitylake.types.create_subscriber_notification_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.create_subscriber_notification_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
