"""Generated from Smithy shape ``com.amazonaws.securitylake#GetDataLakeExceptionSubscription``."""
...
def handle_response(
    ...
    out: capo_securitylake.types.get_data_lake_exception_subscription_response.GetDataLakeExceptionSubscriptionResponse = capo_securitylake.types.get_data_lake_exception_subscription_response.deserialize_json(
...
async def async_get_data_lake_exception_subscription(
