...
def handle_response(
    ...
    out: capo_securitylake.types.update_subscriber_response.UpdateSubscriberResponse = (
        capo_securitylake.types.update_subscriber_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securitylake.types.update_subscriber_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
