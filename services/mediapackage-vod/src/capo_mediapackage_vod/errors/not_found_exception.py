"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#NotFoundException``."""
...
class NotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.mediapackagevod#NotFoundException``."""
