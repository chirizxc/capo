"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#DescribeAsset``."""
...
def handle_response(
    ...
    out: capo_mediapackage_vod.types.describe_asset_response.DescribeAssetResponse = (
        capo_mediapackage_vod.types.describe_asset_response.deserialize_json(
