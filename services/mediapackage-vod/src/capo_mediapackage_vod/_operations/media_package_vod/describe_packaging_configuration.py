...
def handle_response(
    ...
    out: capo_mediapackage_vod.types.describe_packaging_configuration_response.DescribePackagingConfigurationResponse = capo_mediapackage_vod.types.describe_packaging_configuration_response.deserialize_json(
