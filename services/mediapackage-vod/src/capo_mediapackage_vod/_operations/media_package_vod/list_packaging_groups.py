...
import capo_mediapackage_vod.types.__list_of_packaging_group
...
def handle_response(
    ...
    out: capo_mediapackage_vod.types.list_packaging_groups_response.ListPackagingGroupsResponse = capo_mediapackage_vod.types.list_packaging_groups_response.deserialize_json(
