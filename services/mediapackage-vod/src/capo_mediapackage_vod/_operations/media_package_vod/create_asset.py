...
def handle_response(
    ...
    out: capo_mediapackage_vod.types.create_asset_response.CreateAssetResponse = (
        capo_mediapackage_vod.types.create_asset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackage_vod.types.create_asset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
