"""Generated from Smithy shape ``com.amazonaws.mediapackagevod#EncryptionContractConfiguration``."""
...
class EncryptionContractConfiguration(TypedDict, closed=True):
    preset_speke20_audio: NotRequired[
        "capo_mediapackage_vod.types.preset_speke20_audio.PresetSpeke20Audio"
    ]
    """A collection of audio encryption presets."""
    preset_speke20_video: NotRequired[
        "capo_mediapackage_vod.types.preset_speke20_video.PresetSpeke20Video"
    ]
...
def serialize_json(value: EncryptionContractConfiguration) -> dict:
    ...
    if "preset_speke20_audio" in value:
        ...
        out["presetSpeke20Audio"] = (
            capo_mediapackage_vod.types.preset_speke20_audio.serialize_json(
    ...
    if "preset_speke20_video" in value:
        ...
        out["presetSpeke20Video"] = (
            capo_mediapackage_vod.types.preset_speke20_video.serialize_json(
...
def deserialize_json(data: dict) -> EncryptionContractConfiguration:
    ...
    if data.get("presetSpeke20Audio") is not None:
        ...
        out["preset_speke20_audio"] = (
            capo_mediapackage_vod.types.preset_speke20_audio.deserialize_json(
    ...
    if data.get("presetSpeke20Video") is not None:
        ...
        out["preset_speke20_video"] = (
            capo_mediapackage_vod.types.preset_speke20_video.deserialize_json(
