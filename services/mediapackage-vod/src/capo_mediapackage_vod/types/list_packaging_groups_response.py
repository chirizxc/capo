...
class ListPackagingGroupsResponse(TypedDict, closed=True):
    ...
    packaging_groups: NotRequired[
        "capo_mediapackage_vod.types.__list_of_packaging_group.__listOfPackagingGroup"
    ]
...
def serialize_json(value: ListPackagingGroupsResponse) -> dict:
    ...
    if "packaging_groups" in value:
        ...
        out["packagingGroups"] = (
            capo_mediapackage_vod.types.__list_of_packaging_group.serialize_json(
...
def deserialize_json(data: dict) -> ListPackagingGroupsResponse:
    ...
    if data.get("packagingGroups") is not None:
        import capo_mediapackage_vod.types.__list_of_packaging_group

        out["packaging_groups"] = (
            capo_mediapackage_vod.types.__list_of_packaging_group.deserialize_json(
