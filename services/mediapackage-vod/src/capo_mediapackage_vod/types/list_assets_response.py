...
class ListAssetsResponse(TypedDict, closed=True):
    assets: NotRequired[
        "capo_mediapackage_vod.types.__list_of_asset_shallow.__listOfAssetShallow"
    ]
...
def serialize_json(value: ListAssetsResponse) -> dict:
    ...
    if "assets" in value:
        ...
        out["assets"] = (
            capo_mediapackage_vod.types.__list_of_asset_shallow.serialize_json(
                value["assets"]
            )
        )
...
def deserialize_json(data: dict) -> ListAssetsResponse:
    ...
    if data.get("assets") is not None:
        ...
        out["assets"] = (
            capo_mediapackage_vod.types.__list_of_asset_shallow.deserialize_json(
                data["assets"]
            )
        )
