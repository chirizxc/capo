...
from capo_workmailmessageflow._services._aws_config import aaws_config
...
class AsyncWorkMailMessageFlowClientConfig(TypedDict, total=False, closed=True):
...
class AsyncWorkMailMessageFlowClient:
    ...
    async def get_raw_message_content(
        ...
        *,
    ...
    ) -> "AsyncGenerator[capo_workmailmessageflow.types.get_raw_message_content_response.GetRawMessageContentResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workmailmessageflow.types.get_raw_message_content_request.GetRawMessageContentRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_workmailmessageflow._operations.giraffe_message_in_transit_service.get_raw_message_content.async_get_raw_message_content(
    ...
    async def put_raw_message_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workmailmessageflow.types.put_raw_message_content_request.PutRawMessageContentRequest]",
        ) -> AsyncOperationResponse[
            "capo_workmailmessageflow.types.put_raw_message_content_response.PutRawMessageContentResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_workmailmessageflow._operations.giraffe_message_in_transit_service.put_raw_message_content.async_put_raw_message_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
