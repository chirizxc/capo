"""Generated from Smithy shape ``com.amazonaws.workmailmessageflow#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.workmailmessageflow#ResourceNotFoundException``."""
