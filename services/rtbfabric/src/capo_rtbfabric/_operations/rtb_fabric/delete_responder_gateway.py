...
def handle_response(
    ...
    out: capo_rtbfabric.types.delete_responder_gateway_response.DeleteResponderGatewayResponse = capo_rtbfabric.types.delete_responder_gateway_response.deserialize_json(
