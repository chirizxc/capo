...
def handle_response(
    ...
    out: capo_rtbfabric.types.create_link_response.CreateLinkResponse = (
        capo_rtbfabric.types.create_link_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rtbfabric.types.create_link_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_link(
    ...
    capo_rtbfabric.types.create_link_response.CreateLinkResponse, zapros.Response
]:
