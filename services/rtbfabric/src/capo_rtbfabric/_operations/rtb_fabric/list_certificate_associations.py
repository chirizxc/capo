...
def handle_response(
    ...
    out: capo_rtbfabric.types.list_certificate_associations_response.ListCertificateAssociationsResponse = capo_rtbfabric.types.list_certificate_associations_response.deserialize_json(
...
def build_request(
    ...
    params.append(("maxResults", str(input_.get("max_results", 5))))
