"""Generated from Smithy shape ``com.amazonaws.rtbfabric#CreateInboundExternalLink``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.create_inbound_external_link_response.CreateInboundExternalLinkResponse = capo_rtbfabric.types.create_inbound_external_link_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rtbfabric.types.create_inbound_external_link_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_inbound_external_link(
