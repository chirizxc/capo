"""Generated from Smithy shape ``com.amazonaws.rtbfabric#UpdateLink``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.update_link_response.UpdateLinkResponse = (
        capo_rtbfabric.types.update_link_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rtbfabric.types.update_link_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_link(
    ...
    capo_rtbfabric.types.update_link_response.UpdateLinkResponse, zapros.Response
]:
