...
def handle_response(
    ...
    out: capo_rtbfabric.types.get_inbound_external_link_response.GetInboundExternalLinkResponse = capo_rtbfabric.types.get_inbound_external_link_response.deserialize_json(
