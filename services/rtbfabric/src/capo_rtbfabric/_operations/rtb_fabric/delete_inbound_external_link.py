"""Generated from Smithy shape ``com.amazonaws.rtbfabric#DeleteInboundExternalLink``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.delete_inbound_external_link_response.DeleteInboundExternalLinkResponse = capo_rtbfabric.types.delete_inbound_external_link_response.deserialize_json(
...
async def async_delete_inbound_external_link(
