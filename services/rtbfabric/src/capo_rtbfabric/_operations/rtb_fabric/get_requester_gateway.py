"""Generated from Smithy shape ``com.amazonaws.rtbfabric#GetRequesterGateway``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.get_requester_gateway_response.GetRequesterGatewayResponse = capo_rtbfabric.types.get_requester_gateway_response.deserialize_json(
...
async def async_get_requester_gateway(
