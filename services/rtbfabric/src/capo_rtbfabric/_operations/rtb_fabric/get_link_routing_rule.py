...
def handle_response(
    ...
    out: capo_rtbfabric.types.get_link_routing_rule_response.GetLinkRoutingRuleResponse = capo_rtbfabric.types.get_link_routing_rule_response.deserialize_json(
