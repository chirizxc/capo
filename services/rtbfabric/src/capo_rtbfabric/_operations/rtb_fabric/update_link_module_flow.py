...
def handle_response(
    ...
    out: capo_rtbfabric.types.update_link_module_flow_response.UpdateLinkModuleFlowResponse = capo_rtbfabric.types.update_link_module_flow_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rtbfabric.types.update_link_module_flow_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
