...
def handle_response(
    ...
    out: capo_rtbfabric.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_rtbfabric.types.list_tags_for_resource_response.deserialize_json(
