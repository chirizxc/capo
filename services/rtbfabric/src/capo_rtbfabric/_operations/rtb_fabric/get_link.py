"""Generated from Smithy shape ``com.amazonaws.rtbfabric#GetLink``."""
...
def handle_response(
    ...
    out: capo_rtbfabric.types.get_link_response.GetLinkResponse = (
        capo_rtbfabric.types.get_link_response.deserialize_json(
...
def get_link(
    ...
    input_: capo_rtbfabric.types.get_link_request.GetLinkRequest,
) -> tuple[capo_rtbfabric.types.get_link_response.GetLinkResponse, zapros.Response]:
