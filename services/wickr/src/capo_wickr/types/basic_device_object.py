...
class BasicDeviceObject(TypedDict, closed=True):
    app_id: NotRequired["capo_wickr.types.generic_string.GenericString"]
    """<p>The unique application ID for the Wickr app on this device.</p>"""
    created: NotRequired["capo_wickr.types.generic_string.GenericString"]
    ...
    status_text: NotRequired["capo_wickr.types.generic_string.GenericString"]
