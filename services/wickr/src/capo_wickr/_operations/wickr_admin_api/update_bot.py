"""Generated from Smithy shape ``com.amazonaws.wickr#UpdateBot``."""
...
def handle_response(
    ...
    out: capo_wickr.types.update_bot_response.UpdateBotResponse = (
        capo_wickr.types.update_bot_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.update_bot_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_bot(
    ...
    input_: capo_wickr.types.update_bot_request.UpdateBotRequest,
) -> tuple[capo_wickr.types.update_bot_response.UpdateBotResponse, zapros.Response]:
