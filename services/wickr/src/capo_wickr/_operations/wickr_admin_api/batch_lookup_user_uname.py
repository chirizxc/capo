...
def handle_response(
    ...
    out: capo_wickr.types.batch_lookup_user_uname_response.BatchLookupUserUnameResponse = capo_wickr.types.batch_lookup_user_uname_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.batch_lookup_user_uname_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
