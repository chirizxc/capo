...
def handle_response(
    ...
    out: capo_wickr.types.batch_reinvite_user_response.BatchReinviteUserResponse = (
        capo_wickr.types.batch_reinvite_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.batch_reinvite_user_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
