"""Generated from Smithy shape ``com.amazonaws.wickr#ListSecurityGroups``."""
...
def handle_response(
    ...
    out: capo_wickr.types.list_security_groups_response.ListSecurityGroupsResponse = (
        capo_wickr.types.list_security_groups_response.deserialize_json(
...
async def async_list_security_groups(
