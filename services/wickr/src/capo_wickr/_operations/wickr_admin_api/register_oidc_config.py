...
def handle_response(
    ...
    out: capo_wickr.types.register_oidc_config_response.RegisterOidcConfigResponse = (
        capo_wickr.types.register_oidc_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.register_oidc_config_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
