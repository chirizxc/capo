...
def handle_response(
    ...
    out: capo_wickr.types.get_guest_user_history_count_response.GetGuestUserHistoryCountResponse = capo_wickr.types.get_guest_user_history_count_response.deserialize_json(
