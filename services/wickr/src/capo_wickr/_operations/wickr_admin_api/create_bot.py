"""Generated from Smithy shape ``com.amazonaws.wickr#CreateBot``."""
...
def handle_response(
    ...
    out: capo_wickr.types.create_bot_response.CreateBotResponse = (
        capo_wickr.types.create_bot_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.create_bot_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_bot(
    ...
    input_: capo_wickr.types.create_bot_request.CreateBotRequest,
) -> tuple[capo_wickr.types.create_bot_response.CreateBotResponse, zapros.Response]:
