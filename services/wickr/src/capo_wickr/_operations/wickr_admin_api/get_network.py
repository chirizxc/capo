"""Generated from Smithy shape ``com.amazonaws.wickr#GetNetwork``."""
...
def handle_response(
    ...
    out: capo_wickr.types.get_network_response.GetNetworkResponse = (
        capo_wickr.types.get_network_response.deserialize_json(
...
def get_network(
    ...
    input_: capo_wickr.types.get_network_request.GetNetworkRequest,
) -> tuple[capo_wickr.types.get_network_response.GetNetworkResponse, zapros.Response]:
