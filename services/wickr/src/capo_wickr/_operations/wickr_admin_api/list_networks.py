...
def handle_response(
    ...
    out: capo_wickr.types.list_networks_response.ListNetworksResponse = (
        capo_wickr.types.list_networks_response.deserialize_json(
...
def list_networks(
    ...
    capo_wickr.types.list_networks_response.ListNetworksResponse, zapros.Response
]:
