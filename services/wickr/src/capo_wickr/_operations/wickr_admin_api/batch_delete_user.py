...
def handle_response(
    ...
    out: capo_wickr.types.batch_delete_user_response.BatchDeleteUserResponse = (
        capo_wickr.types.batch_delete_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wickr.types.batch_delete_user_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def batch_delete_user(
    ...
    capo_wickr.types.batch_delete_user_response.BatchDeleteUserResponse, zapros.Response
]:
