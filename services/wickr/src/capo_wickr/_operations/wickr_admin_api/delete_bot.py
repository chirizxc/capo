...
def handle_response(
    ...
    out: capo_wickr.types.delete_bot_response.DeleteBotResponse = (
        capo_wickr.types.delete_bot_response.deserialize_json(
...
def delete_bot(
    ...
    input_: capo_wickr.types.delete_bot_request.DeleteBotRequest,
) -> tuple[capo_wickr.types.delete_bot_response.DeleteBotResponse, zapros.Response]:
