...
def handle_response(
    ...
    out: capo_wickr.types.get_bot_response.GetBotResponse = (
        capo_wickr.types.get_bot_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_wickr.types.get_bot_response.GetBotResponse = (
        capo_wickr.types.get_bot_response.deserialize_json(
...
def get_bot(
    options: OperationOptions, input_: capo_wickr.types.get_bot_request.GetBotRequest
) -> tuple[capo_wickr.types.get_bot_response.GetBotResponse, zapros.Response]:
