...
def handle_response(
    ...
    out: capo_wickr.types.get_oidc_info_response.GetOidcInfoResponse = (
        capo_wickr.types.get_oidc_info_response.deserialize_json(
...
def build_request(
    ...
    if "client_id" in input_:
        params.append(("clientId", input_["client_id"]))
    if "code" in input_:
        params.append(("code", input_["code"]))
    if "grant_type" in input_:
        params.append(("grantType", input_["grant_type"]))
    if "redirect_uri" in input_:
        params.append(("redirectUri", input_["redirect_uri"]))
    if "url" in input_:
        params.append(("url", input_["url"]))
    if "client_secret" in input_:
        params.append(("clientSecret", input_["client_secret"]))
    if "code_verifier" in input_:
        params.append(("codeVerifier", input_["code_verifier"]))
    if "certificate" in input_:
        params.append(("certificate", input_["certificate"]))
...
def get_oidc_info(
    ...
    capo_wickr.types.get_oidc_info_response.GetOidcInfoResponse, zapros.Response
]:
