"""Generated from Smithy shape ``com.amazonaws.wickr#GetDataRetentionBot``."""
...
def handle_response(
    ...
    out: capo_wickr.types.get_data_retention_bot_response.GetDataRetentionBotResponse = capo_wickr.types.get_data_retention_bot_response.deserialize_json(
...
async def async_get_data_retention_bot(
