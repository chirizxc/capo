"""Generated from Smithy shape ``com.amazonaws.wickr#GetUsersCount``."""
...
def handle_response(
    ...
    out: capo_wickr.types.get_users_count_response.GetUsersCountResponse = (
        capo_wickr.types.get_users_count_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/networks/{networkId}/users/count"
...
def get_users_count(
    ...
    capo_wickr.types.get_users_count_response.GetUsersCountResponse, zapros.Response
]:
