...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_check_details_output.ListCheckDetailsOutput = (
        capo_wellarchitected.types.list_check_details_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.list_check_details_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
