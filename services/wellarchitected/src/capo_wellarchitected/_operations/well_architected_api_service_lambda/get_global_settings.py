...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_global_settings_output.GetGlobalSettingsOutput = capo_wellarchitected.types.get_global_settings_output.deserialize_json(
