"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListReviewTemplates``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_review_templates_output.ListReviewTemplatesOutput = capo_wellarchitected.types.list_review_templates_output.deserialize_json(
...
async def async_list_review_templates(
