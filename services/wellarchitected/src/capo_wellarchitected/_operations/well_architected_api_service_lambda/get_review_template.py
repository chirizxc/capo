"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetReviewTemplate``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_review_template_output.GetReviewTemplateOutput = capo_wellarchitected.types.get_review_template_output.deserialize_json(
...
async def async_get_review_template(
