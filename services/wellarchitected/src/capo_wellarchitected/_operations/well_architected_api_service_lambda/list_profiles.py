...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_profiles_output.ListProfilesOutput = (
        capo_wellarchitected.types.list_profiles_output.deserialize_json(
...
def build_request(
    ...
    if "profile_name_prefix" in input_:
        params.append(("ProfileNamePrefix", input_["profile_name_prefix"]))
    if "profile_owner_type" in input_:
        params.append(
            (
                "ProfileOwnerType",
                capo_wellarchitected.types.profile_owner_type.serialize_json(
                    input_["profile_owner_type"]
                ),
            )
        )
...
def list_profiles(
    ...
    capo_wellarchitected.types.list_profiles_output.ListProfilesOutput, zapros.Response
]:
