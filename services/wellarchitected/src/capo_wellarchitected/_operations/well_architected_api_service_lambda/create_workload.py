...
def handle_response(
    ...
    out: capo_wellarchitected.types.create_workload_output.CreateWorkloadOutput = (
        capo_wellarchitected.types.create_workload_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.create_workload_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
