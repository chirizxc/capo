...
def handle_response(
    ...
    out: capo_wellarchitected.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{WorkloadArn}", quote(input_["workload_arn"], safe=""))
