"""Generated from Smithy shape ``com.amazonaws.wellarchitected#ListAnswers``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_answers_output.ListAnswersOutput = (
        capo_wellarchitected.types.list_answers_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{WorkloadId}", quote(input_["workload_id"], safe=""))
    url = url.replace("{LensAlias}", quote(input_["lens_alias"], safe=""))
    params: list[tuple[str, str]] = []
    if "pillar_id" in input_:
        params.append(("PillarId", input_["pillar_id"]))
    if "milestone_number" in input_:
        params.append(("MilestoneNumber", str(input_["milestone_number"])))
    ...
    if "question_priority" in input_:
        params.append(
            (
                "QuestionPriority",
                capo_wellarchitected.types.question_priority.serialize_json(
                    input_["question_priority"]
                ),
            )
        )
...
def list_answers(
    ...
    capo_wellarchitected.types.list_answers_output.ListAnswersOutput, zapros.Response
]:
