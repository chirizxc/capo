...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_template_shares_output.ListTemplateSharesOutput = capo_wellarchitected.types.list_template_shares_output.deserialize_json(
...
def build_request(
    ...
    if "shared_with_prefix" in input_:
        params.append(("SharedWithPrefix", input_["shared_with_prefix"]))
    ...
    if "status" in input_:
        params.append(
            (
                "Status",
                capo_wellarchitected.types.share_status.serialize_json(
                    input_["status"]
                ),
            )
        )
