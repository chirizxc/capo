...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_lens_review_report_output.GetLensReviewReportOutput = capo_wellarchitected.types.get_lens_review_report_output.deserialize_json(
