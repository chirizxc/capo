...
def handle_response(
    ...
    out: capo_wellarchitected.types.create_milestone_output.CreateMilestoneOutput = (
        capo_wellarchitected.types.create_milestone_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.create_milestone_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
