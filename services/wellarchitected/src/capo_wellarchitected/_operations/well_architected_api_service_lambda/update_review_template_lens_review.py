...
def handle_response(
    ...
    out: capo_wellarchitected.types.update_review_template_lens_review_output.UpdateReviewTemplateLensReviewOutput = capo_wellarchitected.types.update_review_template_lens_review_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.update_review_template_lens_review_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
