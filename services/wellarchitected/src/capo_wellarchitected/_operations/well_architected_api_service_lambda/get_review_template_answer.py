...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_review_template_answer_output.GetReviewTemplateAnswerOutput = capo_wellarchitected.types.get_review_template_answer_output.deserialize_json(
