...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_milestone_output.GetMilestoneOutput = (
        capo_wellarchitected.types.get_milestone_output.deserialize_json(
...
def get_milestone(
    ...
    capo_wellarchitected.types.get_milestone_output.GetMilestoneOutput, zapros.Response
]:
