"""Generated from Smithy shape ``com.amazonaws.wellarchitected#GetReviewTemplateLensReview``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_review_template_lens_review_output.GetReviewTemplateLensReviewOutput = capo_wellarchitected.types.get_review_template_lens_review_output.deserialize_json(
...
async def async_get_review_template_lens_review(
