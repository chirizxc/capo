"""Generated from Smithy shape ``com.amazonaws.wellarchitected#DeleteReviewTemplate``."""
...
def build_request(
    ...
    if "client_request_token" in input_:
        params.append(("ClientRequestToken", input_["client_request_token"]))
...
async def async_delete_review_template(
