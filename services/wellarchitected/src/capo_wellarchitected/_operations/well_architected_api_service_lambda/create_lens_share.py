...
def handle_response(
    ...
    out: capo_wellarchitected.types.create_lens_share_output.CreateLensShareOutput = (
        capo_wellarchitected.types.create_lens_share_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.create_lens_share_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
