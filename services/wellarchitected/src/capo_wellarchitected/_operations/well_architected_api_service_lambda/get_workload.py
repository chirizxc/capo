...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_workload_output.GetWorkloadOutput = (
        capo_wellarchitected.types.get_workload_output.deserialize_json(
...
def get_workload(
    ...
    capo_wellarchitected.types.get_workload_output.GetWorkloadOutput, zapros.Response
]:
