"""Generated from Smithy shape ``com.amazonaws.wellarchitected#UpdateProfile``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.update_profile_output.UpdateProfileOutput = (
        capo_wellarchitected.types.update_profile_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.update_profile_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
