"""Generated from Smithy shape ``com.amazonaws.wellarchitected#CreateTemplateShare``."""
...
def handle_response(
    ...
    out: capo_wellarchitected.types.create_template_share_output.CreateTemplateShareOutput = capo_wellarchitected.types.create_template_share_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wellarchitected.types.create_template_share_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_template_share(
