...
def build_request(
    ...
    if "workload_name_prefix" in input_:
        params.append(("WorkloadNamePrefix", input_["workload_name_prefix"]))
    if "lens_name_prefix" in input_:
        params.append(("LensNamePrefix", input_["lens_name_prefix"]))
    if "share_resource_type" in input_:
        params.append(
            (
                "ShareResourceType",
                capo_wellarchitected.types.share_resource_type.serialize_json(
                    input_["share_resource_type"]
                ),
            )
        )
    ...
    if "template_name_prefix" in input_:
        params.append(("TemplateNamePrefix", input_["template_name_prefix"]))
