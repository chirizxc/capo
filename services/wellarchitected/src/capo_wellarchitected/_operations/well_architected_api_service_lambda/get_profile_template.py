...
def handle_response(
    ...
    out: capo_wellarchitected.types.get_profile_template_output.GetProfileTemplateOutput = capo_wellarchitected.types.get_profile_template_output.deserialize_json(
