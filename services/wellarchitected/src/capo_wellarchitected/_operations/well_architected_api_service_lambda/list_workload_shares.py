...
def handle_response(
    ...
    out: capo_wellarchitected.types.list_workload_shares_output.ListWorkloadSharesOutput = capo_wellarchitected.types.list_workload_shares_output.deserialize_json(
