...
if TYPE_CHECKING:
    ...
    import capo_wellarchitected.types.profile_template_question_choices
...
class ProfileTemplateQuestion(TypedDict, closed=True):
    ...
    question_choices: NotRequired[
        "capo_wellarchitected.types.profile_template_question_choices.ProfileTemplateQuestionChoices"
    ]
...
def serialize_json(value: ProfileTemplateQuestion) -> dict:
    ...
    if "question_choices" in value:
        ...
        out["QuestionChoices"] = (
            capo_wellarchitected.types.profile_template_question_choices.serialize_json(
...
def deserialize_json(data: dict) -> ProfileTemplateQuestion:
    ...
    if data.get("QuestionChoices") is not None:
        ...
        out["question_choices"] = (
            capo_wellarchitected.types.profile_template_question_choices.deserialize_json(
