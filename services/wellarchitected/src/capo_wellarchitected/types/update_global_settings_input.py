...
def serialize_json(value: UpdateGlobalSettingsInput) -> dict:
    ...
    if "jira_configuration" in value:
        ...
        out["JiraConfiguration"] = (
            capo_wellarchitected.types.account_jira_configuration_input.serialize_json(
...
def deserialize_json(data: dict) -> UpdateGlobalSettingsInput:
    ...
    if data.get("JiraConfiguration") is not None:
        ...
        out["jira_configuration"] = (
            capo_wellarchitected.types.account_jira_configuration_input.deserialize_json(
