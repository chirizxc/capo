"""Generated from Smithy shape ``com.amazonaws.directconnect#UpdateVirtualInterfaceAttributes``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.virtual_interface.VirtualInterface = (
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.update_virtual_interface_attributes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def update_virtual_interface_attributes(
    ...
    capo_direct_connect.types.virtual_interface.VirtualInterface, zapros.Response
]:
...
async def async_update_virtual_interface_attributes(
