...
def handle_response(
    ...
    out: capo_direct_connect.types.confirm_public_virtual_interface_response.ConfirmPublicVirtualInterfaceResponse = capo_direct_connect.types.confirm_public_virtual_interface_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.confirm_public_virtual_interface_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
