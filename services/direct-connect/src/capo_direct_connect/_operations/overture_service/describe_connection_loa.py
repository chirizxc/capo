"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeConnectionLoa``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.describe_connection_loa_response.DescribeConnectionLoaResponse = capo_direct_connect.types.describe_connection_loa_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_connection_loa_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_connection_loa(
