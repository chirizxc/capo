"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeInterconnectLoa``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.describe_interconnect_loa_response.DescribeInterconnectLoaResponse = capo_direct_connect.types.describe_interconnect_loa_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_interconnect_loa_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_interconnect_loa(
