"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeVirtualInterfaces``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.virtual_interfaces.VirtualInterfaces = (
        capo_direct_connect.types.virtual_interfaces.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_virtual_interfaces_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def describe_virtual_interfaces(
    ...
    capo_direct_connect.types.virtual_interfaces.VirtualInterfaces, zapros.Response
]:
...
async def async_describe_virtual_interfaces(
