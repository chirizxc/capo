...
def handle_response(
    ...
    out: capo_direct_connect.types.confirm_customer_agreement_response.ConfirmCustomerAgreementResponse = capo_direct_connect.types.confirm_customer_agreement_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.confirm_customer_agreement_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
