"""Generated from Smithy shape ``com.amazonaws.directconnect#DisassociateMacSecKey``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.disassociate_mac_sec_key_response.DisassociateMacSecKeyResponse = capo_direct_connect.types.disassociate_mac_sec_key_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OvertureService.DisassociateMacSecKey"
    body: bytes | None = json.dumps(
        capo_direct_connect.types.disassociate_mac_sec_key_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_mac_sec_key(
