"""Generated from Smithy shape ``com.amazonaws.directconnect#CreateInterconnect``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.interconnect.Interconnect = (
        capo_direct_connect.types.interconnect.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.create_interconnect_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def create_interconnect(
    ...
    input_: capo_direct_connect.types.create_interconnect_request.CreateInterconnectRequest,
) -> tuple[capo_direct_connect.types.interconnect.Interconnect, zapros.Response]:
...
async def async_create_interconnect(
