"""Generated from Smithy shape ``com.amazonaws.directconnect#CreatePrivateVirtualInterface``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.create_private_virtual_interface_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_private_virtual_interface(
