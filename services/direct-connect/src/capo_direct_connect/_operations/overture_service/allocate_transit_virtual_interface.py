...
def handle_response(
    ...
    out: capo_direct_connect.types.allocate_transit_virtual_interface_result.AllocateTransitVirtualInterfaceResult = capo_direct_connect.types.allocate_transit_virtual_interface_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.allocate_transit_virtual_interface_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
