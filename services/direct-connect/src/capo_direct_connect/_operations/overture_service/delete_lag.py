"""Generated from Smithy shape ``com.amazonaws.directconnect#DeleteLag``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.delete_lag_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
