"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeConnectionsOnInterconnect``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_connections_on_interconnect_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_connections_on_interconnect(
