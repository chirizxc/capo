"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeInterconnects``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.interconnects.Interconnects = (
        capo_direct_connect.types.interconnects.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_interconnects_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def describe_interconnects(
    ...
    input_: capo_direct_connect.types.describe_interconnects_request.DescribeInterconnectsRequest,
) -> tuple[capo_direct_connect.types.interconnects.Interconnects, zapros.Response]:
...
async def async_describe_interconnects(
