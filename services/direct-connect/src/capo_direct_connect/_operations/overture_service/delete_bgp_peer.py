"""Generated from Smithy shape ``com.amazonaws.directconnect#DeleteBGPPeer``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.delete_bgp_peer_response.DeleteBGPPeerResponse = (
        capo_direct_connect.types.delete_bgp_peer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.delete_bgp_peer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_bgp_peer(
