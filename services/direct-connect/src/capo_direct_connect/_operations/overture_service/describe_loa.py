"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeLoa``."""
...
def handle_response(response: zapros.Response) -> capo_direct_connect.types.loa.Loa:
    out: capo_direct_connect.types.loa.Loa = (
        capo_direct_connect.types.loa.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_loa_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_loa(
    ...
    input_: capo_direct_connect.types.describe_loa_request.DescribeLoaRequest,
) -> tuple[capo_direct_connect.types.loa.Loa, zapros.Response]:
