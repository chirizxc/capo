"""Generated from Smithy shape ``com.amazonaws.directconnect#ListVirtualInterfaceTestHistory``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.list_virtual_interface_test_history_response.ListVirtualInterfaceTestHistoryResponse = capo_direct_connect.types.list_virtual_interface_test_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OvertureService.ListVirtualInterfaceTestHistory"
    body: bytes | None = json.dumps(
        capo_direct_connect.types.list_virtual_interface_test_history_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_virtual_interface_test_history(
