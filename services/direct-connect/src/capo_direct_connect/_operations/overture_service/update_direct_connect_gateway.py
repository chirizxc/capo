...
def handle_response(
    ...
    out: capo_direct_connect.types.update_direct_connect_gateway_response.UpdateDirectConnectGatewayResponse = capo_direct_connect.types.update_direct_connect_gateway_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.update_direct_connect_gateway_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
