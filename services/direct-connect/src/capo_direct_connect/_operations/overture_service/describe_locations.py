"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeLocations``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.locations.Locations = (
        capo_direct_connect.types.locations.deserialize_aws_json_1_1(
...
) -> tuple[capo_direct_connect.types.locations.Locations, zapros.Response]:
...
async def async_describe_locations(
