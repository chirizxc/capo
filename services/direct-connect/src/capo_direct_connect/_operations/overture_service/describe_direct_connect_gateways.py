"""Generated from Smithy shape ``com.amazonaws.directconnect#DescribeDirectConnectGateways``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.describe_direct_connect_gateways_result.DescribeDirectConnectGatewaysResult = capo_direct_connect.types.describe_direct_connect_gateways_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.describe_direct_connect_gateways_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_direct_connect_gateways(
