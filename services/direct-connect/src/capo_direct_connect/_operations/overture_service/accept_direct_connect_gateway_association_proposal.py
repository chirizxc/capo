"""Generated from Smithy shape ``com.amazonaws.directconnect#AcceptDirectConnectGatewayAssociationProposal``."""
...
def handle_response(
    ...
    out: capo_direct_connect.types.accept_direct_connect_gateway_association_proposal_result.AcceptDirectConnectGatewayAssociationProposalResult = capo_direct_connect.types.accept_direct_connect_gateway_association_proposal_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_direct_connect.types.accept_direct_connect_gateway_association_proposal_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_accept_direct_connect_gateway_association_proposal(
