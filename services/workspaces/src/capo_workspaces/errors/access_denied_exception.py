"""Generated from Smithy shape ``com.amazonaws.workspaces#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.workspaces#AccessDeniedException``."""
