"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeImport``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_import_response.DescribeImportResponse = (
        capo_lex_models_v2.types.describe_import_response.deserialize_json(
