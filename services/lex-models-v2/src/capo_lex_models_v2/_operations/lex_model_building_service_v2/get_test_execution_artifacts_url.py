...
def handle_response(
    ...
    out: capo_lex_models_v2.types.get_test_execution_artifacts_url_response.GetTestExecutionArtifactsUrlResponse = capo_lex_models_v2.types.get_test_execution_artifacts_url_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{testExecutionId}", quote(input_["test_execution_id"], safe=""))
