"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListIntents``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_intents_response.ListIntentsResponse = (
        capo_lex_models_v2.types.list_intents_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_intents_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_intents(
    ...
    capo_lex_models_v2.types.list_intents_response.ListIntentsResponse, zapros.Response
]:
