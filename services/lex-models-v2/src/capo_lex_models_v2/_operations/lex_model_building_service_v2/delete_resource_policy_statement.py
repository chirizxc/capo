...
def handle_response(
    ...
    out: capo_lex_models_v2.types.delete_resource_policy_statement_response.DeleteResourcePolicyStatementResponse = capo_lex_models_v2.types.delete_resource_policy_statement_response.deserialize_json(
...
def build_request(
    ...
    if "expected_revision_id" in input_:
        params.append(("expectedRevisionId", input_["expected_revision_id"]))
