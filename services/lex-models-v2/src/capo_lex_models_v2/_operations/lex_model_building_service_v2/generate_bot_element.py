...
def handle_response(
    ...
    out: capo_lex_models_v2.types.generate_bot_element_response.GenerateBotElementResponse = capo_lex_models_v2.types.generate_bot_element_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.generate_bot_element_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
