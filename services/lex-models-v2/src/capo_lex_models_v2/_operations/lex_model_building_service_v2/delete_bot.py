"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DeleteBot``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.delete_bot_response.DeleteBotResponse = (
        capo_lex_models_v2.types.delete_bot_response.deserialize_json(
...
def delete_bot(
    ...
    capo_lex_models_v2.types.delete_bot_response.DeleteBotResponse, zapros.Response
]:
