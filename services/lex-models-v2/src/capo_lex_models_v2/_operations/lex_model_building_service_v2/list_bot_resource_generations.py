...
import capo_lex_models_v2.types.generation_summary_list
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_bot_resource_generations_response.ListBotResourceGenerationsResponse = capo_lex_models_v2.types.list_bot_resource_generations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_bot_resource_generations_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
