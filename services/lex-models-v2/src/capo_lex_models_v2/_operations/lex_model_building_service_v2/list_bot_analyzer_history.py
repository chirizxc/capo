...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_bot_analyzer_history_response.ListBotAnalyzerHistoryResponse = capo_lex_models_v2.types.list_bot_analyzer_history_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_bot_analyzer_history_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
