...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_test_set_generation_response.DescribeTestSetGenerationResponse = capo_lex_models_v2.types.describe_test_set_generation_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{testSetGenerationId}", quote(input_["test_set_generation_id"], safe="")
    )
