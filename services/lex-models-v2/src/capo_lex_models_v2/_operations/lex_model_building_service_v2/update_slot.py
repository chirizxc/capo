...
def handle_response(
    ...
    out: capo_lex_models_v2.types.update_slot_response.UpdateSlotResponse = (
        capo_lex_models_v2.types.update_slot_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{slotId}", quote(input_["slot_id"], safe=""))
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.update_slot_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_slot(
    ...
    capo_lex_models_v2.types.update_slot_response.UpdateSlotResponse, zapros.Response
]:
