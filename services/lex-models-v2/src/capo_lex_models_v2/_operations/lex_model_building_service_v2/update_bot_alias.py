"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#UpdateBotAlias``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.update_bot_alias_response.UpdateBotAliasResponse = (
        capo_lex_models_v2.types.update_bot_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.update_bot_alias_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_bot_alias(
