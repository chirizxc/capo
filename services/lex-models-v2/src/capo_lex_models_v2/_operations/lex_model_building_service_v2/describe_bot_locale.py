...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_bot_locale_response.DescribeBotLocaleResponse = capo_lex_models_v2.types.describe_bot_locale_response.deserialize_json(
