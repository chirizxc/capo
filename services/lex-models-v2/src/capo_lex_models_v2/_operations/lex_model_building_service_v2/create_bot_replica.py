...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_bot_replica_response.CreateBotReplicaResponse = capo_lex_models_v2.types.create_bot_replica_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_bot_replica_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
