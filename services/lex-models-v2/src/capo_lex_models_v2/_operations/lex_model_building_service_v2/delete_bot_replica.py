...
def handle_response(
    ...
    out: capo_lex_models_v2.types.delete_bot_replica_response.DeleteBotReplicaResponse = capo_lex_models_v2.types.delete_bot_replica_response.deserialize_json(
