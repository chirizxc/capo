"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeBot``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_bot_response.DescribeBotResponse = (
        capo_lex_models_v2.types.describe_bot_response.deserialize_json(
...
def describe_bot(
    ...
    capo_lex_models_v2.types.describe_bot_response.DescribeBotResponse, zapros.Response
]:
