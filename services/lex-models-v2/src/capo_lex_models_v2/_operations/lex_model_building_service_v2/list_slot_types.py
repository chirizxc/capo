"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListSlotTypes``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_slot_types_response.ListSlotTypesResponse = (
        capo_lex_models_v2.types.list_slot_types_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_slot_types_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_slot_types(
