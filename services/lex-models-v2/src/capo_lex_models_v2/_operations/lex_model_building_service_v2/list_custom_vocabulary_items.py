"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListCustomVocabularyItems``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_custom_vocabulary_items_response.ListCustomVocabularyItemsResponse = capo_lex_models_v2.types.list_custom_vocabulary_items_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_custom_vocabulary_items_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_custom_vocabulary_items(
