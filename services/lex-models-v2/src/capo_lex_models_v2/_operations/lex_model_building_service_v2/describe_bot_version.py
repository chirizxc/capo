...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_bot_version_response.DescribeBotVersionResponse = capo_lex_models_v2.types.describe_bot_version_response.deserialize_json(
