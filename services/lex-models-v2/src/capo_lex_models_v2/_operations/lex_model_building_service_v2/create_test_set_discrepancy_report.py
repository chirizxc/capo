...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_test_set_discrepancy_report_response.CreateTestSetDiscrepancyReportResponse = capo_lex_models_v2.types.create_test_set_discrepancy_report_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_test_set_discrepancy_report_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
