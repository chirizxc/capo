...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_test_set_discrepancy_report_response.DescribeTestSetDiscrepancyReportResponse = capo_lex_models_v2.types.describe_test_set_discrepancy_report_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["test_set_discrepancy_report_id"], safe=""),
    )
