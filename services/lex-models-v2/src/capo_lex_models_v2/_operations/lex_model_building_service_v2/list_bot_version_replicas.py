...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_bot_version_replicas_response.ListBotVersionReplicasResponse = capo_lex_models_v2.types.list_bot_version_replicas_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_bot_version_replicas_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
