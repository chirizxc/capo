...
def handle_response(
    ...
    out: capo_lex_models_v2.types.update_intent_response.UpdateIntentResponse = (
        capo_lex_models_v2.types.update_intent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.update_intent_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
