...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_bots_response.ListBotsResponse = (
        capo_lex_models_v2.types.list_bots_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_bots_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_bots(
    ...
    capo_lex_models_v2.types.list_bots_response.ListBotsResponse, zapros.Response
]:
