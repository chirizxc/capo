...
def handle_response(
    ...
    out: capo_lex_models_v2.types.start_import_response.StartImportResponse = (
        capo_lex_models_v2.types.start_import_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.start_import_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def start_import(
    ...
    capo_lex_models_v2.types.start_import_response.StartImportResponse, zapros.Response
]:
