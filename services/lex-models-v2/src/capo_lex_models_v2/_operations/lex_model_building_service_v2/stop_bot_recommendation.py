...
def handle_response(
    ...
    out: capo_lex_models_v2.types.stop_bot_recommendation_response.StopBotRecommendationResponse = capo_lex_models_v2.types.stop_bot_recommendation_response.deserialize_json(
