"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#StopBotAnalyzer``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.stop_bot_analyzer_response.StopBotAnalyzerResponse = (
        capo_lex_models_v2.types.stop_bot_analyzer_response.deserialize_json(
...
async def async_stop_bot_analyzer(
