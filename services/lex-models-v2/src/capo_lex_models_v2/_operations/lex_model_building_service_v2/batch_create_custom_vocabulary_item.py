...
def handle_response(
    ...
    out: capo_lex_models_v2.types.batch_create_custom_vocabulary_item_response.BatchCreateCustomVocabularyItemResponse = capo_lex_models_v2.types.batch_create_custom_vocabulary_item_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.batch_create_custom_vocabulary_item_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
