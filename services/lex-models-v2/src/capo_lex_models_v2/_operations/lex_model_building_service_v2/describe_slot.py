"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#DescribeSlot``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.describe_slot_response.DescribeSlotResponse = (
        capo_lex_models_v2.types.describe_slot_response.deserialize_json(
