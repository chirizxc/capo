...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_recommended_intents_response.ListRecommendedIntentsResponse = capo_lex_models_v2.types.list_recommended_intents_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_recommended_intents_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
