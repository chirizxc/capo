...
def handle_response(
    ...
    out: capo_lex_models_v2.types.create_bot_version_response.CreateBotVersionResponse = capo_lex_models_v2.types.create_bot_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.create_bot_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
