"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#ListSlots``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_slots_response.ListSlotsResponse = (
        capo_lex_models_v2.types.list_slots_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_slots_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_slots(
    ...
    capo_lex_models_v2.types.list_slots_response.ListSlotsResponse, zapros.Response
]:
