...
def handle_response(
    ...
    out: capo_lex_models_v2.types.list_bot_recommendations_response.ListBotRecommendationsResponse = capo_lex_models_v2.types.list_bot_recommendations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.list_bot_recommendations_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
