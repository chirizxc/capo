"""Generated from Smithy shape ``com.amazonaws.lexmodelsv2#StartBotResourceGeneration``."""
...
def handle_response(
    ...
    out: capo_lex_models_v2.types.start_bot_resource_generation_response.StartBotResourceGenerationResponse = capo_lex_models_v2.types.start_bot_resource_generation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lex_models_v2.types.start_bot_resource_generation_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_bot_resource_generation(
