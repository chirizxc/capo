...
if TYPE_CHECKING:
    ...
    import capo_lex_models_v2.types.hit_count
    import capo_lex_models_v2.types.missed_count
    import capo_lex_models_v2.types.timestamp
    import capo_lex_models_v2.types.utterance


class AggregatedUtterancesSummary(TypedDict, closed=True):
    utterance: NotRequired["capo_lex_models_v2.types.utterance.Utterance"]
    ...
    hit_count: NotRequired["capo_lex_models_v2.types.hit_count.HitCount"]
    ...
    missed_count: NotRequired["capo_lex_models_v2.types.missed_count.MissedCount"]
