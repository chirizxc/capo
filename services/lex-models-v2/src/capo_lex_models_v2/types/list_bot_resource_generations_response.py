...
class ListBotResourceGenerationsResponse(TypedDict, closed=True):
    ...
    generation_summaries: NotRequired[
        "capo_lex_models_v2.types.generation_summary_list.GenerationSummaryList"
    ]
...
def serialize_json(value: ListBotResourceGenerationsResponse) -> dict:
    ...
    if "generation_summaries" in value:
        ...
        out["generationSummaries"] = (
            capo_lex_models_v2.types.generation_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListBotResourceGenerationsResponse:
    ...
    if data.get("generationSummaries") is not None:
        import capo_lex_models_v2.types.generation_summary_list

        out["generation_summaries"] = (
            capo_lex_models_v2.types.generation_summary_list.deserialize_json(
