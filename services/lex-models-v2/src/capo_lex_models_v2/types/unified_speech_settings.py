...
class UnifiedSpeechSettings(TypedDict, closed=True):
    speech_foundation_model: (
        "capo_lex_models_v2.types.speech_foundation_model.SpeechFoundationModel"
    )
...
def serialize_json(value: UnifiedSpeechSettings) -> dict:
    ...
    out["speechFoundationModel"] = (
        capo_lex_models_v2.types.speech_foundation_model.serialize_json(
...
def deserialize_json(data: dict) -> UnifiedSpeechSettings:
    ...
    if data.get("speechFoundationModel") is not None:
        ...
        out["speech_foundation_model"] = (
            capo_lex_models_v2.types.speech_foundation_model.deserialize_json(
