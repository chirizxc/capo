...
def serialize_json(value: BatchCreateCustomVocabularyItemRequest) -> dict:
    ...
    out["customVocabularyItemList"] = (
        capo_lex_models_v2.types.create_custom_vocabulary_items_list.serialize_json(
...
def deserialize_json(data: dict) -> BatchCreateCustomVocabularyItemRequest:
    ...
    if data.get("customVocabularyItemList") is not None:
        ...
        out["custom_vocabulary_item_list"] = (
            capo_lex_models_v2.types.create_custom_vocabulary_items_list.deserialize_json(
