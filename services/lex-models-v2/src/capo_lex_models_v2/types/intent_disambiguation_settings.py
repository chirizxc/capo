...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.custom_disambiguation_message
    import capo_lex_models_v2.types.enabled
    import capo_lex_models_v2.types.max_disambiguation_intents
...
class IntentDisambiguationSettings(TypedDict, closed=True):
    ...
    max_disambiguation_intents: NotRequired[
        "capo_lex_models_v2.types.max_disambiguation_intents.MaxDisambiguationIntents"
    ]
    ...
    custom_disambiguation_message: NotRequired[
        "capo_lex_models_v2.types.custom_disambiguation_message.CustomDisambiguationMessage"
    ]
