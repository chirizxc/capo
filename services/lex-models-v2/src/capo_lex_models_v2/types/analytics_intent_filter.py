...
if TYPE_CHECKING:
    ...
    import capo_lex_models_v2.types.analytics_intent_filter_name


class AnalyticsIntentFilter(TypedDict, closed=True):
    name: "capo_lex_models_v2.types.analytics_intent_filter_name.AnalyticsIntentFilterName"
...
def serialize_json(value: AnalyticsIntentFilter) -> dict:
    ...
    out["name"] = capo_lex_models_v2.types.analytics_intent_filter_name.serialize_json(
        value["name"]
    )
    import capo_lex_models_v2.types.analytics_filter_operator
...
def deserialize_json(data: dict) -> AnalyticsIntentFilter:
    ...
    if data.get("name") is not None:
        ...
        out["name"] = (
            capo_lex_models_v2.types.analytics_intent_filter_name.deserialize_json(
                data["name"]
            )
        )
    else:
