...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.analytics_intent_result

AnalyticsIntentResults: TypeAlias = list[
    "capo_lex_models_v2.types.analytics_intent_result.AnalyticsIntentResult"
]
...
def serialize_json(value: AnalyticsIntentResults) -> list:
    ...
    for item in value:
        out.append(
            capo_lex_models_v2.types.analytics_intent_result.serialize_json(item)
        )
    return out
