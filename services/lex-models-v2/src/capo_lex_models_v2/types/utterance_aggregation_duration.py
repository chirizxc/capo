...
class UtteranceAggregationDuration(TypedDict, closed=True):
    relative_aggregation_duration: "capo_lex_models_v2.types.relative_aggregation_duration.RelativeAggregationDuration"
...
def serialize_json(value: UtteranceAggregationDuration) -> dict:
    ...
    out["relativeAggregationDuration"] = (
        capo_lex_models_v2.types.relative_aggregation_duration.serialize_json(
...
def deserialize_json(data: dict) -> UtteranceAggregationDuration:
    ...
    if data.get("relativeAggregationDuration") is not None:
        ...
        out["relative_aggregation_duration"] = (
            capo_lex_models_v2.types.relative_aggregation_duration.deserialize_json(
