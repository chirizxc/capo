...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.intent_level_slot_resolution_test_result_item

IntentLevelSlotResolutionTestResultItemList: TypeAlias = list[
    "capo_lex_models_v2.types.intent_level_slot_resolution_test_result_item.IntentLevelSlotResolutionTestResultItem"
]
...
def serialize_json(value: IntentLevelSlotResolutionTestResultItemList) -> list:
    ...
    for item in value:
        out.append(
            capo_lex_models_v2.types.intent_level_slot_resolution_test_result_item.serialize_json(
                item
            )
        )
    return out
