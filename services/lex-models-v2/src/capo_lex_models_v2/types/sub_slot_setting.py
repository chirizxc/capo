...
if TYPE_CHECKING:
    import capo_lex_models_v2.types.sub_slot_expression
...
class SubSlotSetting(TypedDict, closed=True):
    expression: NotRequired[
        "capo_lex_models_v2.types.sub_slot_expression.SubSlotExpression"
    ]
    ...
    slot_specifications: NotRequired[
        "capo_lex_models_v2.types.sub_slot_specification_map.SubSlotSpecificationMap"
    ]
...
def serialize_json(value: SubSlotSetting) -> dict:
    ...
    if "slot_specifications" in value:
        ...
        out["slotSpecifications"] = (
            capo_lex_models_v2.types.sub_slot_specification_map.serialize_json(
...
def deserialize_json(data: dict) -> SubSlotSetting:
    ...
    if data.get("slotSpecifications") is not None:
        ...
        out["slot_specifications"] = (
            capo_lex_models_v2.types.sub_slot_specification_map.deserialize_json(
