...
class ListSlotsResponse(TypedDict, closed=True):
    ...
    slot_summaries: NotRequired[
        "capo_lex_models_v2.types.slot_summary_list.SlotSummaryList"
    ]
...
def serialize_json(value: ListSlotsResponse) -> dict:
    ...
    if "slot_summaries" in value:
        ...
        out["slotSummaries"] = (
            capo_lex_models_v2.types.slot_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListSlotsResponse:
    ...
    if data.get("slotSummaries") is not None:
        ...
        out["slot_summaries"] = (
            capo_lex_models_v2.types.slot_summary_list.deserialize_json(
                data["slotSummaries"]
            )
        )
