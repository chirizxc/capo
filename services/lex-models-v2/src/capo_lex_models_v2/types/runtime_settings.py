...
class RuntimeSettings(TypedDict, closed=True):
    slot_resolution_improvement: NotRequired[
        "capo_lex_models_v2.types.slot_resolution_improvement_specification.SlotResolutionImprovementSpecification"
    ]
    """<p>An object containing specifications for the assisted slot resolution feature.</p>"""
    nlu_improvement: NotRequired[
        "capo_lex_models_v2.types.nlu_improvement_specification.NluImprovementSpecification"
    ]
...
def serialize_json(value: RuntimeSettings) -> dict:
    ...
    if "slot_resolution_improvement" in value:
        ...
        out["slotResolutionImprovement"] = (
            capo_lex_models_v2.types.slot_resolution_improvement_specification.serialize_json(
    ...
    if "nlu_improvement" in value:
        ...
        out["nluImprovement"] = (
            capo_lex_models_v2.types.nlu_improvement_specification.serialize_json(
...
def deserialize_json(data: dict) -> RuntimeSettings:
    ...
    if data.get("slotResolutionImprovement") is not None:
        ...
        out["slot_resolution_improvement"] = (
            capo_lex_models_v2.types.slot_resolution_improvement_specification.deserialize_json(
    ...
    if data.get("nluImprovement") is not None:
        ...
        out["nlu_improvement"] = (
            capo_lex_models_v2.types.nlu_improvement_specification.deserialize_json(
                data["nluImprovement"]
            )
        )
    return out
