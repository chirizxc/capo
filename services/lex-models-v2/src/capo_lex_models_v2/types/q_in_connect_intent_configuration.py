...
class QInConnectIntentConfiguration(TypedDict, closed=True):
    q_in_connect_assistant_configuration: NotRequired[
        "capo_lex_models_v2.types.q_in_connect_assistant_configuration.QInConnectAssistantConfiguration"
    ]
...
def serialize_json(value: QInConnectIntentConfiguration) -> dict:
    ...
    if "q_in_connect_assistant_configuration" in value:
        ...
        out["qInConnectAssistantConfiguration"] = (
            capo_lex_models_v2.types.q_in_connect_assistant_configuration.serialize_json(
...
def deserialize_json(data: dict) -> QInConnectIntentConfiguration:
    ...
    if data.get("qInConnectAssistantConfiguration") is not None:
        ...
        out["q_in_connect_assistant_configuration"] = (
            capo_lex_models_v2.types.q_in_connect_assistant_configuration.deserialize_json(
