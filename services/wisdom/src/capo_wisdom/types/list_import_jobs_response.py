...
if TYPE_CHECKING:
    import capo_wisdom.types.import_job_list
    import capo_wisdom.types.non_empty_string


class ListImportJobsResponse(TypedDict, closed=True):
    import_job_summaries: "capo_wisdom.types.import_job_list.ImportJobList"
...
def serialize_json(value: ListImportJobsResponse) -> dict:
    ...
    out["importJobSummaries"] = capo_wisdom.types.import_job_list.serialize_json(
...
def deserialize_json(data: dict) -> ListImportJobsResponse:
    ...
    if data.get("importJobSummaries") is not None:
        import capo_wisdom.types.import_job_list

        out["import_job_summaries"] = (
            capo_wisdom.types.import_job_list.deserialize_json(
