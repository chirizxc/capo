...
if TYPE_CHECKING:
    ...
    import capo_wisdom.types.quick_response_filter_operator
    import capo_wisdom.types.quick_response_filter_value_list
...
class QuickResponseFilterField(TypedDict, closed=True):
    ...
    values: NotRequired[
        "capo_wisdom.types.quick_response_filter_value_list.QuickResponseFilterValueList"
    ]
    """<p>The values of attribute field to filter the quick response by.</p>"""
    operator: (
        "capo_wisdom.types.quick_response_filter_operator.QuickResponseFilterOperator"
    )
...
def serialize_json(value: QuickResponseFilterField) -> dict:
    ...
    if "values" in value:
        ...
        out["values"] = (
            capo_wisdom.types.quick_response_filter_value_list.serialize_json(
                value["values"]
            )
        )
...
def deserialize_json(data: dict) -> QuickResponseFilterField:
    ...
    if data.get("values") is not None:
        ...
        out["values"] = (
            capo_wisdom.types.quick_response_filter_value_list.deserialize_json(
                data["values"]
            )
        )
