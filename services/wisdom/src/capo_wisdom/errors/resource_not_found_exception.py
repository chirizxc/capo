"""Generated from Smithy shape ``com.amazonaws.wisdom#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.wisdom#ResourceNotFoundException``."""
