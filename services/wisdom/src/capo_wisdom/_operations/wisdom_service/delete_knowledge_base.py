"""Generated from Smithy shape ``com.amazonaws.wisdom#DeleteKnowledgeBase``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.delete_knowledge_base_response.DeleteKnowledgeBaseResponse = {}  # type: ignore[typeddict-item]
    return out
