...
def handle_response(
    ...
    out: capo_wisdom.types.create_knowledge_base_response.CreateKnowledgeBaseResponse = capo_wisdom.types.create_knowledge_base_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.create_knowledge_base_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
