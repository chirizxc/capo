...
def handle_response(
    ...
    out: capo_wisdom.types.start_import_job_response.StartImportJobResponse = (
        capo_wisdom.types.start_import_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.start_import_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def start_import_job(
    ...
    capo_wisdom.types.start_import_job_response.StartImportJobResponse, zapros.Response
]:
