...
def handle_response(
    ...
    out: capo_wisdom.types.list_import_jobs_response.ListImportJobsResponse = (
        capo_wisdom.types.list_import_jobs_response.deserialize_json(
...
def list_import_jobs(
    ...
    capo_wisdom.types.list_import_jobs_response.ListImportJobsResponse, zapros.Response
]:
