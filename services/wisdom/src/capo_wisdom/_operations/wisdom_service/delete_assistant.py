...
def handle_response(
    ...
    out: capo_wisdom.types.delete_assistant_response.DeleteAssistantResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_assistant(
    ...
    capo_wisdom.types.delete_assistant_response.DeleteAssistantResponse, zapros.Response
]:
