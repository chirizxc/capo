"""Generated from Smithy shape ``com.amazonaws.wisdom#GetKnowledgeBase``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.get_knowledge_base_response.GetKnowledgeBaseResponse = (
        capo_wisdom.types.get_knowledge_base_response.deserialize_json(
