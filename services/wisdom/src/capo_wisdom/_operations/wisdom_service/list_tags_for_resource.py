"""Generated from Smithy shape ``com.amazonaws.wisdom#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_wisdom.types.list_tags_for_resource_response.deserialize_json(
