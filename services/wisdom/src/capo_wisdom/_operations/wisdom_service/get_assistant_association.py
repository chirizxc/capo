...
def handle_response(
    ...
    out: capo_wisdom.types.get_assistant_association_response.GetAssistantAssociationResponse = capo_wisdom.types.get_assistant_association_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{assistantAssociationId}", quote(input_["assistant_association_id"], safe="")
    )
