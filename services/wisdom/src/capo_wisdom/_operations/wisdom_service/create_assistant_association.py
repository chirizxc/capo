"""Generated from Smithy shape ``com.amazonaws.wisdom#CreateAssistantAssociation``."""
...
def handle_response(
    ...
    out: capo_wisdom.types.create_assistant_association_response.CreateAssistantAssociationResponse = capo_wisdom.types.create_assistant_association_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_wisdom.types.create_assistant_association_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
