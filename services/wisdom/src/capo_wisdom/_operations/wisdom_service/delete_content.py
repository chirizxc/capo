...
def handle_response(
    ...
    out: capo_wisdom.types.delete_content_response.DeleteContentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_content(
    ...
    capo_wisdom.types.delete_content_response.DeleteContentResponse, zapros.Response
]:
