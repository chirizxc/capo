...
def handle_response(
    ...
    out: capo_wisdom.types.get_session_response.GetSessionResponse = (
        capo_wisdom.types.get_session_response.deserialize_json(
...
def get_session(
    ...
    input_: capo_wisdom.types.get_session_request.GetSessionRequest,
) -> tuple[capo_wisdom.types.get_session_response.GetSessionResponse, zapros.Response]:
