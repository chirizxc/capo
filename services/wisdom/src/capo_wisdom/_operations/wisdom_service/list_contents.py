...
def handle_response(
    ...
    out: capo_wisdom.types.list_contents_response.ListContentsResponse = (
        capo_wisdom.types.list_contents_response.deserialize_json(
...
def list_contents(
    ...
    capo_wisdom.types.list_contents_response.ListContentsResponse, zapros.Response
]:
