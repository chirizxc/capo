...
if TYPE_CHECKING:
    ...
    import capo_opensearch.types.number_of_a_zs
...
class DescribeDomainHealthResponse(TypedDict, closed=True):
    domain_state: NotRequired["capo_opensearch.types.domain_state.DomainState"]
    ...
    availability_zone_count: NotRequired[
        "capo_opensearch.types.number_of_a_zs.NumberOfAZs"
    ]
    ...
    data_node_count: NotRequired["capo_opensearch.types.number_of_nodes.NumberOfNodes"]
    ...
    dedicated_master: NotRequired["capo_opensearch.types.boolean.Boolean"]
    ...
    warm_node_count: NotRequired["capo_opensearch.types.number_of_nodes.NumberOfNodes"]
    """<p>The number of warm nodes configured for the domain.</p>"""
    master_node: NotRequired[
        "capo_opensearch.types.master_node_status.MasterNodeStatus"
    ]
    ...
    cluster_health: NotRequired["capo_opensearch.types.domain_health.DomainHealth"]
    ...
    environment_information: NotRequired[
        "capo_opensearch.types.environment_info_list.EnvironmentInfoList"
    ]
...
def serialize_json(value: DescribeDomainHealthResponse) -> dict:
    ...
    if "domain_state" in value:
        ...
        out["DomainState"] = capo_opensearch.types.domain_state.serialize_json(
            value["domain_state"]
        )
    ...
    if "master_node" in value:
        ...
        out["MasterNode"] = capo_opensearch.types.master_node_status.serialize_json(
            value["master_node"]
        )
    if "cluster_health" in value:
        import capo_opensearch.types.domain_health

        out["ClusterHealth"] = capo_opensearch.types.domain_health.serialize_json(
    ...
    if "environment_information" in value:
        ...
        out["EnvironmentInformation"] = (
            capo_opensearch.types.environment_info_list.serialize_json(
...
def deserialize_json(data: dict) -> DescribeDomainHealthResponse:
    ...
    if data.get("EnvironmentInformation") is not None:
        ...
        out["environment_information"] = (
            capo_opensearch.types.environment_info_list.deserialize_json(
