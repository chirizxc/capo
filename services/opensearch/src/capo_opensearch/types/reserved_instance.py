...
class ReservedInstance(TypedDict, closed=True):
    ...
    billing_subscription_id: NotRequired["capo_opensearch.types.long.Long"]
    """<p>The unique identifier of the billing subscription.</p>"""
    reserved_instance_offering_id: NotRequired["capo_opensearch.types.string.String"]
    ...
    instance_count: "capo_opensearch.types.integer.Integer"
    """<p>The number of OpenSearch instances that have been reserved.</p>"""
    state: NotRequired["capo_opensearch.types.string.String"]
