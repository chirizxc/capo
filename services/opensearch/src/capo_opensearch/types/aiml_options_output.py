...
class AIMLOptionsOutput(TypedDict, closed=True):
    natural_language_query_generation_options: NotRequired[
        "capo_opensearch.types.natural_language_query_generation_options_output.NaturalLanguageQueryGenerationOptionsOutput"
    ]
...
def serialize_json(value: AIMLOptionsOutput) -> dict:
    ...
    if "natural_language_query_generation_options" in value:
        ...
        out["NaturalLanguageQueryGenerationOptions"] = (
            capo_opensearch.types.natural_language_query_generation_options_output.serialize_json(
...
def deserialize_json(data: dict) -> AIMLOptionsOutput:
    ...
    if data.get("NaturalLanguageQueryGenerationOptions") is not None:
        ...
        out["natural_language_query_generation_options"] = (
            capo_opensearch.types.natural_language_query_generation_options_output.deserialize_json(
