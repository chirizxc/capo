...
if TYPE_CHECKING:
    import capo_opensearch.types.auto_tune_details
    import capo_opensearch.types.auto_tune_type


class AutoTune(TypedDict, closed=True):
    auto_tune_type: NotRequired["capo_opensearch.types.auto_tune_type.AutoTuneType"]
    """<p>The type of Auto-Tune action.</p>"""
    auto_tune_details: NotRequired[
        "capo_opensearch.types.auto_tune_details.AutoTuneDetails"
    ]
...
def serialize_json(value: AutoTune) -> dict:
    ...
    if "auto_tune_type" in value:
        ...
        out["AutoTuneType"] = capo_opensearch.types.auto_tune_type.serialize_json(
            value["auto_tune_type"]
        )
    if "auto_tune_details" in value:
        import capo_opensearch.types.auto_tune_details

        out["AutoTuneDetails"] = capo_opensearch.types.auto_tune_details.serialize_json(
...
def deserialize_json(data: dict) -> AutoTune:
    ...
    if data.get("AutoTuneType") is not None:
        ...
        out["auto_tune_type"] = capo_opensearch.types.auto_tune_type.deserialize_json(
            data["AutoTuneType"]
        )
    if data.get("AutoTuneDetails") is not None:
        ...
        out["auto_tune_details"] = (
            capo_opensearch.types.auto_tune_details.deserialize_json(
