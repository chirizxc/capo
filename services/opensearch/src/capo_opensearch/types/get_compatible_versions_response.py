...
class GetCompatibleVersionsResponse(TypedDict, closed=True):
    compatible_versions: NotRequired[
        "capo_opensearch.types.compatible_versions_list.CompatibleVersionsList"
    ]
...
def serialize_json(value: GetCompatibleVersionsResponse) -> dict:
    ...
    if "compatible_versions" in value:
        ...
        out["CompatibleVersions"] = (
            capo_opensearch.types.compatible_versions_list.serialize_json(
...
def deserialize_json(data: dict) -> GetCompatibleVersionsResponse:
    ...
    if data.get("CompatibleVersions") is not None:
        ...
        out["compatible_versions"] = (
            capo_opensearch.types.compatible_versions_list.deserialize_json(
