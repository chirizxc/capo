...
if TYPE_CHECKING:
    import capo_opensearch.types.deployment_type
    import capo_opensearch.types.message


class DryRunResults(TypedDict, closed=True):
    deployment_type: NotRequired["capo_opensearch.types.deployment_type.DeploymentType"]
    ...
    message: NotRequired["capo_opensearch.types.message.Message"]
