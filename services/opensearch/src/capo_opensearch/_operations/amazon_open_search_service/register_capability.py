"""Generated from Smithy shape ``com.amazonaws.opensearch#RegisterCapability``."""
...
import capo_opensearch.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ServiceQuotaExceededException":
            raise capo_opensearch.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_opensearch.types.register_capability_response.RegisterCapabilityResponse = capo_opensearch.types.register_capability_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.register_capability_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_register_capability(
