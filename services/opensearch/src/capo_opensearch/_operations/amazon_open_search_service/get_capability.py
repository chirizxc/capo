"""Generated from Smithy shape ``com.amazonaws.opensearch#GetCapability``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.get_capability_response.GetCapabilityResponse = (
        capo_opensearch.types.get_capability_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{capabilityName}", quote(input_["capability_name"], safe=""))
...
def get_capability(
    ...
    capo_opensearch.types.get_capability_response.GetCapabilityResponse, zapros.Response
]:
