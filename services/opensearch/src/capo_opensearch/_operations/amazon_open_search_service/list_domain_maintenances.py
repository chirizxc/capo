"""Generated from Smithy shape ``com.amazonaws.opensearch#ListDomainMaintenances``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.list_domain_maintenances_response.ListDomainMaintenancesResponse = capo_opensearch.types.list_domain_maintenances_response.deserialize_json(
...
def build_request(
    ...
    if "action" in input_:
        params.append(
            (
                "action",
                capo_opensearch.types.maintenance_type.serialize_json(input_["action"]),
            )
        )
    if "status" in input_:
        params.append(
            (
                "status",
                capo_opensearch.types.maintenance_status.serialize_json(
                    input_["status"]
                ),
            )
        )
...
async def async_list_domain_maintenances(
