...
def handle_response(
    ...
    out: capo_opensearch.types.create_index_response.CreateIndexResponse = (
        capo_opensearch.types.create_index_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.create_index_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_index(
    ...
    capo_opensearch.types.create_index_response.CreateIndexResponse, zapros.Response
]:
