...
def handle_response(
    ...
    out: capo_opensearch.types.create_outbound_connection_response.CreateOutboundConnectionResponse = capo_opensearch.types.create_outbound_connection_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.create_outbound_connection_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
