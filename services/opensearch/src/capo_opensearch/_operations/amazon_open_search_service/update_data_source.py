...
def handle_response(
    ...
    out: capo_opensearch.types.update_data_source_response.UpdateDataSourceResponse = (
        capo_opensearch.types.update_data_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.update_data_source_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
