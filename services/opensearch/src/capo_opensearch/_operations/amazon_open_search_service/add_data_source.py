"""Generated from Smithy shape ``com.amazonaws.opensearch#AddDataSource``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.add_data_source_response.AddDataSourceResponse = (
        capo_opensearch.types.add_data_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.add_data_source_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_add_data_source(
