...
def handle_response(
    ...
    out: capo_opensearch.types.list_direct_query_data_sources_response.ListDirectQueryDataSourcesResponse = capo_opensearch.types.list_direct_query_data_sources_response.deserialize_json(
