"""Generated from Smithy shape ``com.amazonaws.opensearch#ListTags``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.list_tags_response.ListTagsResponse = (
        capo_opensearch.types.list_tags_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_opensearch.types.list_tags_request.ListTagsRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def list_tags(
    ...
    input_: capo_opensearch.types.list_tags_request.ListTagsRequest,
) -> tuple[capo_opensearch.types.list_tags_response.ListTagsResponse, zapros.Response]:
