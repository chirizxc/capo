"""Generated from Smithy shape ``com.amazonaws.opensearch#ListVpcEndpointsForDomain``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.list_vpc_endpoints_for_domain_response.ListVpcEndpointsForDomainResponse = capo_opensearch.types.list_vpc_endpoints_for_domain_response.deserialize_json(
