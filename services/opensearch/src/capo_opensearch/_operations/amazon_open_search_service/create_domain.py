...
def handle_response(
    ...
    out: capo_opensearch.types.create_domain_response.CreateDomainResponse = (
        capo_opensearch.types.create_domain_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.create_domain_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_domain(
    ...
    capo_opensearch.types.create_domain_response.CreateDomainResponse, zapros.Response
]:
