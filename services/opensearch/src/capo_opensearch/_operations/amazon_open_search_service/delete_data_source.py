"""Generated from Smithy shape ``com.amazonaws.opensearch#DeleteDataSource``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.delete_data_source_response.DeleteDataSourceResponse = (
        capo_opensearch.types.delete_data_source_response.deserialize_json(
