...
def handle_response(
    ...
    out: capo_opensearch.types.describe_domain_health_response.DescribeDomainHealthResponse = capo_opensearch.types.describe_domain_health_response.deserialize_json(
