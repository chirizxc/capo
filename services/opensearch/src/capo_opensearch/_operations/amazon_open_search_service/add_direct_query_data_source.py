"""Generated from Smithy shape ``com.amazonaws.opensearch#AddDirectQueryDataSource``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.add_direct_query_data_source_response.AddDirectQueryDataSourceResponse = capo_opensearch.types.add_direct_query_data_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.add_direct_query_data_source_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_add_direct_query_data_source(
