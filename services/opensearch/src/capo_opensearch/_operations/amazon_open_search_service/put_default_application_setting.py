...
def handle_response(
    ...
    out: capo_opensearch.types.put_default_application_setting_response.PutDefaultApplicationSettingResponse = capo_opensearch.types.put_default_application_setting_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.put_default_application_setting_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
