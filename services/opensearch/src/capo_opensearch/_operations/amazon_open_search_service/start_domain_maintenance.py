"""Generated from Smithy shape ``com.amazonaws.opensearch#StartDomainMaintenance``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.start_domain_maintenance_response.StartDomainMaintenanceResponse = capo_opensearch.types.start_domain_maintenance_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.start_domain_maintenance_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_domain_maintenance(
