...
import capo_opensearch.errors.slot_not_available_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SlotNotAvailableException":
            raise capo_opensearch.errors.slot_not_available_exception.SlotNotAvailableException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_opensearch.types.update_scheduled_action_response.UpdateScheduledActionResponse = capo_opensearch.types.update_scheduled_action_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.update_scheduled_action_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
