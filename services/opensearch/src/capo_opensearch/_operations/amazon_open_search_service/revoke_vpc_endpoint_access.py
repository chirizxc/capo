"""Generated from Smithy shape ``com.amazonaws.opensearch#RevokeVpcEndpointAccess``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.revoke_vpc_endpoint_access_response.RevokeVpcEndpointAccessResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.revoke_vpc_endpoint_access_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
