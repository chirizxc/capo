"""Generated from Smithy shape ``com.amazonaws.opensearch#ListVersions``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.list_versions_response.ListVersionsResponse = (
        capo_opensearch.types.list_versions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/versions"
...
def list_versions(
    ...
    capo_opensearch.types.list_versions_response.ListVersionsResponse, zapros.Response
]:
