...
def handle_response(
    ...
    out: capo_opensearch.types.list_domains_for_package_response.ListDomainsForPackageResponse = capo_opensearch.types.list_domains_for_package_response.deserialize_json(
