...
def handle_response(
    ...
    out: capo_opensearch.types.describe_inbound_connections_response.DescribeInboundConnectionsResponse = capo_opensearch.types.describe_inbound_connections_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.describe_inbound_connections_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
