"""Generated from Smithy shape ``com.amazonaws.opensearch#ListPackagesForDomain``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.list_packages_for_domain_response.ListPackagesForDomainResponse = capo_opensearch.types.list_packages_for_domain_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/domain/{DomainName}/packages"
