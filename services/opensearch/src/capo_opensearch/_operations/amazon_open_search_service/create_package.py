...
def handle_response(
    ...
    out: capo_opensearch.types.create_package_response.CreatePackageResponse = (
        capo_opensearch.types.create_package_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.create_package_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_package(
    ...
    capo_opensearch.types.create_package_response.CreatePackageResponse, zapros.Response
]:
