...
import capo_opensearch.types.domain_status_list
...
def handle_response(
    ...
    out: capo_opensearch.types.describe_domains_response.DescribeDomainsResponse = (
        capo_opensearch.types.describe_domains_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.describe_domains_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
