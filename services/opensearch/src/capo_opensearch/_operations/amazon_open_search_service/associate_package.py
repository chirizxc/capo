...
def handle_response(
    ...
    out: capo_opensearch.types.associate_package_response.AssociatePackageResponse = (
        capo_opensearch.types.associate_package_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.associate_package_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
