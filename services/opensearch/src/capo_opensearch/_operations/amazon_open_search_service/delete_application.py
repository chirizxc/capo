"""Generated from Smithy shape ``com.amazonaws.opensearch#DeleteApplication``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.delete_application_response.DeleteApplicationResponse = {}  # type: ignore[typeddict-item]
    return out
