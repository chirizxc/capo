"""Generated from Smithy shape ``com.amazonaws.opensearch#DeleteDomain``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.delete_domain_response.DeleteDomainResponse = (
        capo_opensearch.types.delete_domain_response.deserialize_json(
...
def delete_domain(
    ...
    capo_opensearch.types.delete_domain_response.DeleteDomainResponse, zapros.Response
]:
