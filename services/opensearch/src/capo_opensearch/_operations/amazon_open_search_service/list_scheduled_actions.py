...
def handle_response(
    ...
    out: capo_opensearch.types.list_scheduled_actions_response.ListScheduledActionsResponse = capo_opensearch.types.list_scheduled_actions_response.deserialize_json(
