...
def handle_response(
    ...
    out: capo_opensearch.types.get_domain_maintenance_status_response.GetDomainMaintenanceStatusResponse = capo_opensearch.types.get_domain_maintenance_status_response.deserialize_json(
...
def build_request(
    ...
    if "maintenance_id" in input_:
        params.append(("maintenanceId", input_["maintenance_id"]))
