...
def handle_response(
    ...
    out: capo_opensearch.types.update_application_response.UpdateApplicationResponse = (
        capo_opensearch.types.update_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.update_application_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
