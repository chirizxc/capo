"""Generated from Smithy shape ``com.amazonaws.opensearch#DeleteDirectQueryDataSource``."""
...
def build_request(
    ...
    url = url.replace("{DataSourceName}", quote(input_["data_source_name"], safe=""))
...
async def async_delete_direct_query_data_source(
