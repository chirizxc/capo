"""Generated from Smithy shape ``com.amazonaws.opensearch#ListVpcEndpointAccess``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.list_vpc_endpoint_access_response.ListVpcEndpointAccessResponse = capo_opensearch.types.list_vpc_endpoint_access_response.deserialize_json(
