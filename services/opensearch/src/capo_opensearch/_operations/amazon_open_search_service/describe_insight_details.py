...
def handle_response(
    ...
    out: capo_opensearch.types.describe_insight_details_response.DescribeInsightDetailsResponse = capo_opensearch.types.describe_insight_details_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.describe_insight_details_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
