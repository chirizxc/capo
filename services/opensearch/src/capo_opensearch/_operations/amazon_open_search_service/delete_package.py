...
def handle_response(
    ...
    out: capo_opensearch.types.delete_package_response.DeletePackageResponse = (
        capo_opensearch.types.delete_package_response.deserialize_json(
...
def delete_package(
    ...
    capo_opensearch.types.delete_package_response.DeletePackageResponse, zapros.Response
]:
