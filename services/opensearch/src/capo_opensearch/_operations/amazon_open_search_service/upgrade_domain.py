...
def handle_response(
    ...
    out: capo_opensearch.types.upgrade_domain_response.UpgradeDomainResponse = (
        capo_opensearch.types.upgrade_domain_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearch.types.upgrade_domain_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def upgrade_domain(
    ...
    capo_opensearch.types.upgrade_domain_response.UpgradeDomainResponse, zapros.Response
]:
