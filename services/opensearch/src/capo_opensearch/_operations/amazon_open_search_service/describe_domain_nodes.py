"""Generated from Smithy shape ``com.amazonaws.opensearch#DescribeDomainNodes``."""
...
def handle_response(
    ...
    out: capo_opensearch.types.describe_domain_nodes_response.DescribeDomainNodesResponse = capo_opensearch.types.describe_domain_nodes_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/2021-01-01/opensearch/domain/{DomainName}/nodes"
...
async def async_describe_domain_nodes(
