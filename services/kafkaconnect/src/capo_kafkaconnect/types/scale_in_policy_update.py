"""Generated from Smithy shape ``com.amazonaws.kafkaconnect#ScaleInPolicyUpdate``."""
...
class ScaleInPolicyUpdate(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ScaleInPolicyUpdate) -> dict:
    out: dict = {}
    out["cpuUtilizationPercentage"] = value.get("cpu_utilization_percentage", 0)
    return out


def deserialize_json(data: dict) -> ScaleInPolicyUpdate:
    out: ScaleInPolicyUpdate = {}  # type: ignore[typeddict-item]
