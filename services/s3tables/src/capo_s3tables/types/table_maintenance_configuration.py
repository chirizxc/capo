...
TableMaintenanceConfiguration: TypeAlias = dict[
    "capo_s3tables.types.table_maintenance_type.TableMaintenanceType",
    "capo_s3tables.types.table_maintenance_configuration_value.TableMaintenanceConfigurationValue",
]
...
def serialize_json(input_to_serialize: TableMaintenanceConfiguration) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[capo_s3tables.types.table_maintenance_type.serialize_json(key)] = (
...
def deserialize_json(data: dict) -> TableMaintenanceConfiguration:
    ...
    for key, value in data.items():
        ...
        out[capo_s3tables.types.table_maintenance_type.deserialize_json(key)] = (
