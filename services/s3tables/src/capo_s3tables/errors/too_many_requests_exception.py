"""Generated from Smithy shape ``com.amazonaws.s3tables#TooManyRequestsException``."""
...
class TooManyRequestsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.s3tables#TooManyRequestsException``."""
