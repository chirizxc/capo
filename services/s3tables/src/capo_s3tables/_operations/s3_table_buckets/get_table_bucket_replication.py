...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_bucket_replication_response.GetTableBucketReplicationResponse = capo_s3tables.types.get_table_bucket_replication_response.deserialize_json(
