...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_bucket_metrics_configuration_response.GetTableBucketMetricsConfigurationResponse = capo_s3tables.types.get_table_bucket_metrics_configuration_response.deserialize_json(
