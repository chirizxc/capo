"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableMaintenanceJobStatus``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_maintenance_job_status_response.GetTableMaintenanceJobStatusResponse = capo_s3tables.types.get_table_maintenance_job_status_response.deserialize_json(
...
async def async_get_table_maintenance_job_status(
