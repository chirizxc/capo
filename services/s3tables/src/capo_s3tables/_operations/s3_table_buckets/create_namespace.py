...
def handle_response(
    ...
    out: capo_s3tables.types.create_namespace_response.CreateNamespaceResponse = (
        capo_s3tables.types.create_namespace_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3tables.types.create_namespace_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
