...
def handle_response(
    ...
    out: capo_s3tables.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_s3tables.types.list_tags_for_resource_response.deserialize_json(
