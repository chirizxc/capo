...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_storage_class_response.GetTableStorageClassResponse = capo_s3tables.types.get_table_storage_class_response.deserialize_json(
