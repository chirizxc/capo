...
def handle_response(
    ...
    out: capo_s3tables.types.update_table_metadata_location_response.UpdateTableMetadataLocationResponse = capo_s3tables.types.update_table_metadata_location_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3tables.types.update_table_metadata_location_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
