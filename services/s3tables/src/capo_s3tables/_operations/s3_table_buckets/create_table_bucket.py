"""Generated from Smithy shape ``com.amazonaws.s3tables#CreateTableBucket``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.create_table_bucket_response.CreateTableBucketResponse = (
        capo_s3tables.types.create_table_bucket_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3tables.types.create_table_bucket_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_table_bucket(
