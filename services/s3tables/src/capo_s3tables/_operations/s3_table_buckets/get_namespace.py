"""Generated from Smithy shape ``com.amazonaws.s3tables#GetNamespace``."""
...
def handle_response(
    ...
    out: capo_s3tables.types.get_namespace_response.GetNamespaceResponse = (
        capo_s3tables.types.get_namespace_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/namespaces/{tableBucketARN}/{namespace}"
...
def get_namespace(
    ...
    capo_s3tables.types.get_namespace_response.GetNamespaceResponse, zapros.Response
]:
