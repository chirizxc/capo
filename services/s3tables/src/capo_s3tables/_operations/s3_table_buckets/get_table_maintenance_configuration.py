...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_maintenance_configuration_response.GetTableMaintenanceConfigurationResponse = capo_s3tables.types.get_table_maintenance_configuration_response.deserialize_json(
