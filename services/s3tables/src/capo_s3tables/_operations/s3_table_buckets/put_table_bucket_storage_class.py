"""Generated from Smithy shape ``com.amazonaws.s3tables#PutTableBucketStorageClass``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_s3tables.types.put_table_bucket_storage_class_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_table_bucket_storage_class(
