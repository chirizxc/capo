"""Generated from Smithy shape ``com.amazonaws.s3tables#GetTableBucketMaintenanceConfiguration``."""
...
import capo_s3tables.types.table_bucket_maintenance_configuration
...
def handle_response(
    ...
    out: capo_s3tables.types.get_table_bucket_maintenance_configuration_response.GetTableBucketMaintenanceConfigurationResponse = capo_s3tables.types.get_table_bucket_maintenance_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/buckets/{tableBucketARN}/maintenance"
...
async def async_get_table_bucket_maintenance_configuration(
