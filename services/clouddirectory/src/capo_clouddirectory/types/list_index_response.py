"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListIndexResponse``."""
...
class ListIndexResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ListIndexResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ListIndexResponse:
    out: ListIndexResponse = {}  # type: ignore[typeddict-item]
    if data.get("IndexAttachments") is not None:
        import capo_clouddirectory.types.index_attachment_list
