...
# --- restJson1 ser/de ---
def serialize_json(value: BatchListIncomingTypedLinksResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> BatchListIncomingTypedLinksResponse:
    out: BatchListIncomingTypedLinksResponse = {}  # type: ignore[typeddict-item]
