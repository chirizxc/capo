...
# --- restJson1 ser/de ---
def serialize_json(value: BatchListAttachedIndicesResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> BatchListAttachedIndicesResponse:
    out: BatchListAttachedIndicesResponse = {}  # type: ignore[typeddict-item]
