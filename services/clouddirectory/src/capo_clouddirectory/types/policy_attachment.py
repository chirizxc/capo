...
if TYPE_CHECKING:
    ...
    import capo_clouddirectory.types.policy_type


class PolicyAttachment(TypedDict, closed=True):
    ...
    policy_type: NotRequired["capo_clouddirectory.types.policy_type.PolicyType"]
