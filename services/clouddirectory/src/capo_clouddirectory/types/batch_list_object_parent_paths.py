"""Generated from Smithy shape ``com.amazonaws.clouddirectory#BatchListObjectParentPaths``."""
...
class BatchListObjectParentPaths(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: BatchListObjectParentPaths) -> dict:
    out: dict = {}
    import capo_clouddirectory.types.object_reference
...
def deserialize_json(data: dict) -> BatchListObjectParentPaths:
    out: BatchListObjectParentPaths = {}  # type: ignore[typeddict-item]
    if data.get("ObjectReference") is not None:
        ...
        raise DeserializationError(
            "BatchListObjectParentPaths.object_reference required"
        )
