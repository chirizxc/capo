...
def handle_response(
    ...
    out: capo_clouddirectory.types.create_facet_response.CreateFacetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.create_facet_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_facet(
    ...
    capo_clouddirectory.types.create_facet_response.CreateFacetResponse, zapros.Response
]:
