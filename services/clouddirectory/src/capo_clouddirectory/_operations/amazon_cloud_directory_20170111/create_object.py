...
def handle_response(
    ...
    out: capo_clouddirectory.types.create_object_response.CreateObjectResponse = (
        capo_clouddirectory.types.create_object_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.create_object_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
