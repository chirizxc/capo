"""Generated from Smithy shape ``com.amazonaws.clouddirectory#DeleteTypedLinkFacet``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.delete_typed_link_facet_response.DeleteTypedLinkFacetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.delete_typed_link_facet_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_typed_link_facet(
