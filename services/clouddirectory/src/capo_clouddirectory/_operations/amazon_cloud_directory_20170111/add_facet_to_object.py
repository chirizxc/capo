...
def handle_response(
    ...
    out: capo_clouddirectory.types.add_facet_to_object_response.AddFacetToObjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.add_facet_to_object_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
