...
import capo_clouddirectory.errors.still_contains_links_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "StillContainsLinksException":
            raise capo_clouddirectory.errors.still_contains_links_exception.StillContainsLinksException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.delete_schema_response.DeleteSchemaResponse = (
        capo_clouddirectory.types.delete_schema_response.deserialize_json(
