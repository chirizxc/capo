"""Generated from Smithy shape ``com.amazonaws.clouddirectory#GetFacet``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.get_facet_response.GetFacetResponse = (
        capo_clouddirectory.types.get_facet_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.get_facet_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_facet(
    ...
    capo_clouddirectory.types.get_facet_response.GetFacetResponse, zapros.Response
]:
