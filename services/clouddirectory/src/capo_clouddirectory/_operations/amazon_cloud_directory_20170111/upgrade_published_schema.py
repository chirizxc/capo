"""Generated from Smithy shape ``com.amazonaws.clouddirectory#UpgradePublishedSchema``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.upgrade_published_schema_response.UpgradePublishedSchemaResponse = capo_clouddirectory.types.upgrade_published_schema_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.upgrade_published_schema_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_upgrade_published_schema(
