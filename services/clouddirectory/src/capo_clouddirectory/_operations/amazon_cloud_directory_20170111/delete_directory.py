...
import capo_clouddirectory.errors.directory_not_disabled_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryNotDisabledException":
            raise capo_clouddirectory.errors.directory_not_disabled_exception.DirectoryNotDisabledException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.delete_directory_response.DeleteDirectoryResponse = (
        capo_clouddirectory.types.delete_directory_response.deserialize_json(
