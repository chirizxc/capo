"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListTypedLinkFacetNames``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_typed_link_facet_names_response.ListTypedLinkFacetNamesResponse = capo_clouddirectory.types.list_typed_link_facet_names_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_typed_link_facet_names_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_typed_link_facet_names(
