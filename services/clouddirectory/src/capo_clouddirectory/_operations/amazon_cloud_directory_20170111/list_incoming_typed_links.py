...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_incoming_typed_links_response.ListIncomingTypedLinksResponse = capo_clouddirectory.types.list_incoming_typed_links_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_incoming_typed_links_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
