...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_object_children_response.ListObjectChildrenResponse = capo_clouddirectory.types.list_object_children_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_object_children_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
