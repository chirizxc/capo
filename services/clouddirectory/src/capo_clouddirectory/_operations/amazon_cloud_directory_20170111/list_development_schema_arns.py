...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_development_schema_arns_response.ListDevelopmentSchemaArnsResponse = capo_clouddirectory.types.list_development_schema_arns_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_development_schema_arns_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
