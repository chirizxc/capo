...
def handle_response(
    ...
    out: capo_clouddirectory.types.disable_directory_response.DisableDirectoryResponse = capo_clouddirectory.types.disable_directory_response.deserialize_json(
