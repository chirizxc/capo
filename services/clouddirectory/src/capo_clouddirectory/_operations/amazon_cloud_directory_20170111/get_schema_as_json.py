"""Generated from Smithy shape ``com.amazonaws.clouddirectory#GetSchemaAsJson``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.get_schema_as_json_response.GetSchemaAsJsonResponse = capo_clouddirectory.types.get_schema_as_json_response.deserialize_json(
...
async def async_get_schema_as_json(
