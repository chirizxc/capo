"""Generated from Smithy shape ``com.amazonaws.clouddirectory#ListObjectPolicies``."""
...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_object_policies_response.ListObjectPoliciesResponse = capo_clouddirectory.types.list_object_policies_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/amazonclouddirectory/2017-01-11/object/policy"
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_object_policies_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_object_policies(
