...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_facet_attributes_response.ListFacetAttributesResponse = capo_clouddirectory.types.list_facet_attributes_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_facet_attributes_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
