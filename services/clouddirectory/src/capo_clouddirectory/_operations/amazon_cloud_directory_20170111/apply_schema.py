...
def handle_response(
    ...
    out: capo_clouddirectory.types.apply_schema_response.ApplySchemaResponse = (
        capo_clouddirectory.types.apply_schema_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.apply_schema_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def apply_schema(
    ...
    capo_clouddirectory.types.apply_schema_response.ApplySchemaResponse, zapros.Response
]:
