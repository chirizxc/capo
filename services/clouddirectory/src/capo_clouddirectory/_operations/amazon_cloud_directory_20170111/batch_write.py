...
import capo_clouddirectory.errors.batch_write_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BatchWriteException":
            raise capo_clouddirectory.errors.batch_write_exception.BatchWriteException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.batch_write_response.BatchWriteResponse = (
        capo_clouddirectory.types.batch_write_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.batch_write_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def batch_write(
    ...
    capo_clouddirectory.types.batch_write_response.BatchWriteResponse, zapros.Response
]:
