...
import capo_clouddirectory.errors.incompatible_schema_exception
...
import capo_clouddirectory.errors.schema_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IncompatibleSchemaException":
            raise capo_clouddirectory.errors.incompatible_schema_exception.IncompatibleSchemaException.from_json(
                data, message
            )
        ...
        case "SchemaAlreadyExistsException":
            raise capo_clouddirectory.errors.schema_already_exists_exception.SchemaAlreadyExistsException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_clouddirectory.types.upgrade_applied_schema_response.UpgradeAppliedSchemaResponse = capo_clouddirectory.types.upgrade_applied_schema_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.upgrade_applied_schema_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
