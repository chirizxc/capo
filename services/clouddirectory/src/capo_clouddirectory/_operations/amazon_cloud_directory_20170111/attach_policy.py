...
def handle_response(
    ...
    out: capo_clouddirectory.types.attach_policy_response.AttachPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.attach_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
