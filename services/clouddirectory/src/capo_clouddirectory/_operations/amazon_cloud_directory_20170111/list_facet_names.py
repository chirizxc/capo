...
def handle_response(
    ...
    out: capo_clouddirectory.types.list_facet_names_response.ListFacetNamesResponse = (
        capo_clouddirectory.types.list_facet_names_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_clouddirectory.types.list_facet_names_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
