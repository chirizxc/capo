"""Generated from Smithy shape ``com.amazonaws.clouddirectory#InternalServiceException``."""
...
class InternalServiceException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.clouddirectory#InternalServiceException``."""
