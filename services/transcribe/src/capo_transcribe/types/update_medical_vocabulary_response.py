"""Generated from Smithy shape ``com.amazonaws.transcribe#UpdateMedicalVocabularyResponse``."""
...
class UpdateMedicalVocabularyResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateMedicalVocabularyResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateMedicalVocabularyResponse:
    out: UpdateMedicalVocabularyResponse = {}  # type: ignore[typeddict-item]
