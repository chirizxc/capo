...
def handle_response(
    ...
    out: capo_transcribe.types.create_vocabulary_filter_response.CreateVocabularyFilterResponse = capo_transcribe.types.create_vocabulary_filter_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_transcribe.types.create_vocabulary_filter_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
