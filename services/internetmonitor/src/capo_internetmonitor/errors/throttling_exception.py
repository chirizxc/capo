"""Generated from Smithy shape ``com.amazonaws.internetmonitor#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.internetmonitor#ThrottlingException``."""
