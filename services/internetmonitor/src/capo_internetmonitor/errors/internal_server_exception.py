"""Generated from Smithy shape ``com.amazonaws.internetmonitor#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.internetmonitor#InternalServerException``."""
