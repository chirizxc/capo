"""Generated from Smithy shape ``com.amazonaws.internetmonitor#GetQueryStatus``."""
...
def handle_response(
    ...
    out: capo_internetmonitor.types.get_query_status_output.GetQueryStatusOutput = (
        capo_internetmonitor.types.get_query_status_output.deserialize_json(
...
async def async_get_query_status(
