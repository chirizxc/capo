"""Generated from Smithy shape ``com.amazonaws.internetmonitor#DeleteMonitor``."""
...
def handle_response(
    ...
    out: capo_internetmonitor.types.delete_monitor_output.DeleteMonitorOutput = {}  # type: ignore[typeddict-item]
    return out
