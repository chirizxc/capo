...
def handle_response(
    ...
    out: capo_internetmonitor.types.start_query_output.StartQueryOutput = (
        capo_internetmonitor.types.start_query_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_internetmonitor.types.start_query_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def start_query(
    ...
    capo_internetmonitor.types.start_query_output.StartQueryOutput, zapros.Response
]:
