...
def handle_response(
    ...
    out: capo_internetmonitor.types.get_monitor_output.GetMonitorOutput = (
        capo_internetmonitor.types.get_monitor_output.deserialize_json(
...
def get_monitor(
    ...
    capo_internetmonitor.types.get_monitor_output.GetMonitorOutput, zapros.Response
]:
