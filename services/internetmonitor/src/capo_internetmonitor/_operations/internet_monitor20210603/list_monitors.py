"""Generated from Smithy shape ``com.amazonaws.internetmonitor#ListMonitors``."""
...
def handle_response(
    ...
    out: capo_internetmonitor.types.list_monitors_output.ListMonitorsOutput = (
        capo_internetmonitor.types.list_monitors_output.deserialize_json(
...
def build_request(
    ...
    if "monitor_status" in input_:
        params.append(("MonitorStatus", input_["monitor_status"]))
    if "include_linked_accounts" in input_:
        params.append(
            (
                "IncludeLinkedAccounts",
                "true" if input_["include_linked_accounts"] else "false",
            )
        )
...
def list_monitors(
    ...
    capo_internetmonitor.types.list_monitors_output.ListMonitorsOutput, zapros.Response
]:
