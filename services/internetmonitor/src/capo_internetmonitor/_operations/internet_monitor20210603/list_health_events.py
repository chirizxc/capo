"""Generated from Smithy shape ``com.amazonaws.internetmonitor#ListHealthEvents``."""
...
def handle_response(
    ...
    out: capo_internetmonitor.types.list_health_events_output.ListHealthEventsOutput = (
        capo_internetmonitor.types.list_health_events_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v20210603/Monitors/{MonitorName}/HealthEvents"
    ...
    if "linked_account_id" in input_:
        params.append(("LinkedAccountId", input_["linked_account_id"]))
...
async def async_list_health_events(
