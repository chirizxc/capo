...
def handle_response(
    ...
    out: capo_codestar_connections.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_codestar_connections.types.list_tags_for_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.list_tags_for_resource_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
