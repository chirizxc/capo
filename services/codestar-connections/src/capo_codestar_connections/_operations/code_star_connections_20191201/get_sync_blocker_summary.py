...
def handle_response(
    ...
    out: capo_codestar_connections.types.get_sync_blocker_summary_output.GetSyncBlockerSummaryOutput = capo_codestar_connections.types.get_sync_blocker_summary_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.get_sync_blocker_summary_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
