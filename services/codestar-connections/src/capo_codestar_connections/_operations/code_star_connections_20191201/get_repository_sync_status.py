...
import capo_codestar_connections.types.repository_sync_attempt
...
def handle_response(
    ...
    out: capo_codestar_connections.types.get_repository_sync_status_output.GetRepositorySyncStatusOutput = capo_codestar_connections.types.get_repository_sync_status_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.get_repository_sync_status_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
