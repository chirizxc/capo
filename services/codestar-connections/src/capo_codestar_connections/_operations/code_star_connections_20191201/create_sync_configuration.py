...
def handle_response(
    ...
    out: capo_codestar_connections.types.create_sync_configuration_output.CreateSyncConfigurationOutput = capo_codestar_connections.types.create_sync_configuration_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codestar_connections.types.create_sync_configuration_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
