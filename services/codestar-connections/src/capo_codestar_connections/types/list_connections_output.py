"""Generated from Smithy shape ``com.amazonaws.codestarconnections#ListConnectionsOutput``."""
...
class ListConnectionsOutput(TypedDict, closed=True):
    connections: NotRequired[
        "capo_codestar_connections.types.connection_list.ConnectionList"
    ]
...
def serialize_aws_json_1_0(value: ListConnectionsOutput) -> dict:
    ...
    if "connections" in value:
        ...
        out["Connections"] = (
            capo_codestar_connections.types.connection_list.serialize_aws_json_1_0(
                value["connections"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListConnectionsOutput:
    ...
    if data.get("Connections") is not None:
        ...
        out["connections"] = (
            capo_codestar_connections.types.connection_list.deserialize_aws_json_1_0(
                data["Connections"]
            )
        )
