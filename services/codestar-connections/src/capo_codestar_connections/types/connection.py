...
if TYPE_CHECKING:
    import capo_codestar_connections.types.account_id
...
class Connection(TypedDict, closed=True):
    connection_name: NotRequired[
        "capo_codestar_connections.types.connection_name.ConnectionName"
    ]
    ...
    owner_account_id: NotRequired[
        "capo_codestar_connections.types.account_id.AccountId"
    ]
    ...
    connection_status: NotRequired[
        "capo_codestar_connections.types.connection_status.ConnectionStatus"
    ]
...
def serialize_aws_json_1_0(value: Connection) -> dict:
    ...
    if "connection_status" in value:
        ...
        out["ConnectionStatus"] = (
            capo_codestar_connections.types.connection_status.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> Connection:
    ...
    if data.get("ConnectionStatus") is not None:
        ...
        out["connection_status"] = (
            capo_codestar_connections.types.connection_status.deserialize_aws_json_1_0(
