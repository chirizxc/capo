"""Generated from Smithy shape ``com.amazonaws.codestarconnections#InvalidInputException``."""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: InvalidInputException_) -> dict:
    out: dict = {}
    if "message" in value:
...
def deserialize_aws_json_1_0(data: dict) -> InvalidInputException_:
...
class InvalidInputException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codestarconnections#InvalidInputException``."""
