...
from capo_dsql._resources.dsql.cluster import AsyncCluster
from capo_dsql._resources.dsql.stream import AsyncStream
from capo_dsql._services._aws_config import aaws_config
...
class AsyncDSQLClient:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dsql.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_dsql.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_dsql._operations.dsql.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dsql.types.tag_resource_input.TagResourceInput]",
            ...
            (
                output,
                http_response,
            ) = await capo_dsql._operations.dsql.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_dsql.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_dsql._operations.dsql.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
