"""Generated from Smithy shape ``com.amazonaws.dsql#ListStreams``."""
...
def handle_response(
    ...
    out: capo_dsql.types.list_streams_output.ListStreamsOutput = (
        capo_dsql.types.list_streams_output.deserialize_json(
...
def build_request(
    ...
    params.append(("max-results", str(input_.get("max_results", 10))))
...
def list_streams(
    ...
    input_: capo_dsql.types.list_streams_input.ListStreamsInput,
) -> tuple[capo_dsql.types.list_streams_output.ListStreamsOutput, zapros.Response]:
