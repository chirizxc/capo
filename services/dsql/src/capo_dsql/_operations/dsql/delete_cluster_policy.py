...
def handle_response(
    ...
    out: capo_dsql.types.delete_cluster_policy_output.DeleteClusterPolicyOutput = (
        capo_dsql.types.delete_cluster_policy_output.deserialize_json(
...
def build_request(
    ...
    if "expected_policy_version" in input_:
        params.append(("expected-policy-version", input_["expected_policy_version"]))
