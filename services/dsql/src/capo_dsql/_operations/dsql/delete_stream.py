"""Generated from Smithy shape ``com.amazonaws.dsql#DeleteStream``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ConflictException":
            raise capo_dsql.errors.conflict_exception.ConflictException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_dsql.types.delete_stream_output.DeleteStreamOutput = (
        capo_dsql.types.delete_stream_output.deserialize_json(
...
def build_request(
    ...
    if "client_token" in input_:
        params.append(("client-token", input_["client_token"]))
...
def delete_stream(
    ...
    input_: capo_dsql.types.delete_stream_input.DeleteStreamInput,
) -> tuple[capo_dsql.types.delete_stream_output.DeleteStreamOutput, zapros.Response]:
