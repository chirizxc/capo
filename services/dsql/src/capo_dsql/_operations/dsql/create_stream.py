...
def handle_response(
    ...
    out: capo_dsql.types.create_stream_output.CreateStreamOutput = (
        capo_dsql.types.create_stream_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dsql.types.create_stream_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_stream(
    ...
    input_: capo_dsql.types.create_stream_input.CreateStreamInput,
) -> tuple[capo_dsql.types.create_stream_output.CreateStreamOutput, zapros.Response]:
