"""Generated from Smithy shape ``com.amazonaws.dsql#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_dsql.types.list_tags_for_resource_output.ListTagsForResourceOutput = (
        capo_dsql.types.list_tags_for_resource_output.deserialize_json(
