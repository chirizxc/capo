...
def handle_response(
    ...
    out: capo_dsql.types.put_cluster_policy_output.PutClusterPolicyOutput = (
        capo_dsql.types.put_cluster_policy_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dsql.types.put_cluster_policy_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def put_cluster_policy(
    ...
    capo_dsql.types.put_cluster_policy_output.PutClusterPolicyOutput, zapros.Response
]:
