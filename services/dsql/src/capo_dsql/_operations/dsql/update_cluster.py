...
def handle_response(
    ...
    out: capo_dsql.types.update_cluster_output.UpdateClusterOutput = (
        capo_dsql.types.update_cluster_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_dsql.types.update_cluster_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_cluster(
    ...
    input_: capo_dsql.types.update_cluster_input.UpdateClusterInput,
) -> tuple[capo_dsql.types.update_cluster_output.UpdateClusterOutput, zapros.Response]:
