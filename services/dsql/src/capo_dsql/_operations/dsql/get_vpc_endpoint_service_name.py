...
def handle_response(
    ...
    out: capo_dsql.types.get_vpc_endpoint_service_name_output.GetVpcEndpointServiceNameOutput = capo_dsql.types.get_vpc_endpoint_service_name_output.deserialize_json(
