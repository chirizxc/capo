"""Generated from Smithy shape ``com.amazonaws.dsql#GetClusterPolicy``."""
...
def handle_response(
    ...
    out: capo_dsql.types.get_cluster_policy_output.GetClusterPolicyOutput = (
        capo_dsql.types.get_cluster_policy_output.deserialize_json(
...
def get_cluster_policy(
    ...
    capo_dsql.types.get_cluster_policy_output.GetClusterPolicyOutput, zapros.Response
]:
