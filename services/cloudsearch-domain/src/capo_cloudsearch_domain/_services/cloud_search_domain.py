...
from capo_cloudsearch_domain._auth._identity import Credentials
...
class CloudSearchDomainClientConfig(TypedDict, total=False, closed=True):
...
class CloudSearchDomainClient:
    ...
    def __init__(
        ...
        self._config = CloudSearchDomainClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[CloudSearchDomainClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: CloudSearchDomainClientConfig = config_overrides or {}
    ...
    def search(
        ...
        *,
        ...
        cursor: Optional["capo_cloudsearch_domain.types.cursor.Cursor"] = None,
        expr: Optional["capo_cloudsearch_domain.types.expr.Expr"] = None,
        facet: Optional["capo_cloudsearch_domain.types.facet.Facet"] = None,
        filter_query: Optional[
            "capo_cloudsearch_domain.types.filter_query.FilterQuery"
        ] = None,
        highlight: Optional["capo_cloudsearch_domain.types.highlight.Highlight"] = None,
        partial: Optional["capo_cloudsearch_domain.types.partial.Partial"] = None,
        ...
        return_: Optional["capo_cloudsearch_domain.types.return_.Return"] = None,
        size: Optional["capo_cloudsearch_domain.types.size.Size"] = None,
        sort: Optional["capo_cloudsearch_domain.types.sort.Sort"] = None,
        start: Optional["capo_cloudsearch_domain.types.start.Start"] = None,
        stats: Optional["capo_cloudsearch_domain.types.stat.Stat"] = None,
        ...
        Raises:
            capo_cloudsearch_domain.errors.search_exception.SearchException: <p>Information about any problems encountered while processing a search request.</p>
            capo_cloudsearch_domain.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[capo_cloudsearch_domain.types.search_request.SearchRequest]",
        ) -> OperationResponse[
            "capo_cloudsearch_domain.types.search_response.SearchResponse"
        ]:
            import capo_cloudsearch_domain._operations.amazon_cloud_search2013.search

            output, http_response = (
                capo_cloudsearch_domain._operations.amazon_cloud_search2013.search.search(
    ...
    def suggest(
        ...
        *,
        config_overrides: Optional[CloudSearchDomainClientConfig] = None,
        size: Optional[
            "capo_cloudsearch_domain.types.suggestions_size.SuggestionsSize"
        ] = None,
        ...
        def _handler(
            req: "OperationRequest[capo_cloudsearch_domain.types.suggest_request.SuggestRequest]",
        ) -> OperationResponse[
            "capo_cloudsearch_domain.types.suggest_response.SuggestResponse"
        ]:
            import capo_cloudsearch_domain._operations.amazon_cloud_search2013.suggest

            output, http_response = (
                capo_cloudsearch_domain._operations.amazon_cloud_search2013.suggest.suggest(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def upload_documents(
        ...
        *,
        ...
        Raises:
            capo_cloudsearch_domain.errors.document_service_exception.DocumentServiceException: <p>Information about any problems encountered while processing an upload request.</p>
            capo_cloudsearch_domain.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        def _handler(
            req: "OperationRequest[capo_cloudsearch_domain.types.upload_documents_request.UploadDocumentsRequest]",
        ) -> OperationResponse[
            "capo_cloudsearch_domain.types.upload_documents_response.UploadDocumentsResponse"
        ]:
            import capo_cloudsearch_domain._operations.amazon_cloud_search2013.upload_documents

            output, http_response = (
                capo_cloudsearch_domain._operations.amazon_cloud_search2013.upload_documents.upload_documents(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
