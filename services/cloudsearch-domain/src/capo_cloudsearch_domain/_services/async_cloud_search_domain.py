...
class AsyncCloudSearchDomainClient:
    ...
    async def search(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudsearch_domain.types.search_request.SearchRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudsearch_domain.types.search_response.SearchResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudsearch_domain._operations.amazon_cloud_search2013.search.async_search(
    ...
    async def suggest(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudsearch_domain.types.suggest_request.SuggestRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudsearch_domain.types.suggest_response.SuggestResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudsearch_domain._operations.amazon_cloud_search2013.suggest.async_suggest(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def upload_documents(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cloudsearch_domain.types.upload_documents_request.UploadDocumentsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cloudsearch_domain.types.upload_documents_response.UploadDocumentsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_cloudsearch_domain._operations.amazon_cloud_search2013.upload_documents.async_upload_documents(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
