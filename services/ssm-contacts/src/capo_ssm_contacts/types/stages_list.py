...
if TYPE_CHECKING:
    import capo_ssm_contacts.types.stage

StagesList: TypeAlias = list["capo_ssm_contacts.types.stage.Stage"]
...
def serialize_aws_json_1_1(value: StagesList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_ssm_contacts.types.stage.serialize_aws_json_1_1(item))
    return out
