...
class Target(TypedDict, closed=True):
    channel_target_info: NotRequired[
        "capo_ssm_contacts.types.channel_target_info.ChannelTargetInfo"
    ]
    """<p>Information about the contact channel that Incident Manager engages.</p>"""
    contact_target_info: NotRequired[
        "capo_ssm_contacts.types.contact_target_info.ContactTargetInfo"
    ]
...
def serialize_aws_json_1_1(value: Target) -> dict:
    ...
    if "channel_target_info" in value:
        ...
        out["ChannelTargetInfo"] = (
            capo_ssm_contacts.types.channel_target_info.serialize_aws_json_1_1(
    ...
    if "contact_target_info" in value:
        ...
        out["ContactTargetInfo"] = (
            capo_ssm_contacts.types.contact_target_info.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> Target:
    ...
    if data.get("ChannelTargetInfo") is not None:
        ...
        out["channel_target_info"] = (
            capo_ssm_contacts.types.channel_target_info.deserialize_aws_json_1_1(
    ...
    if data.get("ContactTargetInfo") is not None:
        ...
        out["contact_target_info"] = (
            capo_ssm_contacts.types.contact_target_info.deserialize_aws_json_1_1(
