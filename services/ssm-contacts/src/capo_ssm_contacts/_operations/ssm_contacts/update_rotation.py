...
def handle_response(
    ...
    out: capo_ssm_contacts.types.update_rotation_result.UpdateRotationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.update_rotation_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_rotation(
    ...
    capo_ssm_contacts.types.update_rotation_result.UpdateRotationResult, zapros.Response
]:
