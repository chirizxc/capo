...
def handle_response(
    ...
    out: capo_ssm_contacts.types.put_contact_policy_result.PutContactPolicyResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.put_contact_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
