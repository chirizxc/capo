...
def handle_response(
    ...
    out: capo_ssm_contacts.types.list_page_receipts_result.ListPageReceiptsResult = (
        capo_ssm_contacts.types.list_page_receipts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.list_page_receipts_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
