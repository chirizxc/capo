"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#CreateContact``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.create_contact_result.CreateContactResult = (
        capo_ssm_contacts.types.create_contact_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.CreateContact"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.create_contact_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_contact(
    ...
    capo_ssm_contacts.types.create_contact_result.CreateContactResult, zapros.Response
]:
