"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#ListEngagements``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.list_engagements_result.ListEngagementsResult = (
        capo_ssm_contacts.types.list_engagements_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.ListEngagements"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.list_engagements_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
