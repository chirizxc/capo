"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#StartEngagement``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.start_engagement_result.StartEngagementResult = (
        capo_ssm_contacts.types.start_engagement_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.StartEngagement"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.start_engagement_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_engagement(
