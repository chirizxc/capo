...
def handle_response(
    ...
    out: capo_ssm_contacts.types.list_preview_rotation_shifts_result.ListPreviewRotationShiftsResult = capo_ssm_contacts.types.list_preview_rotation_shifts_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.list_preview_rotation_shifts_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
