...
def handle_response(
    ...
    out: capo_ssm_contacts.types.list_rotations_result.ListRotationsResult = (
        capo_ssm_contacts.types.list_rotations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.list_rotations_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_rotations(
    ...
    capo_ssm_contacts.types.list_rotations_result.ListRotationsResult, zapros.Response
]:
