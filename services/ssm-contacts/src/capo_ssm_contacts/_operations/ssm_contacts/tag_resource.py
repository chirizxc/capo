...
def handle_response(
    ...
    out: capo_ssm_contacts.types.tag_resource_result.TagResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.tag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_ssm_contacts.types.tag_resource_result.TagResourceResult, zapros.Response
]:
