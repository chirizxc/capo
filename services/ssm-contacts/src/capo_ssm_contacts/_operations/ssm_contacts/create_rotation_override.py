"""Generated from Smithy shape ``com.amazonaws.ssmcontacts#CreateRotationOverride``."""
...
def handle_response(
    ...
    out: capo_ssm_contacts.types.create_rotation_override_result.CreateRotationOverrideResult = capo_ssm_contacts.types.create_rotation_override_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SSMContacts.CreateRotationOverride"
    body: bytes | None = json.dumps(
        capo_ssm_contacts.types.create_rotation_override_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_rotation_override(
