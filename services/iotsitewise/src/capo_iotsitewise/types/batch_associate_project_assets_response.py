...
class BatchAssociateProjectAssetsResponse(TypedDict, closed=True):
    errors: NotRequired[
        "capo_iotsitewise.types.batch_associate_project_assets_errors.BatchAssociateProjectAssetsErrors"
    ]
...
def serialize_json(value: BatchAssociateProjectAssetsResponse) -> dict:
    ...
    if "errors" in value:
        ...
        out["errors"] = (
            capo_iotsitewise.types.batch_associate_project_assets_errors.serialize_json(
                value["errors"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> BatchAssociateProjectAssetsResponse:
    ...
    if data.get("errors") is not None:
        ...
        out["errors"] = (
            capo_iotsitewise.types.batch_associate_project_assets_errors.deserialize_json(
                data["errors"]
            )
        )
    return out
