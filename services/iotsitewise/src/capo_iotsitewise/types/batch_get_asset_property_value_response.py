...
class BatchGetAssetPropertyValueResponse(TypedDict, closed=True):
    error_entries: "capo_iotsitewise.types.batch_get_asset_property_value_error_entries.BatchGetAssetPropertyValueErrorEntries"
    ...
    success_entries: "capo_iotsitewise.types.batch_get_asset_property_value_success_entries.BatchGetAssetPropertyValueSuccessEntries"
    ...
    skipped_entries: "capo_iotsitewise.types.batch_get_asset_property_value_skipped_entries.BatchGetAssetPropertyValueSkippedEntries"
...
def serialize_json(value: BatchGetAssetPropertyValueResponse) -> dict:
    ...
    out["errorEntries"] = (
        capo_iotsitewise.types.batch_get_asset_property_value_error_entries.serialize_json(
            value["error_entries"]
        )
    )
    import capo_iotsitewise.types.batch_get_asset_property_value_success_entries
    ...
    out["successEntries"] = (
        capo_iotsitewise.types.batch_get_asset_property_value_success_entries.serialize_json(
    ...
    out["skippedEntries"] = (
        capo_iotsitewise.types.batch_get_asset_property_value_skipped_entries.serialize_json(
...
def deserialize_json(data: dict) -> BatchGetAssetPropertyValueResponse:
    ...
    if data.get("errorEntries") is not None:
        ...
        out["error_entries"] = (
            capo_iotsitewise.types.batch_get_asset_property_value_error_entries.deserialize_json(
                data["errorEntries"]
            )
        )
    else:
    ...
    if data.get("successEntries") is not None:
        ...
        out["success_entries"] = (
            capo_iotsitewise.types.batch_get_asset_property_value_success_entries.deserialize_json(
                data["successEntries"]
            )
        )
    else:
    ...
    if data.get("skippedEntries") is not None:
        ...
        out["skipped_entries"] = (
            capo_iotsitewise.types.batch_get_asset_property_value_skipped_entries.deserialize_json(
                data["skippedEntries"]
            )
        )
    else:
