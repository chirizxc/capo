...
InterpolatedAssetPropertyValues: TypeAlias = list[
    "capo_iotsitewise.types.interpolated_asset_property_value.InterpolatedAssetPropertyValue"
]
...
def serialize_json(value: InterpolatedAssetPropertyValues) -> list:
    ...
    for item in value:
        out.append(
            capo_iotsitewise.types.interpolated_asset_property_value.serialize_json(
                item
            )
        )
    return out
