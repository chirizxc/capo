...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_action_response.DescribeActionResponse = (
        capo_iotsitewise.types.describe_action_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{actionId}", quote(input_["action_id"], safe=""))
