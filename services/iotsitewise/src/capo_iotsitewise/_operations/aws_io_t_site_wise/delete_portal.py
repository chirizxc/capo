...
def handle_response(
    ...
    out: capo_iotsitewise.types.delete_portal_response.DeletePortalResponse = (
        capo_iotsitewise.types.delete_portal_response.deserialize_json(
...
def delete_portal(
    ...
    capo_iotsitewise.types.delete_portal_response.DeletePortalResponse, zapros.Response
]:
