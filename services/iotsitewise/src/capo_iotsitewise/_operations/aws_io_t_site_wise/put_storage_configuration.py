...
def handle_response(
    ...
    out: capo_iotsitewise.types.put_storage_configuration_response.PutStorageConfigurationResponse = capo_iotsitewise.types.put_storage_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.put_storage_configuration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
