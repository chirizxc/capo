...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_dataset_response.CreateDatasetResponse = (
        capo_iotsitewise.types.create_dataset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_dataset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
