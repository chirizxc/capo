...
import capo_iotsitewise.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_iotsitewise.errors.too_many_tags_exception.TooManyTagsException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_iotsitewise.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.tag_resource_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    capo_iotsitewise.types.tag_resource_response.TagResourceResponse, zapros.Response
]:
