...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_asset_model_properties_response.ListAssetModelPropertiesResponse = capo_iotsitewise.types.list_asset_model_properties_response.deserialize_json(
...
def build_request(
    ...
    if "filter" in input_:
        params.append(
            (
                "filter",
                capo_iotsitewise.types.list_asset_model_properties_filter.serialize_json(
                    input_["filter"]
                ),
            )
        )
    if "asset_model_version" in input_:
        params.append(("assetModelVersion", input_["asset_model_version"]))
