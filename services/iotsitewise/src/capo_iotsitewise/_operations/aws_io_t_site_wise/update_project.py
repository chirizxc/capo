"""Generated from Smithy shape ``com.amazonaws.iotsitewise#UpdateProject``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.update_project_response.UpdateProjectResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.update_project_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
