"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListGateways``."""
...
import capo_iotsitewise.types.gateway_summaries
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_gateways_response.ListGatewaysResponse = (
        capo_iotsitewise.types.list_gateways_response.deserialize_json(
...
def list_gateways(
    ...
    capo_iotsitewise.types.list_gateways_response.ListGatewaysResponse, zapros.Response
]:
