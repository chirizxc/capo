"""Generated from Smithy shape ``com.amazonaws.iotsitewise#AssociateTimeSeriesToAssetProperty``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/timeseries/associate"
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.associate_time_series_to_asset_property_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_associate_time_series_to_asset_property(
