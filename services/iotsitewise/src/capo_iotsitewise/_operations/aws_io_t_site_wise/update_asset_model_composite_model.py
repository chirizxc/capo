"""Generated from Smithy shape ``com.amazonaws.iotsitewise#UpdateAssetModelCompositeModel``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.update_asset_model_composite_model_response.UpdateAssetModelCompositeModelResponse = capo_iotsitewise.types.update_asset_model_composite_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.update_asset_model_composite_model_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_asset_model_composite_model(
