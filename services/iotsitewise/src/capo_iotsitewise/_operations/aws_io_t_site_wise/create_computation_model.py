"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreateComputationModel``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_computation_model_response.CreateComputationModelResponse = capo_iotsitewise.types.create_computation_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_computation_model_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_computation_model(
