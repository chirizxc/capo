"""Generated from Smithy shape ``com.amazonaws.iotsitewise#GetAssetPropertyValue``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.get_asset_property_value_response.GetAssetPropertyValueResponse = capo_iotsitewise.types.get_asset_property_value_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/properties/latest"
...
async def async_get_asset_property_value(
