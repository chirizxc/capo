...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "QueryTimeoutException":
            raise capo_iotsitewise.errors.query_timeout_exception.QueryTimeoutException.from_json(
                data, message
            )
        ...
        case "ValidationException":
            raise capo_iotsitewise.errors.validation_exception.ValidationException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_iotsitewise.types.execute_query_response.ExecuteQueryResponse = (
        capo_iotsitewise.types.execute_query_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.execute_query_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def execute_query(
    ...
    capo_iotsitewise.types.execute_query_response.ExecuteQueryResponse, zapros.Response
]:
