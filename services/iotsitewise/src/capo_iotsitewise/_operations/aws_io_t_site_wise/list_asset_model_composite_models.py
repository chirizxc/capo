...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_asset_model_composite_models_response.ListAssetModelCompositeModelsResponse = capo_iotsitewise.types.list_asset_model_composite_models_response.deserialize_json(
