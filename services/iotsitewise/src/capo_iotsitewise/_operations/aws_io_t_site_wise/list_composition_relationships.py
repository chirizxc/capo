"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListCompositionRelationships``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_composition_relationships_response.ListCompositionRelationshipsResponse = capo_iotsitewise.types.list_composition_relationships_response.deserialize_json(
...
async def async_list_composition_relationships(
