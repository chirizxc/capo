...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_default_encryption_configuration_response.DescribeDefaultEncryptionConfigurationResponse = capo_iotsitewise.types.describe_default_encryption_configuration_response.deserialize_json(
