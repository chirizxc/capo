"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ExecuteAction``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.execute_action_response.ExecuteActionResponse = (
        capo_iotsitewise.types.execute_action_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.execute_action_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
