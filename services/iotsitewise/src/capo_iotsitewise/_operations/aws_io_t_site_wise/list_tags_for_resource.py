"""Generated from Smithy shape ``com.amazonaws.iotsitewise#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_iotsitewise.types.list_tags_for_resource_response.deserialize_json(
