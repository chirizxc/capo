...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_dashboards_response.ListDashboardsResponse = (
        capo_iotsitewise.types.list_dashboards_response.deserialize_json(
...
def build_request(
    ...
    if "project_id" in input_:
        params.append(("projectId", input_["project_id"]))
