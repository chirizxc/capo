"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DescribeGatewayCapabilityConfiguration``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_gateway_capability_configuration_response.DescribeGatewayCapabilityConfigurationResponse = capo_iotsitewise.types.describe_gateway_capability_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{capabilityNamespace}", quote(input_["capability_namespace"], safe="")
    )
...
async def async_describe_gateway_capability_configuration(
