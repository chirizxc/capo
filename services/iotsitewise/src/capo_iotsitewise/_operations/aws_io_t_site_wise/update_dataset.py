...
def handle_response(
    ...
    out: capo_iotsitewise.types.update_dataset_response.UpdateDatasetResponse = (
        capo_iotsitewise.types.update_dataset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.update_dataset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
