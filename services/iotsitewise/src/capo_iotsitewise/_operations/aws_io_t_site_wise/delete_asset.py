"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DeleteAsset``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.delete_asset_response.DeleteAssetResponse = (
        capo_iotsitewise.types.delete_asset_response.deserialize_json(
...
def delete_asset(
    ...
    capo_iotsitewise.types.delete_asset_response.DeleteAssetResponse, zapros.Response
]:
