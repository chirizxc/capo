...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_storage_configuration_response.DescribeStorageConfigurationResponse = capo_iotsitewise.types.describe_storage_configuration_response.deserialize_json(
