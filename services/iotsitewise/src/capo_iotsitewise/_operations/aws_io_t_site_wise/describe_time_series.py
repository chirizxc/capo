...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_time_series_response.DescribeTimeSeriesResponse = capo_iotsitewise.types.describe_time_series_response.deserialize_json(
