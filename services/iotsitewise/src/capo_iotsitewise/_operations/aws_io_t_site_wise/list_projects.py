...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_projects_response.ListProjectsResponse = (
        capo_iotsitewise.types.list_projects_response.deserialize_json(
...
def build_request(
    ...
    if "portal_id" in input_:
        params.append(("portalId", input_["portal_id"]))
...
def list_projects(
    ...
    capo_iotsitewise.types.list_projects_response.ListProjectsResponse, zapros.Response
]:
