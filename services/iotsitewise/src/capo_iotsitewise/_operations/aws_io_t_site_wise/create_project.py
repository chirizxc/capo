"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreateProject``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_project_response.CreateProjectResponse = (
        capo_iotsitewise.types.create_project_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_project_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
