...
def handle_response(
    ...
    out: capo_iotsitewise.types.list_assets_response.ListAssetsResponse = (
        capo_iotsitewise.types.list_assets_response.deserialize_json(
...
def build_request(
    ...
    if "asset_model_id" in input_:
        params.append(("assetModelId", input_["asset_model_id"]))
    if "filter" in input_:
        params.append(
            (
                "filter",
                capo_iotsitewise.types.list_assets_filter.serialize_json(
                    input_["filter"]
                ),
            )
        )
...
def list_assets(
    ...
    capo_iotsitewise.types.list_assets_response.ListAssetsResponse, zapros.Response
]:
