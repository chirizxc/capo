...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_asset_model_composite_model_response.CreateAssetModelCompositeModelResponse = capo_iotsitewise.types.create_asset_model_composite_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_asset_model_composite_model_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
