...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_computation_model_response.DescribeComputationModelResponse = capo_iotsitewise.types.describe_computation_model_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{computationModelId}", quote(input_["computation_model_id"], safe="")
    )
    params: list[tuple[str, str]] = []
    if "computation_model_version" in input_:
        params.append(("computationModelVersion", input_["computation_model_version"]))
