...
def handle_response(
    ...
    out: capo_iotsitewise.types.update_asset_response.UpdateAssetResponse = (
        capo_iotsitewise.types.update_asset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.update_asset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_asset(
    ...
    capo_iotsitewise.types.update_asset_response.UpdateAssetResponse, zapros.Response
]:
