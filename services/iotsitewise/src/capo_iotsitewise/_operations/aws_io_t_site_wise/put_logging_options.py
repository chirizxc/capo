"""Generated from Smithy shape ``com.amazonaws.iotsitewise#PutLoggingOptions``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.put_logging_options_response.PutLoggingOptionsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.put_logging_options_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
