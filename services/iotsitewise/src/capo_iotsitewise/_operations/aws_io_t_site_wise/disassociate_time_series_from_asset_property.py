"""Generated from Smithy shape ``com.amazonaws.iotsitewise#DisassociateTimeSeriesFromAssetProperty``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/timeseries/disassociate"
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.disassociate_time_series_from_asset_property_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_time_series_from_asset_property(
