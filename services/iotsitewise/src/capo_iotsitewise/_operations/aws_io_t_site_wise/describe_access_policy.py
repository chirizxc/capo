...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_access_policy_response.DescribeAccessPolicyResponse = capo_iotsitewise.types.describe_access_policy_response.deserialize_json(
