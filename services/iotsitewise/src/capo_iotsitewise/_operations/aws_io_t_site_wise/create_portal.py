"""Generated from Smithy shape ``com.amazonaws.iotsitewise#CreatePortal``."""
...
def handle_response(
    ...
    out: capo_iotsitewise.types.create_portal_response.CreatePortalResponse = (
        capo_iotsitewise.types.create_portal_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotsitewise.types.create_portal_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_portal(
    ...
    capo_iotsitewise.types.create_portal_response.CreatePortalResponse, zapros.Response
]:
