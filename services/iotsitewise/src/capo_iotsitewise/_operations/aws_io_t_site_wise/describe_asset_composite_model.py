...
def handle_response(
    ...
    out: capo_iotsitewise.types.describe_asset_composite_model_response.DescribeAssetCompositeModelResponse = capo_iotsitewise.types.describe_asset_composite_model_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{assetCompositeModelId}", quote(input_["asset_composite_model_id"], safe="")
    )
