"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#UnauthorizedException``."""
...
class UnauthorizedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagentcore#UnauthorizedException``."""
