"""Generated from Smithy shape ``com.amazonaws.bedrockagentcore#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagentcore#InternalServerException``."""
