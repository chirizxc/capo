...
EarthObservationJobList: TypeAlias = list[
    "capo_sagemaker_geospatial.types.list_earth_observation_job_output_config.ListEarthObservationJobOutputConfig"
]
...
def serialize_json(value: EarthObservationJobList) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker_geospatial.types.list_earth_observation_job_output_config.serialize_json(
                item
            )
        )
    return out
