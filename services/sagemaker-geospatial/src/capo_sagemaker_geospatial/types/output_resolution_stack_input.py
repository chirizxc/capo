...
if TYPE_CHECKING:
    import capo_sagemaker_geospatial.types.predefined_resolution
    import capo_sagemaker_geospatial.types.user_defined


class OutputResolutionStackInput(TypedDict, closed=True):
    predefined: NotRequired[
        "capo_sagemaker_geospatial.types.predefined_resolution.PredefinedResolution"
    ]
    ...
    user_defined: NotRequired[
        "capo_sagemaker_geospatial.types.user_defined.UserDefined"
    ]
...
def serialize_json(value: OutputResolutionStackInput) -> dict:
    ...
    if "user_defined" in value:
        ...
        out["UserDefined"] = (
            capo_sagemaker_geospatial.types.user_defined.serialize_json(
                value["user_defined"]
            )
        )
    return out
