...
if TYPE_CHECKING:
    import capo_sagemaker_geospatial.types.vector_enrichment_job_error_type


class VectorEnrichmentJobErrorDetails(TypedDict, closed=True):
    error_type: NotRequired[
        "capo_sagemaker_geospatial.types.vector_enrichment_job_error_type.VectorEnrichmentJobErrorType"
    ]
