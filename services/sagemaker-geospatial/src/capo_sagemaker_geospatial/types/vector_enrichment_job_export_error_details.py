...
if TYPE_CHECKING:
    import capo_sagemaker_geospatial.types.vector_enrichment_job_export_error_type


class VectorEnrichmentJobExportErrorDetails(TypedDict, closed=True):
    type: NotRequired[
        "capo_sagemaker_geospatial.types.vector_enrichment_job_export_error_type.VectorEnrichmentJobExportErrorType"
    ]
