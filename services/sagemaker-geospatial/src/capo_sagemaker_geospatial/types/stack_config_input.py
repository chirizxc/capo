...
class StackConfigInput(TypedDict, closed=True):
    output_resolution: NotRequired[
        "capo_sagemaker_geospatial.types.output_resolution_stack_input.OutputResolutionStackInput"
    ]
...
def serialize_json(value: StackConfigInput) -> dict:
    ...
    if "output_resolution" in value:
        ...
        out["OutputResolution"] = (
            capo_sagemaker_geospatial.types.output_resolution_stack_input.serialize_json(
...
def deserialize_json(data: dict) -> StackConfigInput:
    ...
    if data.get("OutputResolution") is not None:
        ...
        out["output_resolution"] = (
            capo_sagemaker_geospatial.types.output_resolution_stack_input.deserialize_json(
