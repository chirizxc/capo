...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_sagemaker_geospatial.types.list_tags_for_resource_response.deserialize_json(
