"""Generated from Smithy shape ``com.amazonaws.sagemakergeospatial#GetVectorEnrichmentJob``."""
...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.get_vector_enrichment_job_output.GetVectorEnrichmentJobOutput = capo_sagemaker_geospatial.types.get_vector_enrichment_job_output.deserialize_json(
...
async def async_get_vector_enrichment_job(
