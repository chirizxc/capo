...
def handle_response(
    ...
    out: capo_sagemaker_geospatial.types.get_earth_observation_job_output.GetEarthObservationJobOutput = capo_sagemaker_geospatial.types.get_earth_observation_job_output.deserialize_json(
