...
class OpenIDConnectConfig(TypedDict, closed=True):
    issuer: "capo_appsync.types.string.String"
    ...
    client_id: NotRequired["capo_appsync.types.string.String"]
