...
class CodeError(TypedDict, closed=True):
    ...
    location: NotRequired["capo_appsync.types.code_error_location.CodeErrorLocation"]
...
def serialize_json(value: CodeError) -> dict:
    ...
    if "location" in value:
        ...
        out["location"] = capo_appsync.types.code_error_location.serialize_json(
            value["location"]
        )
    return out
