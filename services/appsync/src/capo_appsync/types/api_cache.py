...
class ApiCache(TypedDict, closed=True):
    ...
    api_caching_behavior: NotRequired[
        "capo_appsync.types.api_caching_behavior.ApiCachingBehavior"
    ]
    ...
    transit_encryption_enabled: "capo_appsync.types.boolean.Boolean"
    """<p>Transit encryption flag when connecting to cache. You cannot update this setting after creation.</p>"""
    at_rest_encryption_enabled: "capo_appsync.types.boolean.Boolean"
    """<p>At-rest encryption flag for cache. You cannot update this setting after creation.</p>"""
    type: NotRequired["capo_appsync.types.api_cache_type.ApiCacheType"]
    ...
    status: NotRequired["capo_appsync.types.api_cache_status.ApiCacheStatus"]
...
def serialize_json(value: ApiCache) -> dict:
    ...
    if "api_caching_behavior" in value:
        ...
        out["apiCachingBehavior"] = (
            capo_appsync.types.api_caching_behavior.serialize_json(
    ...
    if "status" in value:
        ...
        out["status"] = capo_appsync.types.api_cache_status.serialize_json(
            value["status"]
        )
