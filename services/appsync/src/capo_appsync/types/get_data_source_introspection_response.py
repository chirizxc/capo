...
class GetDataSourceIntrospectionResponse(TypedDict, closed=True):
    ...
    introspection_result: NotRequired[
        "capo_appsync.types.data_source_introspection_result.DataSourceIntrospectionResult"
    ]
...
def serialize_json(value: GetDataSourceIntrospectionResponse) -> dict:
    ...
    if "introspection_result" in value:
        ...
        out["introspectionResult"] = (
            capo_appsync.types.data_source_introspection_result.serialize_json(
...
def deserialize_json(data: dict) -> GetDataSourceIntrospectionResponse:
    ...
    if data.get("introspectionResult") is not None:
        import capo_appsync.types.data_source_introspection_result

        out["introspection_result"] = (
            capo_appsync.types.data_source_introspection_result.deserialize_json(
