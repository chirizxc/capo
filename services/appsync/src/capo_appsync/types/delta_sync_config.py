...
class DeltaSyncConfig(TypedDict, closed=True):
    base_table_ttl: "capo_appsync.types.long.Long"
    """<p>The number of minutes that an Item is stored in the data source.</p>"""
    delta_sync_table_name: NotRequired["capo_appsync.types.string.String"]
    """<p>The Delta Sync table name.</p>"""
    delta_sync_table_ttl: "capo_appsync.types.long.Long"
