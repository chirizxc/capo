...
if TYPE_CHECKING:
    ...
    import capo_appsync.types.cognito_user_pool_config
...
class AdditionalAuthenticationProvider(TypedDict, closed=True):
    ...
    user_pool_config: NotRequired[
        "capo_appsync.types.cognito_user_pool_config.CognitoUserPoolConfig"
    ]
...
def serialize_json(value: AdditionalAuthenticationProvider) -> dict:
    ...
    if "user_pool_config" in value:
        ...
        out["userPoolConfig"] = (
            capo_appsync.types.cognito_user_pool_config.serialize_json(
...
def deserialize_json(data: dict) -> AdditionalAuthenticationProvider:
    ...
    if data.get("userPoolConfig") is not None:
        ...
        out["user_pool_config"] = (
            capo_appsync.types.cognito_user_pool_config.deserialize_json(
                data["userPoolConfig"]
            )
        )
