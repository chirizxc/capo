...
if TYPE_CHECKING:
    ...
    import capo_appsync.types.owner_contact
...
class Api(TypedDict, closed=True):
    ...
    name: NotRequired["capo_appsync.types.api_name.ApiName"]
    """<p>The name of the <code>Api</code>.</p>"""
    owner_contact: NotRequired["capo_appsync.types.owner_contact.OwnerContact"]
    ...
    api_arn: NotRequired["capo_appsync.types.string.String"]
    ...
    event_config: NotRequired["capo_appsync.types.event_config.EventConfig"]
