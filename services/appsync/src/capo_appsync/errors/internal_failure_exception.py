"""Generated from Smithy shape ``com.amazonaws.appsync#InternalFailureException``."""
...
class InternalFailureException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appsync#InternalFailureException``."""
