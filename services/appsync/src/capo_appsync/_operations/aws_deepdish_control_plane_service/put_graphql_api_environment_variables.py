...
def handle_response(
    ...
    out: capo_appsync.types.put_graphql_api_environment_variables_response.PutGraphqlApiEnvironmentVariablesResponse = capo_appsync.types.put_graphql_api_environment_variables_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.put_graphql_api_environment_variables_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
