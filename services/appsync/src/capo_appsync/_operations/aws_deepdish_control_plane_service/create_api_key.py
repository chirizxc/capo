"""Generated from Smithy shape ``com.amazonaws.appsync#CreateApiKey``."""
...
import capo_appsync.errors.api_key_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApiKeyLimitExceededException":
            raise capo_appsync.errors.api_key_limit_exceeded_exception.ApiKeyLimitExceededException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_appsync.types.create_api_key_response.CreateApiKeyResponse = (
        capo_appsync.types.create_api_key_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.create_api_key_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_api_key(
    ...
    capo_appsync.types.create_api_key_response.CreateApiKeyResponse, zapros.Response
]:
