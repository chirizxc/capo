...
def handle_response(
    ...
    out: capo_appsync.types.create_type_response.CreateTypeResponse = (
        capo_appsync.types.create_type_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.create_type_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_type(
    ...
    input_: capo_appsync.types.create_type_request.CreateTypeRequest,
) -> tuple[capo_appsync.types.create_type_response.CreateTypeResponse, zapros.Response]:
