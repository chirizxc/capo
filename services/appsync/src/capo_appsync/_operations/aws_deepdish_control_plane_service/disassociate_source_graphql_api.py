...
def handle_response(
    ...
    out: capo_appsync.types.disassociate_source_graphql_api_response.DisassociateSourceGraphqlApiResponse = capo_appsync.types.disassociate_source_graphql_api_response.deserialize_json(
