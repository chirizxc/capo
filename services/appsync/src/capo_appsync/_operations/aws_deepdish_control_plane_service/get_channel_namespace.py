"""Generated from Smithy shape ``com.amazonaws.appsync#GetChannelNamespace``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_channel_namespace_response.GetChannelNamespaceResponse = capo_appsync.types.get_channel_namespace_response.deserialize_json(
