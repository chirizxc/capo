"""Generated from Smithy shape ``com.amazonaws.appsync#GetDomainName``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_domain_name_response.GetDomainNameResponse = (
        capo_appsync.types.get_domain_name_response.deserialize_json(
...
def get_domain_name(
    ...
    capo_appsync.types.get_domain_name_response.GetDomainNameResponse, zapros.Response
]:
