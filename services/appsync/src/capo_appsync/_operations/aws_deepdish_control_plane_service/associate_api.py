...
def handle_response(
    ...
    out: capo_appsync.types.associate_api_response.AssociateApiResponse = (
        capo_appsync.types.associate_api_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.associate_api_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def associate_api(
    ...
    capo_appsync.types.associate_api_response.AssociateApiResponse, zapros.Response
]:
