...
def handle_response(
    ...
    out: capo_appsync.types.update_data_source_response.UpdateDataSourceResponse = (
        capo_appsync.types.update_data_source_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.update_data_source_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
