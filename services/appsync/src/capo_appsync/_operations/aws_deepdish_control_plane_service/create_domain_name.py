...
def handle_response(
    ...
    out: capo_appsync.types.create_domain_name_response.CreateDomainNameResponse = (
        capo_appsync.types.create_domain_name_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.create_domain_name_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
