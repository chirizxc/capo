...
def handle_response(
    ...
    out: capo_appsync.types.update_api_cache_response.UpdateApiCacheResponse = (
        capo_appsync.types.update_api_cache_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.update_api_cache_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_api_cache(
    ...
    capo_appsync.types.update_api_cache_response.UpdateApiCacheResponse, zapros.Response
]:
