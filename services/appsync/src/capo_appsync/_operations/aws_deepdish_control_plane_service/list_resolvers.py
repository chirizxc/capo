...
def handle_response(
    ...
    out: capo_appsync.types.list_resolvers_response.ListResolversResponse = (
        capo_appsync.types.list_resolvers_response.deserialize_json(
...
def list_resolvers(
    ...
    capo_appsync.types.list_resolvers_response.ListResolversResponse, zapros.Response
]:
