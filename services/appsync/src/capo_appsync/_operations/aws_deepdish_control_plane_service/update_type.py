...
def handle_response(
    ...
    out: capo_appsync.types.update_type_response.UpdateTypeResponse = (
        capo_appsync.types.update_type_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.update_type_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_type(
    ...
    input_: capo_appsync.types.update_type_request.UpdateTypeRequest,
) -> tuple[capo_appsync.types.update_type_response.UpdateTypeResponse, zapros.Response]:
