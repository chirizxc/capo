...
def handle_response(
    ...
    out: capo_appsync.types.delete_api_key_response.DeleteApiKeyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_api_key(
    ...
    capo_appsync.types.delete_api_key_response.DeleteApiKeyResponse, zapros.Response
]:
