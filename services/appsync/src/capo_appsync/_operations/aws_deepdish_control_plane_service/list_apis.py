...
def handle_response(
    ...
    out: capo_appsync.types.list_apis_response.ListApisResponse = (
        capo_appsync.types.list_apis_response.deserialize_json(
...
def list_apis(
    ...
    input_: capo_appsync.types.list_apis_request.ListApisRequest,
) -> tuple[capo_appsync.types.list_apis_response.ListApisResponse, zapros.Response]:
