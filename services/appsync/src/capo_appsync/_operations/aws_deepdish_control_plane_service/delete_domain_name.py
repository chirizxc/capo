"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteDomainName``."""
...
def handle_response(
    ...
    out: capo_appsync.types.delete_domain_name_response.DeleteDomainNameResponse = {}  # type: ignore[typeddict-item]
    return out
