"""Generated from Smithy shape ``com.amazonaws.appsync#DisassociateApi``."""
...
def handle_response(
    ...
    out: capo_appsync.types.disassociate_api_response.DisassociateApiResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_api(
