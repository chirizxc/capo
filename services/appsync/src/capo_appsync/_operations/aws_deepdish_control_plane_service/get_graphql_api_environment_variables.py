...
def handle_response(
    ...
    out: capo_appsync.types.get_graphql_api_environment_variables_response.GetGraphqlApiEnvironmentVariablesResponse = capo_appsync.types.get_graphql_api_environment_variables_response.deserialize_json(
