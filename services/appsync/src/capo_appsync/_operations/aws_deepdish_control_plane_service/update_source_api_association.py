...
def handle_response(
    ...
    out: capo_appsync.types.update_source_api_association_response.UpdateSourceApiAssociationResponse = capo_appsync.types.update_source_api_association_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.update_source_api_association_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
