"""Generated from Smithy shape ``com.amazonaws.appsync#GetDataSource``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_data_source_response.GetDataSourceResponse = (
        capo_appsync.types.get_data_source_response.deserialize_json(
...
def get_data_source(
    ...
    capo_appsync.types.get_data_source_response.GetDataSourceResponse, zapros.Response
]:
