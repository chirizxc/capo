"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteApiCache``."""
...
def handle_response(
    ...
    out: capo_appsync.types.delete_api_cache_response.DeleteApiCacheResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_api_cache(
    ...
    capo_appsync.types.delete_api_cache_response.DeleteApiCacheResponse, zapros.Response
]:
...
async def async_delete_api_cache(
