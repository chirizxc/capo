"""Generated from Smithy shape ``com.amazonaws.appsync#GetType``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_type_response.GetTypeResponse = (
        capo_appsync.types.get_type_response.deserialize_json(
...
def get_type(
    ...
    input_: capo_appsync.types.get_type_request.GetTypeRequest,
) -> tuple[capo_appsync.types.get_type_response.GetTypeResponse, zapros.Response]:
