"""Generated from Smithy shape ``com.amazonaws.appsync#UpdateChannelNamespace``."""
...
def handle_response(
    ...
    out: capo_appsync.types.update_channel_namespace_response.UpdateChannelNamespaceResponse = capo_appsync.types.update_channel_namespace_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.update_channel_namespace_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_channel_namespace(
