"""Generated from Smithy shape ``com.amazonaws.appsync#CreateApi``."""
...
def handle_response(
    ...
    out: capo_appsync.types.create_api_response.CreateApiResponse = (
        capo_appsync.types.create_api_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.create_api_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_api(
    ...
    input_: capo_appsync.types.create_api_request.CreateApiRequest,
) -> tuple[capo_appsync.types.create_api_response.CreateApiResponse, zapros.Response]:
