"""Generated from Smithy shape ``com.amazonaws.appsync#GetApiCache``."""
...
def handle_response(
    ...
    out: capo_appsync.types.get_api_cache_response.GetApiCacheResponse = (
        capo_appsync.types.get_api_cache_response.deserialize_json(
...
def get_api_cache(
    ...
    capo_appsync.types.get_api_cache_response.GetApiCacheResponse, zapros.Response
]:
