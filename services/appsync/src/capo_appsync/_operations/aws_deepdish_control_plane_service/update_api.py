...
def handle_response(
    ...
    out: capo_appsync.types.update_api_response.UpdateApiResponse = (
        capo_appsync.types.update_api_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.update_api_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_api(
    ...
    input_: capo_appsync.types.update_api_request.UpdateApiRequest,
) -> tuple[capo_appsync.types.update_api_response.UpdateApiResponse, zapros.Response]:
