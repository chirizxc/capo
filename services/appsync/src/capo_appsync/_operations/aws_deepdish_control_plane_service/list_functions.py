"""Generated from Smithy shape ``com.amazonaws.appsync#ListFunctions``."""
...
def handle_response(
    ...
    out: capo_appsync.types.list_functions_response.ListFunctionsResponse = (
        capo_appsync.types.list_functions_response.deserialize_json(
...
def list_functions(
    ...
    capo_appsync.types.list_functions_response.ListFunctionsResponse, zapros.Response
]:
