"""Generated from Smithy shape ``com.amazonaws.appsync#UntagResource``."""
...
def handle_response(
    ...
    out: capo_appsync.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_appsync.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
