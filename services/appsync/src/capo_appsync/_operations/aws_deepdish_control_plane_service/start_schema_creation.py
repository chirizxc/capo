"""Generated from Smithy shape ``com.amazonaws.appsync#StartSchemaCreation``."""
...
def handle_response(
    ...
    out: capo_appsync.types.start_schema_creation_response.StartSchemaCreationResponse = capo_appsync.types.start_schema_creation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appsync.types.start_schema_creation_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_schema_creation(
