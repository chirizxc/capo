"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteApi``."""
...
def handle_response(
    ...
    out: capo_appsync.types.delete_api_response.DeleteApiResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_api(
    ...
    input_: capo_appsync.types.delete_api_request.DeleteApiRequest,
) -> tuple[capo_appsync.types.delete_api_response.DeleteApiResponse, zapros.Response]:
