"""Generated from Smithy shape ``com.amazonaws.appsync#DeleteResolver``."""
...
def handle_response(
    ...
    out: capo_appsync.types.delete_resolver_response.DeleteResolverResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_resolver(
    ...
    capo_appsync.types.delete_resolver_response.DeleteResolverResponse, zapros.Response
]:
...
async def async_delete_resolver(
