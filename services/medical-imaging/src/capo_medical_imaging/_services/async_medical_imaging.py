...
from capo_medical_imaging._services._aws_config import aaws_config
...
class AsyncMedicalImagingClient:
    ...
    async def copy_image_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.copy_image_set_request.CopyImageSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.copy_image_set_response.CopyImageSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.copy_image_set.async_copy_image_set(
    ...
    async def delete_image_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.delete_image_set_request.DeleteImageSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.delete_image_set_response.DeleteImageSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.delete_image_set.async_delete_image_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_dicom_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.get_dicom_import_job_request.GetDICOMImportJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.get_dicom_import_job_response.GetDICOMImportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.get_dicom_import_job.async_get_dicom_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_image_frame(
        ...
        *,
        config_overrides: Optional[AsyncMedicalImagingClientConfig] = None,
    ) -> "AsyncGenerator[capo_medical_imaging.types.get_image_frame_response.GetImageFrameResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.get_image_frame_request.GetImageFrameRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.get_image_frame.async_get_image_frame(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_image_set(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.get_image_set_request.GetImageSetRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.get_image_set_response.GetImageSetResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.get_image_set.async_get_image_set(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_image_set_metadata(
        ...
        *,
    ...
    ) -> "AsyncGenerator[capo_medical_imaging.types.get_image_set_metadata_response.GetImageSetMetadataResponse]":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.get_image_set_metadata_request.GetImageSetMetadataRequest]",
        ) -> AsyncOperationResponse[
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.get_image_set_metadata.async_get_image_set_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_dicom_import_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.list_dicom_import_jobs_request.ListDICOMImportJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.list_dicom_import_jobs_response.ListDICOMImportJobsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.list_dicom_import_jobs.async_list_dicom_import_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_dicom_import_jobs(
        ...
        *,
        ...
        next_token: Optional["capo_medical_imaging.types.next_token.NextToken"] = None,
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[capo_medical_imaging.types.dicom_import_job_summary.DICOMImportJobSummary]":
        _token = next_token
        while True:
    ...
    async def list_image_set_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.list_image_set_versions_request.ListImageSetVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.list_image_set_versions_response.ListImageSetVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.list_image_set_versions.async_list_image_set_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_image_set_versions(
        ...
        *,
        ...
        next_token: Optional["capo_medical_imaging.types.next_token.NextToken"] = None,
        max_results: Optional[int] = None,
    ) -> "AsyncIterator[capo_medical_imaging.types.image_set_properties.ImageSetProperties]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_image_sets(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.search_image_sets_request.SearchImageSetsRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.search_image_sets_response.SearchImageSetsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.search_image_sets.async_search_image_sets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_search_image_sets(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_medical_imaging.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_medical_imaging.types.image_sets_metadata_summary.ImageSetsMetadataSummary]":
        _token = next_token
        while True:
    ...
    async def start_dicom_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.start_dicom_import_job_request.StartDICOMImportJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.start_dicom_import_job_response.StartDICOMImportJobResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.start_dicom_import_job.async_start_dicom_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_image_set_metadata(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_medical_imaging.types.update_image_set_metadata_request.UpdateImageSetMetadataRequest]",
        ) -> AsyncOperationResponse[
            "capo_medical_imaging.types.update_image_set_metadata_response.UpdateImageSetMetadataResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_medical_imaging._operations.ahi_gateway_service.update_image_set_metadata.async_update_image_set_metadata(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
