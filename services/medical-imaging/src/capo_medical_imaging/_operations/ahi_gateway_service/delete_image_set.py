"""Generated from Smithy shape ``com.amazonaws.medicalimaging#DeleteImageSet``."""
...
def handle_response(
    ...
    out: capo_medical_imaging.types.delete_image_set_response.DeleteImageSetResponse = (
        capo_medical_imaging.types.delete_image_set_response.deserialize_json(
...
async def async_delete_image_set(
