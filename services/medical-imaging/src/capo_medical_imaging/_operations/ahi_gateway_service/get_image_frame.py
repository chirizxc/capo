...
import capo_medical_imaging.errors.bad_request_exception
import capo_medical_imaging.errors.conflict_exception
import capo_medical_imaging.errors.internal_server_exception
import capo_medical_imaging.errors.not_acceptable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "BadRequestException":
            raise capo_medical_imaging.errors.bad_request_exception.BadRequestException.from_json(
                data, message
            )
        ...
        case "NotAcceptableException":
            raise capo_medical_imaging.errors.not_acceptable_exception.NotAcceptableException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_medical_imaging.types.get_image_frame_response.GetImageFrameResponse = {
