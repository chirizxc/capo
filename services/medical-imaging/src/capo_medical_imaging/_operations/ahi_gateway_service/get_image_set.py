"""Generated from Smithy shape ``com.amazonaws.medicalimaging#GetImageSet``."""
...
def handle_response(
    ...
    out: capo_medical_imaging.types.get_image_set_response.GetImageSetResponse = (
        capo_medical_imaging.types.get_image_set_response.deserialize_json(
