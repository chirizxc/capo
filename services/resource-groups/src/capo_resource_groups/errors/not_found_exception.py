"""Generated from Smithy shape ``com.amazonaws.resourcegroups#NotFoundException``."""
...
class NotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.resourcegroups#NotFoundException``."""
