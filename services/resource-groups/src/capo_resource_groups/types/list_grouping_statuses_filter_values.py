...
if TYPE_CHECKING:
    import capo_resource_groups.types.list_grouping_statuses_filter_value

ListGroupingStatusesFilterValues: TypeAlias = list[
    "capo_resource_groups.types.list_grouping_statuses_filter_value.ListGroupingStatusesFilterValue"
]
