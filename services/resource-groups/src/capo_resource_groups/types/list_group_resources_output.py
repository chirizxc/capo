...
class ListGroupResourcesOutput(TypedDict, closed=True):
    resources: NotRequired[
        "capo_resource_groups.types.list_group_resources_item_list.ListGroupResourcesItemList"
    ]
...
def serialize_json(value: ListGroupResourcesOutput) -> dict:
    ...
    if "resources" in value:
        ...
        out["Resources"] = (
            capo_resource_groups.types.list_group_resources_item_list.serialize_json(
                value["resources"]
            )
        )
...
def deserialize_json(data: dict) -> ListGroupResourcesOutput:
    ...
    if data.get("Resources") is not None:
        ...
        out["resources"] = (
            capo_resource_groups.types.list_group_resources_item_list.deserialize_json(
                data["Resources"]
            )
        )
