...
def handle_response(
    ...
    out: capo_partnercentral_benefits.types.recall_benefit_application_output.RecallBenefitApplicationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_benefits.types.recall_benefit_application_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
