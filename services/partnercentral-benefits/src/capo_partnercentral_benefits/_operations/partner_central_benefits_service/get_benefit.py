...
def handle_response(
    ...
    out: capo_partnercentral_benefits.types.get_benefit_output.GetBenefitOutput = (
        capo_partnercentral_benefits.types.get_benefit_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_benefits.types.get_benefit_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
