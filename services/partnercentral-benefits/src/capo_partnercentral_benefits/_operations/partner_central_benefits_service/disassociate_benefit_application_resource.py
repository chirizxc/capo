...
def handle_response(
    ...
    out: capo_partnercentral_benefits.types.disassociate_benefit_application_resource_output.DisassociateBenefitApplicationResourceOutput = capo_partnercentral_benefits.types.disassociate_benefit_application_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_partnercentral_benefits.types.disassociate_benefit_application_resource_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
