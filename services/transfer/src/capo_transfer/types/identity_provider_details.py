...
if TYPE_CHECKING:
    import capo_transfer.types.directory_id
    import capo_transfer.types.function
...
class IdentityProviderDetails(TypedDict, closed=True):
    ...
    invocation_role: NotRequired["capo_transfer.types.role.Role"]
...
def serialize_aws_json_1_1(value: IdentityProviderDetails) -> dict:
    ...
    if "sftp_authentication_methods" in value:
        ...
        out["SftpAuthenticationMethods"] = (
            capo_transfer.types.sftp_authentication_methods.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> IdentityProviderDetails:
    ...
    if data.get("SftpAuthenticationMethods") is not None:
        ...
        out["sftp_authentication_methods"] = (
            capo_transfer.types.sftp_authentication_methods.deserialize_aws_json_1_1(
