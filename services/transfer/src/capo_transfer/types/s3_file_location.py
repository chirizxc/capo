...
if TYPE_CHECKING:
    ...
    import capo_transfer.types.s3_etag
    import capo_transfer.types.s3_key
    import capo_transfer.types.s3_version_id
...
class S3FileLocation(TypedDict, closed=True):
    ...
    version_id: NotRequired["capo_transfer.types.s3_version_id.S3VersionId"]
    """<p>Specifies the file version.</p>"""
    etag: NotRequired["capo_transfer.types.s3_etag.S3Etag"]
