"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotthingsgraph#ResourceNotFoundException``."""
