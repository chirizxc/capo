"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#ResourceAlreadyExistsException``."""
...
class ResourceAlreadyExistsException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotthingsgraph#ResourceAlreadyExistsException``."""
