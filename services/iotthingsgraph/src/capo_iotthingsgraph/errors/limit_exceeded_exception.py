"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotthingsgraph#LimitExceededException``."""
