...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.delete_system_template_response.DeleteSystemTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.delete_system_template_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
