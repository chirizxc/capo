"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#GetEntities``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.get_entities_response.GetEntitiesResponse = (
        capo_iotthingsgraph.types.get_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.get_entities_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_entities(
    ...
    capo_iotthingsgraph.types.get_entities_response.GetEntitiesResponse, zapros.Response
]:
