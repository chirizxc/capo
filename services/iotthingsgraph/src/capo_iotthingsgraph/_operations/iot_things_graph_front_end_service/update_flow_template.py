...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.update_flow_template_response.UpdateFlowTemplateResponse = capo_iotthingsgraph.types.update_flow_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.update_flow_template_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
