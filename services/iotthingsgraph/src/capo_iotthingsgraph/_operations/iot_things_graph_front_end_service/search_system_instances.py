...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.search_system_instances_response.SearchSystemInstancesResponse = capo_iotthingsgraph.types.search_system_instances_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.search_system_instances_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
