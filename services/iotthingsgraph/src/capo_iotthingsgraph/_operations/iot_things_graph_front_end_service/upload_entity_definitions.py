"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#UploadEntityDefinitions``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.upload_entity_definitions_response.UploadEntityDefinitionsResponse = capo_iotthingsgraph.types.upload_entity_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.UploadEntityDefinitions"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.upload_entity_definitions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_upload_entity_definitions(
