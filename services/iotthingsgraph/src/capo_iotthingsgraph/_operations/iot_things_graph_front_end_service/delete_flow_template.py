"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DeleteFlowTemplate``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.delete_flow_template_response.DeleteFlowTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.delete_flow_template_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_flow_template(
