"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#DeleteSystemInstance``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.delete_system_instance_response.DeleteSystemInstanceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.DeleteSystemInstance"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.delete_system_instance_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_system_instance(
