"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#GetSystemInstance``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.get_system_instance_response.GetSystemInstanceResponse = capo_iotthingsgraph.types.get_system_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.get_system_instance_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_system_instance(
