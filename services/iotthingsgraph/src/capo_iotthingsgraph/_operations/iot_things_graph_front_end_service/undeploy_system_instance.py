...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.undeploy_system_instance_response.UndeploySystemInstanceResponse = capo_iotthingsgraph.types.undeploy_system_instance_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.undeploy_system_instance_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
