"""Generated from Smithy shape ``com.amazonaws.iotthingsgraph#SearchSystemTemplates``."""
...
def handle_response(
    ...
    out: capo_iotthingsgraph.types.search_system_templates_response.SearchSystemTemplatesResponse = capo_iotthingsgraph.types.search_system_templates_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "IotThingsGraphFrontEndService.SearchSystemTemplates"
    body: bytes | None = json.dumps(
        capo_iotthingsgraph.types.search_system_templates_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_search_system_templates(
