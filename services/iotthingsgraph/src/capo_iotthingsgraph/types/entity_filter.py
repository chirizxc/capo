...
class EntityFilter(TypedDict, closed=True):
    name: NotRequired["capo_iotthingsgraph.types.entity_filter_name.EntityFilterName"]
    ...
    value: NotRequired[
        "capo_iotthingsgraph.types.entity_filter_values.EntityFilterValues"
    ]
...
def serialize_aws_json_1_1(value: EntityFilter) -> dict:
    ...
    if "name" in value:
        ...
        out["name"] = (
            capo_iotthingsgraph.types.entity_filter_name.serialize_aws_json_1_1(
                value["name"]
            )
        )
    if "value" in value:
        ...
        out["value"] = (
            capo_iotthingsgraph.types.entity_filter_values.serialize_aws_json_1_1(
                value["value"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> EntityFilter:
    ...
    if data.get("name") is not None:
        ...
        out["name"] = (
            capo_iotthingsgraph.types.entity_filter_name.deserialize_aws_json_1_1(
                data["name"]
            )
        )
    if data.get("value") is not None:
        ...
        out["value"] = (
            capo_iotthingsgraph.types.entity_filter_values.deserialize_aws_json_1_1(
                data["value"]
            )
        )
    return out
