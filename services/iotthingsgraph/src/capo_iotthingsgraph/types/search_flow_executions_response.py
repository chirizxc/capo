...
class SearchFlowExecutionsResponse(TypedDict, closed=True):
    summaries: NotRequired[
        "capo_iotthingsgraph.types.flow_execution_summaries.FlowExecutionSummaries"
    ]
...
def serialize_aws_json_1_1(value: SearchFlowExecutionsResponse) -> dict:
    ...
    if "summaries" in value:
        ...
        out["summaries"] = (
            capo_iotthingsgraph.types.flow_execution_summaries.serialize_aws_json_1_1(
                value["summaries"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> SearchFlowExecutionsResponse:
    ...
    if data.get("summaries") is not None:
        ...
        out["summaries"] = (
            capo_iotthingsgraph.types.flow_execution_summaries.deserialize_aws_json_1_1(
                data["summaries"]
            )
        )
