...
if TYPE_CHECKING:
    import capo_auditmanager.types.export_destination_type
    import capo_auditmanager.types.s3_url


class DefaultExportDestination(TypedDict, closed=True):
    destination_type: NotRequired[
        "capo_auditmanager.types.export_destination_type.ExportDestinationType"
    ]
...
def serialize_json(value: DefaultExportDestination) -> dict:
    ...
    if "destination_type" in value:
        ...
        out["destinationType"] = (
            capo_auditmanager.types.export_destination_type.serialize_json(
...
def deserialize_json(data: dict) -> DefaultExportDestination:
    ...
    if data.get("destinationType") is not None:
        ...
        out["destination_type"] = (
            capo_auditmanager.types.export_destination_type.deserialize_json(
