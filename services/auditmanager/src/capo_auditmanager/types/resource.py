...
if TYPE_CHECKING:
    import capo_auditmanager.types.generic_arn
    import capo_auditmanager.types.string


class Resource(TypedDict, closed=True):
    arn: NotRequired["capo_auditmanager.types.generic_arn.GenericArn"]
    """<p> The Amazon Resource Name (ARN) for the resource. </p>"""
    value: NotRequired["capo_auditmanager.types.string.String"]
