...
if TYPE_CHECKING:
    import capo_auditmanager.types.hyperlink_name
    import capo_auditmanager.types.url_link


class URL(TypedDict, closed=True):
    hyperlink_name: NotRequired["capo_auditmanager.types.hyperlink_name.HyperlinkName"]
    """<p> The name or word that's used as a hyperlink to the URL. </p>"""
    link: NotRequired["capo_auditmanager.types.url_link.UrlLink"]
