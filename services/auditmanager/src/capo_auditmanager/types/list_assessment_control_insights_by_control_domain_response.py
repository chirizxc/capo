...
class ListAssessmentControlInsightsByControlDomainResponse(TypedDict, closed=True):
    control_insights_by_assessment: NotRequired[
        "capo_auditmanager.types.control_insights_metadata_by_assessment.ControlInsightsMetadataByAssessment"
    ]
...
def serialize_json(value: ListAssessmentControlInsightsByControlDomainResponse) -> dict:
    ...
    if "control_insights_by_assessment" in value:
        ...
        out["controlInsightsByAssessment"] = (
            capo_auditmanager.types.control_insights_metadata_by_assessment.serialize_json(
...
def deserialize_json(
    ...
    if data.get("controlInsightsByAssessment") is not None:
        import capo_auditmanager.types.control_insights_metadata_by_assessment

        out["control_insights_by_assessment"] = (
            capo_auditmanager.types.control_insights_metadata_by_assessment.deserialize_json(
