...
if TYPE_CHECKING:
    import capo_auditmanager.types.assessment_evidence_folder_name
...
class AssessmentEvidenceFolder(TypedDict, closed=True):
    name: NotRequired[
        "capo_auditmanager.types.assessment_evidence_folder_name.AssessmentEvidenceFolderName"
    ]
    """<p> The name of the evidence folder. </p>"""
    date: NotRequired["capo_auditmanager.types.timestamp.Timestamp"]
    ...
    control_id: NotRequired["capo_auditmanager.types.uuid.UUID"]
    ...
    author: NotRequired["capo_auditmanager.types.string.String"]
    """<p> The name of the user who created the evidence folder. </p>"""
    total_evidence: "capo_auditmanager.types.integer.Integer"
    """<p> The total amount of evidence in the evidence folder. </p>"""
    assessment_report_selection_count: "capo_auditmanager.types.integer.Integer"
    """<p> The total count of evidence that's included in the assessment report. </p>"""
    control_name: NotRequired["capo_auditmanager.types.control_name.ControlName"]
    """<p> The name of the control. </p>"""
    evidence_resources_included_count: "capo_auditmanager.types.integer.Integer"
    """<p> The amount of evidence that's included in the evidence folder. </p>"""
    evidence_by_type_configuration_data_count: "capo_auditmanager.types.integer.Integer"
    ...
    evidence_by_type_manual_count: "capo_auditmanager.types.integer.Integer"
    """<p> The number of evidence that falls under the manual category. This evidence is imported manually. </p>"""
    evidence_by_type_compliance_check_count: "capo_auditmanager.types.integer.Integer"
...
def serialize_json(value: AssessmentEvidenceFolder) -> dict:
    ...
    if "date" in value:
        ...
        out["date"] = capo_auditmanager.types.timestamp.serialize_json(value["date"])
