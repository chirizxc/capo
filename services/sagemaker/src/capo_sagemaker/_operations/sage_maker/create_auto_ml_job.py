"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateAutoMLJob``."""
...
import capo_sagemaker.types.create_auto_ml_job_request
import capo_sagemaker.types.create_auto_ml_job_response
...
) -> capo_sagemaker.types.create_auto_ml_job_response.CreateAutoMLJobResponse:
    out: capo_sagemaker.types.create_auto_ml_job_response.CreateAutoMLJobResponse = (
        capo_sagemaker.types.create_auto_ml_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_auto_ml_job_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_auto_ml_job(
