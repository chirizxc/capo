"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListActions``."""
...
import capo_sagemaker.types.list_actions_request
import capo_sagemaker.types.list_actions_response
import capo_sagemaker.types.sort_actions_by
...
) -> capo_sagemaker.types.list_actions_response.ListActionsResponse:
    out: capo_sagemaker.types.list_actions_response.ListActionsResponse = (
        capo_sagemaker.types.list_actions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListActions"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_actions_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_actions(
    ...
    capo_sagemaker.types.list_actions_response.ListActionsResponse, zapros.Response
]:
