"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListMonitoringSchedules``."""
...
import capo_sagemaker.types.list_monitoring_schedules_request
import capo_sagemaker.types.list_monitoring_schedules_response
...
) -> capo_sagemaker.types.list_monitoring_schedules_response.ListMonitoringSchedulesResponse:
    out: capo_sagemaker.types.list_monitoring_schedules_response.ListMonitoringSchedulesResponse = capo_sagemaker.types.list_monitoring_schedules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_monitoring_schedules_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_monitoring_schedules(
