...
import capo_sagemaker.types.describe_artifact_request
import capo_sagemaker.types.describe_artifact_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_artifact_response.DescribeArtifactResponse = (
        capo_sagemaker.types.describe_artifact_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_artifact_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
