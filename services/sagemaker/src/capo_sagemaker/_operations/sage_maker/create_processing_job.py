"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateProcessingJob``."""
...
import capo_sagemaker.types.create_processing_job_request
import capo_sagemaker.types.create_processing_job_response
...
) -> capo_sagemaker.types.create_processing_job_response.CreateProcessingJobResponse:
    out: capo_sagemaker.types.create_processing_job_response.CreateProcessingJobResponse = capo_sagemaker.types.create_processing_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_processing_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_processing_job(
