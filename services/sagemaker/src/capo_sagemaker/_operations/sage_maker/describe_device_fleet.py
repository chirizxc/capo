"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeDeviceFleet``."""
...
import capo_sagemaker.types.describe_device_fleet_request
import capo_sagemaker.types.describe_device_fleet_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_device_fleet_response.DescribeDeviceFleetResponse = capo_sagemaker.types.describe_device_fleet_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeDeviceFleet"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_device_fleet_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_device_fleet(
