...
import capo_sagemaker.types.update_inference_component_runtime_config_input
import capo_sagemaker.types.update_inference_component_runtime_config_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.update_inference_component_runtime_config_output.UpdateInferenceComponentRuntimeConfigOutput = capo_sagemaker.types.update_inference_component_runtime_config_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_inference_component_runtime_config_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
