"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeAIWorkloadConfig``."""
...
import capo_sagemaker.types.describe_ai_workload_config_request
import capo_sagemaker.types.describe_ai_workload_config_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_ai_workload_config_response.DescribeAIWorkloadConfigResponse = capo_sagemaker.types.describe_ai_workload_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeAIWorkloadConfig"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_ai_workload_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_ai_workload_config(
