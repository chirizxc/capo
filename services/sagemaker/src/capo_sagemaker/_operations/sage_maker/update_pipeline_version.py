...
import capo_sagemaker.types.update_pipeline_version_request
import capo_sagemaker.types.update_pipeline_version_response
...
def handle_response(
    ...
    capo_sagemaker.types.update_pipeline_version_response.UpdatePipelineVersionResponse
):
    out: capo_sagemaker.types.update_pipeline_version_response.UpdatePipelineVersionResponse = capo_sagemaker.types.update_pipeline_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_pipeline_version_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
