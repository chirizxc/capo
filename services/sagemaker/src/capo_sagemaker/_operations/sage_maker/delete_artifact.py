"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteArtifact``."""
...
import capo_sagemaker.types.delete_artifact_request
import capo_sagemaker.types.delete_artifact_response
...
) -> capo_sagemaker.types.delete_artifact_response.DeleteArtifactResponse:
    out: capo_sagemaker.types.delete_artifact_response.DeleteArtifactResponse = (
        capo_sagemaker.types.delete_artifact_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteArtifact"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_artifact_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
