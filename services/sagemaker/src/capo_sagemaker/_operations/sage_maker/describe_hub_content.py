"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeHubContent``."""
...
import capo_sagemaker.types.describe_hub_content_request
import capo_sagemaker.types.describe_hub_content_response
...
) -> capo_sagemaker.types.describe_hub_content_response.DescribeHubContentResponse:
    out: capo_sagemaker.types.describe_hub_content_response.DescribeHubContentResponse = capo_sagemaker.types.describe_hub_content_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeHubContent"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_hub_content_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_hub_content(
