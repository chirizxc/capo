"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateAlgorithm``."""
...
import capo_sagemaker.types.create_algorithm_input
import capo_sagemaker.types.create_algorithm_output
...
) -> capo_sagemaker.types.create_algorithm_output.CreateAlgorithmOutput:
    out: capo_sagemaker.types.create_algorithm_output.CreateAlgorithmOutput = (
        capo_sagemaker.types.create_algorithm_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_algorithm_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_algorithm(
    ...
    capo_sagemaker.types.create_algorithm_output.CreateAlgorithmOutput, zapros.Response
]:
...
async def async_create_algorithm(
