"""Generated from Smithy shape ``com.amazonaws.sagemaker#BatchDeleteClusterNodes``."""
...
import capo_sagemaker.types.batch_delete_cluster_nodes_request
import capo_sagemaker.types.batch_delete_cluster_nodes_response
...
) -> capo_sagemaker.types.batch_delete_cluster_nodes_response.BatchDeleteClusterNodesResponse:
    out: capo_sagemaker.types.batch_delete_cluster_nodes_response.BatchDeleteClusterNodesResponse = capo_sagemaker.types.batch_delete_cluster_nodes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.BatchDeleteClusterNodes"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.batch_delete_cluster_nodes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_delete_cluster_nodes(
