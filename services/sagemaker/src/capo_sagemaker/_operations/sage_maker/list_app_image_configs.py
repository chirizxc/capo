"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListAppImageConfigs``."""
...
import capo_sagemaker.types.list_app_image_configs_request
import capo_sagemaker.types.list_app_image_configs_response
...
) -> capo_sagemaker.types.list_app_image_configs_response.ListAppImageConfigsResponse:
    out: capo_sagemaker.types.list_app_image_configs_response.ListAppImageConfigsResponse = capo_sagemaker.types.list_app_image_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListAppImageConfigs"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_app_image_configs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_app_image_configs(
