...
import capo_sagemaker.types.list_aliases_request
import capo_sagemaker.types.list_aliases_response
...
) -> capo_sagemaker.types.list_aliases_response.ListAliasesResponse:
    out: capo_sagemaker.types.list_aliases_response.ListAliasesResponse = (
        capo_sagemaker.types.list_aliases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_aliases_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_aliases(
    ...
    capo_sagemaker.types.list_aliases_response.ListAliasesResponse, zapros.Response
]:
