...
import capo_sagemaker.types.create_domain_request
import capo_sagemaker.types.create_domain_response
...
) -> capo_sagemaker.types.create_domain_response.CreateDomainResponse:
    out: capo_sagemaker.types.create_domain_response.CreateDomainResponse = (
        capo_sagemaker.types.create_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_domain_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_domain(
    ...
    capo_sagemaker.types.create_domain_response.CreateDomainResponse, zapros.Response
]:
