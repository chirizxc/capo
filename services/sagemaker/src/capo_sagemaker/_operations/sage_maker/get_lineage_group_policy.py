...
import capo_sagemaker.types.get_lineage_group_policy_request
import capo_sagemaker.types.get_lineage_group_policy_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.get_lineage_group_policy_response.GetLineageGroupPolicyResponse = capo_sagemaker.types.get_lineage_group_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.get_lineage_group_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
