"""Generated from Smithy shape ``com.amazonaws.sagemaker#ExtendTrainingPlan``."""
...
import capo_sagemaker.types.extend_training_plan_request
import capo_sagemaker.types.extend_training_plan_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.extend_training_plan_response.ExtendTrainingPlanResponse = capo_sagemaker.types.extend_training_plan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ExtendTrainingPlan"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.extend_training_plan_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_extend_training_plan(
