...
import capo_sagemaker.types.update_domain_request
import capo_sagemaker.types.update_domain_response
...
) -> capo_sagemaker.types.update_domain_response.UpdateDomainResponse:
    out: capo_sagemaker.types.update_domain_response.UpdateDomainResponse = (
        capo_sagemaker.types.update_domain_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_domain_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_domain(
    ...
    capo_sagemaker.types.update_domain_response.UpdateDomainResponse, zapros.Response
]:
