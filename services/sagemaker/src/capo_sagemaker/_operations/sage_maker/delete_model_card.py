"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteModelCard``."""
...
import capo_sagemaker.types.delete_model_card_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteModelCard"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_model_card_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_model_card(
