"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeTrainingPlanExtensionHistory``."""
...
import capo_sagemaker.types.describe_training_plan_extension_history_request
import capo_sagemaker.types.describe_training_plan_extension_history_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_training_plan_extension_history_response.DescribeTrainingPlanExtensionHistoryResponse = capo_sagemaker.types.describe_training_plan_extension_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeTrainingPlanExtensionHistory"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_training_plan_extension_history_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_training_plan_extension_history(
