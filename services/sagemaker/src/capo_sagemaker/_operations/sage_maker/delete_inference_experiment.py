"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteInferenceExperiment``."""
...
import capo_sagemaker.types.delete_inference_experiment_request
import capo_sagemaker.types.delete_inference_experiment_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_inference_experiment_response.DeleteInferenceExperimentResponse = capo_sagemaker.types.delete_inference_experiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteInferenceExperiment"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_inference_experiment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_inference_experiment(
