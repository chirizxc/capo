...
import capo_sagemaker.types.create_inference_component_input
import capo_sagemaker.types.create_inference_component_output
...
) -> capo_sagemaker.types.create_inference_component_output.CreateInferenceComponentOutput:
    out: capo_sagemaker.types.create_inference_component_output.CreateInferenceComponentOutput = capo_sagemaker.types.create_inference_component_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_inference_component_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
