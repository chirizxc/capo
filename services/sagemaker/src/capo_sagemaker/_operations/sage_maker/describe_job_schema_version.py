"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeJobSchemaVersion``."""
...
import capo_sagemaker.types.describe_job_schema_version_request
import capo_sagemaker.types.describe_job_schema_version_response
...
) -> capo_sagemaker.types.describe_job_schema_version_response.DescribeJobSchemaVersionResponse:
    out: capo_sagemaker.types.describe_job_schema_version_response.DescribeJobSchemaVersionResponse = capo_sagemaker.types.describe_job_schema_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeJobSchemaVersion"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_job_schema_version_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_job_schema_version(
