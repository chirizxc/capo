"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeTrial``."""
...
import capo_sagemaker.types.describe_trial_request
import capo_sagemaker.types.describe_trial_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_trial_response.DescribeTrialResponse = (
        capo_sagemaker.types.describe_trial_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_trial_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_trial(
    ...
    capo_sagemaker.types.describe_trial_response.DescribeTrialResponse, zapros.Response
]:
...
async def async_describe_trial(
