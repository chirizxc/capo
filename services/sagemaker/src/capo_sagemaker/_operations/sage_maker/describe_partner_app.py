...
) -> capo_sagemaker.types.describe_partner_app_response.DescribePartnerAppResponse:
    out: capo_sagemaker.types.describe_partner_app_response.DescribePartnerAppResponse = capo_sagemaker.types.describe_partner_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_partner_app_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
