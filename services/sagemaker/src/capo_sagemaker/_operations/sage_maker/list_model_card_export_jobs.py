"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListModelCardExportJobs``."""
...
import capo_sagemaker.types.list_model_card_export_jobs_request
import capo_sagemaker.types.list_model_card_export_jobs_response
...
) -> capo_sagemaker.types.list_model_card_export_jobs_response.ListModelCardExportJobsResponse:
    out: capo_sagemaker.types.list_model_card_export_jobs_response.ListModelCardExportJobsResponse = capo_sagemaker.types.list_model_card_export_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListModelCardExportJobs"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_model_card_export_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_model_card_export_jobs(
