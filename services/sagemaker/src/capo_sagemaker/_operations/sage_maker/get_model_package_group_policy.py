"""Generated from Smithy shape ``com.amazonaws.sagemaker#GetModelPackageGroupPolicy``."""
...
import capo_sagemaker.types.get_model_package_group_policy_input
import capo_sagemaker.types.get_model_package_group_policy_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.get_model_package_group_policy_output.GetModelPackageGroupPolicyOutput = capo_sagemaker.types.get_model_package_group_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.GetModelPackageGroupPolicy"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.get_model_package_group_policy_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_model_package_group_policy(
