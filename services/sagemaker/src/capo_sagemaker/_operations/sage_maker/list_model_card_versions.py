...
import capo_sagemaker.types.list_model_card_versions_request
import capo_sagemaker.types.list_model_card_versions_response
...
def handle_response(
    ...
    capo_sagemaker.types.list_model_card_versions_response.ListModelCardVersionsResponse
):
    out: capo_sagemaker.types.list_model_card_versions_response.ListModelCardVersionsResponse = capo_sagemaker.types.list_model_card_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_model_card_versions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
