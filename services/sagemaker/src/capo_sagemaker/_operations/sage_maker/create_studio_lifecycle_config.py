...
import capo_sagemaker.types.create_studio_lifecycle_config_request
import capo_sagemaker.types.create_studio_lifecycle_config_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.create_studio_lifecycle_config_response.CreateStudioLifecycleConfigResponse = capo_sagemaker.types.create_studio_lifecycle_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_studio_lifecycle_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
