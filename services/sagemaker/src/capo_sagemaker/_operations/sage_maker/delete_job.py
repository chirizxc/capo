...
import capo_sagemaker.types.delete_job_request
import capo_sagemaker.types.delete_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_job_response.DeleteJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_job_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_job(
    ...
    input_: capo_sagemaker.types.delete_job_request.DeleteJobRequest,
) -> tuple[capo_sagemaker.types.delete_job_response.DeleteJobResponse, zapros.Response]:
