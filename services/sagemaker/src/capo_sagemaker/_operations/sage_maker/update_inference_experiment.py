...
import capo_sagemaker.types.update_inference_experiment_request
import capo_sagemaker.types.update_inference_experiment_response
...
) -> capo_sagemaker.types.update_inference_experiment_response.UpdateInferenceExperimentResponse:
    out: capo_sagemaker.types.update_inference_experiment_response.UpdateInferenceExperimentResponse = capo_sagemaker.types.update_inference_experiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_inference_experiment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
