...
import capo_sagemaker.types.create_notebook_instance_lifecycle_config_input
import capo_sagemaker.types.create_notebook_instance_lifecycle_config_output
...
) -> capo_sagemaker.types.create_notebook_instance_lifecycle_config_output.CreateNotebookInstanceLifecycleConfigOutput:
    out: capo_sagemaker.types.create_notebook_instance_lifecycle_config_output.CreateNotebookInstanceLifecycleConfigOutput = capo_sagemaker.types.create_notebook_instance_lifecycle_config_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_notebook_instance_lifecycle_config_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
