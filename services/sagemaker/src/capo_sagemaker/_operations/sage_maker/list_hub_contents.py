"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListHubContents``."""
...
import capo_sagemaker.types.list_hub_contents_request
import capo_sagemaker.types.list_hub_contents_response
...
) -> capo_sagemaker.types.list_hub_contents_response.ListHubContentsResponse:
    out: capo_sagemaker.types.list_hub_contents_response.ListHubContentsResponse = (
        capo_sagemaker.types.list_hub_contents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListHubContents"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_hub_contents_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_hub_contents(
