"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListCandidatesForAutoMLJob``."""
...
import capo_sagemaker.types.list_candidates_for_auto_ml_job_request
import capo_sagemaker.types.list_candidates_for_auto_ml_job_response
...
) -> capo_sagemaker.types.list_candidates_for_auto_ml_job_response.ListCandidatesForAutoMLJobResponse:
    out: capo_sagemaker.types.list_candidates_for_auto_ml_job_response.ListCandidatesForAutoMLJobResponse = capo_sagemaker.types.list_candidates_for_auto_ml_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_candidates_for_auto_ml_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_candidates_for_auto_ml_job(
