"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopEdgeDeploymentStage``."""
...
import capo_sagemaker.types.stop_edge_deployment_stage_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StopEdgeDeploymentStage"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_edge_deployment_stage_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_edge_deployment_stage(
