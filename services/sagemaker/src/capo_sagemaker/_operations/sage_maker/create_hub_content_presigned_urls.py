...
import capo_sagemaker.types.create_hub_content_presigned_urls_request
import capo_sagemaker.types.create_hub_content_presigned_urls_response
...
) -> capo_sagemaker.types.create_hub_content_presigned_urls_response.CreateHubContentPresignedUrlsResponse:
    out: capo_sagemaker.types.create_hub_content_presigned_urls_response.CreateHubContentPresignedUrlsResponse = capo_sagemaker.types.create_hub_content_presigned_urls_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_hub_content_presigned_urls_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
