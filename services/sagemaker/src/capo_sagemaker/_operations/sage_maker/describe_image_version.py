"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeImageVersion``."""
...
import capo_sagemaker.types.describe_image_version_request
import capo_sagemaker.types.describe_image_version_response
...
) -> capo_sagemaker.types.describe_image_version_response.DescribeImageVersionResponse:
    out: capo_sagemaker.types.describe_image_version_response.DescribeImageVersionResponse = capo_sagemaker.types.describe_image_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeImageVersion"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_image_version_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_image_version(
