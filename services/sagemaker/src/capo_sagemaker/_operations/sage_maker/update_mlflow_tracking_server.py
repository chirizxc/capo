...
import capo_sagemaker.types.update_mlflow_tracking_server_request
import capo_sagemaker.types.update_mlflow_tracking_server_response
...
) -> capo_sagemaker.types.update_mlflow_tracking_server_response.UpdateMlflowTrackingServerResponse:
    out: capo_sagemaker.types.update_mlflow_tracking_server_response.UpdateMlflowTrackingServerResponse = capo_sagemaker.types.update_mlflow_tracking_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_mlflow_tracking_server_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
