"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListTrainingJobs``."""
...
import capo_sagemaker.types.list_training_jobs_request
import capo_sagemaker.types.list_training_jobs_response
...
) -> capo_sagemaker.types.list_training_jobs_response.ListTrainingJobsResponse:
    out: capo_sagemaker.types.list_training_jobs_response.ListTrainingJobsResponse = (
        capo_sagemaker.types.list_training_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_training_jobs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_training_jobs(
