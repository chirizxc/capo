"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteNotebookInstance``."""
...
import capo_sagemaker.types.delete_notebook_instance_input
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_notebook_instance_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_notebook_instance(
