...
import capo_sagemaker.types.create_model_package_input
import capo_sagemaker.types.create_model_package_output
...
) -> capo_sagemaker.types.create_model_package_output.CreateModelPackageOutput:
    out: capo_sagemaker.types.create_model_package_output.CreateModelPackageOutput = (
        capo_sagemaker.types.create_model_package_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_model_package_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
