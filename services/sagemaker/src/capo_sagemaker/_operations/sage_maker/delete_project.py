"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteProject``."""
...
import capo_sagemaker.types.delete_project_input
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteProject"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_project_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
