"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListHubs``."""
...
import capo_sagemaker.types.list_hubs_request
import capo_sagemaker.types.list_hubs_response
...
) -> capo_sagemaker.types.list_hubs_response.ListHubsResponse:
    out: capo_sagemaker.types.list_hubs_response.ListHubsResponse = (
        capo_sagemaker.types.list_hubs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListHubs"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_hubs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_hubs(
    ...
    input_: capo_sagemaker.types.list_hubs_request.ListHubsRequest,
) -> tuple[capo_sagemaker.types.list_hubs_response.ListHubsResponse, zapros.Response]:
