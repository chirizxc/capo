"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListAutoMLJobs``."""
...
import capo_sagemaker.types.auto_ml_sort_by
import capo_sagemaker.types.auto_ml_sort_order
import capo_sagemaker.types.list_auto_ml_jobs_request
import capo_sagemaker.types.list_auto_ml_jobs_response
...
) -> capo_sagemaker.types.list_auto_ml_jobs_response.ListAutoMLJobsResponse:
    out: capo_sagemaker.types.list_auto_ml_jobs_response.ListAutoMLJobsResponse = (
        capo_sagemaker.types.list_auto_ml_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_auto_ml_jobs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_auto_ml_jobs(
