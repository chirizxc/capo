"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartClusterHealthCheck``."""
...
import capo_sagemaker.types.start_cluster_health_check_request
import capo_sagemaker.types.start_cluster_health_check_response
...
) -> capo_sagemaker.types.start_cluster_health_check_response.StartClusterHealthCheckResponse:
    out: capo_sagemaker.types.start_cluster_health_check_response.StartClusterHealthCheckResponse = capo_sagemaker.types.start_cluster_health_check_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StartClusterHealthCheck"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.start_cluster_health_check_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_cluster_health_check(
