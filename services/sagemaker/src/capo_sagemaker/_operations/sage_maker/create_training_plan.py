"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateTrainingPlan``."""
...
import capo_sagemaker.types.create_training_plan_request
import capo_sagemaker.types.create_training_plan_response
...
) -> capo_sagemaker.types.create_training_plan_response.CreateTrainingPlanResponse:
    out: capo_sagemaker.types.create_training_plan_response.CreateTrainingPlanResponse = capo_sagemaker.types.create_training_plan_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateTrainingPlan"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_training_plan_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_training_plan(
