"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteHub``."""
...
import capo_sagemaker.types.delete_hub_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteHub"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_hub_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
