...
import capo_sagemaker.types.render_ui_template_request
import capo_sagemaker.types.render_ui_template_response
...
) -> capo_sagemaker.types.render_ui_template_response.RenderUiTemplateResponse:
    out: capo_sagemaker.types.render_ui_template_response.RenderUiTemplateResponse = (
        capo_sagemaker.types.render_ui_template_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.render_ui_template_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
