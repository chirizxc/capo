"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteDataQualityJobDefinition``."""
...
import capo_sagemaker.types.delete_data_quality_job_definition_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteDataQualityJobDefinition"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_data_quality_job_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_data_quality_job_definition(
