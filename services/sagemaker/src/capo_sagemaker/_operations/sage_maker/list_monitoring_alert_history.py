"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListMonitoringAlertHistory``."""
...
import capo_sagemaker.types.list_monitoring_alert_history_request
import capo_sagemaker.types.list_monitoring_alert_history_response
import capo_sagemaker.types.monitoring_alert_history_list
import capo_sagemaker.types.monitoring_alert_history_sort_key
...
) -> capo_sagemaker.types.list_monitoring_alert_history_response.ListMonitoringAlertHistoryResponse:
    out: capo_sagemaker.types.list_monitoring_alert_history_response.ListMonitoringAlertHistoryResponse = capo_sagemaker.types.list_monitoring_alert_history_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListMonitoringAlertHistory"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_monitoring_alert_history_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_monitoring_alert_history(
