...
import capo_sagemaker.types.create_training_job_request
import capo_sagemaker.types.create_training_job_response
...
) -> capo_sagemaker.types.create_training_job_response.CreateTrainingJobResponse:
    out: capo_sagemaker.types.create_training_job_response.CreateTrainingJobResponse = (
        capo_sagemaker.types.create_training_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_training_job_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
