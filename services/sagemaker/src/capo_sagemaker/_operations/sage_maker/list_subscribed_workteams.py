...
import capo_sagemaker.types.list_subscribed_workteams_request
import capo_sagemaker.types.list_subscribed_workteams_response
...
) -> capo_sagemaker.types.list_subscribed_workteams_response.ListSubscribedWorkteamsResponse:
    out: capo_sagemaker.types.list_subscribed_workteams_response.ListSubscribedWorkteamsResponse = capo_sagemaker.types.list_subscribed_workteams_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_subscribed_workteams_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
