...
import capo_sagemaker.types.describe_model_explainability_job_definition_request
import capo_sagemaker.types.describe_model_explainability_job_definition_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_model_explainability_job_definition_response.DescribeModelExplainabilityJobDefinitionResponse = capo_sagemaker.types.describe_model_explainability_job_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_model_explainability_job_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
