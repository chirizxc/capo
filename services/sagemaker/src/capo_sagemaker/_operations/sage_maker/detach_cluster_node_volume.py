"""Generated from Smithy shape ``com.amazonaws.sagemaker#DetachClusterNodeVolume``."""
...
import capo_sagemaker.types.detach_cluster_node_volume_request
import capo_sagemaker.types.detach_cluster_node_volume_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.detach_cluster_node_volume_response.DetachClusterNodeVolumeResponse = capo_sagemaker.types.detach_cluster_node_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DetachClusterNodeVolume"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.detach_cluster_node_volume_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_detach_cluster_node_volume(
