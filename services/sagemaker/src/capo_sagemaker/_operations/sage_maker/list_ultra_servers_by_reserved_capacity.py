"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListUltraServersByReservedCapacity``."""
...
import capo_sagemaker.types.list_ultra_servers_by_reserved_capacity_request
import capo_sagemaker.types.list_ultra_servers_by_reserved_capacity_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.list_ultra_servers_by_reserved_capacity_response.ListUltraServersByReservedCapacityResponse = capo_sagemaker.types.list_ultra_servers_by_reserved_capacity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListUltraServersByReservedCapacity"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_ultra_servers_by_reserved_capacity_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_ultra_servers_by_reserved_capacity(
