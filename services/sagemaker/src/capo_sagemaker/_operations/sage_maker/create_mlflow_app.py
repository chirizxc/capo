"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateMlflowApp``."""
...
import capo_sagemaker.types.create_mlflow_app_request
import capo_sagemaker.types.create_mlflow_app_response
...
) -> capo_sagemaker.types.create_mlflow_app_response.CreateMlflowAppResponse:
    out: capo_sagemaker.types.create_mlflow_app_response.CreateMlflowAppResponse = (
        capo_sagemaker.types.create_mlflow_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateMlflowApp"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_mlflow_app_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_mlflow_app(
