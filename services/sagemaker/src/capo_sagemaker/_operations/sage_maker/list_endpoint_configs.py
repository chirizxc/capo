"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListEndpointConfigs``."""
...
import capo_sagemaker.types.endpoint_config_summary_list
import capo_sagemaker.types.list_endpoint_configs_input
import capo_sagemaker.types.list_endpoint_configs_output
...
) -> capo_sagemaker.types.list_endpoint_configs_output.ListEndpointConfigsOutput:
    out: capo_sagemaker.types.list_endpoint_configs_output.ListEndpointConfigsOutput = (
        capo_sagemaker.types.list_endpoint_configs_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_endpoint_configs_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_endpoint_configs(
