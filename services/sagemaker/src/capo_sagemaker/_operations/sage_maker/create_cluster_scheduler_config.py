"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateClusterSchedulerConfig``."""
...
import capo_sagemaker.types.create_cluster_scheduler_config_request
import capo_sagemaker.types.create_cluster_scheduler_config_response
...
) -> capo_sagemaker.types.create_cluster_scheduler_config_response.CreateClusterSchedulerConfigResponse:
    out: capo_sagemaker.types.create_cluster_scheduler_config_response.CreateClusterSchedulerConfigResponse = capo_sagemaker.types.create_cluster_scheduler_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateClusterSchedulerConfig"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_cluster_scheduler_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_cluster_scheduler_config(
