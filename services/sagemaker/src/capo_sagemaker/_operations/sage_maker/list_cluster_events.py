...
import capo_sagemaker.types.list_cluster_events_request
import capo_sagemaker.types.list_cluster_events_response
...
) -> capo_sagemaker.types.list_cluster_events_response.ListClusterEventsResponse:
    out: capo_sagemaker.types.list_cluster_events_response.ListClusterEventsResponse = (
        capo_sagemaker.types.list_cluster_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_cluster_events_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
