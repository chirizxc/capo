"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeHub``."""
...
import capo_sagemaker.types.describe_hub_request
import capo_sagemaker.types.describe_hub_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_hub_response.DescribeHubResponse = (
        capo_sagemaker.types.describe_hub_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeHub"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_hub_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_hub(
    ...
    capo_sagemaker.types.describe_hub_response.DescribeHubResponse, zapros.Response
]:
