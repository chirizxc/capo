...
import capo_sagemaker.types.list_mlflow_tracking_servers_request
import capo_sagemaker.types.list_mlflow_tracking_servers_response
...
) -> capo_sagemaker.types.list_mlflow_tracking_servers_response.ListMlflowTrackingServersResponse:
    out: capo_sagemaker.types.list_mlflow_tracking_servers_response.ListMlflowTrackingServersResponse = capo_sagemaker.types.list_mlflow_tracking_servers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_mlflow_tracking_servers_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
