"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartPipelineExecution``."""
...
import capo_sagemaker.types.start_pipeline_execution_request
import capo_sagemaker.types.start_pipeline_execution_response
...
) -> capo_sagemaker.types.start_pipeline_execution_response.StartPipelineExecutionResponse:
    out: capo_sagemaker.types.start_pipeline_execution_response.StartPipelineExecutionResponse = capo_sagemaker.types.start_pipeline_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StartPipelineExecution"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.start_pipeline_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
