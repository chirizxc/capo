...
import capo_sagemaker.types.create_model_input
import capo_sagemaker.types.create_model_output
...
) -> capo_sagemaker.types.create_model_output.CreateModelOutput:
    out: capo_sagemaker.types.create_model_output.CreateModelOutput = (
        capo_sagemaker.types.create_model_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_model_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_model(
    ...
    input_: capo_sagemaker.types.create_model_input.CreateModelInput,
) -> tuple[capo_sagemaker.types.create_model_output.CreateModelOutput, zapros.Response]:
