...
import capo_sagemaker.types.create_workteam_request
import capo_sagemaker.types.create_workteam_response
...
) -> capo_sagemaker.types.create_workteam_response.CreateWorkteamResponse:
    out: capo_sagemaker.types.create_workteam_response.CreateWorkteamResponse = (
        capo_sagemaker.types.create_workteam_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_workteam_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
