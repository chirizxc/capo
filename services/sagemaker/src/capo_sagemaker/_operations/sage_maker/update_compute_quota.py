...
import capo_sagemaker.types.update_compute_quota_request
import capo_sagemaker.types.update_compute_quota_response
...
) -> capo_sagemaker.types.update_compute_quota_response.UpdateComputeQuotaResponse:
    out: capo_sagemaker.types.update_compute_quota_response.UpdateComputeQuotaResponse = capo_sagemaker.types.update_compute_quota_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_compute_quota_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
