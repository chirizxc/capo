...
import capo_sagemaker.types.describe_mlflow_tracking_server_request
import capo_sagemaker.types.describe_mlflow_tracking_server_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_mlflow_tracking_server_response.DescribeMlflowTrackingServerResponse = capo_sagemaker.types.describe_mlflow_tracking_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_mlflow_tracking_server_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
