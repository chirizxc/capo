"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListUserProfiles``."""
...
import capo_sagemaker.types.list_user_profiles_request
import capo_sagemaker.types.list_user_profiles_response
import capo_sagemaker.types.sort_order
import capo_sagemaker.types.user_profile_list
import capo_sagemaker.types.user_profile_sort_key
...
) -> capo_sagemaker.types.list_user_profiles_response.ListUserProfilesResponse:
    out: capo_sagemaker.types.list_user_profiles_response.ListUserProfilesResponse = (
        capo_sagemaker.types.list_user_profiles_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_user_profiles_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_user_profiles(
