"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteSpace``."""
...
import capo_sagemaker.types.delete_space_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteSpace"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_space_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
