...
import capo_sagemaker.types.update_pipeline_execution_request
import capo_sagemaker.types.update_pipeline_execution_response
...
) -> capo_sagemaker.types.update_pipeline_execution_response.UpdatePipelineExecutionResponse:
    out: capo_sagemaker.types.update_pipeline_execution_response.UpdatePipelineExecutionResponse = capo_sagemaker.types.update_pipeline_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_pipeline_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
