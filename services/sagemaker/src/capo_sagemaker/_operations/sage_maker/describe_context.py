"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeContext``."""
...
import capo_sagemaker.types.describe_context_request
import capo_sagemaker.types.describe_context_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_context_response.DescribeContextResponse = (
        capo_sagemaker.types.describe_context_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeContext"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_context_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
