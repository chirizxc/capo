"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateNotebookInstance``."""
...
import capo_sagemaker.types.create_notebook_instance_input
import capo_sagemaker.types.create_notebook_instance_output
...
) -> capo_sagemaker.types.create_notebook_instance_output.CreateNotebookInstanceOutput:
    out: capo_sagemaker.types.create_notebook_instance_output.CreateNotebookInstanceOutput = capo_sagemaker.types.create_notebook_instance_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_notebook_instance_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_notebook_instance(
