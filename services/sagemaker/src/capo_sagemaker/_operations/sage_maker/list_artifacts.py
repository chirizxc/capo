...
import capo_sagemaker.types.list_artifacts_request
import capo_sagemaker.types.list_artifacts_response
...
) -> capo_sagemaker.types.list_artifacts_response.ListArtifactsResponse:
    out: capo_sagemaker.types.list_artifacts_response.ListArtifactsResponse = (
        capo_sagemaker.types.list_artifacts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_artifacts_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_artifacts(
    ...
    capo_sagemaker.types.list_artifacts_response.ListArtifactsResponse, zapros.Response
]:
