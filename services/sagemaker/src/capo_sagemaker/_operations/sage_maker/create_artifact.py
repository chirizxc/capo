...
import capo_sagemaker.types.create_artifact_request
import capo_sagemaker.types.create_artifact_response
...
) -> capo_sagemaker.types.create_artifact_response.CreateArtifactResponse:
    out: capo_sagemaker.types.create_artifact_response.CreateArtifactResponse = (
        capo_sagemaker.types.create_artifact_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_artifact_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
