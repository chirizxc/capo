...
import capo_sagemaker.types.update_action_request
import capo_sagemaker.types.update_action_response
...
) -> capo_sagemaker.types.update_action_response.UpdateActionResponse:
    out: capo_sagemaker.types.update_action_response.UpdateActionResponse = (
        capo_sagemaker.types.update_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_action_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_action(
    ...
    capo_sagemaker.types.update_action_response.UpdateActionResponse, zapros.Response
]:
