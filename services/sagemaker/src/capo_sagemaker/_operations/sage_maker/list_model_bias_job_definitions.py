"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListModelBiasJobDefinitions``."""
...
import capo_sagemaker.types.list_model_bias_job_definitions_request
import capo_sagemaker.types.list_model_bias_job_definitions_response
...
) -> capo_sagemaker.types.list_model_bias_job_definitions_response.ListModelBiasJobDefinitionsResponse:
    out: capo_sagemaker.types.list_model_bias_job_definitions_response.ListModelBiasJobDefinitionsResponse = capo_sagemaker.types.list_model_bias_job_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListModelBiasJobDefinitions"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_model_bias_job_definitions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_model_bias_job_definitions(
