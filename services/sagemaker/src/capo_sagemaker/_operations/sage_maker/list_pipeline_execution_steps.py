"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListPipelineExecutionSteps``."""
...
import capo_sagemaker.types.list_pipeline_execution_steps_request
import capo_sagemaker.types.list_pipeline_execution_steps_response
import capo_sagemaker.types.pipeline_execution_step_list
...
) -> capo_sagemaker.types.list_pipeline_execution_steps_response.ListPipelineExecutionStepsResponse:
    out: capo_sagemaker.types.list_pipeline_execution_steps_response.ListPipelineExecutionStepsResponse = capo_sagemaker.types.list_pipeline_execution_steps_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListPipelineExecutionSteps"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_pipeline_execution_steps_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_pipeline_execution_steps(
