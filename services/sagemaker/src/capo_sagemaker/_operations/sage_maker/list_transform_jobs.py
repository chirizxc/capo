"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListTransformJobs``."""
...
import capo_sagemaker.types.list_transform_jobs_request
import capo_sagemaker.types.list_transform_jobs_response
...
) -> capo_sagemaker.types.list_transform_jobs_response.ListTransformJobsResponse:
    out: capo_sagemaker.types.list_transform_jobs_response.ListTransformJobsResponse = (
        capo_sagemaker.types.list_transform_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_transform_jobs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_transform_jobs(
