"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateWorkforce``."""
...
import capo_sagemaker.types.update_workforce_request
import capo_sagemaker.types.update_workforce_response
...
) -> capo_sagemaker.types.update_workforce_response.UpdateWorkforceResponse:
    out: capo_sagemaker.types.update_workforce_response.UpdateWorkforceResponse = (
        capo_sagemaker.types.update_workforce_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_workforce_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_workforce(
