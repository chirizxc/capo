...
import capo_sagemaker.types.list_ai_benchmark_jobs_request
import capo_sagemaker.types.list_ai_benchmark_jobs_response
...
) -> capo_sagemaker.types.list_ai_benchmark_jobs_response.ListAIBenchmarkJobsResponse:
    out: capo_sagemaker.types.list_ai_benchmark_jobs_response.ListAIBenchmarkJobsResponse = capo_sagemaker.types.list_ai_benchmark_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_ai_benchmark_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
