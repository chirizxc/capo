"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListFeatureGroups``."""
...
import capo_sagemaker.types.list_feature_groups_request
import capo_sagemaker.types.list_feature_groups_response
...
) -> capo_sagemaker.types.list_feature_groups_response.ListFeatureGroupsResponse:
    out: capo_sagemaker.types.list_feature_groups_response.ListFeatureGroupsResponse = (
        capo_sagemaker.types.list_feature_groups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListFeatureGroups"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_feature_groups_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_feature_groups(
