"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteModelBiasJobDefinition``."""
...
import capo_sagemaker.types.delete_model_bias_job_definition_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteModelBiasJobDefinition"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_model_bias_job_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_model_bias_job_definition(
