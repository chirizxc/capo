"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeAutoMLJob``."""
...
import capo_sagemaker.types.describe_auto_ml_job_request
import capo_sagemaker.types.describe_auto_ml_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_auto_ml_job_response.DescribeAutoMLJobResponse = capo_sagemaker.types.describe_auto_ml_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_auto_ml_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_auto_ml_job(
