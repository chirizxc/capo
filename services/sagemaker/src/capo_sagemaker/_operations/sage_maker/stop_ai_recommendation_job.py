"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopAIRecommendationJob``."""
...
import capo_sagemaker.types.stop_ai_recommendation_job_request
import capo_sagemaker.types.stop_ai_recommendation_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.stop_ai_recommendation_job_response.StopAIRecommendationJobResponse = capo_sagemaker.types.stop_ai_recommendation_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StopAIRecommendationJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_ai_recommendation_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_ai_recommendation_job(
