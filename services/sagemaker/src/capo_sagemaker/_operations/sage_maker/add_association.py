...
import capo_sagemaker.types.add_association_request
import capo_sagemaker.types.add_association_response
...
) -> capo_sagemaker.types.add_association_response.AddAssociationResponse:
    out: capo_sagemaker.types.add_association_response.AddAssociationResponse = (
        capo_sagemaker.types.add_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.add_association_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
