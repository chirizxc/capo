"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteFlowDefinition``."""
...
import capo_sagemaker.types.delete_flow_definition_request
import capo_sagemaker.types.delete_flow_definition_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_flow_definition_response.DeleteFlowDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_flow_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_flow_definition(
