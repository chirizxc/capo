...
import capo_sagemaker.types.get_device_fleet_report_request
import capo_sagemaker.types.get_device_fleet_report_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.get_device_fleet_report_response.GetDeviceFleetReportResponse = capo_sagemaker.types.get_device_fleet_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.get_device_fleet_report_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
