"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListMonitoringExecutions``."""
...
import capo_sagemaker.types.list_monitoring_executions_request
import capo_sagemaker.types.list_monitoring_executions_response
...
) -> capo_sagemaker.types.list_monitoring_executions_response.ListMonitoringExecutionsResponse:
    out: capo_sagemaker.types.list_monitoring_executions_response.ListMonitoringExecutionsResponse = capo_sagemaker.types.list_monitoring_executions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_monitoring_executions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_monitoring_executions(
