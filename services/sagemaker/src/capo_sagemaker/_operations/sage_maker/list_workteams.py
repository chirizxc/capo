"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListWorkteams``."""
...
import capo_sagemaker.types.list_workteams_request
import capo_sagemaker.types.list_workteams_response
import capo_sagemaker.types.list_workteams_sort_by_options
...
def handle_response(
    ...
    out: capo_sagemaker.types.list_workteams_response.ListWorkteamsResponse = (
        capo_sagemaker.types.list_workteams_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_workteams_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_workteams(
    ...
    capo_sagemaker.types.list_workteams_response.ListWorkteamsResponse, zapros.Response
]:
...
async def async_list_workteams(
