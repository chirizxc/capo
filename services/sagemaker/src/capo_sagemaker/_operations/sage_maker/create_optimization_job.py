"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateOptimizationJob``."""
...
import capo_sagemaker.types.create_optimization_job_request
import capo_sagemaker.types.create_optimization_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.create_optimization_job_response.CreateOptimizationJobResponse = capo_sagemaker.types.create_optimization_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateOptimizationJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_optimization_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_optimization_job(
