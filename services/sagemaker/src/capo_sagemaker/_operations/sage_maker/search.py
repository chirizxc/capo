...
import capo_sagemaker.types.search_request
import capo_sagemaker.types.search_response
...
) -> capo_sagemaker.types.search_response.SearchResponse:
    out: capo_sagemaker.types.search_response.SearchResponse = (
        capo_sagemaker.types.search_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.search_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def search(
    options: OperationOptions, input_: capo_sagemaker.types.search_request.SearchRequest
) -> tuple[capo_sagemaker.types.search_response.SearchResponse, zapros.Response]:
