"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListMlflowApps``."""
...
import capo_sagemaker.types.list_mlflow_apps_request
import capo_sagemaker.types.list_mlflow_apps_response
...
) -> capo_sagemaker.types.list_mlflow_apps_response.ListMlflowAppsResponse:
    out: capo_sagemaker.types.list_mlflow_apps_response.ListMlflowAppsResponse = (
        capo_sagemaker.types.list_mlflow_apps_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListMlflowApps"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_mlflow_apps_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_mlflow_apps(
