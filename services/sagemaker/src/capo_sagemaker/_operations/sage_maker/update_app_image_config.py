"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateAppImageConfig``."""
...
import capo_sagemaker.types.update_app_image_config_request
import capo_sagemaker.types.update_app_image_config_response
...
) -> capo_sagemaker.types.update_app_image_config_response.UpdateAppImageConfigResponse:
    out: capo_sagemaker.types.update_app_image_config_response.UpdateAppImageConfigResponse = capo_sagemaker.types.update_app_image_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateAppImageConfig"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_app_image_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_app_image_config(
