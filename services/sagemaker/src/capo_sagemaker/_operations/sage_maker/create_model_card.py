...
import capo_sagemaker.types.create_model_card_request
import capo_sagemaker.types.create_model_card_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.create_model_card_response.CreateModelCardResponse = (
        capo_sagemaker.types.create_model_card_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_model_card_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
