"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateInferenceComponent``."""
...
import capo_sagemaker.types.update_inference_component_input
import capo_sagemaker.types.update_inference_component_output
...
) -> capo_sagemaker.types.update_inference_component_output.UpdateInferenceComponentOutput:
    out: capo_sagemaker.types.update_inference_component_output.UpdateInferenceComponentOutput = capo_sagemaker.types.update_inference_component_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateInferenceComponent"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_inference_component_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_inference_component(
