"""Generated from Smithy shape ``com.amazonaws.sagemaker#BatchRebootClusterNodes``."""
...
import capo_sagemaker.types.batch_reboot_cluster_nodes_request
import capo_sagemaker.types.batch_reboot_cluster_nodes_response
...
) -> capo_sagemaker.types.batch_reboot_cluster_nodes_response.BatchRebootClusterNodesResponse:
    out: capo_sagemaker.types.batch_reboot_cluster_nodes_response.BatchRebootClusterNodesResponse = capo_sagemaker.types.batch_reboot_cluster_nodes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.BatchRebootClusterNodes"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.batch_reboot_cluster_nodes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_reboot_cluster_nodes(
