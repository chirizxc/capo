"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListCodeRepositories``."""
...
import capo_sagemaker.types.code_repository_sort_by
import capo_sagemaker.types.code_repository_sort_order
import capo_sagemaker.types.code_repository_summary_list
import capo_sagemaker.types.creation_time
import capo_sagemaker.types.list_code_repositories_input
import capo_sagemaker.types.list_code_repositories_output
...
) -> capo_sagemaker.types.list_code_repositories_output.ListCodeRepositoriesOutput:
    out: capo_sagemaker.types.list_code_repositories_output.ListCodeRepositoriesOutput = capo_sagemaker.types.list_code_repositories_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_code_repositories_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_code_repositories(
