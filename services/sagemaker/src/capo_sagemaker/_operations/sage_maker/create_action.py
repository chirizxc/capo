...
import capo_sagemaker.types.create_action_request
import capo_sagemaker.types.create_action_response
...
) -> capo_sagemaker.types.create_action_response.CreateActionResponse:
    out: capo_sagemaker.types.create_action_response.CreateActionResponse = (
        capo_sagemaker.types.create_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_action_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_action(
    ...
    capo_sagemaker.types.create_action_response.CreateActionResponse, zapros.Response
]:
