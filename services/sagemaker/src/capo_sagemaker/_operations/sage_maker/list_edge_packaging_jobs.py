...
import capo_sagemaker.types.list_edge_packaging_jobs_request
import capo_sagemaker.types.list_edge_packaging_jobs_response
import capo_sagemaker.types.list_edge_packaging_jobs_sort_by
...
def handle_response(
    ...
    capo_sagemaker.types.list_edge_packaging_jobs_response.ListEdgePackagingJobsResponse
):
    out: capo_sagemaker.types.list_edge_packaging_jobs_response.ListEdgePackagingJobsResponse = capo_sagemaker.types.list_edge_packaging_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_edge_packaging_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
