"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteHyperParameterTuningJob``."""
...
import capo_sagemaker.types.delete_hyper_parameter_tuning_job_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteHyperParameterTuningJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_hyper_parameter_tuning_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_hyper_parameter_tuning_job(
