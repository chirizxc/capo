...
import capo_sagemaker.types.list_pipelines_request
import capo_sagemaker.types.list_pipelines_response
import capo_sagemaker.types.pipeline_summary_list
...
) -> capo_sagemaker.types.list_pipelines_response.ListPipelinesResponse:
    out: capo_sagemaker.types.list_pipelines_response.ListPipelinesResponse = (
        capo_sagemaker.types.list_pipelines_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_pipelines_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_pipelines(
    ...
    capo_sagemaker.types.list_pipelines_response.ListPipelinesResponse, zapros.Response
]:
