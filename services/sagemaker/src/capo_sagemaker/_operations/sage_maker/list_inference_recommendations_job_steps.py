"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListInferenceRecommendationsJobSteps``."""
...
import capo_sagemaker.types.list_inference_recommendations_job_steps_request
import capo_sagemaker.types.list_inference_recommendations_job_steps_response
...
) -> capo_sagemaker.types.list_inference_recommendations_job_steps_response.ListInferenceRecommendationsJobStepsResponse:
    out: capo_sagemaker.types.list_inference_recommendations_job_steps_response.ListInferenceRecommendationsJobStepsResponse = capo_sagemaker.types.list_inference_recommendations_job_steps_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListInferenceRecommendationsJobSteps"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_inference_recommendations_job_steps_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_inference_recommendations_job_steps(
