"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListModels``."""
...
import capo_sagemaker.types.list_models_input
import capo_sagemaker.types.list_models_output
...
) -> capo_sagemaker.types.list_models_output.ListModelsOutput:
    out: capo_sagemaker.types.list_models_output.ListModelsOutput = (
        capo_sagemaker.types.list_models_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_models_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_models(
    ...
    input_: capo_sagemaker.types.list_models_input.ListModelsInput,
) -> tuple[capo_sagemaker.types.list_models_output.ListModelsOutput, zapros.Response]:
