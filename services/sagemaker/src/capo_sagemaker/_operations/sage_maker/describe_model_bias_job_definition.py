"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeModelBiasJobDefinition``."""
...
import capo_sagemaker.types.describe_model_bias_job_definition_request
import capo_sagemaker.types.describe_model_bias_job_definition_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_model_bias_job_definition_response.DescribeModelBiasJobDefinitionResponse = capo_sagemaker.types.describe_model_bias_job_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeModelBiasJobDefinition"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_model_bias_job_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_model_bias_job_definition(
