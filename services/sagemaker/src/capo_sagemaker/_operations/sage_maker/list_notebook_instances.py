"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListNotebookInstances``."""
...
import capo_sagemaker.types.list_notebook_instances_input
import capo_sagemaker.types.list_notebook_instances_output
...
) -> capo_sagemaker.types.list_notebook_instances_output.ListNotebookInstancesOutput:
    out: capo_sagemaker.types.list_notebook_instances_output.ListNotebookInstancesOutput = capo_sagemaker.types.list_notebook_instances_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_notebook_instances_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_notebook_instances(
