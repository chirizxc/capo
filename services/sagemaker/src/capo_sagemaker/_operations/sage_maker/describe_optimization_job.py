...
import capo_sagemaker.types.describe_optimization_job_request
import capo_sagemaker.types.describe_optimization_job_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_optimization_job_response.DescribeOptimizationJobResponse = capo_sagemaker.types.describe_optimization_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_optimization_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
