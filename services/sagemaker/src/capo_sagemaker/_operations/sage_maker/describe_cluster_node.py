...
import capo_sagemaker.types.describe_cluster_node_request
import capo_sagemaker.types.describe_cluster_node_response
...
) -> capo_sagemaker.types.describe_cluster_node_response.DescribeClusterNodeResponse:
    out: capo_sagemaker.types.describe_cluster_node_response.DescribeClusterNodeResponse = capo_sagemaker.types.describe_cluster_node_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_cluster_node_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
