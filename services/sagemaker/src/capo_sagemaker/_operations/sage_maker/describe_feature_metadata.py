"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeFeatureMetadata``."""
...
import capo_sagemaker.types.describe_feature_metadata_request
import capo_sagemaker.types.describe_feature_metadata_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_feature_metadata_response.DescribeFeatureMetadataResponse = capo_sagemaker.types.describe_feature_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeFeatureMetadata"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_feature_metadata_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_feature_metadata(
