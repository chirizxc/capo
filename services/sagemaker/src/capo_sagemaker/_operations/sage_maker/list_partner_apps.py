...
import capo_sagemaker.types.list_partner_apps_request
import capo_sagemaker.types.list_partner_apps_response
...
) -> capo_sagemaker.types.list_partner_apps_response.ListPartnerAppsResponse:
    out: capo_sagemaker.types.list_partner_apps_response.ListPartnerAppsResponse = (
        capo_sagemaker.types.list_partner_apps_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_partner_apps_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
