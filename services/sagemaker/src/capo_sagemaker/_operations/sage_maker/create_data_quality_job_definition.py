"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateDataQualityJobDefinition``."""
...
import capo_sagemaker.types.create_data_quality_job_definition_request
import capo_sagemaker.types.create_data_quality_job_definition_response
...
) -> capo_sagemaker.types.create_data_quality_job_definition_response.CreateDataQualityJobDefinitionResponse:
    out: capo_sagemaker.types.create_data_quality_job_definition_response.CreateDataQualityJobDefinitionResponse = capo_sagemaker.types.create_data_quality_job_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateDataQualityJobDefinition"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_data_quality_job_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_data_quality_job_definition(
