"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateInferenceExperiment``."""
...
import capo_sagemaker.types.create_inference_experiment_request
import capo_sagemaker.types.create_inference_experiment_response
...
) -> capo_sagemaker.types.create_inference_experiment_response.CreateInferenceExperimentResponse:
    out: capo_sagemaker.types.create_inference_experiment_response.CreateInferenceExperimentResponse = capo_sagemaker.types.create_inference_experiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateInferenceExperiment"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_inference_experiment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_inference_experiment(
