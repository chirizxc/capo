...
import capo_sagemaker.types.describe_user_profile_request
import capo_sagemaker.types.describe_user_profile_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_user_profile_response.DescribeUserProfileResponse = capo_sagemaker.types.describe_user_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_user_profile_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
