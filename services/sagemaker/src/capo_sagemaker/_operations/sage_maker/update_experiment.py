"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateExperiment``."""
...
import capo_sagemaker.types.update_experiment_request
import capo_sagemaker.types.update_experiment_response
...
) -> capo_sagemaker.types.update_experiment_response.UpdateExperimentResponse:
    out: capo_sagemaker.types.update_experiment_response.UpdateExperimentResponse = (
        capo_sagemaker.types.update_experiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_experiment_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_experiment(
