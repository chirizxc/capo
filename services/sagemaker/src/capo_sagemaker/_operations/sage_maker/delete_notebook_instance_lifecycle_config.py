...
import capo_sagemaker.types.delete_notebook_instance_lifecycle_config_input
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_notebook_instance_lifecycle_config_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
