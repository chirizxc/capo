"""Generated from Smithy shape ``com.amazonaws.sagemaker#RetryPipelineExecution``."""
...
import capo_sagemaker.types.retry_pipeline_execution_request
import capo_sagemaker.types.retry_pipeline_execution_response
...
) -> capo_sagemaker.types.retry_pipeline_execution_response.RetryPipelineExecutionResponse:
    out: capo_sagemaker.types.retry_pipeline_execution_response.RetryPipelineExecutionResponse = capo_sagemaker.types.retry_pipeline_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.RetryPipelineExecution"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.retry_pipeline_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_retry_pipeline_execution(
