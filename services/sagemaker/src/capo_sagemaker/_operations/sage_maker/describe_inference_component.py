"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeInferenceComponent``."""
...
import capo_sagemaker.types.describe_inference_component_input
import capo_sagemaker.types.describe_inference_component_output
import capo_sagemaker.types.inference_component_deployment_config
import capo_sagemaker.types.inference_component_runtime_config_summary
import capo_sagemaker.types.inference_component_specification_summary
import capo_sagemaker.types.inference_component_specification_summary_list
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_inference_component_output.DescribeInferenceComponentOutput = capo_sagemaker.types.describe_inference_component_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeInferenceComponent"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_inference_component_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_inference_component(
