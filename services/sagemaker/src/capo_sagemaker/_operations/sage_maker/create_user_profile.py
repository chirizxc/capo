"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateUserProfile``."""
...
import capo_sagemaker.types.create_user_profile_request
import capo_sagemaker.types.create_user_profile_response
...
) -> capo_sagemaker.types.create_user_profile_response.CreateUserProfileResponse:
    out: capo_sagemaker.types.create_user_profile_response.CreateUserProfileResponse = (
        capo_sagemaker.types.create_user_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_user_profile_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
