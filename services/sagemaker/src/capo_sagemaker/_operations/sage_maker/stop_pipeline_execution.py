"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopPipelineExecution``."""
...
import capo_sagemaker.types.stop_pipeline_execution_request
import capo_sagemaker.types.stop_pipeline_execution_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.stop_pipeline_execution_response.StopPipelineExecutionResponse = capo_sagemaker.types.stop_pipeline_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.StopPipelineExecution"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_pipeline_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
