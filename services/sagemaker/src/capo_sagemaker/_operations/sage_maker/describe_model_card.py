...
import capo_sagemaker.types.describe_model_card_request
import capo_sagemaker.types.describe_model_card_response
...
) -> capo_sagemaker.types.describe_model_card_response.DescribeModelCardResponse:
    out: capo_sagemaker.types.describe_model_card_response.DescribeModelCardResponse = (
        capo_sagemaker.types.describe_model_card_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_model_card_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
