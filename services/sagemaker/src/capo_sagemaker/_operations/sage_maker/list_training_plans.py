...
import capo_sagemaker.types.list_training_plans_request
import capo_sagemaker.types.list_training_plans_response
...
) -> capo_sagemaker.types.list_training_plans_response.ListTrainingPlansResponse:
    out: capo_sagemaker.types.list_training_plans_response.ListTrainingPlansResponse = (
        capo_sagemaker.types.list_training_plans_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_training_plans_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
