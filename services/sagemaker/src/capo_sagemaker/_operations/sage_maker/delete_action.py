"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteAction``."""
...
import capo_sagemaker.types.delete_action_request
import capo_sagemaker.types.delete_action_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_action_response.DeleteActionResponse = (
        capo_sagemaker.types.delete_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteAction"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_action_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_action(
    ...
    capo_sagemaker.types.delete_action_response.DeleteActionResponse, zapros.Response
]:
