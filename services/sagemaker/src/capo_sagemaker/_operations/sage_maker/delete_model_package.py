"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteModelPackage``."""
...
import capo_sagemaker.types.delete_model_package_input
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_model_package_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_model_package(
