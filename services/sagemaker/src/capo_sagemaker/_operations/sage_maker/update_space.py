"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateSpace``."""
...
import capo_sagemaker.types.update_space_request
import capo_sagemaker.types.update_space_response
...
) -> capo_sagemaker.types.update_space_response.UpdateSpaceResponse:
    out: capo_sagemaker.types.update_space_response.UpdateSpaceResponse = (
        capo_sagemaker.types.update_space_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateSpace"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_space_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_space(
    ...
    capo_sagemaker.types.update_space_response.UpdateSpaceResponse, zapros.Response
]:
