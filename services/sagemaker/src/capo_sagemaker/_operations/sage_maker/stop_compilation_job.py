"""Generated from Smithy shape ``com.amazonaws.sagemaker#StopCompilationJob``."""
...
import capo_sagemaker.types.stop_compilation_job_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.stop_compilation_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_compilation_job(
