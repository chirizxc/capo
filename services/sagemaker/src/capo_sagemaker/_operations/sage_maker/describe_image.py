...
import capo_sagemaker.types.describe_image_request
import capo_sagemaker.types.describe_image_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_image_response.DescribeImageResponse = (
        capo_sagemaker.types.describe_image_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_image_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_image(
    ...
    capo_sagemaker.types.describe_image_response.DescribeImageResponse, zapros.Response
]:
