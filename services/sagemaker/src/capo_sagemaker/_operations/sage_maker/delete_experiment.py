...
import capo_sagemaker.types.delete_experiment_request
import capo_sagemaker.types.delete_experiment_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_experiment_response.DeleteExperimentResponse = (
        capo_sagemaker.types.delete_experiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_experiment_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
