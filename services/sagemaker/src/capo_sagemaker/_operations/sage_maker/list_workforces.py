...
import capo_sagemaker.types.list_workforces_request
import capo_sagemaker.types.list_workforces_response
...
) -> capo_sagemaker.types.list_workforces_response.ListWorkforcesResponse:
    out: capo_sagemaker.types.list_workforces_response.ListWorkforcesResponse = (
        capo_sagemaker.types.list_workforces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_workforces_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
