"""Generated from Smithy shape ``com.amazonaws.sagemaker#RegisterDevices``."""
...
import capo_sagemaker.types.register_devices_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.RegisterDevices"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.register_devices_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
