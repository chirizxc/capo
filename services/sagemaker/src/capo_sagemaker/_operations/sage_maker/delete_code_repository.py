"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteCodeRepository``."""
...
import capo_sagemaker.types.delete_code_repository_input
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_code_repository_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_code_repository(
