"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeSpace``."""
...
import capo_sagemaker.types.describe_space_request
import capo_sagemaker.types.describe_space_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_space_response.DescribeSpaceResponse = (
        capo_sagemaker.types.describe_space_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DescribeSpace"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_space_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_space(
    ...
    capo_sagemaker.types.describe_space_response.DescribeSpaceResponse, zapros.Response
]:
