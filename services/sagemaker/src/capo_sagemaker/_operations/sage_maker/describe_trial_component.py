"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeTrialComponent``."""
...
import capo_sagemaker.types.describe_trial_component_request
import capo_sagemaker.types.describe_trial_component_response
...
import capo_sagemaker.types.trial_component_sources
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_trial_component_response.DescribeTrialComponentResponse = capo_sagemaker.types.describe_trial_component_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_trial_component_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_trial_component(
