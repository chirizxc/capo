"""Generated from Smithy shape ``com.amazonaws.sagemaker#StartMonitoringSchedule``."""
...
import capo_sagemaker.types.start_monitoring_schedule_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.start_monitoring_schedule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_monitoring_schedule(
