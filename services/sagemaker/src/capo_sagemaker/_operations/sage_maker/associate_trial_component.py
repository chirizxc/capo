...
import capo_sagemaker.types.associate_trial_component_request
import capo_sagemaker.types.associate_trial_component_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.associate_trial_component_response.AssociateTrialComponentResponse = capo_sagemaker.types.associate_trial_component_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.associate_trial_component_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
