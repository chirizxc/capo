...
import capo_sagemaker.types.create_space_request
import capo_sagemaker.types.create_space_response
...
) -> capo_sagemaker.types.create_space_response.CreateSpaceResponse:
    out: capo_sagemaker.types.create_space_response.CreateSpaceResponse = (
        capo_sagemaker.types.create_space_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_space_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_space(
    ...
    capo_sagemaker.types.create_space_response.CreateSpaceResponse, zapros.Response
]:
