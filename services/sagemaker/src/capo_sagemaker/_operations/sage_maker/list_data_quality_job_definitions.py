"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListDataQualityJobDefinitions``."""
...
import capo_sagemaker.types.list_data_quality_job_definitions_request
import capo_sagemaker.types.list_data_quality_job_definitions_response
...
) -> capo_sagemaker.types.list_data_quality_job_definitions_response.ListDataQualityJobDefinitionsResponse:
    out: capo_sagemaker.types.list_data_quality_job_definitions_response.ListDataQualityJobDefinitionsResponse = capo_sagemaker.types.list_data_quality_job_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListDataQualityJobDefinitions"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_data_quality_job_definitions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_data_quality_job_definitions(
