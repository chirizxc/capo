"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateContext``."""
...
import capo_sagemaker.types.create_context_request
import capo_sagemaker.types.create_context_response
...
) -> capo_sagemaker.types.create_context_response.CreateContextResponse:
    out: capo_sagemaker.types.create_context_response.CreateContextResponse = (
        capo_sagemaker.types.create_context_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreateContext"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_context_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_context(
    ...
    capo_sagemaker.types.create_context_response.CreateContextResponse, zapros.Response
]:
...
async def async_create_context(
