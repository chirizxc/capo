...
import capo_sagemaker.types.list_model_explainability_job_definitions_request
import capo_sagemaker.types.list_model_explainability_job_definitions_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.list_model_explainability_job_definitions_response.ListModelExplainabilityJobDefinitionsResponse = capo_sagemaker.types.list_model_explainability_job_definitions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_model_explainability_job_definitions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
