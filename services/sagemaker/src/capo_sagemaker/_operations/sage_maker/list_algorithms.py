...
import capo_sagemaker.types.list_algorithms_input
import capo_sagemaker.types.list_algorithms_output
...
) -> capo_sagemaker.types.list_algorithms_output.ListAlgorithmsOutput:
    out: capo_sagemaker.types.list_algorithms_output.ListAlgorithmsOutput = (
        capo_sagemaker.types.list_algorithms_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_algorithms_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_algorithms(
    ...
    capo_sagemaker.types.list_algorithms_output.ListAlgorithmsOutput, zapros.Response
]:
