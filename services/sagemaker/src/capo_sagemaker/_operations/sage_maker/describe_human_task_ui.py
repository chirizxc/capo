"""Generated from Smithy shape ``com.amazonaws.sagemaker#DescribeHumanTaskUi``."""
...
import capo_sagemaker.types.describe_human_task_ui_request
import capo_sagemaker.types.describe_human_task_ui_response
import capo_sagemaker.types.human_task_ui_status
import capo_sagemaker.types.timestamp
import capo_sagemaker.types.ui_template_info
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_human_task_ui_response.DescribeHumanTaskUiResponse = capo_sagemaker.types.describe_human_task_ui_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_human_task_ui_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_human_task_ui(
