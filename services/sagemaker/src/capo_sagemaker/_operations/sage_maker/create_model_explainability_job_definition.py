...
import capo_sagemaker.types.create_model_explainability_job_definition_request
import capo_sagemaker.types.create_model_explainability_job_definition_response
...
) -> capo_sagemaker.types.create_model_explainability_job_definition_response.CreateModelExplainabilityJobDefinitionResponse:
    out: capo_sagemaker.types.create_model_explainability_job_definition_response.CreateModelExplainabilityJobDefinitionResponse = capo_sagemaker.types.create_model_explainability_job_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_model_explainability_job_definition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
