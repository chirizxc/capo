"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteMlflowApp``."""
...
import capo_sagemaker.types.delete_mlflow_app_request
import capo_sagemaker.types.delete_mlflow_app_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_mlflow_app_response.DeleteMlflowAppResponse = (
        capo_sagemaker.types.delete_mlflow_app_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteMlflowApp"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_mlflow_app_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_mlflow_app(
