...
import capo_sagemaker.types.describe_auto_ml_job_v2_request
import capo_sagemaker.types.describe_auto_ml_job_v2_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_auto_ml_job_v2_response.DescribeAutoMLJobV2Response = capo_sagemaker.types.describe_auto_ml_job_v2_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_auto_ml_job_v2_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
