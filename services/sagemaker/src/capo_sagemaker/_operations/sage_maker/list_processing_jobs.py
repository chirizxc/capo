"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListProcessingJobs``."""
...
import capo_sagemaker.types.list_processing_jobs_request
import capo_sagemaker.types.list_processing_jobs_response
...
) -> capo_sagemaker.types.list_processing_jobs_response.ListProcessingJobsResponse:
    out: capo_sagemaker.types.list_processing_jobs_response.ListProcessingJobsResponse = capo_sagemaker.types.list_processing_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_processing_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_processing_jobs(
