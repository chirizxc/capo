...
import capo_sagemaker.types.describe_pipeline_definition_for_execution_request
import capo_sagemaker.types.describe_pipeline_definition_for_execution_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_pipeline_definition_for_execution_response.DescribePipelineDefinitionForExecutionResponse = capo_sagemaker.types.describe_pipeline_definition_for_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_pipeline_definition_for_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
