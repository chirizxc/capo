"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListTrainingJobsForHyperParameterTuningJob``."""
...
import capo_sagemaker.types.list_training_jobs_for_hyper_parameter_tuning_job_request
import capo_sagemaker.types.list_training_jobs_for_hyper_parameter_tuning_job_response
...
) -> capo_sagemaker.types.list_training_jobs_for_hyper_parameter_tuning_job_response.ListTrainingJobsForHyperParameterTuningJobResponse:
    out: capo_sagemaker.types.list_training_jobs_for_hyper_parameter_tuning_job_response.ListTrainingJobsForHyperParameterTuningJobResponse = capo_sagemaker.types.list_training_jobs_for_hyper_parameter_tuning_job_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_sagemaker._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListTrainingJobsForHyperParameterTuningJob"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_training_jobs_for_hyper_parameter_tuning_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_training_jobs_for_hyper_parameter_tuning_job(
