"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListStudioLifecycleConfigs``."""
...
import capo_sagemaker.types.list_studio_lifecycle_configs_request
import capo_sagemaker.types.list_studio_lifecycle_configs_response
...
) -> capo_sagemaker.types.list_studio_lifecycle_configs_response.ListStudioLifecycleConfigsResponse:
    out: capo_sagemaker.types.list_studio_lifecycle_configs_response.ListStudioLifecycleConfigsResponse = capo_sagemaker.types.list_studio_lifecycle_configs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListStudioLifecycleConfigs"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_studio_lifecycle_configs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_studio_lifecycle_configs(
