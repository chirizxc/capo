"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateWorkteam``."""
...
import capo_sagemaker.types.update_workteam_request
import capo_sagemaker.types.update_workteam_response
...
) -> capo_sagemaker.types.update_workteam_response.UpdateWorkteamResponse:
    out: capo_sagemaker.types.update_workteam_response.UpdateWorkteamResponse = (
        capo_sagemaker.types.update_workteam_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_workteam_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_workteam(
