"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListOptimizationJobs``."""
...
import capo_sagemaker.types.list_optimization_jobs_request
import capo_sagemaker.types.list_optimization_jobs_response
...
) -> capo_sagemaker.types.list_optimization_jobs_response.ListOptimizationJobsResponse:
    out: capo_sagemaker.types.list_optimization_jobs_response.ListOptimizationJobsResponse = capo_sagemaker.types.list_optimization_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListOptimizationJobs"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_optimization_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_optimization_jobs(
