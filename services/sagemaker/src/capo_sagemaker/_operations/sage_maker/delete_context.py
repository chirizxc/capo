"""Generated from Smithy shape ``com.amazonaws.sagemaker#DeleteContext``."""
...
import capo_sagemaker.types.delete_context_request
import capo_sagemaker.types.delete_context_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_context_response.DeleteContextResponse = (
        capo_sagemaker.types.delete_context_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.DeleteContext"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_context_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_context(
    ...
    capo_sagemaker.types.delete_context_response.DeleteContextResponse, zapros.Response
]:
...
async def async_delete_context(
