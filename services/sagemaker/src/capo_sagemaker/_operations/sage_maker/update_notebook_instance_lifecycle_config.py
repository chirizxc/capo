"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateNotebookInstanceLifecycleConfig``."""
...
import capo_sagemaker.types.update_notebook_instance_lifecycle_config_input
import capo_sagemaker.types.update_notebook_instance_lifecycle_config_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.update_notebook_instance_lifecycle_config_output.UpdateNotebookInstanceLifecycleConfigOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_notebook_instance_lifecycle_config_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_notebook_instance_lifecycle_config(
