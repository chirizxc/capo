"""Generated from Smithy shape ``com.amazonaws.sagemaker#SendPipelineExecutionStepFailure``."""
...
import capo_sagemaker.types.send_pipeline_execution_step_failure_request
import capo_sagemaker.types.send_pipeline_execution_step_failure_response
...
) -> capo_sagemaker.types.send_pipeline_execution_step_failure_response.SendPipelineExecutionStepFailureResponse:
    out: capo_sagemaker.types.send_pipeline_execution_step_failure_response.SendPipelineExecutionStepFailureResponse = capo_sagemaker.types.send_pipeline_execution_step_failure_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.SendPipelineExecutionStepFailure"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.send_pipeline_execution_step_failure_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_send_pipeline_execution_step_failure(
