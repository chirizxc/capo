"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreatePresignedMlflowAppUrl``."""
...
import capo_sagemaker.types.create_presigned_mlflow_app_url_request
import capo_sagemaker.types.create_presigned_mlflow_app_url_response
...
) -> capo_sagemaker.types.create_presigned_mlflow_app_url_response.CreatePresignedMlflowAppUrlResponse:
    out: capo_sagemaker.types.create_presigned_mlflow_app_url_response.CreatePresignedMlflowAppUrlResponse = capo_sagemaker.types.create_presigned_mlflow_app_url_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.CreatePresignedMlflowAppUrl"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_presigned_mlflow_app_url_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_presigned_mlflow_app_url(
