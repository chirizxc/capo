"""Generated from Smithy shape ``com.amazonaws.sagemaker#CreateMonitoringSchedule``."""
...
import capo_sagemaker.types.create_monitoring_schedule_request
import capo_sagemaker.types.create_monitoring_schedule_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.create_monitoring_schedule_response.CreateMonitoringScheduleResponse = capo_sagemaker.types.create_monitoring_schedule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_monitoring_schedule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_monitoring_schedule(
