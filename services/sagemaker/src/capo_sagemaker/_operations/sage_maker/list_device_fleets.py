"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListDeviceFleets``."""
...
import capo_sagemaker.types.list_device_fleets_request
import capo_sagemaker.types.list_device_fleets_response
...
) -> capo_sagemaker.types.list_device_fleets_response.ListDeviceFleetsResponse:
    out: capo_sagemaker.types.list_device_fleets_response.ListDeviceFleetsResponse = (
        capo_sagemaker.types.list_device_fleets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.ListDeviceFleets"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_device_fleets_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_device_fleets(
