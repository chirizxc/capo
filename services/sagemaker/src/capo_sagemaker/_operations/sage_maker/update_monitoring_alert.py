"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateMonitoringAlert``."""
...
import capo_sagemaker.types.update_monitoring_alert_request
import capo_sagemaker.types.update_monitoring_alert_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.update_monitoring_alert_response.UpdateMonitoringAlertResponse = capo_sagemaker.types.update_monitoring_alert_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateMonitoringAlert"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_monitoring_alert_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_monitoring_alert(
