...
import capo_sagemaker.types.describe_code_repository_input
import capo_sagemaker.types.describe_code_repository_output
...
def handle_response(
    ...
    out: capo_sagemaker.types.describe_code_repository_output.DescribeCodeRepositoryOutput = capo_sagemaker.types.describe_code_repository_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.describe_code_repository_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
