"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateFeatureMetadata``."""
...
import capo_sagemaker.types.update_feature_metadata_request
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateFeatureMetadata"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_feature_metadata_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_feature_metadata(
