"""Generated from Smithy shape ``com.amazonaws.sagemaker#ListModelPackages``."""
...
import capo_sagemaker.types.list_model_packages_input
import capo_sagemaker.types.list_model_packages_output
...
) -> capo_sagemaker.types.list_model_packages_output.ListModelPackagesOutput:
    out: capo_sagemaker.types.list_model_packages_output.ListModelPackagesOutput = (
        capo_sagemaker.types.list_model_packages_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.list_model_packages_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_model_packages(
