...
import capo_sagemaker.types.create_model_package_group_input
import capo_sagemaker.types.create_model_package_group_output
...
def handle_response(
    ...
    capo_sagemaker.types.create_model_package_group_output.CreateModelPackageGroupOutput
):
    out: capo_sagemaker.types.create_model_package_group_output.CreateModelPackageGroupOutput = capo_sagemaker.types.create_model_package_group_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.create_model_package_group_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
