"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateClusterSchedulerConfig``."""
...
import capo_sagemaker.types.update_cluster_scheduler_config_request
import capo_sagemaker.types.update_cluster_scheduler_config_response
...
) -> capo_sagemaker.types.update_cluster_scheduler_config_response.UpdateClusterSchedulerConfigResponse:
    out: capo_sagemaker.types.update_cluster_scheduler_config_response.UpdateClusterSchedulerConfigResponse = capo_sagemaker.types.update_cluster_scheduler_config_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "SageMaker.UpdateClusterSchedulerConfig"
    body: bytes | None = json.dumps(
        capo_sagemaker.types.update_cluster_scheduler_config_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_cluster_scheduler_config(
