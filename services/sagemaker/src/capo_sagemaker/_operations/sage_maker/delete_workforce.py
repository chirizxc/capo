...
import capo_sagemaker.types.delete_workforce_request
import capo_sagemaker.types.delete_workforce_response
...
def handle_response(
    ...
    out: capo_sagemaker.types.delete_workforce_response.DeleteWorkforceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_sagemaker.types.delete_workforce_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
