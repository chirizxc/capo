...
if TYPE_CHECKING:
    import capo_sagemaker.types.transform_environment_key
    import capo_sagemaker.types.transform_environment_value

TransformEnvironmentMap: TypeAlias = dict[
    "capo_sagemaker.types.transform_environment_key.TransformEnvironmentKey",
    "capo_sagemaker.types.transform_environment_value.TransformEnvironmentValue",
]
