...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.auto_ml_max_results
    import capo_sagemaker.types.auto_ml_name_contains
...
class ListAutoMLJobsRequest(TypedDict, closed=True):
    ...
    name_contains: NotRequired[
        "capo_sagemaker.types.auto_ml_name_contains.AutoMLNameContains"
    ]
    ...
    sort_by: NotRequired["capo_sagemaker.types.auto_ml_sort_by.AutoMLSortBy"]
    """<p>The parameter by which to sort the results. The default is <code>Name</code>.</p>"""
    max_results: NotRequired[
        "capo_sagemaker.types.auto_ml_max_results.AutoMLMaxResults"
    ]
...
def serialize_aws_json_1_1(value: ListAutoMLJobsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.auto_ml_sort_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListAutoMLJobsRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = capo_sagemaker.types.auto_ml_sort_by.deserialize_aws_json_1_1(
            data["SortBy"]
        )
