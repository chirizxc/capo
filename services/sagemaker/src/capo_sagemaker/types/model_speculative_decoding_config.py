...
class ModelSpeculativeDecodingConfig(TypedDict, closed=True):
    technique: NotRequired[
        "capo_sagemaker.types.model_speculative_decoding_technique.ModelSpeculativeDecodingTechnique"
    ]
    """<p>The speculative decoding technique to apply during model optimization.</p>"""
    training_data_source: NotRequired[
        "capo_sagemaker.types.model_speculative_decoding_training_data_source.ModelSpeculativeDecodingTrainingDataSource"
    ]
...
def serialize_aws_json_1_1(value: ModelSpeculativeDecodingConfig) -> dict:
    ...
    if "technique" in value:
        ...
        out["Technique"] = (
            capo_sagemaker.types.model_speculative_decoding_technique.serialize_aws_json_1_1(
                value["technique"]
            )
        )
    if "training_data_source" in value:
        ...
        out["TrainingDataSource"] = (
            capo_sagemaker.types.model_speculative_decoding_training_data_source.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ModelSpeculativeDecodingConfig:
    ...
    if data.get("Technique") is not None:
        ...
        out["technique"] = (
            capo_sagemaker.types.model_speculative_decoding_technique.deserialize_aws_json_1_1(
                data["Technique"]
            )
        )
    if data.get("TrainingDataSource") is not None:
        ...
        out["training_data_source"] = (
            capo_sagemaker.types.model_speculative_decoding_training_data_source.deserialize_aws_json_1_1(
