...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.content_column
    import capo_sagemaker.types.target_label_column
...
class TextClassificationJobConfig(TypedDict, closed=True):
    ...
    content_column: NotRequired["capo_sagemaker.types.content_column.ContentColumn"]
    ...
    target_label_column: NotRequired[
        "capo_sagemaker.types.target_label_column.TargetLabelColumn"
    ]
