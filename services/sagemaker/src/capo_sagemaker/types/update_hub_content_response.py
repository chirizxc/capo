"""Generated from Smithy shape ``com.amazonaws.sagemaker#UpdateHubContentResponse``."""
...
class UpdateHubContentResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateHubContentResponse) -> dict:
    out: dict = {}
    if "hub_arn" in value:
...
def deserialize_aws_json_1_1(data: dict) -> UpdateHubContentResponse:
    out: UpdateHubContentResponse = {}  # type: ignore[typeddict-item]
