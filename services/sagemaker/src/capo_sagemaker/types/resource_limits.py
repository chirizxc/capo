...
if TYPE_CHECKING:
    import capo_sagemaker.types.hyper_parameter_tuning_max_runtime_in_seconds
    import capo_sagemaker.types.max_number_of_training_jobs
    import capo_sagemaker.types.max_parallel_training_jobs


class ResourceLimits(TypedDict, closed=True):
    max_number_of_training_jobs: NotRequired[
        "capo_sagemaker.types.max_number_of_training_jobs.MaxNumberOfTrainingJobs"
    ]
    ...
    max_parallel_training_jobs: NotRequired[
        "capo_sagemaker.types.max_parallel_training_jobs.MaxParallelTrainingJobs"
    ]
    ...
    max_runtime_in_seconds: NotRequired[
        "capo_sagemaker.types.hyper_parameter_tuning_max_runtime_in_seconds.HyperParameterTuningMaxRuntimeInSeconds"
    ]
