...
class DescribeModelCardExportJobResponse(TypedDict, closed=True):
    ...
    export_artifacts: NotRequired[
        "capo_sagemaker.types.model_card_export_artifacts.ModelCardExportArtifacts"
    ]
...
def serialize_aws_json_1_1(value: DescribeModelCardExportJobResponse) -> dict:
    ...
    if "output_config" in value:
        ...
        out["OutputConfig"] = (
            capo_sagemaker.types.model_card_export_output_config.serialize_aws_json_1_1(
                value["output_config"]
            )
        )
    ...
    if "export_artifacts" in value:
        ...
        out["ExportArtifacts"] = (
            capo_sagemaker.types.model_card_export_artifacts.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeModelCardExportJobResponse:
    ...
    if data.get("OutputConfig") is not None:
        ...
        out["output_config"] = (
            capo_sagemaker.types.model_card_export_output_config.deserialize_aws_json_1_1(
                data["OutputConfig"]
            )
        )
    ...
    if data.get("ExportArtifacts") is not None:
        ...
        out["export_artifacts"] = (
            capo_sagemaker.types.model_card_export_artifacts.deserialize_aws_json_1_1(
