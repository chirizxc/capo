...
class ModelQualityAppSpecification(TypedDict, closed=True):
    ...
    problem_type: NotRequired[
        "capo_sagemaker.types.monitoring_problem_type.MonitoringProblemType"
    ]
...
def serialize_aws_json_1_1(value: ModelQualityAppSpecification) -> dict:
    ...
    if "problem_type" in value:
        ...
        out["ProblemType"] = (
            capo_sagemaker.types.monitoring_problem_type.serialize_aws_json_1_1(
                value["problem_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ModelQualityAppSpecification:
    ...
    if data.get("ProblemType") is not None:
        ...
        out["problem_type"] = (
            capo_sagemaker.types.monitoring_problem_type.deserialize_aws_json_1_1(
                data["ProblemType"]
            )
        )
