...
class DeviceSummary(TypedDict, closed=True):
    ...
    models: NotRequired["capo_sagemaker.types.edge_model_summaries.EdgeModelSummaries"]
...
def serialize_aws_json_1_1(value: DeviceSummary) -> dict:
    ...
    if "models" in value:
        ...
        out["Models"] = (
            capo_sagemaker.types.edge_model_summaries.serialize_aws_json_1_1(
                value["models"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DeviceSummary:
    ...
    if data.get("Models") is not None:
        ...
        out["models"] = (
            capo_sagemaker.types.edge_model_summaries.deserialize_aws_json_1_1(
                data["Models"]
            )
        )
