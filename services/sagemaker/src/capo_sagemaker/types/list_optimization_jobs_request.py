...
class ListOptimizationJobsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.list_optimization_jobs_sort_by.ListOptimizationJobsSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListOptimizationJobsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.list_optimization_jobs_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListOptimizationJobsRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.list_optimization_jobs_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
