...
class ListTrialsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["capo_sagemaker.types.sort_trials_by.SortTrialsBy"]
...
def serialize_aws_json_1_1(value: ListTrialsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.sort_trials_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListTrialsRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = capo_sagemaker.types.sort_trials_by.deserialize_aws_json_1_1(
            data["SortBy"]
        )
