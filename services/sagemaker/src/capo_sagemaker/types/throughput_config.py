"""Generated from Smithy shape ``com.amazonaws.sagemaker#ThroughputConfig``."""
...
class ThroughputConfig(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ThroughputConfig) -> dict:
    out: dict = {}
