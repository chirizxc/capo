...
if TYPE_CHECKING:
    import capo_sagemaker.types.labeling_job_algorithm_specification_arn
...
class LabelingJobAlgorithmsConfig(TypedDict, closed=True):
    labeling_job_algorithm_specification_arn: NotRequired[
        "capo_sagemaker.types.labeling_job_algorithm_specification_arn.LabelingJobAlgorithmSpecificationArn"
    ]
    ...
    initial_active_learning_model_arn: NotRequired[
        "capo_sagemaker.types.model_arn.ModelArn"
    ]
    ...
    labeling_job_resource_config: NotRequired[
        "capo_sagemaker.types.labeling_job_resource_config.LabelingJobResourceConfig"
    ]
...
def serialize_aws_json_1_1(value: LabelingJobAlgorithmsConfig) -> dict:
    ...
    if "labeling_job_resource_config" in value:
        ...
        out["LabelingJobResourceConfig"] = (
            capo_sagemaker.types.labeling_job_resource_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LabelingJobAlgorithmsConfig:
    ...
    if data.get("LabelingJobResourceConfig") is not None:
        ...
        out["labeling_job_resource_config"] = (
            capo_sagemaker.types.labeling_job_resource_config.deserialize_aws_json_1_1(
