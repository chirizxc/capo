...
if TYPE_CHECKING:
    import capo_sagemaker.types.max_number_of_training_jobs_not_improving


class BestObjectiveNotImproving(TypedDict, closed=True):
    max_number_of_training_jobs_not_improving: NotRequired[
        "capo_sagemaker.types.max_number_of_training_jobs_not_improving.MaxNumberOfTrainingJobsNotImproving"
    ]
...
def deserialize_aws_json_1_1(data: dict) -> BestObjectiveNotImproving:
    ...
    if data.get("MaxNumberOfTrainingJobsNotImproving") is not None:
