"""Generated from Smithy shape ``com.amazonaws.sagemaker#AttachClusterNodeVolumeResponse``."""
...
class AttachClusterNodeVolumeResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: AttachClusterNodeVolumeResponse) -> dict:
    out: dict = {}
