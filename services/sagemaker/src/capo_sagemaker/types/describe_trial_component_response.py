...
class DescribeTrialComponentResponse(TypedDict, closed=True):
    ...
    sources: NotRequired[
        "capo_sagemaker.types.trial_component_sources.TrialComponentSources"
    ]
...
def serialize_aws_json_1_1(value: DescribeTrialComponentResponse) -> dict:
    ...
    if "sources" in value:
        ...
        out["Sources"] = (
            capo_sagemaker.types.trial_component_sources.serialize_aws_json_1_1(
                value["sources"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTrialComponentResponse:
    ...
    if data.get("Sources") is not None:
        ...
        out["sources"] = (
            capo_sagemaker.types.trial_component_sources.deserialize_aws_json_1_1(
                data["Sources"]
            )
        )
    return out
