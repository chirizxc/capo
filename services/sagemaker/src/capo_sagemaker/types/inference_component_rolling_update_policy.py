...
if TYPE_CHECKING:
    import capo_sagemaker.types.inference_component_capacity_size
...
class InferenceComponentRollingUpdatePolicy(TypedDict, closed=True):
    maximum_batch_size: NotRequired[
        "capo_sagemaker.types.inference_component_capacity_size.InferenceComponentCapacitySize"
    ]
...
def serialize_aws_json_1_1(value: InferenceComponentRollingUpdatePolicy) -> dict:
    ...
    if "maximum_batch_size" in value:
        ...
        out["MaximumBatchSize"] = (
            capo_sagemaker.types.inference_component_capacity_size.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InferenceComponentRollingUpdatePolicy:
    ...
    if data.get("MaximumBatchSize") is not None:
        ...
        out["maximum_batch_size"] = (
            capo_sagemaker.types.inference_component_capacity_size.deserialize_aws_json_1_1(
