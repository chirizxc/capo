...
class PartnerAppConfig(TypedDict, closed=True):
    admin_users: NotRequired[
        "capo_sagemaker.types.partner_app_admin_user_list.PartnerAppAdminUserList"
    ]
    """<p>The list of users that are given admin access to the SageMaker Partner AI App.</p>"""
    arguments: NotRequired[
        "capo_sagemaker.types.partner_app_arguments.PartnerAppArguments"
    ]
    ...
    assigned_group_patterns: NotRequired[
        "capo_sagemaker.types.assigned_group_patterns_list.AssignedGroupPatternsList"
    ]
    ...
    role_group_assignments: NotRequired[
        "capo_sagemaker.types.role_group_assignments_list.RoleGroupAssignmentsList"
    ]
...
def serialize_aws_json_1_1(value: PartnerAppConfig) -> dict:
    ...
    if "admin_users" in value:
        ...
        out["AdminUsers"] = (
            capo_sagemaker.types.partner_app_admin_user_list.serialize_aws_json_1_1(
                value["admin_users"]
            )
        )
    if "arguments" in value:
        ...
        out["Arguments"] = (
            capo_sagemaker.types.partner_app_arguments.serialize_aws_json_1_1(
                value["arguments"]
            )
        )
    if "assigned_group_patterns" in value:
        ...
        out["AssignedGroupPatterns"] = (
            capo_sagemaker.types.assigned_group_patterns_list.serialize_aws_json_1_1(
    ...
    if "role_group_assignments" in value:
        ...
        out["RoleGroupAssignments"] = (
            capo_sagemaker.types.role_group_assignments_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> PartnerAppConfig:
    ...
    if data.get("AdminUsers") is not None:
        ...
        out["admin_users"] = (
            capo_sagemaker.types.partner_app_admin_user_list.deserialize_aws_json_1_1(
                data["AdminUsers"]
            )
        )
    if data.get("Arguments") is not None:
        ...
        out["arguments"] = (
            capo_sagemaker.types.partner_app_arguments.deserialize_aws_json_1_1(
                data["Arguments"]
            )
        )
    if data.get("AssignedGroupPatterns") is not None:
        ...
        out["assigned_group_patterns"] = (
            capo_sagemaker.types.assigned_group_patterns_list.deserialize_aws_json_1_1(
    ...
    if data.get("RoleGroupAssignments") is not None:
        ...
        out["role_group_assignments"] = (
            capo_sagemaker.types.role_group_assignments_list.deserialize_aws_json_1_1(
