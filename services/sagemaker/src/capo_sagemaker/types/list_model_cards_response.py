...
class ListModelCardsResponse(TypedDict, closed=True):
    model_card_summaries: NotRequired[
        "capo_sagemaker.types.model_card_summary_list.ModelCardSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListModelCardsResponse) -> dict:
    ...
    if "model_card_summaries" in value:
        ...
        out["ModelCardSummaries"] = (
            capo_sagemaker.types.model_card_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListModelCardsResponse:
    ...
    if data.get("ModelCardSummaries") is not None:
        import capo_sagemaker.types.model_card_summary_list

        out["model_card_summaries"] = (
            capo_sagemaker.types.model_card_summary_list.deserialize_aws_json_1_1(
