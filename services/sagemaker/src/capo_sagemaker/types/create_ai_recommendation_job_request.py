...
class CreateAIRecommendationJobRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: CreateAIRecommendationJobRequest) -> dict:
    ...
    if "output_config" in value:
        ...
        out["OutputConfig"] = (
            capo_sagemaker.types.ai_recommendation_output_config.serialize_aws_json_1_1(
                value["output_config"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> CreateAIRecommendationJobRequest:
    ...
    if data.get("OutputConfig") is not None:
        ...
        out["output_config"] = (
            capo_sagemaker.types.ai_recommendation_output_config.deserialize_aws_json_1_1(
                data["OutputConfig"]
            )
        )
