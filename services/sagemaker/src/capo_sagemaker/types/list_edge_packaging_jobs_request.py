...
class ListEdgePackagingJobsRequest(TypedDict, closed=True):
    ...
    model_name_contains: NotRequired["capo_sagemaker.types.name_contains.NameContains"]
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.list_edge_packaging_jobs_sort_by.ListEdgePackagingJobsSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListEdgePackagingJobsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.list_edge_packaging_jobs_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListEdgePackagingJobsRequest:
    ...
    if data.get("ModelNameContains") is not None:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.list_edge_packaging_jobs_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
