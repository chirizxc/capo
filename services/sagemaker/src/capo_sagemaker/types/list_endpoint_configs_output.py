...
class ListEndpointConfigsOutput(TypedDict, closed=True):
    endpoint_configs: NotRequired[
        "capo_sagemaker.types.endpoint_config_summary_list.EndpointConfigSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListEndpointConfigsOutput) -> dict:
    ...
    if "endpoint_configs" in value:
        ...
        out["EndpointConfigs"] = (
            capo_sagemaker.types.endpoint_config_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListEndpointConfigsOutput:
    ...
    if data.get("EndpointConfigs") is not None:
        import capo_sagemaker.types.endpoint_config_summary_list

        out["endpoint_configs"] = (
            capo_sagemaker.types.endpoint_config_summary_list.deserialize_aws_json_1_1(
