...
class ListModelPackageGroupsOutput(TypedDict, closed=True):
    model_package_group_summary_list: NotRequired[
        "capo_sagemaker.types.model_package_group_summary_list.ModelPackageGroupSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListModelPackageGroupsOutput) -> dict:
    ...
    if "model_package_group_summary_list" in value:
        ...
        out["ModelPackageGroupSummaryList"] = (
            capo_sagemaker.types.model_package_group_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListModelPackageGroupsOutput:
    ...
    if data.get("ModelPackageGroupSummaryList") is not None:
        import capo_sagemaker.types.model_package_group_summary_list

        out["model_package_group_summary_list"] = (
            capo_sagemaker.types.model_package_group_summary_list.deserialize_aws_json_1_1(
