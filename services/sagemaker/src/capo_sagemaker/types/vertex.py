...
class Vertex(TypedDict, closed=True):
    arn: NotRequired["capo_sagemaker.types.association_entity_arn.AssociationEntityArn"]
    """<p>The Amazon Resource Name (ARN) of the lineage entity resource.</p>"""
    type: NotRequired["capo_sagemaker.types.string40.String40"]
    """<p>The type of the lineage entity resource. For example: <code>DataSet</code>, <code>Model</code>, <code>Endpoint</code>, etc...</p>"""
    lineage_type: NotRequired["capo_sagemaker.types.lineage_type.LineageType"]
...
def serialize_aws_json_1_1(value: Vertex) -> dict:
    ...
    if "lineage_type" in value:
        ...
        out["LineageType"] = capo_sagemaker.types.lineage_type.serialize_aws_json_1_1(
            value["lineage_type"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> Vertex:
    ...
    if data.get("LineageType") is not None:
        ...
        out["lineage_type"] = (
            capo_sagemaker.types.lineage_type.deserialize_aws_json_1_1(
                data["LineageType"]
            )
        )
    return out
