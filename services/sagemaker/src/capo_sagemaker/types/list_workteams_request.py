...
class ListWorkteamsRequest(TypedDict, closed=True):
    sort_by: NotRequired[
        "capo_sagemaker.types.list_workteams_sort_by_options.ListWorkteamsSortByOptions"
    ]
    """<p>The field to sort results by. The default is <code>CreationTime</code>.</p>"""
    sort_order: NotRequired["capo_sagemaker.types.sort_order.SortOrder"]
    """<p>The sort order for results. The default is <code>Ascending</code>.</p>"""
    name_contains: NotRequired["capo_sagemaker.types.workteam_name.WorkteamName"]
...
def serialize_aws_json_1_1(value: ListWorkteamsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.list_workteams_sort_by_options.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListWorkteamsRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.list_workteams_sort_by_options.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
