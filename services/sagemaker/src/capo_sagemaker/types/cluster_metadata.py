...
class ClusterMetadata(TypedDict, closed=True):
    ...
    eks_role_access_entries: NotRequired[
        "capo_sagemaker.types.eks_role_access_entries.EksRoleAccessEntries"
    ]
...
def serialize_aws_json_1_1(value: ClusterMetadata) -> dict:
    ...
    if "eks_role_access_entries" in value:
        ...
        out["EksRoleAccessEntries"] = (
            capo_sagemaker.types.eks_role_access_entries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ClusterMetadata:
    ...
    if data.get("EksRoleAccessEntries") is not None:
        ...
        out["eks_role_access_entries"] = (
            capo_sagemaker.types.eks_role_access_entries.deserialize_aws_json_1_1(
