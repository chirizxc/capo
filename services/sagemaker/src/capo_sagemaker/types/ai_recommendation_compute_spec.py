...
class AIRecommendationComputeSpec(TypedDict, closed=True):
    instance_types: NotRequired[
        "capo_sagemaker.types.ai_recommendation_instance_type_list.AIRecommendationInstanceTypeList"
    ]
    ...
    capacity_reservation_config: NotRequired[
        "capo_sagemaker.types.ai_capacity_reservation_config.AICapacityReservationConfig"
    ]
...
def serialize_aws_json_1_1(value: AIRecommendationComputeSpec) -> dict:
    ...
    if "instance_types" in value:
        ...
        out["InstanceTypes"] = (
            capo_sagemaker.types.ai_recommendation_instance_type_list.serialize_aws_json_1_1(
    ...
    if "capacity_reservation_config" in value:
        ...
        out["CapacityReservationConfig"] = (
            capo_sagemaker.types.ai_capacity_reservation_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AIRecommendationComputeSpec:
    ...
    if data.get("InstanceTypes") is not None:
        ...
        out["instance_types"] = (
            capo_sagemaker.types.ai_recommendation_instance_type_list.deserialize_aws_json_1_1(
                data["InstanceTypes"]
            )
        )
    if data.get("CapacityReservationConfig") is not None:
        ...
        out["capacity_reservation_config"] = (
            capo_sagemaker.types.ai_capacity_reservation_config.deserialize_aws_json_1_1(
