...
class SharingSettings(TypedDict, closed=True):
    notebook_output_option: NotRequired[
        "capo_sagemaker.types.notebook_output_option.NotebookOutputOption"
    ]
...
def serialize_aws_json_1_1(value: SharingSettings) -> dict:
    ...
    if "notebook_output_option" in value:
        ...
        out["NotebookOutputOption"] = (
            capo_sagemaker.types.notebook_output_option.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SharingSettings:
    ...
    if data.get("NotebookOutputOption") is not None:
        ...
        out["notebook_output_option"] = (
            capo_sagemaker.types.notebook_output_option.deserialize_aws_json_1_1(
