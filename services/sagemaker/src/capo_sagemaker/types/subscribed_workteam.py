...
class SubscribedWorkteam(TypedDict, closed=True):
    ...
    marketplace_title: NotRequired["capo_sagemaker.types.string200.String200"]
    """<p>The title of the service provided by the vendor in the Amazon Marketplace.</p>"""
    seller_name: NotRequired["capo_sagemaker.types.string.String"]
    """<p>The name of the vendor in the Amazon Marketplace.</p>"""
    marketplace_description: NotRequired["capo_sagemaker.types.string200.String200"]
    """<p>The description of the vendor from the Amazon Marketplace.</p>"""
    listing_id: NotRequired["capo_sagemaker.types.string.String"]
