...
if TYPE_CHECKING:
    import capo_sagemaker.types.ebs_storage_settings


class SpaceStorageSettings(TypedDict, closed=True):
    ebs_storage_settings: NotRequired[
        "capo_sagemaker.types.ebs_storage_settings.EbsStorageSettings"
    ]
...
def serialize_aws_json_1_1(value: SpaceStorageSettings) -> dict:
    ...
    if "ebs_storage_settings" in value:
        ...
        out["EbsStorageSettings"] = (
            capo_sagemaker.types.ebs_storage_settings.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SpaceStorageSettings:
    ...
    if data.get("EbsStorageSettings") is not None:
        import capo_sagemaker.types.ebs_storage_settings

        out["ebs_storage_settings"] = (
            capo_sagemaker.types.ebs_storage_settings.deserialize_aws_json_1_1(
