...
if TYPE_CHECKING:
    import capo_sagemaker.types.initial_instance_count
...
class EndpointOutputConfiguration(TypedDict, closed=True):
    endpoint_name: NotRequired["capo_sagemaker.types.string.String"]
    """<p>The name of the endpoint made during a recommendation job.</p>"""
    variant_name: NotRequired["capo_sagemaker.types.string.String"]
    ...
    initial_instance_count: NotRequired[
        "capo_sagemaker.types.initial_instance_count.InitialInstanceCount"
    ]
