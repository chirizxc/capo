...
if TYPE_CHECKING:
    import capo_sagemaker.types.active_cluster_operation_count
    import capo_sagemaker.types.active_cluster_operation_name

ActiveOperations: TypeAlias = dict[
    "capo_sagemaker.types.active_cluster_operation_name.ActiveClusterOperationName",
    "capo_sagemaker.types.active_cluster_operation_count.ActiveClusterOperationCount",
]
...
def serialize_aws_json_1_1(input_to_serialize: ActiveOperations) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[
            capo_sagemaker.types.active_cluster_operation_name.serialize_aws_json_1_1(
                key
            )
        ] = value
    return out
