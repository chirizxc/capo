...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.termination_wait_in_seconds
...
class BlueGreenUpdatePolicy(TypedDict, closed=True):
    traffic_routing_configuration: NotRequired[
        "capo_sagemaker.types.traffic_routing_config.TrafficRoutingConfig"
    ]
    ...
    termination_wait_in_seconds: NotRequired[
        "capo_sagemaker.types.termination_wait_in_seconds.TerminationWaitInSeconds"
    ]
...
def serialize_aws_json_1_1(value: BlueGreenUpdatePolicy) -> dict:
    ...
    if "traffic_routing_configuration" in value:
        ...
        out["TrafficRoutingConfiguration"] = (
            capo_sagemaker.types.traffic_routing_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> BlueGreenUpdatePolicy:
    ...
    if data.get("TrafficRoutingConfiguration") is not None:
        ...
        out["traffic_routing_configuration"] = (
            capo_sagemaker.types.traffic_routing_config.deserialize_aws_json_1_1(
