...
if TYPE_CHECKING:
    import capo_sagemaker.types.max_concurrent_invocations_per_instance


class AsyncInferenceClientConfig(TypedDict, closed=True):
    max_concurrent_invocations_per_instance: NotRequired[
        "capo_sagemaker.types.max_concurrent_invocations_per_instance.MaxConcurrentInvocationsPerInstance"
    ]
