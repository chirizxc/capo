...
def serialize_aws_json_1_1(value: ListClusterSchedulerConfigsResponse) -> dict:
    ...
    if "cluster_scheduler_config_summaries" in value:
        ...
        out["ClusterSchedulerConfigSummaries"] = (
            capo_sagemaker.types.cluster_scheduler_config_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListClusterSchedulerConfigsResponse:
    ...
    if data.get("ClusterSchedulerConfigSummaries") is not None:
        import capo_sagemaker.types.cluster_scheduler_config_summary_list

        out["cluster_scheduler_config_summaries"] = (
            capo_sagemaker.types.cluster_scheduler_config_summary_list.deserialize_aws_json_1_1(
