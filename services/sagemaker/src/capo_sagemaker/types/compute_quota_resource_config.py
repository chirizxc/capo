...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.accelerators_amount
    import capo_sagemaker.types.cluster_instance_type
    import capo_sagemaker.types.instance_count
    import capo_sagemaker.types.memory_in_gi_b_amount
    import capo_sagemaker.types.v_cpu_amount
...
class ComputeQuotaResourceConfig(TypedDict, closed=True):
    ...
    count: NotRequired["capo_sagemaker.types.instance_count.InstanceCount"]
    """<p>The number of instances to add to the instance group of a SageMaker HyperPod cluster.</p>"""
    accelerators: NotRequired[
        "capo_sagemaker.types.accelerators_amount.AcceleratorsAmount"
    ]
    ...
    v_cpu: NotRequired["capo_sagemaker.types.v_cpu_amount.VCpuAmount"]
    ...
    memory_in_gi_b: NotRequired[
        "capo_sagemaker.types.memory_in_gi_b_amount.MemoryInGiBAmount"
    ]
    ...
    accelerator_partition: NotRequired[
        "capo_sagemaker.types.accelerator_partition_config.AcceleratorPartitionConfig"
    ]
...
def serialize_aws_json_1_1(value: ComputeQuotaResourceConfig) -> dict:
    ...
    if "accelerator_partition" in value:
        ...
        out["AcceleratorPartition"] = (
            capo_sagemaker.types.accelerator_partition_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ComputeQuotaResourceConfig:
    ...
    if data.get("AcceleratorPartition") is not None:
        ...
        out["accelerator_partition"] = (
            capo_sagemaker.types.accelerator_partition_config.deserialize_aws_json_1_1(
