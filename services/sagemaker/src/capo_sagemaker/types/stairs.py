...
if TYPE_CHECKING:
    import capo_sagemaker.types.number_of_steps
    import capo_sagemaker.types.traffic_duration_in_seconds
    import capo_sagemaker.types.users_per_step
...
class Stairs(TypedDict, closed=True):
    ...
    number_of_steps: NotRequired["capo_sagemaker.types.number_of_steps.NumberOfSteps"]
    """<p>Specifies how many steps to perform during traffic.</p>"""
    users_per_step: NotRequired["capo_sagemaker.types.users_per_step.UsersPerStep"]
