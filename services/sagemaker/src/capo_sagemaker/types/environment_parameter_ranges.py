...
if TYPE_CHECKING:
    import capo_sagemaker.types.categorical_parameters


class EnvironmentParameterRanges(TypedDict, closed=True):
    categorical_parameter_ranges: NotRequired[
        "capo_sagemaker.types.categorical_parameters.CategoricalParameters"
    ]
...
def serialize_aws_json_1_1(value: EnvironmentParameterRanges) -> dict:
    ...
    if "categorical_parameter_ranges" in value:
        ...
        out["CategoricalParameterRanges"] = (
            capo_sagemaker.types.categorical_parameters.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> EnvironmentParameterRanges:
    ...
    if data.get("CategoricalParameterRanges") is not None:
        ...
        out["categorical_parameter_ranges"] = (
            capo_sagemaker.types.categorical_parameters.deserialize_aws_json_1_1(
