...
if TYPE_CHECKING:
    import capo_sagemaker.types.f_sx_lustre_per_unit_storage_throughput
    import capo_sagemaker.types.f_sx_lustre_size_in_gi_b


class FSxLustreConfig(TypedDict, closed=True):
    size_in_gi_b: NotRequired[
        "capo_sagemaker.types.f_sx_lustre_size_in_gi_b.FSxLustreSizeInGiB"
    ]
    ...
    per_unit_storage_throughput: NotRequired[
        "capo_sagemaker.types.f_sx_lustre_per_unit_storage_throughput.FSxLustrePerUnitStorageThroughput"
    ]
