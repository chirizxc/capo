...
class RecommendationJobVpcConfig(TypedDict, closed=True):
    security_group_ids: NotRequired[
        "capo_sagemaker.types.recommendation_job_vpc_security_group_ids.RecommendationJobVpcSecurityGroupIds"
    ]
    ...
    subnets: NotRequired[
        "capo_sagemaker.types.recommendation_job_vpc_subnets.RecommendationJobVpcSubnets"
    ]
...
def serialize_aws_json_1_1(value: RecommendationJobVpcConfig) -> dict:
    ...
    if "security_group_ids" in value:
        ...
        out["SecurityGroupIds"] = (
            capo_sagemaker.types.recommendation_job_vpc_security_group_ids.serialize_aws_json_1_1(
    ...
    if "subnets" in value:
        ...
        out["Subnets"] = (
            capo_sagemaker.types.recommendation_job_vpc_subnets.serialize_aws_json_1_1(
                value["subnets"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> RecommendationJobVpcConfig:
    ...
    if data.get("SecurityGroupIds") is not None:
        ...
        out["security_group_ids"] = (
            capo_sagemaker.types.recommendation_job_vpc_security_group_ids.deserialize_aws_json_1_1(
    ...
    if data.get("Subnets") is not None:
        ...
        out["subnets"] = (
            capo_sagemaker.types.recommendation_job_vpc_subnets.deserialize_aws_json_1_1(
                data["Subnets"]
            )
        )
    return out
