...
class DescribeHumanTaskUiResponse(TypedDict, closed=True):
    ...
    human_task_ui_status: NotRequired[
        "capo_sagemaker.types.human_task_ui_status.HumanTaskUiStatus"
    ]
    ...
    ui_template: NotRequired["capo_sagemaker.types.ui_template_info.UiTemplateInfo"]
...
def serialize_aws_json_1_1(value: DescribeHumanTaskUiResponse) -> dict:
    ...
    if "human_task_ui_status" in value:
        ...
        out["HumanTaskUiStatus"] = (
            capo_sagemaker.types.human_task_ui_status.serialize_aws_json_1_1(
    ...
    if "ui_template" in value:
        ...
        out["UiTemplate"] = (
            capo_sagemaker.types.ui_template_info.serialize_aws_json_1_1(
                value["ui_template"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DescribeHumanTaskUiResponse:
    ...
    if data.get("HumanTaskUiStatus") is not None:
        import capo_sagemaker.types.human_task_ui_status

        out["human_task_ui_status"] = (
            capo_sagemaker.types.human_task_ui_status.deserialize_aws_json_1_1(
    ...
    if data.get("UiTemplate") is not None:
        ...
        out["ui_template"] = (
            capo_sagemaker.types.ui_template_info.deserialize_aws_json_1_1(
                data["UiTemplate"]
            )
        )
    return out
