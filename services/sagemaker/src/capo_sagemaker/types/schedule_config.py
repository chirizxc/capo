...
class ScheduleConfig(TypedDict, closed=True):
    ...
    data_analysis_start_time: NotRequired["capo_sagemaker.types.string.String"]
    ...
    data_analysis_end_time: NotRequired["capo_sagemaker.types.string.String"]
