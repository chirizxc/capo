...
class HumanLoopRequestSource(TypedDict, closed=True):
    aws_managed_human_loop_request_source: NotRequired[
        "capo_sagemaker.types.aws_managed_human_loop_request_source.AwsManagedHumanLoopRequestSource"
    ]
...
def serialize_aws_json_1_1(value: HumanLoopRequestSource) -> dict:
    ...
    if "aws_managed_human_loop_request_source" in value:
        ...
        out["AwsManagedHumanLoopRequestSource"] = (
            capo_sagemaker.types.aws_managed_human_loop_request_source.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> HumanLoopRequestSource:
    ...
    if data.get("AwsManagedHumanLoopRequestSource") is not None:
        ...
        out["aws_managed_human_loop_request_source"] = (
            capo_sagemaker.types.aws_managed_human_loop_request_source.deserialize_aws_json_1_1(
