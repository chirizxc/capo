...
class ListAIRecommendationJobsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.list_ai_recommendation_jobs_sort_by.ListAIRecommendationJobsSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListAIRecommendationJobsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.list_ai_recommendation_jobs_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListAIRecommendationJobsRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.list_ai_recommendation_jobs_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
