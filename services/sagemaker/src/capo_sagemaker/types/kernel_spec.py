...
if TYPE_CHECKING:
    import capo_sagemaker.types.kernel_display_name
    import capo_sagemaker.types.kernel_name


class KernelSpec(TypedDict, closed=True):
    name: NotRequired["capo_sagemaker.types.kernel_name.KernelName"]
    """<p>The name of the Jupyter kernel in the image. This value is case sensitive.</p>"""
    display_name: NotRequired[
        "capo_sagemaker.types.kernel_display_name.KernelDisplayName"
    ]
