...
class ListStageDevicesResponse(TypedDict, closed=True):
    device_deployment_summaries: NotRequired[
        "capo_sagemaker.types.device_deployment_summaries.DeviceDeploymentSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListStageDevicesResponse) -> dict:
    ...
    if "device_deployment_summaries" in value:
        ...
        out["DeviceDeploymentSummaries"] = (
            capo_sagemaker.types.device_deployment_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListStageDevicesResponse:
    ...
    if data.get("DeviceDeploymentSummaries") is not None:
        import capo_sagemaker.types.device_deployment_summaries

        out["device_deployment_summaries"] = (
            capo_sagemaker.types.device_deployment_summaries.deserialize_aws_json_1_1(
