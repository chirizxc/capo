...
class CfnTemplateProviderDetail(TypedDict, closed=True):
    ...
    parameters: NotRequired[
        "capo_sagemaker.types.cfn_stack_parameters.CfnStackParameters"
    ]
    """<p> An array of CloudFormation stack parameters.</p>"""
    stack_detail: NotRequired["capo_sagemaker.types.cfn_stack_detail.CfnStackDetail"]
...
def serialize_aws_json_1_1(value: CfnTemplateProviderDetail) -> dict:
    ...
    if "parameters" in value:
        ...
        out["Parameters"] = (
            capo_sagemaker.types.cfn_stack_parameters.serialize_aws_json_1_1(
                value["parameters"]
            )
        )
    if "stack_detail" in value:
        ...
        out["StackDetail"] = (
            capo_sagemaker.types.cfn_stack_detail.serialize_aws_json_1_1(
                value["stack_detail"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CfnTemplateProviderDetail:
    ...
    if data.get("Parameters") is not None:
        ...
        out["parameters"] = (
            capo_sagemaker.types.cfn_stack_parameters.deserialize_aws_json_1_1(
                data["Parameters"]
            )
        )
    if data.get("StackDetail") is not None:
        ...
        out["stack_detail"] = (
            capo_sagemaker.types.cfn_stack_detail.deserialize_aws_json_1_1(
                data["StackDetail"]
            )
        )
    return out
