...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.billable_token_count
    ...
    import capo_sagemaker.types.mlflow_details
    ...
    import capo_sagemaker.types.profiler_rule_evaluation_statuses
    import capo_sagemaker.types.profiling_status
    ...
    import capo_sagemaker.types.training_progress_info
...
class DescribeTrainingJobResponse(TypedDict, closed=True):
    ...
    billable_token_count: NotRequired[
        "capo_sagemaker.types.billable_token_count.BillableTokenCount"
    ]
    ...
    profiling_status: NotRequired[
        "capo_sagemaker.types.profiling_status.ProfilingStatus"
    ]
    ...
    mlflow_details: NotRequired["capo_sagemaker.types.mlflow_details.MlflowDetails"]
    """<p> The MLflow details of this job. </p>"""
    progress_info: NotRequired[
        "capo_sagemaker.types.training_progress_info.TrainingProgressInfo"
    ]
...
def serialize_aws_json_1_1(value: DescribeTrainingJobResponse) -> dict:
    ...
    if "profiler_rule_evaluation_statuses" in value:
        ...
        out["ProfilerRuleEvaluationStatuses"] = (
            capo_sagemaker.types.profiler_rule_evaluation_statuses.serialize_aws_json_1_1(
    ...
    if "profiling_status" in value:
        ...
        out["ProfilingStatus"] = (
            capo_sagemaker.types.profiling_status.serialize_aws_json_1_1(
    ...
    if "mlflow_details" in value:
        ...
        out["MlflowDetails"] = (
            capo_sagemaker.types.mlflow_details.serialize_aws_json_1_1(
    ...
    if "progress_info" in value:
        ...
        out["ProgressInfo"] = (
            capo_sagemaker.types.training_progress_info.serialize_aws_json_1_1(
                value["progress_info"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeTrainingJobResponse:
    ...
    if data.get("TuningJobArn") is not None:
    ...
    if data.get("FinalMetricDataList") is not None:
        import capo_sagemaker.types.final_metric_data_list
    ...
    if data.get("TrainingTimeInSeconds") is not None:
        out["training_time_in_seconds"] = data["TrainingTimeInSeconds"]
    if data.get("BillableTimeInSeconds") is not None:
        out["billable_time_in_seconds"] = data["BillableTimeInSeconds"]
    if data.get("BillableTokenCount") is not None:
    ...
    if data.get("DebugRuleEvaluationStatuses") is not None:
        import capo_sagemaker.types.debug_rule_evaluation_statuses
    ...
    if data.get("ProfilerRuleEvaluationStatuses") is not None:
        import capo_sagemaker.types.profiler_rule_evaluation_statuses

        out["profiler_rule_evaluation_statuses"] = (
            capo_sagemaker.types.profiler_rule_evaluation_statuses.deserialize_aws_json_1_1(
    ...
    if data.get("ProfilingStatus") is not None:
        ...
        out["profiling_status"] = (
            capo_sagemaker.types.profiling_status.deserialize_aws_json_1_1(
    ...
    if data.get("MlflowDetails") is not None:
        import capo_sagemaker.types.mlflow_details

        out["mlflow_details"] = (
            capo_sagemaker.types.mlflow_details.deserialize_aws_json_1_1(
                data["MlflowDetails"]
            )
        )
    if data.get("ProgressInfo") is not None:
        import capo_sagemaker.types.training_progress_info

        out["progress_info"] = (
            capo_sagemaker.types.training_progress_info.deserialize_aws_json_1_1(
                data["ProgressInfo"]
            )
        )
    if data.get("OutputModelPackageArn") is not None:
