...
class ListAIRecommendationJobsResponse(TypedDict, closed=True):
    ai_recommendation_jobs: NotRequired[
        "capo_sagemaker.types.ai_recommendation_job_summary_list.AIRecommendationJobSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListAIRecommendationJobsResponse) -> dict:
    ...
    if "ai_recommendation_jobs" in value:
        ...
        out["AIRecommendationJobs"] = (
            capo_sagemaker.types.ai_recommendation_job_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListAIRecommendationJobsResponse:
    ...
    if data.get("AIRecommendationJobs") is not None:
        import capo_sagemaker.types.ai_recommendation_job_summary_list

        out["ai_recommendation_jobs"] = (
            capo_sagemaker.types.ai_recommendation_job_summary_list.deserialize_aws_json_1_1(
