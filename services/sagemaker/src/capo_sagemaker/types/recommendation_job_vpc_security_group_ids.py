...
if TYPE_CHECKING:
    import capo_sagemaker.types.recommendation_job_vpc_security_group_id

RecommendationJobVpcSecurityGroupIds: TypeAlias = list[
    "capo_sagemaker.types.recommendation_job_vpc_security_group_id.RecommendationJobVpcSecurityGroupId"
]
