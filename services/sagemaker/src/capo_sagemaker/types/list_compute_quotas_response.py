...
class ListComputeQuotasResponse(TypedDict, closed=True):
    compute_quota_summaries: NotRequired[
        "capo_sagemaker.types.compute_quota_summary_list.ComputeQuotaSummaryList"
    ]
...
def serialize_aws_json_1_1(value: ListComputeQuotasResponse) -> dict:
    ...
    if "compute_quota_summaries" in value:
        ...
        out["ComputeQuotaSummaries"] = (
            capo_sagemaker.types.compute_quota_summary_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListComputeQuotasResponse:
    ...
    if data.get("ComputeQuotaSummaries") is not None:
        import capo_sagemaker.types.compute_quota_summary_list

        out["compute_quota_summaries"] = (
            capo_sagemaker.types.compute_quota_summary_list.deserialize_aws_json_1_1(
