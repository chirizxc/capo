...
class ShadowModeConfig(TypedDict, closed=True):
    ...
    shadow_model_variants: NotRequired[
        "capo_sagemaker.types.shadow_model_variant_config_list.ShadowModelVariantConfigList"
    ]
...
def serialize_aws_json_1_1(value: ShadowModeConfig) -> dict:
    ...
    if "shadow_model_variants" in value:
        ...
        out["ShadowModelVariants"] = (
            capo_sagemaker.types.shadow_model_variant_config_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ShadowModeConfig:
    ...
    if data.get("ShadowModelVariants") is not None:
        ...
        out["shadow_model_variants"] = (
            capo_sagemaker.types.shadow_model_variant_config_list.deserialize_aws_json_1_1(
