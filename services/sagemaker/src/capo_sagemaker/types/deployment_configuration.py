...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.wait_time_interval_in_seconds


class DeploymentConfiguration(TypedDict, closed=True):
    rolling_update_policy: NotRequired[
        "capo_sagemaker.types.rolling_deployment_policy.RollingDeploymentPolicy"
    ]
    """<p>The policy that SageMaker uses when updating the AMI versions of the cluster. </p>"""
    wait_interval_in_seconds: NotRequired[
        "capo_sagemaker.types.wait_time_interval_in_seconds.WaitTimeIntervalInSeconds"
    ]
    ...
    auto_rollback_configuration: NotRequired[
        "capo_sagemaker.types.auto_rollback_alarms.AutoRollbackAlarms"
    ]
...
def serialize_aws_json_1_1(value: DeploymentConfiguration) -> dict:
    ...
    if "rolling_update_policy" in value:
        ...
        out["RollingUpdatePolicy"] = (
            capo_sagemaker.types.rolling_deployment_policy.serialize_aws_json_1_1(
    ...
    if "auto_rollback_configuration" in value:
        ...
        out["AutoRollbackConfiguration"] = (
            capo_sagemaker.types.auto_rollback_alarms.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DeploymentConfiguration:
    ...
    if data.get("RollingUpdatePolicy") is not None:
        ...
        out["rolling_update_policy"] = (
            capo_sagemaker.types.rolling_deployment_policy.deserialize_aws_json_1_1(
    ...
    if data.get("AutoRollbackConfiguration") is not None:
        ...
        out["auto_rollback_configuration"] = (
            capo_sagemaker.types.auto_rollback_alarms.deserialize_aws_json_1_1(
