...
if TYPE_CHECKING:
    import capo_sagemaker.types.training_repository_credentials_provider_arn


class TrainingRepositoryAuthConfig(TypedDict, closed=True):
    training_repository_credentials_provider_arn: NotRequired[
        "capo_sagemaker.types.training_repository_credentials_provider_arn.TrainingRepositoryCredentialsProviderArn"
    ]
