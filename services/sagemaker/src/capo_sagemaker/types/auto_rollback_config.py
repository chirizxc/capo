...
if TYPE_CHECKING:
    import capo_sagemaker.types.alarm_list


class AutoRollbackConfig(TypedDict, closed=True):
    alarms: NotRequired["capo_sagemaker.types.alarm_list.AlarmList"]
...
def serialize_aws_json_1_1(value: AutoRollbackConfig) -> dict:
    ...
    if "alarms" in value:
        ...
        out["Alarms"] = capo_sagemaker.types.alarm_list.serialize_aws_json_1_1(
            value["alarms"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> AutoRollbackConfig:
    ...
    if data.get("Alarms") is not None:
        ...
        out["alarms"] = capo_sagemaker.types.alarm_list.deserialize_aws_json_1_1(
            data["Alarms"]
        )
    return out
