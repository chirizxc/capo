...
class ListUserProfilesRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.user_profile_sort_key.UserProfileSortKey"
    ]
...
def serialize_aws_json_1_1(value: ListUserProfilesRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.user_profile_sort_key.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListUserProfilesRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.user_profile_sort_key.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    if data.get("DomainIdEquals") is not None:
        out["domain_id_equals"] = data["DomainIdEquals"]
    if data.get("UserProfileNameContains") is not None:
