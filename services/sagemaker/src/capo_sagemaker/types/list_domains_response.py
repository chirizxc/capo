...
class ListDomainsResponse(TypedDict, closed=True):
    domains: NotRequired["capo_sagemaker.types.domain_list.DomainList"]
...
def serialize_aws_json_1_1(value: ListDomainsResponse) -> dict:
    ...
    if "domains" in value:
        ...
        out["Domains"] = capo_sagemaker.types.domain_list.serialize_aws_json_1_1(
            value["domains"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDomainsResponse:
    ...
    if data.get("Domains") is not None:
        ...
        out["domains"] = capo_sagemaker.types.domain_list.deserialize_aws_json_1_1(
            data["Domains"]
        )
