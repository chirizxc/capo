...
if TYPE_CHECKING:
    import capo_sagemaker.types.code_repository_name_contains
...
class ListCodeRepositoriesInput(TypedDict, closed=True):
    ...
    name_contains: NotRequired[
        "capo_sagemaker.types.code_repository_name_contains.CodeRepositoryNameContains"
    ]
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.code_repository_sort_by.CodeRepositorySortBy"
    ]
    """<p>The field to sort results by. The default is <code>Name</code>.</p>"""
    sort_order: NotRequired[
        "capo_sagemaker.types.code_repository_sort_order.CodeRepositorySortOrder"
    ]
...
def serialize_aws_json_1_1(value: ListCodeRepositoriesInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.code_repository_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
    if "sort_order" in value:
        ...
        out["SortOrder"] = (
            capo_sagemaker.types.code_repository_sort_order.serialize_aws_json_1_1(
                value["sort_order"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListCodeRepositoriesInput:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.code_repository_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
    if data.get("SortOrder") is not None:
        ...
        out["sort_order"] = (
            capo_sagemaker.types.code_repository_sort_order.deserialize_aws_json_1_1(
                data["SortOrder"]
            )
        )
    return out
