...
class ListMonitoringAlertHistoryRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.monitoring_alert_history_sort_key.MonitoringAlertHistorySortKey"
    ]
...
def serialize_aws_json_1_1(value: ListMonitoringAlertHistoryRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.monitoring_alert_history_sort_key.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListMonitoringAlertHistoryRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.monitoring_alert_history_sort_key.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
