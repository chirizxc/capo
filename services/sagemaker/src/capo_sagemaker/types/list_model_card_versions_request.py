...
class ListModelCardVersionsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.model_card_version_sort_by.ModelCardVersionSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListModelCardVersionsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.model_card_version_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListModelCardVersionsRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.model_card_version_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
