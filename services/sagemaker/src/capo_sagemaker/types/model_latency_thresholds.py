...
if TYPE_CHECKING:
    import capo_sagemaker.types.model_latency_threshold

ModelLatencyThresholds: TypeAlias = list[
    "capo_sagemaker.types.model_latency_threshold.ModelLatencyThreshold"
]
...
def serialize_aws_json_1_1(value: ModelLatencyThresholds) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.model_latency_threshold.serialize_aws_json_1_1(item)
        )
    return out
