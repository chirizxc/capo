...
class ListAppsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["capo_sagemaker.types.app_sort_key.AppSortKey"]
    ...
    space_name_equals: NotRequired["capo_sagemaker.types.space_name.SpaceName"]
...
def serialize_aws_json_1_1(value: ListAppsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.app_sort_key.serialize_aws_json_1_1(
            value["sort_by"]
        )
