...
class ListModelPackageGroupsInput(TypedDict, closed=True):
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.model_package_group_sort_by.ModelPackageGroupSortBy"
    ]
...
def serialize_aws_json_1_1(value: ListModelPackageGroupsInput) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.model_package_group_sort_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListModelPackageGroupsInput:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.model_package_group_sort_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
