...
if TYPE_CHECKING:
    ...
    import capo_sagemaker.types.status_details
    import capo_sagemaker.types.timestamp


class ProfilerRuleEvaluationStatus(TypedDict, closed=True):
    ...
    rule_evaluation_status: NotRequired[
        "capo_sagemaker.types.rule_evaluation_status.RuleEvaluationStatus"
    ]
    """<p>Status of the rule evaluation.</p>"""
    status_details: NotRequired["capo_sagemaker.types.status_details.StatusDetails"]
...
def serialize_aws_json_1_1(value: ProfilerRuleEvaluationStatus) -> dict:
    ...
    if "rule_evaluation_status" in value:
        ...
        out["RuleEvaluationStatus"] = (
            capo_sagemaker.types.rule_evaluation_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ProfilerRuleEvaluationStatus:
    ...
    if data.get("RuleEvaluationStatus") is not None:
        ...
        out["rule_evaluation_status"] = (
            capo_sagemaker.types.rule_evaluation_status.deserialize_aws_json_1_1(
