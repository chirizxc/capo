...
if TYPE_CHECKING:
    import capo_sagemaker.types.desired_weight_and_capacity

DesiredWeightAndCapacityList: TypeAlias = list[
    "capo_sagemaker.types.desired_weight_and_capacity.DesiredWeightAndCapacity"
]
...
def serialize_aws_json_1_1(value: DesiredWeightAndCapacityList) -> list:
    ...
    for item in value:
        out.append(
            capo_sagemaker.types.desired_weight_and_capacity.serialize_aws_json_1_1(
                item
            )
        )
    return out
