...
class ListTrialComponentsRequest(TypedDict, closed=True):
    ...
    source_arn: NotRequired["capo_sagemaker.types.string256.String256"]
    ...
    sort_by: NotRequired[
        "capo_sagemaker.types.sort_trial_components_by.SortTrialComponentsBy"
    ]
...
def serialize_aws_json_1_1(value: ListTrialComponentsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = (
            capo_sagemaker.types.sort_trial_components_by.serialize_aws_json_1_1(
                value["sort_by"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListTrialComponentsRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = (
            capo_sagemaker.types.sort_trial_components_by.deserialize_aws_json_1_1(
                data["SortBy"]
            )
        )
