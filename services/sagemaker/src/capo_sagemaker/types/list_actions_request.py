...
class ListActionsRequest(TypedDict, closed=True):
    ...
    sort_by: NotRequired["capo_sagemaker.types.sort_actions_by.SortActionsBy"]
...
def serialize_aws_json_1_1(value: ListActionsRequest) -> dict:
    ...
    if "sort_by" in value:
        ...
        out["SortBy"] = capo_sagemaker.types.sort_actions_by.serialize_aws_json_1_1(
            value["sort_by"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListActionsRequest:
    ...
    if data.get("SortBy") is not None:
        ...
        out["sort_by"] = capo_sagemaker.types.sort_actions_by.deserialize_aws_json_1_1(
            data["SortBy"]
        )
