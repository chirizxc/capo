...
class ProcessingS3Input(TypedDict, closed=True):
    ...
    s3_data_type: NotRequired[
        "capo_sagemaker.types.processing_s3_data_type.ProcessingS3DataType"
    ]
    ...
    s3_compression_type: NotRequired[
        "capo_sagemaker.types.processing_s3_compression_type.ProcessingS3CompressionType"
    ]
...
def serialize_aws_json_1_1(value: ProcessingS3Input) -> dict:
    ...
    if "s3_data_type" in value:
        ...
        out["S3DataType"] = (
            capo_sagemaker.types.processing_s3_data_type.serialize_aws_json_1_1(
                value["s3_data_type"]
            )
        )
    ...
    if "s3_compression_type" in value:
        ...
        out["S3CompressionType"] = (
            capo_sagemaker.types.processing_s3_compression_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ProcessingS3Input:
    ...
    if data.get("S3DataType") is not None:
        ...
        out["s3_data_type"] = (
            capo_sagemaker.types.processing_s3_data_type.deserialize_aws_json_1_1(
                data["S3DataType"]
            )
        )
    ...
    if data.get("S3CompressionType") is not None:
        ...
        out["s3_compression_type"] = (
            capo_sagemaker.types.processing_s3_compression_type.deserialize_aws_json_1_1(
