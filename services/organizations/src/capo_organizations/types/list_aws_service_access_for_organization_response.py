...
class ListAWSServiceAccessForOrganizationResponse(TypedDict, closed=True):
    enabled_service_principals: NotRequired[
        "capo_organizations.types.enabled_service_principals.EnabledServicePrincipals"
    ]
...
def serialize_aws_json_1_1(value: ListAWSServiceAccessForOrganizationResponse) -> dict:
    ...
    if "enabled_service_principals" in value:
        ...
        out["EnabledServicePrincipals"] = (
            capo_organizations.types.enabled_service_principals.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListAWSServiceAccessForOrganizationResponse:
    ...
    if data.get("EnabledServicePrincipals") is not None:
        import capo_organizations.types.enabled_service_principals

        out["enabled_service_principals"] = (
            capo_organizations.types.enabled_service_principals.deserialize_aws_json_1_1(
