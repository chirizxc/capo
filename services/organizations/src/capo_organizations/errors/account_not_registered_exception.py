"""Generated from Smithy shape ``com.amazonaws.organizations#AccountNotRegisteredException``."""
...
class AccountNotRegisteredException_(TypedDict, closed=True):
...
class AccountNotRegisteredException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.organizations#AccountNotRegisteredException``."""

    code: str | None = "AccountNotRegisteredException"

    def __init__(
        self, data: AccountNotRegisteredException_, message: str | None = None
    ):
        super().__init__(
            "client",
