"""Generated from Smithy shape ``com.amazonaws.organizations#ResourcePolicyNotFoundException``."""
...
class ResourcePolicyNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.organizations#ResourcePolicyNotFoundException``."""
