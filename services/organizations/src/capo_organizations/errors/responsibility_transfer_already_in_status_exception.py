"""Generated from Smithy shape ``com.amazonaws.organizations#ResponsibilityTransferAlreadyInStatusException``."""
...
class ResponsibilityTransferAlreadyInStatusException_(TypedDict, closed=True):
    message: NotRequired["capo_organizations.types.exception_message.ExceptionMessage"]


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(
    value: ResponsibilityTransferAlreadyInStatusException_,
) -> dict:
    out: dict = {}
    if "message" in value:
...
class ResponsibilityTransferAlreadyInStatusException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.organizations#ResponsibilityTransferAlreadyInStatusException``."""
