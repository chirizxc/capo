"""Generated from Smithy shape ``com.amazonaws.organizations#ListInboundResponsibilityTransfers``."""
...
import capo_organizations.types.list_inbound_responsibility_transfers_request
import capo_organizations.types.list_inbound_responsibility_transfers_response
...
) -> capo_organizations.types.list_inbound_responsibility_transfers_response.ListInboundResponsibilityTransfersResponse:
    out: capo_organizations.types.list_inbound_responsibility_transfers_response.ListInboundResponsibilityTransfersResponse = capo_organizations.types.list_inbound_responsibility_transfers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_inbound_responsibility_transfers_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_inbound_responsibility_transfers(
