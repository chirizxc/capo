"""Generated from Smithy shape ``com.amazonaws.organizations#DisableAWSServiceAccess``."""
...
import capo_organizations.types.disable_aws_service_access_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.disable_aws_service_access_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disable_aws_service_access(
