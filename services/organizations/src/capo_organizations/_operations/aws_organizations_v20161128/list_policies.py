"""Generated from Smithy shape ``com.amazonaws.organizations#ListPolicies``."""
...
import capo_organizations.types.list_policies_request
import capo_organizations.types.list_policies_response
...
) -> capo_organizations.types.list_policies_response.ListPoliciesResponse:
    out: capo_organizations.types.list_policies_response.ListPoliciesResponse = (
        capo_organizations.types.list_policies_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_policies_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
