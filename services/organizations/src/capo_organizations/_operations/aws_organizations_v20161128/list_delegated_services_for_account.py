"""Generated from Smithy shape ``com.amazonaws.organizations#ListDelegatedServicesForAccount``."""
...
import capo_organizations.types.list_delegated_services_for_account_request
import capo_organizations.types.list_delegated_services_for_account_response
...
) -> capo_organizations.types.list_delegated_services_for_account_response.ListDelegatedServicesForAccountResponse:
    out: capo_organizations.types.list_delegated_services_for_account_response.ListDelegatedServicesForAccountResponse = capo_organizations.types.list_delegated_services_for_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_delegated_services_for_account_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_delegated_services_for_account(
