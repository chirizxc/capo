"""Generated from Smithy shape ``com.amazonaws.organizations#InviteOrganizationToTransferResponsibility``."""
...
import capo_organizations.types.invite_organization_to_transfer_responsibility_request
import capo_organizations.types.invite_organization_to_transfer_responsibility_response
...
) -> capo_organizations.types.invite_organization_to_transfer_responsibility_response.InviteOrganizationToTransferResponsibilityResponse:
    out: capo_organizations.types.invite_organization_to_transfer_responsibility_response.InviteOrganizationToTransferResponsibilityResponse = capo_organizations.types.invite_organization_to_transfer_responsibility_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.invite_organization_to_transfer_responsibility_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_invite_organization_to_transfer_responsibility(
