"""Generated from Smithy shape ``com.amazonaws.organizations#DescribeEffectivePolicy``."""
...
import capo_organizations.types.describe_effective_policy_request
import capo_organizations.types.describe_effective_policy_response
...
) -> capo_organizations.types.describe_effective_policy_response.DescribeEffectivePolicyResponse:
    out: capo_organizations.types.describe_effective_policy_response.DescribeEffectivePolicyResponse = capo_organizations.types.describe_effective_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.describe_effective_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_effective_policy(
