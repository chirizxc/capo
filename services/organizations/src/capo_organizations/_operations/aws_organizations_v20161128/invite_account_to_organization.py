"""Generated from Smithy shape ``com.amazonaws.organizations#InviteAccountToOrganization``."""
...
import capo_organizations.errors.account_owner_not_verified_exception
...
import capo_organizations.errors.duplicate_handshake_exception
import capo_organizations.errors.finalizing_organization_exception
import capo_organizations.errors.handshake_constraint_violation_exception
...
import capo_organizations.types.invite_account_to_organization_request
import capo_organizations.types.invite_account_to_organization_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountOwnerNotVerifiedException":
            raise capo_organizations.errors.account_owner_not_verified_exception.AccountOwnerNotVerifiedException.from_aws_json_1_1(
                data, message
            )
        ...
        case "DuplicateHandshakeException":
            raise capo_organizations.errors.duplicate_handshake_exception.DuplicateHandshakeException.from_aws_json_1_1(
                data, message
            )
        ...
        case "HandshakeConstraintViolationException":
            raise capo_organizations.errors.handshake_constraint_violation_exception.HandshakeConstraintViolationException.from_aws_json_1_1(
                data, message
            )
...
) -> capo_organizations.types.invite_account_to_organization_response.InviteAccountToOrganizationResponse:
    out: capo_organizations.types.invite_account_to_organization_response.InviteAccountToOrganizationResponse = capo_organizations.types.invite_account_to_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.invite_account_to_organization_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_invite_account_to_organization(
