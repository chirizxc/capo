...
import capo_organizations.errors.policy_not_attached_exception
...
import capo_organizations.types.detach_policy_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyNotAttachedException":
            raise capo_organizations.errors.policy_not_attached_exception.PolicyNotAttachedException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.detach_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
