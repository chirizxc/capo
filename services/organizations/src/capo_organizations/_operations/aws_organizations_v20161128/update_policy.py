"""Generated from Smithy shape ``com.amazonaws.organizations#UpdatePolicy``."""
...
import capo_organizations.errors.duplicate_policy_exception
import capo_organizations.errors.invalid_input_exception
import capo_organizations.errors.malformed_policy_document_exception
...
import capo_organizations.types.update_policy_request
import capo_organizations.types.update_policy_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DuplicatePolicyException":
            raise capo_organizations.errors.duplicate_policy_exception.DuplicatePolicyException.from_aws_json_1_1(
                data, message
            )
        ...
        case "MalformedPolicyDocumentException":
            raise capo_organizations.errors.malformed_policy_document_exception.MalformedPolicyDocumentException.from_aws_json_1_1(
                data, message
            )
...
) -> capo_organizations.types.update_policy_response.UpdatePolicyResponse:
    out: capo_organizations.types.update_policy_response.UpdatePolicyResponse = (
        capo_organizations.types.update_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.update_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
