"""Generated from Smithy shape ``com.amazonaws.organizations#DisablePolicyType``."""
...
import capo_organizations.types.disable_policy_type_request
import capo_organizations.types.disable_policy_type_response
...
) -> capo_organizations.types.disable_policy_type_response.DisablePolicyTypeResponse:
    out: capo_organizations.types.disable_policy_type_response.DisablePolicyTypeResponse = capo_organizations.types.disable_policy_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.disable_policy_type_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disable_policy_type(
