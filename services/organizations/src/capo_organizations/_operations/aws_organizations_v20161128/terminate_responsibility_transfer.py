"""Generated from Smithy shape ``com.amazonaws.organizations#TerminateResponsibilityTransfer``."""
...
import capo_organizations.errors.invalid_responsibility_transfer_transition_exception
import capo_organizations.errors.responsibility_transfer_already_in_status_exception
...
import capo_organizations.types.terminate_responsibility_transfer_request
import capo_organizations.types.terminate_responsibility_transfer_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidResponsibilityTransferTransitionException":
            raise capo_organizations.errors.invalid_responsibility_transfer_transition_exception.InvalidResponsibilityTransferTransitionException.from_aws_json_1_1(
                data, message
            )
        case "ResponsibilityTransferAlreadyInStatusException":
            raise capo_organizations.errors.responsibility_transfer_already_in_status_exception.ResponsibilityTransferAlreadyInStatusException.from_aws_json_1_1(
                data, message
            )
...
) -> capo_organizations.types.terminate_responsibility_transfer_response.TerminateResponsibilityTransferResponse:
    out: capo_organizations.types.terminate_responsibility_transfer_response.TerminateResponsibilityTransferResponse = capo_organizations.types.terminate_responsibility_transfer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.terminate_responsibility_transfer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_terminate_responsibility_transfer(
