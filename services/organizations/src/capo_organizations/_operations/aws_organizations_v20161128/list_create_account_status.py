"""Generated from Smithy shape ``com.amazonaws.organizations#ListCreateAccountStatus``."""
...
import capo_organizations.types.list_create_account_status_request
import capo_organizations.types.list_create_account_status_response
...
) -> capo_organizations.types.list_create_account_status_response.ListCreateAccountStatusResponse:
    out: capo_organizations.types.list_create_account_status_response.ListCreateAccountStatusResponse = capo_organizations.types.list_create_account_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_create_account_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_create_account_status(
