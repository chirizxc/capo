...
import capo_organizations.types.enabled_service_principals
import capo_organizations.types.list_aws_service_access_for_organization_request
import capo_organizations.types.list_aws_service_access_for_organization_response
...
) -> capo_organizations.types.list_aws_service_access_for_organization_response.ListAWSServiceAccessForOrganizationResponse:
    out: capo_organizations.types.list_aws_service_access_for_organization_response.ListAWSServiceAccessForOrganizationResponse = capo_organizations.types.list_aws_service_access_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_aws_service_access_for_organization_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
