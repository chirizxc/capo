"""Generated from Smithy shape ``com.amazonaws.organizations#CancelHandshake``."""
...
import capo_organizations.types.cancel_handshake_request
import capo_organizations.types.cancel_handshake_response
...
) -> capo_organizations.types.cancel_handshake_response.CancelHandshakeResponse:
    out: capo_organizations.types.cancel_handshake_response.CancelHandshakeResponse = (
        capo_organizations.types.cancel_handshake_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.cancel_handshake_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_cancel_handshake(
