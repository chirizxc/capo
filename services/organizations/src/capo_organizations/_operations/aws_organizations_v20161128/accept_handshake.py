"""Generated from Smithy shape ``com.amazonaws.organizations#AcceptHandshake``."""
...
import capo_organizations.types.accept_handshake_request
import capo_organizations.types.accept_handshake_response
...
) -> capo_organizations.types.accept_handshake_response.AcceptHandshakeResponse:
    out: capo_organizations.types.accept_handshake_response.AcceptHandshakeResponse = (
        capo_organizations.types.accept_handshake_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.accept_handshake_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_accept_handshake(
