...
import capo_organizations.errors.child_not_found_exception
...
import capo_organizations.types.list_parents_request
import capo_organizations.types.list_parents_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ChildNotFoundException":
            raise capo_organizations.errors.child_not_found_exception.ChildNotFoundException.from_aws_json_1_1(
                data, message
            )
...
) -> capo_organizations.types.list_parents_response.ListParentsResponse:
    out: capo_organizations.types.list_parents_response.ListParentsResponse = (
        capo_organizations.types.list_parents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_parents_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_parents(
    ...
    capo_organizations.types.list_parents_response.ListParentsResponse, zapros.Response
]:
