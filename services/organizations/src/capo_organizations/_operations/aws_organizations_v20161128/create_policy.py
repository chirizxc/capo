"""Generated from Smithy shape ``com.amazonaws.organizations#CreatePolicy``."""
...
import capo_organizations.types.create_policy_request
import capo_organizations.types.create_policy_response
...
) -> capo_organizations.types.create_policy_response.CreatePolicyResponse:
    out: capo_organizations.types.create_policy_response.CreatePolicyResponse = (
        capo_organizations.types.create_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.create_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
