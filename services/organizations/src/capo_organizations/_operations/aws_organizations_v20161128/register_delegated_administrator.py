"""Generated from Smithy shape ``com.amazonaws.organizations#RegisterDelegatedAdministrator``."""
...
import capo_organizations.errors.account_already_registered_exception
...
import capo_organizations.types.register_delegated_administrator_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "AccountAlreadyRegisteredException":
            raise capo_organizations.errors.account_already_registered_exception.AccountAlreadyRegisteredException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.register_delegated_administrator_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_register_delegated_administrator(
