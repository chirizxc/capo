"""Generated from Smithy shape ``com.amazonaws.organizations#CreateOrganizationalUnit``."""
...
import capo_organizations.types.create_organizational_unit_request
import capo_organizations.types.create_organizational_unit_response
...
) -> capo_organizations.types.create_organizational_unit_response.CreateOrganizationalUnitResponse:
    out: capo_organizations.types.create_organizational_unit_response.CreateOrganizationalUnitResponse = capo_organizations.types.create_organizational_unit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.CreateOrganizationalUnit"
    body: bytes | None = json.dumps(
        capo_organizations.types.create_organizational_unit_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_organizational_unit(
