...
import capo_organizations.errors.create_account_status_not_found_exception
...
import capo_organizations.types.describe_create_account_status_request
import capo_organizations.types.describe_create_account_status_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CreateAccountStatusNotFoundException":
            raise capo_organizations.errors.create_account_status_not_found_exception.CreateAccountStatusNotFoundException.from_aws_json_1_1(
                data, message
            )
...
) -> capo_organizations.types.describe_create_account_status_response.DescribeCreateAccountStatusResponse:
    out: capo_organizations.types.describe_create_account_status_response.DescribeCreateAccountStatusResponse = capo_organizations.types.describe_create_account_status_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.describe_create_account_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
