...
import capo_organizations.types.list_organizational_units_for_parent_request
import capo_organizations.types.list_organizational_units_for_parent_response
...
) -> capo_organizations.types.list_organizational_units_for_parent_response.ListOrganizationalUnitsForParentResponse:
    out: capo_organizations.types.list_organizational_units_for_parent_response.ListOrganizationalUnitsForParentResponse = capo_organizations.types.list_organizational_units_for_parent_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_organizational_units_for_parent_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
