...
import capo_organizations.types.list_accounts_with_invalid_effective_policy_request
import capo_organizations.types.list_accounts_with_invalid_effective_policy_response
...
) -> capo_organizations.types.list_accounts_with_invalid_effective_policy_response.ListAccountsWithInvalidEffectivePolicyResponse:
    out: capo_organizations.types.list_accounts_with_invalid_effective_policy_response.ListAccountsWithInvalidEffectivePolicyResponse = capo_organizations.types.list_accounts_with_invalid_effective_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_accounts_with_invalid_effective_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
