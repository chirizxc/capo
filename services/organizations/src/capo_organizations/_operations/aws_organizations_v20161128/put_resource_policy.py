...
import capo_organizations.types.put_resource_policy_request
import capo_organizations.types.put_resource_policy_response
...
) -> capo_organizations.types.put_resource_policy_response.PutResourcePolicyResponse:
    out: capo_organizations.types.put_resource_policy_response.PutResourcePolicyResponse = capo_organizations.types.put_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.put_resource_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
