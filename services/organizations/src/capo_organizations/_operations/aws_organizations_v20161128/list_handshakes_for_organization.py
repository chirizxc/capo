"""Generated from Smithy shape ``com.amazonaws.organizations#ListHandshakesForOrganization``."""
...
import capo_organizations.types.list_handshakes_for_organization_request
import capo_organizations.types.list_handshakes_for_organization_response
...
) -> capo_organizations.types.list_handshakes_for_organization_response.ListHandshakesForOrganizationResponse:
    out: capo_organizations.types.list_handshakes_for_organization_response.ListHandshakesForOrganizationResponse = capo_organizations.types.list_handshakes_for_organization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.ListHandshakesForOrganization"
    body: bytes | None = json.dumps(
        capo_organizations.types.list_handshakes_for_organization_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_handshakes_for_organization(
