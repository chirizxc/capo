"""Generated from Smithy shape ``com.amazonaws.organizations#ListHandshakesForAccount``."""
...
import capo_organizations.types.list_handshakes_for_account_request
import capo_organizations.types.list_handshakes_for_account_response
...
) -> capo_organizations.types.list_handshakes_for_account_response.ListHandshakesForAccountResponse:
    out: capo_organizations.types.list_handshakes_for_account_response.ListHandshakesForAccountResponse = capo_organizations.types.list_handshakes_for_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.ListHandshakesForAccount"
    body: bytes | None = json.dumps(
        capo_organizations.types.list_handshakes_for_account_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_handshakes_for_account(
