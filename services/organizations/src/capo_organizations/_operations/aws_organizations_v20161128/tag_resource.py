"""Generated from Smithy shape ``com.amazonaws.organizations#TagResource``."""
...
import capo_organizations.types.tag_resource_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.tag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
