"""Generated from Smithy shape ``com.amazonaws.organizations#EnableAllFeatures``."""
...
import capo_organizations.types.enable_all_features_request
import capo_organizations.types.enable_all_features_response
...
) -> capo_organizations.types.enable_all_features_response.EnableAllFeaturesResponse:
    out: capo_organizations.types.enable_all_features_response.EnableAllFeaturesResponse = capo_organizations.types.enable_all_features_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.enable_all_features_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_enable_all_features(
