"""Generated from Smithy shape ``com.amazonaws.organizations#DescribeOrganization``."""
...
import capo_organizations.types.describe_organization_response
...
def handle_response(
    ...
    capo_organizations.types.describe_organization_response.DescribeOrganizationResponse
):
    out: capo_organizations.types.describe_organization_response.DescribeOrganizationResponse = capo_organizations.types.describe_organization_response.deserialize_aws_json_1_1(
