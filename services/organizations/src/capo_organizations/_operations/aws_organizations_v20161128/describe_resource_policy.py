...
import capo_organizations.errors.resource_policy_not_found_exception
...
import capo_organizations.types.describe_resource_policy_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourcePolicyNotFoundException":
            raise capo_organizations.errors.resource_policy_not_found_exception.ResourcePolicyNotFoundException.from_aws_json_1_1(
                data, message
            )
...
) -> capo_organizations.types.describe_resource_policy_response.DescribeResourcePolicyResponse:
    out: capo_organizations.types.describe_resource_policy_response.DescribeResourcePolicyResponse = capo_organizations.types.describe_resource_policy_response.deserialize_aws_json_1_1(
