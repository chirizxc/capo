"""Generated from Smithy shape ``com.amazonaws.organizations#ListTargetsForPolicy``."""
...
import capo_organizations.types.list_targets_for_policy_request
import capo_organizations.types.list_targets_for_policy_response
...
) -> capo_organizations.types.list_targets_for_policy_response.ListTargetsForPolicyResponse:
    out: capo_organizations.types.list_targets_for_policy_response.ListTargetsForPolicyResponse = capo_organizations.types.list_targets_for_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.list_targets_for_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
