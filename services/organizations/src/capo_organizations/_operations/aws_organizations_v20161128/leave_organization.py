"""Generated from Smithy shape ``com.amazonaws.organizations#LeaveOrganization``."""
...
def leave_organization(options: OperationOptions) -> tuple[None, zapros.Response]:
...
async def async_leave_organization(
