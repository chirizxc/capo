...
import capo_organizations.types.describe_organizational_unit_request
import capo_organizations.types.describe_organizational_unit_response
...
) -> capo_organizations.types.describe_organizational_unit_response.DescribeOrganizationalUnitResponse:
    out: capo_organizations.types.describe_organizational_unit_response.DescribeOrganizationalUnitResponse = capo_organizations.types.describe_organizational_unit_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.describe_organizational_unit_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
