"""Generated from Smithy shape ``com.amazonaws.organizations#DeleteResourcePolicy``."""
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    headers["X-Amz-Target"] = "AWSOrganizationsV20161128.DeleteResourcePolicy"
    body: bytes | None = b"{}"
...
def delete_resource_policy(options: OperationOptions) -> tuple[None, zapros.Response]:
