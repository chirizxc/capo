"""Generated from Smithy shape ``com.amazonaws.organizations#DeletePolicy``."""
...
import capo_organizations.errors.policy_in_use_exception
...
import capo_organizations.types.delete_policy_request
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "PolicyInUseException":
            raise capo_organizations.errors.policy_in_use_exception.PolicyInUseException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_organizations.types.delete_policy_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
