...
from capo_marketplace_catalog._services._aws_config import aws_config
...
class MarketplaceCatalogClientConfig(TypedDict, total=False, closed=True):
...
class MarketplaceCatalogClient:
    ...
    def batch_describe_entities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.batch_describe_entities_request.BatchDescribeEntitiesRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.batch_describe_entities_response.BatchDescribeEntitiesResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.batch_describe_entities.batch_describe_entities(
    ...
    def cancel_change_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.cancel_change_set_request.CancelChangeSetRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.cancel_change_set_response.CancelChangeSetResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.cancel_change_set.cancel_change_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.delete_resource_policy_request.DeleteResourcePolicyRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.delete_resource_policy_response.DeleteResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.delete_resource_policy.delete_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_change_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.describe_change_set_request.DescribeChangeSetRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.describe_change_set_response.DescribeChangeSetResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.describe_change_set.describe_change_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_entity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.describe_entity_request.DescribeEntityRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.describe_entity_response.DescribeEntityResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.describe_entity.describe_entity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.get_resource_policy_request.GetResourcePolicyRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.get_resource_policy_response.GetResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.get_resource_policy.get_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_change_sets(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.list_change_sets_request.ListChangeSetsRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.list_change_sets_response.ListChangeSetsResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.list_change_sets.list_change_sets(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_marketplace_catalog.types.change_set_summary_list_item.ChangeSetSummaryListItem]":
        _token = next_token
        while True:
    ...
    def list_entities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.list_entities_request.ListEntitiesRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.list_entities_response.ListEntitiesResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.list_entities.list_entities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_marketplace_catalog.types.entity_summary.EntitySummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_resource_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.put_resource_policy_request.PutResourcePolicyRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.put_resource_policy_response.PutResourcePolicyResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.put_resource_policy.put_resource_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_change_set(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.start_change_set_request.StartChangeSetRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.start_change_set_response.StartChangeSetResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.start_change_set.start_change_set(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_marketplace_catalog.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_marketplace_catalog.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_marketplace_catalog._operations.awsmp_seymour.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
