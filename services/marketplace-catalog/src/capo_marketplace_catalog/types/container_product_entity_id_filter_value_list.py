...
if TYPE_CHECKING:
    import capo_marketplace_catalog.types.container_product_entity_id_string

ContainerProductEntityIdFilterValueList: TypeAlias = list[
    "capo_marketplace_catalog.types.container_product_entity_id_string.ContainerProductEntityIdString"
]
