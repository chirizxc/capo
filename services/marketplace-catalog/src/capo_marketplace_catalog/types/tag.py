...
if TYPE_CHECKING:
    import capo_marketplace_catalog.types.tag_key
    import capo_marketplace_catalog.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_marketplace_catalog.types.tag_key.TagKey"
    """<p>The key associated with the tag.</p>"""
    value: "capo_marketplace_catalog.types.tag_value.TagValue"
