"""Generated from Smithy shape ``com.amazonaws.marketplacecatalog#DescribeChangeSet``."""
...
def handle_response(
    ...
    out: capo_marketplace_catalog.types.describe_change_set_response.DescribeChangeSetResponse = capo_marketplace_catalog.types.describe_change_set_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DescribeChangeSet"
