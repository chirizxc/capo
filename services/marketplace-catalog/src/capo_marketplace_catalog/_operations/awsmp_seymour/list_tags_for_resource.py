"""Generated from Smithy shape ``com.amazonaws.marketplacecatalog#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_marketplace_catalog.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_marketplace_catalog.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_catalog.types.list_tags_for_resource_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
