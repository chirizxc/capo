...
def handle_response(
    ...
    out: capo_marketplace_catalog.types.cancel_change_set_response.CancelChangeSetResponse = capo_marketplace_catalog.types.cancel_change_set_response.deserialize_json(
...
def build_request(
    ...
    if "catalog" in input_:
        params.append(("catalog", input_["catalog"]))
    if "change_set_id" in input_:
        params.append(("changeSetId", input_["change_set_id"]))
