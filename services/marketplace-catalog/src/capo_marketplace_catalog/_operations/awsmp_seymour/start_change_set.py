...
import capo_marketplace_catalog._protocol.eventstream
...
import capo_marketplace_catalog.errors.resource_in_use_exception
import capo_marketplace_catalog.errors.resource_not_found_exception
import capo_marketplace_catalog.errors.service_quota_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceInUseException":
            raise capo_marketplace_catalog.errors.resource_in_use_exception.ResourceInUseException.from_json(
                data, message
            )
        ...
        case "ServiceQuotaExceededException":
            raise capo_marketplace_catalog.errors.service_quota_exceeded_exception.ServiceQuotaExceededException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_marketplace_catalog.types.start_change_set_response.StartChangeSetResponse = capo_marketplace_catalog.types.start_change_set_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = (
                capo_marketplace_catalog._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_catalog.types.start_change_set_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
