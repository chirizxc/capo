...
import capo_directory_service.errors.incompatible_settings_exception
...
import capo_directory_service.errors.unsupported_settings_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IncompatibleSettingsException":
            raise capo_directory_service.errors.incompatible_settings_exception.IncompatibleSettingsException.from_aws_json_1_1(
                data, message
            )
        ...
        case "UnsupportedSettingsException":
            raise capo_directory_service.errors.unsupported_settings_exception.UnsupportedSettingsException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_directory_service.types.update_settings_result.UpdateSettingsResult = (
        capo_directory_service.types.update_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.update_settings_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
