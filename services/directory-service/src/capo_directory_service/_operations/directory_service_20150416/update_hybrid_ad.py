...
def handle_response(
    ...
    out: capo_directory_service.types.update_hybrid_ad_result.UpdateHybridADResult = (
        capo_directory_service.types.update_hybrid_ad_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.update_hybrid_ad_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
