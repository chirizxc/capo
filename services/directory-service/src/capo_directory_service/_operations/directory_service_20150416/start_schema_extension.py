...
def handle_response(
    ...
    out: capo_directory_service.types.start_schema_extension_result.StartSchemaExtensionResult = capo_directory_service.types.start_schema_extension_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.start_schema_extension_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
