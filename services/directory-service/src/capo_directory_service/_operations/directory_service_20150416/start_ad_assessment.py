"""Generated from Smithy shape ``com.amazonaws.directoryservice#StartADAssessment``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.start_ad_assessment_result.StartADAssessmentResult = capo_directory_service.types.start_ad_assessment_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.StartADAssessment"
    body: bytes | None = json.dumps(
        capo_directory_service.types.start_ad_assessment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_ad_assessment(
