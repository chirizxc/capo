"""Generated from Smithy shape ``com.amazonaws.directoryservice#DeregisterEventTopic``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.deregister_event_topic_result.DeregisterEventTopicResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.deregister_event_topic_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_deregister_event_topic(
