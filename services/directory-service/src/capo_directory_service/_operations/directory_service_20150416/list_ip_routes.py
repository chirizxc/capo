"""Generated from Smithy shape ``com.amazonaws.directoryservice#ListIpRoutes``."""
...
import capo_directory_service.types.ip_routes_info
...
def handle_response(
    ...
    out: capo_directory_service.types.list_ip_routes_result.ListIpRoutesResult = (
        capo_directory_service.types.list_ip_routes_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.list_ip_routes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_ip_routes(
