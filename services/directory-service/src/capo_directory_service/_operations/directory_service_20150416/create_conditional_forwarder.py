...
def handle_response(
    ...
    out: capo_directory_service.types.create_conditional_forwarder_result.CreateConditionalForwarderResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.create_conditional_forwarder_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
