"""Generated from Smithy shape ``com.amazonaws.directoryservice#VerifyTrust``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.verify_trust_result.VerifyTrustResult = (
        capo_directory_service.types.verify_trust_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.verify_trust_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def verify_trust(
    ...
    capo_directory_service.types.verify_trust_result.VerifyTrustResult, zapros.Response
]:
