"""Generated from Smithy shape ``com.amazonaws.directoryservice#ResetUserPassword``."""
...
import capo_directory_service.errors.invalid_password_exception
...
import capo_directory_service.errors.user_does_not_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPasswordException":
            raise capo_directory_service.errors.invalid_password_exception.InvalidPasswordException.from_aws_json_1_1(
                data, message
            )
        ...
        case "UserDoesNotExistException":
            raise capo_directory_service.errors.user_does_not_exist_exception.UserDoesNotExistException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_directory_service.types.reset_user_password_result.ResetUserPasswordResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.reset_user_password_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
