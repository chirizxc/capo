...
import capo_directory_service.errors.enable_already_in_progress_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EnableAlreadyInProgressException":
            raise capo_directory_service.errors.enable_already_in_progress_exception.EnableAlreadyInProgressException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.enable_ca_enrollment_policy_result.EnableCAEnrollmentPolicyResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.enable_ca_enrollment_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
