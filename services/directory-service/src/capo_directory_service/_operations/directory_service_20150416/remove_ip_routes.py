"""Generated from Smithy shape ``com.amazonaws.directoryservice#RemoveIpRoutes``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.remove_ip_routes_result.RemoveIpRoutesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.remove_ip_routes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_remove_ip_routes(
