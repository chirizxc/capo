...
import capo_directory_service.errors.invalid_target_exception
import capo_directory_service.errors.organizations_exception
import capo_directory_service.errors.service_exception
import capo_directory_service.errors.share_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTargetException":
            raise capo_directory_service.errors.invalid_target_exception.InvalidTargetException.from_aws_json_1_1(
                data, message
            )
        case "OrganizationsException":
            raise capo_directory_service.errors.organizations_exception.OrganizationsException.from_aws_json_1_1(
                data, message
            )
        ...
        case "ShareLimitExceededException":
            raise capo_directory_service.errors.share_limit_exceeded_exception.ShareLimitExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.share_directory_result.ShareDirectoryResult = (
        capo_directory_service.types.share_directory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.share_directory_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
