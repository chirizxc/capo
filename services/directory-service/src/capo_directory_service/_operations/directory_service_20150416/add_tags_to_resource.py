"""Generated from Smithy shape ``com.amazonaws.directoryservice#AddTagsToResource``."""
...
import capo_directory_service.errors.tag_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TagLimitExceededException":
            raise capo_directory_service.errors.tag_limit_exceeded_exception.TagLimitExceededException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_directory_service.types.add_tags_to_resource_result.AddTagsToResourceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.add_tags_to_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
