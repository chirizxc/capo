...
import capo_directory_service.types.ldaps_settings_info
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_ldaps_settings_result.DescribeLDAPSSettingsResult = capo_directory_service.types.describe_ldaps_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_ldaps_settings_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
