"""Generated from Smithy shape ``com.amazonaws.directoryservice#EnableLDAPS``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.enable_ldaps_result.EnableLDAPSResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.enable_ldaps_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def enable_ldaps(
    ...
    capo_directory_service.types.enable_ldaps_result.EnableLDAPSResult, zapros.Response
]:
