"""Generated from Smithy shape ``com.amazonaws.directoryservice#UnshareDirectory``."""
...
import capo_directory_service.errors.directory_not_shared_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DirectoryNotSharedException":
            raise capo_directory_service.errors.directory_not_shared_exception.DirectoryNotSharedException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.unshare_directory_result.UnshareDirectoryResult = capo_directory_service.types.unshare_directory_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.unshare_directory_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_unshare_directory(
