"""Generated from Smithy shape ``com.amazonaws.directoryservice#DescribeSnapshots``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.describe_snapshots_result.DescribeSnapshotsResult = capo_directory_service.types.describe_snapshots_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.describe_snapshots_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
