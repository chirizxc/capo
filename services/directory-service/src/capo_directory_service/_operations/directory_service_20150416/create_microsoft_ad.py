"""Generated from Smithy shape ``com.amazonaws.directoryservice#CreateMicrosoftAD``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.create_microsoft_ad_result.CreateMicrosoftADResult = capo_directory_service.types.create_microsoft_ad_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.create_microsoft_ad_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_microsoft_ad(
