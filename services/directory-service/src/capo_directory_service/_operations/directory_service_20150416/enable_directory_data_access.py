"""Generated from Smithy shape ``com.amazonaws.directoryservice#EnableDirectoryDataAccess``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.enable_directory_data_access_result.EnableDirectoryDataAccessResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.EnableDirectoryDataAccess"
    body: bytes | None = json.dumps(
        capo_directory_service.types.enable_directory_data_access_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_enable_directory_data_access(
