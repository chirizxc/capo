"""Generated from Smithy shape ``com.amazonaws.directoryservice#EnableClientAuthentication``."""
...
import capo_directory_service.errors.invalid_client_auth_status_exception
import capo_directory_service.errors.no_available_certificate_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidClientAuthStatusException":
            raise capo_directory_service.errors.invalid_client_auth_status_exception.InvalidClientAuthStatusException.from_aws_json_1_1(
                data, message
            )
        case "NoAvailableCertificateException":
            raise capo_directory_service.errors.no_available_certificate_exception.NoAvailableCertificateException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.enable_client_authentication_result.EnableClientAuthenticationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "DirectoryService_20150416.EnableClientAuthentication"
    body: bytes | None = json.dumps(
        capo_directory_service.types.enable_client_authentication_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_enable_client_authentication(
