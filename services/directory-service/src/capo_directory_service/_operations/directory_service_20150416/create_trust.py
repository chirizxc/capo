...
def handle_response(
    ...
    out: capo_directory_service.types.create_trust_result.CreateTrustResult = (
        capo_directory_service.types.create_trust_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.create_trust_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def create_trust(
    ...
    capo_directory_service.types.create_trust_result.CreateTrustResult, zapros.Response
]:
