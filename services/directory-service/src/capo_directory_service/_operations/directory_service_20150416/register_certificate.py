...
import capo_directory_service.errors.certificate_already_exists_exception
import capo_directory_service.errors.certificate_limit_exceeded_exception
...
import capo_directory_service.errors.invalid_certificate_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CertificateAlreadyExistsException":
            raise capo_directory_service.errors.certificate_already_exists_exception.CertificateAlreadyExistsException.from_aws_json_1_1(
                data, message
            )
        case "CertificateLimitExceededException":
            raise capo_directory_service.errors.certificate_limit_exceeded_exception.CertificateLimitExceededException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidCertificateException":
            raise capo_directory_service.errors.invalid_certificate_exception.InvalidCertificateException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.register_certificate_result.RegisterCertificateResult = capo_directory_service.types.register_certificate_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.register_certificate_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
