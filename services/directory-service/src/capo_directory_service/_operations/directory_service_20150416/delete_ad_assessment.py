...
def handle_response(
    ...
    out: capo_directory_service.types.delete_ad_assessment_result.DeleteADAssessmentResult = capo_directory_service.types.delete_ad_assessment_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.delete_ad_assessment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
