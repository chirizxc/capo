"""Generated from Smithy shape ``com.amazonaws.directoryservice#UpdateNumberOfDomainControllers``."""
...
import capo_directory_service.errors.domain_controller_limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DomainControllerLimitExceededException":
            raise capo_directory_service.errors.domain_controller_limit_exceeded_exception.DomainControllerLimitExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_directory_service.types.update_number_of_domain_controllers_result.UpdateNumberOfDomainControllersResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.update_number_of_domain_controllers_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_number_of_domain_controllers(
