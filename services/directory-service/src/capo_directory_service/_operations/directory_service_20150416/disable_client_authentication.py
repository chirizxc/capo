...
def handle_response(
    ...
    out: capo_directory_service.types.disable_client_authentication_result.DisableClientAuthenticationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.disable_client_authentication_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
