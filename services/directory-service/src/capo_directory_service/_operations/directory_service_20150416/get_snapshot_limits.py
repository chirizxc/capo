"""Generated from Smithy shape ``com.amazonaws.directoryservice#GetSnapshotLimits``."""
...
def handle_response(
    ...
    out: capo_directory_service.types.get_snapshot_limits_result.GetSnapshotLimitsResult = capo_directory_service.types.get_snapshot_limits_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_directory_service.types.get_snapshot_limits_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_snapshot_limits(
