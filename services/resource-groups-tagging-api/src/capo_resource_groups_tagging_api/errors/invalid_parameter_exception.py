"""Generated from Smithy shape ``com.amazonaws.resourcegroupstaggingapi#InvalidParameterException``."""
...
class InvalidParameterException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.resourcegroupstaggingapi#InvalidParameterException``."""
