...
from capo_resource_groups_tagging_api._services._aws_config import aws_config
...
class ResourceGroupsTaggingAPIClientConfig(TypedDict, total=False, closed=True):
...
class ResourceGroupsTaggingAPIClient:
    ...
    def __init__(
        ...
        self._config = ResourceGroupsTaggingAPIClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[ResourceGroupsTaggingAPIClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: ResourceGroupsTaggingAPIClientConfig = config_overrides or {}
    ...
    def describe_report_creation(
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.describe_report_creation_input.DescribeReportCreationInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.describe_report_creation_output.DescribeReportCreationOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.describe_report_creation.describe_report_creation(
    ...
    def get_compliance_summary(
        self,
        *,
        config_overrides: Optional[ResourceGroupsTaggingAPIClientConfig] = None,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.get_compliance_summary_input.GetComplianceSummaryInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.get_compliance_summary_output.GetComplianceSummaryOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.get_compliance_summary.get_compliance_summary(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_resource_groups_tagging_api.types.summary.Summary]":
        _token = pagination_token
        while True:
            _response = self.get_compliance_summary(
    ...
    def get_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.get_resources_input.GetResourcesInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.get_resources_output.GetResourcesOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.get_resources.get_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_resource_groups_tagging_api.types.resource_tag_mapping.ResourceTagMapping]":
        _token = pagination_token
        while True:
    ...
    def get_tag_keys(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.get_tag_keys_input.GetTagKeysInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.get_tag_keys_output.GetTagKeysOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.get_tag_keys.get_tag_keys(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_resource_groups_tagging_api.types.tag_key.TagKey]":
        _token = pagination_token
        while True:
            _response = self.get_tag_keys(
                config_overrides=config_overrides,
                pagination_token=_token,
            )
    ...
    def get_tag_values(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.get_tag_values_input.GetTagValuesInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.get_tag_values_output.GetTagValuesOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.get_tag_values.get_tag_values(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_resource_groups_tagging_api.types.tag_value.TagValue]":
        _token = pagination_token
        while True:
            _response = self.get_tag_values(
                key,
                config_overrides=config_overrides,
                pagination_token=_token,
            )
    ...
    def list_required_tags(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.list_required_tags_input.ListRequiredTagsInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.list_required_tags_output.ListRequiredTagsOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.list_required_tags.list_required_tags(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_resource_groups_tagging_api.types.required_tag.RequiredTag]":
        _token = next_token
        while True:
            _response = self.list_required_tags(
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
            )
    ...
    def start_report_creation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.start_report_creation_input.StartReportCreationInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.start_report_creation_output.StartReportCreationOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.start_report_creation.start_report_creation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.tag_resources_input.TagResourcesInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.tag_resources_output.TagResourcesOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.tag_resources.tag_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resources(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_resource_groups_tagging_api.types.untag_resources_input.UntagResourcesInput]",
        ) -> OperationResponse[
            "capo_resource_groups_tagging_api.types.untag_resources_output.UntagResourcesOutput"
        ]:
            ...
            output, http_response = (
                capo_resource_groups_tagging_api._operations.resource_groups_tagging_api_20170126.untag_resources.untag_resources(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
