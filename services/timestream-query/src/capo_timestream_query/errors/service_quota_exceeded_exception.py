"""Generated from Smithy shape ``com.amazonaws.timestreamquery#ServiceQuotaExceededException``."""
...
class ServiceQuotaExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.timestreamquery#ServiceQuotaExceededException``."""
