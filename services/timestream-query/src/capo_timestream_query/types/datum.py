...
if TYPE_CHECKING:
    ...
    import capo_timestream_query.types.scalar_value
    import capo_timestream_query.types.time_series_data_point_list


class Datum(TypedDict, closed=True):
    scalar_value: NotRequired["capo_timestream_query.types.scalar_value.ScalarValue"]
    """<p> Indicates if the data point is a scalar value such as integer, string, double, or Boolean. </p>"""
    time_series_value: NotRequired[
        "capo_timestream_query.types.time_series_data_point_list.TimeSeriesDataPointList"
    ]
    """<p> Indicates if the data point is a timeseries data type. </p>"""
    array_value: NotRequired["capo_timestream_query.types.datum_list.DatumList"]
    """<p> Indicates if the data point is an array. </p>"""
    row_value: NotRequired["capo_timestream_query.types.row.Row"]
...
def serialize_aws_json_1_0(value: Datum) -> dict:
    ...
    if "time_series_value" in value:
        ...
        out["TimeSeriesValue"] = (
            capo_timestream_query.types.time_series_data_point_list.serialize_aws_json_1_0(
    ...
    if "array_value" in value:
        ...
        out["ArrayValue"] = (
            capo_timestream_query.types.datum_list.serialize_aws_json_1_0(
                value["array_value"]
            )
        )
    if "row_value" in value:
        ...
        out["RowValue"] = capo_timestream_query.types.row.serialize_aws_json_1_0(
            value["row_value"]
        )
...
def deserialize_aws_json_1_0(data: dict) -> Datum:
    ...
    if data.get("TimeSeriesValue") is not None:
        ...
        out["time_series_value"] = (
            capo_timestream_query.types.time_series_data_point_list.deserialize_aws_json_1_0(
    ...
    if data.get("ArrayValue") is not None:
        ...
        out["array_value"] = (
            capo_timestream_query.types.datum_list.deserialize_aws_json_1_0(
                data["ArrayValue"]
            )
        )
