...
from capo_timestream_query._services._aws_config import aws_config
...
class TimestreamQueryClient:
    ...
    def cancel_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.cancel_query_request.CancelQueryRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.cancel_query_response.CancelQueryResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.cancel_query.cancel_query(
    ...
    def create_scheduled_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.create_scheduled_query_request.CreateScheduledQueryRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.create_scheduled_query_response.CreateScheduledQueryResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.create_scheduled_query.create_scheduled_query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_scheduled_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.delete_scheduled_query_request.DeleteScheduledQueryRequest]",
        ) -> OperationResponse[None]:
            import capo_timestream_query._operations.timestream_20181101.delete_scheduled_query

            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.delete_scheduled_query.delete_scheduled_query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_account_settings(
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.describe_account_settings_request.DescribeAccountSettingsRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.describe_account_settings_response.DescribeAccountSettingsResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.describe_account_settings.describe_account_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_endpoints(
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.describe_endpoints_request.DescribeEndpointsRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.describe_endpoints_response.DescribeEndpointsResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.describe_endpoints.describe_endpoints(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_scheduled_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.describe_scheduled_query_request.DescribeScheduledQueryRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.describe_scheduled_query_response.DescribeScheduledQueryResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.describe_scheduled_query.describe_scheduled_query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def execute_scheduled_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.execute_scheduled_query_request.ExecuteScheduledQueryRequest]",
        ) -> OperationResponse[None]:
            import capo_timestream_query._operations.timestream_20181101.execute_scheduled_query

            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.execute_scheduled_query.execute_scheduled_query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_scheduled_queries(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.list_scheduled_queries_request.ListScheduledQueriesRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.list_scheduled_queries_response.ListScheduledQueriesResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.list_scheduled_queries.list_scheduled_queries(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_timestream_query.types.scheduled_query.ScheduledQuery]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_timestream_query.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    def prepare_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.prepare_query_request.PrepareQueryRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.prepare_query_response.PrepareQueryResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.prepare_query.prepare_query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.query_request.QueryRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.query_response.QueryResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.query.query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_timestream_query.types.row.Row]":
        _token = next_token
        while True:
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_account_settings(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.update_account_settings_request.UpdateAccountSettingsRequest]",
        ) -> OperationResponse[
            "capo_timestream_query.types.update_account_settings_response.UpdateAccountSettingsResponse"
        ]:
            ...
            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.update_account_settings.update_account_settings(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_scheduled_query(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_timestream_query.types.update_scheduled_query_request.UpdateScheduledQueryRequest]",
        ) -> OperationResponse[None]:
            import capo_timestream_query._operations.timestream_20181101.update_scheduled_query

            output, http_response = (
                capo_timestream_query._operations.timestream_20181101.update_scheduled_query.update_scheduled_query(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
