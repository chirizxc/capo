"""Generated from Smithy shape ``com.amazonaws.timestreamquery#ExecuteScheduledQuery``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.ExecuteScheduledQuery"
    body: bytes | None = json.dumps(
        capo_timestream_query.types.execute_scheduled_query_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_execute_scheduled_query(
