"""Generated from Smithy shape ``com.amazonaws.timestreamquery#CancelQuery``."""
...
def handle_response(
    ...
    out: capo_timestream_query.types.cancel_query_response.CancelQueryResponse = (
        capo_timestream_query.types.cancel_query_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Timestream_20181101.CancelQuery"
    body: bytes | None = json.dumps(
        capo_timestream_query.types.cancel_query_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
