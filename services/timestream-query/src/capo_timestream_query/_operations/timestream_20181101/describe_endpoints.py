...
def handle_response(
    ...
    out: capo_timestream_query.types.describe_endpoints_response.DescribeEndpointsResponse = capo_timestream_query.types.describe_endpoints_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_timestream_query.types.describe_endpoints_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
