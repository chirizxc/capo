...
```
pip install capo-timestream-query
```

## Usage

```python
from capo_timestream_query import AsyncTimestreamQueryClient
...
```python
from capo_timestream_query import AsyncTimestreamQueryClient
from capo_timestream_query.error import AccessDeniedException
