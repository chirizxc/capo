...
class IdleRecommendationFilter(TypedDict, closed=True):
    name: NotRequired[
        "capo_compute_optimizer.types.idle_recommendation_filter_name.IdleRecommendationFilterName"
    ]
...
def serialize_aws_json_1_0(value: IdleRecommendationFilter) -> dict:
    ...
    if "name" in value:
        ...
        out["name"] = (
            capo_compute_optimizer.types.idle_recommendation_filter_name.serialize_aws_json_1_0(
                value["name"]
            )
        )
    if "values" in value:
...
def deserialize_aws_json_1_0(data: dict) -> IdleRecommendationFilter:
    ...
    if data.get("name") is not None:
        ...
        out["name"] = (
            capo_compute_optimizer.types.idle_recommendation_filter_name.deserialize_aws_json_1_0(
                data["name"]
            )
        )
