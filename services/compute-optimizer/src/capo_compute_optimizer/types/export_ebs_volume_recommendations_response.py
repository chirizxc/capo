"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ExportEBSVolumeRecommendationsResponse``."""
...
class ExportEBSVolumeRecommendationsResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ExportEBSVolumeRecommendationsResponse) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_aws_json_1_0(data: dict) -> ExportEBSVolumeRecommendationsResponse:
    out: ExportEBSVolumeRecommendationsResponse = {}  # type: ignore[typeddict-item]
