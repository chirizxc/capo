"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#ECSServiceUtilizationMetric``."""
...
class ECSServiceUtilizationMetric(TypedDict, closed=True):
    name: NotRequired[
        "capo_compute_optimizer.types.ecs_service_metric_name.ECSServiceMetricName"
    ]
    """<p> The name of the utilization metric. </p> <p>The following utilization metrics are available:</p> <ul> <li> <p> <code>Cpu</code> — The amount of CPU capacity that's used in the service.</p> </li> <li> <p> <code>Memory</code> — The amount of memory that's used in the service.</p> </li> </ul>"""
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ECSServiceUtilizationMetric) -> dict:
    out: dict = {}
    if "name" in value:
        import capo_compute_optimizer.types.ecs_service_metric_name
...
def deserialize_aws_json_1_0(data: dict) -> ECSServiceUtilizationMetric:
    out: ECSServiceUtilizationMetric = {}  # type: ignore[typeddict-item]
