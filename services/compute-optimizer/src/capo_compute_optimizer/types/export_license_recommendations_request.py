...
def serialize_aws_json_1_0(value: ExportLicenseRecommendationsRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["filters"] = (
            capo_compute_optimizer.types.license_recommendation_filters.serialize_aws_json_1_0(
                value["filters"]
            )
        )
    if "fields_to_export" in value:
        ...
        out["fieldsToExport"] = (
            capo_compute_optimizer.types.exportable_license_fields.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ExportLicenseRecommendationsRequest:
    ...
    if data.get("filters") is not None:
        ...
        out["filters"] = (
            capo_compute_optimizer.types.license_recommendation_filters.deserialize_aws_json_1_0(
                data["filters"]
            )
        )
    if data.get("fieldsToExport") is not None:
        ...
        out["fields_to_export"] = (
            capo_compute_optimizer.types.exportable_license_fields.deserialize_aws_json_1_0(
                data["fieldsToExport"]
            )
        )
