"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#LambdaEstimatedMonthlySavings``."""
...
class LambdaEstimatedMonthlySavings(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: LambdaEstimatedMonthlySavings) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> LambdaEstimatedMonthlySavings:
    out: LambdaEstimatedMonthlySavings = {}  # type: ignore[typeddict-item]
