...
if TYPE_CHECKING:
    import capo_compute_optimizer.types.ebs_estimated_monthly_savings
...
class EBSSavingsOpportunityAfterDiscounts(TypedDict, closed=True):
    ...
    estimated_monthly_savings: NotRequired[
        "capo_compute_optimizer.types.ebs_estimated_monthly_savings.EBSEstimatedMonthlySavings"
    ]
...
def serialize_aws_json_1_0(value: EBSSavingsOpportunityAfterDiscounts) -> dict:
    ...
    if "estimated_monthly_savings" in value:
        ...
        out["estimatedMonthlySavings"] = (
            capo_compute_optimizer.types.ebs_estimated_monthly_savings.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> EBSSavingsOpportunityAfterDiscounts:
    ...
    if data.get("estimatedMonthlySavings") is not None:
        ...
        out["estimated_monthly_savings"] = (
            capo_compute_optimizer.types.ebs_estimated_monthly_savings.deserialize_aws_json_1_0(
