...
def handle_response(
    ...
    out: capo_compute_optimizer.types.export_ec2_instance_recommendations_response.ExportEC2InstanceRecommendationsResponse = capo_compute_optimizer.types.export_ec2_instance_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.export_ec2_instance_recommendations_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
