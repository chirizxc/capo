...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_enrollment_statuses_for_organization_response.GetEnrollmentStatusesForOrganizationResponse = capo_compute_optimizer.types.get_enrollment_statuses_for_organization_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_enrollment_statuses_for_organization_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
