...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_response.GetRDSDatabaseRecommendationProjectedMetricsResponse = capo_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_rds_database_recommendation_projected_metrics_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
