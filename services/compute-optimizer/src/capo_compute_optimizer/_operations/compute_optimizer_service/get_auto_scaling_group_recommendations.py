"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetAutoScalingGroupRecommendations``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_auto_scaling_group_recommendations_response.GetAutoScalingGroupRecommendationsResponse = capo_compute_optimizer.types.get_auto_scaling_group_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_auto_scaling_group_recommendations_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_auto_scaling_group_recommendations(
