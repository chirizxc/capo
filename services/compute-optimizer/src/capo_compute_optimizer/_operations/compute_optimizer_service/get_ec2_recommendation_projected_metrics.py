"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#GetEC2RecommendationProjectedMetrics``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_ec2_recommendation_projected_metrics_response.GetEC2RecommendationProjectedMetricsResponse = capo_compute_optimizer.types.get_ec2_recommendation_projected_metrics_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_ec2_recommendation_projected_metrics_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_ec2_recommendation_projected_metrics(
