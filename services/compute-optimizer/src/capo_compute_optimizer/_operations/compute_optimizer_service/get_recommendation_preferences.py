...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_recommendation_preferences_response.GetRecommendationPreferencesResponse = capo_compute_optimizer.types.get_recommendation_preferences_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_recommendation_preferences_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
