"""Generated from Smithy shape ``com.amazonaws.computeoptimizer#PutRecommendationPreferences``."""
...
def handle_response(
    ...
    out: capo_compute_optimizer.types.put_recommendation_preferences_response.PutRecommendationPreferencesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ComputeOptimizerService.PutRecommendationPreferences"
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.put_recommendation_preferences_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_recommendation_preferences(
