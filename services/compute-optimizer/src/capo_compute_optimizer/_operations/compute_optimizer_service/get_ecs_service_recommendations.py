...
def handle_response(
    ...
    out: capo_compute_optimizer.types.get_ecs_service_recommendations_response.GetECSServiceRecommendationsResponse = capo_compute_optimizer.types.get_ecs_service_recommendations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_compute_optimizer.types.get_ecs_service_recommendations_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
