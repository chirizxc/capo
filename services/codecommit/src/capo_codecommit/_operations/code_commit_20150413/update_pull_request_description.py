...
def handle_response(
    ...
    out: capo_codecommit.types.update_pull_request_description_output.UpdatePullRequestDescriptionOutput = capo_codecommit.types.update_pull_request_description_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_pull_request_description_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
