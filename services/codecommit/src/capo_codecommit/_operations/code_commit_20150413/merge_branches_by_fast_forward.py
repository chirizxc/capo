"""Generated from Smithy shape ``com.amazonaws.codecommit#MergeBranchesByFastForward``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.merge_branches_by_fast_forward_output.MergeBranchesByFastForwardOutput = capo_codecommit.types.merge_branches_by_fast_forward_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.merge_branches_by_fast_forward_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_merge_branches_by_fast_forward(
