...
def handle_response(
    ...
    out: capo_codecommit.types.get_pull_request_approval_states_output.GetPullRequestApprovalStatesOutput = capo_codecommit.types.get_pull_request_approval_states_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_pull_request_approval_states_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
