...
import capo_codecommit.errors.tags_map_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TagsMapRequiredException":
            raise capo_codecommit.errors.tags_map_required_exception.TagsMapRequiredException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.tag_resource_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
