...
def handle_response(
    ...
    out: capo_codecommit.types.get_merge_commit_output.GetMergeCommitOutput = (
        capo_codecommit.types.get_merge_commit_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_merge_commit_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_merge_commit(
    ...
    capo_codecommit.types.get_merge_commit_output.GetMergeCommitOutput, zapros.Response
]:
