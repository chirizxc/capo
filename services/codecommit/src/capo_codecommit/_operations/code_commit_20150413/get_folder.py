...
import capo_codecommit.errors.folder_does_not_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FolderDoesNotExistException":
            raise capo_codecommit.errors.folder_does_not_exist_exception.FolderDoesNotExistException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.get_folder_output.GetFolderOutput = (
        capo_codecommit.types.get_folder_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_folder_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_folder(
    ...
    input_: capo_codecommit.types.get_folder_input.GetFolderInput,
) -> tuple[capo_codecommit.types.get_folder_output.GetFolderOutput, zapros.Response]:
