"""Generated from Smithy shape ``com.amazonaws.codecommit#BatchDisassociateApprovalRuleTemplateFromRepositories``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_output.BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput = capo_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.batch_disassociate_approval_rule_template_from_repositories_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_disassociate_approval_rule_template_from_repositories(
