"""Generated from Smithy shape ``com.amazonaws.codecommit#ListRepositories``."""
...
import capo_codecommit.errors.invalid_order_exception
import capo_codecommit.errors.invalid_sort_by_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOrderException":
            raise capo_codecommit.errors.invalid_order_exception.InvalidOrderException.from_aws_json_1_1(
                data, message
            )
        case "InvalidSortByException":
            raise capo_codecommit.errors.invalid_sort_by_exception.InvalidSortByException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_codecommit.types.list_repositories_output.ListRepositoriesOutput = (
        capo_codecommit.types.list_repositories_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.list_repositories_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_repositories(
