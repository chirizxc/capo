"""Generated from Smithy shape ``com.amazonaws.codecommit#GetCommentsForComparedCommit``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.get_comments_for_compared_commit_output.GetCommentsForComparedCommitOutput = capo_codecommit.types.get_comments_for_compared_commit_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_comments_for_compared_commit_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_comments_for_compared_commit(
