"""Generated from Smithy shape ``com.amazonaws.codecommit#DeleteApprovalRuleTemplate``."""
...
import capo_codecommit.errors.approval_rule_template_in_use_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ApprovalRuleTemplateInUseException":
            raise capo_codecommit.errors.approval_rule_template_in_use_exception.ApprovalRuleTemplateInUseException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.delete_approval_rule_template_output.DeleteApprovalRuleTemplateOutput = capo_codecommit.types.delete_approval_rule_template_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.delete_approval_rule_template_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_approval_rule_template(
