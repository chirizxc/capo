...
import capo_codecommit.errors.actor_does_not_exist_exception
...
import capo_codecommit.errors.invalid_actor_arn_exception
...
import capo_codecommit.errors.invalid_pull_request_event_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ActorDoesNotExistException":
            raise capo_codecommit.errors.actor_does_not_exist_exception.ActorDoesNotExistException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidActorArnException":
            raise capo_codecommit.errors.invalid_actor_arn_exception.InvalidActorArnException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidPullRequestEventTypeException":
            raise capo_codecommit.errors.invalid_pull_request_event_type_exception.InvalidPullRequestEventTypeException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.describe_pull_request_events_output.DescribePullRequestEventsOutput = capo_codecommit.types.describe_pull_request_events_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.describe_pull_request_events_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
