"""Generated from Smithy shape ``com.amazonaws.codecommit#GetCommentsForPullRequest``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.get_comments_for_pull_request_output.GetCommentsForPullRequestOutput = capo_codecommit.types.get_comments_for_pull_request_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_comments_for_pull_request_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_comments_for_pull_request(
