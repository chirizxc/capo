"""Generated from Smithy shape ``com.amazonaws.codecommit#GetMergeConflicts``."""
...
import capo_codecommit.errors.invalid_destination_commit_specifier_exception
...
import capo_codecommit.errors.invalid_source_commit_specifier_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidDestinationCommitSpecifierException":
            raise capo_codecommit.errors.invalid_destination_commit_specifier_exception.InvalidDestinationCommitSpecifierException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidSourceCommitSpecifierException":
            raise capo_codecommit.errors.invalid_source_commit_specifier_exception.InvalidSourceCommitSpecifierException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.get_merge_conflicts_output.GetMergeConflictsOutput = (
        capo_codecommit.types.get_merge_conflicts_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_merge_conflicts_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_merge_conflicts(
