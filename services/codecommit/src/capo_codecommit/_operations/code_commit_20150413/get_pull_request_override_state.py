"""Generated from Smithy shape ``com.amazonaws.codecommit#GetPullRequestOverrideState``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.get_pull_request_override_state_output.GetPullRequestOverrideStateOutput = capo_codecommit.types.get_pull_request_override_state_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_pull_request_override_state_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_pull_request_override_state(
