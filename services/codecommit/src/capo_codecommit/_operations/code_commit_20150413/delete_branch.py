"""Generated from Smithy shape ``com.amazonaws.codecommit#DeleteBranch``."""
...
import capo_codecommit.errors.default_branch_cannot_be_deleted_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DefaultBranchCannotBeDeletedException":
            raise capo_codecommit.errors.default_branch_cannot_be_deleted_exception.DefaultBranchCannotBeDeletedException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.delete_branch_output.DeleteBranchOutput = (
        capo_codecommit.types.delete_branch_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.delete_branch_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_branch(
    ...
    capo_codecommit.types.delete_branch_output.DeleteBranchOutput, zapros.Response
]:
