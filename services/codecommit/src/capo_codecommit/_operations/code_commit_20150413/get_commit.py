"""Generated from Smithy shape ``com.amazonaws.codecommit#GetCommit``."""
...
import capo_codecommit.errors.commit_id_does_not_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CommitIdDoesNotExistException":
            raise capo_codecommit.errors.commit_id_does_not_exist_exception.CommitIdDoesNotExistException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.get_commit_output.GetCommitOutput = (
        capo_codecommit.types.get_commit_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_commit_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_commit(
    ...
    input_: capo_codecommit.types.get_commit_input.GetCommitInput,
) -> tuple[capo_codecommit.types.get_commit_output.GetCommitOutput, zapros.Response]:
