"""Generated from Smithy shape ``com.amazonaws.codecommit#GetDifferences``."""
...
import capo_codecommit.types.difference_list
...
def handle_response(
    ...
    out: capo_codecommit.types.get_differences_output.GetDifferencesOutput = (
        capo_codecommit.types.get_differences_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_differences_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_differences(
    ...
    capo_codecommit.types.get_differences_output.GetDifferencesOutput, zapros.Response
]:
...
async def async_get_differences(
