...
import capo_codecommit.errors.file_content_required_exception
...
import capo_codecommit.errors.same_file_content_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FileContentRequiredException":
            raise capo_codecommit.errors.file_content_required_exception.FileContentRequiredException.from_aws_json_1_1(
                data, message
            )
        ...
        case "SameFileContentException":
            raise capo_codecommit.errors.same_file_content_exception.SameFileContentException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_codecommit.types.put_file_output.PutFileOutput = (
        capo_codecommit.types.put_file_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.put_file_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_file(
    options: OperationOptions, input_: capo_codecommit.types.put_file_input.PutFileInput
) -> tuple[capo_codecommit.types.put_file_output.PutFileOutput, zapros.Response]:
