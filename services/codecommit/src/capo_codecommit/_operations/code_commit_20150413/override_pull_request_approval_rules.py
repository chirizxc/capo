...
import capo_codecommit.errors.invalid_override_status_exception
...
import capo_codecommit.errors.override_already_set_exception
import capo_codecommit.errors.override_status_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOverrideStatusException":
            raise capo_codecommit.errors.invalid_override_status_exception.InvalidOverrideStatusException.from_aws_json_1_1(
                data, message
            )
        ...
        case "OverrideAlreadySetException":
            raise capo_codecommit.errors.override_already_set_exception.OverrideAlreadySetException.from_aws_json_1_1(
                data, message
            )
        case "OverrideStatusRequiredException":
            raise capo_codecommit.errors.override_status_required_exception.OverrideStatusRequiredException.from_aws_json_1_1(
                data, message
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.override_pull_request_approval_rules_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
