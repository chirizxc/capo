"""Generated from Smithy shape ``com.amazonaws.codecommit#BatchGetCommits``."""
...
import capo_codecommit.errors.commit_ids_limit_exceeded_exception
import capo_codecommit.errors.commit_ids_list_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "CommitIdsLimitExceededException":
            raise capo_codecommit.errors.commit_ids_limit_exceeded_exception.CommitIdsLimitExceededException.from_aws_json_1_1(
                data, message
            )
        case "CommitIdsListRequiredException":
            raise capo_codecommit.errors.commit_ids_list_required_exception.CommitIdsListRequiredException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.batch_get_commits_output.BatchGetCommitsOutput = (
        capo_codecommit.types.batch_get_commits_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.batch_get_commits_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_batch_get_commits(
