"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdatePullRequestStatus``."""
...
import capo_codecommit.errors.invalid_pull_request_status_update_exception
...
import capo_codecommit.errors.pull_request_status_required_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPullRequestStatusUpdateException":
            raise capo_codecommit.errors.invalid_pull_request_status_update_exception.InvalidPullRequestStatusUpdateException.from_aws_json_1_1(
                data, message
            )
        ...
        case "PullRequestStatusRequiredException":
            raise capo_codecommit.errors.pull_request_status_required_exception.PullRequestStatusRequiredException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_codecommit.types.update_pull_request_status_output.UpdatePullRequestStatusOutput = capo_codecommit.types.update_pull_request_status_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_pull_request_status_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_pull_request_status(
