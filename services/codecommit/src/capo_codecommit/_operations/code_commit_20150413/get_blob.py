...
import capo_codecommit.errors.blob_id_does_not_exist_exception
import capo_codecommit.errors.blob_id_required_exception
...
import capo_codecommit.errors.invalid_blob_id_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BlobIdDoesNotExistException":
            raise capo_codecommit.errors.blob_id_does_not_exist_exception.BlobIdDoesNotExistException.from_aws_json_1_1(
                data, message
            )
        case "BlobIdRequiredException":
            raise capo_codecommit.errors.blob_id_required_exception.BlobIdRequiredException.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidBlobIdException":
            raise capo_codecommit.errors.invalid_blob_id_exception.InvalidBlobIdException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_codecommit.types.get_blob_output.GetBlobOutput = (
        capo_codecommit.types.get_blob_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_blob_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_blob(
    options: OperationOptions, input_: capo_codecommit.types.get_blob_input.GetBlobInput
) -> tuple[capo_codecommit.types.get_blob_output.GetBlobOutput, zapros.Response]:
