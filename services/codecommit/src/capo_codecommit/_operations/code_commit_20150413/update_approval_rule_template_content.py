"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdateApprovalRuleTemplateContent``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.update_approval_rule_template_content_output.UpdateApprovalRuleTemplateContentOutput = capo_codecommit.types.update_approval_rule_template_content_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_approval_rule_template_content_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_approval_rule_template_content(
