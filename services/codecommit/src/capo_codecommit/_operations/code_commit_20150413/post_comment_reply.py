...
def handle_response(
    ...
    out: capo_codecommit.types.post_comment_reply_output.PostCommentReplyOutput = (
        capo_codecommit.types.post_comment_reply_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.post_comment_reply_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
