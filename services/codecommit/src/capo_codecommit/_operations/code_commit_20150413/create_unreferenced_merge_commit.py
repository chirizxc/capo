...
def handle_response(
    ...
    out: capo_codecommit.types.create_unreferenced_merge_commit_output.CreateUnreferencedMergeCommitOutput = capo_codecommit.types.create_unreferenced_merge_commit_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.create_unreferenced_merge_commit_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
