...
def handle_response(
    ...
    out: capo_codecommit.types.put_repository_triggers_output.PutRepositoryTriggersOutput = capo_codecommit.types.put_repository_triggers_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.put_repository_triggers_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
