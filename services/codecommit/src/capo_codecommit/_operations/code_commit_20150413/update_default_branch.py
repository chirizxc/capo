"""Generated from Smithy shape ``com.amazonaws.codecommit#UpdateDefaultBranch``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_default_branch_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_default_branch(
