...
def handle_response(
    ...
    out: capo_codecommit.types.update_approval_rule_template_name_output.UpdateApprovalRuleTemplateNameOutput = capo_codecommit.types.update_approval_rule_template_name_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.update_approval_rule_template_name_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
