"""Generated from Smithy shape ``com.amazonaws.codecommit#GetApprovalRuleTemplate``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.get_approval_rule_template_output.GetApprovalRuleTemplateOutput = capo_codecommit.types.get_approval_rule_template_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_approval_rule_template_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_approval_rule_template(
