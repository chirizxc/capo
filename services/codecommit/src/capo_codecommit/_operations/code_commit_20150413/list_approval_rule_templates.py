"""Generated from Smithy shape ``com.amazonaws.codecommit#ListApprovalRuleTemplates``."""
...
def handle_response(
    ...
    out: capo_codecommit.types.list_approval_rule_templates_output.ListApprovalRuleTemplatesOutput = capo_codecommit.types.list_approval_rule_templates_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.list_approval_rule_templates_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_approval_rule_templates(
