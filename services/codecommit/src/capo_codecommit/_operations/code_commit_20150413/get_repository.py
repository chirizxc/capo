...
def handle_response(
    ...
    out: capo_codecommit.types.get_repository_output.GetRepositoryOutput = (
        capo_codecommit.types.get_repository_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecommit.types.get_repository_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_repository(
    ...
    capo_codecommit.types.get_repository_output.GetRepositoryOutput, zapros.Response
]:
