"""Generated from Smithy shape ``com.amazonaws.codecommit#RepositoryTriggerDestinationArnRequiredException``."""
...
class RepositoryTriggerDestinationArnRequiredException_(TypedDict, closed=True):
...
def serialize_aws_json_1_1(
    value: RepositoryTriggerDestinationArnRequiredException_,
) -> dict:
    out: dict = {}
    if "message" in value:
...
class RepositoryTriggerDestinationArnRequiredException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.codecommit#RepositoryTriggerDestinationArnRequiredException``."""
