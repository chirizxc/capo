...
class GetCommentsForComparedCommitOutput(TypedDict, closed=True):
    comments_for_compared_commit_data: NotRequired[
        "capo_codecommit.types.comments_for_compared_commit_data.CommentsForComparedCommitData"
    ]
...
def serialize_aws_json_1_1(value: GetCommentsForComparedCommitOutput) -> dict:
    ...
    if "comments_for_compared_commit_data" in value:
        ...
        out["commentsForComparedCommitData"] = (
            capo_codecommit.types.comments_for_compared_commit_data.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetCommentsForComparedCommitOutput:
    ...
    if data.get("commentsForComparedCommitData") is not None:
        ...
        out["comments_for_compared_commit_data"] = (
            capo_codecommit.types.comments_for_compared_commit_data.deserialize_aws_json_1_1(
