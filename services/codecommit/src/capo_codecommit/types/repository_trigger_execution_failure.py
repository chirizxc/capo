...
if TYPE_CHECKING:
    import capo_codecommit.types.repository_trigger_execution_failure_message
...
class RepositoryTriggerExecutionFailure(TypedDict, closed=True):
    ...
    failure_message: NotRequired[
        "capo_codecommit.types.repository_trigger_execution_failure_message.RepositoryTriggerExecutionFailureMessage"
    ]
