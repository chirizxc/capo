...
if TYPE_CHECKING:
    import capo_codecommit.types.hunk_content
    import capo_codecommit.types.line_number


class MergeHunkDetail(TypedDict, closed=True):
    start_line: NotRequired["capo_codecommit.types.line_number.LineNumber"]
    """<p>The start position of the hunk in the merge result.</p>"""
    end_line: NotRequired["capo_codecommit.types.line_number.LineNumber"]
    """<p>The end position of the hunk in the merge result.</p>"""
    hunk_content: NotRequired["capo_codecommit.types.hunk_content.HunkContent"]
