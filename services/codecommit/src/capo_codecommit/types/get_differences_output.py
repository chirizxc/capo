...
class GetDifferencesOutput(TypedDict, closed=True):
    differences: NotRequired["capo_codecommit.types.difference_list.DifferenceList"]
...
def serialize_aws_json_1_1(value: GetDifferencesOutput) -> dict:
    ...
    if "differences" in value:
        ...
        out["differences"] = (
            capo_codecommit.types.difference_list.serialize_aws_json_1_1(
                value["differences"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetDifferencesOutput:
    ...
    if data.get("differences") is not None:
        ...
        out["differences"] = (
            capo_codecommit.types.difference_list.deserialize_aws_json_1_1(
                data["differences"]
            )
        )
