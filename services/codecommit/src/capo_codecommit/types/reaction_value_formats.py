...
if TYPE_CHECKING:
    import capo_codecommit.types.reaction_emoji
    import capo_codecommit.types.reaction_short_code
    import capo_codecommit.types.reaction_unicode


class ReactionValueFormats(TypedDict, closed=True):
    emoji: NotRequired["capo_codecommit.types.reaction_emoji.ReactionEmoji"]
    ...
    short_code: NotRequired[
        "capo_codecommit.types.reaction_short_code.ReactionShortCode"
    ]
    ...
    unicode: NotRequired["capo_codecommit.types.reaction_unicode.ReactionUnicode"]
