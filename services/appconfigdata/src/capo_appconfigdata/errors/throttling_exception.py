"""Generated from Smithy shape ``com.amazonaws.appconfigdata#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appconfigdata#ThrottlingException``."""
