...
from capo_lambda._async import anysleep
...
class AsyncLambdaClient:
    ...
    async def iter_list_capacity_providers(
        self,
        *,
        config_overrides: Optional[AsyncLambdaClientConfig] = None,
        state: Optional[
    ...
    ) -> "AsyncIterator[capo_lambda.types.capacity_provider.CapacityProvider]":
        _token = marker
        while True:
            _response = await self.list_capacity_providers(
    ...
    async def iter_list_function_versions_by_capacity_provider(
        self,
        capacity_provider_name: "capo_lambda.types.capacity_provider_name.CapacityProviderName",
        *,
        config_overrides: Optional[AsyncLambdaClientConfig] = None,
    ...
    ) -> "AsyncIterator[capo_lambda.types.function_versions_by_capacity_provider_list_item.FunctionVersionsByCapacityProviderListItem]":
        _token = marker
        while True:
            _response = await self.list_function_versions_by_capacity_provider(
    ...
    async def create_event_source_mapping(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_event_source_mapping(batch_size=5, event_source_arn='arn:aws:sqs:us-west-2:123456789012:my-queue', function_name='my-function')
        """
    ...
    async def get_event_source_mapping(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_event_source_mapping(uuid='14e0db71-xmpl-4eb5-b481-8945cf9d10c2')
        """
    ...
    async def update_event_source_mapping(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_event_source_mapping(batch_size=123, enabled=True, function_name='myFunction', uuid='a1b2c3d4-5678-90ab-cdef-11111EXAMPLE')
        """
    ...
    async def delete_event_source_mapping(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_event_source_mapping(uuid='14e0db71-xmpl-4eb5-b481-8945cf9d10c2')
        """
    ...
    async def list_event_source_mappings(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_event_source_mappings(function_name='my-function')
        """
    ...
    async def create_function(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_function(code={'S3Bucket': 'my-bucket-1xpuxmplzrlbh', 'S3Key': 'function.zip'}, description='Process image objects from Amazon S3.', durable_config={'ExecutionTimeout': 31622400, 'RetentionPeriodInDays': 30}, environment={'Variables': {'BUCKET': 'my-bucket-1xpuxmplzrlbh', 'PREFIX': 'inbound'}}, function_name='my-function', handler='index.handler', kms_key_arn='arn:aws:kms:us-west-2:123456789012:key/b0844d6c-xmpl-4463-97a4-d49f50839966', memory_size=256, publish=True, role='arn:aws:iam::123456789012:role/lambda-role', runtime='nodejs12.x', tags={'DEPARTMENT': 'Assets'}, timeout=15, tracing_config={'Mode': 'Active'})
        """
    ...
    async def wait_until_function_exists(
        self,
        function_name: "capo_lambda.types.namespaced_function_name.NamespacedFunctionName",
        *,
        max_wait_time: float,
        ...
        while True:
            ...
            try:
                op_output = await self.get_function(  # noqa: F841
                    function_name,
                    config_overrides=config_overrides,
                    qualifier=qualifier,
                )
    ...
    async def create_alias(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_alias(description='alias for live version of function', function_name='my-function', function_version='1', name='LIVE')
        """
    ...
    async def get_alias(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_alias(function_name='my-function', name='BLUE')
        """
    ...
    async def update_alias(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_alias(function_name='my-function', function_version='2', name='BLUE', routing_config={'AdditionalVersionWeights': {'1': 0.7}})
        """
    ...
    async def delete_alias(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_alias(function_name='my-function', name='BLUE')
        """
    ...
    async def list_aliases(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_aliases(function_name='my-function')
        """
    ...
    async def publish_version(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.publish_version(code_sha256='', description='', function_name='myFunction')
        """
    ...
    async def iter_list_versions_by_function(
        self,
        function_name: "capo_lambda.types.namespaced_function_name.NamespacedFunctionName",
        *,
        config_overrides: Optional[AsyncLambdaClientConfig] = None,
        ...
        "AsyncIterator[capo_lambda.types.function_configuration.FunctionConfiguration]"
    ):
        _token = marker
        while True:
            _response = await self.list_versions_by_function(
                function_name,
                config_overrides=config_overrides,
                marker=_token,
                max_items=max_items,
    ...
    async def list_layers(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_layers(compatible_runtime='python3.7')
        """
    ...
    async def list_layer_versions(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_layer_versions(layer_name='blank-java-lib')
        """
    ...
    async def add_permission(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_lambda.types.add_permission_request.AddPermissionRequest]",
        ) -> AsyncOperationResponse[
            "capo_lambda.types.add_permission_response.AddPermissionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_lambda._operations.aws_gir_api_service.add_permission.async_add_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def remove_permission(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_lambda.types.remove_permission_request.RemovePermissionRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_lambda._operations.aws_gir_api_service.remove_permission.async_remove_permission(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_provisioned_concurrency_config(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.put_provisioned_concurrency_config(function_name='my-function', provisioned_concurrent_executions=100, qualifier='BLUE')
        """
    ...
    async def delete_provisioned_concurrency_config(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_provisioned_concurrency_config(function_name='my-function', qualifier='GREEN')
        """
