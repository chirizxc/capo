"""Generated from Smithy shape ``com.amazonaws.glue#RemoveSchemaVersionMetadata``."""
...
def handle_response(
    ...
    out: capo_glue.types.remove_schema_version_metadata_response.RemoveSchemaVersionMetadataResponse = capo_glue.types.remove_schema_version_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.RemoveSchemaVersionMetadata"
    body: bytes | None = json.dumps(
        capo_glue.types.remove_schema_version_metadata_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_remove_schema_version_metadata(
