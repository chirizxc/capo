...
def handle_response(
    ...
    out: capo_glue.types.list_data_quality_rulesets_response.ListDataQualityRulesetsResponse = capo_glue.types.list_data_quality_rulesets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_data_quality_rulesets_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
