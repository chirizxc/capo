"""Generated from Smithy shape ``com.amazonaws.glue#DeleteWorkflow``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_workflow_response.DeleteWorkflowResponse = (
        capo_glue.types.delete_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_workflow_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_workflow(
    ...
    capo_glue.types.delete_workflow_response.DeleteWorkflowResponse, zapros.Response
]:
