"""Generated from Smithy shape ``com.amazonaws.glue#TestConnection``."""
...
def handle_response(
    ...
    out: capo_glue.types.test_connection_response.TestConnectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.TestConnection"
    body: bytes | None = json.dumps(
        capo_glue.types.test_connection_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def test_connection(
    ...
    capo_glue.types.test_connection_response.TestConnectionResponse, zapros.Response
]:
