...
def handle_response(
    ...
    out: capo_glue.types.create_blueprint_response.CreateBlueprintResponse = (
        capo_glue.types.create_blueprint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_blueprint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_blueprint(
    ...
    capo_glue.types.create_blueprint_response.CreateBlueprintResponse, zapros.Response
]:
