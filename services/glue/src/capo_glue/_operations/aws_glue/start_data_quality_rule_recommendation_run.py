"""Generated from Smithy shape ``com.amazonaws.glue#StartDataQualityRuleRecommendationRun``."""
...
def handle_response(
    ...
    out: capo_glue.types.start_data_quality_rule_recommendation_run_response.StartDataQualityRuleRecommendationRunResponse = capo_glue.types.start_data_quality_rule_recommendation_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StartDataQualityRuleRecommendationRun"
    body: bytes | None = json.dumps(
        capo_glue.types.start_data_quality_rule_recommendation_run_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_data_quality_rule_recommendation_run(
