"""Generated from Smithy shape ``com.amazonaws.glue#GetBlueprintRuns``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_blueprint_runs_response.GetBlueprintRunsResponse = (
        capo_glue.types.get_blueprint_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetBlueprintRuns"
    body: bytes | None = json.dumps(
        capo_glue.types.get_blueprint_runs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_blueprint_runs(
