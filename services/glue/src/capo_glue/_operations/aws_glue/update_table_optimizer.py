"""Generated from Smithy shape ``com.amazonaws.glue#UpdateTableOptimizer``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_table_optimizer_response.UpdateTableOptimizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateTableOptimizer"
    body: bytes | None = json.dumps(
        capo_glue.types.update_table_optimizer_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_table_optimizer(
