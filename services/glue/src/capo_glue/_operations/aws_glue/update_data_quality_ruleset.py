"""Generated from Smithy shape ``com.amazonaws.glue#UpdateDataQualityRuleset``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_data_quality_ruleset_response.UpdateDataQualityRulesetResponse = capo_glue.types.update_data_quality_ruleset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateDataQualityRuleset"
    body: bytes | None = json.dumps(
        capo_glue.types.update_data_quality_ruleset_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_data_quality_ruleset(
