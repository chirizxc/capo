...
def handle_response(
    ...
    out: capo_glue.types.create_trigger_response.CreateTriggerResponse = (
        capo_glue.types.create_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_trigger_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_trigger(
    ...
    capo_glue.types.create_trigger_response.CreateTriggerResponse, zapros.Response
]:
