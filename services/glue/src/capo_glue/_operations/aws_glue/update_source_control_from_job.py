...
def handle_response(
    ...
    out: capo_glue.types.update_source_control_from_job_response.UpdateSourceControlFromJobResponse = capo_glue.types.update_source_control_from_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_source_control_from_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
