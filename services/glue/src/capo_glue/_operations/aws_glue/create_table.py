...
def handle_response(
    ...
    out: capo_glue.types.create_table_response.CreateTableResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_table_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_table(
    ...
    input_: capo_glue.types.create_table_request.CreateTableRequest,
) -> tuple[capo_glue.types.create_table_response.CreateTableResponse, zapros.Response]:
