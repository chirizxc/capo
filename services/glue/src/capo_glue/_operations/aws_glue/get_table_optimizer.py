...
def handle_response(
    ...
    out: capo_glue.types.get_table_optimizer_response.GetTableOptimizerResponse = (
        capo_glue.types.get_table_optimizer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_table_optimizer_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
