"""Generated from Smithy shape ``com.amazonaws.glue#CreateMLTransform``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_ml_transform_response.CreateMLTransformResponse = (
        capo_glue.types.create_ml_transform_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_ml_transform_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_ml_transform(
