...
def handle_response(
    ...
    out: capo_glue.types.cancel_data_quality_ruleset_evaluation_run_response.CancelDataQualityRulesetEvaluationRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.cancel_data_quality_ruleset_evaluation_run_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
