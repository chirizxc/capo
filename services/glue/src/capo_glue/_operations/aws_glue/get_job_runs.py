...
def handle_response(
    ...
    out: capo_glue.types.get_job_runs_response.GetJobRunsResponse = (
        capo_glue.types.get_job_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_job_runs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_job_runs(
    ...
    input_: capo_glue.types.get_job_runs_request.GetJobRunsRequest,
) -> tuple[capo_glue.types.get_job_runs_response.GetJobRunsResponse, zapros.Response]:
