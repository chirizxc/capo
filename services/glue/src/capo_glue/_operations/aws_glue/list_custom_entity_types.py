...
def handle_response(
    ...
    out: capo_glue.types.list_custom_entity_types_response.ListCustomEntityTypesResponse = capo_glue.types.list_custom_entity_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_custom_entity_types_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
