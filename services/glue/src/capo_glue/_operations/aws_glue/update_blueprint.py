"""Generated from Smithy shape ``com.amazonaws.glue#UpdateBlueprint``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_blueprint_response.UpdateBlueprintResponse = (
        capo_glue.types.update_blueprint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateBlueprint"
    body: bytes | None = json.dumps(
        capo_glue.types.update_blueprint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_blueprint(
    ...
    capo_glue.types.update_blueprint_response.UpdateBlueprintResponse, zapros.Response
]:
