"""Generated from Smithy shape ``com.amazonaws.glue#ListBlueprints``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_blueprints_response.ListBlueprintsResponse = (
        capo_glue.types.list_blueprints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListBlueprints"
    body: bytes | None = json.dumps(
        capo_glue.types.list_blueprints_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_blueprints(
    ...
    capo_glue.types.list_blueprints_response.ListBlueprintsResponse, zapros.Response
]:
