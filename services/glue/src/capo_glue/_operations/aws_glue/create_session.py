"""Generated from Smithy shape ``com.amazonaws.glue#CreateSession``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_session_response.CreateSessionResponse = (
        capo_glue.types.create_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateSession"
    body: bytes | None = json.dumps(
        capo_glue.types.create_session_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_session(
    ...
    capo_glue.types.create_session_response.CreateSessionResponse, zapros.Response
]:
