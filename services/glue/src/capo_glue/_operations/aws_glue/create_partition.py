"""Generated from Smithy shape ``com.amazonaws.glue#CreatePartition``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_partition_response.CreatePartitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_partition_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_partition(
    ...
    capo_glue.types.create_partition_response.CreatePartitionResponse, zapros.Response
]:
...
async def async_create_partition(
