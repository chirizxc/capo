...
def handle_response(
    ...
    out: capo_glue.types.reset_job_bookmark_response.ResetJobBookmarkResponse = (
        capo_glue.types.reset_job_bookmark_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.reset_job_bookmark_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
