...
def handle_response(
    ...
    out: capo_glue.types.list_table_optimizer_runs_response.ListTableOptimizerRunsResponse = capo_glue.types.list_table_optimizer_runs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_table_optimizer_runs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
