"""Generated from Smithy shape ``com.amazonaws.glue#UpdateGlueIdentityCenterConfiguration``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_glue_identity_center_configuration_response.UpdateGlueIdentityCenterConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateGlueIdentityCenterConfiguration"
    body: bytes | None = json.dumps(
        capo_glue.types.update_glue_identity_center_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_glue_identity_center_configuration(
