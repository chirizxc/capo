"""Generated from Smithy shape ``com.amazonaws.glue#UpdateMLTransform``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_ml_transform_response.UpdateMLTransformResponse = (
        capo_glue.types.update_ml_transform_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_ml_transform_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_ml_transform(
