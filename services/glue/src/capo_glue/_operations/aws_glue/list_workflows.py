"""Generated from Smithy shape ``com.amazonaws.glue#ListWorkflows``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_workflows_response.ListWorkflowsResponse = (
        capo_glue.types.list_workflows_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_workflows_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_workflows(
    ...
    capo_glue.types.list_workflows_response.ListWorkflowsResponse, zapros.Response
]:
