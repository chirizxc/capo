...
def handle_response(
    ...
    out: capo_glue.types.get_schema_versions_diff_response.GetSchemaVersionsDiffResponse = capo_glue.types.get_schema_versions_diff_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_schema_versions_diff_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
