...
def handle_response(
    ...
    out: capo_glue.types.get_triggers_response.GetTriggersResponse = (
        capo_glue.types.get_triggers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_triggers_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_triggers(
    ...
    input_: capo_glue.types.get_triggers_request.GetTriggersRequest,
) -> tuple[capo_glue.types.get_triggers_response.GetTriggersResponse, zapros.Response]:
