...
import capo_glue.types.registry_list_definition
...
def handle_response(
    ...
    out: capo_glue.types.list_registries_response.ListRegistriesResponse = (
        capo_glue.types.list_registries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_registries_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_registries(
    ...
    capo_glue.types.list_registries_response.ListRegistriesResponse, zapros.Response
]:
