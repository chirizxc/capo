"""Generated from Smithy shape ``com.amazonaws.glue#GetTrigger``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_trigger_response.GetTriggerResponse = (
        capo_glue.types.get_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.get_trigger_request.GetTriggerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_trigger_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_trigger(
    ...
    input_: capo_glue.types.get_trigger_request.GetTriggerRequest,
) -> tuple[capo_glue.types.get_trigger_response.GetTriggerResponse, zapros.Response]:
