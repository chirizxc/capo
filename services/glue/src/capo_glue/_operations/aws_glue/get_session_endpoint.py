"""Generated from Smithy shape ``com.amazonaws.glue#GetSessionEndpoint``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_session_endpoint_response.GetSessionEndpointResponse = (
        capo_glue.types.get_session_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetSessionEndpoint"
    body: bytes | None = json.dumps(
        capo_glue.types.get_session_endpoint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
