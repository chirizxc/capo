...
def handle_response(
    ...
    out: capo_glue.types.get_ml_transform_response.GetMLTransformResponse = (
        capo_glue.types.get_ml_transform_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_ml_transform_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_ml_transform(
    ...
    capo_glue.types.get_ml_transform_response.GetMLTransformResponse, zapros.Response
]:
