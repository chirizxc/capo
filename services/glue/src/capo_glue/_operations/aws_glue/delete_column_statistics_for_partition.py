...
def handle_response(
    ...
    out: capo_glue.types.delete_column_statistics_for_partition_response.DeleteColumnStatisticsForPartitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_column_statistics_for_partition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
