...
def handle_response(
    ...
    out: capo_glue.types.get_crawler_response.GetCrawlerResponse = (
        capo_glue.types.get_crawler_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.get_crawler_request.GetCrawlerRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_crawler_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_crawler(
    ...
    input_: capo_glue.types.get_crawler_request.GetCrawlerRequest,
) -> tuple[capo_glue.types.get_crawler_response.GetCrawlerResponse, zapros.Response]:
