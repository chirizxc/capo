"""Generated from Smithy shape ``com.amazonaws.glue#DeleteConnection``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_connection_response.DeleteConnectionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_connection_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_connection(
    ...
    capo_glue.types.delete_connection_response.DeleteConnectionResponse, zapros.Response
]:
