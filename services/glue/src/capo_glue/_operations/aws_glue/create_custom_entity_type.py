...
def handle_response(
    ...
    out: capo_glue.types.create_custom_entity_type_response.CreateCustomEntityTypeResponse = capo_glue.types.create_custom_entity_type_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_custom_entity_type_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
