...
def handle_response(
    ...
    out: capo_glue.types.describe_entity_response.DescribeEntityResponse = (
        capo_glue.types.describe_entity_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.describe_entity_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_entity(
    ...
    capo_glue.types.describe_entity_response.DescribeEntityResponse, zapros.Response
]:
