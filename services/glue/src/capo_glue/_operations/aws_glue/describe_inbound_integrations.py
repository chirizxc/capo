...
import capo_glue.errors.target_resource_not_found
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TargetResourceNotFound":
            raise capo_glue.errors.target_resource_not_found.TargetResourceNotFound.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_glue.types.describe_inbound_integrations_response.DescribeInboundIntegrationsResponse = capo_glue.types.describe_inbound_integrations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.describe_inbound_integrations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
