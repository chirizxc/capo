...
def handle_response(
    ...
    out: capo_glue.types.get_partition_indexes_response.GetPartitionIndexesResponse = (
        capo_glue.types.get_partition_indexes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_partition_indexes_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
