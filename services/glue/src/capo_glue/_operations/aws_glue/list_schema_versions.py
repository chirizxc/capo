...
def handle_response(
    ...
    out: capo_glue.types.list_schema_versions_response.ListSchemaVersionsResponse = (
        capo_glue.types.list_schema_versions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_schema_versions_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
