"""Generated from Smithy shape ``com.amazonaws.glue#StopWorkflowRun``."""
...
def handle_response(
    ...
    out: capo_glue.types.stop_workflow_run_response.StopWorkflowRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StopWorkflowRun"
    body: bytes | None = json.dumps(
        capo_glue.types.stop_workflow_run_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def stop_workflow_run(
    ...
    capo_glue.types.stop_workflow_run_response.StopWorkflowRunResponse, zapros.Response
]:
