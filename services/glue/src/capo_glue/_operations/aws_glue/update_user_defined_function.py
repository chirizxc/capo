"""Generated from Smithy shape ``com.amazonaws.glue#UpdateUserDefinedFunction``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_user_defined_function_response.UpdateUserDefinedFunctionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_user_defined_function_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_user_defined_function(
