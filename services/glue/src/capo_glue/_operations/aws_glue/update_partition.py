...
def handle_response(
    ...
    out: capo_glue.types.update_partition_response.UpdatePartitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_partition_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_partition(
    ...
    capo_glue.types.update_partition_response.UpdatePartitionResponse, zapros.Response
]:
