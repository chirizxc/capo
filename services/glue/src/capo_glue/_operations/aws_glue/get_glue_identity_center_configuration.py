...
def handle_response(
    ...
    out: capo_glue.types.get_glue_identity_center_configuration_response.GetGlueIdentityCenterConfigurationResponse = capo_glue.types.get_glue_identity_center_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_glue_identity_center_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
