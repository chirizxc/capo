"""Generated from Smithy shape ``com.amazonaws.glue#CreateScript``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_script_response.CreateScriptResponse = (
        capo_glue.types.create_script_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_script_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_script(
    ...
    capo_glue.types.create_script_response.CreateScriptResponse, zapros.Response
]:
