"""Generated from Smithy shape ``com.amazonaws.glue#GetWorkflowRunProperties``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_workflow_run_properties_response.GetWorkflowRunPropertiesResponse = capo_glue.types.get_workflow_run_properties_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_workflow_run_properties_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_workflow_run_properties(
