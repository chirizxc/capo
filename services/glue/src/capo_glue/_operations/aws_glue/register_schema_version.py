...
def handle_response(
    ...
    out: capo_glue.types.register_schema_version_response.RegisterSchemaVersionResponse = capo_glue.types.register_schema_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.register_schema_version_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
