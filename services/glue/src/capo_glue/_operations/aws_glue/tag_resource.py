...
def handle_response(
    ...
    out: capo_glue.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.tag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def tag_resource(
    ...
    input_: capo_glue.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_glue.types.tag_resource_response.TagResourceResponse, zapros.Response]:
