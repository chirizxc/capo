...
def handle_response(
    ...
    out: capo_glue.types.put_workflow_run_properties_response.PutWorkflowRunPropertiesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.put_workflow_run_properties_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
