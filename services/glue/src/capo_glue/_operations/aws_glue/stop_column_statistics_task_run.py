...
import capo_glue.errors.column_statistics_task_not_running_exception
import capo_glue.errors.column_statistics_task_stopping_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ColumnStatisticsTaskNotRunningException":
            raise capo_glue.errors.column_statistics_task_not_running_exception.ColumnStatisticsTaskNotRunningException.from_aws_json_1_1(
                data, message
            )
        case "ColumnStatisticsTaskStoppingException":
            raise capo_glue.errors.column_statistics_task_stopping_exception.ColumnStatisticsTaskStoppingException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_glue.types.stop_column_statistics_task_run_response.StopColumnStatisticsTaskRunResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.stop_column_statistics_task_run_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
