"""Generated from Smithy shape ``com.amazonaws.glue#UpdateRegistry``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_registry_response.UpdateRegistryResponse = (
        capo_glue.types.update_registry_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateRegistry"
    body: bytes | None = json.dumps(
        capo_glue.types.update_registry_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_registry(
    ...
    capo_glue.types.update_registry_response.UpdateRegistryResponse, zapros.Response
]:
