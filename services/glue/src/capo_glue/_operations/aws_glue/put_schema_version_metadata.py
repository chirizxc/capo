"""Generated from Smithy shape ``com.amazonaws.glue#PutSchemaVersionMetadata``."""
...
def handle_response(
    ...
    out: capo_glue.types.put_schema_version_metadata_response.PutSchemaVersionMetadataResponse = capo_glue.types.put_schema_version_metadata_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.put_schema_version_metadata_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_schema_version_metadata(
