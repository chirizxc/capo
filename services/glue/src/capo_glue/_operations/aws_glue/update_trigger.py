...
def handle_response(
    ...
    out: capo_glue.types.update_trigger_response.UpdateTriggerResponse = (
        capo_glue.types.update_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_trigger_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_trigger(
    ...
    capo_glue.types.update_trigger_response.UpdateTriggerResponse, zapros.Response
]:
