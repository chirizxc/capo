"""Generated from Smithy shape ``com.amazonaws.glue#CreateUsageProfile``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_usage_profile_response.CreateUsageProfileResponse = (
        capo_glue.types.create_usage_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateUsageProfile"
    body: bytes | None = json.dumps(
        capo_glue.types.create_usage_profile_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_usage_profile(
