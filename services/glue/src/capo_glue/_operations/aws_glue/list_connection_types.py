"""Generated from Smithy shape ``com.amazonaws.glue#ListConnectionTypes``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_connection_types_response.ListConnectionTypesResponse = (
        capo_glue.types.list_connection_types_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListConnectionTypes"
    body: bytes | None = json.dumps(
        capo_glue.types.list_connection_types_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_connection_types(
