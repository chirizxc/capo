...
def handle_response(
    ...
    out: capo_glue.types.get_catalog_response.GetCatalogResponse = (
        capo_glue.types.get_catalog_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_catalog_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_catalog(
    ...
    input_: capo_glue.types.get_catalog_request.GetCatalogRequest,
) -> tuple[capo_glue.types.get_catalog_response.GetCatalogResponse, zapros.Response]:
