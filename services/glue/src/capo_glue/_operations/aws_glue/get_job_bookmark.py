"""Generated from Smithy shape ``com.amazonaws.glue#GetJobBookmark``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_job_bookmark_response.GetJobBookmarkResponse = (
        capo_glue.types.get_job_bookmark_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_job_bookmark_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_job_bookmark(
    ...
    capo_glue.types.get_job_bookmark_response.GetJobBookmarkResponse, zapros.Response
]:
...
async def async_get_job_bookmark(
