"""Generated from Smithy shape ``com.amazonaws.glue#GetWorkflow``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_workflow_response.GetWorkflowResponse = (
        capo_glue.types.get_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_glue.types.get_workflow_request.GetWorkflowRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_workflow_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_workflow(
    ...
    input_: capo_glue.types.get_workflow_request.GetWorkflowRequest,
) -> tuple[capo_glue.types.get_workflow_response.GetWorkflowResponse, zapros.Response]:
