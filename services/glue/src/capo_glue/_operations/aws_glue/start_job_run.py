...
def handle_response(
    ...
    out: capo_glue.types.start_job_run_response.StartJobRunResponse = (
        capo_glue.types.start_job_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_job_run_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def start_job_run(
    ...
    input_: capo_glue.types.start_job_run_request.StartJobRunRequest,
) -> tuple[capo_glue.types.start_job_run_response.StartJobRunResponse, zapros.Response]:
