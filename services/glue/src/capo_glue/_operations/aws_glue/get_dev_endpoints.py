"""Generated from Smithy shape ``com.amazonaws.glue#GetDevEndpoints``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_dev_endpoints_response.GetDevEndpointsResponse = (
        capo_glue.types.get_dev_endpoints_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_dev_endpoints_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_dev_endpoints(
    ...
    capo_glue.types.get_dev_endpoints_response.GetDevEndpointsResponse, zapros.Response
]:
...
async def async_get_dev_endpoints(
