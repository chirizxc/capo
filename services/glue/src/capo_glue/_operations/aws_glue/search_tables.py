...
def handle_response(
    ...
    out: capo_glue.types.search_tables_response.SearchTablesResponse = (
        capo_glue.types.search_tables_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.search_tables_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def search_tables(
    ...
    capo_glue.types.search_tables_response.SearchTablesResponse, zapros.Response
]:
