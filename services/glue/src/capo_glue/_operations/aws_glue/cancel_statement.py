...
def handle_response(
    ...
    out: capo_glue.types.cancel_statement_response.CancelStatementResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.cancel_statement_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def cancel_statement(
    ...
    capo_glue.types.cancel_statement_response.CancelStatementResponse, zapros.Response
]:
