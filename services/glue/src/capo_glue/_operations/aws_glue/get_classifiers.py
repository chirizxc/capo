"""Generated from Smithy shape ``com.amazonaws.glue#GetClassifiers``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_classifiers_response.GetClassifiersResponse = (
        capo_glue.types.get_classifiers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_classifiers_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_classifiers(
    ...
    capo_glue.types.get_classifiers_response.GetClassifiersResponse, zapros.Response
]:
...
async def async_get_classifiers(
