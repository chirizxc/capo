...
def handle_response(
    ...
    out: capo_glue.types.get_workflow_run_response.GetWorkflowRunResponse = (
        capo_glue.types.get_workflow_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_workflow_run_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_workflow_run(
    ...
    capo_glue.types.get_workflow_run_response.GetWorkflowRunResponse, zapros.Response
]:
