...
def handle_response(
    ...
    out: capo_glue.types.batch_get_crawlers_response.BatchGetCrawlersResponse = (
        capo_glue.types.batch_get_crawlers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_get_crawlers_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
