"""Generated from Smithy shape ``com.amazonaws.glue#CreateIntegrationResourceProperty``."""
...
def handle_response(
    ...
    out: capo_glue.types.create_integration_resource_property_response.CreateIntegrationResourcePropertyResponse = capo_glue.types.create_integration_resource_property_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.CreateIntegrationResourceProperty"
    body: bytes | None = json.dumps(
        capo_glue.types.create_integration_resource_property_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_integration_resource_property(
