"""Generated from Smithy shape ``com.amazonaws.glue#GetSchemaByDefinition``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_schema_by_definition_response.GetSchemaByDefinitionResponse = capo_glue.types.get_schema_by_definition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetSchemaByDefinition"
    body: bytes | None = json.dumps(
        capo_glue.types.get_schema_by_definition_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_schema_by_definition(
