"""Generated from Smithy shape ``com.amazonaws.glue#DeleteBlueprint``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_blueprint_response.DeleteBlueprintResponse = (
        capo_glue.types.delete_blueprint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteBlueprint"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_blueprint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_blueprint(
    ...
    capo_glue.types.delete_blueprint_response.DeleteBlueprintResponse, zapros.Response
]:
