"""Generated from Smithy shape ``com.amazonaws.glue#ListDataQualityResults``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_data_quality_results_response.ListDataQualityResultsResponse = capo_glue.types.list_data_quality_results_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.ListDataQualityResults"
    body: bytes | None = json.dumps(
        capo_glue.types.list_data_quality_results_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_data_quality_results(
