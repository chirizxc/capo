"""Generated from Smithy shape ``com.amazonaws.glue#GetDataCatalogEncryptionSettings``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_data_catalog_encryption_settings_response.GetDataCatalogEncryptionSettingsResponse = capo_glue.types.get_data_catalog_encryption_settings_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_data_catalog_encryption_settings_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_data_catalog_encryption_settings(
