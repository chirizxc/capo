...
def handle_response(
    ...
    out: capo_glue.types.batch_put_data_quality_statistic_annotation_response.BatchPutDataQualityStatisticAnnotationResponse = capo_glue.types.batch_put_data_quality_statistic_annotation_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_put_data_quality_statistic_annotation_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
