...
def handle_response(
    ...
    out: capo_glue.types.get_connections_response.GetConnectionsResponse = (
        capo_glue.types.get_connections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_connections_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_connections(
    ...
    capo_glue.types.get_connections_response.GetConnectionsResponse, zapros.Response
]:
