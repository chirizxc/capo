"""Generated from Smithy shape ``com.amazonaws.glue#GetColumnStatisticsTaskRun``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_column_statistics_task_run_response.GetColumnStatisticsTaskRunResponse = capo_glue.types.get_column_statistics_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetColumnStatisticsTaskRun"
    body: bytes | None = json.dumps(
        capo_glue.types.get_column_statistics_task_run_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_column_statistics_task_run(
