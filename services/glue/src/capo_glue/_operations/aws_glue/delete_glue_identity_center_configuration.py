"""Generated from Smithy shape ``com.amazonaws.glue#DeleteGlueIdentityCenterConfiguration``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_glue_identity_center_configuration_response.DeleteGlueIdentityCenterConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteGlueIdentityCenterConfiguration"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_glue_identity_center_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_glue_identity_center_configuration(
