...
def handle_response(
    ...
    out: capo_glue.types.list_entities_response.ListEntitiesResponse = (
        capo_glue.types.list_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_entities_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_entities(
    ...
    capo_glue.types.list_entities_response.ListEntitiesResponse, zapros.Response
]:
