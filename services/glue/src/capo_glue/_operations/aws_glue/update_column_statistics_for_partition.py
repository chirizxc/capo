"""Generated from Smithy shape ``com.amazonaws.glue#UpdateColumnStatisticsForPartition``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_column_statistics_for_partition_response.UpdateColumnStatisticsForPartitionResponse = capo_glue.types.update_column_statistics_for_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateColumnStatisticsForPartition"
    body: bytes | None = json.dumps(
        capo_glue.types.update_column_statistics_for_partition_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_column_statistics_for_partition(
