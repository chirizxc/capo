"""Generated from Smithy shape ``com.amazonaws.glue#BatchDeletePartition``."""
...
def handle_response(
    ...
    out: capo_glue.types.batch_delete_partition_response.BatchDeletePartitionResponse = capo_glue.types.batch_delete_partition_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.batch_delete_partition_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_batch_delete_partition(
