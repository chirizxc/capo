"""Generated from Smithy shape ``com.amazonaws.glue#StartTrigger``."""
...
def handle_response(
    ...
    out: capo_glue.types.start_trigger_response.StartTriggerResponse = (
        capo_glue.types.start_trigger_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_trigger_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def start_trigger(
    ...
    capo_glue.types.start_trigger_response.StartTriggerResponse, zapros.Response
]:
