"""Generated from Smithy shape ``com.amazonaws.glue#StartWorkflowRun``."""
...
def handle_response(
    ...
    out: capo_glue.types.start_workflow_run_response.StartWorkflowRunResponse = (
        capo_glue.types.start_workflow_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_workflow_run_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
