"""Generated from Smithy shape ``com.amazonaws.glue#UpdateSchema``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_schema_response.UpdateSchemaResponse = (
        capo_glue.types.update_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.UpdateSchema"
    body: bytes | None = json.dumps(
        capo_glue.types.update_schema_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_schema(
    ...
    capo_glue.types.update_schema_response.UpdateSchemaResponse, zapros.Response
]:
