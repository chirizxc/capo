...
def handle_response(
    ...
    out: capo_glue.types.get_blueprint_response.GetBlueprintResponse = (
        capo_glue.types.get_blueprint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_blueprint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_blueprint(
    ...
    capo_glue.types.get_blueprint_response.GetBlueprintResponse, zapros.Response
]:
