"""Generated from Smithy shape ``com.amazonaws.glue#DeleteIntegrationTableProperties``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_integration_table_properties_response.DeleteIntegrationTablePropertiesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteIntegrationTableProperties"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_integration_table_properties_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_integration_table_properties(
