"""Generated from Smithy shape ``com.amazonaws.glue#GetDataQualityModel``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_data_quality_model_response.GetDataQualityModelResponse = (
        capo_glue.types.get_data_quality_model_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetDataQualityModel"
    body: bytes | None = json.dumps(
        capo_glue.types.get_data_quality_model_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_data_quality_model(
