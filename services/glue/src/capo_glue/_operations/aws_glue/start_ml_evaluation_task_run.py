...
import capo_glue.errors.ml_transform_not_ready_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MLTransformNotReadyException":
            raise capo_glue.errors.ml_transform_not_ready_exception.MLTransformNotReadyException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_glue.types.start_ml_evaluation_task_run_response.StartMLEvaluationTaskRunResponse = capo_glue.types.start_ml_evaluation_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.start_ml_evaluation_task_run_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
