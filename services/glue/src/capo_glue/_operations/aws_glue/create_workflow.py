...
def handle_response(
    ...
    out: capo_glue.types.create_workflow_response.CreateWorkflowResponse = (
        capo_glue.types.create_workflow_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_workflow_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_workflow(
    ...
    capo_glue.types.create_workflow_response.CreateWorkflowResponse, zapros.Response
]:
