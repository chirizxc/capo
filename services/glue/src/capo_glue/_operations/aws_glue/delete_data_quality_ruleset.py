"""Generated from Smithy shape ``com.amazonaws.glue#DeleteDataQualityRuleset``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_data_quality_ruleset_response.DeleteDataQualityRulesetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.DeleteDataQualityRuleset"
    body: bytes | None = json.dumps(
        capo_glue.types.delete_data_quality_ruleset_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_data_quality_ruleset(
