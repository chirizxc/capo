"""Generated from Smithy shape ``com.amazonaws.glue#DeleteTableVersion``."""
...
def handle_response(
    ...
    out: capo_glue.types.delete_table_version_response.DeleteTableVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_table_version_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_table_version(
