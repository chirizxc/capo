...
def handle_response(
    ...
    out: capo_glue.types.get_usage_profile_response.GetUsageProfileResponse = (
        capo_glue.types.get_usage_profile_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_usage_profile_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_usage_profile(
    ...
    capo_glue.types.get_usage_profile_response.GetUsageProfileResponse, zapros.Response
]:
