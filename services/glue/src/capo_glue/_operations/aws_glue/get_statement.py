...
def handle_response(
    ...
    out: capo_glue.types.get_statement_response.GetStatementResponse = (
        capo_glue.types.get_statement_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_statement_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_statement(
    ...
    capo_glue.types.get_statement_response.GetStatementResponse, zapros.Response
]:
