...
def handle_response(
    ...
    out: capo_glue.types.create_schema_response.CreateSchemaResponse = (
        capo_glue.types.create_schema_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_schema_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_schema(
    ...
    capo_glue.types.create_schema_response.CreateSchemaResponse, zapros.Response
]:
