...
def handle_response(
    ...
    out: capo_glue.types.create_crawler_response.CreateCrawlerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.create_crawler_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_crawler(
    ...
    capo_glue.types.create_crawler_response.CreateCrawlerResponse, zapros.Response
]:
