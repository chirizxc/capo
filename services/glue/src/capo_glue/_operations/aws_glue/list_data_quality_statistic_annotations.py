...
def handle_response(
    ...
    out: capo_glue.types.list_data_quality_statistic_annotations_response.ListDataQualityStatisticAnnotationsResponse = capo_glue.types.list_data_quality_statistic_annotations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_data_quality_statistic_annotations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
