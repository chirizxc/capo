...
def handle_response(
    ...
    out: capo_glue.types.delete_database_response.DeleteDatabaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.delete_database_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_database(
    ...
    capo_glue.types.delete_database_response.DeleteDatabaseResponse, zapros.Response
]:
