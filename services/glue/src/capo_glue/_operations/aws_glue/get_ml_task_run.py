...
def handle_response(
    ...
    out: capo_glue.types.get_ml_task_run_response.GetMLTaskRunResponse = (
        capo_glue.types.get_ml_task_run_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_ml_task_run_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_ml_task_run(
    ...
    capo_glue.types.get_ml_task_run_response.GetMLTaskRunResponse, zapros.Response
]:
