"""Generated from Smithy shape ``com.amazonaws.glue#GetCrawlers``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_crawlers_response.GetCrawlersResponse = (
        capo_glue.types.get_crawlers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.get_crawlers_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_crawlers(
    ...
    input_: capo_glue.types.get_crawlers_request.GetCrawlersRequest,
) -> tuple[capo_glue.types.get_crawlers_response.GetCrawlersResponse, zapros.Response]:
