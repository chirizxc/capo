"""Generated from Smithy shape ``com.amazonaws.glue#StopColumnStatisticsTaskRunSchedule``."""
...
def handle_response(
    ...
    out: capo_glue.types.stop_column_statistics_task_run_schedule_response.StopColumnStatisticsTaskRunScheduleResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.StopColumnStatisticsTaskRunSchedule"
    body: bytes | None = json.dumps(
        capo_glue.types.stop_column_statistics_task_run_schedule_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_column_statistics_task_run_schedule(
