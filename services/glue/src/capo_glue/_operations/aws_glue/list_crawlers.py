"""Generated from Smithy shape ``com.amazonaws.glue#ListCrawlers``."""
...
def handle_response(
    ...
    out: capo_glue.types.list_crawlers_response.ListCrawlersResponse = (
        capo_glue.types.list_crawlers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.list_crawlers_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_crawlers(
    ...
    capo_glue.types.list_crawlers_response.ListCrawlersResponse, zapros.Response
]:
