"""Generated from Smithy shape ``com.amazonaws.glue#GetCatalogs``."""
...
def handle_response(
    ...
    out: capo_glue.types.get_catalogs_response.GetCatalogsResponse = (
        capo_glue.types.get_catalogs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSGlue.GetCatalogs"
    body: bytes | None = json.dumps(
        capo_glue.types.get_catalogs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_catalogs(
    ...
    input_: capo_glue.types.get_catalogs_request.GetCatalogsRequest,
) -> tuple[capo_glue.types.get_catalogs_response.GetCatalogsResponse, zapros.Response]:
