...
def handle_response(
    ...
    out: capo_glue.types.update_catalog_response.UpdateCatalogResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_catalog_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_catalog(
    ...
    capo_glue.types.update_catalog_response.UpdateCatalogResponse, zapros.Response
]:
