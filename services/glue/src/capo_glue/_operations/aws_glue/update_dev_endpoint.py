"""Generated from Smithy shape ``com.amazonaws.glue#UpdateDevEndpoint``."""
...
def handle_response(
    ...
    out: capo_glue.types.update_dev_endpoint_response.UpdateDevEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_glue.types.update_dev_endpoint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_dev_endpoint(
