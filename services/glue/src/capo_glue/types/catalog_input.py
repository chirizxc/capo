...
class CatalogInput(TypedDict, closed=True):
    ...
    catalog_properties: NotRequired[
        "capo_glue.types.catalog_properties.CatalogProperties"
    ]
    ...
    overwrite_child_resource_permissions_with_default: NotRequired[
        "capo_glue.types.overwrite_child_resource_permissions_with_default_enum.OverwriteChildResourcePermissionsWithDefaultEnum"
    ]
...
def serialize_aws_json_1_1(value: CatalogInput) -> dict:
    ...
    if "catalog_properties" in value:
        ...
        out["CatalogProperties"] = (
            capo_glue.types.catalog_properties.serialize_aws_json_1_1(
    ...
    if "overwrite_child_resource_permissions_with_default" in value:
        ...
        out["OverwriteChildResourcePermissionsWithDefault"] = (
            capo_glue.types.overwrite_child_resource_permissions_with_default_enum.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CatalogInput:
    ...
    if data.get("CatalogProperties") is not None:
        ...
        out["catalog_properties"] = (
            capo_glue.types.catalog_properties.deserialize_aws_json_1_1(
    ...
    if data.get("OverwriteChildResourcePermissionsWithDefault") is not None:
        ...
        out["overwrite_child_resource_permissions_with_default"] = (
            capo_glue.types.overwrite_child_resource_permissions_with_default_enum.deserialize_aws_json_1_1(
