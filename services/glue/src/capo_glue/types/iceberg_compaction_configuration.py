...
class IcebergCompactionConfiguration(TypedDict, closed=True):
    strategy: NotRequired["capo_glue.types.compaction_strategy.CompactionStrategy"]
    ...
    min_input_files: NotRequired["capo_glue.types.nullable_integer.NullableInteger"]
...
def serialize_aws_json_1_1(value: IcebergCompactionConfiguration) -> dict:
    ...
    if "strategy" in value:
        ...
        out["strategy"] = capo_glue.types.compaction_strategy.serialize_aws_json_1_1(
            value["strategy"]
        )
