...
class DataQualityEncryption(TypedDict, closed=True):
    data_quality_encryption_mode: NotRequired[
        "capo_glue.types.data_quality_encryption_mode.DataQualityEncryptionMode"
    ]
...
def serialize_aws_json_1_1(value: DataQualityEncryption) -> dict:
    ...
    if "data_quality_encryption_mode" in value:
        ...
        out["DataQualityEncryptionMode"] = (
            capo_glue.types.data_quality_encryption_mode.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DataQualityEncryption:
    ...
    if data.get("DataQualityEncryptionMode") is not None:
        ...
        out["data_quality_encryption_mode"] = (
            capo_glue.types.data_quality_encryption_mode.deserialize_aws_json_1_1(
