...
class ListWorkflowsResponse(TypedDict, closed=True):
    workflows: NotRequired["capo_glue.types.workflow_names.WorkflowNames"]
...
def serialize_aws_json_1_1(value: ListWorkflowsResponse) -> dict:
    ...
    if "workflows" in value:
        ...
        out["Workflows"] = capo_glue.types.workflow_names.serialize_aws_json_1_1(
            value["workflows"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListWorkflowsResponse:
    ...
    if data.get("Workflows") is not None:
        ...
        out["workflows"] = capo_glue.types.workflow_names.deserialize_aws_json_1_1(
            data["Workflows"]
        )
