"""Generated from Smithy shape ``com.amazonaws.glue#CreateBlueprintResponse``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateBlueprintResponse) -> dict:
    out: dict = {}
    if "name" in value:
        out["Name"] = value["name"]
    return out
...
def deserialize_aws_json_1_1(data: dict) -> CreateBlueprintResponse:
