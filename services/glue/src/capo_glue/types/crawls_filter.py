...
class CrawlsFilter(TypedDict, closed=True):
    field_name: NotRequired["capo_glue.types.field_name.FieldName"]
    ...
    filter_operator: NotRequired["capo_glue.types.filter_operator.FilterOperator"]
    ...
    field_value: NotRequired["capo_glue.types.generic_string.GenericString"]
...
def serialize_aws_json_1_1(value: CrawlsFilter) -> dict:
    ...
    if "field_name" in value:
        ...
        out["FieldName"] = capo_glue.types.field_name.serialize_aws_json_1_1(
            value["field_name"]
        )
    if "filter_operator" in value:
        import capo_glue.types.filter_operator

        out["FilterOperator"] = capo_glue.types.filter_operator.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CrawlsFilter:
    ...
    if data.get("FilterOperator") is not None:
        ...
        out["filter_operator"] = (
            capo_glue.types.filter_operator.deserialize_aws_json_1_1(
                data["FilterOperator"]
            )
        )
