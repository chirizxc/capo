...
class CatalogProperties(TypedDict, closed=True):
    data_lake_access_properties: NotRequired[
        "capo_glue.types.data_lake_access_properties.DataLakeAccessProperties"
    ]
    ...
    iceberg_optimization_properties: NotRequired[
        "capo_glue.types.iceberg_optimization_properties.IcebergOptimizationProperties"
    ]
...
def serialize_aws_json_1_1(value: CatalogProperties) -> dict:
    ...
    if "data_lake_access_properties" in value:
        ...
        out["DataLakeAccessProperties"] = (
            capo_glue.types.data_lake_access_properties.serialize_aws_json_1_1(
    ...
    if "iceberg_optimization_properties" in value:
        ...
        out["IcebergOptimizationProperties"] = (
            capo_glue.types.iceberg_optimization_properties.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CatalogProperties:
    ...
    if data.get("DataLakeAccessProperties") is not None:
        ...
        out["data_lake_access_properties"] = (
            capo_glue.types.data_lake_access_properties.deserialize_aws_json_1_1(
    ...
    if data.get("IcebergOptimizationProperties") is not None:
        ...
        out["iceberg_optimization_properties"] = (
            capo_glue.types.iceberg_optimization_properties.deserialize_aws_json_1_1(
