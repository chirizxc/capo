...
class DQStopJobOnFailureOptions(TypedDict, closed=True):
    stop_job_on_failure_timing: NotRequired[
        "capo_glue.types.dq_stop_job_on_failure_timing.DQStopJobOnFailureTiming"
    ]
...
def serialize_aws_json_1_1(value: DQStopJobOnFailureOptions) -> dict:
    ...
    if "stop_job_on_failure_timing" in value:
        ...
        out["StopJobOnFailureTiming"] = (
            capo_glue.types.dq_stop_job_on_failure_timing.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DQStopJobOnFailureOptions:
    ...
    if data.get("StopJobOnFailureTiming") is not None:
        ...
        out["stop_job_on_failure_timing"] = (
            capo_glue.types.dq_stop_job_on_failure_timing.deserialize_aws_json_1_1(
