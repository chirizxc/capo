...
if TYPE_CHECKING:
    import capo_glue.types.aws_managed_client_application_reference
    import capo_glue.types.user_managed_client_application_client_id


class OAuth2ClientApplication(TypedDict, closed=True):
    user_managed_client_application_client_id: NotRequired[
        "capo_glue.types.user_managed_client_application_client_id.UserManagedClientApplicationClientId"
    ]
    ...
    aws_managed_client_application_reference: NotRequired[
        "capo_glue.types.aws_managed_client_application_reference.AWSManagedClientApplicationReference"
    ]
