...
if TYPE_CHECKING:
    import capo_glue.types.key_string
    import capo_glue.types.parameters_map_value

ParametersMap: TypeAlias = dict[
    "capo_glue.types.key_string.KeyString",
    "capo_glue.types.parameters_map_value.ParametersMapValue",
]
