...
class NullCheckBoxList(TypedDict, closed=True):
    is_empty: NotRequired["capo_glue.types.boxed_boolean.BoxedBoolean"]
    """<p>Specifies that an empty string is considered as a null value.</p>"""
    is_null_string: NotRequired["capo_glue.types.boxed_boolean.BoxedBoolean"]
    """<p>Specifies that a value spelling out the word 'null' is considered as a null value.</p>"""
    is_neg_one: NotRequired["capo_glue.types.boxed_boolean.BoxedBoolean"]
