"""Generated from Smithy shape ``com.amazonaws.glue#CatalogKafkaSource``."""
...
class CatalogKafkaSource(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CatalogKafkaSource) -> dict:
    out: dict = {}
    out["Name"] = value["name"]
