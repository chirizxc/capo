...
class ListMaterializedViewRefreshTaskRunsResponse(TypedDict, closed=True):
    materialized_view_refresh_task_runs: NotRequired[
        "capo_glue.types.materialized_view_refresh_task_runs_list.MaterializedViewRefreshTaskRunsList"
    ]
...
def serialize_aws_json_1_1(value: ListMaterializedViewRefreshTaskRunsResponse) -> dict:
    ...
    if "materialized_view_refresh_task_runs" in value:
        ...
        out["MaterializedViewRefreshTaskRuns"] = (
            capo_glue.types.materialized_view_refresh_task_runs_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListMaterializedViewRefreshTaskRunsResponse:
    ...
    if data.get("MaterializedViewRefreshTaskRuns") is not None:
        import capo_glue.types.materialized_view_refresh_task_runs_list

        out["materialized_view_refresh_task_runs"] = (
            capo_glue.types.materialized_view_refresh_task_runs_list.deserialize_aws_json_1_1(
