...
class SearchTablesRequest(TypedDict, closed=True):
    ...
    search_text: NotRequired["capo_glue.types.value_string.ValueString"]
    """<p>A string used for a text search.</p> <p>Specifying a value in quotes filters based on an exact match to the value.</p>"""
    sort_criteria: NotRequired["capo_glue.types.sort_criteria.SortCriteria"]
...
def serialize_aws_json_1_1(value: SearchTablesRequest) -> dict:
    ...
    if "filters" in value:
        ...
        out["Filters"] = (
            capo_glue.types.search_property_predicates.serialize_aws_json_1_1(
                value["filters"]
            )
        )
    ...
    if "sort_criteria" in value:
        ...
        out["SortCriteria"] = capo_glue.types.sort_criteria.serialize_aws_json_1_1(
            value["sort_criteria"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> SearchTablesRequest:
    ...
    if data.get("Filters") is not None:
        ...
        out["filters"] = (
            capo_glue.types.search_property_predicates.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
