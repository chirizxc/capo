...
if TYPE_CHECKING:
    ...
    import capo_glue.types.byte_count
...
class MaterializedViewRefreshTaskRun(TypedDict, closed=True):
    ...
    refresh_type: NotRequired[
        "capo_glue.types.materialized_view_refresh_type.MaterializedViewRefreshType"
    ]
    """<p>The type of the refresh task run. Either FULL or INCREMENTAL.</p>"""
    processed_bytes: NotRequired["capo_glue.types.byte_count.ByteCount"]
...
def serialize_aws_json_1_1(value: MaterializedViewRefreshTaskRun) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_glue.types.materialized_view_refresh_state.serialize_aws_json_1_1(
                value["status"]
            )
        )
    ...
    if "refresh_type" in value:
        ...
        out["RefreshType"] = (
            capo_glue.types.materialized_view_refresh_type.serialize_aws_json_1_1(
                value["refresh_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> MaterializedViewRefreshTaskRun:
    ...
    if data.get("Status") is not None:
        ...
        out["status"] = (
            capo_glue.types.materialized_view_refresh_state.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    ...
    if data.get("RefreshType") is not None:
        ...
        out["refresh_type"] = (
            capo_glue.types.materialized_view_refresh_type.deserialize_aws_json_1_1(
                data["RefreshType"]
            )
        )
