...
class ListDataQualityRulesetsResponse(TypedDict, closed=True):
    rulesets: NotRequired[
        "capo_glue.types.data_quality_ruleset_list.DataQualityRulesetList"
    ]
...
def serialize_aws_json_1_1(value: ListDataQualityRulesetsResponse) -> dict:
    ...
    if "rulesets" in value:
        ...
        out["Rulesets"] = (
            capo_glue.types.data_quality_ruleset_list.serialize_aws_json_1_1(
                value["rulesets"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListDataQualityRulesetsResponse:
    ...
    if data.get("Rulesets") is not None:
        ...
        out["rulesets"] = (
            capo_glue.types.data_quality_ruleset_list.deserialize_aws_json_1_1(
                data["Rulesets"]
            )
        )
