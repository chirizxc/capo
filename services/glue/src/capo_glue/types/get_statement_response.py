...
class GetStatementResponse(TypedDict, closed=True):
    statement: NotRequired["capo_glue.types.statement.Statement"]
...
def serialize_aws_json_1_1(value: GetStatementResponse) -> dict:
    ...
    if "statement" in value:
        ...
        out["Statement"] = capo_glue.types.statement.serialize_aws_json_1_1(
            value["statement"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetStatementResponse:
    ...
    if data.get("Statement") is not None:
        ...
        out["statement"] = capo_glue.types.statement.deserialize_aws_json_1_1(
            data["Statement"]
        )
    return out
