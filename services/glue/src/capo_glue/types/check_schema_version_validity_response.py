...
if TYPE_CHECKING:
    import capo_glue.types.is_version_valid
    import capo_glue.types.schema_validation_error


class CheckSchemaVersionValidityResponse(TypedDict, closed=True):
    valid: "capo_glue.types.is_version_valid.IsVersionValid"
    """<p>Return true, if the schema is valid and false otherwise.</p>"""
    error: NotRequired["capo_glue.types.schema_validation_error.SchemaValidationError"]
