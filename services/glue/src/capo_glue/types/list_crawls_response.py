...
class ListCrawlsResponse(TypedDict, closed=True):
    crawls: NotRequired["capo_glue.types.crawler_history_list.CrawlerHistoryList"]
...
def serialize_aws_json_1_1(value: ListCrawlsResponse) -> dict:
    ...
    if "crawls" in value:
        ...
        out["Crawls"] = capo_glue.types.crawler_history_list.serialize_aws_json_1_1(
            value["crawls"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListCrawlsResponse:
    ...
    if data.get("Crawls") is not None:
        import capo_glue.types.crawler_history_list

        out["crawls"] = capo_glue.types.crawler_history_list.deserialize_aws_json_1_1(
            data["Crawls"]
        )
