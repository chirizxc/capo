...
class CreateSchemaResponse(TypedDict, closed=True):
    ...
    schema_version_status: NotRequired[
        "capo_glue.types.schema_version_status.SchemaVersionStatus"
    ]
...
def serialize_aws_json_1_1(value: CreateSchemaResponse) -> dict:
    ...
    if "schema_version_status" in value:
        ...
        out["SchemaVersionStatus"] = (
            capo_glue.types.schema_version_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CreateSchemaResponse:
    ...
    if data.get("SchemaVersionStatus") is not None:
        import capo_glue.types.schema_version_status

        out["schema_version_status"] = (
            capo_glue.types.schema_version_status.deserialize_aws_json_1_1(
