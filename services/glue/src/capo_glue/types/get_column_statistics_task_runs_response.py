...
class GetColumnStatisticsTaskRunsResponse(TypedDict, closed=True):
    column_statistics_task_runs: NotRequired[
        "capo_glue.types.column_statistics_task_runs_list.ColumnStatisticsTaskRunsList"
    ]
...
def serialize_aws_json_1_1(value: GetColumnStatisticsTaskRunsResponse) -> dict:
    ...
    if "column_statistics_task_runs" in value:
        ...
        out["ColumnStatisticsTaskRuns"] = (
            capo_glue.types.column_statistics_task_runs_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetColumnStatisticsTaskRunsResponse:
    ...
    if data.get("ColumnStatisticsTaskRuns") is not None:
        ...
        out["column_statistics_task_runs"] = (
            capo_glue.types.column_statistics_task_runs_list.deserialize_aws_json_1_1(
