...
class ListRegistriesResponse(TypedDict, closed=True):
    registries: NotRequired[
        "capo_glue.types.registry_list_definition.RegistryListDefinition"
    ]
...
def serialize_aws_json_1_1(value: ListRegistriesResponse) -> dict:
    ...
    if "registries" in value:
        ...
        out["Registries"] = (
            capo_glue.types.registry_list_definition.serialize_aws_json_1_1(
                value["registries"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListRegistriesResponse:
    ...
    if data.get("Registries") is not None:
        ...
        out["registries"] = (
            capo_glue.types.registry_list_definition.deserialize_aws_json_1_1(
                data["Registries"]
            )
        )
