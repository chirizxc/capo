...
class StatusDetails(TypedDict, closed=True):
    requested_change: NotRequired["capo_glue.types.table.Table"]
    """<p>A <code>Table</code> object representing the requested changes.</p>"""
    view_validations: NotRequired[
        "capo_glue.types.view_validation_list.ViewValidationList"
    ]
...
def serialize_aws_json_1_1(value: StatusDetails) -> dict:
    ...
    if "requested_change" in value:
        ...
        out["RequestedChange"] = capo_glue.types.table.serialize_aws_json_1_1(
    ...
    if "view_validations" in value:
        ...
        out["ViewValidations"] = (
            capo_glue.types.view_validation_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> StatusDetails:
    ...
    if data.get("ViewValidations") is not None:
        ...
        out["view_validations"] = (
            capo_glue.types.view_validation_list.deserialize_aws_json_1_1(
