...
def handle_response(
    ...
    out: capo_cleanrooms.types.start_protected_query_output.StartProtectedQueryOutput = capo_cleanrooms.types.start_protected_query_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.start_protected_query_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
