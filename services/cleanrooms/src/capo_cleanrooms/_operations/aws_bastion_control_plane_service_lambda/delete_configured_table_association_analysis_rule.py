...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_configured_table_association_analysis_rule_output.DeleteConfiguredTableAssociationAnalysisRuleOutput = {}  # type: ignore[typeddict-item]
    return out
