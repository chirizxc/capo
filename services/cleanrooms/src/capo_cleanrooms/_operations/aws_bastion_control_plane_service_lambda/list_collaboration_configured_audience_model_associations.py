"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListCollaborationConfiguredAudienceModelAssociations``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_collaboration_configured_audience_model_associations_output.ListCollaborationConfiguredAudienceModelAssociationsOutput = capo_cleanrooms.types.list_collaboration_configured_audience_model_associations_output.deserialize_json(
...
async def async_list_collaboration_configured_audience_model_associations(
