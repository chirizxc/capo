"""Generated from Smithy shape ``com.amazonaws.cleanrooms#GetPrivacyBudgetTemplate``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_privacy_budget_template_output.GetPrivacyBudgetTemplateOutput = capo_cleanrooms.types.get_privacy_budget_template_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["privacy_budget_template_identifier"], safe=""),
    )
...
async def async_get_privacy_budget_template(
