"""Generated from Smithy shape ``com.amazonaws.cleanrooms#DeleteMember``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_member_output.DeleteMemberOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_member(
    ...
    capo_cleanrooms.types.delete_member_output.DeleteMemberOutput, zapros.Response
]:
