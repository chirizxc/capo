...
def handle_response(
    ...
    out: capo_cleanrooms.types.update_configured_audience_model_association_output.UpdateConfiguredAudienceModelAssociationOutput = capo_cleanrooms.types.update_configured_audience_model_association_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["configured_audience_model_association_identifier"], safe=""),
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.update_configured_audience_model_association_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
