...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_configured_table_analysis_rule_output.CreateConfiguredTableAnalysisRuleOutput = capo_cleanrooms.types.create_configured_table_analysis_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_configured_table_analysis_rule_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
