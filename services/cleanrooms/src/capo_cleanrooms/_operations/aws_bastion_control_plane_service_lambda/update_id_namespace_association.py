"""Generated from Smithy shape ``com.amazonaws.cleanrooms#UpdateIdNamespaceAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.update_id_namespace_association_output.UpdateIdNamespaceAssociationOutput = capo_cleanrooms.types.update_id_namespace_association_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["id_namespace_association_identifier"], safe=""),
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.update_id_namespace_association_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_id_namespace_association(
