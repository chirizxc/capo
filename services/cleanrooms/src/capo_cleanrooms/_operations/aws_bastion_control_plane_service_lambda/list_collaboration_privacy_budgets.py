...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_collaboration_privacy_budgets_output.ListCollaborationPrivacyBudgetsOutput = capo_cleanrooms.types.list_collaboration_privacy_budgets_output.deserialize_json(
...
def build_request(
    ...
    if "privacy_budget_type" in input_:
        params.append(
            (
                "privacyBudgetType",
                capo_cleanrooms.types.privacy_budget_type.serialize_json(
                    input_["privacy_budget_type"]
                ),
            )
        )
    ...
    if "access_budget_resource_arn" in input_:
        params.append(("accessBudgetResourceArn", input_["access_budget_resource_arn"]))
