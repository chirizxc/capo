...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_id_mapping_tables_output.ListIdMappingTablesOutput = capo_cleanrooms.types.list_id_mapping_tables_output.deserialize_json(
