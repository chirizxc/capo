"""Generated from Smithy shape ``com.amazonaws.cleanrooms#DeleteConfiguredTableAnalysisRule``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_configured_table_analysis_rule_output.DeleteConfiguredTableAnalysisRuleOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["configured_table_identifier"], safe=""),
    )
    url = url.replace(
        "{analysisRuleType}",
        quote(
...
async def async_delete_configured_table_analysis_rule(
