"""Generated from Smithy shape ``com.amazonaws.cleanrooms#DeleteIdNamespaceAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_id_namespace_association_output.DeleteIdNamespaceAssociationOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_id_namespace_association(
