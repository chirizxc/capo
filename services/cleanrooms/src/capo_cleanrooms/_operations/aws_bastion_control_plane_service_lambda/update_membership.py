"""Generated from Smithy shape ``com.amazonaws.cleanrooms#UpdateMembership``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.update_membership_output.UpdateMembershipOutput = (
        capo_cleanrooms.types.update_membership_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.update_membership_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_membership(
