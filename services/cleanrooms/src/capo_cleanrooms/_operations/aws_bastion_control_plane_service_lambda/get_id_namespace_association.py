...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_id_namespace_association_output.GetIdNamespaceAssociationOutput = capo_cleanrooms.types.get_id_namespace_association_output.deserialize_json(
