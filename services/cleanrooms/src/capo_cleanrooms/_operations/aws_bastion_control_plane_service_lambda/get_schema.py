...
def handle_response(
    ...
    out: capo_cleanrooms.types.get_schema_output.GetSchemaOutput = (
        capo_cleanrooms.types.get_schema_output.deserialize_json(
...
def get_schema(
    ...
    input_: capo_cleanrooms.types.get_schema_input.GetSchemaInput,
) -> tuple[capo_cleanrooms.types.get_schema_output.GetSchemaOutput, zapros.Response]:
