...
def handle_response(
    ...
    out: capo_cleanrooms.types.preview_privacy_impact_output.PreviewPrivacyImpactOutput = capo_cleanrooms.types.preview_privacy_impact_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.preview_privacy_impact_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
