...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_privacy_budget_templates_output.ListPrivacyBudgetTemplatesOutput = capo_cleanrooms.types.list_privacy_budget_templates_output.deserialize_json(
