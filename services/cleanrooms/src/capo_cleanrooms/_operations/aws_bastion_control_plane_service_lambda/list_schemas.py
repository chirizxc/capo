"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListSchemas``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_schemas_output.ListSchemasOutput = (
        capo_cleanrooms.types.list_schemas_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/schemas"
    url = url.replace(
        "{collaborationIdentifier}", quote(input_["collaboration_identifier"], safe="")
    )
    params: list[tuple[str, str]] = []
    if "schema_type" in input_:
        params.append(
            (
                "schemaType",
                capo_cleanrooms.types.schema_type.serialize_json(input_["schema_type"]),
            )
        )
...
def list_schemas(
    ...
    capo_cleanrooms.types.list_schemas_output.ListSchemasOutput, zapros.Response
]:
