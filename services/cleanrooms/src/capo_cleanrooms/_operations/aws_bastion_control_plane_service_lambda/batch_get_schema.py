...
def handle_response(
    ...
    out: capo_cleanrooms.types.batch_get_schema_output.BatchGetSchemaOutput = (
        capo_cleanrooms.types.batch_get_schema_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.batch_get_schema_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def batch_get_schema(
    ...
    capo_cleanrooms.types.batch_get_schema_output.BatchGetSchemaOutput, zapros.Response
]:
