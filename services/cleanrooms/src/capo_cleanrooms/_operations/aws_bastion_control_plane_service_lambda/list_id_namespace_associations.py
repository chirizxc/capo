...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_id_namespace_associations_output.ListIdNamespaceAssociationsOutput = capo_cleanrooms.types.list_id_namespace_associations_output.deserialize_json(
