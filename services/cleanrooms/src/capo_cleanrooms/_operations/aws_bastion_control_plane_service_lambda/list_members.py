"""Generated from Smithy shape ``com.amazonaws.cleanrooms#ListMembers``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_members_output.ListMembersOutput = (
        capo_cleanrooms.types.list_members_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/collaborations/{collaborationIdentifier}/members"
    url = url.replace(
...
def list_members(
    ...
    capo_cleanrooms.types.list_members_output.ListMembersOutput, zapros.Response
]:
