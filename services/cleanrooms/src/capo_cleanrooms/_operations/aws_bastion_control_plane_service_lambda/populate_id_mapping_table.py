...
def handle_response(
    ...
    out: capo_cleanrooms.types.populate_id_mapping_table_output.PopulateIdMappingTableOutput = capo_cleanrooms.types.populate_id_mapping_table_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["id_mapping_table_identifier"], safe=""),
    )
    url = url.replace(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.populate_id_mapping_table_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
