...
def handle_response(
    ...
    out: capo_cleanrooms.types.list_configured_tables_output.ListConfiguredTablesOutput = capo_cleanrooms.types.list_configured_tables_output.deserialize_json(
