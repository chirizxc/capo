"""Generated from Smithy shape ``com.amazonaws.cleanrooms#DeleteConfiguredTableAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.delete_configured_table_association_output.DeleteConfiguredTableAssociationOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_configured_table_association(
