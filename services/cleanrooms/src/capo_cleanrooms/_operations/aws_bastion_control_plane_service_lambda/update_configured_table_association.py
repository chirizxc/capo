"""Generated from Smithy shape ``com.amazonaws.cleanrooms#UpdateConfiguredTableAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.update_configured_table_association_output.UpdateConfiguredTableAssociationOutput = capo_cleanrooms.types.update_configured_table_association_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.update_configured_table_association_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_configured_table_association(
