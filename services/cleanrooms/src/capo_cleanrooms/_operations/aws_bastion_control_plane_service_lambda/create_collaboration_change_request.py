...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_collaboration_change_request_output.CreateCollaborationChangeRequestOutput = capo_cleanrooms.types.create_collaboration_change_request_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_collaboration_change_request_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
