"""Generated from Smithy shape ``com.amazonaws.cleanrooms#CreateConfiguredTableAssociation``."""
...
def handle_response(
    ...
    out: capo_cleanrooms.types.create_configured_table_association_output.CreateConfiguredTableAssociationOutput = capo_cleanrooms.types.create_configured_table_association_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.create_configured_table_association_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_configured_table_association(
