...
def handle_response(
    ...
    out: capo_cleanrooms.types.update_configured_table_output.UpdateConfiguredTableOutput = capo_cleanrooms.types.update_configured_table_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanrooms.types.update_configured_table_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
