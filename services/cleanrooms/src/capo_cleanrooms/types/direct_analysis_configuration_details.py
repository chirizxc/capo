...
class DirectAnalysisConfigurationDetails(TypedDict, closed=True):
    receiver_account_ids: NotRequired[
        "capo_cleanrooms.types.receiver_account_ids.ReceiverAccountIds"
    ]
...
def serialize_json(value: DirectAnalysisConfigurationDetails) -> dict:
    ...
    if "receiver_account_ids" in value:
        ...
        out["receiverAccountIds"] = (
            capo_cleanrooms.types.receiver_account_ids.serialize_json(
...
def deserialize_json(data: dict) -> DirectAnalysisConfigurationDetails:
    ...
    if data.get("receiverAccountIds") is not None:
        ...
        out["receiver_account_ids"] = (
            capo_cleanrooms.types.receiver_account_ids.deserialize_json(
