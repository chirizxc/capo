...
class UpdateMembershipInput(TypedDict, closed=True):
...
def serialize_json(value: UpdateMembershipInput) -> dict:
    ...
    if "membership_payment_configuration" in value:
        ...
        out["membershipPaymentConfiguration"] = (
            capo_cleanrooms.types.update_membership_payment_configuration.serialize_json(
...
def deserialize_json(data: dict) -> UpdateMembershipInput:
    ...
    if data.get("membershipPaymentConfiguration") is not None:
        ...
        out["membership_payment_configuration"] = (
            capo_cleanrooms.types.update_membership_payment_configuration.deserialize_json(
