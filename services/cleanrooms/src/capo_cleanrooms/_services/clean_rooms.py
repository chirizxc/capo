...
class CleanRoomsClient:
    ...
    def iter_list_collaboration_change_requests(
        self,
        collaboration_identifier: "capo_cleanrooms.types.collaboration_identifier.CollaborationIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        max_results: Optional["capo_cleanrooms.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_cleanrooms.types.collaboration_change_request_summary.CollaborationChangeRequestSummary]":
        _token = next_token
        while True:
            _response = self.list_collaboration_change_requests(
    ...
    def iter_list_collaboration_configured_audience_model_associations(
        self,
        collaboration_identifier: "capo_cleanrooms.types.collaboration_identifier.CollaborationIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        max_results: Optional["capo_cleanrooms.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_cleanrooms.types.collaboration_configured_audience_model_association_summary.CollaborationConfiguredAudienceModelAssociationSummary]":
        _token = next_token
        while True:
            _response = self.list_collaboration_configured_audience_model_associations(
                collaboration_identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_collaboration_id_namespace_associations(
        self,
        collaboration_identifier: "capo_cleanrooms.types.collaboration_identifier.CollaborationIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        max_results: Optional["capo_cleanrooms.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_cleanrooms.types.collaboration_id_namespace_association_summary.CollaborationIdNamespaceAssociationSummary]":
        _token = next_token
        while True:
            _response = self.list_collaboration_id_namespace_associations(
                collaboration_identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_collaboration_privacy_budgets(
        self,
        collaboration_identifier: "capo_cleanrooms.types.collaboration_identifier.CollaborationIdentifier",
        privacy_budget_type: "capo_cleanrooms.types.privacy_budget_type.PrivacyBudgetType",
        *,
    ...
    ) -> "Iterator[capo_cleanrooms.types.collaboration_privacy_budget_summary.CollaborationPrivacyBudgetSummary]":
        _token = next_token
        while True:
            _response = self.list_collaboration_privacy_budgets(
                collaboration_identifier,
                privacy_budget_type,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    def iter_list_collaboration_privacy_budget_templates(
        self,
        collaboration_identifier: "capo_cleanrooms.types.collaboration_identifier.CollaborationIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        max_results: Optional["capo_cleanrooms.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_cleanrooms.types.collaboration_privacy_budget_template_summary.CollaborationPrivacyBudgetTemplateSummary]":
        _token = next_token
        while True:
            _response = self.list_collaboration_privacy_budget_templates(
                collaboration_identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_configured_audience_model_associations(
        self,
        membership_identifier: "capo_cleanrooms.types.membership_identifier.MembershipIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        max_results: Optional["capo_cleanrooms.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_cleanrooms.types.configured_audience_model_association_summary.ConfiguredAudienceModelAssociationSummary]":
        _token = next_token
        while True:
            _response = self.list_configured_audience_model_associations(
    ...
    def iter_list_id_mapping_tables(
        self,
        membership_identifier: "capo_cleanrooms.types.membership_identifier.MembershipIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        "Iterator[capo_cleanrooms.types.id_mapping_table_summary.IdMappingTableSummary]"
    ):
        _token = next_token
        while True:
            _response = self.list_id_mapping_tables(
                membership_identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def iter_list_id_namespace_associations(
        self,
        membership_identifier: "capo_cleanrooms.types.membership_identifier.MembershipIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        max_results: Optional["capo_cleanrooms.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_cleanrooms.types.id_namespace_association_summary.IdNamespaceAssociationSummary]":
        _token = next_token
        while True:
            _response = self.list_id_namespace_associations(
                membership_identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    ) -> "Iterator[capo_cleanrooms.types.privacy_budget_summary.PrivacyBudgetSummary]":
        _token = next_token
        while True:
            _response = self.list_privacy_budgets(
                membership_identifier,
                privacy_budget_type,
                config_overrides=config_overrides,
                next_token=_token,
    ...
    def iter_list_protected_jobs(
        ...
        *,
        ...
        max_results: Optional["capo_cleanrooms.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_cleanrooms.types.protected_job_summary.ProtectedJobSummary]":
        _token = next_token
        while True:
            _response = self.list_protected_jobs(
                membership_identifier,
                config_overrides=config_overrides,
                status=status,
                next_token=_token,
    ...
    def iter_list_protected_queries(
        self,
        membership_identifier: "capo_cleanrooms.types.membership_identifier.MembershipIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        "Iterator[capo_cleanrooms.types.protected_query_summary.ProtectedQuerySummary]"
    ):
        _token = next_token
        while True:
            _response = self.list_protected_queries(
                membership_identifier,
                config_overrides=config_overrides,
                status=status,
                next_token=_token,
    ...
    def iter_list_privacy_budget_templates(
        self,
        membership_identifier: "capo_cleanrooms.types.membership_identifier.MembershipIdentifier",
        *,
        config_overrides: Optional[CleanRoomsClientConfig] = None,
        ...
        max_results: Optional["capo_cleanrooms.types.max_results.MaxResults"] = None,
    ) -> "Iterator[capo_cleanrooms.types.privacy_budget_template_summary.PrivacyBudgetTemplateSummary]":
        _token = next_token
        while True:
            _response = self.list_privacy_budget_templates(
                membership_identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
