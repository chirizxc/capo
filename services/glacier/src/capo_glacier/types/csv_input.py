...
class CSVInput(TypedDict, closed=True):
    file_header_info: NotRequired["capo_glacier.types.file_header_info.FileHeaderInfo"]
    """<p>Describes the first line of input. Valid values are <code>None</code>, <code>Ignore</code>, and <code>Use</code>.</p>"""
    comments: NotRequired["capo_glacier.types.string.string"]
...
def serialize_json(value: CSVInput) -> dict:
    ...
    if "file_header_info" in value:
        ...
        out["FileHeaderInfo"] = capo_glacier.types.file_header_info.serialize_json(
