...
from capo_glacier._iter import ensure_sync_iterator
from capo_glacier._pagination import resolve_path as _resolve_path
from capo_glacier._services._aws_config import aws_config
...
class GlacierClient:
    ...
    def abort_multipart_upload(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.abort_multipart_upload_input.AbortMultipartUploadInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.abort_multipart_upload

            output, http_response = (
                capo_glacier._operations.glacier.abort_multipart_upload.abort_multipart_upload(
    ...
    def abort_vault_lock(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.abort_vault_lock_input.AbortVaultLockInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.abort_vault_lock

            output, http_response = (
                capo_glacier._operations.glacier.abort_vault_lock.abort_vault_lock(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def add_tags_to_vault(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.add_tags_to_vault_input.AddTagsToVaultInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.add_tags_to_vault

            output, http_response = (
                capo_glacier._operations.glacier.add_tags_to_vault.add_tags_to_vault(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def complete_multipart_upload(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.complete_multipart_upload_input.CompleteMultipartUploadInput]",
        ) -> OperationResponse[
            "capo_glacier.types.archive_creation_output.ArchiveCreationOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.complete_multipart_upload.complete_multipart_upload(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def complete_vault_lock(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.complete_vault_lock_input.CompleteVaultLockInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.complete_vault_lock

            output, http_response = (
                capo_glacier._operations.glacier.complete_vault_lock.complete_vault_lock(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_vault(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.create_vault_input.CreateVaultInput]",
        ) -> OperationResponse[
            "capo_glacier.types.create_vault_output.CreateVaultOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.create_vault.create_vault(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_archive(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.delete_archive_input.DeleteArchiveInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.delete_archive

            output, http_response = (
                capo_glacier._operations.glacier.delete_archive.delete_archive(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_vault(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.delete_vault_input.DeleteVaultInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.delete_vault

            output, http_response = (
                capo_glacier._operations.glacier.delete_vault.delete_vault(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_vault_access_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.delete_vault_access_policy_input.DeleteVaultAccessPolicyInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.delete_vault_access_policy

            output, http_response = (
                capo_glacier._operations.glacier.delete_vault_access_policy.delete_vault_access_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_vault_notifications(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.delete_vault_notifications_input.DeleteVaultNotificationsInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.delete_vault_notifications

            output, http_response = (
                capo_glacier._operations.glacier.delete_vault_notifications.delete_vault_notifications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.describe_job_input.DescribeJobInput]",
        ) -> OperationResponse[
            "capo_glacier.types.glacier_job_description.GlacierJobDescription"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.describe_job.describe_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_vault(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.describe_vault_input.DescribeVaultInput]",
        ) -> OperationResponse[
            "capo_glacier.types.describe_vault_output.DescribeVaultOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.describe_vault.describe_vault(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_data_retrieval_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.get_data_retrieval_policy_input.GetDataRetrievalPolicyInput]",
        ) -> OperationResponse[
            "capo_glacier.types.get_data_retrieval_policy_output.GetDataRetrievalPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.get_data_retrieval_policy.get_data_retrieval_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_job_output(
        ...
        *,
    ...
    ) -> "Generator[capo_glacier.types.get_job_output_output.GetJobOutputOutput]":
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.get_job_output_input.GetJobOutputInput]",
        ) -> OperationResponse[
            ...
            output, http_response = (
                capo_glacier._operations.glacier.get_job_output.get_job_output(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_vault_access_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.get_vault_access_policy_input.GetVaultAccessPolicyInput]",
        ) -> OperationResponse[
            "capo_glacier.types.get_vault_access_policy_output.GetVaultAccessPolicyOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.get_vault_access_policy.get_vault_access_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_vault_lock(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.get_vault_lock_input.GetVaultLockInput]",
        ) -> OperationResponse[
            "capo_glacier.types.get_vault_lock_output.GetVaultLockOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.get_vault_lock.get_vault_lock(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_vault_notifications(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.get_vault_notifications_input.GetVaultNotificationsInput]",
        ) -> OperationResponse[
            "capo_glacier.types.get_vault_notifications_output.GetVaultNotificationsOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.get_vault_notifications.get_vault_notifications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def initiate_job(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.initiate_job_input.InitiateJobInput]",
        ) -> OperationResponse[
            "capo_glacier.types.initiate_job_output.InitiateJobOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.initiate_job.initiate_job(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def initiate_multipart_upload(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.initiate_multipart_upload_input.InitiateMultipartUploadInput]",
        ) -> OperationResponse[
            "capo_glacier.types.initiate_multipart_upload_output.InitiateMultipartUploadOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.initiate_multipart_upload.initiate_multipart_upload(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def initiate_vault_lock(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.initiate_vault_lock_input.InitiateVaultLockInput]",
        ) -> OperationResponse[
            "capo_glacier.types.initiate_vault_lock_output.InitiateVaultLockOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.initiate_vault_lock.initiate_vault_lock(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_jobs(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.list_jobs_input.ListJobsInput]",
        ) -> OperationResponse["capo_glacier.types.list_jobs_output.ListJobsOutput"]:
            import capo_glacier._operations.glacier.list_jobs

            output, http_response = (
                capo_glacier._operations.glacier.list_jobs.list_jobs(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_jobs(
        ...
        *,
        ...
        statuscode: Optional["capo_glacier.types.string.string"] = None,
        completed: Optional["capo_glacier.types.string.string"] = None,
    ) -> "Iterator[capo_glacier.types.glacier_job_description.GlacierJobDescription]":
        _token = marker
        while True:
    ...
    def list_multipart_uploads(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.list_multipart_uploads_input.ListMultipartUploadsInput]",
        ) -> OperationResponse[
            "capo_glacier.types.list_multipart_uploads_output.ListMultipartUploadsOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.list_multipart_uploads.list_multipart_uploads(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_multipart_uploads(
        ...
        *,
        ...
        limit: Optional[int] = None,
        marker: Optional["capo_glacier.types.string.string"] = None,
    ) -> "Iterator[capo_glacier.types.upload_list_element.UploadListElement]":
        _token = marker
        while True:
    ...
    def list_parts(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.list_parts_input.ListPartsInput]",
        ) -> OperationResponse["capo_glacier.types.list_parts_output.ListPartsOutput"]:
            import capo_glacier._operations.glacier.list_parts

            output, http_response = (
                capo_glacier._operations.glacier.list_parts.list_parts(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_parts(
        ...
        *,
        ...
        marker: Optional["capo_glacier.types.string.string"] = None,
        limit: Optional[int] = None,
    ) -> "Iterator[capo_glacier.types.part_list_element.PartListElement]":
        _token = marker
        while True:
    ...
    def list_provisioned_capacity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.list_provisioned_capacity_input.ListProvisionedCapacityInput]",
        ) -> OperationResponse[
            "capo_glacier.types.list_provisioned_capacity_output.ListProvisionedCapacityOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.list_provisioned_capacity.list_provisioned_capacity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_tags_for_vault(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.list_tags_for_vault_input.ListTagsForVaultInput]",
        ) -> OperationResponse[
            "capo_glacier.types.list_tags_for_vault_output.ListTagsForVaultOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.list_tags_for_vault.list_tags_for_vault(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_vaults(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.list_vaults_input.ListVaultsInput]",
        ) -> OperationResponse[
            "capo_glacier.types.list_vaults_output.ListVaultsOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.list_vaults.list_vaults(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_vaults(
        ...
        *,
        ...
        marker: Optional["capo_glacier.types.string.string"] = None,
        limit: Optional[int] = None,
    ) -> "Iterator[capo_glacier.types.describe_vault_output.DescribeVaultOutput]":
        _token = marker
        while True:
    ...
    def purchase_provisioned_capacity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.purchase_provisioned_capacity_input.PurchaseProvisionedCapacityInput]",
        ) -> OperationResponse[
            "capo_glacier.types.purchase_provisioned_capacity_output.PurchaseProvisionedCapacityOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.purchase_provisioned_capacity.purchase_provisioned_capacity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def remove_tags_from_vault(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.remove_tags_from_vault_input.RemoveTagsFromVaultInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.remove_tags_from_vault

            output, http_response = (
                capo_glacier._operations.glacier.remove_tags_from_vault.remove_tags_from_vault(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_data_retrieval_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.set_data_retrieval_policy_input.SetDataRetrievalPolicyInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.set_data_retrieval_policy

            output, http_response = (
                capo_glacier._operations.glacier.set_data_retrieval_policy.set_data_retrieval_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_vault_access_policy(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.set_vault_access_policy_input.SetVaultAccessPolicyInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.set_vault_access_policy

            output, http_response = (
                capo_glacier._operations.glacier.set_vault_access_policy.set_vault_access_policy(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_vault_notifications(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.set_vault_notifications_input.SetVaultNotificationsInput]",
        ) -> OperationResponse[None]:
            import capo_glacier._operations.glacier.set_vault_notifications

            output, http_response = (
                capo_glacier._operations.glacier.set_vault_notifications.set_vault_notifications(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def upload_archive(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.upload_archive_input.UploadArchiveInput]",
        ) -> OperationResponse[
            "capo_glacier.types.archive_creation_output.ArchiveCreationOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.upload_archive.upload_archive(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def upload_multipart_part(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_glacier.types.upload_multipart_part_input.UploadMultipartPartInput]",
        ) -> OperationResponse[
            "capo_glacier.types.upload_multipart_part_output.UploadMultipartPartOutput"
        ]:
            ...
            output, http_response = (
                capo_glacier._operations.glacier.upload_multipart_part.upload_multipart_part(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
