...
def handle_response(
    ...
    out: capo_glacier.types.get_vault_lock_output.GetVaultLockOutput = (
        capo_glacier.types.get_vault_lock_output.deserialize_json(
...
def get_vault_lock(
    ...
    capo_glacier.types.get_vault_lock_output.GetVaultLockOutput, zapros.Response
]:
