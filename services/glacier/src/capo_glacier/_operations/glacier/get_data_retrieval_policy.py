"""Generated from Smithy shape ``com.amazonaws.glacier#GetDataRetrievalPolicy``."""
...
def handle_response(
    ...
    out: capo_glacier.types.get_data_retrieval_policy_output.GetDataRetrievalPolicyOutput = capo_glacier.types.get_data_retrieval_policy_output.deserialize_json(
...
async def async_get_data_retrieval_policy(
