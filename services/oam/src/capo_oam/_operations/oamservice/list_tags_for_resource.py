"""Generated from Smithy shape ``com.amazonaws.oam#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_oam.types.list_tags_for_resource_output.ListTagsForResourceOutput = (
        capo_oam.types.list_tags_for_resource_output.deserialize_json(
