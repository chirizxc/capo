...
def handle_response(
    ...
    out: capo_oam.types.delete_link_output.DeleteLinkOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_oam.types.delete_link_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def delete_link(
    options: OperationOptions, input_: capo_oam.types.delete_link_input.DeleteLinkInput
) -> tuple[capo_oam.types.delete_link_output.DeleteLinkOutput, zapros.Response]:
