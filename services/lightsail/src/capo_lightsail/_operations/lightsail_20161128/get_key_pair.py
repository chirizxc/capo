...
def handle_response(
    ...
    out: capo_lightsail.types.get_key_pair_result.GetKeyPairResult = (
        capo_lightsail.types.get_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_key_pair_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_key_pair(
    ...
    input_: capo_lightsail.types.get_key_pair_request.GetKeyPairRequest,
) -> tuple[capo_lightsail.types.get_key_pair_result.GetKeyPairResult, zapros.Response]:
