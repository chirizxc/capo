...
def handle_response(
    ...
    out: capo_lightsail.types.create_container_service_result.CreateContainerServiceResult = capo_lightsail.types.create_container_service_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_container_service_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
