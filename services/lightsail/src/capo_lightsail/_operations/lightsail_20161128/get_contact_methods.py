...
def handle_response(
    ...
    out: capo_lightsail.types.get_contact_methods_result.GetContactMethodsResult = (
        capo_lightsail.types.get_contact_methods_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_contact_methods_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
