...
def handle_response(
    ...
    out: capo_lightsail.types.get_bundles_result.GetBundlesResult = (
        capo_lightsail.types.get_bundles_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_bundles_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_bundles(
    ...
    input_: capo_lightsail.types.get_bundles_request.GetBundlesRequest,
) -> tuple[capo_lightsail.types.get_bundles_result.GetBundlesResult, zapros.Response]:
