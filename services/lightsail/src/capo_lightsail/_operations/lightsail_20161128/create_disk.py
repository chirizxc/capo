"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateDisk``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_disk_result.CreateDiskResult = (
        capo_lightsail.types.create_disk_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateDisk"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateDisk"
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_disk_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_disk(
    ...
    input_: capo_lightsail.types.create_disk_request.CreateDiskRequest,
) -> tuple[capo_lightsail.types.create_disk_result.CreateDiskResult, zapros.Response]:
