...
def handle_response(
    ...
    out: capo_lightsail.types.open_instance_public_ports_result.OpenInstancePublicPortsResult = capo_lightsail.types.open_instance_public_ports_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.open_instance_public_ports_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
