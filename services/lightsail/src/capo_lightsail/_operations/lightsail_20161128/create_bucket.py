"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateBucket``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_bucket_result.CreateBucketResult = (
        capo_lightsail.types.create_bucket_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/CreateBucket"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateBucket"
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_bucket_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_bucket(
    ...
    capo_lightsail.types.create_bucket_result.CreateBucketResult, zapros.Response
]:
