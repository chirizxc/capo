...
def handle_response(
    ...
    out: capo_lightsail.types.get_certificates_result.GetCertificatesResult = (
        capo_lightsail.types.get_certificates_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_certificates_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_certificates(
    ...
    capo_lightsail.types.get_certificates_result.GetCertificatesResult, zapros.Response
]:
