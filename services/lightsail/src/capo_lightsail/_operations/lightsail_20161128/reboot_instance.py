...
def handle_response(
    ...
    out: capo_lightsail.types.reboot_instance_result.RebootInstanceResult = (
        capo_lightsail.types.reboot_instance_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.reboot_instance_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def reboot_instance(
    ...
    capo_lightsail.types.reboot_instance_result.RebootInstanceResult, zapros.Response
]:
