...
def handle_response(
    ...
    out: capo_lightsail.types.create_load_balancer_result.CreateLoadBalancerResult = (
        capo_lightsail.types.create_load_balancer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_load_balancer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
