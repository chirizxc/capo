...
def handle_response(
    ...
    out: capo_lightsail.types.attach_instances_to_load_balancer_result.AttachInstancesToLoadBalancerResult = capo_lightsail.types.attach_instances_to_load_balancer_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.attach_instances_to_load_balancer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
