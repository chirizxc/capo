"""Generated from Smithy shape ``com.amazonaws.lightsail#GetOperations``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_operations_result.GetOperationsResult = (
        capo_lightsail.types.get_operations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetOperations"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetOperations"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_operations_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_operations(
    ...
    capo_lightsail.types.get_operations_result.GetOperationsResult, zapros.Response
]:
