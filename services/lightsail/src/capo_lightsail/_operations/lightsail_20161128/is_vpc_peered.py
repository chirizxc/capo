...
def handle_response(
    ...
    out: capo_lightsail.types.is_vpc_peered_result.IsVpcPeeredResult = (
        capo_lightsail.types.is_vpc_peered_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.is_vpc_peered_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def is_vpc_peered(
    ...
    capo_lightsail.types.is_vpc_peered_result.IsVpcPeeredResult, zapros.Response
]:
