"""Generated from Smithy shape ``com.amazonaws.lightsail#GetContainerImages``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_container_images_result.GetContainerImagesResult = (
        capo_lightsail.types.get_container_images_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Lightsail_20161128.GetContainerImages"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_container_images_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_container_images(
