...
def handle_response(
    ...
    out: capo_lightsail.types.export_snapshot_result.ExportSnapshotResult = (
        capo_lightsail.types.export_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.export_snapshot_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def export_snapshot(
    ...
    capo_lightsail.types.export_snapshot_result.ExportSnapshotResult, zapros.Response
]:
