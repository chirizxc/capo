...
def handle_response(
    ...
    out: capo_lightsail.types.get_container_service_powers_result.GetContainerServicePowersResult = capo_lightsail.types.get_container_service_powers_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_container_service_powers_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
