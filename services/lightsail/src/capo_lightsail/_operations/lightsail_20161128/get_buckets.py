...
def handle_response(
    ...
    out: capo_lightsail.types.get_buckets_result.GetBucketsResult = (
        capo_lightsail.types.get_buckets_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_buckets_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_buckets(
    ...
    input_: capo_lightsail.types.get_buckets_request.GetBucketsRequest,
) -> tuple[capo_lightsail.types.get_buckets_result.GetBucketsResult, zapros.Response]:
