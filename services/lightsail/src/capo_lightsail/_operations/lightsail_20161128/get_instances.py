...
import capo_lightsail.types.instance_list
...
def handle_response(
    ...
    out: capo_lightsail.types.get_instances_result.GetInstancesResult = (
        capo_lightsail.types.get_instances_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_instances_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_instances(
    ...
    capo_lightsail.types.get_instances_result.GetInstancesResult, zapros.Response
]:
