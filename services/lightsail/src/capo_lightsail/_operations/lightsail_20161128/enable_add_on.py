"""Generated from Smithy shape ``com.amazonaws.lightsail#EnableAddOn``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.enable_add_on_result.EnableAddOnResult = (
        capo_lightsail.types.enable_add_on_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/EnableAddOn"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.EnableAddOn"
    body: bytes | None = json.dumps(
        capo_lightsail.types.enable_add_on_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def enable_add_on(
    ...
    capo_lightsail.types.enable_add_on_result.EnableAddOnResult, zapros.Response
]:
