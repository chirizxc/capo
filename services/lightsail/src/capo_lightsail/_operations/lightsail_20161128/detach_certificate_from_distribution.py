"""Generated from Smithy shape ``com.amazonaws.lightsail#DetachCertificateFromDistribution``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.detach_certificate_from_distribution_result.DetachCertificateFromDistributionResult = capo_lightsail.types.detach_certificate_from_distribution_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Lightsail_20161128.DetachCertificateFromDistribution"
    body: bytes | None = json.dumps(
        capo_lightsail.types.detach_certificate_from_distribution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_detach_certificate_from_distribution(
