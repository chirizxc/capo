"""Generated from Smithy shape ``com.amazonaws.lightsail#DeleteKeyPair``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.delete_key_pair_result.DeleteKeyPairResult = (
        capo_lightsail.types.delete_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/DeleteKeyPair"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.DeleteKeyPair"
    body: bytes | None = json.dumps(
        capo_lightsail.types.delete_key_pair_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_key_pair(
    ...
    capo_lightsail.types.delete_key_pair_result.DeleteKeyPairResult, zapros.Response
]:
