"""Generated from Smithy shape ``com.amazonaws.lightsail#PutAlarm``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.put_alarm_result.PutAlarmResult = (
        capo_lightsail.types.put_alarm_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/PutAlarm"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.PutAlarm"
    body: bytes | None = json.dumps(
        capo_lightsail.types.put_alarm_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_alarm(
    ...
    input_: capo_lightsail.types.put_alarm_request.PutAlarmRequest,
) -> tuple[capo_lightsail.types.put_alarm_result.PutAlarmResult, zapros.Response]:
