...
def handle_response(
    ...
    out: capo_lightsail.types.test_alarm_result.TestAlarmResult = (
        capo_lightsail.types.test_alarm_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.test_alarm_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def test_alarm(
    ...
    input_: capo_lightsail.types.test_alarm_request.TestAlarmRequest,
) -> tuple[capo_lightsail.types.test_alarm_result.TestAlarmResult, zapros.Response]:
