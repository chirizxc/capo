...
def handle_response(
    ...
    out: capo_lightsail.types.get_disks_result.GetDisksResult = (
        capo_lightsail.types.get_disks_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_disks_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_disks(
    ...
    input_: capo_lightsail.types.get_disks_request.GetDisksRequest,
) -> tuple[capo_lightsail.types.get_disks_result.GetDisksResult, zapros.Response]:
