...
def handle_response(
    ...
    out: capo_lightsail.types.get_relational_database_master_user_password_result.GetRelationalDatabaseMasterUserPasswordResult = capo_lightsail.types.get_relational_database_master_user_password_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_relational_database_master_user_password_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
