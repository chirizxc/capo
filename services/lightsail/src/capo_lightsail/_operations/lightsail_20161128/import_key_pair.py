...
def handle_response(
    ...
    out: capo_lightsail.types.import_key_pair_result.ImportKeyPairResult = (
        capo_lightsail.types.import_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.import_key_pair_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def import_key_pair(
    ...
    capo_lightsail.types.import_key_pair_result.ImportKeyPairResult, zapros.Response
]:
