...
def handle_response(
    ...
    out: capo_lightsail.types.delete_container_service_result.DeleteContainerServiceResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.delete_container_service_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
