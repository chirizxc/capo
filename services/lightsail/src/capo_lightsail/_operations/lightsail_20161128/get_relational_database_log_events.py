...
def handle_response(
    ...
    out: capo_lightsail.types.get_relational_database_log_events_result.GetRelationalDatabaseLogEventsResult = capo_lightsail.types.get_relational_database_log_events_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_relational_database_log_events_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
