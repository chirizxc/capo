...
def handle_response(
    ...
    out: capo_lightsail.types.download_default_key_pair_result.DownloadDefaultKeyPairResult = capo_lightsail.types.download_default_key_pair_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.download_default_key_pair_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
