...
def handle_response(
    ...
    out: capo_lightsail.types.get_container_log_result.GetContainerLogResult = (
        capo_lightsail.types.get_container_log_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_container_log_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_container_log(
    ...
    capo_lightsail.types.get_container_log_result.GetContainerLogResult, zapros.Response
]:
