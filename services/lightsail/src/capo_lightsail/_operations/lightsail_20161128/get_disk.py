...
def handle_response(
    ...
    out: capo_lightsail.types.get_disk_result.GetDiskResult = (
        capo_lightsail.types.get_disk_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_disk_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_disk(
    ...
    input_: capo_lightsail.types.get_disk_request.GetDiskRequest,
) -> tuple[capo_lightsail.types.get_disk_result.GetDiskResult, zapros.Response]:
