...
def handle_response(
    ...
    out: capo_lightsail.types.delete_instance_snapshot_result.DeleteInstanceSnapshotResult = capo_lightsail.types.delete_instance_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.delete_instance_snapshot_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
