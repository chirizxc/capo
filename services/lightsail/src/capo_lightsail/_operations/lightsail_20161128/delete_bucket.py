...
def handle_response(
    ...
    out: capo_lightsail.types.delete_bucket_result.DeleteBucketResult = (
        capo_lightsail.types.delete_bucket_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.delete_bucket_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_bucket(
    ...
    capo_lightsail.types.delete_bucket_result.DeleteBucketResult, zapros.Response
]:
