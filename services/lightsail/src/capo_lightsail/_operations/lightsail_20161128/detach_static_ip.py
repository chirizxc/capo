...
def handle_response(
    ...
    out: capo_lightsail.types.detach_static_ip_result.DetachStaticIpResult = (
        capo_lightsail.types.detach_static_ip_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.detach_static_ip_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def detach_static_ip(
    ...
    capo_lightsail.types.detach_static_ip_result.DetachStaticIpResult, zapros.Response
]:
