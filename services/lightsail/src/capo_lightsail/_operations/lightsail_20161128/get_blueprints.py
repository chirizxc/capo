...
def handle_response(
    ...
    out: capo_lightsail.types.get_blueprints_result.GetBlueprintsResult = (
        capo_lightsail.types.get_blueprints_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_blueprints_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_blueprints(
    ...
    capo_lightsail.types.get_blueprints_result.GetBlueprintsResult, zapros.Response
]:
