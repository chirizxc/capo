...
def handle_response(
    ...
    out: capo_lightsail.types.send_contact_method_verification_result.SendContactMethodVerificationResult = capo_lightsail.types.send_contact_method_verification_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.send_contact_method_verification_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
