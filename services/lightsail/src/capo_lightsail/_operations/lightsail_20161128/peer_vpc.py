...
def handle_response(
    ...
    out: capo_lightsail.types.peer_vpc_result.PeerVpcResult = (
        capo_lightsail.types.peer_vpc_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.peer_vpc_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def peer_vpc(
    ...
    input_: capo_lightsail.types.peer_vpc_request.PeerVpcRequest,
) -> tuple[capo_lightsail.types.peer_vpc_result.PeerVpcResult, zapros.Response]:
