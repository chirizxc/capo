...
def handle_response(
    ...
    out: capo_lightsail.types.untag_resource_result.UntagResourceResult = (
        capo_lightsail.types.untag_resource_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.untag_resource_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def untag_resource(
    ...
    capo_lightsail.types.untag_resource_result.UntagResourceResult, zapros.Response
]:
