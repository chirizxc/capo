...
def handle_response(
    ...
    out: capo_lightsail.types.get_load_balancer_metric_data_result.GetLoadBalancerMetricDataResult = capo_lightsail.types.get_load_balancer_metric_data_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_load_balancer_metric_data_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
