"""Generated from Smithy shape ``com.amazonaws.lightsail#GetLoadBalancerTlsPolicies``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.get_load_balancer_tls_policies_result.GetLoadBalancerTlsPoliciesResult = capo_lightsail.types.get_load_balancer_tls_policies_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/ls/api/2016-11-28/GetLoadBalancerTlsPolicies"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "Lightsail_20161128.GetLoadBalancerTlsPolicies"
    body: bytes | None = json.dumps(
        capo_lightsail.types.get_load_balancer_tls_policies_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_load_balancer_tls_policies(
