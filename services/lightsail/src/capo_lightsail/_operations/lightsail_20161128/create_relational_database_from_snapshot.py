"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateRelationalDatabaseFromSnapshot``."""
...
def handle_response(
    ...
    out: capo_lightsail.types.create_relational_database_from_snapshot_result.CreateRelationalDatabaseFromSnapshotResult = capo_lightsail.types.create_relational_database_from_snapshot_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Lightsail_20161128.CreateRelationalDatabaseFromSnapshot"
    body: bytes | None = json.dumps(
        capo_lightsail.types.create_relational_database_from_snapshot_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_relational_database_from_snapshot(
