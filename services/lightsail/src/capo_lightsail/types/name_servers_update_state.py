...
class NameServersUpdateState(TypedDict, closed=True):
    code: NotRequired[
        "capo_lightsail.types.name_servers_update_state_code.NameServersUpdateStateCode"
    ]
...
def serialize_aws_json_1_1(value: NameServersUpdateState) -> dict:
    ...
    if "code" in value:
        ...
        out["code"] = (
            capo_lightsail.types.name_servers_update_state_code.serialize_aws_json_1_1(
                value["code"]
            )
        )
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> NameServersUpdateState:
    ...
    if data.get("code") is not None:
        ...
        out["code"] = (
            capo_lightsail.types.name_servers_update_state_code.deserialize_aws_json_1_1(
                data["code"]
            )
        )
