...
class GetDistributionsResult(TypedDict, closed=True):
    distributions: NotRequired[
        "capo_lightsail.types.distribution_list.DistributionList"
    ]
...
def serialize_aws_json_1_1(value: GetDistributionsResult) -> dict:
    ...
    if "distributions" in value:
        ...
        out["distributions"] = (
            capo_lightsail.types.distribution_list.serialize_aws_json_1_1(
                value["distributions"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetDistributionsResult:
    ...
    if data.get("distributions") is not None:
        ...
        out["distributions"] = (
            capo_lightsail.types.distribution_list.deserialize_aws_json_1_1(
                data["distributions"]
            )
        )
