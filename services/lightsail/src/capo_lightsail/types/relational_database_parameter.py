...
class RelationalDatabaseParameter(TypedDict, closed=True):
    allowed_values: NotRequired["capo_lightsail.types.string.string"]
    """<p>Specifies the valid range of values for the parameter.</p>"""
    apply_method: NotRequired["capo_lightsail.types.string.string"]
    """<p>Indicates when parameter updates are applied.</p> <p>Can be <code>immediate</code> or <code>pending-reboot</code>.</p>"""
    apply_type: NotRequired["capo_lightsail.types.string.string"]
    """<p>Specifies the engine-specific parameter type.</p>"""
    data_type: NotRequired["capo_lightsail.types.string.string"]
    """<p>Specifies the valid data type for the parameter.</p>"""
    description: NotRequired["capo_lightsail.types.string.string"]
    """<p>Provides a description of the parameter.</p>"""
    is_modifiable: NotRequired["capo_lightsail.types.boolean.boolean"]
    """<p>A Boolean value indicating whether the parameter can be modified.</p>"""
    parameter_name: NotRequired["capo_lightsail.types.string.string"]
    """<p>Specifies the name of the parameter.</p>"""
    parameter_value: NotRequired["capo_lightsail.types.string.string"]
