"""Generated from Smithy shape ``com.amazonaws.lightsail#StopInstanceResult``."""
...
def deserialize_aws_json_1_1(data: dict) -> StopInstanceResult:
    out: StopInstanceResult = {}  # type: ignore[typeddict-item]
