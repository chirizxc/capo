...
class GetContactMethodsResult(TypedDict, closed=True):
    contact_methods: NotRequired[
        "capo_lightsail.types.contact_methods_list.ContactMethodsList"
    ]
...
def serialize_aws_json_1_1(value: GetContactMethodsResult) -> dict:
    ...
    if "contact_methods" in value:
        ...
        out["contactMethods"] = (
            capo_lightsail.types.contact_methods_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetContactMethodsResult:
    ...
    if data.get("contactMethods") is not None:
        ...
        out["contact_methods"] = (
            capo_lightsail.types.contact_methods_list.deserialize_aws_json_1_1(
                data["contactMethods"]
            )
        )
    return out
