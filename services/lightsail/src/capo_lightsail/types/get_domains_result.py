...
class GetDomainsResult(TypedDict, closed=True):
    domains: NotRequired["capo_lightsail.types.domain_list.DomainList"]
...
def serialize_aws_json_1_1(value: GetDomainsResult) -> dict:
    ...
    if "domains" in value:
        ...
        out["domains"] = capo_lightsail.types.domain_list.serialize_aws_json_1_1(
            value["domains"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetDomainsResult:
    ...
    if data.get("domains") is not None:
        ...
        out["domains"] = capo_lightsail.types.domain_list.deserialize_aws_json_1_1(
            data["domains"]
        )
