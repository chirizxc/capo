...
class LoadBalancerTlsCertificateRenewalSummary(TypedDict, closed=True):
    renewal_status: NotRequired[
        "capo_lightsail.types.load_balancer_tls_certificate_renewal_status.LoadBalancerTlsCertificateRenewalStatus"
    ]
    ...
    domain_validation_options: NotRequired[
        "capo_lightsail.types.load_balancer_tls_certificate_domain_validation_option_list.LoadBalancerTlsCertificateDomainValidationOptionList"
    ]
...
def serialize_aws_json_1_1(value: LoadBalancerTlsCertificateRenewalSummary) -> dict:
    ...
    if "renewal_status" in value:
        ...
        out["renewalStatus"] = (
            capo_lightsail.types.load_balancer_tls_certificate_renewal_status.serialize_aws_json_1_1(
    ...
    if "domain_validation_options" in value:
        ...
        out["domainValidationOptions"] = (
            capo_lightsail.types.load_balancer_tls_certificate_domain_validation_option_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LoadBalancerTlsCertificateRenewalSummary:
    ...
    if data.get("renewalStatus") is not None:
        ...
        out["renewal_status"] = (
            capo_lightsail.types.load_balancer_tls_certificate_renewal_status.deserialize_aws_json_1_1(
                data["renewalStatus"]
            )
        )
    if data.get("domainValidationOptions") is not None:
        ...
        out["domain_validation_options"] = (
            capo_lightsail.types.load_balancer_tls_certificate_domain_validation_option_list.deserialize_aws_json_1_1(
