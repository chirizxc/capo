...
class InstanceSnapshotInfo(TypedDict, closed=True):
    from_bundle_id: NotRequired["capo_lightsail.types.non_empty_string.NonEmptyString"]
    ...
    from_disk_info: NotRequired["capo_lightsail.types.disk_info_list.DiskInfoList"]
...
def serialize_aws_json_1_1(value: InstanceSnapshotInfo) -> dict:
    ...
    if "from_disk_info" in value:
        ...
        out["fromDiskInfo"] = (
            capo_lightsail.types.disk_info_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> InstanceSnapshotInfo:
    ...
    if data.get("fromDiskInfo") is not None:
        ...
        out["from_disk_info"] = (
            capo_lightsail.types.disk_info_list.deserialize_aws_json_1_1(
                data["fromDiskInfo"]
            )
        )
    return out
