...
if TYPE_CHECKING:
    ...
    import capo_lightsail.types.port_state
...
class InstancePortState(TypedDict, closed=True):
    ...
    state: NotRequired["capo_lightsail.types.port_state.PortState"]
...
def serialize_aws_json_1_1(value: InstancePortState) -> dict:
    ...
    if "state" in value:
        ...
        out["state"] = capo_lightsail.types.port_state.serialize_aws_json_1_1(
            value["state"]
        )
    if "cidrs" in value:
        import capo_lightsail.types.string_list
...
def deserialize_aws_json_1_1(data: dict) -> InstancePortState:
    ...
    if data.get("state") is not None:
        ...
        out["state"] = capo_lightsail.types.port_state.deserialize_aws_json_1_1(
            data["state"]
        )
