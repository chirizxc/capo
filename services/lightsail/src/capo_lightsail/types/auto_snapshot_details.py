...
class AutoSnapshotDetails(TypedDict, closed=True):
    date: NotRequired["capo_lightsail.types.string.string"]
    ...
    status: NotRequired["capo_lightsail.types.auto_snapshot_status.AutoSnapshotStatus"]
    """<p>The status of the automatic snapshot.</p>"""
    from_attached_disks: NotRequired[
        "capo_lightsail.types.attached_disk_list.AttachedDiskList"
    ]
...
def serialize_aws_json_1_1(value: AutoSnapshotDetails) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = (
            capo_lightsail.types.auto_snapshot_status.serialize_aws_json_1_1(
                value["status"]
            )
        )
    if "from_attached_disks" in value:
        ...
        out["fromAttachedDisks"] = (
            capo_lightsail.types.attached_disk_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AutoSnapshotDetails:
    ...
    if data.get("status") is not None:
        ...
        out["status"] = (
            capo_lightsail.types.auto_snapshot_status.deserialize_aws_json_1_1(
                data["status"]
            )
        )
    if data.get("fromAttachedDisks") is not None:
        ...
        out["from_attached_disks"] = (
            capo_lightsail.types.attached_disk_list.deserialize_aws_json_1_1(
