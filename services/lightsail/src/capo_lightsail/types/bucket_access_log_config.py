...
class BucketAccessLogConfig(TypedDict, closed=True):
    ...
    prefix: NotRequired[
        "capo_lightsail.types.bucket_access_log_prefix.BucketAccessLogPrefix"
    ]
