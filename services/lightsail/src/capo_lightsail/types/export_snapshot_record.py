...
class ExportSnapshotRecord(TypedDict, closed=True):
    ...
    source_info: NotRequired[
        "capo_lightsail.types.export_snapshot_record_source_info.ExportSnapshotRecordSourceInfo"
    ]
...
def serialize_aws_json_1_1(value: ExportSnapshotRecord) -> dict:
    ...
    if "source_info" in value:
        ...
        out["sourceInfo"] = (
            capo_lightsail.types.export_snapshot_record_source_info.serialize_aws_json_1_1(
                value["source_info"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ExportSnapshotRecord:
    ...
    if data.get("sourceInfo") is not None:
        ...
        out["source_info"] = (
            capo_lightsail.types.export_snapshot_record_source_info.deserialize_aws_json_1_1(
                data["sourceInfo"]
            )
        )
