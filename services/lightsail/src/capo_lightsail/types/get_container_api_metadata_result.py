...
class GetContainerAPIMetadataResult(TypedDict, closed=True):
    metadata: NotRequired[
        "capo_lightsail.types.container_service_metadata_entry_list.ContainerServiceMetadataEntryList"
    ]
...
def serialize_aws_json_1_1(value: GetContainerAPIMetadataResult) -> dict:
    ...
    if "metadata" in value:
        ...
        out["metadata"] = (
            capo_lightsail.types.container_service_metadata_entry_list.serialize_aws_json_1_1(
                value["metadata"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetContainerAPIMetadataResult:
    ...
    if data.get("metadata") is not None:
        ...
        out["metadata"] = (
            capo_lightsail.types.container_service_metadata_entry_list.deserialize_aws_json_1_1(
                data["metadata"]
            )
        )
    return out
