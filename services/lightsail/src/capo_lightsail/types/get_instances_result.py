...
class GetInstancesResult(TypedDict, closed=True):
    instances: NotRequired["capo_lightsail.types.instance_list.InstanceList"]
...
def serialize_aws_json_1_1(value: GetInstancesResult) -> dict:
    ...
    if "instances" in value:
        ...
        out["instances"] = capo_lightsail.types.instance_list.serialize_aws_json_1_1(
            value["instances"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetInstancesResult:
    ...
    if data.get("instances") is not None:
        ...
        out["instances"] = capo_lightsail.types.instance_list.deserialize_aws_json_1_1(
            data["instances"]
        )
