...
class GetInstancePortStatesResult(TypedDict, closed=True):
    port_states: NotRequired[
        "capo_lightsail.types.instance_port_state_list.InstancePortStateList"
    ]
...
def serialize_aws_json_1_1(value: GetInstancePortStatesResult) -> dict:
    ...
    if "port_states" in value:
        ...
        out["portStates"] = (
            capo_lightsail.types.instance_port_state_list.serialize_aws_json_1_1(
                value["port_states"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetInstancePortStatesResult:
    ...
    if data.get("portStates") is not None:
        ...
        out["port_states"] = (
            capo_lightsail.types.instance_port_state_list.deserialize_aws_json_1_1(
                data["portStates"]
            )
        )
    return out
