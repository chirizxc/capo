"""Generated from Smithy shape ``com.amazonaws.lightsail#CreateDomainResult``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: CreateDomainResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> CreateDomainResult:
