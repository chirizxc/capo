"""Generated from Smithy shape ``com.amazonaws.lightsail#AttachDiskResult``."""
...
def deserialize_aws_json_1_1(data: dict) -> AttachDiskResult:
    out: AttachDiskResult = {}  # type: ignore[typeddict-item]
