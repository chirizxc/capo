...
class GetSetupHistoryResult(TypedDict, closed=True):
    setup_history: NotRequired[
        "capo_lightsail.types.setup_history_list.setupHistoryList"
    ]
...
def serialize_aws_json_1_1(value: GetSetupHistoryResult) -> dict:
    ...
    if "setup_history" in value:
        ...
        out["setupHistory"] = (
            capo_lightsail.types.setup_history_list.serialize_aws_json_1_1(
                value["setup_history"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetSetupHistoryResult:
    ...
    if data.get("setupHistory") is not None:
        ...
        out["setup_history"] = (
            capo_lightsail.types.setup_history_list.deserialize_aws_json_1_1(
                data["setupHistory"]
            )
        )
