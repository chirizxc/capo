...
class GetCertificatesResult(TypedDict, closed=True):
    certificates: NotRequired[
        "capo_lightsail.types.certificate_summary_list.CertificateSummaryList"
    ]
...
def serialize_aws_json_1_1(value: GetCertificatesResult) -> dict:
    ...
    if "certificates" in value:
        ...
        out["certificates"] = (
            capo_lightsail.types.certificate_summary_list.serialize_aws_json_1_1(
                value["certificates"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetCertificatesResult:
    ...
    if data.get("certificates") is not None:
        ...
        out["certificates"] = (
            capo_lightsail.types.certificate_summary_list.deserialize_aws_json_1_1(
                data["certificates"]
            )
        )
