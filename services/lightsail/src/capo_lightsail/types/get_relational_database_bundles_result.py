...
class GetRelationalDatabaseBundlesResult(TypedDict, closed=True):
    bundles: NotRequired[
        "capo_lightsail.types.relational_database_bundle_list.RelationalDatabaseBundleList"
    ]
...
def serialize_aws_json_1_1(value: GetRelationalDatabaseBundlesResult) -> dict:
    ...
    if "bundles" in value:
        ...
        out["bundles"] = (
            capo_lightsail.types.relational_database_bundle_list.serialize_aws_json_1_1(
                value["bundles"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetRelationalDatabaseBundlesResult:
    ...
    if data.get("bundles") is not None:
        ...
        out["bundles"] = (
            capo_lightsail.types.relational_database_bundle_list.deserialize_aws_json_1_1(
                data["bundles"]
            )
        )
