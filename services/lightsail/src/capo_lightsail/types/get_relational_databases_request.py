"""Generated from Smithy shape ``com.amazonaws.lightsail#GetRelationalDatabasesRequest``."""
...
class GetRelationalDatabasesRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: GetRelationalDatabasesRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> GetRelationalDatabasesRequest:
    out: GetRelationalDatabasesRequest = {}  # type: ignore[typeddict-item]
