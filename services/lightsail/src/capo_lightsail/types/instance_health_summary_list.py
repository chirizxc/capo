...
if TYPE_CHECKING:
    import capo_lightsail.types.instance_health_summary

InstanceHealthSummaryList: TypeAlias = list[
    "capo_lightsail.types.instance_health_summary.InstanceHealthSummary"
]
...
def serialize_aws_json_1_1(value: InstanceHealthSummaryList) -> list:
    ...
    for item in value:
        out.append(
            capo_lightsail.types.instance_health_summary.serialize_aws_json_1_1(item)
        )
    return out
