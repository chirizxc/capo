...
class DomainValidationRecord(TypedDict, closed=True):
    ...
    resource_record: NotRequired["capo_lightsail.types.resource_record.ResourceRecord"]
    ...
    dns_record_creation_state: NotRequired[
        "capo_lightsail.types.dns_record_creation_state.DnsRecordCreationState"
    ]
    ...
    validation_status: NotRequired[
        "capo_lightsail.types.certificate_domain_validation_status.CertificateDomainValidationStatus"
    ]
...
def serialize_aws_json_1_1(value: DomainValidationRecord) -> dict:
    ...
    if "resource_record" in value:
        ...
        out["resourceRecord"] = (
            capo_lightsail.types.resource_record.serialize_aws_json_1_1(
    ...
    if "dns_record_creation_state" in value:
        ...
        out["dnsRecordCreationState"] = (
            capo_lightsail.types.dns_record_creation_state.serialize_aws_json_1_1(
    ...
    if "validation_status" in value:
        ...
        out["validationStatus"] = (
            capo_lightsail.types.certificate_domain_validation_status.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DomainValidationRecord:
    ...
    if data.get("resourceRecord") is not None:
        ...
        out["resource_record"] = (
            capo_lightsail.types.resource_record.deserialize_aws_json_1_1(
                data["resourceRecord"]
            )
        )
    if data.get("dnsRecordCreationState") is not None:
        ...
        out["dns_record_creation_state"] = (
            capo_lightsail.types.dns_record_creation_state.deserialize_aws_json_1_1(
    ...
    if data.get("validationStatus") is not None:
        ...
        out["validation_status"] = (
            capo_lightsail.types.certificate_domain_validation_status.deserialize_aws_json_1_1(
