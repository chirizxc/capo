...
class GetContainerServiceDeploymentsResult(TypedDict, closed=True):
    deployments: NotRequired[
        "capo_lightsail.types.container_service_deployment_list.ContainerServiceDeploymentList"
    ]
...
def serialize_aws_json_1_1(value: GetContainerServiceDeploymentsResult) -> dict:
    ...
    if "deployments" in value:
        ...
        out["deployments"] = (
            capo_lightsail.types.container_service_deployment_list.serialize_aws_json_1_1(
                value["deployments"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> GetContainerServiceDeploymentsResult:
    ...
    if data.get("deployments") is not None:
        ...
        out["deployments"] = (
            capo_lightsail.types.container_service_deployment_list.deserialize_aws_json_1_1(
                data["deployments"]
            )
        )
    return out
