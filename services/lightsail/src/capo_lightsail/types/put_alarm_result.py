"""Generated from Smithy shape ``com.amazonaws.lightsail#PutAlarmResult``."""
...
def deserialize_aws_json_1_1(data: dict) -> PutAlarmResult:
    out: PutAlarmResult = {}  # type: ignore[typeddict-item]
