"""Generated from Smithy shape ``com.amazonaws.lightsail#UpdateDistributionResult``."""
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: UpdateDistributionResult) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> UpdateDistributionResult:
