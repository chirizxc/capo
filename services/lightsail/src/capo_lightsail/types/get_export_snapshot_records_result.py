...
class GetExportSnapshotRecordsResult(TypedDict, closed=True):
    export_snapshot_records: NotRequired[
        "capo_lightsail.types.export_snapshot_record_list.ExportSnapshotRecordList"
    ]
...
def serialize_aws_json_1_1(value: GetExportSnapshotRecordsResult) -> dict:
    ...
    if "export_snapshot_records" in value:
        ...
        out["exportSnapshotRecords"] = (
            capo_lightsail.types.export_snapshot_record_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetExportSnapshotRecordsResult:
    ...
    if data.get("exportSnapshotRecords") is not None:
        ...
        out["export_snapshot_records"] = (
            capo_lightsail.types.export_snapshot_record_list.deserialize_aws_json_1_1(
