...
class PendingMaintenanceAction(TypedDict, closed=True):
    action: NotRequired["capo_lightsail.types.non_empty_string.NonEmptyString"]
    """<p>The type of pending database maintenance action.</p>"""
    description: NotRequired["capo_lightsail.types.non_empty_string.NonEmptyString"]
    """<p>Additional detail about the pending database maintenance action.</p>"""
    current_apply_date: NotRequired["capo_lightsail.types.iso_date.IsoDate"]
...
def serialize_aws_json_1_1(value: PendingMaintenanceAction) -> dict:
    ...
    if "current_apply_date" in value:
        ...
        out["currentApplyDate"] = capo_lightsail.types.iso_date.serialize_aws_json_1_1(
