...
import capo_verifiedpermissions.errors.too_many_tags_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "TooManyTagsException":
            raise capo_verifiedpermissions.errors.too_many_tags_exception.TooManyTagsException.from_aws_json_1_0(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.tag_resource_output.TagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.tag_resource_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
