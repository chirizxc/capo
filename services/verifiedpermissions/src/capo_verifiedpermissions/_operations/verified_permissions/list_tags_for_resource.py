"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_verifiedpermissions.types.list_tags_for_resource_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.list_tags_for_resource_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
