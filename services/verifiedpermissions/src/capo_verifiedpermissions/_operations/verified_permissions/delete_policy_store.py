"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#DeletePolicyStore``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.delete_policy_store_output.DeletePolicyStoreOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.DeletePolicyStore"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.delete_policy_store_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_policy_store(
