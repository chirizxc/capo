"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#DeleteIdentitySource``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.delete_identity_source_output.DeleteIdentitySourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.DeleteIdentitySource"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.delete_identity_source_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_identity_source(
