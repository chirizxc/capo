"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#CreatePolicyStore``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.create_policy_store_output.CreatePolicyStoreOutput = capo_verifiedpermissions.types.create_policy_store_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.CreatePolicyStore"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.create_policy_store_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_policy_store(
