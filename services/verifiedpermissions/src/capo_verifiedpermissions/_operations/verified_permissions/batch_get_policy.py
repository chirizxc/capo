...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.batch_get_policy_output.BatchGetPolicyOutput = (
        capo_verifiedpermissions.types.batch_get_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.batch_get_policy_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
