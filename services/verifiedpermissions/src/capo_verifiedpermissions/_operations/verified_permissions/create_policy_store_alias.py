...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.create_policy_store_alias_output.CreatePolicyStoreAliasOutput = capo_verifiedpermissions.types.create_policy_store_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.create_policy_store_alias_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
