"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#ListPolicies``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.list_policies_output.ListPoliciesOutput = (
        capo_verifiedpermissions.types.list_policies_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.ListPolicies"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.list_policies_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
