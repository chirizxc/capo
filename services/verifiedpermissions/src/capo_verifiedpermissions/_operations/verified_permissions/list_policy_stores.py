"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#ListPolicyStores``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.list_policy_stores_output.ListPolicyStoresOutput = capo_verifiedpermissions.types.list_policy_stores_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.ListPolicyStores"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.list_policy_stores_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_policy_stores(
