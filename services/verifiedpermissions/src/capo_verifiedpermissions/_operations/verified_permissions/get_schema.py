"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#GetSchema``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.get_schema_output.GetSchemaOutput = (
        capo_verifiedpermissions.types.get_schema_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.GetSchema"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.get_schema_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_schema(
    ...
    capo_verifiedpermissions.types.get_schema_output.GetSchemaOutput, zapros.Response
]:
