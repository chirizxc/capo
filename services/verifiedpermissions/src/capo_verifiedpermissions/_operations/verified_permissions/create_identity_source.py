...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.create_identity_source_output.CreateIdentitySourceOutput = capo_verifiedpermissions.types.create_identity_source_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.create_identity_source_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
