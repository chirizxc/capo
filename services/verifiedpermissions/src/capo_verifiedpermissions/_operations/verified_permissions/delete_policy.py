"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#DeletePolicy``."""
...
def handle_response(
    ...
    out: capo_verifiedpermissions.types.delete_policy_output.DeletePolicyOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "VerifiedPermissions.DeletePolicy"
    body: bytes | None = json.dumps(
        capo_verifiedpermissions.types.delete_policy_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
