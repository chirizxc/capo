"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#TemplateLinkedPolicyDefinition``."""
...
class TemplateLinkedPolicyDefinition(TypedDict, closed=True):
    policy_template_id: (
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: TemplateLinkedPolicyDefinition) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> TemplateLinkedPolicyDefinition:
    out: TemplateLinkedPolicyDefinition = {}  # type: ignore[typeddict-item]
    if data.get("policyTemplateId") is not None:
        out["policy_template_id"] = data["policyTemplateId"]
    else:
        raise DeserializationError(
            "TemplateLinkedPolicyDefinition.policy_template_id required"
        )
