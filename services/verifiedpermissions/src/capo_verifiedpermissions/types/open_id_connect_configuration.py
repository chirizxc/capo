...
if TYPE_CHECKING:
    ...
    import capo_verifiedpermissions.types.open_id_connect_group_configuration
    import capo_verifiedpermissions.types.open_id_connect_token_selection
...
class OpenIdConnectConfiguration(TypedDict, closed=True):
    ...
    group_configuration: NotRequired[
        "capo_verifiedpermissions.types.open_id_connect_group_configuration.OpenIdConnectGroupConfiguration"
    ]
    ...
    token_selection: "capo_verifiedpermissions.types.open_id_connect_token_selection.OpenIdConnectTokenSelection"
...
def serialize_aws_json_1_0(value: OpenIdConnectConfiguration) -> dict:
    ...
    if "group_configuration" in value:
        ...
        out["groupConfiguration"] = (
            capo_verifiedpermissions.types.open_id_connect_group_configuration.serialize_aws_json_1_0(
    ...
    out["tokenSelection"] = (
        capo_verifiedpermissions.types.open_id_connect_token_selection.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> OpenIdConnectConfiguration:
    ...
    if data.get("groupConfiguration") is not None:
        ...
        out["group_configuration"] = (
            capo_verifiedpermissions.types.open_id_connect_group_configuration.deserialize_aws_json_1_0(
    ...
    if data.get("tokenSelection") is not None:
        ...
        out["token_selection"] = (
            capo_verifiedpermissions.types.open_id_connect_token_selection.deserialize_aws_json_1_0(
                data["tokenSelection"]
            )
        )
    else:
