"""Generated from Smithy shape ``com.amazonaws.verifiedpermissions#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.verifiedpermissions#InternalServerException``."""
