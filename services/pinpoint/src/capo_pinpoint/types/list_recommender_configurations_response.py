...
if TYPE_CHECKING:
    ...
    import capo_pinpoint.types.list_of_recommender_configuration_response


class ListRecommenderConfigurationsResponse(TypedDict, closed=True):
    item: NotRequired[
        "capo_pinpoint.types.list_of_recommender_configuration_response.ListOfRecommenderConfigurationResponse"
    ]
...
def serialize_json(value: ListRecommenderConfigurationsResponse) -> dict:
    ...
    if "item" in value:
        ...
        out["Item"] = (
            capo_pinpoint.types.list_of_recommender_configuration_response.serialize_json(
                value["item"]
            )
        )
...
def deserialize_json(data: dict) -> ListRecommenderConfigurationsResponse:
    ...
    if data.get("Item") is not None:
        ...
        out["item"] = (
            capo_pinpoint.types.list_of_recommender_configuration_response.deserialize_json(
                data["Item"]
            )
        )
