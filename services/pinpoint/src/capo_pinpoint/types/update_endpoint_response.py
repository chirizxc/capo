"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateEndpointResponse``."""
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateEndpointResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateEndpointResponse:
