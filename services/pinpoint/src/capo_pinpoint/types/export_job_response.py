...
if TYPE_CHECKING:
    ...
    import capo_pinpoint.types.export_job_resource
...
class ExportJobResponse(TypedDict, closed=True):
    ...
    definition: NotRequired["capo_pinpoint.types.export_job_resource.ExportJobResource"]
...
def serialize_json(value: ExportJobResponse) -> dict:
    ...
    if "definition" in value:
        ...
        out["Definition"] = capo_pinpoint.types.export_job_resource.serialize_json(
            value["definition"]
        )
...
def deserialize_json(data: dict) -> ExportJobResponse:
    ...
    if data.get("Definition") is not None:
        ...
        out["definition"] = capo_pinpoint.types.export_job_resource.deserialize_json(
            data["Definition"]
        )
