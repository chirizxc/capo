...
class Session(TypedDict, closed=True):
    duration: NotRequired["capo_pinpoint.types.__integer.__integer"]
    """<p>The duration of the session, in milliseconds.</p>"""
    id: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The unique identifier for the session.</p>"""
    start_timestamp: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The date and time when the session began.</p>"""
    stop_timestamp: NotRequired["capo_pinpoint.types.__string.__string"]
