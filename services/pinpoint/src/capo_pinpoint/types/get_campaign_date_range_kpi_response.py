...
class GetCampaignDateRangeKpiResponse(TypedDict, closed=True):
    campaign_date_range_kpi_response: NotRequired[
        "capo_pinpoint.types.campaign_date_range_kpi_response.CampaignDateRangeKpiResponse"
    ]
...
def serialize_json(value: GetCampaignDateRangeKpiResponse) -> dict:
    ...
    if "campaign_date_range_kpi_response" in value:
        ...
        out["CampaignDateRangeKpiResponse"] = (
            capo_pinpoint.types.campaign_date_range_kpi_response.serialize_json(
...
def deserialize_json(data: dict) -> GetCampaignDateRangeKpiResponse:
    ...
    if data.get("CampaignDateRangeKpiResponse") is not None:
        import capo_pinpoint.types.campaign_date_range_kpi_response

        out["campaign_date_range_kpi_response"] = (
            capo_pinpoint.types.campaign_date_range_kpi_response.deserialize_json(
