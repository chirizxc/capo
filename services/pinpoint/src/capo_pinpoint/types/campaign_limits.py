...
class CampaignLimits(TypedDict, closed=True):
    daily: NotRequired["capo_pinpoint.types.__integer.__integer"]
    ...
    maximum_duration: NotRequired["capo_pinpoint.types.__integer.__integer"]
    ...
    total: NotRequired["capo_pinpoint.types.__integer.__integer"]
    ...
    session: NotRequired["capo_pinpoint.types.__integer.__integer"]
