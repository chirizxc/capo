...
class Event(TypedDict, closed=True):
    app_package_name: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The package name of the app that's recording the event.</p>"""
    app_title: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The title of the app that's recording the event.</p>"""
    app_version_code: NotRequired["capo_pinpoint.types.__string.__string"]
    ...
    client_sdk_version: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The version of the SDK that's running on the client device.</p>"""
    event_type: NotRequired["capo_pinpoint.types.__string.__string"]
    ...
    sdk_name: NotRequired["capo_pinpoint.types.__string.__string"]
    """<p>The name of the SDK that's being used to record the event.</p>"""
    session: NotRequired["capo_pinpoint.types.session.Session"]
    """<p>Information about the session in which the event occurred.</p>"""
    timestamp: NotRequired["capo_pinpoint.types.__string.__string"]
...
def serialize_json(value: Event) -> dict:
    ...
    if "session" in value:
        ...
        out["Session"] = capo_pinpoint.types.session.serialize_json(value["session"])
