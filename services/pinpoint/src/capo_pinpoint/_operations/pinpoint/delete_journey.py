"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteJourney``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_journey_response.DeleteJourneyResponse = {
...
def delete_journey(
    ...
    capo_pinpoint.types.delete_journey_response.DeleteJourneyResponse, zapros.Response
]:
...
async def async_delete_journey(
