"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteInAppTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_in_app_template_response.DeleteInAppTemplateResponse = {
...
async def async_delete_in_app_template(
