"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateGcmChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.update_gcm_channel_response.UpdateGcmChannelResponse = {
...
async def async_update_gcm_channel(
