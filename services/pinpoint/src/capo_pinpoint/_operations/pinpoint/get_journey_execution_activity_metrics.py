...
def handle_response(
    ...
    out: capo_pinpoint.types.get_journey_execution_activity_metrics_response.GetJourneyExecutionActivityMetricsResponse = {
        "journey_execution_activity_metrics_response": capo_pinpoint.types.journey_execution_activity_metrics_response.deserialize_json(
