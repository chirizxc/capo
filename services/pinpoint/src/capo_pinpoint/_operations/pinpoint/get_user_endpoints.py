"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetUserEndpoints``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_user_endpoints_response.GetUserEndpointsResponse = {
        "endpoints_response": capo_pinpoint.types.endpoints_response.deserialize_json(
...
async def async_get_user_endpoints(
