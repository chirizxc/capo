"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetVoiceChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_voice_channel_response.GetVoiceChannelResponse = {
...
async def async_get_voice_channel(
