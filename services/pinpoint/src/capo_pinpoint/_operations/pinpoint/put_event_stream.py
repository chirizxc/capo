"""Generated from Smithy shape ``com.amazonaws.pinpoint#PutEventStream``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.put_event_stream_response.PutEventStreamResponse = {
...
def build_request(
    ...
    if "write_event_stream" in input_:
        body: bytes | None = json.dumps(
            capo_pinpoint.types.write_event_stream.serialize_json(
                input_["write_event_stream"]
            ),
            allow_nan=False,
        ).encode()
...
async def async_put_event_stream(
