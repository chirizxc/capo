...
def handle_response(
    ...
    out: capo_pinpoint.types.get_journey_date_range_kpi_response.GetJourneyDateRangeKpiResponse = {
        "journey_date_range_kpi_response": capo_pinpoint.types.journey_date_range_kpi_response.deserialize_json(
...
def build_request(
    ...
    import capo_pinpoint._protocol.serialize
    ...
    url = url.replace("{KpiName}", quote(input_["kpi_name"], safe=""))
    params: list[tuple[str, str]] = []
    if "end_time" in input_:
        params.append(
            (
                "end-time",
                capo_pinpoint._protocol.serialize.fmt_date_time(input_["end_time"]),
            )
        )
    ...
    if "start_time" in input_:
        params.append(
            (
                "start-time",
                capo_pinpoint._protocol.serialize.fmt_date_time(input_["start_time"]),
            )
        )
