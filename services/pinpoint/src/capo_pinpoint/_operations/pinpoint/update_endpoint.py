...
def handle_response(
    ...
    out: capo_pinpoint.types.update_endpoint_response.UpdateEndpointResponse = {
...
def build_request(
    ...
    if "endpoint_request" in input_:
        body: bytes | None = json.dumps(
            capo_pinpoint.types.endpoint_request.serialize_json(
...
def update_endpoint(
    ...
    capo_pinpoint.types.update_endpoint_response.UpdateEndpointResponse, zapros.Response
]:
