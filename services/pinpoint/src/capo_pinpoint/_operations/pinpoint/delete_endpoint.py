"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteEndpoint``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_endpoint_response.DeleteEndpointResponse = {
        "endpoint_response": capo_pinpoint.types.endpoint_response.deserialize_json(
...
def delete_endpoint(
    ...
    capo_pinpoint.types.delete_endpoint_response.DeleteEndpointResponse, zapros.Response
]:
