...
def handle_response(
    ...
    out: capo_pinpoint.types.create_segment_response.CreateSegmentResponse = {
...
def create_segment(
    ...
    capo_pinpoint.types.create_segment_response.CreateSegmentResponse, zapros.Response
]:
