"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetRecommenderConfiguration``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_recommender_configuration_response.GetRecommenderConfigurationResponse = {
...
def build_request(
    ...
    url = url.replace("{RecommenderId}", quote(input_["recommender_id"], safe=""))
...
async def async_get_recommender_configuration(
