...
def handle_response(
    ...
    out: capo_pinpoint.types.get_journey_run_execution_metrics_response.GetJourneyRunExecutionMetricsResponse = {
        "journey_run_execution_metrics_response": capo_pinpoint.types.journey_run_execution_metrics_response.deserialize_json(
