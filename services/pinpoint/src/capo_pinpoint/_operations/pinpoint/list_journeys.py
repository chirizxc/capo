...
def handle_response(
    ...
    out: capo_pinpoint.types.list_journeys_response.ListJourneysResponse = {
        "journeys_response": capo_pinpoint.types.journeys_response.deserialize_json(
...
def list_journeys(
    ...
    capo_pinpoint.types.list_journeys_response.ListJourneysResponse, zapros.Response
]:
