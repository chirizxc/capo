"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeletePushTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_push_template_response.DeletePushTemplateResponse = {
...
async def async_delete_push_template(
