"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetApnsSandboxChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_apns_sandbox_channel_response.GetApnsSandboxChannelResponse = {
...
async def async_get_apns_sandbox_channel(
