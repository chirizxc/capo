"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateVoiceTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.create_voice_template_response.CreateVoiceTemplateResponse = {
...
async def async_create_voice_template(
