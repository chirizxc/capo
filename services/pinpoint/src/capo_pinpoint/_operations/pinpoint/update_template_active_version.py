...
def handle_response(
    ...
    out: capo_pinpoint.types.update_template_active_version_response.UpdateTemplateActiveVersionResponse = {
...
def build_request(
    ...
    url = url.replace("{TemplateType}", quote(input_["template_type"], safe=""))
