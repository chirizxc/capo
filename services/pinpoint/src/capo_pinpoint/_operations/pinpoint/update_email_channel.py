"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateEmailChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.update_email_channel_response.UpdateEmailChannelResponse = {
...
def build_request(
    ...
    if "email_channel_request" in input_:
        body: bytes | None = json.dumps(
            capo_pinpoint.types.email_channel_request.serialize_json(
                input_["email_channel_request"]
            ),
            allow_nan=False,
        ).encode()
...
async def async_update_email_channel(
