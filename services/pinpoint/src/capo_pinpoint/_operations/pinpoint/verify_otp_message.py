"""Generated from Smithy shape ``com.amazonaws.pinpoint#VerifyOTPMessage``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.verify_otp_message_response.VerifyOTPMessageResponse = {
        "verification_response": capo_pinpoint.types.verification_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/verify-otp"
...
async def async_verify_otp_message(
