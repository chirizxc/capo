"""Generated from Smithy shape ``com.amazonaws.pinpoint#DeleteEmailChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.delete_email_channel_response.DeleteEmailChannelResponse = {
...
async def async_delete_email_channel(
