"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetSegments``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_segments_response.GetSegmentsResponse = {
...
def get_segments(
    ...
    capo_pinpoint.types.get_segments_response.GetSegmentsResponse, zapros.Response
]:
