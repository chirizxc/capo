"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetPushTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_push_template_response.GetPushTemplateResponse = {
        "push_notification_template_response": capo_pinpoint.types.push_notification_template_response.deserialize_json(
...
def build_request(
    ...
    if "version" in input_:
        params.append(("version", input_["version"]))
...
async def async_get_push_template(
