"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetImportJob``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_import_job_response.GetImportJobResponse = {
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/apps/{ApplicationId}/jobs/import/{JobId}"
...
def get_import_job(
    ...
    capo_pinpoint.types.get_import_job_response.GetImportJobResponse, zapros.Response
]:
