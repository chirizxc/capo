...
def handle_response(
    ...
    out: capo_pinpoint.types.remove_attributes_response.RemoveAttributesResponse = {
        "attributes_resource": capo_pinpoint.types.attributes_resource.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{AttributeType}", quote(input_["attribute_type"], safe=""))
