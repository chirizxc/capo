"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateApnsVoipChannel``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.update_apns_voip_channel_response.UpdateApnsVoipChannelResponse = {
...
def build_request(
    ...
    if "apns_voip_channel_request" in input_:
        body: bytes | None = json.dumps(
            capo_pinpoint.types.apns_voip_channel_request.serialize_json(
                input_["apns_voip_channel_request"]
            ),
            allow_nan=False,
        ).encode()
...
async def async_update_apns_voip_channel(
