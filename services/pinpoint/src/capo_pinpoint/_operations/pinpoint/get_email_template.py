"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetEmailTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_email_template_response.GetEmailTemplateResponse = {
        "email_template_response": capo_pinpoint.types.email_template_response.deserialize_json(
