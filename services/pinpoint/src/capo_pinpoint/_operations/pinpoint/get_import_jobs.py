"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetImportJobs``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_import_jobs_response.GetImportJobsResponse = {
...
def build_request(
    ...
    if "token" in input_:
        params.append(("token", input_["token"]))
...
def get_import_jobs(
    ...
    capo_pinpoint.types.get_import_jobs_response.GetImportJobsResponse, zapros.Response
]:
...
async def async_get_import_jobs(
