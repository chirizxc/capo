"""Generated from Smithy shape ``com.amazonaws.pinpoint#CreateRecommenderConfiguration``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.create_recommender_configuration_response.CreateRecommenderConfigurationResponse = {
...
def build_request(
    ...
    if "create_recommender_configuration" in input_:
...
async def async_create_recommender_configuration(
