"""Generated from Smithy shape ``com.amazonaws.pinpoint#GetEndpoint``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.get_endpoint_response.GetEndpointResponse = {
...
def get_endpoint(
    ...
    capo_pinpoint.types.get_endpoint_response.GetEndpointResponse, zapros.Response
]:
