...
def handle_response(
    ...
    out: capo_pinpoint.types.get_segment_version_response.GetSegmentVersionResponse = {
...
def build_request(
    ...
    url = url.replace("{SegmentId}", quote(input_["segment_id"], safe=""))
    url = url.replace("{Version}", quote(input_["version"], safe=""))
