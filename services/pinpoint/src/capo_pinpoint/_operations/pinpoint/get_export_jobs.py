...
def handle_response(
    ...
    out: capo_pinpoint.types.get_export_jobs_response.GetExportJobsResponse = {
...
def get_export_jobs(
    ...
    capo_pinpoint.types.get_export_jobs_response.GetExportJobsResponse, zapros.Response
]:
