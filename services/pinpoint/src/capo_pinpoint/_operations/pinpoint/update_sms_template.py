"""Generated from Smithy shape ``com.amazonaws.pinpoint#UpdateSmsTemplate``."""
...
def handle_response(
    ...
    out: capo_pinpoint.types.update_sms_template_response.UpdateSmsTemplateResponse = {
...
def build_request(
    ...
    if "create_new_version" in input_:
        params.append(
            ("create-new-version", "true" if input_["create_new_version"] else "false")
        )
...
async def async_update_sms_template(
