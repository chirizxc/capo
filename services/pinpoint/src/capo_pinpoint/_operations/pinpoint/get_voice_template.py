...
def handle_response(
    ...
    out: capo_pinpoint.types.get_voice_template_response.GetVoiceTemplateResponse = {
        "voice_template_response": capo_pinpoint.types.voice_template_response.deserialize_json(
