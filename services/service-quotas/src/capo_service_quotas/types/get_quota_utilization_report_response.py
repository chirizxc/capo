...
if TYPE_CHECKING:
    ...
    import capo_service_quotas.types.report_error_code
    import capo_service_quotas.types.report_error_message
    import capo_service_quotas.types.report_id
    import capo_service_quotas.types.report_status
    import capo_service_quotas.types.total_count
...
class GetQuotaUtilizationReportResponse(TypedDict, closed=True):
    ...
    generated_at: NotRequired["capo_service_quotas.types.date_time.DateTime"]
    """<p>The timestamp when the report was generated, in ISO 8601 format.</p>"""
    total_count: NotRequired["capo_service_quotas.types.total_count.TotalCount"]
    """<p>The total number of quotas included in the report across all pages.</p>"""
    quotas: NotRequired[
        "capo_service_quotas.types.quota_utilization_info_list.QuotaUtilizationInfoList"
    ]
    ...
    error_code: NotRequired[
        "capo_service_quotas.types.report_error_code.ReportErrorCode"
    ]
    ...
    error_message: NotRequired[
        "capo_service_quotas.types.report_error_message.ReportErrorMessage"
    ]
...
def serialize_aws_json_1_1(value: GetQuotaUtilizationReportResponse) -> dict:
    ...
    if "generated_at" in value:
        ...
        out["GeneratedAt"] = capo_service_quotas.types.date_time.serialize_aws_json_1_1(
            value["generated_at"]
        )
    ...
    if "quotas" in value:
        ...
        out["Quotas"] = (
            capo_service_quotas.types.quota_utilization_info_list.serialize_aws_json_1_1(
                value["quotas"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> GetQuotaUtilizationReportResponse:
    ...
    if data.get("Quotas") is not None:
        ...
        out["quotas"] = (
            capo_service_quotas.types.quota_utilization_info_list.deserialize_aws_json_1_1(
                data["Quotas"]
            )
        )
