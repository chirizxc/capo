...
if TYPE_CHECKING:
    ...
    import capo_service_quotas.types.quota_description
...
class ServiceQuota(TypedDict, closed=True):
    ...
    value: NotRequired["capo_service_quotas.types.quota_value.QuotaValue"]
    """<p>The quota value.</p>"""
    ...
    usage_metric: NotRequired["capo_service_quotas.types.metric_info.MetricInfo"]
    """<p>Information about the measurement.</p>"""
    period: NotRequired["capo_service_quotas.types.quota_period.QuotaPeriod"]
    """<p>The period of time.</p>"""
    error_reason: NotRequired["capo_service_quotas.types.error_reason.ErrorReason"]
    ...
    description: NotRequired[
        "capo_service_quotas.types.quota_description.QuotaDescription"
    ]
...
def serialize_aws_json_1_1(value: ServiceQuota) -> dict:
    ...
    if "usage_metric" in value:
        ...
        out["UsageMetric"] = (
            capo_service_quotas.types.metric_info.serialize_aws_json_1_1(
                value["usage_metric"]
            )
        )
    if "period" in value:
        ...
        out["Period"] = capo_service_quotas.types.quota_period.serialize_aws_json_1_1(
            value["period"]
        )
    if "error_reason" in value:
        ...
        out["ErrorReason"] = (
            capo_service_quotas.types.error_reason.serialize_aws_json_1_1(
                value["error_reason"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ServiceQuota:
    ...
    if data.get("UsageMetric") is not None:
        ...
        out["usage_metric"] = (
            capo_service_quotas.types.metric_info.deserialize_aws_json_1_1(
                data["UsageMetric"]
            )
        )
    ...
    if data.get("ErrorReason") is not None:
        ...
        out["error_reason"] = (
            capo_service_quotas.types.error_reason.deserialize_aws_json_1_1(
                data["ErrorReason"]
            )
        )
