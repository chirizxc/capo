...
if TYPE_CHECKING:
    ...
    import capo_service_quotas.types.error_message


class ErrorReason(TypedDict, closed=True):
    error_code: NotRequired["capo_service_quotas.types.error_code.ErrorCode"]
    ...
    error_message: NotRequired["capo_service_quotas.types.error_message.ErrorMessage"]
...
def serialize_aws_json_1_1(value: ErrorReason) -> dict:
    ...
    if "error_code" in value:
        ...
        out["ErrorCode"] = capo_service_quotas.types.error_code.serialize_aws_json_1_1(
            value["error_code"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ErrorReason:
    ...
    if data.get("ErrorCode") is not None:
        ...
        out["error_code"] = (
            capo_service_quotas.types.error_code.deserialize_aws_json_1_1(
                data["ErrorCode"]
            )
        )
