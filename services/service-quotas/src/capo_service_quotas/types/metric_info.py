...
if TYPE_CHECKING:
    ...
    import capo_service_quotas.types.quota_metric_name
    import capo_service_quotas.types.quota_metric_namespace
    import capo_service_quotas.types.statistic
...
class MetricInfo(TypedDict, closed=True):
    ...
    metric_name: NotRequired[
        "capo_service_quotas.types.quota_metric_name.QuotaMetricName"
    ]
    """<p>The name of the metric.</p>"""
    metric_dimensions: NotRequired[
        "capo_service_quotas.types.metric_dimensions_map_definition.MetricDimensionsMapDefinition"
    ]
    ...
    metric_statistic_recommendation: NotRequired[
        "capo_service_quotas.types.statistic.Statistic"
    ]
...
def serialize_aws_json_1_1(value: MetricInfo) -> dict:
    ...
    if "metric_dimensions" in value:
        ...
        out["MetricDimensions"] = (
            capo_service_quotas.types.metric_dimensions_map_definition.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MetricInfo:
    ...
    if data.get("MetricDimensions") is not None:
        ...
        out["metric_dimensions"] = (
            capo_service_quotas.types.metric_dimensions_map_definition.deserialize_aws_json_1_1(
