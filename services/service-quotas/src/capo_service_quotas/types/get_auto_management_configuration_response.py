...
class GetAutoManagementConfigurationResponse(TypedDict, closed=True):
    opt_in_level: NotRequired["capo_service_quotas.types.opt_in_level.OptInLevel"]
    ...
    exclusion_list: NotRequired[
        "capo_service_quotas.types.exclusion_quota_list.ExclusionQuotaList"
    ]
...
def serialize_aws_json_1_1(value: GetAutoManagementConfigurationResponse) -> dict:
    ...
    if "opt_in_level" in value:
        ...
        out["OptInLevel"] = (
            capo_service_quotas.types.opt_in_level.serialize_aws_json_1_1(
                value["opt_in_level"]
            )
        )
    ...
    if "opt_in_status" in value:
        ...
        out["OptInStatus"] = (
            capo_service_quotas.types.opt_in_status.serialize_aws_json_1_1(
                value["opt_in_status"]
            )
        )
    if "exclusion_list" in value:
        ...
        out["ExclusionList"] = (
            capo_service_quotas.types.exclusion_quota_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetAutoManagementConfigurationResponse:
    ...
    if data.get("OptInStatus") is not None:
        ...
        out["opt_in_status"] = (
            capo_service_quotas.types.opt_in_status.deserialize_aws_json_1_1(
                data["OptInStatus"]
            )
        )
    if data.get("ExclusionList") is not None:
        ...
        out["exclusion_list"] = (
            capo_service_quotas.types.exclusion_quota_list.deserialize_aws_json_1_1(
                data["ExclusionList"]
            )
        )
    return out
