...
if TYPE_CHECKING:
    import capo_iam.types.policy_evaluation_error_message


class PolicyEvaluationException_(TypedDict, closed=True):
    message: NotRequired[
        "capo_iam.types.policy_evaluation_error_message.policyEvaluationErrorMessage"
    ]
