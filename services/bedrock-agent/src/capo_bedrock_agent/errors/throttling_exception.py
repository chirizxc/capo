"""Generated from Smithy shape ``com.amazonaws.bedrockagent#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockagent#ThrottlingException``."""
