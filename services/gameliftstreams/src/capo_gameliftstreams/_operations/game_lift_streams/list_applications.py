"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#ListApplications``."""
...
def handle_response(
    ...
    out: capo_gameliftstreams.types.list_applications_output.ListApplicationsOutput = (
        capo_gameliftstreams.types.list_applications_output.deserialize_json(
