"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_gameliftstreams.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_gameliftstreams.types.list_tags_for_resource_response.deserialize_json(
