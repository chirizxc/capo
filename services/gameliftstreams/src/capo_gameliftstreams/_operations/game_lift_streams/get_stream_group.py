"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#GetStreamGroup``."""
...
def handle_response(
    ...
    out: capo_gameliftstreams.types.get_stream_group_output.GetStreamGroupOutput = (
        capo_gameliftstreams.types.get_stream_group_output.deserialize_json(
...
async def async_get_stream_group(
