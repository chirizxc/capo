...
def handle_response(
    ...
    out: capo_gameliftstreams.types.update_application_output.UpdateApplicationOutput = capo_gameliftstreams.types.update_application_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_gameliftstreams.types.update_application_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
