"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#UpdateStreamGroupOutput``."""
...
class UpdateStreamGroupOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateStreamGroupOutput) -> dict:
    out: dict = {}
    out["Arn"] = value["arn"]
...
def deserialize_json(data: dict) -> UpdateStreamGroupOutput:
    out: UpdateStreamGroupOutput = {}  # type: ignore[typeddict-item]
    if data.get("Arn") is not None:
        out["arn"] = data["Arn"]
    else:
        raise DeserializationError("UpdateStreamGroupOutput.arn required")
