"""Generated from Smithy shape ``com.amazonaws.gameliftstreams#StartStreamSessionOutput``."""
...
class StartStreamSessionOutput(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: StartStreamSessionOutput) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
