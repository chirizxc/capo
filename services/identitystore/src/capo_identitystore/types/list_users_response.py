...
class ListUsersResponse(TypedDict, closed=True):
    users: "capo_identitystore.types.users.Users"
...
def serialize_aws_json_1_1(value: ListUsersResponse) -> dict:
    ...
    out["Users"] = capo_identitystore.types.users.serialize_aws_json_1_1(value["users"])
...
def deserialize_aws_json_1_1(data: dict) -> ListUsersResponse:
    ...
    if data.get("Users") is not None:
        ...
        out["users"] = capo_identitystore.types.users.deserialize_aws_json_1_1(
            data["Users"]
        )
    else:
