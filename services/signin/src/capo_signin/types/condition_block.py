...
if TYPE_CHECKING:
    ...
    import capo_signin.types.condition_type

ConditionBlock: TypeAlias = dict[
    "capo_signin.types.condition_type.ConditionType",
    "capo_signin.types.condition.Condition",
]
...
def serialize_json(input_to_serialize: ConditionBlock) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = capo_signin.types.condition.serialize_json(value)
    return out
