"""Generated from Smithy shape ``com.amazonaws.migrationhub#InternalServerError``."""
...
class InternalServerError(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.migrationhub#InternalServerError``."""
