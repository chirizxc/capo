"""Generated from Smithy shape ``com.amazonaws.migrationhub#CreateProgressUpdateStream``."""
...
def handle_response(
    ...
    out: capo_migration_hub.types.create_progress_update_stream_result.CreateProgressUpdateStreamResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.create_progress_update_stream_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_progress_update_stream(
