...
def handle_response(
    ...
    out: capo_migration_hub.types.list_source_resources_result.ListSourceResourcesResult = capo_migration_hub.types.list_source_resources_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.list_source_resources_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
