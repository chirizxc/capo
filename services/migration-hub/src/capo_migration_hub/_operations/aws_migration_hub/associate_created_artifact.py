"""Generated from Smithy shape ``com.amazonaws.migrationhub#AssociateCreatedArtifact``."""
...
def handle_response(
    ...
    out: capo_migration_hub.types.associate_created_artifact_result.AssociateCreatedArtifactResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.associate_created_artifact_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_associate_created_artifact(
