...
def handle_response(
    ...
    out: capo_migration_hub.types.put_resource_attributes_result.PutResourceAttributesResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_migration_hub.types.put_resource_attributes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
