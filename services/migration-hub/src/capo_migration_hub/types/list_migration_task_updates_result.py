...
class ListMigrationTaskUpdatesResult(TypedDict, closed=True):
    ...
    migration_task_update_list: NotRequired[
        "capo_migration_hub.types.migration_task_update_list.MigrationTaskUpdateList"
    ]
...
def serialize_aws_json_1_1(value: ListMigrationTaskUpdatesResult) -> dict:
    ...
    if "migration_task_update_list" in value:
        ...
        out["MigrationTaskUpdateList"] = (
            capo_migration_hub.types.migration_task_update_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListMigrationTaskUpdatesResult:
    ...
    if data.get("MigrationTaskUpdateList") is not None:
        ...
        out["migration_task_update_list"] = (
            capo_migration_hub.types.migration_task_update_list.deserialize_aws_json_1_1(
