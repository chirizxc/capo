...
class ListApplicationStatesResult(TypedDict, closed=True):
    application_state_list: NotRequired[
        "capo_migration_hub.types.application_state_list.ApplicationStateList"
    ]
...
def serialize_aws_json_1_1(value: ListApplicationStatesResult) -> dict:
    ...
    if "application_state_list" in value:
        ...
        out["ApplicationStateList"] = (
            capo_migration_hub.types.application_state_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListApplicationStatesResult:
    ...
    if data.get("ApplicationStateList") is not None:
        import capo_migration_hub.types.application_state_list

        out["application_state_list"] = (
            capo_migration_hub.types.application_state_list.deserialize_aws_json_1_1(
