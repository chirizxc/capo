...
class DescribeAccountLimitsResult(TypedDict, closed=True):
    account_limits: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.account_limit_list.AccountLimitList"
    ]
...
def serialize_aws_json_1_0(value: DescribeAccountLimitsResult) -> dict:
    ...
    if "account_limits" in value:
        ...
        out["AccountLimits"] = (
            capo_pinpoint_sms_voice_v2.types.account_limit_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeAccountLimitsResult:
    ...
    if data.get("AccountLimits") is not None:
        ...
        out["account_limits"] = (
            capo_pinpoint_sms_voice_v2.types.account_limit_list.deserialize_aws_json_1_0(
                data["AccountLimits"]
            )
        )
