...
class DescribeRcsAgentsResult(TypedDict, closed=True):
    rcs_agents: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.rcs_agent_information_list.RcsAgentInformationList"
    ]
...
def serialize_aws_json_1_0(value: DescribeRcsAgentsResult) -> dict:
    ...
    if "rcs_agents" in value:
        ...
        out["RcsAgents"] = (
            capo_pinpoint_sms_voice_v2.types.rcs_agent_information_list.serialize_aws_json_1_0(
                value["rcs_agents"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeRcsAgentsResult:
    ...
    if data.get("RcsAgents") is not None:
        import capo_pinpoint_sms_voice_v2.types.rcs_agent_information_list

        out["rcs_agents"] = (
            capo_pinpoint_sms_voice_v2.types.rcs_agent_information_list.deserialize_aws_json_1_0(
                data["RcsAgents"]
            )
        )
