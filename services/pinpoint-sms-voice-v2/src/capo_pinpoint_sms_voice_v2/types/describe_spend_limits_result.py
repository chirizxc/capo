...
class DescribeSpendLimitsResult(TypedDict, closed=True):
    spend_limits: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.spend_limit_list.SpendLimitList"
    ]
...
def serialize_aws_json_1_0(value: DescribeSpendLimitsResult) -> dict:
    ...
    if "spend_limits" in value:
        ...
        out["SpendLimits"] = (
            capo_pinpoint_sms_voice_v2.types.spend_limit_list.serialize_aws_json_1_0(
                value["spend_limits"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeSpendLimitsResult:
    ...
    if data.get("SpendLimits") is not None:
        ...
        out["spend_limits"] = (
            capo_pinpoint_sms_voice_v2.types.spend_limit_list.deserialize_aws_json_1_0(
                data["SpendLimits"]
            )
        )
