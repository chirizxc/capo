...
class DescribeRegistrationSectionDefinitionsResult(TypedDict, closed=True):
    ...
    registration_section_definitions: "capo_pinpoint_sms_voice_v2.types.registration_section_definition_list.RegistrationSectionDefinitionList"
...
def serialize_aws_json_1_0(value: DescribeRegistrationSectionDefinitionsResult) -> dict:
    ...
    out["RegistrationSectionDefinitions"] = (
        capo_pinpoint_sms_voice_v2.types.registration_section_definition_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(
    ...
    if data.get("RegistrationSectionDefinitions") is not None:
        import capo_pinpoint_sms_voice_v2.types.registration_section_definition_list

        out["registration_section_definitions"] = (
            capo_pinpoint_sms_voice_v2.types.registration_section_definition_list.deserialize_aws_json_1_0(
