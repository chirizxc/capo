...
class DescribeKeywordsResult(TypedDict, closed=True):
    ...
    keywords: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.keyword_information_list.KeywordInformationList"
    ]
...
def serialize_aws_json_1_0(value: DescribeKeywordsResult) -> dict:
    ...
    if "keywords" in value:
        ...
        out["Keywords"] = (
            capo_pinpoint_sms_voice_v2.types.keyword_information_list.serialize_aws_json_1_0(
                value["keywords"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> DescribeKeywordsResult:
    ...
    if data.get("Keywords") is not None:
        ...
        out["keywords"] = (
            capo_pinpoint_sms_voice_v2.types.keyword_information_list.deserialize_aws_json_1_0(
                data["Keywords"]
            )
        )
