...
if TYPE_CHECKING:
    ...
    import capo_pinpoint_sms_voice_v2.types.notify_template_filter_name


class NotifyTemplateFilter(TypedDict, closed=True):
    name: "capo_pinpoint_sms_voice_v2.types.notify_template_filter_name.NotifyTemplateFilterName"
