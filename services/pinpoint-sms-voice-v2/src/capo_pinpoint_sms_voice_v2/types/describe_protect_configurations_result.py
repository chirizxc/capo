...
class DescribeProtectConfigurationsResult(TypedDict, closed=True):
    protect_configurations: NotRequired[
        "capo_pinpoint_sms_voice_v2.types.protect_configuration_information_list.ProtectConfigurationInformationList"
    ]
...
def serialize_aws_json_1_0(value: DescribeProtectConfigurationsResult) -> dict:
    ...
    if "protect_configurations" in value:
        ...
        out["ProtectConfigurations"] = (
            capo_pinpoint_sms_voice_v2.types.protect_configuration_information_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DescribeProtectConfigurationsResult:
    ...
    if data.get("ProtectConfigurations") is not None:
        import capo_pinpoint_sms_voice_v2.types.protect_configuration_information_list

        out["protect_configurations"] = (
            capo_pinpoint_sms_voice_v2.types.protect_configuration_information_list.deserialize_aws_json_1_0(
