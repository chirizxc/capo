"""Generated from Smithy shape ``com.amazonaws.pinpointsmsvoicev2#DeleteDefaultSenderIdRequest``."""
...
class DeleteDefaultSenderIdRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DeleteDefaultSenderIdRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> DeleteDefaultSenderIdRequest:
    ...
    if data.get("ConfigurationSetName") is not None:
        ...
        raise DeserializationError(
            "DeleteDefaultSenderIdRequest.configuration_set_name required"
        )
    return out
