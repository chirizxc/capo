...
```
pip install capo-pinpoint-sms-voice-v2
```

## Usage

```python
from capo_pinpoint_sms_voice_v2 import AsyncPinpointSMSVoiceV2Client
...
```python
from capo_pinpoint_sms_voice_v2 import AsyncPinpointSMSVoiceV2Client
from capo_pinpoint_sms_voice_v2.error import AccessDeniedException
