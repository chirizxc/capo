"""Generated from Smithy shape ``com.amazonaws.georoutes#RouteEnterHighwayStepDetails``."""
...
class RouteEnterHighwayStepDetails(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: RouteEnterHighwayStepDetails) -> dict:
    out: dict = {}
    import capo_geo_routes.types.localized_string_list
...
def deserialize_json(data: dict) -> RouteEnterHighwayStepDetails:
    out: RouteEnterHighwayStepDetails = {}  # type: ignore[typeddict-item]
    if data.get("Intersection") is not None:
        ...
        raise DeserializationError("RouteEnterHighwayStepDetails.intersection required")
