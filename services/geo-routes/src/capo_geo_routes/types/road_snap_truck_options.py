...
class RoadSnapTruckOptions(TypedDict, closed=True):
    ...
    hazardous_cargos: NotRequired[
        "capo_geo_routes.types.road_snap_hazardous_cargo_type_list.RoadSnapHazardousCargoTypeList"
    ]
    ...
    trailer: NotRequired[
        "capo_geo_routes.types.road_snap_trailer_options.RoadSnapTrailerOptions"
    ]
...
def serialize_json(value: RoadSnapTruckOptions) -> dict:
    ...
    if "hazardous_cargos" in value:
        ...
        out["HazardousCargos"] = (
            capo_geo_routes.types.road_snap_hazardous_cargo_type_list.serialize_json(
    ...
    if "trailer" in value:
        ...
        out["Trailer"] = capo_geo_routes.types.road_snap_trailer_options.serialize_json(
            value["trailer"]
        )
...
def deserialize_json(data: dict) -> RoadSnapTruckOptions:
    ...
    if data.get("HazardousCargos") is not None:
        ...
        out["hazardous_cargos"] = (
            capo_geo_routes.types.road_snap_hazardous_cargo_type_list.deserialize_json(
    ...
    if data.get("Trailer") is not None:
        ...
        out["trailer"] = (
            capo_geo_routes.types.road_snap_trailer_options.deserialize_json(
                data["Trailer"]
            )
        )
