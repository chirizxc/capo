"""Generated from Smithy shape ``com.amazonaws.georoutes#RouteMatrixTruckOptions``."""
...
class RouteMatrixTruckOptions(TypedDict, closed=True):
    ...
    hazardous_cargos: NotRequired[
        "capo_geo_routes.types.route_matrix_hazardous_cargo_type_list.RouteMatrixHazardousCargoTypeList"
    ]
    ...
    trailer: NotRequired[
        "capo_geo_routes.types.route_matrix_trailer_options.RouteMatrixTrailerOptions"
    ]
    """<p>Trailer options corresponding to the vehicle.</p>"""
    truck_type: NotRequired[
        "capo_geo_routes.types.route_matrix_truck_type.RouteMatrixTruckType"
    ]
...
# --- restJson1 ser/de ---
def serialize_json(value: RouteMatrixTruckOptions) -> dict:
    out: dict = {}
    ...
    if "hazardous_cargos" in value:
        ...
        out["HazardousCargos"] = (
            capo_geo_routes.types.route_matrix_hazardous_cargo_type_list.serialize_json(
    ...
    if "trailer" in value:
        ...
        out["Trailer"] = (
            capo_geo_routes.types.route_matrix_trailer_options.serialize_json(
                value["trailer"]
            )
        )
    if "truck_type" in value:
        ...
        out["TruckType"] = capo_geo_routes.types.route_matrix_truck_type.serialize_json(
            value["truck_type"]
        )
...
def deserialize_json(data: dict) -> RouteMatrixTruckOptions:
    ...
    if data.get("HazardousCargos") is not None:
        ...
        out["hazardous_cargos"] = (
            capo_geo_routes.types.route_matrix_hazardous_cargo_type_list.deserialize_json(
    ...
    if data.get("Trailer") is not None:
        ...
        out["trailer"] = (
            capo_geo_routes.types.route_matrix_trailer_options.deserialize_json(
                data["Trailer"]
            )
        )
    if data.get("TruckType") is not None:
        ...
        out["truck_type"] = (
            capo_geo_routes.types.route_matrix_truck_type.deserialize_json(
                data["TruckType"]
            )
        )
