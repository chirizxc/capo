...
if TYPE_CHECKING:
    ...
    import capo_geo_routes.types.route_vehicle_mode_list
...
def serialize_json(value: RouteIntermodalVehicleOptions) -> dict:
    ...
    if "allowed_modes" in value:
        ...
        out["AllowedModes"] = (
            capo_geo_routes.types.route_vehicle_mode_list.serialize_json(
                value["allowed_modes"]
            )
        )
...
def deserialize_json(data: dict) -> RouteIntermodalVehicleOptions:
    ...
    if data.get("AllowedModes") is not None:
        ...
        out["allowed_modes"] = (
            capo_geo_routes.types.route_vehicle_mode_list.deserialize_json(
                data["AllowedModes"]
            )
        )
