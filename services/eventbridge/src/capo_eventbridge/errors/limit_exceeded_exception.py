"""Generated from Smithy shape ``com.amazonaws.eventbridge#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.eventbridge#LimitExceededException``."""
