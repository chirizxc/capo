"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeBudgetActionsForAccount``."""
...
def handle_response(
    ...
    out: capo_budgets.types.describe_budget_actions_for_account_response.DescribeBudgetActionsForAccountResponse = capo_budgets.types.describe_budget_actions_for_account_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.DescribeBudgetActionsForAccount"
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_budget_actions_for_account_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_budget_actions_for_account(
