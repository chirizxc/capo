...
def handle_response(
    ...
    out: capo_budgets.types.create_subscriber_response.CreateSubscriberResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.create_subscriber_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
