"""Generated from Smithy shape ``com.amazonaws.budgets#UpdateSubscriber``."""
...
def handle_response(
    ...
    out: capo_budgets.types.update_subscriber_response.UpdateSubscriberResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.update_subscriber_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
