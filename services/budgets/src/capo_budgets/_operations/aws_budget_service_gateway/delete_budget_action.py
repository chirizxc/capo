"""Generated from Smithy shape ``com.amazonaws.budgets#DeleteBudgetAction``."""
...
def handle_response(
    ...
    out: capo_budgets.types.delete_budget_action_response.DeleteBudgetActionResponse = (
        capo_budgets.types.delete_budget_action_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSBudgetServiceGateway.DeleteBudgetAction"
    body: bytes | None = json.dumps(
        capo_budgets.types.delete_budget_action_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_budget_action(
