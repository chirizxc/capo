...
def handle_response(
    ...
    out: capo_budgets.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_budgets.types.list_tags_for_resource_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.list_tags_for_resource_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
