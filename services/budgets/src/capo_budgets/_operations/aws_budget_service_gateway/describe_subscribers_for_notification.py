"""Generated from Smithy shape ``com.amazonaws.budgets#DescribeSubscribersForNotification``."""
...
def handle_response(
    ...
    out: capo_budgets.types.describe_subscribers_for_notification_response.DescribeSubscribersForNotificationResponse = capo_budgets.types.describe_subscribers_for_notification_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_budgets.types.describe_subscribers_for_notification_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_subscribers_for_notification(
