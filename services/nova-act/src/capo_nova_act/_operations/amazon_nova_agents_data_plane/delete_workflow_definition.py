...
def handle_response(
    ...
    out: capo_nova_act.types.delete_workflow_definition_response.DeleteWorkflowDefinitionResponse = capo_nova_act.types.delete_workflow_definition_response.deserialize_json(
