...
def handle_response(
    ...
    out: capo_nova_act.types.list_models_response.ListModelsResponse = (
        capo_nova_act.types.list_models_response.deserialize_json(
...
def build_request(
    ...
    if "client_compatibility_version" in input_:
        params.append(
            ("clientCompatibilityVersion", str(input_["client_compatibility_version"]))
        )
...
def list_models(
    ...
    capo_nova_act.types.list_models_response.ListModelsResponse, zapros.Response
]:
