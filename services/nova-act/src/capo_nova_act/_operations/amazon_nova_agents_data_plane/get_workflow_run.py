"""Generated from Smithy shape ``com.amazonaws.novaact#GetWorkflowRun``."""
...
def handle_response(
    ...
    out: capo_nova_act.types.get_workflow_run_response.GetWorkflowRunResponse = (
        capo_nova_act.types.get_workflow_run_response.deserialize_json(
