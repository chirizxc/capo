...
class TimeWindow(TypedDict, closed=True):
    start_time: "capo_waf.types.timestamp.Timestamp"
    ...
    end_time: "capo_waf.types.timestamp.Timestamp"
...
def serialize_aws_json_1_1(value: TimeWindow) -> dict:
    ...
    out["StartTime"] = capo_waf.types.timestamp.serialize_aws_json_1_1(
        value["start_time"]
    )
    import capo_waf.types.timestamp

    out["EndTime"] = capo_waf.types.timestamp.serialize_aws_json_1_1(value["end_time"])
    return out
