...
class RateBasedRule(TypedDict, closed=True):
    ...
    match_predicates: "capo_waf.types.predicates.Predicates"
...
def serialize_aws_json_1_1(value: RateBasedRule) -> dict:
    ...
    out["MatchPredicates"] = capo_waf.types.predicates.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RateBasedRule:
    ...
    if data.get("MatchPredicates") is not None:
        ...
        out["match_predicates"] = capo_waf.types.predicates.deserialize_aws_json_1_1(
