"""Generated from Smithy shape ``com.amazonaws.waf#UpdateRegexMatchSetRequest``."""
...
class UpdateRegexMatchSetRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: UpdateRegexMatchSetRequest) -> dict:
    ...
    out["Updates"] = capo_waf.types.regex_match_set_updates.serialize_aws_json_1_1(
        value["updates"]
    )
...
def deserialize_aws_json_1_1(data: dict) -> UpdateRegexMatchSetRequest:
    ...
    if data.get("Updates") is not None:
        ...
        out["updates"] = (
            capo_waf.types.regex_match_set_updates.deserialize_aws_json_1_1(
                data["Updates"]
            )
        )
    else:
