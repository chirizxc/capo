...
if TYPE_CHECKING:
    import capo_waf.types.geo_match_set_update

GeoMatchSetUpdates: TypeAlias = list[
    "capo_waf.types.geo_match_set_update.GeoMatchSetUpdate"
]
...
def serialize_aws_json_1_1(value: GeoMatchSetUpdates) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_waf.types.geo_match_set_update.serialize_aws_json_1_1(item))
    return out
