...
class LoggingConfiguration(TypedDict, closed=True):
    ...
    log_destination_configs: (
        "capo_waf.types.log_destination_configs.LogDestinationConfigs"
    )
    """<p>An array of Amazon Kinesis Data Firehose ARNs.</p>"""
    redacted_fields: NotRequired["capo_waf.types.redacted_fields.RedactedFields"]
...
def serialize_aws_json_1_1(value: LoggingConfiguration) -> dict:
    ...
    out["LogDestinationConfigs"] = (
        capo_waf.types.log_destination_configs.serialize_aws_json_1_1(
    ...
    if "redacted_fields" in value:
        ...
        out["RedactedFields"] = capo_waf.types.redacted_fields.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LoggingConfiguration:
    ...
    if data.get("LogDestinationConfigs") is not None:
        ...
        out["log_destination_configs"] = (
            capo_waf.types.log_destination_configs.deserialize_aws_json_1_1(
    ...
    if data.get("RedactedFields") is not None:
        ...
        out["redacted_fields"] = (
            capo_waf.types.redacted_fields.deserialize_aws_json_1_1(
                data["RedactedFields"]
            )
        )
    return out
