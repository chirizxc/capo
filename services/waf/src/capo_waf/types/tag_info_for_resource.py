...
class TagInfoForResource(TypedDict, closed=True):
    resource_arn: NotRequired["capo_waf.types.resource_arn.ResourceArn"]
    """<p></p>"""
    tag_list: NotRequired["capo_waf.types.tag_list.TagList"]
    """<p></p>"""
...
def serialize_aws_json_1_1(value: TagInfoForResource) -> dict:
    ...
    if "tag_list" in value:
        ...
        out["TagList"] = capo_waf.types.tag_list.serialize_aws_json_1_1(
            value["tag_list"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> TagInfoForResource:
    ...
    if data.get("TagList") is not None:
        ...
        out["tag_list"] = capo_waf.types.tag_list.deserialize_aws_json_1_1(
            data["TagList"]
        )
    return out
