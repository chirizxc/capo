...
class ListXssMatchSetsResponse(TypedDict, closed=True):
    ...
    xss_match_sets: NotRequired[
        "capo_waf.types.xss_match_set_summaries.XssMatchSetSummaries"
    ]
...
def serialize_aws_json_1_1(value: ListXssMatchSetsResponse) -> dict:
    ...
    if "xss_match_sets" in value:
        ...
        out["XssMatchSets"] = (
            capo_waf.types.xss_match_set_summaries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListXssMatchSetsResponse:
    ...
    if data.get("XssMatchSets") is not None:
        ...
        out["xss_match_sets"] = (
            capo_waf.types.xss_match_set_summaries.deserialize_aws_json_1_1(
                data["XssMatchSets"]
            )
        )
    return out
