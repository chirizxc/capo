...
if TYPE_CHECKING:
    import capo_waf.types.match_field_data
    import capo_waf.types.match_field_type


class FieldToMatch(TypedDict, closed=True):
    type: "capo_waf.types.match_field_type.MatchFieldType"
    ...
    data: NotRequired["capo_waf.types.match_field_data.MatchFieldData"]
...
def serialize_aws_json_1_1(value: FieldToMatch) -> dict:
    ...
    out["Type"] = capo_waf.types.match_field_type.serialize_aws_json_1_1(value["type"])
    if "data" in value:
        out["Data"] = value["data"]
    return out
...
def deserialize_aws_json_1_1(data: dict) -> FieldToMatch:
    ...
    if data.get("Type") is not None:
        ...
        out["type"] = capo_waf.types.match_field_type.deserialize_aws_json_1_1(
            data["Type"]
        )
    else:
