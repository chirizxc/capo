...
class ListRuleGroupsResponse(TypedDict, closed=True):
    ...
    rule_groups: NotRequired["capo_waf.types.rule_group_summaries.RuleGroupSummaries"]
...
def serialize_aws_json_1_1(value: ListRuleGroupsResponse) -> dict:
    ...
    if "rule_groups" in value:
        ...
        out["RuleGroups"] = capo_waf.types.rule_group_summaries.serialize_aws_json_1_1(
            value["rule_groups"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> ListRuleGroupsResponse:
    ...
    if data.get("RuleGroups") is not None:
        ...
        out["rule_groups"] = (
            capo_waf.types.rule_group_summaries.deserialize_aws_json_1_1(
                data["RuleGroups"]
            )
        )
    return out
