...
from capo_eks._services._aws_config import aaws_config
...
class AsyncEKSClientConfig(TypedDict, total=False, closed=True):
...
class AsyncEKSClient:
    ...
    def __init__(
        ...
        self._config = AsyncEKSClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncEKSClientConfig] = None
    ) -> tuple[Iterable[AsyncInterceptor[Any, Any]], AsyncOperationOptions]:
        overrides: AsyncEKSClientConfig = config_overrides or {}
    ...
    async def associate_access_policy(
        ...
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
    ) -> (
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.associate_access_policy_request.AssociateAccessPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.associate_access_policy_response.AssociateAccessPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.associate_access_policy.async_associate_access_policy(
    ...
    async def associate_encryption_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.associate_encryption_config_request.AssociateEncryptionConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.associate_encryption_config_response.AssociateEncryptionConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.associate_encryption_config.async_associate_encryption_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_identity_provider_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.associate_identity_provider_config_request.AssociateIdentityProviderConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.associate_identity_provider_config_response.AssociateIdentityProviderConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.associate_identity_provider_config.async_associate_identity_provider_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_access_entry(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.create_access_entry_request.CreateAccessEntryRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.create_access_entry_response.CreateAccessEntryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.create_access_entry.async_create_access_entry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_addon(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.create_addon_request.CreateAddonRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.create_addon_response.CreateAddonResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.create_addon.async_create_addon(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_capability(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.create_capability_request.CreateCapabilityRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.create_capability_response.CreateCapabilityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.create_capability.async_create_capability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_cluster(name='prod', version='1.10', role_arn='arn:aws:iam::012345678910:role/eks-service-role-AWSServiceRoleForAmazonEKS-J7ONKE3BQ4PI', resources_vpc_config={'subnetIds': ['subnet-6782e71e', 'subnet-e7e761ac'], 'securityGroupIds': ['sg-6979fe18']}, client_request_token='1d2129a1-3d38-460a-9756-e5b91fddb951')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.create_cluster_request.CreateClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.create_cluster_response.CreateClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.create_cluster.async_create_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_eks_anywhere_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.create_eks_anywhere_subscription_request.CreateEksAnywhereSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.create_eks_anywhere_subscription_response.CreateEksAnywhereSubscriptionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.create_eks_anywhere_subscription.async_create_eks_anywhere_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_fargate_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.create_fargate_profile_request.CreateFargateProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.create_fargate_profile_response.CreateFargateProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.create_fargate_profile.async_create_fargate_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_nodegroup(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.create_nodegroup_request.CreateNodegroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.create_nodegroup_response.CreateNodegroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.create_nodegroup.async_create_nodegroup(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_pod_identity_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.create_pod_identity_association_request.CreatePodIdentityAssociationRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.create_pod_identity_association_response.CreatePodIdentityAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.create_pod_identity_association.async_create_pod_identity_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_access_entry(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.delete_access_entry_request.DeleteAccessEntryRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.delete_access_entry_response.DeleteAccessEntryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.delete_access_entry.async_delete_access_entry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_addon(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.delete_addon_request.DeleteAddonRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.delete_addon_response.DeleteAddonResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.delete_addon.async_delete_addon(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_capability(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.delete_capability_request.DeleteCapabilityRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.delete_capability_response.DeleteCapabilityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.delete_capability.async_delete_capability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_cluster(name='devel')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.delete_cluster_request.DeleteClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.delete_cluster_response.DeleteClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.delete_cluster.async_delete_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_eks_anywhere_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.delete_eks_anywhere_subscription_request.DeleteEksAnywhereSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.delete_eks_anywhere_subscription_response.DeleteEksAnywhereSubscriptionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.delete_eks_anywhere_subscription.async_delete_eks_anywhere_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_fargate_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.delete_fargate_profile_request.DeleteFargateProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.delete_fargate_profile_response.DeleteFargateProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.delete_fargate_profile.async_delete_fargate_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_nodegroup(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.delete_nodegroup_request.DeleteNodegroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.delete_nodegroup_response.DeleteNodegroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.delete_nodegroup.async_delete_nodegroup(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_pod_identity_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.delete_pod_identity_association_request.DeletePodIdentityAssociationRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.delete_pod_identity_association_response.DeletePodIdentityAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.delete_pod_identity_association.async_delete_pod_identity_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def deregister_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.deregister_cluster_request.DeregisterClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.deregister_cluster_response.DeregisterClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.deregister_cluster.async_deregister_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_access_entry(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_access_entry_request.DescribeAccessEntryRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_access_entry_response.DescribeAccessEntryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_access_entry.async_describe_access_entry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_addon(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_addon_request.DescribeAddonRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_addon_response.DescribeAddonResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_addon.async_describe_addon(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_addon_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_addon_configuration_request.DescribeAddonConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_addon_configuration_response.DescribeAddonConfigurationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_addon_configuration.async_describe_addon_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_addon_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_addon_versions_request.DescribeAddonVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_addon_versions_response.DescribeAddonVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_addon_versions.async_describe_addon_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_addon_versions(
        self,
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        kubernetes_version: Optional["capo_eks.types.string.String"] = None,
        ...
        publishers: Optional["capo_eks.types.string_list.StringList"] = None,
        owners: Optional["capo_eks.types.string_list.StringList"] = None,
    ) -> "AsyncIterator[capo_eks.types.addon_info.AddonInfo]":
        _token = next_token
        while True:
            _response = await self.describe_addon_versions(
    ...
    async def describe_capability(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_capability_request.DescribeCapabilityRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_capability_response.DescribeCapabilityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_capability.async_describe_capability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cluster(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.describe_cluster(name='devel')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_cluster_request.DescribeClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_cluster_response.DescribeClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_cluster.async_describe_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_cluster_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_cluster_versions_request.DescribeClusterVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_cluster_versions_response.DescribeClusterVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_cluster_versions.async_describe_cluster_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_cluster_versions(
        ...
        *,
        ...
        version_status: Optional["capo_eks.types.version_status.VersionStatus"] = None,
    ) -> "AsyncIterator[capo_eks.types.cluster_version_information.ClusterVersionInformation]":
        _token = next_token
        while True:
    ...
    async def describe_eks_anywhere_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_eks_anywhere_subscription_request.DescribeEksAnywhereSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_eks_anywhere_subscription_response.DescribeEksAnywhereSubscriptionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_eks_anywhere_subscription.async_describe_eks_anywhere_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_fargate_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_fargate_profile_request.DescribeFargateProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_fargate_profile_response.DescribeFargateProfileResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_fargate_profile.async_describe_fargate_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_identity_provider_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_identity_provider_config_request.DescribeIdentityProviderConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_identity_provider_config_response.DescribeIdentityProviderConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_identity_provider_config.async_describe_identity_provider_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_insight(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_insight_request.DescribeInsightRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_insight_response.DescribeInsightResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_insight.async_describe_insight(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_insights_refresh(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_insights_refresh_request.DescribeInsightsRefreshRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_insights_refresh_response.DescribeInsightsRefreshResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_insights_refresh.async_describe_insights_refresh(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_nodegroup(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_nodegroup_request.DescribeNodegroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_nodegroup_response.DescribeNodegroupResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_nodegroup.async_describe_nodegroup(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_pod_identity_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_pod_identity_association_request.DescribePodIdentityAssociationRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_pod_identity_association_response.DescribePodIdentityAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_pod_identity_association.async_describe_pod_identity_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.describe_update_request.DescribeUpdateRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.describe_update_response.DescribeUpdateResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.describe_update.async_describe_update(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_access_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.disassociate_access_policy_request.DisassociateAccessPolicyRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.disassociate_access_policy_response.DisassociateAccessPolicyResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.disassociate_access_policy.async_disassociate_access_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_identity_provider_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.disassociate_identity_provider_config_request.DisassociateIdentityProviderConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.disassociate_identity_provider_config_response.DisassociateIdentityProviderConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.disassociate_identity_provider_config.async_disassociate_identity_provider_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_access_entries(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_access_entries_request.ListAccessEntriesRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_access_entries_response.ListAccessEntriesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_access_entries.async_list_access_entries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_access_entries(
        self,
        cluster_name: "capo_eks.types.string.String",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        ...
        next_token: Optional["capo_eks.types.string.String"] = None,
    ) -> "AsyncIterator[capo_eks.types.string.String]":
        _token = next_token
        while True:
            _response = await self.list_access_entries(
                cluster_name,
                config_overrides=config_overrides,
    ...
    async def list_access_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_access_policies_request.ListAccessPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_access_policies_response.ListAccessPoliciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_access_policies.async_list_access_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_access_policies(
        ...
        *,
        ...
        next_token: Optional["capo_eks.types.string.String"] = None,
    ) -> "AsyncIterator[capo_eks.types.access_policy.AccessPolicy]":
        _token = next_token
        while True:
    ...
    async def list_addons(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_addons_request.ListAddonsRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_addons_response.ListAddonsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_addons.async_list_addons(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_addons(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.list_addons(
                cluster_name,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_associated_access_policies(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_associated_access_policies_request.ListAssociatedAccessPoliciesRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_associated_access_policies_response.ListAssociatedAccessPoliciesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_associated_access_policies.async_list_associated_access_policies(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_associated_access_policies(
        self,
        cluster_name: "capo_eks.types.string.String",
        principal_arn: "capo_eks.types.string.String",
        *,
        ...
        "AsyncIterator[capo_eks.types.associated_access_policy.AssociatedAccessPolicy]"
    ):
        _token = next_token
        while True:
            _response = await self.list_associated_access_policies(
                cluster_name,
                principal_arn,
                config_overrides=config_overrides,
                max_results=max_results,
    ...
    async def list_capabilities(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_capabilities_request.ListCapabilitiesRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_capabilities_response.ListCapabilitiesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_capabilities.async_list_capabilities(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_eks.types.capability_summary.CapabilitySummary]":
        _token = next_token
        while True:
    ...
    async def list_clusters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_clusters_request.ListClustersRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_clusters_response.ListClustersResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_clusters.async_list_clusters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_eks_anywhere_subscriptions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_eks_anywhere_subscriptions_request.ListEksAnywhereSubscriptionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_eks_anywhere_subscriptions_response.ListEksAnywhereSubscriptionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_eks_anywhere_subscriptions.async_list_eks_anywhere_subscriptions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_eks_anywhere_subscriptions(
        self,
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        max_results: Optional[
    ...
    ) -> "AsyncIterator[capo_eks.types.eks_anywhere_subscription.EksAnywhereSubscription]":
        _token = next_token
        while True:
            _response = await self.list_eks_anywhere_subscriptions(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_fargate_profiles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_fargate_profiles_request.ListFargateProfilesRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_fargate_profiles_response.ListFargateProfilesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_fargate_profiles.async_list_fargate_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_fargate_profiles(
        self,
        cluster_name: "capo_eks.types.string.String",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        ...
        _token = next_token
        while True:
            _response = await self.list_fargate_profiles(
                cluster_name,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_identity_provider_configs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_identity_provider_configs_request.ListIdentityProviderConfigsRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_identity_provider_configs_response.ListIdentityProviderConfigsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_identity_provider_configs.async_list_identity_provider_configs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_identity_provider_configs(
        self,
        cluster_name: "capo_eks.types.string.String",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        ...
        "AsyncIterator[capo_eks.types.identity_provider_config.IdentityProviderConfig]"
    ):
        _token = next_token
        while True:
            _response = await self.list_identity_provider_configs(
                cluster_name,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_insights(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_insights_request.ListInsightsRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_insights_response.ListInsightsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_insights.async_list_insights(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_insights(
        ...
        *,
        ...
        next_token: Optional["capo_eks.types.string.String"] = None,
    ) -> "AsyncIterator[capo_eks.types.insight_summary.InsightSummary]":
        _token = next_token
        while True:
    ...
    async def list_nodegroups(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_nodegroups_request.ListNodegroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_nodegroups_response.ListNodegroupsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_nodegroups.async_list_nodegroups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_nodegroups(
        self,
        cluster_name: "capo_eks.types.string.String",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        ...
        _token = next_token
        while True:
            _response = await self.list_nodegroups(
                cluster_name,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    async def list_pod_identity_associations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_pod_identity_associations_request.ListPodIdentityAssociationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_pod_identity_associations_response.ListPodIdentityAssociationsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_pod_identity_associations.async_list_pod_identity_associations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_pod_identity_associations(
        self,
        cluster_name: "capo_eks.types.string.String",
        *,
        config_overrides: Optional[AsyncEKSClientConfig] = None,
        ...
        next_token: Optional["capo_eks.types.string.String"] = None,
    ) -> "AsyncIterator[capo_eks.types.pod_identity_association_summary.PodIdentityAssociationSummary]":
        _token = next_token
        while True:
            _response = await self.list_pod_identity_associations(
                cluster_name,
                config_overrides=config_overrides,
                namespace=namespace,
                service_account=service_account,
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_tags_for_resource(resource_arn='arn:aws:eks:us-west-2:012345678910:cluster/beta')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_updates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.list_updates_request.ListUpdatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.list_updates_response.ListUpdatesResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.list_updates.async_list_updates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_updates(
        ...
        *,
        ...
        _token = next_token
        while True:
            _response = await self.list_updates(
                name,
                config_overrides=config_overrides,
                nodegroup_name=nodegroup_name,
                addon_name=addon_name,
    ...
    async def register_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.register_cluster_request.RegisterClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.register_cluster_response.RegisterClusterResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.register_cluster.async_register_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_insights_refresh(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.start_insights_refresh_request.StartInsightsRefreshRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.start_insights_refresh_response.StartInsightsRefreshResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.start_insights_refresh.async_start_insights_refresh(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_access_entry(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_access_entry_request.UpdateAccessEntryRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_access_entry_response.UpdateAccessEntryResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_access_entry.async_update_access_entry(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_addon(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_addon_request.UpdateAddonRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_addon_response.UpdateAddonResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_addon.async_update_addon(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_capability(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_capability_request.UpdateCapabilityRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_capability_response.UpdateCapabilityResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_capability.async_update_capability(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cluster_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_cluster_config_request.UpdateClusterConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_cluster_config_response.UpdateClusterConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_cluster_config.async_update_cluster_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cluster_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_cluster_version_request.UpdateClusterVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_cluster_version_response.UpdateClusterVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_cluster_version.async_update_cluster_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_eks_anywhere_subscription(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_eks_anywhere_subscription_request.UpdateEksAnywhereSubscriptionRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_eks_anywhere_subscription_response.UpdateEksAnywhereSubscriptionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_eks_anywhere_subscription.async_update_eks_anywhere_subscription(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_nodegroup_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_nodegroup_config_request.UpdateNodegroupConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_nodegroup_config_response.UpdateNodegroupConfigResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_nodegroup_config.async_update_nodegroup_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_nodegroup_version(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_nodegroup_version_request.UpdateNodegroupVersionRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_nodegroup_version_response.UpdateNodegroupVersionResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_nodegroup_version.async_update_nodegroup_version(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_pod_identity_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_eks.types.update_pod_identity_association_request.UpdatePodIdentityAssociationRequest]",
        ) -> AsyncOperationResponse[
            "capo_eks.types.update_pod_identity_association_response.UpdatePodIdentityAssociationResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_eks._operations.aws_wesley_frontend.update_pod_identity_association.async_update_pod_identity_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
