...
class ArgoCdAwsIdcConfigResponse(TypedDict, closed=True):
    idc_instance_arn: NotRequired["capo_eks.types.string.String"]
    ...
    idc_managed_application_arn: NotRequired["capo_eks.types.string.String"]
...
def deserialize_json(data: dict) -> ArgoCdAwsIdcConfigResponse:
    ...
    if data.get("idcManagedApplicationArn") is not None:
