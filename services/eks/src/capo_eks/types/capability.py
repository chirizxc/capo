...
class Capability(TypedDict, closed=True):
    ...
    configuration: NotRequired[
        "capo_eks.types.capability_configuration_response.CapabilityConfigurationResponse"
    ]
    ...
    health: NotRequired["capo_eks.types.capability_health.CapabilityHealth"]
...
def serialize_json(value: Capability) -> dict:
    ...
    if "configuration" in value:
        ...
        out["configuration"] = (
            capo_eks.types.capability_configuration_response.serialize_json(
                value["configuration"]
            )
        )
    if "tags" in value:
    ...
    if "health" in value:
        ...
        out["health"] = capo_eks.types.capability_health.serialize_json(value["health"])
...
def deserialize_json(data: dict) -> Capability:
    ...
    if data.get("configuration") is not None:
        ...
        out["configuration"] = (
            capo_eks.types.capability_configuration_response.deserialize_json(
                data["configuration"]
            )
        )
