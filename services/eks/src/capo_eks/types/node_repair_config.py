...
class NodeRepairConfig(TypedDict, closed=True):
    ...
    node_repair_config_overrides: NotRequired[
        "capo_eks.types.node_repair_config_overrides_list.NodeRepairConfigOverridesList"
    ]
...
def serialize_json(value: NodeRepairConfig) -> dict:
    ...
    if "node_repair_config_overrides" in value:
        ...
        out["nodeRepairConfigOverrides"] = (
            capo_eks.types.node_repair_config_overrides_list.serialize_json(
...
def deserialize_json(data: dict) -> NodeRepairConfig:
    ...
    if data.get("nodeRepairConfigOverrides") is not None:
        ...
        out["node_repair_config_overrides"] = (
            capo_eks.types.node_repair_config_overrides_list.deserialize_json(
