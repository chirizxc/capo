...
class ListAssociatedAccessPoliciesResponse(TypedDict, closed=True):
    ...
    associated_access_policies: NotRequired[
        "capo_eks.types.associated_access_policies_list.AssociatedAccessPoliciesList"
    ]
...
def serialize_json(value: ListAssociatedAccessPoliciesResponse) -> dict:
    ...
    if "associated_access_policies" in value:
        ...
        out["associatedAccessPolicies"] = (
            capo_eks.types.associated_access_policies_list.serialize_json(
...
def deserialize_json(data: dict) -> ListAssociatedAccessPoliciesResponse:
    ...
    if data.get("associatedAccessPolicies") is not None:
        ...
        out["associated_access_policies"] = (
            capo_eks.types.associated_access_policies_list.deserialize_json(
