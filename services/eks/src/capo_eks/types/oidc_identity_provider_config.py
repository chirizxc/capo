...
class OidcIdentityProviderConfig(TypedDict, closed=True):
    identity_provider_config_name: NotRequired["capo_eks.types.string.String"]
    """<p>The name of the configuration.</p>"""
    identity_provider_config_arn: NotRequired["capo_eks.types.string.String"]
    """<p>The ARN of the configuration.</p>"""
    cluster_name: NotRequired["capo_eks.types.string.String"]
    """<p>The name of your cluster.</p>"""
    issuer_url: NotRequired["capo_eks.types.string.String"]
    ...
    client_id: NotRequired["capo_eks.types.string.String"]
    ...
    status: NotRequired["capo_eks.types.config_status.configStatus"]
...
def serialize_json(value: OidcIdentityProviderConfig) -> dict:
    ...
    if "status" in value:
        ...
        out["status"] = capo_eks.types.config_status.serialize_json(value["status"])
    return out
