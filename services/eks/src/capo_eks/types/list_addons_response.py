...
class ListAddonsResponse(TypedDict, closed=True):
    addons: NotRequired["capo_eks.types.string_list.StringList"]
...
def serialize_json(value: ListAddonsResponse) -> dict:
    ...
    if "addons" in value:
        ...
        out["addons"] = capo_eks.types.string_list.serialize_json(value["addons"])
