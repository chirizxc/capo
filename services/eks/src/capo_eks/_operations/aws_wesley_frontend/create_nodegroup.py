"""Generated from Smithy shape ``com.amazonaws.eks#CreateNodegroup``."""
...
def handle_response(
    ...
    out: capo_eks.types.create_nodegroup_response.CreateNodegroupResponse = (
        capo_eks.types.create_nodegroup_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.create_nodegroup_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_nodegroup(
    ...
    capo_eks.types.create_nodegroup_response.CreateNodegroupResponse, zapros.Response
]:
...
async def async_create_nodegroup(
