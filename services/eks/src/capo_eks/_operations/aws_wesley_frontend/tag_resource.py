"""Generated from Smithy shape ``com.amazonaws.eks#TagResource``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "NotFoundException":
            raise capo_eks.errors.not_found_exception.NotFoundException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_eks.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.tag_resource_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def tag_resource(
    ...
    input_: capo_eks.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_eks.types.tag_resource_response.TagResourceResponse, zapros.Response]:
