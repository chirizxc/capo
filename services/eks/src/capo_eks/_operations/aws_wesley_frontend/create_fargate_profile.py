...
def handle_response(
    ...
    out: capo_eks.types.create_fargate_profile_response.CreateFargateProfileResponse = (
        capo_eks.types.create_fargate_profile_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.create_fargate_profile_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
