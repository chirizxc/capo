"""Generated from Smithy shape ``com.amazonaws.eks#ListCapabilities``."""
...
def handle_response(
    ...
    out: capo_eks.types.list_capabilities_response.ListCapabilitiesResponse = (
        capo_eks.types.list_capabilities_response.deserialize_json(
...
def list_capabilities(
    ...
    capo_eks.types.list_capabilities_response.ListCapabilitiesResponse, zapros.Response
]:
