...
def handle_response(
    ...
    out: capo_eks.types.describe_addon_response.DescribeAddonResponse = (
        capo_eks.types.describe_addon_response.deserialize_json(
...
def describe_addon(
    ...
    capo_eks.types.describe_addon_response.DescribeAddonResponse, zapros.Response
]:
