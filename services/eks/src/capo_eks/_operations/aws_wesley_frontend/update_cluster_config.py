...
def handle_response(
    ...
    out: capo_eks.types.update_cluster_config_response.UpdateClusterConfigResponse = (
        capo_eks.types.update_cluster_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.update_cluster_config_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
