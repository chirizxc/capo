...
def handle_response(
    ...
    out: capo_eks.types.list_identity_provider_configs_response.ListIdentityProviderConfigsResponse = capo_eks.types.list_identity_provider_configs_response.deserialize_json(
