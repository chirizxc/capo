...
def handle_response(
    ...
    out: capo_eks.types.delete_addon_response.DeleteAddonResponse = (
        capo_eks.types.delete_addon_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{addonName}", quote(input_["addon_name"], safe=""))
    params: list[tuple[str, str]] = []
    params.append(("preserve", "true" if input_.get("preserve", False) else "false"))
...
def delete_addon(
    ...
    input_: capo_eks.types.delete_addon_request.DeleteAddonRequest,
) -> tuple[capo_eks.types.delete_addon_response.DeleteAddonResponse, zapros.Response]:
