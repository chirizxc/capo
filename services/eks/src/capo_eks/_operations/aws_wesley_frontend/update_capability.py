"""Generated from Smithy shape ``com.amazonaws.eks#UpdateCapability``."""
...
def handle_response(
    ...
    out: capo_eks.types.update_capability_response.UpdateCapabilityResponse = (
        capo_eks.types.update_capability_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.update_capability_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_capability(
    ...
    capo_eks.types.update_capability_response.UpdateCapabilityResponse, zapros.Response
]:
