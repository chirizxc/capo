...
def handle_response(
    ...
    out: capo_eks.types.describe_insights_refresh_response.DescribeInsightsRefreshResponse = capo_eks.types.describe_insights_refresh_response.deserialize_json(
