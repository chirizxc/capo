...
def handle_response(
    ...
    out: capo_eks.types.list_clusters_response.ListClustersResponse = (
        capo_eks.types.list_clusters_response.deserialize_json(
...
def list_clusters(
    ...
    input_: capo_eks.types.list_clusters_request.ListClustersRequest,
) -> tuple[capo_eks.types.list_clusters_response.ListClustersResponse, zapros.Response]:
