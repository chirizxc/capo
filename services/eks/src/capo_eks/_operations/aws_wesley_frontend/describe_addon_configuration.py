...
def handle_response(
    ...
    out: capo_eks.types.describe_addon_configuration_response.DescribeAddonConfigurationResponse = capo_eks.types.describe_addon_configuration_response.deserialize_json(
...
def build_request(
    ...
    if "addon_version" in input_:
        params.append(("addonVersion", input_["addon_version"]))
