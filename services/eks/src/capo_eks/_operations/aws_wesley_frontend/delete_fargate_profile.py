"""Generated from Smithy shape ``com.amazonaws.eks#DeleteFargateProfile``."""
...
def handle_response(
    ...
    out: capo_eks.types.delete_fargate_profile_response.DeleteFargateProfileResponse = (
        capo_eks.types.delete_fargate_profile_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{fargateProfileName}", quote(input_["fargate_profile_name"], safe="")
    )
...
async def async_delete_fargate_profile(
