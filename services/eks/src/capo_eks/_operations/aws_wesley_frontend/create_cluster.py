...
import capo_eks.errors.unsupported_availability_zone_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedAvailabilityZoneException":
            raise capo_eks.errors.unsupported_availability_zone_exception.UnsupportedAvailabilityZoneException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_eks.types.create_cluster_response.CreateClusterResponse = (
        capo_eks.types.create_cluster_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.create_cluster_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_cluster(
    ...
    capo_eks.types.create_cluster_response.CreateClusterResponse, zapros.Response
]:
