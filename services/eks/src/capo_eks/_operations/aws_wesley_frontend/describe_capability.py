"""Generated from Smithy shape ``com.amazonaws.eks#DescribeCapability``."""
...
def handle_response(
    ...
    out: capo_eks.types.describe_capability_response.DescribeCapabilityResponse = (
        capo_eks.types.describe_capability_response.deserialize_json(
...
async def async_describe_capability(
