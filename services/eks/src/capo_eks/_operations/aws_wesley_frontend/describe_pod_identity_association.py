...
def handle_response(
    ...
    out: capo_eks.types.describe_pod_identity_association_response.DescribePodIdentityAssociationResponse = capo_eks.types.describe_pod_identity_association_response.deserialize_json(
