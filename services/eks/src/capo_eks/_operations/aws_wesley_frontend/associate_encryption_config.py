...
def handle_response(
    ...
    out: capo_eks.types.associate_encryption_config_response.AssociateEncryptionConfigResponse = capo_eks.types.associate_encryption_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.associate_encryption_config_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
