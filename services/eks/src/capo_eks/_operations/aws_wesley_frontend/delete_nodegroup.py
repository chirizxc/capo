"""Generated from Smithy shape ``com.amazonaws.eks#DeleteNodegroup``."""
...
def handle_response(
    ...
    out: capo_eks.types.delete_nodegroup_response.DeleteNodegroupResponse = (
        capo_eks.types.delete_nodegroup_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{nodegroupName}", quote(input_["nodegroup_name"], safe=""))
...
def delete_nodegroup(
    ...
    capo_eks.types.delete_nodegroup_response.DeleteNodegroupResponse, zapros.Response
]:
...
async def async_delete_nodegroup(
