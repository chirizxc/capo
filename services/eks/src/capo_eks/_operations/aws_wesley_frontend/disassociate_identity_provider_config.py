"""Generated from Smithy shape ``com.amazonaws.eks#DisassociateIdentityProviderConfig``."""
...
def handle_response(
    ...
    out: capo_eks.types.disassociate_identity_provider_config_response.DisassociateIdentityProviderConfigResponse = capo_eks.types.disassociate_identity_provider_config_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.disassociate_identity_provider_config_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_identity_provider_config(
