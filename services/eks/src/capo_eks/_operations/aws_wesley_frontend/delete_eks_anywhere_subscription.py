...
def handle_response(
    ...
    out: capo_eks.types.delete_eks_anywhere_subscription_response.DeleteEksAnywhereSubscriptionResponse = capo_eks.types.delete_eks_anywhere_subscription_response.deserialize_json(
