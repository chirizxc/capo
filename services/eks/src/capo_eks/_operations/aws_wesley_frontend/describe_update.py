...
def build_request(
    ...
    url = url.replace("{updateId}", quote(input_["update_id"], safe=""))
    params: list[tuple[str, str]] = []
    if "nodegroup_name" in input_:
        params.append(("nodegroupName", input_["nodegroup_name"]))
    if "addon_name" in input_:
        params.append(("addonName", input_["addon_name"]))
    if "capability_name" in input_:
        params.append(("capabilityName", input_["capability_name"]))
