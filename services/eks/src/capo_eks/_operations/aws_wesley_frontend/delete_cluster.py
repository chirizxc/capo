...
def handle_response(
    ...
    out: capo_eks.types.delete_cluster_response.DeleteClusterResponse = (
        capo_eks.types.delete_cluster_response.deserialize_json(
...
def delete_cluster(
    ...
    capo_eks.types.delete_cluster_response.DeleteClusterResponse, zapros.Response
]:
