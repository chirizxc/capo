"""Generated from Smithy shape ``com.amazonaws.eks#CreatePodIdentityAssociation``."""
...
def handle_response(
    ...
    out: capo_eks.types.create_pod_identity_association_response.CreatePodIdentityAssociationResponse = capo_eks.types.create_pod_identity_association_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_eks.types.create_pod_identity_association_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_pod_identity_association(
