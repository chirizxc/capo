...
class AsyncSchedulerClient:
    ...
    async def iter_list_schedules(
        ...
        *,
        ...
        next_token: Optional["capo_scheduler.types.next_token.NextToken"] = None,
        max_results: Optional["capo_scheduler.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_scheduler.types.schedule_summary.ScheduleSummary]":
        _token = next_token
        while True:
    ...
    async def iter_list_schedule_groups(
        self,
        *,
        config_overrides: Optional[AsyncSchedulerClientConfig] = None,
        name_prefix: Optional[
        ...
        next_token: Optional["capo_scheduler.types.next_token.NextToken"] = None,
        max_results: Optional["capo_scheduler.types.max_results.MaxResults"] = None,
    ) -> "AsyncIterator[capo_scheduler.types.schedule_group_summary.ScheduleGroupSummary]":
        _token = next_token
        while True:
            _response = await self.list_schedule_groups(
                config_overrides=config_overrides,
                name_prefix=name_prefix,
                next_token=_token,
                max_results=max_results,
