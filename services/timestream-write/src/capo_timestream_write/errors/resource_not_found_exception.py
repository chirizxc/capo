"""Generated from Smithy shape ``com.amazonaws.timestreamwrite#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.timestreamwrite#ResourceNotFoundException``."""
