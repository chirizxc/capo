...
class ListBatchLoadTasksResponse(TypedDict, closed=True):
    ...
    batch_load_tasks: NotRequired[
        "capo_timestream_write.types.batch_load_task_list.BatchLoadTaskList"
    ]
...
def serialize_aws_json_1_0(value: ListBatchLoadTasksResponse) -> dict:
    ...
    if "batch_load_tasks" in value:
        ...
        out["BatchLoadTasks"] = (
            capo_timestream_write.types.batch_load_task_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListBatchLoadTasksResponse:
    ...
    if data.get("BatchLoadTasks") is not None:
        ...
        out["batch_load_tasks"] = (
            capo_timestream_write.types.batch_load_task_list.deserialize_aws_json_1_0(
                data["BatchLoadTasks"]
            )
        )
    return out
