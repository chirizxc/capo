"""Generated from Smithy shape ``com.amazonaws.mturk#ListHITsForQualificationTypeResponse``."""
...
class ListHITsForQualificationTypeResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListHITsForQualificationTypeResponse) -> dict:
    out: dict = {}
