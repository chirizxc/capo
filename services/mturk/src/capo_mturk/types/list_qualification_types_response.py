...
class ListQualificationTypesResponse(TypedDict, closed=True):
    ...
    qualification_types: NotRequired[
        "capo_mturk.types.qualification_type_list.QualificationTypeList"
    ]
...
def serialize_aws_json_1_1(value: ListQualificationTypesResponse) -> dict:
    ...
    if "qualification_types" in value:
        ...
        out["QualificationTypes"] = (
            capo_mturk.types.qualification_type_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListQualificationTypesResponse:
    ...
    if data.get("QualificationTypes") is not None:
        import capo_mturk.types.qualification_type_list

        out["qualification_types"] = (
            capo_mturk.types.qualification_type_list.deserialize_aws_json_1_1(
