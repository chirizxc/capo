...
def handle_response(
    ...
    out: capo_mturk.types.delete_worker_block_response.DeleteWorkerBlockResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mturk.types.delete_worker_block_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
