...
if TYPE_CHECKING:
    import capo_deadline.types.setting_key
    import capo_deadline.types.setting_value

SettingsMap: TypeAlias = dict[
    "capo_deadline.types.setting_key.SettingKey",
    "capo_deadline.types.setting_value.SettingValue",
]
