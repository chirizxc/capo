"""Generated from Smithy shape ``com.amazonaws.deadline#GetMonitorResponse``."""
...
class GetMonitorResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetMonitorResponse) -> dict:
    out: dict = {}
