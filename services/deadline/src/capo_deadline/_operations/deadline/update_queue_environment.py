...
def handle_response(
    ...
    out: capo_deadline.types.update_queue_environment_response.UpdateQueueEnvironmentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_queue_environment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
