...
def handle_response(
    ...
    out: capo_deadline.types.create_storage_profile_response.CreateStorageProfileResponse = capo_deadline.types.create_storage_profile_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_storage_profile_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
