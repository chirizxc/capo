"""Generated from Smithy shape ``com.amazonaws.deadline#DeleteQueueFleetAssociation``."""
...
def handle_response(
    ...
    out: capo_deadline.types.delete_queue_fleet_association_response.DeleteQueueFleetAssociationResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_queue_fleet_association(
