...
def handle_response(
    ...
    out: capo_deadline.types.associate_member_to_queue_response.AssociateMemberToQueueResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.associate_member_to_queue_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
