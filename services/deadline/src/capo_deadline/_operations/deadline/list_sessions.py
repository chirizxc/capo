...
import capo_deadline.types.session_summaries
...
def handle_response(
    ...
    out: capo_deadline.types.list_sessions_response.ListSessionsResponse = (
        capo_deadline.types.list_sessions_response.deserialize_json(
...
def list_sessions(
    ...
    capo_deadline.types.list_sessions_response.ListSessionsResponse, zapros.Response
]:
