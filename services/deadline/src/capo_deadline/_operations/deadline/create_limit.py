"""Generated from Smithy shape ``com.amazonaws.deadline#CreateLimit``."""
...
def handle_response(
    ...
    out: capo_deadline.types.create_limit_response.CreateLimitResponse = (
        capo_deadline.types.create_limit_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_limit_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_limit(
    ...
    capo_deadline.types.create_limit_response.CreateLimitResponse, zapros.Response
]:
