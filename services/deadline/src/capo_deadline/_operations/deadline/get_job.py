...
def handle_response(
    ...
    out: capo_deadline.types.get_job_response.GetJobResponse = (
        capo_deadline.types.get_job_response.deserialize_json(
...
def get_job(
    options: OperationOptions, input_: capo_deadline.types.get_job_request.GetJobRequest
) -> tuple[capo_deadline.types.get_job_response.GetJobResponse, zapros.Response]:
