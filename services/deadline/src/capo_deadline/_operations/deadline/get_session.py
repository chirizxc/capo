"""Generated from Smithy shape ``com.amazonaws.deadline#GetSession``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_session_response.GetSessionResponse = (
        capo_deadline.types.get_session_response.deserialize_json(
...
def get_session(
    ...
    capo_deadline.types.get_session_response.GetSessionResponse, zapros.Response
]:
