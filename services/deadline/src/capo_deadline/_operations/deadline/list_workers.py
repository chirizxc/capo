"""Generated from Smithy shape ``com.amazonaws.deadline#ListWorkers``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_workers_response.ListWorkersResponse = (
        capo_deadline.types.list_workers_response.deserialize_json(
...
def list_workers(
    ...
    capo_deadline.types.list_workers_response.ListWorkersResponse, zapros.Response
]:
