...
def handle_response(
    ...
    out: capo_deadline.types.get_budget_response.GetBudgetResponse = (
        capo_deadline.types.get_budget_response.deserialize_json(
...
def get_budget(
    ...
    input_: capo_deadline.types.get_budget_request.GetBudgetRequest,
) -> tuple[capo_deadline.types.get_budget_response.GetBudgetResponse, zapros.Response]:
