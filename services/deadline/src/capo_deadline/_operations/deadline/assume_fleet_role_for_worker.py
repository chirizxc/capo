...
def handle_response(
    ...
    out: capo_deadline.types.assume_fleet_role_for_worker_response.AssumeFleetRoleForWorkerResponse = capo_deadline.types.assume_fleet_role_for_worker_response.deserialize_json(
