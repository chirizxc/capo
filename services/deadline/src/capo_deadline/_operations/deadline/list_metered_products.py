"""Generated from Smithy shape ``com.amazonaws.deadline#ListMeteredProducts``."""
...
def handle_response(
    ...
    out: capo_deadline.types.list_metered_products_response.ListMeteredProductsResponse = capo_deadline.types.list_metered_products_response.deserialize_json(
...
async def async_list_metered_products(
