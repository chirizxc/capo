"""Generated from Smithy shape ``com.amazonaws.deadline#GetQueueEnvironment``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_queue_environment_response.GetQueueEnvironmentResponse = capo_deadline.types.get_queue_environment_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{queueEnvironmentId}", quote(input_["queue_environment_id"], safe="")
    )
