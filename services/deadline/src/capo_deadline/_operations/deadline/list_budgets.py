...
def handle_response(
    ...
    out: capo_deadline.types.list_budgets_response.ListBudgetsResponse = (
        capo_deadline.types.list_budgets_response.deserialize_json(
...
def build_request(
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_deadline.types.budget_status.serialize_json(input_["status"]),
            )
        )
...
def list_budgets(
    ...
    capo_deadline.types.list_budgets_response.ListBudgetsResponse, zapros.Response
]:
