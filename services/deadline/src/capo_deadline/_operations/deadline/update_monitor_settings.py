...
def handle_response(
    ...
    out: capo_deadline.types.update_monitor_settings_response.UpdateMonitorSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_monitor_settings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
