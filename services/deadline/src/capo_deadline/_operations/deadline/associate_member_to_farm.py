...
def handle_response(
    ...
    out: capo_deadline.types.associate_member_to_farm_response.AssociateMemberToFarmResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.associate_member_to_farm_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
