"""Generated from Smithy shape ``com.amazonaws.deadline#UpdateFleet``."""
...
def handle_response(
    ...
    out: capo_deadline.types.update_fleet_response.UpdateFleetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_fleet_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_fleet(
    ...
    capo_deadline.types.update_fleet_response.UpdateFleetResponse, zapros.Response
]:
