"""Generated from Smithy shape ``com.amazonaws.deadline#CreateQueueEnvironment``."""
...
def handle_response(
    ...
    out: capo_deadline.types.create_queue_environment_response.CreateQueueEnvironmentResponse = capo_deadline.types.create_queue_environment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_queue_environment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_queue_environment(
