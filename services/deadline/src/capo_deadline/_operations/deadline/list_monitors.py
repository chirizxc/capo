...
def handle_response(
    ...
    out: capo_deadline.types.list_monitors_response.ListMonitorsResponse = (
        capo_deadline.types.list_monitors_response.deserialize_json(
...
def list_monitors(
    ...
    capo_deadline.types.list_monitors_response.ListMonitorsResponse, zapros.Response
]:
