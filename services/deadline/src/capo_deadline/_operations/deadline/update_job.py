...
def handle_response(
    ...
    out: capo_deadline.types.update_job_response.UpdateJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_job_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_job(
    ...
    input_: capo_deadline.types.update_job_request.UpdateJobRequest,
) -> tuple[capo_deadline.types.update_job_response.UpdateJobResponse, zapros.Response]:
