...
import capo_deadline.types.task_summaries
...
def handle_response(
    ...
    out: capo_deadline.types.list_tasks_response.ListTasksResponse = (
        capo_deadline.types.list_tasks_response.deserialize_json(
...
def list_tasks(
    ...
    input_: capo_deadline.types.list_tasks_request.ListTasksRequest,
) -> tuple[capo_deadline.types.list_tasks_response.ListTasksResponse, zapros.Response]:
