...
def handle_response(
    ...
    out: capo_deadline.types.create_queue_response.CreateQueueResponse = (
        capo_deadline.types.create_queue_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_queue_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_queue(
    ...
    capo_deadline.types.create_queue_response.CreateQueueResponse, zapros.Response
]:
