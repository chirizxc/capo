...
def handle_response(
    ...
    out: capo_deadline.types.create_worker_response.CreateWorkerResponse = (
        capo_deadline.types.create_worker_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.create_worker_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_worker(
    ...
    capo_deadline.types.create_worker_response.CreateWorkerResponse, zapros.Response
]:
