"""Generated from Smithy shape ``com.amazonaws.deadline#DeleteWorker``."""
...
def handle_response(
    ...
    out: capo_deadline.types.delete_worker_response.DeleteWorkerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_worker(
    ...
    capo_deadline.types.delete_worker_response.DeleteWorkerResponse, zapros.Response
]:
