"""Generated from Smithy shape ``com.amazonaws.deadline#GetLimit``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_limit_response.GetLimitResponse = (
        capo_deadline.types.get_limit_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{limitId}", quote(input_["limit_id"], safe=""))
...
def get_limit(
    ...
    input_: capo_deadline.types.get_limit_request.GetLimitRequest,
) -> tuple[capo_deadline.types.get_limit_response.GetLimitResponse, zapros.Response]:
