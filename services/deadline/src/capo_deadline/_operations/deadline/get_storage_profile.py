"""Generated from Smithy shape ``com.amazonaws.deadline#GetStorageProfile``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_storage_profile_response.GetStorageProfileResponse = (
        capo_deadline.types.get_storage_profile_response.deserialize_json(
...
async def async_get_storage_profile(
