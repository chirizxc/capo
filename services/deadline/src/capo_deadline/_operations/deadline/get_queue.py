...
def handle_response(
    ...
    out: capo_deadline.types.get_queue_response.GetQueueResponse = (
        capo_deadline.types.get_queue_response.deserialize_json(
...
def get_queue(
    ...
    input_: capo_deadline.types.get_queue_request.GetQueueRequest,
) -> tuple[capo_deadline.types.get_queue_response.GetQueueResponse, zapros.Response]:
