...
def handle_response(
    ...
    out: capo_deadline.types.delete_budget_response.DeleteBudgetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_budget(
    ...
    capo_deadline.types.delete_budget_response.DeleteBudgetResponse, zapros.Response
]:
