...
def handle_response(
    ...
    out: capo_deadline.types.update_task_response.UpdateTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_task_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_task(
    ...
    capo_deadline.types.update_task_response.UpdateTaskResponse, zapros.Response
]:
