"""Generated from Smithy shape ``com.amazonaws.deadline#GetWorker``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_worker_response.GetWorkerResponse = (
        capo_deadline.types.get_worker_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{fleetId}", quote(input_["fleet_id"], safe=""))
    url = url.replace("{workerId}", quote(input_["worker_id"], safe=""))
...
def get_worker(
    ...
    input_: capo_deadline.types.get_worker_request.GetWorkerRequest,
) -> tuple[capo_deadline.types.get_worker_response.GetWorkerResponse, zapros.Response]:
