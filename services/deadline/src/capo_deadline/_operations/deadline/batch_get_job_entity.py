...
def handle_response(
    ...
    out: capo_deadline.types.batch_get_job_entity_response.BatchGetJobEntityResponse = (
        capo_deadline.types.batch_get_job_entity_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.batch_get_job_entity_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
