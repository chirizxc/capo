...
def handle_response(
    ...
    out: capo_deadline.types.get_queue_fleet_association_response.GetQueueFleetAssociationResponse = capo_deadline.types.get_queue_fleet_association_response.deserialize_json(
