...
def handle_response(
    ...
    out: capo_deadline.types.update_worker_response.UpdateWorkerResponse = (
        capo_deadline.types.update_worker_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.update_worker_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_worker(
    ...
    capo_deadline.types.update_worker_response.UpdateWorkerResponse, zapros.Response
]:
