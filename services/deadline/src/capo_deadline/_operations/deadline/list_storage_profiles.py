...
def handle_response(
    ...
    out: capo_deadline.types.list_storage_profiles_response.ListStorageProfilesResponse = capo_deadline.types.list_storage_profiles_response.deserialize_json(
