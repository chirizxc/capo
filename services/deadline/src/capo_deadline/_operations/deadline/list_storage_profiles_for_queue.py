...
def handle_response(
    ...
    out: capo_deadline.types.list_storage_profiles_for_queue_response.ListStorageProfilesForQueueResponse = capo_deadline.types.list_storage_profiles_for_queue_response.deserialize_json(
