...
def handle_response(
    ...
    out: capo_deadline.types.delete_fleet_response.DeleteFleetResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_fleet(
    ...
    capo_deadline.types.delete_fleet_response.DeleteFleetResponse, zapros.Response
]:
