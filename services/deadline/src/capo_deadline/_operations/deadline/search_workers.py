...
def handle_response(
    ...
    out: capo_deadline.types.search_workers_response.SearchWorkersResponse = (
        capo_deadline.types.search_workers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.search_workers_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def search_workers(
    ...
    capo_deadline.types.search_workers_response.SearchWorkersResponse, zapros.Response
]:
