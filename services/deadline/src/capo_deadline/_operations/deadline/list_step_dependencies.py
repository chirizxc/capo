...
def handle_response(
    ...
    out: capo_deadline.types.list_step_dependencies_response.ListStepDependenciesResponse = capo_deadline.types.list_step_dependencies_response.deserialize_json(
