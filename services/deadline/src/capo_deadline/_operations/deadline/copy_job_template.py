"""Generated from Smithy shape ``com.amazonaws.deadline#CopyJobTemplate``."""
...
def handle_response(
    ...
    out: capo_deadline.types.copy_job_template_response.CopyJobTemplateResponse = (
        capo_deadline.types.copy_job_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_deadline.types.copy_job_template_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_copy_job_template(
