"""Generated from Smithy shape ``com.amazonaws.deadline#GetMonitor``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_monitor_response.GetMonitorResponse = (
        capo_deadline.types.get_monitor_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{monitorId}", quote(input_["monitor_id"], safe=""))
...
def get_monitor(
    ...
    capo_deadline.types.get_monitor_response.GetMonitorResponse, zapros.Response
]:
