"""Generated from Smithy shape ``com.amazonaws.deadline#GetTask``."""
...
def handle_response(
    ...
    out: capo_deadline.types.get_task_response.GetTaskResponse = (
        capo_deadline.types.get_task_response.deserialize_json(
...
def get_task(
    ...
    input_: capo_deadline.types.get_task_request.GetTaskRequest,
) -> tuple[capo_deadline.types.get_task_response.GetTaskResponse, zapros.Response]:
