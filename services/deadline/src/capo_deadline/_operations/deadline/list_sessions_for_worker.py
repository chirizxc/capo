...
def handle_response(
    ...
    out: capo_deadline.types.list_sessions_for_worker_response.ListSessionsForWorkerResponse = capo_deadline.types.list_sessions_for_worker_response.deserialize_json(
