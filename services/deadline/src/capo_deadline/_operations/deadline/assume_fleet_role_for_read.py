...
def handle_response(
    ...
    out: capo_deadline.types.assume_fleet_role_for_read_response.AssumeFleetRoleForReadResponse = capo_deadline.types.assume_fleet_role_for_read_response.deserialize_json(
