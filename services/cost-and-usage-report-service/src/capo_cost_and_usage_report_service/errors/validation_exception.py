"""Generated from Smithy shape ``com.amazonaws.costandusagereportservice#ValidationException``."""
...
class ValidationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.costandusagereportservice#ValidationException``."""
