...
def handle_response(
    ...
    out: capo_network_firewall.types.update_tls_inspection_configuration_response.UpdateTLSInspectionConfigurationResponse = capo_network_firewall.types.update_tls_inspection_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_tls_inspection_configuration_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
