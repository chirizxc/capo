...
def handle_response(
    ...
    out: capo_network_firewall.types.describe_rule_group_metadata_response.DescribeRuleGroupMetadataResponse = capo_network_firewall.types.describe_rule_group_metadata_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.describe_rule_group_metadata_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
