"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListProxies``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.list_proxies_response.ListProxiesResponse = (
        capo_network_firewall.types.list_proxies_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.ListProxies"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_proxies_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
