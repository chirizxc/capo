...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_proxy_rules_response.DeleteProxyRulesResponse = capo_network_firewall.types.delete_proxy_rules_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_proxy_rules_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
