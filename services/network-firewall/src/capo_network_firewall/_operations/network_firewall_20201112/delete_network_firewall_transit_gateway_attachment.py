"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DeleteNetworkFirewallTransitGatewayAttachment``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_network_firewall_transit_gateway_attachment_response.DeleteNetworkFirewallTransitGatewayAttachmentResponse = capo_network_firewall.types.delete_network_firewall_transit_gateway_attachment_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_network_firewall_transit_gateway_attachment_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_network_firewall_transit_gateway_attachment(
