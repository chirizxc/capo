"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DescribeProxyRule``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.describe_proxy_rule_response.DescribeProxyRuleResponse = capo_network_firewall.types.describe_proxy_rule_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DescribeProxyRule"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.describe_proxy_rule_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_proxy_rule(
