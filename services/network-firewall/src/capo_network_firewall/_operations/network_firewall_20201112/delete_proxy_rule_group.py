...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_proxy_rule_group_response.DeleteProxyRuleGroupResponse = capo_network_firewall.types.delete_proxy_rule_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_proxy_rule_group_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
