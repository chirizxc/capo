...
import capo_network_firewall.types.analysis_reports
...
def handle_response(
    ...
    out: capo_network_firewall.types.list_analysis_reports_response.ListAnalysisReportsResponse = capo_network_firewall.types.list_analysis_reports_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_analysis_reports_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
