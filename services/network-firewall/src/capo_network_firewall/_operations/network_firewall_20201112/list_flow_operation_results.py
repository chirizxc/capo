"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListFlowOperationResults``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.list_flow_operation_results_response.ListFlowOperationResultsResponse = capo_network_firewall.types.list_flow_operation_results_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.ListFlowOperationResults"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_flow_operation_results_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_flow_operation_results(
