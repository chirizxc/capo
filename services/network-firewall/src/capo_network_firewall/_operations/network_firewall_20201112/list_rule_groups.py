"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListRuleGroups``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.list_rule_groups_response.ListRuleGroupsResponse = capo_network_firewall.types.list_rule_groups_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.ListRuleGroups"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_rule_groups_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
