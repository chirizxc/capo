"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListProxyRuleGroups``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.list_proxy_rule_groups_response.ListProxyRuleGroupsResponse = capo_network_firewall.types.list_proxy_rule_groups_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.ListProxyRuleGroups"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_proxy_rule_groups_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_proxy_rule_groups(
