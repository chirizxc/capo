"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DescribeResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.describe_resource_policy_response.DescribeResourcePolicyResponse = capo_network_firewall.types.describe_resource_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DescribeResourcePolicy"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.describe_resource_policy_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
