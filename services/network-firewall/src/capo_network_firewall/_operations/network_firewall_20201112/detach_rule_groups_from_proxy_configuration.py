...
def handle_response(
    ...
    out: capo_network_firewall.types.detach_rule_groups_from_proxy_configuration_response.DetachRuleGroupsFromProxyConfigurationResponse = capo_network_firewall.types.detach_rule_groups_from_proxy_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.detach_rule_groups_from_proxy_configuration_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
