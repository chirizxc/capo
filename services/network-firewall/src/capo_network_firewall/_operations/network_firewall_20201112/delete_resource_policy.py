"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DeleteResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.delete_resource_policy_response.DeleteResourcePolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.DeleteResourcePolicy"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.delete_resource_policy_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
