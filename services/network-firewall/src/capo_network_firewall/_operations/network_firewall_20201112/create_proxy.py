...
def handle_response(
    ...
    out: capo_network_firewall.types.create_proxy_response.CreateProxyResponse = (
        capo_network_firewall.types.create_proxy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.create_proxy_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
