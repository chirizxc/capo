"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UpdateSubnetChangeProtection``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.update_subnet_change_protection_response.UpdateSubnetChangeProtectionResponse = capo_network_firewall.types.update_subnet_change_protection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.UpdateSubnetChangeProtection"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_subnet_change_protection_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_subnet_change_protection(
