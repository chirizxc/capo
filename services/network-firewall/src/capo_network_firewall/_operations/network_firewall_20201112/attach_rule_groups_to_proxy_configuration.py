"""Generated from Smithy shape ``com.amazonaws.networkfirewall#AttachRuleGroupsToProxyConfiguration``."""
...
def handle_response(
    ...
    out: capo_network_firewall.types.attach_rule_groups_to_proxy_configuration_response.AttachRuleGroupsToProxyConfigurationResponse = capo_network_firewall.types.attach_rule_groups_to_proxy_configuration_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.attach_rule_groups_to_proxy_configuration_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_attach_rule_groups_to_proxy_configuration(
