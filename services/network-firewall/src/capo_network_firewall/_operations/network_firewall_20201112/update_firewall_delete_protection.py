...
def handle_response(
    ...
    out: capo_network_firewall.types.update_firewall_delete_protection_response.UpdateFirewallDeleteProtectionResponse = capo_network_firewall.types.update_firewall_delete_protection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_network_firewall.types.update_firewall_delete_protection_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
