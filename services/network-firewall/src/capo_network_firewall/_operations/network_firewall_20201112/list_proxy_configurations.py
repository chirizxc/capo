"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListProxyConfigurations``."""
...
import capo_network_firewall.types.proxy_configurations
...
def handle_response(
    ...
    out: capo_network_firewall.types.list_proxy_configurations_response.ListProxyConfigurationsResponse = capo_network_firewall.types.list_proxy_configurations_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "NetworkFirewall_20201112.ListProxyConfigurations"
    body: bytes | None = json.dumps(
        capo_network_firewall.types.list_proxy_configurations_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_proxy_configurations(
