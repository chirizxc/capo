"""Generated from Smithy shape ``com.amazonaws.networkfirewall#UnsupportedOperationException``."""
...
class UnsupportedOperationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.networkfirewall#UnsupportedOperationException``."""
