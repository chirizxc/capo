"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.networkfirewall#ResourceNotFoundException``."""
