"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListAnalysisReportsRequest``."""
...
class ListAnalysisReportsRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListAnalysisReportsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListAnalysisReportsRequest:
    out: ListAnalysisReportsRequest = {}  # type: ignore[typeddict-item]
