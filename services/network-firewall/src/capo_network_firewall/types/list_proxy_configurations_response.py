...
class ListProxyConfigurationsResponse(TypedDict, closed=True):
    proxy_configurations: NotRequired[
        "capo_network_firewall.types.proxy_configurations.ProxyConfigurations"
    ]
...
def serialize_aws_json_1_0(value: ListProxyConfigurationsResponse) -> dict:
    ...
    if "proxy_configurations" in value:
        ...
        out["ProxyConfigurations"] = (
            capo_network_firewall.types.proxy_configurations.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListProxyConfigurationsResponse:
    ...
    if data.get("ProxyConfigurations") is not None:
        import capo_network_firewall.types.proxy_configurations

        out["proxy_configurations"] = (
            capo_network_firewall.types.proxy_configurations.deserialize_aws_json_1_0(
