"""Generated from Smithy shape ``com.amazonaws.networkfirewall#ListTLSInspectionConfigurationsRequest``."""
...
class ListTLSInspectionConfigurationsRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: ListTLSInspectionConfigurationsRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> ListTLSInspectionConfigurationsRequest:
    out: ListTLSInspectionConfigurationsRequest = {}  # type: ignore[typeddict-item]
