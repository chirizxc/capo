"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DescribeProxyConfigurationRequest``."""
...
class DescribeProxyConfigurationRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DescribeProxyConfigurationRequest) -> dict:
    out: dict = {}
