...
class UpdateProxyRuleGroupPrioritiesResponse(TypedDict, closed=True):
    proxy_rule_groups: NotRequired[
        "capo_network_firewall.types.proxy_rule_group_priority_result_list.ProxyRuleGroupPriorityResultList"
    ]
...
def serialize_aws_json_1_0(value: UpdateProxyRuleGroupPrioritiesResponse) -> dict:
    ...
    if "proxy_rule_groups" in value:
        ...
        out["ProxyRuleGroups"] = (
            capo_network_firewall.types.proxy_rule_group_priority_result_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> UpdateProxyRuleGroupPrioritiesResponse:
    ...
    if data.get("ProxyRuleGroups") is not None:
        ...
        out["proxy_rule_groups"] = (
            capo_network_firewall.types.proxy_rule_group_priority_result_list.deserialize_aws_json_1_0(
