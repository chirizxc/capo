...
def serialize_aws_json_1_0(value: UpdateProxyRuleGroupPrioritiesRequest) -> dict:
    ...
    out["RuleGroups"] = (
        capo_network_firewall.types.proxy_rule_group_priority_list.serialize_aws_json_1_0(
            value["rule_groups"]
        )
    )
...
def deserialize_aws_json_1_0(data: dict) -> UpdateProxyRuleGroupPrioritiesRequest:
    ...
    if data.get("RuleGroups") is not None:
        ...
        out["rule_groups"] = (
            capo_network_firewall.types.proxy_rule_group_priority_list.deserialize_aws_json_1_0(
                data["RuleGroups"]
            )
        )
    else:
