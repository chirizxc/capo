"""Generated from Smithy shape ``com.amazonaws.networkfirewall#DeleteFirewallPolicyRequest``."""
...
class DeleteFirewallPolicyRequest(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: DeleteFirewallPolicyRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> DeleteFirewallPolicyRequest:
    out: DeleteFirewallPolicyRequest = {}  # type: ignore[typeddict-item]
