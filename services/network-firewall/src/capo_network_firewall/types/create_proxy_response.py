"""Generated from Smithy shape ``com.amazonaws.networkfirewall#CreateProxyResponse``."""
...
class CreateProxyResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateProxyResponse) -> dict:
    out: dict = {}
    if "proxy" in value:
        import capo_network_firewall.types.proxy
