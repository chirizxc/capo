"""Generated from Smithy shape ``com.amazonaws.networkfirewall#CreateProxyConfigurationResponse``."""
...
class CreateProxyConfigurationResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateProxyConfigurationResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> CreateProxyConfigurationResponse:
    out: CreateProxyConfigurationResponse = {}  # type: ignore[typeddict-item]
