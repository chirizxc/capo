"""Generated from Smithy shape ``com.amazonaws.iotdataplane#ServiceUnavailableException``."""
...
class ServiceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.iotdataplane#ServiceUnavailableException``."""
