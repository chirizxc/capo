...
def handle_response(
    ...
    out: capo_iot_data_plane.types.list_subscriptions_response.ListSubscriptionsResponse = capo_iot_data_plane.types.list_subscriptions_response.deserialize_json(
