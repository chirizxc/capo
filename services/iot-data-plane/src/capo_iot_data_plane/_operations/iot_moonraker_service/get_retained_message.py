...
def handle_response(
    ...
    out: capo_iot_data_plane.types.get_retained_message_response.GetRetainedMessageResponse = capo_iot_data_plane.types.get_retained_message_response.deserialize_json(
