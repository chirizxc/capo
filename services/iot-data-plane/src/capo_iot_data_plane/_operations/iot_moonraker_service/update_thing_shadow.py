...
import capo_iot_data_plane.errors.conflict_exception
...
import capo_iot_data_plane.errors.unsupported_document_encoding_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_iot_data_plane.errors.conflict_exception.ConflictException.from_json(
                data, message
            )
        ...
        case "UnsupportedDocumentEncodingException":
            raise capo_iot_data_plane.errors.unsupported_document_encoding_exception.UnsupportedDocumentEncodingException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_iot_data_plane.types.update_thing_shadow_response.UpdateThingShadowResponse = {
...
def build_request(
    ...
    if "shadow_name" in input_:
        params.append(("name", input_["shadow_name"]))
