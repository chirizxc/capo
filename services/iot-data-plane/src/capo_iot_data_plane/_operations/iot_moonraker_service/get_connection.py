"""Generated from Smithy shape ``com.amazonaws.iotdataplane#GetConnection``."""
...
def handle_response(
    ...
    out: capo_iot_data_plane.types.get_connection_response.GetConnectionResponse = (
        capo_iot_data_plane.types.get_connection_response.deserialize_json(
...
def build_request(
    ...
    params.append(
        (
            ...
            "true" if input_.get("include_socket_information", False) else "false",
        )
    )
