"""Generated from Smithy shape ``com.amazonaws.groundstation#CreateMissionProfile``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.mission_profile_id_response.MissionProfileIdResponse = capo_groundstation.types.mission_profile_id_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.create_mission_profile_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_mission_profile(
