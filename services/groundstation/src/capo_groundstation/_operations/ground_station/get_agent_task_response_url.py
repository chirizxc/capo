...
def handle_response(
    ...
    out: capo_groundstation.types.get_agent_task_response_url_response.GetAgentTaskResponseUrlResponse = capo_groundstation.types.get_agent_task_response_url_response.deserialize_json(
