"""Generated from Smithy shape ``com.amazonaws.groundstation#ListConfigs``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.list_configs_response.ListConfigsResponse = (
        capo_groundstation.types.list_configs_response.deserialize_json(
...
def list_configs(
    ...
    capo_groundstation.types.list_configs_response.ListConfigsResponse, zapros.Response
]:
