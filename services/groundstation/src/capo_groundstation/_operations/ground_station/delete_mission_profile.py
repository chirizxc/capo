"""Generated from Smithy shape ``com.amazonaws.groundstation#DeleteMissionProfile``."""
...
def build_request(
    ...
    url = url.replace(
        "{missionProfileId}", quote(input_["mission_profile_id"], safe="")
    )
...
async def async_delete_mission_profile(
