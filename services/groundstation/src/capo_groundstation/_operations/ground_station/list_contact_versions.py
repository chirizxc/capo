"""Generated from Smithy shape ``com.amazonaws.groundstation#ListContactVersions``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.list_contact_versions_response.ListContactVersionsResponse = capo_groundstation.types.list_contact_versions_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{contactId}", quote(input_["contact_id"], safe=""))
...
async def async_list_contact_versions(
