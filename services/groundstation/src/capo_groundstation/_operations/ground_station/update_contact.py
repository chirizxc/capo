...
def handle_response(
    ...
    out: capo_groundstation.types.update_contact_response.UpdateContactResponse = (
        capo_groundstation.types.update_contact_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.update_contact_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
