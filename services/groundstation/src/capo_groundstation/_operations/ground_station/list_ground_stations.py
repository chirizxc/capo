...
def handle_response(
    ...
    out: capo_groundstation.types.list_ground_stations_response.ListGroundStationsResponse = capo_groundstation.types.list_ground_stations_response.deserialize_json(
...
def build_request(
    ...
    if "satellite_id" in input_:
        params.append(("satelliteId", input_["satellite_id"]))
