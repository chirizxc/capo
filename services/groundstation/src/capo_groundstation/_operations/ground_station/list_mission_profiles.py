...
def handle_response(
    ...
    out: capo_groundstation.types.list_mission_profiles_response.ListMissionProfilesResponse = capo_groundstation.types.list_mission_profiles_response.deserialize_json(
