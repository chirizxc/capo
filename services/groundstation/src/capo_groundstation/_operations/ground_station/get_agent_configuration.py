"""Generated from Smithy shape ``com.amazonaws.groundstation#GetAgentConfiguration``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.get_agent_configuration_response.GetAgentConfigurationResponse = capo_groundstation.types.get_agent_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/agent/{agentId}/configuration"
...
async def async_get_agent_configuration(
