"""Generated from Smithy shape ``com.amazonaws.groundstation#DescribeContact``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.describe_contact_response.DescribeContactResponse = (
        capo_groundstation.types.describe_contact_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/contact/{contactId}"
