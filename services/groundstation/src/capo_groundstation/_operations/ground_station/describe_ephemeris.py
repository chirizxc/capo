"""Generated from Smithy shape ``com.amazonaws.groundstation#DescribeEphemeris``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.describe_ephemeris_response.DescribeEphemerisResponse = capo_groundstation.types.describe_ephemeris_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ephemerisId}", quote(input_["ephemeris_id"], safe=""))
...
async def async_describe_ephemeris(
