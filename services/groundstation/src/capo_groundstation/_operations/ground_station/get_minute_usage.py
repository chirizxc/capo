...
def handle_response(
    ...
    out: capo_groundstation.types.get_minute_usage_response.GetMinuteUsageResponse = (
        capo_groundstation.types.get_minute_usage_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.get_minute_usage_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
