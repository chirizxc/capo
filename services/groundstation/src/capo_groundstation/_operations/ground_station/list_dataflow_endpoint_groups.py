"""Generated from Smithy shape ``com.amazonaws.groundstation#ListDataflowEndpointGroups``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.list_dataflow_endpoint_groups_response.ListDataflowEndpointGroupsResponse = capo_groundstation.types.list_dataflow_endpoint_groups_response.deserialize_json(
...
async def async_list_dataflow_endpoint_groups(
