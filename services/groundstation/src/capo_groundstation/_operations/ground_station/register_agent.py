...
def handle_response(
    ...
    out: capo_groundstation.types.register_agent_response.RegisterAgentResponse = (
        capo_groundstation.types.register_agent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_groundstation.types.register_agent_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
