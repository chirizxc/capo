"""Generated from Smithy shape ``com.amazonaws.groundstation#ListSatellites``."""
...
def handle_response(
    ...
    out: capo_groundstation.types.list_satellites_response.ListSatellitesResponse = (
        capo_groundstation.types.list_satellites_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/satellite"
...
async def async_list_satellites(
