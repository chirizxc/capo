...
if TYPE_CHECKING:
    import capo_groundstation.types.component_status_data

ComponentStatusList: TypeAlias = list[
    "capo_groundstation.types.component_status_data.ComponentStatusData"
]
...
def serialize_json(value: ComponentStatusList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_groundstation.types.component_status_data.serialize_json(item))
    return out
