...
def handle_response(
    ...
    out: capo_observabilityadmin.types.update_telemetry_rule_output.UpdateTelemetryRuleOutput = capo_observabilityadmin.types.update_telemetry_rule_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.update_telemetry_rule_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
