"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#StopTelemetryEnrichment``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.stop_telemetry_enrichment_output.StopTelemetryEnrichmentOutput = capo_observabilityadmin.types.stop_telemetry_enrichment_output.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/StopTelemetryEnrichment"
...
async def async_stop_telemetry_enrichment(
