"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#CreateCentralizationRuleForOrganization``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.create_centralization_rule_for_organization_output.CreateCentralizationRuleForOrganizationOutput = capo_observabilityadmin.types.create_centralization_rule_for_organization_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.create_centralization_rule_for_organization_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_centralization_rule_for_organization(
