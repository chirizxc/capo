"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#GetTelemetryEvaluationStatusForOrganization``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.get_telemetry_evaluation_status_for_organization_output.GetTelemetryEvaluationStatusForOrganizationOutput = capo_observabilityadmin.types.get_telemetry_evaluation_status_for_organization_output.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/GetTelemetryEvaluationStatusForOrganization"
...
async def async_get_telemetry_evaluation_status_for_organization(
