...
def handle_response(
    ...
    out: capo_observabilityadmin.types.get_telemetry_enrichment_status_output.GetTelemetryEnrichmentStatusOutput = capo_observabilityadmin.types.get_telemetry_enrichment_status_output.deserialize_json(
