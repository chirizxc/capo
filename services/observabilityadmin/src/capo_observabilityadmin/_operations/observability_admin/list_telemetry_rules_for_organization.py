...
def handle_response(
    ...
    out: capo_observabilityadmin.types.list_telemetry_rules_for_organization_output.ListTelemetryRulesForOrganizationOutput = capo_observabilityadmin.types.list_telemetry_rules_for_organization_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.list_telemetry_rules_for_organization_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
