...
def handle_response(
    ...
    out: capo_observabilityadmin.types.get_s3_table_integration_output.GetS3TableIntegrationOutput = capo_observabilityadmin.types.get_s3_table_integration_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.get_s3_table_integration_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
