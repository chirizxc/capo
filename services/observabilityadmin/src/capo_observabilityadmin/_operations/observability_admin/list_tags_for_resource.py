...
def handle_response(
    ...
    out: capo_observabilityadmin.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_observabilityadmin.types.list_tags_for_resource_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.list_tags_for_resource_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
