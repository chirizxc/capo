"""Generated from Smithy shape ``com.amazonaws.observabilityadmin#GetCentralizationRuleForOrganization``."""
...
def handle_response(
    ...
    out: capo_observabilityadmin.types.get_centralization_rule_for_organization_output.GetCentralizationRuleForOrganizationOutput = capo_observabilityadmin.types.get_centralization_rule_for_organization_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/GetCentralizationRuleForOrganization"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.get_centralization_rule_for_organization_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_centralization_rule_for_organization(
