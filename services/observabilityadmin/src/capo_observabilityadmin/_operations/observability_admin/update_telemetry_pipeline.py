...
def handle_response(
    ...
    out: capo_observabilityadmin.types.update_telemetry_pipeline_output.UpdateTelemetryPipelineOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_observabilityadmin.types.update_telemetry_pipeline_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
