...
if TYPE_CHECKING:
    import capo_odb.types.oci_iam_role

OciIamRoleList: TypeAlias = list["capo_odb.types.oci_iam_role.OciIamRole"]
...
def serialize_aws_json_1_0(value: OciIamRoleList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_odb.types.oci_iam_role.serialize_aws_json_1_0(item))
    return out
