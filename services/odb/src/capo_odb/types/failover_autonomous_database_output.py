"""Generated from Smithy shape ``com.amazonaws.odb#FailoverAutonomousDatabaseOutput``."""
...
class FailoverAutonomousDatabaseOutput(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: FailoverAutonomousDatabaseOutput) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> FailoverAutonomousDatabaseOutput:
    out: FailoverAutonomousDatabaseOutput = {}  # type: ignore[typeddict-item]
    if data.get("autonomousDatabaseId") is not None:
        out["autonomous_database_id"] = data["autonomousDatabaseId"]
    else:
        raise DeserializationError(
            "FailoverAutonomousDatabaseOutput.autonomous_database_id required"
        )
