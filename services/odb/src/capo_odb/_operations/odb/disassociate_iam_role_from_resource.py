...
def handle_response(
    ...
    out: capo_odb.types.disassociate_iam_role_from_resource_output.DisassociateIamRoleFromResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.disassociate_iam_role_from_resource_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
