...
def handle_response(
    ...
    out: capo_odb.types.list_autonomous_database_clones_output.ListAutonomousDatabaseClonesOutput = capo_odb.types.list_autonomous_database_clones_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.list_autonomous_database_clones_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
