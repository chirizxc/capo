...
import capo_odb.types.cloud_vm_cluster
...
def handle_response(
    ...
    out: capo_odb.types.get_cloud_vm_cluster_output.GetCloudVmClusterOutput = (
        capo_odb.types.get_cloud_vm_cluster_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.get_cloud_vm_cluster_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_cloud_vm_cluster(
    ...
    capo_odb.types.get_cloud_vm_cluster_output.GetCloudVmClusterOutput, zapros.Response
]:
