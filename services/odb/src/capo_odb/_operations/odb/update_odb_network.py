...
def handle_response(
    ...
    out: capo_odb.types.update_odb_network_output.UpdateOdbNetworkOutput = (
        capo_odb.types.update_odb_network_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.update_odb_network_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def update_odb_network(
    ...
    capo_odb.types.update_odb_network_output.UpdateOdbNetworkOutput, zapros.Response
]:
