"""Generated from Smithy shape ``com.amazonaws.odb#ListAutonomousDatabasePeers``."""
...
def handle_response(
    ...
    out: capo_odb.types.list_autonomous_database_peers_output.ListAutonomousDatabasePeersOutput = capo_odb.types.list_autonomous_database_peers_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.ListAutonomousDatabasePeers"
    body: bytes | None = json.dumps(
        capo_odb.types.list_autonomous_database_peers_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_autonomous_database_peers(
