...
def handle_response(
    ...
    out: capo_odb.types.get_odb_network_output.GetOdbNetworkOutput = (
        capo_odb.types.get_odb_network_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.get_odb_network_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_odb_network(
    ...
    input_: capo_odb.types.get_odb_network_input.GetOdbNetworkInput,
) -> tuple[capo_odb.types.get_odb_network_output.GetOdbNetworkOutput, zapros.Response]:
