"""Generated from Smithy shape ``com.amazonaws.odb#DeleteCloudExadataInfrastructure``."""
...
def handle_response(
    ...
    out: capo_odb.types.delete_cloud_exadata_infrastructure_output.DeleteCloudExadataInfrastructureOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.DeleteCloudExadataInfrastructure"
    body: bytes | None = json.dumps(
        capo_odb.types.delete_cloud_exadata_infrastructure_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_cloud_exadata_infrastructure(
