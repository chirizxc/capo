"""Generated from Smithy shape ``com.amazonaws.odb#DeleteAutonomousDatabase``."""
...
def handle_response(
    ...
    out: capo_odb.types.delete_autonomous_database_output.DeleteAutonomousDatabaseOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.DeleteAutonomousDatabase"
    body: bytes | None = json.dumps(
        capo_odb.types.delete_autonomous_database_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_delete_autonomous_database(
