...
def handle_response(
    ...
    out: capo_odb.types.update_odb_peering_connection_output.UpdateOdbPeeringConnectionOutput = capo_odb.types.update_odb_peering_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.update_odb_peering_connection_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
