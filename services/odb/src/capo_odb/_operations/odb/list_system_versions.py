"""Generated from Smithy shape ``com.amazonaws.odb#ListSystemVersions``."""
...
def handle_response(
    ...
    out: capo_odb.types.list_system_versions_output.ListSystemVersionsOutput = (
        capo_odb.types.list_system_versions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.ListSystemVersions"
    body: bytes | None = json.dumps(
        capo_odb.types.list_system_versions_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_system_versions(
    ...
    capo_odb.types.list_system_versions_output.ListSystemVersionsOutput, zapros.Response
]:
...
async def async_list_system_versions(
