...
def handle_response(
    ...
    out: capo_odb.types.update_autonomous_database_backup_output.UpdateAutonomousDatabaseBackupOutput = capo_odb.types.update_autonomous_database_backup_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.update_autonomous_database_backup_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
