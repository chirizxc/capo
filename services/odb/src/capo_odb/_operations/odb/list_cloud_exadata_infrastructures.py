...
def handle_response(
    ...
    out: capo_odb.types.list_cloud_exadata_infrastructures_output.ListCloudExadataInfrastructuresOutput = capo_odb.types.list_cloud_exadata_infrastructures_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.list_cloud_exadata_infrastructures_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
