...
def handle_response(
    ...
    out: capo_odb.types.list_gi_versions_output.ListGiVersionsOutput = (
        capo_odb.types.list_gi_versions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.list_gi_versions_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_gi_versions(
    ...
    capo_odb.types.list_gi_versions_output.ListGiVersionsOutput, zapros.Response
]:
