...
def handle_response(
    ...
    out: capo_odb.types.initialize_service_output.InitializeServiceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.initialize_service_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def initialize_service(
    ...
    capo_odb.types.initialize_service_output.InitializeServiceOutput, zapros.Response
]:
