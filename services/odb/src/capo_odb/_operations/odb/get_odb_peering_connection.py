"""Generated from Smithy shape ``com.amazonaws.odb#GetOdbPeeringConnection``."""
...
def handle_response(
    ...
    out: capo_odb.types.get_odb_peering_connection_output.GetOdbPeeringConnectionOutput = capo_odb.types.get_odb_peering_connection_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.GetOdbPeeringConnection"
    body: bytes | None = json.dumps(
        capo_odb.types.get_odb_peering_connection_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_odb_peering_connection(
