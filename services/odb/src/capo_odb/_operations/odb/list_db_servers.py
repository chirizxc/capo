...
def handle_response(
    ...
    out: capo_odb.types.list_db_servers_output.ListDbServersOutput = (
        capo_odb.types.list_db_servers_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.list_db_servers_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_db_servers(
    ...
    input_: capo_odb.types.list_db_servers_input.ListDbServersInput,
) -> tuple[capo_odb.types.list_db_servers_output.ListDbServersOutput, zapros.Response]:
