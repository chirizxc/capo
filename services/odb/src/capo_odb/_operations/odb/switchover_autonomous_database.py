"""Generated from Smithy shape ``com.amazonaws.odb#SwitchoverAutonomousDatabase``."""
...
def handle_response(
    ...
    out: capo_odb.types.switchover_autonomous_database_output.SwitchoverAutonomousDatabaseOutput = capo_odb.types.switchover_autonomous_database_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.SwitchoverAutonomousDatabase"
    body: bytes | None = json.dumps(
        capo_odb.types.switchover_autonomous_database_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_switchover_autonomous_database(
