...
def handle_response(
    ...
    out: capo_odb.types.get_cloud_exadata_infrastructure_output.GetCloudExadataInfrastructureOutput = capo_odb.types.get_cloud_exadata_infrastructure_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.get_cloud_exadata_infrastructure_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
