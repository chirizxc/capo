...
def handle_response(
    ...
    out: capo_odb.types.list_db_nodes_output.ListDbNodesOutput = (
        capo_odb.types.list_db_nodes_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.list_db_nodes_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_db_nodes(
    ...
    input_: capo_odb.types.list_db_nodes_input.ListDbNodesInput,
) -> tuple[capo_odb.types.list_db_nodes_output.ListDbNodesOutput, zapros.Response]:
