"""Generated from Smithy shape ``com.amazonaws.odb#AssociateIamRoleToResource``."""
...
def handle_response(
    ...
    out: capo_odb.types.associate_iam_role_to_resource_output.AssociateIamRoleToResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.AssociateIamRoleToResource"
    body: bytes | None = json.dumps(
        capo_odb.types.associate_iam_role_to_resource_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
