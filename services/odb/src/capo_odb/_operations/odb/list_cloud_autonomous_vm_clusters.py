"""Generated from Smithy shape ``com.amazonaws.odb#ListCloudAutonomousVmClusters``."""
...
def handle_response(
    ...
    out: capo_odb.types.list_cloud_autonomous_vm_clusters_output.ListCloudAutonomousVmClustersOutput = capo_odb.types.list_cloud_autonomous_vm_clusters_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.ListCloudAutonomousVmClusters"
    body: bytes | None = json.dumps(
        capo_odb.types.list_cloud_autonomous_vm_clusters_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_cloud_autonomous_vm_clusters(
