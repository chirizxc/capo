...
def handle_response(
    ...
    out: capo_odb.types.list_db_system_shapes_output.ListDbSystemShapesOutput = (
        capo_odb.types.list_db_system_shapes_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.list_db_system_shapes_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
