...
def handle_response(
    ...
    out: capo_odb.types.list_odb_peering_connections_output.ListOdbPeeringConnectionsOutput = capo_odb.types.list_odb_peering_connections_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.list_odb_peering_connections_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
