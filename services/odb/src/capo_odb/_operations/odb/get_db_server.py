...
def handle_response(
    ...
    out: capo_odb.types.get_db_server_output.GetDbServerOutput = (
        capo_odb.types.get_db_server_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.get_db_server_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_db_server(
    ...
    input_: capo_odb.types.get_db_server_input.GetDbServerInput,
) -> tuple[capo_odb.types.get_db_server_output.GetDbServerOutput, zapros.Response]:
