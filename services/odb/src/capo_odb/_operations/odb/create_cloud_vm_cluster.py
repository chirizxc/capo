...
def handle_response(
    ...
    out: capo_odb.types.create_cloud_vm_cluster_output.CreateCloudVmClusterOutput = (
        capo_odb.types.create_cloud_vm_cluster_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.create_cloud_vm_cluster_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
