"""Generated from Smithy shape ``com.amazonaws.odb#ListAutonomousDatabaseVersions``."""
...
def handle_response(
    ...
    out: capo_odb.types.list_autonomous_database_versions_output.ListAutonomousDatabaseVersionsOutput = capo_odb.types.list_autonomous_database_versions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Odb.ListAutonomousDatabaseVersions"
    body: bytes | None = json.dumps(
        capo_odb.types.list_autonomous_database_versions_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_autonomous_database_versions(
