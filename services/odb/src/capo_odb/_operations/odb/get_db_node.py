...
def handle_response(
    ...
    out: capo_odb.types.get_db_node_output.GetDbNodeOutput = (
        capo_odb.types.get_db_node_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_odb.types.get_db_node_input.serialize_aws_json_1_0(input_), allow_nan=False
    ).encode()
...
def get_db_node(
    options: OperationOptions, input_: capo_odb.types.get_db_node_input.GetDbNodeInput
) -> tuple[capo_odb.types.get_db_node_output.GetDbNodeOutput, zapros.Response]:
