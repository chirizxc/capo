"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#BatchGetCollectionGroup``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.batch_get_collection_group_response.BatchGetCollectionGroupResponse = capo_opensearchserverless.types.batch_get_collection_group_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.BatchGetCollectionGroup"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.batch_get_collection_group_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_get_collection_group(
