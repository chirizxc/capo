...
def handle_response(
    ...
    out: capo_opensearchserverless.types.list_collection_groups_response.ListCollectionGroupsResponse = capo_opensearchserverless.types.list_collection_groups_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.list_collection_groups_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
