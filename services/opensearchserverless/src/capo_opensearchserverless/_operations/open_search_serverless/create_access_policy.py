...
def handle_response(
    ...
    out: capo_opensearchserverless.types.create_access_policy_response.CreateAccessPolicyResponse = capo_opensearchserverless.types.create_access_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.create_access_policy_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
