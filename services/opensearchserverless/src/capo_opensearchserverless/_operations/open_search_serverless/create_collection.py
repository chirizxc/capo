...
import capo_opensearchserverless.errors.ocu_limit_exceeded_exception
...
import capo_opensearchserverless.types.create_collection_detail
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "OcuLimitExceededException":
            raise capo_opensearchserverless.errors.ocu_limit_exceeded_exception.OcuLimitExceededException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.create_collection_response.CreateCollectionResponse = capo_opensearchserverless.types.create_collection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.create_collection_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
