...
def handle_response(
    ...
    out: capo_opensearchserverless.types.update_lifecycle_policy_response.UpdateLifecyclePolicyResponse = capo_opensearchserverless.types.update_lifecycle_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.update_lifecycle_policy_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
