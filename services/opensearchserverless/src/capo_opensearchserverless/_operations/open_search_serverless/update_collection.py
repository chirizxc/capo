...
def handle_response(
    ...
    out: capo_opensearchserverless.types.update_collection_response.UpdateCollectionResponse = capo_opensearchserverless.types.update_collection_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.update_collection_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
