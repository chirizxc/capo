...
def handle_response(
    ...
    out: capo_opensearchserverless.types.delete_index_response.DeleteIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.delete_index_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
