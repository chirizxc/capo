"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#GetPoliciesStats``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.get_policies_stats_response.GetPoliciesStatsResponse = capo_opensearchserverless.types.get_policies_stats_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.GetPoliciesStats"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.get_policies_stats_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_policies_stats(
