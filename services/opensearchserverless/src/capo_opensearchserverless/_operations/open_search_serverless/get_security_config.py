"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#GetSecurityConfig``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.get_security_config_response.GetSecurityConfigResponse = capo_opensearchserverless.types.get_security_config_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.GetSecurityConfig"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.get_security_config_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
