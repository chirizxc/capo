"""Generated from Smithy shape ``com.amazonaws.opensearchserverless#GetSecurityPolicy``."""
...
def handle_response(
    ...
    out: capo_opensearchserverless.types.get_security_policy_response.GetSecurityPolicyResponse = capo_opensearchserverless.types.get_security_policy_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "OpenSearchServerless.GetSecurityPolicy"
    body: bytes | None = json.dumps(
        capo_opensearchserverless.types.get_security_policy_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_security_policy(
