...
class DeleteCollectionResponse(TypedDict, closed=True):
    delete_collection_detail: NotRequired[
        "capo_opensearchserverless.types.delete_collection_detail.DeleteCollectionDetail"
    ]
...
def serialize_aws_json_1_0(value: DeleteCollectionResponse) -> dict:
    ...
    if "delete_collection_detail" in value:
        ...
        out["deleteCollectionDetail"] = (
            capo_opensearchserverless.types.delete_collection_detail.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> DeleteCollectionResponse:
    ...
    if data.get("deleteCollectionDetail") is not None:
        import capo_opensearchserverless.types.delete_collection_detail

        out["delete_collection_detail"] = (
            capo_opensearchserverless.types.delete_collection_detail.deserialize_aws_json_1_0(
