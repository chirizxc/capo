...
if TYPE_CHECKING:
    ...
    import capo_opensearchserverless.types.resource_type
...
class EffectiveLifecyclePolicyDetail(TypedDict, closed=True):
    ...
    policy_name: NotRequired["capo_opensearchserverless.types.policy_name.PolicyName"]
    """<p>The name of the lifecycle policy.</p>"""
    resource_type: NotRequired[
        "capo_opensearchserverless.types.resource_type.ResourceType"
    ]
