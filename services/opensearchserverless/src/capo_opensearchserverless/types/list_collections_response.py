...
class ListCollectionsResponse(TypedDict, closed=True):
    collection_summaries: NotRequired[
        "capo_opensearchserverless.types.collection_summaries.CollectionSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListCollectionsResponse) -> dict:
    ...
    if "collection_summaries" in value:
        ...
        out["collectionSummaries"] = (
            capo_opensearchserverless.types.collection_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListCollectionsResponse:
    ...
    if data.get("collectionSummaries") is not None:
        import capo_opensearchserverless.types.collection_summaries

        out["collection_summaries"] = (
            capo_opensearchserverless.types.collection_summaries.deserialize_aws_json_1_0(
