...
class CreateCollectionResponse(TypedDict, closed=True):
    create_collection_detail: NotRequired[
        "capo_opensearchserverless.types.create_collection_detail.CreateCollectionDetail"
    ]
...
def serialize_aws_json_1_0(value: CreateCollectionResponse) -> dict:
    ...
    if "create_collection_detail" in value:
        ...
        out["createCollectionDetail"] = (
            capo_opensearchserverless.types.create_collection_detail.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CreateCollectionResponse:
    ...
    if data.get("createCollectionDetail") is not None:
        import capo_opensearchserverless.types.create_collection_detail

        out["create_collection_detail"] = (
            capo_opensearchserverless.types.create_collection_detail.deserialize_aws_json_1_0(
