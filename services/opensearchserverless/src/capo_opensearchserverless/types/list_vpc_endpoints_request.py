...
def serialize_aws_json_1_0(value: ListVpcEndpointsRequest) -> dict:
    ...
    if "vpc_endpoint_filters" in value:
        ...
        out["vpcEndpointFilters"] = (
            capo_opensearchserverless.types.vpc_endpoint_filters.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListVpcEndpointsRequest:
    ...
    if data.get("vpcEndpointFilters") is not None:
        import capo_opensearchserverless.types.vpc_endpoint_filters

        out["vpc_endpoint_filters"] = (
            capo_opensearchserverless.types.vpc_endpoint_filters.deserialize_aws_json_1_0(
