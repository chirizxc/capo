...
class ListLifecyclePoliciesResponse(TypedDict, closed=True):
    lifecycle_policy_summaries: NotRequired[
        "capo_opensearchserverless.types.lifecycle_policy_summaries.LifecyclePolicySummaries"
    ]
...
def serialize_aws_json_1_0(value: ListLifecyclePoliciesResponse) -> dict:
    ...
    if "lifecycle_policy_summaries" in value:
        ...
        out["lifecyclePolicySummaries"] = (
            capo_opensearchserverless.types.lifecycle_policy_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListLifecyclePoliciesResponse:
    ...
    if data.get("lifecyclePolicySummaries") is not None:
        import capo_opensearchserverless.types.lifecycle_policy_summaries

        out["lifecycle_policy_summaries"] = (
            capo_opensearchserverless.types.lifecycle_policy_summaries.deserialize_aws_json_1_0(
