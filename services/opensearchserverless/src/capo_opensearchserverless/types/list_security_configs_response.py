...
class ListSecurityConfigsResponse(TypedDict, closed=True):
    security_config_summaries: NotRequired[
        "capo_opensearchserverless.types.security_config_summaries.SecurityConfigSummaries"
    ]
...
def serialize_aws_json_1_0(value: ListSecurityConfigsResponse) -> dict:
    ...
    if "security_config_summaries" in value:
        ...
        out["securityConfigSummaries"] = (
            capo_opensearchserverless.types.security_config_summaries.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ListSecurityConfigsResponse:
    ...
    if data.get("securityConfigSummaries") is not None:
        import capo_opensearchserverless.types.security_config_summaries

        out["security_config_summaries"] = (
            capo_opensearchserverless.types.security_config_summaries.deserialize_aws_json_1_0(
