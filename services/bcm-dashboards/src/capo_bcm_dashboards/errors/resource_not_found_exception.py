"""Generated from Smithy shape ``com.amazonaws.bcmdashboards#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bcmdashboards#ResourceNotFoundException``."""
