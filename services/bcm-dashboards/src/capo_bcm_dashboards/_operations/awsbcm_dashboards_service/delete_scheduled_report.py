...
def handle_response(
    ...
    out: capo_bcm_dashboards.types.delete_scheduled_report_response.DeleteScheduledReportResponse = capo_bcm_dashboards.types.delete_scheduled_report_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_dashboards.types.delete_scheduled_report_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
