...
def handle_response(
    ...
    out: capo_bcm_dashboards.types.update_dashboard_response.UpdateDashboardResponse = (
        capo_bcm_dashboards.types.update_dashboard_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_bcm_dashboards.types.update_dashboard_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
