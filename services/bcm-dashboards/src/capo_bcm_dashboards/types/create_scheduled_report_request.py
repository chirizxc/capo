...
class CreateScheduledReportRequest(TypedDict, closed=True):
    scheduled_report: (
        "capo_bcm_dashboards.types.scheduled_report_input.ScheduledReportInput"
    )
...
def serialize_aws_json_1_0(value: CreateScheduledReportRequest) -> dict:
    ...
    out["scheduledReport"] = (
        capo_bcm_dashboards.types.scheduled_report_input.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> CreateScheduledReportRequest:
    ...
    if data.get("scheduledReport") is not None:
        ...
        out["scheduled_report"] = (
            capo_bcm_dashboards.types.scheduled_report_input.deserialize_aws_json_1_0(
