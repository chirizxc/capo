...
class GetScheduledReportResponse(TypedDict, closed=True):
    scheduled_report: "capo_bcm_dashboards.types.scheduled_report.ScheduledReport"
...
def serialize_aws_json_1_0(value: GetScheduledReportResponse) -> dict:
    ...
    out["scheduledReport"] = (
        capo_bcm_dashboards.types.scheduled_report.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> GetScheduledReportResponse:
    ...
    if data.get("scheduledReport") is not None:
        ...
        out["scheduled_report"] = (
            capo_bcm_dashboards.types.scheduled_report.deserialize_aws_json_1_0(
