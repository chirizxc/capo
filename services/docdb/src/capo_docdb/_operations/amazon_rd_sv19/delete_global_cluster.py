...
def handle_response(
    ...
    out: capo_docdb.types.delete_global_cluster_result.DeleteGlobalClusterResult = (
        capo_docdb.types.delete_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.delete_global_cluster_message.serialize_query(input_, pairs, "")
