"""Generated from Smithy shape ``com.amazonaws.docdb#RemoveSourceIdentifierFromSubscription``."""
...
def handle_response(
    ...
    out: capo_docdb.types.remove_source_identifier_from_subscription_result.RemoveSourceIdentifierFromSubscriptionResult = capo_docdb.types.remove_source_identifier_from_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.remove_source_identifier_from_subscription_message.serialize_query(
        input_, pairs, ""
    )
