...
def handle_response(
    ...
    out: capo_docdb.types.event_categories_message.EventCategoriesMessage = (
        capo_docdb.types.event_categories_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_event_categories_message.serialize_query(
        input_, pairs, ""
    )
...
def describe_event_categories(
    ...
    capo_docdb.types.event_categories_message.EventCategoriesMessage, zapros.Response
]:
