"""Generated from Smithy shape ``com.amazonaws.docdb#CopyDBClusterParameterGroup``."""
...
import capo_docdb.errors.db_parameter_group_already_exists_fault
import capo_docdb.errors.db_parameter_group_not_found_fault
import capo_docdb.errors.db_parameter_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBParameterGroupAlreadyExists":
            raise capo_docdb.errors.db_parameter_group_already_exists_fault.DBParameterGroupAlreadyExistsFault.from_query(
                error_el, message
            )
        ...
        case "DBParameterGroupQuotaExceeded":
            raise capo_docdb.errors.db_parameter_group_quota_exceeded_fault.DBParameterGroupQuotaExceededFault.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_docdb.types.copy_db_cluster_parameter_group_result.CopyDBClusterParameterGroupResult = capo_docdb.types.copy_db_cluster_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.copy_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
