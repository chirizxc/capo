...
def handle_response(
    ...
    out: capo_docdb.types.failover_db_cluster_result.FailoverDBClusterResult = (
        capo_docdb.types.failover_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.failover_db_cluster_message.serialize_query(input_, pairs, "")
...
def failover_db_cluster(
    ...
    capo_docdb.types.failover_db_cluster_result.FailoverDBClusterResult, zapros.Response
]:
