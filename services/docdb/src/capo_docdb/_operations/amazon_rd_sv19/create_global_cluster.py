"""Generated from Smithy shape ``com.amazonaws.docdb#CreateGlobalCluster``."""
...
import capo_docdb.errors.global_cluster_already_exists_fault
import capo_docdb.errors.global_cluster_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "GlobalClusterAlreadyExistsFault":
            raise capo_docdb.errors.global_cluster_already_exists_fault.GlobalClusterAlreadyExistsFault.from_query(
                error_el, message
            )
        case "GlobalClusterQuotaExceededFault":
            raise capo_docdb.errors.global_cluster_quota_exceeded_fault.GlobalClusterQuotaExceededFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_docdb.types.create_global_cluster_result.CreateGlobalClusterResult = (
        capo_docdb.types.create_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.create_global_cluster_message.serialize_query(input_, pairs, "")
