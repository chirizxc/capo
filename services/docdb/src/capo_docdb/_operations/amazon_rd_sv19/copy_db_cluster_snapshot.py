...
def handle_response(
    ...
    out: capo_docdb.types.copy_db_cluster_snapshot_result.CopyDBClusterSnapshotResult = capo_docdb.types.copy_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.copy_db_cluster_snapshot_message.serialize_query(input_, pairs, "")
