"""Generated from Smithy shape ``com.amazonaws.docdb#DeleteEventSubscription``."""
...
import capo_docdb.errors.invalid_event_subscription_state_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidEventSubscriptionState":
            raise capo_docdb.errors.invalid_event_subscription_state_fault.InvalidEventSubscriptionStateFault.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_docdb.types.delete_event_subscription_result.DeleteEventSubscriptionResult = capo_docdb.types.delete_event_subscription_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.delete_event_subscription_message.serialize_query(
        input_, pairs, ""
    )
