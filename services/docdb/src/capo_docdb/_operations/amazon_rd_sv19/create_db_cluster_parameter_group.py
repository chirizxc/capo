...
def handle_response(
    ...
    out: capo_docdb.types.create_db_cluster_parameter_group_result.CreateDBClusterParameterGroupResult = capo_docdb.types.create_db_cluster_parameter_group_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.create_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
