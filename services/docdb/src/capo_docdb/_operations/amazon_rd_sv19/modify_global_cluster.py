...
def handle_response(
    ...
    out: capo_docdb.types.modify_global_cluster_result.ModifyGlobalClusterResult = (
        capo_docdb.types.modify_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.modify_global_cluster_message.serialize_query(input_, pairs, "")
