"""Generated from Smithy shape ``com.amazonaws.docdb#CreateDBSubnetGroup``."""
...
import capo_docdb.errors.db_subnet_group_already_exists_fault
import capo_docdb.errors.db_subnet_group_does_not_cover_enough_a_zs
import capo_docdb.errors.db_subnet_group_quota_exceeded_fault
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DBSubnetGroupAlreadyExists":
            raise capo_docdb.errors.db_subnet_group_already_exists_fault.DBSubnetGroupAlreadyExistsFault.from_query(
                error_el, message
            )
        ...
        case "DBSubnetGroupQuotaExceeded":
            raise capo_docdb.errors.db_subnet_group_quota_exceeded_fault.DBSubnetGroupQuotaExceededFault.from_query(
                error_el, message
            )
        ...
        case "InvalidSubnet":
            raise capo_docdb.errors.invalid_subnet.InvalidSubnet.from_query(
                error_el, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_docdb.types.create_db_subnet_group_result.CreateDBSubnetGroupResult = (
        capo_docdb.types.create_db_subnet_group_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.create_db_subnet_group_message.serialize_query(input_, pairs, "")
