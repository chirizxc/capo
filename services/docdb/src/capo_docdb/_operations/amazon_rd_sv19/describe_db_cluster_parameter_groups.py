...
def handle_response(
    ...
    out: capo_docdb.types.db_cluster_parameter_groups_message.DBClusterParameterGroupsMessage = capo_docdb.types.db_cluster_parameter_groups_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_db_cluster_parameter_groups_message.serialize_query(
        input_, pairs, ""
    )
