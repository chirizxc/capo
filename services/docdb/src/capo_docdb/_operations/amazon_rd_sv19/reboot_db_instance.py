...
def handle_response(
    ...
    out: capo_docdb.types.reboot_db_instance_result.RebootDBInstanceResult = (
        capo_docdb.types.reboot_db_instance_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.reboot_db_instance_message.serialize_query(input_, pairs, "")
...
def reboot_db_instance(
    ...
    capo_docdb.types.reboot_db_instance_result.RebootDBInstanceResult, zapros.Response
]:
