"""Generated from Smithy shape ``com.amazonaws.docdb#DeleteDBClusterSnapshot``."""
...
def handle_response(
    ...
    out: capo_docdb.types.delete_db_cluster_snapshot_result.DeleteDBClusterSnapshotResult = capo_docdb.types.delete_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.delete_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
