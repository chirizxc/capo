...
import capo_docdb.types.certificate_list
...
def handle_response(
    ...
    out: capo_docdb.types.certificate_message.CertificateMessage = (
        capo_docdb.types.certificate_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_certificates_message.serialize_query(input_, pairs, "")
...
def describe_certificates(
    ...
    input_: capo_docdb.types.describe_certificates_message.DescribeCertificatesMessage,
) -> tuple[capo_docdb.types.certificate_message.CertificateMessage, zapros.Response]:
