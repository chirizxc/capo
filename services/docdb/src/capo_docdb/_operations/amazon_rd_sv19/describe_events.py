"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeEvents``."""
...
def handle_response(
    ...
    out: capo_docdb.types.events_message.EventsMessage = (
        capo_docdb.types.events_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_events_message.serialize_query(input_, pairs, "")
...
def describe_events(
    ...
    input_: capo_docdb.types.describe_events_message.DescribeEventsMessage,
) -> tuple[capo_docdb.types.events_message.EventsMessage, zapros.Response]:
