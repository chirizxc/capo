...
def handle_response(
    ...
    out: capo_docdb.types.stop_db_cluster_result.StopDBClusterResult = (
        capo_docdb.types.stop_db_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.stop_db_cluster_message.serialize_query(input_, pairs, "")
...
def stop_db_cluster(
    ...
    capo_docdb.types.stop_db_cluster_result.StopDBClusterResult, zapros.Response
]:
