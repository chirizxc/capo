"""Generated from Smithy shape ``com.amazonaws.docdb#ModifyDBClusterParameterGroup``."""
...
def handle_response(
    ...
    out: capo_docdb.types.db_cluster_parameter_group_name_message.DBClusterParameterGroupNameMessage = capo_docdb.types.db_cluster_parameter_group_name_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.modify_db_cluster_parameter_group_message.serialize_query(
        input_, pairs, ""
    )
