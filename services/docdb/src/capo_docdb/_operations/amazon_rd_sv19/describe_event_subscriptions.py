"""Generated from Smithy shape ``com.amazonaws.docdb#DescribeEventSubscriptions``."""
...
import capo_docdb.types.event_subscriptions_list
...
def handle_response(
    ...
    out: capo_docdb.types.event_subscriptions_message.EventSubscriptionsMessage = (
        capo_docdb.types.event_subscriptions_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_event_subscriptions_message.serialize_query(
        input_, pairs, ""
    )
