"""Generated from Smithy shape ``com.amazonaws.docdb#FailoverGlobalCluster``."""
...
def handle_response(
    ...
    out: capo_docdb.types.failover_global_cluster_result.FailoverGlobalClusterResult = (
        capo_docdb.types.failover_global_cluster_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.failover_global_cluster_message.serialize_query(input_, pairs, "")
