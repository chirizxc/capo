"""Generated from Smithy shape ``com.amazonaws.docdb#CreateDBClusterSnapshot``."""
...
def handle_response(
    ...
    out: capo_docdb.types.create_db_cluster_snapshot_result.CreateDBClusterSnapshotResult = capo_docdb.types.create_db_cluster_snapshot_result.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.create_db_cluster_snapshot_message.serialize_query(
        input_, pairs, ""
    )
