"""Generated from Smithy shape ``com.amazonaws.docdb#DescribePendingMaintenanceActions``."""
...
def handle_response(
    ...
    out: capo_docdb.types.pending_maintenance_actions_message.PendingMaintenanceActionsMessage = capo_docdb.types.pending_maintenance_actions_message.deserialize_query(
...
def build_request(
    ...
    capo_docdb.types.describe_pending_maintenance_actions_message.serialize_query(
        input_, pairs, ""
    )
