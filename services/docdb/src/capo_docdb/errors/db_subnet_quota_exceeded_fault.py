"""Generated from Smithy shape ``com.amazonaws.docdb#DBSubnetQuotaExceededFault``."""
...
class DBSubnetQuotaExceededFault(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.docdb#DBSubnetQuotaExceededFault``."""
