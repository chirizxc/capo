...
class GetConfigResponse(TypedDict, closed=True):
    config_type: NotRequired["capo_cloudhsm.types.string.String"]
    """<p>The type of credentials.</p>"""
    config_file: NotRequired["capo_cloudhsm.types.string.String"]
    """<p>The chrystoki.conf configuration file.</p>"""
    config_cred: NotRequired["capo_cloudhsm.types.string.String"]
