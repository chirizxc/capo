...
from capo_chime_sdk_voice._auth._zapros_handler import AuthMiddleware
from capo_chime_sdk_voice._pagination import resolve_path as _resolve_path
from capo_chime_sdk_voice._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    ...
    import capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_request
    import capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_response
    ...
    import capo_chime_sdk_voice.types.create_sip_media_application_call_request
    import capo_chime_sdk_voice.types.create_sip_media_application_call_response
    ...
    import capo_chime_sdk_voice.types.create_sip_rule_request
    import capo_chime_sdk_voice.types.create_sip_rule_response
    ...
    import capo_chime_sdk_voice.types.create_voice_connector_request
    import capo_chime_sdk_voice.types.create_voice_connector_response
    import capo_chime_sdk_voice.types.create_voice_profile_domain_request
    import capo_chime_sdk_voice.types.create_voice_profile_domain_response
    import capo_chime_sdk_voice.types.create_voice_profile_request
    import capo_chime_sdk_voice.types.create_voice_profile_response
    import capo_chime_sdk_voice.types.credential_list
    import capo_chime_sdk_voice.types.delete_phone_number_request
    ...
    import capo_chime_sdk_voice.types.delete_sip_rule_request
    import capo_chime_sdk_voice.types.delete_voice_connector_emergency_calling_configuration_request
    ...
    import capo_chime_sdk_voice.types.delete_voice_connector_origination_request
    import capo_chime_sdk_voice.types.delete_voice_connector_proxy_request
    import capo_chime_sdk_voice.types.delete_voice_connector_request
    import capo_chime_sdk_voice.types.delete_voice_connector_streaming_configuration_request
    import capo_chime_sdk_voice.types.delete_voice_connector_termination_credentials_request
    ...
    import capo_chime_sdk_voice.types.delete_voice_profile_request
    ...
    import capo_chime_sdk_voice.types.get_global_settings_response
    import capo_chime_sdk_voice.types.get_phone_number_order_request
    import capo_chime_sdk_voice.types.get_phone_number_order_response
    import capo_chime_sdk_voice.types.get_phone_number_request
    import capo_chime_sdk_voice.types.get_phone_number_response
    import capo_chime_sdk_voice.types.get_phone_number_settings_response
    ...
    import capo_chime_sdk_voice.types.get_sip_media_application_logging_configuration_request
    import capo_chime_sdk_voice.types.get_sip_media_application_logging_configuration_response
    ...
    import capo_chime_sdk_voice.types.get_sip_rule_request
    import capo_chime_sdk_voice.types.get_sip_rule_response
    ...
    import capo_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_request
    import capo_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_response
    ...
    import capo_chime_sdk_voice.types.get_voice_connector_proxy_request
    import capo_chime_sdk_voice.types.get_voice_connector_proxy_response
    import capo_chime_sdk_voice.types.get_voice_connector_request
    import capo_chime_sdk_voice.types.get_voice_connector_response
    import capo_chime_sdk_voice.types.get_voice_connector_streaming_configuration_request
    import capo_chime_sdk_voice.types.get_voice_connector_streaming_configuration_response
    ...
    import capo_chime_sdk_voice.types.get_voice_connector_termination_request
    import capo_chime_sdk_voice.types.get_voice_connector_termination_response
    import capo_chime_sdk_voice.types.get_voice_profile_domain_request
    import capo_chime_sdk_voice.types.get_voice_profile_domain_response
    ...
    import capo_chime_sdk_voice.types.list_phone_number_orders_request
    import capo_chime_sdk_voice.types.list_phone_number_orders_response
    import capo_chime_sdk_voice.types.list_phone_numbers_request
    import capo_chime_sdk_voice.types.list_phone_numbers_response
    ...
    import capo_chime_sdk_voice.types.list_sip_media_applications_request
    import capo_chime_sdk_voice.types.list_sip_media_applications_response
    import capo_chime_sdk_voice.types.list_sip_rules_request
    import capo_chime_sdk_voice.types.list_sip_rules_response
    import capo_chime_sdk_voice.types.list_supported_phone_number_countries_request
    import capo_chime_sdk_voice.types.list_supported_phone_number_countries_response
    import capo_chime_sdk_voice.types.list_tags_for_resource_request
    import capo_chime_sdk_voice.types.list_tags_for_resource_response
    import capo_chime_sdk_voice.types.list_voice_connector_groups_request
    import capo_chime_sdk_voice.types.list_voice_connector_groups_response
    ...
    import capo_chime_sdk_voice.types.list_voice_profile_domains_request
    import capo_chime_sdk_voice.types.list_voice_profile_domains_response
    ...
    import capo_chime_sdk_voice.types.put_voice_connector_external_systems_configuration_request
    import capo_chime_sdk_voice.types.put_voice_connector_external_systems_configuration_response
    ...
    import capo_chime_sdk_voice.types.put_voice_connector_streaming_configuration_request
    import capo_chime_sdk_voice.types.put_voice_connector_streaming_configuration_response
    import capo_chime_sdk_voice.types.put_voice_connector_termination_credentials_request
    import capo_chime_sdk_voice.types.put_voice_connector_termination_request
    import capo_chime_sdk_voice.types.put_voice_connector_termination_response
    import capo_chime_sdk_voice.types.restore_phone_number_request
    import capo_chime_sdk_voice.types.restore_phone_number_response
    ...
    import capo_chime_sdk_voice.types.start_speaker_search_task_request
    import capo_chime_sdk_voice.types.start_speaker_search_task_response
    ...
    import capo_chime_sdk_voice.types.stop_speaker_search_task_request
    ...
    import capo_chime_sdk_voice.types.tag_resource_request
    ...
    import capo_chime_sdk_voice.types.update_phone_number_request
    import capo_chime_sdk_voice.types.update_phone_number_request_item_list
    import capo_chime_sdk_voice.types.update_phone_number_response
    import capo_chime_sdk_voice.types.update_phone_number_settings_request
    ...
    import capo_chime_sdk_voice.types.update_sip_media_application_call_request
    import capo_chime_sdk_voice.types.update_sip_media_application_call_response
    import capo_chime_sdk_voice.types.update_sip_media_application_request
    import capo_chime_sdk_voice.types.update_sip_media_application_response
    import capo_chime_sdk_voice.types.update_sip_rule_request
    import capo_chime_sdk_voice.types.update_sip_rule_response
    ...
    import capo_chime_sdk_voice.types.update_voice_profile_domain_request
    import capo_chime_sdk_voice.types.update_voice_profile_domain_response
    import capo_chime_sdk_voice.types.update_voice_profile_request
    import capo_chime_sdk_voice.types.update_voice_profile_response
...
class AsyncChimeSDKVoiceClient:
    ...
    async def associate_phone_numbers_with_voice_connector(
        ...
        *,
        ...
        Raises:
            ...
            capo_chime_sdk_voice.errors.unauthorized_client_exception.UnauthorizedClientException: <p>The client isn't authorized to request a resource.</p>
            capo_chime_sdk_voice.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_request.AssociatePhoneNumbersWithVoiceConnectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_response.AssociatePhoneNumbersWithVoiceConnectorResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.associate_phone_numbers_with_voice_connector

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.associate_phone_numbers_with_voice_connector.async_associate_phone_numbers_with_voice_connector(
    ...
    async def associate_phone_numbers_with_voice_connector_group(
        self,
        voice_connector_group_id: "capo_chime_sdk_voice.types.non_empty_string.NonEmptyString",
        e164_phone_numbers: "capo_chime_sdk_voice.types.e164_phone_number_list.E164PhoneNumberList",
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
        force_associate: Optional[
    ...
    ) -> "capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_response.AssociatePhoneNumbersWithVoiceConnectorGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_request.AssociatePhoneNumbersWithVoiceConnectorGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.associate_phone_numbers_with_voice_connector_group_response.AssociatePhoneNumbersWithVoiceConnectorGroupResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.associate_phone_numbers_with_voice_connector_group

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.associate_phone_numbers_with_voice_connector_group.async_associate_phone_numbers_with_voice_connector_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_delete_phone_number(
        self,
        phone_number_ids: "capo_chime_sdk_voice.types.non_empty_string_list.NonEmptyStringList",
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.batch_delete_phone_number_request.BatchDeletePhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.batch_delete_phone_number_response.BatchDeletePhoneNumberResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.batch_delete_phone_number

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.batch_delete_phone_number.async_batch_delete_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def batch_update_phone_number(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.batch_update_phone_number_response.BatchUpdatePhoneNumberResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.batch_update_phone_number_request.BatchUpdatePhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.batch_update_phone_number_response.BatchUpdatePhoneNumberResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.batch_update_phone_number

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.batch_update_phone_number.async_batch_update_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_phone_number_order(
        self,
        product_type: "capo_chime_sdk_voice.types.phone_number_product_type.PhoneNumberProductType",
        e164_phone_numbers: "capo_chime_sdk_voice.types.e164_phone_number_list.E164PhoneNumberList",
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
        name: Optional[
            "capo_chime_sdk_voice.types.phone_number_name.PhoneNumberName"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_phone_number_order_request.CreatePhoneNumberOrderRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_phone_number_order_response.CreatePhoneNumberOrderResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_phone_number_order

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_phone_number_order.async_create_phone_number_order(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_proxy_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_proxy_session_request.CreateProxySessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_proxy_session_response.CreateProxySessionResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_proxy_session

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_proxy_session.async_create_proxy_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_sip_media_application(
        ...
        name: "capo_chime_sdk_voice.types.sip_media_application_name.SipMediaApplicationName",
        ...
        *,
        ...
        Raises:
            capo_chime_sdk_voice.errors.access_denied_exception.AccessDeniedException: <p>You don't have the permissions needed to run this action.</p>
            capo_chime_sdk_voice.errors.bad_request_exception.BadRequestException: <p>The input parameters don't match the service's restrictions.</p>
            capo_chime_sdk_voice.errors.conflict_exception.ConflictException: <p>Multiple instances of the same request were made simultaneously.</p>
            capo_chime_sdk_voice.errors.forbidden_exception.ForbiddenException: <p>The client is permanently forbidden from making the request.</p>
            capo_chime_sdk_voice.errors.resource_limit_exceeded_exception.ResourceLimitExceededException: <p>The request exceeds the resource limit.</p>
            capo_chime_sdk_voice.errors.service_failure_exception.ServiceFailureException: <p>The service encountered an unexpected error.</p>
            capo_chime_sdk_voice.errors.service_unavailable_exception.ServiceUnavailableException: <p>The service is currently unavailable.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_sip_media_application_request.CreateSipMediaApplicationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_sip_media_application_response.CreateSipMediaApplicationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_sip_media_application

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_sip_media_application.async_create_sip_media_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_sip_media_application_call(
        ...
        sip_media_application_id: "capo_chime_sdk_voice.types.non_empty_string.NonEmptyString",
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
        sip_headers: Optional[
            "capo_chime_sdk_voice.types.sip_headers_map.SipHeadersMap"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_sip_media_application_call_request.CreateSipMediaApplicationCallRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_sip_media_application_call_response.CreateSipMediaApplicationCallResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_sip_media_application_call

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_sip_media_application_call.async_create_sip_media_application_call(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_sip_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_sip_rule_request.CreateSipRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_sip_rule_response.CreateSipRuleResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_sip_rule

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_sip_rule.async_create_sip_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_voice_connector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_voice_connector_request.CreateVoiceConnectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_voice_connector_response.CreateVoiceConnectorResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_voice_connector

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_voice_connector.async_create_voice_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_voice_connector_group(
        self,
        name: "capo_chime_sdk_voice.types.voice_connector_group_name.VoiceConnectorGroupName",
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_voice_connector_group_request.CreateVoiceConnectorGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_voice_connector_group_response.CreateVoiceConnectorGroupResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_voice_connector_group

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_voice_connector_group.async_create_voice_connector_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_voice_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_voice_profile_request.CreateVoiceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_voice_profile_response.CreateVoiceProfileResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_voice_profile

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_voice_profile.async_create_voice_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_voice_profile_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.create_voice_profile_domain_request.CreateVoiceProfileDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.create_voice_profile_domain_response.CreateVoiceProfileDomainResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_voice_profile_domain

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.create_voice_profile_domain.async_create_voice_profile_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_phone_number(
        self,
        phone_number_id: "capo_chime_sdk_voice.types.sensitive_non_empty_string.SensitiveNonEmptyString",
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> None:
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_phone_number_request.DeletePhoneNumberRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_phone_number

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_phone_number.async_delete_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_proxy_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_proxy_session_request.DeleteProxySessionRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_proxy_session

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_proxy_session.async_delete_proxy_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sip_media_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_sip_media_application_request.DeleteSipMediaApplicationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_sip_media_application

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_sip_media_application.async_delete_sip_media_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sip_rule(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_sip_rule_request.DeleteSipRuleRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_sip_rule

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_sip_rule.async_delete_sip_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_request.DeleteVoiceConnectorRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector.async_delete_voice_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector_emergency_calling_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_emergency_calling_configuration_request.DeleteVoiceConnectorEmergencyCallingConfigurationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_emergency_calling_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_emergency_calling_configuration.async_delete_voice_connector_emergency_calling_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector_external_systems_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_external_systems_configuration_request.DeleteVoiceConnectorExternalSystemsConfigurationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_external_systems_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_external_systems_configuration.async_delete_voice_connector_external_systems_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_group_request.DeleteVoiceConnectorGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_group

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_group.async_delete_voice_connector_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector_origination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_origination_request.DeleteVoiceConnectorOriginationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_origination

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_origination.async_delete_voice_connector_origination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector_proxy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_proxy_request.DeleteVoiceConnectorProxyRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_proxy

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_proxy.async_delete_voice_connector_proxy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector_streaming_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_streaming_configuration_request.DeleteVoiceConnectorStreamingConfigurationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_streaming_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_streaming_configuration.async_delete_voice_connector_streaming_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector_termination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_termination_request.DeleteVoiceConnectorTerminationRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_termination

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_termination.async_delete_voice_connector_termination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_connector_termination_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_connector_termination_credentials_request.DeleteVoiceConnectorTerminationCredentialsRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_termination_credentials

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_connector_termination_credentials.async_delete_voice_connector_termination_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_profile_request.DeleteVoiceProfileRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_profile

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_profile.async_delete_voice_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_voice_profile_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.delete_voice_profile_domain_request.DeleteVoiceProfileDomainRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_profile_domain

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.delete_voice_profile_domain.async_delete_voice_profile_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_phone_numbers_from_voice_connector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_request.DisassociatePhoneNumbersFromVoiceConnectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_response.DisassociatePhoneNumbersFromVoiceConnectorResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.disassociate_phone_numbers_from_voice_connector

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.disassociate_phone_numbers_from_voice_connector.async_disassociate_phone_numbers_from_voice_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_phone_numbers_from_voice_connector_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_request.DisassociatePhoneNumbersFromVoiceConnectorGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.disassociate_phone_numbers_from_voice_connector_group_response.DisassociatePhoneNumbersFromVoiceConnectorGroupResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.disassociate_phone_numbers_from_voice_connector_group

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.disassociate_phone_numbers_from_voice_connector_group.async_disassociate_phone_numbers_from_voice_connector_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_global_settings(
        self, *, config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None
    ) -> "capo_chime_sdk_voice.types.get_global_settings_response.GetGlobalSettingsResponse":
        ...
        async def _handler(
            ...
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_global_settings

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_global_settings.async_get_global_settings(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_phone_number(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_phone_number_request.GetPhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_phone_number_response.GetPhoneNumberResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_phone_number

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_phone_number.async_get_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_phone_number_order(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.get_phone_number_order_response.GetPhoneNumberOrderResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_phone_number_order_request.GetPhoneNumberOrderRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_phone_number_order_response.GetPhoneNumberOrderResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_phone_number_order

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_phone_number_order.async_get_phone_number_order(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_phone_number_settings(
        self, *, config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None
    ) -> "capo_chime_sdk_voice.types.get_phone_number_settings_response.GetPhoneNumberSettingsResponse":
        ...
        async def _handler(
            ...
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_phone_number_settings

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_phone_number_settings.async_get_phone_number_settings(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_proxy_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_proxy_session_request.GetProxySessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_proxy_session_response.GetProxySessionResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_proxy_session

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_proxy_session.async_get_proxy_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sip_media_application(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_sip_media_application_request.GetSipMediaApplicationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_sip_media_application_response.GetSipMediaApplicationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_sip_media_application

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_sip_media_application.async_get_sip_media_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sip_media_application_alexa_skill_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_sip_media_application_alexa_skill_configuration_request.GetSipMediaApplicationAlexaSkillConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_sip_media_application_alexa_skill_configuration_response.GetSipMediaApplicationAlexaSkillConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_sip_media_application_alexa_skill_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_sip_media_application_alexa_skill_configuration.async_get_sip_media_application_alexa_skill_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sip_media_application_logging_configuration(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.get_sip_media_application_logging_configuration_response.GetSipMediaApplicationLoggingConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_sip_media_application_logging_configuration_request.GetSipMediaApplicationLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_sip_media_application_logging_configuration_response.GetSipMediaApplicationLoggingConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_sip_media_application_logging_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_sip_media_application_logging_configuration.async_get_sip_media_application_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sip_rule(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.get_sip_rule_response.GetSipRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_sip_rule_request.GetSipRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_sip_rule_response.GetSipRuleResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_sip_rule

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_sip_rule.async_get_sip_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_speaker_search_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_speaker_search_task_request.GetSpeakerSearchTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_speaker_search_task_response.GetSpeakerSearchTaskResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_speaker_search_task

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_speaker_search_task.async_get_speaker_search_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_request.GetVoiceConnectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_response.GetVoiceConnectorResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector.async_get_voice_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_emergency_calling_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_request.GetVoiceConnectorEmergencyCallingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_response.GetVoiceConnectorEmergencyCallingConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_emergency_calling_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_emergency_calling_configuration.async_get_voice_connector_emergency_calling_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_external_systems_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_request.GetVoiceConnectorExternalSystemsConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_external_systems_configuration_response.GetVoiceConnectorExternalSystemsConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_external_systems_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_external_systems_configuration.async_get_voice_connector_external_systems_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_group_request.GetVoiceConnectorGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_group_response.GetVoiceConnectorGroupResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_group

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_group.async_get_voice_connector_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_logging_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_logging_configuration_request.GetVoiceConnectorLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_logging_configuration_response.GetVoiceConnectorLoggingConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_logging_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_logging_configuration.async_get_voice_connector_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_origination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_origination_request.GetVoiceConnectorOriginationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_origination_response.GetVoiceConnectorOriginationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_origination

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_origination.async_get_voice_connector_origination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_proxy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_proxy_request.GetVoiceConnectorProxyRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_proxy_response.GetVoiceConnectorProxyResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_proxy

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_proxy.async_get_voice_connector_proxy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_streaming_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_streaming_configuration_request.GetVoiceConnectorStreamingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_streaming_configuration_response.GetVoiceConnectorStreamingConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_streaming_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_streaming_configuration.async_get_voice_connector_streaming_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_termination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_termination_request.GetVoiceConnectorTerminationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_termination_response.GetVoiceConnectorTerminationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_termination

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_termination.async_get_voice_connector_termination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_connector_termination_health(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_connector_termination_health_request.GetVoiceConnectorTerminationHealthRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_connector_termination_health_response.GetVoiceConnectorTerminationHealthResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_termination_health

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_connector_termination_health.async_get_voice_connector_termination_health(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_profile_request.GetVoiceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_profile_response.GetVoiceProfileResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_profile

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_profile.async_get_voice_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_profile_domain(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.get_voice_profile_domain_response.GetVoiceProfileDomainResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_profile_domain_request.GetVoiceProfileDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_profile_domain_response.GetVoiceProfileDomainResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_profile_domain

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_profile_domain.async_get_voice_profile_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_voice_tone_analysis_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.get_voice_tone_analysis_task_request.GetVoiceToneAnalysisTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.get_voice_tone_analysis_task_response.GetVoiceToneAnalysisTaskResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_tone_analysis_task

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.get_voice_tone_analysis_task.async_get_voice_tone_analysis_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_available_voice_connector_regions(
        ...
        async def _handler(
            ...
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_available_voice_connector_regions

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_available_voice_connector_regions.async_list_available_voice_connector_regions(
                req.options
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_phone_number_orders(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_phone_number_orders_request.ListPhoneNumberOrdersRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_phone_number_orders_response.ListPhoneNumberOrdersResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_phone_number_orders

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_phone_number_orders.async_list_phone_number_orders(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_phone_numbers(
        ...
        *,
        ...
        max_results: Optional["capo_chime_sdk_voice.types.result_max.ResultMax"] = None,
        next_token: Optional["capo_chime_sdk_voice.types.string.String"] = None,
    ) -> "capo_chime_sdk_voice.types.list_phone_numbers_response.ListPhoneNumbersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_phone_numbers_request.ListPhoneNumbersRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_phone_numbers_response.ListPhoneNumbersResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_phone_numbers

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_phone_numbers.async_list_phone_numbers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_proxy_sessions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_proxy_sessions_request.ListProxySessionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_proxy_sessions_response.ListProxySessionsResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_proxy_sessions

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_proxy_sessions.async_list_proxy_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_sip_media_applications(
        ...
        *,
    ...
    ) -> "capo_chime_sdk_voice.types.list_sip_media_applications_response.ListSipMediaApplicationsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_sip_media_applications_request.ListSipMediaApplicationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_sip_media_applications_response.ListSipMediaApplicationsResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_sip_media_applications

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_sip_media_applications.async_list_sip_media_applications(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_chime_sdk_voice.types.sip_media_application.SipMediaApplication]":
        _token = next_token
        while True:
    ...
    async def list_sip_rules(
        ...
        *,
    ...
    ) -> "capo_chime_sdk_voice.types.list_sip_rules_response.ListSipRulesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_sip_rules_request.ListSipRulesRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_sip_rules_response.ListSipRulesResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_sip_rules

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_sip_rules.async_list_sip_rules(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_chime_sdk_voice.types.sip_rule.SipRule]":
        _token = next_token
        while True:
    ...
    async def list_supported_phone_number_countries(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.list_supported_phone_number_countries_response.ListSupportedPhoneNumberCountriesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_supported_phone_number_countries_request.ListSupportedPhoneNumberCountriesRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_supported_phone_number_countries_response.ListSupportedPhoneNumberCountriesResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_supported_phone_number_countries

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_supported_phone_number_countries.async_list_supported_phone_number_countries(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.list_tags_for_resource_response.ListTagsForResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_tags_for_resource

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_voice_connector_groups(
        ...
        *,
        ...
        next_token: Optional["capo_chime_sdk_voice.types.string.String"] = None,
        max_results: Optional["capo_chime_sdk_voice.types.result_max.ResultMax"] = None,
    ) -> "capo_chime_sdk_voice.types.list_voice_connector_groups_response.ListVoiceConnectorGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_voice_connector_groups_request.ListVoiceConnectorGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_voice_connector_groups_response.ListVoiceConnectorGroupsResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_connector_groups

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_connector_groups.async_list_voice_connector_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_voice_connectors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_voice_connectors_request.ListVoiceConnectorsRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_voice_connectors_response.ListVoiceConnectorsResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_connectors

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_connectors.async_list_voice_connectors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_voice_connector_termination_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_voice_connector_termination_credentials_request.ListVoiceConnectorTerminationCredentialsRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_voice_connector_termination_credentials_response.ListVoiceConnectorTerminationCredentialsResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_connector_termination_credentials

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_connector_termination_credentials.async_list_voice_connector_termination_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_voice_profile_domains(
        ...
        *,
        ...
        next_token: Optional["capo_chime_sdk_voice.types.string.String"] = None,
        max_results: Optional["capo_chime_sdk_voice.types.result_max.ResultMax"] = None,
    ) -> "capo_chime_sdk_voice.types.list_voice_profile_domains_response.ListVoiceProfileDomainsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_voice_profile_domains_request.ListVoiceProfileDomainsRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_voice_profile_domains_response.ListVoiceProfileDomainsResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_profile_domains

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_profile_domains.async_list_voice_profile_domains(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_voice_profiles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.list_voice_profiles_request.ListVoiceProfilesRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.list_voice_profiles_response.ListVoiceProfilesResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_profiles

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.list_voice_profiles.async_list_voice_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_sip_media_application_alexa_skill_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_sip_media_application_alexa_skill_configuration_request.PutSipMediaApplicationAlexaSkillConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_sip_media_application_alexa_skill_configuration_response.PutSipMediaApplicationAlexaSkillConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_sip_media_application_alexa_skill_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_sip_media_application_alexa_skill_configuration.async_put_sip_media_application_alexa_skill_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_sip_media_application_logging_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_sip_media_application_logging_configuration_request.PutSipMediaApplicationLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_sip_media_application_logging_configuration_response.PutSipMediaApplicationLoggingConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_sip_media_application_logging_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_sip_media_application_logging_configuration.async_put_sip_media_application_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_voice_connector_emergency_calling_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_request.PutVoiceConnectorEmergencyCallingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_voice_connector_emergency_calling_configuration_response.PutVoiceConnectorEmergencyCallingConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_emergency_calling_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_emergency_calling_configuration.async_put_voice_connector_emergency_calling_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_voice_connector_external_systems_configuration(
        ...
        *,
    ...
    ) -> "capo_chime_sdk_voice.types.put_voice_connector_external_systems_configuration_response.PutVoiceConnectorExternalSystemsConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_voice_connector_external_systems_configuration_request.PutVoiceConnectorExternalSystemsConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_voice_connector_external_systems_configuration_response.PutVoiceConnectorExternalSystemsConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_external_systems_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_external_systems_configuration.async_put_voice_connector_external_systems_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_voice_connector_logging_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_voice_connector_logging_configuration_request.PutVoiceConnectorLoggingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_voice_connector_logging_configuration_response.PutVoiceConnectorLoggingConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_logging_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_logging_configuration.async_put_voice_connector_logging_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_voice_connector_origination(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_voice_connector_origination_request.PutVoiceConnectorOriginationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_voice_connector_origination_response.PutVoiceConnectorOriginationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_origination

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_origination.async_put_voice_connector_origination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_voice_connector_proxy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_voice_connector_proxy_request.PutVoiceConnectorProxyRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_voice_connector_proxy_response.PutVoiceConnectorProxyResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_proxy

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_proxy.async_put_voice_connector_proxy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_voice_connector_streaming_configuration(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.put_voice_connector_streaming_configuration_response.PutVoiceConnectorStreamingConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_voice_connector_streaming_configuration_request.PutVoiceConnectorStreamingConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_voice_connector_streaming_configuration_response.PutVoiceConnectorStreamingConfigurationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_streaming_configuration

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_streaming_configuration.async_put_voice_connector_streaming_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_voice_connector_termination(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.put_voice_connector_termination_response.PutVoiceConnectorTerminationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_voice_connector_termination_request.PutVoiceConnectorTerminationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.put_voice_connector_termination_response.PutVoiceConnectorTerminationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_termination

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_termination.async_put_voice_connector_termination(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_voice_connector_termination_credentials(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.put_voice_connector_termination_credentials_request.PutVoiceConnectorTerminationCredentialsRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_termination_credentials

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.put_voice_connector_termination_credentials.async_put_voice_connector_termination_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def restore_phone_number(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.restore_phone_number_response.RestorePhoneNumberResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.restore_phone_number_request.RestorePhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.restore_phone_number_response.RestorePhoneNumberResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.restore_phone_number

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.restore_phone_number.async_restore_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def search_available_phone_numbers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.search_available_phone_numbers_request.SearchAvailablePhoneNumbersRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.search_available_phone_numbers_response.SearchAvailablePhoneNumbersResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.search_available_phone_numbers

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.search_available_phone_numbers.async_search_available_phone_numbers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_speaker_search_task(
        ...
        *,
        ...
        Raises:
            ...
            capo_chime_sdk_voice.errors.throttled_client_exception.ThrottledClientException: <p>The number of customer requests exceeds the request rate limit.</p>
            capo_chime_sdk_voice.errors.unauthorized_client_exception.UnauthorizedClientException: <p>The client isn't authorized to request a resource.</p>
            capo_chime_sdk_voice.errors.unprocessable_entity_exception.UnprocessableEntityException: <p>A well-formed request couldn't be followed due to semantic errors.</p>
            capo_chime_sdk_voice.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.start_speaker_search_task_request.StartSpeakerSearchTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.start_speaker_search_task_response.StartSpeakerSearchTaskResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.start_speaker_search_task

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.start_speaker_search_task.async_start_speaker_search_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_voice_tone_analysis_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.start_voice_tone_analysis_task_request.StartVoiceToneAnalysisTaskRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.start_voice_tone_analysis_task_response.StartVoiceToneAnalysisTaskResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.start_voice_tone_analysis_task

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.start_voice_tone_analysis_task.async_start_voice_tone_analysis_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_speaker_search_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.stop_speaker_search_task_request.StopSpeakerSearchTaskRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.stop_speaker_search_task

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.stop_speaker_search_task.async_stop_speaker_search_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_voice_tone_analysis_task(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.stop_voice_tone_analysis_task_request.StopVoiceToneAnalysisTaskRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.stop_voice_tone_analysis_task

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.stop_voice_tone_analysis_task.async_stop_voice_tone_analysis_task(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.tag_resource

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.untag_resource

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_global_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_global_settings_request.UpdateGlobalSettingsRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_global_settings

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_global_settings.async_update_global_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_phone_number(
        ...
        *,
        ...
        calling_name: Optional[
            "capo_chime_sdk_voice.types.calling_name.CallingName"
        ] = None,
        name: Optional[
            "capo_chime_sdk_voice.types.phone_number_name.PhoneNumberName"
        ] = None,
    ) -> "capo_chime_sdk_voice.types.update_phone_number_response.UpdatePhoneNumberResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_phone_number_request.UpdatePhoneNumberRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_phone_number_response.UpdatePhoneNumberResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_phone_number

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_phone_number.async_update_phone_number(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_phone_number_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_phone_number_settings_request.UpdatePhoneNumberSettingsRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_phone_number_settings

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_phone_number_settings.async_update_phone_number_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_proxy_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_proxy_session_request.UpdateProxySessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_proxy_session_response.UpdateProxySessionResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_proxy_session

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_proxy_session.async_update_proxy_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sip_media_application(
        ...
        *,
    ...
    ) -> "capo_chime_sdk_voice.types.update_sip_media_application_response.UpdateSipMediaApplicationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_sip_media_application_request.UpdateSipMediaApplicationRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_sip_media_application_response.UpdateSipMediaApplicationResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_sip_media_application

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_sip_media_application.async_update_sip_media_application(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sip_media_application_call(
        ...
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
    ) -> "capo_chime_sdk_voice.types.update_sip_media_application_call_response.UpdateSipMediaApplicationCallResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_sip_media_application_call_request.UpdateSipMediaApplicationCallRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_sip_media_application_call_response.UpdateSipMediaApplicationCallResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_sip_media_application_call

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_sip_media_application_call.async_update_sip_media_application_call(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sip_rule(
        ...
        *,
    ...
    ) -> "capo_chime_sdk_voice.types.update_sip_rule_response.UpdateSipRuleResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_sip_rule_request.UpdateSipRuleRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_sip_rule_response.UpdateSipRuleResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_sip_rule

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_sip_rule.async_update_sip_rule(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_voice_connector(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_voice_connector_request.UpdateVoiceConnectorRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_voice_connector_response.UpdateVoiceConnectorResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_voice_connector

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_voice_connector.async_update_voice_connector(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_voice_connector_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_voice_connector_group_request.UpdateVoiceConnectorGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_voice_connector_group_response.UpdateVoiceConnectorGroupResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_voice_connector_group

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_voice_connector_group.async_update_voice_connector_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_voice_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_voice_profile_request.UpdateVoiceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_voice_profile_response.UpdateVoiceProfileResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_voice_profile

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_voice_profile.async_update_voice_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_voice_profile_domain(
        ...
        *,
    ...
    ) -> "capo_chime_sdk_voice.types.update_voice_profile_domain_response.UpdateVoiceProfileDomainResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.update_voice_profile_domain_request.UpdateVoiceProfileDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.update_voice_profile_domain_response.UpdateVoiceProfileDomainResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_voice_profile_domain

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.update_voice_profile_domain.async_update_voice_profile_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_e911_address(
        ...
        street_number: "capo_chime_sdk_voice.types.sensitive_non_empty_string.SensitiveNonEmptyString",
        street_info: "capo_chime_sdk_voice.types.sensitive_non_empty_string.SensitiveNonEmptyString",
        city: "capo_chime_sdk_voice.types.sensitive_non_empty_string.SensitiveNonEmptyString",
        state: "capo_chime_sdk_voice.types.sensitive_non_empty_string.SensitiveNonEmptyString",
        country: "capo_chime_sdk_voice.types.sensitive_non_empty_string.SensitiveNonEmptyString",
        postal_code: "capo_chime_sdk_voice.types.sensitive_non_empty_string.SensitiveNonEmptyString",
        *,
        config_overrides: Optional[AsyncChimeSDKVoiceClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_chime_sdk_voice.types.validate_e911_address_request.ValidateE911AddressRequest]",
        ) -> AsyncOperationResponse[
            "capo_chime_sdk_voice.types.validate_e911_address_response.ValidateE911AddressResponse"
        ]:
            import capo_chime_sdk_voice._operations.chime_sdk_telephony_service.validate_e911_address

            (
                output,
                http_response,
            ) = await capo_chime_sdk_voice._operations.chime_sdk_telephony_service.validate_e911_address.async_validate_e911_address(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
