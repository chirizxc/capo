...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.update_sip_media_application_call_response.UpdateSipMediaApplicationCallResponse = capo_chime_sdk_voice.types.update_sip_media_application_call_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{TransactionId}", quote(input_["transaction_id"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_sip_media_application_call_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
