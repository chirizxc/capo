"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListSipMediaApplications``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_sip_media_applications_response.ListSipMediaApplicationsResponse = capo_chime_sdk_voice.types.list_sip_media_applications_response.deserialize_json(
...
async def async_list_sip_media_applications(
