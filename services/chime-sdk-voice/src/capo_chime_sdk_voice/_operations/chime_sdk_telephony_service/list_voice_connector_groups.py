"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListVoiceConnectorGroups``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_voice_connector_groups_response.ListVoiceConnectorGroupsResponse = capo_chime_sdk_voice.types.list_voice_connector_groups_response.deserialize_json(
...
async def async_list_voice_connector_groups(
