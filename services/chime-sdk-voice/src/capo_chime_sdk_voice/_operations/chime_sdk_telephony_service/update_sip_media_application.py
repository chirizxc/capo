...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.update_sip_media_application_response.UpdateSipMediaApplicationResponse = capo_chime_sdk_voice.types.update_sip_media_application_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_sip_media_application_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
