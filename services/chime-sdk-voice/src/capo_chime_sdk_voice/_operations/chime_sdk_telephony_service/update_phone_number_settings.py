"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdatePhoneNumberSettings``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_phone_number_settings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
