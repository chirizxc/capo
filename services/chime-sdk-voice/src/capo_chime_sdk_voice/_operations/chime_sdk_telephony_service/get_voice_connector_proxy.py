...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_proxy_response.GetVoiceConnectorProxyResponse = capo_chime_sdk_voice.types.get_voice_connector_proxy_response.deserialize_json(
