...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_chime_sdk_voice.types.list_tags_for_resource_response.deserialize_json(
...
def build_request(
    ...
    if "resource_arn" in input_:
        params.append(("arn", input_["resource_arn"]))
