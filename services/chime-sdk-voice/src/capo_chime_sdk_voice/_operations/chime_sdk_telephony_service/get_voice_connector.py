"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnector``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_response.GetVoiceConnectorResponse = capo_chime_sdk_voice.types.get_voice_connector_response.deserialize_json(
...
async def async_get_voice_connector(
