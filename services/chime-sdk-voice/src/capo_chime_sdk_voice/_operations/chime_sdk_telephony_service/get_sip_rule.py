"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetSipRule``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_sip_rule_response.GetSipRuleResponse = (
        capo_chime_sdk_voice.types.get_sip_rule_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{SipRuleId}", quote(input_["sip_rule_id"], safe=""))
...
def get_sip_rule(
    ...
    capo_chime_sdk_voice.types.get_sip_rule_response.GetSipRuleResponse, zapros.Response
]:
