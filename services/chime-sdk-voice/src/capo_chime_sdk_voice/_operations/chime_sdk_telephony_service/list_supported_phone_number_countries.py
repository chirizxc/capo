...
import capo_chime_sdk_voice.types.phone_number_countries_list
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_supported_phone_number_countries_response.ListSupportedPhoneNumberCountriesResponse = capo_chime_sdk_voice.types.list_supported_phone_number_countries_response.deserialize_json(
