"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#PutVoiceConnectorStreamingConfiguration``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.put_voice_connector_streaming_configuration_response.PutVoiceConnectorStreamingConfigurationResponse = capo_chime_sdk_voice.types.put_voice_connector_streaming_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.put_voice_connector_streaming_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_voice_connector_streaming_configuration(
