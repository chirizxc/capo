...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.update_sip_rule_response.UpdateSipRuleResponse = (
        capo_chime_sdk_voice.types.update_sip_rule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_sip_rule_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
