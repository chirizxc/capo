"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#ListSipRules``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_sip_rules_response.ListSipRulesResponse = (
        capo_chime_sdk_voice.types.list_sip_rules_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/sip-rules"
    params: list[tuple[str, str]] = []
    if "sip_media_application_id" in input_:
        params.append(("sip-media-application", input_["sip_media_application_id"]))
...
async def async_list_sip_rules(
