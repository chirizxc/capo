...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_phone_number_order_response.GetPhoneNumberOrderResponse = capo_chime_sdk_voice.types.get_phone_number_order_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{PhoneNumberOrderId}", quote(input_["phone_number_order_id"], safe="")
    )
