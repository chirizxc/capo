"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#CreateVoiceProfileDomain``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.create_voice_profile_domain_response.CreateVoiceProfileDomainResponse = capo_chime_sdk_voice.types.create_voice_profile_domain_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.create_voice_profile_domain_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_voice_profile_domain(
