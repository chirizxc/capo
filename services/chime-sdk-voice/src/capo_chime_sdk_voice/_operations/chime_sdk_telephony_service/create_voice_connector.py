"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#CreateVoiceConnector``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.create_voice_connector_response.CreateVoiceConnectorResponse = capo_chime_sdk_voice.types.create_voice_connector_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.create_voice_connector_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_voice_connector(
