...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_termination_response.GetVoiceConnectorTerminationResponse = capo_chime_sdk_voice.types.get_voice_connector_termination_response.deserialize_json(
