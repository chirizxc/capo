...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_phone_number_settings_response.GetPhoneNumberSettingsResponse = capo_chime_sdk_voice.types.get_phone_number_settings_response.deserialize_json(
