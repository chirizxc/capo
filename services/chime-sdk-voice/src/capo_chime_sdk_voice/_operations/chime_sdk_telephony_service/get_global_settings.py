"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetGlobalSettings``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_global_settings_response.GetGlobalSettingsResponse = capo_chime_sdk_voice.types.get_global_settings_response.deserialize_json(
