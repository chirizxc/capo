"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#DeleteVoiceConnectorEmergencyCallingConfiguration``."""
...
async def async_delete_voice_connector_emergency_calling_configuration(
