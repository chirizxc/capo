...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_profile_domain_response.GetVoiceProfileDomainResponse = capo_chime_sdk_voice.types.get_voice_profile_domain_response.deserialize_json(
