"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#GetVoiceConnectorEmergencyCallingConfiguration``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_response.GetVoiceConnectorEmergencyCallingConfigurationResponse = capo_chime_sdk_voice.types.get_voice_connector_emergency_calling_configuration_response.deserialize_json(
...
async def async_get_voice_connector_emergency_calling_configuration(
