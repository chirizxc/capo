...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_sip_media_application_logging_configuration_response.GetSipMediaApplicationLoggingConfigurationResponse = capo_chime_sdk_voice.types.get_sip_media_application_logging_configuration_response.deserialize_json(
