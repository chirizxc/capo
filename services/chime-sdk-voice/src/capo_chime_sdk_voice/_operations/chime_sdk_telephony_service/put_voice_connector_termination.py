...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.put_voice_connector_termination_response.PutVoiceConnectorTerminationResponse = capo_chime_sdk_voice.types.put_voice_connector_termination_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.put_voice_connector_termination_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
