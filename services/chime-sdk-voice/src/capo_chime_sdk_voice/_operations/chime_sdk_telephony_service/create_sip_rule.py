"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#CreateSipRule``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.create_sip_rule_response.CreateSipRuleResponse = (
        capo_chime_sdk_voice.types.create_sip_rule_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.create_sip_rule_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_sip_rule(
