"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#PutVoiceConnectorExternalSystemsConfiguration``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.put_voice_connector_external_systems_configuration_response.PutVoiceConnectorExternalSystemsConfigurationResponse = capo_chime_sdk_voice.types.put_voice_connector_external_systems_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{VoiceConnectorId}", quote(input_["voice_connector_id"], safe="")
    )
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.put_voice_connector_external_systems_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_voice_connector_external_systems_configuration(
