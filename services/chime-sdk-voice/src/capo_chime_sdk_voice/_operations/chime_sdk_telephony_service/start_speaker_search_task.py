...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.start_speaker_search_task_response.StartSpeakerSearchTaskResponse = capo_chime_sdk_voice.types.start_speaker_search_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.start_speaker_search_task_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
