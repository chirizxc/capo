"""Generated from Smithy shape ``com.amazonaws.chimesdkvoice#UpdatePhoneNumber``."""
...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.update_phone_number_response.UpdatePhoneNumberResponse = capo_chime_sdk_voice.types.update_phone_number_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.update_phone_number_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
