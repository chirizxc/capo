...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.get_voice_connector_streaming_configuration_response.GetVoiceConnectorStreamingConfigurationResponse = capo_chime_sdk_voice.types.get_voice_connector_streaming_configuration_response.deserialize_json(
