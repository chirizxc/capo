...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_voice_profile_domains_response.ListVoiceProfileDomainsResponse = capo_chime_sdk_voice.types.list_voice_profile_domains_response.deserialize_json(
