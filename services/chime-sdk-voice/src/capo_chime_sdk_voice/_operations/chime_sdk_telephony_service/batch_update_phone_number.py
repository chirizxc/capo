...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.batch_update_phone_number_response.BatchUpdatePhoneNumberResponse = capo_chime_sdk_voice.types.batch_update_phone_number_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime_sdk_voice.types.batch_update_phone_number_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
