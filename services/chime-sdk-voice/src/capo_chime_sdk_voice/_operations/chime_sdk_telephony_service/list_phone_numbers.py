...
def handle_response(
    ...
    out: capo_chime_sdk_voice.types.list_phone_numbers_response.ListPhoneNumbersResponse = capo_chime_sdk_voice.types.list_phone_numbers_response.deserialize_json(
...
def build_request(
    ...
    if "filter_name" in input_:
        params.append(
            (
                "filter-name",
                capo_chime_sdk_voice.types.phone_number_association_name.serialize_json(
                    input_["filter_name"]
                ),
            )
        )
    if "filter_value" in input_:
        params.append(("filter-value", input_["filter_value"]))
