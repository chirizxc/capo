"""Generated from Smithy shape ``com.amazonaws.bedrock#ServiceUnavailableException``."""
...
class ServiceUnavailableException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrock#ServiceUnavailableException``."""
