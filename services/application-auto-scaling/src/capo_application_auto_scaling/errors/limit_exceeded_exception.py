"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.applicationautoscaling#LimitExceededException``."""
