...
def handle_response(
    ...
    out: capo_application_auto_scaling.types.register_scalable_target_response.RegisterScalableTargetResponse = capo_application_auto_scaling.types.register_scalable_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_auto_scaling.types.register_scalable_target_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
