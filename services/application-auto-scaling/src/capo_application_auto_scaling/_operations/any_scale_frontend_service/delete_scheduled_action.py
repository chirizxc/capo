"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DeleteScheduledAction``."""
...
def handle_response(
    ...
    out: capo_application_auto_scaling.types.delete_scheduled_action_response.DeleteScheduledActionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_auto_scaling.types.delete_scheduled_action_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
