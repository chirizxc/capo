...
import capo_application_auto_scaling._protocol.eventstream
import capo_application_auto_scaling.errors.concurrent_update_exception
import capo_application_auto_scaling.errors.failed_resource_access_exception
import capo_application_auto_scaling.errors.internal_service_exception
import capo_application_auto_scaling.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "FailedResourceAccessException":
            raise capo_application_auto_scaling.errors.failed_resource_access_exception.FailedResourceAccessException.from_aws_json_1_1(
                data, message
            )
        ...
        case "LimitExceededException":
            raise capo_application_auto_scaling.errors.limit_exceeded_exception.LimitExceededException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_application_auto_scaling.types.put_scaling_policy_response.PutScalingPolicyResponse = capo_application_auto_scaling.types.put_scaling_policy_response.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = (
                capo_application_auto_scaling._auth._sigv4.build_sigv4_auth_scheme(
                    "application-autoscaling", options.region, endpoint_scheme
                )
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_auto_scaling.types.put_scaling_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
