"""Generated from Smithy shape ``com.amazonaws.applicationautoscaling#DescribeScalingActivitiesRequest``."""
...
class DescribeScalingActivitiesRequest(TypedDict, closed=True):
    service_namespace: (
...
def serialize_aws_json_1_1(value: DescribeScalingActivitiesRequest) -> dict:
    ...
    if "include_not_scaled_activities" in value:
        out["IncludeNotScaledActivities"] = value["include_not_scaled_activities"]
    return out
