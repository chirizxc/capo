...
if TYPE_CHECKING:
    import capo_application_auto_scaling.types.predictive_scaling_metric
    import capo_application_auto_scaling.types.predictive_scaling_metric_unit
...
def serialize_aws_json_1_1(value: PredictiveScalingMetricStat) -> dict:
    ...
    out["Metric"] = (
        capo_application_auto_scaling.types.predictive_scaling_metric.serialize_aws_json_1_1(
            value["metric"]
        )
    )
    out["Stat"] = value["stat"]
...
def deserialize_aws_json_1_1(data: dict) -> PredictiveScalingMetricStat:
    ...
    if data.get("Metric") is not None:
        ...
        out["metric"] = (
            capo_application_auto_scaling.types.predictive_scaling_metric.deserialize_aws_json_1_1(
                data["Metric"]
            )
        )
    else:
