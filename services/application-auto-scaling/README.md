...
```
pip install capo-application-auto-scaling
```

## Usage

```python
from capo_application_auto_scaling import AsyncApplicationAutoScalingClient
...
```python
from capo_application_auto_scaling import AsyncApplicationAutoScalingClient
from capo_application_auto_scaling.error import ConcurrentUpdateException
