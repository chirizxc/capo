...
def serialize_aws_json_1_1(value: DescribeEvaluationsInput) -> dict:
    ...
    if "filter_variable" in value:
        ...
        out["FilterVariable"] = (
            capo_machine_learning.types.evaluation_filter_variable.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeEvaluationsInput:
    ...
    if data.get("FilterVariable") is not None:
        ...
        out["filter_variable"] = (
            capo_machine_learning.types.evaluation_filter_variable.deserialize_aws_json_1_1(
                data["FilterVariable"]
            )
        )
