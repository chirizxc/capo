...
class GetBatchPredictionOutput(TypedDict, closed=True):
    ...
    output_uri: NotRequired["capo_machine_learning.types.s3_url.S3Url"]
    ...
    total_record_count: NotRequired["capo_machine_learning.types.long_type.LongType"]
    """<p>The number of total records that Amazon Machine Learning saw while processing the <code>BatchPrediction</code>.</p>"""
    invalid_record_count: NotRequired["capo_machine_learning.types.long_type.LongType"]
