"""Generated from Smithy shape ``com.amazonaws.mediapackagev2#CreateChannelGroupResponse``."""
...
class CreateChannelGroupResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateChannelGroupResponse) -> dict:
    out: dict = {}
