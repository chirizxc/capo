...
class EncryptionMethod(TypedDict, closed=True):
    ts_encryption_method: NotRequired[
        "capo_mediapackagev2.types.ts_encryption_method.TsEncryptionMethod"
    ]
    """<p>The encryption method to use.</p>"""
    cmaf_encryption_method: NotRequired[
        "capo_mediapackagev2.types.cmaf_encryption_method.CmafEncryptionMethod"
    ]
    """<p>The encryption method to use.</p>"""
    ism_encryption_method: NotRequired[
        "capo_mediapackagev2.types.ism_encryption_method.IsmEncryptionMethod"
    ]
...
def serialize_json(value: EncryptionMethod) -> dict:
    ...
    if "ts_encryption_method" in value:
        ...
        out["TsEncryptionMethod"] = (
            capo_mediapackagev2.types.ts_encryption_method.serialize_json(
    ...
    if "cmaf_encryption_method" in value:
        ...
        out["CmafEncryptionMethod"] = (
            capo_mediapackagev2.types.cmaf_encryption_method.serialize_json(
    ...
    if "ism_encryption_method" in value:
        ...
        out["IsmEncryptionMethod"] = (
            capo_mediapackagev2.types.ism_encryption_method.serialize_json(
...
def deserialize_json(data: dict) -> EncryptionMethod:
    ...
    if data.get("TsEncryptionMethod") is not None:
        ...
        out["ts_encryption_method"] = (
            capo_mediapackagev2.types.ts_encryption_method.deserialize_json(
    ...
    if data.get("CmafEncryptionMethod") is not None:
        ...
        out["cmaf_encryption_method"] = (
            capo_mediapackagev2.types.cmaf_encryption_method.deserialize_json(
    ...
    if data.get("IsmEncryptionMethod") is not None:
        ...
        out["ism_encryption_method"] = (
            capo_mediapackagev2.types.ism_encryption_method.deserialize_json(
