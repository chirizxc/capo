...
from capo_mediapackagev2._services._aws_config import aaws_config
...
class AsyncMediaPackageV2ClientConfig(TypedDict, total=False, closed=True):
...
class AsyncMediaPackageV2Client:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackagev2.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_mediapackagev2.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackagev2._operations.mediapackagev2.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackagev2.types.tag_resource_request.TagResourceRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackagev2._operations.mediapackagev2.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_mediapackagev2.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_mediapackagev2._operations.mediapackagev2.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
