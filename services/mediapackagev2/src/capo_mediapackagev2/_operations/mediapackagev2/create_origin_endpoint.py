...
def handle_response(
    ...
    out: capo_mediapackagev2.types.create_origin_endpoint_response.CreateOriginEndpointResponse = capo_mediapackagev2.types.create_origin_endpoint_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mediapackagev2.types.create_origin_endpoint_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
