...
def handle_response(
    ...
    out: capo_mediapackagev2.types.get_origin_endpoint_response.GetOriginEndpointResponse = capo_mediapackagev2.types.get_origin_endpoint_response.deserialize_json(
