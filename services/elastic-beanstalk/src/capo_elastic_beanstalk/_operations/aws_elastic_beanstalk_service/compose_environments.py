"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#ComposeEnvironments``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ComposeEnvironmentsResult")
...
def build_request(
    ...
    pairs.append(("Action", "ComposeEnvironments"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.compose_environments_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_compose_environments(
