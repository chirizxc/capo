"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeApplicationVersions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeApplicationVersionsResult")
    out: capo_elastic_beanstalk.types.application_version_descriptions_message.ApplicationVersionDescriptionsMessage = capo_elastic_beanstalk.types.application_version_descriptions_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeApplicationVersions"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.describe_application_versions_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_application_versions(
