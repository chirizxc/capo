"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#UpdateConfigurationTemplate``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateConfigurationTemplateResult")
...
def build_request(
    ...
    capo_elastic_beanstalk.types.update_configuration_template_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_configuration_template(
