"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeApplications``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeApplicationsResult")
    out: capo_elastic_beanstalk.types.application_descriptions_message.ApplicationDescriptionsMessage = capo_elastic_beanstalk.types.application_descriptions_message.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeApplications"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.describe_applications_message.serialize_query(
        input_, pairs, ""
    )
