"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#UpdateEnvironment``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateEnvironmentResult")
...
def build_request(
    ...
    capo_elastic_beanstalk.types.update_environment_message.serialize_query(
        input_, pairs, ""
    )
