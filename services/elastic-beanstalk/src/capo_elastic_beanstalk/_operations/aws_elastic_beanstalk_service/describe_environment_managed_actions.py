"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeEnvironmentManagedActions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeEnvironmentManagedActionsResult")
    out: capo_elastic_beanstalk.types.describe_environment_managed_actions_result.DescribeEnvironmentManagedActionsResult = capo_elastic_beanstalk.types.describe_environment_managed_actions_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeEnvironmentManagedActions"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.describe_environment_managed_actions_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_environment_managed_actions(
