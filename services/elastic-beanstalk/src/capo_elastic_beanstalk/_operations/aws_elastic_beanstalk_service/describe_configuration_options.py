"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeConfigurationOptions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeConfigurationOptionsResult")
    out: capo_elastic_beanstalk.types.configuration_options_description.ConfigurationOptionsDescription = capo_elastic_beanstalk.types.configuration_options_description.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeConfigurationOptions"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.describe_configuration_options_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_configuration_options(
