"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeEvents``."""
...
def handle_response(
    ...
    out: capo_elastic_beanstalk.types.event_descriptions_message.EventDescriptionsMessage = capo_elastic_beanstalk.types.event_descriptions_message.deserialize_query(
...
def build_request(
    ...
    capo_elastic_beanstalk.types.describe_events_message.serialize_query(
        input_, pairs, ""
    )
