"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#ListPlatformBranches``."""
...
import capo_elastic_beanstalk.types.platform_branch_summary_list
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListPlatformBranchesResult")
    out: capo_elastic_beanstalk.types.list_platform_branches_result.ListPlatformBranchesResult = capo_elastic_beanstalk.types.list_platform_branches_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ListPlatformBranches"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.list_platform_branches_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_platform_branches(
