"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#ValidateConfigurationSettings``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ValidateConfigurationSettingsResult")
    out: capo_elastic_beanstalk.types.configuration_settings_validation_messages.ConfigurationSettingsValidationMessages = capo_elastic_beanstalk.types.configuration_settings_validation_messages.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "ValidateConfigurationSettings"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.validate_configuration_settings_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_validate_configuration_settings(
