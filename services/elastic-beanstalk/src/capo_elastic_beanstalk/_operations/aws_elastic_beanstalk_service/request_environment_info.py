"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#RequestEnvironmentInfo``."""
...
def build_request(
    ...
    capo_elastic_beanstalk.types.request_environment_info_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_request_environment_info(
