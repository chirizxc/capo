"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribeConfigurationSettings``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeConfigurationSettingsResult")
    out: capo_elastic_beanstalk.types.configuration_settings_descriptions.ConfigurationSettingsDescriptions = capo_elastic_beanstalk.types.configuration_settings_descriptions.deserialize_query(
...
def build_request(
    ...
    capo_elastic_beanstalk.types.describe_configuration_settings_message.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_configuration_settings(
