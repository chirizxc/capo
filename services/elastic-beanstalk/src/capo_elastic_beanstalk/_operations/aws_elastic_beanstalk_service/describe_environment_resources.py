...
def handle_response(
    ...
    out: capo_elastic_beanstalk.types.environment_resource_descriptions_message.EnvironmentResourceDescriptionsMessage = capo_elastic_beanstalk.types.environment_resource_descriptions_message.deserialize_query(
...
def build_request(
    ...
    capo_elastic_beanstalk.types.describe_environment_resources_message.serialize_query(
        input_, pairs, ""
    )
