"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#DescribePlatformVersion``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribePlatformVersionResult")
    out: capo_elastic_beanstalk.types.describe_platform_version_result.DescribePlatformVersionResult = capo_elastic_beanstalk.types.describe_platform_version_result.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribePlatformVersion"))
    pairs.append(("Version", "2010-12-01"))
    capo_elastic_beanstalk.types.describe_platform_version_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_platform_version(
