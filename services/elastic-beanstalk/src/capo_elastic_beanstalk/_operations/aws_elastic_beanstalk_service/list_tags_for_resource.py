"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_elastic_beanstalk.types.resource_tags_description_message.ResourceTagsDescriptionMessage = capo_elastic_beanstalk.types.resource_tags_description_message.deserialize_query(
...
def build_request(
    ...
    capo_elastic_beanstalk.types.list_tags_for_resource_message.serialize_query(
        input_, pairs, ""
    )
