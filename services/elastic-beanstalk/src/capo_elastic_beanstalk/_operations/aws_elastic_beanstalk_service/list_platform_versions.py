"""Generated from Smithy shape ``com.amazonaws.elasticbeanstalk#ListPlatformVersions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("ListPlatformVersionsResult")
    out: capo_elastic_beanstalk.types.list_platform_versions_result.ListPlatformVersionsResult = capo_elastic_beanstalk.types.list_platform_versions_result.deserialize_query(
...
def build_request(
    ...
    capo_elastic_beanstalk.types.list_platform_versions_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_list_platform_versions(
