...
def handle_response(
    ...
    out: capo_iot_jobs_data_plane.types.get_pending_job_executions_response.GetPendingJobExecutionsResponse = capo_iot_jobs_data_plane.types.get_pending_job_executions_response.deserialize_json(
