...
def handle_response(
    ...
    out: capo_iot_jobs_data_plane.types.start_next_pending_job_execution_response.StartNextPendingJobExecutionResponse = capo_iot_jobs_data_plane.types.start_next_pending_job_execution_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_jobs_data_plane.types.start_next_pending_job_execution_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
