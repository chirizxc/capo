"""Generated from Smithy shape ``com.amazonaws.partnercentralaccount#CreateConnectionInvitationResponse``."""
...
class CreateConnectionInvitationResponse(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: CreateConnectionInvitationResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> CreateConnectionInvitationResponse:
    out: CreateConnectionInvitationResponse = {}  # type: ignore[typeddict-item]
    if data.get("Catalog") is not None:
        out["catalog"] = data["Catalog"]
    else:
        raise DeserializationError(
            "CreateConnectionInvitationResponse.catalog required"
        )
    if data.get("Id") is not None:
        out["id"] = data["Id"]
    else:
        raise DeserializationError("CreateConnectionInvitationResponse.id required")
    if data.get("Arn") is not None:
        out["arn"] = data["Arn"]
    else:
        raise DeserializationError("CreateConnectionInvitationResponse.arn required")
    ...
    if data.get("ConnectionType") is not None:
        ...
        raise DeserializationError(
            "CreateConnectionInvitationResponse.connection_type required"
        )
    if data.get("CreatedAt") is not None:
        ...
        raise DeserializationError(
            "CreateConnectionInvitationResponse.created_at required"
        )
    if data.get("UpdatedAt") is not None:
        ...
        raise DeserializationError(
            "CreateConnectionInvitationResponse.updated_at required"
        )
    ...
    if data.get("OtherParticipantIdentifier") is not None:
        ...
        raise DeserializationError(
            "CreateConnectionInvitationResponse.other_participant_identifier required"
        )
    if data.get("ParticipantType") is not None:
        ...
        raise DeserializationError(
            "CreateConnectionInvitationResponse.participant_type required"
        )
    if data.get("Status") is not None:
        ...
        raise DeserializationError("CreateConnectionInvitationResponse.status required")
    if data.get("InvitationMessage") is not None:
        out["invitation_message"] = data["InvitationMessage"]
    else:
        raise DeserializationError(
            "CreateConnectionInvitationResponse.invitation_message required"
        )
    if data.get("InviterEmail") is not None:
        out["inviter_email"] = data["InviterEmail"]
    else:
        raise DeserializationError(
            "CreateConnectionInvitationResponse.inviter_email required"
        )
    if data.get("InviterName") is not None:
        out["inviter_name"] = data["InviterName"]
    else:
        raise DeserializationError(
            "CreateConnectionInvitationResponse.inviter_name required"
        )
    return out
