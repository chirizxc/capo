...
if TYPE_CHECKING:
    ...
    import capo_iotdeviceadvisor.types.intended_for_qualification_boolean
    import capo_iotdeviceadvisor.types.is_long_duration_test_boolean
    import capo_iotdeviceadvisor.types.protocol
    import capo_iotdeviceadvisor.types.root_group
    import capo_iotdeviceadvisor.types.suite_definition_name


class SuiteDefinitionConfiguration(TypedDict, closed=True):
    ...
    devices: NotRequired[
        "capo_iotdeviceadvisor.types.device_under_test_list.DeviceUnderTestList"
    ]
    """<p>Gets the devices configured.</p>"""
    intended_for_qualification: NotRequired[
        "capo_iotdeviceadvisor.types.intended_for_qualification_boolean.IntendedForQualificationBoolean"
    ]
    """<p>Gets the tests intended for qualification in a suite.</p>"""
    is_long_duration_test: NotRequired[
        "capo_iotdeviceadvisor.types.is_long_duration_test_boolean.IsLongDurationTestBoolean"
    ]
    """<p>Verifies if the test suite is a long duration test.</p>"""
    root_group: NotRequired["capo_iotdeviceadvisor.types.root_group.RootGroup"]
    ...
    protocol: NotRequired["capo_iotdeviceadvisor.types.protocol.Protocol"]
...
def serialize_json(value: SuiteDefinitionConfiguration) -> dict:
    ...
    if "devices" in value:
        ...
        out["devices"] = (
            capo_iotdeviceadvisor.types.device_under_test_list.serialize_json(
                value["devices"]
            )
        )
    ...
    if "protocol" in value:
        ...
        out["protocol"] = capo_iotdeviceadvisor.types.protocol.serialize_json(
            value["protocol"]
        )
    return out
...
def deserialize_json(data: dict) -> SuiteDefinitionConfiguration:
    ...
    if data.get("devices") is not None:
        ...
        out["devices"] = (
            capo_iotdeviceadvisor.types.device_under_test_list.deserialize_json(
                data["devices"]
            )
        )
