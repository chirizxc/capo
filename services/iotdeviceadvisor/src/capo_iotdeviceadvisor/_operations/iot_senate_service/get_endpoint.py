...
def build_request(
    ...
    if "thing_arn" in input_:
        params.append(("thingArn", input_["thing_arn"]))
    if "certificate_arn" in input_:
        params.append(("certificateArn", input_["certificate_arn"]))
    if "device_role_arn" in input_:
        params.append(("deviceRoleArn", input_["device_role_arn"]))
    if "authentication_method" in input_:
        params.append(
            (
                "authenticationMethod",
                capo_iotdeviceadvisor.types.authentication_method.serialize_json(
                    input_["authentication_method"]
                ),
            )
        )
