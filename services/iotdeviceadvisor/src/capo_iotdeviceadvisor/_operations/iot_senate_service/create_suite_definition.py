...
def handle_response(
    ...
    out: capo_iotdeviceadvisor.types.create_suite_definition_response.CreateSuiteDefinitionResponse = capo_iotdeviceadvisor.types.create_suite_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotdeviceadvisor.types.create_suite_definition_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
