...
def handle_response(
    ...
    out: capo_iotdeviceadvisor.types.list_suite_runs_response.ListSuiteRunsResponse = (
        capo_iotdeviceadvisor.types.list_suite_runs_response.deserialize_json(
...
def build_request(
    ...
    if "suite_definition_id" in input_:
        params.append(("suiteDefinitionId", input_["suite_definition_id"]))
