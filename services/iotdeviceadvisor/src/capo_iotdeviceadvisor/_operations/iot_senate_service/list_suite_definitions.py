...
def handle_response(
    ...
    out: capo_iotdeviceadvisor.types.list_suite_definitions_response.ListSuiteDefinitionsResponse = capo_iotdeviceadvisor.types.list_suite_definitions_response.deserialize_json(
