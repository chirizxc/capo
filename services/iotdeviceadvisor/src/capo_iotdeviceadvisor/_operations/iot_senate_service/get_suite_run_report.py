...
def handle_response(
    ...
    out: capo_iotdeviceadvisor.types.get_suite_run_report_response.GetSuiteRunReportResponse = capo_iotdeviceadvisor.types.get_suite_run_report_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{suiteRunId}", quote(input_["suite_run_id"], safe=""))
