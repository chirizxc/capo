"""Generated from Smithy shape ``com.amazonaws.iotdeviceadvisor#DeleteSuiteDefinition``."""
...
def handle_response(
    ...
    out: capo_iotdeviceadvisor.types.delete_suite_definition_response.DeleteSuiteDefinitionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_suite_definition(
