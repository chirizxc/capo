"""Generated from Smithy shape ``com.amazonaws.iotdeviceadvisor#UpdateSuiteDefinition``."""
...
def handle_response(
    ...
    out: capo_iotdeviceadvisor.types.update_suite_definition_response.UpdateSuiteDefinitionResponse = capo_iotdeviceadvisor.types.update_suite_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iotdeviceadvisor.types.update_suite_definition_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_suite_definition(
