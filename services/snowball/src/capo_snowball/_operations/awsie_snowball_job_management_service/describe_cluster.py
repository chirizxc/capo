...
def handle_response(
    ...
    out: capo_snowball.types.describe_cluster_result.DescribeClusterResult = (
        capo_snowball.types.describe_cluster_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.describe_cluster_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_cluster(
    ...
    capo_snowball.types.describe_cluster_result.DescribeClusterResult, zapros.Response
]:
