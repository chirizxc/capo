"""Generated from Smithy shape ``com.amazonaws.snowball#CreateAddress``."""
...
import capo_snowball.errors.invalid_address_exception
import capo_snowball.errors.unsupported_address_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InvalidAddressException":
            raise capo_snowball.errors.invalid_address_exception.InvalidAddressException.from_aws_json_1_1(
                data, message
            )
        case "UnsupportedAddressException":
            raise capo_snowball.errors.unsupported_address_exception.UnsupportedAddressException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_snowball.types.create_address_result.CreateAddressResult = (
        capo_snowball.types.create_address_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.create_address_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_address(
    ...
    capo_snowball.types.create_address_result.CreateAddressResult, zapros.Response
]:
...
async def async_create_address(
