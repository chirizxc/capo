...
def handle_response(
    ...
    out: capo_snowball.types.list_compatible_images_result.ListCompatibleImagesResult = capo_snowball.types.list_compatible_images_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.list_compatible_images_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
