"""Generated from Smithy shape ``com.amazonaws.snowball#CreateLongTermPricing``."""
...
def handle_response(
    ...
    out: capo_snowball.types.create_long_term_pricing_result.CreateLongTermPricingResult = capo_snowball.types.create_long_term_pricing_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.create_long_term_pricing_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_long_term_pricing(
