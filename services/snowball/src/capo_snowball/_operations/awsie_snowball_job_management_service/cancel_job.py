...
def handle_response(
    ...
    out: capo_snowball.types.cancel_job_result.CancelJobResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.cancel_job_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def cancel_job(
    ...
    input_: capo_snowball.types.cancel_job_request.CancelJobRequest,
) -> tuple[capo_snowball.types.cancel_job_result.CancelJobResult, zapros.Response]:
