...
def handle_response(
    ...
    out: capo_snowball.types.get_snowball_usage_result.GetSnowballUsageResult = (
        capo_snowball.types.get_snowball_usage_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.get_snowball_usage_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
