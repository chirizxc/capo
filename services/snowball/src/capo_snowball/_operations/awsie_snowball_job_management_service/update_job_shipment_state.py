...
def handle_response(
    ...
    out: capo_snowball.types.update_job_shipment_state_result.UpdateJobShipmentStateResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.update_job_shipment_state_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
