...
def handle_response(
    ...
    out: capo_snowball.types.describe_addresses_result.DescribeAddressesResult = (
        capo_snowball.types.describe_addresses_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.describe_addresses_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
