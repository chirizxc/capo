"""Generated from Smithy shape ``com.amazonaws.snowball#GetSoftwareUpdates``."""
...
def handle_response(
    ...
    out: capo_snowball.types.get_software_updates_result.GetSoftwareUpdatesResult = (
        capo_snowball.types.get_software_updates_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_snowball.types.get_software_updates_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_software_updates(
