...
from capo_snowball._services._aws_config import aaws_config
...
class AsyncSnowballClient:
    ...
    async def cancel_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.cancel_cluster_request.CancelClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.cancel_cluster_result.CancelClusterResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.cancel_cluster.async_cancel_cluster(
    ...
    async def cancel_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.cancel_job_request.CancelJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.cancel_job_result.CancelJobResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.cancel_job.async_cancel_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_address(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.create_address_request.CreateAddressRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.create_address_result.CreateAddressResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.create_address.async_create_address(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.create_cluster_request.CreateClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.create_cluster_result.CreateClusterResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.create_cluster.async_create_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.create_job_request.CreateJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.create_job_result.CreateJobResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.create_job.async_create_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_long_term_pricing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.create_long_term_pricing_request.CreateLongTermPricingRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.create_long_term_pricing_result.CreateLongTermPricingResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.create_long_term_pricing.async_create_long_term_pricing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_return_shipping_label(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.create_return_shipping_label_request.CreateReturnShippingLabelRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.create_return_shipping_label_result.CreateReturnShippingLabelResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.create_return_shipping_label.async_create_return_shipping_label(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_address(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.describe_address_request.DescribeAddressRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.describe_address_result.DescribeAddressResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.describe_address.async_describe_address(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_addresses(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.describe_addresses_request.DescribeAddressesRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.describe_addresses_result.DescribeAddressesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.describe_addresses.async_describe_addresses(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_describe_addresses(
        ...
        *,
        ...
        max_results: Optional["capo_snowball.types.list_limit.ListLimit"] = None,
        next_token: Optional["capo_snowball.types.string.String"] = None,
    ) -> "AsyncIterator[capo_snowball.types.address.Address]":
        _token = next_token
        while True:
    ...
    async def describe_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.describe_cluster_request.DescribeClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.describe_cluster_result.DescribeClusterResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.describe_cluster.async_describe_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.describe_job_request.DescribeJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.describe_job_result.DescribeJobResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.describe_job.async_describe_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_return_shipping_label(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.describe_return_shipping_label_request.DescribeReturnShippingLabelRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.describe_return_shipping_label_result.DescribeReturnShippingLabelResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.describe_return_shipping_label.async_describe_return_shipping_label(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_job_manifest(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.get_job_manifest_request.GetJobManifestRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.get_job_manifest_result.GetJobManifestResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.get_job_manifest.async_get_job_manifest(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_job_unlock_code(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.get_job_unlock_code_request.GetJobUnlockCodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.get_job_unlock_code_result.GetJobUnlockCodeResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.get_job_unlock_code.async_get_job_unlock_code(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_snowball_usage(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.get_snowball_usage_request.GetSnowballUsageRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.get_snowball_usage_result.GetSnowballUsageResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.get_snowball_usage.async_get_snowball_usage(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_software_updates(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.get_software_updates_request.GetSoftwareUpdatesRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.get_software_updates_result.GetSoftwareUpdatesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.get_software_updates.async_get_software_updates(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_cluster_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.list_cluster_jobs_request.ListClusterJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.list_cluster_jobs_result.ListClusterJobsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.list_cluster_jobs.async_list_cluster_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_cluster_jobs(
        ...
        *,
        ...
        max_results: Optional["capo_snowball.types.list_limit.ListLimit"] = None,
        next_token: Optional["capo_snowball.types.string.String"] = None,
    ) -> "AsyncIterator[capo_snowball.types.job_list_entry.JobListEntry]":
        _token = next_token
        while True:
    ...
    async def list_clusters(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.list_clusters_request.ListClustersRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.list_clusters_result.ListClustersResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.list_clusters.async_list_clusters(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_clusters(
        ...
        *,
        ...
        max_results: Optional["capo_snowball.types.list_limit.ListLimit"] = None,
        next_token: Optional["capo_snowball.types.string.String"] = None,
    ) -> "AsyncIterator[capo_snowball.types.cluster_list_entry.ClusterListEntry]":
        _token = next_token
        while True:
    ...
    async def list_compatible_images(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.list_compatible_images_request.ListCompatibleImagesRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.list_compatible_images_result.ListCompatibleImagesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.list_compatible_images.async_list_compatible_images(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_compatible_images(
        ...
        *,
        ...
        max_results: Optional["capo_snowball.types.list_limit.ListLimit"] = None,
        next_token: Optional["capo_snowball.types.string.String"] = None,
    ) -> "AsyncIterator[capo_snowball.types.compatible_image.CompatibleImage]":
        _token = next_token
        while True:
    ...
    async def list_jobs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.list_jobs_request.ListJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.list_jobs_result.ListJobsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.list_jobs.async_list_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_long_term_pricing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.list_long_term_pricing_request.ListLongTermPricingRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.list_long_term_pricing_result.ListLongTermPricingResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.list_long_term_pricing.async_list_long_term_pricing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_long_term_pricing(
        ...
        *,
        ...
        max_results: Optional["capo_snowball.types.list_limit.ListLimit"] = None,
        next_token: Optional["capo_snowball.types.string.String"] = None,
    ) -> "AsyncIterator[capo_snowball.types.long_term_pricing_list_entry.LongTermPricingListEntry]":
        _token = next_token
        while True:
    ...
    async def list_pickup_locations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.list_pickup_locations_request.ListPickupLocationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.list_pickup_locations_result.ListPickupLocationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.list_pickup_locations.async_list_pickup_locations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_pickup_locations(
        self,
        *,
        config_overrides: Optional[AsyncSnowballClientConfig] = None,
        max_results: Optional["capo_snowball.types.list_limit.ListLimit"] = None,
        next_token: Optional["capo_snowball.types.string.String"] = None,
    ) -> "AsyncIterator[capo_snowball.types.list_pickup_locations_result.ListPickupLocationsResult]":
        _token = next_token
        while True:
            _response = await self.list_pickup_locations(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
            )
    ...
    async def list_service_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.list_service_versions_request.ListServiceVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.list_service_versions_result.ListServiceVersionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.list_service_versions.async_list_service_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_cluster(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.update_cluster_request.UpdateClusterRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.update_cluster_result.UpdateClusterResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.update_cluster.async_update_cluster(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.update_job_request.UpdateJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.update_job_result.UpdateJobResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.update_job.async_update_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_job_shipment_state(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.update_job_shipment_state_request.UpdateJobShipmentStateRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.update_job_shipment_state_result.UpdateJobShipmentStateResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.update_job_shipment_state.async_update_job_shipment_state(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_long_term_pricing(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_snowball.types.update_long_term_pricing_request.UpdateLongTermPricingRequest]",
        ) -> AsyncOperationResponse[
            "capo_snowball.types.update_long_term_pricing_result.UpdateLongTermPricingResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_snowball._operations.awsie_snowball_job_management_service.update_long_term_pricing.async_update_long_term_pricing(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
