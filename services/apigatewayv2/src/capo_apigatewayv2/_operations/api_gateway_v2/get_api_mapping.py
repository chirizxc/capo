...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_api_mapping_response.GetApiMappingResponse = (
        capo_apigatewayv2.types.get_api_mapping_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ApiMappingId}", quote(input_["api_mapping_id"], safe=""))
