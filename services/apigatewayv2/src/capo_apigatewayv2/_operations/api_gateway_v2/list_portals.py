...
def handle_response(
    ...
    out: capo_apigatewayv2.types.list_portals_response.ListPortalsResponse = (
        capo_apigatewayv2.types.list_portals_response.deserialize_json(
...
def list_portals(
    ...
    capo_apigatewayv2.types.list_portals_response.ListPortalsResponse, zapros.Response
]:
