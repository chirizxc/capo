...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_portal_product_sharing_policy_response.GetPortalProductSharingPolicyResponse = capo_apigatewayv2.types.get_portal_product_sharing_policy_response.deserialize_json(
