...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_route_responses_response.GetRouteResponsesResponse = capo_apigatewayv2.types.get_route_responses_response.deserialize_json(
