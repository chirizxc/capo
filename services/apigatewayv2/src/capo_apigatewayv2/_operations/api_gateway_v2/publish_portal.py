...
def handle_response(
    ...
    out: capo_apigatewayv2.types.publish_portal_response.PublishPortalResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.publish_portal_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
