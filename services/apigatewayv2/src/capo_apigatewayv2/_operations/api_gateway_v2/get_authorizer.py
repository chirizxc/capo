"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetAuthorizer``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_authorizer_response.GetAuthorizerResponse = (
        capo_apigatewayv2.types.get_authorizer_response.deserialize_json(
