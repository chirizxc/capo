"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#PutPortalProductSharingPolicy``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.put_portal_product_sharing_policy_response.PutPortalProductSharingPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.put_portal_product_sharing_policy_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_portal_product_sharing_policy(
