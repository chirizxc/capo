...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_model_response.GetModelResponse = (
        capo_apigatewayv2.types.get_model_response.deserialize_json(
...
def get_model(
    ...
    capo_apigatewayv2.types.get_model_response.GetModelResponse, zapros.Response
]:
