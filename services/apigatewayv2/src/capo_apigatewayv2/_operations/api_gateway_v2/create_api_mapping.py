"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateApiMapping``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_api_mapping_response.CreateApiMappingResponse = capo_apigatewayv2.types.create_api_mapping_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_api_mapping_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_api_mapping(
