...
def handle_response(
    ...
    out: capo_apigatewayv2.types.list_portal_products_response.ListPortalProductsResponse = capo_apigatewayv2.types.list_portal_products_response.deserialize_json(
...
def build_request(
    ...
    if "resource_owner" in input_:
        params.append(("resourceOwner", input_["resource_owner"]))
