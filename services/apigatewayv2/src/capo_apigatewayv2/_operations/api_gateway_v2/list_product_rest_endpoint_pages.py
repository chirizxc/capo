...
def handle_response(
    ...
    out: capo_apigatewayv2.types.list_product_rest_endpoint_pages_response.ListProductRestEndpointPagesResponse = capo_apigatewayv2.types.list_product_rest_endpoint_pages_response.deserialize_json(
