...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_integration_responses_response.GetIntegrationResponsesResponse = capo_apigatewayv2.types.get_integration_responses_response.deserialize_json(
