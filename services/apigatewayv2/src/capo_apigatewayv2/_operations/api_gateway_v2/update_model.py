...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_model_response.UpdateModelResponse = (
        capo_apigatewayv2.types.update_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_model_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_model(
    ...
    capo_apigatewayv2.types.update_model_response.UpdateModelResponse, zapros.Response
]:
