...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_deployment_response.CreateDeploymentResponse = (
        capo_apigatewayv2.types.create_deployment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_deployment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
