"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetApis``."""
...
import capo_apigatewayv2.types.__list_of_api
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_apis_response.GetApisResponse = (
        capo_apigatewayv2.types.get_apis_response.deserialize_json(
...
def get_apis(
    ...
    input_: capo_apigatewayv2.types.get_apis_request.GetApisRequest,
) -> tuple[capo_apigatewayv2.types.get_apis_response.GetApisResponse, zapros.Response]:
