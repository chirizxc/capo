"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetPortal``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_portal_response.GetPortalResponse = (
        capo_apigatewayv2.types.get_portal_response.deserialize_json(
...
def get_portal(
    ...
    capo_apigatewayv2.types.get_portal_response.GetPortalResponse, zapros.Response
]:
