"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateApi``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_api_response.UpdateApiResponse = (
        capo_apigatewayv2.types.update_api_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_api_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_api(
    ...
    capo_apigatewayv2.types.update_api_response.UpdateApiResponse, zapros.Response
]:
