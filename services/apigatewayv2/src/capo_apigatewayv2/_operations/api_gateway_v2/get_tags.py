"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetTags``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_tags_response.GetTagsResponse = (
        capo_apigatewayv2.types.get_tags_response.deserialize_json(
...
def get_tags(
    ...
    input_: capo_apigatewayv2.types.get_tags_request.GetTagsRequest,
) -> tuple[capo_apigatewayv2.types.get_tags_response.GetTagsResponse, zapros.Response]:
