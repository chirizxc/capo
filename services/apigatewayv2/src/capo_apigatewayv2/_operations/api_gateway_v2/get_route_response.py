"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetRouteResponse``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_route_response_response.GetRouteResponseResponse = capo_apigatewayv2.types.get_route_response_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{RouteResponseId}", quote(input_["route_response_id"], safe=""))
...
async def async_get_route_response(
