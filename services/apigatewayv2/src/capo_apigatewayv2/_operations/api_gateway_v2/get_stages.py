...
import capo_apigatewayv2.types.__list_of_stage
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_stages_response.GetStagesResponse = (
        capo_apigatewayv2.types.get_stages_response.deserialize_json(
...
def get_stages(
    ...
    capo_apigatewayv2.types.get_stages_response.GetStagesResponse, zapros.Response
]:
