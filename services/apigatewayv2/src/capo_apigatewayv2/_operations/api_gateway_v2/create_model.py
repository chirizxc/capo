...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_model_response.CreateModelResponse = (
        capo_apigatewayv2.types.create_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_model_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_model(
    ...
    capo_apigatewayv2.types.create_model_response.CreateModelResponse, zapros.Response
]:
