"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateIntegration``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_integration_result.UpdateIntegrationResult = (
        capo_apigatewayv2.types.update_integration_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_integration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
