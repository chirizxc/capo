...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_vpc_link_response.UpdateVpcLinkResponse = (
        capo_apigatewayv2.types.update_vpc_link_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_vpc_link_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
