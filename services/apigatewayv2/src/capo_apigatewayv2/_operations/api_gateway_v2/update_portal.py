"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdatePortal``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_portal_response.UpdatePortalResponse = (
        capo_apigatewayv2.types.update_portal_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_portal_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_portal(
    ...
    capo_apigatewayv2.types.update_portal_response.UpdatePortalResponse, zapros.Response
]:
