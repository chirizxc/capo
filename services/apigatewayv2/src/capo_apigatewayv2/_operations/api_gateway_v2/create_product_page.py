"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateProductPage``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_product_page_response.CreateProductPageResponse = capo_apigatewayv2.types.create_product_page_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_product_page_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_product_page(
