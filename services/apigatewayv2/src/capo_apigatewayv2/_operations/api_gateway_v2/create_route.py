"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#CreateRoute``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_route_result.CreateRouteResult = (
        capo_apigatewayv2.types.create_route_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_route_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_route(
    ...
    capo_apigatewayv2.types.create_route_result.CreateRouteResult, zapros.Response
]:
