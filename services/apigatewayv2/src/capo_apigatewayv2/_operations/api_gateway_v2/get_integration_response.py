"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetIntegrationResponse``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.get_integration_response_response.GetIntegrationResponseResponse = capo_apigatewayv2.types.get_integration_response_response.deserialize_json(
...
async def async_get_integration_response(
