...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_integration_response_response.CreateIntegrationResponseResponse = capo_apigatewayv2.types.create_integration_response_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_integration_response_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
