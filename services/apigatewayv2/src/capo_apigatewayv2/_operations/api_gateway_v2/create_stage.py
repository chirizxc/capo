...
def handle_response(
    ...
    out: capo_apigatewayv2.types.create_stage_response.CreateStageResponse = (
        capo_apigatewayv2.types.create_stage_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.create_stage_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_stage(
    ...
    capo_apigatewayv2.types.create_stage_response.CreateStageResponse, zapros.Response
]:
