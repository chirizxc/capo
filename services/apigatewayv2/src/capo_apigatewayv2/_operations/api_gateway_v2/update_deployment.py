"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#UpdateDeployment``."""
...
def handle_response(
    ...
    out: capo_apigatewayv2.types.update_deployment_response.UpdateDeploymentResponse = (
        capo_apigatewayv2.types.update_deployment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_apigatewayv2.types.update_deployment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
