...
if TYPE_CHECKING:
    ...
    import capo_apigatewayv2.types.string_with_length_between0_and2048

StageVariablesMap: TypeAlias = dict[
    "capo_apigatewayv2.types.__string.__string",
    "capo_apigatewayv2.types.string_with_length_between0_and2048.StringWithLengthBetween0And2048",
]
