"""Generated from Smithy shape ``com.amazonaws.apigatewayv2#GetRouteResponseResponse``."""
...
class GetRouteResponseResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetRouteResponseResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetRouteResponseResponse:
    out: GetRouteResponseResponse = {}  # type: ignore[typeddict-item]
    ...
    if data.get("routeResponseId") is not None:
