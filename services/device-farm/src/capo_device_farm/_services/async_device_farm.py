...
from capo_device_farm._services._aws_config import aaws_config
...
class AsyncDeviceFarmClientConfig(TypedDict, total=False, closed=True):
...
class AsyncDeviceFarmClient:
    ...
    def operation_options(
        self, config_overrides: Optional[AsyncDeviceFarmClientConfig] = None
    ...
    async def create_device_pool(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_device_pool(project_arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456', name='MyDevicePool', description='My Android devices', rules=[])
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_device_pool_request.CreateDevicePoolRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_device_pool_result.CreateDevicePoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_device_pool.async_create_device_pool(
    ...
    async def create_instance_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_instance_profile_request.CreateInstanceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_instance_profile_result.CreateInstanceProfileResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_instance_profile.async_create_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_network_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_network_profile_request.CreateNetworkProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_network_profile_result.CreateNetworkProfileResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_network_profile.async_create_network_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_project(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_project_request.CreateProjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_project_result.CreateProjectResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_project.async_create_project(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_remote_access_session(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.create_remote_access_session(project_arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456', device_arn='arn:aws:devicefarm:us-west-2::device:123EXAMPLE', name='MySession', configuration={'billingMethod': 'METERED'})
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_remote_access_session_request.CreateRemoteAccessSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_remote_access_session_result.CreateRemoteAccessSessionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_remote_access_session.async_create_remote_access_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_test_grid_project(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_test_grid_project_request.CreateTestGridProjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_test_grid_project_result.CreateTestGridProjectResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_test_grid_project.async_create_test_grid_project(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_test_grid_url(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_test_grid_url_request.CreateTestGridUrlRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_test_grid_url_result.CreateTestGridUrlResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_test_grid_url.async_create_test_grid_url(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_upload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_upload_request.CreateUploadRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_upload_result.CreateUploadResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_upload.async_create_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_vpce_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.create_vpce_configuration_request.CreateVPCEConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.create_vpce_configuration_result.CreateVPCEConfigurationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.create_vpce_configuration.async_create_vpce_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_device_pool(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_device_pool(arn='arn:aws:devicefarm:us-west-2::devicepool:123-456-EXAMPLE-GUID')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_device_pool_request.DeleteDevicePoolRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_device_pool_result.DeleteDevicePoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_device_pool.async_delete_device_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_instance_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_instance_profile_request.DeleteInstanceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_instance_profile_result.DeleteInstanceProfileResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_instance_profile.async_delete_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_network_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_network_profile_request.DeleteNetworkProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_network_profile_result.DeleteNetworkProfileResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_network_profile.async_delete_network_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_project(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_project(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_project_request.DeleteProjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_project_result.DeleteProjectResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_project.async_delete_project(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_remote_access_session(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_remote_access_session(arn='arn:aws:devicefarm:us-west-2:123456789101:session:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_remote_access_session_request.DeleteRemoteAccessSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_remote_access_session_result.DeleteRemoteAccessSessionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_remote_access_session.async_delete_remote_access_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_run(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_run(arn='arn:aws:devicefarm:us-west-2:123456789101:run:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_run_request.DeleteRunRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_run_result.DeleteRunResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_run.async_delete_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_test_grid_project(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_test_grid_project_request.DeleteTestGridProjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_test_grid_project_result.DeleteTestGridProjectResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_test_grid_project.async_delete_test_grid_project(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_upload(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.delete_upload(arn='arn:aws:devicefarm:us-west-2:123456789101:upload:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_upload_request.DeleteUploadRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_upload_result.DeleteUploadResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_upload.async_delete_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_vpce_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.delete_vpce_configuration_request.DeleteVPCEConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.delete_vpce_configuration_result.DeleteVPCEConfigurationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.delete_vpce_configuration.async_delete_vpce_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_account_settings(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_account_settings_request.GetAccountSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_account_settings_result.GetAccountSettingsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_account_settings.async_get_account_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_device(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_device(arn='arn:aws:devicefarm:us-west-2::device:123EXAMPLE')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_device_request.GetDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_device_result.GetDeviceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_device.async_get_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_device_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_device_instance_request.GetDeviceInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_device_instance_result.GetDeviceInstanceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_device_instance.async_get_device_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_device_pool(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_device_pool(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_device_pool_request.GetDevicePoolRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_device_pool_result.GetDevicePoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_device_pool.async_get_device_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_device_pool_compatibility(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_device_pool_compatibility(device_pool_arn='arn:aws:devicefarm:us-west-2::devicepool:123-456-EXAMPLE-GUID', app_arn='arn:aws:devicefarm:us-west-2::app:123-456-EXAMPLE-GUID', test_type='APPIUM_PYTHON')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_device_pool_compatibility_request.GetDevicePoolCompatibilityRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_device_pool_compatibility_result.GetDevicePoolCompatibilityResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_device_pool_compatibility.async_get_device_pool_compatibility(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_instance_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_instance_profile_request.GetInstanceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_instance_profile_result.GetInstanceProfileResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_instance_profile.async_get_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_job(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_job(arn='arn:aws:devicefarm:us-west-2::job:123-456-EXAMPLE-GUID')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_job_request.GetJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_job_result.GetJobResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_job.async_get_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_network_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_network_profile_request.GetNetworkProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_network_profile_result.GetNetworkProfileResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_network_profile.async_get_network_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_offering_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_offering_status_request.GetOfferingStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_offering_status_result.GetOfferingStatusResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_offering_status.async_get_offering_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_project(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_project_request.GetProjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_project_result.GetProjectResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_project.async_get_project(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_remote_access_session(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_remote_access_session(arn='arn:aws:devicefarm:us-west-2:123456789101:session:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_remote_access_session_request.GetRemoteAccessSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_remote_access_session_result.GetRemoteAccessSessionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_remote_access_session.async_get_remote_access_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_run(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_run_request.GetRunRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_run_result.GetRunResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_run.async_get_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_suite(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_suite(arn='arn:aws:devicefarm:us-west-2:123456789101:suite:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_suite_request.GetSuiteRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_suite_result.GetSuiteResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_suite.async_get_suite(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_test(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_test(arn='arn:aws:devicefarm:us-west-2:123456789101:test:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_test_request.GetTestRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_test_result.GetTestResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_test.async_get_test(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_test_grid_project(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_test_grid_project_request.GetTestGridProjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_test_grid_project_result.GetTestGridProjectResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_test_grid_project.async_get_test_grid_project(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_test_grid_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_test_grid_session_request.GetTestGridSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_test_grid_session_result.GetTestGridSessionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_test_grid_session.async_get_test_grid_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_upload(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.get_upload(arn='arn:aws:devicefarm:us-west-2:123456789101:upload:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_upload_request.GetUploadRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_upload_result.GetUploadResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_upload.async_get_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_vpce_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.get_vpce_configuration_request.GetVPCEConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.get_vpce_configuration_result.GetVPCEConfigurationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.get_vpce_configuration.async_get_vpce_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def install_to_remote_access_session(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.install_to_remote_access_session(remote_access_session_arn='arn:aws:devicefarm:us-west-2:123456789101:session:EXAMPLE-GUID-123-456', app_arn='arn:aws:devicefarm:us-west-2:123456789101:app:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.install_to_remote_access_session_request.InstallToRemoteAccessSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.install_to_remote_access_session_result.InstallToRemoteAccessSessionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.install_to_remote_access_session.async_install_to_remote_access_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_artifacts(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_artifacts(arn='arn:aws:devicefarm:us-west-2:123456789101:run:EXAMPLE-GUID-123-456', type='SCREENSHOT')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_artifacts_request.ListArtifactsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_artifacts_result.ListArtifactsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_artifacts.async_list_artifacts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.artifact.Artifact]":
        _token = next_token
        while True:
    ...
    async def list_device_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_device_instances_request.ListDeviceInstancesRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_device_instances_result.ListDeviceInstancesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_device_instances.async_list_device_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_device_pools(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_device_pools(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456', type='PRIVATE')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_device_pools_request.ListDevicePoolsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_device_pools_result.ListDevicePoolsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_device_pools.async_list_device_pools(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.device_pool.DevicePool]":
        _token = next_token
        while True:
            _response = await self.list_device_pools(
                arn,
                config_overrides=config_overrides,
                type=type,
                next_token=_token,
    ...
    async def list_devices(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_devices(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_devices_request.ListDevicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_devices_result.ListDevicesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_devices.async_list_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_devices(
        ...
        *,
        ...
        filters: Optional["capo_device_farm.types.device_filters.DeviceFilters"] = None,
    ) -> "AsyncIterator[capo_device_farm.types.device.Device]":
        _token = next_token
        while True:
    ...
    async def list_instance_profiles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_instance_profiles_request.ListInstanceProfilesRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_instance_profiles_result.ListInstanceProfilesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_instance_profiles.async_list_instance_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_jobs(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_jobs(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_jobs_request.ListJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_jobs_result.ListJobsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_jobs.async_list_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.job.Job]":
        _token = next_token
        while True:
    ...
    async def list_network_profiles(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_network_profiles_request.ListNetworkProfilesRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_network_profiles_result.ListNetworkProfilesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_network_profiles.async_list_network_profiles(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_offering_promotions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_offering_promotions_request.ListOfferingPromotionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_offering_promotions_result.ListOfferingPromotionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_offering_promotions.async_list_offering_promotions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_offerings(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_offerings(next_token='RW5DdDJkMWYwZjM2MzM2VHVpOHJIUXlDUXlhc2QzRGViYnc9SEXAMPLE=')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_offerings_request.ListOfferingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_offerings_result.ListOfferingsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_offerings.async_list_offerings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.offering.Offering]":
        _token = next_token
        while True:
    ...
    async def list_offering_transactions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_offering_transactions_request.ListOfferingTransactionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_offering_transactions_result.ListOfferingTransactionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_offering_transactions.async_list_offering_transactions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_offering_transactions(
        ...
        *,
        ...
        "AsyncIterator[capo_device_farm.types.offering_transaction.OfferingTransaction]"
    ):
        _token = next_token
        while True:
            _response = await self.list_offering_transactions(
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    async def list_projects(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_projects_request.ListProjectsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_projects_result.ListProjectsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_projects.async_list_projects(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.project.Project]":
        _token = next_token
        while True:
    ...
    async def list_remote_access_sessions(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_remote_access_sessions(arn='arn:aws:devicefarm:us-west-2:123456789101:session:EXAMPLE-GUID-123-456', next_token='RW5DdDJkMWYwZjM2MzM2VHVpOHJIUXlDUXlhc2QzRGViYnc9SEXAMPLE=')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_remote_access_sessions_request.ListRemoteAccessSessionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_remote_access_sessions_result.ListRemoteAccessSessionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_remote_access_sessions.async_list_remote_access_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_runs(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_runs_request.ListRunsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_runs_result.ListRunsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_runs.async_list_runs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.run.Run]":
        _token = next_token
        while True:
    ...
    async def list_samples(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_samples(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456', next_token='RW5DdDJkMWYwZjM2MzM2VHVpOHJIUXlDUXlhc2QzRGViYnc9SEXAMPLE')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_samples_request.ListSamplesRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_samples_result.ListSamplesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_samples.async_list_samples(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.sample.Sample]":
        _token = next_token
        while True:
            _response = await self.list_samples(
                arn,
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    async def list_suites(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_suites(arn='arn:aws:devicefarm:us-west-2:123456789101:job:EXAMPLE-GUID-123-456', next_token='RW5DdDJkMWYwZjM2MzM2VHVpOHJIUXlDUXlhc2QzRGViYnc9SEXAMPLE')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_suites_request.ListSuitesRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_suites_result.ListSuitesResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_suites.async_list_suites(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.suite.Suite]":
        _token = next_token
        while True:
            _response = await self.list_suites(
                arn,
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_test_grid_projects(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_test_grid_projects_request.ListTestGridProjectsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_test_grid_projects_result.ListTestGridProjectsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_test_grid_projects.async_list_test_grid_projects(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_test_grid_session_actions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_test_grid_session_actions_request.ListTestGridSessionActionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_test_grid_session_actions_result.ListTestGridSessionActionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_test_grid_session_actions.async_list_test_grid_session_actions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_test_grid_session_artifacts(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_test_grid_session_artifacts_request.ListTestGridSessionArtifactsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_test_grid_session_artifacts_result.ListTestGridSessionArtifactsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_test_grid_session_artifacts.async_list_test_grid_session_artifacts(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_test_grid_sessions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_test_grid_sessions_request.ListTestGridSessionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_test_grid_sessions_result.ListTestGridSessionsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_test_grid_sessions.async_list_test_grid_sessions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tests(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_tests(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456', next_token='RW5DdDJkMWYwZjM2MzM2VHVpOHJIUXlDUXlhc2QzRGViYnc9SEXAMPLE')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_tests_request.ListTestsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_tests_result.ListTestsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_tests.async_list_tests(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.test.Test]":
        _token = next_token
        while True:
            _response = await self.list_tests(
                arn,
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    async def list_unique_problems(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_unique_problems(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456', next_token='RW5DdDJkMWYwZjM2MzM2VHVpOHJIUXlDUXlhc2QzRGViYnc9SEXAMPLE')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_unique_problems_request.ListUniqueProblemsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_unique_problems_result.ListUniqueProblemsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_unique_problems.async_list_unique_problems(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[tuple[capo_device_farm.types.execution_result.ExecutionResult, capo_device_farm.types.unique_problems.UniqueProblems]]":
        _token = next_token
        while True:
            _response = await self.list_unique_problems(
                arn,
                config_overrides=config_overrides,
                next_token=_token,
            )
    ...
    async def list_uploads(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.list_uploads(arn='arn:aws:devicefarm:us-west-2:123456789101:project:EXAMPLE-GUID-123-456', next_token='RW5DdDJkMWYwZjM2MzM2VHVpOHJIUXlDUXlhc2QzRGViYnc9SEXAMPLE')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_uploads_request.ListUploadsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_uploads_result.ListUploadsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_uploads.async_list_uploads(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_device_farm.types.upload.Upload]":
        _token = next_token
        while True:
            _response = await self.list_uploads(
                arn,
                config_overrides=config_overrides,
                type=type,
                next_token=_token,
    ...
    async def list_vpce_configurations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.list_vpce_configurations_request.ListVPCEConfigurationsRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.list_vpce_configurations_result.ListVPCEConfigurationsResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.list_vpce_configurations.async_list_vpce_configurations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def purchase_offering(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.purchase_offering_request.PurchaseOfferingRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.purchase_offering_result.PurchaseOfferingResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.purchase_offering.async_purchase_offering(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def renew_offering(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.renew_offering_request.RenewOfferingRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.renew_offering_result.RenewOfferingResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.renew_offering.async_renew_offering(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
        ...
        *,
        ...
        async def _handler(
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.schedule_run.async_schedule_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.stop_job_request.StopJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.stop_job_result.StopJobResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.stop_job.async_stop_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_remote_access_session(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.stop_remote_access_session_request.StopRemoteAccessSessionRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.stop_remote_access_session_result.StopRemoteAccessSessionResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.stop_remote_access_session.async_stop_remote_access_session(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_run(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.stop_run(arn='arn:aws:devicefarm:us-west-2:123456789101:run:EXAMPLE-GUID-123-456')
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.stop_run_request.StopRunRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.stop_run_result.StopRunResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.stop_run.async_stop_run(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_device_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.update_device_instance_request.UpdateDeviceInstanceRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.update_device_instance_result.UpdateDeviceInstanceResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.update_device_instance.async_update_device_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_device_pool(
        ...
        *,
        ...
        Examples:
            ...
            >>> await client.update_device_pool(arn='arn:aws:devicefarm:us-west-2::devicepool:082d10e5-d7d7-48a5-ba5c-12345EXAMPLE', name='NewName', description='NewDescription', rules=[{'attribute': 'REMOTE_ACCESS_ENABLED', 'operator': 'EQUALS', 'value': 'True'}])
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.update_device_pool_request.UpdateDevicePoolRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.update_device_pool_result.UpdateDevicePoolResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.update_device_pool.async_update_device_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_instance_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.update_instance_profile_request.UpdateInstanceProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.update_instance_profile_result.UpdateInstanceProfileResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.update_instance_profile.async_update_instance_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_network_profile(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.update_network_profile_request.UpdateNetworkProfileRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.update_network_profile_result.UpdateNetworkProfileResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.update_network_profile.async_update_network_profile(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_project(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.update_project_request.UpdateProjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.update_project_result.UpdateProjectResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.update_project.async_update_project(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_test_grid_project(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.update_test_grid_project_request.UpdateTestGridProjectRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.update_test_grid_project_result.UpdateTestGridProjectResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.update_test_grid_project.async_update_test_grid_project(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_upload(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.update_upload_request.UpdateUploadRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.update_upload_result.UpdateUploadResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.update_upload.async_update_upload(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_vpce_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_device_farm.types.update_vpce_configuration_request.UpdateVPCEConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_device_farm.types.update_vpce_configuration_result.UpdateVPCEConfigurationResult"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_device_farm._operations.device_farm_20150623.update_vpce_configuration.async_update_vpce_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
