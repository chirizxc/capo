"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateInstanceProfile``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.update_instance_profile_result.UpdateInstanceProfileResult = capo_device_farm.types.update_instance_profile_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.update_instance_profile_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_instance_profile(
