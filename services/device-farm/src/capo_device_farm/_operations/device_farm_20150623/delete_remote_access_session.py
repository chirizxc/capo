"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteRemoteAccessSession``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.delete_remote_access_session_result.DeleteRemoteAccessSessionResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.delete_remote_access_session_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_remote_access_session(
