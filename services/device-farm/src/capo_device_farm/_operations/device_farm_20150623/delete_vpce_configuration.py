...
def handle_response(
    ...
    out: capo_device_farm.types.delete_vpce_configuration_result.DeleteVPCEConfigurationResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.delete_vpce_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
