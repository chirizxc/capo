"""Generated from Smithy shape ``com.amazonaws.devicefarm#DeleteDevicePool``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.delete_device_pool_result.DeleteDevicePoolResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.delete_device_pool_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_device_pool(
