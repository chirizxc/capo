"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateNetworkProfile``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.update_network_profile_result.UpdateNetworkProfileResult = capo_device_farm.types.update_network_profile_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.update_network_profile_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_network_profile(
