...
import capo_device_farm.errors.cannot_delete_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "CannotDeleteException":
            raise capo_device_farm.errors.cannot_delete_exception.CannotDeleteException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_device_farm.types.delete_test_grid_project_result.DeleteTestGridProjectResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.delete_test_grid_project_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
