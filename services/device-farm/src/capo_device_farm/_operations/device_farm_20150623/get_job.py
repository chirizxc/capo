...
def handle_response(
    ...
    out: capo_device_farm.types.get_job_result.GetJobResult = (
        capo_device_farm.types.get_job_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_device_farm.types.get_job_request.GetJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_job_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_job(
    ...
    input_: capo_device_farm.types.get_job_request.GetJobRequest,
) -> tuple[capo_device_farm.types.get_job_result.GetJobResult, zapros.Response]:
