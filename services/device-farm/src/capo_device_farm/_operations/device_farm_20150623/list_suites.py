...
def handle_response(
    ...
    out: capo_device_farm.types.list_suites_result.ListSuitesResult = (
        capo_device_farm.types.list_suites_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_suites_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_suites(
    ...
    input_: capo_device_farm.types.list_suites_request.ListSuitesRequest,
) -> tuple[capo_device_farm.types.list_suites_result.ListSuitesResult, zapros.Response]:
