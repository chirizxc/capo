"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetTest``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_test_result.GetTestResult = (
        capo_device_farm.types.get_test_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_device_farm.types.get_test_request.GetTestRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_test_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_test(
    ...
    input_: capo_device_farm.types.get_test_request.GetTestRequest,
) -> tuple[capo_device_farm.types.get_test_result.GetTestResult, zapros.Response]:
