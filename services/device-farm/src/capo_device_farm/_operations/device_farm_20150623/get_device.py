"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetDevice``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_device_result.GetDeviceResult = (
        capo_device_farm.types.get_device_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_device_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_device(
    ...
    input_: capo_device_farm.types.get_device_request.GetDeviceRequest,
) -> tuple[capo_device_farm.types.get_device_result.GetDeviceResult, zapros.Response]:
