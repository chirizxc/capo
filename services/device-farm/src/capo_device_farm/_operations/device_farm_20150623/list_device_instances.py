"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListDeviceInstances``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.list_device_instances_result.ListDeviceInstancesResult = capo_device_farm.types.list_device_instances_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_device_instances_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_device_instances(
