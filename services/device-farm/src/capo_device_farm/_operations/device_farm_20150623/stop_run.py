"""Generated from Smithy shape ``com.amazonaws.devicefarm#StopRun``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.stop_run_result.StopRunResult = (
        capo_device_farm.types.stop_run_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_device_farm.types.stop_run_request.StopRunRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.stop_run_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def stop_run(
    ...
    input_: capo_device_farm.types.stop_run_request.StopRunRequest,
) -> tuple[capo_device_farm.types.stop_run_result.StopRunResult, zapros.Response]:
