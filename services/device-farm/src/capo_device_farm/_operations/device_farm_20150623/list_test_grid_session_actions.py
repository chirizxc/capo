"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListTestGridSessionActions``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.list_test_grid_session_actions_result.ListTestGridSessionActionsResult = capo_device_farm.types.list_test_grid_session_actions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_test_grid_session_actions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_test_grid_session_actions(
