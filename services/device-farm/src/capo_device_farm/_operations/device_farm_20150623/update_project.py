"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateProject``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.update_project_result.UpdateProjectResult = (
        capo_device_farm.types.update_project_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.update_project_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_project(
    ...
    capo_device_farm.types.update_project_result.UpdateProjectResult, zapros.Response
]:
