"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetAccountSettings``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_account_settings_result.GetAccountSettingsResult = (
        capo_device_farm.types.get_account_settings_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_account_settings_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
