"""Generated from Smithy shape ``com.amazonaws.devicefarm#UpdateDevicePool``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.update_device_pool_result.UpdateDevicePoolResult = (
        capo_device_farm.types.update_device_pool_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.update_device_pool_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_device_pool(
