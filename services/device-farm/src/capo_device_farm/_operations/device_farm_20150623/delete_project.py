...
def handle_response(
    ...
    out: capo_device_farm.types.delete_project_result.DeleteProjectResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.delete_project_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_project(
    ...
    capo_device_farm.types.delete_project_result.DeleteProjectResult, zapros.Response
]:
