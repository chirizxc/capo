...
def handle_response(
    ...
    out: capo_device_farm.types.delete_run_result.DeleteRunResult = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.delete_run_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_run(
    ...
    input_: capo_device_farm.types.delete_run_request.DeleteRunRequest,
) -> tuple[capo_device_farm.types.delete_run_result.DeleteRunResult, zapros.Response]:
