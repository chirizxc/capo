"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListTestGridProjects``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.list_test_grid_projects_result.ListTestGridProjectsResult = capo_device_farm.types.list_test_grid_projects_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_test_grid_projects_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_test_grid_projects(
