"""Generated from Smithy shape ``com.amazonaws.devicefarm#CreateRemoteAccessSession``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.create_remote_access_session_result.CreateRemoteAccessSessionResult = capo_device_farm.types.create_remote_access_session_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.create_remote_access_session_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_remote_access_session(
