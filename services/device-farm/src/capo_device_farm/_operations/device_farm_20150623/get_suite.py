...
def handle_response(
    ...
    out: capo_device_farm.types.get_suite_result.GetSuiteResult = (
        capo_device_farm.types.get_suite_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    input_: capo_device_farm.types.get_suite_request.GetSuiteRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_suite_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_suite(
    ...
    input_: capo_device_farm.types.get_suite_request.GetSuiteRequest,
) -> tuple[capo_device_farm.types.get_suite_result.GetSuiteResult, zapros.Response]:
