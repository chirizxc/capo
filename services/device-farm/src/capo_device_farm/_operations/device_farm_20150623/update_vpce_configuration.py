...
import capo_device_farm.errors.invalid_operation_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOperationException":
            raise capo_device_farm.errors.invalid_operation_exception.InvalidOperationException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_device_farm.types.update_vpce_configuration_result.UpdateVPCEConfigurationResult = capo_device_farm.types.update_vpce_configuration_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.update_vpce_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
