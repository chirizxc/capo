"""Generated from Smithy shape ``com.amazonaws.devicefarm#GetDevicePoolCompatibility``."""
...
def handle_response(
    ...
    out: capo_device_farm.types.get_device_pool_compatibility_result.GetDevicePoolCompatibilityResult = capo_device_farm.types.get_device_pool_compatibility_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_device_pool_compatibility_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_device_pool_compatibility(
