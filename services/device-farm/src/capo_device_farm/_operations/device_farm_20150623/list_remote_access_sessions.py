...
def handle_response(
    ...
    out: capo_device_farm.types.list_remote_access_sessions_result.ListRemoteAccessSessionsResult = capo_device_farm.types.list_remote_access_sessions_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_remote_access_sessions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
