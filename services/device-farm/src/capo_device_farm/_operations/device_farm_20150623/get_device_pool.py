...
def handle_response(
    ...
    out: capo_device_farm.types.get_device_pool_result.GetDevicePoolResult = (
        capo_device_farm.types.get_device_pool_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.get_device_pool_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_device_pool(
    ...
    capo_device_farm.types.get_device_pool_result.GetDevicePoolResult, zapros.Response
]:
