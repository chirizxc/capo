...
def handle_response(
    ...
    out: capo_device_farm.types.list_vpce_configurations_result.ListVPCEConfigurationsResult = capo_device_farm.types.list_vpce_configurations_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_vpce_configurations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
