"""Generated from Smithy shape ``com.amazonaws.devicefarm#ListTests``."""
...
import capo_device_farm.types.tests
...
def handle_response(
    ...
    out: capo_device_farm.types.list_tests_result.ListTestsResult = (
        capo_device_farm.types.list_tests_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.list_tests_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_tests(
    ...
    input_: capo_device_farm.types.list_tests_request.ListTestsRequest,
) -> tuple[capo_device_farm.types.list_tests_result.ListTestsResult, zapros.Response]:
