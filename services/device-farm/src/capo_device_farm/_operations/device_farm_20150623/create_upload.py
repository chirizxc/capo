...
def handle_response(
    ...
    out: capo_device_farm.types.create_upload_result.CreateUploadResult = (
        capo_device_farm.types.create_upload_result.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_device_farm.types.create_upload_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_upload(
    ...
    capo_device_farm.types.create_upload_result.CreateUploadResult, zapros.Response
]:
