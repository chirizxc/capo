...
class ListTestsResult(TypedDict, closed=True):
    tests: NotRequired["capo_device_farm.types.tests.Tests"]
...
def serialize_aws_json_1_1(value: ListTestsResult) -> dict:
    ...
    if "tests" in value:
        ...
        out["tests"] = capo_device_farm.types.tests.serialize_aws_json_1_1(
            value["tests"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListTestsResult:
    ...
    if data.get("tests") is not None:
        ...
        out["tests"] = capo_device_farm.types.tests.deserialize_aws_json_1_1(
            data["tests"]
        )
