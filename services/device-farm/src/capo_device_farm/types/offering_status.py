...
class OfferingStatus(TypedDict, closed=True):
    type: NotRequired[
        "capo_device_farm.types.offering_transaction_type.OfferingTransactionType"
    ]
    """<p>The type specified for the offering status.</p>"""
    offering: NotRequired["capo_device_farm.types.offering.Offering"]
    """<p>Represents the metadata of an offering status.</p>"""
    quantity: NotRequired["capo_device_farm.types.integer.Integer"]
    """<p>The number of available devices in the offering.</p>"""
    effective_on: NotRequired["capo_device_farm.types.date_time.DateTime"]
...
def serialize_aws_json_1_1(value: OfferingStatus) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = (
            capo_device_farm.types.offering_transaction_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
    if "offering" in value:
        ...
        out["offering"] = capo_device_farm.types.offering.serialize_aws_json_1_1(
            value["offering"]
        )
    ...
    if "effective_on" in value:
        ...
        out["effectiveOn"] = capo_device_farm.types.date_time.serialize_aws_json_1_1(
            value["effective_on"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> OfferingStatus:
    ...
    if data.get("type") is not None:
        ...
        out["type"] = (
            capo_device_farm.types.offering_transaction_type.deserialize_aws_json_1_1(
                data["type"]
            )
        )
