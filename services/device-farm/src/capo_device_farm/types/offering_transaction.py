...
if TYPE_CHECKING:
    ...
    import capo_device_farm.types.transaction_identifier
...
class OfferingTransaction(TypedDict, closed=True):
    ...
    transaction_id: NotRequired[
        "capo_device_farm.types.transaction_identifier.TransactionIdentifier"
    ]
    ...
    created_on: NotRequired["capo_device_farm.types.date_time.DateTime"]
...
def serialize_aws_json_1_1(value: OfferingTransaction) -> dict:
    ...
    if "offering_status" in value:
        ...
        out["offeringStatus"] = (
            capo_device_farm.types.offering_status.serialize_aws_json_1_1(
    ...
    if "created_on" in value:
        ...
        out["createdOn"] = capo_device_farm.types.date_time.serialize_aws_json_1_1(
            value["created_on"]
        )
    if "cost" in value:
        import capo_device_farm.types.monetary_amount
...
def deserialize_aws_json_1_1(data: dict) -> OfferingTransaction:
    ...
    if data.get("offeringStatus") is not None:
        ...
        out["offering_status"] = (
            capo_device_farm.types.offering_status.deserialize_aws_json_1_1(
                data["offeringStatus"]
            )
        )
