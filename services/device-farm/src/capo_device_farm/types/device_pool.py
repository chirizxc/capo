...
class DevicePool(TypedDict, closed=True):
    ...
    type: NotRequired["capo_device_farm.types.device_pool_type.DevicePoolType"]
...
def serialize_aws_json_1_1(value: DevicePool) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = capo_device_farm.types.device_pool_type.serialize_aws_json_1_1(
            value["type"]
        )
    if "rules" in value:
        import capo_device_farm.types.rules
