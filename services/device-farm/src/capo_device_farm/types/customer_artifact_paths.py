...
class CustomerArtifactPaths(TypedDict, closed=True):
    ios_paths: NotRequired["capo_device_farm.types.ios_paths.IosPaths"]
    ...
    android_paths: NotRequired["capo_device_farm.types.android_paths.AndroidPaths"]
    ...
    device_host_paths: NotRequired[
        "capo_device_farm.types.device_host_paths.DeviceHostPaths"
    ]
...
def serialize_aws_json_1_1(value: CustomerArtifactPaths) -> dict:
    ...
    if "ios_paths" in value:
        ...
        out["iosPaths"] = capo_device_farm.types.ios_paths.serialize_aws_json_1_1(
            value["ios_paths"]
        )
    if "android_paths" in value:
        ...
        out["androidPaths"] = (
            capo_device_farm.types.android_paths.serialize_aws_json_1_1(
                value["android_paths"]
            )
        )
    if "device_host_paths" in value:
        ...
        out["deviceHostPaths"] = (
            capo_device_farm.types.device_host_paths.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> CustomerArtifactPaths:
    ...
    if data.get("androidPaths") is not None:
        ...
        out["android_paths"] = (
            capo_device_farm.types.android_paths.deserialize_aws_json_1_1(
                data["androidPaths"]
            )
        )
    if data.get("deviceHostPaths") is not None:
        ...
        out["device_host_paths"] = (
            capo_device_farm.types.device_host_paths.deserialize_aws_json_1_1(
