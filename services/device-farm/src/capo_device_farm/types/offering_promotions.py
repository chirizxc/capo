...
if TYPE_CHECKING:
    import capo_device_farm.types.offering_promotion

OfferingPromotions: TypeAlias = list[
    "capo_device_farm.types.offering_promotion.OfferingPromotion"
]
...
def serialize_aws_json_1_1(value: OfferingPromotions) -> list:
    ...
    for item in value:
        out.append(
            capo_device_farm.types.offering_promotion.serialize_aws_json_1_1(item)
        )
    return out
