...
class GetTestGridSessionRequest(TypedDict, closed=True):
    project_arn: NotRequired["capo_device_farm.types.device_farm_arn.DeviceFarmArn"]
    """<p>The ARN for the project that this session belongs to. See <a>CreateTestGridProject</a> and <a>ListTestGridProjects</a>.</p>"""
    session_id: NotRequired["capo_device_farm.types.resource_id.ResourceId"]
    """<p>An ID associated with this session.</p>"""
    session_arn: NotRequired["capo_device_farm.types.device_farm_arn.DeviceFarmArn"]
