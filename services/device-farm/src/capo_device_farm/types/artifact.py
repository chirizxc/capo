...
class Artifact(TypedDict, closed=True):
    ...
    type: NotRequired["capo_device_farm.types.artifact_type.ArtifactType"]
    ...
    extension: NotRequired["capo_device_farm.types.string.String"]
...
def serialize_aws_json_1_1(value: Artifact) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = capo_device_farm.types.artifact_type.serialize_aws_json_1_1(
            value["type"]
        )
