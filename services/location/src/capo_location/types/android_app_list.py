...
if TYPE_CHECKING:
    import capo_location.types.android_app

AndroidAppList: TypeAlias = list["capo_location.types.android_app.AndroidApp"]
...
def serialize_json(value: AndroidAppList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_location.types.android_app.serialize_json(item))
    return out
