...
def handle_response(
    ...
    out: capo_location.types.delete_tracker_response.DeleteTrackerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_tracker(
    ...
    capo_location.types.delete_tracker_response.DeleteTrackerResponse, zapros.Response
]:
