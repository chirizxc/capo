"""Generated from Smithy shape ``com.amazonaws.location#UpdatePlaceIndex``."""
...
def handle_response(
    ...
    out: capo_location.types.update_place_index_response.UpdatePlaceIndexResponse = (
        capo_location.types.update_place_index_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.update_place_index_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_place_index(
