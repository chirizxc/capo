...
def handle_response(
    ...
    out: capo_location.types.batch_get_device_position_response.BatchGetDevicePositionResponse = capo_location.types.batch_get_device_position_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.batch_get_device_position_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
