"""Generated from Smithy shape ``com.amazonaws.location#GetMapGlyphs``."""
...
def handle_response(
    ...
    out: capo_location.types.get_map_glyphs_response.GetMapGlyphsResponse = {
...
def get_map_glyphs(
    ...
    capo_location.types.get_map_glyphs_response.GetMapGlyphsResponse, zapros.Response
]:
