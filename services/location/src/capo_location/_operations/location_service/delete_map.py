...
def handle_response(
    ...
    out: capo_location.types.delete_map_response.DeleteMapResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_map(
    ...
    input_: capo_location.types.delete_map_request.DeleteMapRequest,
) -> tuple[capo_location.types.delete_map_response.DeleteMapResponse, zapros.Response]:
