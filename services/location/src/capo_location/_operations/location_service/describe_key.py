...
def handle_response(
    ...
    out: capo_location.types.describe_key_response.DescribeKeyResponse = (
        capo_location.types.describe_key_response.deserialize_json(
...
def describe_key(
    ...
    capo_location.types.describe_key_response.DescribeKeyResponse, zapros.Response
]:
