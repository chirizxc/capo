"""Generated from Smithy shape ``com.amazonaws.location#DeletePlaceIndex``."""
...
def handle_response(
    ...
    out: capo_location.types.delete_place_index_response.DeletePlaceIndexResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_place_index(
