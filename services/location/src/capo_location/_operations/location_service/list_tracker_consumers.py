...
def handle_response(
    ...
    out: capo_location.types.list_tracker_consumers_response.ListTrackerConsumersResponse = capo_location.types.list_tracker_consumers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.list_tracker_consumers_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
