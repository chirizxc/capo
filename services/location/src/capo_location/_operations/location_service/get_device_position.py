"""Generated from Smithy shape ``com.amazonaws.location#GetDevicePosition``."""
...
def handle_response(
    ...
    out: capo_location.types.get_device_position_response.GetDevicePositionResponse = (
        capo_location.types.get_device_position_response.deserialize_json(
...
async def async_get_device_position(
