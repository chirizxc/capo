...
def handle_response(
    ...
    out: capo_location.types.list_trackers_response.ListTrackersResponse = (
        capo_location.types.list_trackers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.list_trackers_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_trackers(
    ...
    capo_location.types.list_trackers_response.ListTrackersResponse, zapros.Response
]:
