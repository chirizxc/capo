...
def handle_response(
    ...
    out: capo_location.types.disassociate_tracker_consumer_response.DisassociateTrackerConsumerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{ConsumerArn}", quote(input_["consumer_arn"], safe=""))
