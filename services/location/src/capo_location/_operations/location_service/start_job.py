...
def handle_response(
    ...
    out: capo_location.types.start_job_response.StartJobResponse = (
        capo_location.types.start_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.start_job_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def start_job(
    ...
    input_: capo_location.types.start_job_request.StartJobRequest,
) -> tuple[capo_location.types.start_job_response.StartJobResponse, zapros.Response]:
