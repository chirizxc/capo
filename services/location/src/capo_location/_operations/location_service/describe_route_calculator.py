...
def handle_response(
    ...
    out: capo_location.types.describe_route_calculator_response.DescribeRouteCalculatorResponse = capo_location.types.describe_route_calculator_response.deserialize_json(
