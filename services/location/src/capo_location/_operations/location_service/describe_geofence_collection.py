"""Generated from Smithy shape ``com.amazonaws.location#DescribeGeofenceCollection``."""
...
def handle_response(
    ...
    out: capo_location.types.describe_geofence_collection_response.DescribeGeofenceCollectionResponse = capo_location.types.describe_geofence_collection_response.deserialize_json(
...
async def async_describe_geofence_collection(
