...
def handle_response(
    ...
    out: capo_location.types.list_geofence_collections_response.ListGeofenceCollectionsResponse = capo_location.types.list_geofence_collections_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.list_geofence_collections_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
