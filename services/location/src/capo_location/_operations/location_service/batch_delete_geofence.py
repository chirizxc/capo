"""Generated from Smithy shape ``com.amazonaws.location#BatchDeleteGeofence``."""
...
def handle_response(
    ...
    out: capo_location.types.batch_delete_geofence_response.BatchDeleteGeofenceResponse = capo_location.types.batch_delete_geofence_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.batch_delete_geofence_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_batch_delete_geofence(
