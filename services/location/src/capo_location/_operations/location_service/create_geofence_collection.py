...
def handle_response(
    ...
    out: capo_location.types.create_geofence_collection_response.CreateGeofenceCollectionResponse = capo_location.types.create_geofence_collection_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.create_geofence_collection_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
