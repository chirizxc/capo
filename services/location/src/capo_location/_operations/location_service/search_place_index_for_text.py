...
def handle_response(
    ...
    out: capo_location.types.search_place_index_for_text_response.SearchPlaceIndexForTextResponse = capo_location.types.search_place_index_for_text_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.search_place_index_for_text_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
