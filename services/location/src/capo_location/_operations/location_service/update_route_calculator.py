"""Generated from Smithy shape ``com.amazonaws.location#UpdateRouteCalculator``."""
...
def handle_response(
    ...
    out: capo_location.types.update_route_calculator_response.UpdateRouteCalculatorResponse = capo_location.types.update_route_calculator_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.update_route_calculator_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_route_calculator(
