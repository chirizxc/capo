...
def handle_response(
    ...
    out: capo_location.types.get_device_position_history_response.GetDevicePositionHistoryResponse = capo_location.types.get_device_position_history_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_location.types.get_device_position_history_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
