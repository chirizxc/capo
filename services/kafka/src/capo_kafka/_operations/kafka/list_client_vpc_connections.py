...
def handle_response(
    ...
    out: capo_kafka.types.list_client_vpc_connections_response.ListClientVpcConnectionsResponse = capo_kafka.types.list_client_vpc_connections_response.deserialize_json(
