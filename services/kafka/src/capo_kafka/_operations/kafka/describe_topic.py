"""Generated from Smithy shape ``com.amazonaws.kafka#DescribeTopic``."""
...
def handle_response(
    ...
    out: capo_kafka.types.describe_topic_response.DescribeTopicResponse = (
        capo_kafka.types.describe_topic_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{TopicName}", quote(input_["topic_name"], safe=""))
...
def describe_topic(
    ...
    capo_kafka.types.describe_topic_response.DescribeTopicResponse, zapros.Response
]:
