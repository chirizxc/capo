"""Generated from Smithy shape ``com.amazonaws.kafka#ListKafkaVersions``."""
...
def handle_response(
    ...
    out: capo_kafka.types.list_kafka_versions_response.ListKafkaVersionsResponse = (
        capo_kafka.types.list_kafka_versions_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/kafka-versions"
...
async def async_list_kafka_versions(
