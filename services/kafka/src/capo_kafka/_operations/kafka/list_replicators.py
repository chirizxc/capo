"""Generated from Smithy shape ``com.amazonaws.kafka#ListReplicators``."""
...
def handle_response(
    ...
    out: capo_kafka.types.list_replicators_response.ListReplicatorsResponse = (
        capo_kafka.types.list_replicators_response.deserialize_json(
...
def build_request(
    ...
    if "replicator_name_filter" in input_:
        params.append(("replicatorNameFilter", input_["replicator_name_filter"]))
...
def list_replicators(
    ...
    capo_kafka.types.list_replicators_response.ListReplicatorsResponse, zapros.Response
]:
...
async def async_list_replicators(
