"""Generated from Smithy shape ``com.amazonaws.kafka#ListClusters``."""
...
import capo_kafka.types.__list_of_cluster_info
...
def handle_response(
    ...
    out: capo_kafka.types.list_clusters_response.ListClustersResponse = (
        capo_kafka.types.list_clusters_response.deserialize_json(
...
def list_clusters(
    ...
    capo_kafka.types.list_clusters_response.ListClustersResponse, zapros.Response
]:
