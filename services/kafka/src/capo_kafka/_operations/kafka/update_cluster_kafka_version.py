...
def handle_response(
    ...
    out: capo_kafka.types.update_cluster_kafka_version_response.UpdateClusterKafkaVersionResponse = capo_kafka.types.update_cluster_kafka_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.update_cluster_kafka_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
