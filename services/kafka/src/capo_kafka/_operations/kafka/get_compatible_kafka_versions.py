...
def handle_response(
    ...
    out: capo_kafka.types.get_compatible_kafka_versions_response.GetCompatibleKafkaVersionsResponse = capo_kafka.types.get_compatible_kafka_versions_response.deserialize_json(
