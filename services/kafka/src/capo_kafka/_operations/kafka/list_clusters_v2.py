...
import capo_kafka.types.__list_of_cluster
...
def handle_response(
    ...
    out: capo_kafka.types.list_clusters_v2_response.ListClustersV2Response = (
        capo_kafka.types.list_clusters_v2_response.deserialize_json(
...
def build_request(
    ...
    if "cluster_name_filter" in input_:
        params.append(("clusterNameFilter", input_["cluster_name_filter"]))
    if "cluster_type_filter" in input_:
        params.append(("clusterTypeFilter", input_["cluster_type_filter"]))
...
def list_clusters_v2(
    ...
    capo_kafka.types.list_clusters_v2_response.ListClustersV2Response, zapros.Response
]:
