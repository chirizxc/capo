...
def handle_response(
    ...
    out: capo_kafka.types.describe_topic_partitions_response.DescribeTopicPartitionsResponse = capo_kafka.types.describe_topic_partitions_response.deserialize_json(
