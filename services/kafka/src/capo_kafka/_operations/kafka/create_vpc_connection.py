...
def handle_response(
    ...
    out: capo_kafka.types.create_vpc_connection_response.CreateVpcConnectionResponse = (
        capo_kafka.types.create_vpc_connection_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.create_vpc_connection_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
