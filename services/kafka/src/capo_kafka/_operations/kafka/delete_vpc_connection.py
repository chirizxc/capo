"""Generated from Smithy shape ``com.amazonaws.kafka#DeleteVpcConnection``."""
...
def handle_response(
    ...
    out: capo_kafka.types.delete_vpc_connection_response.DeleteVpcConnectionResponse = (
        capo_kafka.types.delete_vpc_connection_response.deserialize_json(
