...
def handle_response(
    ...
    out: capo_kafka.types.update_broker_storage_response.UpdateBrokerStorageResponse = (
        capo_kafka.types.update_broker_storage_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.update_broker_storage_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
