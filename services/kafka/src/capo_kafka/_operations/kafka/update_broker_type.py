...
def handle_response(
    ...
    out: capo_kafka.types.update_broker_type_response.UpdateBrokerTypeResponse = (
        capo_kafka.types.update_broker_type_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kafka.types.update_broker_type_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
