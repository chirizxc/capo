...
def handle_response(
    ...
    out: capo_kafka.types.describe_vpc_connection_response.DescribeVpcConnectionResponse = capo_kafka.types.describe_vpc_connection_response.deserialize_json(
