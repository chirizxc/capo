"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateConnectivityResponse``."""
...
class UpdateConnectivityResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateConnectivityResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateConnectivityResponse:
    out: UpdateConnectivityResponse = {}  # type: ignore[typeddict-item]
