"""Generated from Smithy shape ``com.amazonaws.kafka#UpdateBrokerStorageResponse``."""
...
class UpdateBrokerStorageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateBrokerStorageResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateBrokerStorageResponse:
    out: UpdateBrokerStorageResponse = {}  # type: ignore[typeddict-item]
