...
if TYPE_CHECKING:
    ...
    import capo_kafka.types.replication_starting_position
    import capo_kafka.types.replication_topic_name_configuration
...
class TopicReplication(TypedDict, closed=True):
    ...
    copy_topic_configurations: NotRequired["capo_kafka.types.__boolean.__boolean"]
    """<p>Whether to periodically configure remote topics to match their corresponding upstream topics.</p>"""
    detect_and_copy_new_topics: NotRequired["capo_kafka.types.__boolean.__boolean"]
    """<p>Whether to periodically check for new topics and partitions.</p>"""
    starting_position: NotRequired[
        "capo_kafka.types.replication_starting_position.ReplicationStartingPosition"
    ]
    ...
    topic_name_configuration: NotRequired[
        "capo_kafka.types.replication_topic_name_configuration.ReplicationTopicNameConfiguration"
    ]
    ...
    topics_to_exclude: NotRequired[
        "capo_kafka.types.__list_of__string_max249.__listOf__stringMax249"
    ]
...
def serialize_json(value: TopicReplication) -> dict:
    ...
    if "starting_position" in value:
        ...
        out["startingPosition"] = (
            capo_kafka.types.replication_starting_position.serialize_json(
    ...
    if "topic_name_configuration" in value:
        ...
        out["topicNameConfiguration"] = (
            capo_kafka.types.replication_topic_name_configuration.serialize_json(
    ...
    if "topics_to_exclude" in value:
        ...
        out["topicsToExclude"] = (
            capo_kafka.types.__list_of__string_max249.serialize_json(
...
def deserialize_json(data: dict) -> TopicReplication:
    ...
    if data.get("startingPosition") is not None:
        ...
        out["starting_position"] = (
            capo_kafka.types.replication_starting_position.deserialize_json(
                data["startingPosition"]
            )
        )
    if data.get("topicNameConfiguration") is not None:
        import capo_kafka.types.replication_topic_name_configuration

        out["topic_name_configuration"] = (
            capo_kafka.types.replication_topic_name_configuration.deserialize_json(
    ...
    if data.get("topicsToExclude") is not None:
        ...
        out["topics_to_exclude"] = (
            capo_kafka.types.__list_of__string_max249.deserialize_json(
