...
class GetBootstrapBrokersResponse(TypedDict, closed=True):
    ...
    bootstrap_broker_string_tls: NotRequired["capo_kafka.types.__string.__string"]
    ...
    bootstrap_broker_string_sasl_iam: NotRequired["capo_kafka.types.__string.__string"]
    ...
    bootstrap_broker_string_ipv6: NotRequired["capo_kafka.types.__string.__string"]
    """<p>A string that contains one or more DNS names (or IP) and port pairs for IPv6 connectivity.</p>"""
    bootstrap_broker_string_tls_ipv6: NotRequired["capo_kafka.types.__string.__string"]
