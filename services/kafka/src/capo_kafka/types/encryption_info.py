...
class EncryptionInfo(TypedDict, closed=True):
    encryption_at_rest: NotRequired[
        "capo_kafka.types.encryption_at_rest.EncryptionAtRest"
    ]
    """<p>The data-volume encryption details.</p>"""
    encryption_in_transit: NotRequired[
        "capo_kafka.types.encryption_in_transit.EncryptionInTransit"
    ]
...
def serialize_json(value: EncryptionInfo) -> dict:
    ...
    if "encryption_at_rest" in value:
        ...
        out["encryptionAtRest"] = capo_kafka.types.encryption_at_rest.serialize_json(
    ...
    if "encryption_in_transit" in value:
        ...
        out["encryptionInTransit"] = (
            capo_kafka.types.encryption_in_transit.serialize_json(
...
def deserialize_json(data: dict) -> EncryptionInfo:
    ...
    if data.get("encryptionAtRest") is not None:
        ...
        out["encryption_at_rest"] = (
            capo_kafka.types.encryption_at_rest.deserialize_json(
    ...
    if data.get("encryptionInTransit") is not None:
        ...
        out["encryption_in_transit"] = (
            capo_kafka.types.encryption_in_transit.deserialize_json(
