...
class Connector(TypedDict, closed=True):
    ...
    type: NotRequired["capo_evs.types.connector_type.ConnectorType"]
    ...
    secret_arn: NotRequired["capo_evs.types.secret_identifier.SecretIdentifier"]
    ...
    state: NotRequired["capo_evs.types.connector_state.ConnectorState"]
    ...
    status: NotRequired["capo_evs.types.check_result.CheckResult"]
    """<p>The status of the connector.</p>"""
    checks: NotRequired["capo_evs.types.connectors_checks_list.ConnectorsChecksList"]
...
def serialize_aws_json_1_0(value: Connector) -> dict:
    ...
    if "type" in value:
        ...
        out["type"] = capo_evs.types.connector_type.serialize_aws_json_1_0(
            value["type"]
        )
    ...
    if "state" in value:
        ...
        out["state"] = capo_evs.types.connector_state.serialize_aws_json_1_0(
            value["state"]
        )
    ...
    if "status" in value:
        ...
        out["status"] = capo_evs.types.check_result.serialize_aws_json_1_0(
            value["status"]
        )
    if "checks" in value:
        import capo_evs.types.connectors_checks_list

        out["checks"] = capo_evs.types.connectors_checks_list.serialize_aws_json_1_0(
            value["checks"]
        )
