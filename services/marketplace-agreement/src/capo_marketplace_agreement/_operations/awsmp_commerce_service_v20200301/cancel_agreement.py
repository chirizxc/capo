"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#CancelAgreement``."""
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.cancel_agreement_output.CancelAgreementOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.cancel_agreement_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_cancel_agreement(
