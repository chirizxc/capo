"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#GetAgreementCancellationRequest``."""
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.get_agreement_cancellation_request_output.GetAgreementCancellationRequestOutput = capo_marketplace_agreement.types.get_agreement_cancellation_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.get_agreement_cancellation_request_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_agreement_cancellation_request(
