"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#GetAgreementTerms``."""
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.get_agreement_terms_output.GetAgreementTermsOutput = capo_marketplace_agreement.types.get_agreement_terms_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSMPCommerceService_v20200301.GetAgreementTerms"
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.get_agreement_terms_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_agreement_terms(
