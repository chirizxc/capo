"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#ListAgreementPaymentRequests``."""
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.list_agreement_payment_requests_output.ListAgreementPaymentRequestsOutput = capo_marketplace_agreement.types.list_agreement_payment_requests_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.list_agreement_payment_requests_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_agreement_payment_requests(
