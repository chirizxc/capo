...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.describe_agreement_output.DescribeAgreementOutput = capo_marketplace_agreement.types.describe_agreement_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.describe_agreement_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
