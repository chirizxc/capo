"""Generated from Smithy shape ``com.amazonaws.marketplaceagreement#RejectAgreementCancellationRequest``."""
...
import capo_marketplace_agreement._protocol.eventstream
...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.reject_agreement_cancellation_request_output.RejectAgreementCancellationRequestOutput = capo_marketplace_agreement.types.reject_agreement_cancellation_request_output.deserialize_aws_json_1_0(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = (
                capo_marketplace_agreement._auth._sigv4.build_sigv4_auth_scheme(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.reject_agreement_cancellation_request_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_reject_agreement_cancellation_request(
