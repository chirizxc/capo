...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.batch_create_billing_adjustment_request_output.BatchCreateBillingAdjustmentRequestOutput = capo_marketplace_agreement.types.batch_create_billing_adjustment_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.batch_create_billing_adjustment_request_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
