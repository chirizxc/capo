...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.update_purchase_orders_output.UpdatePurchaseOrdersOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.update_purchase_orders_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
