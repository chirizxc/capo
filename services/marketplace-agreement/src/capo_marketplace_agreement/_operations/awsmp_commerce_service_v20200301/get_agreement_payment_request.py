...
def handle_response(
    ...
    out: capo_marketplace_agreement.types.get_agreement_payment_request_output.GetAgreementPaymentRequestOutput = capo_marketplace_agreement.types.get_agreement_payment_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_marketplace_agreement.types.get_agreement_payment_request_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
