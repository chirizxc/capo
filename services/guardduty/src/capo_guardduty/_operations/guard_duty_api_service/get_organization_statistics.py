"""Generated from Smithy shape ``com.amazonaws.guardduty#GetOrganizationStatistics``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.get_organization_statistics_response.GetOrganizationStatisticsResponse = capo_guardduty.types.get_organization_statistics_response.deserialize_json(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    url = endpoint.url.rstrip("/") + "/organization/statistics"
...
async def async_get_organization_statistics(
