...
def handle_response(
    ...
    out: capo_guardduty.types.get_trusted_entity_set_response.GetTrustedEntitySetResponse = capo_guardduty.types.get_trusted_entity_set_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{TrustedEntitySetId}", quote(input_["trusted_entity_set_id"], safe="")
    )
