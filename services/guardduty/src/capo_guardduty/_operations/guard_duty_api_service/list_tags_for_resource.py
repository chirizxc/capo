"""Generated from Smithy shape ``com.amazonaws.guardduty#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_guardduty.types.list_tags_for_resource_response.deserialize_json(
