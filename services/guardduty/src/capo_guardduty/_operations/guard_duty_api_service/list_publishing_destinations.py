"""Generated from Smithy shape ``com.amazonaws.guardduty#ListPublishingDestinations``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.list_publishing_destinations_response.ListPublishingDestinationsResponse = capo_guardduty.types.list_publishing_destinations_response.deserialize_json(
...
async def async_list_publishing_destinations(
