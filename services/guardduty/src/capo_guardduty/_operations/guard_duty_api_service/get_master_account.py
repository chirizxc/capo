"""Generated from Smithy shape ``com.amazonaws.guardduty#GetMasterAccount``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.get_master_account_response.GetMasterAccountResponse = (
        capo_guardduty.types.get_master_account_response.deserialize_json(
