...
def handle_response(
    ...
    out: capo_guardduty.types.list_coverage_response.ListCoverageResponse = (
        capo_guardduty.types.list_coverage_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.list_coverage_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_coverage(
    ...
    capo_guardduty.types.list_coverage_response.ListCoverageResponse, zapros.Response
]:
