"""Generated from Smithy shape ``com.amazonaws.guardduty#GetAdministratorAccount``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.get_administrator_account_response.GetAdministratorAccountResponse = capo_guardduty.types.get_administrator_account_response.deserialize_json(
