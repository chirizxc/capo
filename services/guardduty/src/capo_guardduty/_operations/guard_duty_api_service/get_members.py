...
def handle_response(
    ...
    out: capo_guardduty.types.get_members_response.GetMembersResponse = (
        capo_guardduty.types.get_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.get_members_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def get_members(
    ...
    capo_guardduty.types.get_members_response.GetMembersResponse, zapros.Response
]:
