"""Generated from Smithy shape ``com.amazonaws.guardduty#DescribePublishingDestination``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.describe_publishing_destination_response.DescribePublishingDestinationResponse = capo_guardduty.types.describe_publishing_destination_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{DestinationId}", quote(input_["destination_id"], safe=""))
...
async def async_describe_publishing_destination(
