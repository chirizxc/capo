...
def handle_response(
    ...
    out: capo_guardduty.types.list_threat_intel_sets_response.ListThreatIntelSetsResponse = capo_guardduty.types.list_threat_intel_sets_response.deserialize_json(
