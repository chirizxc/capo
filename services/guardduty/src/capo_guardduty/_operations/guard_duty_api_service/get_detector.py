"""Generated from Smithy shape ``com.amazonaws.guardduty#GetDetector``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.get_detector_response.GetDetectorResponse = (
        capo_guardduty.types.get_detector_response.deserialize_json(
...
def get_detector(
    ...
    capo_guardduty.types.get_detector_response.GetDetectorResponse, zapros.Response
]:
