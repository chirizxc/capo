"""Generated from Smithy shape ``com.amazonaws.guardduty#DescribeOrganizationConfiguration``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse = capo_guardduty.types.describe_organization_configuration_response.deserialize_json(
