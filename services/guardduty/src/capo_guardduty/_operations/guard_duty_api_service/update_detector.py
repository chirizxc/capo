"""Generated from Smithy shape ``com.amazonaws.guardduty#UpdateDetector``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.update_detector_response.UpdateDetectorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.update_detector_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_detector(
