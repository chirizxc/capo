...
def handle_response(
    ...
    out: capo_guardduty.types.list_threat_entity_sets_response.ListThreatEntitySetsResponse = capo_guardduty.types.list_threat_entity_sets_response.deserialize_json(
