"""Generated from Smithy shape ``com.amazonaws.guardduty#CreateFilter``."""
...
def handle_response(
    ...
    out: capo_guardduty.types.create_filter_response.CreateFilterResponse = (
        capo_guardduty.types.create_filter_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.create_filter_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_filter(
    ...
    capo_guardduty.types.create_filter_response.CreateFilterResponse, zapros.Response
]:
