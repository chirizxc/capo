...
def handle_response(
    ...
    out: capo_guardduty.types.create_threat_entity_set_response.CreateThreatEntitySetResponse = capo_guardduty.types.create_threat_entity_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_guardduty.types.create_threat_entity_set_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
