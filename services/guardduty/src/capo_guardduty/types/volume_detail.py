...
class VolumeDetail(TypedDict, closed=True):
    ...
    volume_type: NotRequired["capo_guardduty.types.string.String"]
    """<p>The EBS volume type.</p>"""
    device_name: NotRequired["capo_guardduty.types.string.String"]
    """<p>The device name for the EBS volume.</p>"""
    volume_size_in_gb: NotRequired["capo_guardduty.types.integer.Integer"]
    ...
    kms_key_arn: NotRequired["capo_guardduty.types.string.String"]
