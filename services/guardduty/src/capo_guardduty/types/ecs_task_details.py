...
class EcsTaskDetails(TypedDict, closed=True):
    ...
    definition_arn: NotRequired["capo_guardduty.types.string.String"]
    """<p>The ARN of the task definition that creates the task.</p>"""
    version: NotRequired["capo_guardduty.types.string.String"]
    """<p>The version counter for the task.</p>"""
    task_created_at: NotRequired["capo_guardduty.types.timestamp.Timestamp"]
    """<p>The Unix timestamp for the time when the task was created.</p>"""
    started_at: NotRequired["capo_guardduty.types.timestamp.Timestamp"]
    """<p>The Unix timestamp for the time when the task started.</p>"""
    started_by: NotRequired["capo_guardduty.types.string.String"]
    ...
    group: NotRequired["capo_guardduty.types.string.String"]
    """<p>The name of the task group that's associated with the task.</p>"""
    launch_type: NotRequired["capo_guardduty.types.string.String"]
...
def serialize_json(value: EcsTaskDetails) -> dict:
    ...
    if "started_at" in value:
        ...
        out["startedAt"] = capo_guardduty.types.timestamp.serialize_json(
            value["started_at"]
        )
