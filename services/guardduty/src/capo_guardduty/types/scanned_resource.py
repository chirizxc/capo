...
class ScannedResource(TypedDict, closed=True):
    ...
    scanned_resource_type: NotRequired[
        "capo_guardduty.types.malware_protection_resource_type.MalwareProtectionResourceType"
    ]
    """<p>The resource type of the scanned resource.</p>"""
    scanned_resource_status: NotRequired[
        "capo_guardduty.types.malware_protection_scan_status.MalwareProtectionScanStatus"
    ]
    """<p>The status of the scanned resource.</p>"""
    scan_status_reason: NotRequired[
        "capo_guardduty.types.scan_status_reason.ScanStatusReason"
    ]
    """<p>The reason for the scan status of this particular resource, if applicable.</p>"""
    resource_details: NotRequired[
        "capo_guardduty.types.scanned_resource_details.ScannedResourceDetails"
    ]
...
def serialize_json(value: ScannedResource) -> dict:
    ...
    if "scanned_resource_type" in value:
        ...
        out["scannedResourceType"] = (
            capo_guardduty.types.malware_protection_resource_type.serialize_json(
    ...
    if "scanned_resource_status" in value:
        ...
        out["scannedResourceStatus"] = (
            capo_guardduty.types.malware_protection_scan_status.serialize_json(
    ...
    if "scan_status_reason" in value:
        ...
        out["scanStatusReason"] = (
            capo_guardduty.types.scan_status_reason.serialize_json(
    ...
    if "resource_details" in value:
        ...
        out["resourceDetails"] = (
            capo_guardduty.types.scanned_resource_details.serialize_json(
...
def deserialize_json(data: dict) -> ScannedResource:
    ...
    if data.get("scannedResourceType") is not None:
        ...
        out["scanned_resource_type"] = (
            capo_guardduty.types.malware_protection_resource_type.deserialize_json(
    ...
    if data.get("scannedResourceStatus") is not None:
        ...
        out["scanned_resource_status"] = (
            capo_guardduty.types.malware_protection_scan_status.deserialize_json(
    ...
    if data.get("scanStatusReason") is not None:
        ...
        out["scan_status_reason"] = (
            capo_guardduty.types.scan_status_reason.deserialize_json(
    ...
    if data.get("resourceDetails") is not None:
        ...
        out["resource_details"] = (
            capo_guardduty.types.scanned_resource_details.deserialize_json(
