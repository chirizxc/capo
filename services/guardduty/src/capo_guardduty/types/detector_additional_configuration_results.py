...
if TYPE_CHECKING:
    import capo_guardduty.types.detector_additional_configuration_result

DetectorAdditionalConfigurationResults: TypeAlias = list[
    "capo_guardduty.types.detector_additional_configuration_result.DetectorAdditionalConfigurationResult"
]
...
def serialize_json(value: DetectorAdditionalConfigurationResults) -> list:
    ...
    for item in value:
        out.append(
            capo_guardduty.types.detector_additional_configuration_result.serialize_json(
                item
            )
        )
    return out
