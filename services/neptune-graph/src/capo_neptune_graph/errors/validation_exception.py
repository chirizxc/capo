...
if TYPE_CHECKING:
    import capo_neptune_graph.types.validation_exception_reason
...
class ValidationException_(TypedDict, closed=True):
    ...
    reason: NotRequired[
        "capo_neptune_graph.types.validation_exception_reason.ValidationExceptionReason"
    ]
...
def serialize_json(value: ValidationException_) -> dict:
    ...
    if "reason" in value:
        ...
        out["reason"] = (
            capo_neptune_graph.types.validation_exception_reason.serialize_json(
                value["reason"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> ValidationException_:
    ...
    if data.get("reason") is not None:
        ...
        out["reason"] = (
            capo_neptune_graph.types.validation_exception_reason.deserialize_json(
                data["reason"]
            )
        )
    return out
