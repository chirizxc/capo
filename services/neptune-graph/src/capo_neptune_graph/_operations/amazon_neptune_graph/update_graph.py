"""Generated from Smithy shape ``com.amazonaws.neptunegraph#UpdateGraph``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.update_graph_output.UpdateGraphOutput = (
        capo_neptune_graph.types.update_graph_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.update_graph_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_graph(
    ...
    capo_neptune_graph.types.update_graph_output.UpdateGraphOutput, zapros.Response
]:
