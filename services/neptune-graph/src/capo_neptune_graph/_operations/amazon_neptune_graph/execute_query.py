"""Generated from Smithy shape ``com.amazonaws.neptunegraph#ExecuteQuery``."""
...
import capo_neptune_graph.errors.unprocessable_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnprocessableException":
            raise capo_neptune_graph.errors.unprocessable_exception.UnprocessableException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_neptune_graph.types.execute_query_output.ExecuteQueryOutput = {
        "payload": _iter
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.execute_query_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def execute_query(
    ...
    capo_neptune_graph.types.execute_query_output.ExecuteQueryOutput, zapros.Response
]:
