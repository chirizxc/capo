"""Generated from Smithy shape ``com.amazonaws.neptunegraph#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_neptune_graph.types.list_tags_for_resource_output.deserialize_json(
