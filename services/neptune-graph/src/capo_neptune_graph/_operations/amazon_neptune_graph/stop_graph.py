"""Generated from Smithy shape ``com.amazonaws.neptunegraph#StopGraph``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.stop_graph_output.StopGraphOutput = (
        capo_neptune_graph.types.stop_graph_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/graphs/{graphIdentifier}/stop"
...
def stop_graph(
    ...
    input_: capo_neptune_graph.types.stop_graph_input.StopGraphInput,
) -> tuple[capo_neptune_graph.types.stop_graph_output.StopGraphOutput, zapros.Response]:
