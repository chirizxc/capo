...
def handle_response(
    ...
    out: capo_neptune_graph.types.start_graph_output.StartGraphOutput = (
        capo_neptune_graph.types.start_graph_output.deserialize_json(
...
def start_graph(
    ...
    capo_neptune_graph.types.start_graph_output.StartGraphOutput, zapros.Response
]:
