...
import capo_neptune_graph.types.export_task_details
...
def handle_response(
    ...
    out: capo_neptune_graph.types.get_export_task_output.GetExportTaskOutput = (
        capo_neptune_graph.types.get_export_task_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{taskIdentifier}", quote(input_["task_identifier"], safe=""))
...
def get_export_task(
    ...
    capo_neptune_graph.types.get_export_task_output.GetExportTaskOutput, zapros.Response
]:
