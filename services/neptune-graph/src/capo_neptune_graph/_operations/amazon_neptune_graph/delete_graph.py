...
def handle_response(
    ...
    out: capo_neptune_graph.types.delete_graph_output.DeleteGraphOutput = (
        capo_neptune_graph.types.delete_graph_output.deserialize_json(
...
def build_request(
    ...
    if "skip_snapshot" in input_:
        params.append(("skipSnapshot", "true" if input_["skip_snapshot"] else "false"))
...
def delete_graph(
    ...
    capo_neptune_graph.types.delete_graph_output.DeleteGraphOutput, zapros.Response
]:
