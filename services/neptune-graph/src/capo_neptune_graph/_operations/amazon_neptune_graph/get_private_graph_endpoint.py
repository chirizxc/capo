"""Generated from Smithy shape ``com.amazonaws.neptunegraph#GetPrivateGraphEndpoint``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.get_private_graph_endpoint_output.GetPrivateGraphEndpointOutput = capo_neptune_graph.types.get_private_graph_endpoint_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{vpcId}", quote(input_["vpc_id"], safe=""))
...
async def async_get_private_graph_endpoint(
