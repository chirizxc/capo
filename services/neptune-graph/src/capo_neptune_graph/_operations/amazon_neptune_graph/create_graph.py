"""Generated from Smithy shape ``com.amazonaws.neptunegraph#CreateGraph``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.create_graph_output.CreateGraphOutput = (
        capo_neptune_graph.types.create_graph_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.create_graph_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_graph(
    ...
    capo_neptune_graph.types.create_graph_output.CreateGraphOutput, zapros.Response
]:
