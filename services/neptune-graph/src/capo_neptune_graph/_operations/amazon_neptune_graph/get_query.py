"""Generated from Smithy shape ``com.amazonaws.neptunegraph#GetQuery``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.get_query_output.GetQueryOutput = (
        capo_neptune_graph.types.get_query_output.deserialize_json(
...
def get_query(
    ...
    input_: capo_neptune_graph.types.get_query_input.GetQueryInput,
) -> tuple[capo_neptune_graph.types.get_query_output.GetQueryOutput, zapros.Response]:
