...
def handle_response(
    ...
    out: capo_neptune_graph.types.create_graph_using_import_task_output.CreateGraphUsingImportTaskOutput = capo_neptune_graph.types.create_graph_using_import_task_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.create_graph_using_import_task_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
