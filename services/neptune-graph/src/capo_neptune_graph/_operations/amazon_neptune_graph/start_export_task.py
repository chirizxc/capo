"""Generated from Smithy shape ``com.amazonaws.neptunegraph#StartExportTask``."""
...
def handle_response(
    ...
    out: capo_neptune_graph.types.start_export_task_output.StartExportTaskOutput = (
        capo_neptune_graph.types.start_export_task_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_neptune_graph.types.start_export_task_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
