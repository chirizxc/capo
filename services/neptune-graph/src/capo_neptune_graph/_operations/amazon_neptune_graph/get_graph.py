...
def handle_response(
    ...
    out: capo_neptune_graph.types.get_graph_output.GetGraphOutput = (
        capo_neptune_graph.types.get_graph_output.deserialize_json(
...
def get_graph(
    ...
    input_: capo_neptune_graph.types.get_graph_input.GetGraphInput,
) -> tuple[capo_neptune_graph.types.get_graph_output.GetGraphOutput, zapros.Response]:
