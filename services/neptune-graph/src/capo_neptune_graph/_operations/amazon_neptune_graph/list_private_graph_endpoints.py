...
def handle_response(
    ...
    out: capo_neptune_graph.types.list_private_graph_endpoints_output.ListPrivateGraphEndpointsOutput = capo_neptune_graph.types.list_private_graph_endpoints_output.deserialize_json(
