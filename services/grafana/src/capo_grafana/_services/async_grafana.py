...
from capo_grafana._resources.aws_grafana_control_plane.api_key import AsyncApiKey
...
from capo_grafana._resources.aws_grafana_control_plane.license import AsyncLicense
from capo_grafana._resources.aws_grafana_control_plane.permission import AsyncPermission
...
from capo_grafana._resources.aws_grafana_control_plane.workspace import AsyncWorkspace
from capo_grafana._services._aws_config import aaws_config
...
class AsyncgrafanaClientConfig(TypedDict, total=False, closed=True):
...
class AsyncgrafanaClient:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_grafana.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_grafana.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_grafana._operations.aws_grafana_control_plane.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def list_versions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_grafana.types.list_versions_request.ListVersionsRequest]",
        ) -> AsyncOperationResponse[
            "capo_grafana.types.list_versions_response.ListVersionsResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_grafana._operations.aws_grafana_control_plane.list_versions.async_list_versions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_versions(
        ...
        *,
        ...
        workspace_id: Optional["capo_grafana.types.workspace_id.WorkspaceId"] = None,
    ) -> "AsyncIterator[capo_grafana.types.grafana_version.GrafanaVersion]":
        _token = next_token
        while True:
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_grafana.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_grafana.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_grafana._operations.aws_grafana_control_plane.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_grafana.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_grafana.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_grafana._operations.aws_grafana_control_plane.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
