"""Generated from Smithy shape ``com.amazonaws.grafana#UpdateWorkspaceAuthentication``."""
...
def handle_response(
    ...
    out: capo_grafana.types.update_workspace_authentication_response.UpdateWorkspaceAuthenticationResponse = capo_grafana.types.update_workspace_authentication_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_grafana.types.update_workspace_authentication_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_workspace_authentication(
