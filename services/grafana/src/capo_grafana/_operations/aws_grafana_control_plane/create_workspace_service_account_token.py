...
def handle_response(
    ...
    out: capo_grafana.types.create_workspace_service_account_token_response.CreateWorkspaceServiceAccountTokenResponse = capo_grafana.types.create_workspace_service_account_token_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_grafana.types.create_workspace_service_account_token_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
