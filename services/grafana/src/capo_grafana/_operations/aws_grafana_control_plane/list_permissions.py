...
def handle_response(
    ...
    out: capo_grafana.types.list_permissions_response.ListPermissionsResponse = (
        capo_grafana.types.list_permissions_response.deserialize_json(
...
def build_request(
    ...
    if "user_type" in input_:
        params.append(("userType", input_["user_type"]))
