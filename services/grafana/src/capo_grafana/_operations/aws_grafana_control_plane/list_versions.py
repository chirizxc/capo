...
def handle_response(
    ...
    out: capo_grafana.types.list_versions_response.ListVersionsResponse = (
        capo_grafana.types.list_versions_response.deserialize_json(
...
def build_request(
    ...
    if "workspace_id" in input_:
        params.append(("workspace-id", input_["workspace_id"]))
...
def list_versions(
    ...
    capo_grafana.types.list_versions_response.ListVersionsResponse, zapros.Response
]:
