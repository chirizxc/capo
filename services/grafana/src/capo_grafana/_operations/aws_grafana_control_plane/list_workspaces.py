"""Generated from Smithy shape ``com.amazonaws.grafana#ListWorkspaces``."""
...
def handle_response(
    ...
    out: capo_grafana.types.list_workspaces_response.ListWorkspacesResponse = (
        capo_grafana.types.list_workspaces_response.deserialize_json(
...
def list_workspaces(
    ...
    capo_grafana.types.list_workspaces_response.ListWorkspacesResponse, zapros.Response
]:
