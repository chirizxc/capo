"""Generated from Smithy shape ``com.amazonaws.grafana#CreateWorkspace``."""
...
def handle_response(
    ...
    out: capo_grafana.types.create_workspace_response.CreateWorkspaceResponse = (
        capo_grafana.types.create_workspace_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_grafana.types.create_workspace_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
