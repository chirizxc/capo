"""Generated from Smithy shape ``com.amazonaws.grafana#DisassociateLicense``."""
...
def handle_response(
    ...
    out: capo_grafana.types.disassociate_license_response.DisassociateLicenseResponse = capo_grafana.types.disassociate_license_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{licenseType}", quote(input_["license_type"], safe=""))
...
async def async_disassociate_license(
