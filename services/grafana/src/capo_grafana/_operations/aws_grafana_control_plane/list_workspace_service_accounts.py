"""Generated from Smithy shape ``com.amazonaws.grafana#ListWorkspaceServiceAccounts``."""
...
import capo_grafana.types.service_account_list
...
def handle_response(
    ...
    out: capo_grafana.types.list_workspace_service_accounts_response.ListWorkspaceServiceAccountsResponse = capo_grafana.types.list_workspace_service_accounts_response.deserialize_json(
...
async def async_list_workspace_service_accounts(
