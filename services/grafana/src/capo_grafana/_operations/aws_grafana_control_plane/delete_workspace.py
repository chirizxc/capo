"""Generated from Smithy shape ``com.amazonaws.grafana#DeleteWorkspace``."""
...
def handle_response(
    ...
    out: capo_grafana.types.delete_workspace_response.DeleteWorkspaceResponse = (
        capo_grafana.types.delete_workspace_response.deserialize_json(
