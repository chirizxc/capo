"""Generated from Smithy shape ``com.amazonaws.grafana#UpdateWorkspaceConfiguration``."""
...
def handle_response(
    ...
    out: capo_grafana.types.update_workspace_configuration_response.UpdateWorkspaceConfigurationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_grafana.types.update_workspace_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
