"""Generated from Smithy shape ``com.amazonaws.amplifybackend#DeleteBackendStorageResponse``."""
...
class DeleteBackendStorageResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DeleteBackendStorageResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> DeleteBackendStorageResponse:
    out: DeleteBackendStorageResponse = {}  # type: ignore[typeddict-item]
