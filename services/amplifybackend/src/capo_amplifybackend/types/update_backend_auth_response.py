"""Generated from Smithy shape ``com.amazonaws.amplifybackend#UpdateBackendAuthResponse``."""
...
class UpdateBackendAuthResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateBackendAuthResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> UpdateBackendAuthResponse:
    out: UpdateBackendAuthResponse = {}  # type: ignore[typeddict-item]
