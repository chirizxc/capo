"""Generated from Smithy shape ``com.amazonaws.amplifybackend#CreateBackendConfigResponse``."""
...
class CreateBackendConfigResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateBackendConfigResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
