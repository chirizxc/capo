"""Generated from Smithy shape ``com.amazonaws.amplifybackend#CloneBackendResponse``."""
...
class CloneBackendResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CloneBackendResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> CloneBackendResponse:
    out: CloneBackendResponse = {}  # type: ignore[typeddict-item]
