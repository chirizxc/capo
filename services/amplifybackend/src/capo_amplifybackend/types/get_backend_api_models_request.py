"""Generated from Smithy shape ``com.amazonaws.amplifybackend#GetBackendAPIModelsRequest``."""
...
class GetBackendAPIModelsRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetBackendAPIModelsRequest) -> dict:
    out: dict = {}
