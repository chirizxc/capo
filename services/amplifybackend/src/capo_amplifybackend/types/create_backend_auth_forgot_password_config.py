"""Generated from Smithy shape ``com.amazonaws.amplifybackend#CreateBackendAuthForgotPasswordConfig``."""
...
class CreateBackendAuthForgotPasswordConfig(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateBackendAuthForgotPasswordConfig) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateBackendAuthForgotPasswordConfig:
    out: CreateBackendAuthForgotPasswordConfig = {}  # type: ignore[typeddict-item]
