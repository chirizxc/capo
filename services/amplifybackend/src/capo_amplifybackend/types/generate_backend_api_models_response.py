"""Generated from Smithy shape ``com.amazonaws.amplifybackend#GenerateBackendAPIModelsResponse``."""
...
class GenerateBackendAPIModelsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GenerateBackendAPIModelsResponse) -> dict:
    out: dict = {}
    if "app_id" in value:
...
def deserialize_json(data: dict) -> GenerateBackendAPIModelsResponse:
    out: GenerateBackendAPIModelsResponse = {}  # type: ignore[typeddict-item]
