...
class UpdateEnvironmentRequest(TypedDict, closed=True):
    ...
    desired_capacity: NotRequired["capo_m2.types.capacity_value.CapacityValue"]
    """<p>The desired capacity for the runtime environment to update. The minimum possible value is 0 and the maximum is 100.</p>"""
    instance_type: NotRequired["capo_m2.types.string20.String20"]
    ...
    apply_during_maintenance_window: "capo_m2.types.boolean.Boolean"
    ...
    force_update: "capo_m2.types.boolean.Boolean"
