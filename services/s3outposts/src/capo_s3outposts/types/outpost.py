...
if TYPE_CHECKING:
    import capo_s3outposts.types.aws_account_id
    import capo_s3outposts.types.capacity_in_bytes
    import capo_s3outposts.types.outpost_arn
    import capo_s3outposts.types.outpost_id
    import capo_s3outposts.types.s3_outpost_arn


class Outpost(TypedDict, closed=True):
    outpost_arn: NotRequired["capo_s3outposts.types.outpost_arn.OutpostArn"]
    """<p>Specifies the unique Amazon Resource Name (ARN) for the outpost.</p>"""
    s3_outpost_arn: NotRequired["capo_s3outposts.types.s3_outpost_arn.S3OutpostArn"]
    """<p>Specifies the unique S3 on Outposts ARN for use with Resource Access Manager (RAM).</p>"""
    outpost_id: NotRequired["capo_s3outposts.types.outpost_id.OutpostId"]
    """<p>Specifies the unique identifier for the outpost.</p>"""
    owner_id: NotRequired["capo_s3outposts.types.aws_account_id.AwsAccountId"]
    """<p>Returns the Amazon Web Services account ID of the outpost owner. Useful for comparing owned versus shared outposts.</p>"""
    capacity_in_bytes: "capo_s3outposts.types.capacity_in_bytes.CapacityInBytes"
