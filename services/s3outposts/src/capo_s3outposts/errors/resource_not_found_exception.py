"""Generated from Smithy shape ``com.amazonaws.s3outposts#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.s3outposts#ResourceNotFoundException``."""
