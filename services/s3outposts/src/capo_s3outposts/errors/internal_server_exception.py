"""Generated from Smithy shape ``com.amazonaws.s3outposts#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.s3outposts#InternalServerException``."""
