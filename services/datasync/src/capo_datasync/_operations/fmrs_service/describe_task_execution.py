...
def handle_response(
    ...
    out: capo_datasync.types.describe_task_execution_response.DescribeTaskExecutionResponse = capo_datasync.types.describe_task_execution_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_task_execution_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
