...
def handle_response(
    ...
    out: capo_datasync.types.describe_task_response.DescribeTaskResponse = (
        capo_datasync.types.describe_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_task_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_task(
    ...
    capo_datasync.types.describe_task_response.DescribeTaskResponse, zapros.Response
]:
