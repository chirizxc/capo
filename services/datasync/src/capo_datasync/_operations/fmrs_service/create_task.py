...
def handle_response(
    ...
    out: capo_datasync.types.create_task_response.CreateTaskResponse = (
        capo_datasync.types.create_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.create_task_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_task(
    ...
    capo_datasync.types.create_task_response.CreateTaskResponse, zapros.Response
]:
