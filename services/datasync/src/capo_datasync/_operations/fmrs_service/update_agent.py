"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateAgent``."""
...
def handle_response(
    ...
    out: capo_datasync.types.update_agent_response.UpdateAgentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.update_agent_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_agent(
    ...
    capo_datasync.types.update_agent_response.UpdateAgentResponse, zapros.Response
]:
