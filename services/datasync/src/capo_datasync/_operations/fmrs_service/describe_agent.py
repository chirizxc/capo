"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeAgent``."""
...
def handle_response(
    ...
    out: capo_datasync.types.describe_agent_response.DescribeAgentResponse = (
        capo_datasync.types.describe_agent_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_agent_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_agent(
    ...
    capo_datasync.types.describe_agent_response.DescribeAgentResponse, zapros.Response
]:
