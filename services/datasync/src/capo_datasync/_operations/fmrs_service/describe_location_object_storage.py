"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationObjectStorage``."""
...
def handle_response(
    ...
    out: capo_datasync.types.describe_location_object_storage_response.DescribeLocationObjectStorageResponse = capo_datasync.types.describe_location_object_storage_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.DescribeLocationObjectStorage"
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_location_object_storage_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_location_object_storage(
