...
def handle_response(
    ...
    out: capo_datasync.types.update_location_nfs_response.UpdateLocationNfsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.update_location_nfs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
