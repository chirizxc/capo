"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationFsxOpenZfs``."""
...
def handle_response(
    ...
    out: capo_datasync.types.describe_location_fsx_open_zfs_response.DescribeLocationFsxOpenZfsResponse = capo_datasync.types.describe_location_fsx_open_zfs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.DescribeLocationFsxOpenZfs"
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_location_fsx_open_zfs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_location_fsx_open_zfs(
