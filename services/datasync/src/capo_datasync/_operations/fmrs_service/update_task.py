"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateTask``."""
...
def handle_response(
    ...
    out: capo_datasync.types.update_task_response.UpdateTaskResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.update_task_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_task(
    ...
    capo_datasync.types.update_task_response.UpdateTaskResponse, zapros.Response
]:
