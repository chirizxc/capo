"""Generated from Smithy shape ``com.amazonaws.datasync#UpdateLocationFsxLustre``."""
...
def handle_response(
    ...
    out: capo_datasync.types.update_location_fsx_lustre_response.UpdateLocationFsxLustreResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.UpdateLocationFsxLustre"
    body: bytes | None = json.dumps(
        capo_datasync.types.update_location_fsx_lustre_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_location_fsx_lustre(
