"""Generated from Smithy shape ``com.amazonaws.datasync#CreateLocationFsxLustre``."""
...
def handle_response(
    ...
    out: capo_datasync.types.create_location_fsx_lustre_response.CreateLocationFsxLustreResponse = capo_datasync.types.create_location_fsx_lustre_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.CreateLocationFsxLustre"
    body: bytes | None = json.dumps(
        capo_datasync.types.create_location_fsx_lustre_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_location_fsx_lustre(
