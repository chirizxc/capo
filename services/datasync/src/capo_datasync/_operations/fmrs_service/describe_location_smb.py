"""Generated from Smithy shape ``com.amazonaws.datasync#DescribeLocationSmb``."""
...
def handle_response(
    ...
    out: capo_datasync.types.describe_location_smb_response.DescribeLocationSmbResponse = capo_datasync.types.describe_location_smb_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_location_smb_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_location_smb(
