"""Generated from Smithy shape ``com.amazonaws.datasync#ListAgents``."""
...
import capo_datasync.types.agent_list
...
def handle_response(
    ...
    out: capo_datasync.types.list_agents_response.ListAgentsResponse = (
        capo_datasync.types.list_agents_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.list_agents_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_agents(
    ...
    capo_datasync.types.list_agents_response.ListAgentsResponse, zapros.Response
]:
