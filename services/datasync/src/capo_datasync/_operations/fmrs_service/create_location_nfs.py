"""Generated from Smithy shape ``com.amazonaws.datasync#CreateLocationNfs``."""
...
def handle_response(
    ...
    out: capo_datasync.types.create_location_nfs_response.CreateLocationNfsResponse = (
        capo_datasync.types.create_location_nfs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.create_location_nfs_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_location_nfs(
