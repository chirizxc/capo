...
def handle_response(
    ...
    out: capo_datasync.types.create_location_s3_response.CreateLocationS3Response = (
        capo_datasync.types.create_location_s3_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.create_location_s3_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
