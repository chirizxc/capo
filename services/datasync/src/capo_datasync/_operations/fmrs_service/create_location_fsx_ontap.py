"""Generated from Smithy shape ``com.amazonaws.datasync#CreateLocationFsxOntap``."""
...
def handle_response(
    ...
    out: capo_datasync.types.create_location_fsx_ontap_response.CreateLocationFsxOntapResponse = capo_datasync.types.create_location_fsx_ontap_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "FmrsService.CreateLocationFsxOntap"
    body: bytes | None = json.dumps(
        capo_datasync.types.create_location_fsx_ontap_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_location_fsx_ontap(
