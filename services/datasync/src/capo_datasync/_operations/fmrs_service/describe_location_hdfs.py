...
def handle_response(
    ...
    out: capo_datasync.types.describe_location_hdfs_response.DescribeLocationHdfsResponse = capo_datasync.types.describe_location_hdfs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datasync.types.describe_location_hdfs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
