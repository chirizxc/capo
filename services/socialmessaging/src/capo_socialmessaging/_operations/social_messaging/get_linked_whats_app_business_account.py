"""Generated from Smithy shape ``com.amazonaws.socialmessaging#GetLinkedWhatsAppBusinessAccount``."""
...
def handle_response(
    ...
    out: capo_socialmessaging.types.get_linked_whats_app_business_account_output.GetLinkedWhatsAppBusinessAccountOutput = capo_socialmessaging.types.get_linked_whats_app_business_account_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/waba/details"
...
async def async_get_linked_whats_app_business_account(
