...
def handle_response(
    ...
    out: capo_socialmessaging.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_socialmessaging.types.list_tags_for_resource_output.deserialize_json(
