...
def handle_response(
    ...
    out: capo_socialmessaging.types.post_whats_app_message_media_output.PostWhatsAppMessageMediaOutput = capo_socialmessaging.types.post_whats_app_message_media_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.post_whats_app_message_media_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
