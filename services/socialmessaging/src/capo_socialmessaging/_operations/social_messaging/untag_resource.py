...
def handle_response(
    ...
    out: capo_socialmessaging.types.untag_resource_output.UntagResourceOutput = (
        capo_socialmessaging.types.untag_resource_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.untag_resource_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
