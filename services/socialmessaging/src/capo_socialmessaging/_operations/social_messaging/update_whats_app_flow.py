...
def handle_response(
    ...
    out: capo_socialmessaging.types.update_whats_app_flow_output.UpdateWhatsAppFlowOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.update_whats_app_flow_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
