"""Generated from Smithy shape ``com.amazonaws.socialmessaging#ListLinkedWhatsAppBusinessAccounts``."""
...
def handle_response(
    ...
    out: capo_socialmessaging.types.list_linked_whats_app_business_accounts_output.ListLinkedWhatsAppBusinessAccountsOutput = capo_socialmessaging.types.list_linked_whats_app_business_accounts_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/whatsapp/waba/list"
...
async def async_list_linked_whats_app_business_accounts(
