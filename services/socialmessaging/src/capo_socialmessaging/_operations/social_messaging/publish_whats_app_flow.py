...
def handle_response(
    ...
    out: capo_socialmessaging.types.publish_whats_app_flow_output.PublishWhatsAppFlowOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_socialmessaging.types.publish_whats_app_flow_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
