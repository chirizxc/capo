...
class WhatsAppSetupFinalization(TypedDict, closed=True):
    associate_in_progress_token: "capo_socialmessaging.types.associate_in_progress_token.AssociateInProgressToken"
    ...
    phone_numbers: "capo_socialmessaging.types.waba_phone_number_setup_finalization_list.WabaPhoneNumberSetupFinalizationList"
    ...
    waba: NotRequired[
        "capo_socialmessaging.types.waba_setup_finalization.WabaSetupFinalization"
    ]
...
def serialize_json(value: WhatsAppSetupFinalization) -> dict:
    ...
    out["phoneNumbers"] = (
        capo_socialmessaging.types.waba_phone_number_setup_finalization_list.serialize_json(
            value["phone_numbers"]
        )
    )
    ...
    if "waba" in value:
        ...
        out["waba"] = capo_socialmessaging.types.waba_setup_finalization.serialize_json(
            value["waba"]
        )
    return out
...
def deserialize_json(data: dict) -> WhatsAppSetupFinalization:
    ...
    if data.get("phoneNumbers") is not None:
        ...
        out["phone_numbers"] = (
            capo_socialmessaging.types.waba_phone_number_setup_finalization_list.deserialize_json(
                data["phoneNumbers"]
            )
        )
    else:
    ...
    if data.get("waba") is not None:
        ...
        out["waba"] = (
            capo_socialmessaging.types.waba_setup_finalization.deserialize_json(
                data["waba"]
            )
        )
    return out
