...
class LibraryTemplateButtonInput(TypedDict, closed=True):
    ...
    url: NotRequired[
        "capo_socialmessaging.types.meta_url_with_suffix_example.MetaUrlWithSuffixExample"
    ]
...
def serialize_json(value: LibraryTemplateButtonInput) -> dict:
    ...
    if "url" in value:
        ...
        out["url"] = (
            capo_socialmessaging.types.meta_url_with_suffix_example.serialize_json(
                value["url"]
            )
        )
...
def deserialize_json(data: dict) -> LibraryTemplateButtonInput:
    ...
    if data.get("url") is not None:
        ...
        out["url"] = (
            capo_socialmessaging.types.meta_url_with_suffix_example.deserialize_json(
                data["url"]
            )
        )
