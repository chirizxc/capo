...
import capo_mgn.types.network_migration_analyses_list
...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_analyses_response.ListNetworkMigrationAnalysesResponse = capo_mgn.types.list_network_migration_analyses_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_analyses_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
