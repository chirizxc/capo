"""Generated from Smithy shape ``com.amazonaws.mgn#DescribeVcenterClients``."""
...
def handle_response(
    ...
    out: capo_mgn.types.describe_vcenter_clients_response.DescribeVcenterClientsResponse = capo_mgn.types.describe_vcenter_clients_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/DescribeVcenterClients"
...
async def async_describe_vcenter_clients(
