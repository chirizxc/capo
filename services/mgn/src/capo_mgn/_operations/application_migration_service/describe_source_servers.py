"""Generated from Smithy shape ``com.amazonaws.mgn#DescribeSourceServers``."""
...
def handle_response(
    ...
    out: capo_mgn.types.describe_source_servers_response.DescribeSourceServersResponse = capo_mgn.types.describe_source_servers_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.describe_source_servers_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
