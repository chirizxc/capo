...
def handle_response(
    ...
    out: capo_mgn.types.list_template_actions_response.ListTemplateActionsResponse = (
        capo_mgn.types.list_template_actions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_template_actions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
