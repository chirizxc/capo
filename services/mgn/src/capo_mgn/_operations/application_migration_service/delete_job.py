...
def handle_response(
    ...
    out: capo_mgn.types.delete_job_response.DeleteJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    input_: capo_mgn.types.delete_job_request.DeleteJobRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.delete_job_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def delete_job(
    ...
    input_: capo_mgn.types.delete_job_request.DeleteJobRequest,
) -> tuple[capo_mgn.types.delete_job_response.DeleteJobResponse, zapros.Response]:
