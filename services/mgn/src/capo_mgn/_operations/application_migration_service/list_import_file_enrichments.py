...
def handle_response(
    ...
    out: capo_mgn.types.list_import_file_enrichments_response.ListImportFileEnrichmentsResponse = capo_mgn.types.list_import_file_enrichments_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_import_file_enrichments_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
