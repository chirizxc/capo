...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_mappings_response.ListNetworkMigrationMappingsResponse = capo_mgn.types.list_network_migration_mappings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_mappings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
