...
def handle_response(
    ...
    out: capo_mgn.types.list_export_errors_response.ListExportErrorsResponse = (
        capo_mgn.types.list_export_errors_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_export_errors_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_export_errors(
    ...
    capo_mgn.types.list_export_errors_response.ListExportErrorsResponse, zapros.Response
]:
