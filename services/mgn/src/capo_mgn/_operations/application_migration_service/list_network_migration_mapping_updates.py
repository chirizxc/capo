"""Generated from Smithy shape ``com.amazonaws.mgn#ListNetworkMigrationMappingUpdates``."""
...
import capo_mgn.types.network_migration_mapping_updates_list
...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_mapping_updates_response.ListNetworkMigrationMappingUpdatesResponse = capo_mgn.types.list_network_migration_mapping_updates_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_mapping_updates_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_network_migration_mapping_updates(
