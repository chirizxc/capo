...
def handle_response(
    ...
    out: capo_mgn.types.delete_launch_configuration_template_response.DeleteLaunchConfigurationTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.delete_launch_configuration_template_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
