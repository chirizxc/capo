...
def handle_response(
    ...
    out: capo_mgn.types.delete_source_server_response.DeleteSourceServerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.delete_source_server_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
