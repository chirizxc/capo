...
def handle_response(
    ...
    out: capo_mgn.types.list_managed_accounts_response.ListManagedAccountsResponse = (
        capo_mgn.types.list_managed_accounts_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_managed_accounts_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
