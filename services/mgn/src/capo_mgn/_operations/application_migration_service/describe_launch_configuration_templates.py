...
def handle_response(
    ...
    out: capo_mgn.types.describe_launch_configuration_templates_response.DescribeLaunchConfigurationTemplatesResponse = capo_mgn.types.describe_launch_configuration_templates_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.describe_launch_configuration_templates_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
