...
def handle_response(
    ...
    out: capo_mgn.types.start_network_migration_mapping_update_response.StartNetworkMigrationMappingUpdateResponse = capo_mgn.types.start_network_migration_mapping_update_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.start_network_migration_mapping_update_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
