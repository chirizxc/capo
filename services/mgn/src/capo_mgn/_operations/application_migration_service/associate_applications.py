"""Generated from Smithy shape ``com.amazonaws.mgn#AssociateApplications``."""
...
def handle_response(
    ...
    out: capo_mgn.types.associate_applications_response.AssociateApplicationsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.associate_applications_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
