...
def handle_response(
    ...
    out: capo_mgn.types.list_import_errors_response.ListImportErrorsResponse = (
        capo_mgn.types.list_import_errors_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_import_errors_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def list_import_errors(
    ...
    capo_mgn.types.list_import_errors_response.ListImportErrorsResponse, zapros.Response
]:
