...
def handle_response(
    ...
    out: capo_mgn.types.list_network_migration_mapper_segment_constructs_response.ListNetworkMigrationMapperSegmentConstructsResponse = capo_mgn.types.list_network_migration_mapper_segment_constructs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_network_migration_mapper_segment_constructs_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
