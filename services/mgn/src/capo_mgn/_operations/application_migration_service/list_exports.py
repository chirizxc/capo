...
def handle_response(
    ...
    out: capo_mgn.types.list_exports_response.ListExportsResponse = (
        capo_mgn.types.list_exports_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.list_exports_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def list_exports(
    ...
    input_: capo_mgn.types.list_exports_request.ListExportsRequest,
) -> tuple[capo_mgn.types.list_exports_response.ListExportsResponse, zapros.Response]:
