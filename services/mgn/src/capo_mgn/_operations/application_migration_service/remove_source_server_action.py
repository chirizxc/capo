...
def handle_response(
    ...
    out: capo_mgn.types.remove_source_server_action_response.RemoveSourceServerActionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.remove_source_server_action_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
