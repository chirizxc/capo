...
def handle_response(
    ...
    out: capo_mgn.types.associate_source_servers_response.AssociateSourceServersResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_mgn.types.associate_source_servers_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
