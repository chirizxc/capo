...
if TYPE_CHECKING:
    import capo_mgn.types.scope_tag_key
    import capo_mgn.types.scope_tag_value

ScopeTagsMap: TypeAlias = dict[
    "capo_mgn.types.scope_tag_key.ScopeTagKey",
    "capo_mgn.types.scope_tag_value.ScopeTagValue",
]
