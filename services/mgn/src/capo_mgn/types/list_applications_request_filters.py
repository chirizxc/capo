...
class ListApplicationsRequestFilters(TypedDict, closed=True):
    application_i_ds: NotRequired[
        "capo_mgn.types.application_i_ds_filter.ApplicationIDsFilter"
    ]
    ...
    wave_i_ds: NotRequired["capo_mgn.types.wave_i_ds_filter.WaveIDsFilter"]
...
def serialize_json(value: ListApplicationsRequestFilters) -> dict:
    ...
    if "application_i_ds" in value:
        ...
        out["applicationIDs"] = capo_mgn.types.application_i_ds_filter.serialize_json(
    ...
    if "wave_i_ds" in value:
        ...
        out["waveIDs"] = capo_mgn.types.wave_i_ds_filter.serialize_json(
            value["wave_i_ds"]
        )
    return out
...
def deserialize_json(data: dict) -> ListApplicationsRequestFilters:
    ...
    if data.get("applicationIDs") is not None:
        ...
        out["application_i_ds"] = (
            capo_mgn.types.application_i_ds_filter.deserialize_json(
                data["applicationIDs"]
            )
        )
