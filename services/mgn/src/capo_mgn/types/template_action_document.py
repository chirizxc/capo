"""Generated from Smithy shape ``com.amazonaws.mgn#TemplateActionDocument``."""
...
class TemplateActionDocument(TypedDict, closed=True):
    action_id: NotRequired["capo_mgn.types.action_id.ActionID"]
    """<p>Template post migration custom action ID.</p>"""
    action_name: NotRequired["capo_mgn.types.bounded_string.BoundedString"]
...
# --- restJson1 ser/de ---
def serialize_json(value: TemplateActionDocument) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> TemplateActionDocument:
    out: TemplateActionDocument = {}  # type: ignore[typeddict-item]
