"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#VerifiedAttributesListType``."""
...
VerifiedAttributesListType: TypeAlias = list[
    "capo_cognito_identity_provider.types.verified_attribute_type.VerifiedAttributeType"
]


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: VerifiedAttributesListType) -> list:
    import capo_cognito_identity_provider.types.verified_attribute_type
...
def deserialize_aws_json_1_1(data: list) -> VerifiedAttributesListType:
    import capo_cognito_identity_provider.types.verified_attribute_type

    out: VerifiedAttributesListType = []
    for item in data:
        if item is None:
            continue
        out.append(
