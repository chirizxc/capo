...
class AccountTakeoverRiskConfigurationType(TypedDict, closed=True):
    notify_configuration: NotRequired[
        "capo_cognito_identity_provider.types.notify_configuration_type.NotifyConfigurationType"
    ]
    ...
    actions: "capo_cognito_identity_provider.types.account_takeover_actions_type.AccountTakeoverActionsType"
...
def serialize_aws_json_1_1(value: AccountTakeoverRiskConfigurationType) -> dict:
    ...
    if "notify_configuration" in value:
        ...
        out["NotifyConfiguration"] = (
            capo_cognito_identity_provider.types.notify_configuration_type.serialize_aws_json_1_1(
    ...
    out["Actions"] = (
        capo_cognito_identity_provider.types.account_takeover_actions_type.serialize_aws_json_1_1(
            value["actions"]
        )
    )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> AccountTakeoverRiskConfigurationType:
    ...
    if data.get("NotifyConfiguration") is not None:
        ...
        out["notify_configuration"] = (
            capo_cognito_identity_provider.types.notify_configuration_type.deserialize_aws_json_1_1(
    ...
    if data.get("Actions") is not None:
        ...
        out["actions"] = (
            capo_cognito_identity_provider.types.account_takeover_actions_type.deserialize_aws_json_1_1(
                data["Actions"]
            )
        )
    else:
