"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#StartWebAuthnRegistrationRequest``."""
...
class StartWebAuthnRegistrationRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartWebAuthnRegistrationRequest) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> StartWebAuthnRegistrationRequest:
    ...
    if data.get("AccessToken") is not None:
        ...
        raise DeserializationError(
            "StartWebAuthnRegistrationRequest.access_token required"
        )
    return out
