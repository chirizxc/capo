...
class UserPoolReplicaType(TypedDict, closed=True):
    region_name: NotRequired[
        "capo_cognito_identity_provider.types.region_name_type.RegionNameType"
    ]
    """<p>The Amazon Web Services Region where the replica is located.</p>"""
    status: NotRequired[
        "capo_cognito_identity_provider.types.replica_status_type.ReplicaStatusType"
    ]
    ...
    role: NotRequired[
        "capo_cognito_identity_provider.types.replica_role_type.ReplicaRoleType"
    ]
    ...
    user_pool_arn: NotRequired["capo_cognito_identity_provider.types.arn_type.ArnType"]
...
def serialize_aws_json_1_1(value: UserPoolReplicaType) -> dict:
    ...
    if "status" in value:
        ...
        out["Status"] = (
            capo_cognito_identity_provider.types.replica_status_type.serialize_aws_json_1_1(
                value["status"]
            )
        )
    if "role" in value:
        ...
        out["Role"] = (
            capo_cognito_identity_provider.types.replica_role_type.serialize_aws_json_1_1(
                value["role"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> UserPoolReplicaType:
    ...
    if data.get("Status") is not None:
        ...
        out["status"] = (
            capo_cognito_identity_provider.types.replica_status_type.deserialize_aws_json_1_1(
                data["Status"]
            )
        )
    if data.get("Role") is not None:
        ...
        out["role"] = (
            capo_cognito_identity_provider.types.replica_role_type.deserialize_aws_json_1_1(
                data["Role"]
            )
        )
