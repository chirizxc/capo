...
class ListUserImportJobsResponse(TypedDict, closed=True):
    user_import_jobs: NotRequired[
        "capo_cognito_identity_provider.types.user_import_jobs_list_type.UserImportJobsListType"
    ]
...
def serialize_aws_json_1_1(value: ListUserImportJobsResponse) -> dict:
    ...
    if "user_import_jobs" in value:
        ...
        out["UserImportJobs"] = (
            capo_cognito_identity_provider.types.user_import_jobs_list_type.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListUserImportJobsResponse:
    ...
    if data.get("UserImportJobs") is not None:
        ...
        out["user_import_jobs"] = (
            capo_cognito_identity_provider.types.user_import_jobs_list_type.deserialize_aws_json_1_1(
                data["UserImportJobs"]
            )
        )
