"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeUserImportJobResponse``."""
...
class DescribeUserImportJobResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: DescribeUserImportJobResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> DescribeUserImportJobResponse:
    out: DescribeUserImportJobResponse = {}  # type: ignore[typeddict-item]
    if data.get("UserImportJob") is not None:
        import capo_cognito_identity_provider.types.user_import_job_type
