...
class AdminListUserAuthEventsResponse(TypedDict, closed=True):
    auth_events: NotRequired[
        "capo_cognito_identity_provider.types.auth_events_type.AuthEventsType"
    ]
...
def serialize_aws_json_1_1(value: AdminListUserAuthEventsResponse) -> dict:
    ...
    if "auth_events" in value:
        ...
        out["AuthEvents"] = (
            capo_cognito_identity_provider.types.auth_events_type.serialize_aws_json_1_1(
                value["auth_events"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> AdminListUserAuthEventsResponse:
    ...
    if data.get("AuthEvents") is not None:
        ...
        out["auth_events"] = (
            capo_cognito_identity_provider.types.auth_events_type.deserialize_aws_json_1_1(
                data["AuthEvents"]
            )
        )
