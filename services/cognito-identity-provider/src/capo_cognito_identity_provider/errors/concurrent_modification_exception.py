"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ConcurrentModificationException``."""
...
class ConcurrentModificationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentityprovider#ConcurrentModificationException``."""
