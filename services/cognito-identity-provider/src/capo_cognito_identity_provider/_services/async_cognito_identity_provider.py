...
from capo_cognito_identity_provider._pagination import resolve_path as _resolve_path
from capo_cognito_identity_provider._services._aws_config import aaws_config
...
if TYPE_CHECKING:
    ...
    import capo_cognito_identity_provider.types.add_user_pool_client_secret_request
    import capo_cognito_identity_provider.types.add_user_pool_client_secret_response
    import capo_cognito_identity_provider.types.admin_add_user_to_group_request
    ...
    import capo_cognito_identity_provider.types.admin_disable_provider_for_user_request
    import capo_cognito_identity_provider.types.admin_disable_provider_for_user_response
    ...
    import capo_cognito_identity_provider.types.admin_enable_user_request
    import capo_cognito_identity_provider.types.admin_enable_user_response
    ...
    import capo_cognito_identity_provider.types.admin_link_provider_for_user_request
    import capo_cognito_identity_provider.types.admin_link_provider_for_user_response
    ...
    import capo_cognito_identity_provider.types.admin_list_groups_for_user_request
    import capo_cognito_identity_provider.types.admin_list_groups_for_user_response
    import capo_cognito_identity_provider.types.admin_list_user_auth_events_request
    import capo_cognito_identity_provider.types.admin_list_user_auth_events_response
    import capo_cognito_identity_provider.types.admin_remove_user_from_group_request
    ...
    import capo_cognito_identity_provider.types.admin_set_user_mfa_preference_request
    import capo_cognito_identity_provider.types.admin_set_user_mfa_preference_response
    import capo_cognito_identity_provider.types.admin_set_user_password_request
    import capo_cognito_identity_provider.types.admin_set_user_password_response
    ...
    import capo_cognito_identity_provider.types.change_password_request
    import capo_cognito_identity_provider.types.change_password_response
    ...
    import capo_cognito_identity_provider.types.complete_web_authn_registration_request
    import capo_cognito_identity_provider.types.complete_web_authn_registration_response
    import capo_cognito_identity_provider.types.compromised_credentials_risk_configuration_type
    import capo_cognito_identity_provider.types.confirm_device_request
    import capo_cognito_identity_provider.types.confirm_device_response
    ...
    import capo_cognito_identity_provider.types.confirm_sign_up_request
    import capo_cognito_identity_provider.types.confirm_sign_up_response
    import capo_cognito_identity_provider.types.confirmation_code_type
    ...
    import capo_cognito_identity_provider.types.create_terms_request
    import capo_cognito_identity_provider.types.create_terms_response
    ...
    import capo_cognito_identity_provider.types.create_user_pool_client_request
    import capo_cognito_identity_provider.types.create_user_pool_client_response
    import capo_cognito_identity_provider.types.create_user_pool_domain_request
    import capo_cognito_identity_provider.types.create_user_pool_domain_response
    import capo_cognito_identity_provider.types.create_user_pool_replica_request
    import capo_cognito_identity_provider.types.create_user_pool_replica_response
    import capo_cognito_identity_provider.types.create_user_pool_request
    import capo_cognito_identity_provider.types.create_user_pool_response
    ...
    import capo_cognito_identity_provider.types.delete_identity_provider_request
    ...
    import capo_cognito_identity_provider.types.delete_terms_request
    ...
    import capo_cognito_identity_provider.types.delete_user_pool_client_secret_request
    import capo_cognito_identity_provider.types.delete_user_pool_client_secret_response
    ...
    import capo_cognito_identity_provider.types.delete_user_request
    ...
    import capo_cognito_identity_provider.types.describe_managed_login_branding_by_client_request
    import capo_cognito_identity_provider.types.describe_managed_login_branding_by_client_response
    ...
    import capo_cognito_identity_provider.types.describe_resource_server_request
    ...
    import capo_cognito_identity_provider.types.describe_user_import_job_response
    ...
    import capo_cognito_identity_provider.types.describe_user_pool_domain_request
    import capo_cognito_identity_provider.types.describe_user_pool_domain_response
    ...
    import capo_cognito_identity_provider.types.forget_device_request
    ...
    import capo_cognito_identity_provider.types.get_device_response
    import capo_cognito_identity_provider.types.get_group_request
    import capo_cognito_identity_provider.types.get_group_response
    import capo_cognito_identity_provider.types.get_identity_provider_by_identifier_request
    ...
    import capo_cognito_identity_provider.types.get_ui_customization_request
    import capo_cognito_identity_provider.types.get_ui_customization_response
    ...
    import capo_cognito_identity_provider.types.get_user_request
    import capo_cognito_identity_provider.types.get_user_response
    ...
    import capo_cognito_identity_provider.types.list_groups_request
    import capo_cognito_identity_provider.types.list_groups_response
    ...
    import capo_cognito_identity_provider.types.list_resource_servers_limit_type
    ...
    import capo_cognito_identity_provider.types.list_user_pool_client_secrets_request
    import capo_cognito_identity_provider.types.list_user_pool_client_secrets_response
    ...
    import capo_cognito_identity_provider.types.list_user_pool_replicas_request
    import capo_cognito_identity_provider.types.list_user_pool_replicas_response
    import capo_cognito_identity_provider.types.list_user_pools_request
    import capo_cognito_identity_provider.types.list_user_pools_response
    ...
    import capo_cognito_identity_provider.types.list_users_request
    import capo_cognito_identity_provider.types.list_users_response
    import capo_cognito_identity_provider.types.list_web_authn_credentials_request
    import capo_cognito_identity_provider.types.list_web_authn_credentials_response
    ...
    import capo_cognito_identity_provider.types.provider_name_type_v2
    ...
    import capo_cognito_identity_provider.types.revoke_token_request
    import capo_cognito_identity_provider.types.revoke_token_response
    ...
    import capo_cognito_identity_provider.types.set_log_delivery_configuration_request
    import capo_cognito_identity_provider.types.set_log_delivery_configuration_response
    import capo_cognito_identity_provider.types.set_risk_configuration_request
    import capo_cognito_identity_provider.types.set_risk_configuration_response
    import capo_cognito_identity_provider.types.set_ui_customization_request
    import capo_cognito_identity_provider.types.set_ui_customization_response
    import capo_cognito_identity_provider.types.set_user_mfa_preference_request
    import capo_cognito_identity_provider.types.set_user_mfa_preference_response
    ...
    import capo_cognito_identity_provider.types.stop_user_import_job_request
    import capo_cognito_identity_provider.types.stop_user_import_job_response
    ...
    import capo_cognito_identity_provider.types.untag_resource_request
    import capo_cognito_identity_provider.types.untag_resource_response
    import capo_cognito_identity_provider.types.update_auth_event_feedback_request
    import capo_cognito_identity_provider.types.update_auth_event_feedback_response
    import capo_cognito_identity_provider.types.update_device_status_request
    import capo_cognito_identity_provider.types.update_device_status_response
    ...
    import capo_cognito_identity_provider.types.update_identity_provider_request
    ...
    import capo_cognito_identity_provider.types.update_user_attributes_request
    import capo_cognito_identity_provider.types.update_user_attributes_response
    import capo_cognito_identity_provider.types.update_user_pool_client_request
    import capo_cognito_identity_provider.types.update_user_pool_client_response
    import capo_cognito_identity_provider.types.update_user_pool_domain_request
    import capo_cognito_identity_provider.types.update_user_pool_domain_response
    ...
    import capo_cognito_identity_provider.types.user_pool_tags_list_type
    ...
    import capo_cognito_identity_provider.types.verify_software_token_request
    import capo_cognito_identity_provider.types.verify_software_token_response
...
class AsyncCognitoIdentityProviderClientConfig(TypedDict, total=False, closed=True):
...
class AsyncCognitoIdentityProviderClient:
    ...
    async def add_custom_attributes(
        ...
        custom_attributes: "capo_cognito_identity_provider.types.custom_attributes_list_type.CustomAttributesListType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.user_import_in_progress_exception.UserImportInProgressException: <p>This exception is thrown when you're trying to modify a user pool while a user import job is in progress for that pool.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.add_custom_attributes_request.AddCustomAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.add_custom_attributes_response.AddCustomAttributesResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.add_custom_attributes

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.add_custom_attributes.async_add_custom_attributes(
    ...
    async def add_user_pool_client_secret(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.add_user_pool_client_secret_response.AddUserPoolClientSecretResponse":
        ...
        Raises:
            capo_cognito_identity_provider.errors.access_denied_exception.AccessDeniedException: <p>This exception is thrown when you don't have sufficient permissions to perform the requested operation.</p>
            capo_cognito_identity_provider.errors.internal_server_exception.InternalServerException: <p>This exception is thrown when Amazon Cognito encounters an internal server error.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.limit_exceeded_exception.LimitExceededException: <p>This exception is thrown when a user exceeds the limit for a requested Amazon Web Services resource.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.add_user_pool_client_secret_request.AddUserPoolClientSecretRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.add_user_pool_client_secret_response.AddUserPoolClientSecretResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.add_user_pool_client_secret

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.add_user_pool_client_secret.async_add_user_pool_client_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_add_user_to_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_add_user_to_group_request.AdminAddUserToGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_add_user_to_group

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_add_user_to_group.async_admin_add_user_to_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_confirm_sign_up(
        ...
        *,
        ...
        Raises:
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_lambda_response_exception.InvalidLambdaResponseException: <p>This exception is thrown when Amazon Cognito encounters an invalid Lambda response.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.limit_exceeded_exception.LimitExceededException: <p>This exception is thrown when a user exceeds the limit for a requested Amazon Web Services resource.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.too_many_failed_attempts_exception.TooManyFailedAttemptsException: <p>This exception is thrown when the user has made too many failed attempts for a given action, such as sign-in.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.unexpected_lambda_exception.UnexpectedLambdaException: <p>This exception is thrown when Amazon Cognito encounters an unexpected exception with Lambda.</p>
            capo_cognito_identity_provider.errors.user_lambda_validation_exception.UserLambdaValidationException: <p>This exception is thrown when the Amazon Cognito service encounters a user validation exception with the Lambda service.</p>
            capo_cognito_identity_provider.errors.user_not_found_exception.UserNotFoundException: <p>This exception is thrown when a user isn't found.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_confirm_sign_up_request.AdminConfirmSignUpRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_confirm_sign_up_response.AdminConfirmSignUpResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_confirm_sign_up

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_confirm_sign_up.async_admin_confirm_sign_up(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_create_user(
        ...
        *,
        ...
        Raises:
            capo_cognito_identity_provider.errors.code_delivery_failure_exception.CodeDeliveryFailureException: <p>This exception is thrown when a verification code fails to deliver successfully.</p>
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_lambda_response_exception.InvalidLambdaResponseException: <p>This exception is thrown when Amazon Cognito encounters an invalid Lambda response.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.invalid_password_exception.InvalidPasswordException: <p>This exception is thrown when Amazon Cognito encounters an invalid password.</p>
            capo_cognito_identity_provider.errors.invalid_sms_role_access_policy_exception.InvalidSmsRoleAccessPolicyException: <p>This exception is returned when the role provided for SMS configuration doesn't have permission to publish using Amazon SNS.</p>
            capo_cognito_identity_provider.errors.invalid_sms_role_trust_relationship_exception.InvalidSmsRoleTrustRelationshipException: <p>This exception is thrown when the trust relationship is not valid for the role provided for SMS configuration. This can happen if you don't trust <code>cognito-idp.amazonaws.com</code> or the external ID provided in the role does not match what is provided in the SMS configuration for the user pool.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.precondition_not_met_exception.PreconditionNotMetException: <p>This exception is thrown when a precondition is not met.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.unexpected_lambda_exception.UnexpectedLambdaException: <p>This exception is thrown when Amazon Cognito encounters an unexpected exception with Lambda.</p>
            capo_cognito_identity_provider.errors.unsupported_user_state_exception.UnsupportedUserStateException: <p>The request failed because the user is in an unsupported state.</p>
            capo_cognito_identity_provider.errors.user_lambda_validation_exception.UserLambdaValidationException: <p>This exception is thrown when the Amazon Cognito service encounters a user validation exception with the Lambda service.</p>
            capo_cognito_identity_provider.errors.username_exists_exception.UsernameExistsException: <p>This exception is thrown when Amazon Cognito encounters a user name that already exists in the user pool.</p>
            capo_cognito_identity_provider.errors.user_not_found_exception.UserNotFoundException: <p>This exception is thrown when a user isn't found.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_create_user_request.AdminCreateUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_create_user_response.AdminCreateUserResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_create_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_create_user.async_admin_create_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_delete_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_delete_user_request.AdminDeleteUserRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_delete_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_delete_user.async_admin_delete_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_delete_user_attributes(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.admin_delete_user_attributes_response.AdminDeleteUserAttributesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_delete_user_attributes_request.AdminDeleteUserAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_delete_user_attributes_response.AdminDeleteUserAttributesResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_delete_user_attributes

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_delete_user_attributes.async_admin_delete_user_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_disable_provider_for_user(
        ...
        user: "capo_cognito_identity_provider.types.provider_user_identifier_type.ProviderUserIdentifierType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.admin_disable_provider_for_user_response.AdminDisableProviderForUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_disable_provider_for_user_request.AdminDisableProviderForUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_disable_provider_for_user_response.AdminDisableProviderForUserResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_disable_provider_for_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_disable_provider_for_user.async_admin_disable_provider_for_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_disable_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_disable_user_request.AdminDisableUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_disable_user_response.AdminDisableUserResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_disable_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_disable_user.async_admin_disable_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_enable_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_enable_user_request.AdminEnableUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_enable_user_response.AdminEnableUserResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_enable_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_enable_user.async_admin_enable_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_forget_device(
        ...
        *,
        ...
        Raises:
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.invalid_user_pool_configuration_exception.InvalidUserPoolConfigurationException: <p>This exception is thrown when the user pool configuration is not valid.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_forget_device_request.AdminForgetDeviceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_forget_device

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_forget_device.async_admin_forget_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_get_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_get_device_request.AdminGetDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_get_device_response.AdminGetDeviceResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_get_device

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_get_device.async_admin_get_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_get_user(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.admin_get_user_response.AdminGetUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_get_user_request.AdminGetUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_get_user_response.AdminGetUserResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_get_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_get_user.async_admin_get_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_initiate_auth(
        ...
        *,
        ...
        Raises:
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_email_role_access_policy_exception.InvalidEmailRoleAccessPolicyException: <p>This exception is thrown when Amazon Cognito isn't allowed to use your email identity. HTTP status code: 400.</p>
            capo_cognito_identity_provider.errors.invalid_lambda_response_exception.InvalidLambdaResponseException: <p>This exception is thrown when Amazon Cognito encounters an invalid Lambda response.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.invalid_sms_role_access_policy_exception.InvalidSmsRoleAccessPolicyException: <p>This exception is returned when the role provided for SMS configuration doesn't have permission to publish using Amazon SNS.</p>
            capo_cognito_identity_provider.errors.invalid_sms_role_trust_relationship_exception.InvalidSmsRoleTrustRelationshipException: <p>This exception is thrown when the trust relationship is not valid for the role provided for SMS configuration. This can happen if you don't trust <code>cognito-idp.amazonaws.com</code> or the external ID provided in the role does not match what is provided in the SMS configuration for the user pool.</p>
            capo_cognito_identity_provider.errors.invalid_user_pool_configuration_exception.InvalidUserPoolConfigurationException: <p>This exception is thrown when the user pool configuration is not valid.</p>
            capo_cognito_identity_provider.errors.mfa_method_not_found_exception.MFAMethodNotFoundException: <p>This exception is thrown when Amazon Cognito can't find a multi-factor authentication (MFA) method.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.password_reset_required_exception.PasswordResetRequiredException: <p>This exception is thrown when a password reset is required.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.unexpected_lambda_exception.UnexpectedLambdaException: <p>This exception is thrown when Amazon Cognito encounters an unexpected exception with Lambda.</p>
            capo_cognito_identity_provider.errors.unsupported_operation_exception.UnsupportedOperationException: <p>Exception that is thrown when you attempt to perform an operation that isn't enabled for the user pool client.</p>
            capo_cognito_identity_provider.errors.user_lambda_validation_exception.UserLambdaValidationException: <p>This exception is thrown when the Amazon Cognito service encounters a user validation exception with the Lambda service.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_initiate_auth_request.AdminInitiateAuthRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_initiate_auth_response.AdminInitiateAuthResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_initiate_auth

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_initiate_auth.async_admin_initiate_auth(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_link_provider_for_user(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.admin_link_provider_for_user_response.AdminLinkProviderForUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_link_provider_for_user_request.AdminLinkProviderForUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_link_provider_for_user_response.AdminLinkProviderForUserResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_link_provider_for_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_link_provider_for_user.async_admin_link_provider_for_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_list_devices(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_list_devices_request.AdminListDevicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_list_devices_response.AdminListDevicesResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_list_devices

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_list_devices.async_admin_list_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_list_groups_for_user(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.admin_list_groups_for_user_response.AdminListGroupsForUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_list_groups_for_user_request.AdminListGroupsForUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_list_groups_for_user_response.AdminListGroupsForUserResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_list_groups_for_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_list_groups_for_user.async_admin_list_groups_for_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cognito_identity_provider.types.group_type.GroupType]":
        _token = next_token
        while True:
    ...
    async def admin_list_user_auth_events(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.admin_list_user_auth_events_response.AdminListUserAuthEventsResponse":
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.user_not_found_exception.UserNotFoundException: <p>This exception is thrown when a user isn't found.</p>
            capo_cognito_identity_provider.errors.user_pool_add_on_not_enabled_exception.UserPoolAddOnNotEnabledException: <p>This exception is thrown when user pool add-ons aren't enabled.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_list_user_auth_events_request.AdminListUserAuthEventsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_list_user_auth_events_response.AdminListUserAuthEventsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_list_user_auth_events

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_list_user_auth_events.async_admin_list_user_auth_events(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cognito_identity_provider.types.auth_event_type.AuthEventType]":
        _token = next_token
        while True:
    ...
    async def admin_remove_user_from_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_remove_user_from_group_request.AdminRemoveUserFromGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_remove_user_from_group

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_remove_user_from_group.async_admin_remove_user_from_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_reset_user_password(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_reset_user_password_request.AdminResetUserPasswordRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_reset_user_password_response.AdminResetUserPasswordResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_reset_user_password

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_reset_user_password.async_admin_reset_user_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_respond_to_auth_challenge(
        ...
        user_pool_id: "capo_cognito_identity_provider.types.user_pool_id_type.UserPoolIdType",
        client_id: "capo_cognito_identity_provider.types.client_id_type.ClientIdType",
        challenge_name: "capo_cognito_identity_provider.types.challenge_name_type.ChallengeNameType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        ...
        Raises:
            capo_cognito_identity_provider.errors.alias_exists_exception.AliasExistsException: <p>This exception is thrown when a user tries to confirm the account with an email address or phone number that has already been supplied as an alias for a different user profile. This exception indicates that an account with this email address or phone already exists in a user pool that you've configured to use email address or phone number as a sign-in alias.</p>
            capo_cognito_identity_provider.errors.code_mismatch_exception.CodeMismatchException: <p>This exception is thrown if the provided code doesn't match what the server was expecting.</p>
            capo_cognito_identity_provider.errors.expired_code_exception.ExpiredCodeException: <p>This exception is thrown if a code has expired.</p>
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_email_role_access_policy_exception.InvalidEmailRoleAccessPolicyException: <p>This exception is thrown when Amazon Cognito isn't allowed to use your email identity. HTTP status code: 400.</p>
            capo_cognito_identity_provider.errors.invalid_lambda_response_exception.InvalidLambdaResponseException: <p>This exception is thrown when Amazon Cognito encounters an invalid Lambda response.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            ...
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.password_history_policy_violation_exception.PasswordHistoryPolicyViolationException: <p>The message returned when a user's new password matches a previous password and doesn't comply with the password-history policy.</p>
            capo_cognito_identity_provider.errors.password_reset_required_exception.PasswordResetRequiredException: <p>This exception is thrown when a password reset is required.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.software_token_mfa_not_found_exception.SoftwareTokenMFANotFoundException: <p>This exception is thrown when the software token time-based one-time password (TOTP) multi-factor authentication (MFA) isn't activated for the user pool.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.unexpected_lambda_exception.UnexpectedLambdaException: <p>This exception is thrown when Amazon Cognito encounters an unexpected exception with Lambda.</p>
            capo_cognito_identity_provider.errors.user_lambda_validation_exception.UserLambdaValidationException: <p>This exception is thrown when the Amazon Cognito service encounters a user validation exception with the Lambda service.</p>
            capo_cognito_identity_provider.errors.user_not_confirmed_exception.UserNotConfirmedException: <p>This exception is thrown when a user isn't confirmed successfully.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_respond_to_auth_challenge_request.AdminRespondToAuthChallengeRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_respond_to_auth_challenge_response.AdminRespondToAuthChallengeResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_respond_to_auth_challenge

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_respond_to_auth_challenge.async_admin_respond_to_auth_challenge(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_set_user_mfa_preference(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.admin_set_user_mfa_preference_response.AdminSetUserMFAPreferenceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_set_user_mfa_preference_request.AdminSetUserMFAPreferenceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_set_user_mfa_preference_response.AdminSetUserMFAPreferenceResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_set_user_mfa_preference

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_set_user_mfa_preference.async_admin_set_user_mfa_preference(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_set_user_password(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.admin_set_user_password_response.AdminSetUserPasswordResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_set_user_password_request.AdminSetUserPasswordRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_set_user_password_response.AdminSetUserPasswordResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_set_user_password

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_set_user_password.async_admin_set_user_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_set_user_settings(
        ...
        user_pool_id: "capo_cognito_identity_provider.types.user_pool_id_type.UserPoolIdType",
        username: "capo_cognito_identity_provider.types.username_type.UsernameType",
        mfa_options: "capo_cognito_identity_provider.types.mfa_option_list_type.MFAOptionListType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_set_user_settings_request.AdminSetUserSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_set_user_settings_response.AdminSetUserSettingsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_set_user_settings

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_set_user_settings.async_admin_set_user_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_update_auth_event_feedback(
        ...
        feedback_value: "capo_cognito_identity_provider.types.feedback_value_type.FeedbackValueType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_update_auth_event_feedback_request.AdminUpdateAuthEventFeedbackRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_update_auth_event_feedback_response.AdminUpdateAuthEventFeedbackResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_update_auth_event_feedback

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_update_auth_event_feedback.async_admin_update_auth_event_feedback(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_update_device_status(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_update_device_status_request.AdminUpdateDeviceStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_update_device_status_response.AdminUpdateDeviceStatusResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_update_device_status

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_update_device_status.async_admin_update_device_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_update_user_attributes(
        ...
        user_pool_id: "capo_cognito_identity_provider.types.user_pool_id_type.UserPoolIdType",
        username: "capo_cognito_identity_provider.types.username_type.UsernameType",
        user_attributes: "capo_cognito_identity_provider.types.attribute_list_type.AttributeListType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        client_metadata: Optional[
            "capo_cognito_identity_provider.types.client_metadata_type.ClientMetadataType"
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_update_user_attributes_request.AdminUpdateUserAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_update_user_attributes_response.AdminUpdateUserAttributesResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_update_user_attributes

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_update_user_attributes.async_admin_update_user_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def admin_user_global_sign_out(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.admin_user_global_sign_out_request.AdminUserGlobalSignOutRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.admin_user_global_sign_out_response.AdminUserGlobalSignOutResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_user_global_sign_out

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.admin_user_global_sign_out.async_admin_user_global_sign_out(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def associate_software_token(
        ...
        *,
        ...
        Raises:
            capo_cognito_identity_provider.errors.concurrent_modification_exception.ConcurrentModificationException: <p>This exception is thrown if two or more modifications are happening concurrently.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.associate_software_token_request.AssociateSoftwareTokenRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.associate_software_token_response.AssociateSoftwareTokenResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.associate_software_token

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.associate_software_token.async_associate_software_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def change_password(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.change_password_response.ChangePasswordResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.change_password_request.ChangePasswordRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.change_password_response.ChangePasswordResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.change_password

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.change_password.async_change_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def complete_web_authn_registration(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.complete_web_authn_registration_response.CompleteWebAuthnRegistrationResponse":
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.password_reset_required_exception.PasswordResetRequiredException: <p>This exception is thrown when a password reset is required.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.web_authn_challenge_not_found_exception.WebAuthnChallengeNotFoundException: <p>This exception is thrown when the challenge from <code>StartWebAuthn</code> registration has expired.</p>
            capo_cognito_identity_provider.errors.web_authn_client_mismatch_exception.WebAuthnClientMismatchException: <p>This exception is thrown when the access token is for a different client than the one in the original <code>StartWebAuthnRegistration</code> request.</p>
            capo_cognito_identity_provider.errors.web_authn_credential_not_supported_exception.WebAuthnCredentialNotSupportedException: <p>This exception is thrown when a user presents passkey credentials from an unsupported device or provider.</p>
            capo_cognito_identity_provider.errors.web_authn_not_enabled_exception.WebAuthnNotEnabledException: <p>This exception is thrown when the passkey feature isn't enabled for the user pool.</p>
            capo_cognito_identity_provider.errors.web_authn_origin_not_allowed_exception.WebAuthnOriginNotAllowedException: <p>This exception is thrown when the passkey credential's registration origin does not align with the user pool relying party id.</p>
            capo_cognito_identity_provider.errors.web_authn_relying_party_mismatch_exception.WebAuthnRelyingPartyMismatchException: <p>This exception is thrown when the given passkey credential is associated with a different relying party ID than the user pool relying party ID.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.complete_web_authn_registration_request.CompleteWebAuthnRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.complete_web_authn_registration_response.CompleteWebAuthnRegistrationResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.complete_web_authn_registration

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.complete_web_authn_registration.async_complete_web_authn_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def confirm_device(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.confirm_device_response.ConfirmDeviceResponse":
        ...
        Raises:
            capo_cognito_identity_provider.errors.device_key_exists_exception.DeviceKeyExistsException: <p>This exception is thrown when a user attempts to confirm a device with a device key that already exists.</p>
            capo_cognito_identity_provider.errors.forbidden_exception.ForbiddenException: <p>This exception is thrown when WAF doesn't allow your request based on a web ACL that's associated with your user pool.</p>
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_lambda_response_exception.InvalidLambdaResponseException: <p>This exception is thrown when Amazon Cognito encounters an invalid Lambda response.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.confirm_device_request.ConfirmDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.confirm_device_response.ConfirmDeviceResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.confirm_device

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.confirm_device.async_confirm_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def confirm_forgot_password(
        ...
        client_id: "capo_cognito_identity_provider.types.client_id_type.ClientIdType",
        username: "capo_cognito_identity_provider.types.username_type.UsernameType",
        confirmation_code: "capo_cognito_identity_provider.types.confirmation_code_type.ConfirmationCodeType",
        password: "capo_cognito_identity_provider.types.password_type.PasswordType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.confirm_forgot_password_request.ConfirmForgotPasswordRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.confirm_forgot_password_response.ConfirmForgotPasswordResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.confirm_forgot_password

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.confirm_forgot_password.async_confirm_forgot_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def confirm_sign_up(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.confirm_sign_up_response.ConfirmSignUpResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.confirm_sign_up_request.ConfirmSignUpRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.confirm_sign_up_response.ConfirmSignUpResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.confirm_sign_up

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.confirm_sign_up.async_confirm_sign_up(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_group(
        ...
        *,
        ...
        Raises:
            capo_cognito_identity_provider.errors.group_exists_exception.GroupExistsException: <p>This exception is thrown when Amazon Cognito encounters a group that already exists in the user pool.</p>
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.limit_exceeded_exception.LimitExceededException: <p>This exception is thrown when a user exceeds the limit for a requested Amazon Web Services resource.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_group_request.CreateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_group_response.CreateGroupResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_group

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_group.async_create_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_identity_provider(
        self,
        user_pool_id: "capo_cognito_identity_provider.types.user_pool_id_type.UserPoolIdType",
        provider_name: "capo_cognito_identity_provider.types.provider_name_type_v2.ProviderNameTypeV2",
        provider_type: "capo_cognito_identity_provider.types.identity_provider_type_type.IdentityProviderTypeType",
        provider_details: "capo_cognito_identity_provider.types.provider_details_type.ProviderDetailsType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        ...
        Raises:
            capo_cognito_identity_provider.errors.duplicate_provider_exception.DuplicateProviderException: <p>This exception is thrown when the provider is already supported by the user pool.</p>
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.limit_exceeded_exception.LimitExceededException: <p>This exception is thrown when a user exceeds the limit for a requested Amazon Web Services resource.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_identity_provider_request.CreateIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_identity_provider_response.CreateIdentityProviderResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_identity_provider

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_identity_provider.async_create_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_managed_login_branding(
        ...
        *,
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.limit_exceeded_exception.LimitExceededException: <p>This exception is thrown when a user exceeds the limit for a requested Amazon Web Services resource.</p>
            capo_cognito_identity_provider.errors.managed_login_branding_exists_exception.ManagedLoginBrandingExistsException: <p>This exception is thrown when you attempt to apply a managed login branding style to an app client that already has an assigned style.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_managed_login_branding_request.CreateManagedLoginBrandingRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_managed_login_branding_response.CreateManagedLoginBrandingResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_managed_login_branding

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_managed_login_branding.async_create_managed_login_branding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_resource_server(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_resource_server_request.CreateResourceServerRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_resource_server_response.CreateResourceServerResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_resource_server

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_resource_server.async_create_resource_server(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_terms(
        ...
        terms_source: "capo_cognito_identity_provider.types.terms_source_type.TermsSourceType",
        enforcement: "capo_cognito_identity_provider.types.terms_enforcement_type.TermsEnforcementType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        links: Optional[
            "capo_cognito_identity_provider.types.links_type.LinksType"
        ] = None,
    ) -> (
        "capo_cognito_identity_provider.types.create_terms_response.CreateTermsResponse"
    ):
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.terms_exists_exception.TermsExistsException: <p>Terms document names must be unique to the app client. This exception is thrown when you attempt to create terms documents with a duplicate <code>TermsName</code>.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_terms_request.CreateTermsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_terms_response.CreateTermsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_terms

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_terms.async_create_terms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_user_import_job_request.CreateUserImportJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_user_import_job_response.CreateUserImportJobResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_import_job

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_import_job.async_create_user_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user_pool(
        self,
        pool_name: "capo_cognito_identity_provider.types.user_pool_name_type.UserPoolNameType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        policies: Optional[
    ...
    ) -> "capo_cognito_identity_provider.types.create_user_pool_response.CreateUserPoolResponse":
        ...
        Raises:
            capo_cognito_identity_provider.errors.feature_unavailable_in_tier_exception.FeatureUnavailableInTierException: <p>This exception is thrown when a feature you attempted to configure isn't available in your current feature plan.</p>
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_email_role_access_policy_exception.InvalidEmailRoleAccessPolicyException: <p>This exception is thrown when Amazon Cognito isn't allowed to use your email identity. HTTP status code: 400.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.invalid_sms_role_access_policy_exception.InvalidSmsRoleAccessPolicyException: <p>This exception is returned when the role provided for SMS configuration doesn't have permission to publish using Amazon SNS.</p>
            ...
            capo_cognito_identity_provider.errors.limit_exceeded_exception.LimitExceededException: <p>This exception is thrown when a user exceeds the limit for a requested Amazon Web Services resource.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.tier_change_not_allowed_exception.TierChangeNotAllowedException: <p>This exception is thrown when you've attempted to change your feature plan but the operation isn't permitted.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.user_pool_tagging_exception.UserPoolTaggingException: <p>This exception is thrown when a user pool tag can't be set or updated.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_user_pool_request.CreateUserPoolRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_user_pool_response.CreateUserPoolResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_pool

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_pool.async_create_user_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user_pool_client(
        ...
        *,
        ...
        refresh_token_validity: Optional[
            "capo_cognito_identity_provider.types.refresh_token_validity_type.RefreshTokenValidityType"
        ] = None,
    ...
    ) -> "capo_cognito_identity_provider.types.create_user_pool_client_response.CreateUserPoolClientResponse":
        ...
        Raises:
            capo_cognito_identity_provider.errors.feature_unavailable_in_tier_exception.FeatureUnavailableInTierException: <p>This exception is thrown when a feature you attempted to configure isn't available in your current feature plan.</p>
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_o_auth_flow_exception.InvalidOAuthFlowException: <p>This exception is thrown when the specified OAuth flow is not valid.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.limit_exceeded_exception.LimitExceededException: <p>This exception is thrown when a user exceeds the limit for a requested Amazon Web Services resource.</p>
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.scope_does_not_exist_exception.ScopeDoesNotExistException: <p>This exception is thrown when the specified scope doesn't exist.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_user_pool_client_request.CreateUserPoolClientRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_user_pool_client_response.CreateUserPoolClientResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_pool_client

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_pool_client.async_create_user_pool_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user_pool_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_user_pool_domain_request.CreateUserPoolDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_user_pool_domain_response.CreateUserPoolDomainResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_pool_domain

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_pool_domain.async_create_user_pool_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_user_pool_replica(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.create_user_pool_replica_response.CreateUserPoolReplicaResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.create_user_pool_replica_request.CreateUserPoolReplicaRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.create_user_pool_replica_response.CreateUserPoolReplicaResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_pool_replica

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.create_user_pool_replica.async_create_user_pool_replica(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_group_request.DeleteGroupRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_group

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_group.async_delete_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_identity_provider(
        self,
        user_pool_id: "capo_cognito_identity_provider.types.user_pool_id_type.UserPoolIdType",
        provider_name: "capo_cognito_identity_provider.types.provider_name_type.ProviderNameType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> None:
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.unsupported_identity_provider_exception.UnsupportedIdentityProviderException: <p>This exception is thrown when the specified identifier isn't supported.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_identity_provider_request.DeleteIdentityProviderRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_identity_provider

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_identity_provider.async_delete_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_managed_login_branding(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_managed_login_branding_request.DeleteManagedLoginBrandingRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_managed_login_branding

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_managed_login_branding.async_delete_managed_login_branding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_resource_server(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_resource_server_request.DeleteResourceServerRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_resource_server

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_resource_server.async_delete_resource_server(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_terms(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_terms_request.DeleteTermsRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_terms

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_terms.async_delete_terms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_user_request.DeleteUserRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user.async_delete_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_attributes(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_user_attributes_request.DeleteUserAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.delete_user_attributes_response.DeleteUserAttributesResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_attributes

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_attributes.async_delete_user_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_user_pool_request.DeleteUserPoolRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool.async_delete_user_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_pool_client(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_user_pool_client_request.DeleteUserPoolClientRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool_client

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool_client.async_delete_user_pool_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_pool_client_secret(
        ...
        user_pool_id: "capo_cognito_identity_provider.types.user_pool_id_type.UserPoolIdType",
        client_id: "capo_cognito_identity_provider.types.client_id_type.ClientIdType",
        client_secret_id: "capo_cognito_identity_provider.types.client_secret_id_type.ClientSecretIdType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.delete_user_pool_client_secret_response.DeleteUserPoolClientSecretResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_user_pool_client_secret_request.DeleteUserPoolClientSecretRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.delete_user_pool_client_secret_response.DeleteUserPoolClientSecretResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool_client_secret

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool_client_secret.async_delete_user_pool_client_secret(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_pool_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_user_pool_domain_request.DeleteUserPoolDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.delete_user_pool_domain_response.DeleteUserPoolDomainResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool_domain

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool_domain.async_delete_user_pool_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_user_pool_replica(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_user_pool_replica_request.DeleteUserPoolReplicaRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.delete_user_pool_replica_response.DeleteUserPoolReplicaResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool_replica

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_user_pool_replica.async_delete_user_pool_replica(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_web_authn_credential(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.delete_web_authn_credential_request.DeleteWebAuthnCredentialRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.delete_web_authn_credential_response.DeleteWebAuthnCredentialResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_web_authn_credential

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.delete_web_authn_credential.async_delete_web_authn_credential(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_identity_provider(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_identity_provider_request.DescribeIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_identity_provider_response.DescribeIdentityProviderResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_identity_provider

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_identity_provider.async_describe_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_managed_login_branding(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_managed_login_branding_request.DescribeManagedLoginBrandingRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_managed_login_branding_response.DescribeManagedLoginBrandingResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_managed_login_branding

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_managed_login_branding.async_describe_managed_login_branding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_managed_login_branding_by_client(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.describe_managed_login_branding_by_client_response.DescribeManagedLoginBrandingByClientResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_managed_login_branding_by_client_request.DescribeManagedLoginBrandingByClientRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_managed_login_branding_by_client_response.DescribeManagedLoginBrandingByClientResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_managed_login_branding_by_client

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_managed_login_branding_by_client.async_describe_managed_login_branding_by_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_resource_server(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.describe_resource_server_response.DescribeResourceServerResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_resource_server_request.DescribeResourceServerRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_resource_server_response.DescribeResourceServerResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_resource_server

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_resource_server.async_describe_resource_server(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_risk_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_risk_configuration_request.DescribeRiskConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_risk_configuration_response.DescribeRiskConfigurationResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_risk_configuration

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_risk_configuration.async_describe_risk_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_terms(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.describe_terms_response.DescribeTermsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_terms_request.DescribeTermsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_terms_response.DescribeTermsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_terms

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_terms.async_describe_terms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_user_import_job(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.describe_user_import_job_response.DescribeUserImportJobResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_user_import_job_request.DescribeUserImportJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_user_import_job_response.DescribeUserImportJobResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_user_import_job

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_user_import_job.async_describe_user_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_user_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_user_pool_request.DescribeUserPoolRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_user_pool_response.DescribeUserPoolResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_user_pool

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_user_pool.async_describe_user_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_user_pool_client(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_user_pool_client_request.DescribeUserPoolClientRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_user_pool_client_response.DescribeUserPoolClientResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_user_pool_client

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_user_pool_client.async_describe_user_pool_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def describe_user_pool_domain(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.describe_user_pool_domain_request.DescribeUserPoolDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.describe_user_pool_domain_response.DescribeUserPoolDomainResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_user_pool_domain

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.describe_user_pool_domain.async_describe_user_pool_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def forget_device(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.forget_device_request.ForgetDeviceRequest]",
        ) -> AsyncOperationResponse[None]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.forget_device

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.forget_device.async_forget_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def forgot_password(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.forgot_password_request.ForgotPasswordRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.forgot_password_response.ForgotPasswordResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.forgot_password

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.forgot_password.async_forgot_password(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_csv_header(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_csv_header_request.GetCSVHeaderRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_csv_header_response.GetCSVHeaderResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_csv_header

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_csv_header.async_get_csv_header(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_device(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.get_device_response.GetDeviceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_device_request.GetDeviceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_device_response.GetDeviceResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_device

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_device.async_get_device(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_group(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.get_group_response.GetGroupResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_group_request.GetGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_group_response.GetGroupResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_group

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_group.async_get_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_identity_provider_by_identifier(
        self,
        user_pool_id: "capo_cognito_identity_provider.types.user_pool_id_type.UserPoolIdType",
        idp_identifier: "capo_cognito_identity_provider.types.idp_identifier_type.IdpIdentifierType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.get_identity_provider_by_identifier_response.GetIdentityProviderByIdentifierResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_identity_provider_by_identifier_request.GetIdentityProviderByIdentifierRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_identity_provider_by_identifier_response.GetIdentityProviderByIdentifierResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_identity_provider_by_identifier

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_identity_provider_by_identifier.async_get_identity_provider_by_identifier(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_log_delivery_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_log_delivery_configuration_request.GetLogDeliveryConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_log_delivery_configuration_response.GetLogDeliveryConfigurationResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_log_delivery_configuration

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_log_delivery_configuration.async_get_log_delivery_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_signing_certificate(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.get_signing_certificate_response.GetSigningCertificateResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_signing_certificate_request.GetSigningCertificateRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_signing_certificate_response.GetSigningCertificateResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_signing_certificate

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_signing_certificate.async_get_signing_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_tokens_from_refresh_token(
        self,
        refresh_token: "capo_cognito_identity_provider.types.token_model_type.TokenModelType",
        client_id: "capo_cognito_identity_provider.types.client_id_type.ClientIdType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        client_secret: Optional[
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.not_authorized_exception.NotAuthorizedException: <p>This exception is thrown when a user isn't authorized.</p>
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.refresh_token_reuse_exception.RefreshTokenReuseException: <p>This exception is throw when your application requests token refresh with a refresh token that has been invalidated by refresh-token rotation.</p>
            capo_cognito_identity_provider.errors.resource_not_found_exception.ResourceNotFoundException: <p>This exception is thrown when the Amazon Cognito service can't find the requested resource.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.unexpected_lambda_exception.UnexpectedLambdaException: <p>This exception is thrown when Amazon Cognito encounters an unexpected exception with Lambda.</p>
            capo_cognito_identity_provider.errors.user_lambda_validation_exception.UserLambdaValidationException: <p>This exception is thrown when the Amazon Cognito service encounters a user validation exception with the Lambda service.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_tokens_from_refresh_token_request.GetTokensFromRefreshTokenRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_tokens_from_refresh_token_response.GetTokensFromRefreshTokenResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_tokens_from_refresh_token

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_tokens_from_refresh_token.async_get_tokens_from_refresh_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_ui_customization(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.get_ui_customization_response.GetUICustomizationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_ui_customization_request.GetUICustomizationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_ui_customization_response.GetUICustomizationResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_ui_customization

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_ui_customization.async_get_ui_customization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_user(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.get_user_response.GetUserResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_user_request.GetUserRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_user_response.GetUserResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_user

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_user.async_get_user(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_user_attribute_verification_code(
        self,
        access_token: "capo_cognito_identity_provider.types.token_model_type.TokenModelType",
        attribute_name: "capo_cognito_identity_provider.types.attribute_name_type.AttributeNameType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        client_metadata: Optional[
            "capo_cognito_identity_provider.types.client_metadata_type.ClientMetadataType"
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_user_attribute_verification_code_request.GetUserAttributeVerificationCodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_user_attribute_verification_code_response.GetUserAttributeVerificationCodeResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_user_attribute_verification_code

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_user_attribute_verification_code.async_get_user_attribute_verification_code(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_user_auth_factors(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_user_auth_factors_request.GetUserAuthFactorsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_user_auth_factors_response.GetUserAuthFactorsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_user_auth_factors

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_user_auth_factors.async_get_user_auth_factors(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_user_pool_mfa_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.get_user_pool_mfa_config_request.GetUserPoolMfaConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.get_user_pool_mfa_config_response.GetUserPoolMfaConfigResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_user_pool_mfa_config

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.get_user_pool_mfa_config.async_get_user_pool_mfa_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def global_sign_out(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.global_sign_out_request.GlobalSignOutRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.global_sign_out_response.GlobalSignOutResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.global_sign_out

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.global_sign_out.async_global_sign_out(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def initiate_auth(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.initiate_auth_response.InitiateAuthResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.initiate_auth_request.InitiateAuthRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.initiate_auth_response.InitiateAuthResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.initiate_auth

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.initiate_auth.async_initiate_auth(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_devices(
        ...
        *,
        ...
        "capo_cognito_identity_provider.types.list_devices_response.ListDevicesResponse"
    ):
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_devices_request.ListDevicesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_devices_response.ListDevicesResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_devices

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_devices.async_list_devices(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_groups(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.list_groups_response.ListGroupsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_groups_request.ListGroupsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_groups_response.ListGroupsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_groups

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_groups.async_list_groups(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_identity_providers(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_identity_providers_request.ListIdentityProvidersRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_identity_providers_response.ListIdentityProvidersResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_identity_providers

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_identity_providers.async_list_identity_providers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cognito_identity_provider.types.provider_description.ProviderDescription]":
        _token = next_token
        while True:
    ...
    async def list_resource_servers(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        max_results: Optional[
            "capo_cognito_identity_provider.types.list_resource_servers_limit_type.ListResourceServersLimitType"
        ] = None,
        next_token: Optional[
            "capo_cognito_identity_provider.types.pagination_key_type.PaginationKeyType"
        ] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_resource_servers_request.ListResourceServersRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_resource_servers_response.ListResourceServersResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_resource_servers

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_resource_servers.async_list_resource_servers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cognito_identity_provider.types.resource_server_type.ResourceServerType]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_tags_for_resource

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_terms(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_terms_request.ListTermsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_terms_response.ListTermsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_terms

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_terms.async_list_terms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_user_import_jobs(
        self,
        user_pool_id: "capo_cognito_identity_provider.types.user_pool_id_type.UserPoolIdType",
        max_results: "capo_cognito_identity_provider.types.pool_query_limit_type.PoolQueryLimitType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        pagination_token: Optional[
            "capo_cognito_identity_provider.types.pagination_key_type.PaginationKeyType"
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_user_import_jobs_request.ListUserImportJobsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_user_import_jobs_response.ListUserImportJobsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_import_jobs

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_import_jobs.async_list_user_import_jobs(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_user_pool_clients(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_user_pool_clients_request.ListUserPoolClientsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_user_pool_clients_response.ListUserPoolClientsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_pool_clients

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_pool_clients.async_list_user_pool_clients(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cognito_identity_provider.types.user_pool_client_description.UserPoolClientDescription]":
        _token = next_token
        while True:
    ...
    async def list_user_pool_client_secrets(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.list_user_pool_client_secrets_response.ListUserPoolClientSecretsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_user_pool_client_secrets_request.ListUserPoolClientSecretsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_user_pool_client_secrets_response.ListUserPoolClientSecretsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_pool_client_secrets

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_pool_client_secrets.async_list_user_pool_client_secrets(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_user_pool_replicas(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.list_user_pool_replicas_response.ListUserPoolReplicasResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_user_pool_replicas_request.ListUserPoolReplicasRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_user_pool_replicas_response.ListUserPoolReplicasResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_pool_replicas

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_pool_replicas.async_list_user_pool_replicas(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_user_pools(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.list_user_pools_response.ListUserPoolsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_user_pools_request.ListUserPoolsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_user_pools_response.ListUserPoolsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_pools

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_user_pools.async_list_user_pools(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cognito_identity_provider.types.user_pool_description_type.UserPoolDescriptionType]":
        _token = next_token
        while True:
    ...
    async def list_users(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.list_users_response.ListUsersResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_users_request.ListUsersRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_users_response.ListUsersResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_users

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_users.async_list_users(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_cognito_identity_provider.types.user_type.UserType]":
    ...
    async def list_users_in_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_users_in_group_request.ListUsersInGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_users_in_group_response.ListUsersInGroupResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_users_in_group

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_users_in_group.async_list_users_in_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_web_authn_credentials(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.list_web_authn_credentials_response.ListWebAuthnCredentialsResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.list_web_authn_credentials_request.ListWebAuthnCredentialsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.list_web_authn_credentials_response.ListWebAuthnCredentialsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_web_authn_credentials

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.list_web_authn_credentials.async_list_web_authn_credentials(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def resend_confirmation_code(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.resend_confirmation_code_request.ResendConfirmationCodeRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.resend_confirmation_code_response.ResendConfirmationCodeResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.resend_confirmation_code

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.resend_confirmation_code.async_resend_confirmation_code(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def respond_to_auth_challenge(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.respond_to_auth_challenge_request.RespondToAuthChallengeRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.respond_to_auth_challenge_response.RespondToAuthChallengeResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.respond_to_auth_challenge

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.respond_to_auth_challenge.async_respond_to_auth_challenge(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def revoke_token(
        self,
        token: "capo_cognito_identity_provider.types.token_model_type.TokenModelType",
        client_id: "capo_cognito_identity_provider.types.client_id_type.ClientIdType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        client_secret: Optional[
        ...
        "capo_cognito_identity_provider.types.revoke_token_response.RevokeTokenResponse"
    ):
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.operation_not_enabled_exception.OperationNotEnabledException: <p>This exception is thrown when an operation is not available in the current region or for the current user pool configuration. This can occur when attempting to perform operations that are not supported in secondary replica regions.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.unauthorized_exception.UnauthorizedException: <p>Exception that is thrown when the request isn't authorized. This can happen due to an invalid access token in the request.</p>
            capo_cognito_identity_provider.errors.unsupported_operation_exception.UnsupportedOperationException: <p>Exception that is thrown when you attempt to perform an operation that isn't enabled for the user pool client.</p>
            capo_cognito_identity_provider.errors.unsupported_token_type_exception.UnsupportedTokenTypeException: <p>Exception that is thrown when an unsupported token is passed to an operation.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.revoke_token_request.RevokeTokenRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.revoke_token_response.RevokeTokenResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.revoke_token

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.revoke_token.async_revoke_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_log_delivery_configuration(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.set_log_delivery_configuration_request.SetLogDeliveryConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.set_log_delivery_configuration_response.SetLogDeliveryConfigurationResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_log_delivery_configuration

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_log_delivery_configuration.async_set_log_delivery_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_risk_configuration(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.set_risk_configuration_response.SetRiskConfigurationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.set_risk_configuration_request.SetRiskConfigurationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.set_risk_configuration_response.SetRiskConfigurationResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_risk_configuration

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_risk_configuration.async_set_risk_configuration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_ui_customization(
        ...
        *,
        ...
        css: Optional["capo_cognito_identity_provider.types.css_type.CSSType"] = None,
        image_file: Optional[
            "capo_cognito_identity_provider.types.image_file_type.ImageFileType"
        ] = None,
    ) -> "capo_cognito_identity_provider.types.set_ui_customization_response.SetUICustomizationResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.set_ui_customization_request.SetUICustomizationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.set_ui_customization_response.SetUICustomizationResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_ui_customization

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_ui_customization.async_set_ui_customization(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_user_mfa_preference(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.set_user_mfa_preference_response.SetUserMFAPreferenceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.set_user_mfa_preference_request.SetUserMFAPreferenceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.set_user_mfa_preference_response.SetUserMFAPreferenceResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_user_mfa_preference

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_user_mfa_preference.async_set_user_mfa_preference(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_user_pool_mfa_config(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.set_user_pool_mfa_config_request.SetUserPoolMfaConfigRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.set_user_pool_mfa_config_response.SetUserPoolMfaConfigResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_user_pool_mfa_config

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_user_pool_mfa_config.async_set_user_pool_mfa_config(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def set_user_settings(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.set_user_settings_request.SetUserSettingsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.set_user_settings_response.SetUserSettingsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_user_settings

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.set_user_settings.async_set_user_settings(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def sign_up(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.sign_up_request.SignUpRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.sign_up_response.SignUpResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.sign_up

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.sign_up.async_sign_up(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_user_import_job(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.start_user_import_job_request.StartUserImportJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.start_user_import_job_response.StartUserImportJobResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.start_user_import_job

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.start_user_import_job.async_start_user_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def start_web_authn_registration(
        ...
        *,
        ...
        Raises:
            ...
            capo_cognito_identity_provider.errors.password_reset_required_exception.PasswordResetRequiredException: <p>This exception is thrown when a password reset is required.</p>
            capo_cognito_identity_provider.errors.too_many_requests_exception.TooManyRequestsException: <p>This exception is thrown when the user has made too many requests for a given operation.</p>
            capo_cognito_identity_provider.errors.web_authn_configuration_missing_exception.WebAuthnConfigurationMissingException: <p>This exception is thrown when a user pool doesn't have a configured relying party id or a user pool domain.</p>
            capo_cognito_identity_provider.errors.web_authn_not_enabled_exception.WebAuthnNotEnabledException: <p>This exception is thrown when the passkey feature isn't enabled for the user pool.</p>
            capo_cognito_identity_provider.errors.UnknownServiceError: The service returned an error code this client does not model.
        """

        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.start_web_authn_registration_request.StartWebAuthnRegistrationRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.start_web_authn_registration_response.StartWebAuthnRegistrationResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.start_web_authn_registration

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.start_web_authn_registration.async_start_web_authn_registration(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def stop_user_import_job(
        ...
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.stop_user_import_job_response.StopUserImportJobResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.stop_user_import_job_request.StopUserImportJobRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.stop_user_import_job_response.StopUserImportJobResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.stop_user_import_job

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.stop_user_import_job.async_stop_user_import_job(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.tag_resource_request.TagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.tag_resource_response.TagResourceResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.tag_resource

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        self,
        resource_arn: "capo_cognito_identity_provider.types.arn_type.ArnType",
        tag_keys: "capo_cognito_identity_provider.types.user_pool_tags_list_type.UserPoolTagsListType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.untag_resource_response.UntagResourceResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.untag_resource_request.UntagResourceRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.untag_resource_response.UntagResourceResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.untag_resource

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_auth_event_feedback(
        ...
        username: "capo_cognito_identity_provider.types.username_type.UsernameType",
        event_id: "capo_cognito_identity_provider.types.event_id_type.EventIdType",
        feedback_token: "capo_cognito_identity_provider.types.token_model_type.TokenModelType",
        feedback_value: "capo_cognito_identity_provider.types.feedback_value_type.FeedbackValueType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
    ) -> "capo_cognito_identity_provider.types.update_auth_event_feedback_response.UpdateAuthEventFeedbackResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_auth_event_feedback_request.UpdateAuthEventFeedbackRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_auth_event_feedback_response.UpdateAuthEventFeedbackResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_auth_event_feedback

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_auth_event_feedback.async_update_auth_event_feedback(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_device_status(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.update_device_status_response.UpdateDeviceStatusResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_device_status_request.UpdateDeviceStatusRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_device_status_response.UpdateDeviceStatusResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_device_status

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_device_status.async_update_device_status(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_group(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_group_request.UpdateGroupRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_group_response.UpdateGroupResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_group

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_group.async_update_group(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_identity_provider(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.update_identity_provider_response.UpdateIdentityProviderResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_identity_provider_request.UpdateIdentityProviderRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_identity_provider_response.UpdateIdentityProviderResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_identity_provider

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_identity_provider.async_update_identity_provider(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_managed_login_branding(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_managed_login_branding_request.UpdateManagedLoginBrandingRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_managed_login_branding_response.UpdateManagedLoginBrandingResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_managed_login_branding

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_managed_login_branding.async_update_managed_login_branding(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_resource_server(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.update_resource_server_response.UpdateResourceServerResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_resource_server_request.UpdateResourceServerRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_resource_server_response.UpdateResourceServerResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_resource_server

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_resource_server.async_update_resource_server(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_terms(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_terms_request.UpdateTermsRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_terms_response.UpdateTermsResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_terms

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_terms.async_update_terms(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user_attributes(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.update_user_attributes_response.UpdateUserAttributesResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_user_attributes_request.UpdateUserAttributesRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_user_attributes_response.UpdateUserAttributesResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_attributes

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_attributes.async_update_user_attributes(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user_pool(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_user_pool_request.UpdateUserPoolRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_user_pool_response.UpdateUserPoolResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_pool

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_pool.async_update_user_pool(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user_pool_client(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.update_user_pool_client_response.UpdateUserPoolClientResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_user_pool_client_request.UpdateUserPoolClientRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_user_pool_client_response.UpdateUserPoolClientResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_pool_client

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_pool_client.async_update_user_pool_client(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user_pool_domain(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.update_user_pool_domain_response.UpdateUserPoolDomainResponse":
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_user_pool_domain_request.UpdateUserPoolDomainRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_user_pool_domain_response.UpdateUserPoolDomainResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_pool_domain

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_pool_domain.async_update_user_pool_domain(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_user_pool_replica(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.update_user_pool_replica_request.UpdateUserPoolReplicaRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.update_user_pool_replica_response.UpdateUserPoolReplicaResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_pool_replica

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.update_user_pool_replica.async_update_user_pool_replica(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def verify_software_token(
        ...
        *,
    ...
    ) -> "capo_cognito_identity_provider.types.verify_software_token_response.VerifySoftwareTokenResponse":
        ...
        Raises:
            capo_cognito_identity_provider.errors.code_mismatch_exception.CodeMismatchException: <p>This exception is thrown if the provided code doesn't match what the server was expecting.</p>
            capo_cognito_identity_provider.errors.enable_software_token_mfa_exception.EnableSoftwareTokenMFAException: <p>This exception is thrown when there is a code mismatch and the service fails to configure the software token TOTP multi-factor authentication (MFA).</p>
            capo_cognito_identity_provider.errors.forbidden_exception.ForbiddenException: <p>This exception is thrown when WAF doesn't allow your request based on a web ACL that's associated with your user pool.</p>
            capo_cognito_identity_provider.errors.internal_error_exception.InternalErrorException: <p>This exception is thrown when Amazon Cognito encounters an internal error.</p>
            capo_cognito_identity_provider.errors.invalid_parameter_exception.InvalidParameterException: <p>This exception is thrown when the Amazon Cognito service encounters an invalid parameter.</p>
            capo_cognito_identity_provider.errors.invalid_user_pool_configuration_exception.InvalidUserPoolConfigurationException: <p>This exception is thrown when the user pool configuration is not valid.</p>
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.verify_software_token_request.VerifySoftwareTokenRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.verify_software_token_response.VerifySoftwareTokenResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.verify_software_token

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.verify_software_token.async_verify_software_token(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def verify_user_attribute(
        ...
        access_token: "capo_cognito_identity_provider.types.token_model_type.TokenModelType",
        attribute_name: "capo_cognito_identity_provider.types.attribute_name_type.AttributeNameType",
        code: "capo_cognito_identity_provider.types.confirmation_code_type.ConfirmationCodeType",
        *,
        config_overrides: Optional[AsyncCognitoIdentityProviderClientConfig] = None,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_cognito_identity_provider.types.verify_user_attribute_request.VerifyUserAttributeRequest]",
        ) -> AsyncOperationResponse[
            "capo_cognito_identity_provider.types.verify_user_attribute_response.VerifyUserAttributeResponse"
        ]:
            import capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.verify_user_attribute

            (
                output,
                http_response,
            ) = await capo_cognito_identity_provider._operations.aws_cognito_identity_provider_service.verify_user_attribute.async_verify_user_attribute(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
