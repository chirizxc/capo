"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListUserPoolReplicas``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.list_user_pool_replicas_response.ListUserPoolReplicasResponse = capo_cognito_identity_provider.types.list_user_pool_replicas_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.ListUserPoolReplicas"
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_user_pool_replicas_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_user_pool_replicas(
