"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminSetUserMFAPreference``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.admin_set_user_mfa_preference_response.AdminSetUserMFAPreferenceResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_admin_set_user_mfa_preference(
