"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminListUserAuthEvents``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.admin_list_user_auth_events_response.AdminListUserAuthEventsResponse = capo_cognito_identity_provider.types.admin_list_user_auth_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_list_user_auth_events_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_admin_list_user_auth_events(
