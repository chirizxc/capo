...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.list_web_authn_credentials_response.ListWebAuthnCredentialsResponse = capo_cognito_identity_provider.types.list_web_authn_credentials_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_web_authn_credentials_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
