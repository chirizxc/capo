"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#UpdateDeviceStatus``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.update_device_status_response.UpdateDeviceStatusResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_device_status_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
