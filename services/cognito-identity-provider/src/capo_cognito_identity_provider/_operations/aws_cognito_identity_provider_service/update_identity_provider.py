...
import capo_cognito_identity_provider.errors.unsupported_identity_provider_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnsupportedIdentityProviderException":
            raise capo_cognito_identity_provider.errors.unsupported_identity_provider_exception.UnsupportedIdentityProviderException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.update_identity_provider_response.UpdateIdentityProviderResponse = capo_cognito_identity_provider.types.update_identity_provider_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_identity_provider_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
