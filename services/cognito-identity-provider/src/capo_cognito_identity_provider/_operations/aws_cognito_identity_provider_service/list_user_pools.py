"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListUserPools``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.list_user_pools_response.ListUserPoolsResponse = capo_cognito_identity_provider.types.list_user_pools_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_user_pools_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_user_pools(
