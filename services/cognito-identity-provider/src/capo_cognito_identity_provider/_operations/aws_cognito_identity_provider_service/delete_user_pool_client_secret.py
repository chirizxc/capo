"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteUserPoolClientSecret``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.delete_user_pool_client_secret_response.DeleteUserPoolClientSecretResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_user_pool_client_secret_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_user_pool_client_secret(
