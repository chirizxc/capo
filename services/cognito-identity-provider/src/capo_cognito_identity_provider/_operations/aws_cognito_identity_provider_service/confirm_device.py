...
import capo_cognito_identity_provider.errors.device_key_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeviceKeyExistsException":
            raise capo_cognito_identity_provider.errors.device_key_exists_exception.DeviceKeyExistsException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.confirm_device_response.ConfirmDeviceResponse = capo_cognito_identity_provider.types.confirm_device_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.confirm_device_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
