...
import capo_cognito_identity_provider.types.code_delivery_details_list_type
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.update_user_attributes_response.UpdateUserAttributesResponse = capo_cognito_identity_provider.types.update_user_attributes_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_user_attributes_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
