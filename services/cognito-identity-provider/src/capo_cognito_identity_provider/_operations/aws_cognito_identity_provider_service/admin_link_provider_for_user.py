"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminLinkProviderForUser``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.admin_link_provider_for_user_response.AdminLinkProviderForUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_link_provider_for_user_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_admin_link_provider_for_user(
