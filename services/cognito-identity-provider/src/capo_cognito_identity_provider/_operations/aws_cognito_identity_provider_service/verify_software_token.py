"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#VerifySoftwareToken``."""
...
import capo_cognito_identity_provider.errors.enable_software_token_mfa_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "EnableSoftwareTokenMFAException":
            raise capo_cognito_identity_provider.errors.enable_software_token_mfa_exception.EnableSoftwareTokenMFAException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.verify_software_token_response.VerifySoftwareTokenResponse = capo_cognito_identity_provider.types.verify_software_token_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.verify_software_token_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_verify_software_token(
