...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.update_resource_server_response.UpdateResourceServerResponse = capo_cognito_identity_provider.types.update_resource_server_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_resource_server_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
