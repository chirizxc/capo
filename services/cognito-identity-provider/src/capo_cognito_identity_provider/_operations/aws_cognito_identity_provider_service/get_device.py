"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetDevice``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.get_device_response.GetDeviceResponse = capo_cognito_identity_provider.types.get_device_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_device_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
