"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#InitiateAuth``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.initiate_auth_response.InitiateAuthResponse = capo_cognito_identity_provider.types.initiate_auth_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.initiate_auth_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
