"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#UpdateUserPoolClient``."""
...
import capo_cognito_identity_provider.errors.invalid_o_auth_flow_exception
...
import capo_cognito_identity_provider.errors.scope_does_not_exist_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidOAuthFlowException":
            raise capo_cognito_identity_provider.errors.invalid_o_auth_flow_exception.InvalidOAuthFlowException.from_aws_json_1_1(
                data, message
            )
        ...
        case "ScopeDoesNotExistException":
            raise capo_cognito_identity_provider.errors.scope_does_not_exist_exception.ScopeDoesNotExistException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.update_user_pool_client_response.UpdateUserPoolClientResponse = capo_cognito_identity_provider.types.update_user_pool_client_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.update_user_pool_client_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_user_pool_client(
