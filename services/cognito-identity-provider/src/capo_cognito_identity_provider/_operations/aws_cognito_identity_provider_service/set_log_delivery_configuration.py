"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#SetLogDeliveryConfiguration``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.set_log_delivery_configuration_response.SetLogDeliveryConfigurationResponse = capo_cognito_identity_provider.types.set_log_delivery_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.set_log_delivery_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_set_log_delivery_configuration(
