"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetUICustomization``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.get_ui_customization_response.GetUICustomizationResponse = capo_cognito_identity_provider.types.get_ui_customization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_ui_customization_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_ui_customization(
