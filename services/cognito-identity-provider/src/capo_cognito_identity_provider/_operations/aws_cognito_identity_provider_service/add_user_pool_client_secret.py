...
import capo_cognito_identity_provider.errors.access_denied_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "AccessDeniedException":
            raise capo_cognito_identity_provider.errors.access_denied_exception.AccessDeniedException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.add_user_pool_client_secret_response.AddUserPoolClientSecretResponse = capo_cognito_identity_provider.types.add_user_pool_client_secret_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.add_user_pool_client_secret_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
