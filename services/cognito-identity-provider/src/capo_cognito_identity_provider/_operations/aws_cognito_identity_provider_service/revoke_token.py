...
import capo_cognito_identity_provider.errors.unauthorized_exception
import capo_cognito_identity_provider.errors.unsupported_operation_exception
import capo_cognito_identity_provider.errors.unsupported_token_type_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnauthorizedException":
            raise capo_cognito_identity_provider.errors.unauthorized_exception.UnauthorizedException.from_aws_json_1_1(
                data, message
            )
        ...
        case "UnsupportedTokenTypeException":
            raise capo_cognito_identity_provider.errors.unsupported_token_type_exception.UnsupportedTokenTypeException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.revoke_token_response.RevokeTokenResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.revoke_token_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
