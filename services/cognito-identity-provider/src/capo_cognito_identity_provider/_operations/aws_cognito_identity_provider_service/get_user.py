"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#GetUser``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.get_user_response.GetUserResponse = (
        capo_cognito_identity_provider.types.get_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.get_user_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
