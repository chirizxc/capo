"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#SetUICustomization``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.set_ui_customization_response.SetUICustomizationResponse = capo_cognito_identity_provider.types.set_ui_customization_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.set_ui_customization_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_set_ui_customization(
