"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListDevices``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.list_devices_response.ListDevicesResponse = capo_cognito_identity_provider.types.list_devices_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_devices_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
