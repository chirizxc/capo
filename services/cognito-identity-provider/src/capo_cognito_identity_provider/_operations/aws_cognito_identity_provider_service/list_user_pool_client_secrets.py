"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#ListUserPoolClientSecrets``."""
...
import capo_cognito_identity_provider.errors.internal_server_exception
...
import capo_cognito_identity_provider.types.client_secret_descriptor_list_type
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "InternalServerException":
            raise capo_cognito_identity_provider.errors.internal_server_exception.InternalServerException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.list_user_pool_client_secrets_response.ListUserPoolClientSecretsResponse = capo_cognito_identity_provider.types.list_user_pool_client_secrets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.list_user_pool_client_secrets_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_user_pool_client_secrets(
