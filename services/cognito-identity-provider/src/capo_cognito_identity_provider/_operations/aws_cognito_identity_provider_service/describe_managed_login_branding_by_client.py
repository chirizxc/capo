"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeManagedLoginBrandingByClient``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.describe_managed_login_branding_by_client_response.DescribeManagedLoginBrandingByClientResponse = capo_cognito_identity_provider.types.describe_managed_login_branding_by_client_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.describe_managed_login_branding_by_client_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_managed_login_branding_by_client(
