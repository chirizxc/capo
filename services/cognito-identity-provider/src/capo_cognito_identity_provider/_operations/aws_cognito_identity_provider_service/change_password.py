...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.change_password_response.ChangePasswordResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.change_password_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
