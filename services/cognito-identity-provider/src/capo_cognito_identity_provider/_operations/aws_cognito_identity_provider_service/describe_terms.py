"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DescribeTerms``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.describe_terms_response.DescribeTermsResponse = capo_cognito_identity_provider.types.describe_terms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.DescribeTerms"
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.describe_terms_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_terms(
