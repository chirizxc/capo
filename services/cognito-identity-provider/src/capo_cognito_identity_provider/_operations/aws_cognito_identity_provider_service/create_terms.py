"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateTerms``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.create_terms_response.CreateTermsResponse = capo_cognito_identity_provider.types.create_terms_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSCognitoIdentityProviderService.CreateTerms"
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.create_terms_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
