...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.set_user_mfa_preference_response.SetUserMFAPreferenceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.set_user_mfa_preference_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
