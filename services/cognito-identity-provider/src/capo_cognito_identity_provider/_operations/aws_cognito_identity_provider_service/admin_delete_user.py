"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminDeleteUser``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_delete_user_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_admin_delete_user(
