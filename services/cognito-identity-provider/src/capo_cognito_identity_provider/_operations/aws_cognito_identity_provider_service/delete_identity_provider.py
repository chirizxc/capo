"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#DeleteIdentityProvider``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.delete_identity_provider_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
