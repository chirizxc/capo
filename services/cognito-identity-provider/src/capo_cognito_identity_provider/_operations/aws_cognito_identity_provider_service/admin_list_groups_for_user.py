"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#AdminListGroupsForUser``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.admin_list_groups_for_user_response.AdminListGroupsForUserResponse = capo_cognito_identity_provider.types.admin_list_groups_for_user_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.admin_list_groups_for_user_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_admin_list_groups_for_user(
