"""Generated from Smithy shape ``com.amazonaws.cognitoidentityprovider#CreateUserImportJob``."""
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.create_user_import_job_response.CreateUserImportJobResponse = capo_cognito_identity_provider.types.create_user_import_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.create_user_import_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_user_import_job(
