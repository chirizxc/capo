...
import capo_cognito_identity_provider.errors.web_authn_challenge_not_found_exception
import capo_cognito_identity_provider.errors.web_authn_client_mismatch_exception
import capo_cognito_identity_provider.errors.web_authn_credential_not_supported_exception
import capo_cognito_identity_provider.errors.web_authn_not_enabled_exception
import capo_cognito_identity_provider.errors.web_authn_origin_not_allowed_exception
import capo_cognito_identity_provider.errors.web_authn_relying_party_mismatch_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "WebAuthnChallengeNotFoundException":
            raise capo_cognito_identity_provider.errors.web_authn_challenge_not_found_exception.WebAuthnChallengeNotFoundException.from_aws_json_1_1(
                data, message
            )
        case "WebAuthnClientMismatchException":
            raise capo_cognito_identity_provider.errors.web_authn_client_mismatch_exception.WebAuthnClientMismatchException.from_aws_json_1_1(
                data, message
            )
        case "WebAuthnCredentialNotSupportedException":
            raise capo_cognito_identity_provider.errors.web_authn_credential_not_supported_exception.WebAuthnCredentialNotSupportedException.from_aws_json_1_1(
                data, message
            )
        ...
        case "WebAuthnOriginNotAllowedException":
            raise capo_cognito_identity_provider.errors.web_authn_origin_not_allowed_exception.WebAuthnOriginNotAllowedException.from_aws_json_1_1(
                data, message
            )
        case "WebAuthnRelyingPartyMismatchException":
            raise capo_cognito_identity_provider.errors.web_authn_relying_party_mismatch_exception.WebAuthnRelyingPartyMismatchException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_cognito_identity_provider.types.complete_web_authn_registration_response.CompleteWebAuthnRegistrationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cognito_identity_provider.types.complete_web_authn_registration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
