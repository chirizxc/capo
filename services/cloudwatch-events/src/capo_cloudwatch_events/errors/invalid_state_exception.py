"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#InvalidStateException``."""
...
class InvalidStateException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchevents#InvalidStateException``."""
