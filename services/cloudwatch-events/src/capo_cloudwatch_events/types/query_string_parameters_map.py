...
if TYPE_CHECKING:
    ...
    import capo_cloudwatch_events.types.query_string_value

QueryStringParametersMap: TypeAlias = dict[
    "capo_cloudwatch_events.types.query_string_key.QueryStringKey",
    "capo_cloudwatch_events.types.query_string_value.QueryStringValue",
]
