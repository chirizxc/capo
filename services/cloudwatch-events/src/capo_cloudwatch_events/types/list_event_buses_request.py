"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListEventBusesRequest``."""
...
class ListEventBusesRequest(TypedDict, closed=True):
    name_prefix: NotRequired["capo_cloudwatch_events.types.event_bus_name.EventBusName"]
