...
if TYPE_CHECKING:
    import capo_cloudwatch_events.types.maximum_event_age_in_seconds
    import capo_cloudwatch_events.types.maximum_retry_attempts


class RetryPolicy(TypedDict, closed=True):
    maximum_retry_attempts: NotRequired[
        "capo_cloudwatch_events.types.maximum_retry_attempts.MaximumRetryAttempts"
    ]
    ...
    maximum_event_age_in_seconds: NotRequired[
        "capo_cloudwatch_events.types.maximum_event_age_in_seconds.MaximumEventAgeInSeconds"
    ]
