...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.list_rules_response.ListRulesResponse = (
        capo_cloudwatch_events.types.list_rules_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.list_rules_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_rules(
    ...
    capo_cloudwatch_events.types.list_rules_response.ListRulesResponse, zapros.Response
]:
