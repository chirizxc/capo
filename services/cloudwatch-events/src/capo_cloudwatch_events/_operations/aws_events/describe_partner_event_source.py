"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#DescribePartnerEventSource``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.describe_partner_event_source_response.DescribePartnerEventSourceResponse = capo_cloudwatch_events.types.describe_partner_event_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.describe_partner_event_source_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
