"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#TestEventPattern``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.test_event_pattern_response.TestEventPatternResponse = capo_cloudwatch_events.types.test_event_pattern_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.test_event_pattern_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
