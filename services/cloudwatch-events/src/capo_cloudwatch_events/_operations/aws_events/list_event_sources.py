"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListEventSources``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.list_event_sources_response.ListEventSourcesResponse = capo_cloudwatch_events.types.list_event_sources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.list_event_sources_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
