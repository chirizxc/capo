"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#PutPartnerEvents``."""
...
import capo_cloudwatch_events.types.put_partner_events_result_entry_list
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.put_partner_events_response.PutPartnerEventsResponse = capo_cloudwatch_events.types.put_partner_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.put_partner_events_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
