"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListRuleNamesByTarget``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.list_rule_names_by_target_response.ListRuleNamesByTargetResponse = capo_cloudwatch_events.types.list_rule_names_by_target_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.list_rule_names_by_target_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
