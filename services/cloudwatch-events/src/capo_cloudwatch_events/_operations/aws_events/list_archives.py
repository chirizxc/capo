"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListArchives``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.list_archives_response.ListArchivesResponse = (
        capo_cloudwatch_events.types.list_archives_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSEvents.ListArchives"
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.list_archives_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
