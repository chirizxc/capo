"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListPartnerEventSourceAccounts``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.list_partner_event_source_accounts_response.ListPartnerEventSourceAccountsResponse = capo_cloudwatch_events.types.list_partner_event_source_accounts_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.list_partner_event_source_accounts_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
