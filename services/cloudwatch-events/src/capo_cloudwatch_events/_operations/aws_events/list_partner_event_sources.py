"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#ListPartnerEventSources``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.list_partner_event_sources_response.ListPartnerEventSourcesResponse = capo_cloudwatch_events.types.list_partner_event_sources_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.list_partner_event_sources_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
