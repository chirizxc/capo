...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.put_rule_response.PutRuleResponse = (
        capo_cloudwatch_events.types.put_rule_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.put_rule_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_rule(
    ...
    capo_cloudwatch_events.types.put_rule_response.PutRuleResponse, zapros.Response
]:
