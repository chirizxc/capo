"""Generated from Smithy shape ``com.amazonaws.cloudwatchevents#DescribeEventSource``."""
...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.describe_event_source_response.DescribeEventSourceResponse = capo_cloudwatch_events.types.describe_event_source_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.describe_event_source_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
