...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.delete_api_destination_response.DeleteApiDestinationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.delete_api_destination_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
