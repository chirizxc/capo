...
def handle_response(
    ...
    out: capo_cloudwatch_events.types.put_events_response.PutEventsResponse = (
        capo_cloudwatch_events.types.put_events_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudwatch_events.types.put_events_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_events(
    ...
    capo_cloudwatch_events.types.put_events_response.PutEventsResponse, zapros.Response
]:
