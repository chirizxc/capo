...
```
pip install capo-cloudwatch-events
```

## Usage

```python
from capo_cloudwatch_events import AsyncCloudWatchEventsClient
...
```python
from capo_cloudwatch_events import AsyncCloudWatchEventsClient
from capo_cloudwatch_events.error import ConcurrentModificationException
