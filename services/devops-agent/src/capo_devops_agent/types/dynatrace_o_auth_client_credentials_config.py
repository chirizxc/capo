"""Generated from Smithy shape ``com.amazonaws.devopsagent#DynatraceOAuthClientCredentialsConfig``."""
...
class DynatraceOAuthClientCredentialsConfig(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: DynatraceOAuthClientCredentialsConfig) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> DynatraceOAuthClientCredentialsConfig:
    out: DynatraceOAuthClientCredentialsConfig = {}  # type: ignore[typeddict-item]
    ...
    if data.get("clientId") is not None:
        ...
        raise DeserializationError(
            "DynatraceOAuthClientCredentialsConfig.client_id required"
        )
    ...
    if data.get("clientSecret") is not None:
        ...
        raise DeserializationError(
            "DynatraceOAuthClientCredentialsConfig.client_secret required"
        )
    return out
