...
def handle_response(
    ...
    out: capo_devops_agent.types.list_backlog_tasks_response.ListBacklogTasksResponse = capo_devops_agent.types.list_backlog_tasks_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.list_backlog_tasks_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
