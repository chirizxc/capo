...
def handle_response(
    ...
    out: capo_devops_agent.types.update_association_output.UpdateAssociationOutput = (
        capo_devops_agent.types.update_association_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.update_association_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
