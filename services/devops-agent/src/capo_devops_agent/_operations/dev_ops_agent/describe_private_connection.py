"""Generated from Smithy shape ``com.amazonaws.devopsagent#DescribePrivateConnection``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.describe_private_connection_output.DescribePrivateConnectionOutput = capo_devops_agent.types.describe_private_connection_output.deserialize_json(
...
async def async_describe_private_connection(
