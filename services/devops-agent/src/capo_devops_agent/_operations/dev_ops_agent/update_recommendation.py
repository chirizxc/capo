"""Generated from Smithy shape ``com.amazonaws.devopsagent#UpdateRecommendation``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.update_recommendation_response.UpdateRecommendationResponse = capo_devops_agent.types.update_recommendation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.update_recommendation_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_recommendation(
