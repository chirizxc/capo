"""Generated from Smithy shape ``com.amazonaws.devopsagent#CreatePrivateConnection``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.create_private_connection_output.CreatePrivateConnectionOutput = capo_devops_agent.types.create_private_connection_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.create_private_connection_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_private_connection(
