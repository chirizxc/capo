...
def handle_response(
    ...
    out: capo_devops_agent.types.list_pending_messages_response.ListPendingMessagesResponse = capo_devops_agent.types.list_pending_messages_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.list_pending_messages_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
