...
def handle_response(
    ...
    out: capo_devops_agent.types.create_agent_space_output.CreateAgentSpaceOutput = (
        capo_devops_agent.types.create_agent_space_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.create_agent_space_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
