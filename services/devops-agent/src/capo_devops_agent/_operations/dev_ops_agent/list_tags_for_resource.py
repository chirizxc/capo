...
def handle_response(
    ...
    out: capo_devops_agent.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_devops_agent.types.list_tags_for_resource_response.deserialize_json(
