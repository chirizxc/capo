"""Generated from Smithy shape ``com.amazonaws.devopsagent#UntagResource``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
