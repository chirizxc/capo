...
def handle_response(
    ...
    out: capo_devops_agent.types.create_backlog_task_response.CreateBacklogTaskResponse = capo_devops_agent.types.create_backlog_task_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.create_backlog_task_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
