"""Generated from Smithy shape ``com.amazonaws.devopsagent#UpdateAssetFile``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.update_asset_file_response.UpdateAssetFileResponse = (
        capo_devops_agent.types.update_asset_file_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.update_asset_file_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_asset_file(
