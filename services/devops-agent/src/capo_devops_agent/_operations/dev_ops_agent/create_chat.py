...
def handle_response(
    ...
    out: capo_devops_agent.types.create_chat_response.CreateChatResponse = (
        capo_devops_agent.types.create_chat_response.deserialize_json(
...
def build_request(
    ...
    if "user_type" in input_:
        params.append(
            (
                "userType",
                capo_devops_agent.types.user_type.serialize_json(input_["user_type"]),
            )
        )
...
def create_chat(
    ...
    capo_devops_agent.types.create_chat_response.CreateChatResponse, zapros.Response
]:
