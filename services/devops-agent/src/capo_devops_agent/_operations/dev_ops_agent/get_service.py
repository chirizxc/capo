"""Generated from Smithy shape ``com.amazonaws.devopsagent#GetService``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.get_service_output.GetServiceOutput = (
        capo_devops_agent.types.get_service_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{serviceId}", quote(input_["service_id"], safe=""))
...
def get_service(
    ...
    capo_devops_agent.types.get_service_output.GetServiceOutput, zapros.Response
]:
