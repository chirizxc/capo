...
def handle_response(
    ...
    out: capo_devops_agent.types.update_operator_app_idp_config_output.UpdateOperatorAppIdpConfigOutput = capo_devops_agent.types.update_operator_app_idp_config_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.update_operator_app_idp_config_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
