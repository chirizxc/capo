"""Generated from Smithy shape ``com.amazonaws.devopsagent#CreateAsset``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.create_asset_response.CreateAssetResponse = (
        capo_devops_agent.types.create_asset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.create_asset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_asset(
    ...
    capo_devops_agent.types.create_asset_response.CreateAssetResponse, zapros.Response
]:
