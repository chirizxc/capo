"""Generated from Smithy shape ``com.amazonaws.devopsagent#DisableOperatorApp``."""
...
def build_request(
    ...
    if "auth_flow" in input_:
        headers["x-amzn-app-auth-flow"] = (
            capo_devops_agent.types.auth_flow.serialize_json(input_["auth_flow"])
        )
    body: bytes | None = b""
...
async def async_disable_operator_app(
