...
def handle_response(
    ...
    out: capo_devops_agent.types.get_asset_response.GetAssetResponse = (
        capo_devops_agent.types.get_asset_response.deserialize_json(
...
def get_asset(
    ...
    capo_devops_agent.types.get_asset_response.GetAssetResponse, zapros.Response
]:
