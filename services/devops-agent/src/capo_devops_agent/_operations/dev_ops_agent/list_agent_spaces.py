"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListAgentSpaces``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.list_agent_spaces_output.ListAgentSpacesOutput = (
        capo_devops_agent.types.list_agent_spaces_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/agentspaces/list"
