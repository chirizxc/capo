...
def handle_response(
    ...
    out: capo_devops_agent.types.get_agent_space_output.GetAgentSpaceOutput = (
        capo_devops_agent.types.get_agent_space_output.deserialize_json(
...
def get_agent_space(
    ...
    capo_devops_agent.types.get_agent_space_output.GetAgentSpaceOutput, zapros.Response
]:
