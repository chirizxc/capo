...
def handle_response(
    ...
    out: capo_devops_agent.types.delete_private_connection_output.DeletePrivateConnectionOutput = capo_devops_agent.types.delete_private_connection_output.deserialize_json(
