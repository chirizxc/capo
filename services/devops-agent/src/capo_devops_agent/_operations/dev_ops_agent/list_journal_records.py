...
def handle_response(
    ...
    out: capo_devops_agent.types.list_journal_records_response.ListJournalRecordsResponse = capo_devops_agent.types.list_journal_records_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.list_journal_records_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
