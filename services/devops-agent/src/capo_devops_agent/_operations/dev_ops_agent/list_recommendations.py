"""Generated from Smithy shape ``com.amazonaws.devopsagent#ListRecommendations``."""
...
def handle_response(
    ...
    out: capo_devops_agent.types.list_recommendations_response.ListRecommendationsResponse = capo_devops_agent.types.list_recommendations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_devops_agent.types.list_recommendations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
