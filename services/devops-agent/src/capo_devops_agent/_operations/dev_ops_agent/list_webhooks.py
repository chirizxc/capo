...
def handle_response(
    ...
    out: capo_devops_agent.types.list_webhooks_output.ListWebhooksOutput = (
        capo_devops_agent.types.list_webhooks_output.deserialize_json(
...
def list_webhooks(
    ...
    capo_devops_agent.types.list_webhooks_output.ListWebhooksOutput, zapros.Response
]:
