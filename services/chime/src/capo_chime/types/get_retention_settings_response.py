"""Generated from Smithy shape ``com.amazonaws.chime#GetRetentionSettingsResponse``."""
...
class GetRetentionSettingsResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetRetentionSettingsResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> GetRetentionSettingsResponse:
    out: GetRetentionSettingsResponse = {}  # type: ignore[typeddict-item]
