...
class PhoneNumberCapabilities(TypedDict, closed=True):
    inbound_call: NotRequired["capo_chime.types.nullable_boolean.NullableBoolean"]
    """<p>Allows or denies inbound calling for the specified phone number.</p>"""
    outbound_call: NotRequired["capo_chime.types.nullable_boolean.NullableBoolean"]
    """<p>Allows or denies outbound calling for the specified phone number.</p>"""
    inbound_sms: NotRequired["capo_chime.types.nullable_boolean.NullableBoolean"]
    """<p>Allows or denies inbound SMS messaging for the specified phone number.</p>"""
    outbound_sms: NotRequired["capo_chime.types.nullable_boolean.NullableBoolean"]
    """<p>Allows or denies outbound SMS messaging for the specified phone number.</p>"""
    inbound_mms: NotRequired["capo_chime.types.nullable_boolean.NullableBoolean"]
    """<p>Allows or denies inbound MMS messaging for the specified phone number.</p>"""
    outbound_mms: NotRequired["capo_chime.types.nullable_boolean.NullableBoolean"]
