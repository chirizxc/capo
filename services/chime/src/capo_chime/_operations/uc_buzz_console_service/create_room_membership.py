"""Generated from Smithy shape ``com.amazonaws.chime#CreateRoomMembership``."""
...
def handle_response(
    ...
    out: capo_chime.types.create_room_membership_response.CreateRoomMembershipResponse = capo_chime.types.create_room_membership_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.create_room_membership_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_room_membership(
