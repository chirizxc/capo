...
def handle_response(
    ...
    out: capo_chime.types.regenerate_security_token_response.RegenerateSecurityTokenResponse = capo_chime.types.regenerate_security_token_response.deserialize_json(
