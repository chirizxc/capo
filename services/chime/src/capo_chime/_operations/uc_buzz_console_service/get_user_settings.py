"""Generated from Smithy shape ``com.amazonaws.chime#GetUserSettings``."""
...
def handle_response(
    ...
    out: capo_chime.types.get_user_settings_response.GetUserSettingsResponse = (
        capo_chime.types.get_user_settings_response.deserialize_json(
...
def get_user_settings(
    ...
    capo_chime.types.get_user_settings_response.GetUserSettingsResponse, zapros.Response
]:
