"""Generated from Smithy shape ``com.amazonaws.chime#ListSupportedPhoneNumberCountries``."""
...
import capo_chime.types.phone_number_countries_list
...
def handle_response(
    ...
    out: capo_chime.types.list_supported_phone_number_countries_response.ListSupportedPhoneNumberCountriesResponse = capo_chime.types.list_supported_phone_number_countries_response.deserialize_json(
...
def build_request(
    ...
    if "product_type" in input_:
        params.append(
            (
                "product-type",
                capo_chime.types.phone_number_product_type.serialize_json(
                    input_["product_type"]
                ),
            )
        )
