...
def handle_response(
    ...
    out: capo_chime.types.create_room_response.CreateRoomResponse = (
        capo_chime.types.create_room_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.create_room_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_room(
    ...
    input_: capo_chime.types.create_room_request.CreateRoomRequest,
) -> tuple[capo_chime.types.create_room_response.CreateRoomResponse, zapros.Response]:
