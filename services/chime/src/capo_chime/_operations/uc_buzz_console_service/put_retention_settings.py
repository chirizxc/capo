...
def handle_response(
    ...
    out: capo_chime.types.put_retention_settings_response.PutRetentionSettingsResponse = capo_chime.types.put_retention_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.put_retention_settings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
