"""Generated from Smithy shape ``com.amazonaws.chime#GetPhoneNumberSettings``."""
...
def handle_response(
    ...
    out: capo_chime.types.get_phone_number_settings_response.GetPhoneNumberSettingsResponse = capo_chime.types.get_phone_number_settings_response.deserialize_json(
