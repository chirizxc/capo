"""Generated from Smithy shape ``com.amazonaws.chime#UpdateUser``."""
...
def handle_response(
    ...
    out: capo_chime.types.update_user_response.UpdateUserResponse = (
        capo_chime.types.update_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.update_user_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_user(
    ...
    input_: capo_chime.types.update_user_request.UpdateUserRequest,
) -> tuple[capo_chime.types.update_user_response.UpdateUserResponse, zapros.Response]:
