"""Generated from Smithy shape ``com.amazonaws.chime#CreateAccount``."""
...
def handle_response(
    ...
    out: capo_chime.types.create_account_response.CreateAccountResponse = (
        capo_chime.types.create_account_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.create_account_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_account(
    ...
    capo_chime.types.create_account_response.CreateAccountResponse, zapros.Response
]:
