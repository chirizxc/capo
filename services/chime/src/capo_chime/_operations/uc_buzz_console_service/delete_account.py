"""Generated from Smithy shape ``com.amazonaws.chime#DeleteAccount``."""
...
import capo_chime.errors.unprocessable_entity_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnprocessableEntityException":
            raise capo_chime.errors.unprocessable_entity_exception.UnprocessableEntityException.from_json(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_chime.types.delete_account_response.DeleteAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_account(
    ...
    capo_chime.types.delete_account_response.DeleteAccountResponse, zapros.Response
]:
