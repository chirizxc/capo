"""Generated from Smithy shape ``com.amazonaws.chime#RedactRoomMessage``."""
...
def handle_response(
    ...
    out: capo_chime.types.redact_room_message_response.RedactRoomMessageResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_redact_room_message(
