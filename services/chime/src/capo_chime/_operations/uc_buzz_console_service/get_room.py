"""Generated from Smithy shape ``com.amazonaws.chime#GetRoom``."""
...
def handle_response(
    ...
    out: capo_chime.types.get_room_response.GetRoomResponse = (
        capo_chime.types.get_room_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_chime.types.get_room_response.GetRoomResponse = (
        capo_chime.types.get_room_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{RoomId}", quote(input_["room_id"], safe=""))
...
def get_room(
    options: OperationOptions, input_: capo_chime.types.get_room_request.GetRoomRequest
) -> tuple[capo_chime.types.get_room_response.GetRoomResponse, zapros.Response]:
