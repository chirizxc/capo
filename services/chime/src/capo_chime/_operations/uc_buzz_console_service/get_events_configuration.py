...
def handle_response(
    ...
    out: capo_chime.types.get_events_configuration_response.GetEventsConfigurationResponse = capo_chime.types.get_events_configuration_response.deserialize_json(
