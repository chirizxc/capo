...
def handle_response(
    ...
    out: capo_chime.types.disassociate_signin_delegate_groups_from_account_response.DisassociateSigninDelegateGroupsFromAccountResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.disassociate_signin_delegate_groups_from_account_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
