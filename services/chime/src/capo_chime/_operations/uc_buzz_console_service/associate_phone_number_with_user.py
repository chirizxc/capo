...
def handle_response(
    ...
    out: capo_chime.types.associate_phone_number_with_user_response.AssociatePhoneNumberWithUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.associate_phone_number_with_user_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
