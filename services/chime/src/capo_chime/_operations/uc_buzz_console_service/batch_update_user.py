...
def handle_response(
    ...
    out: capo_chime.types.batch_update_user_response.BatchUpdateUserResponse = (
        capo_chime.types.batch_update_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.batch_update_user_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def batch_update_user(
    ...
    capo_chime.types.batch_update_user_response.BatchUpdateUserResponse, zapros.Response
]:
