"""Generated from Smithy shape ``com.amazonaws.chime#GetGlobalSettings``."""
...
def handle_response(
    ...
    out: capo_chime.types.get_global_settings_response.GetGlobalSettingsResponse = (
        capo_chime.types.get_global_settings_response.deserialize_json(
