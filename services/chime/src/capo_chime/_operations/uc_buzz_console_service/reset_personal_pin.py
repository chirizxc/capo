"""Generated from Smithy shape ``com.amazonaws.chime#ResetPersonalPIN``."""
...
def handle_response(
    ...
    out: capo_chime.types.reset_personal_pin_response.ResetPersonalPINResponse = (
        capo_chime.types.reset_personal_pin_response.deserialize_json(
...
async def async_reset_personal_pin(
