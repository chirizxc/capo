...
def handle_response(
    ...
    out: capo_chime.types.get_user_response.GetUserResponse = (
        capo_chime.types.get_user_response.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_chime.types.get_user_response.GetUserResponse = (
        capo_chime.types.get_user_response.deserialize_json(
...
def get_user(
    options: OperationOptions, input_: capo_chime.types.get_user_request.GetUserRequest
) -> tuple[capo_chime.types.get_user_response.GetUserResponse, zapros.Response]:
