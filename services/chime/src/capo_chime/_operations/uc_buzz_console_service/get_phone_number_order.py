"""Generated from Smithy shape ``com.amazonaws.chime#GetPhoneNumberOrder``."""
...
def handle_response(
    ...
    out: capo_chime.types.get_phone_number_order_response.GetPhoneNumberOrderResponse = capo_chime.types.get_phone_number_order_response.deserialize_json(
