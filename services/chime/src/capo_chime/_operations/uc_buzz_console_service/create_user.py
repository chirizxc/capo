...
def handle_response(
    ...
    out: capo_chime.types.create_user_response.CreateUserResponse = (
        capo_chime.types.create_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_chime.types.create_user_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_user(
    ...
    input_: capo_chime.types.create_user_request.CreateUserRequest,
) -> tuple[capo_chime.types.create_user_response.CreateUserResponse, zapros.Response]:
