...
def handle_response(
    ...
    out: capo_chime.types.get_phone_number_response.GetPhoneNumberResponse = (
        capo_chime.types.get_phone_number_response.deserialize_json(
...
def get_phone_number(
    ...
    capo_chime.types.get_phone_number_response.GetPhoneNumberResponse, zapros.Response
]:
