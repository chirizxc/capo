...
class AssociatedClientDevice(TypedDict, closed=True):
    ...
    association_timestamp: NotRequired["capo_greengrassv2.types.timestamp.Timestamp"]
...
def serialize_json(value: AssociatedClientDevice) -> dict:
    ...
    if "association_timestamp" in value:
        ...
        out["associationTimestamp"] = capo_greengrassv2.types.timestamp.serialize_json(
