...
if TYPE_CHECKING:
    import capo_greengrassv2.types.installed_component_lifecycle_status_code

InstalledComponentLifecycleStatusCodeList: TypeAlias = list[
    "capo_greengrassv2.types.installed_component_lifecycle_status_code.InstalledComponentLifecycleStatusCode"
]
