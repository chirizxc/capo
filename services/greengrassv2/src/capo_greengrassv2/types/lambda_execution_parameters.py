...
class LambdaExecutionParameters(TypedDict, closed=True):
    event_sources: NotRequired[
        "capo_greengrassv2.types.lambda_event_source_list.LambdaEventSourceList"
    ]
    ...
    pinned: NotRequired["capo_greengrassv2.types.optional_boolean.OptionalBoolean"]
    ...
    input_payload_encoding_type: NotRequired[
        "capo_greengrassv2.types.lambda_input_payload_encoding_type.LambdaInputPayloadEncodingType"
    ]
    """<p>The encoding type that the Lambda function supports.</p> <p>Default: <code>json</code> </p>"""
    exec_args: NotRequired[
        "capo_greengrassv2.types.lambda_exec_args_list.LambdaExecArgsList"
    ]
    """<p>The list of arguments to pass to the Lambda function when it runs.</p>"""
    environment_variables: NotRequired[
        "capo_greengrassv2.types.lambda_environment_variables.LambdaEnvironmentVariables"
    ]
    ...
    linux_process_params: NotRequired[
        "capo_greengrassv2.types.lambda_linux_process_params.LambdaLinuxProcessParams"
    ]
...
def serialize_json(value: LambdaExecutionParameters) -> dict:
    ...
    if "event_sources" in value:
        ...
        out["eventSources"] = (
            capo_greengrassv2.types.lambda_event_source_list.serialize_json(
                value["event_sources"]
            )
        )
    ...
    if "input_payload_encoding_type" in value:
        ...
        out["inputPayloadEncodingType"] = (
            capo_greengrassv2.types.lambda_input_payload_encoding_type.serialize_json(
    ...
    if "exec_args" in value:
        ...
        out["execArgs"] = capo_greengrassv2.types.lambda_exec_args_list.serialize_json(
            value["exec_args"]
        )
    if "environment_variables" in value:
        ...
        out["environmentVariables"] = (
            capo_greengrassv2.types.lambda_environment_variables.serialize_json(
    ...
    if "linux_process_params" in value:
        ...
        out["linuxProcessParams"] = (
            capo_greengrassv2.types.lambda_linux_process_params.serialize_json(
...
def deserialize_json(data: dict) -> LambdaExecutionParameters:
    ...
    if data.get("eventSources") is not None:
        ...
        out["event_sources"] = (
            capo_greengrassv2.types.lambda_event_source_list.deserialize_json(
                data["eventSources"]
            )
        )
    ...
    if data.get("inputPayloadEncodingType") is not None:
        ...
        out["input_payload_encoding_type"] = (
            capo_greengrassv2.types.lambda_input_payload_encoding_type.deserialize_json(
    ...
    if data.get("execArgs") is not None:
        ...
        out["exec_args"] = (
            capo_greengrassv2.types.lambda_exec_args_list.deserialize_json(
                data["execArgs"]
            )
        )
    if data.get("environmentVariables") is not None:
        ...
        out["environment_variables"] = (
            capo_greengrassv2.types.lambda_environment_variables.deserialize_json(
    ...
    if data.get("linuxProcessParams") is not None:
        ...
        out["linux_process_params"] = (
            capo_greengrassv2.types.lambda_linux_process_params.deserialize_json(
