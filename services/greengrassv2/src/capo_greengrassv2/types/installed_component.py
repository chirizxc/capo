...
if TYPE_CHECKING:
    ...
    import capo_greengrassv2.types.is_root
    import capo_greengrassv2.types.lifecycle_state_details
...
class InstalledComponent(TypedDict, closed=True):
    ...
    lifecycle_state: NotRequired[
        "capo_greengrassv2.types.installed_component_lifecycle_state.InstalledComponentLifecycleState"
    ]
    """<p>The lifecycle state of the component.</p>"""
    lifecycle_state_details: NotRequired[
        "capo_greengrassv2.types.lifecycle_state_details.LifecycleStateDetails"
    ]
    ...
    is_root: "capo_greengrassv2.types.is_root.IsRoot"
    ...
    last_reported_timestamp: NotRequired["capo_greengrassv2.types.timestamp.Timestamp"]
    ...
    lifecycle_status_codes: NotRequired[
        "capo_greengrassv2.types.installed_component_lifecycle_status_code_list.InstalledComponentLifecycleStatusCodeList"
    ]
...
def serialize_json(value: InstalledComponent) -> dict:
    ...
    if "lifecycle_state" in value:
        ...
        out["lifecycleState"] = (
            capo_greengrassv2.types.installed_component_lifecycle_state.serialize_json(
    ...
    if "last_reported_timestamp" in value:
        ...
        out["lastReportedTimestamp"] = capo_greengrassv2.types.timestamp.serialize_json(
    ...
    if "lifecycle_status_codes" in value:
        ...
        out["lifecycleStatusCodes"] = (
            capo_greengrassv2.types.installed_component_lifecycle_status_code_list.serialize_json(
...
def deserialize_json(data: dict) -> InstalledComponent:
    ...
    if data.get("lifecycleState") is not None:
        ...
        out["lifecycle_state"] = (
            capo_greengrassv2.types.installed_component_lifecycle_state.deserialize_json(
                data["lifecycleState"]
            )
        )
    ...
    if data.get("lifecycleStatusCodes") is not None:
        ...
        out["lifecycle_status_codes"] = (
            capo_greengrassv2.types.installed_component_lifecycle_status_code_list.deserialize_json(
