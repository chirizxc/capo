...
if TYPE_CHECKING:
    ...
    import capo_greengrassv2.types.io_t_job_max_executions_per_min


class IoTJobExecutionsRolloutConfig(TypedDict, closed=True):
    exponential_rate: NotRequired[
        "capo_greengrassv2.types.io_t_job_exponential_rollout_rate.IoTJobExponentialRolloutRate"
    ]
    """<p>The exponential rate to increase the job rollout rate.</p>"""
    maximum_per_minute: NotRequired[
        "capo_greengrassv2.types.io_t_job_max_executions_per_min.IoTJobMaxExecutionsPerMin"
    ]
...
def serialize_json(value: IoTJobExecutionsRolloutConfig) -> dict:
    ...
    if "exponential_rate" in value:
        ...
        out["exponentialRate"] = (
            capo_greengrassv2.types.io_t_job_exponential_rollout_rate.serialize_json(
...
def deserialize_json(data: dict) -> IoTJobExecutionsRolloutConfig:
    ...
    if data.get("exponentialRate") is not None:
        ...
        out["exponential_rate"] = (
            capo_greengrassv2.types.io_t_job_exponential_rollout_rate.deserialize_json(
