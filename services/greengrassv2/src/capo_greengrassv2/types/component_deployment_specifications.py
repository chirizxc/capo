...
ComponentDeploymentSpecifications: TypeAlias = dict[
    ...
    "capo_greengrassv2.types.component_deployment_specification.ComponentDeploymentSpecification",
]
...
def serialize_json(input_to_serialize: ComponentDeploymentSpecifications) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            capo_greengrassv2.types.component_deployment_specification.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> ComponentDeploymentSpecifications:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            capo_greengrassv2.types.component_deployment_specification.deserialize_json(
                value
            )
        )
    return out
