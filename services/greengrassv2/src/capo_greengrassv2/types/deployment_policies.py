...
class DeploymentPolicies(TypedDict, closed=True):
    failure_handling_policy: NotRequired[
        "capo_greengrassv2.types.deployment_failure_handling_policy.DeploymentFailureHandlingPolicy"
    ]
    ...
    component_update_policy: NotRequired[
        "capo_greengrassv2.types.deployment_component_update_policy.DeploymentComponentUpdatePolicy"
    ]
    ...
    configuration_validation_policy: NotRequired[
        "capo_greengrassv2.types.deployment_configuration_validation_policy.DeploymentConfigurationValidationPolicy"
    ]
...
def serialize_json(value: DeploymentPolicies) -> dict:
    ...
    if "failure_handling_policy" in value:
        ...
        out["failureHandlingPolicy"] = (
            capo_greengrassv2.types.deployment_failure_handling_policy.serialize_json(
    ...
    if "component_update_policy" in value:
        ...
        out["componentUpdatePolicy"] = (
            capo_greengrassv2.types.deployment_component_update_policy.serialize_json(
    ...
    if "configuration_validation_policy" in value:
        ...
        out["configurationValidationPolicy"] = (
            capo_greengrassv2.types.deployment_configuration_validation_policy.serialize_json(
...
def deserialize_json(data: dict) -> DeploymentPolicies:
    ...
    if data.get("failureHandlingPolicy") is not None:
        ...
        out["failure_handling_policy"] = (
            capo_greengrassv2.types.deployment_failure_handling_policy.deserialize_json(
    ...
    if data.get("componentUpdatePolicy") is not None:
        ...
        out["component_update_policy"] = (
            capo_greengrassv2.types.deployment_component_update_policy.deserialize_json(
    ...
    if data.get("configurationValidationPolicy") is not None:
        ...
        out["configuration_validation_policy"] = (
            capo_greengrassv2.types.deployment_configuration_validation_policy.deserialize_json(
