"""Generated from Smithy shape ``com.amazonaws.greengrassv2#CreateDeployment``."""
...
def handle_response(
    ...
    out: capo_greengrassv2.types.create_deployment_response.CreateDeploymentResponse = (
        capo_greengrassv2.types.create_deployment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_greengrassv2.types.create_deployment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
