...
def handle_response(
    ...
    out: capo_greengrassv2.types.list_component_versions_response.ListComponentVersionsResponse = capo_greengrassv2.types.list_component_versions_response.deserialize_json(
