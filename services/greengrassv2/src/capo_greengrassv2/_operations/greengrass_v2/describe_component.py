...
def handle_response(
    ...
    out: capo_greengrassv2.types.describe_component_response.DescribeComponentResponse = capo_greengrassv2.types.describe_component_response.deserialize_json(
