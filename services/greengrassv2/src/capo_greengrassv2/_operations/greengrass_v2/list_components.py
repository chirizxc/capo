...
def handle_response(
    ...
    out: capo_greengrassv2.types.list_components_response.ListComponentsResponse = (
        capo_greengrassv2.types.list_components_response.deserialize_json(
...
def build_request(
    ...
    if "scope" in input_:
        params.append(
            (
                "scope",
                capo_greengrassv2.types.component_visibility_scope.serialize_json(
                    input_["scope"]
                ),
            )
        )
