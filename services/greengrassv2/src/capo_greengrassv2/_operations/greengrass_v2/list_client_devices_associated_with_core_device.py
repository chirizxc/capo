...
def handle_response(
    ...
    out: capo_greengrassv2.types.list_client_devices_associated_with_core_device_response.ListClientDevicesAssociatedWithCoreDeviceResponse = capo_greengrassv2.types.list_client_devices_associated_with_core_device_response.deserialize_json(
