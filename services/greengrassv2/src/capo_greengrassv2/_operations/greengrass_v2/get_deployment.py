...
def handle_response(
    ...
    out: capo_greengrassv2.types.get_deployment_response.GetDeploymentResponse = (
        capo_greengrassv2.types.get_deployment_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{deploymentId}", quote(input_["deployment_id"], safe=""))
