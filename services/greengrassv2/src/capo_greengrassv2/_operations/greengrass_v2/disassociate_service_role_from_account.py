...
def handle_response(
    ...
    out: capo_greengrassv2.types.disassociate_service_role_from_account_response.DisassociateServiceRoleFromAccountResponse = capo_greengrassv2.types.disassociate_service_role_from_account_response.deserialize_json(
