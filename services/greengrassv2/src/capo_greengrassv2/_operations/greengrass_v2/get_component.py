...
def handle_response(
    ...
    out: capo_greengrassv2.types.get_component_response.GetComponentResponse = (
        capo_greengrassv2.types.get_component_response.deserialize_json(
...
def get_component(
    ...
    capo_greengrassv2.types.get_component_response.GetComponentResponse, zapros.Response
]:
