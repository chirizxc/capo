"""Generated from Smithy shape ``com.amazonaws.greengrassv2#ListEffectiveDeployments``."""
...
def handle_response(
    ...
    out: capo_greengrassv2.types.list_effective_deployments_response.ListEffectiveDeploymentsResponse = capo_greengrassv2.types.list_effective_deployments_response.deserialize_json(
...
async def async_list_effective_deployments(
