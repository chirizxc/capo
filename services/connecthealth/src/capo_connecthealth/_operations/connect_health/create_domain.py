...
def handle_response(
    ...
    out: capo_connecthealth.types.create_domain_output.CreateDomainOutput = (
        capo_connecthealth.types.create_domain_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connecthealth.types.create_domain_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_domain(
    ...
    capo_connecthealth.types.create_domain_output.CreateDomainOutput, zapros.Response
]:
