...
def handle_response(
    ...
    out: capo_connecthealth.types.deactivate_subscription_output.DeactivateSubscriptionOutput = capo_connecthealth.types.deactivate_subscription_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{subscriptionId}", quote(input_["subscription_id"], safe=""))
