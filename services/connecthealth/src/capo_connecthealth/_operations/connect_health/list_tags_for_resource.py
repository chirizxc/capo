...
def handle_response(
    ...
    out: capo_connecthealth.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_connecthealth.types.list_tags_for_resource_output.deserialize_json(
