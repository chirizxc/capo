"""Generated from Smithy shape ``com.amazonaws.connecthealth#CreateSubscription``."""
...
def handle_response(
    ...
    out: capo_connecthealth.types.create_subscription_output.CreateSubscriptionOutput = capo_connecthealth.types.create_subscription_output.deserialize_json(
