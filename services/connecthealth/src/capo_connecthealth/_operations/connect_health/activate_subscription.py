...
def handle_response(
    ...
    out: capo_connecthealth.types.activate_subscription_output.ActivateSubscriptionOutput = capo_connecthealth.types.activate_subscription_output.deserialize_json(
