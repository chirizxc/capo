"""Generated from Smithy shape ``com.amazonaws.connecthealth#GetDomain``."""
...
def handle_response(
    ...
    out: capo_connecthealth.types.get_domain_output.GetDomainOutput = (
        capo_connecthealth.types.get_domain_output.deserialize_json(
...
def get_domain(
    ...
    input_: capo_connecthealth.types.get_domain_input.GetDomainInput,
) -> tuple[capo_connecthealth.types.get_domain_output.GetDomainOutput, zapros.Response]:
