"""Generated from Smithy shape ``com.amazonaws.connecthealth#DeleteDomain``."""
...
def handle_response(
    ...
    out: capo_connecthealth.types.delete_domain_output.DeleteDomainOutput = (
        capo_connecthealth.types.delete_domain_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domain/{domainId}"
...
def delete_domain(
    ...
    capo_connecthealth.types.delete_domain_output.DeleteDomainOutput, zapros.Response
]:
