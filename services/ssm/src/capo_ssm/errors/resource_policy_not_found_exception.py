"""Generated from Smithy shape ``com.amazonaws.ssm#ResourcePolicyNotFoundException``."""
...
class ResourcePolicyNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.ssm#ResourcePolicyNotFoundException``."""
