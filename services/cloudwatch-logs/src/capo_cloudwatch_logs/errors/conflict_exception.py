"""Generated from Smithy shape ``com.amazonaws.cloudwatchlogs#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudwatchlogs#ConflictException``."""
