...
if TYPE_CHECKING:
    import capo_iot_managed_integrations.types.in_progress_timeout_in_minutes


class OtaTaskTimeoutConfig(TypedDict, closed=True):
    in_progress_timeout_in_minutes: NotRequired[
        "capo_iot_managed_integrations.types.in_progress_timeout_in_minutes.InProgressTimeoutInMinutes"
    ]
