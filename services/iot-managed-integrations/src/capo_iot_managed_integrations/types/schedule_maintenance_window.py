...
if TYPE_CHECKING:
    import capo_iot_managed_integrations.types.duration_in_minutes
    import capo_iot_managed_integrations.types.start_time


class ScheduleMaintenanceWindow(TypedDict, closed=True):
    duration_in_minutes: NotRequired[
        "capo_iot_managed_integrations.types.duration_in_minutes.DurationInMinutes"
    ]
    """<p>Displays the duration of the next maintenance window.</p>"""
    start_time: NotRequired["capo_iot_managed_integrations.types.start_time.StartTime"]
