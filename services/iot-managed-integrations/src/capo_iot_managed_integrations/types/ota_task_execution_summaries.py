...
class OtaTaskExecutionSummaries(TypedDict, closed=True):
    task_execution_summary: NotRequired[
        "capo_iot_managed_integrations.types.ota_task_execution_summary.OtaTaskExecutionSummary"
    ]
...
def serialize_json(value: OtaTaskExecutionSummaries) -> dict:
    ...
    if "task_execution_summary" in value:
        ...
        out["TaskExecutionSummary"] = (
            capo_iot_managed_integrations.types.ota_task_execution_summary.serialize_json(
...
def deserialize_json(data: dict) -> OtaTaskExecutionSummaries:
    ...
    if data.get("TaskExecutionSummary") is not None:
        ...
        out["task_execution_summary"] = (
            capo_iot_managed_integrations.types.ota_task_execution_summary.deserialize_json(
