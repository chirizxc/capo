...
class ListManagedThingAccountAssociationsResponse(TypedDict, closed=True):
    items: NotRequired[
        "capo_iot_managed_integrations.types.managed_thing_association_list.ManagedThingAssociationList"
    ]
...
def serialize_json(value: ListManagedThingAccountAssociationsResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["Items"] = (
            capo_iot_managed_integrations.types.managed_thing_association_list.serialize_json(
                value["items"]
            )
        )
...
def deserialize_json(data: dict) -> ListManagedThingAccountAssociationsResponse:
    ...
    if data.get("Items") is not None:
        ...
        out["items"] = (
            capo_iot_managed_integrations.types.managed_thing_association_list.deserialize_json(
                data["Items"]
            )
        )
