...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_managed_thing_state_response.GetManagedThingStateResponse = capo_iot_managed_integrations.types.get_managed_thing_state_response.deserialize_json(
