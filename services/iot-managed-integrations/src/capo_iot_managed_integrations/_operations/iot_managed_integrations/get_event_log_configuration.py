...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_event_log_configuration_response.GetEventLogConfigurationResponse = capo_iot_managed_integrations.types.get_event_log_configuration_response.deserialize_json(
