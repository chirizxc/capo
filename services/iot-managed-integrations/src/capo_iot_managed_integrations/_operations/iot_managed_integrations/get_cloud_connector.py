...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_cloud_connector_response.GetCloudConnectorResponse = capo_iot_managed_integrations.types.get_cloud_connector_response.deserialize_json(
