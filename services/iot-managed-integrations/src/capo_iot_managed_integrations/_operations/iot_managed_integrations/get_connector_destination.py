"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetConnectorDestination``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_connector_destination_response.GetConnectorDestinationResponse = capo_iot_managed_integrations.types.get_connector_destination_response.deserialize_json(
...
async def async_get_connector_destination(
