...
import capo_iot_managed_integrations.errors.limit_exceeded_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "LimitExceededException":
            raise capo_iot_managed_integrations.errors.limit_exceeded_exception.LimitExceededException.from_json(
                data, message
            )
