...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.create_destination_response.CreateDestinationResponse = capo_iot_managed_integrations.types.create_destination_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.create_destination_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
