"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetManagedThingCapabilities``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_managed_thing_capabilities_response.GetManagedThingCapabilitiesResponse = capo_iot_managed_integrations.types.get_managed_thing_capabilities_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/managed-things-capabilities/{Identifier}"
...
async def async_get_managed_thing_capabilities(
