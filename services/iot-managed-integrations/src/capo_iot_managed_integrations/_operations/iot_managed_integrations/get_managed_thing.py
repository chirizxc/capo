...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_managed_thing_response.GetManagedThingResponse = capo_iot_managed_integrations.types.get_managed_thing_response.deserialize_json(
