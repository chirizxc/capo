"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListDestinations``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_destinations_response.ListDestinationsResponse = capo_iot_managed_integrations.types.list_destinations_response.deserialize_json(
...
async def async_list_destinations(
