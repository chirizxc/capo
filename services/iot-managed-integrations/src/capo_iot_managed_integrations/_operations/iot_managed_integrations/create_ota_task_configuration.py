"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateOtaTaskConfiguration``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.create_ota_task_configuration_response.CreateOtaTaskConfigurationResponse = capo_iot_managed_integrations.types.create_ota_task_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.create_ota_task_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_ota_task_configuration(
