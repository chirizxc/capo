...
def build_request(
    ...
    if "owner_filter" in input_:
        params.append(("OwnerFilter", input_["owner_filter"]))
    if "credential_locker_filter" in input_:
        params.append(("CredentialLockerFilter", input_["credential_locker_filter"]))
    if "role_filter" in input_:
        params.append(
            (
                "RoleFilter",
                capo_iot_managed_integrations.types.role.serialize_json(
                    input_["role_filter"]
                ),
            )
        )
    ...
    if "connector_policy_id_filter" in input_:
        params.append(("ConnectorPolicyIdFilter", input_["connector_policy_id_filter"]))
    if "connector_destination_id_filter" in input_:
        params.append(
            ("ConnectorDestinationIdFilter", input_["connector_destination_id_filter"])
        )
    if "connector_device_id_filter" in input_:
        params.append(("ConnectorDeviceIdFilter", input_["connector_device_id_filter"]))
    if "serial_number_filter" in input_:
        params.append(("SerialNumberFilter", input_["serial_number_filter"]))
        ...
        params.append(
            (
                ...
                capo_iot_managed_integrations.types.provisioning_status.serialize_json(
                    input_["provisioning_status_filter"]
                ),
            )
        )
