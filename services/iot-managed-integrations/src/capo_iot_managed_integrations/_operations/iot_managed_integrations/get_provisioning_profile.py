"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetProvisioningProfile``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_provisioning_profile_response.GetProvisioningProfileResponse = capo_iot_managed_integrations.types.get_provisioning_profile_response.deserialize_json(
