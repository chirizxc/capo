...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.put_default_encryption_configuration_response.PutDefaultEncryptionConfigurationResponse = capo_iot_managed_integrations.types.put_default_encryption_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.put_default_encryption_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
