"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetRuntimeLogConfiguration``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_runtime_log_configuration_response.GetRuntimeLogConfigurationResponse = capo_iot_managed_integrations.types.get_runtime_log_configuration_response.deserialize_json(
...
async def async_get_runtime_log_configuration(
