...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.create_credential_locker_response.CreateCredentialLockerResponse = capo_iot_managed_integrations.types.create_credential_locker_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.create_credential_locker_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
