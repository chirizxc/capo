"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListEventLogConfigurations``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_event_log_configurations_response.ListEventLogConfigurationsResponse = capo_iot_managed_integrations.types.list_event_log_configurations_response.deserialize_json(
...
async def async_list_event_log_configurations(
