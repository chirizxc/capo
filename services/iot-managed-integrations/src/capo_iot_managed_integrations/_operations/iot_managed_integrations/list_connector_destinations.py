...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_connector_destinations_response.ListConnectorDestinationsResponse = capo_iot_managed_integrations.types.list_connector_destinations_response.deserialize_json(
...
def build_request(
    ...
    if "cloud_connector_id" in input_:
        params.append(("CloudConnectorId", input_["cloud_connector_id"]))
