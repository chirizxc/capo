...
import capo_iot_managed_integrations.types.discovered_device_list_definition
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_discovered_devices_response.ListDiscoveredDevicesResponse = capo_iot_managed_integrations.types.list_discovered_devices_response.deserialize_json(
