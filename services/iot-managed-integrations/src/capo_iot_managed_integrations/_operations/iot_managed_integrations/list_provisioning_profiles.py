"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#ListProvisioningProfiles``."""
...
import capo_iot_managed_integrations.types.provisioning_profile_list_definition
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_provisioning_profiles_response.ListProvisioningProfilesResponse = capo_iot_managed_integrations.types.list_provisioning_profiles_response.deserialize_json(
...
async def async_list_provisioning_profiles(
