...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_destination_response.GetDestinationResponse = capo_iot_managed_integrations.types.get_destination_response.deserialize_json(
