"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#CreateNotificationConfiguration``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.create_notification_configuration_response.CreateNotificationConfigurationResponse = capo_iot_managed_integrations.types.create_notification_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.create_notification_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_notification_configuration(
