...
def build_request(
    ...
    if "schema_id" in input_:
        params.append(("SchemaIdFilter", input_["schema_id"]))
    if "namespace" in input_:
        params.append(("NamespaceFilter", input_["namespace"]))
    ...
    if "semantic_version" in input_:
        params.append(("SemanticVersionFilter", input_["semantic_version"]))
