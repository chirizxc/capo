...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_managed_thing_certificate_response.GetManagedThingCertificateResponse = capo_iot_managed_integrations.types.get_managed_thing_certificate_response.deserialize_json(
