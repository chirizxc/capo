...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_managed_thing_schemas_response.ListManagedThingSchemasResponse = capo_iot_managed_integrations.types.list_managed_thing_schemas_response.deserialize_json(
...
def build_request(
    ...
    if "endpoint_id_filter" in input_:
        params.append(("EndpointIdFilter", input_["endpoint_id_filter"]))
    if "capability_id_filter" in input_:
        params.append(("CapabilityIdFilter", input_["capability_id_filter"]))
