"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetDefaultEncryptionConfiguration``."""
...
import capo_iot_managed_integrations._protocol.eventstream
import capo_iot_managed_integrations.errors.access_denied_exception
import capo_iot_managed_integrations.errors.internal_failure_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InternalFailureException":
            raise capo_iot_managed_integrations.errors.internal_failure_exception.InternalFailureException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_default_encryption_configuration_response.GetDefaultEncryptionConfigurationResponse = capo_iot_managed_integrations.types.get_default_encryption_configuration_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = (
                capo_iot_managed_integrations._auth._sigv4.build_sigv4_auth_scheme(
                    "iotmanagedintegrations", options.region, endpoint_scheme
                )
            )
...
async def async_get_default_encryption_configuration(
