"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#GetAccountAssociation``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.get_account_association_response.GetAccountAssociationResponse = capo_iot_managed_integrations.types.get_account_association_response.deserialize_json(
...
async def async_get_account_association(
