"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#StartAccountAssociationRefresh``."""
...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.start_account_association_refresh_response.StartAccountAssociationRefreshResponse = capo_iot_managed_integrations.types.start_account_association_refresh_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{AccountAssociationId}", quote(input_["account_association_id"], safe="")
    )
...
async def async_start_account_association_refresh(
