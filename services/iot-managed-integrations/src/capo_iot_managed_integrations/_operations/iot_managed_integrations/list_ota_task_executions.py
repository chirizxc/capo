...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.list_ota_task_executions_response.ListOtaTaskExecutionsResponse = capo_iot_managed_integrations.types.list_ota_task_executions_response.deserialize_json(
