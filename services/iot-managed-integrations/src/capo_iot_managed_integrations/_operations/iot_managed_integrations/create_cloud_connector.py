...
def handle_response(
    ...
    out: capo_iot_managed_integrations.types.create_cloud_connector_response.CreateCloudConnectorResponse = capo_iot_managed_integrations.types.create_cloud_connector_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.create_cloud_connector_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
