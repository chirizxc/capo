"""Generated from Smithy shape ``com.amazonaws.iotmanagedintegrations#UpdateEventLogConfiguration``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_iot_managed_integrations.types.update_event_log_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_event_log_configuration(
