...
from capo_qconnect._resources.wisdom_service.assistant import Assistant
from capo_qconnect._resources.wisdom_service.knowledge_base import KnowledgeBase
from capo_qconnect._services._aws_config import aws_config
...
class QConnectClientConfig(TypedDict, total=False, closed=True):
...
class QConnectClient:
    ...
    def __init__(
        ...
        self._config = QConnectClientConfig(
            {
    ...
    def operation_options(
        self, config_overrides: Optional[QConnectClientConfig] = None
    ) -> tuple[Iterable[Interceptor[Any, Any]], OperationOptions]:
        overrides: QConnectClientConfig = config_overrides or {}
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_qconnect.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_qconnect.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_qconnect._operations.wisdom_service.list_tags_for_resource.list_tags_for_resource(
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_qconnect.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_qconnect.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_qconnect._operations.wisdom_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_qconnect.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_qconnect.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_qconnect._operations.wisdom_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
