"""Generated from Smithy shape ``com.amazonaws.qconnect#SearchContent``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.search_content_response.SearchContentResponse = (
        capo_qconnect.types.search_content_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.search_content_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def search_content(
    ...
    capo_qconnect.types.search_content_response.SearchContentResponse, zapros.Response
]:
