"""Generated from Smithy shape ``com.amazonaws.qconnect#SearchQuickResponses``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.search_quick_responses_response.SearchQuickResponsesResponse = capo_qconnect.types.search_quick_responses_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.search_quick_responses_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
