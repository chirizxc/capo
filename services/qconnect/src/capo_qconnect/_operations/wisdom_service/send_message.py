"""Generated from Smithy shape ``com.amazonaws.qconnect#SendMessage``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.send_message_response.SendMessageResponse = (
        capo_qconnect.types.send_message_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.send_message_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def send_message(
    ...
    capo_qconnect.types.send_message_response.SendMessageResponse, zapros.Response
]:
