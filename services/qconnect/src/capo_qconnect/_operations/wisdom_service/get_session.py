"""Generated from Smithy shape ``com.amazonaws.qconnect#GetSession``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_session_response.GetSessionResponse = (
        capo_qconnect.types.get_session_response.deserialize_json(
...
def get_session(
    ...
    capo_qconnect.types.get_session_response.GetSessionResponse, zapros.Response
]:
