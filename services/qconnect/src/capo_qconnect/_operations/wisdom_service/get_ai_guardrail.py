"""Generated from Smithy shape ``com.amazonaws.qconnect#GetAIGuardrail``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_ai_guardrail_response.GetAIGuardrailResponse = (
        capo_qconnect.types.get_ai_guardrail_response.deserialize_json(
...
async def async_get_ai_guardrail(
