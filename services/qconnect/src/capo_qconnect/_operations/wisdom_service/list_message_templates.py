...
def handle_response(
    ...
    out: capo_qconnect.types.list_message_templates_response.ListMessageTemplatesResponse = capo_qconnect.types.list_message_templates_response.deserialize_json(
