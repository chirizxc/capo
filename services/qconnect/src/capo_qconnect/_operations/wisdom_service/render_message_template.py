...
def handle_response(
    ...
    out: capo_qconnect.types.render_message_template_response.RenderMessageTemplateResponse = capo_qconnect.types.render_message_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.render_message_template_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
