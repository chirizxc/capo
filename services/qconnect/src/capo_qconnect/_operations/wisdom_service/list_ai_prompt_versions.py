...
def handle_response(
    ...
    out: capo_qconnect.types.list_ai_prompt_versions_response.ListAIPromptVersionsResponse = capo_qconnect.types.list_ai_prompt_versions_response.deserialize_json(
