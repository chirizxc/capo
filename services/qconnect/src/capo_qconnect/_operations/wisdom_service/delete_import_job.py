"""Generated from Smithy shape ``com.amazonaws.qconnect#DeleteImportJob``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.delete_import_job_response.DeleteImportJobResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{importJobId}", quote(input_["import_job_id"], safe=""))
