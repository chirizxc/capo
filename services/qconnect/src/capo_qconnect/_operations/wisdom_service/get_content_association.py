"""Generated from Smithy shape ``com.amazonaws.qconnect#GetContentAssociation``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_content_association_response.GetContentAssociationResponse = capo_qconnect.types.get_content_association_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{contentAssociationId}", quote(input_["content_association_id"], safe="")
    )
...
async def async_get_content_association(
