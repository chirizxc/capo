"""Generated from Smithy shape ``com.amazonaws.qconnect#GetContent``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_content_response.GetContentResponse = (
        capo_qconnect.types.get_content_response.deserialize_json(
...
def get_content(
    ...
    capo_qconnect.types.get_content_response.GetContentResponse, zapros.Response
]:
