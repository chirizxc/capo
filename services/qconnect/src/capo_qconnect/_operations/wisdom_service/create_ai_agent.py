...
def handle_response(
    ...
    out: capo_qconnect.types.create_ai_agent_response.CreateAIAgentResponse = (
        capo_qconnect.types.create_ai_agent_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_ai_agent_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_ai_agent(
    ...
    capo_qconnect.types.create_ai_agent_response.CreateAIAgentResponse, zapros.Response
]:
