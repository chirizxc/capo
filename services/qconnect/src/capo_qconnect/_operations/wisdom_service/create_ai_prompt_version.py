...
def handle_response(
    ...
    out: capo_qconnect.types.create_ai_prompt_version_response.CreateAIPromptVersionResponse = capo_qconnect.types.create_ai_prompt_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_ai_prompt_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
