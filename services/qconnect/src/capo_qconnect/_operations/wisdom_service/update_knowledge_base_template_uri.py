"""Generated from Smithy shape ``com.amazonaws.qconnect#UpdateKnowledgeBaseTemplateUri``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.update_knowledge_base_template_uri_response.UpdateKnowledgeBaseTemplateUriResponse = capo_qconnect.types.update_knowledge_base_template_uri_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.update_knowledge_base_template_uri_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
