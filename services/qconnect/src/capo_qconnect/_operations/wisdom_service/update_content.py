"""Generated from Smithy shape ``com.amazonaws.qconnect#UpdateContent``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.update_content_response.UpdateContentResponse = (
        capo_qconnect.types.update_content_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.update_content_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_content(
    ...
    capo_qconnect.types.update_content_response.UpdateContentResponse, zapros.Response
]:
