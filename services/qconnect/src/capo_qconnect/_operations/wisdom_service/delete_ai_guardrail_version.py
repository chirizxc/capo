"""Generated from Smithy shape ``com.amazonaws.qconnect#DeleteAIGuardrailVersion``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.delete_ai_guardrail_version_response.DeleteAIGuardrailVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_ai_guardrail_version(
