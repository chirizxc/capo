...
def handle_response(
    ...
    out: capo_qconnect.types.list_assistants_response.ListAssistantsResponse = (
        capo_qconnect.types.list_assistants_response.deserialize_json(
...
def list_assistants(
    ...
    capo_qconnect.types.list_assistants_response.ListAssistantsResponse, zapros.Response
]:
