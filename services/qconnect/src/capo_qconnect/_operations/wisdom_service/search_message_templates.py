...
def handle_response(
    ...
    out: capo_qconnect.types.search_message_templates_response.SearchMessageTemplatesResponse = capo_qconnect.types.search_message_templates_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.search_message_templates_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
