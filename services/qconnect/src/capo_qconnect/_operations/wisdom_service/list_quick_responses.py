"""Generated from Smithy shape ``com.amazonaws.qconnect#ListQuickResponses``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.list_quick_responses_response.ListQuickResponsesResponse = capo_qconnect.types.list_quick_responses_response.deserialize_json(
