...
def handle_response(
    ...
    out: capo_qconnect.types.create_ai_guardrail_version_response.CreateAIGuardrailVersionResponse = capo_qconnect.types.create_ai_guardrail_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_ai_guardrail_version_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
