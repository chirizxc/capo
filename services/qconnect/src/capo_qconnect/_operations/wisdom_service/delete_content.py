...
def handle_response(
    ...
    out: capo_qconnect.types.delete_content_response.DeleteContentResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_content(
    ...
    capo_qconnect.types.delete_content_response.DeleteContentResponse, zapros.Response
]:
