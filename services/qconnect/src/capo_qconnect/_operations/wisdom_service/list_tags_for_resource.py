"""Generated from Smithy shape ``com.amazonaws.qconnect#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_qconnect.types.list_tags_for_resource_response.deserialize_json(
