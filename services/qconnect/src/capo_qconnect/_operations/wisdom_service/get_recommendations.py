...
def build_request(
    ...
    params.append(("waitTimeSeconds", str(input_.get("wait_time_seconds", 0))))
    if "next_chunk_token" in input_:
        params.append(("nextChunkToken", input_["next_chunk_token"]))
    if "recommendation_type" in input_:
        params.append(("recommendationType", input_["recommendation_type"]))
