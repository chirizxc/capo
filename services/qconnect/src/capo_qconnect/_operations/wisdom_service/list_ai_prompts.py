"""Generated from Smithy shape ``com.amazonaws.qconnect#ListAIPrompts``."""
...
import capo_qconnect.types.ai_prompt_summary_list
...
def handle_response(
    ...
    out: capo_qconnect.types.list_ai_prompts_response.ListAIPromptsResponse = (
        capo_qconnect.types.list_ai_prompts_response.deserialize_json(
...
def build_request(
    ...
    if "origin" in input_:
        params.append(("origin", input_["origin"]))
...
def list_ai_prompts(
    ...
    capo_qconnect.types.list_ai_prompts_response.ListAIPromptsResponse, zapros.Response
]:
...
async def async_list_ai_prompts(
