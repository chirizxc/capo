"""Generated from Smithy shape ``com.amazonaws.qconnect#ListAIGuardrails``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.list_ai_guardrails_response.ListAIGuardrailsResponse = (
        capo_qconnect.types.list_ai_guardrails_response.deserialize_json(
...
async def async_list_ai_guardrails(
