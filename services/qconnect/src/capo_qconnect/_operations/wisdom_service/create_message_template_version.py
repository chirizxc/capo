...
def handle_response(
    ...
    out: capo_qconnect.types.create_message_template_version_response.CreateMessageTemplateVersionResponse = capo_qconnect.types.create_message_template_version_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_message_template_version_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
