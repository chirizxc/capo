"""Generated from Smithy shape ``com.amazonaws.qconnect#ListAIGuardrailVersions``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.list_ai_guardrail_versions_response.ListAIGuardrailVersionsResponse = capo_qconnect.types.list_ai_guardrail_versions_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{aiGuardrailId}", quote(input_["ai_guardrail_id"], safe=""))
...
async def async_list_ai_guardrail_versions(
