...
import capo_qconnect.errors.unprocessable_content_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "UnprocessableContentException":
            raise capo_qconnect.errors.unprocessable_content_exception.UnprocessableContentException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_qconnect.types.get_next_message_response.GetNextMessageResponse = (
        capo_qconnect.types.get_next_message_response.deserialize_json(
...
def build_request(
    ...
    if "next_message_token" in input_:
        params.append(("nextMessageToken", input_["next_message_token"]))
