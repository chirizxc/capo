...
def handle_response(
    ...
    out: capo_qconnect.types.notify_recommendations_received_response.NotifyRecommendationsReceivedResponse = capo_qconnect.types.notify_recommendations_received_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.notify_recommendations_received_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
