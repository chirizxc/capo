"""Generated from Smithy shape ``com.amazonaws.qconnect#GetQuickResponse``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_quick_response_response.GetQuickResponseResponse = (
        capo_qconnect.types.get_quick_response_response.deserialize_json(
