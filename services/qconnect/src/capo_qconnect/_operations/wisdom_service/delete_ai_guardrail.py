"""Generated from Smithy shape ``com.amazonaws.qconnect#DeleteAIGuardrail``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.delete_ai_guardrail_response.DeleteAIGuardrailResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_ai_guardrail(
