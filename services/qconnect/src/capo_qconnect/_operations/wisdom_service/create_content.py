...
def handle_response(
    ...
    out: capo_qconnect.types.create_content_response.CreateContentResponse = (
        capo_qconnect.types.create_content_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.create_content_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_content(
    ...
    capo_qconnect.types.create_content_response.CreateContentResponse, zapros.Response
]:
