...
def handle_response(
    ...
    out: capo_qconnect.types.search_sessions_response.SearchSessionsResponse = (
        capo_qconnect.types.search_sessions_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.search_sessions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def search_sessions(
    ...
    capo_qconnect.types.search_sessions_response.SearchSessionsResponse, zapros.Response
]:
