...
def handle_response(
    ...
    out: capo_qconnect.types.list_spans_response.ListSpansResponse = (
        capo_qconnect.types.list_spans_response.deserialize_json(
...
def list_spans(
    ...
    input_: capo_qconnect.types.list_spans_request.ListSpansRequest,
) -> tuple[capo_qconnect.types.list_spans_response.ListSpansResponse, zapros.Response]:
