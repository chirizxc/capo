"""Generated from Smithy shape ``com.amazonaws.qconnect#GetAIPrompt``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_ai_prompt_response.GetAIPromptResponse = (
        capo_qconnect.types.get_ai_prompt_response.deserialize_json(
...
def get_ai_prompt(
    ...
    capo_qconnect.types.get_ai_prompt_response.GetAIPromptResponse, zapros.Response
]:
