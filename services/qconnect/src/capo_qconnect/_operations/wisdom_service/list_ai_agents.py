...
def handle_response(
    ...
    out: capo_qconnect.types.list_ai_agents_response.ListAIAgentsResponse = (
        capo_qconnect.types.list_ai_agents_response.deserialize_json(
...
def list_ai_agents(
    ...
    capo_qconnect.types.list_ai_agents_response.ListAIAgentsResponse, zapros.Response
]:
