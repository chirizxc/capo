"""Generated from Smithy shape ``com.amazonaws.qconnect#ListMessages``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.list_messages_response.ListMessagesResponse = (
        capo_qconnect.types.list_messages_response.deserialize_json(
...
def build_request(
    ...
    if "filter" in input_:
        params.append(("filter", input_["filter"]))
...
def list_messages(
    ...
    capo_qconnect.types.list_messages_response.ListMessagesResponse, zapros.Response
]:
