"""Generated from Smithy shape ``com.amazonaws.qconnect#DeleteAIPromptVersion``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.delete_ai_prompt_version_response.DeleteAIPromptVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_ai_prompt_version(
