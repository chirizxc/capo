"""Generated from Smithy shape ``com.amazonaws.qconnect#UpdateSession``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.update_session_response.UpdateSessionResponse = (
        capo_qconnect.types.update_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qconnect.types.update_session_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_session(
    ...
    capo_qconnect.types.update_session_response.UpdateSessionResponse, zapros.Response
]:
