"""Generated from Smithy shape ``com.amazonaws.qconnect#GetContentSummary``."""
...
def handle_response(
    ...
    out: capo_qconnect.types.get_content_summary_response.GetContentSummaryResponse = (
        capo_qconnect.types.get_content_summary_response.deserialize_json(
