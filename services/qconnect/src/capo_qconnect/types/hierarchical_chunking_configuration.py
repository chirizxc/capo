...
if TYPE_CHECKING:
    import capo_qconnect.types.hierarchical_chunking_level_configurations


class HierarchicalChunkingConfiguration(TypedDict, closed=True):
    level_configurations: "capo_qconnect.types.hierarchical_chunking_level_configurations.HierarchicalChunkingLevelConfigurations"
...
def serialize_json(value: HierarchicalChunkingConfiguration) -> dict:
    ...
    out["levelConfigurations"] = (
        capo_qconnect.types.hierarchical_chunking_level_configurations.serialize_json(
...
def deserialize_json(data: dict) -> HierarchicalChunkingConfiguration:
    ...
    if data.get("levelConfigurations") is not None:
        ...
        out["level_configurations"] = (
            capo_qconnect.types.hierarchical_chunking_level_configurations.deserialize_json(
