...
class OrchestrationAIAgentConfiguration(TypedDict, closed=True):
    ...
    tool_configurations: NotRequired[
        "capo_qconnect.types.tool_configuration_list.ToolConfigurationList"
    ]
    """<p>The tool configurations used by the Orchestration AI Agent.</p>"""
    connect_instance_arn: NotRequired["capo_qconnect.types.generic_arn.GenericArn"]
...
def serialize_json(value: OrchestrationAIAgentConfiguration) -> dict:
    ...
    if "tool_configurations" in value:
        ...
        out["toolConfigurations"] = (
            capo_qconnect.types.tool_configuration_list.serialize_json(
...
def deserialize_json(data: dict) -> OrchestrationAIAgentConfiguration:
    ...
    if data.get("toolConfigurations") is not None:
        ...
        out["tool_configurations"] = (
            capo_qconnect.types.tool_configuration_list.deserialize_json(
