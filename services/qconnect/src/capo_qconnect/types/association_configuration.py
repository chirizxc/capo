...
if TYPE_CHECKING:
    import capo_qconnect.types.ai_agent_association_configuration_type
...
class AssociationConfiguration(TypedDict, closed=True):
    association_id: NotRequired["capo_qconnect.types.uuid.Uuid"]
    """<p>The identifier of the association for this Association Configuration.</p>"""
    association_type: NotRequired[
        "capo_qconnect.types.ai_agent_association_configuration_type.AIAgentAssociationConfigurationType"
    ]
    """<p>The type of the association for this Association Configuration.</p>"""
    association_configuration_data: NotRequired[
        "capo_qconnect.types.association_configuration_data.AssociationConfigurationData"
    ]
...
def serialize_json(value: AssociationConfiguration) -> dict:
    ...
    if "association_configuration_data" in value:
        ...
        out["associationConfigurationData"] = (
            capo_qconnect.types.association_configuration_data.serialize_json(
...
def deserialize_json(data: dict) -> AssociationConfiguration:
    ...
    if data.get("associationConfigurationData") is not None:
        ...
        out["association_configuration_data"] = (
            capo_qconnect.types.association_configuration_data.deserialize_json(
