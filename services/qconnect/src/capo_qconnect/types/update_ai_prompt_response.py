"""Generated from Smithy shape ``com.amazonaws.qconnect#UpdateAIPromptResponse``."""
...
class UpdateAIPromptResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateAIPromptResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateAIPromptResponse:
    out: UpdateAIPromptResponse = {}  # type: ignore[typeddict-item]
