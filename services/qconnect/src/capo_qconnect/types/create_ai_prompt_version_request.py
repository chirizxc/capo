"""Generated from Smithy shape ``com.amazonaws.qconnect#CreateAIPromptVersionRequest``."""
...
class CreateAIPromptVersionRequest(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateAIPromptVersionRequest) -> dict:
    out: dict = {}
