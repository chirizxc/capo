...
if TYPE_CHECKING:
    import capo_qconnect.types.llm_model_id
    import capo_qconnect.types.uuid


class GenerativeReference(TypedDict, closed=True):
    model_id: NotRequired["capo_qconnect.types.llm_model_id.LlmModelId"]
    """<p>The identifier of the LLM model. </p>"""
    generation_id: NotRequired["capo_qconnect.types.uuid.Uuid"]
    """<p> The identifier of the LLM model. </p>"""
