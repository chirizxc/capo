...
if TYPE_CHECKING:
    import capo_qconnect.types.contact_attribute_key
    import capo_qconnect.types.contact_attribute_value

ContactAttributes: TypeAlias = dict[
    "capo_qconnect.types.contact_attribute_key.ContactAttributeKey",
    "capo_qconnect.types.contact_attribute_value.ContactAttributeValue",
]
