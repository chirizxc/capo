...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.delete_service_response.DeleteServiceResponse = (
        capo_resiliencehubv2.types.delete_service_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.delete_service_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
