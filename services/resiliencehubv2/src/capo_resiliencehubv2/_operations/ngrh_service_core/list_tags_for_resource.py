"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_resiliencehubv2.types.list_tags_for_resource_response.deserialize_json(
