"""Generated from Smithy shape ``com.amazonaws.resiliencehubv2#ListUserJourneys``."""
...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_user_journeys_response.ListUserJourneysResponse = capo_resiliencehubv2.types.list_user_journeys_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v2/list-user-journeys"
...
async def async_list_user_journeys(
