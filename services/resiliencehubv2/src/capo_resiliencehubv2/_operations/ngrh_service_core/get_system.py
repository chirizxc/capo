...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.get_system_response.GetSystemResponse = (
        capo_resiliencehubv2.types.get_system_response.deserialize_json(
...
def get_system(
    ...
    capo_resiliencehubv2.types.get_system_response.GetSystemResponse, zapros.Response
]:
