...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.update_policy_response.UpdatePolicyResponse = (
        capo_resiliencehubv2.types.update_policy_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.update_policy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
