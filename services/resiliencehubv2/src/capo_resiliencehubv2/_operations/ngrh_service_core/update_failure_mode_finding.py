...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.update_failure_mode_finding_response.UpdateFailureModeFindingResponse = capo_resiliencehubv2.types.update_failure_mode_finding_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_resiliencehubv2.types.update_failure_mode_finding_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
