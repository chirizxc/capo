...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_service_topology_edges_response.ListServiceTopologyEdgesResponse = capo_resiliencehubv2.types.list_service_topology_edges_response.deserialize_json(
