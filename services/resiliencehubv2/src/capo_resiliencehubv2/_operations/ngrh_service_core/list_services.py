...
def handle_response(
    ...
    out: capo_resiliencehubv2.types.list_services_response.ListServicesResponse = (
        capo_resiliencehubv2.types.list_services_response.deserialize_json(
...
def build_request(
    ...
    if "ou_id" in input_:
        params.append(("ouId", input_["ou_id"]))
