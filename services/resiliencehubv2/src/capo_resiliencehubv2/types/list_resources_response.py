...
class ListResourcesResponse(TypedDict, closed=True):
    ...
    service_resources: NotRequired[
        "capo_resiliencehubv2.types.service_resource_list.ServiceResourceList"
    ]
...
def serialize_json(value: ListResourcesResponse) -> dict:
    ...
    if "service_resources" in value:
        ...
        out["serviceResources"] = (
            capo_resiliencehubv2.types.service_resource_list.serialize_json(
...
def deserialize_json(data: dict) -> ListResourcesResponse:
    ...
    if data.get("serviceResources") is not None:
        import capo_resiliencehubv2.types.service_resource_list

        out["service_resources"] = (
            capo_resiliencehubv2.types.service_resource_list.deserialize_json(
