...
if TYPE_CHECKING:
    import capo_resiliencehubv2.types.iam_role_arn


class CrossAccountRole(TypedDict, closed=True):
    cross_account_role_arn: "capo_resiliencehubv2.types.iam_role_arn.IamRoleArn"
