...
if TYPE_CHECKING:
    import capo_tnb.types.error_cause
    import capo_tnb.types.error_details


class ErrorInfo(TypedDict, closed=True):
    cause: NotRequired["capo_tnb.types.error_cause.ErrorCause"]
    """<p>Error cause.</p>"""
    details: NotRequired["capo_tnb.types.error_details.ErrorDetails"]
    """<p>Error details.</p>"""
