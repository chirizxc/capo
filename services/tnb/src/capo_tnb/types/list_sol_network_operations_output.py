...
class ListSolNetworkOperationsOutput(TypedDict, closed=True):
    ...
    network_operations: NotRequired[
        "capo_tnb.types.list_sol_network_operations_resources.ListSolNetworkOperationsResources"
    ]
...
def serialize_json(value: ListSolNetworkOperationsOutput) -> dict:
    ...
    if "network_operations" in value:
        ...
        out["networkOperations"] = (
            capo_tnb.types.list_sol_network_operations_resources.serialize_json(
...
def deserialize_json(data: dict) -> ListSolNetworkOperationsOutput:
    ...
    if data.get("networkOperations") is not None:
        import capo_tnb.types.list_sol_network_operations_resources

        out["network_operations"] = (
            capo_tnb.types.list_sol_network_operations_resources.deserialize_json(
