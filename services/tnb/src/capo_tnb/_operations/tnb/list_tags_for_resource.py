"""Generated from Smithy shape ``com.amazonaws.tnb#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_tnb.types.list_tags_for_resource_output.ListTagsForResourceOutput = (
        capo_tnb.types.list_tags_for_resource_output.deserialize_json(
