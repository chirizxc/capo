"""Generated from Smithy shape ``com.amazonaws.tnb#CreateSolFunctionPackage``."""
...
def handle_response(
    ...
    out: capo_tnb.types.create_sol_function_package_output.CreateSolFunctionPackageOutput = capo_tnb.types.create_sol_function_package_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_tnb.types.create_sol_function_package_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_sol_function_package(
