...
def handle_response(
    ...
    out: capo_tnb.types.update_sol_function_package_output.UpdateSolFunctionPackageOutput = capo_tnb.types.update_sol_function_package_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_tnb.types.update_sol_function_package_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
