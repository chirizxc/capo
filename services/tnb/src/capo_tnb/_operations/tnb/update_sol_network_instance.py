...
def handle_response(
    ...
    out: capo_tnb.types.update_sol_network_instance_output.UpdateSolNetworkInstanceOutput = capo_tnb.types.update_sol_network_instance_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_tnb.types.update_sol_network_instance_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
