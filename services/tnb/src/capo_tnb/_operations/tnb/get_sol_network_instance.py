"""Generated from Smithy shape ``com.amazonaws.tnb#GetSolNetworkInstance``."""
...
def handle_response(
    ...
    out: capo_tnb.types.get_sol_network_instance_output.GetSolNetworkInstanceOutput = (
        capo_tnb.types.get_sol_network_instance_output.deserialize_json(
...
async def async_get_sol_network_instance(
