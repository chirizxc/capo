"""Generated from Smithy shape ``com.amazonaws.tnb#UntagResource``."""
...
def handle_response(
    ...
    out: capo_tnb.types.untag_resource_output.UntagResourceOutput = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    input_: capo_tnb.types.untag_resource_input.UntagResourceInput,
) -> tuple[capo_tnb.types.untag_resource_output.UntagResourceOutput, zapros.Response]:
