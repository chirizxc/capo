"""Generated from Smithy shape ``com.amazonaws.tnb#CreateSolNetworkInstance``."""
...
def handle_response(
    ...
    out: capo_tnb.types.create_sol_network_instance_output.CreateSolNetworkInstanceOutput = capo_tnb.types.create_sol_network_instance_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_tnb.types.create_sol_network_instance_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_sol_network_instance(
