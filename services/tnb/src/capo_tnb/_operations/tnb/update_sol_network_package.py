...
def handle_response(
    ...
    out: capo_tnb.types.update_sol_network_package_output.UpdateSolNetworkPackageOutput = capo_tnb.types.update_sol_network_package_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_tnb.types.update_sol_network_package_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
