...
from capo_tnb._services._aws_config import aaws_config
...
class AsynctnbClient:
    ...
    async def cancel_sol_network_operation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.cancel_sol_network_operation_input.CancelSolNetworkOperationInput]",
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.cancel_sol_network_operation.async_cancel_sol_network_operation(
    ...
    async def create_sol_function_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.create_sol_function_package_input.CreateSolFunctionPackageInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.create_sol_function_package_output.CreateSolFunctionPackageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.create_sol_function_package.async_create_sol_function_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_sol_network_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.create_sol_network_instance_input.CreateSolNetworkInstanceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.create_sol_network_instance_output.CreateSolNetworkInstanceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.create_sol_network_instance.async_create_sol_network_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def create_sol_network_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.create_sol_network_package_input.CreateSolNetworkPackageInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.create_sol_network_package_output.CreateSolNetworkPackageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.create_sol_network_package.async_create_sol_network_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sol_function_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.delete_sol_function_package_input.DeleteSolFunctionPackageInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.delete_sol_function_package.async_delete_sol_function_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sol_network_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.delete_sol_network_instance_input.DeleteSolNetworkInstanceInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.delete_sol_network_instance.async_delete_sol_network_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete_sol_network_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.delete_sol_network_package_input.DeleteSolNetworkPackageInput]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.delete_sol_network_package.async_delete_sol_network_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_function_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_function_instance_input.GetSolFunctionInstanceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_function_instance_output.GetSolFunctionInstanceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_function_instance.async_get_sol_function_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_function_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_function_package_input.GetSolFunctionPackageInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_function_package_output.GetSolFunctionPackageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_function_package.async_get_sol_function_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_function_package_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_function_package_content_input.GetSolFunctionPackageContentInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_function_package_content_output.GetSolFunctionPackageContentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_function_package_content.async_get_sol_function_package_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_function_package_descriptor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_function_package_descriptor_input.GetSolFunctionPackageDescriptorInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_function_package_descriptor_output.GetSolFunctionPackageDescriptorOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_function_package_descriptor.async_get_sol_function_package_descriptor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_network_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_network_instance_input.GetSolNetworkInstanceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_network_instance_output.GetSolNetworkInstanceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_network_instance.async_get_sol_network_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_network_operation(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_network_operation_input.GetSolNetworkOperationInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_network_operation_output.GetSolNetworkOperationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_network_operation.async_get_sol_network_operation(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_network_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_network_package_input.GetSolNetworkPackageInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_network_package_output.GetSolNetworkPackageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_network_package.async_get_sol_network_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_network_package_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_network_package_content_input.GetSolNetworkPackageContentInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_network_package_content_output.GetSolNetworkPackageContentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_network_package_content.async_get_sol_network_package_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_sol_network_package_descriptor(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.get_sol_network_package_descriptor_input.GetSolNetworkPackageDescriptorInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.get_sol_network_package_descriptor_output.GetSolNetworkPackageDescriptorOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.get_sol_network_package_descriptor.async_get_sol_network_package_descriptor(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def instantiate_sol_network_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.instantiate_sol_network_instance_input.InstantiateSolNetworkInstanceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.instantiate_sol_network_instance_output.InstantiateSolNetworkInstanceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.instantiate_sol_network_instance.async_instantiate_sol_network_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_sol_function_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.list_sol_function_instances_input.ListSolFunctionInstancesInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.list_sol_function_instances_output.ListSolFunctionInstancesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.list_sol_function_instances.async_list_sol_function_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sol_function_instances(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_tnb.types.pagination_token.PaginationToken"] = None,
    ) -> "AsyncIterator[capo_tnb.types.list_sol_function_instance_info.ListSolFunctionInstanceInfo]":
        _token = next_token
        while True:
    ...
    async def list_sol_function_packages(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.list_sol_function_packages_input.ListSolFunctionPackagesInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.list_sol_function_packages_output.ListSolFunctionPackagesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.list_sol_function_packages.async_list_sol_function_packages(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sol_function_packages(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_tnb.types.pagination_token.PaginationToken"] = None,
    ) -> "AsyncIterator[capo_tnb.types.list_sol_function_package_info.ListSolFunctionPackageInfo]":
        _token = next_token
        while True:
    ...
    async def list_sol_network_instances(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.list_sol_network_instances_input.ListSolNetworkInstancesInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.list_sol_network_instances_output.ListSolNetworkInstancesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.list_sol_network_instances.async_list_sol_network_instances(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sol_network_instances(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_tnb.types.pagination_token.PaginationToken"] = None,
    ) -> "AsyncIterator[capo_tnb.types.list_sol_network_instance_info.ListSolNetworkInstanceInfo]":
        _token = next_token
        while True:
    ...
    async def list_sol_network_operations(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.list_sol_network_operations_input.ListSolNetworkOperationsInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.list_sol_network_operations_output.ListSolNetworkOperationsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.list_sol_network_operations.async_list_sol_network_operations(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sol_network_operations(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_tnb.types.pagination_token.PaginationToken"] = None,
    ) -> "AsyncIterator[capo_tnb.types.list_sol_network_operations_info.ListSolNetworkOperationsInfo]":
        _token = next_token
        while True:
    ...
    async def list_sol_network_packages(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.list_sol_network_packages_input.ListSolNetworkPackagesInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.list_sol_network_packages_output.ListSolNetworkPackagesOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.list_sol_network_packages.async_list_sol_network_packages(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def iter_list_sol_network_packages(
        ...
        *,
        ...
        max_results: Optional[int] = None,
        next_token: Optional["capo_tnb.types.pagination_token.PaginationToken"] = None,
    ) -> "AsyncIterator[capo_tnb.types.list_sol_network_package_info.ListSolNetworkPackageInfo]":
        _token = next_token
        while True:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_sol_function_package_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.put_sol_function_package_content_input.PutSolFunctionPackageContentInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.put_sol_function_package_content_output.PutSolFunctionPackageContentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.put_sol_function_package_content.async_put_sol_function_package_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_sol_network_package_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.put_sol_network_package_content_input.PutSolNetworkPackageContentInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.put_sol_network_package_content_output.PutSolNetworkPackageContentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.put_sol_network_package_content.async_put_sol_network_package_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def terminate_sol_network_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.terminate_sol_network_instance_input.TerminateSolNetworkInstanceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.terminate_sol_network_instance_output.TerminateSolNetworkInstanceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.terminate_sol_network_instance.async_terminate_sol_network_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sol_function_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.update_sol_function_package_input.UpdateSolFunctionPackageInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.update_sol_function_package_output.UpdateSolFunctionPackageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.update_sol_function_package.async_update_sol_function_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sol_network_instance(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.update_sol_network_instance_input.UpdateSolNetworkInstanceInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.update_sol_network_instance_output.UpdateSolNetworkInstanceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.update_sol_network_instance.async_update_sol_network_instance(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update_sol_network_package(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.update_sol_network_package_input.UpdateSolNetworkPackageInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.update_sol_network_package_output.UpdateSolNetworkPackageOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.update_sol_network_package.async_update_sol_network_package(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_sol_function_package_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.validate_sol_function_package_content_input.ValidateSolFunctionPackageContentInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.validate_sol_function_package_content_output.ValidateSolFunctionPackageContentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.validate_sol_function_package_content.async_validate_sol_function_package_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def validate_sol_network_package_content(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_tnb.types.validate_sol_network_package_content_input.ValidateSolNetworkPackageContentInput]",
        ) -> AsyncOperationResponse[
            "capo_tnb.types.validate_sol_network_package_content_output.ValidateSolNetworkPackageContentOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_tnb._operations.tnb.validate_sol_network_package_content.async_validate_sol_network_package_content(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
