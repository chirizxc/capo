...
class AsyncFSxClient:
    ...
    async def iter_describe_backups(
        ...
        *,
        ...
        max_results: Optional["capo_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_fsx.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_fsx.types.describe_backups_response.DescribeBackupsResponse]":
        _token = next_token
        while True:
    ...
    async def iter_describe_data_repository_associations(
        self,
        *,
        config_overrides: Optional[AsyncFSxClientConfig] = None,
        association_ids: Optional[
        ...
        next_token: Optional["capo_fsx.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_fsx.types.describe_data_repository_associations_response.DescribeDataRepositoryAssociationsResponse]":
        _token = next_token
        while True:
            _response = await self.describe_data_repository_associations(
                config_overrides=config_overrides,
    ...
    async def iter_describe_data_repository_tasks(
        self,
        *,
        config_overrides: Optional[AsyncFSxClientConfig] = None,
        task_ids: Optional["capo_fsx.types.task_ids.TaskIds"] = None,
        ...
        max_results: Optional["capo_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_fsx.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_fsx.types.describe_data_repository_tasks_response.DescribeDataRepositoryTasksResponse]":
        _token = next_token
        while True:
            _response = await self.describe_data_repository_tasks(
                config_overrides=config_overrides,
                task_ids=task_ids,
                filters=filters,
                max_results=max_results,
    ...
    async def iter_describe_file_caches(
        self,
        *,
        config_overrides: Optional[AsyncFSxClientConfig] = None,
        file_cache_ids: Optional["capo_fsx.types.file_cache_ids.FileCacheIds"] = None,
        max_results: Optional["capo_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_fsx.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_fsx.types.describe_file_caches_response.DescribeFileCachesResponse]":
        _token = next_token
        while True:
            _response = await self.describe_file_caches(
                config_overrides=config_overrides,
    ...
    async def iter_describe_file_system_aliases(
        self,
        *,
        config_overrides: Optional[AsyncFSxClientConfig] = None,
        client_request_token: Optional[
        ...
        max_results: Optional["capo_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_fsx.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_fsx.types.describe_file_system_aliases_response.DescribeFileSystemAliasesResponse]":
        _token = next_token
        while True:
            _response = await self.describe_file_system_aliases(
                config_overrides=config_overrides,
    ...
    async def iter_describe_file_systems(
        ...
        *,
        ...
        max_results: Optional["capo_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_fsx.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_fsx.types.describe_file_systems_response.DescribeFileSystemsResponse]":
        _token = next_token
        while True:
    ...
    async def iter_list_tags_for_resource(
        ...
        *,
        ...
        max_results: Optional["capo_fsx.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_fsx.types.next_token.NextToken"] = None,
    ) -> "AsyncIterator[capo_fsx.types.list_tags_for_resource_response.ListTagsForResourceResponse]":
        _token = next_token
        while True:
