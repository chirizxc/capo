...
def serialize_aws_json_1_1(value: DeleteVolumeRequest) -> dict:
    ...
    if "ontap_configuration" in value:
        ...
        out["OntapConfiguration"] = (
            capo_fsx.types.delete_volume_ontap_configuration.serialize_aws_json_1_1(
    ...
    if "open_zfs_configuration" in value:
        ...
        out["OpenZFSConfiguration"] = (
            capo_fsx.types.delete_volume_open_zfs_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DeleteVolumeRequest:
    ...
    if data.get("OntapConfiguration") is not None:
        ...
        out["ontap_configuration"] = (
            capo_fsx.types.delete_volume_ontap_configuration.deserialize_aws_json_1_1(
    ...
    if data.get("OpenZFSConfiguration") is not None:
        ...
        out["open_zfs_configuration"] = (
            capo_fsx.types.delete_volume_open_zfs_configuration.deserialize_aws_json_1_1(
