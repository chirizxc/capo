...
class StorageVirtualMachine(TypedDict, closed=True):
    active_directory_configuration: NotRequired[
        "capo_fsx.types.svm_active_directory_configuration.SvmActiveDirectoryConfiguration"
    ]
    ...
    endpoints: NotRequired["capo_fsx.types.svm_endpoints.SvmEndpoints"]
    ...
    lifecycle: NotRequired[
        "capo_fsx.types.storage_virtual_machine_lifecycle.StorageVirtualMachineLifecycle"
    ]
...
def serialize_aws_json_1_1(value: StorageVirtualMachine) -> dict:
    ...
    if "active_directory_configuration" in value:
        ...
        out["ActiveDirectoryConfiguration"] = (
            capo_fsx.types.svm_active_directory_configuration.serialize_aws_json_1_1(
    ...
    if "endpoints" in value:
        ...
        out["Endpoints"] = capo_fsx.types.svm_endpoints.serialize_aws_json_1_1(
            value["endpoints"]
        )
    ...
    if "lifecycle" in value:
        ...
        out["Lifecycle"] = (
            capo_fsx.types.storage_virtual_machine_lifecycle.serialize_aws_json_1_1(
                value["lifecycle"]
            )
        )
    if "name" in value:
    ...
    if "subtype" in value:
        ...
        out["Subtype"] = (
            capo_fsx.types.storage_virtual_machine_subtype.serialize_aws_json_1_1(
                value["subtype"]
            )
        )
    if "uuid" in value:
...
def deserialize_aws_json_1_1(data: dict) -> StorageVirtualMachine:
    ...
    if data.get("ActiveDirectoryConfiguration") is not None:
        ...
        out["active_directory_configuration"] = (
            capo_fsx.types.svm_active_directory_configuration.deserialize_aws_json_1_1(
    ...
    if data.get("Lifecycle") is not None:
        ...
        out["lifecycle"] = (
            capo_fsx.types.storage_virtual_machine_lifecycle.deserialize_aws_json_1_1(
                data["Lifecycle"]
            )
        )
    ...
    if data.get("Subtype") is not None:
        ...
        out["subtype"] = (
            capo_fsx.types.storage_virtual_machine_subtype.deserialize_aws_json_1_1(
                data["Subtype"]
            )
        )
