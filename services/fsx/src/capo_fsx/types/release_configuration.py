...
class ReleaseConfiguration(TypedDict, closed=True):
    duration_since_last_access: NotRequired[
        "capo_fsx.types.duration_since_last_access.DurationSinceLastAccess"
    ]
...
def serialize_aws_json_1_1(value: ReleaseConfiguration) -> dict:
    ...
    if "duration_since_last_access" in value:
        ...
        out["DurationSinceLastAccess"] = (
            capo_fsx.types.duration_since_last_access.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ReleaseConfiguration:
    ...
    if data.get("DurationSinceLastAccess") is not None:
        ...
        out["duration_since_last_access"] = (
            capo_fsx.types.duration_since_last_access.deserialize_aws_json_1_1(
