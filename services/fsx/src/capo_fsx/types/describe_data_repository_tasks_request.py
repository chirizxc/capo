...
class DescribeDataRepositoryTasksRequest(TypedDict, closed=True):
    task_ids: NotRequired["capo_fsx.types.task_ids.TaskIds"]
...
def serialize_aws_json_1_1(value: DescribeDataRepositoryTasksRequest) -> dict:
    ...
    if "task_ids" in value:
        ...
        out["TaskIds"] = capo_fsx.types.task_ids.serialize_aws_json_1_1(
            value["task_ids"]
        )
    if "filters" in value:
        import capo_fsx.types.data_repository_task_filters
        ...
        out["Filters"] = (
            capo_fsx.types.data_repository_task_filters.serialize_aws_json_1_1(
                value["filters"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> DescribeDataRepositoryTasksRequest:
    ...
    if data.get("Filters") is not None:
        ...
        out["filters"] = (
            capo_fsx.types.data_repository_task_filters.deserialize_aws_json_1_1(
                data["Filters"]
            )
        )
