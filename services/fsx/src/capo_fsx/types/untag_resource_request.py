...
class UntagResourceRequest(TypedDict, closed=True):
    ...
    tag_keys: NotRequired["capo_fsx.types.tag_keys.TagKeys"]
...
def serialize_aws_json_1_1(value: UntagResourceRequest) -> dict:
    ...
    if "tag_keys" in value:
        ...
        out["TagKeys"] = capo_fsx.types.tag_keys.serialize_aws_json_1_1(
            value["tag_keys"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UntagResourceRequest:
    ...
    if data.get("TagKeys") is not None:
        ...
        out["tag_keys"] = capo_fsx.types.tag_keys.deserialize_aws_json_1_1(
            data["TagKeys"]
        )
    return out
