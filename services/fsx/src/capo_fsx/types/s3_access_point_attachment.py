...
if TYPE_CHECKING:
    ...
    import capo_fsx.types.s3_access_point
    ...
    import capo_fsx.types.s3_access_point_ontap_configuration
    import capo_fsx.types.s3_access_point_open_zfs_configuration
...
class S3AccessPointAttachment(TypedDict, closed=True):
    ...
    open_zfs_configuration: NotRequired[
        "capo_fsx.types.s3_access_point_open_zfs_configuration.S3AccessPointOpenZFSConfiguration"
    ]
    """<p>The OpenZFSConfiguration of the S3 access point attachment.</p>"""
    ontap_configuration: NotRequired[
        "capo_fsx.types.s3_access_point_ontap_configuration.S3AccessPointOntapConfiguration"
    ]
    """<p>The ONTAP configuration of the S3 access point attachment.</p>"""
    s3_access_point: NotRequired["capo_fsx.types.s3_access_point.S3AccessPoint"]
...
def serialize_aws_json_1_1(value: S3AccessPointAttachment) -> dict:
    ...
    if "open_zfs_configuration" in value:
        ...
        out["OpenZFSConfiguration"] = (
            capo_fsx.types.s3_access_point_open_zfs_configuration.serialize_aws_json_1_1(
    ...
    if "ontap_configuration" in value:
        ...
        out["OntapConfiguration"] = (
            capo_fsx.types.s3_access_point_ontap_configuration.serialize_aws_json_1_1(
    ...
    if "s3_access_point" in value:
        ...
        out["S3AccessPoint"] = capo_fsx.types.s3_access_point.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> S3AccessPointAttachment:
    ...
    if data.get("OpenZFSConfiguration") is not None:
        ...
        out["open_zfs_configuration"] = (
            capo_fsx.types.s3_access_point_open_zfs_configuration.deserialize_aws_json_1_1(
    ...
    if data.get("OntapConfiguration") is not None:
        ...
        out["ontap_configuration"] = (
            capo_fsx.types.s3_access_point_ontap_configuration.deserialize_aws_json_1_1(
    ...
    if data.get("S3AccessPoint") is not None:
        ...
        out["s3_access_point"] = (
            capo_fsx.types.s3_access_point.deserialize_aws_json_1_1(
                data["S3AccessPoint"]
            )
        )
    return out
