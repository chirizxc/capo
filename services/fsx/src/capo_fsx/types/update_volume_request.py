...
class UpdateVolumeRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: UpdateVolumeRequest) -> dict:
    ...
    if "ontap_configuration" in value:
        ...
        out["OntapConfiguration"] = (
            capo_fsx.types.update_ontap_volume_configuration.serialize_aws_json_1_1(
    ...
    if "open_zfs_configuration" in value:
        ...
        out["OpenZFSConfiguration"] = (
            capo_fsx.types.update_open_zfs_volume_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> UpdateVolumeRequest:
    ...
    if data.get("OntapConfiguration") is not None:
        ...
        out["ontap_configuration"] = (
            capo_fsx.types.update_ontap_volume_configuration.deserialize_aws_json_1_1(
    ...
    if data.get("OpenZFSConfiguration") is not None:
        ...
        out["open_zfs_configuration"] = (
            capo_fsx.types.update_open_zfs_volume_configuration.deserialize_aws_json_1_1(
