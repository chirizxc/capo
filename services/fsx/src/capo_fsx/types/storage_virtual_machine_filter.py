...
class StorageVirtualMachineFilter(TypedDict, closed=True):
    name: NotRequired[
        "capo_fsx.types.storage_virtual_machine_filter_name.StorageVirtualMachineFilterName"
    ]
    """<p>The name for this filter.</p>"""
    values: NotRequired[
        "capo_fsx.types.storage_virtual_machine_filter_values.StorageVirtualMachineFilterValues"
    ]
...
def serialize_aws_json_1_1(value: StorageVirtualMachineFilter) -> dict:
    ...
    if "name" in value:
        ...
        out["Name"] = (
            capo_fsx.types.storage_virtual_machine_filter_name.serialize_aws_json_1_1(
                value["name"]
            )
        )
    if "values" in value:
        ...
        out["Values"] = (
            capo_fsx.types.storage_virtual_machine_filter_values.serialize_aws_json_1_1(
                value["values"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> StorageVirtualMachineFilter:
    ...
    if data.get("Name") is not None:
        ...
        out["name"] = (
            capo_fsx.types.storage_virtual_machine_filter_name.deserialize_aws_json_1_1(
                data["Name"]
            )
        )
    if data.get("Values") is not None:
        ...
        out["values"] = (
            capo_fsx.types.storage_virtual_machine_filter_values.deserialize_aws_json_1_1(
                data["Values"]
            )
        )
    return out
