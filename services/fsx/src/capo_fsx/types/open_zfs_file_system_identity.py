...
class OpenZFSFileSystemIdentity(TypedDict, closed=True):
    type: NotRequired[
        "capo_fsx.types.open_zfs_file_system_user_type.OpenZFSFileSystemUserType"
    ]
    """<p>Specifies the FSx for OpenZFS user identity type, accepts only <code>POSIX</code>.</p>"""
    posix_user: NotRequired[
        "capo_fsx.types.open_zfs_posix_file_system_user.OpenZFSPosixFileSystemUser"
    ]
...
def serialize_aws_json_1_1(value: OpenZFSFileSystemIdentity) -> dict:
    ...
    if "type" in value:
        ...
        out["Type"] = (
            capo_fsx.types.open_zfs_file_system_user_type.serialize_aws_json_1_1(
                value["type"]
            )
        )
    if "posix_user" in value:
        ...
        out["PosixUser"] = (
            capo_fsx.types.open_zfs_posix_file_system_user.serialize_aws_json_1_1(
                value["posix_user"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> OpenZFSFileSystemIdentity:
    ...
    if data.get("Type") is not None:
        ...
        out["type"] = (
            capo_fsx.types.open_zfs_file_system_user_type.deserialize_aws_json_1_1(
                data["Type"]
            )
        )
    if data.get("PosixUser") is not None:
        ...
        out["posix_user"] = (
            capo_fsx.types.open_zfs_posix_file_system_user.deserialize_aws_json_1_1(
                data["PosixUser"]
            )
        )
    return out
