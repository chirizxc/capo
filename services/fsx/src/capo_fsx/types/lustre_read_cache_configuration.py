...
class LustreReadCacheConfiguration(TypedDict, closed=True):
    sizing_mode: NotRequired[
        "capo_fsx.types.lustre_read_cache_sizing_mode.LustreReadCacheSizingMode"
    ]
...
def serialize_aws_json_1_1(value: LustreReadCacheConfiguration) -> dict:
    ...
    if "sizing_mode" in value:
        ...
        out["SizingMode"] = (
            capo_fsx.types.lustre_read_cache_sizing_mode.serialize_aws_json_1_1(
                value["sizing_mode"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> LustreReadCacheConfiguration:
    ...
    if data.get("SizingMode") is not None:
        ...
        out["sizing_mode"] = (
            capo_fsx.types.lustre_read_cache_sizing_mode.deserialize_aws_json_1_1(
                data["SizingMode"]
            )
        )
