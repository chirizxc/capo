...
if TYPE_CHECKING:
    import capo_fsx.types.failed_count
    import capo_fsx.types.last_updated_time
    import capo_fsx.types.released_capacity
    import capo_fsx.types.succeeded_count
    import capo_fsx.types.total_count


class DataRepositoryTaskStatus(TypedDict, closed=True):
    total_count: NotRequired["capo_fsx.types.total_count.TotalCount"]
    ...
    succeeded_count: NotRequired["capo_fsx.types.succeeded_count.SucceededCount"]
    """<p>A running total of the number of files that the task has successfully processed.</p>"""
    failed_count: NotRequired["capo_fsx.types.failed_count.FailedCount"]
    """<p>A running total of the number of files that the task failed to process.</p>"""
    last_updated_time: NotRequired["capo_fsx.types.last_updated_time.LastUpdatedTime"]
    """<p>The time at which the task status was last updated.</p>"""
    released_capacity: NotRequired["capo_fsx.types.released_capacity.ReleasedCapacity"]
...
def serialize_aws_json_1_1(value: DataRepositoryTaskStatus) -> dict:
    ...
    if "last_updated_time" in value:
        ...
        out["LastUpdatedTime"] = (
            capo_fsx.types.last_updated_time.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DataRepositoryTaskStatus:
    ...
    if data.get("LastUpdatedTime") is not None:
        ...
        out["last_updated_time"] = (
            capo_fsx.types.last_updated_time.deserialize_aws_json_1_1(
