...
class UpdateFileCacheResponse(TypedDict, closed=True):
    file_cache: NotRequired["capo_fsx.types.file_cache.FileCache"]
...
def serialize_aws_json_1_1(value: UpdateFileCacheResponse) -> dict:
    ...
    if "file_cache" in value:
        ...
        out["FileCache"] = capo_fsx.types.file_cache.serialize_aws_json_1_1(
            value["file_cache"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> UpdateFileCacheResponse:
    ...
    if data.get("FileCache") is not None:
        ...
        out["file_cache"] = capo_fsx.types.file_cache.deserialize_aws_json_1_1(
            data["FileCache"]
        )
    return out
