...
class DataRepositoryTaskFilter(TypedDict, closed=True):
    ...
    values: NotRequired[
        "capo_fsx.types.data_repository_task_filter_values.DataRepositoryTaskFilterValues"
    ]
...
def serialize_aws_json_1_1(value: DataRepositoryTaskFilter) -> dict:
    ...
    if "name" in value:
        ...
        out["Name"] = (
            capo_fsx.types.data_repository_task_filter_name.serialize_aws_json_1_1(
                value["name"]
            )
        )
    if "values" in value:
        ...
        out["Values"] = (
            capo_fsx.types.data_repository_task_filter_values.serialize_aws_json_1_1(
                value["values"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DataRepositoryTaskFilter:
    ...
    if data.get("Name") is not None:
        ...
        out["name"] = (
            capo_fsx.types.data_repository_task_filter_name.deserialize_aws_json_1_1(
                data["Name"]
            )
        )
    if data.get("Values") is not None:
        ...
        out["values"] = (
            capo_fsx.types.data_repository_task_filter_values.deserialize_aws_json_1_1(
                data["Values"]
            )
        )
    return out
