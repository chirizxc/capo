...
if TYPE_CHECKING:
    ...
    import capo_fsx.types.iops


class DiskIopsConfiguration(TypedDict, closed=True):
    mode: NotRequired[
        "capo_fsx.types.disk_iops_configuration_mode.DiskIopsConfigurationMode"
    ]
    ...
    iops: NotRequired["capo_fsx.types.iops.Iops"]
...
def serialize_aws_json_1_1(value: DiskIopsConfiguration) -> dict:
    ...
    if "mode" in value:
        ...
        out["Mode"] = (
            capo_fsx.types.disk_iops_configuration_mode.serialize_aws_json_1_1(
                value["mode"]
            )
        )
    if "iops" in value:
...
def deserialize_aws_json_1_1(data: dict) -> DiskIopsConfiguration:
    ...
    if data.get("Mode") is not None:
        ...
        out["mode"] = (
            capo_fsx.types.disk_iops_configuration_mode.deserialize_aws_json_1_1(
                data["Mode"]
            )
        )
