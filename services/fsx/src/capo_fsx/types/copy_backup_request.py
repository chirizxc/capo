...
class CopyBackupRequest(TypedDict, closed=True):
    ...
    source_backup_id: NotRequired["capo_fsx.types.source_backup_id.SourceBackupId"]
    """<p>The ID of the source backup. Specifies the ID of the backup that's being copied.</p>"""
    source_region: NotRequired["capo_fsx.types.region.Region"]
    ...
    copy_tags: NotRequired["capo_fsx.types.flag.Flag"]
