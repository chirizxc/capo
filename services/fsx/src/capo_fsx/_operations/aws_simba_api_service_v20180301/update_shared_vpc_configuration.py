...
def handle_response(
    ...
    out: capo_fsx.types.update_shared_vpc_configuration_response.UpdateSharedVpcConfigurationResponse = capo_fsx.types.update_shared_vpc_configuration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.update_shared_vpc_configuration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
