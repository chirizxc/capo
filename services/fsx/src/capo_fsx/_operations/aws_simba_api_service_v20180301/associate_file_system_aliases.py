"""Generated from Smithy shape ``com.amazonaws.fsx#AssociateFileSystemAliases``."""
...
def handle_response(
    ...
    out: capo_fsx.types.associate_file_system_aliases_response.AssociateFileSystemAliasesResponse = capo_fsx.types.associate_file_system_aliases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.AssociateFileSystemAliases"
    body: bytes | None = json.dumps(
        capo_fsx.types.associate_file_system_aliases_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_associate_file_system_aliases(
