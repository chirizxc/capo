...
import capo_fsx.errors.backup_being_copied
import capo_fsx.errors.backup_in_progress
import capo_fsx.errors.backup_not_found
import capo_fsx.errors.backup_restoring
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "BackupBeingCopied":
            raise capo_fsx.errors.backup_being_copied.BackupBeingCopied.from_aws_json_1_1(
                data, message
            )
        case "BackupInProgress":
            raise capo_fsx.errors.backup_in_progress.BackupInProgress.from_aws_json_1_1(
                data, message
            )
        case "BackupNotFound":
        ...
        case "BackupRestoring":
            raise capo_fsx.errors.backup_restoring.BackupRestoring.from_aws_json_1_1(
                data, message
            )
        case "BadRequest":
...
def handle_response(
    ...
    out: capo_fsx.types.delete_backup_response.DeleteBackupResponse = (
        capo_fsx.types.delete_backup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.delete_backup_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_backup(
    ...
    input_: capo_fsx.types.delete_backup_request.DeleteBackupRequest,
) -> tuple[capo_fsx.types.delete_backup_response.DeleteBackupResponse, zapros.Response]:
