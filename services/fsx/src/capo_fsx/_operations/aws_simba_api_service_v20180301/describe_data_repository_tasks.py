...
def handle_response(
    ...
    out: capo_fsx.types.describe_data_repository_tasks_response.DescribeDataRepositoryTasksResponse = capo_fsx.types.describe_data_repository_tasks_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.describe_data_repository_tasks_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
