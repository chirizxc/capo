"""Generated from Smithy shape ``com.amazonaws.fsx#DeleteStorageVirtualMachine``."""
...
def handle_response(
    ...
    out: capo_fsx.types.delete_storage_virtual_machine_response.DeleteStorageVirtualMachineResponse = capo_fsx.types.delete_storage_virtual_machine_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.DeleteStorageVirtualMachine"
    body: bytes | None = json.dumps(
        capo_fsx.types.delete_storage_virtual_machine_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_storage_virtual_machine(
