...
def handle_response(
    ...
    out: capo_fsx.types.create_data_repository_association_response.CreateDataRepositoryAssociationResponse = capo_fsx.types.create_data_repository_association_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.create_data_repository_association_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
