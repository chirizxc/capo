...
def handle_response(
    ...
    out: capo_fsx.types.create_snapshot_response.CreateSnapshotResponse = (
        capo_fsx.types.create_snapshot_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.create_snapshot_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_snapshot(
    ...
    capo_fsx.types.create_snapshot_response.CreateSnapshotResponse, zapros.Response
]:
