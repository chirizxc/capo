...
def handle_response(
    ...
    out: capo_fsx.types.detach_and_delete_s3_access_point_response.DetachAndDeleteS3AccessPointResponse = capo_fsx.types.detach_and_delete_s3_access_point_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.detach_and_delete_s3_access_point_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
