"""Generated from Smithy shape ``com.amazonaws.fsx#CreateDataRepositoryTask``."""
...
import capo_fsx.errors.data_repository_task_executing
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DataRepositoryTaskExecuting":
            raise capo_fsx.errors.data_repository_task_executing.DataRepositoryTaskExecuting.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_fsx.types.create_data_repository_task_response.CreateDataRepositoryTaskResponse = capo_fsx.types.create_data_repository_task_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.create_data_repository_task_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_data_repository_task(
