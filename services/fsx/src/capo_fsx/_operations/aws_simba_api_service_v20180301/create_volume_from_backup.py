...
def handle_response(
    ...
    out: capo_fsx.types.create_volume_from_backup_response.CreateVolumeFromBackupResponse = capo_fsx.types.create_volume_from_backup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.create_volume_from_backup_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
