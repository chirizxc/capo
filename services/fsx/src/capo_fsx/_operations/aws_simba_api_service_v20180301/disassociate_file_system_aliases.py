...
def handle_response(
    ...
    out: capo_fsx.types.disassociate_file_system_aliases_response.DisassociateFileSystemAliasesResponse = capo_fsx.types.disassociate_file_system_aliases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.disassociate_file_system_aliases_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
