...
def handle_response(
    ...
    out: capo_fsx.types.delete_volume_response.DeleteVolumeResponse = (
        capo_fsx.types.delete_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.delete_volume_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_volume(
    ...
    input_: capo_fsx.types.delete_volume_request.DeleteVolumeRequest,
) -> tuple[capo_fsx.types.delete_volume_response.DeleteVolumeResponse, zapros.Response]:
