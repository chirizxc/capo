"""Generated from Smithy shape ``com.amazonaws.fsx#DescribeBackups``."""
...
def handle_response(
    ...
    out: capo_fsx.types.describe_backups_response.DescribeBackupsResponse = (
        capo_fsx.types.describe_backups_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.describe_backups_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def describe_backups(
    ...
    capo_fsx.types.describe_backups_response.DescribeBackupsResponse, zapros.Response
]:
