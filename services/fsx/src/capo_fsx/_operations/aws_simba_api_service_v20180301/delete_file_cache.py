"""Generated from Smithy shape ``com.amazonaws.fsx#DeleteFileCache``."""
...
def handle_response(
    ...
    out: capo_fsx.types.delete_file_cache_response.DeleteFileCacheResponse = (
        capo_fsx.types.delete_file_cache_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "AWSSimbaAPIService_v20180301.DeleteFileCache"
    body: bytes | None = json.dumps(
        capo_fsx.types.delete_file_cache_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_file_cache(
    ...
    capo_fsx.types.delete_file_cache_response.DeleteFileCacheResponse, zapros.Response
]:
...
async def async_delete_file_cache(
