...
import capo_fsx.errors.data_repository_association_not_found
import capo_fsx.errors.file_system_not_found
import capo_fsx.errors.internal_server_error
import capo_fsx.errors.invalid_data_repository_type
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "DataRepositoryAssociationNotFound":
            raise capo_fsx.errors.data_repository_association_not_found.DataRepositoryAssociationNotFound.from_aws_json_1_1(
                data, message
            )
        ...
        case "InvalidDataRepositoryType":
            raise capo_fsx.errors.invalid_data_repository_type.InvalidDataRepositoryType.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_fsx.types.describe_data_repository_associations_response.DescribeDataRepositoryAssociationsResponse = capo_fsx.types.describe_data_repository_associations_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.describe_data_repository_associations_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
