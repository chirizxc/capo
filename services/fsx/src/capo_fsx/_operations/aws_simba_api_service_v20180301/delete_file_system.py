"""Generated from Smithy shape ``com.amazonaws.fsx#DeleteFileSystem``."""
...
def handle_response(
    ...
    out: capo_fsx.types.delete_file_system_response.DeleteFileSystemResponse = (
        capo_fsx.types.delete_file_system_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.delete_file_system_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_file_system(
    ...
    capo_fsx.types.delete_file_system_response.DeleteFileSystemResponse, zapros.Response
]:
