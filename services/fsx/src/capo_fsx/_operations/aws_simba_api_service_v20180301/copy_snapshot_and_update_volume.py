...
def handle_response(
    ...
    out: capo_fsx.types.copy_snapshot_and_update_volume_response.CopySnapshotAndUpdateVolumeResponse = capo_fsx.types.copy_snapshot_and_update_volume_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.copy_snapshot_and_update_volume_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
