...
def handle_response(
    ...
    out: capo_fsx.types.describe_file_systems_response.DescribeFileSystemsResponse = (
        capo_fsx.types.describe_file_systems_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.describe_file_systems_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
