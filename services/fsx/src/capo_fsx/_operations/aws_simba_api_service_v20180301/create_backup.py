...
def handle_response(
    ...
    out: capo_fsx.types.create_backup_response.CreateBackupResponse = (
        capo_fsx.types.create_backup_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_fsx.types.create_backup_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_backup(
    ...
    input_: capo_fsx.types.create_backup_request.CreateBackupRequest,
) -> tuple[capo_fsx.types.create_backup_response.CreateBackupResponse, zapros.Response]:
