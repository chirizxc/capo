...
if TYPE_CHECKING:
    import capo_taxsettings.types.individual_registration_number
    import capo_taxsettings.types.poland_tax_registration_number_type


class PolandAdditionalInfo(TypedDict, closed=True):
    individual_registration_number: NotRequired[
        "capo_taxsettings.types.individual_registration_number.IndividualRegistrationNumber"
    ]
    ...
    tax_registration_number_type: NotRequired[
        "capo_taxsettings.types.poland_tax_registration_number_type.PolandTaxRegistrationNumberType"
    ]
...
def serialize_json(value: PolandAdditionalInfo) -> dict:
    ...
    if "tax_registration_number_type" in value:
        ...
        out["taxRegistrationNumberType"] = (
            capo_taxsettings.types.poland_tax_registration_number_type.serialize_json(
...
def deserialize_json(data: dict) -> PolandAdditionalInfo:
    ...
    if data.get("taxRegistrationNumberType") is not None:
        ...
        out["tax_registration_number_type"] = (
            capo_taxsettings.types.poland_tax_registration_number_type.deserialize_json(
