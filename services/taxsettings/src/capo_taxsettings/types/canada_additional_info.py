...
if TYPE_CHECKING:
    import capo_taxsettings.types.canada_provincial_sales_tax_id_string
    import capo_taxsettings.types.canada_quebec_sales_tax_number_string
    import capo_taxsettings.types.canada_retail_sales_tax_number_string


class CanadaAdditionalInfo(TypedDict, closed=True):
    provincial_sales_tax_id: NotRequired[
        "capo_taxsettings.types.canada_provincial_sales_tax_id_string.CanadaProvincialSalesTaxIdString"
    ]
    ...
    canada_quebec_sales_tax_number: NotRequired[
        "capo_taxsettings.types.canada_quebec_sales_tax_number_string.CanadaQuebecSalesTaxNumberString"
    ]
    ...
    canada_retail_sales_tax_number: NotRequired[
        "capo_taxsettings.types.canada_retail_sales_tax_number_string.CanadaRetailSalesTaxNumberString"
    ]
