...
if TYPE_CHECKING:
    import capo_taxsettings.types.cig_number
    import capo_taxsettings.types.cup_number
    import capo_taxsettings.types.customer_type
    import capo_taxsettings.types.sdi_account_id
    import capo_taxsettings.types.tax_code


class ItalyAdditionalInfo(TypedDict, closed=True):
    sdi_account_id: NotRequired["capo_taxsettings.types.sdi_account_id.SdiAccountId"]
    ...
    cig_number: NotRequired["capo_taxsettings.types.cig_number.CigNumber"]
    """<p> The tender procedure identification code. </p>"""
    cup_number: NotRequired["capo_taxsettings.types.cup_number.CupNumber"]
    ...
    tax_code: NotRequired["capo_taxsettings.types.tax_code.TaxCode"]
    """<p>List of service tax codes for your TRN in Italy. You can use your customer tax code as part of a VAT Group. </p>"""
    customer_type: NotRequired["capo_taxsettings.types.customer_type.CustomerType"]
...
def serialize_json(value: ItalyAdditionalInfo) -> dict:
    ...
    if "customer_type" in value:
        ...
        out["customerType"] = capo_taxsettings.types.customer_type.serialize_json(
            value["customer_type"]
        )
    return out
