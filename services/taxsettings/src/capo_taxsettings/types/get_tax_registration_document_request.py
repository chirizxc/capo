...
def serialize_json(value: GetTaxRegistrationDocumentRequest) -> dict:
    ...
    if "destination_s3_location" in value:
        ...
        out["destinationS3Location"] = (
            capo_taxsettings.types.destination_s3_location.serialize_json(
    ...
    out["taxDocumentMetadata"] = (
        capo_taxsettings.types.tax_document_metadata.serialize_json(
...
def deserialize_json(data: dict) -> GetTaxRegistrationDocumentRequest:
    ...
    if data.get("destinationS3Location") is not None:
        ...
        out["destination_s3_location"] = (
            capo_taxsettings.types.destination_s3_location.deserialize_json(
    ...
    if data.get("taxDocumentMetadata") is not None:
        ...
        out["tax_document_metadata"] = (
            capo_taxsettings.types.tax_document_metadata.deserialize_json(
