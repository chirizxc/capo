...
from capo_taxsettings._services._aws_config import aws_config
...
class TaxSettingsClientConfig(TypedDict, total=False, closed=True):
...
class TaxSettingsClient:
    ...
    def batch_delete_tax_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.batch_delete_tax_registration_request.BatchDeleteTaxRegistrationRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.batch_delete_tax_registration_response.BatchDeleteTaxRegistrationResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.batch_delete_tax_registration.batch_delete_tax_registration(
    ...
    def batch_get_tax_exemptions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.batch_get_tax_exemptions_request.BatchGetTaxExemptionsRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.batch_get_tax_exemptions_response.BatchGetTaxExemptionsResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.batch_get_tax_exemptions.batch_get_tax_exemptions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def batch_put_tax_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.batch_put_tax_registration_request.BatchPutTaxRegistrationRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.batch_put_tax_registration_response.BatchPutTaxRegistrationResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.batch_put_tax_registration.batch_put_tax_registration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_supplemental_tax_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.delete_supplemental_tax_registration_request.DeleteSupplementalTaxRegistrationRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.delete_supplemental_tax_registration_response.DeleteSupplementalTaxRegistrationResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.delete_supplemental_tax_registration.delete_supplemental_tax_registration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_tax_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.delete_tax_registration_request.DeleteTaxRegistrationRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.delete_tax_registration_response.DeleteTaxRegistrationResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.delete_tax_registration.delete_tax_registration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_tax_exemption_types(
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.get_tax_exemption_types_request.GetTaxExemptionTypesRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.get_tax_exemption_types_response.GetTaxExemptionTypesResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.get_tax_exemption_types.get_tax_exemption_types(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_tax_inheritance(
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.get_tax_inheritance_request.GetTaxInheritanceRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.get_tax_inheritance_response.GetTaxInheritanceResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.get_tax_inheritance.get_tax_inheritance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_tax_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.get_tax_registration_request.GetTaxRegistrationRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.get_tax_registration_response.GetTaxRegistrationResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.get_tax_registration.get_tax_registration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_tax_registration_document(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.get_tax_registration_document_request.GetTaxRegistrationDocumentRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.get_tax_registration_document_response.GetTaxRegistrationDocumentResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.get_tax_registration_document.get_tax_registration_document(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_supplemental_tax_registrations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.list_supplemental_tax_registrations_request.ListSupplementalTaxRegistrationsRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.list_supplemental_tax_registrations_response.ListSupplementalTaxRegistrationsResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.list_supplemental_tax_registrations.list_supplemental_tax_registrations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_taxsettings.types.supplemental_tax_registration.SupplementalTaxRegistration]":
        _token = next_token
        while True:
    ...
    def list_tax_exemptions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.list_tax_exemptions_request.ListTaxExemptionsRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.list_tax_exemptions_response.ListTaxExemptionsResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.list_tax_exemptions.list_tax_exemptions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[tuple[capo_taxsettings.types.account_id.AccountId, capo_taxsettings.types.tax_exemption_details.TaxExemptionDetails]]":
        _token = next_token
        while True:
    ...
    def list_tax_registrations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.list_tax_registrations_request.ListTaxRegistrationsRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.list_tax_registrations_response.ListTaxRegistrationsResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.list_tax_registrations.list_tax_registrations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_taxsettings.types.account_details.AccountDetails]":
        _token = next_token
        while True:
    ...
    def put_supplemental_tax_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.put_supplemental_tax_registration_request.PutSupplementalTaxRegistrationRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.put_supplemental_tax_registration_response.PutSupplementalTaxRegistrationResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.put_supplemental_tax_registration.put_supplemental_tax_registration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_tax_exemption(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.put_tax_exemption_request.PutTaxExemptionRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.put_tax_exemption_response.PutTaxExemptionResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.put_tax_exemption.put_tax_exemption(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_tax_inheritance(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.put_tax_inheritance_request.PutTaxInheritanceRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.put_tax_inheritance_response.PutTaxInheritanceResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.put_tax_inheritance.put_tax_inheritance(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def put_tax_registration(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_taxsettings.types.put_tax_registration_request.PutTaxRegistrationRequest]",
        ) -> OperationResponse[
            "capo_taxsettings.types.put_tax_registration_response.PutTaxRegistrationResponse"
        ]:
            ...
            output, http_response = (
                capo_taxsettings._operations.tax_settings.put_tax_registration.put_tax_registration(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
