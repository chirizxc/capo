...
def handle_response(
    ...
    out: capo_arc_region_switch.types.list_route53_health_checks_response.ListRoute53HealthChecksResponse = capo_arc_region_switch.types.list_route53_health_checks_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.list_route53_health_checks_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
