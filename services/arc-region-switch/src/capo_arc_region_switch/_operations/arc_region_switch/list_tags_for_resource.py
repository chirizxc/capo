...
def handle_response(
    ...
    out: capo_arc_region_switch.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_arc_region_switch.types.list_tags_for_resource_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.list_tags_for_resource_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
