...
def handle_response(
    ...
    out: capo_arc_region_switch.types.get_plan_evaluation_status_response.GetPlanEvaluationStatusResponse = capo_arc_region_switch.types.get_plan_evaluation_status_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.get_plan_evaluation_status_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
