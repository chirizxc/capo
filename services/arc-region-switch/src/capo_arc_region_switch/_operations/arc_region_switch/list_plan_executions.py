...
def handle_response(
    ...
    out: capo_arc_region_switch.types.list_plan_executions_response.ListPlanExecutionsResponse = capo_arc_region_switch.types.list_plan_executions_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.list_plan_executions_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
