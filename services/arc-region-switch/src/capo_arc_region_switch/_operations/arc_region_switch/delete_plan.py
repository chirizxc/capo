"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#DeletePlan``."""
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.delete_plan_response.DeletePlanResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.DeletePlan"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.delete_plan_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
