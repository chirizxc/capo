...
def handle_response(
    ...
    out: capo_arc_region_switch.types.update_plan_response.UpdatePlanResponse = (
        capo_arc_region_switch.types.update_plan_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.update_plan_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
