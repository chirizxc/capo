"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#CancelPlanExecution``."""
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.cancel_plan_execution_response.CancelPlanExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.CancelPlanExecution"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.cancel_plan_execution_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_cancel_plan_execution(
