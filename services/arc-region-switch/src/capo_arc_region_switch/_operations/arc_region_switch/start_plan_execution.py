"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#StartPlanExecution``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "IllegalArgumentException":
            raise capo_arc_region_switch.errors.illegal_argument_exception.IllegalArgumentException.from_aws_json_1_0(
                data, message
            )
...
def handle_response(
    ...
    out: capo_arc_region_switch.types.start_plan_execution_response.StartPlanExecutionResponse = capo_arc_region_switch.types.start_plan_execution_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ArcRegionSwitch.StartPlanExecution"
    body: bytes | None = json.dumps(
        capo_arc_region_switch.types.start_plan_execution_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_plan_execution(
