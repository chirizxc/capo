"""Generated from Smithy shape ``com.amazonaws.arcregionswitch#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.arcregionswitch#InternalServerException``."""
