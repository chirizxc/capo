"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockdataautomation#ResourceNotFoundException``."""
