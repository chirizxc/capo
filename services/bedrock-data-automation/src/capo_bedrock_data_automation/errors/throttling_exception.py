"""Generated from Smithy shape ``com.amazonaws.bedrockdataautomation#ThrottlingException``."""
...
class ThrottlingException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.bedrockdataautomation#ThrottlingException``."""
