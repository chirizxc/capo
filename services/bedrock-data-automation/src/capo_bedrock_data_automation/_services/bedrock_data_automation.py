...
class BedrockDataAutomationClient:
    ...
    ) -> "Iterator[capo_bedrock_data_automation.types.blueprint_summary.BlueprintSummary]":
        _token = next_token
        while True:
    ...
    def iter_list_data_automation_library_ingestion_jobs(
        self,
        library_arn: "capo_bedrock_data_automation.types.data_automation_library_arn.DataAutomationLibraryArn",
        *,
        config_overrides: Optional[BedrockDataAutomationClientConfig] = None,
    ...
    ) -> "Iterator[capo_bedrock_data_automation.types.data_automation_library_ingestion_job_summary.DataAutomationLibraryIngestionJobSummary]":
        _token = next_token
        while True:
            _response = self.list_data_automation_library_ingestion_jobs(
                library_arn,
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
    ...
    def iter_list_data_automation_libraries(
        self,
        *,
        config_overrides: Optional[BedrockDataAutomationClientConfig] = None,
        max_results: Optional[
    ...
    ) -> "Iterator[capo_bedrock_data_automation.types.data_automation_library_summary.DataAutomationLibrarySummary]":
        _token = next_token
        while True:
            _response = self.list_data_automation_libraries(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
                project_filter=project_filter,
    ...
    def iter_list_data_automation_projects(
        self,
        *,
        config_overrides: Optional[BedrockDataAutomationClientConfig] = None,
        max_results: Optional[
    ...
    ) -> "Iterator[capo_bedrock_data_automation.types.data_automation_project_summary.DataAutomationProjectSummary]":
        _token = next_token
        while True:
            _response = self.list_data_automation_projects(
                config_overrides=config_overrides,
                max_results=max_results,
                next_token=_token,
