...
class AsyncSageMakerFeatureStoreRuntimeClient:
    ...
    async def batch_get_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sagemaker_featurestore_runtime.types.batch_get_record_request.BatchGetRecordRequest]",
        ) -> AsyncOperationResponse[
            "capo_sagemaker_featurestore_runtime.types.batch_get_record_response.BatchGetRecordResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.batch_get_record.async_batch_get_record(
    ...
    async def delete_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sagemaker_featurestore_runtime.types.delete_record_request.DeleteRecordRequest]",
            ...
            (
                output,
                http_response,
            ) = await capo_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.delete_record.async_delete_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sagemaker_featurestore_runtime.types.get_record_request.GetRecordRequest]",
        ) -> AsyncOperationResponse[
            "capo_sagemaker_featurestore_runtime.types.get_record_response.GetRecordResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.get_record.async_get_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def put_record(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_sagemaker_featurestore_runtime.types.put_record_request.PutRecordRequest]",
        ) -> AsyncOperationResponse[None]:
            ...
            (
                output,
                http_response,
            ) = await capo_sagemaker_featurestore_runtime._operations.amazon_sage_maker_feature_store_runtime.put_record.async_put_record(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
