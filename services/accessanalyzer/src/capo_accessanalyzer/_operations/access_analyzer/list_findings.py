...
def handle_response(
    ...
    out: capo_accessanalyzer.types.list_findings_response.ListFindingsResponse = (
        capo_accessanalyzer.types.list_findings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.list_findings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
