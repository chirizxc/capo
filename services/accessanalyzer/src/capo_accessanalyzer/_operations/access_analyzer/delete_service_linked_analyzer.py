"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#DeleteServiceLinkedAnalyzer``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/service-linked-analyzer/{analyzerName}"
...
async def async_delete_service_linked_analyzer(
