"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GetAccessPreview``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.get_access_preview_response.GetAccessPreviewResponse = capo_accessanalyzer.types.get_access_preview_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{accessPreviewId}", quote(input_["access_preview_id"], safe=""))
    params: list[tuple[str, str]] = []
    if "analyzer_arn" in input_:
        params.append(("analyzerArn", input_["analyzer_arn"]))
...
async def async_get_access_preview(
