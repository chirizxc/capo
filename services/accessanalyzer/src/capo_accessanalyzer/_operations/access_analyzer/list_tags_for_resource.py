"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_accessanalyzer.types.list_tags_for_resource_response.deserialize_json(
