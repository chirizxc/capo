"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ListAnalyzers``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.list_analyzers_response.ListAnalyzersResponse = (
        capo_accessanalyzer.types.list_analyzers_response.deserialize_json(
...
async def async_list_analyzers(
