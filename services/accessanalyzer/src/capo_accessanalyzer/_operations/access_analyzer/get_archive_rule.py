"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GetArchiveRule``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.get_archive_rule_response.GetArchiveRuleResponse = (
        capo_accessanalyzer.types.get_archive_rule_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{ruleName}", quote(input_["rule_name"], safe=""))
...
async def async_get_archive_rule(
