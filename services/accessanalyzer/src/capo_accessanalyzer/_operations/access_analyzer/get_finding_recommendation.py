"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GetFindingRecommendation``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.get_finding_recommendation_response.GetFindingRecommendationResponse = capo_accessanalyzer.types.get_finding_recommendation_response.deserialize_json(
...
async def async_get_finding_recommendation(
