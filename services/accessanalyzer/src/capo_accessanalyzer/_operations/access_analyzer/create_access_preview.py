...
def handle_response(
    ...
    out: capo_accessanalyzer.types.create_access_preview_response.CreateAccessPreviewResponse = capo_accessanalyzer.types.create_access_preview_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.create_access_preview_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
