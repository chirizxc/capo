"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#CreateArchiveRule``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.create_archive_rule_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_archive_rule(
