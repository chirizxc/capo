"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GetAnalyzer``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.get_analyzer_response.GetAnalyzerResponse = (
        capo_accessanalyzer.types.get_analyzer_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{analyzerName}", quote(input_["analyzer_name"], safe=""))
...
def get_analyzer(
    ...
    capo_accessanalyzer.types.get_analyzer_response.GetAnalyzerResponse, zapros.Response
]:
