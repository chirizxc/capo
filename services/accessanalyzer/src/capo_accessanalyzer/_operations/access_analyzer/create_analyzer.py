...
def handle_response(
    ...
    out: capo_accessanalyzer.types.create_analyzer_response.CreateAnalyzerResponse = (
        capo_accessanalyzer.types.create_analyzer_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.create_analyzer_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
