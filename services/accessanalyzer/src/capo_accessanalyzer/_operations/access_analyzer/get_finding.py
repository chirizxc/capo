...
def handle_response(
    ...
    out: capo_accessanalyzer.types.get_finding_response.GetFindingResponse = (
        capo_accessanalyzer.types.get_finding_response.deserialize_json(
...
def get_finding(
    ...
    capo_accessanalyzer.types.get_finding_response.GetFindingResponse, zapros.Response
]:
