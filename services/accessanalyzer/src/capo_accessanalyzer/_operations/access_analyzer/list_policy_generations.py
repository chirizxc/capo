...
def handle_response(
    ...
    out: capo_accessanalyzer.types.list_policy_generations_response.ListPolicyGenerationsResponse = capo_accessanalyzer.types.list_policy_generations_response.deserialize_json(
...
def build_request(
    ...
    if "principal_arn" in input_:
        params.append(("principalArn", input_["principal_arn"]))
