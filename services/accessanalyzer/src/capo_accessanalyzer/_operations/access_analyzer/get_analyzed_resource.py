"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#GetAnalyzedResource``."""
...
def handle_response(
    ...
    out: capo_accessanalyzer.types.get_analyzed_resource_response.GetAnalyzedResourceResponse = capo_accessanalyzer.types.get_analyzed_resource_response.deserialize_json(
...
async def async_get_analyzed_resource(
