...
def handle_response(
    ...
    out: capo_accessanalyzer.types.start_policy_generation_response.StartPolicyGenerationResponse = capo_accessanalyzer.types.start_policy_generation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_accessanalyzer.types.start_policy_generation_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
