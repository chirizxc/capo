...
if TYPE_CHECKING:
    import capo_accessanalyzer.types.internal_access_resource_type_details
...
InternalAccessResourceTypeStatisticsMap: TypeAlias = dict[
    ...
    "capo_accessanalyzer.types.internal_access_resource_type_details.InternalAccessResourceTypeDetails",
]
...
def serialize_json(input_to_serialize: InternalAccessResourceTypeStatisticsMap) -> dict:
    ...
    for key, value in input_to_serialize.items():
        ...
        out[key] = (
            capo_accessanalyzer.types.internal_access_resource_type_details.serialize_json(
                value
            )
        )
    return out
...
def deserialize_json(data: dict) -> InternalAccessResourceTypeStatisticsMap:
    ...
    for key, value in data.items():
        ...
        out[key] = (
            capo_accessanalyzer.types.internal_access_resource_type_details.deserialize_json(
                value
            )
        )
    return out
