"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.accessanalyzer#AccessDeniedException``."""
