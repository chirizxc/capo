"""Generated from Smithy shape ``com.amazonaws.accessanalyzer#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.accessanalyzer#ConflictException``."""
