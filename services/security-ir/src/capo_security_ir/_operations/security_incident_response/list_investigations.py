"""Generated from Smithy shape ``com.amazonaws.securityir#ListInvestigations``."""
...
def handle_response(
    ...
    out: capo_security_ir.types.list_investigations_response.ListInvestigationsResponse = capo_security_ir.types.list_investigations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/cases/{caseId}/list-investigations"
