...
def handle_response(
    ...
    out: capo_security_ir.types.create_case_response.CreateCaseResponse = (
        capo_security_ir.types.create_case_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_security_ir.types.create_case_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_case(
    ...
    capo_security_ir.types.create_case_response.CreateCaseResponse, zapros.Response
]:
