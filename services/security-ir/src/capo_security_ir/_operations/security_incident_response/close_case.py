"""Generated from Smithy shape ``com.amazonaws.securityir#CloseCase``."""
...
def handle_response(
    ...
    out: capo_security_ir.types.close_case_response.CloseCaseResponse = (
        capo_security_ir.types.close_case_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/cases/{caseId}/close-case"
...
def close_case(
    ...
    capo_security_ir.types.close_case_response.CloseCaseResponse, zapros.Response
]:
