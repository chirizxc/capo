"""Generated from Smithy shape ``com.amazonaws.securityir#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.securityir#ResourceNotFoundException``."""
