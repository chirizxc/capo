...
from capo_security_ir._resources.security_incident_response.case import AsyncCase
from capo_security_ir._resources.security_incident_response.membership import (
    AsyncMembership,
)
from capo_security_ir._services._aws_config import aaws_config
...
class AsyncSecurityIRClientConfig(TypedDict, total=False, closed=True):
...
class AsyncSecurityIRClient:
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_security_ir.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_security_ir.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_security_ir._operations.security_incident_response.list_tags_for_resource.async_list_tags_for_resource(
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_security_ir.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_security_ir.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_security_ir._operations.security_incident_response.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_security_ir.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_security_ir.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_security_ir._operations.security_incident_response.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
