"""Generated from Smithy shape ``com.amazonaws.dataexchange#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.dataexchange#AccessDeniedException``."""
