"""Generated from Smithy shape ``com.amazonaws.dataexchange#CreateRevisionResponse``."""
...
class CreateRevisionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateRevisionResponse) -> dict:
    out: dict = {}
    if "arn" in value:
        out["Arn"] = value["arn"]
    if "comment" in value:
