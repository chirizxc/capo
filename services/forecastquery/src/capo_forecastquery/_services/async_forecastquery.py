...
from capo_forecastquery._services._aws_config import aaws_config
...
class AsyncforecastqueryClient:
    ...
    async def query_forecast(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_forecastquery.types.query_forecast_request.QueryForecastRequest]",
        ) -> AsyncOperationResponse[
            "capo_forecastquery.types.query_forecast_response.QueryForecastResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_forecastquery._operations.amazon_forecast_runtime.query_forecast.async_query_forecast(
    ...
    async def query_what_if_forecast(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_forecastquery.types.query_what_if_forecast_request.QueryWhatIfForecastRequest]",
        ) -> AsyncOperationResponse[
            "capo_forecastquery.types.query_what_if_forecast_response.QueryWhatIfForecastResponse"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_forecastquery._operations.amazon_forecast_runtime.query_what_if_forecast.async_query_what_if_forecast(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
