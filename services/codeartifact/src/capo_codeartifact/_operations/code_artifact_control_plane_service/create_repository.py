"""Generated from Smithy shape ``com.amazonaws.codeartifact#CreateRepository``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.create_repository_result.CreateRepositoryResult = (
        capo_codeartifact.types.create_repository_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.create_repository_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
