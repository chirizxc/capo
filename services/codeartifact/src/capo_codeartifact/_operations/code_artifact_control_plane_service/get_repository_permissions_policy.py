...
def handle_response(
    ...
    out: capo_codeartifact.types.get_repository_permissions_policy_result.GetRepositoryPermissionsPolicyResult = capo_codeartifact.types.get_repository_permissions_policy_result.deserialize_json(
