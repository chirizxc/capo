"""Generated from Smithy shape ``com.amazonaws.codeartifact#GetAssociatedPackageGroup``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.get_associated_package_group_result.GetAssociatedPackageGroupResult = capo_codeartifact.types.get_associated_package_group_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/get-associated-package-group"
...
async def async_get_associated_package_group(
