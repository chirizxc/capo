"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListSubPackageGroups``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.list_sub_package_groups_result.ListSubPackageGroupsResult = capo_codeartifact.types.list_sub_package_groups_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package-groups/sub-groups"
...
async def async_list_sub_package_groups(
