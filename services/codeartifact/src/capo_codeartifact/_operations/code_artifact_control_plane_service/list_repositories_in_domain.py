...
def handle_response(
    ...
    out: capo_codeartifact.types.list_repositories_in_domain_result.ListRepositoriesInDomainResult = capo_codeartifact.types.list_repositories_in_domain_result.deserialize_json(
...
def build_request(
    ...
    if "administrator_account" in input_:
        params.append(("administrator-account", input_["administrator_account"]))
