"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListPackageGroups``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.list_package_groups_result.ListPackageGroupsResult = (
        capo_codeartifact.types.list_package_groups_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/package-groups"
...
async def async_list_package_groups(
