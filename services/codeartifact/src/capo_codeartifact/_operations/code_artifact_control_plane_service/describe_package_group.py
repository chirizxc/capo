...
def handle_response(
    ...
    out: capo_codeartifact.types.describe_package_group_result.DescribePackageGroupResult = capo_codeartifact.types.describe_package_group_result.deserialize_json(
