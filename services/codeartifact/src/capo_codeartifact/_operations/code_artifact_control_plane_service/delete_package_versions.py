...
def handle_response(
    ...
    out: capo_codeartifact.types.delete_package_versions_result.DeletePackageVersionsResult = capo_codeartifact.types.delete_package_versions_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codeartifact.types.delete_package_versions_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
