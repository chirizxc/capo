...
def handle_response(
    ...
    out: capo_codeartifact.types.delete_repository_permissions_policy_result.DeleteRepositoryPermissionsPolicyResult = capo_codeartifact.types.delete_repository_permissions_policy_result.deserialize_json(
...
def build_request(
    ...
    if "policy_revision" in input_:
        params.append(("policy-revision", input_["policy_revision"]))
