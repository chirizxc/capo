"""Generated from Smithy shape ``com.amazonaws.codeartifact#ListRepositories``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.list_repositories_result.ListRepositoriesResult = (
        capo_codeartifact.types.list_repositories_result.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/repositories"
    params: list[tuple[str, str]] = []
    if "repository_prefix" in input_:
        params.append(("repository-prefix", input_["repository_prefix"]))
