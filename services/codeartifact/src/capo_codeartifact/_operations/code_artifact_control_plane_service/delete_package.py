...
def handle_response(
    ...
    out: capo_codeartifact.types.delete_package_result.DeletePackageResult = (
        capo_codeartifact.types.delete_package_result.deserialize_json(
...
def delete_package(
    ...
    capo_codeartifact.types.delete_package_result.DeletePackageResult, zapros.Response
]:
