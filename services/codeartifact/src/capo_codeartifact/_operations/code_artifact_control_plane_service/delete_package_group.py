"""Generated from Smithy shape ``com.amazonaws.codeartifact#DeletePackageGroup``."""
...
def handle_response(
    ...
    out: capo_codeartifact.types.delete_package_group_result.DeletePackageGroupResult = capo_codeartifact.types.delete_package_group_result.deserialize_json(
...
async def async_delete_package_group(
