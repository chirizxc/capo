...
def handle_response(
    ...
    out: capo_payment_cryptography.types.import_key_output.ImportKeyOutput = (
        capo_payment_cryptography.types.import_key_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.import_key_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def import_key(
    ...
    capo_payment_cryptography.types.import_key_output.ImportKeyOutput, zapros.Response
]:
