...
def handle_response(
    ...
    out: capo_payment_cryptography.types.get_alias_output.GetAliasOutput = (
        capo_payment_cryptography.types.get_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.get_alias_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_alias(
    ...
    capo_payment_cryptography.types.get_alias_output.GetAliasOutput, zapros.Response
]:
