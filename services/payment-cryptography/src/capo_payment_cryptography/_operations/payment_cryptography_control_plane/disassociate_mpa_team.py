"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#DisassociateMpaTeam``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.disassociate_mpa_team_output.DisassociateMpaTeamOutput = capo_payment_cryptography.types.disassociate_mpa_team_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.DisassociateMpaTeam"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.disassociate_mpa_team_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_mpa_team(
