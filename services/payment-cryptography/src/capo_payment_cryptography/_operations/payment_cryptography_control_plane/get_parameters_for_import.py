...
def handle_response(
    ...
    out: capo_payment_cryptography.types.get_parameters_for_import_output.GetParametersForImportOutput = capo_payment_cryptography.types.get_parameters_for_import_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.get_parameters_for_import_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
