"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#DeleteAlias``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.delete_alias_output.DeleteAliasOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.DeleteAlias"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.delete_alias_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
