...
def handle_response(
    ...
    out: capo_payment_cryptography.types.list_keys_output.ListKeysOutput = (
        capo_payment_cryptography.types.list_keys_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.list_keys_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_keys(
    ...
    capo_payment_cryptography.types.list_keys_output.ListKeysOutput, zapros.Response
]:
