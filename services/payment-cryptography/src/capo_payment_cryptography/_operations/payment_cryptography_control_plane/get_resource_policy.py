"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.get_resource_policy_output.GetResourcePolicyOutput = capo_payment_cryptography.types.get_resource_policy_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.GetResourcePolicy"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.get_resource_policy_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
