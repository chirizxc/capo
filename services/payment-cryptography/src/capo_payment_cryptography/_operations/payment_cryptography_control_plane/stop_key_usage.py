"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#StopKeyUsage``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.stop_key_usage_output.StopKeyUsageOutput = (
        capo_payment_cryptography.types.stop_key_usage_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.StopKeyUsage"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.stop_key_usage_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_stop_key_usage(
