"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#ExportKey``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.export_key_output.ExportKeyOutput = (
        capo_payment_cryptography.types.export_key_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.ExportKey"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.export_key_input.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def export_key(
    ...
    capo_payment_cryptography.types.export_key_output.ExportKeyOutput, zapros.Response
]:
