"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#AddKeyReplicationRegions``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.add_key_replication_regions_output.AddKeyReplicationRegionsOutput = capo_payment_cryptography.types.add_key_replication_regions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.AddKeyReplicationRegions"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.add_key_replication_regions_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_add_key_replication_regions(
