"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#GetDefaultKeyReplicationRegions``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.get_default_key_replication_regions_output.GetDefaultKeyReplicationRegionsOutput = capo_payment_cryptography.types.get_default_key_replication_regions_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.get_default_key_replication_regions_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_default_key_replication_regions(
