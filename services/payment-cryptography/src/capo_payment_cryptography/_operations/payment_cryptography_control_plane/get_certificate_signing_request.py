"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#GetCertificateSigningRequest``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.get_certificate_signing_request_output.GetCertificateSigningRequestOutput = capo_payment_cryptography.types.get_certificate_signing_request_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.get_certificate_signing_request_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_certificate_signing_request(
