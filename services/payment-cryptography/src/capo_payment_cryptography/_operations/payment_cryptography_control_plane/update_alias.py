"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#UpdateAlias``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.update_alias_output.UpdateAliasOutput = (
        capo_payment_cryptography.types.update_alias_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.UpdateAlias"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.update_alias_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
