...
def handle_response(
    ...
    out: capo_payment_cryptography.types.list_aliases_output.ListAliasesOutput = (
        capo_payment_cryptography.types.list_aliases_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.list_aliases_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
