"""Generated from Smithy shape ``com.amazonaws.paymentcryptography#RestoreKey``."""
...
def handle_response(
    ...
    out: capo_payment_cryptography.types.restore_key_output.RestoreKeyOutput = (
        capo_payment_cryptography.types.restore_key_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "PaymentCryptographyControlPlane.RestoreKey"
    body: bytes | None = json.dumps(
        capo_payment_cryptography.types.restore_key_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
def restore_key(
    ...
    capo_payment_cryptography.types.restore_key_output.RestoreKeyOutput, zapros.Response
]:
