...
from capo_payment_cryptography._services._aws_config import aaws_config
...
class AsyncPaymentCryptographyClient:
    ...
    async def associate_mpa_team(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.associate_mpa_team_input.AssociateMpaTeamInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.associate_mpa_team_output.AssociateMpaTeamOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.associate_mpa_team.async_associate_mpa_team(
    ...
    async def delete_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.delete_resource_policy_input.DeleteResourcePolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.delete_resource_policy_output.DeleteResourcePolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.delete_resource_policy.async_delete_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disable_default_key_replication_regions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.disable_default_key_replication_regions_input.DisableDefaultKeyReplicationRegionsInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.disable_default_key_replication_regions_output.DisableDefaultKeyReplicationRegionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.disable_default_key_replication_regions.async_disable_default_key_replication_regions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def disassociate_mpa_team(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.disassociate_mpa_team_input.DisassociateMpaTeamInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.disassociate_mpa_team_output.DisassociateMpaTeamOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.disassociate_mpa_team.async_disassociate_mpa_team(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def enable_default_key_replication_regions(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.enable_default_key_replication_regions_input.EnableDefaultKeyReplicationRegionsInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.enable_default_key_replication_regions_output.EnableDefaultKeyReplicationRegionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.enable_default_key_replication_regions.async_enable_default_key_replication_regions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def export_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.export_key_input.ExportKeyInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.export_key_output.ExportKeyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.export_key.async_export_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_certificate_signing_request(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.get_certificate_signing_request_input.GetCertificateSigningRequestInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.get_certificate_signing_request_output.GetCertificateSigningRequestOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.get_certificate_signing_request.async_get_certificate_signing_request(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_default_key_replication_regions(
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.get_default_key_replication_regions_input.GetDefaultKeyReplicationRegionsInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.get_default_key_replication_regions_output.GetDefaultKeyReplicationRegionsOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.get_default_key_replication_regions.async_get_default_key_replication_regions(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_mpa_team_association(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.get_mpa_team_association_input.GetMpaTeamAssociationInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.get_mpa_team_association_output.GetMpaTeamAssociationOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.get_mpa_team_association.async_get_mpa_team_association(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_parameters_for_export(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.get_parameters_for_export_input.GetParametersForExportInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.get_parameters_for_export_output.GetParametersForExportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.get_parameters_for_export.async_get_parameters_for_export(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_parameters_for_import(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.get_parameters_for_import_input.GetParametersForImportInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.get_parameters_for_import_output.GetParametersForImportOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.get_parameters_for_import.async_get_parameters_for_import(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_public_key_certificate(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.get_public_key_certificate_input.GetPublicKeyCertificateInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.get_public_key_certificate_output.GetPublicKeyCertificateOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.get_public_key_certificate.async_get_public_key_certificate(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def get_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.get_resource_policy_input.GetResourcePolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.get_resource_policy_output.GetResourcePolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.get_resource_policy.async_get_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def import_key(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.import_key_input.ImportKeyInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.import_key_output.ImportKeyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.import_key.async_import_key(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list_tags_for_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.list_tags_for_resource_output.ListTagsForResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.list_tags_for_resource.async_list_tags_for_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    ) -> "AsyncIterator[capo_payment_cryptography.types.tag.Tag]":
        _token = next_token
        while True:
    ...
    async def put_resource_policy(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.put_resource_policy_input.PutResourcePolicyInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.put_resource_policy_output.PutResourcePolicyOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.put_resource_policy.async_put_resource_policy(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def tag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.tag_resource_input.TagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.tag_resource_output.TagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.tag_resource.async_tag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def untag_resource(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_payment_cryptography.types.untag_resource_input.UntagResourceInput]",
        ) -> AsyncOperationResponse[
            "capo_payment_cryptography.types.untag_resource_output.UntagResourceOutput"
        ]:
            ...
            (
                output,
                http_response,
            ) = await capo_payment_cryptography._operations.payment_cryptography_control_plane.untag_resource.async_untag_resource(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
