...
class ExportAttributes(TypedDict, closed=True):
    export_dukpt_initial_key: NotRequired[
        "capo_payment_cryptography.types.export_dukpt_initial_key.ExportDukptInitialKey"
    ]
...
def serialize_aws_json_1_0(value: ExportAttributes) -> dict:
    ...
    if "export_dukpt_initial_key" in value:
        ...
        out["ExportDukptInitialKey"] = (
            capo_payment_cryptography.types.export_dukpt_initial_key.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> ExportAttributes:
    ...
    if data.get("ExportDukptInitialKey") is not None:
        ...
        out["export_dukpt_initial_key"] = (
            capo_payment_cryptography.types.export_dukpt_initial_key.deserialize_aws_json_1_0(
