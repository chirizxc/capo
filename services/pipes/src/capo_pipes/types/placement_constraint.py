...
if TYPE_CHECKING:
    import capo_pipes.types.placement_constraint_expression
    import capo_pipes.types.placement_constraint_type


class PlacementConstraint(TypedDict, closed=True):
    type: NotRequired[
        "capo_pipes.types.placement_constraint_type.PlacementConstraintType"
    ]
    ...
    expression: NotRequired[
        "capo_pipes.types.placement_constraint_expression.PlacementConstraintExpression"
    ]
