...
class EcsContainerOverride(TypedDict, closed=True):
    ...
    environment: NotRequired[
        "capo_pipes.types.ecs_environment_variable_list.EcsEnvironmentVariableList"
    ]
    ...
    environment_files: NotRequired[
        "capo_pipes.types.ecs_environment_file_list.EcsEnvironmentFileList"
    ]
    ...
    name: NotRequired["capo_pipes.types.string.String"]
    ...
    resource_requirements: NotRequired[
        "capo_pipes.types.ecs_resource_requirements_list.EcsResourceRequirementsList"
    ]
...
def serialize_json(value: EcsContainerOverride) -> dict:
    ...
    if "environment" in value:
        ...
        out["Environment"] = (
            capo_pipes.types.ecs_environment_variable_list.serialize_json(
                value["environment"]
            )
        )
    if "environment_files" in value:
        ...
        out["EnvironmentFiles"] = (
            capo_pipes.types.ecs_environment_file_list.serialize_json(
    ...
    if "resource_requirements" in value:
        ...
        out["ResourceRequirements"] = (
            capo_pipes.types.ecs_resource_requirements_list.serialize_json(
...
def deserialize_json(data: dict) -> EcsContainerOverride:
    ...
    if data.get("Environment") is not None:
        ...
        out["environment"] = (
            capo_pipes.types.ecs_environment_variable_list.deserialize_json(
                data["Environment"]
            )
        )
    if data.get("EnvironmentFiles") is not None:
        ...
        out["environment_files"] = (
            capo_pipes.types.ecs_environment_file_list.deserialize_json(
    ...
    if data.get("ResourceRequirements") is not None:
        ...
        out["resource_requirements"] = (
            capo_pipes.types.ecs_resource_requirements_list.deserialize_json(
