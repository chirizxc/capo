...
def handle_response(
    ...
    out: capo_pipes.types.untag_resource_response.UntagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def untag_resource(
    ...
    capo_pipes.types.untag_resource_response.UntagResourceResponse, zapros.Response
]:
