"""Generated from Smithy shape ``com.amazonaws.pipes#TagResource``."""
...
def handle_response(
    ...
    out: capo_pipes.types.tag_resource_response.TagResourceResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pipes.types.tag_resource_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def tag_resource(
    ...
    input_: capo_pipes.types.tag_resource_request.TagResourceRequest,
) -> tuple[capo_pipes.types.tag_resource_response.TagResourceResponse, zapros.Response]:
