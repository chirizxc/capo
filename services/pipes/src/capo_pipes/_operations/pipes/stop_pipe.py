...
def handle_response(
    ...
    out: capo_pipes.types.stop_pipe_response.StopPipeResponse = (
        capo_pipes.types.stop_pipe_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_pipes.types.stop_pipe_request.StopPipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def stop_pipe(
    ...
    input_: capo_pipes.types.stop_pipe_request.StopPipeRequest,
) -> tuple[capo_pipes.types.stop_pipe_response.StopPipeResponse, zapros.Response]:
