"""Generated from Smithy shape ``com.amazonaws.pipes#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_pipes.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_pipes.types.list_tags_for_resource_response.deserialize_json(
