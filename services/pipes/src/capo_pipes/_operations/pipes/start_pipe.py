...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "ConflictException":
            raise capo_pipes.errors.conflict_exception.ConflictException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_pipes.types.start_pipe_response.StartPipeResponse = (
        capo_pipes.types.start_pipe_response.deserialize_json(
...
def build_request(
    ...
    input_: capo_pipes.types.start_pipe_request.StartPipeRequest,
) -> zapros.Request:
    endpoint = resolve(
        EndpointParams(
...
def start_pipe(
    ...
    input_: capo_pipes.types.start_pipe_request.StartPipeRequest,
) -> tuple[capo_pipes.types.start_pipe_response.StartPipeResponse, zapros.Response]:
