...
def handle_response(
    ...
    out: capo_cloudsearch.types.delete_suggester_response.DeleteSuggesterResponse = (
        capo_cloudsearch.types.delete_suggester_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.delete_suggester_request.serialize_query(input_, pairs, "")
