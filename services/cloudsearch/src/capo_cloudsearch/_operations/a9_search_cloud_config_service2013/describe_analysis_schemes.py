"""Generated from Smithy shape ``com.amazonaws.cloudsearch#DescribeAnalysisSchemes``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeAnalysisSchemesResult")
    out: capo_cloudsearch.types.describe_analysis_schemes_response.DescribeAnalysisSchemesResponse = capo_cloudsearch.types.describe_analysis_schemes_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeAnalysisSchemes"))
    pairs.append(("Version", "2013-01-01"))
    capo_cloudsearch.types.describe_analysis_schemes_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_analysis_schemes(
