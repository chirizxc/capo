...
def handle_response(
    ...
    out: capo_cloudsearch.types.update_availability_options_response.UpdateAvailabilityOptionsResponse = capo_cloudsearch.types.update_availability_options_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.update_availability_options_request.serialize_query(
        input_, pairs, ""
    )
