...
def handle_response(
    ...
    out: capo_cloudsearch.types.describe_domains_response.DescribeDomainsResponse = (
        capo_cloudsearch.types.describe_domains_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.describe_domains_request.serialize_query(input_, pairs, "")
