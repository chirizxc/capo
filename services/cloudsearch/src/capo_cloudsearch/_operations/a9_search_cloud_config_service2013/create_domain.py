...
import capo_cloudsearch.errors.resource_already_exists_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "ResourceAlreadyExists":
            raise capo_cloudsearch.errors.resource_already_exists_exception.ResourceAlreadyExistsException.from_query(
                error_el, message
            )
...
def handle_response(
    ...
    out: capo_cloudsearch.types.create_domain_response.CreateDomainResponse = (
        capo_cloudsearch.types.create_domain_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.create_domain_request.serialize_query(input_, pairs, "")
...
def create_domain(
    ...
    capo_cloudsearch.types.create_domain_response.CreateDomainResponse, zapros.Response
]:
