...
def handle_response(
    ...
    out: capo_cloudsearch.types.build_suggesters_response.BuildSuggestersResponse = (
        capo_cloudsearch.types.build_suggesters_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.build_suggesters_request.serialize_query(input_, pairs, "")
