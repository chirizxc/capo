"""Generated from Smithy shape ``com.amazonaws.cloudsearch#UpdateDomainEndpointOptions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateDomainEndpointOptionsResult")
    out: capo_cloudsearch.types.update_domain_endpoint_options_response.UpdateDomainEndpointOptionsResponse = capo_cloudsearch.types.update_domain_endpoint_options_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.update_domain_endpoint_options_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_domain_endpoint_options(
