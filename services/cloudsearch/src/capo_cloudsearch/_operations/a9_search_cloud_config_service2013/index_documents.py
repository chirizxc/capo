...
def handle_response(
    ...
    out: capo_cloudsearch.types.index_documents_response.IndexDocumentsResponse = (
        capo_cloudsearch.types.index_documents_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.index_documents_request.serialize_query(input_, pairs, "")
