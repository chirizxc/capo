"""Generated from Smithy shape ``com.amazonaws.cloudsearch#DescribeExpressions``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DescribeExpressionsResult")
    out: capo_cloudsearch.types.describe_expressions_response.DescribeExpressionsResponse = capo_cloudsearch.types.describe_expressions_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DescribeExpressions"))
    pairs.append(("Version", "2013-01-01"))
    capo_cloudsearch.types.describe_expressions_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_describe_expressions(
