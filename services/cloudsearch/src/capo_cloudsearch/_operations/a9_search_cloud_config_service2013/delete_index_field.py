...
def handle_response(
    ...
    out: capo_cloudsearch.types.delete_index_field_response.DeleteIndexFieldResponse = (
        capo_cloudsearch.types.delete_index_field_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.delete_index_field_request.serialize_query(input_, pairs, "")
