"""Generated from Smithy shape ``com.amazonaws.cloudsearch#ListDomainNames``."""
...
def handle_response(
    ...
    out: capo_cloudsearch.types.list_domain_names_response.ListDomainNamesResponse = (
        capo_cloudsearch.types.list_domain_names_response.deserialize_query(
...
def build_request(options: OperationOptions | AsyncOperationOptions) -> zapros.Request:
    ...
    pairs.append(("Action", "ListDomainNames"))
