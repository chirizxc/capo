"""Generated from Smithy shape ``com.amazonaws.cloudsearch#UpdateServiceAccessPolicies``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("UpdateServiceAccessPoliciesResult")
    out: capo_cloudsearch.types.update_service_access_policies_response.UpdateServiceAccessPoliciesResponse = capo_cloudsearch.types.update_service_access_policies_response.deserialize_query(
...
def build_request(
    ...
    capo_cloudsearch.types.update_service_access_policies_request.serialize_query(
        input_, pairs, ""
    )
...
async def async_update_service_access_policies(
