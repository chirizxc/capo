"""Generated from Smithy shape ``com.amazonaws.cloudsearch#DeleteExpression``."""
...
def handle_response(
    ...
    root = fromstring(response.read())
    result = root.find("DeleteExpressionResult")
    out: capo_cloudsearch.types.delete_expression_response.DeleteExpressionResponse = (
        capo_cloudsearch.types.delete_expression_response.deserialize_query(
...
def build_request(
    ...
    pairs.append(("Action", "DeleteExpression"))
    pairs.append(("Version", "2013-01-01"))
    capo_cloudsearch.types.delete_expression_request.serialize_query(input_, pairs, "")
...
async def async_delete_expression(
