"""Generated from Smithy shape ``com.amazonaws.costoptimizationhub#RedshiftReservedInstancesConfiguration``."""

from typing_extensions import NotRequired, TypedDict


class RedshiftReservedInstancesConfiguration(TypedDict, closed=True):
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: RedshiftReservedInstancesConfiguration) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> RedshiftReservedInstancesConfiguration:
    out: RedshiftReservedInstancesConfiguration = {}  # type: ignore[typeddict-item]
