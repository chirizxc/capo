...
class ListEnrollmentStatusesResponse(TypedDict, closed=True):
    items: NotRequired[
        "capo_cost_optimization_hub.types.account_enrollment_statuses.AccountEnrollmentStatuses"
    ]
...
def serialize_aws_json_1_0(value: ListEnrollmentStatusesResponse) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            capo_cost_optimization_hub.types.account_enrollment_statuses.serialize_aws_json_1_0(
                value["items"]
            )
        )
...
def deserialize_aws_json_1_0(data: dict) -> ListEnrollmentStatusesResponse:
    ...
    if data.get("items") is not None:
        ...
        out["items"] = (
            capo_cost_optimization_hub.types.account_enrollment_statuses.deserialize_aws_json_1_0(
                data["items"]
            )
        )
