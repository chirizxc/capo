...
if TYPE_CHECKING:
    import capo_cost_optimization_hub.types.metrics_by_time_list


class EfficiencyMetricsByGroup(TypedDict, closed=True):
    metrics_by_time: NotRequired[
        "capo_cost_optimization_hub.types.metrics_by_time_list.MetricsByTimeList"
    ]
...
def serialize_aws_json_1_0(value: EfficiencyMetricsByGroup) -> dict:
    ...
    if "metrics_by_time" in value:
        ...
        out["metricsByTime"] = (
            capo_cost_optimization_hub.types.metrics_by_time_list.serialize_aws_json_1_0(
...
def deserialize_aws_json_1_0(data: dict) -> EfficiencyMetricsByGroup:
    ...
    if data.get("metricsByTime") is not None:
        import capo_cost_optimization_hub.types.metrics_by_time_list

        out["metrics_by_time"] = (
            capo_cost_optimization_hub.types.metrics_by_time_list.deserialize_aws_json_1_0(
                data["metricsByTime"]
            )
        )
