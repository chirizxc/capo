...
if TYPE_CHECKING:
    import capo_cost_optimization_hub.types.mixed_instance_configuration

MixedInstanceConfigurationList: TypeAlias = list[
    "capo_cost_optimization_hub.types.mixed_instance_configuration.MixedInstanceConfiguration"
]
...
def serialize_aws_json_1_0(value: MixedInstanceConfigurationList) -> list:
    ...
    for item in value:
        out.append(
            capo_cost_optimization_hub.types.mixed_instance_configuration.serialize_aws_json_1_0(
                item
            )
        )
    return out
