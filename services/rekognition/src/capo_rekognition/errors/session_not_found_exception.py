"""Generated from Smithy shape ``com.amazonaws.rekognition#SessionNotFoundException``."""
...
class SessionNotFoundException_(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: SessionNotFoundException_) -> dict:
    out: dict = {}
    if "message" in value:
...
class SessionNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.rekognition#SessionNotFoundException``."""
