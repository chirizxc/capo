...
def serialize_aws_json_1_1(value: CreateFaceLivenessSessionRequest) -> dict:
    ...
    if "settings" in value:
        ...
        out["Settings"] = (
            capo_rekognition.types.create_face_liveness_session_request_settings.serialize_aws_json_1_1(
                value["settings"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> CreateFaceLivenessSessionRequest:
    ...
    if data.get("Settings") is not None:
        ...
        out["settings"] = (
            capo_rekognition.types.create_face_liveness_session_request_settings.deserialize_aws_json_1_1(
                data["Settings"]
            )
        )
