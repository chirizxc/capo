...
class ListDatasetEntriesResponse(TypedDict, closed=True):
    dataset_entries: NotRequired[
        "capo_rekognition.types.dataset_entries.DatasetEntries"
    ]
...
def serialize_aws_json_1_1(value: ListDatasetEntriesResponse) -> dict:
    ...
    if "dataset_entries" in value:
        ...
        out["DatasetEntries"] = (
            capo_rekognition.types.dataset_entries.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListDatasetEntriesResponse:
    ...
    if data.get("DatasetEntries") is not None:
        import capo_rekognition.types.dataset_entries

        out["dataset_entries"] = (
            capo_rekognition.types.dataset_entries.deserialize_aws_json_1_1(
                data["DatasetEntries"]
            )
        )
