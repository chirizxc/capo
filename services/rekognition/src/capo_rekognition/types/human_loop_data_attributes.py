"""Generated from Smithy shape ``com.amazonaws.rekognition#HumanLoopDataAttributes``."""
...
if TYPE_CHECKING:
    import capo_rekognition.types.content_classifiers


class HumanLoopDataAttributes(TypedDict, closed=True):
    content_classifiers: NotRequired[
        "capo_rekognition.types.content_classifiers.ContentClassifiers"
    ]
...
def serialize_aws_json_1_1(value: HumanLoopDataAttributes) -> dict:
    ...
    if "content_classifiers" in value:
        ...
        out["ContentClassifiers"] = (
            capo_rekognition.types.content_classifiers.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> HumanLoopDataAttributes:
    ...
    if data.get("ContentClassifiers") is not None:
        ...
        out["content_classifiers"] = (
            capo_rekognition.types.content_classifiers.deserialize_aws_json_1_1(
