...
class GetPersonTrackingResponse(TypedDict, closed=True):
    ...
    persons: NotRequired["capo_rekognition.types.person_detections.PersonDetections"]
...
def serialize_aws_json_1_1(value: GetPersonTrackingResponse) -> dict:
    ...
    if "persons" in value:
        ...
        out["Persons"] = (
            capo_rekognition.types.person_detections.serialize_aws_json_1_1(
                value["persons"]
            )
        )
    if "job_id" in value:
...
def deserialize_aws_json_1_1(data: dict) -> GetPersonTrackingResponse:
    ...
    if data.get("Persons") is not None:
        ...
        out["persons"] = (
            capo_rekognition.types.person_detections.deserialize_aws_json_1_1(
                data["Persons"]
            )
        )
