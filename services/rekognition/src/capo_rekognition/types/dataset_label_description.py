...
class DatasetLabelDescription(TypedDict, closed=True):
    label_name: NotRequired["capo_rekognition.types.dataset_label.DatasetLabel"]
    """<p> The name of the label. </p>"""
    label_stats: NotRequired[
        "capo_rekognition.types.dataset_label_stats.DatasetLabelStats"
    ]
...
def serialize_aws_json_1_1(value: DatasetLabelDescription) -> dict:
    ...
    if "label_stats" in value:
        ...
        out["LabelStats"] = (
            capo_rekognition.types.dataset_label_stats.serialize_aws_json_1_1(
                value["label_stats"]
            )
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> DatasetLabelDescription:
    ...
    if data.get("LabelStats") is not None:
        ...
        out["label_stats"] = (
            capo_rekognition.types.dataset_label_stats.deserialize_aws_json_1_1(
                data["LabelStats"]
            )
        )
    return out
