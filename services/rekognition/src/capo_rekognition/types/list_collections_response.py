...
class ListCollectionsResponse(TypedDict, closed=True):
    collection_ids: NotRequired[
        "capo_rekognition.types.collection_id_list.CollectionIdList"
    ]
    ...
    face_model_versions: NotRequired[
        "capo_rekognition.types.face_model_version_list.FaceModelVersionList"
    ]
...
def serialize_aws_json_1_1(value: ListCollectionsResponse) -> dict:
    ...
    if "collection_ids" in value:
        ...
        out["CollectionIds"] = (
            capo_rekognition.types.collection_id_list.serialize_aws_json_1_1(
    ...
    if "face_model_versions" in value:
        ...
        out["FaceModelVersions"] = (
            capo_rekognition.types.face_model_version_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ListCollectionsResponse:
    ...
    if data.get("CollectionIds") is not None:
        ...
        out["collection_ids"] = (
            capo_rekognition.types.collection_id_list.deserialize_aws_json_1_1(
                data["CollectionIds"]
            )
        )
    ...
    if data.get("FaceModelVersions") is not None:
        ...
        out["face_model_versions"] = (
            capo_rekognition.types.face_model_version_list.deserialize_aws_json_1_1(
