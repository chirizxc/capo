...
class RecognizeCelebritiesResponse(TypedDict, closed=True):
    celebrity_faces: NotRequired["capo_rekognition.types.celebrity_list.CelebrityList"]
    ...
    unrecognized_faces: NotRequired[
        "capo_rekognition.types.compared_face_list.ComparedFaceList"
    ]
...
def serialize_aws_json_1_1(value: RecognizeCelebritiesResponse) -> dict:
    ...
    if "celebrity_faces" in value:
        ...
        out["CelebrityFaces"] = (
            capo_rekognition.types.celebrity_list.serialize_aws_json_1_1(
    ...
    if "unrecognized_faces" in value:
        ...
        out["UnrecognizedFaces"] = (
            capo_rekognition.types.compared_face_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> RecognizeCelebritiesResponse:
    ...
    if data.get("CelebrityFaces") is not None:
        import capo_rekognition.types.celebrity_list

        out["celebrity_faces"] = (
            capo_rekognition.types.celebrity_list.deserialize_aws_json_1_1(
                data["CelebrityFaces"]
            )
        )
    if data.get("UnrecognizedFaces") is not None:
        import capo_rekognition.types.compared_face_list

        out["unrecognized_faces"] = (
            capo_rekognition.types.compared_face_list.deserialize_aws_json_1_1(
