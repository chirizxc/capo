"""Generated from Smithy shape ``com.amazonaws.rekognition#StartPersonTrackingRequest``."""
...
class StartPersonTrackingRequest(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartPersonTrackingRequest) -> dict:
    out: dict = {}
    import capo_rekognition.types.video
...
def deserialize_aws_json_1_1(data: dict) -> StartPersonTrackingRequest:
    out: StartPersonTrackingRequest = {}  # type: ignore[typeddict-item]
    if data.get("Video") is not None:
        ...
        raise DeserializationError("StartPersonTrackingRequest.video required")
