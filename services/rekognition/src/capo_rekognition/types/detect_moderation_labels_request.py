...
class DetectModerationLabelsRequest(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: DetectModerationLabelsRequest) -> dict:
    ...
    if "human_loop_config" in value:
        ...
        out["HumanLoopConfig"] = (
            capo_rekognition.types.human_loop_config.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DetectModerationLabelsRequest:
    ...
    if data.get("HumanLoopConfig") is not None:
        ...
        out["human_loop_config"] = (
            capo_rekognition.types.human_loop_config.deserialize_aws_json_1_1(
