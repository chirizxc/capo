...
def handle_response(
    ...
    out: capo_rekognition.types.detect_labels_response.DetectLabelsResponse = (
        capo_rekognition.types.detect_labels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.detect_labels_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def detect_labels(
    ...
    capo_rekognition.types.detect_labels_response.DetectLabelsResponse, zapros.Response
]:
