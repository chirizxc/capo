"""Generated from Smithy shape ``com.amazonaws.rekognition#UpdateDatasetEntries``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.update_dataset_entries_response.UpdateDatasetEntriesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.UpdateDatasetEntries"
    body: bytes | None = json.dumps(
        capo_rekognition.types.update_dataset_entries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_dataset_entries(
