...
import capo_rekognition.types.dataset_entries
...
def handle_response(
    ...
    out: capo_rekognition.types.list_dataset_entries_response.ListDatasetEntriesResponse = capo_rekognition.types.list_dataset_entries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.list_dataset_entries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
