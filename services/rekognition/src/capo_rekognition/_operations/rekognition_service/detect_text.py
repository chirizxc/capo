"""Generated from Smithy shape ``com.amazonaws.rekognition#DetectText``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.detect_text_response.DetectTextResponse = (
        capo_rekognition.types.detect_text_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.detect_text_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def detect_text(
    ...
    capo_rekognition.types.detect_text_response.DetectTextResponse, zapros.Response
]:
