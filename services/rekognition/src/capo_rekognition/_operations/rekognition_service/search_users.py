...
def handle_response(
    ...
    out: capo_rekognition.types.search_users_response.SearchUsersResponse = (
        capo_rekognition.types.search_users_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.search_users_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def search_users(
    ...
    capo_rekognition.types.search_users_response.SearchUsersResponse, zapros.Response
]:
