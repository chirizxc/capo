"""Generated from Smithy shape ``com.amazonaws.rekognition#ListUsers``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.list_users_response.ListUsersResponse = (
        capo_rekognition.types.list_users_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.ListUsers"
    body: bytes | None = json.dumps(
        capo_rekognition.types.list_users_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_users(
    ...
    capo_rekognition.types.list_users_response.ListUsersResponse, zapros.Response
]:
