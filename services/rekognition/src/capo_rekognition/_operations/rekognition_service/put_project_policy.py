"""Generated from Smithy shape ``com.amazonaws.rekognition#PutProjectPolicy``."""
...
import capo_rekognition.errors.invalid_policy_revision_id_exception
import capo_rekognition.errors.limit_exceeded_exception
import capo_rekognition.errors.malformed_policy_document_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidPolicyRevisionIdException":
            raise capo_rekognition.errors.invalid_policy_revision_id_exception.InvalidPolicyRevisionIdException.from_aws_json_1_1(
                data, message
            )
        ...
        case "MalformedPolicyDocumentException":
            raise capo_rekognition.errors.malformed_policy_document_exception.MalformedPolicyDocumentException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_rekognition.types.put_project_policy_response.PutProjectPolicyResponse = (
        capo_rekognition.types.put_project_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.PutProjectPolicy"
    body: bytes | None = json.dumps(
        capo_rekognition.types.put_project_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_put_project_policy(
