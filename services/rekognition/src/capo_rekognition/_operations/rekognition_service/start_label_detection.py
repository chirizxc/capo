"""Generated from Smithy shape ``com.amazonaws.rekognition#StartLabelDetection``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.start_label_detection_response.StartLabelDetectionResponse = capo_rekognition.types.start_label_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_label_detection_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_label_detection(
