...
def handle_response(
    ...
    out: capo_rekognition.types.compare_faces_response.CompareFacesResponse = (
        capo_rekognition.types.compare_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.compare_faces_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def compare_faces(
    ...
    capo_rekognition.types.compare_faces_response.CompareFacesResponse, zapros.Response
]:
