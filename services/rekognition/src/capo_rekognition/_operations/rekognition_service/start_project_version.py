...
def handle_response(
    ...
    out: capo_rekognition.types.start_project_version_response.StartProjectVersionResponse = capo_rekognition.types.start_project_version_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_project_version_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
