...
def handle_response(
    ...
    out: capo_rekognition.types.delete_faces_response.DeleteFacesResponse = (
        capo_rekognition.types.delete_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.delete_faces_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_faces(
    ...
    capo_rekognition.types.delete_faces_response.DeleteFacesResponse, zapros.Response
]:
