...
def handle_response(
    ...
    out: capo_rekognition.types.delete_user_response.DeleteUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.delete_user_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def delete_user(
    ...
    capo_rekognition.types.delete_user_response.DeleteUserResponse, zapros.Response
]:
