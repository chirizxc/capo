...
def handle_response(
    ...
    out: capo_rekognition.types.delete_project_policy_response.DeleteProjectPolicyResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.delete_project_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
