"""Generated from Smithy shape ``com.amazonaws.rekognition#ListDatasetLabels``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.list_dataset_labels_response.ListDatasetLabelsResponse = capo_rekognition.types.list_dataset_labels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.ListDatasetLabels"
    body: bytes | None = json.dumps(
        capo_rekognition.types.list_dataset_labels_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_dataset_labels(
