...
def handle_response(
    ...
    out: capo_rekognition.types.distribute_dataset_entries_response.DistributeDatasetEntriesResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.distribute_dataset_entries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
