"""Generated from Smithy shape ``com.amazonaws.rekognition#GetFaceLivenessSessionResults``."""
...
import capo_rekognition.errors.session_not_found_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "SessionNotFoundException":
            raise capo_rekognition.errors.session_not_found_exception.SessionNotFoundException.from_aws_json_1_1(
                data, message
            )
...
def handle_response(
    ...
    out: capo_rekognition.types.get_face_liveness_session_results_response.GetFaceLivenessSessionResultsResponse = capo_rekognition.types.get_face_liveness_session_results_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.GetFaceLivenessSessionResults"
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_face_liveness_session_results_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_face_liveness_session_results(
