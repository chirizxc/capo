"""Generated from Smithy shape ``com.amazonaws.rekognition#CreateUser``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.create_user_response.CreateUserResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.CreateUser"
    body: bytes | None = json.dumps(
        capo_rekognition.types.create_user_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_user(
    ...
    capo_rekognition.types.create_user_response.CreateUserResponse, zapros.Response
]:
