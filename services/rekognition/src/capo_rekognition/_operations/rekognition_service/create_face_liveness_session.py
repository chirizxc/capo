"""Generated from Smithy shape ``com.amazonaws.rekognition#CreateFaceLivenessSession``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.create_face_liveness_session_response.CreateFaceLivenessSessionResponse = capo_rekognition.types.create_face_liveness_session_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.CreateFaceLivenessSession"
    body: bytes | None = json.dumps(
        capo_rekognition.types.create_face_liveness_session_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_face_liveness_session(
