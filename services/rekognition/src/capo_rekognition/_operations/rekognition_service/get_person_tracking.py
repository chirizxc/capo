...
import capo_rekognition.types.person_detections
...
def handle_response(
    ...
    out: capo_rekognition.types.get_person_tracking_response.GetPersonTrackingResponse = capo_rekognition.types.get_person_tracking_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_person_tracking_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
