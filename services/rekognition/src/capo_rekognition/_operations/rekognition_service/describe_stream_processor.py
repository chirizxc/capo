"""Generated from Smithy shape ``com.amazonaws.rekognition#DescribeStreamProcessor``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.describe_stream_processor_response.DescribeStreamProcessorResponse = capo_rekognition.types.describe_stream_processor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.describe_stream_processor_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_stream_processor(
