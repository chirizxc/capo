"""Generated from Smithy shape ``com.amazonaws.rekognition#ListMediaAnalysisJobs``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.list_media_analysis_jobs_response.ListMediaAnalysisJobsResponse = capo_rekognition.types.list_media_analysis_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.ListMediaAnalysisJobs"
    body: bytes | None = json.dumps(
        capo_rekognition.types.list_media_analysis_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_media_analysis_jobs(
