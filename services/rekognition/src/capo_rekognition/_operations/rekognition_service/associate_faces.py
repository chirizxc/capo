...
def handle_response(
    ...
    out: capo_rekognition.types.associate_faces_response.AssociateFacesResponse = (
        capo_rekognition.types.associate_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.associate_faces_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
