"""Generated from Smithy shape ``com.amazonaws.rekognition#GetFaceDetection``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.get_face_detection_response.GetFaceDetectionResponse = (
        capo_rekognition.types.get_face_detection_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_face_detection_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_face_detection(
