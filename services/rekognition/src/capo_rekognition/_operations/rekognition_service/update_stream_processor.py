"""Generated from Smithy shape ``com.amazonaws.rekognition#UpdateStreamProcessor``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.update_stream_processor_response.UpdateStreamProcessorResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    headers["X-Amz-Target"] = "RekognitionService.UpdateStreamProcessor"
    body: bytes | None = json.dumps(
        capo_rekognition.types.update_stream_processor_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_stream_processor(
