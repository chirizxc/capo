"""Generated from Smithy shape ``com.amazonaws.rekognition#ListCollections``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.list_collections_response.ListCollectionsResponse = (
        capo_rekognition.types.list_collections_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.list_collections_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
