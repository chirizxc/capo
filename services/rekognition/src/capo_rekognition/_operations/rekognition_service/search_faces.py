"""Generated from Smithy shape ``com.amazonaws.rekognition#SearchFaces``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.search_faces_response.SearchFacesResponse = (
        capo_rekognition.types.search_faces_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.search_faces_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def search_faces(
    ...
    capo_rekognition.types.search_faces_response.SearchFacesResponse, zapros.Response
]:
