"""Generated from Smithy shape ``com.amazonaws.rekognition#DetectCustomLabels``."""
...
def handle_response(
    ...
    out: capo_rekognition.types.detect_custom_labels_response.DetectCustomLabelsResponse = capo_rekognition.types.detect_custom_labels_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.detect_custom_labels_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_detect_custom_labels(
