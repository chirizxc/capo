...
def handle_response(
    ...
    out: capo_rekognition.types.start_stream_processor_response.StartStreamProcessorResponse = capo_rekognition.types.start_stream_processor_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.start_stream_processor_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
