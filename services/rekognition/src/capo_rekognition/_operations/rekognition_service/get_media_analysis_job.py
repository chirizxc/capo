...
def handle_response(
    ...
    out: capo_rekognition.types.get_media_analysis_job_response.GetMediaAnalysisJobResponse = capo_rekognition.types.get_media_analysis_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_rekognition.types.get_media_analysis_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
