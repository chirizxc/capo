"""Generated from Smithy shape ``com.amazonaws.appconfig#UpdateEnvironment``."""
...
def handle_response(
    ...
    out: capo_appconfig.types.environment.Environment = (
        capo_appconfig.types.environment.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_appconfig.types.environment.Environment = (
        capo_appconfig.types.environment.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appconfig.types.update_environment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_environment(
    ...
    input_: capo_appconfig.types.update_environment_request.UpdateEnvironmentRequest,
) -> tuple[capo_appconfig.types.environment.Environment, zapros.Response]:
