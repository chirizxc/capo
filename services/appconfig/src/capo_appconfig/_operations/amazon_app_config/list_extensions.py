"""Generated from Smithy shape ``com.amazonaws.appconfig#ListExtensions``."""
...
def handle_response(
    ...
    out: capo_appconfig.types.extensions.Extensions = (
        capo_appconfig.types.extensions.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_appconfig.types.extensions.Extensions = (
        capo_appconfig.types.extensions.deserialize_json(
...
def list_extensions(
    ...
    input_: capo_appconfig.types.list_extensions_request.ListExtensionsRequest,
) -> tuple[capo_appconfig.types.extensions.Extensions, zapros.Response]:
...
async def async_list_extensions(
