"""Generated from Smithy shape ``com.amazonaws.appconfig#DeleteExtensionAssociation``."""
...
def build_request(
    ...
    url = url.replace(
        "{ExtensionAssociationId}", quote(input_["extension_association_id"], safe="")
    )
...
async def async_delete_extension_association(
