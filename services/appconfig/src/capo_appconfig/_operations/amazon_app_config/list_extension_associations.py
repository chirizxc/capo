...
def build_request(
    ...
    if "resource_identifier" in input_:
        params.append(("resource_identifier", input_["resource_identifier"]))
    if "extension_identifier" in input_:
        params.append(("extension_identifier", input_["extension_identifier"]))
    if "extension_version_number" in input_:
        params.append(
            ("extension_version_number", str(input_["extension_version_number"]))
        )
