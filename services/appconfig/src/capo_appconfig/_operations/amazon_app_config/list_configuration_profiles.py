...
def handle_response(
    ...
    out: capo_appconfig.types.configuration_profiles.ConfigurationProfiles = (
        capo_appconfig.types.configuration_profiles.deserialize_json(
...
def list_configuration_profiles(
    ...
    capo_appconfig.types.configuration_profiles.ConfigurationProfiles, zapros.Response
]:
