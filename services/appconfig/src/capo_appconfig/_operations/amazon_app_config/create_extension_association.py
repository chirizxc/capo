"""Generated from Smithy shape ``com.amazonaws.appconfig#CreateExtensionAssociation``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appconfig.types.create_extension_association_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_extension_association(
