"""Generated from Smithy shape ``com.amazonaws.appconfig#DeleteDeploymentStrategy``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/deployementstrategies/{DeploymentStrategyId}"
    url = url.replace(
        "{DeploymentStrategyId}", quote(input_["deployment_strategy_id"], safe="")
    )
...
async def async_delete_deployment_strategy(
