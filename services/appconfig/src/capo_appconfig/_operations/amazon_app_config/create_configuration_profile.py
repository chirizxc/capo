"""Generated from Smithy shape ``com.amazonaws.appconfig#CreateConfigurationProfile``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appconfig.types.create_configuration_profile_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_configuration_profile(
