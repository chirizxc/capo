...
import capo_appconfig.types.hosted_configuration_version_summary_list
...
def handle_response(
    ...
    out: capo_appconfig.types.hosted_configuration_versions.HostedConfigurationVersions = capo_appconfig.types.hosted_configuration_versions.deserialize_json(
...
def build_request(
    ...
    if "version_label" in input_:
        params.append(("version_label", input_["version_label"]))
