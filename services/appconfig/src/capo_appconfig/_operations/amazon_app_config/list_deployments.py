"""Generated from Smithy shape ``com.amazonaws.appconfig#ListDeployments``."""
...
import capo_appconfig.types.deployment_list
...
def handle_response(
    ...
    out: capo_appconfig.types.deployments.Deployments = (
        capo_appconfig.types.deployments.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_appconfig.types.deployments.Deployments = (
        capo_appconfig.types.deployments.deserialize_json(
...
def list_deployments(
    ...
    input_: capo_appconfig.types.list_deployments_request.ListDeploymentsRequest,
) -> tuple[capo_appconfig.types.deployments.Deployments, zapros.Response]:
