"""Generated from Smithy shape ``com.amazonaws.appconfig#CreateDeploymentStrategy``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_appconfig.types.create_deployment_strategy_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_deployment_strategy(
