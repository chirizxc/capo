...
from capo_cognito_identity._services._aws_config import aws_config
...
class CognitoIdentityClient:
    ...
    def create_identity_pool(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.create_identity_pool_input.CreateIdentityPoolInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.identity_pool.IdentityPool"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.create_identity_pool.create_identity_pool(
    ...
    def delete_identities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.delete_identities_input.DeleteIdentitiesInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.delete_identities_response.DeleteIdentitiesResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.delete_identities.delete_identities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_identity_pool(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.delete_identity_pool_input.DeleteIdentityPoolInput]",
        ) -> OperationResponse[None]:
            import capo_cognito_identity._operations.aws_cognito_identity_service.delete_identity_pool

            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.delete_identity_pool.delete_identity_pool(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.describe_identity_input.DescribeIdentityInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.identity_description.IdentityDescription"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.describe_identity.describe_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def describe_identity_pool(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.describe_identity_pool_input.DescribeIdentityPoolInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.identity_pool.IdentityPool"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.describe_identity_pool.describe_identity_pool(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_credentials_for_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.get_credentials_for_identity_input.GetCredentialsForIdentityInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.get_credentials_for_identity_response.GetCredentialsForIdentityResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.get_credentials_for_identity.get_credentials_for_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_id(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.get_id_input.GetIdInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.get_id_response.GetIdResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.get_id.get_id(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_identity_pool_roles(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.get_identity_pool_roles_input.GetIdentityPoolRolesInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.get_identity_pool_roles_response.GetIdentityPoolRolesResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.get_identity_pool_roles.get_identity_pool_roles(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_open_id_token(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.get_open_id_token_input.GetOpenIdTokenInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.get_open_id_token_response.GetOpenIdTokenResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.get_open_id_token.get_open_id_token(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_open_id_token_for_developer_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.get_open_id_token_for_developer_identity_input.GetOpenIdTokenForDeveloperIdentityInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.get_open_id_token_for_developer_identity_response.GetOpenIdTokenForDeveloperIdentityResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.get_open_id_token_for_developer_identity.get_open_id_token_for_developer_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_principal_tag_attribute_map(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.get_principal_tag_attribute_map_input.GetPrincipalTagAttributeMapInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.get_principal_tag_attribute_map_response.GetPrincipalTagAttributeMapResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.get_principal_tag_attribute_map.get_principal_tag_attribute_map(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_identities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.list_identities_input.ListIdentitiesInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.list_identities_response.ListIdentitiesResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.list_identities.list_identities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_identity_pools(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.list_identity_pools_input.ListIdentityPoolsInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.list_identity_pools_response.ListIdentityPoolsResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.list_identity_pools.list_identity_pools(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_cognito_identity.types.identity_pool_short_description.IdentityPoolShortDescription]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.list_tags_for_resource_input.ListTagsForResourceInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def lookup_developer_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.lookup_developer_identity_input.LookupDeveloperIdentityInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.lookup_developer_identity_response.LookupDeveloperIdentityResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.lookup_developer_identity.lookup_developer_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def merge_developer_identities(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.merge_developer_identities_input.MergeDeveloperIdentitiesInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.merge_developer_identities_response.MergeDeveloperIdentitiesResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.merge_developer_identities.merge_developer_identities(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_identity_pool_roles(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.set_identity_pool_roles_input.SetIdentityPoolRolesInput]",
        ) -> OperationResponse[None]:
            import capo_cognito_identity._operations.aws_cognito_identity_service.set_identity_pool_roles

            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.set_identity_pool_roles.set_identity_pool_roles(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def set_principal_tag_attribute_map(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.set_principal_tag_attribute_map_input.SetPrincipalTagAttributeMapInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.set_principal_tag_attribute_map_response.SetPrincipalTagAttributeMapResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.set_principal_tag_attribute_map.set_principal_tag_attribute_map(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.tag_resource_input.TagResourceInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def unlink_developer_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.unlink_developer_identity_input.UnlinkDeveloperIdentityInput]",
        ) -> OperationResponse[None]:
            import capo_cognito_identity._operations.aws_cognito_identity_service.unlink_developer_identity

            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.unlink_developer_identity.unlink_developer_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def unlink_identity(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.unlink_identity_input.UnlinkIdentityInput]",
        ) -> OperationResponse[None]:
            import capo_cognito_identity._operations.aws_cognito_identity_service.unlink_identity

            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.unlink_identity.unlink_identity(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.untag_resource_input.UntagResourceInput]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_identity_pool(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_cognito_identity.types.identity_pool.IdentityPool]",
        ) -> OperationResponse[
            "capo_cognito_identity.types.identity_pool.IdentityPool"
        ]:
            ...
            output, http_response = (
                capo_cognito_identity._operations.aws_cognito_identity_service.update_identity_pool.update_identity_pool(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
