...
if TYPE_CHECKING:
    import capo_cognito_identity.types.cognito_identity_provider_client_id
    import capo_cognito_identity.types.cognito_identity_provider_name
    import capo_cognito_identity.types.cognito_identity_provider_token_check


class CognitoIdentityProvider(TypedDict, closed=True):
    provider_name: NotRequired[
        "capo_cognito_identity.types.cognito_identity_provider_name.CognitoIdentityProviderName"
    ]
    ...
    client_id: NotRequired[
        "capo_cognito_identity.types.cognito_identity_provider_client_id.CognitoIdentityProviderClientId"
    ]
    """<p>The client ID for the Amazon Cognito user pool.</p>"""
    server_side_token_check: NotRequired[
        "capo_cognito_identity.types.cognito_identity_provider_token_check.CognitoIdentityProviderTokenCheck"
    ]
