...
class LookupDeveloperIdentityResponse(TypedDict, closed=True):
    ...
    developer_user_identifier_list: NotRequired[
        "capo_cognito_identity.types.developer_user_identifier_list.DeveloperUserIdentifierList"
    ]
...
def serialize_aws_json_1_1(value: LookupDeveloperIdentityResponse) -> dict:
    ...
    if "developer_user_identifier_list" in value:
        ...
        out["DeveloperUserIdentifierList"] = (
            capo_cognito_identity.types.developer_user_identifier_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> LookupDeveloperIdentityResponse:
    ...
    if data.get("DeveloperUserIdentifierList") is not None:
        ...
        out["developer_user_identifier_list"] = (
            capo_cognito_identity.types.developer_user_identifier_list.deserialize_aws_json_1_1(
