"""Generated from Smithy shape ``com.amazonaws.cognitoidentity#ConcurrentModificationException``."""
...
class ConcurrentModificationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cognitoidentity#ConcurrentModificationException``."""
