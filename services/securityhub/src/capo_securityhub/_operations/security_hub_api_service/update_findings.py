...
def handle_response(
    ...
    out: capo_securityhub.types.update_findings_response.UpdateFindingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.update_findings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
