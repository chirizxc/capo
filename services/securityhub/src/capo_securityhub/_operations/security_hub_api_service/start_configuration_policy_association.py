...
def handle_response(
    ...
    out: capo_securityhub.types.start_configuration_policy_association_response.StartConfigurationPolicyAssociationResponse = capo_securityhub.types.start_configuration_policy_association_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.start_configuration_policy_association_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
