"""Generated from Smithy shape ``com.amazonaws.securityhub#DescribeHub``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.describe_hub_response.DescribeHubResponse = (
        capo_securityhub.types.describe_hub_response.deserialize_json(
...
def build_request(
    ...
    if "hub_arn" in input_:
        params.append(("HubArn", input_["hub_arn"]))
...
def describe_hub(
    ...
    capo_securityhub.types.describe_hub_response.DescribeHubResponse, zapros.Response
]:
