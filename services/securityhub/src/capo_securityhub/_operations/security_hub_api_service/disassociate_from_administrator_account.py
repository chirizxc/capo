"""Generated from Smithy shape ``com.amazonaws.securityhub#DisassociateFromAdministratorAccount``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.disassociate_from_administrator_account_response.DisassociateFromAdministratorAccountResponse = {}  # type: ignore[typeddict-item]
    return out
