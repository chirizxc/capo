"""Generated from Smithy shape ``com.amazonaws.securityhub#ListConfigurationPolicyAssociations``."""
...
import capo_securityhub.types.configuration_policy_association_summary_list
...
def handle_response(
    ...
    out: capo_securityhub.types.list_configuration_policy_associations_response.ListConfigurationPolicyAssociationsResponse = capo_securityhub.types.list_configuration_policy_associations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/configurationPolicyAssociation/list"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_securityhub.types.list_configuration_policy_associations_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_configuration_policy_associations(
