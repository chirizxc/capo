...
def handle_response(
    ...
    out: capo_securityhub.types.generate_recommended_policy_v2_response.GenerateRecommendedPolicyV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{MetadataUid}", quote(input_["metadata_uid"], safe=""))
