"""Generated from Smithy shape ``com.amazonaws.securityhub#ListStandardsControlAssociations``."""
...
import capo_securityhub.types.standards_control_association_summaries
...
def handle_response(
    ...
    out: capo_securityhub.types.list_standards_control_associations_response.ListStandardsControlAssociationsResponse = capo_securityhub.types.list_standards_control_associations_response.deserialize_json(
...
def build_request(
    ...
    if "security_control_id" in input_:
        params.append(("SecurityControlId", input_["security_control_id"]))
...
async def async_list_standards_control_associations(
