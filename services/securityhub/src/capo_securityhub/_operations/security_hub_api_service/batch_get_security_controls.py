...
def handle_response(
    ...
    out: capo_securityhub.types.batch_get_security_controls_response.BatchGetSecurityControlsResponse = capo_securityhub.types.batch_get_security_controls_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.batch_get_security_controls_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
