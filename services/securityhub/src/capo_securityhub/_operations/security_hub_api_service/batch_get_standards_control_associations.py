...
def handle_response(
    ...
    out: capo_securityhub.types.batch_get_standards_control_associations_response.BatchGetStandardsControlAssociationsResponse = capo_securityhub.types.batch_get_standards_control_associations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.batch_get_standards_control_associations_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
