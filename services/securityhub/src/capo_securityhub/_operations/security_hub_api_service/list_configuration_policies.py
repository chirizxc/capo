...
def handle_response(
    ...
    out: capo_securityhub.types.list_configuration_policies_response.ListConfigurationPoliciesResponse = capo_securityhub.types.list_configuration_policies_response.deserialize_json(
