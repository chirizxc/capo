"""Generated from Smithy shape ``com.amazonaws.securityhub#GetMasterAccount``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_master_account_response.GetMasterAccountResponse = (
        capo_securityhub.types.get_master_account_response.deserialize_json(
