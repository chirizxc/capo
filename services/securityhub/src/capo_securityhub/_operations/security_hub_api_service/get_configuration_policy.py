"""Generated from Smithy shape ``com.amazonaws.securityhub#GetConfigurationPolicy``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_configuration_policy_response.GetConfigurationPolicyResponse = capo_securityhub.types.get_configuration_policy_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/configurationPolicy/get/{Identifier}"
...
async def async_get_configuration_policy(
