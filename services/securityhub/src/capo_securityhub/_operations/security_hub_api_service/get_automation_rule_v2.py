...
def handle_response(
    ...
    out: capo_securityhub.types.get_automation_rule_v2_response.GetAutomationRuleV2Response = capo_securityhub.types.get_automation_rule_v2_response.deserialize_json(
