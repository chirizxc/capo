"""Generated from Smithy shape ``com.amazonaws.securityhub#DeleteAggregatorV2``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.delete_aggregator_v2_response.DeleteAggregatorV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/aggregatorv2/delete/{AggregatorV2Arn+}"
    url = url.replace(
...
async def async_delete_aggregator_v2(
