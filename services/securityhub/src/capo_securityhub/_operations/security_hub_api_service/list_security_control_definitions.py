"""Generated from Smithy shape ``com.amazonaws.securityhub#ListSecurityControlDefinitions``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.list_security_control_definitions_response.ListSecurityControlDefinitionsResponse = capo_securityhub.types.list_security_control_definitions_response.deserialize_json(
...
def build_request(
    ...
    if "standards_arn" in input_:
        params.append(("StandardsArn", input_["standards_arn"]))
...
async def async_list_security_control_definitions(
