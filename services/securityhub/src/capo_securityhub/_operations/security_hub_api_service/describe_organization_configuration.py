...
def handle_response(
    ...
    out: capo_securityhub.types.describe_organization_configuration_response.DescribeOrganizationConfigurationResponse = capo_securityhub.types.describe_organization_configuration_response.deserialize_json(
