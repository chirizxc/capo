"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateAutomationRuleV2``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.update_automation_rule_v2_response.UpdateAutomationRuleV2Response = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.update_automation_rule_v2_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_automation_rule_v2(
