...
def handle_response(
    ...
    out: capo_securityhub.types.get_findings_v2_response.GetFindingsV2Response = (
        capo_securityhub.types.get_findings_v2_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.get_findings_v2_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
