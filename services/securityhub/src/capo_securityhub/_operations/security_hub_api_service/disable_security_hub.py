"""Generated from Smithy shape ``com.amazonaws.securityhub#DisableSecurityHub``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.disable_security_hub_response.DisableSecurityHubResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disable_security_hub(
