...
def handle_response(
    ...
    out: capo_securityhub.types.describe_security_hub_v2_response.DescribeSecurityHubV2Response = capo_securityhub.types.describe_security_hub_v2_response.deserialize_json(
