...
def handle_response(
    ...
    out: capo_securityhub.types.register_connector_v2_response.RegisterConnectorV2Response = capo_securityhub.types.register_connector_v2_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.register_connector_v2_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
