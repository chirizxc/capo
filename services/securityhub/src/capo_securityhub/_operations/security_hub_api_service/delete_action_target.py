...
def handle_response(
    ...
    out: capo_securityhub.types.delete_action_target_response.DeleteActionTargetResponse = capo_securityhub.types.delete_action_target_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ActionTargetArn+}", quote(input_["action_target_arn"], safe="/")
    )
