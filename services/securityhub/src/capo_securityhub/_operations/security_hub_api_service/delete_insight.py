"""Generated from Smithy shape ``com.amazonaws.securityhub#DeleteInsight``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.delete_insight_response.DeleteInsightResponse = (
        capo_securityhub.types.delete_insight_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{InsightArn+}", quote(input_["insight_arn"], safe="/"))
