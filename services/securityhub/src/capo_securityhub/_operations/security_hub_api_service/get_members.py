"""Generated from Smithy shape ``com.amazonaws.securityhub#GetMembers``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_members_response.GetMembersResponse = (
        capo_securityhub.types.get_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.get_members_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_members(
    ...
    capo_securityhub.types.get_members_response.GetMembersResponse, zapros.Response
]:
