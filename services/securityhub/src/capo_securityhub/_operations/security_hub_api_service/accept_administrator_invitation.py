...
def handle_response(
    ...
    out: capo_securityhub.types.accept_administrator_invitation_response.AcceptAdministratorInvitationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.accept_administrator_invitation_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
