"""Generated from Smithy shape ``com.amazonaws.securityhub#GetFindings``."""
...
def handle_response(
    ...
    out: capo_securityhub.types.get_findings_response.GetFindingsResponse = (
        capo_securityhub.types.get_findings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.get_findings_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_findings(
    ...
    capo_securityhub.types.get_findings_response.GetFindingsResponse, zapros.Response
]:
