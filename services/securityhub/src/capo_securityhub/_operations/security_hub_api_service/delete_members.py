...
def handle_response(
    ...
    out: capo_securityhub.types.delete_members_response.DeleteMembersResponse = (
        capo_securityhub.types.delete_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.delete_members_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
