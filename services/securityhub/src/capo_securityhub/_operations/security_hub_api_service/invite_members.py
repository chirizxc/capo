...
def handle_response(
    ...
    out: capo_securityhub.types.invite_members_response.InviteMembersResponse = (
        capo_securityhub.types.invite_members_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_securityhub.types.invite_members_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
