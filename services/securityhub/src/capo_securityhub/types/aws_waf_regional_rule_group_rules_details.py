...
if TYPE_CHECKING:
    import capo_securityhub.types.aws_waf_regional_rule_group_rules_action_details
...
class AwsWafRegionalRuleGroupRulesDetails(TypedDict, closed=True):
    action: NotRequired[
        "capo_securityhub.types.aws_waf_regional_rule_group_rules_action_details.AwsWafRegionalRuleGroupRulesActionDetails"
    ]
...
def serialize_json(value: AwsWafRegionalRuleGroupRulesDetails) -> dict:
    ...
    if "action" in value:
        ...
        out["Action"] = (
            capo_securityhub.types.aws_waf_regional_rule_group_rules_action_details.serialize_json(
                value["action"]
            )
        )
...
def deserialize_json(data: dict) -> AwsWafRegionalRuleGroupRulesDetails:
    ...
    if data.get("Action") is not None:
        ...
        out["action"] = (
            capo_securityhub.types.aws_waf_regional_rule_group_rules_action_details.deserialize_json(
                data["Action"]
            )
        )
