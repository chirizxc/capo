...
if TYPE_CHECKING:
    import capo_securityhub.types.aws_ecs_service_load_balancers_details

AwsEcsServiceLoadBalancersList: TypeAlias = list[
    "capo_securityhub.types.aws_ecs_service_load_balancers_details.AwsEcsServiceLoadBalancersDetails"
]
...
def serialize_json(value: AwsEcsServiceLoadBalancersList) -> list:
    ...
    for item in value:
        out.append(
            capo_securityhub.types.aws_ecs_service_load_balancers_details.serialize_json(
                item
            )
        )
    return out
