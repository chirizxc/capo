...
class AwsWafRegionalRateBasedRuleDetails(TypedDict, closed=True):
    ...
    match_predicates: NotRequired[
        "capo_securityhub.types.aws_waf_regional_rate_based_rule_match_predicate_list.AwsWafRegionalRateBasedRuleMatchPredicateList"
    ]
...
def serialize_json(value: AwsWafRegionalRateBasedRuleDetails) -> dict:
    ...
    if "match_predicates" in value:
        ...
        out["MatchPredicates"] = (
            capo_securityhub.types.aws_waf_regional_rate_based_rule_match_predicate_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsWafRegionalRateBasedRuleDetails:
    ...
    if data.get("MatchPredicates") is not None:
        ...
        out["match_predicates"] = (
            capo_securityhub.types.aws_waf_regional_rate_based_rule_match_predicate_list.deserialize_json(
