...
class AwsElasticsearchDomainLogPublishingOptions(TypedDict, closed=True):
    index_slow_logs: NotRequired[
        "capo_securityhub.types.aws_elasticsearch_domain_log_publishing_options_log_config.AwsElasticsearchDomainLogPublishingOptionsLogConfig"
    ]
...
def serialize_json(value: AwsElasticsearchDomainLogPublishingOptions) -> dict:
    ...
    if "index_slow_logs" in value:
        ...
        out["IndexSlowLogs"] = (
            capo_securityhub.types.aws_elasticsearch_domain_log_publishing_options_log_config.serialize_json(
...
def deserialize_json(data: dict) -> AwsElasticsearchDomainLogPublishingOptions:
    ...
    if data.get("IndexSlowLogs") is not None:
        ...
        out["index_slow_logs"] = (
            capo_securityhub.types.aws_elasticsearch_domain_log_publishing_options_log_config.deserialize_json(
                data["IndexSlowLogs"]
            )
        )
