...
class ResourceSeverityBreakdown(TypedDict, closed=True):
    other: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p>The number of findings not in any of the severity categories.</p>"""
    fatal: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p>The number of findings with a severity level of fatal.</p>"""
    critical: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p>The number of findings with a severity level of critical.</p>"""
    high: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p>The number of findings with a severity level of high.</p>"""
    medium: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p>The number of findings with a severity level of medium.</p>"""
    low: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p>The number of findings with a severity level of low.</p>"""
    informational: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p>The number of findings that provide security-related information.</p>"""
    unknown: NotRequired["capo_securityhub.types.integer.Integer"]
