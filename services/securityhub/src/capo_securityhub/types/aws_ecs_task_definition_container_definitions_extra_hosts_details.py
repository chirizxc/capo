...
class AwsEcsTaskDefinitionContainerDefinitionsExtraHostsDetails(TypedDict, closed=True):
    ...
    ip_address: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
