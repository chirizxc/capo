...
class AwsEcsTaskDefinitionProxyConfigurationDetails(TypedDict, closed=True):
    container_name: NotRequired[
        "capo_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p>The name of the container that will serve as the App Mesh proxy.</p>"""
    proxy_configuration_properties: NotRequired[
        "capo_securityhub.types.aws_ecs_task_definition_proxy_configuration_proxy_configuration_properties_list.AwsEcsTaskDefinitionProxyConfigurationProxyConfigurationPropertiesList"
    ]
...
def serialize_json(value: AwsEcsTaskDefinitionProxyConfigurationDetails) -> dict:
    ...
    if "proxy_configuration_properties" in value:
        ...
        out["ProxyConfigurationProperties"] = (
            capo_securityhub.types.aws_ecs_task_definition_proxy_configuration_proxy_configuration_properties_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsEcsTaskDefinitionProxyConfigurationDetails:
    ...
    if data.get("ProxyConfigurationProperties") is not None:
        ...
        out["proxy_configuration_properties"] = (
            capo_securityhub.types.aws_ecs_task_definition_proxy_configuration_proxy_configuration_properties_list.deserialize_json(
