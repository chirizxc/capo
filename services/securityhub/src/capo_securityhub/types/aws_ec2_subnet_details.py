...
class AwsEc2SubnetDetails(TypedDict, closed=True):
    ...
    available_ip_address_count: NotRequired["capo_securityhub.types.integer.Integer"]
    ...
    default_for_az: NotRequired["capo_securityhub.types.boolean.Boolean"]
    """<p>Whether this subnet is the default subnet for the Availability Zone.</p>"""
    map_public_ip_on_launch: NotRequired["capo_securityhub.types.boolean.Boolean"]
    ...
    subnet_arn: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
