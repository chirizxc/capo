"""Generated from Smithy shape ``com.amazonaws.securityhub#UpdateFindingAggregatorResponse``."""
...
class UpdateFindingAggregatorResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: UpdateFindingAggregatorResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> UpdateFindingAggregatorResponse:
    out: UpdateFindingAggregatorResponse = {}  # type: ignore[typeddict-item]
