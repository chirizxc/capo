...
class AwsStepFunctionStateMachineDetails(TypedDict, closed=True):
    label: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    logging_configuration: NotRequired[
        "capo_securityhub.types.aws_step_function_state_machine_logging_configuration_details.AwsStepFunctionStateMachineLoggingConfigurationDetails"
    ]
    ...
    tracing_configuration: NotRequired[
        "capo_securityhub.types.aws_step_function_state_machine_tracing_configuration_details.AwsStepFunctionStateMachineTracingConfigurationDetails"
    ]
...
def serialize_json(value: AwsStepFunctionStateMachineDetails) -> dict:
    ...
    if "logging_configuration" in value:
        ...
        out["LoggingConfiguration"] = (
            capo_securityhub.types.aws_step_function_state_machine_logging_configuration_details.serialize_json(
    ...
    if "tracing_configuration" in value:
        ...
        out["TracingConfiguration"] = (
            capo_securityhub.types.aws_step_function_state_machine_tracing_configuration_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsStepFunctionStateMachineDetails:
    ...
    if data.get("LoggingConfiguration") is not None:
        ...
        out["logging_configuration"] = (
            capo_securityhub.types.aws_step_function_state_machine_logging_configuration_details.deserialize_json(
    ...
    if data.get("TracingConfiguration") is not None:
        ...
        out["tracing_configuration"] = (
            capo_securityhub.types.aws_step_function_state_machine_tracing_configuration_details.deserialize_json(
