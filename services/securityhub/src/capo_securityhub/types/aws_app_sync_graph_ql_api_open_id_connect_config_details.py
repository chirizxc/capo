...
class AwsAppSyncGraphQlApiOpenIdConnectConfigDetails(TypedDict, closed=True):
    auth_tt_l: NotRequired["capo_securityhub.types.long.Long"]
    """<p> The number of milliseconds that a token is valid after being authenticated. </p>"""
    client_id: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    iat_tt_l: NotRequired["capo_securityhub.types.long.Long"]
