...
class AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails(TypedDict, closed=True):
    authorization_config: NotRequired[
        "capo_securityhub.types.aws_ecs_task_definition_volumes_efs_volume_configuration_authorization_config_details.AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationAuthorizationConfigDetails"
    ]
    """<p>The authorization configuration details for the Amazon EFS file system.</p>"""
    filesystem_id: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    transit_encryption_port: NotRequired["capo_securityhub.types.integer.Integer"]
...
def serialize_json(
    ...
    if "authorization_config" in value:
        ...
        out["AuthorizationConfig"] = (
            capo_securityhub.types.aws_ecs_task_definition_volumes_efs_volume_configuration_authorization_config_details.serialize_json(
...
def deserialize_json(
    ...
    if data.get("AuthorizationConfig") is not None:
        ...
        out["authorization_config"] = (
            capo_securityhub.types.aws_ecs_task_definition_volumes_efs_volume_configuration_authorization_config_details.deserialize_json(
