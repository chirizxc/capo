...
class AwsEc2LaunchTemplateDataPlacementDetails(TypedDict, closed=True):
    affinity: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    host_id: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    partition_number: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p> The number of the partition the instance should launch in. </p>"""
    spread_domain: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p> Reserved for future use. </p>"""
    tenancy: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
