...
class AwsElbLoadBalancerPolicies(TypedDict, closed=True):
    app_cookie_stickiness_policies: NotRequired[
        "capo_securityhub.types.aws_elb_app_cookie_stickiness_policies.AwsElbAppCookieStickinessPolicies"
    ]
    ...
    lb_cookie_stickiness_policies: NotRequired[
        "capo_securityhub.types.aws_elb_lb_cookie_stickiness_policies.AwsElbLbCookieStickinessPolicies"
    ]
    """<p>The stickiness policies that are created using <code>CreateLBCookieStickinessPolicy</code>.</p>"""
    other_policies: NotRequired["capo_securityhub.types.string_list.StringList"]
...
def serialize_json(value: AwsElbLoadBalancerPolicies) -> dict:
    ...
    if "app_cookie_stickiness_policies" in value:
        ...
        out["AppCookieStickinessPolicies"] = (
            capo_securityhub.types.aws_elb_app_cookie_stickiness_policies.serialize_json(
    ...
    if "lb_cookie_stickiness_policies" in value:
        ...
        out["LbCookieStickinessPolicies"] = (
            capo_securityhub.types.aws_elb_lb_cookie_stickiness_policies.serialize_json(
    ...
    if "other_policies" in value:
        ...
        out["OtherPolicies"] = capo_securityhub.types.string_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsElbLoadBalancerPolicies:
    ...
    if data.get("AppCookieStickinessPolicies") is not None:
        ...
        out["app_cookie_stickiness_policies"] = (
            capo_securityhub.types.aws_elb_app_cookie_stickiness_policies.deserialize_json(
    ...
    if data.get("LbCookieStickinessPolicies") is not None:
        ...
        out["lb_cookie_stickiness_policies"] = (
            capo_securityhub.types.aws_elb_lb_cookie_stickiness_policies.deserialize_json(
