...
class SoftwarePackage(TypedDict, closed=True):
    ...
    epoch: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The epoch of the software package.</p>"""
    release: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    remediation: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
