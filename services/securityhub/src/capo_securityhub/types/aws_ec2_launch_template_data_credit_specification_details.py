...
class AwsEc2LaunchTemplateDataCreditSpecificationDetails(TypedDict, closed=True):
    cpu_credits: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
