...
class FirewallPolicyDetails(TypedDict, closed=True):
    stateful_rule_group_references: NotRequired[
        "capo_securityhub.types.firewall_policy_stateful_rule_group_references_list.FirewallPolicyStatefulRuleGroupReferencesList"
    ]
    """<p>The stateful rule groups that are used in the firewall policy.</p>"""
    stateless_custom_actions: NotRequired[
        "capo_securityhub.types.firewall_policy_stateless_custom_actions_list.FirewallPolicyStatelessCustomActionsList"
    ]
    ...
    stateless_rule_group_references: NotRequired[
        "capo_securityhub.types.firewall_policy_stateless_rule_group_references_list.FirewallPolicyStatelessRuleGroupReferencesList"
    ]
...
def serialize_json(value: FirewallPolicyDetails) -> dict:
    ...
    if "stateful_rule_group_references" in value:
        ...
        out["StatefulRuleGroupReferences"] = (
            capo_securityhub.types.firewall_policy_stateful_rule_group_references_list.serialize_json(
    ...
    if "stateless_custom_actions" in value:
        ...
        out["StatelessCustomActions"] = (
            capo_securityhub.types.firewall_policy_stateless_custom_actions_list.serialize_json(
    ...
    if "stateless_rule_group_references" in value:
        ...
        out["StatelessRuleGroupReferences"] = (
            capo_securityhub.types.firewall_policy_stateless_rule_group_references_list.serialize_json(
...
def deserialize_json(data: dict) -> FirewallPolicyDetails:
    ...
    if data.get("StatefulRuleGroupReferences") is not None:
        ...
        out["stateful_rule_group_references"] = (
            capo_securityhub.types.firewall_policy_stateful_rule_group_references_list.deserialize_json(
    ...
    if data.get("StatelessCustomActions") is not None:
        ...
        out["stateless_custom_actions"] = (
            capo_securityhub.types.firewall_policy_stateless_custom_actions_list.deserialize_json(
    ...
    if data.get("StatelessRuleGroupReferences") is not None:
        ...
        out["stateless_rule_group_references"] = (
            capo_securityhub.types.firewall_policy_stateless_rule_group_references_list.deserialize_json(
