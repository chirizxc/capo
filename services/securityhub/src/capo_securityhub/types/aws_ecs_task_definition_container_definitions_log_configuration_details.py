...
class AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetails(
    ...
    log_driver: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    secret_options: NotRequired[
        "capo_securityhub.types.aws_ecs_task_definition_container_definitions_log_configuration_secret_options_list.AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationSecretOptionsList"
    ]
...
def serialize_json(
    ...
    if "secret_options" in value:
        ...
        out["SecretOptions"] = (
            capo_securityhub.types.aws_ecs_task_definition_container_definitions_log_configuration_secret_options_list.serialize_json(
...
def deserialize_json(
    ...
    if data.get("SecretOptions") is not None:
        ...
        out["secret_options"] = (
            capo_securityhub.types.aws_ecs_task_definition_container_definitions_log_configuration_secret_options_list.deserialize_json(
                data["SecretOptions"]
            )
        )
    return out
