...
def serialize_json(value: BatchEnableStandardsRequest) -> dict:
    ...
    if "standards_subscription_requests" in value:
        ...
        out["StandardsSubscriptionRequests"] = (
            capo_securityhub.types.standards_subscription_requests.serialize_json(
...
def deserialize_json(data: dict) -> BatchEnableStandardsRequest:
    ...
    if data.get("StandardsSubscriptionRequests") is not None:
        import capo_securityhub.types.standards_subscription_requests

        out["standards_subscription_requests"] = (
            capo_securityhub.types.standards_subscription_requests.deserialize_json(
