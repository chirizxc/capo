...
if TYPE_CHECKING:
    import capo_securityhub.types.aws_waf_rate_based_rule_match_predicate_list
...
class AwsWafRateBasedRuleDetails(TypedDict, closed=True):
    ...
    rate_key: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    rate_limit: NotRequired["capo_securityhub.types.long.Long"]
    ...
    match_predicates: NotRequired[
        "capo_securityhub.types.aws_waf_rate_based_rule_match_predicate_list.AwsWafRateBasedRuleMatchPredicateList"
    ]
...
def serialize_json(value: AwsWafRateBasedRuleDetails) -> dict:
    ...
    if "match_predicates" in value:
        ...
        out["MatchPredicates"] = (
            capo_securityhub.types.aws_waf_rate_based_rule_match_predicate_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsWafRateBasedRuleDetails:
    ...
    if data.get("MatchPredicates") is not None:
        ...
        out["match_predicates"] = (
            capo_securityhub.types.aws_waf_rate_based_rule_match_predicate_list.deserialize_json(
