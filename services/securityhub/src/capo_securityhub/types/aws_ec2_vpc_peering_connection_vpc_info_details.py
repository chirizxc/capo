...
class AwsEc2VpcPeeringConnectionVpcInfoDetails(TypedDict, closed=True):
    ...
    cidr_block_set: NotRequired[
        "capo_securityhub.types.vpc_info_cidr_block_set_list.VpcInfoCidrBlockSetList"
    ]
    """<p>Information about the IPv4 CIDR blocks for the VPC. </p>"""
    ipv6_cidr_block_set: NotRequired[
        "capo_securityhub.types.vpc_info_ipv6_cidr_block_set_list.VpcInfoIpv6CidrBlockSetList"
    ]
    ...
    peering_options: NotRequired[
        "capo_securityhub.types.vpc_info_peering_options_details.VpcInfoPeeringOptionsDetails"
    ]
...
def serialize_json(value: AwsEc2VpcPeeringConnectionVpcInfoDetails) -> dict:
    ...
    if "cidr_block_set" in value:
        ...
        out["CidrBlockSet"] = (
            capo_securityhub.types.vpc_info_cidr_block_set_list.serialize_json(
    ...
    if "ipv6_cidr_block_set" in value:
        ...
        out["Ipv6CidrBlockSet"] = (
            capo_securityhub.types.vpc_info_ipv6_cidr_block_set_list.serialize_json(
    ...
    if "peering_options" in value:
        ...
        out["PeeringOptions"] = (
            capo_securityhub.types.vpc_info_peering_options_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsEc2VpcPeeringConnectionVpcInfoDetails:
    ...
    if data.get("CidrBlockSet") is not None:
        ...
        out["cidr_block_set"] = (
            capo_securityhub.types.vpc_info_cidr_block_set_list.deserialize_json(
                data["CidrBlockSet"]
            )
        )
    if data.get("Ipv6CidrBlockSet") is not None:
        ...
        out["ipv6_cidr_block_set"] = (
            capo_securityhub.types.vpc_info_ipv6_cidr_block_set_list.deserialize_json(
    ...
    if data.get("PeeringOptions") is not None:
        ...
        out["peering_options"] = (
            capo_securityhub.types.vpc_info_peering_options_details.deserialize_json(
                data["PeeringOptions"]
            )
        )
