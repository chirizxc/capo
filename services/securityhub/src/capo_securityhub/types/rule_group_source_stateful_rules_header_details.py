...
class RuleGroupSourceStatefulRulesHeaderDetails(TypedDict, closed=True):
    ...
    direction: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    source_port: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
