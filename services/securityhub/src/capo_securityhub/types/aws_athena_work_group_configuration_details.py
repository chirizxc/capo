...
if TYPE_CHECKING:
    import capo_securityhub.types.aws_athena_work_group_configuration_result_configuration_details


class AwsAthenaWorkGroupConfigurationDetails(TypedDict, closed=True):
    result_configuration: NotRequired[
        "capo_securityhub.types.aws_athena_work_group_configuration_result_configuration_details.AwsAthenaWorkGroupConfigurationResultConfigurationDetails"
    ]
...
def serialize_json(value: AwsAthenaWorkGroupConfigurationDetails) -> dict:
    ...
    if "result_configuration" in value:
        ...
        out["ResultConfiguration"] = (
            capo_securityhub.types.aws_athena_work_group_configuration_result_configuration_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsAthenaWorkGroupConfigurationDetails:
    ...
    if data.get("ResultConfiguration") is not None:
        ...
        out["result_configuration"] = (
            capo_securityhub.types.aws_athena_work_group_configuration_result_configuration_details.deserialize_json(
