...
class AwsKinesisStreamDetails(TypedDict, closed=True):
    ...
    stream_encryption: NotRequired[
        "capo_securityhub.types.aws_kinesis_stream_stream_encryption_details.AwsKinesisStreamStreamEncryptionDetails"
    ]
    ...
    shard_count: NotRequired["capo_securityhub.types.integer.Integer"]
    """<p>The number of shards that the stream uses. </p>"""
    retention_period_hours: NotRequired["capo_securityhub.types.integer.Integer"]
...
def serialize_json(value: AwsKinesisStreamDetails) -> dict:
    ...
    if "stream_encryption" in value:
        ...
        out["StreamEncryption"] = (
            capo_securityhub.types.aws_kinesis_stream_stream_encryption_details.serialize_json(
...
def deserialize_json(data: dict) -> AwsKinesisStreamDetails:
    ...
    if data.get("StreamEncryption") is not None:
        ...
        out["stream_encryption"] = (
            capo_securityhub.types.aws_kinesis_stream_stream_encryption_details.deserialize_json(
