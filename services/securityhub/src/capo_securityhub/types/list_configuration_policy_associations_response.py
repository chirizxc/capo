...
class ListConfigurationPolicyAssociationsResponse(TypedDict, closed=True):
    configuration_policy_association_summaries: NotRequired[
        "capo_securityhub.types.configuration_policy_association_summary_list.ConfigurationPolicyAssociationSummaryList"
    ]
...
def serialize_json(value: ListConfigurationPolicyAssociationsResponse) -> dict:
    ...
    if "configuration_policy_association_summaries" in value:
        ...
        out["ConfigurationPolicyAssociationSummaries"] = (
            capo_securityhub.types.configuration_policy_association_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListConfigurationPolicyAssociationsResponse:
    ...
    if data.get("ConfigurationPolicyAssociationSummaries") is not None:
        import capo_securityhub.types.configuration_policy_association_summary_list

        out["configuration_policy_association_summaries"] = (
            capo_securityhub.types.configuration_policy_association_summary_list.deserialize_json(
