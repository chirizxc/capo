...
class StandardsControl(TypedDict, closed=True):
    ...
    control_status_updated_at: NotRequired["capo_securityhub.types.timestamp.Timestamp"]
    """<p>The date and time that the status of the security standard control was most recently updated.</p>"""
    control_id: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
...
def serialize_json(value: StandardsControl) -> dict:
    ...
    if "control_status_updated_at" in value:
        ...
        out["ControlStatusUpdatedAt"] = capo_securityhub.types.timestamp.serialize_json(
...
def deserialize_json(data: dict) -> StandardsControl:
    ...
    if data.get("ControlStatusUpdatedAt") is not None:
        ...
        out["control_status_updated_at"] = (
            capo_securityhub.types.timestamp.deserialize_json(
