...
class AwsGuardDutyDetectorDetails(TypedDict, closed=True):
    data_sources: NotRequired[
        "capo_securityhub.types.aws_guard_duty_detector_data_sources_details.AwsGuardDutyDetectorDataSourcesDetails"
    ]
    """<p> Describes which data sources are activated for the detector. </p>"""
    features: NotRequired[
        "capo_securityhub.types.aws_guard_duty_detector_features_list.AwsGuardDutyDetectorFeaturesList"
    ]
...
def serialize_json(value: AwsGuardDutyDetectorDetails) -> dict:
    ...
    if "data_sources" in value:
        ...
        out["DataSources"] = (
            capo_securityhub.types.aws_guard_duty_detector_data_sources_details.serialize_json(
                value["data_sources"]
            )
        )
    if "features" in value:
        ...
        out["Features"] = (
            capo_securityhub.types.aws_guard_duty_detector_features_list.serialize_json(
                value["features"]
            )
        )
...
def deserialize_json(data: dict) -> AwsGuardDutyDetectorDetails:
    ...
    if data.get("DataSources") is not None:
        ...
        out["data_sources"] = (
            capo_securityhub.types.aws_guard_duty_detector_data_sources_details.deserialize_json(
                data["DataSources"]
            )
        )
    if data.get("Features") is not None:
        ...
        out["features"] = (
            capo_securityhub.types.aws_guard_duty_detector_features_list.deserialize_json(
                data["Features"]
            )
        )
