...
class AwsEc2NetworkInterfaceDetails(TypedDict, closed=True):
    attachment: NotRequired[
        "capo_securityhub.types.aws_ec2_network_interface_attachment.AwsEc2NetworkInterfaceAttachment"
    ]
    ...
    security_groups: NotRequired[
        "capo_securityhub.types.aws_ec2_network_interface_security_group_list.AwsEc2NetworkInterfaceSecurityGroupList"
    ]
    """<p>Security groups for the network interface.</p>"""
    source_dest_check: NotRequired["capo_securityhub.types.boolean.Boolean"]
    """<p>Indicates whether traffic to or from the instance is validated.</p>"""
    ip_v6_addresses: NotRequired[
        "capo_securityhub.types.aws_ec2_network_interface_ip_v6_address_list.AwsEc2NetworkInterfaceIpV6AddressList"
    ]
    """<p>The IPv6 addresses associated with the network interface.</p>"""
    private_ip_addresses: NotRequired[
        "capo_securityhub.types.aws_ec2_network_interface_private_ip_address_list.AwsEc2NetworkInterfacePrivateIpAddressList"
    ]
    ...
    public_ip: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
...
def serialize_json(value: AwsEc2NetworkInterfaceDetails) -> dict:
    ...
    if "attachment" in value:
        ...
        out["Attachment"] = (
            capo_securityhub.types.aws_ec2_network_interface_attachment.serialize_json(
                value["attachment"]
            )
        )
    ...
    if "security_groups" in value:
        ...
        out["SecurityGroups"] = (
            capo_securityhub.types.aws_ec2_network_interface_security_group_list.serialize_json(
    ...
    if "ip_v6_addresses" in value:
        ...
        out["IpV6Addresses"] = (
            capo_securityhub.types.aws_ec2_network_interface_ip_v6_address_list.serialize_json(
    ...
    if "private_ip_addresses" in value:
        ...
        out["PrivateIpAddresses"] = (
            capo_securityhub.types.aws_ec2_network_interface_private_ip_address_list.serialize_json(
...
def deserialize_json(data: dict) -> AwsEc2NetworkInterfaceDetails:
    ...
    if data.get("Attachment") is not None:
        ...
        out["attachment"] = (
            capo_securityhub.types.aws_ec2_network_interface_attachment.deserialize_json(
                data["Attachment"]
            )
        )
    ...
    if data.get("SecurityGroups") is not None:
        ...
        out["security_groups"] = (
            capo_securityhub.types.aws_ec2_network_interface_security_group_list.deserialize_json(
                data["SecurityGroups"]
            )
        )
    ...
    if data.get("IpV6Addresses") is not None:
        ...
        out["ip_v6_addresses"] = (
            capo_securityhub.types.aws_ec2_network_interface_ip_v6_address_list.deserialize_json(
                data["IpV6Addresses"]
            )
        )
    if data.get("PrivateIpAddresses") is not None:
        ...
        out["private_ip_addresses"] = (
            capo_securityhub.types.aws_ec2_network_interface_private_ip_address_list.deserialize_json(
