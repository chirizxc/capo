...
class CodeRepositoryDetails(TypedDict, closed=True):
    provider_type: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p> The type of repository provider. </p>"""
    project_name: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
