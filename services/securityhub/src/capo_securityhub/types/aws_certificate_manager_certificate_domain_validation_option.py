...
class AwsCertificateManagerCertificateDomainValidationOption(TypedDict, closed=True):
    ...
    resource_record: NotRequired[
        "capo_securityhub.types.aws_certificate_manager_certificate_resource_record.AwsCertificateManagerCertificateResourceRecord"
    ]
    ...
    validation_emails: NotRequired["capo_securityhub.types.string_list.StringList"]
...
def serialize_json(
    ...
    if "resource_record" in value:
        ...
        out["ResourceRecord"] = (
            capo_securityhub.types.aws_certificate_manager_certificate_resource_record.serialize_json(
    ...
    if "validation_emails" in value:
        ...
        out["ValidationEmails"] = capo_securityhub.types.string_list.serialize_json(
...
def deserialize_json(
    ...
    if data.get("ResourceRecord") is not None:
        ...
        out["resource_record"] = (
            capo_securityhub.types.aws_certificate_manager_certificate_resource_record.deserialize_json(
                data["ResourceRecord"]
            )
        )
