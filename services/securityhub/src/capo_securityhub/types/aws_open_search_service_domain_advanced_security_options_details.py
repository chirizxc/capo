...
class AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetails(TypedDict, closed=True):
    ...
    master_user_options: NotRequired[
        "capo_securityhub.types.aws_open_search_service_domain_master_user_options_details.AwsOpenSearchServiceDomainMasterUserOptionsDetails"
    ]
...
def serialize_json(
    ...
    if "master_user_options" in value:
        ...
        out["MasterUserOptions"] = (
            capo_securityhub.types.aws_open_search_service_domain_master_user_options_details.serialize_json(
...
def deserialize_json(
    ...
    if data.get("MasterUserOptions") is not None:
        ...
        out["master_user_options"] = (
            capo_securityhub.types.aws_open_search_service_domain_master_user_options_details.deserialize_json(
