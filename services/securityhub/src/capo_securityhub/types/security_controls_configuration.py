...
class SecurityControlsConfiguration(TypedDict, closed=True):
    enabled_security_control_identifiers: NotRequired[
        "capo_securityhub.types.enabled_security_control_identifier_list.EnabledSecurityControlIdentifierList"
    ]
    ...
    disabled_security_control_identifiers: NotRequired[
        "capo_securityhub.types.disabled_security_control_identifier_list.DisabledSecurityControlIdentifierList"
    ]
    ...
    security_control_custom_parameters: NotRequired[
        "capo_securityhub.types.security_control_custom_parameters_list.SecurityControlCustomParametersList"
    ]
...
def serialize_json(value: SecurityControlsConfiguration) -> dict:
    ...
    if "enabled_security_control_identifiers" in value:
        ...
        out["EnabledSecurityControlIdentifiers"] = (
            capo_securityhub.types.enabled_security_control_identifier_list.serialize_json(
    ...
    if "disabled_security_control_identifiers" in value:
        ...
        out["DisabledSecurityControlIdentifiers"] = (
            capo_securityhub.types.disabled_security_control_identifier_list.serialize_json(
    ...
    if "security_control_custom_parameters" in value:
        ...
        out["SecurityControlCustomParameters"] = (
            capo_securityhub.types.security_control_custom_parameters_list.serialize_json(
...
def deserialize_json(data: dict) -> SecurityControlsConfiguration:
    ...
    if data.get("EnabledSecurityControlIdentifiers") is not None:
        ...
        out["enabled_security_control_identifiers"] = (
            capo_securityhub.types.enabled_security_control_identifier_list.deserialize_json(
    ...
    if data.get("DisabledSecurityControlIdentifiers") is not None:
        ...
        out["disabled_security_control_identifiers"] = (
            capo_securityhub.types.disabled_security_control_identifier_list.deserialize_json(
    ...
    if data.get("SecurityControlCustomParameters") is not None:
        ...
        out["security_control_custom_parameters"] = (
            capo_securityhub.types.security_control_custom_parameters_list.deserialize_json(
