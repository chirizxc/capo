...
class Product(TypedDict, closed=True):
    ...
    integration_types: NotRequired[
        "capo_securityhub.types.integration_type_list.IntegrationTypeList"
    ]
...
def serialize_json(value: Product) -> dict:
    ...
    if "integration_types" in value:
        ...
        out["IntegrationTypes"] = (
            capo_securityhub.types.integration_type_list.serialize_json(
...
def deserialize_json(data: dict) -> Product:
    ...
    if data.get("IntegrationTypes") is not None:
        ...
        out["integration_types"] = (
            capo_securityhub.types.integration_type_list.deserialize_json(
