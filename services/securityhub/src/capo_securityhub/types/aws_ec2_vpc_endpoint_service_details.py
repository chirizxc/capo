...
class AwsEc2VpcEndpointServiceDetails(TypedDict, closed=True):
    acceptance_required: NotRequired["capo_securityhub.types.boolean.Boolean"]
    ...
    manages_vpc_endpoints: NotRequired["capo_securityhub.types.boolean.Boolean"]
    ...
    service_id: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The identifier of the service.</p>"""
    service_name: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The name of the service.</p>"""
    service_state: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    service_type: NotRequired[
        "capo_securityhub.types.aws_ec2_vpc_endpoint_service_service_type_list.AwsEc2VpcEndpointServiceServiceTypeList"
    ]
...
def serialize_json(value: AwsEc2VpcEndpointServiceDetails) -> dict:
    ...
    if "service_type" in value:
        ...
        out["ServiceType"] = (
            capo_securityhub.types.aws_ec2_vpc_endpoint_service_service_type_list.serialize_json(
                value["service_type"]
            )
        )
    return out
...
def deserialize_json(data: dict) -> AwsEc2VpcEndpointServiceDetails:
    ...
    if data.get("ServiceType") is not None:
        ...
        out["service_type"] = (
            capo_securityhub.types.aws_ec2_vpc_endpoint_service_service_type_list.deserialize_json(
                data["ServiceType"]
            )
        )
    return out
