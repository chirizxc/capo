...
class AwsElasticBeanstalkEnvironmentDetails(TypedDict, closed=True):
    application_name: NotRequired[
        "capo_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p>The name of the application that is associated with the environment.</p>"""
    cname: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The URL to the CNAME for this environment.</p>"""
    date_created: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p>The creation date for this environment.</p>"""
    date_updated: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    environment_links: NotRequired[
        "capo_securityhub.types.aws_elastic_beanstalk_environment_environment_links.AwsElasticBeanstalkEnvironmentEnvironmentLinks"
    ]
    ...
    option_settings: NotRequired[
        "capo_securityhub.types.aws_elastic_beanstalk_environment_option_settings.AwsElasticBeanstalkEnvironmentOptionSettings"
    ]
    """<p>The configuration setting for the environment.</p>"""
    platform_arn: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    tier: NotRequired[
        "capo_securityhub.types.aws_elastic_beanstalk_environment_tier.AwsElasticBeanstalkEnvironmentTier"
    ]
    """<p>The tier of the environment.</p>"""
    version_label: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
...
def serialize_json(value: AwsElasticBeanstalkEnvironmentDetails) -> dict:
    ...
    if "environment_links" in value:
        ...
        out["EnvironmentLinks"] = (
            capo_securityhub.types.aws_elastic_beanstalk_environment_environment_links.serialize_json(
    ...
    if "option_settings" in value:
        ...
        out["OptionSettings"] = (
            capo_securityhub.types.aws_elastic_beanstalk_environment_option_settings.serialize_json(
    ...
    if "tier" in value:
        ...
        out["Tier"] = (
            capo_securityhub.types.aws_elastic_beanstalk_environment_tier.serialize_json(
                value["tier"]
            )
        )
...
def deserialize_json(data: dict) -> AwsElasticBeanstalkEnvironmentDetails:
    ...
    if data.get("EnvironmentLinks") is not None:
        ...
        out["environment_links"] = (
            capo_securityhub.types.aws_elastic_beanstalk_environment_environment_links.deserialize_json(
    ...
    if data.get("OptionSettings") is not None:
        ...
        out["option_settings"] = (
            capo_securityhub.types.aws_elastic_beanstalk_environment_option_settings.deserialize_json(
                data["OptionSettings"]
            )
        )
    ...
    if data.get("Tier") is not None:
        ...
        out["tier"] = (
            capo_securityhub.types.aws_elastic_beanstalk_environment_tier.deserialize_json(
                data["Tier"]
            )
        )
