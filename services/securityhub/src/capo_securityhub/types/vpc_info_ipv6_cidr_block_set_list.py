...
if TYPE_CHECKING:
    import capo_securityhub.types.vpc_info_ipv6_cidr_block_set_details

VpcInfoIpv6CidrBlockSetList: TypeAlias = list[
    "capo_securityhub.types.vpc_info_ipv6_cidr_block_set_details.VpcInfoIpv6CidrBlockSetDetails"
]
...
def serialize_json(value: VpcInfoIpv6CidrBlockSetList) -> list:
    ...
    for item in value:
        out.append(
            capo_securityhub.types.vpc_info_ipv6_cidr_block_set_details.serialize_json(
                item
            )
        )
    return out
