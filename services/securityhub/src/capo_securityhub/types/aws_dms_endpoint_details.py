...
class AwsDmsEndpointDetails(TypedDict, closed=True):
    ...
    endpoint_arn: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p> The Amazon Resource Name (ARN) of the endpoint. </p>"""
    endpoint_identifier: NotRequired[
        "capo_securityhub.types.non_empty_string.NonEmptyString"
    ]
    """<p> The database endpoint identifier. </p>"""
    endpoint_type: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p> The type of endpoint. Valid values are source and target. </p>"""
    engine_name: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p> The type of engine for the endpoint, depending on the <code>EndpointType</code> value. </p>"""
    external_id: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    ...
    server_name: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p> The name of the server where the endpoint database resides.</p>"""
    ssl_mode: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
    """<p> The SSL mode used to connect to the endpoint. The default is none.</p>"""
    username: NotRequired["capo_securityhub.types.non_empty_string.NonEmptyString"]
