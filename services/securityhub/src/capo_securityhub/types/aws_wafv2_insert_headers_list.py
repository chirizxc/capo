...
if TYPE_CHECKING:
    import capo_securityhub.types.aws_wafv2_custom_http_header

AwsWafv2InsertHeadersList: TypeAlias = list[
    "capo_securityhub.types.aws_wafv2_custom_http_header.AwsWafv2CustomHttpHeader"
]
...
def serialize_json(value: AwsWafv2InsertHeadersList) -> list:
    ...
    for item in value:
        out.append(
            capo_securityhub.types.aws_wafv2_custom_http_header.serialize_json(item)
        )
    return out
