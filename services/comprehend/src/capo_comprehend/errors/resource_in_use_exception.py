"""Generated from Smithy shape ``com.amazonaws.comprehend#ResourceInUseException``."""
...
class ResourceInUseException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.comprehend#ResourceInUseException``."""
