...
class BatchDetectEntitiesResponse(TypedDict, closed=True):
    result_list: "capo_comprehend.types.list_of_detect_entities_result.ListOfDetectEntitiesResult"
...
def serialize_aws_json_1_1(value: BatchDetectEntitiesResponse) -> dict:
    ...
    out["ResultList"] = (
        capo_comprehend.types.list_of_detect_entities_result.serialize_aws_json_1_1(
            value["result_list"]
        )
    )
    import capo_comprehend.types.batch_item_error_list
...
def deserialize_aws_json_1_1(data: dict) -> BatchDetectEntitiesResponse:
    ...
    if data.get("ResultList") is not None:
        ...
        out["result_list"] = (
            capo_comprehend.types.list_of_detect_entities_result.deserialize_aws_json_1_1(
                data["ResultList"]
            )
        )
    else:
