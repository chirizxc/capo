"""Generated from Smithy shape ``com.amazonaws.comprehend#StopDominantLanguageDetectionJobResponse``."""
...
class StopDominantLanguageDetectionJobResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StopDominantLanguageDetectionJobResponse) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_aws_json_1_1(data: dict) -> StopDominantLanguageDetectionJobResponse:
    out: StopDominantLanguageDetectionJobResponse = {}  # type: ignore[typeddict-item]
