"""Generated from Smithy shape ``com.amazonaws.comprehend#StartSentimentDetectionJobResponse``."""
...
class StartSentimentDetectionJobResponse(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StartSentimentDetectionJobResponse) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_aws_json_1_1(data: dict) -> StartSentimentDetectionJobResponse:
    out: StartSentimentDetectionJobResponse = {}  # type: ignore[typeddict-item]
