"""Generated from Smithy shape ``com.amazonaws.comprehend#EntitiesDetectionJobFilter``."""
...
class EntitiesDetectionJobFilter(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: EntitiesDetectionJobFilter) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_1(data: dict) -> EntitiesDetectionJobFilter:
    out: EntitiesDetectionJobFilter = {}  # type: ignore[typeddict-item]
