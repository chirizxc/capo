"""Generated from Smithy shape ``com.amazonaws.comprehend#ListEntitiesDetectionJobsRequest``."""
...
class ListEntitiesDetectionJobsRequest(TypedDict, closed=True):
    filter: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListEntitiesDetectionJobsRequest) -> dict:
    out: dict = {}
    if "filter" in value:
        import capo_comprehend.types.entities_detection_job_filter

        out["Filter"] = (
            capo_comprehend.types.entities_detection_job_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListEntitiesDetectionJobsRequest:
    out: ListEntitiesDetectionJobsRequest = {}  # type: ignore[typeddict-item]
    if data.get("Filter") is not None:
        import capo_comprehend.types.entities_detection_job_filter

        out["filter"] = (
            capo_comprehend.types.entities_detection_job_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
