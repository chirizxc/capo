"""Generated from Smithy shape ``com.amazonaws.comprehend#SentimentDetectionJobProperties``."""
...
class SentimentDetectionJobProperties(TypedDict, closed=True):
    ...
    r"""<p> Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you are using for your sentiment detection job. For more information, see <a href=\"https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html\">Amazon VPC</a>. </p>"""


# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: SentimentDetectionJobProperties) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_aws_json_1_1(data: dict) -> SentimentDetectionJobProperties:
    out: SentimentDetectionJobProperties = {}  # type: ignore[typeddict-item]
