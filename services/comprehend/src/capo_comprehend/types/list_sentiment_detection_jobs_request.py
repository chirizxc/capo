"""Generated from Smithy shape ``com.amazonaws.comprehend#ListSentimentDetectionJobsRequest``."""
...
class ListSentimentDetectionJobsRequest(TypedDict, closed=True):
    filter: NotRequired[
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: ListSentimentDetectionJobsRequest) -> dict:
    out: dict = {}
    if "filter" in value:
        import capo_comprehend.types.sentiment_detection_job_filter

        out["Filter"] = (
            capo_comprehend.types.sentiment_detection_job_filter.serialize_aws_json_1_1(
                value["filter"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ListSentimentDetectionJobsRequest:
    ...
    if data.get("Filter") is not None:
        ...
        out["filter"] = (
            capo_comprehend.types.sentiment_detection_job_filter.deserialize_aws_json_1_1(
                data["Filter"]
            )
        )
