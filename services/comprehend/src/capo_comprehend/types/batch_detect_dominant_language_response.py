...
class BatchDetectDominantLanguageResponse(TypedDict, closed=True):
    result_list: "capo_comprehend.types.list_of_detect_dominant_language_result.ListOfDetectDominantLanguageResult"
...
def serialize_aws_json_1_1(value: BatchDetectDominantLanguageResponse) -> dict:
    ...
    out["ResultList"] = (
        capo_comprehend.types.list_of_detect_dominant_language_result.serialize_aws_json_1_1(
            value["result_list"]
        )
    )
    import capo_comprehend.types.batch_item_error_list
...
def deserialize_aws_json_1_1(data: dict) -> BatchDetectDominantLanguageResponse:
    ...
    if data.get("ResultList") is not None:
        ...
        out["result_list"] = (
            capo_comprehend.types.list_of_detect_dominant_language_result.deserialize_aws_json_1_1(
                data["ResultList"]
            )
        )
    else:
    ...
    if data.get("ErrorList") is not None:
        import capo_comprehend.types.batch_item_error_list
