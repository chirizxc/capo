...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: StopSentimentDetectionJobResponse) -> dict:
    out: dict = {}
    if "job_id" in value:
...
def deserialize_aws_json_1_1(data: dict) -> StopSentimentDetectionJobResponse:
    out: StopSentimentDetectionJobResponse = {}  # type: ignore[typeddict-item]
