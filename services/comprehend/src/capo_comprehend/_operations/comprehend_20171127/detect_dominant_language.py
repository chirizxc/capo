...
def handle_response(
    ...
    out: capo_comprehend.types.detect_dominant_language_response.DetectDominantLanguageResponse = capo_comprehend.types.detect_dominant_language_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.detect_dominant_language_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
