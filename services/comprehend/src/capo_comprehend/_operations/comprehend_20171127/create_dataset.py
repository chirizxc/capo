...
def handle_response(
    ...
    out: capo_comprehend.types.create_dataset_response.CreateDatasetResponse = (
        capo_comprehend.types.create_dataset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.create_dataset_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_dataset(
    ...
    capo_comprehend.types.create_dataset_response.CreateDatasetResponse, zapros.Response
]:
