"""Generated from Smithy shape ``com.amazonaws.comprehend#CreateDocumentClassifier``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.create_document_classifier_response.CreateDocumentClassifierResponse = capo_comprehend.types.create_document_classifier_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.create_document_classifier_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_document_classifier(
