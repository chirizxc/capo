"""Generated from Smithy shape ``com.amazonaws.comprehend#StartDocumentClassificationJob``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.start_document_classification_job_response.StartDocumentClassificationJobResponse = capo_comprehend.types.start_document_classification_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.start_document_classification_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_document_classification_job(
