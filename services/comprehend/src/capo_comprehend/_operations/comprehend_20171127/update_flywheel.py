...
def handle_response(
    ...
    out: capo_comprehend.types.update_flywheel_response.UpdateFlywheelResponse = (
        capo_comprehend.types.update_flywheel_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.update_flywheel_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
