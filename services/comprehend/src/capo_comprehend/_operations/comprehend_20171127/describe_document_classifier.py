...
def handle_response(
    ...
    out: capo_comprehend.types.describe_document_classifier_response.DescribeDocumentClassifierResponse = capo_comprehend.types.describe_document_classifier_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_document_classifier_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
