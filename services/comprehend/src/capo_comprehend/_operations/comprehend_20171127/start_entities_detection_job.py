"""Generated from Smithy shape ``com.amazonaws.comprehend#StartEntitiesDetectionJob``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.start_entities_detection_job_response.StartEntitiesDetectionJobResponse = capo_comprehend.types.start_entities_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.start_entities_detection_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_entities_detection_job(
