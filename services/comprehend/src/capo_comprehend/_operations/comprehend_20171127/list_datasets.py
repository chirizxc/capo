...
def handle_response(
    ...
    out: capo_comprehend.types.list_datasets_response.ListDatasetsResponse = (
        capo_comprehend.types.list_datasets_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_datasets_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_datasets(
    ...
    capo_comprehend.types.list_datasets_response.ListDatasetsResponse, zapros.Response
]:
