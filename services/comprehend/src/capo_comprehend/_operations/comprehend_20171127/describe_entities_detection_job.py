...
def handle_response(
    ...
    out: capo_comprehend.types.describe_entities_detection_job_response.DescribeEntitiesDetectionJobResponse = capo_comprehend.types.describe_entities_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_entities_detection_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
