"""Generated from Smithy shape ``com.amazonaws.comprehend#ListSentimentDetectionJobs``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.list_sentiment_detection_jobs_response.ListSentimentDetectionJobsResponse = capo_comprehend.types.list_sentiment_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_sentiment_detection_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_sentiment_detection_jobs(
