"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.describe_resource_policy_response.DescribeResourcePolicyResponse = capo_comprehend.types.describe_resource_policy_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DescribeResourcePolicy"
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_resource_policy_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
