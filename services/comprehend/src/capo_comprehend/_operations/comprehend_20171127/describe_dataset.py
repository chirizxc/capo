"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeDataset``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.describe_dataset_response.DescribeDatasetResponse = (
        capo_comprehend.types.describe_dataset_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DescribeDataset"
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_dataset_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
