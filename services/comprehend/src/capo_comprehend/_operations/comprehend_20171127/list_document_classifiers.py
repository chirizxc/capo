"""Generated from Smithy shape ``com.amazonaws.comprehend#ListDocumentClassifiers``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.list_document_classifiers_response.ListDocumentClassifiersResponse = capo_comprehend.types.list_document_classifiers_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_document_classifiers_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_document_classifiers(
