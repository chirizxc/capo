...
def handle_response(
    ...
    out: capo_comprehend.types.batch_detect_key_phrases_response.BatchDetectKeyPhrasesResponse = capo_comprehend.types.batch_detect_key_phrases_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.batch_detect_key_phrases_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
