"""Generated from Smithy shape ``com.amazonaws.comprehend#ListEntityRecognizerSummaries``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.list_entity_recognizer_summaries_response.ListEntityRecognizerSummariesResponse = capo_comprehend.types.list_entity_recognizer_summaries_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.ListEntityRecognizerSummaries"
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_entity_recognizer_summaries_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_entity_recognizer_summaries(
