...
def handle_response(
    ...
    out: capo_comprehend.types.stop_training_entity_recognizer_response.StopTrainingEntityRecognizerResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.stop_training_entity_recognizer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
