"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribePiiEntitiesDetectionJob``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.describe_pii_entities_detection_job_response.DescribePiiEntitiesDetectionJobResponse = capo_comprehend.types.describe_pii_entities_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Comprehend_20171127.DescribePiiEntitiesDetectionJob"
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_pii_entities_detection_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_pii_entities_detection_job(
