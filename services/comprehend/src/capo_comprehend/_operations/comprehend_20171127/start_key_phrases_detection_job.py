"""Generated from Smithy shape ``com.amazonaws.comprehend#StartKeyPhrasesDetectionJob``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.start_key_phrases_detection_job_response.StartKeyPhrasesDetectionJobResponse = capo_comprehend.types.start_key_phrases_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.start_key_phrases_detection_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_key_phrases_detection_job(
