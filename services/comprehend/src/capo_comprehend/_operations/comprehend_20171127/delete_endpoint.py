"""Generated from Smithy shape ``com.amazonaws.comprehend#DeleteEndpoint``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.delete_endpoint_response.DeleteEndpointResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.delete_endpoint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
