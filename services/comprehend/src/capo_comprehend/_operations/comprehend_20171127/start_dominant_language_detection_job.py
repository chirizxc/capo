...
def handle_response(
    ...
    out: capo_comprehend.types.start_dominant_language_detection_job_response.StartDominantLanguageDetectionJobResponse = capo_comprehend.types.start_dominant_language_detection_job_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.start_dominant_language_detection_job_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
