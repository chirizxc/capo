"""Generated from Smithy shape ``com.amazonaws.comprehend#BatchDetectSentiment``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.batch_detect_sentiment_response.BatchDetectSentimentResponse = capo_comprehend.types.batch_detect_sentiment_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.batch_detect_sentiment_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_detect_sentiment(
