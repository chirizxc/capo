"""Generated from Smithy shape ``com.amazonaws.comprehend#DetectEntities``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.detect_entities_response.DetectEntitiesResponse = (
        capo_comprehend.types.detect_entities_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.detect_entities_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
