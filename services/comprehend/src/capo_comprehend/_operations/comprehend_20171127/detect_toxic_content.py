...
def handle_response(
    ...
    out: capo_comprehend.types.detect_toxic_content_response.DetectToxicContentResponse = capo_comprehend.types.detect_toxic_content_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.detect_toxic_content_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
