"""Generated from Smithy shape ``com.amazonaws.comprehend#BatchDetectDominantLanguage``."""
...
import capo_comprehend.types.list_of_detect_dominant_language_result
...
def handle_response(
    ...
    out: capo_comprehend.types.batch_detect_dominant_language_response.BatchDetectDominantLanguageResponse = capo_comprehend.types.batch_detect_dominant_language_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.batch_detect_dominant_language_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_detect_dominant_language(
