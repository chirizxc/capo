"""Generated from Smithy shape ``com.amazonaws.comprehend#DescribeEntityRecognizer``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.describe_entity_recognizer_response.DescribeEntityRecognizerResponse = capo_comprehend.types.describe_entity_recognizer_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.describe_entity_recognizer_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_entity_recognizer(
