...
def handle_response(
    ...
    out: capo_comprehend.types.list_pii_entities_detection_jobs_response.ListPiiEntitiesDetectionJobsResponse = capo_comprehend.types.list_pii_entities_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_pii_entities_detection_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
