...
def handle_response(
    ...
    out: capo_comprehend.types.start_flywheel_iteration_response.StartFlywheelIterationResponse = capo_comprehend.types.start_flywheel_iteration_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.start_flywheel_iteration_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
