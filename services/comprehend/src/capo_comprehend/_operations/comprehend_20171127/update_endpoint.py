"""Generated from Smithy shape ``com.amazonaws.comprehend#UpdateEndpoint``."""
...
def handle_response(
    ...
    out: capo_comprehend.types.update_endpoint_response.UpdateEndpointResponse = (
        capo_comprehend.types.update_endpoint_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.update_endpoint_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
