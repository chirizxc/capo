...
def handle_response(
    ...
    out: capo_comprehend.types.list_entities_detection_jobs_response.ListEntitiesDetectionJobsResponse = capo_comprehend.types.list_entities_detection_jobs_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_comprehend.types.list_entities_detection_jobs_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
