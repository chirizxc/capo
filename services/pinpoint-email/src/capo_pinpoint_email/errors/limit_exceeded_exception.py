"""Generated from Smithy shape ``com.amazonaws.pinpointemail#LimitExceededException``."""
...
class LimitExceededException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.pinpointemail#LimitExceededException``."""
