...
if TYPE_CHECKING:
    import capo_pinpoint_email.types.tag_key
    import capo_pinpoint_email.types.tag_value


class Tag(TypedDict, closed=True):
    key: "capo_pinpoint_email.types.tag_key.TagKey"
    ...
    value: "capo_pinpoint_email.types.tag_value.TagValue"
