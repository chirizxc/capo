...
class StartAttachmentUploadResponse(TypedDict, closed=True):
    ...
    upload_metadata: NotRequired[
        "capo_connectparticipant.types.upload_metadata.UploadMetadata"
    ]
...
def serialize_json(value: StartAttachmentUploadResponse) -> dict:
    ...
    if "upload_metadata" in value:
        ...
        out["UploadMetadata"] = (
            capo_connectparticipant.types.upload_metadata.serialize_json(
...
def deserialize_json(data: dict) -> StartAttachmentUploadResponse:
    ...
    if data.get("UploadMetadata") is not None:
        ...
        out["upload_metadata"] = (
            capo_connectparticipant.types.upload_metadata.deserialize_json(
                data["UploadMetadata"]
            )
        )
    return out
