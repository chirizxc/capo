...
def handle_response(
    ...
    out: capo_datazone.types.list_lineage_node_history_output.ListLineageNodeHistoryOutput = capo_datazone.types.list_lineage_node_history_output.deserialize_json(
...
def build_request(
    ...
    if "direction" in input_:
        params.append(
            (
                "direction",
                capo_datazone.types.edge_direction.serialize_json(input_["direction"]),
            )
        )
