"""Generated from Smithy shape ``com.amazonaws.datazone#GetEnvironmentBlueprintConfiguration``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_environment_blueprint_configuration_output.GetEnvironmentBlueprintConfigurationOutput = capo_datazone.types.get_environment_blueprint_configuration_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["environment_blueprint_identifier"], safe=""),
    )
...
async def async_get_environment_blueprint_configuration(
