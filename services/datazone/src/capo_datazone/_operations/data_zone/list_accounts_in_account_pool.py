"""Generated from Smithy shape ``com.amazonaws.datazone#ListAccountsInAccountPool``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_accounts_in_account_pool_output.ListAccountsInAccountPoolOutput = capo_datazone.types.list_accounts_in_account_pool_output.deserialize_json(
...
async def async_list_accounts_in_account_pool(
