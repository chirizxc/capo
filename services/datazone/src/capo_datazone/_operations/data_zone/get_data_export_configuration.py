"""Generated from Smithy shape ``com.amazonaws.datazone#GetDataExportConfiguration``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_data_export_configuration_output.GetDataExportConfigurationOutput = capo_datazone.types.get_data_export_configuration_output.deserialize_json(
...
async def async_get_data_export_configuration(
