...
def handle_response(
    ...
    out: capo_datazone.types.list_data_source_run_activities_output.ListDataSourceRunActivitiesOutput = capo_datazone.types.list_data_source_run_activities_output.deserialize_json(
