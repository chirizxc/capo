...
def handle_response(
    ...
    out: capo_datazone.types.create_asset_type_output.CreateAssetTypeOutput = (
        capo_datazone.types.create_asset_type_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_asset_type_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_asset_type(
    ...
    capo_datazone.types.create_asset_type_output.CreateAssetTypeOutput, zapros.Response
]:
