"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteDataSource``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_data_source_output.DeleteDataSourceOutput = (
        capo_datazone.types.delete_data_source_output.deserialize_json(
...
def build_request(
    ...
    if "retain_permissions_on_revoke_failure" in input_:
        params.append(
            (
                "retainPermissionsOnRevokeFailure",
                "true" if input_["retain_permissions_on_revoke_failure"] else "false",
            )
        )
