"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteRule``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_rule_output.DeleteRuleOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_rule(
    ...
    input_: capo_datazone.types.delete_rule_input.DeleteRuleInput,
) -> tuple[capo_datazone.types.delete_rule_output.DeleteRuleOutput, zapros.Response]:
