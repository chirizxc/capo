...
def handle_response(
    ...
    out: capo_datazone.types.update_root_domain_unit_owner_output.UpdateRootDomainUnitOwnerOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_root_domain_unit_owner_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
