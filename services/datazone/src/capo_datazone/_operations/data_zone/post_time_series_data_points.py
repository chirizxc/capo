"""Generated from Smithy shape ``com.amazonaws.datazone#PostTimeSeriesDataPoints``."""
...
def handle_response(
    ...
    out: capo_datazone.types.post_time_series_data_points_output.PostTimeSeriesDataPointsOutput = capo_datazone.types.post_time_series_data_points_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{entityType}",
        quote(
            capo_datazone.types.time_series_entity_type.serialize_json(
                input_["entity_type"]
            ),
            safe="",
        ),
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.post_time_series_data_points_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_post_time_series_data_points(
