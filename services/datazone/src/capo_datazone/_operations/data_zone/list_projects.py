...
def handle_response(
    ...
    out: capo_datazone.types.list_projects_output.ListProjectsOutput = (
        capo_datazone.types.list_projects_output.deserialize_json(
...
def build_request(
    ...
    if "user_identifier" in input_:
        params.append(("userIdentifier", input_["user_identifier"]))
    if "group_identifier" in input_:
        params.append(("groupIdentifier", input_["group_identifier"]))
    if "name" in input_:
        params.append(("name", input_["name"]))
    if "project_category" in input_:
        params.append(("projectCategory", input_["project_category"]))
...
def list_projects(
    ...
    capo_datazone.types.list_projects_output.ListProjectsOutput, zapros.Response
]:
