...
def build_request(
    ...
    if "environment_id" in input_:
        params.append(("environmentId", input_["environment_id"]))
    if "subscription_target_id" in input_:
        params.append(("subscriptionTargetId", input_["subscription_target_id"]))
    ...
    if "subscription_id" in input_:
        params.append(("subscriptionId", input_["subscription_id"]))
