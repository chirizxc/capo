"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteListing``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_listing_output.DeleteListingOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_listing(
    ...
    capo_datazone.types.delete_listing_output.DeleteListingOutput, zapros.Response
]:
...
async def async_delete_listing(
