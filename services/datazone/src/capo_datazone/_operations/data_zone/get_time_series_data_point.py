...
def handle_response(
    ...
    out: capo_datazone.types.get_time_series_data_point_output.GetTimeSeriesDataPointOutput = capo_datazone.types.get_time_series_data_point_output.deserialize_json(
