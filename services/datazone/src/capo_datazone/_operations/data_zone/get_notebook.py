"""Generated from Smithy shape ``com.amazonaws.datazone#GetNotebook``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_notebook_output.GetNotebookOutput = (
        capo_datazone.types.get_notebook_output.deserialize_json(
...
def get_notebook(
    ...
    input_: capo_datazone.types.get_notebook_input.GetNotebookInput,
) -> tuple[capo_datazone.types.get_notebook_output.GetNotebookOutput, zapros.Response]:
