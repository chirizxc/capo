...
import capo_datazone.types.environment_blueprint_configurations
...
def handle_response(
    ...
    out: capo_datazone.types.list_environment_blueprint_configurations_output.ListEnvironmentBlueprintConfigurationsOutput = capo_datazone.types.list_environment_blueprint_configurations_output.deserialize_json(
