...
def handle_response(
    ...
    out: capo_datazone.types.create_data_product_output.CreateDataProductOutput = (
        capo_datazone.types.create_data_product_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_data_product_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
