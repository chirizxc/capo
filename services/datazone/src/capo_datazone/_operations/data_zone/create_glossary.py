...
def handle_response(
    ...
    out: capo_datazone.types.create_glossary_output.CreateGlossaryOutput = (
        capo_datazone.types.create_glossary_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_glossary_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_glossary(
    ...
    capo_datazone.types.create_glossary_output.CreateGlossaryOutput, zapros.Response
]:
