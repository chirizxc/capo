...
def handle_response(
    ...
    out: capo_datazone.types.delete_connection_output.DeleteConnectionOutput = (
        capo_datazone.types.delete_connection_output.deserialize_json(
...
def delete_connection(
    ...
    capo_datazone.types.delete_connection_output.DeleteConnectionOutput, zapros.Response
]:
