...
def handle_response(
    ...
    out: capo_datazone.types.create_environment_profile_output.CreateEnvironmentProfileOutput = capo_datazone.types.create_environment_profile_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_environment_profile_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
