"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteGlossary``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_glossary_output.DeleteGlossaryOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_glossary(
    ...
    capo_datazone.types.delete_glossary_output.DeleteGlossaryOutput, zapros.Response
]:
...
async def async_delete_glossary(
