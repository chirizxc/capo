...
def handle_response(
    ...
    out: capo_datazone.types.update_subscription_grant_status_output.UpdateSubscriptionGrantStatusOutput = capo_datazone.types.update_subscription_grant_status_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_subscription_grant_status_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
