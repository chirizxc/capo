...
def handle_response(
    ...
    out: capo_datazone.types.get_subscription_output.GetSubscriptionOutput = (
        capo_datazone.types.get_subscription_output.deserialize_json(
...
def get_subscription(
    ...
    capo_datazone.types.get_subscription_output.GetSubscriptionOutput, zapros.Response
]:
