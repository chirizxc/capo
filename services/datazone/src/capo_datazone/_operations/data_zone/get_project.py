"""Generated from Smithy shape ``com.amazonaws.datazone#GetProject``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_project_output.GetProjectOutput = (
        capo_datazone.types.get_project_output.deserialize_json(
...
def get_project(
    ...
    input_: capo_datazone.types.get_project_input.GetProjectInput,
) -> tuple[capo_datazone.types.get_project_output.GetProjectOutput, zapros.Response]:
