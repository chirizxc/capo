"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteAsset``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_asset_output.DeleteAssetOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_asset(
    ...
    input_: capo_datazone.types.delete_asset_input.DeleteAssetInput,
) -> tuple[capo_datazone.types.delete_asset_output.DeleteAssetOutput, zapros.Response]:
