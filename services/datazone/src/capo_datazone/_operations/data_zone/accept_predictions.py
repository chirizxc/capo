...
def handle_response(
    ...
    out: capo_datazone.types.accept_predictions_output.AcceptPredictionsOutput = (
        capo_datazone.types.accept_predictions_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.accept_predictions_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
