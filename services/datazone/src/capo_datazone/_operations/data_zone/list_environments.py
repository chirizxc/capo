...
def handle_response(
    ...
    out: capo_datazone.types.list_environments_output.ListEnvironmentsOutput = (
        capo_datazone.types.list_environments_output.deserialize_json(
...
def build_request(
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_datazone.types.environment_status.serialize_json(input_["status"]),
            )
        )
    if "aws_account_region" in input_:
        params.append(("awsAccountRegion", input_["aws_account_region"]))
    if "project_identifier" in input_:
        params.append(("projectIdentifier", input_["project_identifier"]))
    if "environment_profile_identifier" in input_:
        params.append(
            ("environmentProfileIdentifier", input_["environment_profile_identifier"])
        )
    ...
    if "provider" in input_:
        params.append(("provider", input_["provider"]))
    if "name" in input_:
...
def list_environments(
    ...
    capo_datazone.types.list_environments_output.ListEnvironmentsOutput, zapros.Response
]:
