...
import capo_datazone.types.data_source_run_summaries
...
def handle_response(
    ...
    out: capo_datazone.types.list_data_source_runs_output.ListDataSourceRunsOutput = (
        capo_datazone.types.list_data_source_runs_output.deserialize_json(
