"""Generated from Smithy shape ``com.amazonaws.datazone#GetJobRun``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_job_run_output.GetJobRunOutput = (
        capo_datazone.types.get_job_run_output.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/v2/domains/{domainIdentifier}/jobRuns/{identifier}"
    )
...
def get_job_run(
    ...
    input_: capo_datazone.types.get_job_run_input.GetJobRunInput,
) -> tuple[capo_datazone.types.get_job_run_output.GetJobRunOutput, zapros.Response]:
