"""Generated from Smithy shape ``com.amazonaws.datazone#GetGlossary``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_glossary_output.GetGlossaryOutput = (
        capo_datazone.types.get_glossary_output.deserialize_json(
...
def get_glossary(
    ...
    input_: capo_datazone.types.get_glossary_input.GetGlossaryInput,
) -> tuple[capo_datazone.types.get_glossary_output.GetGlossaryOutput, zapros.Response]:
