"""Generated from Smithy shape ``com.amazonaws.datazone#GetNotebookExport``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_notebook_export_output.GetNotebookExportOutput = (
        capo_datazone.types.get_notebook_export_output.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/")
        + "/v2/domains/{domainIdentifier}/notebook-exports/{identifier}"
    )
...
async def async_get_notebook_export(
