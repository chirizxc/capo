...
def handle_response(
    ...
    out: capo_datazone.types.list_time_series_data_points_output.ListTimeSeriesDataPointsOutput = capo_datazone.types.list_time_series_data_points_output.deserialize_json(
...
def build_request(
    ...
    if "form_name" in input_:
        params.append(("formName", input_["form_name"]))
    if "started_at" in input_:
        params.append(
            (
                "startedAt",
                capo_datazone._protocol.serialize.fmt_date_time(input_["started_at"]),
            )
        )
    if "ended_at" in input_:
        params.append(
            (
                "endedAt",
                capo_datazone._protocol.serialize.fmt_date_time(input_["ended_at"]),
            )
        )
