"""Generated from Smithy shape ``com.amazonaws.datazone#AssociateEnvironmentRole``."""
...
def handle_response(
    ...
    out: capo_datazone.types.associate_environment_role_output.AssociateEnvironmentRoleOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        "{environmentRoleArn}", quote(input_["environment_role_arn"], safe="")
    )
