...
def handle_response(
    ...
    out: capo_datazone.types.create_asset_revision_output.CreateAssetRevisionOutput = (
        capo_datazone.types.create_asset_revision_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_asset_revision_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
