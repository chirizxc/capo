"""Generated from Smithy shape ``com.amazonaws.datazone#GetRule``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_rule_output.GetRuleOutput = (
        capo_datazone.types.get_rule_output.deserialize_json(
...
def get_rule(
    options: OperationOptions, input_: capo_datazone.types.get_rule_input.GetRuleInput
) -> tuple[capo_datazone.types.get_rule_output.GetRuleOutput, zapros.Response]:
