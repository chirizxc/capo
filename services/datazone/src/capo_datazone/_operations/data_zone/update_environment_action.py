...
def handle_response(
    ...
    out: capo_datazone.types.update_environment_action_output.UpdateEnvironmentActionOutput = capo_datazone.types.update_environment_action_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_environment_action_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
