...
def handle_response(
    ...
    out: capo_datazone.types.stop_notebook_run_output.StopNotebookRunOutput = (
        capo_datazone.types.stop_notebook_run_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.stop_notebook_run_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def stop_notebook_run(
    ...
    capo_datazone.types.stop_notebook_run_output.StopNotebookRunOutput, zapros.Response
]:
