"""Generated from Smithy shape ``com.amazonaws.datazone#CreateDataProductRevision``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_data_product_revision_output.CreateDataProductRevisionOutput = capo_datazone.types.create_data_product_revision_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_data_product_revision_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_data_product_revision(
