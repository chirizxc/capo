"""Generated from Smithy shape ``com.amazonaws.datazone#ListSubscriptionTargets``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_subscription_targets_output.ListSubscriptionTargetsOutput = capo_datazone.types.list_subscription_targets_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{environmentIdentifier}", quote(input_["environment_identifier"], safe="")
    )
...
async def async_list_subscription_targets(
