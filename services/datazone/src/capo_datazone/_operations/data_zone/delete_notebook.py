"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteNotebook``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_notebook_output.DeleteNotebookOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_notebook(
    ...
    capo_datazone.types.delete_notebook_output.DeleteNotebookOutput, zapros.Response
]:
