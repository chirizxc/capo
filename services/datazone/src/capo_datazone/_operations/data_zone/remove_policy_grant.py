...
def handle_response(
    ...
    out: capo_datazone.types.remove_policy_grant_output.RemovePolicyGrantOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.remove_policy_grant_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
