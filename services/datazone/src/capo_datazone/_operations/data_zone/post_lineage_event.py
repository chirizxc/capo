"""Generated from Smithy shape ``com.amazonaws.datazone#PostLineageEvent``."""
...
def handle_response(
    ...
    out: capo_datazone.types.post_lineage_event_output.PostLineageEventOutput = (
        capo_datazone.types.post_lineage_event_output.deserialize_json(
...
def build_request(
    ...
    if "client_token" in input_:
        headers["Client-Token"] = input_["client_token"]
    body: bytes | None = input_["event"]
...
async def async_post_lineage_event(
