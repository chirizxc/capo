"""Generated from Smithy shape ``com.amazonaws.datazone#StartMetadataGenerationRun``."""
...
def handle_response(
    ...
    out: capo_datazone.types.start_metadata_generation_run_output.StartMetadataGenerationRunOutput = capo_datazone.types.start_metadata_generation_run_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.start_metadata_generation_run_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_metadata_generation_run(
