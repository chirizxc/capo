"""Generated from Smithy shape ``com.amazonaws.datazone#ListAssetRevisions``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_asset_revisions_output.ListAssetRevisionsOutput = (
        capo_datazone.types.list_asset_revisions_output.deserialize_json(
...
async def async_list_asset_revisions(
