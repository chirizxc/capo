"""Generated from Smithy shape ``com.amazonaws.datazone#BatchGetAttributesMetadata``."""
...
def handle_response(
    ...
    out: capo_datazone.types.batch_get_attributes_metadata_output.BatchGetAttributesMetadataOutput = capo_datazone.types.batch_get_attributes_metadata_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{entityType}",
        quote(
            capo_datazone.types.attribute_entity_type.serialize_json(
                input_["entity_type"]
            ),
            safe="",
        ),
    )
    url = url.replace("{entityIdentifier}", quote(input_["entity_identifier"], safe=""))
    params: list[tuple[str, str]] = []
    if "entity_revision" in input_:
        params.append(("entityRevision", input_["entity_revision"]))
    for item in input_["attribute_identifiers"]:
        params.append(("attributeIdentifier", item))
...
async def async_batch_get_attributes_metadata(
