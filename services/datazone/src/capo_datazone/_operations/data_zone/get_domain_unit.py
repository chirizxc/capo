...
def handle_response(
    ...
    out: capo_datazone.types.get_domain_unit_output.GetDomainUnitOutput = (
        capo_datazone.types.get_domain_unit_output.deserialize_json(
...
def get_domain_unit(
    ...
    capo_datazone.types.get_domain_unit_output.GetDomainUnitOutput, zapros.Response
]:
