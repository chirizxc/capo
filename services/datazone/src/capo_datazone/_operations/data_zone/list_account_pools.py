"""Generated from Smithy shape ``com.amazonaws.datazone#ListAccountPools``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_account_pools_output.ListAccountPoolsOutput = (
        capo_datazone.types.list_account_pools_output.deserialize_json(
...
def build_request(
    ...
    if "sort_by" in input_:
        params.append(
            (
                "sortBy",
                capo_datazone.types.sort_field_account_pool.serialize_json(
                    input_["sort_by"]
                ),
            )
        )
...
async def async_list_account_pools(
