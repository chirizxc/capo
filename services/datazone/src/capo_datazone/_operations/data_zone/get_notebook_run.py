...
def handle_response(
    ...
    out: capo_datazone.types.get_notebook_run_output.GetNotebookRunOutput = (
        capo_datazone.types.get_notebook_run_output.deserialize_json(
...
def get_notebook_run(
    ...
    capo_datazone.types.get_notebook_run_output.GetNotebookRunOutput, zapros.Response
]:
