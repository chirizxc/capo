...
def handle_response(
    ...
    out: capo_datazone.types.get_environment_output.GetEnvironmentOutput = (
        capo_datazone.types.get_environment_output.deserialize_json(
...
def get_environment(
    ...
    capo_datazone.types.get_environment_output.GetEnvironmentOutput, zapros.Response
]:
