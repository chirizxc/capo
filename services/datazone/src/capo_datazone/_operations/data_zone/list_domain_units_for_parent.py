"""Generated from Smithy shape ``com.amazonaws.datazone#ListDomainUnitsForParent``."""
...
import capo_datazone.types.domain_unit_summaries
...
def handle_response(
    ...
    out: capo_datazone.types.list_domain_units_for_parent_output.ListDomainUnitsForParentOutput = capo_datazone.types.list_domain_units_for_parent_output.deserialize_json(
...
def build_request(
    ...
    if "parent_domain_unit_identifier" in input_:
        params.append(
            ("parentDomainUnitIdentifier", input_["parent_domain_unit_identifier"])
        )
...
async def async_list_domain_units_for_parent(
