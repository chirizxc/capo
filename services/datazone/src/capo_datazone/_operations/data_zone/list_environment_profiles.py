"""Generated from Smithy shape ``com.amazonaws.datazone#ListEnvironmentProfiles``."""
...
import capo_datazone.types.environment_profile_summaries
...
def handle_response(
    ...
    out: capo_datazone.types.list_environment_profiles_output.ListEnvironmentProfilesOutput = capo_datazone.types.list_environment_profiles_output.deserialize_json(
