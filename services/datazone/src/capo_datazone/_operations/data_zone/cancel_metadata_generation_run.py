"""Generated from Smithy shape ``com.amazonaws.datazone#CancelMetadataGenerationRun``."""
...
def handle_response(
    ...
    out: capo_datazone.types.cancel_metadata_generation_run_output.CancelMetadataGenerationRunOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_cancel_metadata_generation_run(
