"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateDomain``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_domain_output.UpdateDomainOutput = (
        capo_datazone.types.update_domain_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_domain_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_domain(
    ...
    capo_datazone.types.update_domain_output.UpdateDomainOutput, zapros.Response
]:
