"""Generated from Smithy shape ``com.amazonaws.datazone#ListEnvironmentActions``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_environment_actions_output.ListEnvironmentActionsOutput = capo_datazone.types.list_environment_actions_output.deserialize_json(
...
async def async_list_environment_actions(
