...
def handle_response(
    ...
    out: capo_datazone.types.start_notebook_export_output.StartNotebookExportOutput = (
        capo_datazone.types.start_notebook_export_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.start_notebook_export_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
