...
def handle_response(
    ...
    out: capo_datazone.types.create_project_profile_output.CreateProjectProfileOutput = capo_datazone.types.create_project_profile_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_project_profile_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
