"""Generated from Smithy shape ``com.amazonaws.datazone#ListDomains``."""
...
def handle_response(
    ...
    out: capo_datazone.types.list_domains_output.ListDomainsOutput = (
        capo_datazone.types.list_domains_output.deserialize_json(
...
def build_request(
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_datazone.types.domain_status.serialize_json(input_["status"]),
            )
        )
...
def list_domains(
    ...
    input_: capo_datazone.types.list_domains_input.ListDomainsInput,
) -> tuple[capo_datazone.types.list_domains_output.ListDomainsOutput, zapros.Response]:
