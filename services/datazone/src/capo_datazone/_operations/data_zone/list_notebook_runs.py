...
def handle_response(
    ...
    out: capo_datazone.types.list_notebook_runs_output.ListNotebookRunsOutput = (
        capo_datazone.types.list_notebook_runs_output.deserialize_json(
...
def build_request(
    ...
    if "owning_project_identifier" in input_:
        params.append(("owningProjectIdentifier", input_["owning_project_identifier"]))
    if "notebook_identifier" in input_:
        params.append(("notebookIdentifier", input_["notebook_identifier"]))
    if "status" in input_:
        params.append(
            (
                "status",
                capo_datazone.types.notebook_run_status.serialize_json(
                    input_["status"]
                ),
            )
        )
    if "schedule_identifier" in input_:
        params.append(("scheduleIdentifier", input_["schedule_identifier"]))
