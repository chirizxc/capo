"""Generated from Smithy shape ``com.amazonaws.datazone#DeleteProjectProfile``."""
...
def handle_response(
    ...
    out: capo_datazone.types.delete_project_profile_output.DeleteProjectProfileOutput = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_project_profile(
