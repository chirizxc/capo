...
def handle_response(
    ...
    out: capo_datazone.types.update_glossary_term_output.UpdateGlossaryTermOutput = (
        capo_datazone.types.update_glossary_term_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_glossary_term_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
