"""Generated from Smithy shape ``com.amazonaws.datazone#GetEnvironmentBlueprint``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_environment_blueprint_output.GetEnvironmentBlueprintOutput = capo_datazone.types.get_environment_blueprint_output.deserialize_json(
...
async def async_get_environment_blueprint(
