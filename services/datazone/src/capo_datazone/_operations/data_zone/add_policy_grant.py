"""Generated from Smithy shape ``com.amazonaws.datazone#AddPolicyGrant``."""
...
def handle_response(
    ...
    out: capo_datazone.types.add_policy_grant_output.AddPolicyGrantOutput = (
        capo_datazone.types.add_policy_grant_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{entityType}",
        quote(
            capo_datazone.types.target_entity_type.serialize_json(
                input_["entity_type"]
            ),
            safe="",
        ),
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.add_policy_grant_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def add_policy_grant(
    ...
    capo_datazone.types.add_policy_grant_output.AddPolicyGrantOutput, zapros.Response
]:
...
async def async_add_policy_grant(
