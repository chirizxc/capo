"""Generated from Smithy shape ``com.amazonaws.datazone#CreateProject``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_project_output.CreateProjectOutput = (
        capo_datazone.types.create_project_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_project_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_project(
    ...
    capo_datazone.types.create_project_output.CreateProjectOutput, zapros.Response
]:
