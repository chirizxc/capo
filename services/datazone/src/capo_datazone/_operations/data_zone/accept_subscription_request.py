...
def handle_response(
    ...
    out: capo_datazone.types.accept_subscription_request_output.AcceptSubscriptionRequestOutput = capo_datazone.types.accept_subscription_request_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.accept_subscription_request_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
