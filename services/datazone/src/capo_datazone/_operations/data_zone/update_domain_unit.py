...
def handle_response(
    ...
    out: capo_datazone.types.update_domain_unit_output.UpdateDomainUnitOutput = (
        capo_datazone.types.update_domain_unit_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_domain_unit_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
