"""Generated from Smithy shape ``com.amazonaws.datazone#GetLineageNode``."""
...
def handle_response(
    ...
    out: capo_datazone.types.get_lineage_node_output.GetLineageNodeOutput = (
        capo_datazone.types.get_lineage_node_output.deserialize_json(
...
def build_request(
    ...
    if "event_timestamp" in input_:
        params.append(
            (
                "timestamp",
                capo_datazone._protocol.serialize.fmt_date_time(
                    input_["event_timestamp"]
                ),
            )
        )
...
def get_lineage_node(
    ...
    capo_datazone.types.get_lineage_node_output.GetLineageNodeOutput, zapros.Response
]:
...
async def async_get_lineage_node(
