"""Generated from Smithy shape ``com.amazonaws.datazone#CreateSubscriptionRequest``."""
...
def handle_response(
    ...
    out: capo_datazone.types.create_subscription_request_output.CreateSubscriptionRequestOutput = capo_datazone.types.create_subscription_request_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.create_subscription_request_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_subscription_request(
