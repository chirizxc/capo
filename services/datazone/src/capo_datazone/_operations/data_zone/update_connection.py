"""Generated from Smithy shape ``com.amazonaws.datazone#UpdateConnection``."""
...
def handle_response(
    ...
    out: capo_datazone.types.update_connection_output.UpdateConnectionOutput = (
        capo_datazone.types.update_connection_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_datazone.types.update_connection_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_connection(
    ...
    capo_datazone.types.update_connection_output.UpdateConnectionOutput, zapros.Response
]:
