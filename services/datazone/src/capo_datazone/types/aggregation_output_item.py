...
if TYPE_CHECKING:
    import capo_datazone.types.aggregation_attribute_display_value
    import capo_datazone.types.aggregation_attribute_value


class AggregationOutputItem(TypedDict, closed=True):
    value: NotRequired[
        "capo_datazone.types.aggregation_attribute_value.AggregationAttributeValue"
    ]
    ...
    display_value: NotRequired[
        "capo_datazone.types.aggregation_attribute_display_value.AggregationAttributeDisplayValue"
    ]
