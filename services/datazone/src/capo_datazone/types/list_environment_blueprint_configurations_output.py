...
class ListEnvironmentBlueprintConfigurationsOutput(TypedDict, closed=True):
    items: NotRequired[
        "capo_datazone.types.environment_blueprint_configurations.EnvironmentBlueprintConfigurations"
    ]
...
def serialize_json(value: ListEnvironmentBlueprintConfigurationsOutput) -> dict:
    ...
    if "items" in value:
        ...
        out["items"] = (
            capo_datazone.types.environment_blueprint_configurations.serialize_json(
                value["items"]
            )
        )
...
def deserialize_json(data: dict) -> ListEnvironmentBlueprintConfigurationsOutput:
    ...
    if data.get("items") is not None:
        ...
        out["items"] = (
            capo_datazone.types.environment_blueprint_configurations.deserialize_json(
                data["items"]
            )
        )
