...
def deserialize_json(data: dict) -> DataSourceRunActivity:
    ...
    if data.get("dataAssetId") is not None:
        out["data_asset_id"] = data["dataAssetId"]
    if data.get("technicalDescription") is not None:
