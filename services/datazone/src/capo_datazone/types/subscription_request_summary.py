...
class SubscriptionRequestSummary(TypedDict, closed=True):
    ...
    metadata_forms_summary: NotRequired[
        "capo_datazone.types.metadata_forms_summary.MetadataFormsSummary"
    ]
...
def serialize_json(value: SubscriptionRequestSummary) -> dict:
    ...
    if "metadata_forms_summary" in value:
        ...
        out["metadataFormsSummary"] = (
            capo_datazone.types.metadata_forms_summary.serialize_json(
...
def deserialize_json(data: dict) -> SubscriptionRequestSummary:
    ...
    if data.get("metadataFormsSummary") is not None:
        ...
        out["metadata_forms_summary"] = (
            capo_datazone.types.metadata_forms_summary.deserialize_json(
