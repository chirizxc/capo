...
if TYPE_CHECKING:
    ...
    import capo_application_signals.types.calendar_interval_duration
...
class CalendarInterval(TypedDict, closed=True):
    ...
    duration: "capo_application_signals.types.calendar_interval_duration.CalendarIntervalDuration"
