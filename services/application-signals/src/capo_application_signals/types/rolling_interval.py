...
if TYPE_CHECKING:
    ...
    import capo_application_signals.types.rolling_interval_duration
...
class RollingInterval(TypedDict, closed=True):
    ...
    duration: "capo_application_signals.types.rolling_interval_duration.RollingIntervalDuration"
