"""Generated from Smithy shape ``com.amazonaws.applicationsignals#DeleteServiceLevelObjective``."""
...
def handle_response(
    ...
    out: capo_application_signals.types.delete_service_level_objective_output.DeleteServiceLevelObjectiveOutput = {}  # type: ignore[typeddict-item]
    return out
