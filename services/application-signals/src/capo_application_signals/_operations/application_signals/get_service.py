...
def handle_response(
    ...
    out: capo_application_signals.types.get_service_output.GetServiceOutput = (
        capo_application_signals.types.get_service_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_signals.types.get_service_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_service(
    ...
    capo_application_signals.types.get_service_output.GetServiceOutput, zapros.Response
]:
