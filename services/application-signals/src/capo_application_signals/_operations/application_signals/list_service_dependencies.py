"""Generated from Smithy shape ``com.amazonaws.applicationsignals#ListServiceDependencies``."""
...
import capo_application_signals.types.service_dependencies
...
def handle_response(
    ...
    out: capo_application_signals.types.list_service_dependencies_output.ListServiceDependenciesOutput = capo_application_signals.types.list_service_dependencies_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/service-dependencies"
    ...
    body: bytes | None = json.dumps(
        capo_application_signals.types.list_service_dependencies_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_service_dependencies(
