"""Generated from Smithy shape ``com.amazonaws.applicationsignals#ListGroupingAttributeDefinitions``."""
...
def handle_response(
    ...
    out: capo_application_signals.types.list_grouping_attribute_definitions_output.ListGroupingAttributeDefinitionsOutput = capo_application_signals.types.list_grouping_attribute_definitions_output.deserialize_json(
