...
def handle_response(
    ...
    out: capo_application_signals.types.list_service_dependents_output.ListServiceDependentsOutput = capo_application_signals.types.list_service_dependents_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_signals.types.list_service_dependents_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
