...
def handle_response(
    ...
    out: capo_application_signals.types.update_service_level_objective_output.UpdateServiceLevelObjectiveOutput = capo_application_signals.types.update_service_level_objective_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_application_signals.types.update_service_level_objective_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
