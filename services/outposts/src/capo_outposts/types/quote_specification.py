...
class QuoteSpecification(TypedDict, closed=True):
    quote_specification_type: NotRequired[
        "capo_outposts.types.quote_specification_type.QuoteSpecificationType"
    ]
    ...
    existing_rack_specification_details: NotRequired[
        "capo_outposts.types.rack_specification_details.RackSpecificationDetails"
    ]
    ...
    server_specification_details: NotRequired[
        "capo_outposts.types.server_specification_details.ServerSpecificationDetails"
    ]
...
def serialize_json(value: QuoteSpecification) -> dict:
    ...
    if "quote_specification_type" in value:
        ...
        out["QuoteSpecificationType"] = (
            capo_outposts.types.quote_specification_type.serialize_json(
    ...
    if "existing_rack_specification_details" in value:
        ...
        out["ExistingRackSpecificationDetails"] = (
            capo_outposts.types.rack_specification_details.serialize_json(
    ...
    if "server_specification_details" in value:
        ...
        out["ServerSpecificationDetails"] = (
            capo_outposts.types.server_specification_details.serialize_json(
...
def deserialize_json(data: dict) -> QuoteSpecification:
    ...
    if data.get("QuoteSpecificationType") is not None:
        ...
        out["quote_specification_type"] = (
            capo_outposts.types.quote_specification_type.deserialize_json(
    ...
    if data.get("ExistingRackSpecificationDetails") is not None:
        ...
        out["existing_rack_specification_details"] = (
            capo_outposts.types.rack_specification_details.deserialize_json(
    ...
    if data.get("ServerSpecificationDetails") is not None:
        ...
        out["server_specification_details"] = (
            capo_outposts.types.server_specification_details.deserialize_json(
