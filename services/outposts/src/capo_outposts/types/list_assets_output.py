...
class ListAssetsOutput(TypedDict, closed=True):
    assets: NotRequired["capo_outposts.types.asset_list_definition.AssetListDefinition"]
...
def serialize_json(value: ListAssetsOutput) -> dict:
    ...
    if "assets" in value:
        ...
        out["Assets"] = capo_outposts.types.asset_list_definition.serialize_json(
            value["assets"]
        )
...
def deserialize_json(data: dict) -> ListAssetsOutput:
    ...
    if data.get("Assets") is not None:
        ...
        out["assets"] = capo_outposts.types.asset_list_definition.deserialize_json(
            data["Assets"]
        )
