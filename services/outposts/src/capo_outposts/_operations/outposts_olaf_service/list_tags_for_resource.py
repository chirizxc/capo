"""Generated from Smithy shape ``com.amazonaws.outposts#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_outposts.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_outposts.types.list_tags_for_resource_response.deserialize_json(
