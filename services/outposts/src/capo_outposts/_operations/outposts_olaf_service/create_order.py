...
def handle_response(
    ...
    out: capo_outposts.types.create_order_output.CreateOrderOutput = (
        capo_outposts.types.create_order_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_outposts.types.create_order_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_order(
    ...
    input_: capo_outposts.types.create_order_input.CreateOrderInput,
) -> tuple[capo_outposts.types.create_order_output.CreateOrderOutput, zapros.Response]:
