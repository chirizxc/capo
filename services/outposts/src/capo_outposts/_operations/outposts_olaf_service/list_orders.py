"""Generated from Smithy shape ``com.amazonaws.outposts#ListOrders``."""
...
def handle_response(
    ...
    out: capo_outposts.types.list_orders_output.ListOrdersOutput = (
        capo_outposts.types.list_orders_output.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/list-orders"
    params: list[tuple[str, str]] = []
    if "outpost_identifier_filter" in input_:
        params.append(("OutpostIdentifierFilter", input_["outpost_identifier_filter"]))
...
def list_orders(
    ...
    input_: capo_outposts.types.list_orders_input.ListOrdersInput,
) -> tuple[capo_outposts.types.list_orders_output.ListOrdersOutput, zapros.Response]:
