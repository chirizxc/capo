...
def handle_response(
    ...
    out: capo_outposts.types.start_outpost_decommission_output.StartOutpostDecommissionOutput = capo_outposts.types.start_outpost_decommission_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_outposts.types.start_outpost_decommission_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
