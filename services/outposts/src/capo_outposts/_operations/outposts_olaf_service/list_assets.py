...
import capo_outposts.types.asset_list_definition
...
def handle_response(
    ...
    out: capo_outposts.types.list_assets_output.ListAssetsOutput = (
        capo_outposts.types.list_assets_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{OutpostIdentifier}", quote(input_["outpost_identifier"], safe="")
    )
    params: list[tuple[str, str]] = []
    if "host_id_filter" in input_:
        for item in input_["host_id_filter"]:
            params.append(("HostIdFilter", item))
    ...
    if "status_filter" in input_:
        for item in input_["status_filter"]:
            params.append(
                ("StatusFilter", capo_outposts.types.asset_state.serialize_json(item))
            )
    if "asset_type_filter" in input_:
        for item in input_["asset_type_filter"]:
            params.append(
                ("AssetTypeFilter", capo_outposts.types.asset_type.serialize_json(item))
            )
...
def list_assets(
    ...
    input_: capo_outposts.types.list_assets_input.ListAssetsInput,
) -> tuple[capo_outposts.types.list_assets_output.ListAssetsOutput, zapros.Response]:
