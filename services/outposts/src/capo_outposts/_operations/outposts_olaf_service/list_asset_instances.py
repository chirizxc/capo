...
def handle_response(
    ...
    out: capo_outposts.types.list_asset_instances_output.ListAssetInstancesOutput = (
        capo_outposts.types.list_asset_instances_output.deserialize_json(
...
def build_request(
    ...
    if "asset_id_filter" in input_:
        for item in input_["asset_id_filter"]:
            params.append(("AssetIdFilter", item))
    if "instance_type_filter" in input_:
        for item in input_["instance_type_filter"]:
            params.append(("InstanceTypeFilter", item))
    if "account_id_filter" in input_:
        for item in input_["account_id_filter"]:
            params.append(("AccountIdFilter", item))
    if "aws_service_filter" in input_:
        for item in input_["aws_service_filter"]:
            params.append(
                (
                    "AwsServiceFilter",
                    capo_outposts.types.aws_service_name.serialize_json(item),
                )
            )
