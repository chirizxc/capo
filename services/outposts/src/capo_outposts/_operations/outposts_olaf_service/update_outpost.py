"""Generated from Smithy shape ``com.amazonaws.outposts#UpdateOutpost``."""
...
def handle_response(
    ...
    out: capo_outposts.types.update_outpost_output.UpdateOutpostOutput = (
        capo_outposts.types.update_outpost_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{OutpostId}", quote(input_["outpost_id"], safe=""))
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_outposts.types.update_outpost_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_outpost(
    ...
    capo_outposts.types.update_outpost_output.UpdateOutpostOutput, zapros.Response
]:
...
async def async_update_outpost(
