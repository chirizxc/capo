"""Generated from Smithy shape ``com.amazonaws.outposts#GetOutpost``."""
...
def handle_response(
    ...
    out: capo_outposts.types.get_outpost_output.GetOutpostOutput = (
        capo_outposts.types.get_outpost_output.deserialize_json(
...
def get_outpost(
    ...
    input_: capo_outposts.types.get_outpost_input.GetOutpostInput,
) -> tuple[capo_outposts.types.get_outpost_output.GetOutpostOutput, zapros.Response]:
