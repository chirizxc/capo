...
def handle_response(
    ...
    out: capo_outposts.types.get_order_output.GetOrderOutput = (
        capo_outposts.types.get_order_output.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{OrderId}", quote(input_["order_id"], safe=""))
...
def get_order(
    options: OperationOptions, input_: capo_outposts.types.get_order_input.GetOrderInput
) -> tuple[capo_outposts.types.get_order_output.GetOrderOutput, zapros.Response]:
