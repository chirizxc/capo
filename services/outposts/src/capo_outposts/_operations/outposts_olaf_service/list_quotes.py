...
def handle_response(
    ...
    out: capo_outposts.types.list_quotes_output.ListQuotesOutput = (
        capo_outposts.types.list_quotes_output.deserialize_json(
...
def list_quotes(
    ...
    input_: capo_outposts.types.list_quotes_input.ListQuotesInput,
) -> tuple[capo_outposts.types.list_quotes_output.ListQuotesOutput, zapros.Response]:
