...
def handle_response(
    ...
    out: capo_outposts.types.create_quote_output.CreateQuoteOutput = (
        capo_outposts.types.create_quote_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_outposts.types.create_quote_input.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_quote(
    ...
    input_: capo_outposts.types.create_quote_input.CreateQuoteInput,
) -> tuple[capo_outposts.types.create_quote_output.CreateQuoteOutput, zapros.Response]:
