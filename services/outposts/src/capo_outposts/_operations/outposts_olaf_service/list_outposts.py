...
def build_request(
    ...
    if "life_cycle_status_filter" in input_:
        for item in input_["life_cycle_status_filter"]:
            params.append(("LifeCycleStatusFilter", item))
    if "availability_zone_filter" in input_:
        for item in input_["availability_zone_filter"]:
            params.append(("AvailabilityZoneFilter", item))
    if "availability_zone_id_filter" in input_:
        for item in input_["availability_zone_id_filter"]:
            params.append(("AvailabilityZoneIdFilter", item))
