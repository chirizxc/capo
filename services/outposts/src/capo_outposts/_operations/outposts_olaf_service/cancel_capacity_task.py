"""Generated from Smithy shape ``com.amazonaws.outposts#CancelCapacityTask``."""
...
def handle_response(
    ...
    out: capo_outposts.types.cancel_capacity_task_output.CancelCapacityTaskOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{CapacityTaskId}", quote(input_["capacity_task_id"], safe=""))
    url = url.replace(
...
async def async_cancel_capacity_task(
