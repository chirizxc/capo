...
def handle_response(
    ...
    out: capo_outposts.types.get_outpost_supported_instance_types_output.GetOutpostSupportedInstanceTypesOutput = capo_outposts.types.get_outpost_supported_instance_types_output.deserialize_json(
...
def build_request(
    ...
    if "order_id" in input_:
        params.append(("OrderId", input_["order_id"]))
