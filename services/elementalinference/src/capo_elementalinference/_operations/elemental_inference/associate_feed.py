...
def handle_response(
    ...
    out: capo_elementalinference.types.associate_feed_response.AssociateFeedResponse = (
        capo_elementalinference.types.associate_feed_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elementalinference.types.associate_feed_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
