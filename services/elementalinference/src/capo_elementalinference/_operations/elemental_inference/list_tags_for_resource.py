...
def handle_response(
    ...
    out: capo_elementalinference.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_elementalinference.types.list_tags_for_resource_response.deserialize_json(
