"""Generated from Smithy shape ``com.amazonaws.elementalinference#GetDictionary``."""
...
def handle_response(
    ...
    out: capo_elementalinference.types.get_dictionary_response.GetDictionaryResponse = (
        capo_elementalinference.types.get_dictionary_response.deserialize_json(
