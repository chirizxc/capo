"""Generated from Smithy shape ``com.amazonaws.elementalinference#ListDictionaries``."""
...
def handle_response(
    ...
    out: capo_elementalinference.types.list_dictionaries_response.ListDictionariesResponse = capo_elementalinference.types.list_dictionaries_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/dictionaries"
...
async def async_list_dictionaries(
