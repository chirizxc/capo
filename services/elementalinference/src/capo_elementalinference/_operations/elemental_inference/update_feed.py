"""Generated from Smithy shape ``com.amazonaws.elementalinference#UpdateFeed``."""
...
def handle_response(
    ...
    out: capo_elementalinference.types.update_feed_response.UpdateFeedResponse = (
        capo_elementalinference.types.update_feed_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_elementalinference.types.update_feed_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
