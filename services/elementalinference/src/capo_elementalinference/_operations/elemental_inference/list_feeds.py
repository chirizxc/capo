"""Generated from Smithy shape ``com.amazonaws.elementalinference#ListFeeds``."""
...
def handle_response(
    ...
    out: capo_elementalinference.types.list_feeds_response.ListFeedsResponse = (
        capo_elementalinference.types.list_feeds_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/feeds"
...
def list_feeds(
    ...
    capo_elementalinference.types.list_feeds_response.ListFeedsResponse, zapros.Response
]:
