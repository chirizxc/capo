"""Generated from Smithy shape ``com.amazonaws.elementalinference#ConflictException``."""
...
class ConflictException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elementalinference#ConflictException``."""
