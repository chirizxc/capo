"""Generated from Smithy shape ``com.amazonaws.elementalinference#AccessDeniedException``."""
...
class AccessDeniedException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.elementalinference#AccessDeniedException``."""
