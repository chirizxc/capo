...
if TYPE_CHECKING:
    ...
    import capo_finspace_data.types.column_description
    import capo_finspace_data.types.column_name


class ColumnDefinition(TypedDict, closed=True):
    data_type: NotRequired["capo_finspace_data.types.column_data_type.ColumnDataType"]
    ...
    column_name: NotRequired["capo_finspace_data.types.column_name.ColumnName"]
    """<p>The name of a column.</p>"""
    column_description: NotRequired[
        "capo_finspace_data.types.column_description.ColumnDescription"
    ]
...
def serialize_json(value: ColumnDefinition) -> dict:
    ...
    if "data_type" in value:
        ...
        out["dataType"] = capo_finspace_data.types.column_data_type.serialize_json(
            value["data_type"]
        )
