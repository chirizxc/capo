...
if TYPE_CHECKING:
    import capo_finspace_data.types.access_key_id
    import capo_finspace_data.types.secret_access_key
    import capo_finspace_data.types.session_token
    import capo_finspace_data.types.timestamp_epoch


class AwsCredentials(TypedDict, closed=True):
    access_key_id: NotRequired["capo_finspace_data.types.access_key_id.AccessKeyId"]
    """<p> The unique identifier for the security credentials.</p>"""
    secret_access_key: NotRequired[
        "capo_finspace_data.types.secret_access_key.SecretAccessKey"
    ]
    """<p> The secret access key that can be used to sign requests.</p>"""
    session_token: NotRequired["capo_finspace_data.types.session_token.SessionToken"]
    """<p> The token that users must pass to use the credentials.</p>"""
    expiration: "capo_finspace_data.types.timestamp_epoch.TimestampEpoch"
