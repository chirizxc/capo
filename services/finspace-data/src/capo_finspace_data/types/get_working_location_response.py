...
if TYPE_CHECKING:
    import capo_finspace_data.types.string_value_length1to63
    import capo_finspace_data.types.string_value_length1to1024


class GetWorkingLocationResponse(TypedDict, closed=True):
    s3_uri: NotRequired[
        "capo_finspace_data.types.string_value_length1to1024.stringValueLength1to1024"
    ]
    ...
    s3_bucket: NotRequired[
        "capo_finspace_data.types.string_value_length1to63.stringValueLength1to63"
    ]
