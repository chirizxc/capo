...
def handle_response(
    ...
    out: capo_managedblockchain.types.create_accessor_output.CreateAccessorOutput = (
        capo_managedblockchain.types.create_accessor_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain.types.create_accessor_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
