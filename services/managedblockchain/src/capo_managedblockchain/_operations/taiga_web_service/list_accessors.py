"""Generated from Smithy shape ``com.amazonaws.managedblockchain#ListAccessors``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.list_accessors_output.ListAccessorsOutput = (
        capo_managedblockchain.types.list_accessors_output.deserialize_json(
...
async def async_list_accessors(
