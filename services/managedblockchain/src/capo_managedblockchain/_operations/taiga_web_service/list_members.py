...
def handle_response(
    ...
    out: capo_managedblockchain.types.list_members_output.ListMembersOutput = (
        capo_managedblockchain.types.list_members_output.deserialize_json(
...
def build_request(
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_managedblockchain.types.member_status.serialize_json(
                    input_["status"]
                ),
            )
        )
...
def list_members(
    ...
    capo_managedblockchain.types.list_members_output.ListMembersOutput, zapros.Response
]:
