"""Generated from Smithy shape ``com.amazonaws.managedblockchain#GetNetwork``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.get_network_output.GetNetworkOutput = (
        capo_managedblockchain.types.get_network_output.deserialize_json(
...
def get_network(
    ...
    capo_managedblockchain.types.get_network_output.GetNetworkOutput, zapros.Response
]:
