"""Generated from Smithy shape ``com.amazonaws.managedblockchain#CreateProposal``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.create_proposal_output.CreateProposalOutput = (
        capo_managedblockchain.types.create_proposal_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_managedblockchain.types.create_proposal_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
