"""Generated from Smithy shape ``com.amazonaws.managedblockchain#DeleteNode``."""
...
def handle_response(
    ...
    out: capo_managedblockchain.types.delete_node_output.DeleteNodeOutput = {}  # type: ignore[typeddict-item]
    return out
...
def delete_node(
    ...
    capo_managedblockchain.types.delete_node_output.DeleteNodeOutput, zapros.Response
]:
