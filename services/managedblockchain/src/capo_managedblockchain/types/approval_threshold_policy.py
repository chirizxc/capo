...
if TYPE_CHECKING:
    import capo_managedblockchain.types.proposal_duration_int
    import capo_managedblockchain.types.threshold_comparator
    import capo_managedblockchain.types.threshold_percentage_int


class ApprovalThresholdPolicy(TypedDict, closed=True):
    threshold_percentage: NotRequired[
        "capo_managedblockchain.types.threshold_percentage_int.ThresholdPercentageInt"
    ]
    ...
    proposal_duration_in_hours: NotRequired[
        "capo_managedblockchain.types.proposal_duration_int.ProposalDurationInt"
    ]
    ...
    threshold_comparator: NotRequired[
        "capo_managedblockchain.types.threshold_comparator.ThresholdComparator"
    ]
...
def serialize_json(value: ApprovalThresholdPolicy) -> dict:
    ...
    if "threshold_comparator" in value:
        ...
        out["ThresholdComparator"] = (
            capo_managedblockchain.types.threshold_comparator.serialize_json(
...
def deserialize_json(data: dict) -> ApprovalThresholdPolicy:
    ...
    if data.get("ThresholdComparator") is not None:
        ...
        out["threshold_comparator"] = (
            capo_managedblockchain.types.threshold_comparator.deserialize_json(
