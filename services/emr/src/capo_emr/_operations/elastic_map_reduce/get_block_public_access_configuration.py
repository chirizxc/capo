"""Generated from Smithy shape ``com.amazonaws.emr#GetBlockPublicAccessConfiguration``."""
...
def handle_response(
    ...
    out: capo_emr.types.get_block_public_access_configuration_output.GetBlockPublicAccessConfigurationOutput = capo_emr.types.get_block_public_access_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.get_block_public_access_configuration_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_get_block_public_access_configuration(
