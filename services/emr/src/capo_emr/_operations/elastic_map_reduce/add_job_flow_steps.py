"""Generated from Smithy shape ``com.amazonaws.emr#AddJobFlowSteps``."""
...
def handle_response(
    ...
    out: capo_emr.types.add_job_flow_steps_output.AddJobFlowStepsOutput = (
        capo_emr.types.add_job_flow_steps_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.add_job_flow_steps_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def add_job_flow_steps(
    ...
    capo_emr.types.add_job_flow_steps_output.AddJobFlowStepsOutput, zapros.Response
]:
...
async def async_add_job_flow_steps(
