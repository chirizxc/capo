...
def handle_response(
    ...
    out: capo_emr.types.list_studio_session_mappings_output.ListStudioSessionMappingsOutput = capo_emr.types.list_studio_session_mappings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.list_studio_session_mappings_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
