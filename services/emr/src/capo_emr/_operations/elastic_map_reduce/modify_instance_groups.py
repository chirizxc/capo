"""Generated from Smithy shape ``com.amazonaws.emr#ModifyInstanceGroups``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.modify_instance_groups_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_modify_instance_groups(
