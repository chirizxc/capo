"""Generated from Smithy shape ``com.amazonaws.emr#CreateSecurityConfiguration``."""
...
def handle_response(
    ...
    out: capo_emr.types.create_security_configuration_output.CreateSecurityConfigurationOutput = capo_emr.types.create_security_configuration_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.create_security_configuration_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
