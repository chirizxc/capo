"""Generated from Smithy shape ``com.amazonaws.emr#UpdateStudioSessionMapping``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.UpdateStudioSessionMapping"
    body: bytes | None = json.dumps(
        capo_emr.types.update_studio_session_mapping_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_studio_session_mapping(
