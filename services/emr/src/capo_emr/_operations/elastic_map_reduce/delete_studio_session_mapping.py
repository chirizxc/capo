"""Generated from Smithy shape ``com.amazonaws.emr#DeleteStudioSessionMapping``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "ElasticMapReduce.DeleteStudioSessionMapping"
    body: bytes | None = json.dumps(
        capo_emr.types.delete_studio_session_mapping_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_delete_studio_session_mapping(
