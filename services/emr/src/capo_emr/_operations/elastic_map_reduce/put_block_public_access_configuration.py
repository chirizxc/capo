...
def handle_response(
    ...
    out: capo_emr.types.put_block_public_access_configuration_output.PutBlockPublicAccessConfigurationOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.put_block_public_access_configuration_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
