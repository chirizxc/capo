"""Generated from Smithy shape ``com.amazonaws.emr#ListClusters``."""
...
def handle_response(
    ...
    out: capo_emr.types.list_clusters_output.ListClustersOutput = (
        capo_emr.types.list_clusters_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.list_clusters_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_clusters(
    ...
    input_: capo_emr.types.list_clusters_input.ListClustersInput,
) -> tuple[capo_emr.types.list_clusters_output.ListClustersOutput, zapros.Response]:
