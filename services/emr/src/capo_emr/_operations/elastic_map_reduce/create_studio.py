"""Generated from Smithy shape ``com.amazonaws.emr#CreateStudio``."""
...
def handle_response(
    ...
    out: capo_emr.types.create_studio_output.CreateStudioOutput = (
        capo_emr.types.create_studio_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.create_studio_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def create_studio(
    ...
    input_: capo_emr.types.create_studio_input.CreateStudioInput,
) -> tuple[capo_emr.types.create_studio_output.CreateStudioOutput, zapros.Response]:
