"""Generated from Smithy shape ``com.amazonaws.emr#PutAutoScalingPolicy``."""
...
def handle_response(
    ...
    out: capo_emr.types.put_auto_scaling_policy_output.PutAutoScalingPolicyOutput = (
        capo_emr.types.put_auto_scaling_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr.types.put_auto_scaling_policy_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_put_auto_scaling_policy(
