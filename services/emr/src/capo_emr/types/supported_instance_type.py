...
class SupportedInstanceType(TypedDict, closed=True):
    ...
    memory_gb: NotRequired["capo_emr.types.float.Float"]
    ...
    storage_gb: NotRequired["capo_emr.types.integer.Integer"]
