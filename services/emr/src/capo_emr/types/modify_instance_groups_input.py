...
class ModifyInstanceGroupsInput(TypedDict, closed=True):
...
def serialize_aws_json_1_1(value: ModifyInstanceGroupsInput) -> dict:
    ...
    if "instance_groups" in value:
        ...
        out["InstanceGroups"] = (
            capo_emr.types.instance_group_modify_config_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ModifyInstanceGroupsInput:
    ...
    if data.get("InstanceGroups") is not None:
        ...
        out["instance_groups"] = (
            capo_emr.types.instance_group_modify_config_list.deserialize_aws_json_1_1(
                data["InstanceGroups"]
            )
        )
    return out
