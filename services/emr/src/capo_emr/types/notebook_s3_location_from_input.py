"""Generated from Smithy shape ``com.amazonaws.emr#NotebookS3LocationFromInput``."""
...
class NotebookS3LocationFromInput(TypedDict, closed=True):
...
# --- awsJson1_1 ser/de ---
def serialize_aws_json_1_1(value: NotebookS3LocationFromInput) -> dict:
    out: dict = {}
    if "bucket" in value:
...
def deserialize_aws_json_1_1(data: dict) -> NotebookS3LocationFromInput:
    out: NotebookS3LocationFromInput = {}  # type: ignore[typeddict-item]
