...
class GetBlockPublicAccessConfigurationOutput(TypedDict, closed=True):
    ...
    block_public_access_configuration_metadata: NotRequired[
        "capo_emr.types.block_public_access_configuration_metadata.BlockPublicAccessConfigurationMetadata"
    ]
...
def serialize_aws_json_1_1(value: GetBlockPublicAccessConfigurationOutput) -> dict:
    ...
    if "block_public_access_configuration_metadata" in value:
        ...
        out["BlockPublicAccessConfigurationMetadata"] = (
            capo_emr.types.block_public_access_configuration_metadata.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> GetBlockPublicAccessConfigurationOutput:
    ...
    if data.get("BlockPublicAccessConfigurationMetadata") is not None:
        ...
        out["block_public_access_configuration_metadata"] = (
            capo_emr.types.block_public_access_configuration_metadata.deserialize_aws_json_1_1(
