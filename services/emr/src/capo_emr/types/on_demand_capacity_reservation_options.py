...
class OnDemandCapacityReservationOptions(TypedDict, closed=True):
    usage_strategy: NotRequired[
        "capo_emr.types.on_demand_capacity_reservation_usage_strategy.OnDemandCapacityReservationUsageStrategy"
    ]
    ...
    capacity_reservation_preference: NotRequired[
        "capo_emr.types.on_demand_capacity_reservation_preference.OnDemandCapacityReservationPreference"
    ]
...
def serialize_aws_json_1_1(value: OnDemandCapacityReservationOptions) -> dict:
    ...
    if "usage_strategy" in value:
        ...
        out["UsageStrategy"] = (
            capo_emr.types.on_demand_capacity_reservation_usage_strategy.serialize_aws_json_1_1(
    ...
    if "capacity_reservation_preference" in value:
        ...
        out["CapacityReservationPreference"] = (
            capo_emr.types.on_demand_capacity_reservation_preference.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OnDemandCapacityReservationOptions:
    ...
    if data.get("UsageStrategy") is not None:
        ...
        out["usage_strategy"] = (
            capo_emr.types.on_demand_capacity_reservation_usage_strategy.deserialize_aws_json_1_1(
                data["UsageStrategy"]
            )
        )
    if data.get("CapacityReservationPreference") is not None:
        ...
        out["capacity_reservation_preference"] = (
            capo_emr.types.on_demand_capacity_reservation_preference.deserialize_aws_json_1_1(
