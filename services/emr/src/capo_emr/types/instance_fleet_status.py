...
if TYPE_CHECKING:
    import capo_emr.types.instance_fleet_state
    import capo_emr.types.instance_fleet_state_change_reason
    import capo_emr.types.instance_fleet_timeline


class InstanceFleetStatus(TypedDict, closed=True):
    state: NotRequired["capo_emr.types.instance_fleet_state.InstanceFleetState"]
    ...
    state_change_reason: NotRequired[
        "capo_emr.types.instance_fleet_state_change_reason.InstanceFleetStateChangeReason"
    ]
    """<p>Provides status change reason details for the instance fleet.</p>"""
    timeline: NotRequired[
        "capo_emr.types.instance_fleet_timeline.InstanceFleetTimeline"
    ]
...
def serialize_aws_json_1_1(value: InstanceFleetStatus) -> dict:
    ...
    if "state" in value:
        ...
        out["State"] = capo_emr.types.instance_fleet_state.serialize_aws_json_1_1(
            value["state"]
        )
    if "state_change_reason" in value:
        ...
        out["StateChangeReason"] = (
            capo_emr.types.instance_fleet_state_change_reason.serialize_aws_json_1_1(
    ...
    if "timeline" in value:
        ...
        out["Timeline"] = capo_emr.types.instance_fleet_timeline.serialize_aws_json_1_1(
            value["timeline"]
        )
    return out
...
def deserialize_aws_json_1_1(data: dict) -> InstanceFleetStatus:
    ...
    if data.get("State") is not None:
        ...
        out["state"] = capo_emr.types.instance_fleet_state.deserialize_aws_json_1_1(
            data["State"]
        )
    if data.get("StateChangeReason") is not None:
        ...
        out["state_change_reason"] = (
            capo_emr.types.instance_fleet_state_change_reason.deserialize_aws_json_1_1(
    ...
    if data.get("Timeline") is not None:
        ...
        out["timeline"] = (
            capo_emr.types.instance_fleet_timeline.deserialize_aws_json_1_1(
                data["Timeline"]
            )
        )
    return out
