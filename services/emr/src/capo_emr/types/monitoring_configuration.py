...
if TYPE_CHECKING:
    import capo_emr.types.cloud_watch_log_configuration
    import capo_emr.types.s3_logging_configuration


class MonitoringConfiguration(TypedDict, closed=True):
    cloud_watch_log_configuration: NotRequired[
        "capo_emr.types.cloud_watch_log_configuration.CloudWatchLogConfiguration"
    ]
    ...
    s3_logging_configuration: NotRequired[
        "capo_emr.types.s3_logging_configuration.S3LoggingConfiguration"
    ]
...
def serialize_aws_json_1_1(value: MonitoringConfiguration) -> dict:
    ...
    if "cloud_watch_log_configuration" in value:
        ...
        out["CloudWatchLogConfiguration"] = (
            capo_emr.types.cloud_watch_log_configuration.serialize_aws_json_1_1(
    ...
    if "s3_logging_configuration" in value:
        ...
        out["S3LoggingConfiguration"] = (
            capo_emr.types.s3_logging_configuration.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> MonitoringConfiguration:
    ...
    if data.get("CloudWatchLogConfiguration") is not None:
        import capo_emr.types.cloud_watch_log_configuration

        out["cloud_watch_log_configuration"] = (
            capo_emr.types.cloud_watch_log_configuration.deserialize_aws_json_1_1(
    ...
    if data.get("S3LoggingConfiguration") is not None:
        ...
        out["s3_logging_configuration"] = (
            capo_emr.types.s3_logging_configuration.deserialize_aws_json_1_1(
