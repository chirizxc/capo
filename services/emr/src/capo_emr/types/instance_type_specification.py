...
class InstanceTypeSpecification(TypedDict, closed=True):
    ...
    weighted_capacity: NotRequired["capo_emr.types.whole_number.WholeNumber"]
    ...
    bid_price_as_percentage_of_on_demand_price: NotRequired[
        "capo_emr.types.non_negative_double.NonNegativeDouble"
    ]
    ...
    priority: NotRequired["capo_emr.types.non_negative_double.NonNegativeDouble"]
