...
class ComputeLimits(TypedDict, closed=True):
    unit_type: NotRequired[
        "capo_emr.types.compute_limits_unit_type.ComputeLimitsUnitType"
    ]
    """<p> The unit type used for specifying a managed scaling policy. </p>"""
    minimum_capacity_units: NotRequired["capo_emr.types.integer.Integer"]
    ...
    maximum_capacity_units: NotRequired["capo_emr.types.integer.Integer"]
    ...
    maximum_on_demand_capacity_units: NotRequired["capo_emr.types.integer.Integer"]
    """<p> The upper boundary of On-Demand Amazon EC2 units. It is measured through vCPU cores or instances for instance groups and measured through units for instance fleets. The On-Demand units are not allowed to scale beyond this boundary. The parameter is used to split capacity allocation between On-Demand and Spot Instances. </p>"""
    maximum_core_capacity_units: NotRequired["capo_emr.types.integer.Integer"]
...
def serialize_aws_json_1_1(value: ComputeLimits) -> dict:
    ...
    if "unit_type" in value:
        ...
        out["UnitType"] = (
            capo_emr.types.compute_limits_unit_type.serialize_aws_json_1_1(
                value["unit_type"]
            )
        )
...
def deserialize_aws_json_1_1(data: dict) -> ComputeLimits:
    ...
    if data.get("UnitType") is not None:
        ...
        out["unit_type"] = (
            capo_emr.types.compute_limits_unit_type.deserialize_aws_json_1_1(
                data["UnitType"]
            )
        )
