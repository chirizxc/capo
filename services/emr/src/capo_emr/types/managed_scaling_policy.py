...
if TYPE_CHECKING:
    ...
    import capo_emr.types.utilization_performance_index_integer


class ManagedScalingPolicy(TypedDict, closed=True):
    compute_limits: NotRequired["capo_emr.types.compute_limits.ComputeLimits"]
    ...
    utilization_performance_index: NotRequired[
        "capo_emr.types.utilization_performance_index_integer.UtilizationPerformanceIndexInteger"
    ]
    ...
    scaling_strategy: NotRequired["capo_emr.types.scaling_strategy.ScalingStrategy"]
...
def serialize_aws_json_1_1(value: ManagedScalingPolicy) -> dict:
    ...
    if "compute_limits" in value:
        ...
        out["ComputeLimits"] = capo_emr.types.compute_limits.serialize_aws_json_1_1(
    ...
    if "scaling_strategy" in value:
        ...
        out["ScalingStrategy"] = capo_emr.types.scaling_strategy.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> ManagedScalingPolicy:
    ...
    if data.get("ScalingStrategy") is not None:
        ...
        out["scaling_strategy"] = (
            capo_emr.types.scaling_strategy.deserialize_aws_json_1_1(
