...
class InstanceFleetStateChangeReason(TypedDict, closed=True):
    code: NotRequired[
        "capo_emr.types.instance_fleet_state_change_reason_code.InstanceFleetStateChangeReasonCode"
    ]
...
def serialize_aws_json_1_1(value: InstanceFleetStateChangeReason) -> dict:
    ...
    if "code" in value:
        ...
        out["Code"] = (
            capo_emr.types.instance_fleet_state_change_reason_code.serialize_aws_json_1_1(
                value["code"]
            )
        )
    if "message" in value:
...
def deserialize_aws_json_1_1(data: dict) -> InstanceFleetStateChangeReason:
    ...
    if data.get("Code") is not None:
        ...
        out["code"] = (
            capo_emr.types.instance_fleet_state_change_reason_code.deserialize_aws_json_1_1(
                data["Code"]
            )
        )
