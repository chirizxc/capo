...
class AddInstanceGroupsOutput(TypedDict, closed=True):
    ...
    instance_group_ids: NotRequired[
        "capo_emr.types.instance_group_ids_list.InstanceGroupIdsList"
    ]
...
def serialize_aws_json_1_1(value: AddInstanceGroupsOutput) -> dict:
    ...
    if "instance_group_ids" in value:
        ...
        out["InstanceGroupIds"] = (
            capo_emr.types.instance_group_ids_list.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> AddInstanceGroupsOutput:
    ...
    if data.get("InstanceGroupIds") is not None:
        ...
        out["instance_group_ids"] = (
            capo_emr.types.instance_group_ids_list.deserialize_aws_json_1_1(
