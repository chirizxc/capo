...
def handle_response(
    ...
    out: capo_codecatalyst.types.start_dev_environment_session_response.StartDevEnvironmentSessionResponse = capo_codecatalyst.types.start_dev_environment_session_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.start_dev_environment_session_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
