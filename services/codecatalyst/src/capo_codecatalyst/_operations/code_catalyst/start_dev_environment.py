...
def handle_response(
    ...
    out: capo_codecatalyst.types.start_dev_environment_response.StartDevEnvironmentResponse = capo_codecatalyst.types.start_dev_environment_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.start_dev_environment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
