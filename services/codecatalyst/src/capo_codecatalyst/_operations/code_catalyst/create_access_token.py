"""Generated from Smithy shape ``com.amazonaws.codecatalyst#CreateAccessToken``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.create_access_token_response.CreateAccessTokenResponse = capo_codecatalyst.types.create_access_token_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.create_access_token_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
