...
def handle_response(
    ...
    out: capo_codecatalyst.types.list_workflow_runs_response.ListWorkflowRunsResponse = capo_codecatalyst.types.list_workflow_runs_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.list_workflow_runs_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
