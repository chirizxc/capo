...
def handle_response(
    ...
    out: capo_codecatalyst.types.list_dev_environments_response.ListDevEnvironmentsResponse = capo_codecatalyst.types.list_dev_environments_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.list_dev_environments_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
