"""Generated from Smithy shape ``com.amazonaws.codecatalyst#GetSpace``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.get_space_response.GetSpaceResponse = (
        capo_codecatalyst.types.get_space_response.deserialize_json(
...
def get_space(
    ...
    capo_codecatalyst.types.get_space_response.GetSpaceResponse, zapros.Response
]:
