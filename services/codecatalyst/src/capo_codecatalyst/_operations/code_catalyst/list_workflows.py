...
def handle_response(
    ...
    out: capo_codecatalyst.types.list_workflows_response.ListWorkflowsResponse = (
        capo_codecatalyst.types.list_workflows_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.list_workflows_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
