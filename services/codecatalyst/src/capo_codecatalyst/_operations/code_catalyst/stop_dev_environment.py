"""Generated from Smithy shape ``com.amazonaws.codecatalyst#StopDevEnvironment``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.stop_dev_environment_response.StopDevEnvironmentResponse = capo_codecatalyst.types.stop_dev_environment_response.deserialize_json(
...
async def async_stop_dev_environment(
