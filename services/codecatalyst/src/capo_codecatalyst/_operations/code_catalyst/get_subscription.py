"""Generated from Smithy shape ``com.amazonaws.codecatalyst#GetSubscription``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.get_subscription_response.GetSubscriptionResponse = (
        capo_codecatalyst.types.get_subscription_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/v1/spaces/{spaceName}/subscription"
