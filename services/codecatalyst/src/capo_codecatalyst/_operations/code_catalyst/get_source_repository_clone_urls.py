"""Generated from Smithy shape ``com.amazonaws.codecatalyst#GetSourceRepositoryCloneUrls``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.get_source_repository_clone_urls_response.GetSourceRepositoryCloneUrlsResponse = capo_codecatalyst.types.get_source_repository_clone_urls_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{sourceRepositoryName}", quote(input_["source_repository_name"], safe="")
    )
...
async def async_get_source_repository_clone_urls(
