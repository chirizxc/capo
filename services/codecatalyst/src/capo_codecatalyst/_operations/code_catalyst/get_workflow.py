"""Generated from Smithy shape ``com.amazonaws.codecatalyst#GetWorkflow``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.get_workflow_response.GetWorkflowResponse = (
        capo_codecatalyst.types.get_workflow_response.deserialize_json(
...
def get_workflow(
    ...
    capo_codecatalyst.types.get_workflow_response.GetWorkflowResponse, zapros.Response
]:
