...
def handle_response(
    ...
    out: capo_codecatalyst.types.delete_dev_environment_response.DeleteDevEnvironmentResponse = capo_codecatalyst.types.delete_dev_environment_response.deserialize_json(
