...
def handle_response(
    ...
    out: capo_codecatalyst.types.create_source_repository_response.CreateSourceRepositoryResponse = capo_codecatalyst.types.create_source_repository_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.create_source_repository_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
