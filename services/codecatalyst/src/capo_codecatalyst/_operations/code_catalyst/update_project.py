...
def handle_response(
    ...
    out: capo_codecatalyst.types.update_project_response.UpdateProjectResponse = (
        capo_codecatalyst.types.update_project_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_codecatalyst.types.update_project_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
