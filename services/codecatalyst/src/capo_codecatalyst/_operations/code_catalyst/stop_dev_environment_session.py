"""Generated from Smithy shape ``com.amazonaws.codecatalyst#StopDevEnvironmentSession``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.stop_dev_environment_session_response.StopDevEnvironmentSessionResponse = capo_codecatalyst.types.stop_dev_environment_session_response.deserialize_json(
...
async def async_stop_dev_environment_session(
