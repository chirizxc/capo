"""Generated from Smithy shape ``com.amazonaws.codecatalyst#GetDevEnvironment``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.get_dev_environment_response.GetDevEnvironmentResponse = capo_codecatalyst.types.get_dev_environment_response.deserialize_json(
...
async def async_get_dev_environment(
