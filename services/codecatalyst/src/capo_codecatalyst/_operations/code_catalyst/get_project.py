"""Generated from Smithy shape ``com.amazonaws.codecatalyst#GetProject``."""
...
def handle_response(
    ...
    out: capo_codecatalyst.types.get_project_response.GetProjectResponse = (
        capo_codecatalyst.types.get_project_response.deserialize_json(
...
def get_project(
    ...
    capo_codecatalyst.types.get_project_response.GetProjectResponse, zapros.Response
]:
