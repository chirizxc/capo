...
if TYPE_CHECKING:
    import capo_workdocs.types.header_name_type
    import capo_workdocs.types.header_value_type

SignedHeaderMap: TypeAlias = dict[
    "capo_workdocs.types.header_name_type.HeaderNameType",
    "capo_workdocs.types.header_value_type.HeaderValueType",
]
