...
def handle_response(
    ...
    out: capo_workdocs.types.create_user_response.CreateUserResponse = (
        capo_workdocs.types.create_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workdocs.types.create_user_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_user(
    ...
    capo_workdocs.types.create_user_response.CreateUserResponse, zapros.Response
]:
