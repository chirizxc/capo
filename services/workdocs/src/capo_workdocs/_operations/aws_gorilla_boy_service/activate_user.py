...
def handle_response(
    ...
    out: capo_workdocs.types.activate_user_response.ActivateUserResponse = (
        capo_workdocs.types.activate_user_response.deserialize_json(
...
def activate_user(
    ...
    capo_workdocs.types.activate_user_response.ActivateUserResponse, zapros.Response
]:
