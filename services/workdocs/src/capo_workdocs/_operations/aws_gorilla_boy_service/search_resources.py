"""Generated from Smithy shape ``com.amazonaws.workdocs#SearchResources``."""
...
def handle_response(
    ...
    out: capo_workdocs.types.search_resources_response.SearchResourcesResponse = (
        capo_workdocs.types.search_resources_response.deserialize_json(
