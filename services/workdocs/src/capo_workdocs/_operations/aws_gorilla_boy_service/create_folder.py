...
def handle_response(
    ...
    out: capo_workdocs.types.create_folder_response.CreateFolderResponse = (
        capo_workdocs.types.create_folder_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workdocs.types.create_folder_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_folder(
    ...
    capo_workdocs.types.create_folder_response.CreateFolderResponse, zapros.Response
]:
