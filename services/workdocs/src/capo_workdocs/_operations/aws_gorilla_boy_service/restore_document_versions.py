"""Generated from Smithy shape ``com.amazonaws.workdocs#RestoreDocumentVersions``."""
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/api/v1/documentVersions/restore/{DocumentId}"
...
async def async_restore_document_versions(
