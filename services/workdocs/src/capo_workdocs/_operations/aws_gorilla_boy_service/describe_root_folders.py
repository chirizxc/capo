...
def handle_response(
    ...
    out: capo_workdocs.types.describe_root_folders_response.DescribeRootFoldersResponse = capo_workdocs.types.describe_root_folders_response.deserialize_json(
