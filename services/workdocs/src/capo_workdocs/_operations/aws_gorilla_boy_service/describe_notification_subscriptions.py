"""Generated from Smithy shape ``com.amazonaws.workdocs#DescribeNotificationSubscriptions``."""
...
def handle_response(
    ...
    out: capo_workdocs.types.describe_notification_subscriptions_response.DescribeNotificationSubscriptionsResponse = capo_workdocs.types.describe_notification_subscriptions_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{OrganizationId}", quote(input_["organization_id"], safe=""))
...
async def async_describe_notification_subscriptions(
