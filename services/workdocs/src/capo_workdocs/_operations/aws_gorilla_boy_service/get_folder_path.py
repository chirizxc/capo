...
def handle_response(
    ...
    out: capo_workdocs.types.get_folder_path_response.GetFolderPathResponse = (
        capo_workdocs.types.get_folder_path_response.deserialize_json(
...
def get_folder_path(
    ...
    capo_workdocs.types.get_folder_path_response.GetFolderPathResponse, zapros.Response
]:
