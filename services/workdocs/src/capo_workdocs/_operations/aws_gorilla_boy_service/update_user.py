...
import capo_workdocs.errors.deactivating_last_system_user_exception
import capo_workdocs.errors.entity_not_exists_exception
import capo_workdocs.errors.failed_dependency_exception
import capo_workdocs.errors.illegal_user_state_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        case "DeactivatingLastSystemUserException":
            raise capo_workdocs.errors.deactivating_last_system_user_exception.DeactivatingLastSystemUserException.from_json(
                data, message
            )
        ...
        case "IllegalUserStateException":
            raise capo_workdocs.errors.illegal_user_state_exception.IllegalUserStateException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_workdocs.types.update_user_response.UpdateUserResponse = (
        capo_workdocs.types.update_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workdocs.types.update_user_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def update_user(
    ...
    capo_workdocs.types.update_user_response.UpdateUserResponse, zapros.Response
]:
