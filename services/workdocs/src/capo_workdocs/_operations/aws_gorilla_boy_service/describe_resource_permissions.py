"""Generated from Smithy shape ``com.amazonaws.workdocs#DescribeResourcePermissions``."""
...
def handle_response(
    ...
    out: capo_workdocs.types.describe_resource_permissions_response.DescribeResourcePermissionsResponse = capo_workdocs.types.describe_resource_permissions_response.deserialize_json(
...
async def async_describe_resource_permissions(
