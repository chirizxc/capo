"""Generated from Smithy shape ``com.amazonaws.appfabric#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.appfabric#ResourceNotFoundException``."""
