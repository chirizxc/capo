...
from capo_appfabric._services._aws_config import aws_config
...
class AppFabricClient:
    ...
    def batch_get_user_access_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.batch_get_user_access_tasks_request.BatchGetUserAccessTasksRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.batch_get_user_access_tasks_response.BatchGetUserAccessTasksResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.batch_get_user_access_tasks.batch_get_user_access_tasks(
    ...
    def connect_app_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.connect_app_authorization_request.ConnectAppAuthorizationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.connect_app_authorization_response.ConnectAppAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.connect_app_authorization.connect_app_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_app_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.create_app_authorization_request.CreateAppAuthorizationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.create_app_authorization_response.CreateAppAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.create_app_authorization.create_app_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_app_bundle(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.create_app_bundle_request.CreateAppBundleRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.create_app_bundle_response.CreateAppBundleResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.create_app_bundle.create_app_bundle(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_ingestion(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.create_ingestion_request.CreateIngestionRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.create_ingestion_response.CreateIngestionResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.create_ingestion.create_ingestion(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def create_ingestion_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.create_ingestion_destination_request.CreateIngestionDestinationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.create_ingestion_destination_response.CreateIngestionDestinationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.create_ingestion_destination.create_ingestion_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_app_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.delete_app_authorization_request.DeleteAppAuthorizationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.delete_app_authorization_response.DeleteAppAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.delete_app_authorization.delete_app_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_app_bundle(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.delete_app_bundle_request.DeleteAppBundleRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.delete_app_bundle_response.DeleteAppBundleResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.delete_app_bundle.delete_app_bundle(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_ingestion(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.delete_ingestion_request.DeleteIngestionRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.delete_ingestion_response.DeleteIngestionResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.delete_ingestion.delete_ingestion(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def delete_ingestion_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.delete_ingestion_destination_request.DeleteIngestionDestinationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.delete_ingestion_destination_response.DeleteIngestionDestinationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.delete_ingestion_destination.delete_ingestion_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_app_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.get_app_authorization_request.GetAppAuthorizationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.get_app_authorization_response.GetAppAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.get_app_authorization.get_app_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_app_bundle(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.get_app_bundle_request.GetAppBundleRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.get_app_bundle_response.GetAppBundleResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.get_app_bundle.get_app_bundle(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_ingestion(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.get_ingestion_request.GetIngestionRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.get_ingestion_response.GetIngestionResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.get_ingestion.get_ingestion(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_ingestion_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.get_ingestion_destination_request.GetIngestionDestinationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.get_ingestion_destination_response.GetIngestionDestinationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.get_ingestion_destination.get_ingestion_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_app_authorizations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.list_app_authorizations_request.ListAppAuthorizationsRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.list_app_authorizations_response.ListAppAuthorizationsResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.list_app_authorizations.list_app_authorizations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_app_authorizations(
        ...
        *,
        ...
        max_results: Optional["capo_appfabric.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_appfabric.types.string2048.String2048"] = None,
    ) -> "Iterator[capo_appfabric.types.app_authorization_summary.AppAuthorizationSummary]":
        _token = next_token
        while True:
    ...
    def list_app_bundles(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.list_app_bundles_request.ListAppBundlesRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.list_app_bundles_response.ListAppBundlesResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.list_app_bundles.list_app_bundles(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_app_bundles(
        ...
        *,
        ...
        max_results: Optional["capo_appfabric.types.max_results.MaxResults"] = None,
        next_token: Optional["capo_appfabric.types.string2048.String2048"] = None,
    ) -> "Iterator[capo_appfabric.types.app_bundle_summary.AppBundleSummary]":
        _token = next_token
        while True:
    ...
    def list_ingestion_destinations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.list_ingestion_destinations_request.ListIngestionDestinationsRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.list_ingestion_destinations_response.ListIngestionDestinationsResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.list_ingestion_destinations.list_ingestion_destinations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_ingestion_destinations(
        ...
        *,
        ...
        max_results: Optional["capo_appfabric.types.max_results.MaxResults"] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_appfabric.types.ingestion_destination_summary.IngestionDestinationSummary]":
        _token = next_token
        while True:
    ...
    def list_ingestions(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.list_ingestions_request.ListIngestionsRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.list_ingestions_response.ListIngestionsResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.list_ingestions.list_ingestions(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_ingestions(
        ...
        *,
        ...
        max_results: Optional["capo_appfabric.types.max_results.MaxResults"] = None,
        next_token: Optional[str] = None,
    ) -> "Iterator[capo_appfabric.types.ingestion_summary.IngestionSummary]":
        _token = next_token
        while True:
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.list_tags_for_resource_request.ListTagsForResourceRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.list_tags_for_resource_response.ListTagsForResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.list_tags_for_resource.list_tags_for_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_ingestion(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.start_ingestion_request.StartIngestionRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.start_ingestion_response.StartIngestionResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.start_ingestion.start_ingestion(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def start_user_access_tasks(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.start_user_access_tasks_request.StartUserAccessTasksRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.start_user_access_tasks_response.StartUserAccessTasksResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.start_user_access_tasks.start_user_access_tasks(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def stop_ingestion(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.stop_ingestion_request.StopIngestionRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.stop_ingestion_response.StopIngestionResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.stop_ingestion.stop_ingestion(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def tag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.tag_resource_request.TagResourceRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.tag_resource_response.TagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.tag_resource.tag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def untag_resource(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.untag_resource_request.UntagResourceRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.untag_resource_response.UntagResourceResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.untag_resource.untag_resource(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_app_authorization(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.update_app_authorization_request.UpdateAppAuthorizationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.update_app_authorization_response.UpdateAppAuthorizationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.update_app_authorization.update_app_authorization(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def update_ingestion_destination(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_appfabric.types.update_ingestion_destination_request.UpdateIngestionDestinationRequest]",
        ) -> OperationResponse[
            "capo_appfabric.types.update_ingestion_destination_response.UpdateIngestionDestinationResponse"
        ]:
            ...
            output, http_response = (
                capo_appfabric._operations.fabric_front_end_service.update_ingestion_destination.update_ingestion_destination(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
