...
class DescribeStreamSummaryOutput(TypedDict, closed=True):
    stream_description_summary: (
        "capo_kinesis.types.stream_description_summary.StreamDescriptionSummary"
    )
...
def serialize_aws_json_1_1(value: DescribeStreamSummaryOutput) -> dict:
    ...
    out["StreamDescriptionSummary"] = (
        capo_kinesis.types.stream_description_summary.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeStreamSummaryOutput:
    ...
    if data.get("StreamDescriptionSummary") is not None:
        ...
        out["stream_description_summary"] = (
            capo_kinesis.types.stream_description_summary.deserialize_aws_json_1_1(
