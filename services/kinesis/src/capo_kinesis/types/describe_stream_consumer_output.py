...
if TYPE_CHECKING:
    import capo_kinesis.types.consumer_description


class DescribeStreamConsumerOutput(TypedDict, closed=True):
    consumer_description: "capo_kinesis.types.consumer_description.ConsumerDescription"
...
def serialize_aws_json_1_1(value: DescribeStreamConsumerOutput) -> dict:
    ...
    out["ConsumerDescription"] = (
        capo_kinesis.types.consumer_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> DescribeStreamConsumerOutput:
    ...
    if data.get("ConsumerDescription") is not None:
        import capo_kinesis.types.consumer_description

        out["consumer_description"] = (
            capo_kinesis.types.consumer_description.deserialize_aws_json_1_1(
