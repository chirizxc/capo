"""Generated from Smithy shape ``com.amazonaws.kinesis#ListStreams``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.list_streams_output.ListStreamsOutput = (
        capo_kinesis.types.list_streams_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.list_streams_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def list_streams(
    ...
    input_: capo_kinesis.types.list_streams_input.ListStreamsInput,
) -> tuple[capo_kinesis.types.list_streams_output.ListStreamsOutput, zapros.Response]:
