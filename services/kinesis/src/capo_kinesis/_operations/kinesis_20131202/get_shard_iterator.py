...
def handle_response(
    ...
    out: capo_kinesis.types.get_shard_iterator_output.GetShardIteratorOutput = (
        capo_kinesis.types.get_shard_iterator_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.get_shard_iterator_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def get_shard_iterator(
    ...
    capo_kinesis.types.get_shard_iterator_output.GetShardIteratorOutput, zapros.Response
]:
