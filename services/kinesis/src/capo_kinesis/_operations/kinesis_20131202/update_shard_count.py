"""Generated from Smithy shape ``com.amazonaws.kinesis#UpdateShardCount``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.update_shard_count_output.UpdateShardCountOutput = (
        capo_kinesis.types.update_shard_count_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.update_shard_count_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def update_shard_count(
    ...
    capo_kinesis.types.update_shard_count_output.UpdateShardCountOutput, zapros.Response
]:
...
async def async_update_shard_count(
