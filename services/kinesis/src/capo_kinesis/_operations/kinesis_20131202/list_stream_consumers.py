"""Generated from Smithy shape ``com.amazonaws.kinesis#ListStreamConsumers``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.list_stream_consumers_output.ListStreamConsumersOutput = (
        capo_kinesis.types.list_stream_consumers_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.list_stream_consumers_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_list_stream_consumers(
