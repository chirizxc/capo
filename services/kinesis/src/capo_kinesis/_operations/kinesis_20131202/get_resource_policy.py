"""Generated from Smithy shape ``com.amazonaws.kinesis#GetResourcePolicy``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.get_resource_policy_output.GetResourcePolicyOutput = (
        capo_kinesis.types.get_resource_policy_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.GetResourcePolicy"
    body: bytes | None = json.dumps(
        capo_kinesis.types.get_resource_policy_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
