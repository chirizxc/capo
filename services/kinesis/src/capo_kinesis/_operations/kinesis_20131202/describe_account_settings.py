"""Generated from Smithy shape ``com.amazonaws.kinesis#DescribeAccountSettings``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.describe_account_settings_output.DescribeAccountSettingsOutput = capo_kinesis.types.describe_account_settings_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.DescribeAccountSettings"
    body: bytes | None = json.dumps(
        capo_kinesis.types.describe_account_settings_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
