"""Generated from Smithy shape ``com.amazonaws.kinesis#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.list_tags_for_resource_output.ListTagsForResourceOutput = (
        capo_kinesis.types.list_tags_for_resource_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "Kinesis_20131202.ListTagsForResource"
    body: bytes | None = json.dumps(
        capo_kinesis.types.list_tags_for_resource_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
