...
def handle_response(
    ...
    out: capo_kinesis.types.describe_stream_consumer_output.DescribeStreamConsumerOutput = capo_kinesis.types.describe_stream_consumer_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.describe_stream_consumer_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
