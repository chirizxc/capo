"""Generated from Smithy shape ``com.amazonaws.kinesis#DisableEnhancedMonitoring``."""
...
def handle_response(
    ...
    out: capo_kinesis.types.enhanced_monitoring_output.EnhancedMonitoringOutput = (
        capo_kinesis.types.enhanced_monitoring_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_kinesis.types.disable_enhanced_monitoring_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
