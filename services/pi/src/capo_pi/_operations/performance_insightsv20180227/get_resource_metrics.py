"""Generated from Smithy shape ``com.amazonaws.pi#GetResourceMetrics``."""
...
def handle_response(
    ...
    out: capo_pi.types.get_resource_metrics_response.GetResourceMetricsResponse = (
        capo_pi.types.get_resource_metrics_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pi.types.get_resource_metrics_request.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_get_resource_metrics(
