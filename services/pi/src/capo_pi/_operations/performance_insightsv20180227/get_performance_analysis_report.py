...
def handle_response(
    ...
    out: capo_pi.types.get_performance_analysis_report_response.GetPerformanceAnalysisReportResponse = capo_pi.types.get_performance_analysis_report_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pi.types.get_performance_analysis_report_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
