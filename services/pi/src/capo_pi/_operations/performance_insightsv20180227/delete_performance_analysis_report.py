...
def handle_response(
    ...
    out: capo_pi.types.delete_performance_analysis_report_response.DeletePerformanceAnalysisReportResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pi.types.delete_performance_analysis_report_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
