"""Generated from Smithy shape ``com.amazonaws.pi#ListAvailableResourceDimensions``."""
...
def handle_response(
    ...
    out: capo_pi.types.list_available_resource_dimensions_response.ListAvailableResourceDimensionsResponse = capo_pi.types.list_available_resource_dimensions_response.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_pi.types.list_available_resource_dimensions_request.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_available_resource_dimensions(
