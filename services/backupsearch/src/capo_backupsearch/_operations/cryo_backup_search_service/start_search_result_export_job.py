...
def handle_response(
    ...
    out: capo_backupsearch.types.start_search_result_export_job_output.StartSearchResultExportJobOutput = capo_backupsearch.types.start_search_result_export_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backupsearch.types.start_search_result_export_job_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
