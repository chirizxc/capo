"""Generated from Smithy shape ``com.amazonaws.backupsearch#StartSearchJob``."""
...
def handle_response(
    ...
    out: capo_backupsearch.types.start_search_job_output.StartSearchJobOutput = (
        capo_backupsearch.types.start_search_job_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_backupsearch.types.start_search_job_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_search_job(
