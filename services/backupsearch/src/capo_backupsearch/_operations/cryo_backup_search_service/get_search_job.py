...
def handle_response(
    ...
    out: capo_backupsearch.types.get_search_job_output.GetSearchJobOutput = (
        capo_backupsearch.types.get_search_job_output.deserialize_json(
...
def get_search_job(
    ...
    capo_backupsearch.types.get_search_job_output.GetSearchJobOutput, zapros.Response
]:
