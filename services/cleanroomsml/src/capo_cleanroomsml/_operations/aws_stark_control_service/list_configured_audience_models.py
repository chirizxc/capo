...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_configured_audience_models_response.ListConfiguredAudienceModelsResponse = capo_cleanroomsml.types.list_configured_audience_models_response.deserialize_json(
