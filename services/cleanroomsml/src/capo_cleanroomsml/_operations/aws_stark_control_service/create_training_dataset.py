"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#CreateTrainingDataset``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.create_training_dataset_response.CreateTrainingDatasetResponse = capo_cleanroomsml.types.create_training_dataset_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.create_training_dataset_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_training_dataset(
