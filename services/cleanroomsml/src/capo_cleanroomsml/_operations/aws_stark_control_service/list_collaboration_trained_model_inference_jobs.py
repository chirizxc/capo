"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListCollaborationTrainedModelInferenceJobs``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_collaboration_trained_model_inference_jobs_response.ListCollaborationTrainedModelInferenceJobsResponse = capo_cleanroomsml.types.list_collaboration_trained_model_inference_jobs_response.deserialize_json(
...
def build_request(
    ...
    if "trained_model_arn" in input_:
        params.append(("trainedModelArn", input_["trained_model_arn"]))
...
async def async_list_collaboration_trained_model_inference_jobs(
