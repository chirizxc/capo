"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#CreateConfiguredAudienceModel``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.create_configured_audience_model_response.CreateConfiguredAudienceModelResponse = capo_cleanroomsml.types.create_configured_audience_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.create_configured_audience_model_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_configured_audience_model(
