...
def handle_response(
    ...
    out: capo_cleanroomsml.types.start_trained_model_inference_job_response.StartTrainedModelInferenceJobResponse = capo_cleanroomsml.types.start_trained_model_inference_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.start_trained_model_inference_job_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
