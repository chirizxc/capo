"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#StartTrainedModelExportJob``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.start_trained_model_export_job_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_trained_model_export_job(
