"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#DeleteConfiguredModelAlgorithmAssociation``."""
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["configured_model_algorithm_association_arn"], safe=""),
    )
    url = url.replace(
...
async def async_delete_configured_model_algorithm_association(
