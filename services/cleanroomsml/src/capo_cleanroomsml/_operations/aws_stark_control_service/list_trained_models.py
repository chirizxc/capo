...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_trained_models_response.ListTrainedModelsResponse = capo_cleanroomsml.types.list_trained_models_response.deserialize_json(
