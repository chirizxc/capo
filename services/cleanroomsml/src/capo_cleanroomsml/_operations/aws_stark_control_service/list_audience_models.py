"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListAudienceModels``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_audience_models_response.ListAudienceModelsResponse = capo_cleanroomsml.types.list_audience_models_response.deserialize_json(
...
async def async_list_audience_models(
