...
def handle_response(
    ...
    out: capo_cleanroomsml.types.create_configured_model_algorithm_response.CreateConfiguredModelAlgorithmResponse = capo_cleanroomsml.types.create_configured_model_algorithm_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.create_configured_model_algorithm_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
