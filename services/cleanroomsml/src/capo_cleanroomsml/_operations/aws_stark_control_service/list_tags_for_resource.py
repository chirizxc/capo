...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_cleanroomsml.types.list_tags_for_resource_response.deserialize_json(
