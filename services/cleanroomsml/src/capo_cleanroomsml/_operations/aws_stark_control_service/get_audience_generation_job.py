"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetAudienceGenerationJob``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_audience_generation_job_response.GetAudienceGenerationJobResponse = capo_cleanroomsml.types.get_audience_generation_job_response.deserialize_json(
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/audience-generation-job/{audienceGenerationJobArn}"
    )
    url = url.replace(
        "{audienceGenerationJobArn}",
        quote(input_["audience_generation_job_arn"], safe=""),
    )
...
async def async_get_audience_generation_job(
