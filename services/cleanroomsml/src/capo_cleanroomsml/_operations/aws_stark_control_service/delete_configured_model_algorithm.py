"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#DeleteConfiguredModelAlgorithm``."""
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["configured_model_algorithm_arn"], safe=""),
    )
...
async def async_delete_configured_model_algorithm(
