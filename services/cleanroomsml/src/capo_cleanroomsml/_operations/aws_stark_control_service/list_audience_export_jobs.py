"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#ListAudienceExportJobs``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_audience_export_jobs_response.ListAudienceExportJobsResponse = capo_cleanroomsml.types.list_audience_export_jobs_response.deserialize_json(
...
def build_request(
    ...
    if "audience_generation_job_arn" in input_:
        params.append(
            ("audienceGenerationJobArn", input_["audience_generation_job_arn"])
        )
...
async def async_list_audience_export_jobs(
