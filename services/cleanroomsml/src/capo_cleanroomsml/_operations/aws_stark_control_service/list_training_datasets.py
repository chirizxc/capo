...
def handle_response(
    ...
    out: capo_cleanroomsml.types.list_training_datasets_response.ListTrainingDatasetsResponse = capo_cleanroomsml.types.list_training_datasets_response.deserialize_json(
