...
def handle_response(
    ...
    out: capo_cleanroomsml.types.create_audience_model_response.CreateAudienceModelResponse = capo_cleanroomsml.types.create_audience_model_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.create_audience_model_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
