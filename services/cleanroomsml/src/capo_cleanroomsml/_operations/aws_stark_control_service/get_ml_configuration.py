...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_ml_configuration_response.GetMLConfigurationResponse = capo_cleanroomsml.types.get_ml_configuration_response.deserialize_json(
