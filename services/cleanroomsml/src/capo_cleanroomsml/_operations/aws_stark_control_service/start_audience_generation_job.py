...
def handle_response(
    ...
    out: capo_cleanroomsml.types.start_audience_generation_job_response.StartAudienceGenerationJobResponse = capo_cleanroomsml.types.start_audience_generation_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cleanroomsml.types.start_audience_generation_job_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
