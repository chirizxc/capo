"""Generated from Smithy shape ``com.amazonaws.cleanroomsml#GetCollaborationTrainedModel``."""
...
def handle_response(
    ...
    out: capo_cleanroomsml.types.get_collaboration_trained_model_response.GetCollaborationTrainedModelResponse = capo_cleanroomsml.types.get_collaboration_trained_model_response.deserialize_json(
...
def build_request(
    ...
    if "version_identifier" in input_:
        params.append(("versionIdentifier", input_["version_identifier"]))
...
async def async_get_collaboration_trained_model(
