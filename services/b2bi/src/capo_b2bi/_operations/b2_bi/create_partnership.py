...
def handle_response(
    ...
    out: capo_b2bi.types.create_partnership_response.CreatePartnershipResponse = (
        capo_b2bi.types.create_partnership_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_b2bi.types.create_partnership_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
