"""Generated from Smithy shape ``com.amazonaws.b2bi#ListProfiles``."""
...
import capo_b2bi.types.profile_list
...
def handle_response(
    ...
    out: capo_b2bi.types.list_profiles_response.ListProfilesResponse = (
        capo_b2bi.types.list_profiles_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "B2BI.ListProfiles"
    body: bytes | None = json.dumps(
        capo_b2bi.types.list_profiles_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_profiles(
    ...
    capo_b2bi.types.list_profiles_response.ListProfilesResponse, zapros.Response
]:
