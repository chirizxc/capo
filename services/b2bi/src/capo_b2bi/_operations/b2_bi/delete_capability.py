"""Generated from Smithy shape ``com.amazonaws.b2bi#DeleteCapability``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "B2BI.DeleteCapability"
    body: bytes | None = json.dumps(
        capo_b2bi.types.delete_capability_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
