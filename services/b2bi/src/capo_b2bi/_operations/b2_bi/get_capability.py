"""Generated from Smithy shape ``com.amazonaws.b2bi#GetCapability``."""
...
def handle_response(
    ...
    out: capo_b2bi.types.get_capability_response.GetCapabilityResponse = (
        capo_b2bi.types.get_capability_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "B2BI.GetCapability"
    body: bytes | None = json.dumps(
        capo_b2bi.types.get_capability_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_capability(
    ...
    capo_b2bi.types.get_capability_response.GetCapabilityResponse, zapros.Response
]:
