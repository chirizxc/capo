"""Generated from Smithy shape ``com.amazonaws.b2bi#GetProfile``."""
...
def handle_response(
    ...
    out: capo_b2bi.types.get_profile_response.GetProfileResponse = (
        capo_b2bi.types.get_profile_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "B2BI.GetProfile"
    body: bytes | None = json.dumps(
        capo_b2bi.types.get_profile_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_profile(
    ...
    input_: capo_b2bi.types.get_profile_request.GetProfileRequest,
) -> tuple[capo_b2bi.types.get_profile_response.GetProfileResponse, zapros.Response]:
