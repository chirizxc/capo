...
def handle_response(
    ...
    out: capo_b2bi.types.create_starter_mapping_template_response.CreateStarterMappingTemplateResponse = capo_b2bi.types.create_starter_mapping_template_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_b2bi.types.create_starter_mapping_template_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
