...
def handle_response(
    ...
    out: capo_b2bi.types.list_transformers_response.ListTransformersResponse = (
        capo_b2bi.types.list_transformers_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_b2bi.types.list_transformers_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_transformers(
    ...
    capo_b2bi.types.list_transformers_response.ListTransformersResponse, zapros.Response
]:
