"""Generated from Smithy shape ``com.amazonaws.b2bi#DeleteTransformer``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "B2BI.DeleteTransformer"
    body: bytes | None = json.dumps(
        capo_b2bi.types.delete_transformer_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
