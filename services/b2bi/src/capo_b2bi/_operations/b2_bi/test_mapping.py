"""Generated from Smithy shape ``com.amazonaws.b2bi#TestMapping``."""
...
def handle_response(
    ...
    out: capo_b2bi.types.test_mapping_response.TestMappingResponse = (
        capo_b2bi.types.test_mapping_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/testmapping"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    headers["X-Amz-Target"] = "B2BI.TestMapping"
    body: bytes | None = json.dumps(
        capo_b2bi.types.test_mapping_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def test_mapping(
    ...
    input_: capo_b2bi.types.test_mapping_request.TestMappingRequest,
) -> tuple[capo_b2bi.types.test_mapping_response.TestMappingResponse, zapros.Response]:
