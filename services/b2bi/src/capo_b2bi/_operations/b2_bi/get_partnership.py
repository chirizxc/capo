"""Generated from Smithy shape ``com.amazonaws.b2bi#GetPartnership``."""
...
def handle_response(
    ...
    out: capo_b2bi.types.get_partnership_response.GetPartnershipResponse = (
        capo_b2bi.types.get_partnership_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_b2bi.types.get_partnership_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def get_partnership(
    ...
    capo_b2bi.types.get_partnership_response.GetPartnershipResponse, zapros.Response
]:
