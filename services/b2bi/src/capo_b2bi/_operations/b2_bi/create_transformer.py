"""Generated from Smithy shape ``com.amazonaws.b2bi#CreateTransformer``."""
...
def handle_response(
    ...
    out: capo_b2bi.types.create_transformer_response.CreateTransformerResponse = (
        capo_b2bi.types.create_transformer_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "B2BI.CreateTransformer"
    body: bytes | None = json.dumps(
        capo_b2bi.types.create_transformer_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_transformer(
