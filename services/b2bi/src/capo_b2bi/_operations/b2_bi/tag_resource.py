"""Generated from Smithy shape ``com.amazonaws.b2bi#TagResource``."""
...
def build_request(
    ...
    headers["X-Amz-Target"] = "B2BI.TagResource"
    body: bytes | None = json.dumps(
        capo_b2bi.types.tag_resource_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
