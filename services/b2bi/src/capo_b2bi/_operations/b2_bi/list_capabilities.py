"""Generated from Smithy shape ``com.amazonaws.b2bi#ListCapabilities``."""
...
def handle_response(
    ...
    out: capo_b2bi.types.list_capabilities_response.ListCapabilitiesResponse = (
        capo_b2bi.types.list_capabilities_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "B2BI.ListCapabilities"
    body: bytes | None = json.dumps(
        capo_b2bi.types.list_capabilities_request.serialize_aws_json_1_0(input_),
        allow_nan=False,
    ).encode()
...
def list_capabilities(
    ...
    capo_b2bi.types.list_capabilities_response.ListCapabilitiesResponse, zapros.Response
]:
...
async def async_list_capabilities(
