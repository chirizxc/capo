...
if TYPE_CHECKING:
    import capo_b2bi.types.x12_inbound_edi_options


class InboundEdiOptions(TypedDict, closed=True):
    x12: NotRequired["capo_b2bi.types.x12_inbound_edi_options.X12InboundEdiOptions"]
...
def serialize_aws_json_1_0(value: InboundEdiOptions) -> dict:
    ...
    if "x12" in value:
        ...
        out["x12"] = capo_b2bi.types.x12_inbound_edi_options.serialize_aws_json_1_0(
            value["x12"]
        )
    return out
...
def deserialize_aws_json_1_0(data: dict) -> InboundEdiOptions:
    ...
    if data.get("x12") is not None:
        ...
        out["x12"] = capo_b2bi.types.x12_inbound_edi_options.deserialize_aws_json_1_0(
            data["x12"]
        )
    return out
