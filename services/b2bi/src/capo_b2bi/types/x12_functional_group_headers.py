...
if TYPE_CHECKING:
    import capo_b2bi.types.x12_application_receiver_code
    import capo_b2bi.types.x12_application_sender_code
    import capo_b2bi.types.x12_responsible_agency_code


class X12FunctionalGroupHeaders(TypedDict, closed=True):
    application_sender_code: NotRequired[
        "capo_b2bi.types.x12_application_sender_code.X12ApplicationSenderCode"
    ]
    ...
    application_receiver_code: NotRequired[
        "capo_b2bi.types.x12_application_receiver_code.X12ApplicationReceiverCode"
    ]
    ...
    responsible_agency_code: NotRequired[
        "capo_b2bi.types.x12_responsible_agency_code.X12ResponsibleAgencyCode"
    ]
