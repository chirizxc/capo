"""Generated from Smithy shape ``com.amazonaws.b2bi#UpdateTransformerResponse``."""
...
class UpdateTransformerResponse(TypedDict, closed=True):
    ...
    modified_at: "capo_b2bi.types.modified_date.ModifiedDate"
...
# --- awsJson1_0 ser/de ---
def serialize_aws_json_1_0(value: UpdateTransformerResponse) -> dict:
    out: dict = {}
...
def deserialize_aws_json_1_0(data: dict) -> UpdateTransformerResponse:
    out: UpdateTransformerResponse = {}  # type: ignore[typeddict-item]
    if data.get("transformerId") is not None:
        out["transformer_id"] = data["transformerId"]
    else:
        raise DeserializationError("UpdateTransformerResponse.transformer_id required")
    if data.get("transformerArn") is not None:
        out["transformer_arn"] = data["transformerArn"]
    else:
        raise DeserializationError("UpdateTransformerResponse.transformer_arn required")
    if data.get("name") is not None:
        out["name"] = data["name"]
    else:
        raise DeserializationError("UpdateTransformerResponse.name required")
    if data.get("status") is not None:
        ...
        raise DeserializationError("UpdateTransformerResponse.status required")
    if data.get("createdAt") is not None:
        ...
        raise DeserializationError("UpdateTransformerResponse.created_at required")
    if data.get("modifiedAt") is not None:
        ...
        raise DeserializationError("UpdateTransformerResponse.modified_at required")
