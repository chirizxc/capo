...
if TYPE_CHECKING:
    import capo_b2bi.types.x12_component_separator
    import capo_b2bi.types.x12_data_element_separator
    import capo_b2bi.types.x12_segment_terminator


class X12Delimiters(TypedDict, closed=True):
    component_separator: NotRequired[
        "capo_b2bi.types.x12_component_separator.X12ComponentSeparator"
    ]
    """<p>The component, or sub-element, separator. The default value is <code>:</code> (colon).</p>"""
    data_element_separator: NotRequired[
        "capo_b2bi.types.x12_data_element_separator.X12DataElementSeparator"
    ]
    """<p>The data element separator. The default value is <code>*</code> (asterisk).</p>"""
    segment_terminator: NotRequired[
        "capo_b2bi.types.x12_segment_terminator.X12SegmentTerminator"
    ]
