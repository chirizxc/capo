...
def handle_response(
    ...
    out: capo_launch_wizard.types.update_deployment_output.UpdateDeploymentOutput = (
        capo_launch_wizard.types.update_deployment_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_launch_wizard.types.update_deployment_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
