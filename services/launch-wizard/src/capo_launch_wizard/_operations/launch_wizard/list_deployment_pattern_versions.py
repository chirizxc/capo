...
def handle_response(
    ...
    out: capo_launch_wizard.types.list_deployment_pattern_versions_output.ListDeploymentPatternVersionsOutput = capo_launch_wizard.types.list_deployment_pattern_versions_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_launch_wizard.types.list_deployment_pattern_versions_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
