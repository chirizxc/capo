...
def handle_response(
    ...
    out: capo_launch_wizard.types.get_workload_output.GetWorkloadOutput = (
        capo_launch_wizard.types.get_workload_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_launch_wizard.types.get_workload_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_workload(
    ...
    capo_launch_wizard.types.get_workload_output.GetWorkloadOutput, zapros.Response
]:
