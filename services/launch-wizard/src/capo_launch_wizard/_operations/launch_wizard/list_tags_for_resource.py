"""Generated from Smithy shape ``com.amazonaws.launchwizard#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_launch_wizard.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_launch_wizard.types.list_tags_for_resource_output.deserialize_json(
