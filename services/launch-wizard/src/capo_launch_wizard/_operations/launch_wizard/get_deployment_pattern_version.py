...
def handle_response(
    ...
    out: capo_launch_wizard.types.get_deployment_pattern_version_output.GetDeploymentPatternVersionOutput = capo_launch_wizard.types.get_deployment_pattern_version_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_launch_wizard.types.get_deployment_pattern_version_input.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
