...
def handle_response(
    ...
    out: capo_launch_wizard.types.get_deployment_output.GetDeploymentOutput = (
        capo_launch_wizard.types.get_deployment_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_launch_wizard.types.get_deployment_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_deployment(
    ...
    capo_launch_wizard.types.get_deployment_output.GetDeploymentOutput, zapros.Response
]:
