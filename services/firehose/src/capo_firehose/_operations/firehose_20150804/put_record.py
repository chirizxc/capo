"""Generated from Smithy shape ``com.amazonaws.firehose#PutRecord``."""
...
def handle_response(
    ...
    out: capo_firehose.types.put_record_output.PutRecordOutput = (
        capo_firehose.types.put_record_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.put_record_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_record(
    ...
    input_: capo_firehose.types.put_record_input.PutRecordInput,
) -> tuple[capo_firehose.types.put_record_output.PutRecordOutput, zapros.Response]:
