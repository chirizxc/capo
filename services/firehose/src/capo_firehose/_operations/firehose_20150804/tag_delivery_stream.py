"""Generated from Smithy shape ``com.amazonaws.firehose#TagDeliveryStream``."""
...
def handle_response(
    ...
    out: capo_firehose.types.tag_delivery_stream_output.TagDeliveryStreamOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.tag_delivery_stream_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
async def async_tag_delivery_stream(
