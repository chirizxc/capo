"""Generated from Smithy shape ``com.amazonaws.firehose#StartDeliveryStreamEncryption``."""
...
def handle_response(
    ...
    out: capo_firehose.types.start_delivery_stream_encryption_output.StartDeliveryStreamEncryptionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.start_delivery_stream_encryption_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_start_delivery_stream_encryption(
