"""Generated from Smithy shape ``com.amazonaws.firehose#DescribeDeliveryStream``."""
...
def handle_response(
    ...
    out: capo_firehose.types.describe_delivery_stream_output.DescribeDeliveryStreamOutput = capo_firehose.types.describe_delivery_stream_output.deserialize_aws_json_1_1(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.describe_delivery_stream_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_describe_delivery_stream(
