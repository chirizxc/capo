"""Generated from Smithy shape ``com.amazonaws.firehose#PutRecordBatch``."""
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidSourceException":
            raise capo_firehose.errors.invalid_source_exception.InvalidSourceException.from_aws_json_1_1(
                data, message
            )
        ...
        case "ServiceUnavailableException":
            raise capo_firehose.errors.service_unavailable_exception.ServiceUnavailableException.from_aws_json_1_1(
                data, message
            )
        case _:
...
def handle_response(
    ...
    out: capo_firehose.types.put_record_batch_output.PutRecordBatchOutput = (
        capo_firehose.types.put_record_batch_output.deserialize_aws_json_1_1(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_firehose._auth._sigv4.build_sigv4_auth_scheme(
                "firehose", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.put_record_batch_input.serialize_aws_json_1_1(input_),
        allow_nan=False,
    ).encode()
...
def put_record_batch(
    ...
    capo_firehose.types.put_record_batch_output.PutRecordBatchOutput, zapros.Response
]:
...
async def async_put_record_batch(
