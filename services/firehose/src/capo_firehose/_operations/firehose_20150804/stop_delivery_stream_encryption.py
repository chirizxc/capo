...
def handle_response(
    ...
    out: capo_firehose.types.stop_delivery_stream_encryption_output.StopDeliveryStreamEncryptionOutput = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_firehose.types.stop_delivery_stream_encryption_input.serialize_aws_json_1_1(
            input_
        ),
        allow_nan=False,
    ).encode()
