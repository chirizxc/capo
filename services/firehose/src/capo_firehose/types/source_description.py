...
class SourceDescription(TypedDict, closed=True):
    ...
    database_source_description: NotRequired[
        "capo_firehose.types.database_source_description.DatabaseSourceDescription"
    ]
...
def serialize_aws_json_1_1(value: SourceDescription) -> dict:
    ...
    if "direct_put_source_description" in value:
        ...
        out["DirectPutSourceDescription"] = (
            capo_firehose.types.direct_put_source_description.serialize_aws_json_1_1(
    ...
    if "kinesis_stream_source_description" in value:
        ...
        out["KinesisStreamSourceDescription"] = (
            capo_firehose.types.kinesis_stream_source_description.serialize_aws_json_1_1(
    ...
    if "msk_source_description" in value:
        ...
        out["MSKSourceDescription"] = (
            capo_firehose.types.msk_source_description.serialize_aws_json_1_1(
    ...
    if "database_source_description" in value:
        ...
        out["DatabaseSourceDescription"] = (
            capo_firehose.types.database_source_description.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> SourceDescription:
    ...
    if data.get("DirectPutSourceDescription") is not None:
        ...
        out["direct_put_source_description"] = (
            capo_firehose.types.direct_put_source_description.deserialize_aws_json_1_1(
    ...
    if data.get("KinesisStreamSourceDescription") is not None:
        ...
        out["kinesis_stream_source_description"] = (
            capo_firehose.types.kinesis_stream_source_description.deserialize_aws_json_1_1(
    ...
    if data.get("MSKSourceDescription") is not None:
        ...
        out["msk_source_description"] = (
            capo_firehose.types.msk_source_description.deserialize_aws_json_1_1(
    ...
    if data.get("DatabaseSourceDescription") is not None:
        ...
        out["database_source_description"] = (
            capo_firehose.types.database_source_description.deserialize_aws_json_1_1(
