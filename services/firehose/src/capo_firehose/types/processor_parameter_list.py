...
if TYPE_CHECKING:
    import capo_firehose.types.processor_parameter

ProcessorParameterList: TypeAlias = list[
    "capo_firehose.types.processor_parameter.ProcessorParameter"
]
...
def serialize_aws_json_1_1(value: ProcessorParameterList) -> list:
    ...
    out: list = []
    for item in value:
        out.append(capo_firehose.types.processor_parameter.serialize_aws_json_1_1(item))
    return out
