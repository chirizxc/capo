...
class PutRecordBatchResponseEntry(TypedDict, closed=True):
    record_id: NotRequired[
        "capo_firehose.types.put_response_record_id.PutResponseRecordId"
    ]
    """<p>The ID of the record.</p>"""
    error_code: NotRequired["capo_firehose.types.error_code.ErrorCode"]
    """<p>The error code for an individual record result.</p>"""
    error_message: NotRequired["capo_firehose.types.error_message.ErrorMessage"]
