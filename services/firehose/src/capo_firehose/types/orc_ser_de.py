...
if TYPE_CHECKING:
    ...
    import capo_firehose.types.orc_row_index_stride
    import capo_firehose.types.orc_stripe_size_bytes
    import capo_firehose.types.proportion


class OrcSerDe(TypedDict, closed=True):
    stripe_size_bytes: NotRequired[
        "capo_firehose.types.orc_stripe_size_bytes.OrcStripeSizeBytes"
    ]
    ...
    row_index_stride: NotRequired[
        "capo_firehose.types.orc_row_index_stride.OrcRowIndexStride"
    ]
    """<p>The number of rows between index entries. The default is 10,000 and the minimum is 1,000.</p>"""
    enable_padding: NotRequired["capo_firehose.types.boolean_object.BooleanObject"]
    ...
    padding_tolerance: NotRequired["capo_firehose.types.proportion.Proportion"]
    ...
    compression: NotRequired["capo_firehose.types.orc_compression.OrcCompression"]
    """<p>The compression code to use over data blocks. The default is <code>SNAPPY</code>.</p>"""
    bloom_filter_columns: NotRequired[
        "capo_firehose.types.list_of_non_empty_strings_without_whitespace.ListOfNonEmptyStringsWithoutWhitespace"
    ]
    ...
    bloom_filter_false_positive_probability: NotRequired[
        "capo_firehose.types.proportion.Proportion"
    ]
    ...
    dictionary_key_threshold: NotRequired["capo_firehose.types.proportion.Proportion"]
    ...
    format_version: NotRequired[
        "capo_firehose.types.orc_format_version.OrcFormatVersion"
    ]
...
def serialize_aws_json_1_1(value: OrcSerDe) -> dict:
    ...
    if "compression" in value:
        ...
        out["Compression"] = capo_firehose.types.orc_compression.serialize_aws_json_1_1(
            value["compression"]
        )
    if "bloom_filter_columns" in value:
        ...
        out["BloomFilterColumns"] = (
            capo_firehose.types.list_of_non_empty_strings_without_whitespace.serialize_aws_json_1_1(
    ...
    if "format_version" in value:
        ...
        out["FormatVersion"] = (
            capo_firehose.types.orc_format_version.serialize_aws_json_1_1(
...
def deserialize_aws_json_1_1(data: dict) -> OrcSerDe:
    ...
    if data.get("Compression") is not None:
        ...
        out["compression"] = (
            capo_firehose.types.orc_compression.deserialize_aws_json_1_1(
                data["Compression"]
            )
        )
    if data.get("BloomFilterColumns") is not None:
        ...
        out["bloom_filter_columns"] = (
            capo_firehose.types.list_of_non_empty_strings_without_whitespace.deserialize_aws_json_1_1(
    ...
    if data.get("FormatVersion") is not None:
        ...
        out["format_version"] = (
            capo_firehose.types.orc_format_version.deserialize_aws_json_1_1(
                data["FormatVersion"]
            )
        )
    return out
