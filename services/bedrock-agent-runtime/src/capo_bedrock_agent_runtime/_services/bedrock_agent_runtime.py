...
from capo_bedrock_agent_runtime._services._aws_config import aws_config
...
class BedrockAgentRuntimeClient:
    ...
    def iter_list_flow_execution_events(
        self,
        flow_identifier: "capo_bedrock_agent_runtime.types.flow_identifier.FlowIdentifier",
        flow_alias_identifier: "capo_bedrock_agent_runtime.types.flow_alias_identifier.FlowAliasIdentifier",
        execution_identifier: "capo_bedrock_agent_runtime.types.flow_execution_identifier.FlowExecutionIdentifier",
    ...
    ) -> "Iterator[capo_bedrock_agent_runtime.types.flow_execution_event.FlowExecutionEvent]":
        _token = next_token
        while True:
            _response = self.list_flow_execution_events(
                flow_identifier,
    ...
    ) -> "Iterator[capo_bedrock_agent_runtime.types.flow_execution_summary.FlowExecutionSummary]":
        _token = next_token
        while True:
            _response = self.list_flow_executions(
                flow_identifier,
                config_overrides=config_overrides,
                flow_alias_identifier=flow_alias_identifier,
                max_results=max_results,
    ...
    ) -> "Iterator[capo_bedrock_agent_runtime.types.memory.Memory]":
        _token = next_token
        while True:
            _response = self.get_agent_memory(
                agent_id,
                agent_alias_id,
                memory_type,
                memory_id,
    ...
    ) -> "Iterator[capo_bedrock_agent_runtime.types.rerank_result.RerankResult]":
        _token = next_token
        while True:
            _response = self.rerank(
                queries,
                sources,
    ...
    ) -> "Iterator[capo_bedrock_agent_runtime.types.knowledge_base_retrieval_result.KnowledgeBaseRetrievalResult]":
        _token = next_token
        while True:
            _response = self.retrieve(
                knowledge_base_id,
                retrieval_query,
                config_overrides=config_overrides,
    ...
    ) -> "Iterator[capo_bedrock_agent_runtime.types.session_summary.SessionSummary]":
        _token = next_token
        while True:
    ...
    def create_invocation(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_agent_runtime.types.create_invocation_request.CreateInvocationRequest]",
        ) -> OperationResponse[
            "capo_bedrock_agent_runtime.types.create_invocation_response.CreateInvocationResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.create_invocation.create_invocation(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_invocations(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_agent_runtime.types.list_invocations_request.ListInvocationsRequest]",
        ) -> OperationResponse[
            "capo_bedrock_agent_runtime.types.list_invocations_response.ListInvocationsResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.list_invocations.list_invocations(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    ) -> "Iterator[capo_bedrock_agent_runtime.types.invocation_summary.InvocationSummary]":
        _token = next_token
        while True:
            _response = self.list_invocations(
                session_identifier,
                config_overrides=config_overrides,
                next_token=_token,
                max_results=max_results,
    ...
    def put_invocation_step(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_agent_runtime.types.put_invocation_step_request.PutInvocationStepRequest]",
        ) -> OperationResponse[
            "capo_bedrock_agent_runtime.types.put_invocation_step_response.PutInvocationStepResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.put_invocation_step.put_invocation_step(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def get_invocation_step(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_agent_runtime.types.get_invocation_step_request.GetInvocationStepRequest]",
        ) -> OperationResponse[
            "capo_bedrock_agent_runtime.types.get_invocation_step_response.GetInvocationStepResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.get_invocation_step.get_invocation_step(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def list_invocation_steps(
        ...
        *,
        ...
        def _handler(
            req: "OperationRequest[capo_bedrock_agent_runtime.types.list_invocation_steps_request.ListInvocationStepsRequest]",
        ) -> OperationResponse[
            "capo_bedrock_agent_runtime.types.list_invocation_steps_response.ListInvocationStepsResponse"
        ]:
            ...
            output, http_response = (
                capo_bedrock_agent_runtime._operations.amazon_bedrock_agent_run_time_service.list_invocation_steps.list_invocation_steps(
                    req.options, req.input
                )
            )
            return OperationResponse(output=output, response=http_response)
    ...
    def iter_list_invocation_steps(
        self,
        session_identifier: "capo_bedrock_agent_runtime.types.session_identifier.SessionIdentifier",
        *,
        config_overrides: Optional[BedrockAgentRuntimeClientConfig] = None,
    ...
    ) -> "Iterator[capo_bedrock_agent_runtime.types.invocation_step_summary.InvocationStepSummary]":
        _token = next_token
        while True:
            _response = self.list_invocation_steps(
                session_identifier,
                config_overrides=config_overrides,
                invocation_identifier=invocation_identifier,
                next_token=_token,
