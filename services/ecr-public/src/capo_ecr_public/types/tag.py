...
if TYPE_CHECKING:
    import capo_ecr_public.types.tag_key
    import capo_ecr_public.types.tag_value


class Tag(TypedDict, closed=True):
    key: NotRequired["capo_ecr_public.types.tag_key.TagKey"]
    ...
    value: NotRequired["capo_ecr_public.types.tag_value.TagValue"]
