...
if TYPE_CHECKING:
    ...
    import capo_ecr_public.types.marketplace_certified
    import capo_ecr_public.types.operating_system_list
    import capo_ecr_public.types.repository_description
    import capo_ecr_public.types.resource_url
    import capo_ecr_public.types.usage_text


class RepositoryCatalogData(TypedDict, closed=True):
    ...
    logo_url: NotRequired["capo_ecr_public.types.resource_url.ResourceUrl"]
    ...
    marketplace_certified: NotRequired[
        "capo_ecr_public.types.marketplace_certified.MarketplaceCertified"
    ]
