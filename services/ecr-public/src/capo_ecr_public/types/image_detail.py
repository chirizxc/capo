...
class ImageDetail(TypedDict, closed=True):
    ...
    image_tags: NotRequired["capo_ecr_public.types.image_tag_list.ImageTagList"]
...
def serialize_aws_json_1_1(value: ImageDetail) -> dict:
    ...
    if "image_tags" in value:
        ...
        out["imageTags"] = capo_ecr_public.types.image_tag_list.serialize_aws_json_1_1(
            value["image_tags"]
        )
...
def deserialize_aws_json_1_1(data: dict) -> ImageDetail:
    ...
    if data.get("imageTags") is not None:
        ...
        out["image_tags"] = (
            capo_ecr_public.types.image_tag_list.deserialize_aws_json_1_1(
                data["imageTags"]
            )
        )
