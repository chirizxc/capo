"""Generated from Smithy shape ``com.amazonaws.emrcontainers#ListManagedEndpoints``."""
...
def handle_response(
    ...
    out: capo_emr_containers.types.list_managed_endpoints_response.ListManagedEndpointsResponse = capo_emr_containers.types.list_managed_endpoints_response.deserialize_json(
...
def build_request(
    ...
    if "created_before" in input_:
        params.append(
            (
                "createdBefore",
                capo_emr_containers._protocol.serialize.fmt_date_time(
    ...
    if "states" in input_:
        for item in input_["states"]:
            params.append(
                (
                    "states",
                    capo_emr_containers.types.endpoint_state.serialize_json(item),
                )
            )
...
async def async_list_managed_endpoints(
