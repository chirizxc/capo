...
def build_request(
    ...
    if "container_provider_id" in input_:
        params.append(("containerProviderId", input_["container_provider_id"]))
    if "container_provider_type" in input_:
        params.append(
            (
                "containerProviderType",
                capo_emr_containers.types.container_provider_type.serialize_json(
                    input_["container_provider_type"]
                ),
            )
        )
    ...
    if "states" in input_:
        for item in input_["states"]:
            params.append(
                (
                    "states",
                    capo_emr_containers.types.virtual_cluster_state.serialize_json(
                        item
                    ),
                )
            )
    ...
    if "eks_access_entry_integrated" in input_:
        params.append(
            (
                ...
                "true" if input_["eks_access_entry_integrated"] else "false",
            )
        )
