...
def handle_response(
    ...
    out: capo_emr_containers.types.describe_managed_endpoint_response.DescribeManagedEndpointResponse = capo_emr_containers.types.describe_managed_endpoint_response.deserialize_json(
