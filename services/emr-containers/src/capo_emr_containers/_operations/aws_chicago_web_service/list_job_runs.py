...
def handle_response(
    ...
    out: capo_emr_containers.types.list_job_runs_response.ListJobRunsResponse = (
        capo_emr_containers.types.list_job_runs_response.deserialize_json(
...
def build_request(
    ...
    if "states" in input_:
        for item in input_["states"]:
            params.append(
                ("states", capo_emr_containers.types.job_run_state.serialize_json(item))
            )
