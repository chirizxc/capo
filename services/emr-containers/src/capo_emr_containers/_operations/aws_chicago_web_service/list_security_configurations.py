...
def handle_response(
    ...
    out: capo_emr_containers.types.list_security_configurations_response.ListSecurityConfigurationsResponse = capo_emr_containers.types.list_security_configurations_response.deserialize_json(
