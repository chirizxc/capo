"""Generated from Smithy shape ``com.amazonaws.emrcontainers#CreateSecurityConfiguration``."""
...
def handle_response(
    ...
    out: capo_emr_containers.types.create_security_configuration_response.CreateSecurityConfigurationResponse = capo_emr_containers.types.create_security_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr_containers.types.create_security_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
