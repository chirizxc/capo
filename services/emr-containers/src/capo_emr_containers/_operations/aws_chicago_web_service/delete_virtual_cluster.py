"""Generated from Smithy shape ``com.amazonaws.emrcontainers#DeleteVirtualCluster``."""
...
def handle_response(
    ...
    out: capo_emr_containers.types.delete_virtual_cluster_response.DeleteVirtualClusterResponse = capo_emr_containers.types.delete_virtual_cluster_response.deserialize_json(
...
async def async_delete_virtual_cluster(
