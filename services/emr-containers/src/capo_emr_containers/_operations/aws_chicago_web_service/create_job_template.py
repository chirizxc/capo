...
def handle_response(
    ...
    out: capo_emr_containers.types.create_job_template_response.CreateJobTemplateResponse = capo_emr_containers.types.create_job_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_emr_containers.types.create_job_template_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
