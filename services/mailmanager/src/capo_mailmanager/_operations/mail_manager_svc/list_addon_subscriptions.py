"""Generated from Smithy shape ``com.amazonaws.mailmanager#ListAddonSubscriptions``."""
...
def handle_response(
    ...
    out: capo_mailmanager.types.list_addon_subscriptions_response.ListAddonSubscriptionsResponse = capo_mailmanager.types.list_addon_subscriptions_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.ListAddonSubscriptions"
    body: bytes | None = json.dumps(
        capo_mailmanager.types.list_addon_subscriptions_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_addon_subscriptions(
