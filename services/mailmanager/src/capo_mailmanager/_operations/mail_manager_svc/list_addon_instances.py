"""Generated from Smithy shape ``com.amazonaws.mailmanager#ListAddonInstances``."""
...
def handle_response(
    ...
    out: capo_mailmanager.types.list_addon_instances_response.ListAddonInstancesResponse = capo_mailmanager.types.list_addon_instances_response.deserialize_aws_json_1_0(
...
def build_request(
    ...
    headers["X-Amz-Target"] = "MailManagerSvc.ListAddonInstances"
    body: bytes | None = json.dumps(
        capo_mailmanager.types.list_addon_instances_request.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_list_addon_instances(
