...
def handle_response(
    ...
    out: capo_amplify.types.get_job_result.GetJobResult = (
        capo_amplify.types.get_job_result.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_amplify.types.get_job_result.GetJobResult = (
        capo_amplify.types.get_job_result.deserialize_json(
...
def get_job(
    options: OperationOptions, input_: capo_amplify.types.get_job_request.GetJobRequest
) -> tuple[capo_amplify.types.get_job_result.GetJobResult, zapros.Response]:
