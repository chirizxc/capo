...
def handle_response(
    ...
    out: capo_amplify.types.list_artifacts_result.ListArtifactsResult = (
        capo_amplify.types.list_artifacts_result.deserialize_json(
...
def list_artifacts(
    ...
    capo_amplify.types.list_artifacts_result.ListArtifactsResult, zapros.Response
]:
