...
def handle_response(
    ...
    out: capo_amplify.types.create_deployment_result.CreateDeploymentResult = (
        capo_amplify.types.create_deployment_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.create_deployment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_deployment(
    ...
    capo_amplify.types.create_deployment_result.CreateDeploymentResult, zapros.Response
]:
