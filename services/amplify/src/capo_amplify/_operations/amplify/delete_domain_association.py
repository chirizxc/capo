"""Generated from Smithy shape ``com.amazonaws.amplify#DeleteDomainAssociation``."""
...
def handle_response(
    ...
    out: capo_amplify.types.delete_domain_association_result.DeleteDomainAssociationResult = capo_amplify.types.delete_domain_association_result.deserialize_json(
...
async def async_delete_domain_association(
