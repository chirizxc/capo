...
def handle_response(
    ...
    out: capo_amplify.types.list_backend_environments_result.ListBackendEnvironmentsResult = capo_amplify.types.list_backend_environments_result.deserialize_json(
...
def build_request(
    ...
    if "environment_name" in input_:
        params.append(("environmentName", input_["environment_name"]))
