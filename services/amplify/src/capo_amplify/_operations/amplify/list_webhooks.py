"""Generated from Smithy shape ``com.amazonaws.amplify#ListWebhooks``."""
...
def handle_response(
    ...
    out: capo_amplify.types.list_webhooks_result.ListWebhooksResult = (
        capo_amplify.types.list_webhooks_result.deserialize_json(
...
def list_webhooks(
    ...
    input_: capo_amplify.types.list_webhooks_request.ListWebhooksRequest,
) -> tuple[capo_amplify.types.list_webhooks_result.ListWebhooksResult, zapros.Response]:
