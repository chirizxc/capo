"""Generated from Smithy shape ``com.amazonaws.amplify#GetWebhook``."""
...
def handle_response(
    ...
    out: capo_amplify.types.get_webhook_result.GetWebhookResult = (
        capo_amplify.types.get_webhook_result.deserialize_json(
...
def get_webhook(
    ...
    input_: capo_amplify.types.get_webhook_request.GetWebhookRequest,
) -> tuple[capo_amplify.types.get_webhook_result.GetWebhookResult, zapros.Response]:
