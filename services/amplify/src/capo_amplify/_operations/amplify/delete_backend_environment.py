"""Generated from Smithy shape ``com.amazonaws.amplify#DeleteBackendEnvironment``."""
...
def handle_response(
    ...
    out: capo_amplify.types.delete_backend_environment_result.DeleteBackendEnvironmentResult = capo_amplify.types.delete_backend_environment_result.deserialize_json(
...
async def async_delete_backend_environment(
