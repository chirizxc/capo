...
def handle_response(
    ...
    out: capo_amplify.types.start_deployment_result.StartDeploymentResult = (
        capo_amplify.types.start_deployment_result.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_amplify.types.start_deployment_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def start_deployment(
    ...
    capo_amplify.types.start_deployment_result.StartDeploymentResult, zapros.Response
]:
