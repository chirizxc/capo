"""Generated from Smithy shape ``com.amazonaws.amplify#DeleteWebhook``."""
...
def handle_response(
    ...
    out: capo_amplify.types.delete_webhook_result.DeleteWebhookResult = (
        capo_amplify.types.delete_webhook_result.deserialize_json(
...
def delete_webhook(
    ...
    capo_amplify.types.delete_webhook_result.DeleteWebhookResult, zapros.Response
]:
