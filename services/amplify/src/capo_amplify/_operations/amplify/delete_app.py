"""Generated from Smithy shape ``com.amazonaws.amplify#DeleteApp``."""
...
def handle_response(
    ...
    out: capo_amplify.types.delete_app_result.DeleteAppResult = (
        capo_amplify.types.delete_app_result.deserialize_json(
...
def delete_app(
    ...
    input_: capo_amplify.types.delete_app_request.DeleteAppRequest,
) -> tuple[capo_amplify.types.delete_app_result.DeleteAppResult, zapros.Response]:
