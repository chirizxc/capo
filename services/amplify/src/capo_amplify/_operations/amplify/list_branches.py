"""Generated from Smithy shape ``com.amazonaws.amplify#ListBranches``."""
...
def handle_response(
    ...
    out: capo_amplify.types.list_branches_result.ListBranchesResult = (
        capo_amplify.types.list_branches_result.deserialize_json(
...
def list_branches(
    ...
    input_: capo_amplify.types.list_branches_request.ListBranchesRequest,
) -> tuple[capo_amplify.types.list_branches_result.ListBranchesResult, zapros.Response]:
