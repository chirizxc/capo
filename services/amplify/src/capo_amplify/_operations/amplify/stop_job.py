"""Generated from Smithy shape ``com.amazonaws.amplify#StopJob``."""
...
def handle_response(
    ...
    out: capo_amplify.types.stop_job_result.StopJobResult = (
        capo_amplify.types.stop_job_result.deserialize_json(json.loads(response.read()))
    )
    return out
...
async def async_handle_response(
    ...
    out: capo_amplify.types.stop_job_result.StopJobResult = (
        capo_amplify.types.stop_job_result.deserialize_json(
...
def stop_job(
    ...
    input_: capo_amplify.types.stop_job_request.StopJobRequest,
) -> tuple[capo_amplify.types.stop_job_result.StopJobResult, zapros.Response]:
