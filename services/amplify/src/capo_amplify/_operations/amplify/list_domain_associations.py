...
def handle_response(
    ...
    out: capo_amplify.types.list_domain_associations_result.ListDomainAssociationsResult = capo_amplify.types.list_domain_associations_result.deserialize_json(
