...
class HallucinationReductionConfiguration(TypedDict, closed=True):
    hallucination_reduction_control: NotRequired[
        "capo_qbusiness.types.hallucination_reduction_control.HallucinationReductionControl"
    ]
...
def serialize_json(value: HallucinationReductionConfiguration) -> dict:
    ...
    if "hallucination_reduction_control" in value:
        ...
        out["hallucinationReductionControl"] = (
            capo_qbusiness.types.hallucination_reduction_control.serialize_json(
...
def deserialize_json(data: dict) -> HallucinationReductionConfiguration:
    ...
    if data.get("hallucinationReductionControl") is not None:
        ...
        out["hallucination_reduction_control"] = (
            capo_qbusiness.types.hallucination_reduction_control.deserialize_json(
