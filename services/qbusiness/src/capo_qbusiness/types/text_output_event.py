...
class TextOutputEvent(TypedDict, closed=True):
    system_message_type: NotRequired[
        "capo_qbusiness.types.system_message_type.SystemMessageType"
    ]
...
def serialize_json(value: TextOutputEvent) -> dict:
    ...
    if "system_message_type" in value:
        ...
        out["systemMessageType"] = (
            capo_qbusiness.types.system_message_type.serialize_json(
...
def deserialize_json(data: dict) -> TextOutputEvent:
    ...
    if data.get("systemMessageType") is not None:
        ...
        out["system_message_type"] = (
            capo_qbusiness.types.system_message_type.deserialize_json(
