...
if TYPE_CHECKING:
    import capo_qbusiness.types.index_capacity_integer


class IndexCapacityConfiguration(TypedDict, closed=True):
    units: NotRequired[
        "capo_qbusiness.types.index_capacity_integer.IndexCapacityInteger"
    ]
