...
class TextSegment(TypedDict, closed=True):
    ...
    media_id: NotRequired[
        "capo_qbusiness.types.source_attribution_media_id.SourceAttributionMediaId"
    ]
    ...
    source_details: NotRequired["capo_qbusiness.types.source_details.SourceDetails"]
...
def serialize_json(value: TextSegment) -> dict:
    ...
    if "snippet_excerpt" in value:
        ...
        out["snippetExcerpt"] = capo_qbusiness.types.snippet_excerpt.serialize_json(
    ...
    if "source_details" in value:
        ...
        out["sourceDetails"] = capo_qbusiness.types.source_details.serialize_json(
