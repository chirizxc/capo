...
class RelevantContent(TypedDict, closed=True):
    content: NotRequired["capo_qbusiness.types.string.String"]
    """<p>The actual content of the relevant item.</p>"""
    document_id: NotRequired["capo_qbusiness.types.document_id.DocumentId"]
    """<p>The unique identifier of the document containing the relevant content.</p>"""
    document_title: NotRequired["capo_qbusiness.types.title.Title"]
    """<p>The title of the document containing the relevant content.</p>"""
    document_uri: NotRequired["capo_qbusiness.types.url.Url"]
    ...
    score_attributes: NotRequired[
        "capo_qbusiness.types.score_attributes.ScoreAttributes"
    ]
...
def serialize_json(value: RelevantContent) -> dict:
    ...
    if "document_attributes" in value:
        ...
        out["documentAttributes"] = (
            capo_qbusiness.types.document_attributes.serialize_json(
    ...
    if "score_attributes" in value:
        ...
        out["scoreAttributes"] = capo_qbusiness.types.score_attributes.serialize_json(
...
def deserialize_json(data: dict) -> RelevantContent:
    ...
    if data.get("documentAttributes") is not None:
        ...
        out["document_attributes"] = (
            capo_qbusiness.types.document_attributes.deserialize_json(
    ...
    if data.get("scoreAttributes") is not None:
        ...
        out["score_attributes"] = (
            capo_qbusiness.types.score_attributes.deserialize_json(
