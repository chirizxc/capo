...
class ListDocumentsResponse(TypedDict, closed=True):
    document_detail_list: NotRequired[
        "capo_qbusiness.types.document_detail_list.DocumentDetailList"
    ]
...
def serialize_json(value: ListDocumentsResponse) -> dict:
    ...
    if "document_detail_list" in value:
        ...
        out["documentDetailList"] = (
            capo_qbusiness.types.document_detail_list.serialize_json(
...
def deserialize_json(data: dict) -> ListDocumentsResponse:
    ...
    if data.get("documentDetailList") is not None:
        import capo_qbusiness.types.document_detail_list

        out["document_detail_list"] = (
            capo_qbusiness.types.document_detail_list.deserialize_json(
