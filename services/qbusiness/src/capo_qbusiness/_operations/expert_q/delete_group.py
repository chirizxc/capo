...
def handle_response(
    ...
    out: capo_qbusiness.types.delete_group_response.DeleteGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_group(
    ...
    capo_qbusiness.types.delete_group_response.DeleteGroupResponse, zapros.Response
]:
