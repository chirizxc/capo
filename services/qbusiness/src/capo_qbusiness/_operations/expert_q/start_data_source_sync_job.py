"""Generated from Smithy shape ``com.amazonaws.qbusiness#StartDataSourceSyncJob``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.start_data_source_sync_job_response.StartDataSourceSyncJobResponse = capo_qbusiness.types.start_data_source_sync_job_response.deserialize_json(
