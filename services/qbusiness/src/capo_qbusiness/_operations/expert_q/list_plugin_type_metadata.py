"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListPluginTypeMetadata``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_plugin_type_metadata_response.ListPluginTypeMetadataResponse = capo_qbusiness.types.list_plugin_type_metadata_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/pluginTypeMetadata"
...
async def async_list_plugin_type_metadata(
