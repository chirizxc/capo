...
def handle_response(
    ...
    out: capo_qbusiness.types.delete_plugin_response.DeletePluginResponse = {}  # type: ignore[typeddict-item]
    return out
...
def delete_plugin(
    ...
    capo_qbusiness.types.delete_plugin_response.DeletePluginResponse, zapros.Response
]:
