"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListSubscriptions``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_subscriptions_response.ListSubscriptionsResponse = (
        capo_qbusiness.types.list_subscriptions_response.deserialize_json(
