"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetDocumentContent``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_document_content_response.GetDocumentContentResponse = capo_qbusiness.types.get_document_content_response.deserialize_json(
...
def build_request(
    ...
    if "output_format" in input_:
        params.append(
            (
                "outputFormat",
                capo_qbusiness.types.output_format.serialize_json(
