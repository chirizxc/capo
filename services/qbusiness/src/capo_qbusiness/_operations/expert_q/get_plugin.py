...
def handle_response(
    ...
    out: capo_qbusiness.types.get_plugin_response.GetPluginResponse = (
        capo_qbusiness.types.get_plugin_response.deserialize_json(
...
def get_plugin(
    ...
    input_: capo_qbusiness.types.get_plugin_request.GetPluginRequest,
) -> tuple[capo_qbusiness.types.get_plugin_response.GetPluginResponse, zapros.Response]:
