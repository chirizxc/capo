...
def handle_response(
    ...
    out: capo_qbusiness.types.get_user_response.GetUserResponse = (
        capo_qbusiness.types.get_user_response.deserialize_json(
...
def get_user(
    ...
    input_: capo_qbusiness.types.get_user_request.GetUserRequest,
) -> tuple[capo_qbusiness.types.get_user_response.GetUserResponse, zapros.Response]:
