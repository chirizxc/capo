"""Generated from Smithy shape ``com.amazonaws.qbusiness#BatchDeleteDocument``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.batch_delete_document_response.BatchDeleteDocumentResponse = capo_qbusiness.types.batch_delete_document_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.batch_delete_document_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
