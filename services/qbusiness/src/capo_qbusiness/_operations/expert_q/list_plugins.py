"""Generated from Smithy shape ``com.amazonaws.qbusiness#ListPlugins``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_plugins_response.ListPluginsResponse = (
        capo_qbusiness.types.list_plugins_response.deserialize_json(
...
def list_plugins(
    ...
    capo_qbusiness.types.list_plugins_response.ListPluginsResponse, zapros.Response
]:
