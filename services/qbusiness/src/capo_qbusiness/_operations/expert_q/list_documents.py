...
import capo_qbusiness.types.document_detail_list
...
def handle_response(
    ...
    out: capo_qbusiness.types.list_documents_response.ListDocumentsResponse = (
        capo_qbusiness.types.list_documents_response.deserialize_json(
...
def build_request(
    ...
    if "data_source_ids" in input_:
        for item in input_["data_source_ids"]:
            params.append(("dataSourceIds", item))
...
def list_documents(
    ...
    capo_qbusiness.types.list_documents_response.ListDocumentsResponse, zapros.Response
]:
