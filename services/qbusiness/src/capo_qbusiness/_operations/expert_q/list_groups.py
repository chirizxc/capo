...
def handle_response(
    ...
    out: capo_qbusiness.types.list_groups_response.ListGroupsResponse = (
        capo_qbusiness.types.list_groups_response.deserialize_json(
...
def build_request(
    ...
    import capo_qbusiness._protocol.serialize
    ...
    if "updated_earlier_than" in input_:
        params.append(
            (
                "updatedEarlierThan",
                capo_qbusiness._protocol.serialize.fmt_date_time(
                    input_["updated_earlier_than"]
                ),
            )
        )
...
def list_groups(
    ...
    capo_qbusiness.types.list_groups_response.ListGroupsResponse, zapros.Response
]:
