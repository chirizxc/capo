...
def handle_response(
    ...
    out: capo_qbusiness.types.create_web_experience_response.CreateWebExperienceResponse = capo_qbusiness.types.create_web_experience_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_web_experience_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
