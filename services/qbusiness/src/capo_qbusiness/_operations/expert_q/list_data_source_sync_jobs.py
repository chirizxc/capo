...
def build_request(
    ...
    if "start_time" in input_:
        params.append(
            (
                "startTime",
                capo_qbusiness._protocol.serialize.fmt_date_time(input_["start_time"]),
            )
        )
    if "end_time" in input_:
        params.append(
            (
                "endTime",
                capo_qbusiness._protocol.serialize.fmt_date_time(input_["end_time"]),
            )
        )
    if "status_filter" in input_:
        params.append(
            (
                "syncStatus",
                capo_qbusiness.types.data_source_sync_job_status.serialize_json(
                    input_["status_filter"]
                ),
            )
        )
