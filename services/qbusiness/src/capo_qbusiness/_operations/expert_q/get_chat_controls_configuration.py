"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetChatControlsConfiguration``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_chat_controls_configuration_response.GetChatControlsConfigurationResponse = capo_qbusiness.types.get_chat_controls_configuration_response.deserialize_json(
...
async def async_get_chat_controls_configuration(
