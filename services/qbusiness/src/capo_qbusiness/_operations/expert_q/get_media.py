...
import capo_qbusiness.errors.media_too_large_exception
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "MediaTooLargeException":
            raise capo_qbusiness.errors.media_too_large_exception.MediaTooLargeException.from_json(
                data, message
            )
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_media_response.GetMediaResponse = (
        capo_qbusiness.types.get_media_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{conversationId}", quote(input_["conversation_id"], safe=""))
    url = url.replace("{messageId}", quote(input_["message_id"], safe=""))
    url = url.replace("{mediaId}", quote(input_["media_id"], safe=""))
...
def get_media(
    ...
    input_: capo_qbusiness.types.get_media_request.GetMediaRequest,
) -> tuple[capo_qbusiness.types.get_media_response.GetMediaResponse, zapros.Response]:
