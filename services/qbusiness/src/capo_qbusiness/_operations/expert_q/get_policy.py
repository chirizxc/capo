"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetPolicy``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_policy_response.GetPolicyResponse = (
        capo_qbusiness.types.get_policy_response.deserialize_json(
...
def get_policy(
    ...
    input_: capo_qbusiness.types.get_policy_request.GetPolicyRequest,
) -> tuple[capo_qbusiness.types.get_policy_response.GetPolicyResponse, zapros.Response]:
