"""Generated from Smithy shape ``com.amazonaws.qbusiness#DisassociatePermission``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.disassociate_permission_response.DisassociatePermissionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = (
        endpoint.url.rstrip("/") + "/applications/{applicationId}/policy/{statementId}"
    )
...
async def async_disassociate_permission(
