"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreateRetriever``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.create_retriever_response.CreateRetrieverResponse = (
        capo_qbusiness.types.create_retriever_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_retriever_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_retriever(
