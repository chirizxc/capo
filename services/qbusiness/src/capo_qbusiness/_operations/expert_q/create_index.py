"""Generated from Smithy shape ``com.amazonaws.qbusiness#CreateIndex``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.create_index_response.CreateIndexResponse = (
        capo_qbusiness.types.create_index_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_qbusiness.types.create_index_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_index(
    ...
    capo_qbusiness.types.create_index_response.CreateIndexResponse, zapros.Response
]:
