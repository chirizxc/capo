"""Generated from Smithy shape ``com.amazonaws.qbusiness#GetApplication``."""
...
def handle_response(
    ...
    out: capo_qbusiness.types.get_application_response.GetApplicationResponse = (
        capo_qbusiness.types.get_application_response.deserialize_json(
