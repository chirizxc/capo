...
import capo_connect.types.describe_instance_attribute_request
import capo_connect.types.describe_instance_attribute_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_instance_attribute_response.DescribeInstanceAttributeResponse = capo_connect.types.describe_instance_attribute_response.deserialize_json(
