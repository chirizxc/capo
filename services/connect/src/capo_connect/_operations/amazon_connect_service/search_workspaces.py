...
import capo_connect.types.search_workspaces_request
import capo_connect.types.search_workspaces_response
...
def handle_response(
    ...
    out: capo_connect.types.search_workspaces_response.SearchWorkspacesResponse = (
        capo_connect.types.search_workspaces_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_workspaces_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
