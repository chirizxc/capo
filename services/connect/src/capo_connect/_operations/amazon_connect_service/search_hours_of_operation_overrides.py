...
import capo_connect.types.search_hours_of_operation_overrides_request
...
) -> capo_connect.types.search_hours_of_operation_overrides_response.SearchHoursOfOperationOverridesResponse:
    out: capo_connect.types.search_hours_of_operation_overrides_response.SearchHoursOfOperationOverridesResponse = capo_connect.types.search_hours_of_operation_overrides_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_hours_of_operation_overrides_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
