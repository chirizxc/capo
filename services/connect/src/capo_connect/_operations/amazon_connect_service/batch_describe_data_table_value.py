"""Generated from Smithy shape ``com.amazonaws.connect#BatchDescribeDataTableValue``."""
...
import capo_connect.types.batch_describe_data_table_value_request
import capo_connect.types.batch_describe_data_table_value_response
...
def handle_response(
    ...
    out: capo_connect.types.batch_describe_data_table_value_response.BatchDescribeDataTableValueResponse = capo_connect.types.batch_describe_data_table_value_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.batch_describe_data_table_value_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_batch_describe_data_table_value(
