...
import capo_connect.types.list_quick_connects_request
import capo_connect.types.list_quick_connects_response
import capo_connect.types.quick_connect_summary_list
import capo_connect.types.quick_connect_types
...
def handle_response(
    ...
    out: capo_connect.types.list_quick_connects_response.ListQuickConnectsResponse = (
        capo_connect.types.list_quick_connects_response.deserialize_json(
...
def build_request(
    ...
    if "quick_connect_types" in input_:
        for item in input_["quick_connect_types"]:
            params.append(
                (
                    "QuickConnectTypes",
                    capo_connect.types.quick_connect_type.serialize_json(item),
                )
            )
