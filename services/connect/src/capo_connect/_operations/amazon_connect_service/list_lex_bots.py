"""Generated from Smithy shape ``com.amazonaws.connect#ListLexBots``."""
...
def handle_response(
    ...
    out: capo_connect.types.list_lex_bots_response.ListLexBotsResponse = (
        capo_connect.types.list_lex_bots_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/lex-bots"
...
def list_lex_bots(
    ...
    capo_connect.types.list_lex_bots_response.ListLexBotsResponse, zapros.Response
]:
