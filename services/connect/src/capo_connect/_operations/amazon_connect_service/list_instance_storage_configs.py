"""Generated from Smithy shape ``com.amazonaws.connect#ListInstanceStorageConfigs``."""
...
import capo_connect.types.list_instance_storage_configs_request
import capo_connect.types.list_instance_storage_configs_response
...
def handle_response(
    ...
    out: capo_connect.types.list_instance_storage_configs_response.ListInstanceStorageConfigsResponse = capo_connect.types.list_instance_storage_configs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/storage-configs"
...
async def async_list_instance_storage_configs(
