...
import capo_connect.types.search_contact_evaluations_request
import capo_connect.types.search_contact_evaluations_response
...
def handle_response(
    ...
    out: capo_connect.types.search_contact_evaluations_response.SearchContactEvaluationsResponse = capo_connect.types.search_contact_evaluations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_contact_evaluations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
