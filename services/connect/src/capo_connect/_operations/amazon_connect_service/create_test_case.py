...
import capo_connect.errors.invalid_test_case_exception
...
import capo_connect.types.create_test_case_request
import capo_connect.types.create_test_case_response
...
def handle_error(response: zapros.Response) -> Never:
    ...
    match code:
        ...
        case "InvalidTestCaseException":
            raise capo_connect.errors.invalid_test_case_exception.InvalidTestCaseException.from_json(
                data, message
            )
...
) -> capo_connect.types.create_test_case_response.CreateTestCaseResponse:
    out: capo_connect.types.create_test_case_response.CreateTestCaseResponse = (
        capo_connect.types.create_test_case_response.deserialize_json(
...
def build_request(
    ...
    import capo_connect._protocol.serialize
    ...
    if "test_case_id" in input_:
        headers["x-amz-resource-id"] = input_["test_case_id"]
    if "last_modified_time" in input_:
        headers["x-amz-last-modified-time"] = (
            capo_connect._protocol.serialize.fmt_http_date(input_["last_modified_time"])
        )
    if "last_modified_region" in input_:
        headers["x-amz-last-modified-region"] = input_["last_modified_region"]
    body: bytes | None = json.dumps(
        capo_connect.types.create_test_case_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_test_case(
    ...
    capo_connect.types.create_test_case_response.CreateTestCaseResponse, zapros.Response
]:
