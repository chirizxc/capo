"""Generated from Smithy shape ``com.amazonaws.connect#ListApprovedOrigins``."""
...
import capo_connect.types.list_approved_origins_request
import capo_connect.types.list_approved_origins_response
...
def handle_response(
    ...
    out: capo_connect.types.list_approved_origins_response.ListApprovedOriginsResponse = capo_connect.types.list_approved_origins_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/approved-origins"
...
async def async_list_approved_origins(
