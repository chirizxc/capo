...
def handle_response(
    ...
    out: capo_connect.types.monitor_contact_response.MonitorContactResponse = (
        capo_connect.types.monitor_contact_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.monitor_contact_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def monitor_contact(
    ...
    capo_connect.types.monitor_contact_response.MonitorContactResponse, zapros.Response
]:
