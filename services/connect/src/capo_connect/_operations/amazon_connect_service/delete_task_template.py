"""Generated from Smithy shape ``com.amazonaws.connect#DeleteTaskTemplate``."""
...
def handle_response(
    ...
    out: capo_connect.types.delete_task_template_response.DeleteTaskTemplateResponse = {}  # type: ignore[typeddict-item]
    return out
