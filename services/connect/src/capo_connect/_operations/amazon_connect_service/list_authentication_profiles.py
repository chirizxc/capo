...
import capo_connect.types.list_authentication_profiles_request
import capo_connect.types.list_authentication_profiles_response
...
def handle_response(
    ...
    out: capo_connect.types.list_authentication_profiles_response.ListAuthenticationProfilesResponse = capo_connect.types.list_authentication_profiles_response.deserialize_json(
