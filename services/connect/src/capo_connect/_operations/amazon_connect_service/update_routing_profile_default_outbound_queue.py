...
import capo_connect.types.update_routing_profile_default_outbound_queue_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_routing_profile_default_outbound_queue_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
