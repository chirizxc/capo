"""Generated from Smithy shape ``com.amazonaws.connect#DeleteQuickConnect``."""
...
import capo_connect.types.delete_quick_connect_request
...
async def async_delete_quick_connect(
