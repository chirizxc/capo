"""Generated from Smithy shape ``com.amazonaws.connect#DeleteContactFlow``."""
...
import capo_connect.types.delete_contact_flow_request
import capo_connect.types.delete_contact_flow_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_contact_flow_response.DeleteContactFlowResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_contact_flow(
