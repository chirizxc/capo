...
import capo_connect.types.describe_traffic_distribution_group_request
import capo_connect.types.describe_traffic_distribution_group_response
...
) -> capo_connect.types.describe_traffic_distribution_group_response.DescribeTrafficDistributionGroupResponse:
    out: capo_connect.types.describe_traffic_distribution_group_response.DescribeTrafficDistributionGroupResponse = capo_connect.types.describe_traffic_distribution_group_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(input_["traffic_distribution_group_id"], safe=""),
    )
