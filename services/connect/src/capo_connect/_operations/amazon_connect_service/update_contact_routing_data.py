...
import capo_connect.types.update_contact_routing_data_request
...
def handle_response(
    ...
    out: capo_connect.types.update_contact_routing_data_response.UpdateContactRoutingDataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_contact_routing_data_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
