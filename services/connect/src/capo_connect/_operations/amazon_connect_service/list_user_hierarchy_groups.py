...
import capo_connect.types.list_user_hierarchy_groups_request
import capo_connect.types.list_user_hierarchy_groups_response
...
def handle_response(
    ...
    out: capo_connect.types.list_user_hierarchy_groups_response.ListUserHierarchyGroupsResponse = capo_connect.types.list_user_hierarchy_groups_response.deserialize_json(
