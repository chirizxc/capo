"""Generated from Smithy shape ``com.amazonaws.connect#UpdateUserHierarchyStructure``."""
...
import capo_connect.types.update_user_hierarchy_structure_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_user_hierarchy_structure_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_user_hierarchy_structure(
