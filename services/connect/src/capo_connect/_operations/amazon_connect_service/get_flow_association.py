...
import capo_connect.types.get_flow_association_response
...
def handle_response(
    ...
    out: capo_connect.types.get_flow_association_response.GetFlowAssociationResponse = (
        capo_connect.types.get_flow_association_response.deserialize_json(
