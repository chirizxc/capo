"""Generated from Smithy shape ``com.amazonaws.connect#CreateAgentStatus``."""
...
def handle_response(
    ...
    out: capo_connect.types.create_agent_status_response.CreateAgentStatusResponse = (
        capo_connect.types.create_agent_status_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_agent_status_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_agent_status(
