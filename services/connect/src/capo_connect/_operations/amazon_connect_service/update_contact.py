"""Generated from Smithy shape ``com.amazonaws.connect#UpdateContact``."""
...
import capo_connect.types.update_contact_request
import capo_connect.types.update_contact_response
...
def handle_response(
    ...
    out: capo_connect.types.update_contact_response.UpdateContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_contact_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_contact(
    ...
    capo_connect.types.update_contact_response.UpdateContactResponse, zapros.Response
]:
