"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateLexBot``."""
...
import capo_connect.types.disassociate_lex_bot_request
...
def build_request(
    ...
    if "bot_name" in input_:
        params.append(("botName", input_["bot_name"]))
    if "lex_region" in input_:
        params.append(("lexRegion", input_["lex_region"]))
...
async def async_disassociate_lex_bot(
