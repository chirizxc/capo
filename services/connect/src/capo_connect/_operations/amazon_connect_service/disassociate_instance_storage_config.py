"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateInstanceStorageConfig``."""
...
import capo_connect.types.disassociate_instance_storage_config_request
...
async def async_disassociate_instance_storage_config(
