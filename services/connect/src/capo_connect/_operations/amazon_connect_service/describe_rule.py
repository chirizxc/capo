...
import capo_connect.types.describe_rule_request
import capo_connect.types.describe_rule_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_rule_response.DescribeRuleResponse = (
        capo_connect.types.describe_rule_response.deserialize_json(
...
def describe_rule(
    ...
    capo_connect.types.describe_rule_response.DescribeRuleResponse, zapros.Response
]:
