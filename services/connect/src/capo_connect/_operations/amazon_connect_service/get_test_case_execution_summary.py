"""Generated from Smithy shape ``com.amazonaws.connect#GetTestCaseExecutionSummary``."""
...
import capo_connect.types.get_test_case_execution_summary_request
import capo_connect.types.get_test_case_execution_summary_response
...
) -> capo_connect.types.get_test_case_execution_summary_response.GetTestCaseExecutionSummaryResponse:
    out: capo_connect.types.get_test_case_execution_summary_response.GetTestCaseExecutionSummaryResponse = capo_connect.types.get_test_case_execution_summary_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{TestCaseExecutionId}", quote(input_["test_case_execution_id"], safe="")
    )
...
async def async_get_test_case_execution_summary(
