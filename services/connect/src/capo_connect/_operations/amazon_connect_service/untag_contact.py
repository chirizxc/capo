"""Generated from Smithy shape ``com.amazonaws.connect#UntagContact``."""
...
def handle_response(
    ...
    out: capo_connect.types.untag_contact_response.UntagContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/contact/tags/{InstanceId}/{ContactId}"
...
def untag_contact(
    ...
    capo_connect.types.untag_contact_response.UntagContactResponse, zapros.Response
]:
