...
import capo_connect.types.contacts
import capo_connect.types.search_contacts_request
import capo_connect.types.search_contacts_response
...
) -> capo_connect.types.search_contacts_response.SearchContactsResponse:
    out: capo_connect.types.search_contacts_response.SearchContactsResponse = (
        capo_connect.types.search_contacts_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_contacts_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def search_contacts(
    ...
    capo_connect.types.search_contacts_response.SearchContactsResponse, zapros.Response
]:
