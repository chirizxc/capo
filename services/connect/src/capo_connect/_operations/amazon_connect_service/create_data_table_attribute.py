"""Generated from Smithy shape ``com.amazonaws.connect#CreateDataTableAttribute``."""
...
import capo_connect.types.create_data_table_attribute_request
import capo_connect.types.create_data_table_attribute_response
...
) -> capo_connect.types.create_data_table_attribute_response.CreateDataTableAttributeResponse:
    out: capo_connect.types.create_data_table_attribute_response.CreateDataTableAttributeResponse = capo_connect.types.create_data_table_attribute_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_data_table_attribute_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_create_data_table_attribute(
