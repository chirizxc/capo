"""Generated from Smithy shape ``com.amazonaws.connect#DeleteEvaluationForm``."""
...
def build_request(
    ...
    if "evaluation_form_version" in input_:
        params.append(("version", str(input_["evaluation_form_version"])))
...
async def async_delete_evaluation_form(
