...
import capo_connect.types.describe_contact_flow_module_request
import capo_connect.types.describe_contact_flow_module_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_contact_flow_module_response.DescribeContactFlowModuleResponse = capo_connect.types.describe_contact_flow_module_response.deserialize_json(
