"""Generated from Smithy shape ``com.amazonaws.connect#DescribeAttachedFilesConfiguration``."""
...
import capo_connect.types.describe_attached_files_configuration_request
import capo_connect.types.describe_attached_files_configuration_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_attached_files_configuration_response.DescribeAttachedFilesConfigurationResponse = capo_connect.types.describe_attached_files_configuration_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{AttachmentScope}",
        quote(
            capo_connect.types.attachment_scope.serialize_json(
                input_["attachment_scope"]
            ),
            safe="",
        ),
    )
...
async def async_describe_attached_files_configuration(
