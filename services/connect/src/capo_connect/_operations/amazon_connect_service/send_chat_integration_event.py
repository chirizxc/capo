...
import capo_connect.types.send_chat_integration_event_request
...
def handle_response(
    ...
    out: capo_connect.types.send_chat_integration_event_response.SendChatIntegrationEventResponse = capo_connect.types.send_chat_integration_event_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.send_chat_integration_event_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
