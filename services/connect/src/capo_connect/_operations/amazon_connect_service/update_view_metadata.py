...
import capo_connect.types.update_view_metadata_request
import capo_connect.types.update_view_metadata_response
...
) -> capo_connect.types.update_view_metadata_response.UpdateViewMetadataResponse:
    out: capo_connect.types.update_view_metadata_response.UpdateViewMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_view_metadata_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
