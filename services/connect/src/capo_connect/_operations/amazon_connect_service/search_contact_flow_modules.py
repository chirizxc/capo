...
import capo_connect.types.search_contact_flow_modules_request
import capo_connect.types.search_contact_flow_modules_response
...
def handle_response(
    ...
    out: capo_connect.types.search_contact_flow_modules_response.SearchContactFlowModulesResponse = capo_connect.types.search_contact_flow_modules_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_contact_flow_modules_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
