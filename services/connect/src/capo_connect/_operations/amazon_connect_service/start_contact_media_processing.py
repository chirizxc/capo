...
import capo_connect.types.start_contact_media_processing_response
...
def handle_response(
    ...
    out: capo_connect.types.start_contact_media_processing_response.StartContactMediaProcessingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_contact_media_processing_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
