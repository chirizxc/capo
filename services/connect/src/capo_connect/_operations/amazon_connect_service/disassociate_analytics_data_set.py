"""Generated from Smithy shape ``com.amazonaws.connect#DisassociateAnalyticsDataSet``."""
...
import capo_connect.types.disassociate_analytics_data_set_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.disassociate_analytics_data_set_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_disassociate_analytics_data_set(
