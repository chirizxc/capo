"""Generated from Smithy shape ``com.amazonaws.connect#StartAttachedFileUpload``."""
...
def handle_response(
    ...
    out: capo_connect.types.start_attached_file_upload_response.StartAttachedFileUploadResponse = capo_connect.types.start_attached_file_upload_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_attached_file_upload_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_start_attached_file_upload(
