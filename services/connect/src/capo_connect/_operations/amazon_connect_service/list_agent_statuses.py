...
import capo_connect.types.list_agent_status_request
import capo_connect.types.list_agent_status_response
...
def handle_response(
    ...
    out: capo_connect.types.list_agent_status_response.ListAgentStatusResponse = (
        capo_connect.types.list_agent_status_response.deserialize_json(
...
def build_request(
    ...
    if "agent_status_types" in input_:
        for item in input_["agent_status_types"]:
            params.append(
                (
                    "AgentStatusTypes",
                    capo_connect.types.agent_status_type.serialize_json(item),
                )
            )
