...
def handle_response(
    ...
    out: capo_connect.types.start_contact_evaluation_response.StartContactEvaluationResponse = capo_connect.types.start_contact_evaluation_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_contact_evaluation_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
