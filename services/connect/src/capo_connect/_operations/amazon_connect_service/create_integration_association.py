"""Generated from Smithy shape ``com.amazonaws.connect#CreateIntegrationAssociation``."""
...
def handle_response(
    ...
    out: capo_connect.types.create_integration_association_response.CreateIntegrationAssociationResponse = capo_connect.types.create_integration_association_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_integration_association_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_integration_association(
