"""Generated from Smithy shape ``com.amazonaws.connect#CreateContact``."""
...
import capo_connect.types.create_contact_request
import capo_connect.types.create_contact_response
...
def handle_response(
    ...
    out: capo_connect.types.create_contact_response.CreateContactResponse = (
        capo_connect.types.create_contact_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/contact/create-contact"
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.create_contact_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_contact(
    ...
    capo_connect.types.create_contact_response.CreateContactResponse, zapros.Response
]:
