...
import capo_connect.types.update_test_case_request
import capo_connect.types.update_test_case_response
...
) -> capo_connect.types.update_test_case_response.UpdateTestCaseResponse:
    out: capo_connect.types.update_test_case_response.UpdateTestCaseResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_test_case_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def update_test_case(
    ...
    capo_connect.types.update_test_case_response.UpdateTestCaseResponse, zapros.Response
]:
