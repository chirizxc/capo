...
import capo_connect.types.search_workspace_associations_request
import capo_connect.types.search_workspace_associations_response
...
def handle_response(
    ...
    out: capo_connect.types.search_workspace_associations_response.SearchWorkspaceAssociationsResponse = capo_connect.types.search_workspace_associations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_workspace_associations_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
