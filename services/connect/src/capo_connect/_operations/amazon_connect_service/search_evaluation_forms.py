...
import capo_connect.types.search_evaluation_forms_request
import capo_connect.types.search_evaluation_forms_response
...
def handle_response(
    ...
    out: capo_connect.types.search_evaluation_forms_response.SearchEvaluationFormsResponse = capo_connect.types.search_evaluation_forms_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_evaluation_forms_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
