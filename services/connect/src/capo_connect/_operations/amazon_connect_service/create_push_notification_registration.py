...
import capo_connect.types.create_push_notification_registration_request
import capo_connect.types.create_push_notification_registration_response
...
def handle_response(
    ...
    out: capo_connect.types.create_push_notification_registration_response.CreatePushNotificationRegistrationResponse = capo_connect.types.create_push_notification_registration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_push_notification_registration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
