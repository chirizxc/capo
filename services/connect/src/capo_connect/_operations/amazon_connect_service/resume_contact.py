...
import capo_connect.types.resume_contact_request
import capo_connect.types.resume_contact_response
...
) -> capo_connect.types.resume_contact_response.ResumeContactResponse:
    out: capo_connect.types.resume_contact_response.ResumeContactResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.resume_contact_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def resume_contact(
    ...
    capo_connect.types.resume_contact_response.ResumeContactResponse, zapros.Response
]:
