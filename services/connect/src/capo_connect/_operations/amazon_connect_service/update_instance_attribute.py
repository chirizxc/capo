"""Generated from Smithy shape ``com.amazonaws.connect#UpdateInstanceAttribute``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_instance_attribute_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_instance_attribute(
