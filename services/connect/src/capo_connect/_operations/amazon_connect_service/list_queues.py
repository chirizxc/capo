...
import capo_connect.types.list_queues_request
import capo_connect.types.list_queues_response
...
def handle_response(
    ...
    out: capo_connect.types.list_queues_response.ListQueuesResponse = (
        capo_connect.types.list_queues_response.deserialize_json(
...
def build_request(
    ...
    if "queue_types" in input_:
        for item in input_["queue_types"]:
            params.append(
                ("queueTypes", capo_connect.types.queue_type.serialize_json(item))
            )
...
def list_queues(
    ...
    input_: capo_connect.types.list_queues_request.ListQueuesRequest,
) -> tuple[capo_connect.types.list_queues_response.ListQueuesResponse, zapros.Response]:
