"""Generated from Smithy shape ``com.amazonaws.connect#StopTestCaseExecution``."""
...
import capo_connect.types.stop_test_case_execution_request
import capo_connect.types.stop_test_case_execution_response
...
def handle_response(
    ...
    out: capo_connect.types.stop_test_case_execution_response.StopTestCaseExecutionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.stop_test_case_execution_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_stop_test_case_execution(
