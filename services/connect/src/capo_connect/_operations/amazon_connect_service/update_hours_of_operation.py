"""Generated from Smithy shape ``com.amazonaws.connect#UpdateHoursOfOperation``."""
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_hours_of_operation_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_hours_of_operation(
