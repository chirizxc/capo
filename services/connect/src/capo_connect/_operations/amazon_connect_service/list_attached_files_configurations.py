...
import capo_connect.types.list_attached_files_configurations_request
import capo_connect.types.list_attached_files_configurations_response
...
def handle_response(
    ...
    out: capo_connect.types.list_attached_files_configurations_response.ListAttachedFilesConfigurationsResponse = capo_connect.types.list_attached_files_configurations_response.deserialize_json(
