...
def handle_response(
    ...
    out: capo_connect.types.create_evaluation_form_response.CreateEvaluationFormResponse = capo_connect.types.create_evaluation_form_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_evaluation_form_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
