"""Generated from Smithy shape ``com.amazonaws.connect#ListWorkspaceMedia``."""
...
import capo_connect.types.list_workspace_media_request
import capo_connect.types.list_workspace_media_response
...
def handle_response(
    ...
    out: capo_connect.types.list_workspace_media_response.ListWorkspaceMediaResponse = (
        capo_connect.types.list_workspace_media_response.deserialize_json(
...
async def async_list_workspace_media(
