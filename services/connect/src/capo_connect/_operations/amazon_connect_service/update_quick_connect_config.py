"""Generated from Smithy shape ``com.amazonaws.connect#UpdateQuickConnectConfig``."""
...
import capo_connect.types.update_quick_connect_config_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_quick_connect_config_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_quick_connect_config(
