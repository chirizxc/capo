"""Generated from Smithy shape ``com.amazonaws.connect#ListBots``."""
...
import capo_connect.types.list_bots_request
import capo_connect.types.list_bots_response
...
def handle_response(
    ...
    out: capo_connect.types.list_bots_response.ListBotsResponse = (
        capo_connect.types.list_bots_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/bots"
    ...
    if "lex_version" in input_:
        params.append(
            (
                "lexVersion",
                capo_connect.types.lex_version.serialize_json(input_["lex_version"]),
            )
        )
...
def list_bots(
    ...
    input_: capo_connect.types.list_bots_request.ListBotsRequest,
) -> tuple[capo_connect.types.list_bots_response.ListBotsResponse, zapros.Response]:
