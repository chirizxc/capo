...
import capo_connect.types.create_user_request
import capo_connect.types.create_user_response
...
def handle_response(
    ...
    out: capo_connect.types.create_user_response.CreateUserResponse = (
        capo_connect.types.create_user_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_user_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_user(
    ...
    input_: capo_connect.types.create_user_request.CreateUserRequest,
) -> tuple[capo_connect.types.create_user_response.CreateUserResponse, zapros.Response]:
