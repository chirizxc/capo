...
import capo_connect.types.complete_attached_file_upload_request
import capo_connect.types.complete_attached_file_upload_response
...
def handle_response(
    ...
    out: capo_connect.types.complete_attached_file_upload_response.CompleteAttachedFileUploadResponse = {}  # type: ignore[typeddict-item]
    return out
