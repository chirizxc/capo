...
import capo_connect.types.list_user_notifications_request
import capo_connect.types.list_user_notifications_response
...
def handle_response(
    ...
    out: capo_connect.types.list_user_notifications_response.ListUserNotificationsResponse = capo_connect.types.list_user_notifications_response.deserialize_json(
