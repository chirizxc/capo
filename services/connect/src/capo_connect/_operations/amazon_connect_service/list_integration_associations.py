"""Generated from Smithy shape ``com.amazonaws.connect#ListIntegrationAssociations``."""
...
import capo_connect.types.list_integration_associations_request
import capo_connect.types.list_integration_associations_response
...
def handle_response(
    ...
    out: capo_connect.types.list_integration_associations_response.ListIntegrationAssociationsResponse = capo_connect.types.list_integration_associations_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/integration-associations"
    url = url.replace("{InstanceId}", quote(input_["instance_id"], safe=""))
    params: list[tuple[str, str]] = []
    if "integration_type" in input_:
        params.append(
            (
                "integrationType",
                capo_connect.types.integration_type.serialize_json(
                    input_["integration_type"]
                ),
            )
        )
    ...
    if "integration_arn" in input_:
        params.append(("integrationArn", input_["integration_arn"]))
...
async def async_list_integration_associations(
