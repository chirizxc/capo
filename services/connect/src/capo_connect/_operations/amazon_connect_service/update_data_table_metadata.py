"""Generated from Smithy shape ``com.amazonaws.connect#UpdateDataTableMetadata``."""
...
import capo_connect.types.update_data_table_metadata_response
...
) -> capo_connect.types.update_data_table_metadata_response.UpdateDataTableMetadataResponse:
    out: capo_connect.types.update_data_table_metadata_response.UpdateDataTableMetadataResponse = capo_connect.types.update_data_table_metadata_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_data_table_metadata_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_data_table_metadata(
