"""Generated from Smithy shape ``com.amazonaws.connect#DescribePredefinedAttribute``."""
...
import capo_connect.types.describe_predefined_attribute_request
import capo_connect.types.describe_predefined_attribute_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_predefined_attribute_response.DescribePredefinedAttributeResponse = capo_connect.types.describe_predefined_attribute_response.deserialize_json(
...
async def async_describe_predefined_attribute(
