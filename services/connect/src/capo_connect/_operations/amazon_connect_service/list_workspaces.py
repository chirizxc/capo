...
import capo_connect.types.list_workspaces_request
import capo_connect.types.list_workspaces_response
import capo_connect.types.workspace_summary_list
...
def handle_response(
    ...
    out: capo_connect.types.list_workspaces_response.ListWorkspacesResponse = (
        capo_connect.types.list_workspaces_response.deserialize_json(
...
def list_workspaces(
    ...
    capo_connect.types.list_workspaces_response.ListWorkspacesResponse, zapros.Response
]:
