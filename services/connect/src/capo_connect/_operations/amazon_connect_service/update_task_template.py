"""Generated from Smithy shape ``com.amazonaws.connect#UpdateTaskTemplate``."""
...
import capo_connect.types.update_task_template_request
import capo_connect.types.update_task_template_response
...
def handle_response(
    ...
    out: capo_connect.types.update_task_template_response.UpdateTaskTemplateResponse = (
        capo_connect.types.update_task_template_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_task_template_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_task_template(
