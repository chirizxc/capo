"""Generated from Smithy shape ``com.amazonaws.connect#ListDataTables``."""
...
import capo_connect.types.list_data_tables_request
import capo_connect.types.list_data_tables_response
...
) -> capo_connect.types.list_data_tables_response.ListDataTablesResponse:
    out: capo_connect.types.list_data_tables_response.ListDataTablesResponse = (
        capo_connect.types.list_data_tables_response.deserialize_json(
...
def list_data_tables(
    ...
    capo_connect.types.list_data_tables_response.ListDataTablesResponse, zapros.Response
]:
...
async def async_list_data_tables(
