...
import capo_connect.types.search_views_request
import capo_connect.types.search_views_response
...
def handle_response(
    ...
    out: capo_connect.types.search_views_response.SearchViewsResponse = (
        capo_connect.types.search_views_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_views_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def search_views(
    ...
    capo_connect.types.search_views_response.SearchViewsResponse, zapros.Response
]:
