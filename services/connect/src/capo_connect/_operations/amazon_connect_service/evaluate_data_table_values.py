"""Generated from Smithy shape ``com.amazonaws.connect#EvaluateDataTableValues``."""
...
def handle_response(
    ...
    out: capo_connect.types.evaluate_data_table_values_response.EvaluateDataTableValuesResponse = capo_connect.types.evaluate_data_table_values_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.evaluate_data_table_values_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_evaluate_data_table_values(
