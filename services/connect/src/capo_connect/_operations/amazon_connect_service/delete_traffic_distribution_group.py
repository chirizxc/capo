"""Generated from Smithy shape ``com.amazonaws.connect#DeleteTrafficDistributionGroup``."""
...
import capo_connect.types.delete_traffic_distribution_group_request
import capo_connect.types.delete_traffic_distribution_group_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_traffic_distribution_group_response.DeleteTrafficDistributionGroupResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_traffic_distribution_group(
