"""Generated from Smithy shape ``com.amazonaws.connect#SearchTestCases``."""
...
import capo_connect.types.search_test_cases_response
...
) -> capo_connect.types.search_test_cases_response.SearchTestCasesResponse:
    out: capo_connect.types.search_test_cases_response.SearchTestCasesResponse = (
        capo_connect.types.search_test_cases_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_test_cases_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_search_test_cases(
