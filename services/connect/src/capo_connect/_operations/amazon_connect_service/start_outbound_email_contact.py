...
import capo_connect.types.start_outbound_email_contact_response
...
def handle_response(
    ...
    out: capo_connect.types.start_outbound_email_contact_response.StartOutboundEmailContactResponse = capo_connect.types.start_outbound_email_contact_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_outbound_email_contact_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
