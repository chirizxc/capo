"""Generated from Smithy shape ``com.amazonaws.connect#CreateContactFlowModuleAlias``."""
...
def handle_response(
    ...
    out: capo_connect.types.create_contact_flow_module_alias_response.CreateContactFlowModuleAliasResponse = capo_connect.types.create_contact_flow_module_alias_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_contact_flow_module_alias_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_contact_flow_module_alias(
