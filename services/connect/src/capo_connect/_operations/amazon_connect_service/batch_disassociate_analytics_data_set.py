...
import capo_connect.types.batch_disassociate_analytics_data_set_request
import capo_connect.types.batch_disassociate_analytics_data_set_response
...
def handle_response(
    ...
    out: capo_connect.types.batch_disassociate_analytics_data_set_response.BatchDisassociateAnalyticsDataSetResponse = capo_connect.types.batch_disassociate_analytics_data_set_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.batch_disassociate_analytics_data_set_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
