...
import capo_connect.types.create_queue_request
import capo_connect.types.create_queue_response
...
def handle_response(
    ...
    out: capo_connect.types.create_queue_response.CreateQueueResponse = (
        capo_connect.types.create_queue_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_queue_request.serialize_json(input_), allow_nan=False
    ).encode()
...
def create_queue(
    ...
    capo_connect.types.create_queue_response.CreateQueueResponse, zapros.Response
]:
