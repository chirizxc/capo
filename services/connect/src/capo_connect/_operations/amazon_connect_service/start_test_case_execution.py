...
import capo_connect.types.start_test_case_execution_request
import capo_connect.types.start_test_case_execution_response
...
def handle_response(
    ...
    out: capo_connect.types.start_test_case_execution_response.StartTestCaseExecutionResponse = capo_connect.types.start_test_case_execution_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_test_case_execution_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
