"""Generated from Smithy shape ``com.amazonaws.connect#DeleteContactFlowModuleVersion``."""
...
import capo_connect.types.delete_contact_flow_module_version_request
import capo_connect.types.delete_contact_flow_module_version_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_contact_flow_module_version_response.DeleteContactFlowModuleVersionResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace(
        ...
        quote(str(input_["contact_flow_module_version"]), safe=""),
    )
...
async def async_delete_contact_flow_module_version(
