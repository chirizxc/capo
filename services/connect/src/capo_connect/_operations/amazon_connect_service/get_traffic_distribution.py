"""Generated from Smithy shape ``com.amazonaws.connect#GetTrafficDistribution``."""
...
import capo_connect.types.get_traffic_distribution_request
import capo_connect.types.get_traffic_distribution_response
...
def handle_response(
    ...
    capo_connect.types.get_traffic_distribution_response.GetTrafficDistributionResponse
):
    out: capo_connect.types.get_traffic_distribution_response.GetTrafficDistributionResponse = capo_connect.types.get_traffic_distribution_response.deserialize_json(
...
async def async_get_traffic_distribution(
