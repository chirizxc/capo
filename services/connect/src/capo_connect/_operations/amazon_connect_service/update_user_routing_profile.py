"""Generated from Smithy shape ``com.amazonaws.connect#UpdateUserRoutingProfile``."""
...
import capo_connect.types.update_user_routing_profile_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/users/{InstanceId}/{UserId}/routing-profile"
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_user_routing_profile_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_user_routing_profile(
