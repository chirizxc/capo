"""Generated from Smithy shape ``com.amazonaws.connect#ListInstanceAttributes``."""
...
import capo_connect.types.list_instance_attributes_request
import capo_connect.types.list_instance_attributes_response
...
def handle_response(
    ...
    out: capo_connect.types.list_instance_attributes_response.ListInstanceAttributesResponse = capo_connect.types.list_instance_attributes_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/instance/{InstanceId}/attributes"
...
async def async_list_instance_attributes(
