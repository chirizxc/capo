...
import capo_connect.types.delete_push_notification_registration_request
import capo_connect.types.delete_push_notification_registration_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_push_notification_registration_response.DeletePushNotificationRegistrationResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    url = url.replace("{RegistrationId}", quote(input_["registration_id"], safe=""))
