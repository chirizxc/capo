...
import capo_connect.types.update_workspace_visibility_request
import capo_connect.types.update_workspace_visibility_response
...
def handle_response(
    ...
    out: capo_connect.types.update_workspace_visibility_response.UpdateWorkspaceVisibilityResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_workspace_visibility_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
