"""Generated from Smithy shape ``com.amazonaws.connect#DescribeQuickConnect``."""
...
import capo_connect.types.describe_quick_connect_request
import capo_connect.types.describe_quick_connect_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_quick_connect_response.DescribeQuickConnectResponse = capo_connect.types.describe_quick_connect_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/quick-connects/{InstanceId}/{QuickConnectId}"
    url = url.replace("{InstanceId}", quote(input_["instance_id"], safe=""))
    url = url.replace("{QuickConnectId}", quote(input_["quick_connect_id"], safe=""))
...
async def async_describe_quick_connect(
