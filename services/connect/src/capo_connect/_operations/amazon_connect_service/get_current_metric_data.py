...
def handle_response(
    ...
    out: capo_connect.types.get_current_metric_data_response.GetCurrentMetricDataResponse = capo_connect.types.get_current_metric_data_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.get_current_metric_data_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
