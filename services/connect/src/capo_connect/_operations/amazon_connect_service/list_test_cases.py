...
import capo_connect.types.list_test_cases_request
import capo_connect.types.list_test_cases_response
...
) -> capo_connect.types.list_test_cases_response.ListTestCasesResponse:
    out: capo_connect.types.list_test_cases_response.ListTestCasesResponse = (
        capo_connect.types.list_test_cases_response.deserialize_json(
...
def list_test_cases(
    ...
    capo_connect.types.list_test_cases_response.ListTestCasesResponse, zapros.Response
]:
