...
import capo_connect.types.describe_test_case_request
import capo_connect.types.describe_test_case_response
...
) -> capo_connect.types.describe_test_case_response.DescribeTestCaseResponse:
    out: capo_connect.types.describe_test_case_response.DescribeTestCaseResponse = (
        capo_connect.types.describe_test_case_response.deserialize_json(
...
def build_request(
    ...
    if "status" in input_:
        params.append(
            (
                "status",
                capo_connect.types.test_case_status.serialize_json(input_["status"]),
            )
        )
