"""Generated from Smithy shape ``com.amazonaws.connect#UpdateQueueName``."""
...
import capo_connect.types.update_queue_name_request
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/queues/{InstanceId}/{QueueId}/name"
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_queue_name_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_update_queue_name(
