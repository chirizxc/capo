...
import capo_connect.types.list_queue_quick_connects_request
import capo_connect.types.list_queue_quick_connects_response
...
def handle_response(
    ...
    out: capo_connect.types.list_queue_quick_connects_response.ListQueueQuickConnectsResponse = capo_connect.types.list_queue_quick_connects_response.deserialize_json(
