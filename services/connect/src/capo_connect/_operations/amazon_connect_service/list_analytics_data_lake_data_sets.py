"""Generated from Smithy shape ``com.amazonaws.connect#ListAnalyticsDataLakeDataSets``."""
...
import capo_connect.types.list_analytics_data_lake_data_sets_request
import capo_connect.types.list_analytics_data_lake_data_sets_response
...
def handle_response(
    ...
    out: capo_connect.types.list_analytics_data_lake_data_sets_response.ListAnalyticsDataLakeDataSetsResponse = capo_connect.types.list_analytics_data_lake_data_sets_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/analytics-data/instance/{InstanceId}/datasets"
...
async def async_list_analytics_data_lake_data_sets(
