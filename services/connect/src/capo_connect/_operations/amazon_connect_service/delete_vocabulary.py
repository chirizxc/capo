...
import capo_connect.types.delete_vocabulary_request
import capo_connect.types.delete_vocabulary_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_vocabulary_response.DeleteVocabularyResponse = (
        capo_connect.types.delete_vocabulary_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{VocabularyId}", quote(input_["vocabulary_id"], safe=""))
