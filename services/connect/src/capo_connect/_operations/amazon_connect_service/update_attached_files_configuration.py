...
import capo_connect.types.update_attached_files_configuration_request
import capo_connect.types.update_attached_files_configuration_response
...
def handle_response(
    ...
    out: capo_connect.types.update_attached_files_configuration_response.UpdateAttachedFilesConfigurationResponse = capo_connect.types.update_attached_files_configuration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_attached_files_configuration_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
