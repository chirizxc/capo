"""Generated from Smithy shape ``com.amazonaws.connect#ListPrompts``."""
...
import capo_connect.types.list_prompts_request
import capo_connect.types.list_prompts_response
...
) -> capo_connect.types.list_prompts_response.ListPromptsResponse:
    out: capo_connect.types.list_prompts_response.ListPromptsResponse = (
        capo_connect.types.list_prompts_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/prompts-summary/{InstanceId}"
...
def list_prompts(
    ...
    capo_connect.types.list_prompts_response.ListPromptsResponse, zapros.Response
]:
