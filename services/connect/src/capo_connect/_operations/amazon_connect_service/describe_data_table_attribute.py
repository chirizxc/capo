"""Generated from Smithy shape ``com.amazonaws.connect#DescribeDataTableAttribute``."""
...
import capo_connect.types.describe_data_table_attribute_request
import capo_connect.types.describe_data_table_attribute_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_data_table_attribute_response.DescribeDataTableAttributeResponse = capo_connect.types.describe_data_table_attribute_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace("{AttributeName}", quote(input_["attribute_name"], safe=""))
...
async def async_describe_data_table_attribute(
