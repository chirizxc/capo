...
import capo_connect.types.describe_data_table_request
import capo_connect.types.describe_data_table_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_data_table_response.DescribeDataTableResponse = (
        capo_connect.types.describe_data_table_response.deserialize_json(
