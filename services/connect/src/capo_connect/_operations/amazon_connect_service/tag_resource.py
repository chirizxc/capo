"""Generated from Smithy shape ``com.amazonaws.connect#TagResource``."""
...
import capo_connect.types.tag_resource_request
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.tag_resource_request.serialize_json(input_), allow_nan=False
    ).encode()
