...
import capo_connect.types.contact_metric_results
...
def handle_response(
    ...
    out: capo_connect.types.get_contact_metrics_response.GetContactMetricsResponse = (
        capo_connect.types.get_contact_metrics_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.get_contact_metrics_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
