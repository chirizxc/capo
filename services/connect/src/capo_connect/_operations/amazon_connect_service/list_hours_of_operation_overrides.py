...
import capo_connect.types.list_hours_of_operation_overrides_request
import capo_connect.types.list_hours_of_operation_overrides_response
...
) -> capo_connect.types.list_hours_of_operation_overrides_response.ListHoursOfOperationOverridesResponse:
    out: capo_connect.types.list_hours_of_operation_overrides_response.ListHoursOfOperationOverridesResponse = capo_connect.types.list_hours_of_operation_overrides_response.deserialize_json(
