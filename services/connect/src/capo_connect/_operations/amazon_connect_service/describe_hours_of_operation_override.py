"""Generated from Smithy shape ``com.amazonaws.connect#DescribeHoursOfOperationOverride``."""
...
) -> capo_connect.types.describe_hours_of_operation_override_response.DescribeHoursOfOperationOverrideResponse:
    out: capo_connect.types.describe_hours_of_operation_override_response.DescribeHoursOfOperationOverrideResponse = capo_connect.types.describe_hours_of_operation_override_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{HoursOfOperationId}", quote(input_["hours_of_operation_id"], safe="")
    )
    url = url.replace(
        "{HoursOfOperationOverrideId}",
        quote(input_["hours_of_operation_override_id"], safe=""),
    )
...
async def async_describe_hours_of_operation_override(
