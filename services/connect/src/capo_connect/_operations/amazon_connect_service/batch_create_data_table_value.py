"""Generated from Smithy shape ``com.amazonaws.connect#BatchCreateDataTableValue``."""
...
import capo_connect.types.batch_create_data_table_value_request
import capo_connect.types.batch_create_data_table_value_response
...
) -> capo_connect.types.batch_create_data_table_value_response.BatchCreateDataTableValueResponse:
    out: capo_connect.types.batch_create_data_table_value_response.BatchCreateDataTableValueResponse = capo_connect.types.batch_create_data_table_value_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.batch_create_data_table_value_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
async def async_batch_create_data_table_value(
