...
import capo_connect.types.list_rules_request
...
def handle_response(
    ...
    out: capo_connect.types.list_rules_response.ListRulesResponse = (
        capo_connect.types.list_rules_response.deserialize_json(
...
def build_request(
    ...
    if "publish_status" in input_:
        params.append(
            (
                "publishStatus",
                capo_connect.types.rule_publish_status.serialize_json(
                    input_["publish_status"]
                ),
            )
        )
    if "event_source_name" in input_:
        params.append(
            (
                "eventSourceName",
                capo_connect.types.event_source_name.serialize_json(
                    input_["event_source_name"]
                ),
            )
        )
...
def list_rules(
    ...
    input_: capo_connect.types.list_rules_request.ListRulesRequest,
) -> tuple[capo_connect.types.list_rules_response.ListRulesResponse, zapros.Response]:
