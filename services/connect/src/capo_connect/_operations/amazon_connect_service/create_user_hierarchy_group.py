...
import capo_connect.types.create_user_hierarchy_group_request
import capo_connect.types.create_user_hierarchy_group_response
...
def handle_response(
    ...
    out: capo_connect.types.create_user_hierarchy_group_response.CreateUserHierarchyGroupResponse = capo_connect.types.create_user_hierarchy_group_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_user_hierarchy_group_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
