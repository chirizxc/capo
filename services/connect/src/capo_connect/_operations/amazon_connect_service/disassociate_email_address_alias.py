...
import capo_connect.types.disassociate_email_address_alias_request
import capo_connect.types.disassociate_email_address_alias_response
...
def handle_response(
    ...
    out: capo_connect.types.disassociate_email_address_alias_response.DisassociateEmailAddressAliasResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.disassociate_email_address_alias_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
