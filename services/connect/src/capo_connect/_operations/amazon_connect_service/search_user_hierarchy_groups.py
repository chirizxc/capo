...
import capo_connect.types.search_user_hierarchy_groups_request
import capo_connect.types.search_user_hierarchy_groups_response
...
def handle_response(
    ...
    out: capo_connect.types.search_user_hierarchy_groups_response.SearchUserHierarchyGroupsResponse = capo_connect.types.search_user_hierarchy_groups_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_user_hierarchy_groups_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
