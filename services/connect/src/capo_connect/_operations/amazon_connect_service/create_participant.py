...
import capo_connect.types.create_participant_response
...
def handle_response(
    ...
    out: capo_connect.types.create_participant_response.CreateParticipantResponse = (
        capo_connect.types.create_participant_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_participant_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
