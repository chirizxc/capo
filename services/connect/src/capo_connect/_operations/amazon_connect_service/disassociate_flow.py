...
import capo_connect.types.disassociate_flow_request
import capo_connect.types.disassociate_flow_response
...
def handle_response(
    ...
    out: capo_connect.types.disassociate_flow_response.DisassociateFlowResponse = {}  # type: ignore[typeddict-item]
    return out
