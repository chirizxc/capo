...
import capo_connect.types.describe_contact_flow_module_alias_request
import capo_connect.types.describe_contact_flow_module_alias_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_contact_flow_module_alias_response.DescribeContactFlowModuleAliasResponse = capo_connect.types.describe_contact_flow_module_alias_response.deserialize_json(
