"""Generated from Smithy shape ``com.amazonaws.connect#DeleteAttachedFile``."""
...
def handle_response(
    ...
    out: capo_connect.types.delete_attached_file_response.DeleteAttachedFileResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_delete_attached_file(
