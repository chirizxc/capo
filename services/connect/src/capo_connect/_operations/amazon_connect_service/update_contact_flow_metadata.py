...
import capo_connect.types.update_contact_flow_metadata_request
import capo_connect.types.update_contact_flow_metadata_response
...
def handle_response(
    ...
    out: capo_connect.types.update_contact_flow_metadata_response.UpdateContactFlowMetadataResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_contact_flow_metadata_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
