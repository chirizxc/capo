"""Generated from Smithy shape ``com.amazonaws.connect#CreatePersistentContactAssociation``."""
...
import capo_connect.types.create_persistent_contact_association_request
import capo_connect.types.create_persistent_contact_association_response
...
def handle_response(
    ...
    out: capo_connect.types.create_persistent_contact_association_response.CreatePersistentContactAssociationResponse = capo_connect.types.create_persistent_contact_association_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{InitialContactId}", quote(input_["initial_contact_id"], safe="")
    )
    params: list[tuple[str, str]] = []
    headers: dict[str, str] = {k: ", ".join(v) for k, v in endpoint.headers.items()}
    body: bytes | None = json.dumps(
        capo_connect.types.create_persistent_contact_association_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_persistent_contact_association(
