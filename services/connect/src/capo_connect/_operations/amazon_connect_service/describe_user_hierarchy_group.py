"""Generated from Smithy shape ``com.amazonaws.connect#DescribeUserHierarchyGroup``."""
...
import capo_connect.types.describe_user_hierarchy_group_request
import capo_connect.types.describe_user_hierarchy_group_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_user_hierarchy_group_response.DescribeUserHierarchyGroupResponse = capo_connect.types.describe_user_hierarchy_group_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{HierarchyGroupId}", quote(input_["hierarchy_group_id"], safe="")
    )
...
async def async_describe_user_hierarchy_group(
