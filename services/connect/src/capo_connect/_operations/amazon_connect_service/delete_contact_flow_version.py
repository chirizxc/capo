...
import capo_connect.types.delete_contact_flow_version_request
import capo_connect.types.delete_contact_flow_version_response
...
def handle_response(
    ...
    out: capo_connect.types.delete_contact_flow_version_response.DeleteContactFlowVersionResponse = {}  # type: ignore[typeddict-item]
    return out
