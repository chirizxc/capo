...
import capo_connect.types.list_security_profile_permissions_request
import capo_connect.types.list_security_profile_permissions_response
...
def handle_response(
    ...
    out: capo_connect.types.list_security_profile_permissions_response.ListSecurityProfilePermissionsResponse = capo_connect.types.list_security_profile_permissions_response.deserialize_json(
