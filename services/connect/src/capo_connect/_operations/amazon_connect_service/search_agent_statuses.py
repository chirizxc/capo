...
) -> capo_connect.types.search_agent_statuses_response.SearchAgentStatusesResponse:
    out: capo_connect.types.search_agent_statuses_response.SearchAgentStatusesResponse = capo_connect.types.search_agent_statuses_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.search_agent_statuses_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
