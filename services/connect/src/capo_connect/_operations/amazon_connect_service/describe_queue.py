...
import capo_connect.types.describe_queue_request
import capo_connect.types.describe_queue_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_queue_response.DescribeQueueResponse = (
        capo_connect.types.describe_queue_response.deserialize_json(
...
def describe_queue(
    ...
    capo_connect.types.describe_queue_response.DescribeQueueResponse, zapros.Response
]:
