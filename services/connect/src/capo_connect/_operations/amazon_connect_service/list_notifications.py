"""Generated from Smithy shape ``com.amazonaws.connect#ListNotifications``."""
...
def handle_response(
    ...
    out: capo_connect.types.list_notifications_response.ListNotificationsResponse = (
        capo_connect.types.list_notifications_response.deserialize_json(
