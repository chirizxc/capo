...
import capo_connect.types.list_instances_request
import capo_connect.types.list_instances_response
...
) -> capo_connect.types.list_instances_response.ListInstancesResponse:
    out: capo_connect.types.list_instances_response.ListInstancesResponse = (
        capo_connect.types.list_instances_response.deserialize_json(
...
def list_instances(
    ...
    capo_connect.types.list_instances_response.ListInstancesResponse, zapros.Response
]:
