...
import capo_connect.types.update_email_address_metadata_request
...
def handle_response(
    ...
    out: capo_connect.types.update_email_address_metadata_response.UpdateEmailAddressMetadataResponse = capo_connect.types.update_email_address_metadata_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.update_email_address_metadata_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
