...
import capo_connect.types.start_contact_recording_request
import capo_connect.types.start_contact_recording_response
...
def handle_response(
    ...
    out: capo_connect.types.start_contact_recording_response.StartContactRecordingResponse = {}  # type: ignore[typeddict-item]
    return out
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.start_contact_recording_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
