...
import capo_connect.types.batch_put_contact_request
import capo_connect.types.batch_put_contact_response
...
def handle_response(
    ...
    out: capo_connect.types.batch_put_contact_response.BatchPutContactResponse = (
        capo_connect.types.batch_put_contact_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.batch_put_contact_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
