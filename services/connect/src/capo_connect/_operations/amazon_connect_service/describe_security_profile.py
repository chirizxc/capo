"""Generated from Smithy shape ``com.amazonaws.connect#DescribeSecurityProfile``."""
...
import capo_connect.types.describe_security_profile_request
import capo_connect.types.describe_security_profile_response
...
def handle_response(
    ...
    out: capo_connect.types.describe_security_profile_response.DescribeSecurityProfileResponse = capo_connect.types.describe_security_profile_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{SecurityProfileId}", quote(input_["security_profile_id"], safe="")
    )
...
async def async_describe_security_profile(
