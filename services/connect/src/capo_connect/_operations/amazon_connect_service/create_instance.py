"""Generated from Smithy shape ``com.amazonaws.connect#CreateInstance``."""
...
import capo_connect.types.create_instance_request
...
def handle_response(
    ...
    out: capo_connect.types.create_instance_response.CreateInstanceResponse = (
        capo_connect.types.create_instance_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_connect.types.create_instance_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def create_instance(
    ...
    capo_connect.types.create_instance_response.CreateInstanceResponse, zapros.Response
]:
