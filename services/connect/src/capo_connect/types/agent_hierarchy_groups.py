...
class AgentHierarchyGroups(TypedDict, closed=True):
    l1_ids: NotRequired[
        "capo_connect.types.hierarchy_group_id_list.HierarchyGroupIdList"
    ]
...
def serialize_json(value: AgentHierarchyGroups) -> dict:
    ...
    if "l1_ids" in value:
        ...
        out["L1Ids"] = capo_connect.types.hierarchy_group_id_list.serialize_json(
            value["l1_ids"]
        )
    if "l2_ids" in value:
        import capo_connect.types.hierarchy_group_id_list

        out["L2Ids"] = capo_connect.types.hierarchy_group_id_list.serialize_json(
            value["l2_ids"]
        )
    if "l3_ids" in value:
        import capo_connect.types.hierarchy_group_id_list

        out["L3Ids"] = capo_connect.types.hierarchy_group_id_list.serialize_json(
            value["l3_ids"]
        )
    if "l4_ids" in value:
        import capo_connect.types.hierarchy_group_id_list

        out["L4Ids"] = capo_connect.types.hierarchy_group_id_list.serialize_json(
            value["l4_ids"]
        )
    if "l5_ids" in value:
        import capo_connect.types.hierarchy_group_id_list

        out["L5Ids"] = capo_connect.types.hierarchy_group_id_list.serialize_json(
            value["l5_ids"]
        )
    return out
