...
class PredefinedAttribute(TypedDict, closed=True):
    ...
    attribute_configuration: NotRequired[
        "capo_connect.types.predefined_attribute_configuration.PredefinedAttributeConfiguration"
    ]
...
def serialize_json(value: PredefinedAttribute) -> dict:
    ...
    if "attribute_configuration" in value:
        ...
        out["AttributeConfiguration"] = (
            capo_connect.types.predefined_attribute_configuration.serialize_json(
...
def deserialize_json(data: dict) -> PredefinedAttribute:
    ...
    if data.get("AttributeConfiguration") is not None:
        ...
        out["attribute_configuration"] = (
            capo_connect.types.predefined_attribute_configuration.deserialize_json(
