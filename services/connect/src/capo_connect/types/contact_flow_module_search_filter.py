"""Generated from Smithy shape ``com.amazonaws.connect#ContactFlowModuleSearchFilter``."""
...
class ContactFlowModuleSearchFilter(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: ContactFlowModuleSearchFilter) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> ContactFlowModuleSearchFilter:
    out: ContactFlowModuleSearchFilter = {}  # type: ignore[typeddict-item]
