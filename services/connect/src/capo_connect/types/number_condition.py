...
if TYPE_CHECKING:
    import capo_connect.types.nullable_proficiency_limit_value
...
class NumberCondition(TypedDict, closed=True):
    ...
    min_value: NotRequired[
        "capo_connect.types.nullable_proficiency_limit_value.NullableProficiencyLimitValue"
    ]
    ...
    comparison_type: NotRequired[
        "capo_connect.types.number_comparison_type.NumberComparisonType"
    ]
...
def serialize_json(value: NumberCondition) -> dict:
    ...
    if "comparison_type" in value:
        ...
        out["ComparisonType"] = (
            capo_connect.types.number_comparison_type.serialize_json(
...
def deserialize_json(data: dict) -> NumberCondition:
    ...
    if data.get("ComparisonType") is not None:
        ...
        out["comparison_type"] = (
            capo_connect.types.number_comparison_type.deserialize_json(
                data["ComparisonType"]
            )
        )
    return out
