...
class FilterV2(TypedDict, closed=True):
    filter_key: NotRequired["capo_connect.types.resource_arn_or_id.ResourceArnOrId"]
    ...
    filter_values: NotRequired["capo_connect.types.filter_value_list.FilterValueList"]
    ...
    string_condition: NotRequired[
        "capo_connect.types.filter_v2_string_condition.FilterV2StringCondition"
    ]
...
def serialize_json(value: FilterV2) -> dict:
    ...
    if "filter_values" in value:
        ...
        out["FilterValues"] = capo_connect.types.filter_value_list.serialize_json(
            value["filter_values"]
        )
    if "string_condition" in value:
        ...
        out["StringCondition"] = (
            capo_connect.types.filter_v2_string_condition.serialize_json(
...
def deserialize_json(data: dict) -> FilterV2:
    ...
    if data.get("StringCondition") is not None:
        ...
        out["string_condition"] = (
            capo_connect.types.filter_v2_string_condition.deserialize_json(
