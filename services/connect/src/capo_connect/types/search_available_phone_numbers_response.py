...
class SearchAvailablePhoneNumbersResponse(TypedDict, closed=True):
    ...
    available_numbers_list: NotRequired[
        "capo_connect.types.available_numbers_list.AvailableNumbersList"
    ]
...
def serialize_json(value: SearchAvailablePhoneNumbersResponse) -> dict:
    ...
    if "available_numbers_list" in value:
        ...
        out["AvailableNumbersList"] = (
            capo_connect.types.available_numbers_list.serialize_json(
...
def deserialize_json(data: dict) -> SearchAvailablePhoneNumbersResponse:
    ...
    if data.get("AvailableNumbersList") is not None:
        import capo_connect.types.available_numbers_list

        out["available_numbers_list"] = (
            capo_connect.types.available_numbers_list.deserialize_json(
