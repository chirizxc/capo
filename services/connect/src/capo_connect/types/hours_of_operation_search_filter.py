...
# --- restJson1 ser/de ---
def serialize_json(value: HoursOfOperationSearchFilter) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> HoursOfOperationSearchFilter:
    out: HoursOfOperationSearchFilter = {}  # type: ignore[typeddict-item]
