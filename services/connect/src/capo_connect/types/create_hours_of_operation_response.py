"""Generated from Smithy shape ``com.amazonaws.connect#CreateHoursOfOperationResponse``."""
...
class CreateHoursOfOperationResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateHoursOfOperationResponse) -> dict:
    out: dict = {}
