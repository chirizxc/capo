...
if TYPE_CHECKING:
    import capo_connect.types.quick_connect_search_condition_list
...
class QuickConnectSearchCriteria(TypedDict, closed=True):
    or_conditions: NotRequired[
        "capo_connect.types.quick_connect_search_condition_list.QuickConnectSearchConditionList"
    ]
...
def serialize_json(value: QuickConnectSearchCriteria) -> dict:
    ...
    if "or_conditions" in value:
        ...
        out["OrConditions"] = (
            capo_connect.types.quick_connect_search_condition_list.serialize_json(
                value["or_conditions"]
            )
        )
...
def deserialize_json(data: dict) -> QuickConnectSearchCriteria:
    ...
    if data.get("OrConditions") is not None:
        ...
        out["or_conditions"] = (
            capo_connect.types.quick_connect_search_condition_list.deserialize_json(
                data["OrConditions"]
            )
        )
