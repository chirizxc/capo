...
class PersistentChat(TypedDict, closed=True):
    rehydration_type: NotRequired["capo_connect.types.rehydration_type.RehydrationType"]
    ...
    source_contact_id: NotRequired["capo_connect.types.contact_id.ContactId"]
...
def serialize_json(value: PersistentChat) -> dict:
    ...
    if "rehydration_type" in value:
        ...
        out["RehydrationType"] = capo_connect.types.rehydration_type.serialize_json(
