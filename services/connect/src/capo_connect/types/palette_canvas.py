...
class PaletteCanvas(TypedDict, closed=True):
    container_background: NotRequired["capo_connect.types.theme_string.ThemeString"]
    """<p>The background color for container elements.</p>"""
    page_background: NotRequired["capo_connect.types.theme_string.ThemeString"]
    """<p>The background color for page elements.</p>"""
    active_background: NotRequired["capo_connect.types.theme_string.ThemeString"]
