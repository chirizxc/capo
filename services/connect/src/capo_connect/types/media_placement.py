...
class MediaPlacement(TypedDict, closed=True):
    audio_host_url: NotRequired["capo_connect.types.uri.URI"]
    """<p>The audio host URL.</p>"""
    audio_fallback_url: NotRequired["capo_connect.types.uri.URI"]
    """<p>The audio fallback URL.</p>"""
    signaling_url: NotRequired["capo_connect.types.uri.URI"]
    """<p>The signaling URL.</p>"""
    turn_control_url: NotRequired["capo_connect.types.uri.URI"]
    """<p>The turn control URL.</p>"""
    event_ingestion_url: NotRequired["capo_connect.types.uri.URI"]
