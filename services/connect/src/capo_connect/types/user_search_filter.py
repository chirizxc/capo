...
class UserSearchFilter(TypedDict, closed=True):
    ...
    user_attribute_filter: NotRequired[
        "capo_connect.types.control_plane_user_attribute_filter.ControlPlaneUserAttributeFilter"
    ]
...
def serialize_json(value: UserSearchFilter) -> dict:
    ...
    if "user_attribute_filter" in value:
        ...
        out["UserAttributeFilter"] = (
            capo_connect.types.control_plane_user_attribute_filter.serialize_json(
...
def deserialize_json(data: dict) -> UserSearchFilter:
    ...
    if data.get("UserAttributeFilter") is not None:
        ...
        out["user_attribute_filter"] = (
            capo_connect.types.control_plane_user_attribute_filter.deserialize_json(
