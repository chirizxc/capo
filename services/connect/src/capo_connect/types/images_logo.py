...
if TYPE_CHECKING:
    import capo_connect.types.theme_image_link


class ImagesLogo(TypedDict, closed=True):
    default: NotRequired["capo_connect.types.theme_image_link.ThemeImageLink"]
    """<p>The default logo image displayed in the workspace.</p>"""
    favicon: NotRequired["capo_connect.types.theme_image_link.ThemeImageLink"]
