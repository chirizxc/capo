...
class ListTrafficDistributionGroupsResponse(TypedDict, closed=True):
    ...
    traffic_distribution_group_summary_list: NotRequired[
        "capo_connect.types.traffic_distribution_group_summary_list.TrafficDistributionGroupSummaryList"
    ]
...
def serialize_json(value: ListTrafficDistributionGroupsResponse) -> dict:
    ...
    if "traffic_distribution_group_summary_list" in value:
        ...
        out["TrafficDistributionGroupSummaryList"] = (
            capo_connect.types.traffic_distribution_group_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListTrafficDistributionGroupsResponse:
    ...
    if data.get("TrafficDistributionGroupSummaryList") is not None:
        import capo_connect.types.traffic_distribution_group_summary_list

        out["traffic_distribution_group_summary_list"] = (
            capo_connect.types.traffic_distribution_group_summary_list.deserialize_json(
