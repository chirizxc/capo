...
def serialize_json(value: ListTestCaseExecutionsResponse) -> dict:
    ...
    if "test_case_executions" in value:
        ...
        out["TestCaseExecutions"] = (
            capo_connect.types.test_case_execution_list.serialize_json(
...
def deserialize_json(data: dict) -> ListTestCaseExecutionsResponse:
    ...
    if data.get("TestCaseExecutions") is not None:
        import capo_connect.types.test_case_execution_list

        out["test_case_executions"] = (
            capo_connect.types.test_case_execution_list.deserialize_json(
