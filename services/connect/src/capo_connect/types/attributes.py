...
if TYPE_CHECKING:
    import capo_connect.types.attribute_name
    import capo_connect.types.attribute_value

Attributes: TypeAlias = dict[
    "capo_connect.types.attribute_name.AttributeName",
    "capo_connect.types.attribute_value.AttributeValue",
]
