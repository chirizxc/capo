...
class ListPredefinedAttributesResponse(TypedDict, closed=True):
    ...
    predefined_attribute_summary_list: NotRequired[
        "capo_connect.types.predefined_attribute_summary_list.PredefinedAttributeSummaryList"
    ]
...
def serialize_json(value: ListPredefinedAttributesResponse) -> dict:
    ...
    if "predefined_attribute_summary_list" in value:
        ...
        out["PredefinedAttributeSummaryList"] = (
            capo_connect.types.predefined_attribute_summary_list.serialize_json(
...
def deserialize_json(data: dict) -> ListPredefinedAttributesResponse:
    ...
    if data.get("PredefinedAttributeSummaryList") is not None:
        ...
        out["predefined_attribute_summary_list"] = (
            capo_connect.types.predefined_attribute_summary_list.deserialize_json(
