...
if TYPE_CHECKING:
    import capo_connect.types.evaluation_suggested_answer_transcript_millis_offset


class EvaluationSuggestedAnswerTranscriptMillisecondOffsets(TypedDict, closed=True):
    begin_offset_millis: "capo_connect.types.evaluation_suggested_answer_transcript_millis_offset.EvaluationSuggestedAnswerTranscriptMillisOffset"
