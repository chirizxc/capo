...
class ContactFlowModuleAliasInfo(TypedDict, closed=True):
    contact_flow_module_id: NotRequired["capo_connect.types.resource_id.ResourceId"]
    """<p>The identifier of the flow module.</p>"""
    contact_flow_module_arn: NotRequired["capo_connect.types.arn.ARN"]
    """<p>The Amazon Resource Name (ARN) of the flow module.</p>"""
    alias_id: NotRequired[
        "capo_connect.types.contact_flow_module_alias.ContactFlowModuleAlias"
    ]
