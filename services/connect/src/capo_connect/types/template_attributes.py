...
if TYPE_CHECKING:
    ...
    import capo_connect.types.customer_profile_attributes_serialized


class TemplateAttributes(TypedDict, closed=True):
    custom_attributes: NotRequired["capo_connect.types.attributes.Attributes"]
    ...
    customer_profile_attributes: NotRequired[
        "capo_connect.types.customer_profile_attributes_serialized.CustomerProfileAttributesSerialized"
    ]
...
def serialize_json(value: TemplateAttributes) -> dict:
    ...
    if "custom_attributes" in value:
        ...
        out["CustomAttributes"] = capo_connect.types.attributes.serialize_json(
