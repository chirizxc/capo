...
def handle_response(
    ...
    out: capo_customer_profiles.types.merge_profiles_response.MergeProfilesResponse = (
        capo_customer_profiles.types.merge_profiles_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.merge_profiles_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
