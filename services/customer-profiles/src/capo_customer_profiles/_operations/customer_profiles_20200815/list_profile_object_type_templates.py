"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListProfileObjectTypeTemplates``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_profile_object_type_templates_response.ListProfileObjectTypeTemplatesResponse = capo_customer_profiles.types.list_profile_object_type_templates_response.deserialize_json(
...
async def async_list_profile_object_type_templates(
