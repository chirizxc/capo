"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetEventTrigger``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_event_trigger_response.GetEventTriggerResponse = capo_customer_profiles.types.get_event_trigger_response.deserialize_json(
...
async def async_get_event_trigger(
