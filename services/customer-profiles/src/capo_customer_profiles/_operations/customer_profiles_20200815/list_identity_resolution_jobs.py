"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListIdentityResolutionJobs``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_identity_resolution_jobs_response.ListIdentityResolutionJobsResponse = capo_customer_profiles.types.list_identity_resolution_jobs_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/identity-resolution-jobs"
...
async def async_list_identity_resolution_jobs(
