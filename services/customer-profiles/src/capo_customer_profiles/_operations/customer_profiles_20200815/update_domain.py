"""Generated from Smithy shape ``com.amazonaws.customerprofiles#UpdateDomain``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.update_domain_response.UpdateDomainResponse = (
        capo_customer_profiles.types.update_domain_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.update_domain_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
