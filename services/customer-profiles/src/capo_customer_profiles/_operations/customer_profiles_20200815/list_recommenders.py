...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_recommenders_response.ListRecommendersResponse = capo_customer_profiles.types.list_recommenders_response.deserialize_json(
