"""Generated from Smithy shape ``com.amazonaws.customerprofiles#CreateProfile``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.create_profile_response.CreateProfileResponse = (
        capo_customer_profiles.types.create_profile_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.create_profile_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
