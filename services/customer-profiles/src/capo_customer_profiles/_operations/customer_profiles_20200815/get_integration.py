...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_integration_response.GetIntegrationResponse = capo_customer_profiles.types.get_integration_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.get_integration_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
