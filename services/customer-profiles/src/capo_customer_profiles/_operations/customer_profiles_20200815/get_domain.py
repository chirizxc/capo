...
import capo_customer_profiles.types.domain_stats
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_domain_response.GetDomainResponse = (
        capo_customer_profiles.types.get_domain_response.deserialize_json(
...
def get_domain(
    ...
    capo_customer_profiles.types.get_domain_response.GetDomainResponse, zapros.Response
]:
