"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListDomainObjectTypes``."""
...
import capo_customer_profiles.types.domain_object_types_list
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_domain_object_types_response.ListDomainObjectTypesResponse = capo_customer_profiles.types.list_domain_object_types_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/domain-object-types"
...
async def async_list_domain_object_types(
