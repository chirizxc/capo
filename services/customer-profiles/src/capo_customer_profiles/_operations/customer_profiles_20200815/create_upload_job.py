...
def handle_response(
    ...
    out: capo_customer_profiles.types.create_upload_job_response.CreateUploadJobResponse = capo_customer_profiles.types.create_upload_job_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.create_upload_job_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
