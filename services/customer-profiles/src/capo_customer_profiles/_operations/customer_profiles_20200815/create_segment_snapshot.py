...
def handle_response(
    ...
    out: capo_customer_profiles.types.create_segment_snapshot_response.CreateSegmentSnapshotResponse = capo_customer_profiles.types.create_segment_snapshot_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.create_segment_snapshot_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
