...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_calculated_attributes_for_profile_response.ListCalculatedAttributesForProfileResponse = capo_customer_profiles.types.list_calculated_attributes_for_profile_response.deserialize_json(
