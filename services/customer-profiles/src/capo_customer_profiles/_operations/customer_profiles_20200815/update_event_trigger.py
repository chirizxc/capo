"""Generated from Smithy shape ``com.amazonaws.customerprofiles#UpdateEventTrigger``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.update_event_trigger_response.UpdateEventTriggerResponse = capo_customer_profiles.types.update_event_trigger_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.update_event_trigger_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_update_event_trigger(
