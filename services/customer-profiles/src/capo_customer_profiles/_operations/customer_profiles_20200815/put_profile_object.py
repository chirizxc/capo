...
def handle_response(
    ...
    out: capo_customer_profiles.types.put_profile_object_response.PutProfileObjectResponse = capo_customer_profiles.types.put_profile_object_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.put_profile_object_request.serialize_json(input_),
        allow_nan=False,
    ).encode()
