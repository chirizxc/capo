...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_profile_history_records_response.ListProfileHistoryRecordsResponse = capo_customer_profiles.types.list_profile_history_records_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.list_profile_history_records_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
