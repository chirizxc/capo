...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_profile_recommendations_response.GetProfileRecommendationsResponse = capo_customer_profiles.types.get_profile_recommendations_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.get_profile_recommendations_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
