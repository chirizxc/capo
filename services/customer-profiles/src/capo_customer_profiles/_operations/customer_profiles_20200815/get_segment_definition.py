"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetSegmentDefinition``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_segment_definition_response.GetSegmentDefinitionResponse = capo_customer_profiles.types.get_segment_definition_response.deserialize_json(
...
async def async_get_segment_definition(
