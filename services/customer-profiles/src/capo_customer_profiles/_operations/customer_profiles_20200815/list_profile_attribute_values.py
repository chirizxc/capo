...
def handle_response(
    ...
    out: capo_customer_profiles.types.profile_attribute_values_response.ProfileAttributeValuesResponse = capo_customer_profiles.types.profile_attribute_values_response.deserialize_json(
