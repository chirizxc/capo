...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_segment_membership_response.GetSegmentMembershipResponse = capo_customer_profiles.types.get_segment_membership_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.get_segment_membership_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
