...
def handle_response(
    ...
    out: capo_customer_profiles.types.put_domain_object_type_response.PutDomainObjectTypeResponse = capo_customer_profiles.types.put_domain_object_type_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.put_domain_object_type_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
