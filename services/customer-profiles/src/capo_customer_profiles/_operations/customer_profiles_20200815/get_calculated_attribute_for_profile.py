...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_calculated_attribute_for_profile_response.GetCalculatedAttributeForProfileResponse = capo_customer_profiles.types.get_calculated_attribute_for_profile_response.deserialize_json(
