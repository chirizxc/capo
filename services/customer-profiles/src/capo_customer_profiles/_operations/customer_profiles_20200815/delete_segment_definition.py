"""Generated from Smithy shape ``com.amazonaws.customerprofiles#DeleteSegmentDefinition``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.delete_segment_definition_response.DeleteSegmentDefinitionResponse = capo_customer_profiles.types.delete_segment_definition_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{SegmentDefinitionName}", quote(input_["segment_definition_name"], safe="")
    )
...
async def async_delete_segment_definition(
