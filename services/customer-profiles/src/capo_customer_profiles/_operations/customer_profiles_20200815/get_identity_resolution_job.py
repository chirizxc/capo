...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_identity_resolution_job_response.GetIdentityResolutionJobResponse = capo_customer_profiles.types.get_identity_resolution_job_response.deserialize_json(
