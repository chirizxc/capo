...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_recommender_response.GetRecommenderResponse = capo_customer_profiles.types.get_recommender_response.deserialize_json(
...
def build_request(
    ...
    if "training_metrics_count" in input_:
        params.append(("training-metrics-count", str(input_["training_metrics_count"])))
