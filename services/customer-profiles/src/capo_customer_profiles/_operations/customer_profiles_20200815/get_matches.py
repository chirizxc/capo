"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetMatches``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.get_matches_response.GetMatchesResponse = (
        capo_customer_profiles.types.get_matches_response.deserialize_json(
