"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListRecommenderRecipes``."""
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_recommender_recipes_response.ListRecommenderRecipesResponse = capo_customer_profiles.types.list_recommender_recipes_response.deserialize_json(
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/recommender-recipes"
...
async def async_list_recommender_recipes(
