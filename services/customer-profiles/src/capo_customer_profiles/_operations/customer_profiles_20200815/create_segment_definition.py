...
def handle_response(
    ...
    out: capo_customer_profiles.types.create_segment_definition_response.CreateSegmentDefinitionResponse = capo_customer_profiles.types.create_segment_definition_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_customer_profiles.types.create_segment_definition_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
