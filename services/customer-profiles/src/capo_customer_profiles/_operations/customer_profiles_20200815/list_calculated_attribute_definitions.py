"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ListCalculatedAttributeDefinitions``."""
...
import capo_customer_profiles._protocol.eventstream
...
import capo_customer_profiles.types.calculated_attribute_definitions_list
...
def handle_response(
    ...
    out: capo_customer_profiles.types.list_calculated_attribute_definitions_response.ListCalculatedAttributeDefinitionsResponse = capo_customer_profiles.types.list_calculated_attribute_definitions_response.deserialize_json(
...
def get_signer(
    ...
    if options.credentials_provider is not None:
        ...
        if endpoint_scheme is not None or not name_to_schema:
            sigv4_config = capo_customer_profiles._auth._sigv4.build_sigv4_auth_scheme(
                "profile", options.region, endpoint_scheme
            )
...
def build_request(
    ...
    url = endpoint.url.rstrip("/") + "/domains/{DomainName}/calculated-attributes"
...
async def async_list_calculated_attribute_definitions(
