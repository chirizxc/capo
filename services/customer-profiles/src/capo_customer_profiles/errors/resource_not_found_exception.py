"""Generated from Smithy shape ``com.amazonaws.customerprofiles#ResourceNotFoundException``."""
...
class ResourceNotFoundException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.customerprofiles#ResourceNotFoundException``."""
