"""Generated from Smithy shape ``com.amazonaws.customerprofiles#InternalServerException``."""
...
class InternalServerException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.customerprofiles#InternalServerException``."""
