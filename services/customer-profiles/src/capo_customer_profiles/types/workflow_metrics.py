...
if TYPE_CHECKING:
    import capo_customer_profiles.types.appflow_integration_workflow_metrics


class WorkflowMetrics(TypedDict, closed=True):
    appflow_integration: NotRequired[
        "capo_customer_profiles.types.appflow_integration_workflow_metrics.AppflowIntegrationWorkflowMetrics"
    ]
...
def serialize_json(value: WorkflowMetrics) -> dict:
    ...
    if "appflow_integration" in value:
        ...
        out["AppflowIntegration"] = (
            capo_customer_profiles.types.appflow_integration_workflow_metrics.serialize_json(
...
def deserialize_json(data: dict) -> WorkflowMetrics:
    ...
    if data.get("AppflowIntegration") is not None:
        ...
        out["appflow_integration"] = (
            capo_customer_profiles.types.appflow_integration_workflow_metrics.deserialize_json(
