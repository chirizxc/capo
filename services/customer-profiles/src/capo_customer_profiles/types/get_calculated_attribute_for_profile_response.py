"""Generated from Smithy shape ``com.amazonaws.customerprofiles#GetCalculatedAttributeForProfileResponse``."""
...
class GetCalculatedAttributeForProfileResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: GetCalculatedAttributeForProfileResponse) -> dict:
    out: dict = {}
