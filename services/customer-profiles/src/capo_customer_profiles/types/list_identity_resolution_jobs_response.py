...
class ListIdentityResolutionJobsResponse(TypedDict, closed=True):
    identity_resolution_jobs_list: NotRequired[
        "capo_customer_profiles.types.identity_resolution_jobs_list.IdentityResolutionJobsList"
    ]
...
def serialize_json(value: ListIdentityResolutionJobsResponse) -> dict:
    ...
    if "identity_resolution_jobs_list" in value:
        ...
        out["IdentityResolutionJobsList"] = (
            capo_customer_profiles.types.identity_resolution_jobs_list.serialize_json(
...
def deserialize_json(data: dict) -> ListIdentityResolutionJobsResponse:
    ...
    if data.get("IdentityResolutionJobsList") is not None:
        ...
        out["identity_resolution_jobs_list"] = (
            capo_customer_profiles.types.identity_resolution_jobs_list.deserialize_json(
