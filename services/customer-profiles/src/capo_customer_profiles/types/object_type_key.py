...
class ObjectTypeKey(TypedDict, closed=True):
    standard_identifiers: NotRequired[
        "capo_customer_profiles.types.standard_identifier_list.StandardIdentifierList"
    ]
    ...
    field_names: NotRequired[
        "capo_customer_profiles.types.field_name_list.FieldNameList"
    ]
...
def serialize_json(value: ObjectTypeKey) -> dict:
    ...
    if "standard_identifiers" in value:
        ...
        out["StandardIdentifiers"] = (
            capo_customer_profiles.types.standard_identifier_list.serialize_json(
    ...
    if "field_names" in value:
        ...
        out["FieldNames"] = capo_customer_profiles.types.field_name_list.serialize_json(
            value["field_names"]
        )
    return out
...
def deserialize_json(data: dict) -> ObjectTypeKey:
    ...
    if data.get("StandardIdentifiers") is not None:
        ...
        out["standard_identifiers"] = (
            capo_customer_profiles.types.standard_identifier_list.deserialize_json(
    ...
    if data.get("FieldNames") is not None:
        ...
        out["field_names"] = (
            capo_customer_profiles.types.field_name_list.deserialize_json(
                data["FieldNames"]
            )
        )
    return out
