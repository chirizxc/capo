"""Generated from Smithy shape ``com.amazonaws.customerprofiles#CreateCalculatedAttributeDefinitionResponse``."""
...
class CreateCalculatedAttributeDefinitionResponse(TypedDict, closed=True):
...
# --- restJson1 ser/de ---
def serialize_json(value: CreateCalculatedAttributeDefinitionResponse) -> dict:
    out: dict = {}
...
def deserialize_json(data: dict) -> CreateCalculatedAttributeDefinitionResponse:
    out: CreateCalculatedAttributeDefinitionResponse = {}  # type: ignore[typeddict-item]
