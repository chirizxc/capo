...
class JobStats(TypedDict, closed=True):
    number_of_profiles_reviewed: "capo_customer_profiles.types.long.long"
    """<p>The number of profiles reviewed.</p>"""
    number_of_matches_found: "capo_customer_profiles.types.long.long"
    """<p>The number of matches found.</p>"""
    number_of_merges_done: "capo_customer_profiles.types.long.long"
