...
def serialize_json(value: CreateUserSettingsRequest) -> dict:
    ...
    if "branding_configuration_input" in value:
        ...
        out["brandingConfigurationInput"] = (
            capo_workspaces_web.types.branding_configuration_create_input.serialize_json(
...
def deserialize_json(data: dict) -> CreateUserSettingsRequest:
    ...
    if data.get("brandingConfigurationInput") is not None:
        ...
        out["branding_configuration_input"] = (
            capo_workspaces_web.types.branding_configuration_create_input.deserialize_json(
