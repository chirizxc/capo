...
class ListNetworkSettingsResponse(TypedDict, closed=True):
    network_settings: NotRequired[
        "capo_workspaces_web.types.network_settings_list.NetworkSettingsList"
    ]
...
def serialize_json(value: ListNetworkSettingsResponse) -> dict:
    ...
    if "network_settings" in value:
        ...
        out["networkSettings"] = (
            capo_workspaces_web.types.network_settings_list.serialize_json(
...
def deserialize_json(data: dict) -> ListNetworkSettingsResponse:
    ...
    if data.get("networkSettings") is not None:
        ...
        out["network_settings"] = (
            capo_workspaces_web.types.network_settings_list.deserialize_json(
