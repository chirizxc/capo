...
class AsyncSessionLoggerResource:
    ...
    async def create(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.create_session_logger_request.CreateSessionLoggerRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.create_session_logger_response.CreateSessionLoggerResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.create_session_logger
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.create_session_logger.async_create_session_logger(
                req.options, req.input
            )
    ...
    async def read(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.get_session_logger_request.GetSessionLoggerRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.get_session_logger_response.GetSessionLoggerResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.get_session_logger
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.get_session_logger.async_get_session_logger(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def update(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.update_session_logger_request.UpdateSessionLoggerRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.update_session_logger_response.UpdateSessionLoggerResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.update_session_logger
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.update_session_logger.async_update_session_logger(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def delete(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.delete_session_logger_request.DeleteSessionLoggerRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.delete_session_logger_response.DeleteSessionLoggerResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.delete_session_logger
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.delete_session_logger.async_delete_session_logger(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
    ...
    async def list(
        ...
        *,
        ...
        async def _handler(
            req: "AsyncOperationRequest[capo_workspaces_web.types.list_session_loggers_request.ListSessionLoggersRequest]",
        ) -> AsyncOperationResponse[
            "capo_workspaces_web.types.list_session_loggers_response.ListSessionLoggersResponse"
        ]:
            import capo_workspaces_web._operations.aws_ermine_control_plane_service.list_session_loggers
            ...
            (
                output,
                http_response,
            ) = await capo_workspaces_web._operations.aws_ermine_control_plane_service.list_session_loggers.async_list_session_loggers(
                req.options, req.input
            )
            return AsyncOperationResponse(output=output, response=http_response)
