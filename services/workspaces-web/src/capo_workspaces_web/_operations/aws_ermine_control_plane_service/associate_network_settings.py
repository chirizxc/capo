"""Generated from Smithy shape ``com.amazonaws.workspacesweb#AssociateNetworkSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.associate_network_settings_response.AssociateNetworkSettingsResponse = capo_workspaces_web.types.associate_network_settings_response.deserialize_json(
...
def build_request(
    ...
    if "network_settings_arn" in input_:
        params.append(("networkSettingsArn", input_["network_settings_arn"]))
...
async def async_associate_network_settings(
