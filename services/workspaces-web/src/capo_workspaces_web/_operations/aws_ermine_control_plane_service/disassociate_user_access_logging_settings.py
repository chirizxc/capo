"""Generated from Smithy shape ``com.amazonaws.workspacesweb#DisassociateUserAccessLoggingSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.disassociate_user_access_logging_settings_response.DisassociateUserAccessLoggingSettingsResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_user_access_logging_settings(
