"""Generated from Smithy shape ``com.amazonaws.workspacesweb#AssociateUserSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.associate_user_settings_response.AssociateUserSettingsResponse = capo_workspaces_web.types.associate_user_settings_response.deserialize_json(
...
def build_request(
    ...
    if "user_settings_arn" in input_:
        params.append(("userSettingsArn", input_["user_settings_arn"]))
...
async def async_associate_user_settings(
