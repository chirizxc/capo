...
def handle_response(
    ...
    out: capo_workspaces_web.types.associate_session_logger_response.AssociateSessionLoggerResponse = capo_workspaces_web.types.associate_session_logger_response.deserialize_json(
...
def build_request(
    ...
    if "session_logger_arn" in input_:
        params.append(("sessionLoggerArn", input_["session_logger_arn"]))
