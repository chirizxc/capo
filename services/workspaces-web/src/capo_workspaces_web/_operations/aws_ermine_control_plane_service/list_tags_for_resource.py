"""Generated from Smithy shape ``com.amazonaws.workspacesweb#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_tags_for_resource_response.ListTagsForResourceResponse = capo_workspaces_web.types.list_tags_for_resource_response.deserialize_json(
