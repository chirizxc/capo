...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_portal_service_provider_metadata_response.GetPortalServiceProviderMetadataResponse = capo_workspaces_web.types.get_portal_service_provider_metadata_response.deserialize_json(
