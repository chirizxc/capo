...
def handle_response(
    ...
    out: capo_workspaces_web.types.associate_user_access_logging_settings_response.AssociateUserAccessLoggingSettingsResponse = capo_workspaces_web.types.associate_user_access_logging_settings_response.deserialize_json(
...
def build_request(
    ...
    if "user_access_logging_settings_arn" in input_:
        params.append(
            ("userAccessLoggingSettingsArn", input_["user_access_logging_settings_arn"])
        )
