...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_user_access_logging_settings_response.ListUserAccessLoggingSettingsResponse = capo_workspaces_web.types.list_user_access_logging_settings_response.deserialize_json(
