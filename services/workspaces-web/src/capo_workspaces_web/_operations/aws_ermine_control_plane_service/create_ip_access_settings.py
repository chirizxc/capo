...
def handle_response(
    ...
    out: capo_workspaces_web.types.create_ip_access_settings_response.CreateIpAccessSettingsResponse = capo_workspaces_web.types.create_ip_access_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.create_ip_access_settings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
