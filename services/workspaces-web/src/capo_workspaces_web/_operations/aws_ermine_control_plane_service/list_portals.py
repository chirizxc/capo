"""Generated from Smithy shape ``com.amazonaws.workspacesweb#ListPortals``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_portals_response.ListPortalsResponse = (
        capo_workspaces_web.types.list_portals_response.deserialize_json(
...
def list_portals(
    ...
    capo_workspaces_web.types.list_portals_response.ListPortalsResponse, zapros.Response
]:
