...
def handle_response(
    ...
    out: capo_workspaces_web.types.get_ip_access_settings_response.GetIpAccessSettingsResponse = capo_workspaces_web.types.get_ip_access_settings_response.deserialize_json(
...
def build_request(
    ...
    url = url.replace(
        "{ipAccessSettingsArn+}", quote(input_["ip_access_settings_arn"], safe="/")
    )
