"""Generated from Smithy shape ``com.amazonaws.workspacesweb#CreateBrowserSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.create_browser_settings_response.CreateBrowserSettingsResponse = capo_workspaces_web.types.create_browser_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.create_browser_settings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_browser_settings(
