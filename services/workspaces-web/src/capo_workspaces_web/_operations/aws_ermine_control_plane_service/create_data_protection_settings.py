...
def handle_response(
    ...
    out: capo_workspaces_web.types.create_data_protection_settings_response.CreateDataProtectionSettingsResponse = capo_workspaces_web.types.create_data_protection_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.create_data_protection_settings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
