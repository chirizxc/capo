...
def handle_response(
    ...
    out: capo_workspaces_web.types.create_network_settings_response.CreateNetworkSettingsResponse = capo_workspaces_web.types.create_network_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.create_network_settings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
