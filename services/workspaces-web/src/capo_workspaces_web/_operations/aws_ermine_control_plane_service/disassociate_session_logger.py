"""Generated from Smithy shape ``com.amazonaws.workspacesweb#DisassociateSessionLogger``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.disassociate_session_logger_response.DisassociateSessionLoggerResponse = {}  # type: ignore[typeddict-item]
    return out
...
async def async_disassociate_session_logger(
