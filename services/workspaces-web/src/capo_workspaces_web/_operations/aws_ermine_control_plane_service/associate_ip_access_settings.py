"""Generated from Smithy shape ``com.amazonaws.workspacesweb#AssociateIpAccessSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.associate_ip_access_settings_response.AssociateIpAccessSettingsResponse = capo_workspaces_web.types.associate_ip_access_settings_response.deserialize_json(
...
def build_request(
    ...
    if "ip_access_settings_arn" in input_:
        params.append(("ipAccessSettingsArn", input_["ip_access_settings_arn"]))
...
async def async_associate_ip_access_settings(
