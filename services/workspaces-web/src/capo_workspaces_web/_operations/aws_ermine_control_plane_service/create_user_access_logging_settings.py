"""Generated from Smithy shape ``com.amazonaws.workspacesweb#CreateUserAccessLoggingSettings``."""
...
def handle_response(
    ...
    out: capo_workspaces_web.types.create_user_access_logging_settings_response.CreateUserAccessLoggingSettingsResponse = capo_workspaces_web.types.create_user_access_logging_settings_response.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_workspaces_web.types.create_user_access_logging_settings_request.serialize_json(
            input_
        ),
        allow_nan=False,
    ).encode()
...
async def async_create_user_access_logging_settings(
