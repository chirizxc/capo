...
def handle_response(
    ...
    out: capo_workspaces_web.types.associate_browser_settings_response.AssociateBrowserSettingsResponse = capo_workspaces_web.types.associate_browser_settings_response.deserialize_json(
...
def build_request(
    ...
    if "browser_settings_arn" in input_:
        params.append(("browserSettingsArn", input_["browser_settings_arn"]))
