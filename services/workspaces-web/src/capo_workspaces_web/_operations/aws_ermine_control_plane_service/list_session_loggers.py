"""Generated from Smithy shape ``com.amazonaws.workspacesweb#ListSessionLoggers``."""
...
import capo_workspaces_web.types.session_logger_list
...
def handle_response(
    ...
    out: capo_workspaces_web.types.list_session_loggers_response.ListSessionLoggersResponse = capo_workspaces_web.types.list_session_loggers_response.deserialize_json(
...
async def async_list_session_loggers(
