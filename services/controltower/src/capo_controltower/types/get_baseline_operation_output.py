...
class GetBaselineOperationOutput(TypedDict, closed=True):
    baseline_operation: "capo_controltower.types.baseline_operation.BaselineOperation"
...
def serialize_json(value: GetBaselineOperationOutput) -> dict:
    ...
    out["baselineOperation"] = (
        capo_controltower.types.baseline_operation.serialize_json(
...
def deserialize_json(data: dict) -> GetBaselineOperationOutput:
    ...
    if data.get("baselineOperation") is not None:
        import capo_controltower.types.baseline_operation

        out["baseline_operation"] = (
            capo_controltower.types.baseline_operation.deserialize_json(
