...
def handle_response(
    ...
    out: capo_controltower.types.enable_control_output.EnableControlOutput = (
        capo_controltower.types.enable_control_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.enable_control_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def enable_control(
    ...
    capo_controltower.types.enable_control_output.EnableControlOutput, zapros.Response
]:
