...
def handle_response(
    ...
    out: capo_controltower.types.disable_baseline_output.DisableBaselineOutput = (
        capo_controltower.types.disable_baseline_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.disable_baseline_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
