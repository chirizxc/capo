...
def handle_response(
    ...
    out: capo_controltower.types.get_baseline_output.GetBaselineOutput = (
        capo_controltower.types.get_baseline_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.get_baseline_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
...
def get_baseline(
    ...
    capo_controltower.types.get_baseline_output.GetBaselineOutput, zapros.Response
]:
