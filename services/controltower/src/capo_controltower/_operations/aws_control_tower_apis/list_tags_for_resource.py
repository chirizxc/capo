"""Generated from Smithy shape ``com.amazonaws.controltower#ListTagsForResource``."""
...
def handle_response(
    ...
    out: capo_controltower.types.list_tags_for_resource_output.ListTagsForResourceOutput = capo_controltower.types.list_tags_for_resource_output.deserialize_json(
