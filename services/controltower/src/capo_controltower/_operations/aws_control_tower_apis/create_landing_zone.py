...
def handle_response(
    ...
    out: capo_controltower.types.create_landing_zone_output.CreateLandingZoneOutput = (
        capo_controltower.types.create_landing_zone_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.create_landing_zone_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
