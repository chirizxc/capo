...
def handle_response(
    ...
    out: capo_controltower.types.update_enabled_baseline_output.UpdateEnabledBaselineOutput = capo_controltower.types.update_enabled_baseline_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.update_enabled_baseline_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
