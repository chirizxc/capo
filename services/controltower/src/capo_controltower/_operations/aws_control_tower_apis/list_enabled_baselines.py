...
def handle_response(
    ...
    out: capo_controltower.types.list_enabled_baselines_output.ListEnabledBaselinesOutput = capo_controltower.types.list_enabled_baselines_output.deserialize_json(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_controltower.types.list_enabled_baselines_input.serialize_json(input_),
        allow_nan=False,
    ).encode()
