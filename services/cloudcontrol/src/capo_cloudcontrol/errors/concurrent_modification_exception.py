"""Generated from Smithy shape ``com.amazonaws.cloudcontrol#ConcurrentModificationException``."""
...
class ConcurrentModificationException(ServiceError):
    """Modeled error for Smithy shape ``com.amazonaws.cloudcontrol#ConcurrentModificationException``."""
