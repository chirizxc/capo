...
def handle_response(
    ...
    out: capo_cloudcontrol.types.get_resource_request_status_output.GetResourceRequestStatusOutput = capo_cloudcontrol.types.get_resource_request_status_output.deserialize_aws_json_1_0(
...
def build_request(
    ...
    body: bytes | None = json.dumps(
        capo_cloudcontrol.types.get_resource_request_status_input.serialize_aws_json_1_0(
            input_
        ),
        allow_nan=False,
    ).encode()
